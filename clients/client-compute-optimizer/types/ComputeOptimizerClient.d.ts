...
export declare type ServiceInputTypes = GetAutoScalingGroupRecommendationsCommandInput | GetEC2InstanceRecommendationsCommandInput | GetEC2RecommendationProjectedMetricsCommandInput | GetEnrollmentStatusCommandInput | GetRecommendationSummariesCommandInput | UpdateEnrollmentStatusCommandInput;
export declare type ServiceOutputTypes = GetAutoScalingGroupRecommendationsCommandOutput | GetEC2InstanceRecommendationsCommandOutput | GetEC2RecommendationProjectedMetricsCommandOutput | GetEnrollmentStatusCommandOutput | GetRecommendationSummariesCommandOutput | UpdateEnrollmentStatusCommandOutput;
...
export declare type ComputeOptimizerClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type ComputeOptimizerClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
