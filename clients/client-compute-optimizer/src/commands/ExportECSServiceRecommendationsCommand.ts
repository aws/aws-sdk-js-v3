 ...
 * @public
 */
export class ExportECSServiceRecommendationsCommand extends command<ExportECSServiceRecommendationsCommandInput, ExportECSServiceRecommendationsCommandOutput>(
  _ep0,
  _mw0,
