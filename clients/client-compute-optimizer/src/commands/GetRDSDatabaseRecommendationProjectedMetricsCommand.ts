 ...
 * @public
 */
export class GetRDSDatabaseRecommendationProjectedMetricsCommand extends command<GetRDSDatabaseRecommendationProjectedMetricsCommandInput, GetRDSDatabaseRecommendationProjectedMetricsCommandOutput>(
  _ep0,
  _mw0,
