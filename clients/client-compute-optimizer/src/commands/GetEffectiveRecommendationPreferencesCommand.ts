 ...
 * ```
 *
 * @param GetEffectiveRecommendationPreferencesRequest - {@link GetEffectiveRecommendationPreferencesRequest}
 * @returns {@link GetEffectiveRecommendationPreferencesResponse}
