 ...
 * @public
 */
export class GetECSServiceRecommendationProjectedMetricsCommand extends command<GetECSServiceRecommendationProjectedMetricsCommandInput, GetECSServiceRecommendationProjectedMetricsCommandOutput>(
  _ep0,
  _mw0,
