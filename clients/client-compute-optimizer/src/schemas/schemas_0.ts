...
export var AutoScalingGroupEstimatedMonthlySavings$: StaticStructureSchema = [3, n0, _ASGEMS,
  0,
  [_cu, _v],
  [0, 1]
];
export var AutoScalingGroupRecommendation$: StaticStructureSchema = [3, n0, _ASGR,
  0,
...
export var AutoScalingGroupRecommendationOption$: StaticStructureSchema = [3, n0, _ASGRO,
  0,
...
export var AutoScalingGroupSavingsOpportunityAfterDiscounts$: StaticStructureSchema = [3, n0, _ASGSOAD,
  0,
  [_sOP, _eMS],
  [1, () => AutoScalingGroupEstimatedMonthlySavings$]
];
export var ContainerConfiguration$: StaticStructureSchema = [3, n0, _CC,
  0,
  [_cN, _mSC, _cp],
  [0, () => MemorySizeConfiguration$, 1]
];
export var ContainerRecommendation$: StaticStructureSchema = [3, n0, _CR,
  0,
  [_cN, _mSC, _cp],
  [0, () => MemorySizeConfiguration$, 1]
];
export var CurrentPerformanceRiskRatings$: StaticStructureSchema = [3, n0, _CPRR,
  0,
  [_h, _me, _l, _vL],
  [1, 1, 1, 1]
];
export var CustomizableMetricParameters$: StaticStructureSchema = [3, n0, _CMP,
  0,
  [_th, _he],
  [0, 0]
];
export var DBStorageConfiguration$: StaticStructureSchema = [3, n0, _DBSC,
  0,
...
export var DescribeRecommendationExportJobsRequest$: StaticStructureSchema = [3, n0, _DREJR,
  0,
  [_jI, _fi, _nT, _mR],
  [64 | 0, () => JobFilters, 0, 1]
];
export var DescribeRecommendationExportJobsResponse$: StaticStructureSchema = [3, n0, _DREJRe,
  0,
  [_rEJ, _nT],
...
export var EBSFilter$: StaticStructureSchema = [3, n0, _EBSF,
  0,
  [_n, _va],
  [0, 64 | 0]
];
export var EBSSavingsEstimationMode$: StaticStructureSchema = [3, n0, _EBSSEM,
  0,
  [_so],
  [0]
];
export var EBSSavingsOpportunityAfterDiscounts$: StaticStructureSchema = [3, n0, _EBSSOAD,
  0,
  [_sOP, _eMS],
...
export var ECSSavingsEstimationMode$: StaticStructureSchema = [3, n0, _ECSSEM,
  0,
  [_so],
  [0]
];
export var ECSSavingsOpportunityAfterDiscounts$: StaticStructureSchema = [3, n0, _ECSSOAD,
  0,
  [_sOP, _eMS],
  [1, () => ECSEstimatedMonthlySavings$]
];
export var ECSServiceProjectedMetric$: StaticStructureSchema = [3, n0, _ECSSPM,
  0,
  [_n, _ti, _uBV, _lBV],
  [0, 64 | 4, 64 | 1, 64 | 1]
];
...
export var ECSServiceRecommendationFilter$: StaticStructureSchema = [3, n0, _ECSSRF,
  0,
  [_n, _va],
  [0, 64 | 0]
];
export var ECSServiceRecommendationOption$: StaticStructureSchema = [3, n0, _ECSSRO,
  0,
...
export var ECSServiceRecommendedOptionProjectedMetric$: StaticStructureSchema = [3, n0, _ECSSROPM,
  0,
  [_rCU, _rMS, _pM],
...
export var EffectiveRecommendationPreferences$: StaticStructureSchema = [3, n0, _ERP,
  0,
...
export var EnrollmentFilter$: StaticStructureSchema = [3, n0, _EF,
  0,
  [_n, _va],
  [0, 64 | 0]
];
...
export var ExportDestination$: StaticStructureSchema = [3, n0, _ED,
  0,
  [_s_],
  [() => S3Destination$]
];
...
export var ExternalMetricsPreference$: StaticStructureSchema = [3, n0, _EMP,
  0,
  [_so],
  [0]
];
export var ExternalMetricStatus$: StaticStructureSchema = [3, n0, _EMSx,
  0,
  [_sC, _sR],
  [0, 0]
];
...
export var GetAutoScalingGroupRecommendationsRequest$: StaticStructureSchema = [3, n0, _GASGRR,
  0,
  [_aIc, _aSGAu, _nT, _mR, _fi, _rP],
  [64 | 0, 64 | 0, 0, 1, () => Filters, () => RecommendationPreferences$]
];
export var GetAutoScalingGroupRecommendationsResponse$: StaticStructureSchema = [3, n0, _GASGRRe,
  0,
  [_nT, _aSGR, _er],
  [0, () => AutoScalingGroupRecommendations, () => GetRecommendationErrors]
];
export var GetEBSVolumeRecommendationsRequest$: StaticStructureSchema = [3, n0, _GEBSVRR,
  0,
  [_vA, _nT, _mR, _fi, _aIc],
  [64 | 0, 0, 1, () => EBSFilters, 64 | 0]
];
export var GetEBSVolumeRecommendationsResponse$: StaticStructureSchema = [3, n0, _GEBSVRRe,
  0,
  [_nT, _vR, _er],
  [0, () => VolumeRecommendations, () => GetRecommendationErrors]
];
export var GetEC2InstanceRecommendationsRequest$: StaticStructureSchema = [3, n0, _GECIRR,
  0,
  [_iA, _nT, _mR, _fi, _aIc, _rP],
  [64 | 0, 0, 1, () => Filters, 64 | 0, () => RecommendationPreferences$]
];
export var GetEC2InstanceRecommendationsResponse$: StaticStructureSchema = [3, n0, _GECIRRe,
  0,
  [_nT, _iR, _er],
...
export var GetECSServiceRecommendationsRequest$: StaticStructureSchema = [3, n0, _GECSSRR,
  0,
  [_sAe, _nT, _mR, _fi, _aIc],
  [64 | 0, 0, 1, () => ECSServiceRecommendationFilters, 64 | 0]
];
export var GetECSServiceRecommendationsResponse$: StaticStructureSchema = [3, n0, _GECSSRRe,
  0,
  [_nT, _eSR, _er],
...
export var GetEnrollmentStatusesForOrganizationRequest$: StaticStructureSchema = [3, n0, _GESFOR,
  0,
  [_fi, _nT, _mR],
  [() => EnrollmentFilters, 0, 1]
];
export var GetEnrollmentStatusesForOrganizationResponse$: StaticStructureSchema = [3, n0, _GESFORe,
  0,
  [_aES, _nT],
  [() => AccountEnrollmentStatuses, 0]
];
export var GetEnrollmentStatusRequest$: StaticStructureSchema = [3, n0, _GESR,
  0,
  [],
  []
];
...
export var GetIdleRecommendationsResponse$: StaticStructureSchema = [3, n0, _GIRRe,
  0,
  [_nT, _iRd, _er],
  [0, () => IdleRecommendations, () => IdleRecommendationErrors]
];
export var GetLambdaFunctionRecommendationsRequest$: StaticStructureSchema = [3, n0, _GLFRR,
  0,
  [_fA, _aIc, _fi, _nT, _mR],
  [64 | 0, 64 | 0, () => LambdaFunctionRecommendationFilters, 0, 1]
];
export var GetLambdaFunctionRecommendationsResponse$: StaticStructureSchema = [3, n0, _GLFRRe,
  0,
  [_nT, _lFR],
  [0, () => LambdaFunctionRecommendations]
];
export var GetLicenseRecommendationsRequest$: StaticStructureSchema = [3, n0, _GLRR,
  0,
  [_rAe, _nT, _mR, _fi, _aIc],
  [64 | 0, 0, 1, () => LicenseRecommendationFilters, 64 | 0]
];
export var GetLicenseRecommendationsResponse$: StaticStructureSchema = [3, n0, _GLRRe,
  0,
  [_nT, _lR, _er],
...
export var GetRDSDatabaseRecommendationsRequest$: StaticStructureSchema = [3, n0, _GRDSDRR,
  0,
  [_rAe, _nT, _mR, _fi, _aIc, _rP],
  [64 | 0, 0, 1, () => RDSDBRecommendationFilters, 64 | 0, () => RecommendationPreferences$]
];
export var GetRDSDatabaseRecommendationsResponse$: StaticStructureSchema = [3, n0, _GRDSDRRe,
  0,
  [_nT, _rDBR, _er],
  [0, () => RDSDBRecommendations, () => GetRecommendationErrors]
];
export var GetRecommendationError$: StaticStructureSchema = [3, n0, _GRE,
  0,
  [_id, _cod, _m],
  [0, 0, 0]
];
...
export var GetRecommendationSummariesRequest$: StaticStructureSchema = [3, n0, _GRSR,
  0,
  [_aIc, _nT, _mR],
  [64 | 0, 0, 1]
];
export var GetRecommendationSummariesResponse$: StaticStructureSchema = [3, n0, _GRSRe,
  0,
  [_nT, _rS],
  [0, () => RecommendationSummaries]
];
export var Gpu$: StaticStructureSchema = [3, n0, _G,
  0,
  [_gC, _gMSIMB],
  [1, 1]
];
export var GpuInfo$: StaticStructureSchema = [3, n0, _GI,
  0,
  [_g],
  [() => Gpus]
];
...
export var IdleRecommendation$: StaticStructureSchema = [3, n0, _IR,
  0,
...
export var IdleRecommendationError$: StaticStructureSchema = [3, n0, _IRE,
  0,
  [_id, _cod, _m, _rT],
  [0, 0, 0, 0]
];
export var IdleRecommendationFilter$: StaticStructureSchema = [3, n0, _IRF,
  0,
  [_n, _va],
  [0, 64 | 0]
];
export var IdleSavingsOpportunity$: StaticStructureSchema = [3, n0, _ISO,
  0,
  [_sOP, _eMS],
  [1, () => IdleEstimatedMonthlySavings$]
];
export var IdleSavingsOpportunityAfterDiscounts$: StaticStructureSchema = [3, n0, _ISOAD,
  0,
  [_sOP, _eMS],
  [1, () => IdleEstimatedMonthlySavings$]
];
export var IdleSummary$: StaticStructureSchema = [3, n0, _IS,
  0,
  [_n, _v],
  [0, 1]
];
...
export var InstanceEstimatedMonthlySavings$: StaticStructureSchema = [3, n0, _IEMSn,
  0,
  [_cu, _v],
  [0, 1]
];
export var InstanceRecommendation$: StaticStructureSchema = [3, n0, _IRn,
  0,
...
export var InstanceRecommendationOption$: StaticStructureSchema = [3, n0, _IRO,
  0,
...
export var InstanceSavingsEstimationMode$: StaticStructureSchema = [3, n0, _ISEM,
  0,
  [_so],
  [0]
];
export var InstanceSavingsOpportunityAfterDiscounts$: StaticStructureSchema = [3, n0, _ISOADn,
  0,
  [_sOP, _eMS],
...
export var LambdaEffectiveRecommendationPreferences$: StaticStructureSchema = [3, n0, _LERP,
  0,
  [_sEM],
  [() => LambdaSavingsEstimationMode$]
];
export var LambdaEstimatedMonthlySavings$: StaticStructureSchema = [3, n0, _LEMS,
  0,
  [_cu, _v],
  [0, 1]
];
...
export var LambdaFunctionRecommendation$: StaticStructureSchema = [3, n0, _LFR,
  0,
...
export var LambdaFunctionRecommendationFilter$: StaticStructureSchema = [3, n0, _LFRF,
  0,
  [_n, _va],
  [0, 64 | 0]
];
...
export var LambdaSavingsOpportunityAfterDiscounts$: StaticStructureSchema = [3, n0, _LSOAD,
  0,
  [_sOP, _eMS],
  [1, () => LambdaEstimatedMonthlySavings$]
];
export var LicenseConfiguration$: StaticStructureSchema = [3, n0, _LC,
  0,
  [_nOC, _iT, _oS, _lE, _lN, _lM, _lV, _mSet],
  [1, 0, 0, 0, 0, 0, 0, () => MetricsSource]
];
export var LicenseRecommendation$: StaticStructureSchema = [3, n0, _LR,
  0,
  [_rA, _aI, _cLC, _lPID, _lRT, _f, _fRC, _lRO, _ta],
  [0, 0, () => LicenseConfiguration$, 1, 4, 0, 64 | 0, () => LicenseRecommendationOptions, () => Tags]
];
export var LicenseRecommendationFilter$: StaticStructureSchema = [3, n0, _LRF,
  0,
  [_n, _va],
  [0, 64 | 0]
];
export var LicenseRecommendationOption$: StaticStructureSchema = [3, n0, _LRO,
  0,
  [_r, _oS, _lE, _lM, _sO],
...
export var ProjectedMetric$: StaticStructureSchema = [3, n0, _PM,
  0,
  [_n, _ti, _va],
  [0, 64 | 4, 64 | 1]
];
...
export var RDSDatabaseProjectedMetric$: StaticStructureSchema = [3, n0, _RDSDPM,
  0,
  [_n, _ti, _va],
  [0, 64 | 4, 64 | 1]
];
export var RDSDatabaseRecommendedOptionProjectedMetric$: StaticStructureSchema = [3, n0, _RDSDROPM,
  0,
  [_rDBIC, _r, _pM],
  [0, 1, () => RDSDatabaseProjectedMetrics]
];
export var RDSDBInstanceRecommendationOption$: StaticStructureSchema = [3, n0, _RDSDBIRO,
  0,
...
export var RDSDBRecommendation$: StaticStructureSchema = [3, n0, _RDSDBR,
  0,
...
export var RDSDBRecommendationFilter$: StaticStructureSchema = [3, n0, _RDSDBRF,
  0,
  [_n, _va],
  [0, 64 | 0]
];
export var RDSDBStorageRecommendationOption$: StaticStructureSchema = [3, n0, _RDSDBSRO,
  0,
...
export var RDSInstanceEstimatedMonthlySavings$: StaticStructureSchema = [3, n0, _RDSIEMS,
  0,
  [_cu, _v],
  [0, 1]
];
export var RDSInstanceSavingsOpportunityAfterDiscounts$: StaticStructureSchema = [3, n0, _RDSISOAD,
  0,
  [_sOP, _eMS],
  [1, () => RDSInstanceEstimatedMonthlySavings$]
];
export var RDSSavingsEstimationMode$: StaticStructureSchema = [3, n0, _RDSSEM,
  0,
  [_so],
  [0]
];
export var RDSStorageEstimatedMonthlySavings$: StaticStructureSchema = [3, n0, _RDSSEMS,
  0,
  [_cu, _v],
  [0, 1]
];
export var RDSStorageSavingsOpportunityAfterDiscounts$: StaticStructureSchema = [3, n0, _RDSSSOAD,
  0,
  [_sOP, _eMS],
  [1, () => RDSStorageEstimatedMonthlySavings$]
];
export var ReasonCodeSummary$: StaticStructureSchema = [3, n0, _RCS,
  0,
  [_n, _v],
  [0, 1]
];
...
export var RecommendationPreferencesDetail$: StaticStructureSchema = [3, n0, _RPD,
  0,
...
export var RecommendationSource$: StaticStructureSchema = [3, n0, _RS,
  0,
  [_rSA, _rST],
  [0, 0]
];
...
export var RecommendedOptionProjectedMetric$: StaticStructureSchema = [3, n0, _ROPM,
  0,
  [_rIT, _r, _pM],
...
export var SavingsOpportunity$: StaticStructureSchema = [3, n0, _SO,
  0,
  [_sOP, _eMS],
...
export var ServiceConfiguration$: StaticStructureSchema = [3, n0, _SC,
  0,
...
export var VolumeConfiguration$: StaticStructureSchema = [3, n0, _VC,
  0,
  [_vT, _vS, _vBIOPS, _vBIOPSo, _vBT, _vBTo, _rV],
  [0, 1, 1, 1, 1, 1, 2]
];
export var VolumeRecommendation$: StaticStructureSchema = [3, n0, _VR,
  0,
...
export var VolumeRecommendationOption$: StaticStructureSchema = [3, n0, _VRO,
  0,
...
var AutoScalingGroupRecommendationOptions: StaticListSchema = [1, n0, _ASGROu,
  0, () => AutoScalingGroupRecommendationOption$
];
var AutoScalingGroupRecommendations: StaticListSchema = [1, n0, _ASGRu,
  0, () => AutoScalingGroupRecommendation$
];
var ContainerConfigurations: StaticListSchema = [1, n0, _CCo,
  0, () => ContainerConfiguration$
];
var ContainerRecommendations: StaticListSchema = [1, n0, _CRo,
  0, () => ContainerRecommendation$
];
var CpuVendorArchitectures = 64 | 0;
var EBSFilters: StaticListSchema = [1, n0, _EBSFi,
  0, () => EBSFilter$
];
var EBSUtilizationMetrics: StaticListSchema = [1, n0, _EBSUMt,
  0, () => EBSUtilizationMetric$
];
var ECSServiceProjectedMetrics: StaticListSchema = [1, n0, _ECSSPMe,
  0, () => ECSServiceProjectedMetric$
];
var ECSServiceProjectedUtilizationMetrics: StaticListSchema = [1, n0, _ECSSPUMe,
  0, () => ECSServiceProjectedUtilizationMetric$
];
var ECSServiceRecommendationFilters: StaticListSchema = [1, n0, _ECSSRFe,
  0, () => ECSServiceRecommendationFilter$
];
var ECSServiceRecommendationFindingReasonCodes = 64 | 0;
var ECSServiceRecommendationOptions: StaticListSchema = [1, n0, _ECSSROe,
  0, () => ECSServiceRecommendationOption$
];
var ECSServiceRecommendations: StaticListSchema = [1, n0, _ECSSRe,
  0, () => ECSServiceRecommendation$
];
var ECSServiceRecommendedOptionProjectedMetrics: StaticListSchema = [1, n0, _ECSSROPMe,
  0, () => ECSServiceRecommendedOptionProjectedMetric$
];
var ECSServiceUtilizationMetrics: StaticListSchema = [1, n0, _ECSSUMe,
  0, () => ECSServiceUtilizationMetric$
];
var EffectivePreferredResources: StaticListSchema = [1, n0, _EPRf,
  0, () => EffectivePreferredResource$
];
var EnrollmentFilters: StaticListSchema = [1, n0, _EFn,
  0, () => EnrollmentFilter$
];
...
var GetRecommendationErrors: StaticListSchema = [1, n0, _GREe,
...
var IdleRecommendationFilters: StaticListSchema = [1, n0, _IRFd,
  0, () => IdleRecommendationFilter$
];
var IdleRecommendations: StaticListSchema = [1, n0, _IRd,
  0, () => IdleRecommendation$
];
var IdleSummaries: StaticListSchema = [1, n0, _ISd,
  0, () => IdleSummary$
];
var IdleUtilizationMetrics: StaticListSchema = [1, n0, _IUMd,
  0, () => IdleUtilizationMetric$
];
var InferredWorkloadSavings: StaticListSchema = [1, n0, _IWSn,
...
var InstanceRecommendations: StaticListSchema = [1, n0, _IRns,
  0, () => InstanceRecommendation$
];
var JobFilters: StaticListSchema = [1, n0, _JFo,
  0, () => JobFilter$
];
var JobIds = 64 | 0;
var LambdaFunctionMemoryProjectedMetrics: StaticListSchema = [1, n0, _LFMPMa,
  0, () => LambdaFunctionMemoryProjectedMetric$
];
var LambdaFunctionMemoryRecommendationOptions: StaticListSchema = [1, n0, _LFMROa,
  0, () => LambdaFunctionMemoryRecommendationOption$
];
var LambdaFunctionRecommendationFilters: StaticListSchema = [1, n0, _LFRFa,
  0, () => LambdaFunctionRecommendationFilter$
];
var LambdaFunctionRecommendationFindingReasonCodes = 64 | 0;
var LambdaFunctionRecommendations: StaticListSchema = [1, n0, _LFRa,
  0, () => LambdaFunctionRecommendation$
];
var LambdaFunctionUtilizationMetrics: StaticListSchema = [1, n0, _LFUMa,
  0, () => LambdaFunctionUtilizationMetric$
];
var LicenseFindingReasonCodes = 64 | 0;
var LicenseRecommendationFilters: StaticListSchema = [1, n0, _LRFi,
  0, () => LicenseRecommendationFilter$
];
var LicenseRecommendationOptions: StaticListSchema = [1, n0, _LROi,
  0, () => LicenseRecommendationOption$
];
var LicenseRecommendations: StaticListSchema = [1, n0, _LRi,
  0, () => LicenseRecommendation$
];
var MetricsSource: StaticListSchema = [1, n0, _MSe,
  0, () => MetricSource$
];
var MetricValues = 64 | 1;
var MixedInstanceTypes = 64 | 0;
var PlatformDifferences = 64 | 0;
var PreferredResources: StaticListSchema = [1, n0, _PRr,
  0, () => PreferredResource$
];
var PreferredResourceValues = 64 | 0;
var ProjectedMetrics: StaticListSchema = [1, n0, _PMr,
  0, () => ProjectedMetric$
];
var ProjectedUtilizationMetrics: StaticListSchema = [1, n0, _PUM,
  0, () => UtilizationMetric$
];
var RDSDatabaseProjectedMetrics: StaticListSchema = [1, n0, _RDSDPMa,
  0, () => RDSDatabaseProjectedMetric$
];
var RDSDatabaseRecommendedOptionProjectedMetrics: StaticListSchema = [1, n0, _RDSDROPMa,
  0, () => RDSDatabaseRecommendedOptionProjectedMetric$
];
var RDSDBInstanceRecommendationOptions: StaticListSchema = [1, n0, _RDSDBIROn,
  0, () => RDSDBInstanceRecommendationOption$
];
var RDSDBProjectedUtilizationMetrics: StaticListSchema = [1, n0, _RDSDBPUM,
  0, () => RDSDBUtilizationMetric$
];
var RDSDBRecommendationFilters: StaticListSchema = [1, n0, _RDSDBRFe,
  0, () => RDSDBRecommendationFilter$
];
var RDSDBRecommendations: StaticListSchema = [1, n0, _RDSDBRe,
  0, () => RDSDBRecommendation$
];
var RDSDBStorageRecommendationOptions: StaticListSchema = [1, n0, _RDSDBSROt,
  0, () => RDSDBStorageRecommendationOption$
];
var RDSDBUtilizationMetrics: StaticListSchema = [1, n0, _RDSDBUMt,
  0, () => RDSDBUtilizationMetric$
];
var RDSInstanceFindingReasonCodes = 64 | 0;
var RDSStorageFindingReasonCodes = 64 | 0;
var ReasonCodeSummaries: StaticListSchema = [1, n0, _RCSe,
  0, () => ReasonCodeSummary$
];
var RecommendationExportJobs: StaticListSchema = [1, n0, _REJe,
  0, () => RecommendationExportJob$
];
var RecommendationOptions: StaticListSchema = [1, n0, _RO,
  0, () => InstanceRecommendationOption$
];
var RecommendationPreferenceNames = 64 | 0;
var RecommendationPreferencesDetails: StaticListSchema = [1, n0, _RPDe,
  0, () => RecommendationPreferencesDetail$
];
var RecommendationSources: StaticListSchema = [1, n0, _RSec,
  0, () => RecommendationSource$
];
var RecommendationSummaries: StaticListSchema = [1, n0, _RSeco,
  0, () => RecommendationSummary$
];
var RecommendedOptionProjectedMetrics: StaticListSchema = [1, n0, _ROPMe,
  0, () => RecommendedOptionProjectedMetric$
];
var ResourceArns = 64 | 0;
var ServiceArns = 64 | 0;
var Summaries: StaticListSchema = [1, n0, _Sum,
  0, () => Summary$
];
...
var Timestamps = 64 | 4;
var UtilizationMetrics: StaticListSchema = [1, n0, _UMt,
  0, () => UtilizationMetric$
];
var UtilizationPreferences: StaticListSchema = [1, n0, _UPt,
  0, () => UtilizationPreference$
];
var VolumeArns = 64 | 0;
var VolumeRecommendationOptions: StaticListSchema = [1, n0, _VROo,
  0, () => VolumeRecommendationOption$
];
var VolumeRecommendations: StaticListSchema = [1, n0, _VRo,
  0, () => VolumeRecommendation$
];
export var DeleteRecommendationPreferences$: StaticOperationSchema = [9, n0, _DRP,
  0, () => DeleteRecommendationPreferencesRequest$, () => DeleteRecommendationPreferencesResponse$
];
export var DescribeRecommendationExportJobs$: StaticOperationSchema = [9, n0, _DREJ,
  0, () => DescribeRecommendationExportJobsRequest$, () => DescribeRecommendationExportJobsResponse$
];
export var ExportAutoScalingGroupRecommendations$: StaticOperationSchema = [9, n0, _EASGR,
  0, () => ExportAutoScalingGroupRecommendationsRequest$, () => ExportAutoScalingGroupRecommendationsResponse$
];
export var ExportEBSVolumeRecommendations$: StaticOperationSchema = [9, n0, _EEBSVR,
  0, () => ExportEBSVolumeRecommendationsRequest$, () => ExportEBSVolumeRecommendationsResponse$
];
export var ExportEC2InstanceRecommendations$: StaticOperationSchema = [9, n0, _EECIR,
  0, () => ExportEC2InstanceRecommendationsRequest$, () => ExportEC2InstanceRecommendationsResponse$
];
export var ExportECSServiceRecommendations$: StaticOperationSchema = [9, n0, _EECSSR,
  0, () => ExportECSServiceRecommendationsRequest$, () => ExportECSServiceRecommendationsResponse$
];
export var ExportIdleRecommendations$: StaticOperationSchema = [9, n0, _EIR,
  0, () => ExportIdleRecommendationsRequest$, () => ExportIdleRecommendationsResponse$
];
export var ExportLambdaFunctionRecommendations$: StaticOperationSchema = [9, n0, _ELFR,
  0, () => ExportLambdaFunctionRecommendationsRequest$, () => ExportLambdaFunctionRecommendationsResponse$
];
export var ExportLicenseRecommendations$: StaticOperationSchema = [9, n0, _ELR,
  0, () => ExportLicenseRecommendationsRequest$, () => ExportLicenseRecommendationsResponse$
];
export var ExportRDSDatabaseRecommendations$: StaticOperationSchema = [9, n0, _ERDSDR,
  0, () => ExportRDSDatabaseRecommendationsRequest$, () => ExportRDSDatabaseRecommendationsResponse$
];
export var GetAutoScalingGroupRecommendations$: StaticOperationSchema = [9, n0, _GASGR,
  0, () => GetAutoScalingGroupRecommendationsRequest$, () => GetAutoScalingGroupRecommendationsResponse$
];
export var GetEBSVolumeRecommendations$: StaticOperationSchema = [9, n0, _GEBSVR,
  0, () => GetEBSVolumeRecommendationsRequest$, () => GetEBSVolumeRecommendationsResponse$
];
export var GetEC2InstanceRecommendations$: StaticOperationSchema = [9, n0, _GECIR,
  0, () => GetEC2InstanceRecommendationsRequest$, () => GetEC2InstanceRecommendationsResponse$
];
export var GetEC2RecommendationProjectedMetrics$: StaticOperationSchema = [9, n0, _GECRPM,
  0, () => GetEC2RecommendationProjectedMetricsRequest$, () => GetEC2RecommendationProjectedMetricsResponse$
];
export var GetECSServiceRecommendationProjectedMetrics$: StaticOperationSchema = [9, n0, _GECSSRPM,
  0, () => GetECSServiceRecommendationProjectedMetricsRequest$, () => GetECSServiceRecommendationProjectedMetricsResponse$
];
export var GetECSServiceRecommendations$: StaticOperationSchema = [9, n0, _GECSSR,
  0, () => GetECSServiceRecommendationsRequest$, () => GetECSServiceRecommendationsResponse$
];
export var GetEffectiveRecommendationPreferences$: StaticOperationSchema = [9, n0, _GERP,
  0, () => GetEffectiveRecommendationPreferencesRequest$, () => GetEffectiveRecommendationPreferencesResponse$
];
export var GetEnrollmentStatus$: StaticOperationSchema = [9, n0, _GES,
  0, () => GetEnrollmentStatusRequest$, () => GetEnrollmentStatusResponse$
];
export var GetEnrollmentStatusesForOrganization$: StaticOperationSchema = [9, n0, _GESFO,
  0, () => GetEnrollmentStatusesForOrganizationRequest$, () => GetEnrollmentStatusesForOrganizationResponse$
];
export var GetIdleRecommendations$: StaticOperationSchema = [9, n0, _GIR,
  0, () => GetIdleRecommendationsRequest$, () => GetIdleRecommendationsResponse$
];
export var GetLambdaFunctionRecommendations$: StaticOperationSchema = [9, n0, _GLFR,
  0, () => GetLambdaFunctionRecommendationsRequest$, () => GetLambdaFunctionRecommendationsResponse$
];
export var GetLicenseRecommendations$: StaticOperationSchema = [9, n0, _GLR,
  0, () => GetLicenseRecommendationsRequest$, () => GetLicenseRecommendationsResponse$
];
export var GetRDSDatabaseRecommendationProjectedMetrics$: StaticOperationSchema = [9, n0, _GRDSDRPM,
  0, () => GetRDSDatabaseRecommendationProjectedMetricsRequest$, () => GetRDSDatabaseRecommendationProjectedMetricsResponse$
];
export var GetRDSDatabaseRecommendations$: StaticOperationSchema = [9, n0, _GRDSDR,
  0, () => GetRDSDatabaseRecommendationsRequest$, () => GetRDSDatabaseRecommendationsResponse$
];
export var GetRecommendationPreferences$: StaticOperationSchema = [9, n0, _GRP,
  0, () => GetRecommendationPreferencesRequest$, () => GetRecommendationPreferencesResponse$
];
export var GetRecommendationSummaries$: StaticOperationSchema = [9, n0, _GRS,
  0, () => GetRecommendationSummariesRequest$, () => GetRecommendationSummariesResponse$
];
export var PutRecommendationPreferences$: StaticOperationSchema = [9, n0, _PRP,
  0, () => PutRecommendationPreferencesRequest$, () => PutRecommendationPreferencesResponse$
];
export var UpdateEnrollmentStatus$: StaticOperationSchema = [9, n0, _UES,
