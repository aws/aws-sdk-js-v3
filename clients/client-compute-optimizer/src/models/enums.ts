...
export const ExportableIdleField = {
  ...
  UTILIZATION_METRICS_CACHE_HITS_SUM: "UtilizationMetricsCacheHitsSum",
  UTILIZATION_METRICS_CACHE_MISSES_SUM: "UtilizationMetricsCacheMissesSum",
  UTILIZATION_METRICS_CONSUMED_READ_CAPACITY_UNITS_SUM: "UtilizationMetricsConsumedReadCapacityUnitsSum",
  UTILIZATION_METRICS_CONSUMED_WRITE_CAPACITY_UNITS_SUM: "UtilizationMetricsConsumedWriteCapacityUnitsSum",
  UTILIZATION_METRICS_CPU_MAXIMUM: "UtilizationMetricsCpuMaximum",
  UTILIZATION_METRICS_CURR_CONNECTIONS_SUM: "UtilizationMetricsCurrConnectionsSum",
  UTILIZATION_METRICS_DATABASE_CONNECTIONS_MAXIMUM: "UtilizationMetricsDatabaseConnectionsMaximum",
  UTILIZATION_METRICS_DATABASE_CONNECTIONS_SUM: "UtilizationMetricsDatabaseConnectionsSum",
  ...
  UTILIZATION_METRICS_ELASTI_CACHE_PROCESSING_UNITS_SUM: "UtilizationMetricsElastiCacheProcessingUnitsSum",
  UTILIZATION_METRICS_ENGINE_CPU_UTILIZATION_MAXIMUM: "UtilizationMetricsEngineCPUUtilizationMaximum",
  UTILIZATION_METRICS_GET_TYPE_CMDS_SUM: "UtilizationMetricsGetTypeCmdsSum",
  UTILIZATION_METRICS_INVOCATIONS_SUM: "UtilizationMetricsInvocationsSum",
  UTILIZATION_METRICS_IS_IDLE_MINIMUM: "UtilizationMetricsIsIdleMinimum",
  UTILIZATION_METRICS_KEYSPACE_HITS_SUM: "UtilizationMetricsKeyspaceHitsSum",
  UTILIZATION_METRICS_KEYSPACE_MISSES_SUM: "UtilizationMetricsKeyspaceMissesSum",
  UTILIZATION_METRICS_MEMORY_MAXIMUM: "UtilizationMetricsMemoryMaximum",
  UTILIZATION_METRICS_NETWORK_IN_BYTES_PER_SECOND_MAXIMUM: "UtilizationMetricsNetworkInBytesPerSecondMaximum",
  UTILIZATION_METRICS_NETWORK_OUT_BYTES_PER_SECOND_MAXIMUM: "UtilizationMetricsNetworkOutBytesPerSecondMaximum",
  UTILIZATION_METRICS_NEW_CONNECTIONS_SUM: "UtilizationMetricsNewConnectionsSum",
  ...
  UTILIZATION_METRICS_SET_TYPE_CMDS_SUM: "UtilizationMetricsSetTypeCmdsSum",
  UTILIZATION_METRICS_USER_CONNECTED_SUM: "UtilizationMetricsUserConnectedSum",
  UTILIZATION_METRICS_VOLUME_READ_OPS_PER_SECOND_MAXIMUM: "UtilizationMetricsVolumeReadOpsPerSecondMaximum",
  UTILIZATION_METRICS_VOLUME_WRITE_OPS_PER_SECOND_MAXIMUM: "UtilizationMetricsVolumeWriteOpsPerSecondMaximum",
} as const;
/**
