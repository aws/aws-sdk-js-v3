...
export const serializeAws_json1_0GetAutoScalingGroupRecommendationsCommand = async (
  ...
  let body: any;
  body = JSON.stringify(
    serializeAws_json1_0GetAutoScalingGroupRecommendationsRequest(input, context)
  );
...
export const serializeAws_json1_0GetEC2RecommendationProjectedMetricsCommand = async (
  ...
  let body: any;
  body = JSON.stringify(
    serializeAws_json1_0GetEC2RecommendationProjectedMetricsRequest(input, context)
  );
  return buildHttpRpcRequest(context, headers, "/", undefined, body);
};
...
const deserializeAws_json1_0UtilizationMetric = (
  ...
  return {
    ...
    name: output.name !== undefined && output.name !== null ? output.name : undefined,
    statistic:
      output.statistic !== undefined && output.statistic !== null ? output.statistic : undefined,
    value: output.value !== undefined && output.value !== null ? output.value : undefined
  } as any;
};
