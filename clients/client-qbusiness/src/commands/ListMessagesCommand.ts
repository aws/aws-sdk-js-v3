...
> {
  ...
  ): Handler<ListMessagesCommandInput, ListMessagesCommandOutput> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<ListMessagesCommandOutput> {
