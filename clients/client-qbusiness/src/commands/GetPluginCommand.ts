...
import type { GetPluginRequest, GetPluginResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetPluginCommand extends command<GetPluginCommandInput, GetPluginCommandOutput>(
  _ep0,
  _mw0,
  "GetPlugin",
  GetPlugin$
