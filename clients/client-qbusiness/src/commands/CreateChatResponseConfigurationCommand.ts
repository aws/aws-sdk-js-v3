 ...
 * @public
 */
export class CreateChatResponseConfigurationCommand extends command<CreateChatResponseConfigurationCommandInput, CreateChatResponseConfigurationCommandOutput>(
  _ep0,
  _mw0,
