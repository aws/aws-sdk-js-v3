 ...
 * @public
 */
export class UpdateChatResponseConfigurationCommand extends command<UpdateChatResponseConfigurationCommandInput, UpdateChatResponseConfigurationCommandOutput>(
  _ep0,
  _mw0,
