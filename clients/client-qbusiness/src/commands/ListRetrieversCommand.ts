...
> {
  ...
  ): Handler<ListRetrieversCommandInput, ListRetrieversCommandOutput> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<ListRetrieversCommandOutput> {
