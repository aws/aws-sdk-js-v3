...
import { type QBusinessClientResolvedConfig, QBusinessClientConfig } from "../QBusinessClient";
 ...
 * @internal
 */
export const defaultQBusinessHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: QBusinessHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultQBusinessHttpAuthSchemeProvider: QBusinessHttpAuthSchemeProvider = (authParameters) => {
