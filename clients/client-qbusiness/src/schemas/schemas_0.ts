...
export var AccessControl$: StaticStructureSchema = [3, n0, _ACc,
  0,
  [_p, _mR],
  [() => Principals, 0]
];
...
export var ActionExecutionEvent$: StaticStructureSchema = [3, n0, _AEE,
  0,
  [_pI, _pa, _pFNS],
  [0, () => ActionExecutionPayload, 0]
];
export var ActionExecutionPayloadField$: StaticStructureSchema = [3, n0, _AEPF,
  0,
  [_v],
  [15]
];
export var ActionFilterConfiguration$: StaticStructureSchema = [3, n0, _AFC,
  0,
  [_dAF],
  [() => AttributeFilter$]
];
export var ActionReview$: StaticStructureSchema = [3, n0, _AR,
  0,
  [_pI, _pT, _pa, _pFNS],
  [0, 0, () => ActionReviewPayload, 0]
];
export var ActionReviewEvent$: StaticStructureSchema = [3, n0, _ARE,
  0,
...
export var AppliedCreatorModeConfiguration$: StaticStructureSchema = [3, n0, _ACMC,
  0,
  [_cMC],
  [0]
];
export var AppliedOrchestrationConfiguration$: StaticStructureSchema = [3, n0, _AOC,
  0,
  [_co],
  [0]
];
export var AssociatedGroup$: StaticStructureSchema = [3, n0, _AG,
  0,
  [_n, _t],
  [0, 0]
];
export var AssociatedUser$: StaticStructureSchema = [3, n0, _AU,
  0,
  [_i, _t],
  [0, 0]
];
export var AssociatePermissionRequest$: StaticStructureSchema = [3, n0, _APR,
  0,
...
export var AttachmentInputEvent$: StaticStructureSchema = [3, n0, _AIE,
  0,
  [_at],
  [() => AttachmentInput$]
];
...
export var AudioSourceDetails$: StaticStructureSchema = [3, n0, _ASD,
  0,
  [_mI, _mMT, _sTM, _eTM, _aET],
  [0, 0, 1, 1, 0]
];
export var AuthChallengeRequest$: StaticStructureSchema = [3, n0, _ACR,
  0,
  [_aU],
  [0]
];
export var AuthChallengeRequestEvent$: StaticStructureSchema = [3, n0, _ACRE,
  0,
  [_aU],
  [0]
];
export var AuthChallengeResponse$: StaticStructureSchema = [3, n0, _ACRu,
  0,
  [_rM],
  [128 | 0]
];
export var AuthChallengeResponseEvent$: StaticStructureSchema = [3, n0, _ACREu,
  0,
  [_rM],
  [128 | 0]
];
export var AutoSubscriptionConfiguration$: StaticStructureSchema = [3, n0, _ASC,
  0,
  [_aS, _dST],
  [0, 0]
];
export var BasicAuthConfiguration$: StaticStructureSchema = [3, n0, _BAC,
  0,
  [_sA, _rA],
  [0, 0]
];
...
export var BlockedPhrasesConfiguration$: StaticStructureSchema = [3, n0, _BPC,
  0,
  [_bP, _sMO],
  [64 | 0, 0]
];
export var BlockedPhrasesConfigurationUpdate$: StaticStructureSchema = [3, n0, _BPCU,
  0,
  [_bPTCOU, _bPTD, _sMO],
  [64 | 0, 64 | 0, 0]
];
export var BrowserExtensionConfiguration$: StaticStructureSchema = [3, n0, _BEC,
  0,
  [_eBE],
  [64 | 0]
];
export var CancelSubscriptionRequest$: StaticStructureSchema = [3, n0, _CSR,
  0,
  [_aIp, _sIu],
  [[0, 1], [0, 1]]
];
export var CancelSubscriptionResponse$: StaticStructureSchema = [3, n0, _CSRa,
  0,
  [_sAu, _cS, _nS],
  [0, () => SubscriptionDetails$, () => SubscriptionDetails$]
];
export var ChatInput$: StaticStructureSchema = [3, n0, _CI,
  0,
  [_aIp, _uI, _uG, _cI, _pMI, _cT, _iS],
  [[0, 1], [0, { [_hQ]: _uI }], [64 | 0, { [_hQ]: _uG }], [0, { [_hQ]: _cI }], [0, { [_hQ]: _pMI }], [0, { [_hQ]: _cT, [_iTd]: 1 }], [() => ChatInputStream$, 16]]
];
export var ChatOutput$: StaticStructureSchema = [3, n0, _CO,
  0,
  [_oS],
  [[() => ChatOutputStream$, 16]]
];
...
export var ChatSyncOutput$: StaticStructureSchema = [3, n0, _CSO,
  0,
  [_cI, _sM, _sMI, _uMI, _aR, _aCRu, _sAo, _fA],
  [0, 0, 0, 0, () => ActionReview$, () => AuthChallengeRequest$, [() => SourceAttributions, 0], () => AttachmentsOutput]
];
export var CheckDocumentAccessRequest$: StaticStructureSchema = [3, n0, _CDAR,
  0,
  [_aIp, _iI, _uI, _dI, _dSI],
  [[0, 1], [0, 1], [0, 1], [0, 1], [0, { [_hQ]: _dSI }]]
];
export var CheckDocumentAccessResponse$: StaticStructureSchema = [3, n0, _CDARh,
  0,
  [_uG, _uAs, _hA, _dA],
...
export var ContentRetrievalRule$: StaticStructureSchema = [3, n0, _CRR,
  0,
  [_eDS],
  [() => EligibleDataSources]
];
export var Conversation$: StaticStructureSchema = [3, n0, _C,
  0,
  [_cI, _ti, _sT],
  [0, 0, 4]
];
export var ConversationSource$: StaticStructureSchema = [3, n0, _CS,
  0,
  [_cI, _aIt],
  [0, 0]
];
export var CreateAnonymousWebExperienceUrlRequest$: StaticStructureSchema = [3, n0, _CAWEUR,
  0,
  [_aIp, _wEI, _sDIM],
  [[0, 1], [0, 1], 1]
];
export var CreateAnonymousWebExperienceUrlResponse$: StaticStructureSchema = [3, n0, _CAWEURr,
  0,
  [_aUn],
  [0]
];
...
export var CreateChatResponseConfigurationRequest$: StaticStructureSchema = [3, n0, _CCRCR,
  0,
  [_aIp, _dN, _cT, _rC, _ta],
  [[0, 1], 0, [0, 4], () => ResponseConfigurations, () => Tags]
];
export var CreateChatResponseConfigurationResponse$: StaticStructureSchema = [3, n0, _CCRCRr,
  0,
  [_cRCI, _cRCA],
  [0, 0]
];
export var CreateDataAccessorRequest$: StaticStructureSchema = [3, n0, _CDARr,
  0,
  [_aIp, _pr, _aCc, _cT, _dN, _aD, _ta],
  [[0, 1], 0, () => ActionConfigurationList, [0, 4], [() => DataAccessorName, 0], () => DataAccessorAuthenticationDetail$, () => Tags]
];
export var CreateDataAccessorResponse$: StaticStructureSchema = [3, n0, _CDARre,
  0,
  [_dAI, _iAA, _dAA],
  [0, 0, 0]
];
...
export var CreatePluginRequest$: StaticStructureSchema = [3, n0, _CPR,
  0,
  [_aIp, _dN, _t, _aCu, _sU, _cPC, _ta, _cT],
  [[0, 1], 0, 0, () => PluginAuthConfiguration$, 0, [() => CustomPluginConfiguration$, 0], () => Tags, [0, 4]]
];
export var CreatePluginResponse$: StaticStructureSchema = [3, n0, _CPRr,
  0,
  [_pI, _pA, _bS],
  [0, 0, 0]
];
export var CreateRetrieverRequest$: StaticStructureSchema = [3, n0, _CRRr,
  0,
  [_aIp, _t, _dN, _conf, _rA, _cT, _ta],
  [[0, 1], 0, 0, () => RetrieverConfiguration$, 0, [0, 4], () => Tags]
];
export var CreateRetrieverResponse$: StaticStructureSchema = [3, n0, _CRRre,
  0,
  [_rIe, _rAe],
  [0, 0]
];
export var CreateSubscriptionRequest$: StaticStructureSchema = [3, n0, _CSRr,
  0,
  [_aIp, _pr, _t, _cT],
  [[0, 1], () => SubscriptionPrincipal$, 0, [0, 4]]
];
export var CreateSubscriptionResponse$: StaticStructureSchema = [3, n0, _CSRre,
  0,
  [_sIu, _sAu, _cS, _nS],
...
export var CreateWebExperienceRequest$: StaticStructureSchema = [3, n0, _CWER,
  0,
...
export var CreateWebExperienceResponse$: StaticStructureSchema = [3, n0, _CWERr,
  0,
  [_wEI, _wEA],
  [0, 0]
];
export var CreatorModeConfiguration$: StaticStructureSchema = [3, n0, _CMC,
  0,
  [_cMC],
  [0]
];
export var CustomizationConfiguration$: StaticStructureSchema = [3, n0, _CC,
  0,
  [_cCSSU, _lU, _fU, _fUa],
  [0, 0, 0, 0]
];
export var CustomPluginConfiguration$: StaticStructureSchema = [3, n0, _CPC,
  0,
  [_d, _aST, _aSp],
  [0, 0, [() => APISchema$, 0]]
];
export var DataAccessor$: StaticStructureSchema = [3, n0, _DA,
  0,
  [_dN, _dAI, _dAA, _iAA, _pr, _aD, _cA, _uA],
  [[() => DataAccessorName, 0], 0, 0, 0, 0, () => DataAccessorAuthenticationDetail$, 4, 4]
];
export var DataAccessorAuthenticationDetail$: StaticStructureSchema = [3, n0, _DAAD,
  0,
  [_aT, _aCut, _eI],
  [0, () => DataAccessorAuthenticationConfiguration$, 64 | 0]
];
export var DataAccessorIdcTrustedTokenIssuerConfiguration$: StaticStructureSchema = [3, n0, _DAITTIC,
  0,
  [_iTTIA],
  [0]
];
...
export var DateAttributeBoostingConfiguration$: StaticStructureSchema = [3, n0, _DABC,
  0,
  [_bL, _bDIS],
  [0, 1]
];
...
export var DeleteChatControlsConfigurationRequest$: StaticStructureSchema = [3, n0, _DCCCR,
  0,
  [_aIp],
  [[0, 1]]
];
export var DeleteChatControlsConfigurationResponse$: StaticStructureSchema = [3, n0, _DCCCRe,
  0,
  [],
  []
];
export var DeleteChatResponseConfigurationRequest$: StaticStructureSchema = [3, n0, _DCRCR,
  0,
  [_aIp, _cRCI],
  [[0, 1], [0, 1]]
];
export var DeleteChatResponseConfigurationResponse$: StaticStructureSchema = [3, n0, _DCRCRe,
  0,
  [],
  []
];
export var DeleteConversationRequest$: StaticStructureSchema = [3, n0, _DCR,
  0,
  [_cI, _aIp, _uI],
  [[0, 1], [0, 1], [0, { [_hQ]: _uI }]]
];
export var DeleteConversationResponse$: StaticStructureSchema = [3, n0, _DCRe,
  0,
  [],
  []
];
export var DeleteDataAccessorRequest$: StaticStructureSchema = [3, n0, _DDAR,
  0,
  [_aIp, _dAI],
  [[0, 1], [0, 1]]
];
export var DeleteDataAccessorResponse$: StaticStructureSchema = [3, n0, _DDARe,
  0,
  [],
  []
];
...
export var DeleteDocument$: StaticStructureSchema = [3, n0, _DD,
  0,
  [_dI],
  [0]
];
...
export var DeletePluginRequest$: StaticStructureSchema = [3, n0, _DPR,
  0,
  [_aIp, _pI],
  [[0, 1], [0, 1]]
];
export var DeletePluginResponse$: StaticStructureSchema = [3, n0, _DPRe,
  0,
  [],
  []
];
export var DeleteRetrieverRequest$: StaticStructureSchema = [3, n0, _DRR,
  0,
  [_aIp, _rIe],
  [[0, 1], [0, 1]]
];
export var DeleteRetrieverResponse$: StaticStructureSchema = [3, n0, _DRRe,
  0,
  [],
  []
];
...
export var DeleteWebExperienceRequest$: StaticStructureSchema = [3, n0, _DWER,
  0,
  [_aIp, _wEI],
  [[0, 1], [0, 1]]
];
export var DeleteWebExperienceResponse$: StaticStructureSchema = [3, n0, _DWERe,
  0,
  [],
  []
];
export var DisassociatePermissionRequest$: StaticStructureSchema = [3, n0, _DPRi,
  0,
  [_aIp, _sI],
  [[0, 1], [0, 1]]
];
export var DisassociatePermissionResponse$: StaticStructureSchema = [3, n0, _DPRis,
  0,
  [],
  []
];
...
export var DocumentAcl$: StaticStructureSchema = [3, n0, _DAo,
  0,
  [_al, _dL],
  [() => DocumentAclMembership$, () => DocumentAclMembership$]
];
export var DocumentAclCondition$: StaticStructureSchema = [3, n0, _DAC,
  0,
  [_mR, _u, _g],
  [0, () => DocumentAclUsers, () => DocumentAclGroups]
];
export var DocumentAclGroup$: StaticStructureSchema = [3, n0, _DAG,
  0,
  [_n, _t],
  [0, 0]
];
...
export var DocumentAttribute$: StaticStructureSchema = [3, n0, _DAoc,
  0,
  [_n, _v],
  [0, () => DocumentAttributeValue$]
];
export var DocumentAttributeCondition$: StaticStructureSchema = [3, n0, _DACo,
  0,
  [_k, _op, _v],
...
export var EligibleDataSource$: StaticStructureSchema = [3, n0, _EDS,
  0,
  [_iI, _dSI],
  [0, 0]
];
...
export var EndOfInputEvent$: StaticStructureSchema = [3, n0, _EOIE,
  0,
  [],
  []
];
...
export var FailedDocument$: StaticStructureSchema = [3, n0, _FD,
  0,
  [_i, _e, _dSI],
  [0, () => ErrorDetail$, 0]
];
...
export var GetChatControlsConfigurationResponse$: StaticStructureSchema = [3, n0, _GCCCRe,
  0,
...
export var GetChatResponseConfigurationRequest$: StaticStructureSchema = [3, n0, _GCRCR,
  0,
  [_aIp, _cRCI],
  [[0, 1], [0, 1]]
];
export var GetChatResponseConfigurationResponse$: StaticStructureSchema = [3, n0, _GCRCRe,
  0,
  [_cRCI, _cRCA, _dN, _cA, _iUC, _lUC],
  [0, 0, 0, 4, () => ChatResponseConfigurationDetail$, () => ChatResponseConfigurationDetail$]
];
export var GetDataAccessorRequest$: StaticStructureSchema = [3, n0, _GDAR,
  0,
  [_aIp, _dAI],
  [[0, 1], [0, 1]]
];
export var GetDataAccessorResponse$: StaticStructureSchema = [3, n0, _GDARe,
  0,
...
export var GetDocumentContentResponse$: StaticStructureSchema = [3, n0, _GDCRe,
  0,
  [_pU, _mT],
  [0, 0]
];
...
export var GetMediaResponse$: StaticStructureSchema = [3, n0, _GMRe,
  0,
  [_mB, _mMT],
  [21, 0]
];
export var GetPluginRequest$: StaticStructureSchema = [3, n0, _GPR,
  0,
  [_aIp, _pI],
  [[0, 1], [0, 1]]
];
...
export var GetPolicyResponse$: StaticStructureSchema = [3, n0, _GPReto,
  0,
  [_po],
  [0]
];
export var GetRetrieverRequest$: StaticStructureSchema = [3, n0, _GRR,
  0,
  [_aIp, _rIe],
  [[0, 1], [0, 1]]
];
...
export var GetWebExperienceRequest$: StaticStructureSchema = [3, n0, _GWER,
  0,
  [_aIp, _wEI],
  [[0, 1], [0, 1]]
];
...
export var HallucinationReductionConfiguration$: StaticStructureSchema = [3, n0, _HRC,
  0,
  [_hRCa],
  [0]
];
...
export var IdcAuthConfiguration$: StaticStructureSchema = [3, n0, _IAC,
  0,
  [_iAA, _rA],
  [0, 0]
];
...
export var ImageSourceDetails$: StaticStructureSchema = [3, n0, _ISD,
  0,
  [_mI, _mMT],
  [0, 0]
];
...
export var IndexStatistics$: StaticStructureSchema = [3, n0, _IS,
  0,
  [_tDS],
  [() => TextDocumentStatistics$]
];
export var InlineDocumentEnrichmentConfiguration$: StaticStructureSchema = [3, n0, _IDEC,
  0,
  [_cond, _tar, _dCO],
  [() => DocumentAttributeCondition$, () => DocumentAttributeTarget$, 0]
];
export var InstructionCollection$: StaticStructureSchema = [3, n0, _IC,
  0,
...
export var ListAttachmentsRequest$: StaticStructureSchema = [3, n0, _LARis,
  0,
  [_aIp, _cI, _uI, _nT, _mRa],
  [[0, 1], [0, { [_hQ]: _cI }], [0, { [_hQ]: _uI }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListAttachmentsResponse$: StaticStructureSchema = [3, n0, _LARist,
  0,
  [_att, _nT],
  [() => AttachmentList, 0]
];
export var ListChatResponseConfigurationsRequest$: StaticStructureSchema = [3, n0, _LCRCR,
  0,
  [_aIp, _mRa, _nT],
  [[0, 1], [1, { [_hQ]: _mRa }], [0, { [_hQ]: _nT }]]
];
export var ListChatResponseConfigurationsResponse$: StaticStructureSchema = [3, n0, _LCRCRi,
  0,
  [_cRC, _nT],
  [() => ChatResponseConfigurations, 0]
];
export var ListConversationsRequest$: StaticStructureSchema = [3, n0, _LCR,
  0,
  [_aIp, _uI, _nT, _mRa],
  [[0, 1], [0, { [_hQ]: _uI }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListConversationsResponse$: StaticStructureSchema = [3, n0, _LCRi,
  0,
  [_nT, _conv],
  [0, () => Conversations]
];
export var ListDataAccessorsRequest$: StaticStructureSchema = [3, n0, _LDAR,
  0,
  [_aIp, _nT, _mRa],
  [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListDataAccessorsResponse$: StaticStructureSchema = [3, n0, _LDARi,
  0,
  [_dAa, _nT],
  [[() => DataAccessors, 0], 0]
];
...
export var ListDocumentsRequest$: StaticStructureSchema = [3, n0, _LDR,
  0,
  [_aIp, _iI, _dSIa, _nT, _mRa],
  [[0, 1], [0, 1], [64 | 0, { [_hQ]: _dSIa }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListDocumentsResponse$: StaticStructureSchema = [3, n0, _LDRi,
  0,
  [_dDL, _nT],
...
export var ListIndicesRequest$: StaticStructureSchema = [3, n0, _LIR,
  0,
  [_aIp, _nT, _mRa],
  [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListIndicesResponse$: StaticStructureSchema = [3, n0, _LIRi,
  0,
  [_nT, _in],
  [0, () => Indices]
];
export var ListMessagesRequest$: StaticStructureSchema = [3, n0, _LMR,
  0,
  [_cI, _aIp, _uI, _nT, _mRa],
  [[0, 1], [0, 1], [0, { [_hQ]: _uI }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListMessagesResponse$: StaticStructureSchema = [3, n0, _LMRi,
  0,
  [_mes, _nT],
  [[() => Messages, 0], 0]
];
export var ListPluginActionsRequest$: StaticStructureSchema = [3, n0, _LPAR,
  0,
  [_aIp, _pI, _nT, _mRa],
  [[0, 1], [0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListPluginActionsResponse$: StaticStructureSchema = [3, n0, _LPARi,
  0,
  [_nT, _it],
  [0, () => Actions]
];
...
export var ListPluginsResponse$: StaticStructureSchema = [3, n0, _LPRi,
  0,
  [_nT, _pl],
  [0, () => Plugins]
];
export var ListPluginTypeActionsRequest$: StaticStructureSchema = [3, n0, _LPTAR,
  0,
  [_pT, _nT, _mRa],
  [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListPluginTypeActionsResponse$: StaticStructureSchema = [3, n0, _LPTARi,
  0,
  [_nT, _it],
  [0, () => Actions]
];
export var ListPluginTypeMetadataRequest$: StaticStructureSchema = [3, n0, _LPTMR,
  0,
  [_nT, _mRa],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListPluginTypeMetadataResponse$: StaticStructureSchema = [3, n0, _LPTMRi,
  0,
  [_nT, _it],
  [0, () => ListPluginTypeMetadataSummaries]
];
export var ListRetrieversRequest$: StaticStructureSchema = [3, n0, _LRR,
  0,
  [_aIp, _nT, _mRa],
  [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
...
export var ListWebExperiencesRequest$: StaticStructureSchema = [3, n0, _LWER,
  0,
  [_aIp, _nT, _mRa],
  [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListWebExperiencesResponse$: StaticStructureSchema = [3, n0, _LWERi,
  0,
  [_wE, _nT],
  [() => WebExperiences, 0]
];
...
export var MemberUser$: StaticStructureSchema = [3, n0, _MU,
  0,
  [_uI, _t],
  [0, 0]
];
...
export var NativeIndexConfiguration$: StaticStructureSchema = [3, n0, _NIC,
  0,
  [_iI, _ve, _bO],
  [0, 1, () => DocumentAttributeBoostingOverrideMap]
];
export var NoAuthConfiguration$: StaticStructureSchema = [3, n0, _NAC,
  0,
  [],
  []
];
export var NumberAttributeBoostingConfiguration$: StaticStructureSchema = [3, n0, _NABC,
  0,
  [_bL, _bT],
  [0, 0]
];
export var OAuth2ClientCredentialConfiguration$: StaticStructureSchema = [3, n0, _OACCC,
  0,
  [_sA, _rA, _aU, _tU],
  [0, 0, 0, 0]
];
export var OpenIDConnectProviderConfiguration$: StaticStructureSchema = [3, n0, _OIDCPC,
  0,
  [_sAe, _sR],
  [0, 0]
];
...
export var PermissionCondition$: StaticStructureSchema = [3, n0, _PC,
  0,
  [_cO, _cK, _cV],
  [0, 0, 64 | 0]
];
export var PersonalizationConfiguration$: StaticStructureSchema = [3, n0, _PCe,
  0,
  [_pCM],
  [0]
];
...
export var PluginTypeMetadataSummary$: StaticStructureSchema = [3, n0, _PTMS,
  0,
  [_t, _ca, _d],
  [0, 0, 0]
];
export var PrincipalGroup$: StaticStructureSchema = [3, n0, _PG,
  0,
  [_n, _acc, _mTe],
  [0, 0, 0]
];
export var PrincipalUser$: StaticStructureSchema = [3, n0, _PU,
  0,
  [_i, _acc, _mTe],
  [0, 0, 0]
];
export var PutFeedbackRequest$: StaticStructureSchema = [3, n0, _PFR,
  0,
  [_aIp, _uI, _cI, _mIe, _mCA, _mUe],
  [[0, 1], [0, { [_hQ]: _uI }], [0, 1], [0, 1], 4, () => MessageUsefulnessFeedback$]
];
export var PutGroupRequest$: StaticStructureSchema = [3, n0, _PGR,
  0,
  [_aIp, _iI, _gN, _dSI, _t, _gM, _rA],
  [[0, 1], [0, 1], 0, 0, 0, () => GroupMembers$, 0]
];
export var PutGroupResponse$: StaticStructureSchema = [3, n0, _PGRu,
  0,
  [],
  []
];
export var QAppsConfiguration$: StaticStructureSchema = [3, n0, _QAC,
  0,
  [_qACM],
  [0]
];
export var QuickSightConfiguration$: StaticStructureSchema = [3, n0, _QSC,
  0,
  [_cN],
  [0]
];
export var RelevantContent$: StaticStructureSchema = [3, n0, _RC,
  0,
...
export var S3$: StaticStructureSchema = [3, n0, _S,
  0,
  [_bu, _k],
  [0, 0]
];
export var SamlConfiguration$: StaticStructureSchema = [3, n0, _SC,
  0,
  [_mXML, _rA, _uIA, _uGA],
  [0, 0, 0, 0]
];
export var SamlProviderConfiguration$: StaticStructureSchema = [3, n0, _SPC,
  0,
  [_aUu],
  [0]
];
export var ScoreAttributes$: StaticStructureSchema = [3, n0, _SA,
  0,
  [_sC],
  [0]
];
export var SearchRelevantContentRequest$: StaticStructureSchema = [3, n0, _SRCR,
  0,
  [_aIp, _qT, _cSo, _aFt, _mRa, _nT],
  [[0, 1], 0, () => ContentSource$, () => AttributeFilter$, 1, 0]
];
export var SearchRelevantContentResponse$: StaticStructureSchema = [3, n0, _SRCRe,
  0,
  [_rCe, _nT],
...
export var SourceAttribution$: StaticStructureSchema = [3, n0, _SAo,
  0,
...
export var StopDataSourceSyncJobResponse$: StaticStructureSchema = [3, n0, _SDSSJRtop,
  0,
  [],
  []
];
export var StringAttributeBoostingConfiguration$: StaticStructureSchema = [3, n0, _SABC,
  0,
  [_bL, _aVB],
  [0, 128 | 0]
];
export var StringListAttributeBoostingConfiguration$: StaticStructureSchema = [3, n0, _SLABC,
  0,
  [_bL],
  [0]
];
...
export var SubscriptionDetails$: StaticStructureSchema = [3, n0, _SD,
  0,
  [_t],
  [0]
];
...
export var TextInputEvent$: StaticStructureSchema = [3, n0, _TIE,
  0,
  [_uM],
  [0]
];
export var TextOutputEvent$: StaticStructureSchema = [3, n0, _TOE,
  0,
  [_sMT, _cI, _uMI, _sMI, _sM],
  [0, 0, 0, 0, 0]
];
export var TextSegment$: StaticStructureSchema = [3, n0, _TS,
  0,
...
export var UpdateChatControlsConfigurationRequest$: StaticStructureSchema = [3, n0, _UCCCR,
  0,
...
export var UpdateChatControlsConfigurationResponse$: StaticStructureSchema = [3, n0, _UCCCRp,
  0,
  [],
  []
];
export var UpdateChatResponseConfigurationRequest$: StaticStructureSchema = [3, n0, _UCRCR,
  0,
  [_aIp, _cRCI, _dN, _rC, _cT],
  [[0, 1], [0, 1], 0, () => ResponseConfigurations, [0, 4]]
];
export var UpdateChatResponseConfigurationResponse$: StaticStructureSchema = [3, n0, _UCRCRp,
  0,
  [],
  []
];
export var UpdateDataAccessorRequest$: StaticStructureSchema = [3, n0, _UDAR,
  0,
  [_aIp, _dAI, _aCc, _aD, _dN],
  [[0, 1], [0, 1], () => ActionConfigurationList, () => DataAccessorAuthenticationDetail$, [() => DataAccessorName, 0]]
];
export var UpdateDataAccessorResponse$: StaticStructureSchema = [3, n0, _UDARp,
  0,
  [],
  []
];
...
export var UpdateRetrieverRequest$: StaticStructureSchema = [3, n0, _URRp,
  0,
  [_aIp, _rIe, _conf, _dN, _rA],
  [[0, 1], [0, 1], () => RetrieverConfiguration$, 0, 0]
];
export var UpdateRetrieverResponse$: StaticStructureSchema = [3, n0, _URRpd,
  0,
  [],
  []
];
export var UpdateSubscriptionRequest$: StaticStructureSchema = [3, n0, _USR,
  0,
  [_aIp, _sIu, _t],
  [[0, 1], [0, 1], 0]
];
export var UpdateSubscriptionResponse$: StaticStructureSchema = [3, n0, _USRp,
  0,
  [_sAu, _cS, _nS],
  [0, () => SubscriptionDetails$, () => SubscriptionDetails$]
];
...
export var UpdateWebExperienceRequest$: StaticStructureSchema = [3, n0, _UWER,
  0,
...
export var UpdateWebExperienceResponse$: StaticStructureSchema = [3, n0, _UWERp,
  0,
  [],
  []
];
export var UserAlias$: StaticStructureSchema = [3, n0, _UA,
  0,
  [_iI, _dSI, _uI],
  [0, 0, 0]
];
export var UsersAndGroups$: StaticStructureSchema = [3, n0, _UAG,
  0,
  [_uIs, _uG],
  [64 | 0, 64 | 0]
];
...
export var VideoSourceDetails$: StaticStructureSchema = [3, n0, _VSD,
  0,
...
var ActionConfigurationList: StaticListSchema = [1, n0, _ACL,
  0, () => ActionConfiguration$
];
var ActionReviewPayloadFieldAllowedValues: StaticListSchema = [1, n0, _ARPFAVc,
...
var AssociatedGroups: StaticListSchema = [1, n0, _AGs,
  0, () => AssociatedGroup$
];
var AssociatedUsers: StaticListSchema = [1, n0, _AUs,
  0, () => AssociatedUser$
];
var AttachmentList: StaticListSchema = [1, n0, _AL,
  0, () => Attachment$
];
var AttachmentsInput: StaticListSchema = [1, n0, _AIt,
  0, () => AttachmentInput$
];
var AttachmentsOutput: StaticListSchema = [1, n0, _AOt,
  0, () => AttachmentOutput$
];
...
var ChatResponseConfigurations: StaticListSchema = [1, n0, _CRCh,
  0, () => ChatResponseConfiguration$
];
var ClientIdsForOIDC = 64 | 0;
var Conversations: StaticListSchema = [1, n0, _Co,
  0, () => Conversation$
];
var DataAccessorExternalIds = 64 | 0;
var DataAccessors: StaticListSchema = [1, n0, _DAa,
  0, [() => DataAccessor$,
    0]
];
var DataSourceIds = 64 | 0;
var DataSources: StaticListSchema = [1, n0, _DSa,
  0, () => DataSource$
];
var DataSourceSyncJobs: StaticListSchema = [1, n0, _DSSJa,
  0, () => DataSourceSyncJob$
];
var DeleteDocuments: StaticListSchema = [1, n0, _DDe,
  0, () => DeleteDocument$
];
var DocumentAclConditions: StaticListSchema = [1, n0, _DACocu,
  0, () => DocumentAclCondition$
];
var DocumentAclGroups: StaticListSchema = [1, n0, _DAGo,
  0, () => DocumentAclGroup$
];
var DocumentAclUsers: StaticListSchema = [1, n0, _DAUo,
  0, () => DocumentAclUser$
];
var DocumentAttributeConfigurations: StaticListSchema = [1, n0, _DACocum,
  0, () => DocumentAttributeConfiguration$
];
var DocumentAttributes: StaticListSchema = [1, n0, _DAocu,
  0, () => DocumentAttribute$
];
var DocumentAttributeStringListValue = 64 | 0;
var DocumentDetailList: StaticListSchema = [1, n0, _DDL,
  0, () => DocumentDetails$
];
var Documents: StaticListSchema = [1, n0, _Do,
  0, () => Document$
];
var EligibleDataSources: StaticListSchema = [1, n0, _EDSl,
  0, () => EligibleDataSource$
];
var ExampleChatMessages = 64 | 0;
var FailedDocuments: StaticListSchema = [1, n0, _FDa,
  0, () => FailedDocument$
];
var GroupStatusDetails: StaticListSchema = [1, n0, _GSDr,
  0, () => GroupStatusDetail$
];
var GroupSummaryList: StaticListSchema = [1, n0, _GSL,
  0, () => GroupSummary$
];
var Indices: StaticListSchema = [1, n0, _In,
  0, () => Index$
];
var InlineDocumentEnrichmentConfigurations: StaticListSchema = [1, n0, _IDECn,
  0, () => InlineDocumentEnrichmentConfiguration$
];
var ListPluginTypeMetadataSummaries: StaticListSchema = [1, n0, _LPTMS,
  0, () => PluginTypeMetadataSummary$
];
var MemberGroups: StaticListSchema = [1, n0, _MGe,
  0, () => MemberGroup$
];
var MemberUsers: StaticListSchema = [1, n0, _MUe,
  0, () => MemberUser$
];
...
var PermissionConditions: StaticListSchema = [1, n0, _PCer,
  0, () => PermissionCondition$
];
var PermissionConditionValues = 64 | 0;
var Plugins: StaticListSchema = [1, n0, _Plu,
  0, () => Plugin$
];
...
var RelevantContentList: StaticListSchema = [1, n0, _RCL,
  0, () => RelevantContent$
];
var Retrievers: StaticListSchema = [1, n0, _Re,
  0, () => Retriever$
];
var Rules: StaticListSchema = [1, n0, _Rul,
  0, () => Rule$
];
var SecurityGroupIds = 64 | 0;
var SourceAttributions: StaticListSchema = [1, n0, _SAou,
  { [_sp]: 1 }, () => SourceAttribution$
];
var SubnetIds = 64 | 0;
var Subscriptions: StaticListSchema = [1, n0, _Sub,
  0, () => Subscription$
];
var TagKeys = 64 | 0;
...
var TextSegmentList: StaticListSchema = [1, n0, _TSL,
  0, () => TextSegment$
];
var TopicConfigurations: StaticListSchema = [1, n0, _TCo,
  0, () => TopicConfiguration$
];
var UserAliases: StaticListSchema = [1, n0, _UAs,
  0, () => UserAlias$
];
var UserGroups = 64 | 0;
var UserIds = 64 | 0;
...
var WebExperiences: StaticListSchema = [1, n0, _WEe,
  0, () => WebExperience$
];
var ActionExecutionPayload: StaticMapSchema = [2, n0, _AEP,
  0, 0, () => ActionExecutionPayloadField$
];
var ActionReviewPayload: StaticMapSchema = [2, n0, _ARP,
  0, 0, () => ActionReviewPayloadField$
];
var AuthorizationResponseMap = 128 | 0;
var DocumentAttributeBoostingOverrideMap: StaticMapSchema = [2, n0, _DABOM,
  0, 0, () => DocumentAttributeBoostingConfiguration$
];
var ResponseConfigurations: StaticMapSchema = [2, n0, _RCes,
...
export var ChatInputStream$: StaticUnionSchema = [4, n0, _CIS,
  { [_str]: 1 },
...
export var ChatModeConfiguration$: StaticUnionSchema = [4, n0, _CMCh,
  0,
  [_pCl],
  [() => PluginConfiguration$]
];
export var ChatOutputStream$: StaticUnionSchema = [4, n0, _COS,
  { [_str]: 1 },
...
export var DataAccessorAuthenticationConfiguration$: StaticUnionSchema = [4, n0, _DAAC,
  0,
  [_iTTIC],
  [() => DataAccessorIdcTrustedTokenIssuerConfiguration$]
];
export var DocumentAttributeBoostingConfiguration$: StaticUnionSchema = [4, n0, _DABCo,
  0,
  [_nC, _sCt, _dC, _sLC],
...
export var DocumentAttributeValue$: StaticUnionSchema = [4, n0, _DAV,
  0,
  [_sV, _sLV, _lV, _dVa],
  [0, 64 | 0, 1, 4]
];
export var DocumentContent$: StaticUnionSchema = [4, n0, _DC,
  0,
  [_bl, _s_],
  [21, () => S3$]
];
export var IdentityProviderConfiguration$: StaticUnionSchema = [4, n0, _IPC,
  0,
  [_sCa, _oIDCC],
  [() => SamlProviderConfiguration$, () => OpenIDConnectProviderConfiguration$]
];
export var PluginAuthConfiguration$: StaticUnionSchema = [4, n0, _PAC,
  0,
  [_bAC, _oACCC, _nAC, _iAC],
  [() => BasicAuthConfiguration$, () => OAuth2ClientCredentialConfiguration$, () => NoAuthConfiguration$, () => IdcAuthConfiguration$]
];
export var Principal$: StaticUnionSchema = [4, n0, _Pri,
  0,
  [_use, _gr],
  [() => PrincipalUser$, () => PrincipalGroup$]
];
export var RetrieverConfiguration$: StaticUnionSchema = [4, n0, _RCet,
  0,
  [_nIC, _kIC],
  [() => NativeIndexConfiguration$, () => KendraIndexConfiguration$]
];
export var RuleConfiguration$: StaticUnionSchema = [4, n0, _RCu,
  0,
  [_cBR, _cRR],
  [() => ContentBlockerRule$, () => ContentRetrievalRule$]
];
export var SourceDetails$: StaticUnionSchema = [4, n0, _SDo,
  0,
  [_iSD, _aSD, _vSD],
  [() => ImageSourceDetails$, () => AudioSourceDetails$, () => VideoSourceDetails$]
];
export var SubscriptionPrincipal$: StaticUnionSchema = [4, n0, _SP,
  0,
  [_use, _gr],
  [0, 0]
];
export var WebExperienceAuthConfiguration$: StaticUnionSchema = [4, n0, _WEAC,
  0,
  [_sCa],
  [() => SamlConfiguration$]
];
export var AssociatePermission$: StaticOperationSchema = [9, n0, _AP,
  { [_ht]: ["POST", "/applications/{applicationId}/policy", 200] }, () => AssociatePermissionRequest$, () => AssociatePermissionResponse$
];
export var BatchDeleteDocument$: StaticOperationSchema = [9, n0, _BDD,
...
export var BatchPutDocument$: StaticOperationSchema = [9, n0, _BPD,
  { [_ht]: ["POST", "/applications/{applicationId}/indices/{indexId}/documents", 200] }, () => BatchPutDocumentRequest$, () => BatchPutDocumentResponse$
];
export var CancelSubscription$: StaticOperationSchema = [9, n0, _CSa,
...
export var CreateAnonymousWebExperienceUrl$: StaticOperationSchema = [9, n0, _CAWEU,
...
export var CreateChatResponseConfiguration$: StaticOperationSchema = [9, n0, _CCRC,
...
export var CreateWebExperience$: StaticOperationSchema = [9, n0, _CWE,
...
export var DeleteAttachment$: StaticOperationSchema = [9, n0, _DAel,
...
export var DeleteChatControlsConfiguration$: StaticOperationSchema = [9, n0, _DCCC,
...
export var DeleteChatResponseConfiguration$: StaticOperationSchema = [9, n0, _DCRC,
...
export var DeleteConversation$: StaticOperationSchema = [9, n0, _DCe,
...
export var DeleteDataAccessor$: StaticOperationSchema = [9, n0, _DDA,
...
export var DeleteDataSource$: StaticOperationSchema = [9, n0, _DDS,
...
export var DeletePlugin$: StaticOperationSchema = [9, n0, _DP,
  { [_ht]: ["DELETE", "/applications/{applicationId}/plugins/{pluginId}", 200] }, () => DeletePluginRequest$, () => DeletePluginResponse$
];
export var DeleteRetriever$: StaticOperationSchema = [9, n0, _DR,
...
export var DeleteWebExperience$: StaticOperationSchema = [9, n0, _DWE,
...
export var DisassociatePermission$: StaticOperationSchema = [9, n0, _DPi,
...
export var GetChatControlsConfiguration$: StaticOperationSchema = [9, n0, _GCCC,
...
export var GetChatResponseConfiguration$: StaticOperationSchema = [9, n0, _GCRC,
...
export var GetDataAccessor$: StaticOperationSchema = [9, n0, _GDA,
  { [_ht]: ["GET", "/applications/{applicationId}/dataaccessors/{dataAccessorId}", 200] }, () => GetDataAccessorRequest$, () => GetDataAccessorResponse$
];
export var GetDataSource$: StaticOperationSchema = [9, n0, _GDS,
...
export var GetDocumentContent$: StaticOperationSchema = [9, n0, _GDC,
...
export var GetMedia$: StaticOperationSchema = [9, n0, _GMe,
...
export var ListAttachments$: StaticOperationSchema = [9, n0, _LAi,
  { [_ht]: ["GET", "/applications/{applicationId}/attachments", 200] }, () => ListAttachmentsRequest$, () => ListAttachmentsResponse$
];
export var ListChatResponseConfigurations$: StaticOperationSchema = [9, n0, _LCRC,
...
export var ListConversations$: StaticOperationSchema = [9, n0, _LC,
  { [_ht]: ["GET", "/applications/{applicationId}/conversations", 200] }, () => ListConversationsRequest$, () => ListConversationsResponse$
];
export var ListDataAccessors$: StaticOperationSchema = [9, n0, _LDA,
...
export var ListDataSourceSyncJobs$: StaticOperationSchema = [9, n0, _LDSSJ,
...
export var ListDocuments$: StaticOperationSchema = [9, n0, _LD,
...
export var ListWebExperiences$: StaticOperationSchema = [9, n0, _LWE,
  { [_ht]: ["GET", "/applications/{applicationId}/experiences", 200] }, () => ListWebExperiencesRequest$, () => ListWebExperiencesResponse$
];
export var PutFeedback$: StaticOperationSchema = [9, n0, _PF,
...
export var StopDataSourceSyncJob$: StaticOperationSchema = [9, n0, _SDSSJt,
...
export var UpdateChatControlsConfiguration$: StaticOperationSchema = [9, n0, _UCCC,
...
export var UpdateChatResponseConfiguration$: StaticOperationSchema = [9, n0, _UCRC,
...
export var UpdateDataAccessor$: StaticOperationSchema = [9, n0, _UDA,
  { [_ht]: ["PUT", "/applications/{applicationId}/dataaccessors/{dataAccessorId}", 200] }, () => UpdateDataAccessorRequest$, () => UpdateDataAccessorResponse$
];
export var UpdateDataSource$: StaticOperationSchema = [9, n0, _UDS,
...
export var UpdatePlugin$: StaticOperationSchema = [9, n0, _UP,
  { [_ht]: ["PUT", "/applications/{applicationId}/plugins/{pluginId}", 200] }, () => UpdatePluginRequest$, () => UpdatePluginResponse$
];
export var UpdateRetriever$: StaticOperationSchema = [9, n0, _URp,
...
export var UpdateWebExperience$: StaticOperationSchema = [9, n0, _UWE,
