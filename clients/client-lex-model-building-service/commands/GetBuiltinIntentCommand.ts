...
export class GetBuiltinIntentCommand extends $Command<GetBuiltinIntentCommandInput, GetBuiltinIntentCommandOutput, LexModelBuildingServiceClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetBuiltinIntentCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetBuiltinIntentCommand(output, context);
  }
