...
export type GetIntentsCommandOutput = GetIntentsResponse;

export class GetIntentsCommand extends $Command<GetIntentsCommandInput, GetIntentsCommandOutput, LexModelBuildingServiceClientResolvedConfig> {
