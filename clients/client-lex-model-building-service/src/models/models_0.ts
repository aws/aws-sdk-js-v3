...
export interface CreateBotVersionResponse {
   ...
   *       indicates that the bot is using the improvements, otherwise, <code>false</code>.</p>
   */
...
/**
 * <p>Provides configuration information for the AMAZON.KendraSearchIntent intent. When you use
 *       this intent, Amazon Lex searches the specified Amazon Kendra index and returns documents from the
 *       index that match the user's utterance. For more information, see <a href="http://docs.aws.amazon.com/lex/latest/dg/built-in-intent-kendra-search.html">
...
export interface KendraConfiguration {
   ...
   *       call the <code>PutIntent</code> operation.</p>
   */
  kendraIndex: string | undefined;

  /**
   * <p>The Amazon Resource Name (ARN) of an IAM role that has permission to search the Amazon
   *       Kendra index. The role must be in the same account and Region as the Amazon Lex bot. If the role
   *       does not exist, you get an exception when you call the <code>PutIntent</code>
   *       operation.</p>
   */
...
export interface Slot {
  ...
  /**
   * <p> Directs Amazon Lex the order in which to elicit this slot value from the user. For example,
   *       if the intent has two slots with priorities 1 and 2, AWS Amazon Lex first elicits a value for the
   *       slot with priority 1.</p>
   *          <p>If multiple slots share the same priority, the order in which Amazon Lex elicits values is
   *       arbitrary.</p>
   */
  priority?: number;
...
export interface CreateIntentVersionResponse {
  ...
  /**
   * <p>Configuration information, if any, for connecting an Amazon Kendra index with the
...
export interface SlotTypeRegexConfiguration {
   ...
   *             </li>
   *          </ul>
   *          <p>Represent Unicode characters with four digits, for example "\u0041" or
   *       "\u005A".</p>
...
export interface GetBotResponse {
  ...
  /**
   * <p>The score that determines where Amazon Lex inserts the <code>AMAZON.FallbackIntent</code>,
   *         <code>AMAZON.KendraSearchIntent</code>, or both when returning alternative intents in a
   *         <a href="https://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostContent.html">PostContent</a> or <a href="https://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostText.html">PostText</a> response.
   *         <code>AMAZON.FallbackIntent</code> is inserted if the confidence score for all intents is
   *       below this value. <code>AMAZON.KendraSearchIntent</code> is only inserted if it is configured
   *       for the bot.</p>
   */
...
export interface GetIntentResponse {
  ...
  /**
   * <p>Configuration information, if any, to connect to an Amazon Kendra index with the
   *         <code>AMAZON.KendraSearchIntent</code> intent.</p>
   */
  kendraConfiguration?: KendraConfiguration;
...
/**
 * <p>A list of key/value pairs that identify a bot, bot alias, or bot channel. Tag keys and
...
export interface PutBotRequest {
  ...
  /**
   * <p>Set to <code>true</code> to enable  access to natural language understanding improvements.
   *       </p>
   *          <p>When you set the <code>enableModelImprovements</code> parameter to <code>true</code> you
   *       can use the <code>nluIntentConfidenceThreshold</code> parameter to configure confidence
   *       scores. For more information, see <a href="https://docs.aws.amazon.com/lex/latest/dg/confidence-scores.html">Confidence Scores</a>.</p>
   *          <p>You can only set the <code>enableModelImprovements</code> parameter in certain Regions. If
   *       you set the parameter to <code>true</code>, your bot has access to accuracy improvements.</p>
   *          <p>The Regions where you can set the <code>enableModelImprovements</code> parameter to
   *         <code>true</code> are:</p>
   *          <ul>
   *             <li>
   ...
   *             </li>
   *          </ul>
   *          <p>In other Regions, the <code>enableModelImprovements</code> parameter is set to
   *         <code>true</code> by default. In these Regions setting the parameter to <code>false</code>
   *       throws a <code>ValidationException</code> exception.</p>
   *          <ul>
   *             <li>
   *                <p>Asia Pacific (Singapore) (ap-southeast-1)</p>
   *             </li>
   *             <li>
   *                <p>Asia Pacific (Tokyo) (ap-northeast-1)</p>
   *             </li>
   *             <li>
   *                <p>EU (Frankfurt) (eu-central-1)</p>
   *             </li>
   *             <li>
   *                <p>EU (London) (eu-west-2)</p>
   *             </li>
   *          </ul>
   */
  enableModelImprovements?: boolean;
  ...
  /**
   * <p>Determines the threshold where Amazon Lex will insert the <code>AMAZON.FallbackIntent</code>,
   *         <code>AMAZON.KendraSearchIntent</code>, or both when returning alternative intents in a
   *         <a href="https://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostContent.html">PostContent</a> or <a href="https://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostText.html">PostText</a> response.
   *         <code>AMAZON.FallbackIntent</code> and <code>AMAZON.KendraSearchIntent</code> are only
   *       inserted if they are configured for the bot.</p>
   *          <p>You must set the <code>enableModelImprovements</code> parameter to <code>true</code> to
   *       use confidence scores.</p>
   *          <ul>
   *             <li>
   *                <p>US East (N. Virginia) (us-east-1)</p>
   *             </li>
   ...
   *          <p>For example, suppose a bot is configured with the confidence threshold of 0.80 and the
   *         <code>AMAZON.FallbackIntent</code>. Amazon Lex returns three alternative intents with the
   *       following confidence scores: IntentA (0.70), IntentB (0.60), IntentC (0.50). The response from
   *       the <code>PostText</code> operation would be:</p>
   *          <ul>
   *             <li>
   ...
   *         <code>abortStatement</code> to the user, and then cancels the conversation. To set the
   *       number of retries, use the <code>valueElicitationPrompt</code> field for the slot type. </p>
   ...
   *       slot.</p>
   *          <p>If you have defined a fallback intent the cancel statement will not be sent to the user,
  ...
  /**
   * <p>A list of tags to add to the bot. You can only add tags when you create a bot, you can't
   *       use the <code>PutBot</code> operation to update the tags on a bot. To update tags, use the
...
export interface PutBotAliasRequest {
  ...
  /**
   * <p>A list of tags to add to the bot alias. You can only add tags when you create an alias,
   *       you can't use the <code>PutBotAlias</code> operation to update the tags on a bot alias. To
...
export interface PutIntentRequest {
  ...
  /**
   * <p>Configuration information required to use the <code>AMAZON.KendraSearchIntent</code>
...
export interface PutIntentResponse {
  ...
  /**
   * <p>Configuration information, if any, required to connect to an Amazon Kendra index and use
...
export interface PutSlotTypeRequest {
  ...
  /**
   * <p>The built-in slot type used as the parent of the slot type. When you define a parent slot
   *       type, the new slot type has all of the same configuration as the parent.</p>
   ...
   *       slot. </p>
   *          <p>A regular expression slot type doesn't require enumeration values. All other slot types
   *       require a list of enumeration values.</p>
  ...
  /**
   * <p>Configuration information that extends the parent built-in slot type. The configuration is
   *       added to the settings for the parent slot type.</p>
   */
  slotTypeConfigurations?: SlotTypeConfiguration[];
...
export interface UntagResourceRequest {
  /**
   * <p>A list of tag keys to remove from the resource. If a tag key does not exist on the
   *       resource, it is ignored.</p>
   */
