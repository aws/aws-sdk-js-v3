...
export var BuiltinIntentSlot$: StaticStructureSchema = [3, n0, _BIS,
  0,
  [_n],
  [0]
];
export var BuiltinSlotTypeMetadata$: StaticStructureSchema = [3, n0, _BSTM,
  0,
  [_si, _sL],
  [0, 64 | 0]
];
...
export var GetBotsResponse$: StaticStructureSchema = [3, n0, _GBReto,
  0,
  [_b, _nT],
  [() => BotMetadataList, 0]
];
...
export var GetBuiltinIntentsRequest$: StaticStructureSchema = [3, n0, _GBIRet,
  0,
  [_l, _sC, _nT, _mR],
  [[0, { [_hQ]: _l }], [0, { [_hQ]: _sC }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var GetBuiltinIntentsResponse$: StaticStructureSchema = [3, n0, _GBIRetu,
  0,
  [_i, _nT],
  [() => BuiltinIntentMetadataList, 0]
];
export var GetBuiltinSlotTypesRequest$: StaticStructureSchema = [3, n0, _GBSTR,
  0,
  [_l, _sC, _nT, _mR],
  [[0, { [_hQ]: _l }], [0, { [_hQ]: _sC }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var GetBuiltinSlotTypesResponse$: StaticStructureSchema = [3, n0, _GBSTRe,
  0,
  [_sT, _nT],
...
export var GetIntentsRequest$: StaticStructureSchema = [3, n0, _GIRetnt,
  0,
  [_nT, _mR, _nC],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nC }]]
];
export var GetIntentsResponse$: StaticStructureSchema = [3, n0, _GIRetnte,
  0,
  [_i, _nT],
...
export var GetMigrationsRequest$: StaticStructureSchema = [3, n0, _GMRet,
  0,
  [_sBA, _sBO, _vBNC, _mSE, _mR, _nT],
  [[0, { [_hQ]: _sBA }], [0, { [_hQ]: _sBO }], [0, { [_hQ]: _vBNC }], [0, { [_hQ]: _mSE }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var GetMigrationsResponse$: StaticStructureSchema = [3, n0, _GMReti,
  0,
  [_mSigr, _nT],
...
export var GetSlotTypesRequest$: StaticStructureSchema = [3, n0, _GSTRet,
  0,
  [_nT, _mR, _nC],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nC }]]
];
export var GetSlotTypesResponse$: StaticStructureSchema = [3, n0, _GSTRetl,
  0,
  [_sT, _nT],
...
export var MigrationSummary$: StaticStructureSchema = [3, n0, _MS,
  0,
...
export var SlotTypeMetadata$: StaticStructureSchema = [3, n0, _STM,
  0,
  [_n, _d, _lUD, _cD, _v],
  [0, 0, 4, 4, 0]
];
...
export var UtteranceData$: StaticStructureSchema = [3, n0, _UD,
  0,
  [_uS, _cou, _dU, _fUD, _lUDa],
  [0, 1, 1, 4, 4]
];
export var UtteranceList$: StaticStructureSchema = [3, n0, _UL,
  0,
  [_bV, _ut],
  [0, () => ListOfUtterance]
];
...
var BotChannelAssociationList: StaticListSchema = [1, n0, _BCAL,
  0, [() => BotChannelAssociation$,
    0]
];
var BotMetadataList: StaticListSchema = [1, n0, _BML,
  0, () => BotMetadata$
];
var BotVersions = 64 | 0;
var BuiltinIntentMetadataList: StaticListSchema = [1, n0, _BIML,
  0, () => BuiltinIntentMetadata$
];
var BuiltinIntentSlotList: StaticListSchema = [1, n0, _BISL,
  0, () => BuiltinIntentSlot$
];
var BuiltinSlotTypeMetadataList: StaticListSchema = [1, n0, _BSTML,
  0, () => BuiltinSlotTypeMetadata$
];
var EnumerationValues: StaticListSchema = [1, n0, _EVn,
  0, () => EnumerationValue$
];
var InputContextList: StaticListSchema = [1, n0, _ICL,
  0, () => InputContext$
];
var IntentList: StaticListSchema = [1, n0, _IL,
  0, () => Intent$
];
var IntentMetadataList: StaticListSchema = [1, n0, _IML,
  0, () => IntentMetadata$
];
var IntentUtteranceList = 64 | 0;
var ListOfUtterance: StaticListSchema = [1, n0, _LOU,
  0, () => UtteranceData$
];
var ListsOfUtterances: StaticListSchema = [1, n0, _LOUi,
  0, () => UtteranceList$
];
var LocaleList = 64 | 0;
var LogSettingsRequestList: StaticListSchema = [1, n0, _LSRL,
  0, () => LogSettingsRequest$
];
var LogSettingsResponseList: StaticListSchema = [1, n0, _LSRLo,
...
var MigrationAlerts: StaticListSchema = [1, n0, _MAi,
  0, () => MigrationAlert$
];
var MigrationSummaryList: StaticListSchema = [1, n0, _MSL,
  0, () => MigrationSummary$
];
var OutputContextList: StaticListSchema = [1, n0, _OCL,
  0, () => OutputContext$
];
var SlotDefaultValueList: StaticListSchema = [1, n0, _SDVL,
  0, () => SlotDefaultValue$
];
var SlotList: StaticListSchema = [1, n0, _SL,
  0, () => Slot$
];
var SlotTypeConfigurations: StaticListSchema = [1, n0, _STCl,
  0, () => SlotTypeConfiguration$
];
var SlotTypeMetadataList: StaticListSchema = [1, n0, _STML,
  0, () => SlotTypeMetadata$
];
...
var ChannelConfigurationMap: StaticMapSchema = [2, n0, _CCM,
  8, 0, 0
];
export var CreateBotVersion$: StaticOperationSchema = [9, n0, _CBV,
  { [_h]: ["POST", "/bots/{name}/versions", 201] }, () => CreateBotVersionRequest$, () => CreateBotVersionResponse$
];
export var CreateIntentVersion$: StaticOperationSchema = [9, n0, _CIV,
  { [_h]: ["POST", "/intents/{name}/versions", 201] }, () => CreateIntentVersionRequest$, () => CreateIntentVersionResponse$
];
export var CreateSlotTypeVersion$: StaticOperationSchema = [9, n0, _CSTV,
  { [_h]: ["POST", "/slottypes/{name}/versions", 201] }, () => CreateSlotTypeVersionRequest$, () => CreateSlotTypeVersionResponse$
];
export var DeleteBot$: StaticOperationSchema = [9, n0, _DB,
...
export var GetImport$: StaticOperationSchema = [9, n0, _GI,
  { [_h]: ["GET", "/imports/{importId}", 200] }, () => GetImportRequest$, () => GetImportResponse$
];
export var GetIntent$: StaticOperationSchema = [9, n0, _GIe,
  { [_h]: ["GET", "/intents/{name}/versions/{version}", 200] }, () => GetIntentRequest$, () => GetIntentResponse$
];
export var GetIntents$: StaticOperationSchema = [9, n0, _GIet,
  { [_h]: ["GET", "/intents", 200] }, () => GetIntentsRequest$, () => GetIntentsResponse$
];
export var GetIntentVersions$: StaticOperationSchema = [9, n0, _GIV,
...
export var StartMigration$: StaticOperationSchema = [9, n0, _SM,
