 ...
 * @public
 */
export class ListTelemetryRulesForOrganizationCommand extends command<ListTelemetryRulesForOrganizationCommandInput, ListTelemetryRulesForOrganizationCommandOutput>(
  _ep0,
  _mw0,
