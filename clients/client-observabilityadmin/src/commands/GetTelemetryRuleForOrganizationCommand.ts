 ...
 * @public
 */
export class GetTelemetryRuleForOrganizationCommand extends command<GetTelemetryRuleForOrganizationCommandInput, GetTelemetryRuleForOrganizationCommandOutput>(
  _ep0,
  _mw0,
