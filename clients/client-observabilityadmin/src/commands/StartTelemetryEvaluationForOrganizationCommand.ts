 ...
 * @public
 */
export class StartTelemetryEvaluationForOrganizationCommand extends command<StartTelemetryEvaluationForOrganizationCommandInput, StartTelemetryEvaluationForOrganizationCommandOutput>(
  _ep0,
  _mw0,
