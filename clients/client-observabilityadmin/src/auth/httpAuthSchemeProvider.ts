...
import { ObservabilityAdminClientConfig, ObservabilityAdminClientResolvedConfig } from "../ObservabilityAdminClient";
 ...
 * @internal
 */
export const defaultObservabilityAdminHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ObservabilityAdminHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<ObservabilityAdminClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
