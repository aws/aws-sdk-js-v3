...
export const serializeAws_restJson1ListApplicationComponentsCommand = async (
  ...
  body = JSON.stringify({
    ...
    ...(input.groupIdFilter != undefined && {
      groupIdFilter: serializeAws_restJson1GroupIds(input.groupIdFilter, context),
    }),
...
export const serializeAws_restJson1ListServersCommand = async (
  ...
  body = JSON.stringify({
    ...
    ...(input.maxResults != undefined && { maxResults: input.maxResults }),
    ...(input.nextToken != undefined && { nextToken: input.nextToken }),
    ...(input.serverCriteria != undefined && { serverCriteria: input.serverCriteria }),
    ...(input.sort != undefined && { sort: input.sort }),
  });
  return new __HttpRequest({
    protocol,
...
export const serializeAws_restJson1StartAssessmentCommand = async (
  ...
  let body: any;
  body = JSON.stringify({
    ...(input.s3bucketForAnalysisData != undefined && { s3bucketForAnalysisData: input.s3bucketForAnalysisData }),
    ...(input.s3bucketForReportData != undefined && { s3bucketForReportData: input.s3bucketForReportData }),
  });
  return new __HttpRequest({
    protocol,
    hostname,
...
export const serializeAws_restJson1StartImportFileTaskCommand = async (
  ...
  body = JSON.stringify({
    ...
    ...(input.groupId != undefined && { groupId: serializeAws_restJson1GroupIds(input.groupId, context) }),
...
export const serializeAws_restJson1UpdateApplicationComponentConfigCommand = async (
  ...
  let body: any;
  body = JSON.stringify({
    ...(input.applicationComponentId != undefined && { applicationComponentId: input.applicationComponentId }),
    ...(input.inclusionStatus != undefined && { inclusionStatus: input.inclusionStatus }),
    ...(input.secretsManagerKey != undefined && { secretsManagerKey: input.secretsManagerKey }),
...
const serializeAws_restJson1BusinessGoals = (input: BusinessGoals, context: __SerdeContext): any => {
  return {
    ...(input.licenseCostReduction != undefined && { licenseCostReduction: input.licenseCostReduction }),
    ...
    ...(input.speedOfMigration != undefined && { speedOfMigration: input.speedOfMigration }),
  };
};
...
const serializeAws_restJson1SourceCode = (input: SourceCode, context: __SerdeContext): any => {
  return {
    ...
    ...(input.versionControl != undefined && { versionControl: input.versionControl }),
  };
};
...
const serializeAws_restJson1StrategyOption = (input: StrategyOption, context: __SerdeContext): any => {
  return {
    ...
    ...(input.targetDestination != undefined && { targetDestination: input.targetDestination }),
...
const deserializeAws_restJson1ApplicationComponentDetail = (
  ...
  return {
    ...
    antipatternReportS3Object:
      output.antipatternReportS3Object != undefined
    ...
    databaseConfigDetail:
      output.databaseConfigDetail != undefined
    ...
    recommendationSet:
      output.recommendationSet != undefined
    ...
    sourceCodeRepositories:
      output.sourceCodeRepositories != undefined
...
const deserializeAws_restJson1ApplicationPreferences = (
  ...
  return {
    managementPreference:
      output.managementPreference != undefined
...
const deserializeAws_restJson1AssessmentSummary = (output: any, context: __SerdeContext): AssessmentSummary => {
  return {
    ...
    listApplicationComponentSummary:
      output.listApplicationComponentSummary != undefined
...
const deserializeAws_restJson1DatabasePreferences = (output: any, context: __SerdeContext): DatabasePreferences => {
  return {
    ...
    databaseMigrationPreference:
      output.databaseMigrationPreference != undefined
...
const deserializeAws_restJson1Heterogeneous = (output: any, context: __SerdeContext): Heterogeneous => {
  return {
    targetDatabaseEngine:
      output.targetDatabaseEngine != undefined
...
const deserializeAws_restJson1PrioritizeBusinessGoals = (
  ...
  return {
    businessGoals:
      output.businessGoals != undefined
...
const deserializeAws_restJson1RecommendationReportDetails = (
  ...
  return {
    ...
    s3Keys: output.s3Keys != undefined ? deserializeAws_restJson1S3Keys(output.s3Keys, context) : undefined,
    startTime:
      output.startTime != undefined
        ? __expectNonNull(__parseEpochTimestamp(__expectNumber(output.startTime)))
        : undefined,
...
const deserializeAws_restJson1RecommendationSet = (output: any, context: __SerdeContext): RecommendationSet => {
  return {
    ...
    transformationTool:
      output.transformationTool != undefined
...
const deserializeAws_restJson1ServerDetail = (output: any, context: __SerdeContext): ServerDetail => {
  return {
    ...
    applicationComponentStrategySummary:
      output.applicationComponentStrategySummary != undefined
    ...
    statusMessage: __expectString(output.statusMessage),
    systemInfo:
      output.systemInfo != undefined ? deserializeAws_restJson1SystemInfo(output.systemInfo, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1SystemInfo = (output: any, context: __SerdeContext): SystemInfo => {
  return {
    ...
    networkInfoList:
      output.networkInfoList != undefined
        ? deserializeAws_restJson1NetworkInfoList(output.networkInfoList, context)
        : undefined,
    osInfo: output.osInfo != undefined ? deserializeAws_restJson1OSInfo(output.osInfo, context) : undefined,
  } as any;
};
