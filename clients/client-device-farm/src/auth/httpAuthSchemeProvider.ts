...
import { type DeviceFarmClientResolvedConfig, DeviceFarmClientConfig } from "../DeviceFarmClient";
 ...
 * @internal
 */
export const defaultDeviceFarmHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: DeviceFarmHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<DeviceFarmClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultDeviceFarmHttpAuthSchemeProvider: DeviceFarmHttpAuthSchemeProvider = (authParameters) => {
