...
import type { GetDevicePoolRequest, GetDevicePoolResult } from "../models/models_0";
 ...
 * @public
 */
export class GetDevicePoolCommand extends command<GetDevicePoolCommandInput, GetDevicePoolCommandOutput>(
  _ep0,
  _mw0,
  "GetDevicePool",
  GetDevicePool$
