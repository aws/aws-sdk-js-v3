...
import {
  type PinpointSMSVoiceV2ClientResolvedConfig,
 ...
 * @internal
 */
export const defaultPinpointSMSVoiceV2HttpAuthSchemeProvider: PinpointSMSVoiceV2HttpAuthSchemeProvider = (authParameters) => {
