 ...
 * @public
 */
export class DeleteVoiceMessageSpendLimitOverrideCommand extends command<DeleteVoiceMessageSpendLimitOverrideCommandInput, DeleteVoiceMessageSpendLimitOverrideCommandOutput>(
  _ep0,
  _mw0,
