...
import type { DeleteOptOutListRequest, DeleteOptOutListResult } from "../models/models_0";
 ...
 * @public
 */
export class DeleteOptOutListCommand extends command<DeleteOptOutListCommandInput, DeleteOptOutListCommandOutput>(
  _ep0,
  _mw0,
  "DeleteOptOutList",
  DeleteOptOutList$
