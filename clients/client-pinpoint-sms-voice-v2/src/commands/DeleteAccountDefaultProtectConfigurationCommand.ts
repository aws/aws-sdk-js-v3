 ...
 * @public
 */
export class DeleteAccountDefaultProtectConfigurationCommand extends command<DeleteAccountDefaultProtectConfigurationCommandInput, DeleteAccountDefaultProtectConfigurationCommandOutput>(
  _ep0,
  _mw0,
