...
> {
   ...
   * @public
   */
  constructor(readonly input: DiscardRegistrationVersionCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<DiscardRegistrationVersionCommandInput, DiscardRegistrationVersionCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DiscardRegistrationVersionCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "DiscardRegistrationVersionCommand";
   ...
   * @internal
   */
  private serialize(input: DiscardRegistrationVersionCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_DiscardRegistrationVersionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_DiscardRegistrationVersionCommand(output, context);
  }
}
