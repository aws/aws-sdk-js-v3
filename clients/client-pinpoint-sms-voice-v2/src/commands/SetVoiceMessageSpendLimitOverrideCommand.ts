 ...
 * @public
 */
export class SetVoiceMessageSpendLimitOverrideCommand extends command<SetVoiceMessageSpendLimitOverrideCommandInput, SetVoiceMessageSpendLimitOverrideCommandOutput>(
  _ep0,
  _mw0,
