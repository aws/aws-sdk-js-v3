...
> {
   ...
   * @public
   */
  constructor(readonly input: DescribeRegistrationFieldValuesCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<DescribeRegistrationFieldValuesCommandInput, DescribeRegistrationFieldValuesCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DescribeRegistrationFieldValuesCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "DescribeRegistrationFieldValuesCommand";
  ...
  private serialize(
    ...
    return se_DescribeRegistrationFieldValuesCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_DescribeRegistrationFieldValuesCommand(output, context);
  }
}
