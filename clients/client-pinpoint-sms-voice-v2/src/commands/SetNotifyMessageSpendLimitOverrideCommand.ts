 ...
 * @public
 */
export class SetNotifyMessageSpendLimitOverrideCommand extends command<SetNotifyMessageSpendLimitOverrideCommandInput, SetNotifyMessageSpendLimitOverrideCommandOutput>(
  _ep0,
  _mw0,
