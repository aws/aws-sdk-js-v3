...
import { DescribeProtectConfigurationsRequest, DescribeProtectConfigurationsResult } from "../models/models_0";
import {
...
import {
  de_DescribeProtectConfigurationsCommand,
  se_DescribeProtectConfigurationsCommand,
...
export class DescribeProtectConfigurationsCommand extends $Command
  ...
  .f(void 0, void 0)
  .ser(se_DescribeProtectConfigurationsCommand)
  .de(de_DescribeProtectConfigurationsCommand)
  .build() {
