...
> {
   ...
   * @public
   */
  constructor(readonly input: DescribeRegistrationSectionDefinitionsCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<DescribeRegistrationSectionDefinitionsCommandInput, DescribeRegistrationSectionDefinitionsCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DescribeRegistrationSectionDefinitionsCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "DescribeRegistrationSectionDefinitionsCommand";
  ...
  private serialize(
    ...
    return se_DescribeRegistrationSectionDefinitionsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_DescribeRegistrationSectionDefinitionsCommand(output, context);
  }
}
