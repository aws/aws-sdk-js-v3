...
import type { PutRegistrationFieldValueRequest, PutRegistrationFieldValueResult } from "../models/models_0";
 ...
 * @public
 */
export class PutRegistrationFieldValueCommand extends command<PutRegistrationFieldValueCommandInput, PutRegistrationFieldValueCommandOutput>(
  _ep0,
  _mw0,
  ...
  protected declare static __types: {
    ...
    sdk: {
      ...
      output: PutRegistrationFieldValueCommandOutput;
    };
  };
}
