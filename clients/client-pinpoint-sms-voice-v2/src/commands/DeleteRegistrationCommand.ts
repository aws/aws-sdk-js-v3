...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteRegistrationCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<DeleteRegistrationCommandInput, DeleteRegistrationCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteRegistrationCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "DeleteRegistrationCommand";
   ...
   * @internal
   */
  private serialize(input: DeleteRegistrationCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_DeleteRegistrationCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<DeleteRegistrationCommandOutput> {
    return de_DeleteRegistrationCommand(output, context);
  }
}
