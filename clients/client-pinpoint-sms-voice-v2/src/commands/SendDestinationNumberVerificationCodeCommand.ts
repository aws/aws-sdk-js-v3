...
> {
   ...
   * @public
   */
  constructor(readonly input: SendDestinationNumberVerificationCodeCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<SendDestinationNumberVerificationCodeCommandInput, SendDestinationNumberVerificationCodeCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, SendDestinationNumberVerificationCodeCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "SendDestinationNumberVerificationCodeCommand";
  ...
  private serialize(
    ...
    return se_SendDestinationNumberVerificationCodeCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_SendDestinationNumberVerificationCodeCommand(output, context);
  }
}
