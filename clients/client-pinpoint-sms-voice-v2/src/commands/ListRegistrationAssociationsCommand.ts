...
> {
   ...
   * @public
   */
  constructor(readonly input: ListRegistrationAssociationsCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<ListRegistrationAssociationsCommandInput, ListRegistrationAssociationsCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListRegistrationAssociationsCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "ListRegistrationAssociationsCommand";
   ...
   * @internal
   */
  private serialize(input: ListRegistrationAssociationsCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_ListRegistrationAssociationsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_ListRegistrationAssociationsCommand(output, context);
  }
}
