...
import { RequestSenderIdRequest, RequestSenderIdResult } from "../models/models_0";
import {
  PinpointSMSVoiceV2ClientResolvedConfig,
  ServiceInputTypes,
  ServiceOutputTypes,
} from "../PinpointSMSVoiceV2Client";
import { de_RequestSenderIdCommand, se_RequestSenderIdCommand } from "../protocols/Aws_json1_0";
...
> {
   ...
   * @public
   */
  constructor(readonly input: RequestSenderIdCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<RequestSenderIdCommandInput, RequestSenderIdCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, RequestSenderIdCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "RequestSenderIdCommand";
   ...
   * @internal
   */
  private serialize(input: RequestSenderIdCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_RequestSenderIdCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<RequestSenderIdCommandOutput> {
    return de_RequestSenderIdCommand(output, context);
  }
}
