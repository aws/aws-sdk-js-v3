...
import type { DeletePoolRequest, DeletePoolResult } from "../models/models_0";
 ...
 * @public
 */
export class DeletePoolCommand extends command<DeletePoolCommandInput, DeletePoolCommandOutput>(
  _ep0,
  _mw0,
  "DeletePool",
  DeletePool$
