...
> {
   ...
   * @public
   */
  constructor(readonly input: CreateRegistrationAttachmentCommandInput) {
    super();
  }
  ...
  ): Handler<CreateRegistrationAttachmentCommandInput, CreateRegistrationAttachmentCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, CreateRegistrationAttachmentCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: CreateRegistrationAttachmentCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_CreateRegistrationAttachmentCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_CreateRegistrationAttachmentCommand(output, context);
  }
}
