...
import type { UpdatePoolRequest, UpdatePoolResult } from "../models/models_0";
 ...
 * @public
 */
export class UpdatePoolCommand extends command<UpdatePoolCommandInput, UpdatePoolCommandOutput>(
  _ep0,
  _mw0,
  "UpdatePool",
  UpdatePool$
