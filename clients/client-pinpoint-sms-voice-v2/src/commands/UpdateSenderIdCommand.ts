...
import type { UpdateSenderIdRequest, UpdateSenderIdResult } from "../models/models_0";
 ...
 * @public
 */
export class UpdateSenderIdCommand extends command<UpdateSenderIdCommandInput, UpdateSenderIdCommandOutput>(
  _ep0,
  _mw0,
  "UpdateSenderId",
  UpdateSenderId$
