...
> {
   ...
   * @public
   */
  constructor(readonly input: UpdateSenderIdCommandInput) {
    super();
  }
  ...
  ): Handler<UpdateSenderIdCommandInput, UpdateSenderIdCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, UpdateSenderIdCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: UpdateSenderIdCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<UpdateSenderIdCommandOutput> {
