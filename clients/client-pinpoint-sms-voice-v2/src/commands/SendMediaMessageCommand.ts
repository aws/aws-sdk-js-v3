...
import type { SendMediaMessageRequest, SendMediaMessageResult } from "../models/models_0";
 ...
 * @public
 */
export class SendMediaMessageCommand extends command<SendMediaMessageCommandInput, SendMediaMessageCommandOutput>(
  _ep0,
  _mw0,
  "SendMediaMessage",
  SendMediaMessage$
