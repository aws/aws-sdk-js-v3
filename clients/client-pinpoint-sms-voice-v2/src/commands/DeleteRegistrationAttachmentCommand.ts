...
import {
  ...
  se_DeleteRegistrationAttachmentCommand,
...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteRegistrationAttachmentCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<DeleteRegistrationAttachmentCommandInput, DeleteRegistrationAttachmentCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteRegistrationAttachmentCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "DeleteRegistrationAttachmentCommand";
   ...
   * @internal
   */
  private serialize(input: DeleteRegistrationAttachmentCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_DeleteRegistrationAttachmentCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_DeleteRegistrationAttachmentCommand(output, context);
  }
}
