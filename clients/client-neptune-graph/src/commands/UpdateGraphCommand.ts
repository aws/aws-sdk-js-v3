...
import type { UpdateGraphInput, UpdateGraphOutput } from "../models/models_0";
 ...
 * @public
 */
export class UpdateGraphCommand extends command<UpdateGraphCommandInput, UpdateGraphCommandOutput>(
  _ep0,
  _mw0,
  "UpdateGraph",
  UpdateGraph$
