...
const AWS_TEMPLATE = "opsworks.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "opsworks.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "opsworks.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "opsworks.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "opsworks.{region}.amazonaws.com";
