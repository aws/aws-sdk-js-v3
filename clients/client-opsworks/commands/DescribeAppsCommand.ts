...
export type DescribeAppsCommandOutput = DescribeAppsResult;

export class DescribeAppsCommand extends $Command<DescribeAppsCommandInput, DescribeAppsCommandOutput, OpsWorksClientResolvedConfig> {
