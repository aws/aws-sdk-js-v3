...
export type UpdateInstanceCommandInput = UpdateInstanceRequest;
export type UpdateInstanceCommandOutput = __MetadataBearer

export class UpdateInstanceCommand extends $Command<UpdateInstanceCommandInput, UpdateInstanceCommandOutput, OpsWorksClientResolvedConfig> {
