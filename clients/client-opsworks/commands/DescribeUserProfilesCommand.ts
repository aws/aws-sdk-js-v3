...
export class DescribeUserProfilesCommand extends $Command<DescribeUserProfilesCommandInput, DescribeUserProfilesCommandOutput, OpsWorksClientResolvedConfig> {
