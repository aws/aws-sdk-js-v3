...
export type CloneStackCommandOutput = CloneStackResult;

export class CloneStackCommand extends $Command<CloneStackCommandInput, CloneStackCommandOutput, OpsWorksClientResolvedConfig> {
