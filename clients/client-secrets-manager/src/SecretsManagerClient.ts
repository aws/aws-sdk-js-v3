 ...
 * @public
 */
export type SecretsManagerClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultSecretsManagerHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: SecretsManagerClientResolvedConfig) =>
