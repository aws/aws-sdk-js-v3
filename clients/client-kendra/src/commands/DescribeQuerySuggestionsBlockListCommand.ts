 ...
 * @public
 */
export class DescribeQuerySuggestionsBlockListCommand extends command<DescribeQuerySuggestionsBlockListCommandInput, DescribeQuerySuggestionsBlockListCommandOutput>(
  _ep0,
  _mw0,
