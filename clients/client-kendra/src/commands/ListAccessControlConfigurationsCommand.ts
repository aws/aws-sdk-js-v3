 ...
 * @public
 */
export class ListAccessControlConfigurationsCommand extends command<ListAccessControlConfigurationsCommandInput, ListAccessControlConfigurationsCommandOutput>(
  _ep0,
  _mw0,
