 ...
 * @public
 */
export class DeleteQuerySuggestionsBlockListCommand extends command<DeleteQuerySuggestionsBlockListCommandInput, DeleteQuerySuggestionsBlockListCommandOutput>(
  _ep0,
  _mw0,
