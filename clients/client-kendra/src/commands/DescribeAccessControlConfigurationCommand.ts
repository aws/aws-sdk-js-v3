 ...
 * @public
 */
export class DescribeAccessControlConfigurationCommand extends command<DescribeAccessControlConfigurationCommandInput, DescribeAccessControlConfigurationCommandOutput>(
  _ep0,
  _mw0,
