 ...
 * @public
 */
export class DescribeQuerySuggestionsConfigCommand extends command<DescribeQuerySuggestionsConfigCommandInput, DescribeQuerySuggestionsConfigCommandOutput>(
  _ep0,
  _mw0,
