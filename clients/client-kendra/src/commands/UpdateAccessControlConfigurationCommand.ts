 ...
 * @public
 */
export class UpdateAccessControlConfigurationCommand extends command<UpdateAccessControlConfigurationCommandInput, UpdateAccessControlConfigurationCommandOutput>(
  _ep0,
  _mw0,
