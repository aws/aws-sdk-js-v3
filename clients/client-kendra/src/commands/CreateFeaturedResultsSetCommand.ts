 ...
 * ```
 *
 * @param CreateFeaturedResultsSetRequest - {@link CreateFeaturedResultsSetRequest}
 * @returns {@link CreateFeaturedResultsSetResponse}
...
> {
   ...
   * @public
   */
  constructor(readonly input: CreateFeaturedResultsSetCommandInput) {
  ...
  ): Handler<CreateFeaturedResultsSetCommandInput, CreateFeaturedResultsSetCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, CreateFeaturedResultsSetCommand.getEndpointParameterInstructions())
    );
