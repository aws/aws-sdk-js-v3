 ...
 * @public
 */
export class UpdateQuerySuggestionsBlockListCommand extends command<UpdateQuerySuggestionsBlockListCommandInput, UpdateQuerySuggestionsBlockListCommandOutput>(
  _ep0,
  _mw0,
