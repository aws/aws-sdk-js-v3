 ...
 * @public
 */
export class AssociateEntitiesToExperienceCommand extends command<AssociateEntitiesToExperienceCommandInput, AssociateEntitiesToExperienceCommandOutput>(
  _ep0,
  _mw0,
