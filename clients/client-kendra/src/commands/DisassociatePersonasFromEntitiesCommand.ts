 ...
 * @public
 */
export class DisassociatePersonasFromEntitiesCommand extends command<DisassociatePersonasFromEntitiesCommandInput, DisassociatePersonasFromEntitiesCommandOutput>(
  _ep0,
  _mw0,
