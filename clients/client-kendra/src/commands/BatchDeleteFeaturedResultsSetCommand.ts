 ...
 * @public
 */
export class BatchDeleteFeaturedResultsSetCommand extends command<BatchDeleteFeaturedResultsSetCommandInput, BatchDeleteFeaturedResultsSetCommandOutput>(
  _ep0,
  _mw0,
