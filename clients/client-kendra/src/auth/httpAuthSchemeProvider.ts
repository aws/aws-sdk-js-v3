...
import { type KendraClientResolvedConfig, KendraClientConfig } from "../KendraClient";
 ...
 * @internal
 */
export const defaultKendraHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: KendraHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultKendraHttpAuthSchemeProvider: KendraHttpAuthSchemeProvider = (authParameters) => {
