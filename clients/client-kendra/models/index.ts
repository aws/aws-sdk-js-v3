...
export interface CreateIndexRequest {
  ...
  /**
   *
   *          <p>The identifier of the KMS key to use to encrypt data indexed by Amazon Kendra. </p>
   *
   */
...
export interface DescribeIndexResponse extends $MetadataBearer {
  ...
  /**
   *
   *          <p>The identifier of the KMS key used to encrypt your data. </p>
   *
   */
  ServerSideEncryptionConfiguration?: ServerSideEncryptionConfiguration;
...
export interface S3DataSourceConfiguration {
   ...
   *             indexed.</p>
   *         <p>For more information about glob patterns, see <a href="http://wikipedia.org/wiki/Glob_%28programming529">glob (programming)</a> in
   *                 <i>Wikipedia</i>.</p>
   *
   */
