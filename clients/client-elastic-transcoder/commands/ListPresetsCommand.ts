...
import {
  deserializeAws_restJson1_1ListPresetsCommand,
  serializeAws_restJson1_1ListPresetsCommand,
...
export type ListPresetsCommandOutput = ListPresetsResponse;

export class ListPresetsCommand extends $Command<ListPresetsCommandInput, ListPresetsCommandOutput, ElasticTranscoderClientResolvedConfig> {
