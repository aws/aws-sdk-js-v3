...
import {
  defaultElasticTranscoderHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type ElasticTranscoderClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type ElasticTranscoderClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<ElasticTranscoderClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultElasticTranscoderHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: ElasticTranscoderClientResolvedConfig) =>
