...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1GetServiceNetworkVpcAssociationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1GetServiceNetworkVpcAssociationCommand(output, context);
  }
