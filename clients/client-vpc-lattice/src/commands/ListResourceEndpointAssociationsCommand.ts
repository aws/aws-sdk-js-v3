 ...
 * @public
 */
export class ListResourceEndpointAssociationsCommand extends command<ListResourceEndpointAssociationsCommandInput, ListResourceEndpointAssociationsCommandOutput>(
  _ep0,
  _mw0,
