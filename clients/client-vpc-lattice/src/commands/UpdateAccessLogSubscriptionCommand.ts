...
> {
   ...
   * @public
   */
  constructor(readonly input: UpdateAccessLogSubscriptionCommandInput) {
  ...
  ): Handler<UpdateAccessLogSubscriptionCommandInput, UpdateAccessLogSubscriptionCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, UpdateAccessLogSubscriptionCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: UpdateAccessLogSubscriptionCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1UpdateAccessLogSubscriptionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1UpdateAccessLogSubscriptionCommand(output, context);
  }
