 ...
 * @public
 */
export class DeleteResourceEndpointAssociationCommand extends command<DeleteResourceEndpointAssociationCommandInput, DeleteResourceEndpointAssociationCommandOutput>(
  _ep0,
  _mw0,
