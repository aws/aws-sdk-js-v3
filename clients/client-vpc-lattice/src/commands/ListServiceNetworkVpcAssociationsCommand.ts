...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1ListServiceNetworkVpcAssociationsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1ListServiceNetworkVpcAssociationsCommand(output, context);
  }
