...
import type { UpdateTargetGroupRequest, UpdateTargetGroupResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateTargetGroupCommand extends command<UpdateTargetGroupCommandInput, UpdateTargetGroupCommandOutput>(
  _ep0,
  _mw0,
  "UpdateTargetGroup",
  UpdateTargetGroup$
