 ...
 * @public
 */
export class CreateServiceNetworkVpcAssociationCommand extends command<CreateServiceNetworkVpcAssociationCommandInput, CreateServiceNetworkVpcAssociationCommandOutput>(
  _ep0,
  _mw0,
