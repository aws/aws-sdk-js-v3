...
import type { GetTargetGroupRequest, GetTargetGroupResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetTargetGroupCommand extends command<GetTargetGroupCommandInput, GetTargetGroupCommandOutput>(
  _ep0,
  _mw0,
  "GetTargetGroup",
  GetTargetGroup$
