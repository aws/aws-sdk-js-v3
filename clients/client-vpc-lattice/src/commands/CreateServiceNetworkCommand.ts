...
import type { CreateServiceNetworkRequest, CreateServiceNetworkResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateServiceNetworkCommand extends command<CreateServiceNetworkCommandInput, CreateServiceNetworkCommandOutput>(
  _ep0,
  _mw0,
