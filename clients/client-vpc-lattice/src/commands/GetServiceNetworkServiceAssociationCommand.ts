 ...
 * ```
 *
 * @param GetServiceNetworkServiceAssociationRequest - {@link GetServiceNetworkServiceAssociationRequest}
 * @returns {@link GetServiceNetworkServiceAssociationResponse}
