 ...
 * @public
 */
export class GetServiceNetworkServiceAssociationCommand extends command<GetServiceNetworkServiceAssociationCommandInput, GetServiceNetworkServiceAssociationCommandOutput>(
  _ep0,
  _mw0,
