...
export var ArnResource$: StaticStructureSchema = [3, n0, _AR,
  0,
  [_a],
  [0]
];
...
export var CreateAccessLogSubscriptionResponse$: StaticStructureSchema = [3, n0, _CALSRr,
  0,
...
export var CreateResourceConfigurationRequest$: StaticStructureSchema = [3, n0, _CRCR,
  0,
...
export var CreateResourceConfigurationResponse$: StaticStructureSchema = [3, n0, _CRCRr,
  0,
...
export var CreateServiceNetworkResourceAssociationResponse$: StaticStructureSchema = [3, n0, _CSNRARr,
  0,
  [_i, _a, _st, _cB, _pDE],
  [0, 0, 0, 0, 2]
];
...
export var CreateServiceNetworkServiceAssociationResponse$: StaticStructureSchema = [3, n0, _CSNSARr,
  0,
  [_i, _st, _a, _cB, _cDN, _dE],
  [0, 0, 0, 0, 0, () => DnsEntry$]
];
export var CreateServiceNetworkVpcAssociationRequest$: StaticStructureSchema = [3, n0, _CSNVAR,
  0,
  [_cT, _sNI, _vI, _pDE, _sGI, _t, _dO],
  [[0, 4], 0, 0, 2, 64 | 0, 128 | 0, () => DnsOptions$]
];
export var CreateServiceNetworkVpcAssociationResponse$: StaticStructureSchema = [3, n0, _CSNVARr,
  0,
...
export var CreateTargetGroupResponse$: StaticStructureSchema = [3, n0, _CTGRr,
  0,
  [_i, _a, _n, _ty, _co, _st],
  [0, 0, 0, 0, () => TargetGroupConfig$, 0]
];
export var DeleteAccessLogSubscriptionRequest$: StaticStructureSchema = [3, n0, _DALSR,
  0,
  [_aLSI],
  [[0, 1]]
];
export var DeleteAccessLogSubscriptionResponse$: StaticStructureSchema = [3, n0, _DALSRe,
  0,
  [],
  []
];
export var DeleteAuthPolicyRequest$: StaticStructureSchema = [3, n0, _DAPR,
  0,
  [_rIe],
  [[0, 1]]
];
export var DeleteAuthPolicyResponse$: StaticStructureSchema = [3, n0, _DAPRe,
  0,
  [],
  []
];
export var DeleteDomainVerificationRequest$: StaticStructureSchema = [3, n0, _DDVR,
  0,
  [_dVI],
  [[0, 1]]
];
export var DeleteDomainVerificationResponse$: StaticStructureSchema = [3, n0, _DDVRe,
  0,
  [],
  []
];
...
export var DeleteListenerResponse$: StaticStructureSchema = [3, n0, _DLRe,
  0,
  [],
  []
];
export var DeleteResourceConfigurationRequest$: StaticStructureSchema = [3, n0, _DRCR,
  0,
  [_rCI],
  [[0, 1]]
];
export var DeleteResourceConfigurationResponse$: StaticStructureSchema = [3, n0, _DRCRe,
  0,
  [],
  []
];
export var DeleteResourceEndpointAssociationRequest$: StaticStructureSchema = [3, n0, _DREAR,
  0,
  [_rEAI],
  [[0, 1]]
];
export var DeleteResourceEndpointAssociationResponse$: StaticStructureSchema = [3, n0, _DREARe,
  0,
  [_i, _a, _rCIe, _rCA, _vEI],
  [0, 0, 0, 0, 0]
];
export var DeleteResourceGatewayRequest$: StaticStructureSchema = [3, n0, _DRGR,
  0,
  [_rGI],
  [[0, 1]]
];
export var DeleteResourceGatewayResponse$: StaticStructureSchema = [3, n0, _DRGRe,
  0,
  [_i, _a, _n, _st],
  [0, 0, 0, 0]
];
...
export var DeleteServiceNetworkRequest$: StaticStructureSchema = [3, n0, _DSNR,
  0,
  [_sNI],
  [[0, 1]]
];
export var DeleteServiceNetworkResourceAssociationRequest$: StaticStructureSchema = [3, n0, _DSNRAR,
  0,
  [_sNRAI],
  [[0, 1]]
];
export var DeleteServiceNetworkResourceAssociationResponse$: StaticStructureSchema = [3, n0, _DSNRARe,
  0,
  [_i, _a, _st],
  [0, 0, 0]
];
export var DeleteServiceNetworkResponse$: StaticStructureSchema = [3, n0, _DSNRe,
  0,
  [],
  []
];
export var DeleteServiceNetworkServiceAssociationRequest$: StaticStructureSchema = [3, n0, _DSNSAR,
  0,
  [_sNSAI],
  [[0, 1]]
];
export var DeleteServiceNetworkServiceAssociationResponse$: StaticStructureSchema = [3, n0, _DSNSARe,
  0,
  [_i, _st, _a],
  [0, 0, 0]
];
export var DeleteServiceNetworkVpcAssociationRequest$: StaticStructureSchema = [3, n0, _DSNVAR,
  0,
  [_sNVAI],
  [[0, 1]]
];
export var DeleteServiceNetworkVpcAssociationResponse$: StaticStructureSchema = [3, n0, _DSNVARe,
  0,
  [_i, _st, _a],
  [0, 0, 0]
];
...
export var DeleteTargetGroupRequest$: StaticStructureSchema = [3, n0, _DTGR,
  0,
  [_tGI],
  [[0, 1]]
];
export var DeleteTargetGroupResponse$: StaticStructureSchema = [3, n0, _DTGRe,
  0,
  [_i, _a, _st],
  [0, 0, 0]
];
export var DeregisterTargetsRequest$: StaticStructureSchema = [3, n0, _DTR,
  0,
  [_tGI, _ta],
  [[0, 1], () => TargetList]
];
...
export var DnsOptions$: StaticStructureSchema = [3, n0, _DO,
  0,
  [_pDP, _pDSD],
  [0, 64 | 0]
];
export var DnsResource$: StaticStructureSchema = [3, n0, _DR,
  0,
  [_dN, _iAT],
  [0, 0]
];
export var DomainVerificationSummary$: StaticStructureSchema = [3, n0, _DVS,
  0,
  [_i, _a, _dN, _st, _tMC, _cA, _lVT, _t],
  [0, 0, 0, 0, () => TxtMethodConfig$, 5, 5, 128 | 0]
];
export var FixedResponseAction$: StaticStructureSchema = [3, n0, _FRA,
  0,
  [_sCt],
  [1]
];
export var ForwardAction$: StaticStructureSchema = [3, n0, _FA,
  0,
  [_tG],
  [() => WeightedTargetGroupList]
];
export var GetAccessLogSubscriptionRequest$: StaticStructureSchema = [3, n0, _GALSR,
  0,
  [_aLSI],
  [[0, 1]]
];
export var GetAccessLogSubscriptionResponse$: StaticStructureSchema = [3, n0, _GALSRe,
  0,
  [_i, _a, _rI, _rA, _dA, _sNLT, _cA, _lUA],
  [0, 0, 0, 0, 0, 0, 5, 5]
];
export var GetAuthPolicyRequest$: StaticStructureSchema = [3, n0, _GAPR,
  0,
  [_rIe],
  [[0, 1]]
];
export var GetAuthPolicyResponse$: StaticStructureSchema = [3, n0, _GAPRe,
  0,
  [_pol, _sta, _cA, _lUA],
  [0, 0, 5, 5]
];
export var GetDomainVerificationRequest$: StaticStructureSchema = [3, n0, _GDVR,
  0,
  [_dVI],
  [[0, 1]]
];
export var GetDomainVerificationResponse$: StaticStructureSchema = [3, n0, _GDVRe,
  0,
  [_i, _a, _dN, _st, _tMC, _cA, _lVT, _t],
  [0, 0, 0, 0, () => TxtMethodConfig$, 5, 5, 128 | 0]
];
export var GetListenerRequest$: StaticStructureSchema = [3, n0, _GLR,
  0,
  [_sI, _lI],
  [[0, 1], [0, 1]]
];
export var GetListenerResponse$: StaticStructureSchema = [3, n0, _GLRe,
  0,
  [_a, _i, _n, _p, _po, _sA, _sIe, _dAe, _cA, _lUA],
  [0, 0, 0, 0, 1, 0, 0, () => RuleAction$, 5, 5]
];
export var GetResourceConfigurationRequest$: StaticStructureSchema = [3, n0, _GRCR,
  0,
  [_rCI],
  [[0, 1]]
];
export var GetResourceConfigurationResponse$: StaticStructureSchema = [3, n0, _GRCRe,
  0,
...
export var GetResourceGatewayRequest$: StaticStructureSchema = [3, n0, _GRGR,
  0,
  [_rGI],
  [[0, 1]]
];
...
export var GetServiceNetworkRequest$: StaticStructureSchema = [3, n0, _GSNR,
  0,
  [_sNI],
  [[0, 1]]
];
export var GetServiceNetworkResourceAssociationRequest$: StaticStructureSchema = [3, n0, _GSNRAR,
  0,
  [_sNRAI],
  [[0, 1]]
];
export var GetServiceNetworkResourceAssociationResponse$: StaticStructureSchema = [3, n0, _GSNRARe,
  0,
...
export var GetServiceNetworkServiceAssociationResponse$: StaticStructureSchema = [3, n0, _GSNSARe,
  0,
  [_i, _st, _a, _cB, _cA, _sIe, _sN, _sA, _sNIe, _sNN, _sNA, _dE, _cDN, _fM, _fC],
  [0, 0, 0, 0, 5, 0, 0, 0, 0, 0, 0, () => DnsEntry$, 0, 0, 0]
];
export var GetServiceNetworkVpcAssociationRequest$: StaticStructureSchema = [3, n0, _GSNVAR,
  0,
  [_sNVAI],
  [[0, 1]]
];
export var GetServiceNetworkVpcAssociationResponse$: StaticStructureSchema = [3, n0, _GSNVARe,
  0,
...
export var GetTargetGroupResponse$: StaticStructureSchema = [3, n0, _GTGRe,
  0,
  [_i, _a, _n, _ty, _co, _cA, _lUA, _st, _sAe, _fM, _fC],
  [0, 0, 0, 0, () => TargetGroupConfig$, 5, 5, 0, 64 | 0, 0, 0]
];
export var HeaderMatch$: StaticStructureSchema = [3, n0, _HM,
  0,
  [_n, _ma, _cS],
  [0, () => HeaderMatchType$, 2]
];
...
export var HttpMatch$: StaticStructureSchema = [3, n0, _HMt,
  0,
  [_me, _pM, _hM],
...
export var ListAccessLogSubscriptionsRequest$: StaticStructureSchema = [3, n0, _LALSR,
  0,
  [_rIe, _mR, _nT],
  [[0, { [_hQ]: _rIe }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListAccessLogSubscriptionsResponse$: StaticStructureSchema = [3, n0, _LALSRi,
  0,
  [_it, _nT],
  [() => AccessLogSubscriptionList, 0]
];
export var ListDomainVerificationsRequest$: StaticStructureSchema = [3, n0, _LDVR,
  0,
  [_mR, _nT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListDomainVerificationsResponse$: StaticStructureSchema = [3, n0, _LDVRi,
  0,
  [_it, _nT],
  [() => DomainVerificationList, 0]
];
export var ListenerSummary$: StaticStructureSchema = [3, n0, _LS,
  0,
...
export var ListResourceConfigurationsRequest$: StaticStructureSchema = [3, n0, _LRCR,
  0,
  [_rGI, _rCGI, _dVI, _mR, _nT],
  [[0, { [_hQ]: _rGI }], [0, { [_hQ]: _rCGI }], [0, { [_hQ]: _dVI }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListResourceConfigurationsResponse$: StaticStructureSchema = [3, n0, _LRCRi,
  0,
  [_it, _nT],
  [() => ResourceConfigurationSummaryList, 0]
];
export var ListResourceEndpointAssociationsRequest$: StaticStructureSchema = [3, n0, _LREAR,
  0,
  [_rCI, _rEAI, _vEI, _vEO, _mR, _nT],
  [[0, { [_hQ]: _rCI }], [0, { [_hQ]: _rEAI }], [0, { [_hQ]: _vEI }], [0, { [_hQ]: _vEO }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListResourceEndpointAssociationsResponse$: StaticStructureSchema = [3, n0, _LREARi,
  0,
  [_it, _nT],
  [() => ResourceEndpointAssociationList, 0]
];
export var ListResourceGatewaysRequest$: StaticStructureSchema = [3, n0, _LRGR,
  0,
  [_mR, _nT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListResourceGatewaysResponse$: StaticStructureSchema = [3, n0, _LRGRi,
  0,
  [_it, _nT],
...
export var ListServiceNetworkResourceAssociationsRequest$: StaticStructureSchema = [3, n0, _LSNRAR,
  0,
  [_sNI, _rCI, _mR, _nT, _iC],
  [[0, { [_hQ]: _sNI }], [0, { [_hQ]: _rCI }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }], [2, { [_hQ]: _iC }]]
];
export var ListServiceNetworkResourceAssociationsResponse$: StaticStructureSchema = [3, n0, _LSNRARi,
  0,
  [_it, _nT],
  [() => ServiceNetworkResourceAssociationList, 0]
];
export var ListServiceNetworkServiceAssociationsRequest$: StaticStructureSchema = [3, n0, _LSNSAR,
  0,
  [_sNI, _sI, _mR, _nT],
  [[0, { [_hQ]: _sNI }], [0, { [_hQ]: _sI }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListServiceNetworkServiceAssociationsResponse$: StaticStructureSchema = [3, n0, _LSNSARi,
  0,
  [_it, _nT],
  [() => ServiceNetworkServiceAssociationList, 0]
];
export var ListServiceNetworksRequest$: StaticStructureSchema = [3, n0, _LSNR,
  0,
  [_mR, _nT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListServiceNetworksResponse$: StaticStructureSchema = [3, n0, _LSNRi,
  0,
  [_it, _nT],
  [() => ServiceNetworkList, 0]
];
export var ListServiceNetworkVpcAssociationsRequest$: StaticStructureSchema = [3, n0, _LSNVAR,
  0,
  [_sNI, _vI, _mR, _nT],
  [[0, { [_hQ]: _sNI }], [0, { [_hQ]: _vI }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListServiceNetworkVpcAssociationsResponse$: StaticStructureSchema = [3, n0, _LSNVARi,
  0,
  [_it, _nT],
  [() => ServiceNetworkVpcAssociationList, 0]
];
export var ListServiceNetworkVpcEndpointAssociationsRequest$: StaticStructureSchema = [3, n0, _LSNVEAR,
  0,
  [_sNI, _mR, _nT],
  [[0, { [_hQ]: _sNI }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListServiceNetworkVpcEndpointAssociationsResponse$: StaticStructureSchema = [3, n0, _LSNVEARi,
  0,
  [_it, _nT],
...
export var ListTargetGroupsRequest$: StaticStructureSchema = [3, n0, _LTGR,
  0,
  [_mR, _nT, _vI, _tGT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }], [0, { [_hQ]: _vI }], [0, { [_hQ]: _tGT }]]
];
export var ListTargetGroupsResponse$: StaticStructureSchema = [3, n0, _LTGRi,
  0,
  [_it, _nT],
  [() => TargetGroupList, 0]
];
...
export var ListTargetsResponse$: StaticStructureSchema = [3, n0, _LTRi,
  0,
  [_it, _nT],
  [() => TargetSummaryList, 0]
];
export var PathMatch$: StaticStructureSchema = [3, n0, _PM,
  0,
  [_ma, _cS],
  [() => PathMatchType$, 2]
];
...
export var PutAuthPolicyResponse$: StaticStructureSchema = [3, n0, _PAPRu,
  0,
  [_pol, _sta],
  [0, 0]
];
...
export var RegisterTargetsRequest$: StaticStructureSchema = [3, n0, _RTR,
  0,
  [_tGI, _ta],
  [[0, 1], () => TargetList]
];
...
export var RuleUpdate$: StaticStructureSchema = [3, n0, _RU,
  0,
  [_rIu, _ma, _pr, _ac],
  [0, () => RuleMatch$, 1, () => RuleAction$]
];
export var RuleUpdateFailure$: StaticStructureSchema = [3, n0, _RUF,
  0,
  [_rIu, _fC, _fM],
  [0, 0, 0]
];
export var RuleUpdateSuccess$: StaticStructureSchema = [3, n0, _RUS,
  0,
  [_a, _i, _n, _iD, _ma, _pr, _ac],
  [0, 0, 0, 2, () => RuleMatch$, 1, () => RuleAction$]
];
export var ServiceNetworkEndpointAssociation$: StaticStructureSchema = [3, n0, _SNEA,
  0,
  [_vEI, _vIp, _vEOI, _i, _sta, _sNA, _cA],
  [0, 0, 0, 0, 0, 0, 5]
];
export var ServiceNetworkResourceAssociationSummary$: StaticStructureSchema = [3, n0, _SNRAS,
  0,
  [_i, _a, _st, _cB, _cA, _rCIe, _rCA, _rCN, _sNIe, _sNA, _sNN, _dE, _pDEr, _iMA, _fC, _pDE],
  [0, 0, 0, 0, 5, 0, 0, 0, 0, 0, 0, () => DnsEntry$, () => DnsEntry$, 2, 0, 2]
];
export var ServiceNetworkServiceAssociationSummary$: StaticStructureSchema = [3, n0, _SNSAS,
  0,
  [_i, _st, _a, _cB, _cA, _sIe, _sN, _sA, _sNIe, _sNN, _sNA, _dE, _cDN],
  [0, 0, 0, 0, 5, 0, 0, 0, 0, 0, 0, () => DnsEntry$, 0]
];
export var ServiceNetworkSummary$: StaticStructureSchema = [3, n0, _SNS,
  0,
  [_i, _n, _a, _cA, _lUA, _nOAVPC, _nOAS, _nOARC],
  [0, 0, 0, 5, 5, 1, 1, 1]
];
export var ServiceNetworkVpcAssociationSummary$: StaticStructureSchema = [3, n0, _SNVAS,
  0,
...
export var SharingConfig$: StaticStructureSchema = [3, n0, _SC,
  0,
  [_en],
  [2]
];
export var StartDomainVerificationRequest$: StaticStructureSchema = [3, n0, _SDVR,
  0,
  [_cT, _dN, _t],
  [[0, 4], 0, 128 | 0]
];
export var StartDomainVerificationResponse$: StaticStructureSchema = [3, n0, _SDVRt,
  0,
  [_i, _a, _dN, _st, _tMC],
...
export var TargetFailure$: StaticStructureSchema = [3, n0, _TF,
  0,
  [_i, _po, _fC, _fM],
  [0, 1, 0, 0]
];
export var TargetGroupConfig$: StaticStructureSchema = [3, n0, _TGC,
  0,
  [_po, _p, _pV, _iAT, _vI, _hC, _lESV],
  [1, 0, 0, 0, 0, () => HealthCheckConfig$, 0]
];
export var TargetGroupSummary$: StaticStructureSchema = [3, n0, _TGS,
  0,
...
export var UpdateAccessLogSubscriptionRequest$: StaticStructureSchema = [3, n0, _UALSR,
  0,
  [_aLSI, _dA],
  [[0, 1], 0]
];
export var UpdateAccessLogSubscriptionResponse$: StaticStructureSchema = [3, n0, _UALSRp,
  0,
  [_i, _a, _rI, _rA, _dA],
  [0, 0, 0, 0, 0]
];
...
export var UpdateResourceConfigurationRequest$: StaticStructureSchema = [3, n0, _URCR,
  0,
  [_rCI, _rCD, _aATSSN, _pR],
  [[0, 1], () => ResourceConfigurationDefinition$, 2, 64 | 0]
];
export var UpdateResourceConfigurationResponse$: StaticStructureSchema = [3, n0, _URCRp,
  0,
  [_i, _n, _a, _rGIe, _rCGIe, _ty, _pR, _aATSSN, _p, _st, _rCD],
  [0, 0, 0, 0, 0, 0, 64 | 0, 2, 0, 0, () => ResourceConfigurationDefinition$]
];
export var UpdateResourceGatewayRequest$: StaticStructureSchema = [3, n0, _URGR,
  0,
  [_rGI, _sGI],
  [[0, 1], 64 | 0]
];
export var UpdateResourceGatewayResponse$: StaticStructureSchema = [3, n0, _URGRp,
  0,
...
export var UpdateServiceNetworkRequest$: StaticStructureSchema = [3, n0, _USNR,
  0,
  [_sNI, _aT],
  [[0, 1], 0]
];
export var UpdateServiceNetworkResponse$: StaticStructureSchema = [3, n0, _USNRp,
  0,
  [_i, _n, _a, _aT],
  [0, 0, 0, 0]
];
...
export var UpdateTargetGroupResponse$: StaticStructureSchema = [3, n0, _UTGRp,
  0,
  [_i, _a, _n, _ty, _co, _st],
  [0, 0, 0, 0, () => TargetGroupConfig$, 0]
];
...
export var WeightedTargetGroup$: StaticStructureSchema = [3, n0, _WTG,
  0,
  [_tGI, _w],
  [0, 1]
];
...
var HeaderMatchList: StaticListSchema = [1, n0, _HML,
  0, () => HeaderMatch$
];
...
var ResourceConfigurationSummaryList: StaticListSchema = [1, n0, _RCSL,
  0, () => ResourceConfigurationSummary$
];
var ResourceEndpointAssociationList: StaticListSchema = [1, n0, _REAL,
  0, () => ResourceEndpointAssociationSummary$
];
var ResourceGatewayList: StaticListSchema = [1, n0, _RGL,
  0, () => ResourceGatewaySummary$
];
var RuleSummaryList: StaticListSchema = [1, n0, _RSL,
  0, () => RuleSummary$
];
var RuleUpdateFailureList: StaticListSchema = [1, n0, _RUFL,
  0, () => RuleUpdateFailure$
];
var RuleUpdateList: StaticListSchema = [1, n0, _RUL,
  0, () => RuleUpdate$
];
var RuleUpdateSuccessList: StaticListSchema = [1, n0, _RUSL,
  0, () => RuleUpdateSuccess$
];
...
var ServiceNetworkList: StaticListSchema = [1, n0, _SNL,
  0, () => ServiceNetworkSummary$
];
var ServiceNetworkResourceAssociationList: StaticListSchema = [1, n0, _SNRAL,
  0, () => ServiceNetworkResourceAssociationSummary$
];
var ServiceNetworkServiceAssociationList: StaticListSchema = [1, n0, _SNSAL,
  0, () => ServiceNetworkServiceAssociationSummary$
];
var ServiceNetworkVpcAssociationList: StaticListSchema = [1, n0, _SNVAL,
  0, () => ServiceNetworkVpcAssociationSummary$
];
var ServiceNetworkVpcEndpointAssociationList: StaticListSchema = [1, n0, _SNVEAL,
  0, () => ServiceNetworkEndpointAssociation$
];
var SubnetList = 64 | 0;
var TagKeys = 64 | 0;
var TargetFailureList: StaticListSchema = [1, n0, _TFL,
  0, () => TargetFailure$
];
...
var TargetSummaryList: StaticListSchema = [1, n0, _TSL,
  0, () => TargetSummary$
];
var ValidationExceptionFieldList: StaticListSchema = [1, n0, _VEFL,
  0, () => ValidationExceptionField$
];
var WeightedTargetGroupList: StaticListSchema = [1, n0, _WTGL,
  0, () => WeightedTargetGroup$
];
var TagMap = 128 | 0;
export var HeaderMatchType$: StaticUnionSchema = [4, n0, _HMT,
  0,
  [_ex, _pre, _con],
  [0, 0, 0]
];
export var Matcher$: StaticUnionSchema = [4, n0, _M,
  0,
  [_hCt],
  [0]
];
export var PathMatchType$: StaticUnionSchema = [4, n0, _PMT,
  0,
  [_ex, _pre],
  [0, 0]
];
...
export var RuleMatch$: StaticUnionSchema = [4, n0, _RM,
  0,
  [_hMt],
  [() => HttpMatch$]
];
export var BatchUpdateRule$: StaticOperationSchema = [9, n0, _BUR,
...
export var CreateServiceNetwork$: StaticOperationSchema = [9, n0, _CSN,
  { [_h]: ["POST", "/servicenetworks", 201] }, () => CreateServiceNetworkRequest$, () => CreateServiceNetworkResponse$
];
export var CreateServiceNetworkResourceAssociation$: StaticOperationSchema = [9, n0, _CSNRA,
...
export var CreateServiceNetworkServiceAssociation$: StaticOperationSchema = [9, n0, _CSNSA,
...
export var CreateServiceNetworkVpcAssociation$: StaticOperationSchema = [9, n0, _CSNVA,
...
export var DeleteAccessLogSubscription$: StaticOperationSchema = [9, n0, _DALS,
...
export var DeleteAuthPolicy$: StaticOperationSchema = [9, n0, _DAP,
  { [_h]: ["DELETE", "/authpolicy/{resourceIdentifier}", 204] }, () => DeleteAuthPolicyRequest$, () => DeleteAuthPolicyResponse$
];
export var DeleteDomainVerification$: StaticOperationSchema = [9, n0, _DDV,
...
export var DeleteResourceConfiguration$: StaticOperationSchema = [9, n0, _DRC,
...
export var DeleteResourceEndpointAssociation$: StaticOperationSchema = [9, n0, _DREA,
...
export var DeleteResourceGateway$: StaticOperationSchema = [9, n0, _DRG,
...
export var DeleteRule$: StaticOperationSchema = [9, n0, _DRe,
...
export var DeleteServiceNetwork$: StaticOperationSchema = [9, n0, _DSN,
  { [_h]: ["DELETE", "/servicenetworks/{serviceNetworkIdentifier}", 204] }, () => DeleteServiceNetworkRequest$, () => DeleteServiceNetworkResponse$
];
export var DeleteServiceNetworkResourceAssociation$: StaticOperationSchema = [9, n0, _DSNRA,
...
export var DeleteServiceNetworkServiceAssociation$: StaticOperationSchema = [9, n0, _DSNSA,
...
export var DeleteServiceNetworkVpcAssociation$: StaticOperationSchema = [9, n0, _DSNVA,
...
export var GetAccessLogSubscription$: StaticOperationSchema = [9, n0, _GALS,
...
export var GetResourceGateway$: StaticOperationSchema = [9, n0, _GRG,
...
export var GetService$: StaticOperationSchema = [9, n0, _GS,
  { [_h]: ["GET", "/services/{serviceIdentifier}", 200] }, () => GetServiceRequest$, () => GetServiceResponse$
];
export var GetServiceNetwork$: StaticOperationSchema = [9, n0, _GSN,
  { [_h]: ["GET", "/servicenetworks/{serviceNetworkIdentifier}", 200] }, () => GetServiceNetworkRequest$, () => GetServiceNetworkResponse$
];
export var GetServiceNetworkResourceAssociation$: StaticOperationSchema = [9, n0, _GSNRA,
...
export var GetServiceNetworkServiceAssociation$: StaticOperationSchema = [9, n0, _GSNSA,
...
export var GetServiceNetworkVpcAssociation$: StaticOperationSchema = [9, n0, _GSNVA,
...
export var ListServiceNetworks$: StaticOperationSchema = [9, n0, _LSN,
  { [_h]: ["GET", "/servicenetworks", 200] }, () => ListServiceNetworksRequest$, () => ListServiceNetworksResponse$
];
export var ListServiceNetworkServiceAssociations$: StaticOperationSchema = [9, n0, _LSNSA,
...
export var ListServiceNetworkVpcAssociations$: StaticOperationSchema = [9, n0, _LSNVA,
...
export var ListServiceNetworkVpcEndpointAssociations$: StaticOperationSchema = [9, n0, _LSNVEA,
...
export var RegisterTargets$: StaticOperationSchema = [9, n0, _RT,
  { [_h]: ["POST", "/targetgroups/{targetGroupIdentifier}/registertargets", 200] }, () => RegisterTargetsRequest$, () => RegisterTargetsResponse$
];
export var StartDomainVerification$: StaticOperationSchema = [9, n0, _SDV,
...
export var UpdateAccessLogSubscription$: StaticOperationSchema = [9, n0, _UALS,
...
export var UpdateListener$: StaticOperationSchema = [9, n0, _UL,
  { [_h]: ["PATCH", "/services/{serviceIdentifier}/listeners/{listenerIdentifier}", 200] }, () => UpdateListenerRequest$, () => UpdateListenerResponse$
];
export var UpdateResourceConfiguration$: StaticOperationSchema = [9, n0, _URC,
...
export var UpdateResourceGateway$: StaticOperationSchema = [9, n0, _URG,
  { [_h]: ["PATCH", "/resourcegateways/{resourceGatewayIdentifier}", 200] }, () => UpdateResourceGatewayRequest$, () => UpdateResourceGatewayResponse$
];
export var UpdateRule$: StaticOperationSchema = [9, n0, _URp,
...
export var UpdateService$: StaticOperationSchema = [9, n0, _US,
  { [_h]: ["PATCH", "/services/{serviceIdentifier}", 200] }, () => UpdateServiceRequest$, () => UpdateServiceResponse$
];
export var UpdateServiceNetwork$: StaticOperationSchema = [9, n0, _USN,
  { [_h]: ["PATCH", "/servicenetworks/{serviceNetworkIdentifier}", 200] }, () => UpdateServiceNetworkRequest$, () => UpdateServiceNetworkResponse$
];
export var UpdateServiceNetworkVpcAssociation$: StaticOperationSchema = [9, n0, _USNVA,
...
export var UpdateTargetGroup$: StaticOperationSchema = [9, n0, _UTG,
