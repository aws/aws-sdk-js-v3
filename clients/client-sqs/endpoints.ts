...
const AWS_TEMPLATE = "sqs.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "sqs.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "sqs.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "sqs.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "sqs.{region}.amazonaws.com";
