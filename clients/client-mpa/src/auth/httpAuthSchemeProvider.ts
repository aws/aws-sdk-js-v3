...
import { type MPAClientResolvedConfig, MPAClientConfig } from "../MPAClient";
 ...
 * @internal
 */
export const defaultMPAHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: MPAHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<MPAClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultMPAHttpAuthSchemeProvider: MPAHttpAuthSchemeProvider = (authParameters) => {
