 ...
 * ```javascript
 * import { MPAClient, UntagResourceCommand } from "@aws-sdk/client-mpa"; // ES Modules import
 * // const { MPAClient, UntagResourceCommand } = require("@aws-sdk/client-mpa"); // CommonJS import
