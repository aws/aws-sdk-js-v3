 ...
 * @public
 */
export class DeleteInactiveApprovalTeamVersionCommand extends command<DeleteInactiveApprovalTeamVersionCommandInput, DeleteInactiveApprovalTeamVersionCommandOutput>(
  _ep0,
  _mw0,
