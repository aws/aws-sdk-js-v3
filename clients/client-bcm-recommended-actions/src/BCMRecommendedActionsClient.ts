...
import {
  defaultBCMRecommendedActionsHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type BCMRecommendedActionsClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type BCMRecommendedActionsClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 */
export class BCMRecommendedActionsClient extends __Client<
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<BCMRecommendedActionsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultBCMRecommendedActionsHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: BCMRecommendedActionsClientResolvedConfig) =>
