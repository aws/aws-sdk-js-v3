...
import {
  BCMRecommendedActionsClientConfig,
 ...
 * @internal
 */
export const defaultBCMRecommendedActionsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(
  ...
  return {
    ...
    propertiesExtractor: (config: Partial<BCMRecommendedActionsClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
