...
export const defaultRegionInfoProvider: RegionInfoProvider = (region: string, options?: any) => {
  ...
  switch (region) {
    ...
    case "eu-north-1":
      regionInfo = {
        hostname: "appmesh.eu-north-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "eu-south-1":
      regionInfo = {
        hostname: "appmesh.eu-south-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "eu-west-1":
    ...
    case "me-south-1":
      regionInfo = {
        hostname: "appmesh.me-south-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "sa-east-1":
      regionInfo = {
        hostname: "appmesh.sa-east-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "us-east-1":
