...
import { type AppMeshClientResolvedConfig, AppMeshClientConfig } from "../AppMeshClient";
 ...
 * @internal
 */
export const defaultAppMeshHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: AppMeshHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultAppMeshHttpAuthSchemeProvider: AppMeshHttpAuthSchemeProvider = (authParameters) => {
