...
const serializeAws_restJson1AwsCloudMapServiceDiscovery = (
  ...
  return {
    ...
    ...(input.ipPreference != undefined && { ipPreference: input.ipPreference }),
...
const serializeAws_restJson1GatewayRouteHostnameRewrite = (
  ...
  return {
    ...(input.defaultTargetHostname != undefined && { defaultTargetHostname: input.defaultTargetHostname }),
  };
};
...
const serializeAws_restJson1GrpcGatewayRouteAction = (input: GrpcGatewayRouteAction, context: __SerdeContext): any => {
  return {
    ...(input.rewrite != undefined && {
      rewrite: serializeAws_restJson1GrpcGatewayRouteRewrite(input.rewrite, context),
    }),
...
const serializeAws_restJson1GrpcGatewayRouteMetadata = (
  ...
  return {
    ...
    ...(input.match != undefined && { match: serializeAws_restJson1GrpcMetadataMatchMethod(input.match, context) }),
...
const serializeAws_restJson1HttpGatewayRouteAction = (input: HttpGatewayRouteAction, context: __SerdeContext): any => {
  return {
    ...(input.rewrite != undefined && {
      rewrite: serializeAws_restJson1HttpGatewayRouteRewrite(input.rewrite, context),
    }),
    ...(input.target != undefined && { target: serializeAws_restJson1GatewayRouteTarget(input.target, context) }),
  };
};
...
const serializeAws_restJson1HttpGatewayRouteMatch = (input: HttpGatewayRouteMatch, context: __SerdeContext): any => {
  return {
    ...(input.headers != undefined && {
      headers: serializeAws_restJson1HttpGatewayRouteHeaders(input.headers, context),
    }),
    ...(input.hostname != undefined && {
      hostname: serializeAws_restJson1GatewayRouteHostnameMatch(input.hostname, context),
    }),
    ...(input.method != undefined && { method: input.method }),
    ...(input.path != undefined && { path: serializeAws_restJson1HttpPathMatch(input.path, context) }),
...
const serializeAws_restJson1HttpGatewayRoutePrefixRewrite = (
  ...
  return {
    ...(input.defaultPrefix != undefined && { defaultPrefix: input.defaultPrefix }),
    ...(input.value != undefined && { value: input.value }),
  };
};
...
const serializeAws_restJson1HttpGatewayRouteRewrite = (
  ...
  return {
    ...
    ...(input.path != undefined && { path: serializeAws_restJson1HttpGatewayRoutePathRewrite(input.path, context) }),
    ...(input.prefix != undefined && {
      prefix: serializeAws_restJson1HttpGatewayRoutePrefixRewrite(input.prefix, context),
    }),
  };
};
...
const serializeAws_restJson1HttpQueryParameter = (input: HttpQueryParameter, context: __SerdeContext): any => {
  return {
    ...(input.match != undefined && { match: serializeAws_restJson1QueryParameterMatch(input.match, context) }),
    ...(input.name != undefined && { name: input.name }),
  };
};
...
const serializeAws_restJson1OutlierDetection = (input: OutlierDetection, context: __SerdeContext): any => {
  return {
    ...
    ...(input.interval != undefined && { interval: serializeAws_restJson1Duration(input.interval, context) }),
    ...(input.maxEjectionPercent != undefined && { maxEjectionPercent: input.maxEjectionPercent }),
    ...(input.maxServerErrors != undefined && { maxServerErrors: input.maxServerErrors }),
  };
};
...
const serializeAws_restJson1SubjectAlternativeNameMatchers = (
  ...
  return {
    ...(input.exact != undefined && { exact: serializeAws_restJson1SubjectAlternativeNameList(input.exact, context) }),
  };
};
...
const serializeAws_restJson1SubjectAlternativeNames = (
  ...
  return {
    ...(input.match != undefined && {
      match: serializeAws_restJson1SubjectAlternativeNameMatchers(input.match, context),
    }),
  };
};
...
const serializeAws_restJson1VirtualGatewayHttpConnectionPool = (
  ...
  return {
    ...(input.maxConnections != undefined && { maxConnections: input.maxConnections }),
    ...(input.maxPendingRequests != undefined && { maxPendingRequests: input.maxPendingRequests }),
  };
};
...
const serializeAws_restJson1VirtualGatewaySpec = (input: VirtualGatewaySpec, context: __SerdeContext): any => {
  return {
    ...
    ...(input.logging != undefined && { logging: serializeAws_restJson1VirtualGatewayLogging(input.logging, context) }),
  };
};
...
const deserializeAws_restJson1BackendDefaults = (output: any, context: __SerdeContext): BackendDefaults => {
  return {
    clientPolicy:
      output.clientPolicy != undefined ? deserializeAws_restJson1ClientPolicy(output.clientPolicy, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1ClientPolicy = (output: any, context: __SerdeContext): ClientPolicy => {
  return {
    tls: output.tls != undefined ? deserializeAws_restJson1ClientPolicyTls(output.tls, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1ClientPolicyTls = (output: any, context: __SerdeContext): ClientPolicyTls => {
  return {
    ...
    ports: output.ports != undefined ? deserializeAws_restJson1PortSet(output.ports, context) : undefined,
    validation:
...
const deserializeAws_restJson1GatewayRouteData = (output: any, context: __SerdeContext): GatewayRouteData => {
  return {
    ...
    metadata:
      output.metadata != undefined ? deserializeAws_restJson1ResourceMetadata(output.metadata, context) : undefined,
    spec: output.spec != undefined ? deserializeAws_restJson1GatewayRouteSpec(output.spec, context) : undefined,
    status: output.status != undefined ? deserializeAws_restJson1GatewayRouteStatus(output.status, context) : undefined,
...
const deserializeAws_restJson1GatewayRouteSpec = (output: any, context: __SerdeContext): GatewayRouteSpec => {
  return {
    grpcRoute:
      output.grpcRoute != undefined ? deserializeAws_restJson1GrpcGatewayRoute(output.grpcRoute, context) : undefined,
    http2Route:
      output.http2Route != undefined ? deserializeAws_restJson1HttpGatewayRoute(output.http2Route, context) : undefined,
    httpRoute:
      output.httpRoute != undefined ? deserializeAws_restJson1HttpGatewayRoute(output.httpRoute, context) : undefined,
...
const deserializeAws_restJson1GatewayRouteTarget = (output: any, context: __SerdeContext): GatewayRouteTarget => {
  return {
    virtualService:
      output.virtualService != undefined
...
const deserializeAws_restJson1GrpcGatewayRoute = (output: any, context: __SerdeContext): GrpcGatewayRoute => {
  return {
    action:
      output.action != undefined ? deserializeAws_restJson1GrpcGatewayRouteAction(output.action, context) : undefined,
    match: output.match != undefined ? deserializeAws_restJson1GrpcGatewayRouteMatch(output.match, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1GrpcGatewayRouteAction = (
  ...
  return {
    rewrite:
      output.rewrite != undefined
        ? deserializeAws_restJson1GrpcGatewayRouteRewrite(output.rewrite, context)
        : undefined,
    target: output.target != undefined ? deserializeAws_restJson1GatewayRouteTarget(output.target, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1GrpcRoute = (output: any, context: __SerdeContext): GrpcRoute => {
  return {
    action: output.action != undefined ? deserializeAws_restJson1GrpcRouteAction(output.action, context) : undefined,
    match: output.match != undefined ? deserializeAws_restJson1GrpcRouteMatch(output.match, context) : undefined,
    retryPolicy:
      output.retryPolicy != undefined
        ? deserializeAws_restJson1GrpcRetryPolicy(output.retryPolicy, context)
        : undefined,
    timeout: output.timeout != undefined ? deserializeAws_restJson1GrpcTimeout(output.timeout, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1GrpcRouteAction = (output: any, context: __SerdeContext): GrpcRouteAction => {
  return {
    weightedTargets:
      output.weightedTargets != undefined
...
const deserializeAws_restJson1GrpcTimeout = (output: any, context: __SerdeContext): GrpcTimeout => {
  return {
    idle: output.idle != undefined ? deserializeAws_restJson1Duration(output.idle, context) : undefined,
    perRequest:
      output.perRequest != undefined ? deserializeAws_restJson1Duration(output.perRequest, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1HttpGatewayRoute = (output: any, context: __SerdeContext): HttpGatewayRoute => {
  return {
    action:
      output.action != undefined ? deserializeAws_restJson1HttpGatewayRouteAction(output.action, context) : undefined,
    match: output.match != undefined ? deserializeAws_restJson1HttpGatewayRouteMatch(output.match, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1HttpGatewayRouteMatch = (output: any, context: __SerdeContext): HttpGatewayRouteMatch => {
  return {
    ...
    path: output.path != undefined ? deserializeAws_restJson1HttpPathMatch(output.path, context) : undefined,
  ...
  return {
    hostname:
      output.hostname != undefined
        ...
        : undefined,
    path:
      output.path != undefined ? deserializeAws_restJson1HttpGatewayRoutePathRewrite(output.path, context) : undefined,
    prefix:
...
const deserializeAws_restJson1HttpQueryParameter = (output: any, context: __SerdeContext): HttpQueryParameter => {
  return {
    match: output.match != undefined ? deserializeAws_restJson1QueryParameterMatch(output.match, context) : undefined,
    name: __expectString(output.name),
  } as any;
};
...
const deserializeAws_restJson1HttpRoute = (output: any, context: __SerdeContext): HttpRoute => {
  return {
    action: output.action != undefined ? deserializeAws_restJson1HttpRouteAction(output.action, context) : undefined,
    match: output.match != undefined ? deserializeAws_restJson1HttpRouteMatch(output.match, context) : undefined,
    retryPolicy:
      output.retryPolicy != undefined
        ? deserializeAws_restJson1HttpRetryPolicy(output.retryPolicy, context)
        : undefined,
    timeout: output.timeout != undefined ? deserializeAws_restJson1HttpTimeout(output.timeout, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1HttpRouteMatch = (output: any, context: __SerdeContext): HttpRouteMatch => {
  return {
    headers:
      output.headers != undefined ? deserializeAws_restJson1HttpRouteHeaders(output.headers, context) : undefined,
    method: __expectString(output.method),
    path: output.path != undefined ? deserializeAws_restJson1HttpPathMatch(output.path, context) : undefined,
    prefix: __expectString(output.prefix),
    queryParameters:
...
const deserializeAws_restJson1Listener = (output: any, context: __SerdeContext): Listener => {
  return {
    connectionPool:
      output.connectionPool != undefined
    ...
    healthCheck:
      output.healthCheck != undefined
        ...
        : undefined,
    outlierDetection:
      output.outlierDetection != undefined
        ? deserializeAws_restJson1OutlierDetection(output.outlierDetection, context)
        : undefined,
    portMapping:
      output.portMapping != undefined ? deserializeAws_restJson1PortMapping(output.portMapping, context) : undefined,
    timeout:
      output.timeout != undefined
        ? deserializeAws_restJson1ListenerTimeout(__expectUnion(output.timeout), context)
        : undefined,
    tls: output.tls != undefined ? deserializeAws_restJson1ListenerTls(output.tls, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1MeshData = (output: any, context: __SerdeContext): MeshData => {
  return {
    ...
    metadata:
      output.metadata != undefined ? deserializeAws_restJson1ResourceMetadata(output.metadata, context) : undefined,
    spec: output.spec != undefined ? deserializeAws_restJson1MeshSpec(output.spec, context) : undefined,
    status: output.status != undefined ? deserializeAws_restJson1MeshStatus(output.status, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1MeshSpec = (output: any, context: __SerdeContext): MeshSpec => {
  return {
    egressFilter:
      output.egressFilter != undefined ? deserializeAws_restJson1EgressFilter(output.egressFilter, context) : undefined,
    serviceDiscovery:
...
const deserializeAws_restJson1OutlierDetection = (output: any, context: __SerdeContext): OutlierDetection => {
  return {
    baseEjectionDuration:
      output.baseEjectionDuration != undefined
        ? deserializeAws_restJson1Duration(output.baseEjectionDuration, context)
        : undefined,
    interval: output.interval != undefined ? deserializeAws_restJson1Duration(output.interval, context) : undefined,
...
const deserializeAws_restJson1RouteData = (output: any, context: __SerdeContext): RouteData => {
  return {
    ...
    spec: output.spec != undefined ? deserializeAws_restJson1RouteSpec(output.spec, context) : undefined,
    status: output.status != undefined ? deserializeAws_restJson1RouteStatus(output.status, context) : undefined,
...
const deserializeAws_restJson1RouteSpec = (output: any, context: __SerdeContext): RouteSpec => {
  return {
    grpcRoute: output.grpcRoute != undefined ? deserializeAws_restJson1GrpcRoute(output.grpcRoute, context) : undefined,
    http2Route:
      output.http2Route != undefined ? deserializeAws_restJson1HttpRoute(output.http2Route, context) : undefined,
    httpRoute: output.httpRoute != undefined ? deserializeAws_restJson1HttpRoute(output.httpRoute, context) : undefined,
    priority: __expectInt32(output.priority),
    tcpRoute: output.tcpRoute != undefined ? deserializeAws_restJson1TcpRoute(output.tcpRoute, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1SubjectAlternativeNameMatchers = (
  ...
  return {
    exact:
      output.exact != undefined ? deserializeAws_restJson1SubjectAlternativeNameList(output.exact, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1TcpRoute = (output: any, context: __SerdeContext): TcpRoute => {
  return {
    action: output.action != undefined ? deserializeAws_restJson1TcpRouteAction(output.action, context) : undefined,
    timeout: output.timeout != undefined ? deserializeAws_restJson1TcpTimeout(output.timeout, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1VirtualGatewayClientPolicy = (
  ...
  return {
    tls:
      output.tls != undefined ? deserializeAws_restJson1VirtualGatewayClientPolicyTls(output.tls, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1VirtualGatewayData = (output: any, context: __SerdeContext): VirtualGatewayData => {
  return {
    ...
    metadata:
      output.metadata != undefined ? deserializeAws_restJson1ResourceMetadata(output.metadata, context) : undefined,
    spec: output.spec != undefined ? deserializeAws_restJson1VirtualGatewaySpec(output.spec, context) : undefined,
    status:
      output.status != undefined ? deserializeAws_restJson1VirtualGatewayStatus(output.status, context) : undefined,
    virtualGatewayName: __expectString(output.virtualGatewayName),
  } as any;
};
  ...
  return {
    ...
    healthCheck:
      output.healthCheck != undefined
        ...
        : undefined,
    portMapping:
      output.portMapping != undefined
        ? deserializeAws_restJson1VirtualGatewayPortMapping(output.portMapping, context)
        : undefined,
    tls: output.tls != undefined ? deserializeAws_restJson1VirtualGatewayListenerTls(output.tls, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1VirtualGatewaySpec = (output: any, context: __SerdeContext): VirtualGatewaySpec => {
  return {
    backendDefaults:
      output.backendDefaults != undefined
    ...
    listeners:
      output.listeners != undefined
        ...
        : undefined,
    logging:
      output.logging != undefined ? deserializeAws_restJson1VirtualGatewayLogging(output.logging, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1VirtualNodeData = (output: any, context: __SerdeContext): VirtualNodeData => {
  return {
    ...
    metadata:
      output.metadata != undefined ? deserializeAws_restJson1ResourceMetadata(output.metadata, context) : undefined,
    spec: output.spec != undefined ? deserializeAws_restJson1VirtualNodeSpec(output.spec, context) : undefined,
    status: output.status != undefined ? deserializeAws_restJson1VirtualNodeStatus(output.status, context) : undefined,
  ...
  return {
    backendDefaults:
      output.backendDefaults != undefined
        ...
        : undefined,
    backends: output.backends != undefined ? deserializeAws_restJson1Backends(output.backends, context) : undefined,
    listeners: output.listeners != undefined ? deserializeAws_restJson1Listeners(output.listeners, context) : undefined,
    logging: output.logging != undefined ? deserializeAws_restJson1Logging(output.logging, context) : undefined,
    serviceDiscovery:
      output.serviceDiscovery != undefined
...
const deserializeAws_restJson1VirtualRouterData = (output: any, context: __SerdeContext): VirtualRouterData => {
  return {
    ...
    metadata:
      output.metadata != undefined ? deserializeAws_restJson1ResourceMetadata(output.metadata, context) : undefined,
    spec: output.spec != undefined ? deserializeAws_restJson1VirtualRouterSpec(output.spec, context) : undefined,
    status:
      output.status != undefined ? deserializeAws_restJson1VirtualRouterStatus(output.status, context) : undefined,
    virtualRouterName: __expectString(output.virtualRouterName),
  } as any;
};
...
const deserializeAws_restJson1VirtualServiceData = (output: any, context: __SerdeContext): VirtualServiceData => {
  return {
    ...
    metadata:
      output.metadata != undefined ? deserializeAws_restJson1ResourceMetadata(output.metadata, context) : undefined,
    spec: output.spec != undefined ? deserializeAws_restJson1VirtualServiceSpec(output.spec, context) : undefined,
    status:
      output.status != undefined ? deserializeAws_restJson1VirtualServiceStatus(output.status, context) : undefined,
    virtualServiceName: __expectString(output.virtualServiceName),
  } as any;
};
