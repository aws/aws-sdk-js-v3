...
import {
  deserializeAws_restJson1_1DescribeMeshCommand,
  serializeAws_restJson1_1DescribeMeshCommand
...
export type DescribeMeshCommandOutput = DescribeMeshOutput;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DescribeMeshCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeMeshCommand(output, context);
  }
