 ...
 * @public
 */
export class ListNetworkConnectorsCommand extends $Command
  .classBuilder<
  ...
  .s("LambdaCoreApiService", "ListNetworkConnectors", {})
  .n("LambdaCoreClient", "ListNetworkConnectorsCommand")
  .sc(ListNetworkConnectors$)
  .build() {
