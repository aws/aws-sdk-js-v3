 ...
 * @public
 */
export class CreateNetworkConnectorCommand extends $Command
  .classBuilder<
  ...
  .s("LambdaCoreApiService", "CreateNetworkConnector", {})
  .n("LambdaCoreClient", "CreateNetworkConnectorCommand")
  .sc(CreateNetworkConnector$)
  .build() {
