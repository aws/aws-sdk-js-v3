...
const serializeAws_json1_1TrialComponentArtifacts = (
  ...
  return Object.keys(input).reduce((acc: any, key: string) => {
    acc[key] = serializeAws_json1_1TrialComponentArtifact(input[key], context);
    return acc;
  }, {});
};
...
const serializeAws_json1_1TrialComponentParameters = (
  ...
  return Object.keys(input).reduce((acc: any, key: string) => {
    acc[key] = serializeAws_json1_1TrialComponentParameterValue(
      input[key],
      context
    );
    return acc;
...
const deserializeAws_json1_1TrialComponentArtifacts = (
  ...
  return Object.keys(output).reduce((acc: any, key: string) => {
    acc[key] = deserializeAws_json1_1TrialComponentArtifact(
      output[key],
      context
    );
    return acc;
...
const deserializeAws_json1_1TrialComponentParameters = (
  ...
  return Object.keys(output).reduce((acc: any, key: string) => {
    acc[key] = deserializeAws_json1_1TrialComponentParameterValue(
      output[key],
      context
    );
    return acc;
