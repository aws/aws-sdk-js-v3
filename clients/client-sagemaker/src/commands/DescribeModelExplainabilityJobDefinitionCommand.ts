 ...
 * @public
 */
export class DescribeModelExplainabilityJobDefinitionCommand extends command<DescribeModelExplainabilityJobDefinitionCommandInput, DescribeModelExplainabilityJobDefinitionCommandOutput>(
  _ep0,
  _mw0,
