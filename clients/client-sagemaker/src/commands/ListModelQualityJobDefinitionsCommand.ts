 ...
 * @public
 */
export class ListModelQualityJobDefinitionsCommand extends command<ListModelQualityJobDefinitionsCommandInput, ListModelQualityJobDefinitionsCommandOutput>(
  _ep0,
  _mw0,
