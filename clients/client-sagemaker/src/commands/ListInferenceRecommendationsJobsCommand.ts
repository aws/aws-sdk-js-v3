 ...
 * @public
 */
export class ListInferenceRecommendationsJobsCommand extends command<ListInferenceRecommendationsJobsCommandInput, ListInferenceRecommendationsJobsCommandOutput>(
  _ep0,
  _mw0,
