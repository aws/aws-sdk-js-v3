 ...
 * @public
 */
export class DescribeModelQualityJobDefinitionCommand extends command<DescribeModelQualityJobDefinitionCommandInput, DescribeModelQualityJobDefinitionCommandOutput>(
  _ep0,
  _mw0,
