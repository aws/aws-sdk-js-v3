...
import type { ListHubsRequest } from "../models/models_3";
import type { ListHubsResponse } from "../models/models_4";
 ...
 * @public
 */
export class ListHubsCommand extends command<ListHubsCommandInput, ListHubsCommandOutput>(
  _ep0,
  _mw0,
  "ListHubs",
  ListHubs$
