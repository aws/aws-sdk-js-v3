...
import { DeleteMlflowTrackingServer$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteMlflowTrackingServerCommand extends command<DeleteMlflowTrackingServerCommandInput, DeleteMlflowTrackingServerCommandOutput>(
  _ep0,
  _mw0,
