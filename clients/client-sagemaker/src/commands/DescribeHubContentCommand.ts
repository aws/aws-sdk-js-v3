...
import type { DescribeHubContentRequest } from "../models/models_2";
import type { DescribeHubContentResponse } from "../models/models_3";
 ...
 * @public
 */
export class DescribeHubContentCommand extends command<DescribeHubContentCommandInput, DescribeHubContentCommandOutput>(
  _ep0,
  _mw0,
  "DescribeHubContent",
  DescribeHubContent$
