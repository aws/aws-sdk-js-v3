 ...
 * @public
 */
export class UpdateEndpointWeightsAndCapacitiesCommand extends command<UpdateEndpointWeightsAndCapacitiesCommandInput, UpdateEndpointWeightsAndCapacitiesCommandOutput>(
  _ep0,
  _mw0,
