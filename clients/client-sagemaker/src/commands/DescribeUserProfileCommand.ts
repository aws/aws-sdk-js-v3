...
import type { DescribeUserProfileRequest, DescribeUserProfileResponse } from "../models/models_3";
 ...
 * @public
 */
export class DescribeUserProfileCommand extends command<DescribeUserProfileCommandInput, DescribeUserProfileCommandOutput>(
  _ep0,
  _mw0,
  "DescribeUserProfile",
  DescribeUserProfile$
