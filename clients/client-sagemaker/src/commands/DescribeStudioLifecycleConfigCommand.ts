 ...
 * @public
 */
export class DescribeStudioLifecycleConfigCommand extends command<DescribeStudioLifecycleConfigCommandInput, DescribeStudioLifecycleConfigCommandOutput>(
  _ep0,
  _mw0,
