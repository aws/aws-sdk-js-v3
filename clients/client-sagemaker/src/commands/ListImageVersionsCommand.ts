...
import type { ListImageVersionsRequest, ListImageVersionsResponse } from "../models/models_4";
 ...
 * @public
 */
export class ListImageVersionsCommand extends command<ListImageVersionsCommandInput, ListImageVersionsCommandOutput>(
  _ep0,
  _mw0,
  "ListImageVersions",
  ListImageVersions$
