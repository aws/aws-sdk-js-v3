 ...
 * ```
 *
 * @param CreateNotebookInstanceLifecycleConfigInput - {@link CreateNotebookInstanceLifecycleConfigInput}
 * @returns {@link CreateNotebookInstanceLifecycleConfigOutput}
