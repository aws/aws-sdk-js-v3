 ...
 * ```
 *
 * @param DescribeNotebookInstanceLifecycleConfigInput - {@link DescribeNotebookInstanceLifecycleConfigInput}
 * @returns {@link DescribeNotebookInstanceLifecycleConfigOutput}
