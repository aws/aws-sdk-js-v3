...
import type { UpdateModelCardRequest, UpdateModelCardResponse } from "../models/models_5";
 ...
 * @public
 */
export class UpdateModelCardCommand extends command<UpdateModelCardCommandInput, UpdateModelCardCommandOutput>(
  _ep0,
  _mw0,
  "UpdateModelCard",
  UpdateModelCard$
