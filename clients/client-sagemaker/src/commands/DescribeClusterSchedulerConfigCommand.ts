 ...
 * @public
 */
export class DescribeClusterSchedulerConfigCommand extends command<DescribeClusterSchedulerConfigCommandInput, DescribeClusterSchedulerConfigCommandOutput>(
  _ep0,
  _mw0,
