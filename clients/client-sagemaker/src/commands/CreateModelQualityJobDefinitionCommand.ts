 ...
 * @public
 */
export class CreateModelQualityJobDefinitionCommand extends command<CreateModelQualityJobDefinitionCommandInput, CreateModelQualityJobDefinitionCommandOutput>(
  _ep0,
  _mw0,
