...
const makePagedClientRequest = async (
  ...
  // @ts-ignore
  return await client.send(new ListResourceCatalogsCommand(input), ...args);
};
/**
 * @public
 */
export async function* paginateListResourceCatalogs(
  ...
  let hasNext = true;
  let page: ListResourceCatalogsCommandOutput;
  while (hasNext) {
