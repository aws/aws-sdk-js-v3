...
const makePagedClientRequest = async (
  ...
  // @ts-ignore
  return await client.send(new ListStageDevicesCommand(input), ...args);
};
/**
 * @private
 */
const makePagedRequest = async (
  ...
  // @ts-ignore
  return await client.listStageDevices(input, ...args);
};
export async function* paginateListStageDevices(
  ...
  let hasNext = true;
  let page: ListStageDevicesCommandOutput;
  while (hasNext) {
