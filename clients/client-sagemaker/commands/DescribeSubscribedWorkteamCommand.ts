...
export type DescribeSubscribedWorkteamCommandOutput = DescribeSubscribedWorkteamResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1DescribeSubscribedWorkteamCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1DescribeSubscribedWorkteamCommand(
      output,
      context
    );
  }
