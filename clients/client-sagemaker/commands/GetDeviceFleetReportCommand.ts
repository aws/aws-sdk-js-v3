...
export type GetDeviceFleetReportCommandInput = GetDeviceFleetReportRequest;
export type GetDeviceFleetReportCommandOutput = GetDeviceFleetReportResponse & __MetadataBearer;
