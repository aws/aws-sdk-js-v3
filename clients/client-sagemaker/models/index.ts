...
export interface AlgorithmSpecification {
  ...
  /**
   *
   *          <p>To generate and save time-series metrics during training, set to <code>true</code>. The
   *         default is <code>false</code> and time-series metrics aren't generated except in the
   *         following cases:</p>
   *          <ul>
   *             <li>
   ...
   *             </li>
   *             <li>
   *                <p>You use one of the following prebuilt Amazon SageMaker Docker images:</p>
   *                <ul>
   *                   <li>
   *                      <p>Tensorflow</p>
   *                   </li>
...
export interface AnnotationConsolidationConfig {
   ...
   *             <li>
   *                 <p>
   *                   <i>Semantic segmentation verification</i> - Uses a
   ...
   *                 annotations from workers as "votes" for the correct
   *                 label.</p>
   *                 <p>
   ...
   *                 </li>
   *          </ul>
   *         <p>For more information, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/sms-annotation-consolidation.html">Annotation Consolidation</a>.</p>
   *
   */
...
export interface Channel {
   ...
   *             need to set this attribute. For more information, see <a href="https://mxnet.apache.org/api/architecture/note_data_loading#data-format">Create a Dataset Using RecordIO</a>. </p>
...
export interface CheckpointConfig {
  ...
  /**
   *
   *          <p>(Optional) The local directory where checkpoints are written. The default directory
  ...
  /**
   *
   *          <p>Identifies the S3 path where you want Amazon SageMaker to store checkpoints. For
...
export interface ContainerDefinition {
   ...
   *             value for this parameter for a <code>ContainerDefinition</code> that is part of an
   ...
   *             For more information on built-in algorithms, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-algo-docker-registry-paths.html">Common Parameters</a>. </p>
   ...
   *             need to reactivate AWS STS for that region. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html">Activating and Deactivating AWS STS in an AWS Region</a> in the
...
export interface CreateEndpointConfigInput {
   ...
   *             request a <code>KmsKeyId</code> when using an instance type with local storage. If any of the models
   *             that you specify in the <code>ProductionVariants</code> parameter use nitro-based
   *             instances with local storage, do not specify a value for the <code>KmsKeyId</code> parameter. If you
   *             specify a value for <code>KmsKeyId</code> when using any nitro-based instances with local storage,
   *             the call to <code>CreateEndpointConfig</code> fails.</p>
   *             <p>For a list of instance types that support local instance storage, see
   *             <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/InstanceStorage.html#instance-store-volumes">Instance Store Volumes</a>.</p>
   *             <p>For more information about local instance storage encryption, see
   *             <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ssd-instance-store.html">SSD Instance Store Volumes</a>.</p>
   *         </note>
   *
   */
  KmsKeyId?: string;
...
export interface CreateModelInput {
   ...
   *         <note>
   *             <p>The Semantic Segmentation built-in algorithm does not support network
   *                 isolation.</p>
   *         </note>
   *
   */
...
export interface CreateNotebookInstanceInput {
   ...
   *                 Elastic Inference in Amazon SageMaker</a>.</p>
   *
   */
   ...
   *             information, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/nbi-git-repo.html">Associating Git Repositories with Amazon SageMaker Notebook Instances</a>.</p>
   *
   */
   ...
   *             account, or the URL of a Git repository in <a href="https://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html">AWS
   ...
   *             see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/nbi-git-repo.html">Associating Git
   ...
   *             enabled. For information, see <a href="https://docs.aws.amazon.com/kms/latest/developerguide/enabling-keys.html">Enabling and
   *                 Disabling Keys</a> in the <i>AWS Key Management Service Developer Guide</i>.</p>
   *
   */
  KmsKeyId?: string;
...
export interface CreateTrainingJobRequest {
  ...
  /**
   *
   *          <p>To train models using managed spot training, choose <code>True</code>. Managed spot training
   ...
   *             Amazon SageMaker provides metrics and logs in CloudWatch. They can be used to see when
   *             managed spot training jobs are running, interrupted, resumed, or completed.
   *         </p>
   *
   */
   ...
   *                 <code>validation_data</code>. The configuration for each channel provides the S3, EFS, or FSx
   *             location where the input data is stored. It also provides information about the stored
   *             data: the MIME type, compression method, and whether the data is wrapped in RecordIO
   *             format. </p>
   ...
   *             files will be made available as input streams. They do not need to be downloaded.</p>
   *
   */
...
export interface CreateTransformJobRequest {
   ...
   *         <p>To enable the batch strategy, you must set the <code>SplitType</code> property of
   *             the <a>DataProcessing</a> object to <code>Line</code>, <code>RecordIO</code>,
   ...
   *             For more information, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/batch-transform-data-processing.html">Associate Prediction Results with their Corresponding Input Records</a>.</p>
   *
   */
   ...
   *             <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/your-algorithms-batch-code.html#your-algorithms-batch-code-how-containe-serves-requests">How Containers Serve Requests</a>. For built-in algorithms, you don't need to
...
export interface CreateWorkteamRequest {
   ...
   *             the Amazon Cognito user pool that makes up the work team. For more information, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-identity-pools.html">Amazon Cognito User Pools</a>.</p>
 ...
 *             a specific version of an image. For information about Amazon ECR paths, see <a href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/docker-pull-ecr-image.html">Pulling
...
export interface DescribeNotebookInstanceOutput extends $MetadataBearer {
   ...
   *             URL of Git repositories in <a href="https://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html">AWS
   *                 CodeCommit</a> or in any other Git repository. These repositories are cloned at
   *             the same level as the default repository of your notebook instance. For more
   *             information, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/nbi-git-repo.html">Associating Git Repositories with Amazon SageMaker Notebook Instances</a>.</p>
   *
...
export interface DescribeTrainingJobResponse extends $MetadataBearer {
   ...
   *         <code>BillableTimeInSeconds</code> is 100 and <code>TrainingTimeInSeconds</code> is 500,
   *         the savings is 80%.</p>
   *
   */
   ...
   *                                 training instances were interrupted. </p>
   *                         </li>
   *                   <li>
   *                             <p>
  ...
  /**
   *
   *         <p>Specifies a limit to how long a model training job can run. It also
   *             specifies the maximum time to wait for a spot instance. When the job reaches the
   *             time limit, Amazon SageMaker ends the training job. Use this API to cap model training costs.</p>
   *         <p>To stop a job, Amazon SageMaker sends the algorithm the <code>SIGTERM</code> signal, which delays
   *             job termination for 120 seconds. Algorithms can use this 120-second window to save the
   *             model artifacts, so the results of training are not lost. </p>
...
export interface DescribeTransformJobResponse extends $MetadataBearer {
   ...
   *             an Amazon S3
   *             object.
   *             For more information, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/logging-cloudwatch.html">Log Amazon SageMaker Events
...
export interface FileSystemDataSource {
  ...
  /**
   *
   *          <p>The access mode of the mount of the directory associated with the channel.
   *          A directory can be mounted either in <code>ro</code> (read-only) or <code>rw</code> (read-write) mode.</p>
   *
   */
...
export interface Filter {
  ...
  /**
   *
   *         <p>A property name. For example, <code>TrainingJobName</code>. For the list of valid
   *             property names returned in a search result for each supported resource, see
   *                 <a>TrainingJob</a>
   *           properties. You must specify a valid
   *             property name for the resource.</p>
   *
   */
  Name: string | undefined;
...
export interface GetSearchSuggestionsRequest {
  ...
  /**
   *
   *         <p>The name of the Amazon SageMaker resource to Search for. The only valid <code>Resource</code>
   *             value is <code>TrainingJob</code>.</p>
   *
   */
...
export interface HumanLoopConfig {
   ...
   *             </li>
   *          </ul>
   *         <p>Use one of the following prices for Textract AnalyzeDocument Important Form Key Amazon Augmented AI review tasks. Prices are in US
   *             dollars.</p>
   *         <ul>
   *             <li>
   *                 <p>2.400
   ...
   *             </li>
   *          </ul>
   *         <p>Use one of the following prices for Rekognition DetectModerationLabels Amazon Augmented AI review tasks. Prices are in US
   *             dollars.</p>
   *         <ul>
   *             <li>
   *                 <p>1.200
   ...
   *             </li>
   *          </ul>
   *         <p>Use one of the following prices for Amazon Augmented AI custom human review tasks. Prices are in US
   *             dollars.</p>
   *         <ul>
   *             <li>
   *                 <p>1.200
...
export interface HumanTaskConfig {
   ...
   *             same time. Also referred to as batch size. Each object may have more than one worker at one time.</p>
   *
   */
   ...
   *                 (43200)</b>. For private and vendor workforces, the maximum is as
   *             listed.</p>
   *
   */
  TaskAvailabilityLifetimeInSeconds?: number;
...
export interface HyperParameterTuningJobConfig {
   ...
   *             to use for the training job it launches. To use the Bayesian search strategy, set this to
   *                 <code>Bayesian</code>. To randomly search, set it to <code>Random</code>. For
   *             information about search strategies, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/automatic-model-tuning-how-it-works.html">How Hyperparameter Tuning Works</a>.</p>
   *
   */
...
export interface HyperParameterTuningJobWarmStartConfig {
   ...
   *             tuning job, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/automatic-model-tuning-warm-start.html">Using a Previous Hyperparameter Tuning Job as a Starting Point</a>.</p>
...
export interface LabelingJobSummary {
   ...
   *             information, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/sms-annotation-consolidation.html">Annotation Consolidation</a>.</p>
   *
   */
...
export interface ListTrialComponentsRequest {
  ...
  /**
   *
   *          <p>A filter that returns only components that have the specified source
 ...
 *
 *         <p>Defines
 *             a list of <code>NestedFilters</code> objects. To satisfy the conditions specified in the
 *                 <code>NestedFilters</code> call, a resource must satisfy the conditions of all of
 *             the filters.</p>
 ...
 *             objects.
 *         </p>
 *         <p>A <code>NestedFilters</code> object contains multiple filters. For example, to find
 *             all training jobs whose name contains
 *                 <code>train</code>
 *             and that have <code>cat/data</code> in their <code>S3Uri</code>
 *
 *             (specified in <code>InputDataConfig</code>), you need to create a
 *                 <code>NestedFilters</code> object that
 *             specifies
 *             the <code>InputDataConfig</code> property with the following
 *                 <code>Filter</code> objects:</p>
 *         <ul>
 *             <li>
 *                 <p>
 ...
 *                         "Operator":"CONTAINS", "Value":"cat/data"}'</code>
 *                 </p>
 *             </li>
 *          </ul>
 *
...
export interface NestedFilters {
   ...
   *
   *         <p>The
   *             name of the property to use in the nested filters. The value must match a listed
...
export interface ProductionVariant {
   ...
   *             <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/ei.html">Using Elastic Inference in
...
/**
 *
 *         <p>A type of <code>SuggestionQuery</code>. A suggestion query for retrieving property
 *             names that match the specified hint.</p>
 *
 */
export interface PropertyNameQuery {
  ...
  /**
   *
   *         <p>Text that is part of a property's name.
   *             The
   *             property names of hyperparameter, metric, and tag key names that
   *             begin with the specified text in the <code>PropertyNameHint</code>.</p>
   *
   */
...
export interface ResourceConfig {
  ...
  /**
   *
   *         <p>The AWS KMS key that Amazon SageMaker uses to encrypt data on the storage volume
   *             attached to the ML compute instance(s) that run the training job.</p>
   *         <note>
   *             <p>Certain Nitro-based instances include local storage, dependent on the instance type.
   *             Local storage volumes are encrypted using a hardware module on the instance. You can't
   *             request a <code>VolumeKmsKeyId</code> when using an instance type with local storage.</p>
   *             <p>For a list of instance types that support local instance storage, see
   *             <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/InstanceStorage.html#instance-store-volumes">Instance Store Volumes</a>.</p>
   *             <p>For more information about local instance storage encryption, see
   *             <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ssd-instance-store.html">SSD Instance Store Volumes</a>.</p>
   ...
   *             total size per instance type, see
   *             <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/InstanceStorage.html#instance-store-volumes">Instance Store Volumes</a>.</p>
   *         </note>
   *
   */
 ...
 *
 *         <p>A
 *             multi-expression that searches for the specified resource or resources in a
 *             search. All resource objects that satisfy the expression's condition
 *             are included in the search results. You must specify at least one subexpression, filter,
 *             or nested filter. A <code>SearchExpression</code> can contain up to twenty
 *             elements.</p>
...
export interface SearchRequest {
  ...
  /**
   *
   *         <p>The name of the Amazon SageMaker resource to search for. Currently, the only valid
 ...
 *         <p>For Pipe input mode, shuffling is done at the start of every epoch. With large
 *             datasets, this ensures that the order of the training data is different for each epoch,
 *             and it helps reduce bias and possible overfitting. In a multi-node training job when
 *                 <code>ShuffleConfig</code> is combined with <code>S3DataDistributionType</code> of
 *                 <code>ShardedByS3Key</code>, the data is shuffled across nodes so that the content
 *             sent to a particular node on the first epoch might be sent to a different node on the
 *             second epoch.</p>
 *
 ...
 *             specifies how long you are willing to wait for a managed spot training job to complete. When the
 *             job reaches the time limit, Amazon SageMaker ends the training or compilation job. Use this API to
 *             cap model training costs.</p>
 *         <p>To stop a job, Amazon SageMaker sends the algorithm the <code>SIGTERM</code> signal, which delays
 *             job termination for 120 seconds. Algorithms can use this 120-second window to save the
 *             model artifacts, so the results of training are not lost. </p>
...
export interface StoppingCondition {
  ...
  /**
   *
   *         <p>The maximum length of time, in seconds, how long you are willing to wait for a
   *             managed spot training job to complete. It is the amount of time spent waiting for Spot capacity
   *             plus the amount of time the training job runs. It must be equal to or greater
   *             than <code>MaxRuntimeInSeconds</code>.
   *         </p>
   *
   */
...
export interface SuggestionQuery {
  ...
  /**
   *
   *         <p>A type of <code>SuggestionQuery</code>. Defines a property name hint. Only property
   *             names that match the specified hint are included in the response.</p>
   *
   */
...
export interface TransformInput {
   ...
   *             <p>For more information about <code>RecordIO</code>, see
   *                 <a href="https://mxnet.apache.org/api/faq/recordio">Create a Dataset Using RecordIO</a>
   *                 in the MXNet documentation. For more information about <code>TFRecord</code>, see
   *                 <a href="https://www.tensorflow.org/guide/datasets#consuming_tfrecord_data">Consuming TFRecord data</a>
   *                 in the TensorFlow documentation.</p>
   *         </note>
   *
   */
...
export interface UiConfig {
   ...
   *             of a UI template, see <a href="https://docs.aws.amazon.com/sagemaker/latest/dg/sms-custom-templates-step2.html"> Creating
   *                 Your Custom Labeling Task Template</a>.</p>
   *
   */
