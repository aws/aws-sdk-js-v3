...
export var BatchDeleteDetectorErrorEntries: StaticListSchema = [1, n0, _BDDEEa, 0, () => BatchDeleteDetectorErrorEntry];
export var BatchPutMessageErrorEntries: StaticListSchema = [1, n0, _BPMEEa, 0, () => BatchPutMessageErrorEntry];
export var BatchUpdateDetectorErrorEntries: StaticListSchema = [1, n0, _BUDEEa, 0, () => BatchUpdateDetectorErrorEntry];
export var DeleteDetectorRequests: StaticListSchema = [1, n0, _DDRel, 0, () => DeleteDetectorRequest];
export var DetectorSummaries: StaticListSchema = [1, n0, _DSet, 0, () => DetectorSummary];
export var DisableAlarmActionRequests: StaticListSchema = [1, n0, _DAARi, 0, () => DisableAlarmActionRequest];
export var EnableAlarmActionRequests: StaticListSchema = [1, n0, _EAARn, 0, () => EnableAlarmActionRequest];
export var Messages: StaticListSchema = [1, n0, _Me, 0, () => Message];
export var ResetAlarmActionRequests: StaticListSchema = [1, n0, _RAARe, 0, () => ResetAlarmActionRequest];
export var SnoozeAlarmActionRequests: StaticListSchema = [1, n0, _SAARn, 0, () => SnoozeAlarmActionRequest];
export var TimerDefinitions: StaticListSchema = [1, n0, _TDi, 0, () => TimerDefinition];
export var Timers: StaticListSchema = [1, n0, _Ti, 0, () => Timer];
export var UpdateDetectorRequests: StaticListSchema = [1, n0, _UDRp, 0, () => UpdateDetectorRequest];
export var VariableDefinitions: StaticListSchema = [1, n0, _VDa, 0, () => VariableDefinition];
