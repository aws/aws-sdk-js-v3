...
export var AlarmSummary$: StaticStructureSchema = [3, n0, _ASl,
  0,
...
export var BatchAlarmActionErrorEntry$: StaticStructureSchema = [3, n0, _BAAEE,
  0,
  [_rI, _eC, _eM],
  [0, 0, 0]
];
export var BatchDeleteDetectorErrorEntry$: StaticStructureSchema = [3, n0, _BDDEE,
  0,
  [_mI, _eC, _eM],
  [0, 0, 0]
];
...
export var BatchUpdateDetectorErrorEntry$: StaticStructureSchema = [3, n0, _BUDEE,
  0,
  [_mI, _eC, _eM],
  [0, 0, 0]
];
...
export var CustomerAction$: StaticStructureSchema = [3, n0, _CA,
  0,
...
export var DetectorSummary$: StaticStructureSchema = [3, n0, _DSe,
  0,
  [_dMN, _kV, _dMV, _st, _cT, _lUT],
  [0, 0, 0, () => DetectorStateSummary$, 4, 4]
];
export var DisableActionConfiguration$: StaticStructureSchema = [3, n0, _DAC,
  0,
  [_n],
  [0]
];
...
export var SnoozeActionConfiguration$: StaticStructureSchema = [3, n0, _SAC,
  0,
  [_sD, _n],
  [1, 0]
];
...
export var SystemEvent$: StaticStructureSchema = [3, n0, _SE,
  0,
  [_eT, _sCC],
...
var AlarmSummaries: StaticListSchema = [1, n0, _ASla,
  0, () => AlarmSummary$
];
var BatchAlarmActionErrorEntries: StaticListSchema = [1, n0, _BAAEEa,
  0, () => BatchAlarmActionErrorEntry$
];
var BatchDeleteDetectorErrorEntries: StaticListSchema = [1, n0, _BDDEEa,
  0, () => BatchDeleteDetectorErrorEntry$
];
var BatchPutMessageErrorEntries: StaticListSchema = [1, n0, _BPMEEa,
  0, () => BatchPutMessageErrorEntry$
];
var BatchUpdateDetectorErrorEntries: StaticListSchema = [1, n0, _BUDEEa,
  0, () => BatchUpdateDetectorErrorEntry$
];
var DeleteDetectorRequests: StaticListSchema = [1, n0, _DDRel,
  0, () => DeleteDetectorRequest$
];
var DetectorSummaries: StaticListSchema = [1, n0, _DSet,
  0, () => DetectorSummary$
];
var DisableAlarmActionRequests: StaticListSchema = [1, n0, _DAARi,
  0, () => DisableAlarmActionRequest$
];
var EnableAlarmActionRequests: StaticListSchema = [1, n0, _EAARn,
  0, () => EnableAlarmActionRequest$
];
var Messages: StaticListSchema = [1, n0, _Me,
  0, () => Message$
];
var ResetAlarmActionRequests: StaticListSchema = [1, n0, _RAARe,
  0, () => ResetAlarmActionRequest$
];
var SnoozeAlarmActionRequests: StaticListSchema = [1, n0, _SAARn,
  0, () => SnoozeAlarmActionRequest$
];
var TimerDefinitions: StaticListSchema = [1, n0, _TDi,
  0, () => TimerDefinition$
];
var Timers: StaticListSchema = [1, n0, _Ti,
  0, () => Timer$
];
var UpdateDetectorRequests: StaticListSchema = [1, n0, _UDRp,
  0, () => UpdateDetectorRequest$
];
var VariableDefinitions: StaticListSchema = [1, n0, _VDa,
  0, () => VariableDefinition$
];
var Variables: StaticListSchema = [1, n0, _Va,
  0, () => Variable$
];
export var BatchAcknowledgeAlarm$: StaticOperationSchema = [9, n0, _BAA,
  { [_h]: ["POST", "/alarms/acknowledge", 202] }, () => BatchAcknowledgeAlarmRequest$, () => BatchAcknowledgeAlarmResponse$
];
export var BatchDeleteDetector$: StaticOperationSchema = [9, n0, _BDD,
  { [_h]: ["POST", "/detectors/delete", 200] }, () => BatchDeleteDetectorRequest$, () => BatchDeleteDetectorResponse$
];
export var BatchDisableAlarm$: StaticOperationSchema = [9, n0, _BDA,
  { [_h]: ["POST", "/alarms/disable", 202] }, () => BatchDisableAlarmRequest$, () => BatchDisableAlarmResponse$
];
export var BatchEnableAlarm$: StaticOperationSchema = [9, n0, _BEA,
  { [_h]: ["POST", "/alarms/enable", 202] }, () => BatchEnableAlarmRequest$, () => BatchEnableAlarmResponse$
];
export var BatchPutMessage$: StaticOperationSchema = [9, n0, _BPM,
  { [_h]: ["POST", "/inputs/messages", 200] }, () => BatchPutMessageRequest$, () => BatchPutMessageResponse$
];
export var BatchResetAlarm$: StaticOperationSchema = [9, n0, _BRA,
  { [_h]: ["POST", "/alarms/reset", 202] }, () => BatchResetAlarmRequest$, () => BatchResetAlarmResponse$
];
export var BatchSnoozeAlarm$: StaticOperationSchema = [9, n0, _BSA,
  { [_h]: ["POST", "/alarms/snooze", 202] }, () => BatchSnoozeAlarmRequest$, () => BatchSnoozeAlarmResponse$
];
export var BatchUpdateDetector$: StaticOperationSchema = [9, n0, _BUD,
  { [_h]: ["POST", "/detectors", 200] }, () => BatchUpdateDetectorRequest$, () => BatchUpdateDetectorResponse$
];
export var DescribeAlarm$: StaticOperationSchema = [9, n0, _DA,
  { [_h]: ["GET", "/alarms/{alarmModelName}/keyValues", 200] }, () => DescribeAlarmRequest$, () => DescribeAlarmResponse$
];
export var DescribeDetector$: StaticOperationSchema = [9, n0, _DD,
  { [_h]: ["GET", "/detectors/{detectorModelName}/keyValues", 200] }, () => DescribeDetectorRequest$, () => DescribeDetectorResponse$
];
export var ListAlarms$: StaticOperationSchema = [9, n0, _LA,
  { [_h]: ["GET", "/alarms/{alarmModelName}", 200] }, () => ListAlarmsRequest$, () => ListAlarmsResponse$
];
export var ListDetectors$: StaticOperationSchema = [9, n0, _LD,
