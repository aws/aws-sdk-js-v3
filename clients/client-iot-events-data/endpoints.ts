...
const AWS_TEMPLATE = "ioteventsdata.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "ioteventsdata.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "ioteventsdata.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "ioteventsdata.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "ioteventsdata.{region}.amazonaws.com";
