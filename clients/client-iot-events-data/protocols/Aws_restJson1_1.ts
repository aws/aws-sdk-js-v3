...
export const serializeAws_restJson1_1BatchUpdateDetectorCommand = async (
  ...
  body = JSON.stringify({
    ...(input.detectors !== undefined && {
      detectors: serializeAws_restJson1_1UpdateDetectorRequests(input.detectors, context)
    })
  });
  const { hostname, protocol = "https", port } = await context.endpoint();
  return new __HttpRequest({
...
export const deserializeAws_restJson1_1BatchUpdateDetectorCommand = async (
  ...
  if (output.statusCode !== 200 && output.statusCode >= 400) {
    return deserializeAws_restJson1_1BatchUpdateDetectorCommandError(output, context);
  }
...
export const deserializeAws_restJson1_1DescribeDetectorCommand = async (
  ...
  if (output.statusCode !== 200 && output.statusCode >= 400) {
    return deserializeAws_restJson1_1DescribeDetectorCommandError(output, context);
  }
  ...
  if (data.detector !== undefined && data.detector !== null) {
    contents.detector = deserializeAws_restJson1_1Detector(data.detector, context);
  }
  return Promise.resolve(contents);
};
...
export const deserializeAws_restJson1_1ListDetectorsCommand = async (
  ...
  if (data.detectorSummaries !== undefined && data.detectorSummaries !== null) {
    contents.detectorSummaries = deserializeAws_restJson1_1DetectorSummaries(data.detectorSummaries, context);
  }
...
const serializeAws_restJson1_1DetectorStateDefinition = (
  ...
  return {
    ...
    ...(input.variables !== undefined && {
      variables: serializeAws_restJson1_1VariableDefinitions(input.variables, context)
    })
  };
};
...
const serializeAws_restJson1_1TimerDefinition = (input: TimerDefinition, context: __SerdeContext): any => {
  return {
...
const serializeAws_restJson1_1TimerDefinitions = (input: TimerDefinition[], context: __SerdeContext): any => {
  return input.map(entry => serializeAws_restJson1_1TimerDefinition(entry, context));
};

const serializeAws_restJson1_1UpdateDetectorRequest = (input: UpdateDetectorRequest, context: __SerdeContext): any => {
  return {
    ...
    ...(input.state !== undefined && {
      state: serializeAws_restJson1_1DetectorStateDefinition(input.state, context)
    })
  };
};
...
const serializeAws_restJson1_1UpdateDetectorRequests = (
  ...
  return input.map(entry => serializeAws_restJson1_1UpdateDetectorRequest(entry, context));
};

const serializeAws_restJson1_1VariableDefinition = (input: VariableDefinition, context: __SerdeContext): any => {
  return {
    ...(input.name !== undefined && { name: input.name }),
...
const serializeAws_restJson1_1VariableDefinitions = (input: VariableDefinition[], context: __SerdeContext): any => {
  return input.map(entry => serializeAws_restJson1_1VariableDefinition(entry, context));
};
...
const deserializeAws_restJson1_1BatchPutMessageErrorEntries = (
  ...
  return (output || []).map((entry: any) => deserializeAws_restJson1_1BatchPutMessageErrorEntry(entry, context));
};
...
const deserializeAws_restJson1_1BatchUpdateDetectorErrorEntries = (
  ...
  return (output || []).map((entry: any) => deserializeAws_restJson1_1BatchUpdateDetectorErrorEntry(entry, context));
};
...
const deserializeAws_restJson1_1Detector = (output: any, context: __SerdeContext): Detector => {
  return {
    __type: "Detector",
    creationTime:
...
const deserializeAws_restJson1_1DetectorState = (output: any, context: __SerdeContext): DetectorState => {
  return {
...
const deserializeAws_restJson1_1DetectorStateSummary = (output: any, context: __SerdeContext): DetectorStateSummary => {
  return {
...
const deserializeAws_restJson1_1DetectorSummaries = (output: any, context: __SerdeContext): DetectorSummary[] => {
  return (output || []).map((entry: any) => deserializeAws_restJson1_1DetectorSummary(entry, context));
};

const deserializeAws_restJson1_1DetectorSummary = (output: any, context: __SerdeContext): DetectorSummary => {
  return {
...
const deserializeAws_restJson1_1Timer = (output: any, context: __SerdeContext): Timer => {
  return {
    __type: "Timer",
...
const deserializeAws_restJson1_1Timers = (output: any, context: __SerdeContext): Timer[] => {
  return (output || []).map((entry: any) => deserializeAws_restJson1_1Timer(entry, context));
};
