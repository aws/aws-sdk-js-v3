...
import type { UpdateSecurityConfigRequest, UpdateSecurityConfigResponse } from "../models/models_0";
import { UpdateSecurityConfig$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateSecurityConfigCommand extends command<UpdateSecurityConfigCommandInput, UpdateSecurityConfigCommandOutput>(
  _ep0,
  _mw0,
