...
import type { GetSecurityConfigRequest, GetSecurityConfigResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetSecurityConfigCommand extends command<GetSecurityConfigCommandInput, GetSecurityConfigCommandOutput>(
  _ep0,
  _mw0,
  "GetSecurityConfig",
  GetSecurityConfig$
