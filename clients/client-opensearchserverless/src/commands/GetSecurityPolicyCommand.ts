...
import type { GetSecurityPolicyRequest, GetSecurityPolicyResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetSecurityPolicyCommand extends command<GetSecurityPolicyCommandInput, GetSecurityPolicyCommandOutput>(
  _ep0,
  _mw0,
  "GetSecurityPolicy",
  GetSecurityPolicy$
