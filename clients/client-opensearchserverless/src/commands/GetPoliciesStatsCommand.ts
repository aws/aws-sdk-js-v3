...
import type { GetPoliciesStatsRequest, GetPoliciesStatsResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetPoliciesStatsCommand extends command<GetPoliciesStatsCommandInput, GetPoliciesStatsCommandOutput>(
  _ep0,
  _mw0,
  "GetPoliciesStats",
  GetPoliciesStats$
