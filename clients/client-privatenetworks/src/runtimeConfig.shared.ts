...
import { defaultPrivateNetworksHttpAuthSchemeProvider } from "./auth/httpAuthSchemeProvider";
...
export const getRuntimeConfig = (config: PrivateNetworksClientConfig) => {
  return {
    ...
    httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultPrivateNetworksHttpAuthSchemeProvider,
