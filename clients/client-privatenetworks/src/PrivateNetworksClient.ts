...
import {
  defaultPrivateNetworksHttpAuthSchemeParametersProvider,
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<PrivateNetworksClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultPrivateNetworksHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: PrivateNetworksClientResolvedConfig) =>
