...
export class CreateConfigurationSetEventDestinationCommand extends $Command<CreateConfigurationSetEventDestinationCommandInput, CreateConfigurationSetEventDestinationCommandOutput, PinpointEmailClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1CreateConfigurationSetEventDestinationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateConfigurationSetEventDestinationCommand(output, context);
  }
