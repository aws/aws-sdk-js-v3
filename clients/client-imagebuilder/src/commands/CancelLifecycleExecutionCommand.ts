...
> {
   ...
   * @public
   */
  constructor(readonly input: CancelLifecycleExecutionCommandInput) {
    super();
  }
  ...
  ): Handler<CancelLifecycleExecutionCommandInput, CancelLifecycleExecutionCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, CancelLifecycleExecutionCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: CancelLifecycleExecutionCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<CancelLifecycleExecutionCommandOutput> {
