...
> {
   ...
   * @public
   */
  constructor(readonly input: ListLifecycleExecutionsCommandInput) {
    super();
  }
  ...
  ): Handler<ListLifecycleExecutionsCommandInput, ListLifecycleExecutionsCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListLifecycleExecutionsCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: ListLifecycleExecutionsCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<ListLifecycleExecutionsCommandOutput> {
