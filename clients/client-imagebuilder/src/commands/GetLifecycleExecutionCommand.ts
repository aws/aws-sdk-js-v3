...
> {
   ...
   * @public
   */
  constructor(readonly input: GetLifecycleExecutionCommandInput) {
    super();
  }
  ...
  ): Handler<GetLifecycleExecutionCommandInput, GetLifecycleExecutionCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, GetLifecycleExecutionCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: GetLifecycleExecutionCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetLifecycleExecutionCommandOutput> {
