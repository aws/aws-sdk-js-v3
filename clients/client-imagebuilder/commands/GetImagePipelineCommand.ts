...
import {
  deserializeAws_restJson1_1GetImagePipelineCommand,
  serializeAws_restJson1_1GetImagePipelineCommand,
...
export class GetImagePipelineCommand extends $Command<GetImagePipelineCommandInput, GetImagePipelineCommandOutput, imagebuilderClientResolvedConfig> {
