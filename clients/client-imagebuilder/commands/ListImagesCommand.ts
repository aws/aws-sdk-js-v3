...
import {
  deserializeAws_restJson1_1ListImagesCommand,
  serializeAws_restJson1_1ListImagesCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ListImagesCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListImagesCommand(output, context);
  }
