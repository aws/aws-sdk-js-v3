...
export class GetInfrastructureConfigurationCommand extends $Command<GetInfrastructureConfigurationCommandInput, GetInfrastructureConfigurationCommandOutput, imagebuilderClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetInfrastructureConfigurationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetInfrastructureConfigurationCommand(output, context);
  }
