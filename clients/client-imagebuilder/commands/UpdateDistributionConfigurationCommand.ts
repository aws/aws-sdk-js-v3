...
export class UpdateDistributionConfigurationCommand extends $Command<UpdateDistributionConfigurationCommandInput, UpdateDistributionConfigurationCommandOutput, imagebuilderClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1UpdateDistributionConfigurationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1UpdateDistributionConfigurationCommand(output, context);
  }
