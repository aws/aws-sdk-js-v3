...
export declare type ServiceInputTypes = CancelDataRepositoryTaskCommandInput | CreateBackupCommandInput | CreateDataRepositoryTaskCommandInput | CreateFileSystemCommandInput | CreateFileSystemFromBackupCommandInput | DeleteBackupCommandInput | DeleteFileSystemCommandInput | DescribeBackupsCommandInput | DescribeDataRepositoryTasksCommandInput | DescribeFileSystemsCommandInput | ListTagsForResourceCommandInput | TagResourceCommandInput | UntagResourceCommandInput | UpdateFileSystemCommandInput;
export declare type ServiceOutputTypes = CancelDataRepositoryTaskCommandOutput | CreateBackupCommandOutput | CreateDataRepositoryTaskCommandOutput | CreateFileSystemCommandOutput | CreateFileSystemFromBackupCommandOutput | DeleteBackupCommandOutput | DeleteFileSystemCommandOutput | DescribeBackupsCommandOutput | DescribeDataRepositoryTasksCommandOutput | DescribeFileSystemsCommandOutput | ListTagsForResourceCommandOutput | TagResourceCommandOutput | UntagResourceCommandOutput | UpdateFileSystemCommandOutput;
...
export declare type FSxClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type FSxClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
