...
> {
   ...
   * @public
   */
  constructor(readonly input: StartMisconfiguredStateRecoveryCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<StartMisconfiguredStateRecoveryCommandInput, StartMisconfiguredStateRecoveryCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, StartMisconfiguredStateRecoveryCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "StartMisconfiguredStateRecoveryCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      logger,
      clientName,
      commandName,
      inputFilterSensitiveLog: (_: any) => _,
      outputFilterSensitiveLog: StartMisconfiguredStateRecoveryResponseFilterSensitiveLog,
      [SMITHY_CONTEXT_KEY]: {
  ...
  private serialize(
    ...
    return se_StartMisconfiguredStateRecoveryCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_StartMisconfiguredStateRecoveryCommand(output, context);
  }
