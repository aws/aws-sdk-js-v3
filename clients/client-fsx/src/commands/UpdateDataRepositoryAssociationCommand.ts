 ...
 * @public
 */
export class UpdateDataRepositoryAssociationCommand extends command<UpdateDataRepositoryAssociationCommandInput, UpdateDataRepositoryAssociationCommandOutput>(
  _ep0,
  _mw0,
