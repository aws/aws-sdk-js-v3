...
const AWS_TEMPLATE = "fsx.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "fsx.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "fsx.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "fsx.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "fsx.{region}.amazonaws.com";
// Partition regions
