...
export var SubjectToken: StaticSimpleSchema = [0, n0, _ST, 8, 0];
...
export var CreateTokenWithIAMRequest: StaticStructureSchema = [
  3,
  n0,
  _CTWIAMR,
  0,
...
export var CreateTokenWithIAMResponse: StaticStructureSchema = [
  3,
  n0,
  _CTWIAMRr,
  0,
...
export var RegisterClientResponse: StaticStructureSchema = [
  3,
  n0,
  _RCRe,
  0,
...
export var StartDeviceAuthorizationResponse: StaticStructureSchema = [
  3,
  n0,
  _SDARt,
  0,
...
export var CreateTokenWithIAM: StaticOperationSchema = [
  9,
  n0,
  _CTWIAM,
  {
...
export var RegisterClient: StaticOperationSchema = [
  9,
  n0,
  _RC,
  {
...
export var StartDeviceAuthorization: StaticOperationSchema = [
  9,
  n0,
  _SDA,
  {
