...
const deserializeAws_restJson1_1CreateTokenCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.sso.oidc#AuthorizationPendingException":
      response = {
        ...(await deserializeAws_restJson1_1AuthorizationPendingExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
    ...
    case "com.amazonaws.sso.oidc#ExpiredTokenException":
      response = {
        ...(await deserializeAws_restJson1_1ExpiredTokenExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
    ...
    case "com.amazonaws.sso.oidc#InvalidGrantException":
      response = {
        ...(await deserializeAws_restJson1_1InvalidGrantExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
    ...
    case "com.amazonaws.sso.oidc#InvalidScopeException":
      response = {
        ...(await deserializeAws_restJson1_1InvalidScopeExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
    ...
    case "com.amazonaws.sso.oidc#SlowDownException":
      response = {
        ...(await deserializeAws_restJson1_1SlowDownExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
    ...
    case "com.amazonaws.sso.oidc#UnauthorizedClientException":
      response = {
        ...(await deserializeAws_restJson1_1UnauthorizedClientExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
    ...
    case "com.amazonaws.sso.oidc#UnsupportedGrantTypeException":
      response = {
        ...(await deserializeAws_restJson1_1UnsupportedGrantTypeExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
...
const deserializeAws_restJson1_1RegisterClientCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.sso.oidc#InvalidClientMetadataException":
      response = {
        ...(await deserializeAws_restJson1_1InvalidClientMetadataExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
...
const serializeAws_restJson1_1Scopes = (input: string[], context: __SerdeContext): any => {
