 ...
 * ```javascript
 * import { SsmSapClient, ListTagsForResourceCommand } from "@aws-sdk/client-ssmsap"; // ES Modules import
 * // const { SsmSapClient, ListTagsForResourceCommand } = require("@aws-sdk/client-ssmsap"); // CommonJS import
