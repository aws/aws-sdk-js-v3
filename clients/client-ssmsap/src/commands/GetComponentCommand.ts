 ...
 * ```javascript
 * import { SsmSapClient, GetComponentCommand } from "@aws-sdk/client-ssmsap"; // ES Modules import
 * // const { SsmSapClient, GetComponentCommand } = require("@aws-sdk/client-ssmsap"); // CommonJS import
