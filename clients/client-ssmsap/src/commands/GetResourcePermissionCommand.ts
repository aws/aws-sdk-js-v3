 ...
 * ```javascript
 * import { SsmSapClient, GetResourcePermissionCommand } from "@aws-sdk/client-ssmsap"; // ES Modules import
 * // const { SsmSapClient, GetResourcePermissionCommand } = require("@aws-sdk/client-ssmsap"); // CommonJS import
