 ...
 * ```javascript
 * import { SsmSapClient, PutResourcePermissionCommand } from "@aws-sdk/client-ssmsap"; // ES Modules import
 * // const { SsmSapClient, PutResourcePermissionCommand } = require("@aws-sdk/client-ssmsap"); // CommonJS import
