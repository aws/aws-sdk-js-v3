 ...
 * ```javascript
 * import { SsmSapClient, GetApplicationCommand } from "@aws-sdk/client-ssmsap"; // ES Modules import
 * // const { SsmSapClient, GetApplicationCommand } = require("@aws-sdk/client-ssmsap"); // CommonJS import
