 ...
 * ```javascript
 * import { SsmSapClient, ListApplicationsCommand } from "@aws-sdk/client-ssmsap"; // ES Modules import
 * // const { SsmSapClient, ListApplicationsCommand } = require("@aws-sdk/client-ssmsap"); // CommonJS import
