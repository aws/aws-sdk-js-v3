...
export var InvalidTagParameterException$: StaticErrorSchema = [-3, n0, _ITPE,
  { [_e]: _c },
  [_m],
  [0]
];
n0_registry.registerError(InvalidTagParameterException$, InvalidTagParameterException);
export var LayerAlreadyExistsException$: StaticErrorSchema = [-3, n0, _LAEE,
  { [_e]: _c },
  [_m],
  [0]
];
n0_registry.registerError(LayerAlreadyExistsException$, LayerAlreadyExistsException);
export var LayerPartTooSmallException$: StaticErrorSchema = [-3, n0, _LPTSE,
  { [_e]: _c },
  [_m],
  [0]
];
n0_registry.registerError(LayerPartTooSmallException$, LayerPartTooSmallException);
export var LayersNotFoundException$: StaticErrorSchema = [-3, n0, _LNFE,
  { [_e]: _c },
  [_m],
  [0]
];
...
export var ReferencedImagesNotFoundException$: StaticErrorSchema = [-3, n0, _RINFE,
  { [_e]: _c },
  [_m],
  [0]
];
n0_registry.registerError(ReferencedImagesNotFoundException$, ReferencedImagesNotFoundException);
export var RegistryNotFoundException$: StaticErrorSchema = [-3, n0, _RNFE,
  { [_e]: _c },
  [_m],
  [0]
];
n0_registry.registerError(RegistryNotFoundException$, RegistryNotFoundException);
export var RepositoryAlreadyExistsException$: StaticErrorSchema = [-3, n0, _RAEE,
  { [_e]: _c },
  [_m],
  [0]
];
n0_registry.registerError(RepositoryAlreadyExistsException$, RepositoryAlreadyExistsException);
export var RepositoryCatalogDataNotFoundException$: StaticErrorSchema = [-3, n0, _RCDNFE,
  { [_e]: _c },
  [_m],
  [0]
];
...
export var RepositoryNotFoundException$: StaticErrorSchema = [-3, n0, _RNFEe,
  { [_e]: _c },
  [_m],
  [0]
];
n0_registry.registerError(RepositoryNotFoundException$, RepositoryNotFoundException);
export var RepositoryPolicyNotFoundException$: StaticErrorSchema = [-3, n0, _RPNFE,
  { [_e]: _c },
  [_m],
  [0]
];
...
export var UnsupportedCommandException$: StaticErrorSchema = [-3, n0, _UCE,
  { [_e]: _c },
  [_m],
  [0]
];
n0_registry.registerError(UnsupportedCommandException$, UnsupportedCommandException);
export var UploadNotFoundException$: StaticErrorSchema = [-3, n0, _UNFE,
  { [_e]: _c },
  [_m],
  [0]
];
...
export var DescribeRegistriesRequest$: StaticStructureSchema = [3, n0, _DRRes,
  0,
  [_nT, _mR],
  [0, 1]
];
...
export var DescribeRepositoriesResponse$: StaticStructureSchema = [3, n0, _DRRescri,
  0,
  [_rep, _nT],
  [() => RepositoryList, 0]
];
export var GetAuthorizationTokenRequest$: StaticStructureSchema = [3, n0, _GATR,
  0,
  [],
  []
];
export var GetAuthorizationTokenResponse$: StaticStructureSchema = [3, n0, _GATRe,
  0,
  [_aD],
  [() => AuthorizationData$]
];
export var GetRegistryCatalogDataRequest$: StaticStructureSchema = [3, n0, _GRCDR,
  0,
  [],
  []
];
...
export var ImageDetail$: StaticStructureSchema = [3, n0, _ID,
  0,
  [_rI, _rN, _iDm, _iT, _iSIB, _iPA, _iMMT, _aMT],
  [0, 0, 0, 64 | 0, 1, 4, 0, 0]
];
export var ImageFailure$: StaticStructureSchema = [3, n0, _IF,
  0,
  [_iIm, _fC, _fR],
  [() => ImageIdentifier$, 0, 0]
];
export var ImageIdentifier$: StaticStructureSchema = [3, n0, _II,
  0,
  [_iDm, _iTm],
  [0, 0]
];
export var ImageTagDetail$: StaticStructureSchema = [3, n0, _ITD,
  0,
  [_iTm, _cA, _iDma],
...
export var Layer$: StaticStructureSchema = [3, n0, _L,
  0,
  [_lDa, _lA, _lS, _mT],
  [0, 0, 1, 0]
];
export var LayerFailure$: StaticStructureSchema = [3, n0, _LF,
  0,
  [_lDa, _fC, _fR],
  [0, 0, 0]
];
...
export var PutRegistryCatalogDataRequest$: StaticStructureSchema = [3, n0, _PRCDR,
  0,
  [_dN],
  [0]
];
...
export var ReferencedImageDetail$: StaticStructureSchema = [3, n0, _RID,
  0,
...
export var Repository$: StaticStructureSchema = [3, n0, _Re,
  0,
  [_rAep, _rI, _rN, _rUe, _cA],
  [0, 0, 0, 0, 4]
];
export var RepositoryCatalogData$: StaticStructureSchema = [3, n0, _RCDe,
  0,
  [_d, _ar, _oS, _lU, _aTb, _uT, _mC],
  [0, 64 | 0, 64 | 0, 0, 0, 0, 2]
];
export var RepositoryCatalogDataInput$: StaticStructureSchema = [3, n0, _RCDI,
  0,
...
var ImageDetailList: StaticListSchema = [1, n0, _IDL,
  0, () => ImageDetail$
];
var ImageFailureList: StaticListSchema = [1, n0, _IFL,
  0, () => ImageFailure$
];
var ImageIdentifierList: StaticListSchema = [1, n0, _IIL,
  0, () => ImageIdentifier$
];
var ImageTagDetailList: StaticListSchema = [1, n0, _ITDL,
  0, () => ImageTagDetail$
];
var ImageTagList = 64 | 0;
var LayerDigestList = 64 | 0;
var LayerFailureList: StaticListSchema = [1, n0, _LFL,
  0, () => LayerFailure$
];
var LayerList: StaticListSchema = [1, n0, _LL,
  0, () => Layer$
];
var OperatingSystemList = 64 | 0;
var RegistryAliasList: StaticListSchema = [1, n0, _RAL,
  0, () => RegistryAlias$
];
var RegistryList: StaticListSchema = [1, n0, _RL,
  0, () => Registry$
];
var RepositoryList: StaticListSchema = [1, n0, _RLe,
  0, () => Repository$
];
...
export var BatchCheckLayerAvailability$: StaticOperationSchema = [9, n0, _BCLA,
  0, () => BatchCheckLayerAvailabilityRequest$, () => BatchCheckLayerAvailabilityResponse$
];
export var BatchDeleteImage$: StaticOperationSchema = [9, n0, _BDI,
  0, () => BatchDeleteImageRequest$, () => BatchDeleteImageResponse$
];
export var CompleteLayerUpload$: StaticOperationSchema = [9, n0, _CLU,
...
export var DeleteRepositoryPolicy$: StaticOperationSchema = [9, n0, _DRP,
  0, () => DeleteRepositoryPolicyRequest$, () => DeleteRepositoryPolicyResponse$
];
export var DescribeImages$: StaticOperationSchema = [9, n0, _DI,
  0, () => DescribeImagesRequest$, () => DescribeImagesResponse$
];
export var DescribeImageTags$: StaticOperationSchema = [9, n0, _DIT,
  0, () => DescribeImageTagsRequest$, () => DescribeImageTagsResponse$
];
export var DescribeRegistries$: StaticOperationSchema = [9, n0, _DRe,
  0, () => DescribeRegistriesRequest$, () => DescribeRegistriesResponse$
];
export var DescribeRepositories$: StaticOperationSchema = [9, n0, _DRes,
  0, () => DescribeRepositoriesRequest$, () => DescribeRepositoriesResponse$
];
export var GetAuthorizationToken$: StaticOperationSchema = [9, n0, _GAT,
  0, () => GetAuthorizationTokenRequest$, () => GetAuthorizationTokenResponse$
];
export var GetRegistryCatalogData$: StaticOperationSchema = [9, n0, _GRCD,
  0, () => GetRegistryCatalogDataRequest$, () => GetRegistryCatalogDataResponse$
];
export var GetRepositoryCatalogData$: StaticOperationSchema = [9, n0, _GRCDe,
  0, () => GetRepositoryCatalogDataRequest$, () => GetRepositoryCatalogDataResponse$
];
export var GetRepositoryPolicy$: StaticOperationSchema = [9, n0, _GRP,
  0, () => GetRepositoryPolicyRequest$, () => GetRepositoryPolicyResponse$
];
export var InitiateLayerUpload$: StaticOperationSchema = [9, n0, _ILU,
  0, () => InitiateLayerUploadRequest$, () => InitiateLayerUploadResponse$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceRequest$, () => ListTagsForResourceResponse$
];
export var PutImage$: StaticOperationSchema = [9, n0, _PI,
  0, () => PutImageRequest$, () => PutImageResponse$
];
export var PutRegistryCatalogData$: StaticOperationSchema = [9, n0, _PRCD,
  0, () => PutRegistryCatalogDataRequest$, () => PutRegistryCatalogDataResponse$
];
export var PutRepositoryCatalogData$: StaticOperationSchema = [9, n0, _PRCDu,
  0, () => PutRepositoryCatalogDataRequest$, () => PutRepositoryCatalogDataResponse$
];
export var SetRepositoryPolicy$: StaticOperationSchema = [9, n0, _SRP,
...
export var UploadLayerPart$: StaticOperationSchema = [9, n0, _ULP,
