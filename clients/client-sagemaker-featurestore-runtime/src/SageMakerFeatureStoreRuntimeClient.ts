  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<SageMakerFeatureStoreRuntimeClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultSageMakerFeatureStoreRuntimeHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: SageMakerFeatureStoreRuntimeClientResolvedConfig) =>
