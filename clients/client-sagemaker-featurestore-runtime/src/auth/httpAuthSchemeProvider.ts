...
import {
  type SageMakerFeatureStoreRuntimeClientResolvedConfig,
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SageMakerFeatureStoreRuntimeHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultSageMakerFeatureStoreRuntimeHttpAuthSchemeProvider: SageMakerFeatureStoreRuntimeHttpAuthSchemeProvider = (authParameters) => {
