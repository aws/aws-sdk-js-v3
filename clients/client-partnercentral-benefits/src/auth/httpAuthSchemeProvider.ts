...
import {
  type PartnerCentralBenefitsClientResolvedConfig,
  PartnerCentralBenefitsClientConfig,
 ...
 * @internal
 */
export const defaultPartnerCentralBenefitsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: PartnerCentralBenefitsHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<PartnerCentralBenefitsClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
