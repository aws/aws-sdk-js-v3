 ...
 * @public
 */
export type PartnerCentralBenefitsClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 *
 *  The configuration interface of PartnerCentralBenefitsClient class constructor that set the region, credentials and other options.
 */
 ...
 * @public
 */
export type PartnerCentralBenefitsClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 *
 *  The resolved configuration interface of PartnerCentralBenefitsClient class. This is resolved and normalized from the {@link PartnerCentralBenefitsClientConfig | constructor configuration interface}.
 */
 ...
 * @public
 */
export class PartnerCentralBenefitsClient extends __Client<
...
> {
  /**
   * The resolved configuration of PartnerCentralBenefitsClient class. This is resolved and normalized from the {@link PartnerCentralBenefitsClientConfig | constructor configuration interface}.
   */
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<PartnerCentralBenefitsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultPartnerCentralBenefitsHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: PartnerCentralBenefitsClientResolvedConfig) =>
