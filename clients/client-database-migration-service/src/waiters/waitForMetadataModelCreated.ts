 ...
 *  @deprecated Use waitUntilMetadataModelCreated instead. waitForMetadataModelCreated does not throw error in non-success cases.
 */
export const waitForMetadataModelCreated = async (
 ...
 */
export const waitUntilMetadataModelCreated = async (
  params: WaiterConfiguration<DatabaseMigrationServiceClient>,
  input: DescribeMetadataModelCreationsCommandInput
