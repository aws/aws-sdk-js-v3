 ...
 *  @deprecated Use waitUntilMetadataModelConverted instead. waitForMetadataModelConverted does not throw error in non-success cases.
 */
export const waitForMetadataModelConverted = async (
 ...
 */
export const waitUntilMetadataModelConverted = async (
  params: WaiterConfiguration<DatabaseMigrationServiceClient>,
  input: DescribeMetadataModelConversionsCommandInput
