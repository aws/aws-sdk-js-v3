 ...
 * @public
 */
export class DescribeFleetAdvisorLsaAnalysisCommand extends command<DescribeFleetAdvisorLsaAnalysisCommandInput, DescribeFleetAdvisorLsaAnalysisCommandOutput>(
  _ep0,
  _mw0,
