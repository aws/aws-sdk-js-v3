...
import type { CreateReplicationTaskMessage, CreateReplicationTaskResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateReplicationTaskCommand extends command<CreateReplicationTaskCommandInput, CreateReplicationTaskCommandOutput>(
  _ep0,
  _mw0,
