 ...
 * @public
 */
export class StartReplicationTaskAssessmentCommand extends command<StartReplicationTaskAssessmentCommandInput, StartReplicationTaskAssessmentCommandOutput>(
  _ep0,
  _mw0,
