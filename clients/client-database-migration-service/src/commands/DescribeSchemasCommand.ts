...
import { DescribeSchemas$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DescribeSchemasCommand extends command<DescribeSchemasCommandInput, DescribeSchemasCommandOutput>(
  _ep0,
  _mw0,
  "DescribeSchemas",
  DescribeSchemas$
