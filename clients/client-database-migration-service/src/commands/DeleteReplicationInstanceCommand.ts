...
import type { DeleteReplicationInstanceMessage, DeleteReplicationInstanceResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteReplicationInstanceCommand extends command<DeleteReplicationInstanceCommandInput, DeleteReplicationInstanceCommandOutput>(
  _ep0,
  _mw0,
