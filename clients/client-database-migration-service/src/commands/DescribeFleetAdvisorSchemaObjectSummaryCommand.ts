 ...
 * @public
 */
export class DescribeFleetAdvisorSchemaObjectSummaryCommand extends command<DescribeFleetAdvisorSchemaObjectSummaryCommandInput, DescribeFleetAdvisorSchemaObjectSummaryCommandOutput>(
  _ep0,
  _mw0,
