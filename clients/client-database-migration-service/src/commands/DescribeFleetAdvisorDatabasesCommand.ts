 ...
 * @public
 */
export class DescribeFleetAdvisorDatabasesCommand extends command<DescribeFleetAdvisorDatabasesCommandInput, DescribeFleetAdvisorDatabasesCommandOutput>(
  _ep0,
  _mw0,
