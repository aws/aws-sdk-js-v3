...
import type { DeleteDataProviderMessage, DeleteDataProviderResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteDataProviderCommand extends command<DeleteDataProviderCommandInput, DeleteDataProviderCommandOutput>(
  _ep0,
  _mw0,
  "DeleteDataProvider",
  DeleteDataProvider$
