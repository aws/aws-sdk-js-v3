...
import {
  type DatabaseMigrationServiceClientResolvedConfig,
  DatabaseMigrationServiceClientConfig,
...
function createAwsAuthSigv4HttpAuthOption(authParameters: DatabaseMigrationServiceHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultDatabaseMigrationServiceHttpAuthSchemeProvider: DatabaseMigrationServiceHttpAuthSchemeProvider = (authParameters) => {
