 ...
 * @public
 */
export class GetOutpostSupportedInstanceTypesCommand extends command<GetOutpostSupportedInstanceTypesCommandInput, GetOutpostSupportedInstanceTypesCommandOutput>(
  _ep0,
  _mw0,
