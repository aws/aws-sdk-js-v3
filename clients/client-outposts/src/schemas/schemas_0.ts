...
export var BlockingInstance$: StaticStructureSchema = [3, n0, _BI,
  0,
  [_II, _AIc, _ASN],
  [0, 0, 0]
];
...
export var GetOutpostOutput$: StaticStructureSchema = [3, n0, _GOOe,
  0,
  [_Ou],
  [() => Outpost$]
];
...
export var InstancesToExclude$: StaticStructureSchema = [3, n0, _ITE,
  0,
  [_I, _AIcc, _Se],
  [64 | 0, 64 | 0, 64 | 0]
];
...
export var ListCapacityTasksInput$: StaticStructureSchema = [3, n0, _LCTI,
  0,
  [_OIF, _MR, _NT, _CTSF],
...
export var ListCatalogItemsOutput$: StaticStructureSchema = [3, n0, _LCIO,
  0,
  [_CIa, _NT],
...
export var ListOrdersOutput$: StaticStructureSchema = [3, n0, _LOO,
  0,
  [_Or, _NT],
  [() => OrderSummaryListDefinition, 0]
];
export var ListOutpostsInput$: StaticStructureSchema = [3, n0, _LOIi,
  0,
  [_NT, _MR, _LCSF, _AZF, _AZIF],
  [[0, { [_hQ]: _NT }], [1, { [_hQ]: _MR }], [64 | 0, { [_hQ]: _LCSF }], [64 | 0, { [_hQ]: _AZF }], [64 | 0, { [_hQ]: _AZIF }]]
];
export var ListOutpostsOutput$: StaticStructureSchema = [3, n0, _LOOi,
  0,
  [_Out, _NT],
...
export var ListSitesOutput$: StaticStructureSchema = [3, n0, _LSO,
  0,
  [_Sit, _NT],
...
var AssetInstanceList: StaticListSchema = [1, n0, _AILs,
  0, () => AssetInstance$
];
...
var BlockingInstancesList: StaticListSchema = [1, n0, _BIL,
  0, () => BlockingInstance$
];
var BlockingResourceTypeList = 64 | 0;
var CapacityTaskList: StaticListSchema = [1, n0, _CTL,
  0, () => CapacityTaskSummary$
];
var CapacityTaskStatusList = 64 | 0;
var CatalogItemClassList = 64 | 0;
var CatalogItemListDefinition: StaticListSchema = [1, n0, _CILD,
  0, () => CatalogItem$
];
var CIDRList = 64 | 0;
var CityList = 64 | 0;
...
var InstanceTypeListDefinition: StaticListSchema = [1, n0, _ITLD,
  0, () => InstanceTypeItem$
];
var LifeCycleStatusList = 64 | 0;
var LineItemAssetInformationList: StaticListSchema = [1, n0, _LIAIL,
  0, () => LineItemAssetInformation$
];
var LineItemListDefinition: StaticListSchema = [1, n0, _LILD,
  0, () => LineItem$
];
var LineItemRequestListDefinition: StaticListSchema = [1, n0, _LIRLD,
  0, () => LineItemRequest$
];
...
var siteListDefinition: StaticListSchema = [1, n0, _sLD,
  0, () => Site$
];
...
export var CancelOrder$: StaticOperationSchema = [9, n0, _CO,
  { [_h]: ["POST", "/orders/{OrderId}/cancel", 200] }, () => CancelOrderInput$, () => CancelOrderOutput$
];
export var CreateOrder$: StaticOperationSchema = [9, n0, _COr,
...
export var GetCapacityTask$: StaticOperationSchema = [9, n0, _GCT,
  { [_h]: ["GET", "/outposts/{OutpostIdentifier}/capacity/{CapacityTaskId}", 200] }, () => GetCapacityTaskInput$, () => GetCapacityTaskOutput$
];
export var GetCatalogItem$: StaticOperationSchema = [9, n0, _GCI,
...
export var GetOrder$: StaticOperationSchema = [9, n0, _GO,
  { [_h]: ["GET", "/orders/{OrderId}", 200] }, () => GetOrderInput$, () => GetOrderOutput$
];
export var GetOutpost$: StaticOperationSchema = [9, n0, _GOe,
  { [_h]: ["GET", "/outposts/{OutpostId}", 200] }, () => GetOutpostInput$, () => GetOutpostOutput$
];
export var GetOutpostBillingInformation$: StaticOperationSchema = [9, n0, _GOBI,
...
export var GetOutpostInstanceTypes$: StaticOperationSchema = [9, n0, _GOIT,
...
export var GetSiteAddress$: StaticOperationSchema = [9, n0, _GSA,
  { [_h]: ["GET", "/sites/{SiteId}/address", 200] }, () => GetSiteAddressInput$, () => GetSiteAddressOutput$
];
export var ListAssetInstances$: StaticOperationSchema = [9, n0, _LAIi,
...
export var ListBlockingInstancesForCapacityTask$: StaticOperationSchema = [9, n0, _LBIFCT,
...
export var ListCapacityTasks$: StaticOperationSchema = [9, n0, _LCT,
...
export var StartCapacityTask$: StaticOperationSchema = [9, n0, _SCT,
  { [_h]: ["POST", "/outposts/{OutpostIdentifier}/capacity", 200] }, () => StartCapacityTaskInput$, () => StartCapacityTaskOutput$
];
export var StartConnection$: StaticOperationSchema = [9, n0, _SCt,
  { [_h]: ["POST", "/connections", 200] }, () => StartConnectionRequest$, () => StartConnectionResponse$
];
export var StartOutpostDecommission$: StaticOperationSchema = [9, n0, _SOD,
...
export var UpdateSiteAddress$: StaticOperationSchema = [9, n0, _USA,
  { [_h]: ["PUT", "/sites/{SiteId}/address", 200] }, () => UpdateSiteAddressInput$, () => UpdateSiteAddressOutput$
];
export var UpdateSiteRackPhysicalProperties$: StaticOperationSchema = [9, n0, _USRPP,
