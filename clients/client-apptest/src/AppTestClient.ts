...
import {
  defaultAppTestHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type AppTestClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 *
 *  The configuration interface of AppTestClient class constructor that set the region, credentials and other options.
 */
export interface AppTestClientConfig extends AppTestClientConfigType {}

/**
 * @public
 */
export type AppTestClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 *
 *  The resolved configuration interface of AppTestClient class. This is resolved and normalized from the {@link AppTestClientConfig | constructor configuration interface}.
 */
export interface AppTestClientResolvedConfig extends AppTestClientResolvedConfigType {}
 ...
 * @public
 */
export class AppTestClient extends __Client<
...
> {
  /**
   * The resolved configuration of AppTestClient class. This is resolved and normalized from the {@link AppTestClientConfig | constructor configuration interface}.
   */
  readonly config: AppTestClientResolvedConfig;

  constructor(...[configuration]: __CheckOptionalClientConfig<AppTestClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultAppTestHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: AppTestClientResolvedConfig) =>
