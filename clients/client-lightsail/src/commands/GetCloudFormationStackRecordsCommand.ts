 ...
 * @public
 */
export class GetCloudFormationStackRecordsCommand extends command<GetCloudFormationStackRecordsCommandInput, GetCloudFormationStackRecordsCommandOutput>(
  _ep0,
  _mw0,
