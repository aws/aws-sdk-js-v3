...
import { DownloadDefaultKeyPair$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DownloadDefaultKeyPairCommand extends command<DownloadDefaultKeyPairCommandInput, DownloadDefaultKeyPairCommandOutput>(
  _ep0,
  _mw0,
