...
import type { StartRelationalDatabaseRequest, StartRelationalDatabaseResult } from "../models/models_1";
import { StartRelationalDatabase$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class StartRelationalDatabaseCommand extends command<StartRelationalDatabaseCommandInput, StartRelationalDatabaseCommandOutput>(
  _ep0,
  _mw0,
