 ...
 * @public
 */
export class UpdateInstanceMetadataOptionsCommand extends command<UpdateInstanceMetadataOptionsCommandInput, UpdateInstanceMetadataOptionsCommandOutput>(
  _ep0,
  _mw0,
