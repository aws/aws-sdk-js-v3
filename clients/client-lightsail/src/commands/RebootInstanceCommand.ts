...
import type { RebootInstanceRequest, RebootInstanceResult } from "../models/models_1";
import { RebootInstance$ } from "../schemas/schemas_0";
...
export class RebootInstanceCommand extends $Command
  ...
  .s("Lightsail_20161128", "RebootInstance", {})
  .n("LightsailClient", "RebootInstanceCommand")
  .sc(RebootInstance$)
  .build() {
