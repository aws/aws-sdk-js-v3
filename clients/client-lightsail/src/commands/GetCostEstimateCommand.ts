...
import type { GetCostEstimateRequest, GetCostEstimateResult } from "../models/models_0";
 ...
 * @public
 */
export class GetCostEstimateCommand extends command<GetCostEstimateCommandInput, GetCostEstimateCommandOutput>(
  _ep0,
  _mw0,
  "GetCostEstimate",
  GetCostEstimate$
