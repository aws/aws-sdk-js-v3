...
import type { DeleteAutoSnapshotRequest, DeleteAutoSnapshotResult } from "../models/models_0";
 ...
 * @public
 */
export class DeleteAutoSnapshotCommand extends command<DeleteAutoSnapshotCommandInput, DeleteAutoSnapshotCommandOutput>(
  _ep0,
  _mw0,
  "DeleteAutoSnapshot",
  DeleteAutoSnapshot$
