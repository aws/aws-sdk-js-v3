...
import type { DeleteAlarmRequest, DeleteAlarmResult } from "../models/models_0";
 ...
 * @public
 */
export class DeleteAlarmCommand extends command<DeleteAlarmCommandInput, DeleteAlarmCommandOutput>(
  _ep0,
  _mw0,
  "DeleteAlarm",
  DeleteAlarm$
