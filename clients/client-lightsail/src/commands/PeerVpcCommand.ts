...
import type { PeerVpcRequest, PeerVpcResult } from "../models/models_1";
import { PeerVpc$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class PeerVpcCommand extends command<PeerVpcCommandInput, PeerVpcCommandOutput>(
  _ep0,
  _mw0,
  "PeerVpc",
  PeerVpc$
