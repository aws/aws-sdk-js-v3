...
import type { GetOperationRequest, GetOperationResult } from "../models/models_1";
 ...
 * @public
 */
export class GetOperationCommand extends command<GetOperationCommandInput, GetOperationCommandOutput>(
  _ep0,
  _mw0,
  "GetOperation",
  GetOperation$
