...
import { DeleteRelationalDatabase } from "../schemas/schemas_6_DeleteRelationalDatabase";
...
export class DeleteRelationalDatabaseCommand extends $Command
  ...
  .s("Lightsail_20161128", "DeleteRelationalDatabase", {})
  .n("LightsailClient", "DeleteRelationalDatabaseCommand")
  .sc(DeleteRelationalDatabase)
  .build() {
