...
import { DeleteRelationalDatabase$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteRelationalDatabaseCommand extends command<DeleteRelationalDatabaseCommandInput, DeleteRelationalDatabaseCommandOutput>(
  _ep0,
  _mw0,
