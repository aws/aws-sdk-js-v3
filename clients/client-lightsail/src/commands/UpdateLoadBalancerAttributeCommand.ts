...
import type { UpdateLoadBalancerAttributeRequest, UpdateLoadBalancerAttributeResult } from "../models/models_1";
import { UpdateLoadBalancerAttribute } from "../schemas/schemas_0";
...
export class UpdateLoadBalancerAttributeCommand extends $Command
  ...
  .sc(UpdateLoadBalancerAttribute)
  .build() {
