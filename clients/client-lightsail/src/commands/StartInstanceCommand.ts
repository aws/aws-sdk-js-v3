...
import type { StartInstanceRequest, StartInstanceResult } from "../models/models_1";
import { StartInstance$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class StartInstanceCommand extends command<StartInstanceCommandInput, StartInstanceCommandOutput>(
  _ep0,
  _mw0,
  "StartInstance",
  StartInstance$
