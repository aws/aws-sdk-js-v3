 ...
 * @public
 */
export class CreateContainerServiceRegistryLoginCommand extends command<CreateContainerServiceRegistryLoginCommandInput, CreateContainerServiceRegistryLoginCommandOutput>(
  _ep0,
  _mw0,
