...
import type { CreateRelationalDatabaseRequest, CreateRelationalDatabaseResult } from "../models/models_0";
 ...
 * @public
 */
export class CreateRelationalDatabaseCommand extends command<CreateRelationalDatabaseCommandInput, CreateRelationalDatabaseCommandOutput>(
  _ep0,
  _mw0,
