...
import type { DeleteDomainEntryRequest, DeleteDomainEntryResult } from "../models/models_0";
import { DeleteDomainEntry$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteDomainEntryCommand extends command<DeleteDomainEntryCommandInput, DeleteDomainEntryCommandOutput>(
  _ep0,
  _mw0,
  "DeleteDomainEntry",
  DeleteDomainEntry$
