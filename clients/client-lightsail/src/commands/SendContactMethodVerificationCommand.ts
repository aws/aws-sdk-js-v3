 ...
 * @public
 */
export class SendContactMethodVerificationCommand extends command<SendContactMethodVerificationCommandInput, SendContactMethodVerificationCommandOutput>(
  _ep0,
  _mw0,
