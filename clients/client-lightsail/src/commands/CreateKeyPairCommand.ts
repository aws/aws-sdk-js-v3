...
import type { CreateKeyPairRequest, CreateKeyPairResult } from "../models/models_0";
 ...
 * @public
 */
export class CreateKeyPairCommand extends command<CreateKeyPairCommandInput, CreateKeyPairCommandOutput>(
  _ep0,
  _mw0,
  "CreateKeyPair",
  CreateKeyPair$
