 ...
 * @public
 */
export class UpdateRelationalDatabaseParametersCommand extends command<UpdateRelationalDatabaseParametersCommandInput, UpdateRelationalDatabaseParametersCommandOutput>(
  _ep0,
  _mw0,
