...
import type { StopGUISessionRequest, StopGUISessionResult } from "../models/models_1";
import { StopGUISession$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class StopGUISessionCommand extends command<StopGUISessionCommandInput, StopGUISessionCommandOutput>(
  _ep0,
  _mw0,
  "StopGUISession",
  StopGUISession$
