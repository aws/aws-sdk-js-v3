...
import type { GetExportSnapshotRecordsRequest, GetExportSnapshotRecordsResult } from "../models/models_0";
import { GetExportSnapshotRecords$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetExportSnapshotRecordsCommand extends command<GetExportSnapshotRecordsCommandInput, GetExportSnapshotRecordsCommandOutput>(
  _ep0,
  _mw0,
