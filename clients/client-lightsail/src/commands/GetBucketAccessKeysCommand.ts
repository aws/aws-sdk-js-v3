...
import { GetBucketAccessKeys$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetBucketAccessKeysCommand extends command<GetBucketAccessKeysCommandInput, GetBucketAccessKeysCommandOutput>(
  _ep0,
  _mw0,
  "GetBucketAccessKeys",
  GetBucketAccessKeys$
