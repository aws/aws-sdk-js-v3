 ...
 * @public
 */
export class GetLoadBalancerTlsCertificatesCommand extends command<GetLoadBalancerTlsCertificatesCommandInput, GetLoadBalancerTlsCertificatesCommandOutput>(
  _ep0,
  _mw0,
