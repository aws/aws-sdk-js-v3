...
import { DeleteInstanceSnapshot$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteInstanceSnapshotCommand extends command<DeleteInstanceSnapshotCommandInput, DeleteInstanceSnapshotCommandOutput>(
  _ep0,
  _mw0,
