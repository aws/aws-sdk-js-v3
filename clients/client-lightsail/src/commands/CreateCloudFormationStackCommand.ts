...
import { CreateCloudFormationStack } from "../schemas/schemas_16_CreateCloudFormationStack";
...
export class CreateCloudFormationStackCommand extends $Command
  ...
  .s("Lightsail_20161128", "CreateCloudFormationStack", {})
  .n("LightsailClient", "CreateCloudFormationStackCommand")
  .sc(CreateCloudFormationStack)
  .build() {
