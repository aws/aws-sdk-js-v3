...
import type { GetLoadBalancersRequest, GetLoadBalancersResult } from "../models/models_1";
import { GetLoadBalancers$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetLoadBalancersCommand extends command<GetLoadBalancersCommandInput, GetLoadBalancersCommandOutput>(
  _ep0,
  _mw0,
  "GetLoadBalancers",
  GetLoadBalancers$
