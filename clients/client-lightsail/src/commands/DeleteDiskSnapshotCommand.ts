...
import type { DeleteDiskSnapshotRequest, DeleteDiskSnapshotResult } from "../models/models_0";
import { DeleteDiskSnapshot$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteDiskSnapshotCommand extends command<DeleteDiskSnapshotCommandInput, DeleteDiskSnapshotCommandOutput>(
  _ep0,
  _mw0,
  "DeleteDiskSnapshot",
  DeleteDiskSnapshot$
