...
import type { GetKeyPairsRequest, GetKeyPairsResult } from "../models/models_0";
import { GetKeyPairs$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetKeyPairsCommand extends command<GetKeyPairsCommandInput, GetKeyPairsCommandOutput>(
  _ep0,
  _mw0,
  "GetKeyPairs",
  GetKeyPairs$
