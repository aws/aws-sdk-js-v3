 ...
 * @public
 */
export class CreateGUISessionAccessDetailsCommand extends command<CreateGUISessionAccessDetailsCommandInput, CreateGUISessionAccessDetailsCommandOutput>(
  _ep0,
  _mw0,
