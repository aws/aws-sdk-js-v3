...
import type { GetInstancesRequest, GetInstancesResult } from "../models/models_0";
import { GetInstances$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetInstancesCommand extends command<GetInstancesCommandInput, GetInstancesCommandOutput>(
  _ep0,
  _mw0,
  "GetInstances",
  GetInstances$
