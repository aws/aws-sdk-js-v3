 ...
 * @public
 */
export class GetRelationalDatabaseMasterUserPasswordCommand extends command<GetRelationalDatabaseMasterUserPasswordCommandInput, GetRelationalDatabaseMasterUserPasswordCommandOutput>(
  _ep0,
  _mw0,
