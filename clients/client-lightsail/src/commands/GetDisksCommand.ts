...
import type { GetDisksRequest, GetDisksResult } from "../models/models_0";
import { GetDisks$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetDisksCommand extends command<GetDisksCommandInput, GetDisksCommandOutput>(
  _ep0,
  _mw0,
  "GetDisks",
  GetDisks$
