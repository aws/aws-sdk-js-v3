...
export type CreateInstancesFromSnapshotCommandOutput = CreateInstancesFromSnapshotResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1CreateInstancesFromSnapshotCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1CreateInstancesFromSnapshotCommand(
      output,
      context
    );
  }
