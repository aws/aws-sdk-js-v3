...
import {
  ...
  serializeAws_restJson1_1GetDigestCommand,
...
export type GetDigestCommandOutput = GetDigestResponse;
...
export class GetDigestCommand extends $Command<GetDigestCommandInput, GetDigestCommandOutput, QLDBClientResolvedConfig> {
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetDigestCommand(output, context);
  }
