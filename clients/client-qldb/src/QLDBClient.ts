...
import {
  defaultQLDBHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type QLDBClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type QLDBClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<QLDBClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultQLDBHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: QLDBClientResolvedConfig) =>
