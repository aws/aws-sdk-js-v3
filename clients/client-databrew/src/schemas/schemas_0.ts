...
export var DatabaseOutputList: StaticListSchema = [1, n0, _DOL, 0, () => DatabaseOutput];
...
export var RecipeErrorList: StaticListSchema = [1, n0, _REL, 0, () => RecipeVersionErrorDetail];
