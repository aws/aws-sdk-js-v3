...
import { type DataBrewClientResolvedConfig, DataBrewClientConfig } from "../DataBrewClient";
 ...
 * @internal
 */
export const defaultDataBrewHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: DataBrewHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultDataBrewHttpAuthSchemeProvider: DataBrewHttpAuthSchemeProvider = (authParameters) => {
