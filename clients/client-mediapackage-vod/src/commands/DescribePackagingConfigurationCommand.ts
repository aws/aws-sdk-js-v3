 ...
 * @public
 */
export class DescribePackagingConfigurationCommand extends command<DescribePackagingConfigurationCommandInput, DescribePackagingConfigurationCommandOutput>(
  _ep0,
  _mw0,
