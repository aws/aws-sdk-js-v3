...
export class CreatePackagingConfigurationCommand extends $Command<CreatePackagingConfigurationCommandInput, CreatePackagingConfigurationCommandOutput, MediaPackageVodClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1CreatePackagingConfigurationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreatePackagingConfigurationCommand(output, context);
  }
