...
import type { DeleteGeofenceCollectionRequest, DeleteGeofenceCollectionResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteGeofenceCollectionCommand extends command<DeleteGeofenceCollectionCommandInput, DeleteGeofenceCollectionCommandOutput>(
  _ep0,
  _mw0,
