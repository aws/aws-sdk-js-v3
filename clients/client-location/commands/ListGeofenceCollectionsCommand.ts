...
export type ListGeofenceCollectionsCommandInput = ListGeofenceCollectionsRequest;
export type ListGeofenceCollectionsCommandOutput = ListGeofenceCollectionsResponse & __MetadataBearer;
