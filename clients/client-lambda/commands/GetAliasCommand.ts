...
import {
  deserializeAws_restJson1_1GetAliasCommand,
  serializeAws_restJson1_1GetAliasCommand,
...
export type GetAliasCommandOutput = AliasConfiguration;
...
export class GetAliasCommand extends $Command<GetAliasCommandInput, GetAliasCommandOutput, LambdaClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetAliasCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetAliasCommand(output, context);
  }
