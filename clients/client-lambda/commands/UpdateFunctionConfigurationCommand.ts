...
import {
  deserializeAws_restJson1_1UpdateFunctionConfigurationCommand,
  serializeAws_restJson1_1UpdateFunctionConfigurationCommand,
...
export class UpdateFunctionConfigurationCommand extends $Command<UpdateFunctionConfigurationCommandInput, UpdateFunctionConfigurationCommandOutput, LambdaClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1UpdateFunctionConfigurationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1UpdateFunctionConfigurationCommand(output, context);
  }
