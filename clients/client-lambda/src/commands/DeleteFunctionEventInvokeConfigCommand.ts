 ...
 * @public
 */
export class DeleteFunctionEventInvokeConfigCommand extends command<DeleteFunctionEventInvokeConfigCommandInput, DeleteFunctionEventInvokeConfigCommandOutput>(
  _ep0,
  _mw0,
