 ...
 * @public
 */
export class DeleteFunctionCodeSigningConfigCommand extends command<DeleteFunctionCodeSigningConfigCommandInput, DeleteFunctionCodeSigningConfigCommandOutput>(
  _ep0,
  _mw0,
