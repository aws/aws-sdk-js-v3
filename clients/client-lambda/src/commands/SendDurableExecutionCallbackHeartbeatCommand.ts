 ...
 * @public
 */
export class SendDurableExecutionCallbackHeartbeatCommand extends command<SendDurableExecutionCallbackHeartbeatCommandInput, SendDurableExecutionCallbackHeartbeatCommandOutput>(
  _ep0,
  _mw0,
