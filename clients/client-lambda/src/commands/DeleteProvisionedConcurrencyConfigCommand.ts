 ...
 * ```
 *
 * @param DeleteProvisionedConcurrencyConfigRequest - {@link DeleteProvisionedConcurrencyConfigRequest}
 * @returns {@link Unit}
...
> {
  ...
  resolveMiddleware(
    ...
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteProvisionedConcurrencyConfigCommand.getEndpointParameterInstructions())
    );
