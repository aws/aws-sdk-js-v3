...
export async function serializeAws_json1_1CreateIdentityPoolCommand(
  ...
  const wrappedBody: any = {
    CreateIdentityPoolInput: serializeAws_json1_1CreateIdentityPoolInput(input, context),
  };
...
export async function serializeAws_json1_1DeleteIdentitiesCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    DeleteIdentitiesInput: serializeAws_json1_1DeleteIdentitiesInput(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1DeleteIdentityPoolCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    DeleteIdentityPoolInput: serializeAws_json1_1DeleteIdentityPoolInput(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1DescribeIdentityCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    DescribeIdentityInput: serializeAws_json1_1DescribeIdentityInput(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1DescribeIdentityPoolCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    DescribeIdentityPoolInput: serializeAws_json1_1DescribeIdentityPoolInput(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1GetCredentialsForIdentityCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    GetCredentialsForIdentityInput: serializeAws_json1_1GetCredentialsForIdentityInput(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1GetIdentityPoolRolesCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    GetIdentityPoolRolesInput: serializeAws_json1_1GetIdentityPoolRolesInput(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1GetOpenIdTokenForDeveloperIdentityCommand(
  ...
  const headers: any = {};
  headers['Content-Type'] = "application/x-amz-json-1.1";
  headers['X-Amz-Target'] = "AWSCognitoIdentityService.GetOpenIdTokenForDeveloperIdentity";
  let body: any = {};
  const wrappedBody: any = {
    GetOpenIdTokenForDeveloperIdentityInput: serializeAws_json1_1GetOpenIdTokenForDeveloperIdentityInput(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1ListIdentityPoolsCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    ListIdentityPoolsInput: serializeAws_json1_1ListIdentityPoolsInput(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1LookupDeveloperIdentityCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    LookupDeveloperIdentityInput: serializeAws_json1_1LookupDeveloperIdentityInput(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1MergeDeveloperIdentitiesCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    MergeDeveloperIdentitiesInput: serializeAws_json1_1MergeDeveloperIdentitiesInput(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1SetIdentityPoolRolesCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    SetIdentityPoolRolesInput: serializeAws_json1_1SetIdentityPoolRolesInput(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1UnlinkDeveloperIdentityCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    UnlinkDeveloperIdentityInput: serializeAws_json1_1UnlinkDeveloperIdentityInput(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
async function deserializeAws_json1_1CreateIdentityPoolCommandError(
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.cognito.identity.model#ResourceConflictException":
      response = await deserializeAws_json1_1ResourceConflictExceptionResponse(parsedOutput, context);
      break;
...
async function deserializeAws_json1_1GetCredentialsForIdentityCommandError(
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.cognito.identity.model#ExternalServiceException":
      response = await deserializeAws_json1_1ExternalServiceExceptionResponse(parsedOutput, context);
      break;
    case "InternalErrorException":
    case "com.amazonaws.cognito.identity.model#InternalErrorException":
      response = await deserializeAws_json1_1InternalErrorExceptionResponse(parsedOutput, context);
    ...
    case "com.amazonaws.cognito.identity.model#InvalidIdentityPoolConfigurationException":
      response = await deserializeAws_json1_1InvalidIdentityPoolConfigurationExceptionResponse(parsedOutput, context);
      break;
    case "InvalidParameterException":
    case "com.amazonaws.cognito.identity.model#InvalidParameterException":
      response = await deserializeAws_json1_1InvalidParameterExceptionResponse(parsedOutput, context);
...
async function deserializeAws_json1_1GetOpenIdTokenForDeveloperIdentityCommandError(
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.cognito.identity.model#DeveloperUserAlreadyRegisteredException":
      response = await deserializeAws_json1_1DeveloperUserAlreadyRegisteredExceptionResponse(parsedOutput, context);
      break;
    case "InternalErrorException":
    case "com.amazonaws.cognito.identity.model#InternalErrorException":
      response = await deserializeAws_json1_1InternalErrorExceptionResponse(parsedOutput, context);
...
const deserializeAws_json1_1DeveloperUserAlreadyRegisteredExceptionResponse = async (
  ...
  const deserialized: any = deserializeAws_json1_1DeveloperUserAlreadyRegisteredException(output.body, context);
...
const deserializeAws_json1_1ExternalServiceExceptionResponse = async (
  ...
  const deserialized: any = deserializeAws_json1_1ExternalServiceException(output.body, context);
...
const deserializeAws_json1_1InvalidIdentityPoolConfigurationExceptionResponse = async (
  ...
  const deserialized: any = deserializeAws_json1_1InvalidIdentityPoolConfigurationException(output.body, context);
...
const deserializeAws_json1_1ResourceConflictExceptionResponse = async (
  ...
  const deserialized: any = deserializeAws_json1_1ResourceConflictException(output.body, context);
...
const serializeAws_json1_1CreateIdentityPoolInput = (
  ...
  if (input.AllowUnauthenticatedIdentities !== undefined) {
    bodyParams['AllowUnauthenticatedIdentities'] = input.AllowUnauthenticatedIdentities;
  }
...
const deserializeAws_json1_1IdentityPool = (
  ...
  if (output.AllowUnauthenticatedIdentities !== undefined) {
    contents.AllowUnauthenticatedIdentities = output.AllowUnauthenticatedIdentities;
  }
