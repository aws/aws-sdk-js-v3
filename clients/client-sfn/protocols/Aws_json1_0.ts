...
const deserializeAws_json1_0ActivityStartedEventDetails = (
  ...
  return {
    ...
    workerName:
      output.workerName !== undefined && output.workerName !== null ? output.workerName : undefined
  } as any;
};
...
const deserializeAws_json1_0GetActivityTaskOutput = (
  ...
  return {
    ...
    input: output.input !== undefined && output.input !== null ? output.input : undefined,
    taskToken:
      output.taskToken !== undefined && output.taskToken !== null ? output.taskToken : undefined
  } as any;
};
