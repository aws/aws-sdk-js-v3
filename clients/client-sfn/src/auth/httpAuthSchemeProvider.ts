...
import { type SFNClientResolvedConfig, SFNClientConfig } from "../SFNClient";
 ...
 * @internal
 */
export const defaultSFNHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SFNHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultSFNHttpAuthSchemeProvider: SFNHttpAuthSchemeProvider = (authParameters) => {
