  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<VoiceIDClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultVoiceIDHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: VoiceIDClientResolvedConfig) =>
