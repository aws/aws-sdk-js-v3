  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<PcaConnectorAdClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultPcaConnectorAdHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: PcaConnectorAdClientResolvedConfig) =>
