 ...
 * @public
 */
export class ListTemplateGroupAccessControlEntriesCommand extends command<ListTemplateGroupAccessControlEntriesCommandInput, ListTemplateGroupAccessControlEntriesCommandOutput>(
  _ep0,
  _mw0,
