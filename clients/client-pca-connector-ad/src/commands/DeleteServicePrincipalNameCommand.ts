...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteServicePrincipalNameCommandInput) {
  ...
  ): Handler<DeleteServicePrincipalNameCommandInput, DeleteServicePrincipalNameCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteServicePrincipalNameCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: DeleteServicePrincipalNameCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_DeleteServicePrincipalNameCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_DeleteServicePrincipalNameCommand(output, context);
  }
