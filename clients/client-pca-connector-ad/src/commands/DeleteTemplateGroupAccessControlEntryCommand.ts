 ...
 * @public
 */
export class DeleteTemplateGroupAccessControlEntryCommand extends command<DeleteTemplateGroupAccessControlEntryCommandInput, DeleteTemplateGroupAccessControlEntryCommandOutput>(
  _ep0,
  _mw0,
