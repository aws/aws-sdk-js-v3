...
> {
   ...
   * @public
   */
  constructor(readonly input: CreateTemplateGroupAccessControlEntryCommandInput) {
  ...
  ): Handler<CreateTemplateGroupAccessControlEntryCommandInput, CreateTemplateGroupAccessControlEntryCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, CreateTemplateGroupAccessControlEntryCommand.getEndpointParameterInstructions())
    );
  ...
  private serialize(
    ...
    return se_CreateTemplateGroupAccessControlEntryCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_CreateTemplateGroupAccessControlEntryCommand(output, context);
  }
