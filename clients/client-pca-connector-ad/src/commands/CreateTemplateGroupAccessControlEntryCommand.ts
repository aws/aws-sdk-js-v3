 ...
 * @public
 */
export class CreateTemplateGroupAccessControlEntryCommand extends command<CreateTemplateGroupAccessControlEntryCommandInput, CreateTemplateGroupAccessControlEntryCommandOutput>(
  _ep0,
  _mw0,
