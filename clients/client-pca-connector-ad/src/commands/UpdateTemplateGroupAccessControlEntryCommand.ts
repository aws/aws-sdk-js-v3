 ...
 * @public
 */
export class UpdateTemplateGroupAccessControlEntryCommand extends command<UpdateTemplateGroupAccessControlEntryCommandInput, UpdateTemplateGroupAccessControlEntryCommandOutput>(
  _ep0,
  _mw0,
