...
import {
  deserializeAws_restJson1_1DescribeFileSystemsCommand,
  serializeAws_restJson1_1DescribeFileSystemsCommand,
...
export class DescribeFileSystemsCommand extends $Command<DescribeFileSystemsCommandInput, DescribeFileSystemsCommandOutput, EFSClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DescribeFileSystemsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeFileSystemsCommand(output, context);
  }
