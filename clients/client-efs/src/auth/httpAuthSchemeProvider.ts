...
import { type EFSClientResolvedConfig, EFSClientConfig } from "../EFSClient";
 ...
 * @internal
 */
export const defaultEFSHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: EFSHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultEFSHttpAuthSchemeProvider: EFSHttpAuthSchemeProvider = (authParameters) => {
