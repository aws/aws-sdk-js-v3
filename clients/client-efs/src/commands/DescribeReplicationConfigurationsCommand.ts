 ...
 * @public
 */
export class DescribeReplicationConfigurationsCommand extends command<DescribeReplicationConfigurationsCommandInput, DescribeReplicationConfigurationsCommandOutput>(
  _ep0,
  _mw0,
