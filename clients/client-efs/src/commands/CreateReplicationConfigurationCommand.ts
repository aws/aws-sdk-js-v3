 ...
 * @public
 */
export class CreateReplicationConfigurationCommand extends command<CreateReplicationConfigurationCommandInput, CreateReplicationConfigurationCommandOutput>(
  _ep0,
  _mw0,
