...
const AWS_TEMPLATE = "license-manager.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "license-manager.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "license-manager.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "license-manager.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "license-manager.{region}.amazonaws.com";
...
export const defaultRegionInfoProvider: RegionInfoProvider = (region: string, options?: any) => {
  ...
  switch (region) {
    ...
    case "ap-northeast-3":
      regionInfo = {
        hostname: "license-manager.ap-northeast-3.amazonaws.com",
        partition: "aws",
      };
      break;
    case "ap-south-1":
    ...
    case "eu-south-1":
      regionInfo = {
        hostname: "license-manager.eu-south-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "eu-west-1":
