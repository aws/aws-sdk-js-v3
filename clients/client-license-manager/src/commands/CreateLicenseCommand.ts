...
import type { CreateLicenseRequest, CreateLicenseResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateLicenseCommand extends command<CreateLicenseCommandInput, CreateLicenseCommandOutput>(
  _ep0,
  _mw0,
  "CreateLicense",
  CreateLicense$
