 ...
 * @public
 */
export class ListUsageForLicenseConfigurationCommand extends command<ListUsageForLicenseConfigurationCommandInput, ListUsageForLicenseConfigurationCommandOutput>(
  _ep0,
  _mw0,
