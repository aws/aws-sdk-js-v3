 ...
 * @public
 */
export class DeleteLicenseManagerReportGeneratorCommand extends command<DeleteLicenseManagerReportGeneratorCommandInput, DeleteLicenseManagerReportGeneratorCommandOutput>(
  _ep0,
  _mw0,
