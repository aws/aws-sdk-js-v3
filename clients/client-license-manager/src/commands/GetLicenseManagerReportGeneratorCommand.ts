 ...
 * @public
 */
export class GetLicenseManagerReportGeneratorCommand extends command<GetLicenseManagerReportGeneratorCommandInput, GetLicenseManagerReportGeneratorCommandOutput>(
  _ep0,
  _mw0,
