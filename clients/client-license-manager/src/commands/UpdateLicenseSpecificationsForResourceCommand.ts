 ...
 * ```
 *
 * @param UpdateLicenseSpecificationsForResourceRequest - {@link UpdateLicenseSpecificationsForResourceRequest}
 * @returns {@link UpdateLicenseSpecificationsForResourceResponse}
