...
import type { ListLicenseVersionsRequest, ListLicenseVersionsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListLicenseVersionsCommand extends command<ListLicenseVersionsCommandInput, ListLicenseVersionsCommandOutput>(
  _ep0,
  _mw0,
  "ListLicenseVersions",
  ListLicenseVersions$
