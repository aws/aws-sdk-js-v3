 ...
 * @public
 */
export class ListReceivedGrantsForOrganizationCommand extends command<ListReceivedGrantsForOrganizationCommandInput, ListReceivedGrantsForOrganizationCommandOutput>(
  _ep0,
  _mw0,
