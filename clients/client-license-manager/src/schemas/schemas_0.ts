...
export var LicenseManagerServiceException$: StaticErrorSchema = [-3, _s, "LicenseManagerServiceException", 0, [], []];
...
export var AuthorizationException$: StaticErrorSchema = [-3, n0, _AE,
...
export var FilterLimitExceededException$: StaticErrorSchema = [-3, n0, _FLEE,
...
export var LicenseUsageException$: StaticErrorSchema = [-3, n0, _LUE,
  { [_aQE]: [`LicenseUsageFailure`, 412], [_e]: _c, [_hE]: 412 },
  [_M],
  [0]
];
n0_registry.registerError(LicenseUsageException$, LicenseUsageException);
export var NoEntitlementsAllowedException$: StaticErrorSchema = [-3, n0, _NEAE,
  { [_e]: _c, [_hE]: 400 },
  [_M],
  [0]
];
...
export var RedirectException$: StaticErrorSchema = [-3, n0, _RE,
  { [_e]: _c, [_hE]: 308 },
  [_L, _M],
  [[0, { [_hH]: _L }], 0]
];
n0_registry.registerError(RedirectException$, RedirectException);
export var ResourceLimitExceededException$: StaticErrorSchema = [-3, n0, _RLEEe,
...
export var UnsupportedDigitalSignatureMethodException$: StaticErrorSchema = [-3, n0, _UDSME,
  { [_e]: _c, [_hE]: 400 },
  [_M],
  [0]
];
...
export var AndRuleStatement$: StaticStructureSchema = [3, n0, _ARS,
  0,
  [_MRS, _SRS],
...
export var AutomatedDiscoveryInformation$: StaticStructureSchema = [3, n0, _ADI,
  0,
  [_LRT],
  [4]
];
...
export var ConsumedLicenseSummary$: StaticStructureSchema = [3, n0, _CLS,
  0,
  [_RT, _CL],
  [0, 1]
];
export var ConsumptionConfiguration$: StaticStructureSchema = [3, n0, _CC,
  0,
  [_RTe, _PC, _BC],
...
export var CrossAccountDiscoveryServiceStatus$: StaticStructureSchema = [3, n0, _CADSS,
  0,
  [_M],
  [0]
];
export var CrossRegionDiscoveryStatus$: StaticStructureSchema = [3, n0, _CRDS,
  0,
  [_M],
  [() => RegionStatusMap]
];
...
export var InstanceRuleStatement$: StaticStructureSchema = [3, n0, _IRS,
  0,
...
export var License$: StaticStructureSchema = [3, n0, _Li,
  0,
...
export var LicenseConfigurationAssociation$: StaticStructureSchema = [3, n0, _LCAi,
  0,
  [_RA, _RT, _ROI, _ATs, _AAS],
  [0, 0, 0, 4, 0]
];
export var LicenseConfigurationRuleStatement$: StaticStructureSchema = [3, n0, _LCRS,
  0,
  [_ARS, _ORS, _MRSa],
  [() => AndRuleStatement$, () => OrRuleStatement$, () => MatchingRuleStatement$]
];
export var LicenseConfigurationUsage$: StaticStructureSchema = [3, n0, _LCU,
  0,
  [_RA, _RT, _RSe, _ROI, _ATs, _CL],
  [0, 0, 0, 0, 4, 1]
];
export var LicenseConversionContext$: StaticStructureSchema = [3, n0, _LCC,
  0,
  [_UO, _PCr],
  [0, () => ProductCodeList]
];
export var LicenseConversionTask$: StaticStructureSchema = [3, n0, _LCTice,
  0,
  [_LCTI, _RA, _SLC, _DLC, _S, _SM, _STt, _LCTic, _ET],
  [0, 0, () => LicenseConversionContext$, () => LicenseConversionContext$, 0, 0, 4, 4, 4]
];
export var LicenseOperationFailure$: StaticStructureSchema = [3, n0, _LOF,
  0,
  [_RA, _RT, _EM, _FT, _ON, _ROI, _ORB, _ML],
  [0, 0, 0, 4, 0, 0, 0, () => MetadataList]
];
export var LicenseRuleStatement$: StaticStructureSchema = [3, n0, _LRS,
  0,
  [_ARS, _ORS, _MRSa],
  [() => AndRuleStatement$, () => OrRuleStatement$, () => MatchingRuleStatement$]
];
...
export var ListDistributedGrantsRequest$: StaticStructureSchema = [3, n0, _LDGR,
  0,
  [_GAr, _Fi, _NT, _MR],
  [64 | 0, [() => FilterList, 0], 0, 1]
];
export var ListDistributedGrantsResponse$: StaticStructureSchema = [3, n0, _LDGRi,
  0,
  [_Gr, _NT],
  [() => GrantList, 0]
];
...
export var ListLicenseAssetGroupsRequest$: StaticStructureSchema = [3, n0, _LLAGR,
  0,
  [_Fi, _MR, _NT],
  [[() => Filters, 0], 1, 0]
];
export var ListLicenseAssetGroupsResponse$: StaticStructureSchema = [3, n0, _LLAGRi,
  0,
  [_LAGi, _NT],
  [() => LicenseAssetGroupList, 0]
];
export var ListLicenseAssetRulesetsRequest$: StaticStructureSchema = [3, n0, _LLARR,
  0,
  [_Fi, _SAWSMLAR, _MR, _NT],
  [[() => Filters, 0], 2, 1, 0]
];
export var ListLicenseAssetRulesetsResponse$: StaticStructureSchema = [3, n0, _LLARRi,
  0,
  [_LARic, _NT],
  [() => LicenseAssetRulesetList, 0]
];
export var ListLicenseConfigurationsForOrganizationRequest$: StaticStructureSchema = [3, n0, _LLCFOR,
  0,
  [_LCAice, _MR, _NT, _Fi],
  [64 | 0, 1, 0, [() => Filters, 0]]
];
export var ListLicenseConfigurationsForOrganizationResponse$: StaticStructureSchema = [3, n0, _LLCFORi,
  0,
  [_LCic, _NT],
  [() => LicenseConfigurations, 0]
];
export var ListLicenseConfigurationsRequest$: StaticStructureSchema = [3, n0, _LLCR,
  0,
  [_LCAice, _MR, _NT, _Fi],
  [64 | 0, 1, 0, [() => Filters, 0]]
];
export var ListLicenseConfigurationsResponse$: StaticStructureSchema = [3, n0, _LLCRi,
  0,
  [_LCic, _NT],
  [() => LicenseConfigurations, 0]
];
export var ListLicenseConversionTasksRequest$: StaticStructureSchema = [3, n0, _LLCTR,
  0,
  [_NT, _MR, _Fi],
  [0, 1, [() => Filters, 0]]
];
export var ListLicenseConversionTasksResponse$: StaticStructureSchema = [3, n0, _LLCTRi,
  0,
  [_LCTicen, _NT],
  [() => LicenseConversionTasks, 0]
];
export var ListLicenseManagerReportGeneratorsRequest$: StaticStructureSchema = [3, n0, _LLMRGR,
  0,
  [_Fi, _NT, _MR],
  [[() => FilterList, 0], 0, 1]
];
export var ListLicenseManagerReportGeneratorsResponse$: StaticStructureSchema = [3, n0, _LLMRGRi,
  0,
  [_RGe, _NT],
...
export var ListLicensesRequest$: StaticStructureSchema = [3, n0, _LLR,
  0,
  [_LAi, _Fi, _NT, _MR],
  [64 | 0, [() => FilterList, 0], 0, 1]
];
export var ListLicensesResponse$: StaticStructureSchema = [3, n0, _LLRi,
  0,
  [_Lic, _NT],
  [() => LicenseList, 0]
];
...
export var ListReceivedGrantsRequest$: StaticStructureSchema = [3, n0, _LRGR,
  0,
  [_GAr, _Fi, _NT, _MR],
  [64 | 0, [() => FilterList, 0], 0, 1]
];
export var ListReceivedGrantsResponse$: StaticStructureSchema = [3, n0, _LRGRi,
  0,
  [_Gr, _NT],
  [() => GrantList, 0]
];
export var ListReceivedLicensesForOrganizationRequest$: StaticStructureSchema = [3, n0, _LRLFOR,
  0,
  [_Fi, _NT, _MR],
  [[() => FilterList, 0], 0, 1]
];
export var ListReceivedLicensesForOrganizationResponse$: StaticStructureSchema = [3, n0, _LRLFORi,
  0,
  [_Lic, _NT],
  [() => GrantedLicenseList, 0]
];
export var ListReceivedLicensesRequest$: StaticStructureSchema = [3, n0, _LRLR,
  0,
  [_LAi, _Fi, _NT, _MR],
  [64 | 0, [() => FilterList, 0], 0, 1]
];
export var ListReceivedLicensesResponse$: StaticStructureSchema = [3, n0, _LRLRi,
  0,
  [_Lic, _NT],
  [() => GrantedLicenseList, 0]
];
export var ListResourceInventoryRequest$: StaticStructureSchema = [3, n0, _LRIR,
  0,
  [_MR, _NT, _Fi],
  [1, 0, () => InventoryFilterList]
];
export var ListResourceInventoryResponse$: StaticStructureSchema = [3, n0, _LRIRi,
  0,
  [_RIL, _NT],
...
export var ListTokensRequest$: StaticStructureSchema = [3, n0, _LTR,
  0,
  [_TIo, _Fi, _NT, _MR],
  [64 | 0, [() => FilterList, 0], 0, 1]
];
export var ListTokensResponse$: StaticStructureSchema = [3, n0, _LTRi,
  0,
  [_Tok, _NT],
  [() => TokenList, 0]
];
...
export var ManagedResourceSummary$: StaticStructureSchema = [3, n0, _MRSan,
  0,
  [_RT, _AC],
  [0, 1]
];
...
export var ReceivedMetadata$: StaticStructureSchema = [3, n0, _RM,
  0,
  [_RSec, _RSR, _AO],
  [0, 0, 64 | 0]
];
export var RegionStatus$: StaticStructureSchema = [3, n0, _RSeg,
  0,
  [_S],
  [0]
];
...
export var ReportContext$: StaticStructureSchema = [3, n0, _RC,
  0,
  [_lCA, _lAGA, _rSD, _rED],
  [64 | 0, 64 | 0, 4, 4]
];
export var ReportFrequency$: StaticStructureSchema = [3, n0, _RF,
  0,
  [_v, _p],
  [1, 0]
];
export var ReportGenerator$: StaticStructureSchema = [3, n0, _RG,
  0,
...
export var ResourceInventory$: StaticStructureSchema = [3, n0, _RI,
  0,
  [_RIe, _RT, _RA, _Pl, _PV, _ROAI, _MPC, _UO, _AI, _HI, _Re, _IT],
  [0, 0, 0, 0, 0, 0, 64 | 0, 0, 0, 0, 0, 0]
];
export var RuleStatement$: StaticStructureSchema = [3, n0, _RS,
  0,
  [_LCRS, _LRS, _IRS],
...
export var ServiceStatus$: StaticStructureSchema = [3, n0, _SS,
  0,
  [_CAD, _CRD],
...
export var TokenData$: StaticStructureSchema = [3, n0, _TD,
  0,
...
var ConsumedLicenseSummaryList: StaticListSchema = [1, n0, _CLSL,
  0, () => ConsumedLicenseSummary$
];
var EntitlementDataList: StaticListSchema = [1, n0, _EDL,
  0, () => EntitlementData$
];
var EntitlementList: StaticListSchema = [1, n0, _EL,
  0, () => Entitlement$
];
var EntitlementUsageList: StaticListSchema = [1, n0, _EUL,
  0, () => EntitlementUsage$
];
...
var GrantedLicenseList: StaticListSchema = [1, n0, _GLL,
  0, () => GrantedLicense$
];
var GrantList: StaticListSchema = [1, n0, _GLr,
  0, () => Grant$
];
var InventoryFilterList: StaticListSchema = [1, n0, _IFL,
  0, () => InventoryFilter$
];
var LicenseAssetGroupConfigurationList: StaticListSchema = [1, n0, _LAGCL,
  0, () => LicenseAssetGroupConfiguration$
];
var LicenseAssetGroupList: StaticListSchema = [1, n0, _LAGL,
  0, () => LicenseAssetGroup$
];
var LicenseAssetGroupPropertyList: StaticListSchema = [1, n0, _LAGPL,
  0, () => LicenseAssetGroupProperty$
];
var LicenseAssetRuleList: StaticListSchema = [1, n0, _LARL,
  0, () => LicenseAssetRule$
];
var LicenseAssetRulesetArnList = 64 | 0;
var LicenseAssetRulesetList: StaticListSchema = [1, n0, _LARLi,
  0, () => LicenseAssetRuleset$
];
var LicenseConfigurationAssociations: StaticListSchema = [1, n0, _LCAic,
  0, () => LicenseConfigurationAssociation$
];
var LicenseConfigurations: StaticListSchema = [1, n0, _LCic,
  0, () => LicenseConfiguration$
];
var LicenseConfigurationUsageList: StaticListSchema = [1, n0, _LCUL,
  0, () => LicenseConfigurationUsage$
];
var LicenseConversionTasks: StaticListSchema = [1, n0, _LCTicen,
  0, () => LicenseConversionTask$
];
var LicenseList: StaticListSchema = [1, n0, _LL,
  0, () => License$
];
var LicenseOperationFailureList: StaticListSchema = [1, n0, _LOFL,
  0, () => LicenseOperationFailure$
];
var LicenseSpecifications: StaticListSchema = [1, n0, _LSi,
  0, () => LicenseSpecification$
];
var ManagedResourceSummaryList: StaticListSchema = [1, n0, _MRSL,
  0, () => ManagedResourceSummary$
];
var MatchingRuleStatementList: StaticListSchema = [1, n0, _MRSLa,
  0, () => MatchingRuleStatement$
];
var MaxSize3StringList = 64 | 0;
var MetadataList: StaticListSchema = [1, n0, _ML,
  0, () => Metadata$
];
...
var ProductInformationFilterList: StaticListSchema = [1, n0, _PIFL,
  0, () => ProductInformationFilter$
];
var ProductInformationList: StaticListSchema = [1, n0, _PIL,
  0, () => ProductInformation$
];
var ReportGeneratorList: StaticListSchema = [1, n0, _RGL,
  0, () => ReportGenerator$
];
var ReportTypeList = 64 | 0;
var ResourceInventoryList: StaticListSchema = [1, n0, _RIL,
  0, () => ResourceInventory$
];
var ScriptRuleStatementList: StaticListSchema = [1, n0, _SRSL,
...
var TokenList: StaticListSchema = [1, n0, _TLo,
  0, () => TokenData$
];
var RegionStatusMap: StaticMapSchema = [2, n0, _RSM,
  0, 0, () => RegionStatus$
];
export var AcceptGrant$: StaticOperationSchema = [9, n0, _AG,
  0, () => AcceptGrantRequest$, () => AcceptGrantResponse$
];
export var CheckInLicense$: StaticOperationSchema = [9, n0, _CIL,
  0, () => CheckInLicenseRequest$, () => CheckInLicenseResponse$
];
export var CheckoutBorrowLicense$: StaticOperationSchema = [9, n0, _CBL,
  0, () => CheckoutBorrowLicenseRequest$, () => CheckoutBorrowLicenseResponse$
];
export var CheckoutLicense$: StaticOperationSchema = [9, n0, _CLh,
...
export var CreateGrantVersion$: StaticOperationSchema = [9, n0, _CGV,
  0, () => CreateGrantVersionRequest$, () => CreateGrantVersionResponse$
];
export var CreateLicense$: StaticOperationSchema = [9, n0, _CLr,
  0, () => CreateLicenseRequest$, () => CreateLicenseResponse$
];
export var CreateLicenseAssetGroup$: StaticOperationSchema = [9, n0, _CLAG,
  0, () => CreateLicenseAssetGroupRequest$, () => CreateLicenseAssetGroupResponse$
];
export var CreateLicenseAssetRuleset$: StaticOperationSchema = [9, n0, _CLAR,
  0, () => CreateLicenseAssetRulesetRequest$, () => CreateLicenseAssetRulesetResponse$
];
export var CreateLicenseConfiguration$: StaticOperationSchema = [9, n0, _CLC,
  0, () => CreateLicenseConfigurationRequest$, () => CreateLicenseConfigurationResponse$
];
export var CreateLicenseConversionTaskForResource$: StaticOperationSchema = [9, n0, _CLCTFR,
  0, () => CreateLicenseConversionTaskForResourceRequest$, () => CreateLicenseConversionTaskForResourceResponse$
];
export var CreateLicenseManagerReportGenerator$: StaticOperationSchema = [9, n0, _CLMRG,
  0, () => CreateLicenseManagerReportGeneratorRequest$, () => CreateLicenseManagerReportGeneratorResponse$
];
export var CreateLicenseVersion$: StaticOperationSchema = [9, n0, _CLV,
  0, () => CreateLicenseVersionRequest$, () => CreateLicenseVersionResponse$
];
export var CreateToken$: StaticOperationSchema = [9, n0, _CTre,
  0, () => CreateTokenRequest$, () => CreateTokenResponse$
];
export var DeleteGrant$: StaticOperationSchema = [9, n0, _DG,
  0, () => DeleteGrantRequest$, () => DeleteGrantResponse$
];
export var DeleteLicense$: StaticOperationSchema = [9, n0, _DL,
  0, () => DeleteLicenseRequest$, () => DeleteLicenseResponse$
];
export var DeleteLicenseAssetGroup$: StaticOperationSchema = [9, n0, _DLAG,
  0, () => DeleteLicenseAssetGroupRequest$, () => DeleteLicenseAssetGroupResponse$
];
export var DeleteLicenseAssetRuleset$: StaticOperationSchema = [9, n0, _DLAR,
  0, () => DeleteLicenseAssetRulesetRequest$, () => DeleteLicenseAssetRulesetResponse$
];
export var DeleteLicenseConfiguration$: StaticOperationSchema = [9, n0, _DLCe,
  0, () => DeleteLicenseConfigurationRequest$, () => DeleteLicenseConfigurationResponse$
];
export var DeleteLicenseManagerReportGenerator$: StaticOperationSchema = [9, n0, _DLMRG,
  0, () => DeleteLicenseManagerReportGeneratorRequest$, () => DeleteLicenseManagerReportGeneratorResponse$
];
export var DeleteToken$: StaticOperationSchema = [9, n0, _DT,
  0, () => DeleteTokenRequest$, () => DeleteTokenResponse$
];
export var ExtendLicenseConsumption$: StaticOperationSchema = [9, n0, _ELC,
  0, () => ExtendLicenseConsumptionRequest$, () => ExtendLicenseConsumptionResponse$
];
export var GetAccessToken$: StaticOperationSchema = [9, n0, _GAT,
  0, () => GetAccessTokenRequest$, () => GetAccessTokenResponse$
];
export var GetGrant$: StaticOperationSchema = [9, n0, _GG,
  0, () => GetGrantRequest$, () => GetGrantResponse$
];
export var GetLicense$: StaticOperationSchema = [9, n0, _GLe,
  0, () => GetLicenseRequest$, () => GetLicenseResponse$
];
export var GetLicenseAssetGroup$: StaticOperationSchema = [9, n0, _GLAG,
  0, () => GetLicenseAssetGroupRequest$, () => GetLicenseAssetGroupResponse$
];
export var GetLicenseAssetRuleset$: StaticOperationSchema = [9, n0, _GLAR,
  0, () => GetLicenseAssetRulesetRequest$, () => GetLicenseAssetRulesetResponse$
];
export var GetLicenseConfiguration$: StaticOperationSchema = [9, n0, _GLC,
  0, () => GetLicenseConfigurationRequest$, () => GetLicenseConfigurationResponse$
];
export var GetLicenseConversionTask$: StaticOperationSchema = [9, n0, _GLCT,
  0, () => GetLicenseConversionTaskRequest$, () => GetLicenseConversionTaskResponse$
];
export var GetLicenseManagerReportGenerator$: StaticOperationSchema = [9, n0, _GLMRG,
  0, () => GetLicenseManagerReportGeneratorRequest$, () => GetLicenseManagerReportGeneratorResponse$
];
export var GetLicenseUsage$: StaticOperationSchema = [9, n0, _GLU,
...
export var ListAssetsForLicenseAssetGroup$: StaticOperationSchema = [9, n0, _LAFLAG,
  0, () => ListAssetsForLicenseAssetGroupRequest$, () => ListAssetsForLicenseAssetGroupResponse$
];
export var ListAssociationsForLicenseConfiguration$: StaticOperationSchema = [9, n0, _LAFLC,
  0, () => ListAssociationsForLicenseConfigurationRequest$, () => ListAssociationsForLicenseConfigurationResponse$
];
export var ListDistributedGrants$: StaticOperationSchema = [9, n0, _LDG,
  0, () => ListDistributedGrantsRequest$, () => ListDistributedGrantsResponse$
];
export var ListFailuresForLicenseConfigurationOperations$: StaticOperationSchema = [9, n0, _LFFLCO,
  0, () => ListFailuresForLicenseConfigurationOperationsRequest$, () => ListFailuresForLicenseConfigurationOperationsResponse$
];
export var ListLicenseAssetGroups$: StaticOperationSchema = [9, n0, _LLAG,
  0, () => ListLicenseAssetGroupsRequest$, () => ListLicenseAssetGroupsResponse$
];
export var ListLicenseAssetRulesets$: StaticOperationSchema = [9, n0, _LLAR,
  0, () => ListLicenseAssetRulesetsRequest$, () => ListLicenseAssetRulesetsResponse$
];
export var ListLicenseConfigurations$: StaticOperationSchema = [9, n0, _LLC,
  0, () => ListLicenseConfigurationsRequest$, () => ListLicenseConfigurationsResponse$
];
export var ListLicenseConfigurationsForOrganization$: StaticOperationSchema = [9, n0, _LLCFO,
  0, () => ListLicenseConfigurationsForOrganizationRequest$, () => ListLicenseConfigurationsForOrganizationResponse$
];
export var ListLicenseConversionTasks$: StaticOperationSchema = [9, n0, _LLCT,
  0, () => ListLicenseConversionTasksRequest$, () => ListLicenseConversionTasksResponse$
];
export var ListLicenseManagerReportGenerators$: StaticOperationSchema = [9, n0, _LLMRG,
  0, () => ListLicenseManagerReportGeneratorsRequest$, () => ListLicenseManagerReportGeneratorsResponse$
];
export var ListLicenses$: StaticOperationSchema = [9, n0, _LLi,
  0, () => ListLicensesRequest$, () => ListLicensesResponse$
];
export var ListLicenseSpecificationsForResource$: StaticOperationSchema = [9, n0, _LLSFR,
  0, () => ListLicenseSpecificationsForResourceRequest$, () => ListLicenseSpecificationsForResourceResponse$
];
export var ListLicenseVersions$: StaticOperationSchema = [9, n0, _LLV,
  0, () => ListLicenseVersionsRequest$, () => ListLicenseVersionsResponse$
];
export var ListReceivedGrants$: StaticOperationSchema = [9, n0, _LRG,
  0, () => ListReceivedGrantsRequest$, () => ListReceivedGrantsResponse$
];
export var ListReceivedGrantsForOrganization$: StaticOperationSchema = [9, n0, _LRGFO,
  0, () => ListReceivedGrantsForOrganizationRequest$, () => ListReceivedGrantsForOrganizationResponse$
];
export var ListReceivedLicenses$: StaticOperationSchema = [9, n0, _LRL,
  0, () => ListReceivedLicensesRequest$, () => ListReceivedLicensesResponse$
];
export var ListReceivedLicensesForOrganization$: StaticOperationSchema = [9, n0, _LRLFO,
  0, () => ListReceivedLicensesForOrganizationRequest$, () => ListReceivedLicensesForOrganizationResponse$
];
export var ListResourceInventory$: StaticOperationSchema = [9, n0, _LRI,
  0, () => ListResourceInventoryRequest$, () => ListResourceInventoryResponse$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceRequest$, () => ListTagsForResourceResponse$
];
export var ListTokens$: StaticOperationSchema = [9, n0, _LT,
  0, () => ListTokensRequest$, () => ListTokensResponse$
];
export var ListUsageForLicenseConfiguration$: StaticOperationSchema = [9, n0, _LUFLC,
  0, () => ListUsageForLicenseConfigurationRequest$, () => ListUsageForLicenseConfigurationResponse$
];
export var RejectGrant$: StaticOperationSchema = [9, n0, _RGej,
...
export var UpdateLicenseAssetGroup$: StaticOperationSchema = [9, n0, _ULAG,
  0, () => UpdateLicenseAssetGroupRequest$, () => UpdateLicenseAssetGroupResponse$
];
export var UpdateLicenseAssetRuleset$: StaticOperationSchema = [9, n0, _ULAR,
  0, () => UpdateLicenseAssetRulesetRequest$, () => UpdateLicenseAssetRulesetResponse$
];
export var UpdateLicenseConfiguration$: StaticOperationSchema = [9, n0, _ULC,
  0, () => UpdateLicenseConfigurationRequest$, () => UpdateLicenseConfigurationResponse$
];
export var UpdateLicenseManagerReportGenerator$: StaticOperationSchema = [9, n0, _ULMRG,
  0, () => UpdateLicenseManagerReportGeneratorRequest$, () => UpdateLicenseManagerReportGeneratorResponse$
];
export var UpdateLicenseSpecificationsForResource$: StaticOperationSchema = [9, n0, _ULSFR,
