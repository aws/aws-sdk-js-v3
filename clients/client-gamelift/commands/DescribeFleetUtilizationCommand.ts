...
export type DescribeFleetUtilizationCommandOutput = DescribeFleetUtilizationOutput;

export class DescribeFleetUtilizationCommand extends $Command<DescribeFleetUtilizationCommandInput, DescribeFleetUtilizationCommandOutput, GameLiftClientResolvedConfig> {
