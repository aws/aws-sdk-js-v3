...
export type UpdateBuildCommandOutput = UpdateBuildOutput;

export class UpdateBuildCommand extends $Command<UpdateBuildCommandInput, UpdateBuildCommandOutput, GameLiftClientResolvedConfig> {
