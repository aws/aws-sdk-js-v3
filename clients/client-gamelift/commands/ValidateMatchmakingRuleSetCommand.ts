...
export type ValidateMatchmakingRuleSetCommandOutput = ValidateMatchmakingRuleSetOutput;

export class ValidateMatchmakingRuleSetCommand extends $Command<ValidateMatchmakingRuleSetCommandInput, ValidateMatchmakingRuleSetCommandOutput, GameLiftClientResolvedConfig> {
