...
export type DeleteMatchmakingRuleSetCommandOutput = DeleteMatchmakingRuleSetOutput;

export class DeleteMatchmakingRuleSetCommand extends $Command<DeleteMatchmakingRuleSetCommandInput, DeleteMatchmakingRuleSetCommandOutput, GameLiftClientResolvedConfig> {
