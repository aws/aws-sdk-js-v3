...
export type CreateAliasCommandOutput = CreateAliasOutput;

export class CreateAliasCommand extends $Command<CreateAliasCommandInput, CreateAliasCommandOutput, GameLiftClientResolvedConfig> {
