...
export type CreateVpcPeeringConnectionCommandOutput = CreateVpcPeeringConnectionOutput;

export class CreateVpcPeeringConnectionCommand extends $Command<CreateVpcPeeringConnectionCommandInput, CreateVpcPeeringConnectionCommandOutput, GameLiftClientResolvedConfig> {
