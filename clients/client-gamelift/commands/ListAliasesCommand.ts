...
export type ListAliasesCommandOutput = ListAliasesOutput;

export class ListAliasesCommand extends $Command<ListAliasesCommandInput, ListAliasesCommandOutput, GameLiftClientResolvedConfig> {
