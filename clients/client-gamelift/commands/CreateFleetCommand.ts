...
export type CreateFleetCommandOutput = CreateFleetOutput;

export class CreateFleetCommand extends $Command<CreateFleetCommandInput, CreateFleetCommandOutput, GameLiftClientResolvedConfig> {
