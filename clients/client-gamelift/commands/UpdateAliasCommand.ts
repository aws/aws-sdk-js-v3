...
export type UpdateAliasCommandOutput = UpdateAliasOutput;

export class UpdateAliasCommand extends $Command<UpdateAliasCommandInput, UpdateAliasCommandOutput, GameLiftClientResolvedConfig> {
