...
export type DescribeAliasCommandOutput = DescribeAliasOutput;

export class DescribeAliasCommand extends $Command<DescribeAliasCommandInput, DescribeAliasCommandOutput, GameLiftClientResolvedConfig> {
