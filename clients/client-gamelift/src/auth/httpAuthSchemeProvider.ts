...
import { type GameLiftClientResolvedConfig, GameLiftClientConfig } from "../GameLiftClient";
 ...
 * @internal
 */
export const defaultGameLiftHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: GameLiftHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultGameLiftHttpAuthSchemeProvider: GameLiftHttpAuthSchemeProvider = (authParameters) => {
