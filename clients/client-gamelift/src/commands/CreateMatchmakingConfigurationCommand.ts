 ...
 * @public
 */
export class CreateMatchmakingConfigurationCommand extends command<CreateMatchmakingConfigurationCommandInput, CreateMatchmakingConfigurationCommandOutput>(
  _ep0,
  _mw0,
