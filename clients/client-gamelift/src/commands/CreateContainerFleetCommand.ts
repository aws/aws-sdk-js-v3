...
import type { CreateContainerFleetInput, CreateContainerFleetOutput } from "../models/models_0";
 ...
 * @public
 */
export class CreateContainerFleetCommand extends command<CreateContainerFleetCommandInput, CreateContainerFleetCommandOutput>(
  _ep0,
  _mw0,
