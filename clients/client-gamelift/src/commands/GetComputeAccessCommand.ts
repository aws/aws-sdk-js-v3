...
import type { GetComputeAccessInput, GetComputeAccessOutput } from "../models/models_0";
 ...
 * @public
 */
export class GetComputeAccessCommand extends command<GetComputeAccessCommandInput, GetComputeAccessCommandOutput>(
  _ep0,
  _mw0,
  "GetComputeAccess",
  GetComputeAccess$
