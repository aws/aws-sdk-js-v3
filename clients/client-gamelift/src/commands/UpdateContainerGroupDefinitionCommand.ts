 ...
 * @public
 */
export class UpdateContainerGroupDefinitionCommand extends command<UpdateContainerGroupDefinitionCommandInput, UpdateContainerGroupDefinitionCommandOutput>(
  _ep0,
  _mw0,
