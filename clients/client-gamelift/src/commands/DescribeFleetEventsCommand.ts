...
import type { DescribeFleetEventsInput, DescribeFleetEventsOutput } from "../models/models_0";
 ...
 * @public
 */
export class DescribeFleetEventsCommand extends command<DescribeFleetEventsCommandInput, DescribeFleetEventsCommandOutput>(
  _ep0,
  _mw0,
  "DescribeFleetEvents",
  DescribeFleetEvents$
