...
import type { DeleteVpcPeeringAuthorizationInput, DeleteVpcPeeringAuthorizationOutput } from "../models/models_0";
import { DeleteVpcPeeringAuthorization$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteVpcPeeringAuthorizationCommand extends command<DeleteVpcPeeringAuthorizationCommandInput, DeleteVpcPeeringAuthorizationCommandOutput>(
  _ep0,
  _mw0,
