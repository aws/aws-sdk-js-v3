...
import type { DescribeContainerGroupDefinitionInput, DescribeContainerGroupDefinitionOutput } from "../models/models_0";
 ...
 * @public
 */
export class DescribeContainerGroupDefinitionCommand extends command<DescribeContainerGroupDefinitionCommandInput, DescribeContainerGroupDefinitionCommandOutput>(
  _ep0,
  _mw0,
