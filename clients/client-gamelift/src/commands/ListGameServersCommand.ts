...
import type { ListGameServersInput, ListGameServersOutput } from "../models/models_0";
import { ListGameServers$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ListGameServersCommand extends command<ListGameServersCommandInput, ListGameServersCommandOutput>(
  _ep0,
  _mw0,
  "ListGameServers",
  ListGameServers$
