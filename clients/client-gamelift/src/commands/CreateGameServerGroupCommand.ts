...
import type { CreateGameServerGroupInput, CreateGameServerGroupOutput } from "../models/models_0";
 ...
 * @public
 */
export class CreateGameServerGroupCommand extends command<CreateGameServerGroupCommandInput, CreateGameServerGroupCommandOutput>(
  _ep0,
  _mw0,
