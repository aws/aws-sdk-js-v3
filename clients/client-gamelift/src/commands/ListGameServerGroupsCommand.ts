...
import type { ListGameServerGroupsInput, ListGameServerGroupsOutput } from "../models/models_0";
import { ListGameServerGroups$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ListGameServerGroupsCommand extends command<ListGameServerGroupsCommandInput, ListGameServerGroupsCommandOutput>(
  _ep0,
  _mw0,
