 ...
 * @public
 */
export class ListContainerGroupDefinitionsCommand extends command<ListContainerGroupDefinitionsCommandInput, ListContainerGroupDefinitionsCommandOutput>(
  _ep0,
  _mw0,
