 ...
 * @public
 */
export class DescribeMatchmakingConfigurationsCommand extends command<DescribeMatchmakingConfigurationsCommandInput, DescribeMatchmakingConfigurationsCommandOutput>(
  _ep0,
  _mw0,
