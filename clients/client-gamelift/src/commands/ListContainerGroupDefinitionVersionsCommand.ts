 ...
 * @public
 */
export class ListContainerGroupDefinitionVersionsCommand extends command<ListContainerGroupDefinitionVersionsCommandInput, ListContainerGroupDefinitionVersionsCommandOutput>(
  _ep0,
  _mw0,
