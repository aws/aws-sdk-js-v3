...
import type { DescribeScriptInput, DescribeScriptOutput } from "../models/models_0";
 ...
 * @public
 */
export class DescribeScriptCommand extends command<DescribeScriptCommandInput, DescribeScriptCommandOutput>(
  _ep0,
  _mw0,
  "DescribeScript",
  DescribeScript$
