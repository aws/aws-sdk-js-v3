...
import type { CreatePlayerSessionInput, CreatePlayerSessionOutput } from "../models/models_0";
 ...
 * @public
 */
export class CreatePlayerSessionCommand extends command<CreatePlayerSessionCommandInput, CreatePlayerSessionCommandOutput>(
  _ep0,
  _mw0,
  "CreatePlayerSession",
  CreatePlayerSession$
