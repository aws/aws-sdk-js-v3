...
import type { DeleteGameServerGroupInput, DeleteGameServerGroupOutput } from "../models/models_0";
 ...
 * @public
 */
export class DeleteGameServerGroupCommand extends command<DeleteGameServerGroupCommandInput, DeleteGameServerGroupCommandOutput>(
  _ep0,
  _mw0,
