...
import type { CreatePlayerSessionsInput, CreatePlayerSessionsOutput } from "../models/models_0";
 ...
 * @public
 */
export class CreatePlayerSessionsCommand extends command<CreatePlayerSessionsCommandInput, CreatePlayerSessionsCommandOutput>(
  _ep0,
  _mw0,
