...
import type { DeleteContainerFleetInput, DeleteContainerFleetOutput } from "../models/models_0";
 ...
 * @public
 */
export class DeleteContainerFleetCommand extends command<DeleteContainerFleetCommandInput, DeleteContainerFleetCommandOutput>(
  _ep0,
  _mw0,
