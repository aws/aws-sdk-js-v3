...
import type { DescribeGameSessionQueuesInput, DescribeGameSessionQueuesOutput } from "../models/models_0";
 ...
 * @public
 */
export class DescribeGameSessionQueuesCommand extends command<DescribeGameSessionQueuesCommandInput, DescribeGameSessionQueuesCommandOutput>(
  _ep0,
  _mw0,
