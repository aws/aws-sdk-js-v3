...
import type { UpdateGameServerGroupInput, UpdateGameServerGroupOutput } from "../models/models_1";
 ...
 * @public
 */
export class UpdateGameServerGroupCommand extends command<UpdateGameServerGroupCommandInput, UpdateGameServerGroupCommandOutput>(
  _ep0,
  _mw0,
