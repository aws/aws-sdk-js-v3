...
import {
  defaultBackupStorageHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type BackupStorageClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
 ...
 * @public
 */
export type BackupStorageClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  /**
   * The resolved configuration of BackupStorageClient class. This is resolved and normalized from the {@link BackupStorageClientConfig | constructor configuration interface}.
   */
  readonly config: BackupStorageClientResolvedConfig;

  constructor(...[configuration]: __CheckOptionalClientConfig<BackupStorageClientConfig>) {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultBackupStorageHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: BackupStorageClientResolvedConfig) =>
