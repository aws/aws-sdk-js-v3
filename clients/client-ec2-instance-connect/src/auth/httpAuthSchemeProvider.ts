...
import {
  type EC2InstanceConnectClientResolvedConfig,
  EC2InstanceConnectClientConfig,
 ...
 * @internal
 */
export const defaultEC2InstanceConnectHttpAuthSchemeProvider: EC2InstanceConnectHttpAuthSchemeProvider = (authParameters) => {
