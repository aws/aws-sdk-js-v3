...
export var ConsumableResourceSummary$: StaticStructureSchema = [3, n0, _CRS,
  0,
...
export var CreateConsumableResourceRequest$: StaticStructureSchema = [3, n0, _CCRR,
  0,
  [_cRN, _tQ, _rT, _t],
  [0, 1, 0, 128 | 0], 1
];
export var CreateConsumableResourceResponse$: StaticStructureSchema = [3, n0, _CCRRr,
  0,
  [_cRN, _cRA],
  [0, 0], 2
];
export var CreateJobQueueRequest$: StaticStructureSchema = [3, n0, _CJQR,
  0,
...
export var CreateJobQueueResponse$: StaticStructureSchema = [3, n0, _CJQRr,
  0,
  [_jQN, _jQA],
  [0, 0], 2
];
...
export var CreateServiceEnvironmentRequest$: StaticStructureSchema = [3, n0, _CSER,
  0,
  [_sEN, _sET, _cL, _st, _t],
  [0, 0, () => CapacityLimits, 0, 128 | 0], 3
];
export var CreateServiceEnvironmentResponse$: StaticStructureSchema = [3, n0, _CSERr,
  0,
  [_sEN, _sEA],
  [0, 0], 2
];
export var DeleteComputeEnvironmentRequest$: StaticStructureSchema = [3, n0, _DCER,
  0,
  [_cE],
  [0], 1
];
export var DeleteComputeEnvironmentResponse$: StaticStructureSchema = [3, n0, _DCERe,
  0,
  [],
  []
];
export var DeleteConsumableResourceRequest$: StaticStructureSchema = [3, n0, _DCRR,
  0,
  [_cRo],
  [0], 1
];
export var DeleteConsumableResourceResponse$: StaticStructureSchema = [3, n0, _DCRRe,
  0,
  [],
  []
];
export var DeleteJobQueueRequest$: StaticStructureSchema = [3, n0, _DJQR,
  0,
  [_jQ],
  [0], 1
];
...
export var DeleteSchedulingPolicyRequest$: StaticStructureSchema = [3, n0, _DSPR,
  0,
  [_a],
  [0], 1
];
export var DeleteSchedulingPolicyResponse$: StaticStructureSchema = [3, n0, _DSPRe,
  0,
  [],
  []
];
export var DeleteServiceEnvironmentRequest$: StaticStructureSchema = [3, n0, _DSER,
  0,
  [_sE],
  [0], 1
];
export var DeleteServiceEnvironmentResponse$: StaticStructureSchema = [3, n0, _DSERe,
  0,
  [],
  []
];
export var DeregisterJobDefinitionRequest$: StaticStructureSchema = [3, n0, _DJDR,
  0,
  [_jD],
  [0], 1
];
export var DeregisterJobDefinitionResponse$: StaticStructureSchema = [3, n0, _DJDRe,
  0,
  [],
  []
];
export var DescribeComputeEnvironmentsRequest$: StaticStructureSchema = [3, n0, _DCERes,
  0,
  [_cEo, _mR, _nT],
  [64 | 0, 1, 0]
];
export var DescribeComputeEnvironmentsResponse$: StaticStructureSchema = [3, n0, _DCEResc,
  0,
  [_cEo, _nT],
  [() => ComputeEnvironmentDetailList, 0]
];
export var DescribeConsumableResourceRequest$: StaticStructureSchema = [3, n0, _DCRRes,
  0,
  [_cRo],
  [0], 1
];
export var DescribeConsumableResourceResponse$: StaticStructureSchema = [3, n0, _DCRResc,
  0,
  [_cRN, _cRA, _tQ, _iUQ, _aQ, _rT, _cA, _t],
  [0, 0, 1, 1, 1, 0, 1, 128 | 0], 2
];
export var DescribeJobDefinitionsRequest$: StaticStructureSchema = [3, n0, _DJDRes,
  0,
  [_jDo, _mR, _jDN, _sta, _nT],
  [64 | 0, 1, 0, 0, 0]
];
export var DescribeJobDefinitionsResponse$: StaticStructureSchema = [3, n0, _DJDResc,
  0,
  [_jDo, _nT],
  [() => JobDefinitionList, 0]
];
export var DescribeJobQueuesRequest$: StaticStructureSchema = [3, n0, _DJQRes,
  0,
  [_jQo, _mR, _nT],
  [64 | 0, 1, 0]
];
export var DescribeJobQueuesResponse$: StaticStructureSchema = [3, n0, _DJQResc,
  0,
  [_jQo, _nT],
...
export var DescribeServiceEnvironmentsResponse$: StaticStructureSchema = [3, n0, _DSEResc,
  0,
  [_sEe, _nT],
  [() => ServiceEnvironmentDetailList, 0]
];
export var DescribeServiceJobRequest$: StaticStructureSchema = [3, n0, _DSJR,
  0,
  [_jI],
  [0], 1
];
...
export var EcsPropertiesDetail$: StaticStructureSchema = [3, n0, _EPD,
  0,
  [_tP],
  [() => ListEcsTaskDetails]
];
export var EcsPropertiesOverride$: StaticStructureSchema = [3, n0, _EPO,
  0,
  [_tP],
...
export var EksContainer$: StaticStructureSchema = [3, n0, _ECks,
  ...
  [0, 0, 0, 64 | 0, 64 | 0, () => EksContainerEnvironmentVariables, () => EksContainerResourceRequirements$, () => EksContainerVolumeMounts, () => EksContainerSecurityContext$], 1
];
export var EksContainerDetail$: StaticStructureSchema = [3, n0, _ECD,
  0,
...
export var EksContainerEnvironmentVariable$: StaticStructureSchema = [3, n0, _ECEV,
  0,
  [_n, _va],
  [0, 0], 1
];
export var EksContainerOverride$: StaticStructureSchema = [3, n0, _ECO,
  0,
  [_n, _im, _com, _arg, _env, _re],
  [0, 0, 64 | 0, 64 | 0, () => EksContainerEnvironmentVariables, () => EksContainerResourceRequirements$]
];
export var EksContainerResourceRequirements$: StaticStructureSchema = [3, n0, _ECRR,
  0,
  [_l, _req],
  [128 | 0, 128 | 0]
];
export var EksContainerSecurityContext$: StaticStructureSchema = [3, n0, _ECSC,
  0,
  [_rAU, _rAG, _p, _aPE, _rORF, _rANR],
  [1, 1, 2, 2, 2, 2]
];
export var EksContainerVolumeMount$: StaticStructureSchema = [3, n0, _ECVM,
  0,
  [_n, _mPo, _sPu, _rO],
  [0, 0, 0, 2]
];
export var EksEmptyDir$: StaticStructureSchema = [3, n0, _EED,
  0,
  [_med, _sL],
  [0, 0]
];
export var EksHostPath$: StaticStructureSchema = [3, n0, _EHP,
  0,
  [_pa],
  [0]
];
export var EksMetadata$: StaticStructureSchema = [3, n0, _EM,
  0,
  [_la, _an, _na],
  [128 | 0, 128 | 0, 0]
];
export var EksPersistentVolumeClaim$: StaticStructureSchema = [3, n0, _EPVC,
  0,
  [_cN, _rO],
  [0, 2], 1
];
...
export var EksPropertiesDetail$: StaticStructureSchema = [3, n0, _EPDk,
  0,
  [_pP],
  [() => EksPodPropertiesDetail$]
];
export var EksPropertiesOverride$: StaticStructureSchema = [3, n0, _EPOk,
  0,
  [_pP],
...
export var EvaluateOnExit$: StaticStructureSchema = [3, n0, _EOE,
  0,
  [_ac, _oSR, _oR, _oEC],
  [0, 0, 0, 0], 1
];
...
export var ImagePullSecret$: StaticStructureSchema = [3, n0, _IPS,
  0,
  [_n],
  [0], 1
];
...
export var JobStateTimeLimitAction$: StaticStructureSchema = [3, n0, _JSTLA,
  0,
  [_r, _st, _mTS, _ac],
  [0, 0, 1, 0], 4
];
...
export var KeyValuesPair$: StaticStructureSchema = [3, n0, _KVPe,
  0,
  [_n, _val],
  [0, 64 | 0]
];
export var LatestServiceJobAttempt$: StaticStructureSchema = [3, n0, _LSJA,
  0,
  [_sRI],
  [() => ServiceResourceId$]
];
...
export var LaunchTemplateSpecificationOverride$: StaticStructureSchema = [3, n0, _LTSO,
  0,
...
export var ListConsumableResourcesRequest$: StaticStructureSchema = [3, n0, _LCRR,
  0,
  [_f, _mR, _nT],
  [() => ListConsumableResourcesFilterList, 1, 0]
];
export var ListConsumableResourcesResponse$: StaticStructureSchema = [3, n0, _LCRRi,
  0,
  [_cRon, _nT],
  [() => ConsumableResourceSummaryList, 0], 1
];
export var ListJobsByConsumableResourceRequest$: StaticStructureSchema = [3, n0, _LJBCRR,
  0,
  [_cRo, _f, _mR, _nT],
...
export var ListJobsByConsumableResourceSummary$: StaticStructureSchema = [3, n0, _LJBCRS,
  ...
  [0, 0, 0, 0, 1, 1, () => ConsumableResourceProperties$, 0, 0, 0, 1], 7
];
...
export var ListServiceJobsResponse$: StaticStructureSchema = [3, n0, _LSJRi,
  0,
  [_jSL, _nT],
...
export var NodeDetails$: StaticStructureSchema = [3, n0, _ND,
  0,
  [_nIo, _iMN],
  [1, 2]
];
export var NodeOverrides$: StaticStructureSchema = [3, n0, _NO,
  0,
  [_nNu, _nPO],
  [1, () => NodePropertyOverrides]
];
export var NodeProperties$: StaticStructureSchema = [3, n0, _NP,
  0,
  [_nNu, _mN, _nRP],
  [1, 1, () => NodeRangeProperties], 3
];
export var NodePropertiesSummary$: StaticStructureSchema = [3, n0, _NPS,
  0,
  [_iMN, _nNu, _nIo],
  [2, 1, 1]
];
export var NodePropertyOverride$: StaticStructureSchema = [3, n0, _NPO,
  0,
  [_tN, _cO, _ePO, _iT, _ePOk, _cRPO],
  [0, () => ContainerOverrides$, () => EcsPropertiesOverride$, 64 | 0, () => EksPropertiesOverride$, () => ConsumableResourceProperties$], 1
];
...
export var RetryStrategy$: StaticStructureSchema = [3, n0, _RS,
  0,
  [_at, _eOE],
...
export var ServiceEnvironmentOrder$: StaticStructureSchema = [3, n0, _SEO,
  0,
  [_o, _sE],
  [1, 0], 2
];
export var ServiceJobAttemptDetail$: StaticStructureSchema = [3, n0, _SJAD,
  0,
  [_sRI, _sA, _sAt, _sR],
...
export var ServiceResourceId$: StaticStructureSchema = [3, n0, _SRI,
  0,
  [_n, _va],
  [0, 0], 2
];
export var ShareAttributes$: StaticStructureSchema = [3, n0, _SA,
  0,
  [_sI, _wF],
  [0, 1], 1
];
export var SubmitJobRequest$: StaticStructureSchema = [3, n0, _SJR,
  0,
  [_jN, _jQ, _jD, _sI, _sPO, _aP, _dO, _par, _cO, _nO, _rS, _pT, _ti, _t, _ePOk, _ePO, _cRPO],
  [0, 0, 0, 0, 1, () => ArrayProperties$, () => JobDependencyList, 128 | 0, () => ContainerOverrides$, () => NodeOverrides$, () => RetryStrategy$, 2, () => JobTimeout$, 128 | 0, () => EksPropertiesOverride$, () => EcsPropertiesOverride$, () => ConsumableResourceProperties$], 3
];
export var SubmitJobResponse$: StaticStructureSchema = [3, n0, _SJRu,
  0,
  [_jN, _jI, _jA],
  [0, 0, 0], 2
];
...
export var TaskContainerDependency$: StaticStructureSchema = [3, n0, _TCD,
  0,
  [_cNo, _cond],
  [0, 0]
];
...
export var TerminateJobResponse$: StaticStructureSchema = [3, n0, _TJRe,
  0,
  [],
  []
];
...
export var TerminateServiceJobResponse$: StaticStructureSchema = [3, n0, _TSJRe,
  0,
  [],
  []
];
...
export var UpdateJobQueueRequest$: StaticStructureSchema = [3, n0, _UJQR,
  0,
  [_jQ, _st, _sPA, _pr, _cEO, _sEO, _jSTLA],
  [0, 0, 0, 1, () => ComputeEnvironmentOrders, () => ServiceEnvironmentOrders, () => JobStateTimeLimitActions], 1
];
export var UpdateJobQueueResponse$: StaticStructureSchema = [3, n0, _UJQRp,
  0,
  [_jQN, _jQA],
  [0, 0]
];
...
export var UpdateServiceEnvironmentRequest$: StaticStructureSchema = [3, n0, _USER,
  0,
  [_sE, _st, _cL],
  [0, 0, () => CapacityLimits], 1
];
export var UpdateServiceEnvironmentResponse$: StaticStructureSchema = [3, n0, _USERp,
  0,
  [_sEN, _sEA],
  [0, 0], 2
];
...
var ComputeEnvironmentDetailList: StaticListSchema = [1, n0, _CEDL,
  0, () => ComputeEnvironmentDetail$
];
var ComputeEnvironmentOrders: StaticListSchema = [1, n0, _CEOo,
  0, () => ComputeEnvironmentOrder$
];
var ConsumableResourceList: StaticListSchema = [1, n0, _CRL,
  0, () => ConsumableResourceRequirement$
];
var ConsumableResourceSummaryList: StaticListSchema = [1, n0, _CRSL,
  0, () => ConsumableResourceSummary$
];
var DeviceCgroupPermissions = 64 | 0;
var DevicesList: StaticListSchema = [1, n0, _DL,
  0, () => Device$
];
var Ec2ConfigurationList: StaticListSchema = [1, n0, _ECL,
  0, () => Ec2Configuration$
];
var EksAttemptContainerDetails: StaticListSchema = [1, n0, _EACDk,
  0, () => EksAttemptContainerDetail$
];
var EksAttemptDetails: StaticListSchema = [1, n0, _EADk,
  0, () => EksAttemptDetail$
];
var EksContainerDetails: StaticListSchema = [1, n0, _ECDk,
  0, () => EksContainerDetail$
];
var EksContainerEnvironmentVariables: StaticListSchema = [1, n0, _ECEVk,
  0, () => EksContainerEnvironmentVariable$
];
var EksContainerOverrideList: StaticListSchema = [1, n0, _ECOL,
  0, () => EksContainerOverride$
];
var EksContainers: StaticListSchema = [1, n0, _ECkso,
  0, () => EksContainer$
];
var EksContainerVolumeMounts: StaticListSchema = [1, n0, _ECVMk,
  0, () => EksContainerVolumeMount$
];
var EksVolumes: StaticListSchema = [1, n0, _EVk,
  0, () => EksVolume$
];
var EnvironmentVariables: StaticListSchema = [1, n0, _EVn,
  0, () => KeyValuePair$
];
...
var JobDependencyList: StaticListSchema = [1, n0, _JDLo,
  0, () => JobDependency$
];
var JobDetailList: StaticListSchema = [1, n0, _JDLob,
  0, () => JobDetail$
];
var JobQueueDetailList: StaticListSchema = [1, n0, _JQDL,
  0, () => JobQueueDetail$
];
var JobStateTimeLimitActions: StaticListSchema = [1, n0, _JSTLAo,
  0, () => JobStateTimeLimitAction$
];
var JobSummaryList: StaticListSchema = [1, n0, _JSL,
  0, () => JobSummary$
];
var LaunchTemplateSpecificationOverrideList: StaticListSchema = [1, n0, _LTSOL,
  0, () => LaunchTemplateSpecificationOverride$
];
var ListAttemptEcsTaskDetails: StaticListSchema = [1, n0, _LAETD,
  0, () => AttemptEcsTaskDetails$
];
var ListAttemptTaskContainerDetails: StaticListSchema = [1, n0, _LATCD,
  0, () => AttemptTaskContainerDetails$
];
var ListConsumableResourcesFilterList: StaticListSchema = [1, n0, _LCRFL,
  0, () => KeyValuesPair$
];
var ListEcsTaskDetails: StaticListSchema = [1, n0, _LETD,
  0, () => EcsTaskDetails$
];
var ListEcsTaskProperties: StaticListSchema = [1, n0, _LETP,
  0, () => EcsTaskProperties$
];
var ListJobsByConsumableResourceFilterList: StaticListSchema = [1, n0, _LJBCRFL,
  0, () => KeyValuesPair$
];
var ListJobsByConsumableResourceSummaryList: StaticListSchema = [1, n0, _LJBCRSL,
  0, () => ListJobsByConsumableResourceSummary$
];
var ListJobsFilterList: StaticListSchema = [1, n0, _LJFL,
  0, () => KeyValuesPair$
];
var ListTaskContainerDetails: StaticListSchema = [1, n0, _LTCD,
  0, () => TaskContainerDetails$
];
var ListTaskContainerOverrides: StaticListSchema = [1, n0, _LTCO,
  0, () => TaskContainerOverrides$
];
var ListTaskContainerProperties: StaticListSchema = [1, n0, _LTCP,
  0, () => TaskContainerProperties$
];
var ListTaskPropertiesOverride: StaticListSchema = [1, n0, _LTPO,
  0, () => TaskPropertiesOverride$
];
var MountPoints: StaticListSchema = [1, n0, _MPo,
  0, () => MountPoint$
];
var NetworkInterfaceList: StaticListSchema = [1, n0, _NIL,
  0, () => NetworkInterface$
];
var NodePropertyOverrides: StaticListSchema = [1, n0, _NPOo,
  0, () => NodePropertyOverride$
];
var NodeRangeProperties: StaticListSchema = [1, n0, _NRPo,
  0, () => NodeRangeProperty$
];
...
var SchedulingPolicyDetailList: StaticListSchema = [1, n0, _SPDL,
  0, () => SchedulingPolicyDetail$
];
var SchedulingPolicyListingDetailList: StaticListSchema = [1, n0, _SPLDL,
  0, () => SchedulingPolicyListingDetail$
];
var SecretList: StaticListSchema = [1, n0, _SL,
  0, () => Secret$
];
var ServiceEnvironmentDetailList: StaticListSchema = [1, n0, _SEDL,
  0, () => ServiceEnvironmentDetail$
];
var ServiceEnvironmentOrders: StaticListSchema = [1, n0, _SEOe,
...
var ShareAttributesList: StaticListSchema = [1, n0, _SAL,
  0, () => ShareAttributes$
];
var StringList = 64 | 0;
...
var Ulimits: StaticListSchema = [1, n0, _Ul,
  0, () => Ulimit$
];
var Volumes: StaticListSchema = [1, n0, _Vo,
  0, () => Volume$
];
...
export var CreateConsumableResource$: StaticOperationSchema = [9, n0, _CCR,
...
export var DeleteComputeEnvironment$: StaticOperationSchema = [9, n0, _DCE,
  { [_ht]: ["POST", "/v1/deletecomputeenvironment", 200] }, () => DeleteComputeEnvironmentRequest$, () => DeleteComputeEnvironmentResponse$
];
export var DeleteConsumableResource$: StaticOperationSchema = [9, n0, _DCR,
...
export var ListServiceJobs$: StaticOperationSchema = [9, n0, _LSJ,
...
export var RegisterJobDefinition$: StaticOperationSchema = [9, n0, _RJD,
  { [_ht]: ["POST", "/v1/registerjobdefinition", 200] }, () => RegisterJobDefinitionRequest$, () => RegisterJobDefinitionResponse$
];
export var SubmitJob$: StaticOperationSchema = [9, n0, _SJ,
  { [_ht]: ["POST", "/v1/submitjob", 200] }, () => SubmitJobRequest$, () => SubmitJobResponse$
];
export var SubmitServiceJob$: StaticOperationSchema = [9, n0, _SSJ,
...
export var UpdateComputeEnvironment$: StaticOperationSchema = [9, n0, _UCE,
  { [_ht]: ["POST", "/v1/updatecomputeenvironment", 200] }, () => UpdateComputeEnvironmentRequest$, () => UpdateComputeEnvironmentResponse$
];
export var UpdateConsumableResource$: StaticOperationSchema = [9, n0, _UCR,
