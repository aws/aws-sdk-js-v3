...
import { type BatchClientResolvedConfig, BatchClientConfig } from "../BatchClient";
 ...
 * @internal
 */
export const defaultBatchHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: BatchHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultBatchHttpAuthSchemeProvider: BatchHttpAuthSchemeProvider = (authParameters) => {
