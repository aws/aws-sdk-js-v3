...
export class CreateComputeEnvironmentCommand extends $Command<CreateComputeEnvironmentCommandInput, CreateComputeEnvironmentCommandOutput, BatchClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1CreateComputeEnvironmentCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateComputeEnvironmentCommand(output, context);
  }
