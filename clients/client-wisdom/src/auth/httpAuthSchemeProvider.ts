...
import { type WisdomClientResolvedConfig, WisdomClientConfig } from "../WisdomClient";
 ...
 * @internal
 */
export const defaultWisdomHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: WisdomHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultWisdomHttpAuthSchemeProvider: WisdomHttpAuthSchemeProvider = (authParameters) => {
