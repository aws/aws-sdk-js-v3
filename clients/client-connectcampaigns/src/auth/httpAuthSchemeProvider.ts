...
import { type ConnectCampaignsClientResolvedConfig, ConnectCampaignsClientConfig } from "../ConnectCampaignsClient";
 ...
 * @internal
 */
export const defaultConnectCampaignsHttpAuthSchemeProvider: ConnectCampaignsHttpAuthSchemeProvider = (authParameters) => {
