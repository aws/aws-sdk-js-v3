...
export async function deserializeAws_queryStartDBClusterCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBCluster(data.StartDBClusterResult, context);
...
export async function deserializeAws_queryStopDBClusterCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBCluster(data.StopDBClusterResult, context);
...
const deserializeAws_queryCertificateMessage = (
  ...
  if (output["Certificates"]["Certificate"] !== undefined) {
