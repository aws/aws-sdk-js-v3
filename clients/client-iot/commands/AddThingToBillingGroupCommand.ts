...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1AddThingToBillingGroupCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1AddThingToBillingGroupCommand(output, context);
  }
