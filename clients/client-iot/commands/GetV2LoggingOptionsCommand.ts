...
import { GetV2LoggingOptionsRequest, GetV2LoggingOptionsResponse } from "../models/index";
import {
...
> {
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetV2LoggingOptionsCommand(output, context);
  }
