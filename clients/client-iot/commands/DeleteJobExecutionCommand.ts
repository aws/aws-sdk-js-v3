...
import {
  deserializeAws_restJson1_1DeleteJobExecutionCommand,
  serializeAws_restJson1_1DeleteJobExecutionCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteJobExecutionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DeleteJobExecutionCommand(output, context);
  }
