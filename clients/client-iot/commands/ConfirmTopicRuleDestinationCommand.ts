...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ConfirmTopicRuleDestinationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ConfirmTopicRuleDestinationCommand(output, context);
  }
