...
import { ListThingRegistrationTasksRequest, ListThingRegistrationTasksResponse } from "../models/index";
import {
  deserializeAws_restJson1_1ListThingRegistrationTasksCommand,
  serializeAws_restJson1_1ListThingRegistrationTasksCommand
...
> {
  ...
  private serialize(input: ListThingRegistrationTasksCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1ListThingRegistrationTasksCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListThingRegistrationTasksCommand(output, context);
  }
