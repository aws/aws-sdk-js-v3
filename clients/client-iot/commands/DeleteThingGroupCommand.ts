...
import { DeleteThingGroupRequest, DeleteThingGroupResponse } from "../models/index";
import {
  deserializeAws_restJson1_1DeleteThingGroupCommand,
  serializeAws_restJson1_1DeleteThingGroupCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteThingGroupCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DeleteThingGroupCommand(output, context);
  }
