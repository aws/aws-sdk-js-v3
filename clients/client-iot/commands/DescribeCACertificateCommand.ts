...
import { DescribeCACertificateRequest, DescribeCACertificateResponse } from "../models/index";
import {
  deserializeAws_restJson1_1DescribeCACertificateCommand,
  serializeAws_restJson1_1DescribeCACertificateCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DescribeCACertificateCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeCACertificateCommand(output, context);
  }
