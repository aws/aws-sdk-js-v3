...
import {
  ...
  serializeAws_restJson1_1CancelJobCommand
...
export type CancelJobCommandOutput = CancelJobResponse;
...
> {
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CancelJobCommand(output, context);
  }
