...
import { UpdateCACertificateRequest } from "../models/index";
import {
  deserializeAws_restJson1_1UpdateCACertificateCommand,
  serializeAws_restJson1_1UpdateCACertificateCommand
...
> {
  ...
  private serialize(input: UpdateCACertificateCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1UpdateCACertificateCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<UpdateCACertificateCommandOutput> {
    return deserializeAws_restJson1_1UpdateCACertificateCommand(output, context);
  }
