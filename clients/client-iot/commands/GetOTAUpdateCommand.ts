...
import {
  deserializeAws_restJson1_1GetOTAUpdateCommand,
  serializeAws_restJson1_1GetOTAUpdateCommand
...
export type GetOTAUpdateCommandOutput = GetOTAUpdateResponse;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetOTAUpdateCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetOTAUpdateCommand(output, context);
  }
