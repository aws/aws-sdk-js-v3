...
import {
  deserializeAws_restJson1_1UpdateThingGroupCommand,
  serializeAws_restJson1_1UpdateThingGroupCommand
...
export type UpdateThingGroupCommandOutput = UpdateThingGroupResponse &
  __MetadataBearer;
