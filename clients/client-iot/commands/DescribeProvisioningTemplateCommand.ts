...
import { DescribeProvisioningTemplateRequest, DescribeProvisioningTemplateResponse } from "../models/index";
import {
  deserializeAws_restJson1_1DescribeProvisioningTemplateCommand,
  serializeAws_restJson1_1DescribeProvisioningTemplateCommand
...
> {
  ...
  private serialize(input: DescribeProvisioningTemplateCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1DescribeProvisioningTemplateCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeProvisioningTemplateCommand(output, context);
  }
