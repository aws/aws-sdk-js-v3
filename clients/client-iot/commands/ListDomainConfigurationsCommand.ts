...
import { ListDomainConfigurationsRequest, ListDomainConfigurationsResponse } from "../models/index";
import {
  deserializeAws_restJson1_1ListDomainConfigurationsCommand,
  serializeAws_restJson1_1ListDomainConfigurationsCommand
...
export type ListDomainConfigurationsCommandOutput = ListDomainConfigurationsResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ListDomainConfigurationsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListDomainConfigurationsCommand(output, context);
  }
