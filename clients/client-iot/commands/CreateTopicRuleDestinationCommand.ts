...
import { CreateTopicRuleDestinationRequest, CreateTopicRuleDestinationResponse } from "../models/index";
import {
  deserializeAws_restJson1_1CreateTopicRuleDestinationCommand,
  serializeAws_restJson1_1CreateTopicRuleDestinationCommand
...
> {
  ...
  private serialize(input: CreateTopicRuleDestinationCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1CreateTopicRuleDestinationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateTopicRuleDestinationCommand(output, context);
  }
