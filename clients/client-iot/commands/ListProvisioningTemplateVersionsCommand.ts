...
import { ListProvisioningTemplateVersionsRequest, ListProvisioningTemplateVersionsResponse } from "../models/index";
import {
  deserializeAws_restJson1_1ListProvisioningTemplateVersionsCommand,
  serializeAws_restJson1_1ListProvisioningTemplateVersionsCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ListProvisioningTemplateVersionsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListProvisioningTemplateVersionsCommand(output, context);
  }
