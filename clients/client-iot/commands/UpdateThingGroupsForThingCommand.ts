...
import { UpdateThingGroupsForThingRequest, UpdateThingGroupsForThingResponse } from "../models/index";
import {
...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      logger: {} as any,
      clientName: "IoT",
      clientName: "updateThingGroupsForThing",
      inputFilterLog: UpdateThingGroupsForThingRequest.filterSensitiveLog,
      outputFilterLog: UpdateThingGroupsForThingResponse.filterSensitiveLog,
    };
