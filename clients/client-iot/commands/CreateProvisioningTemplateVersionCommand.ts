...
import { CreateProvisioningTemplateVersionRequest, CreateProvisioningTemplateVersionResponse } from "../models/index";
import {
  deserializeAws_restJson1_1CreateProvisioningTemplateVersionCommand,
  serializeAws_restJson1_1CreateProvisioningTemplateVersionCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1CreateProvisioningTemplateVersionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateProvisioningTemplateVersionCommand(output, context);
  }
