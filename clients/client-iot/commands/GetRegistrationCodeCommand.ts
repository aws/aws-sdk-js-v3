...
import {
  deserializeAws_restJson1_1GetRegistrationCodeCommand,
  serializeAws_restJson1_1GetRegistrationCodeCommand
...
> {
  ...
  private serialize(input: GetRegistrationCodeCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1GetRegistrationCodeCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetRegistrationCodeCommandOutput> {
    return deserializeAws_restJson1_1GetRegistrationCodeCommand(output, context);
  }
