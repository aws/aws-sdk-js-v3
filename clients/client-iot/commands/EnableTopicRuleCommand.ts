...
import {
  deserializeAws_restJson1_1EnableTopicRuleCommand,
  serializeAws_restJson1_1EnableTopicRuleCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1EnableTopicRuleCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1EnableTopicRuleCommand(output, context);
  }
