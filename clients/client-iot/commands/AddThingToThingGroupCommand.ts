...
import { AddThingToThingGroupRequest, AddThingToThingGroupResponse } from "../models/index";
import {
  deserializeAws_restJson1_1AddThingToThingGroupCommand,
  serializeAws_restJson1_1AddThingToThingGroupCommand
...
> {
  ...
  private serialize(input: AddThingToThingGroupCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1AddThingToThingGroupCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<AddThingToThingGroupCommandOutput> {
    return deserializeAws_restJson1_1AddThingToThingGroupCommand(output, context);
  }
