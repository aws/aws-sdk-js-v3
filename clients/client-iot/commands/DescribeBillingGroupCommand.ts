...
import { DescribeBillingGroupRequest, DescribeBillingGroupResponse } from "../models/index";
import {
...
> {
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeBillingGroupCommand(output, context);
  }
