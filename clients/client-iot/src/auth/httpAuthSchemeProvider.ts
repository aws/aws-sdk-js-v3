...
import { type IoTClientResolvedConfig, IoTClientConfig } from "../IoTClient";
 ...
 * @internal
 */
export const defaultIoTHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: IoTHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultIoTHttpAuthSchemeProvider: IoTHttpAuthSchemeProvider = (authParameters) => {
