...
import type { UpdateStreamRequest, UpdateStreamResponse } from "../models/models_2";
 ...
 * @public
 */
export class UpdateStreamCommand extends command<UpdateStreamCommandInput, UpdateStreamCommandOutput>(
  _ep0,
  _mw0,
  "UpdateStream",
  UpdateStream$
