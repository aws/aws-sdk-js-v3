...
import type { UpdateRoleAliasRequest, UpdateRoleAliasResponse } from "../models/models_2";
 ...
 * @public
 */
export class UpdateRoleAliasCommand extends command<UpdateRoleAliasCommandInput, UpdateRoleAliasCommandOutput>(
  _ep0,
  _mw0,
  "UpdateRoleAlias",
  UpdateRoleAlias$
