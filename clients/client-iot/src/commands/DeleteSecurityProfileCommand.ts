...
import { DeleteSecurityProfile$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteSecurityProfileCommand extends command<DeleteSecurityProfileCommandInput, DeleteSecurityProfileCommandOutput>(
  _ep0,
  _mw0,
