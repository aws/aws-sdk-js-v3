...
import { DescribeCACertificate$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DescribeCACertificateCommand extends command<DescribeCACertificateCommandInput, DescribeCACertificateCommandOutput>(
  _ep0,
  _mw0,
