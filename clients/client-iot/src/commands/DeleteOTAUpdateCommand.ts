...
import { DeleteOTAUpdate$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteOTAUpdateCommand extends command<DeleteOTAUpdateCommandInput, DeleteOTAUpdateCommandOutput>(
  _ep0,
  _mw0,
  "DeleteOTAUpdate",
  DeleteOTAUpdate$
