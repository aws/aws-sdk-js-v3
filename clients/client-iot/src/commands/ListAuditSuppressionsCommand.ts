...
import type { ListAuditSuppressionsRequest, ListAuditSuppressionsResponse } from "../models/models_1";
 ...
 * @public
 */
export class ListAuditSuppressionsCommand extends command<ListAuditSuppressionsCommandInput, ListAuditSuppressionsCommandOutput>(
  _ep0,
  _mw0,
