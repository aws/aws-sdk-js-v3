...
import { GetBucketsAggregation$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetBucketsAggregationCommand extends command<GetBucketsAggregationCommandInput, GetBucketsAggregationCommandOutput>(
  _ep0,
  _mw0,
