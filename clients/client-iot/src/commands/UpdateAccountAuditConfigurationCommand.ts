 ...
 * @public
 */
export class UpdateAccountAuditConfigurationCommand extends command<UpdateAccountAuditConfigurationCommandInput, UpdateAccountAuditConfigurationCommandOutput>(
  _ep0,
  _mw0,
