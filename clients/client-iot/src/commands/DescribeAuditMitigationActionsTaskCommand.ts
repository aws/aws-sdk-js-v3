 ...
 * @public
 */
export class DescribeAuditMitigationActionsTaskCommand extends command<DescribeAuditMitigationActionsTaskCommandInput, DescribeAuditMitigationActionsTaskCommandOutput>(
  _ep0,
  _mw0,
