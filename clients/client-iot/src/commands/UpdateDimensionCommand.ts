...
import type { UpdateDimensionRequest, UpdateDimensionResponse } from "../models/models_2";
 ...
 * @public
 */
export class UpdateDimensionCommand extends command<UpdateDimensionCommandInput, UpdateDimensionCommandOutput>(
  _ep0,
  _mw0,
  "UpdateDimension",
  UpdateDimension$
