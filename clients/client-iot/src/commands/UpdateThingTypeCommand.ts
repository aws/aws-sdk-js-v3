...
import type { UpdateThingTypeRequest, UpdateThingTypeResponse } from "../models/models_2";
 ...
 * @public
 */
export class UpdateThingTypeCommand extends command<UpdateThingTypeCommandInput, UpdateThingTypeCommandOutput>(
  _ep0,
  _mw0,
  "UpdateThingType",
  UpdateThingType$
