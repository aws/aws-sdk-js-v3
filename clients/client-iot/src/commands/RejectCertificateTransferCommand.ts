...
import { RejectCertificateTransfer$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class RejectCertificateTransferCommand extends command<RejectCertificateTransferCommandInput, RejectCertificateTransferCommandOutput>(
  _ep0,
  _mw0,
