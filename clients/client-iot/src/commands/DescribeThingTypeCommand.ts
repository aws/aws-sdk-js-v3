...
import type { DescribeThingTypeRequest, DescribeThingTypeResponse } from "../models/models_1";
 ...
 * @public
 */
export class DescribeThingTypeCommand extends command<DescribeThingTypeCommandInput, DescribeThingTypeCommandOutput>(
  _ep0,
  _mw0,
  "DescribeThingType",
  DescribeThingType$
