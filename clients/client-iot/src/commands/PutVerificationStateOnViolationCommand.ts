 ...
 * @public
 */
export class PutVerificationStateOnViolationCommand extends command<PutVerificationStateOnViolationCommandInput, PutVerificationStateOnViolationCommandOutput>(
  _ep0,
  _mw0,
