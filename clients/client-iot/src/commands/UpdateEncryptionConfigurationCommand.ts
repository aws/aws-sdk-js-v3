 ...
 * @public
 */
export class UpdateEncryptionConfigurationCommand extends command<UpdateEncryptionConfigurationCommandInput, UpdateEncryptionConfigurationCommandOutput>(
  _ep0,
  _mw0,
