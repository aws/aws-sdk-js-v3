...
import type { DetachPrincipalPolicyRequest } from "../models/models_1";
 ...
 * @public
 */
export class DetachPrincipalPolicyCommand extends command<DetachPrincipalPolicyCommandInput, DetachPrincipalPolicyCommandOutput>(
  _ep0,
  _mw0,
