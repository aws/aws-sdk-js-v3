 ...
 * ```
 *
 * @param DescribeProvisioningTemplateVersionRequest - {@link DescribeProvisioningTemplateVersionRequest}
 * @returns {@link DescribeProvisioningTemplateVersionResponse}
