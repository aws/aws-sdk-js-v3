 ...
 * @public
 */
export class ListDetectMitigationActionsTasksCommand extends command<ListDetectMitigationActionsTasksCommandInput, ListDetectMitigationActionsTasksCommandOutput>(
  _ep0,
  _mw0,
