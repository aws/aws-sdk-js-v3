...
import { DescribeFleetMetric$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DescribeFleetMetricCommand extends command<DescribeFleetMetricCommandInput, DescribeFleetMetricCommandOutput>(
  _ep0,
  _mw0,
  "DescribeFleetMetric",
  DescribeFleetMetric$
