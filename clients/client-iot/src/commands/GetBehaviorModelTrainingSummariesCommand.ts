 ...
 * @public
 */
export class GetBehaviorModelTrainingSummariesCommand extends command<GetBehaviorModelTrainingSummariesCommandInput, GetBehaviorModelTrainingSummariesCommandOutput>(
  _ep0,
  _mw0,
