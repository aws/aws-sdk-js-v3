...
import type { DeleteJobTemplateRequest } from "../models/models_0";
 ...
 * @public
 */
export class DeleteJobTemplateCommand extends command<DeleteJobTemplateCommandInput, DeleteJobTemplateCommandOutput>(
  _ep0,
  _mw0,
  "DeleteJobTemplate",
  DeleteJobTemplate$
