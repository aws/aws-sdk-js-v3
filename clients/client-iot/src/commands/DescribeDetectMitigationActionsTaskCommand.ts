 ...
 * @public
 */
export class DescribeDetectMitigationActionsTaskCommand extends command<DescribeDetectMitigationActionsTaskCommandInput, DescribeDetectMitigationActionsTaskCommandOutput>(
  _ep0,
  _mw0,
