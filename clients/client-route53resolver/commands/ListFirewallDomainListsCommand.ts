...
export type ListFirewallDomainListsCommandInput = ListFirewallDomainListsRequest;
export type ListFirewallDomainListsCommandOutput = ListFirewallDomainListsResponse & __MetadataBearer;
