...
export declare type ServiceInputTypes = AssociateResolverEndpointIpAddressCommandInput | AssociateResolverRuleCommandInput | CreateResolverEndpointCommandInput | CreateResolverRuleCommandInput | DeleteResolverEndpointCommandInput | DeleteResolverRuleCommandInput | DisassociateResolverEndpointIpAddressCommandInput | DisassociateResolverRuleCommandInput | GetResolverEndpointCommandInput | GetResolverRuleAssociationCommandInput | GetResolverRuleCommandInput | GetResolverRulePolicyCommandInput | ListResolverEndpointIpAddressesCommandInput | ListResolverEndpointsCommandInput | ListResolverRuleAssociationsCommandInput | ListResolverRulesCommandInput | ListTagsForResourceCommandInput | PutResolverRulePolicyCommandInput | TagResourceCommandInput | UntagResourceCommandInput | UpdateResolverEndpointCommandInput | UpdateResolverRuleCommandInput;
export declare type ServiceOutputTypes = AssociateResolverEndpointIpAddressCommandOutput | AssociateResolverRuleCommandOutput | CreateResolverEndpointCommandOutput | CreateResolverRuleCommandOutput | DeleteResolverEndpointCommandOutput | DeleteResolverRuleCommandOutput | DisassociateResolverEndpointIpAddressCommandOutput | DisassociateResolverRuleCommandOutput | GetResolverEndpointCommandOutput | GetResolverRuleAssociationCommandOutput | GetResolverRuleCommandOutput | GetResolverRulePolicyCommandOutput | ListResolverEndpointIpAddressesCommandOutput | ListResolverEndpointsCommandOutput | ListResolverRuleAssociationsCommandOutput | ListResolverRulesCommandOutput | ListTagsForResourceCommandOutput | PutResolverRulePolicyCommandOutput | TagResourceCommandOutput | UntagResourceCommandOutput | UpdateResolverEndpointCommandOutput | UpdateResolverRuleCommandOutput;
...
export declare type Route53ResolverClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type Route53ResolverClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
