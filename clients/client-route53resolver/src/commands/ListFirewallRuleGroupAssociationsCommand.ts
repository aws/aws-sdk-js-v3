 ...
 * @public
 */
export class ListFirewallRuleGroupAssociationsCommand extends command<ListFirewallRuleGroupAssociationsCommandInput, ListFirewallRuleGroupAssociationsCommandOutput>(
  _ep0,
  _mw0,
