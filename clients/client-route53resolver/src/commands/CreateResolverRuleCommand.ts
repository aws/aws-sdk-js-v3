...
import type { CreateResolverRuleRequest, CreateResolverRuleResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateResolverRuleCommand extends command<CreateResolverRuleCommandInput, CreateResolverRuleCommandOutput>(
  _ep0,
  _mw0,
  "CreateResolverRule",
  CreateResolverRule$
