...
import type { DeleteResolverQueryLogConfigRequest, DeleteResolverQueryLogConfigResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteResolverQueryLogConfigCommand extends command<DeleteResolverQueryLogConfigCommandInput, DeleteResolverQueryLogConfigCommandOutput>(
  _ep0,
  _mw0,
