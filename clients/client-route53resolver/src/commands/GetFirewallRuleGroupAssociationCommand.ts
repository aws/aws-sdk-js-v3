 ...
 * @public
 */
export class GetFirewallRuleGroupAssociationCommand extends command<GetFirewallRuleGroupAssociationCommandInput, GetFirewallRuleGroupAssociationCommandOutput>(
  _ep0,
  _mw0,
