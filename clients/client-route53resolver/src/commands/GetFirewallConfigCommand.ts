...
import type { GetFirewallConfigRequest, GetFirewallConfigResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetFirewallConfigCommand extends command<GetFirewallConfigCommandInput, GetFirewallConfigCommandOutput>(
  _ep0,
  _mw0,
  "GetFirewallConfig",
  GetFirewallConfig$
