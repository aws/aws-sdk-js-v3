...
import type { GetResolverDnssecConfigRequest, GetResolverDnssecConfigResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetResolverDnssecConfigCommand extends command<GetResolverDnssecConfigCommandInput, GetResolverDnssecConfigCommandOutput>(
  _ep0,
  _mw0,
