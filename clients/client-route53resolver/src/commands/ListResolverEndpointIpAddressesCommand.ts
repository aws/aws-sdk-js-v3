 ...
 * @public
 */
export class ListResolverEndpointIpAddressesCommand extends command<ListResolverEndpointIpAddressesCommandInput, ListResolverEndpointIpAddressesCommandOutput>(
  _ep0,
  _mw0,
