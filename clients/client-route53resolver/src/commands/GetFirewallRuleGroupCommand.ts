...
import type { GetFirewallRuleGroupRequest, GetFirewallRuleGroupResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetFirewallRuleGroupCommand extends command<GetFirewallRuleGroupCommandInput, GetFirewallRuleGroupCommandOutput>(
  _ep0,
  _mw0,
