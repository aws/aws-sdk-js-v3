 ...
 * ```
 *
 * @param GetResolverQueryLogConfigAssociationRequest - {@link GetResolverQueryLogConfigAssociationRequest}
 * @returns {@link GetResolverQueryLogConfigAssociationResponse}
