...
import type { GetOutpostResolverRequest, GetOutpostResolverResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetOutpostResolverCommand extends command<GetOutpostResolverCommandInput, GetOutpostResolverCommandOutput>(
  _ep0,
  _mw0,
  "GetOutpostResolver",
  GetOutpostResolver$
