...
export type DescribeApplicationStateCommandOutput = DescribeApplicationStateResult;

export class DescribeApplicationStateCommand extends $Command<DescribeApplicationStateCommandInput, DescribeApplicationStateCommandOutput, MigrationHubClientResolvedConfig> {
