...
export var ListApplicationStatesResult$: StaticStructureSchema = [3, n0, _LASRi,
  0,
  [_ASL, _NT],
...
export var ListMigrationTasksRequest$: StaticStructureSchema = [3, n0, _LMTR,
  0,
  [_NT, _MR, _RN],
  [0, 1, 0]
];
export var ListMigrationTasksResult$: StaticStructureSchema = [3, n0, _LMTRi,
  0,
  [_NT, _MTSL],
...
export var ListProgressUpdateStreamsRequest$: StaticStructureSchema = [3, n0, _LPUSR,
  0,
  [_NT, _MR],
  [0, 1]
];
export var ListProgressUpdateStreamsResult$: StaticStructureSchema = [3, n0, _LPUSRi,
  0,
  [_PUSSL, _NT],
...
export var MigrationTask$: StaticStructureSchema = [3, n0, _MT,
  0,
  [_PUS, _MTN, _T, _UDT, _RAL],
  [0, 0, () => Task$, 4, () => LatestResourceAttributeList]
];
export var MigrationTaskSummary$: StaticStructureSchema = [3, n0, _MTS,
  0,
  [_PUS, _MTN, _S, _PP, _SD, _UDT],
  [0, 0, 0, 1, 0, 4]
];
export var MigrationTaskUpdate$: StaticStructureSchema = [3, n0, _MTU,
  0,
  [_UDT, _UT, _MTSi],
  [4, 0, () => Task$]
];
...
var CreatedArtifactList: StaticListSchema = [1, n0, _CAL,
  0, () => CreatedArtifact$
];
var DiscoveredResourceList: StaticListSchema = [1, n0, _DRL,
  0, () => DiscoveredResource$
];
var LatestResourceAttributeList: StaticListSchema = [1, n0, _LRAL,
  0, () => ResourceAttribute$
];
var MigrationTaskSummaryList: StaticListSchema = [1, n0, _MTSL,
  0, () => MigrationTaskSummary$
];
var MigrationTaskUpdateList: StaticListSchema = [1, n0, _MTUL,
  0, () => MigrationTaskUpdate$
];
var ProgressUpdateStreamSummaryList: StaticListSchema = [1, n0, _PUSSL,
  0, () => ProgressUpdateStreamSummary$
];
var ResourceAttributeList: StaticListSchema = [1, n0, _RAL,
  0, () => ResourceAttribute$
];
var SourceResourceList: StaticListSchema = [1, n0, _SRL,
  0, () => SourceResource$
];
export var AssociateCreatedArtifact$: StaticOperationSchema = [9, n0, _ACA,
  0, () => AssociateCreatedArtifactRequest$, () => AssociateCreatedArtifactResult$
];
export var AssociateDiscoveredResource$: StaticOperationSchema = [9, n0, _ADR,
  0, () => AssociateDiscoveredResourceRequest$, () => AssociateDiscoveredResourceResult$
];
export var AssociateSourceResource$: StaticOperationSchema = [9, n0, _ASR,
  0, () => AssociateSourceResourceRequest$, () => AssociateSourceResourceResult$
];
export var CreateProgressUpdateStream$: StaticOperationSchema = [9, n0, _CPUS,
  0, () => CreateProgressUpdateStreamRequest$, () => CreateProgressUpdateStreamResult$
];
export var DeleteProgressUpdateStream$: StaticOperationSchema = [9, n0, _DPUS,
  0, () => DeleteProgressUpdateStreamRequest$, () => DeleteProgressUpdateStreamResult$
];
export var DescribeApplicationState$: StaticOperationSchema = [9, n0, _DAS,
  0, () => DescribeApplicationStateRequest$, () => DescribeApplicationStateResult$
];
export var DescribeMigrationTask$: StaticOperationSchema = [9, n0, _DMT,
  0, () => DescribeMigrationTaskRequest$, () => DescribeMigrationTaskResult$
];
export var DisassociateCreatedArtifact$: StaticOperationSchema = [9, n0, _DCA,
  0, () => DisassociateCreatedArtifactRequest$, () => DisassociateCreatedArtifactResult$
];
export var DisassociateDiscoveredResource$: StaticOperationSchema = [9, n0, _DDR,
  0, () => DisassociateDiscoveredResourceRequest$, () => DisassociateDiscoveredResourceResult$
];
export var DisassociateSourceResource$: StaticOperationSchema = [9, n0, _DSR,
  0, () => DisassociateSourceResourceRequest$, () => DisassociateSourceResourceResult$
];
export var ImportMigrationTask$: StaticOperationSchema = [9, n0, _IMT,
  0, () => ImportMigrationTaskRequest$, () => ImportMigrationTaskResult$
];
export var ListApplicationStates$: StaticOperationSchema = [9, n0, _LAS,
  0, () => ListApplicationStatesRequest$, () => ListApplicationStatesResult$
];
export var ListCreatedArtifacts$: StaticOperationSchema = [9, n0, _LCA,
...
export var ListMigrationTasks$: StaticOperationSchema = [9, n0, _LMT,
  0, () => ListMigrationTasksRequest$, () => ListMigrationTasksResult$
];
export var ListMigrationTaskUpdates$: StaticOperationSchema = [9, n0, _LMTU,
  0, () => ListMigrationTaskUpdatesRequest$, () => ListMigrationTaskUpdatesResult$
];
export var ListProgressUpdateStreams$: StaticOperationSchema = [9, n0, _LPUS,
  0, () => ListProgressUpdateStreamsRequest$, () => ListProgressUpdateStreamsResult$
];
export var ListSourceResources$: StaticOperationSchema = [9, n0, _LSR,
  0, () => ListSourceResourcesRequest$, () => ListSourceResourcesResult$
];
export var NotifyApplicationState$: StaticOperationSchema = [9, n0, _NAS,
  0, () => NotifyApplicationStateRequest$, () => NotifyApplicationStateResult$
];
export var NotifyMigrationTaskState$: StaticOperationSchema = [9, n0, _NMTS,
  0, () => NotifyMigrationTaskStateRequest$, () => NotifyMigrationTaskStateResult$
];
export var PutResourceAttributes$: StaticOperationSchema = [9, n0, _PRA,
