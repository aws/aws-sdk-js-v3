 ...
 * @public
 */
export class DisassociateDiscoveredResourceCommand extends command<DisassociateDiscoveredResourceCommandInput, DisassociateDiscoveredResourceCommandOutput>(
  _ep0,
  _mw0,
