 ...
 * @public
 */
export class ListSupplementalTaxRegistrationsCommand extends command<ListSupplementalTaxRegistrationsCommandInput, ListSupplementalTaxRegistrationsCommandOutput>(
  _ep0,
  _mw0,
