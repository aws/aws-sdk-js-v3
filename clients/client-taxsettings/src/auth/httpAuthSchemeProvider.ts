...
import { TaxSettingsClientConfig, TaxSettingsClientResolvedConfig } from "../TaxSettingsClient";
 ...
 * @internal
 */
export const defaultTaxSettingsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: TaxSettingsHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultTaxSettingsHttpAuthSchemeProvider: TaxSettingsHttpAuthSchemeProvider = (authParameters) => {
