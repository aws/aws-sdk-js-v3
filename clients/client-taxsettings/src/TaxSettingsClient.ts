 ...
 * @public
 *
 *  The configuration interface of TaxSettingsClient class constructor that set the region, credentials and other options.
 */
 ...
 * @public
 */
export type TaxSettingsClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 *
 *  The resolved configuration interface of TaxSettingsClient class. This is resolved and normalized from the {@link TaxSettingsClientConfig | constructor configuration interface}.
 */
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<TaxSettingsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultTaxSettingsHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: TaxSettingsClientResolvedConfig) =>
