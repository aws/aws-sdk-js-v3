  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<KinesisVideoClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultKinesisVideoHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: KinesisVideoClientResolvedConfig) =>
