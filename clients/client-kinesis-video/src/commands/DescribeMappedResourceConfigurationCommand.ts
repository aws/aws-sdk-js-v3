 ...
 * @public
 */
export class DescribeMappedResourceConfigurationCommand extends command<DescribeMappedResourceConfigurationCommandInput, DescribeMappedResourceConfigurationCommandOutput>(
  _ep0,
  _mw0,
