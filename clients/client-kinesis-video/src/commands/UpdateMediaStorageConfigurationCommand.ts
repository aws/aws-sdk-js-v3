 ...
 * @public
 */
export class UpdateMediaStorageConfigurationCommand extends command<UpdateMediaStorageConfigurationCommandInput, UpdateMediaStorageConfigurationCommandOutput>(
  _ep0,
  _mw0,
