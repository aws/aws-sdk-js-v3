 ...
 * @public
 */
export class UpdateStreamStorageConfigurationCommand extends command<UpdateStreamStorageConfigurationCommandInput, UpdateStreamStorageConfigurationCommandOutput>(
  _ep0,
  _mw0,
