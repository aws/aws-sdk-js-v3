 ...
 * @public
 */
export class DescribeNotificationConfigurationCommand extends command<DescribeNotificationConfigurationCommandInput, DescribeNotificationConfigurationCommandOutput>(
  _ep0,
  _mw0,
