 ...
 * @public
 */
export class DescribeStreamStorageConfigurationCommand extends command<DescribeStreamStorageConfigurationCommandInput, DescribeStreamStorageConfigurationCommandOutput>(
  _ep0,
  _mw0,
