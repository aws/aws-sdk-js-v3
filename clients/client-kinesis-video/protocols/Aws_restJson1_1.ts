...
export const serializeAws_restJson1_1ListSignalingChannelsCommand = async (
  ...
  body = JSON.stringify({
    ...(input.ChannelNameCondition !== undefined && {
      ChannelNameCondition: serializeAws_restJson1_1ChannelNameCondition(input.ChannelNameCondition, context)
    }),
...
export const serializeAws_restJson1_1ListStreamsCommand = async (
  ...
  body = JSON.stringify({
    ...
    ...(input.StreamNameCondition !== undefined && {
      StreamNameCondition: serializeAws_restJson1_1StreamNameCondition(input.StreamNameCondition, context)
    })
  });
  const { hostname, protocol = "https", port } = await context.endpoint();
  return new __HttpRequest({
...
const deserializeAws_restJson1_1CreateSignalingChannelCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazon.kinesis.video.v20170930#AccountChannelLimitExceededException":
      response = {
        ...(await deserializeAws_restJson1_1AccountChannelLimitExceededExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
    ...
    case "com.amazon.kinesis.video.v20170930#TagsPerResourceExceededLimitException":
      response = {
        ...(await deserializeAws_restJson1_1TagsPerResourceExceededLimitExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
...
const deserializeAws_restJson1_1CreateStreamCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazon.kinesis.video.v20170930#AccountStreamLimitExceededException":
      response = {
        ...(await deserializeAws_restJson1_1AccountStreamLimitExceededExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
    ...
    case "com.amazon.kinesis.video.v20170930#DeviceStreamLimitExceededException":
      response = {
        ...(await deserializeAws_restJson1_1DeviceStreamLimitExceededExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
...
const deserializeAws_restJson1_1DeleteSignalingChannelCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazon.kinesis.video.v20170930#VersionMismatchException":
      response = {
        ...(await deserializeAws_restJson1_1VersionMismatchExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
...
export const deserializeAws_restJson1_1GetSignalingChannelEndpointCommand = async (
  ...
  if (data.ResourceEndpointList !== undefined && data.ResourceEndpointList !== null) {
    contents.ResourceEndpointList = deserializeAws_restJson1_1ResourceEndpointList(data.ResourceEndpointList, context);
  }
  return Promise.resolve(contents);
};
...
export const deserializeAws_restJson1_1ListSignalingChannelsCommand = async (
  ...
  if (data.ChannelInfoList !== undefined && data.ChannelInfoList !== null) {
    contents.ChannelInfoList = deserializeAws_restJson1_1ChannelInfoList(data.ChannelInfoList, context);
  }
...
const deserializeAws_restJson1_1ListTagsForStreamCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazon.kinesis.video.v20170930#InvalidResourceFormatException":
      response = {
        ...(await deserializeAws_restJson1_1InvalidResourceFormatExceptionResponse(parsedOutput, context)),
        name: errorCode,
        $metadata: deserializeMetadata(output)
      };
      break;
...
const serializeAws_restJson1_1ChannelNameCondition = (input: ChannelNameCondition, context: __SerdeContext): any => {
  return {
...
const serializeAws_restJson1_1ListOfProtocols = (input: (ChannelProtocol | string)[], context: __SerdeContext): any => {
  return input.map(entry => entry);
};

const serializeAws_restJson1_1ResourceTags = (input: { [key: string]: string }, context: __SerdeContext): any => {
...
const serializeAws_restJson1_1StreamNameCondition = (input: StreamNameCondition, context: __SerdeContext): any => {
  return {
    ...(input.ComparisonOperator !== undefined && {
      ComparisonOperator: input.ComparisonOperator
    }),
...
const deserializeAws_restJson1_1ChannelInfo = (output: any, context: __SerdeContext): ChannelInfo => {
  return {
    __type: "ChannelInfo",
    ...
    SingleMasterConfiguration:
      output.SingleMasterConfiguration !== undefined && output.SingleMasterConfiguration !== null
        ? deserializeAws_restJson1_1SingleMasterConfiguration(output.SingleMasterConfiguration, context)
        : undefined,
    Version: output.Version !== undefined && output.Version !== null ? output.Version : undefined
  } as any;
};

const deserializeAws_restJson1_1ChannelInfoList = (output: any, context: __SerdeContext): ChannelInfo[] => {
...
const deserializeAws_restJson1_1ResourceEndpointList = (
  ...
  return (output || []).map((entry: any) => deserializeAws_restJson1_1ResourceEndpointListItem(entry, context));
};
...
const deserializeAws_restJson1_1ResourceTags = (output: any, context: __SerdeContext): { [key: string]: string } => {
...
const deserializeAws_restJson1_1SingleMasterConfiguration = (
  ...
  return {
    ...
    MessageTtlSeconds:
      output.MessageTtlSeconds !== undefined && output.MessageTtlSeconds !== null ? output.MessageTtlSeconds : undefined
  } as any;
};
...
const deserializeAws_restJson1_1StreamInfoList = (output: any, context: __SerdeContext): StreamInfo[] => {
