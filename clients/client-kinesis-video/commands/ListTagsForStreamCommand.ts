...
import {
  deserializeAws_restJson1_1ListTagsForStreamCommand,
  serializeAws_restJson1_1ListTagsForStreamCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ListTagsForStreamCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListTagsForStreamCommand(output, context);
  }
