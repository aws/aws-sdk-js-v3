...
import {
  ...
  serializeAws_restJson1_1DescribeStreamCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DescribeStreamCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeStreamCommand(output, context);
  }
