...
export var BatchGetPolicyErrorItem$: StaticStructureSchema = [3, n0, _BGPEI,
  0,
  [_co, _pSI, _pI, _m],
  [0, 0, 0, 0]
];
...
export var CognitoGroupConfiguration$: StaticStructureSchema = [3, n0, _CGC,
  0,
  [_gET],
  [[() => GroupEntityType, 0]]
];
export var CognitoGroupConfigurationDetail$: StaticStructureSchema = [3, n0, _CGCD,
  0,
  [_gET],
  [[() => GroupEntityType, 0]]
];
export var CognitoGroupConfigurationItem$: StaticStructureSchema = [3, n0, _CGCI,
  0,
  [_gET],
  [[() => GroupEntityType, 0]]
];
export var CognitoUserPoolConfiguration$: StaticStructureSchema = [3, n0, _CUPC,
  0,
  [_uPA, _cI, _gC],
  [0, [() => ClientIds, 0], [() => CognitoGroupConfiguration$, 0]]
];
export var CognitoUserPoolConfigurationDetail$: StaticStructureSchema = [3, n0, _CUPCD,
  0,
  [_uPA, _cI, _i, _gC],
  [0, [() => ClientIds, 0], 0, [() => CognitoGroupConfigurationDetail$, 0]]
];
export var CognitoUserPoolConfigurationItem$: StaticStructureSchema = [3, n0, _CUPCI,
  0,
  [_uPA, _cI, _i, _gC],
...
export var CreateIdentitySourceOutput$: StaticStructureSchema = [3, n0, _CISO,
  0,
  [_cD, _iSI, _lUD, _pSI],
  [5, 0, 5, 0]
];
...
export var DeleteIdentitySourceInput$: StaticStructureSchema = [3, n0, _DISI,
  0,
  [_pSI, _iSI],
  [0, 0]
];
export var DeleteIdentitySourceOutput$: StaticStructureSchema = [3, n0, _DISO,
  0,
  [],
  []
];
export var DeletePolicyInput$: StaticStructureSchema = [3, n0, _DPI,
  0,
  [_pSI, _pI],
  [0, 0]
];
...
export var DeletePolicyStoreInput$: StaticStructureSchema = [3, n0, _DPSI,
  0,
  [_pSI],
  [0]
];
export var DeletePolicyStoreOutput$: StaticStructureSchema = [3, n0, _DPSO,
  0,
  [],
  []
];
export var DeletePolicyTemplateInput$: StaticStructureSchema = [3, n0, _DPTI,
  0,
  [_pSI, _pTI],
  [0, 0]
];
export var DeletePolicyTemplateOutput$: StaticStructureSchema = [3, n0, _DPTO,
  0,
  [],
  []
];
export var DeterminingPolicyItem$: StaticStructureSchema = [3, n0, _DPIe,
  0,
  [_pI],
  [0]
];
export var EntityIdentifier$: StaticStructureSchema = [3, n0, _EIn,
  0,
  [_eT, _eI],
  [[() => EntityType, 0], [() => EntityId, 0]]
];
export var EntityItem$: StaticStructureSchema = [3, n0, _EInt,
  0,
  [_id, _at, _pa, _t],
  [[() => EntityIdentifier$, 0], [() => EntityAttributes, 0], [() => ParentList, 0], [() => EntityCedarTags, 0]]
];
export var EvaluationErrorItem$: StaticStructureSchema = [3, n0, _EEI,
  8,
  [_eD],
  [0]
];
export var GetIdentitySourceInput$: StaticStructureSchema = [3, n0, _GISI,
  0,
  [_pSI, _iSI],
  [0, 0]
];
export var GetIdentitySourceOutput$: StaticStructureSchema = [3, n0, _GISO,
  0,
...
export var IdentitySourceFilter$: StaticStructureSchema = [3, n0, _ISF,
  0,
  [_pET],
  [[() => PrincipalEntityType, 0]]
];
export var IdentitySourceItem$: StaticStructureSchema = [3, n0, _ISI,
  0,
  [_cD, _det, _iSI, _lUD, _pSI, _pET, _conf],
  [5, [() => IdentitySourceItemDetails$, 0], 0, 5, 0, [() => PrincipalEntityType, 0], [() => ConfigurationItem$, 0]]
];
export var IdentitySourceItemDetails$: StaticStructureSchema = [3, n0, _ISID,
  0,
  [_cI, _uPA, _dU, _oII],
  [[() => ClientIds, 0], 0, 0, 0]
];
...
export var ListIdentitySourcesOutput$: StaticStructureSchema = [3, n0, _LISO,
  0,
  [_nT, _iS],
  [0, [() => IdentitySources, 0]]
];
export var ListPoliciesInput$: StaticStructureSchema = [3, n0, _LPI,
  0,
  [_pSI, _nT, _mR, _fi],
  [0, 0, 1, [() => PolicyFilter$, 0]]
];
export var ListPoliciesOutput$: StaticStructureSchema = [3, n0, _LPO,
  0,
  [_nT, _po],
  [0, [() => PolicyList, 0]]
];
...
export var ListPolicyStoresOutput$: StaticStructureSchema = [3, n0, _LPSO,
  0,
  [_nT, _pS],
  [0, [() => PolicyStoreList, 0]]
];
export var ListPolicyTemplatesInput$: StaticStructureSchema = [3, n0, _LPTI,
  0,
  [_pSI, _nT, _mR],
  [0, 0, 1]
];
export var ListPolicyTemplatesOutput$: StaticStructureSchema = [3, n0, _LPTO,
  0,
  [_nT, _pTo],
...
export var OpenIdConnectAccessTokenConfiguration$: StaticStructureSchema = [3, n0, _OICATC,
  0,
  [_pIC, _au],
  [[() => Claim, 0], 64 | 0]
];
export var OpenIdConnectAccessTokenConfigurationDetail$: StaticStructureSchema = [3, n0, _OICATCD,
  0,
  [_pIC, _au],
  [[() => Claim, 0], 64 | 0]
];
export var OpenIdConnectAccessTokenConfigurationItem$: StaticStructureSchema = [3, n0, _OICATCI,
  0,
  [_pIC, _au],
  [[() => Claim, 0], 64 | 0]
];
export var OpenIdConnectConfiguration$: StaticStructureSchema = [3, n0, _OICC,
  0,
  [_i, _eIP, _gC, _tS],
  [0, [() => EntityIdPrefix, 0], [() => OpenIdConnectGroupConfiguration$, 0], [() => OpenIdConnectTokenSelection$, 0]]
];
export var OpenIdConnectConfigurationDetail$: StaticStructureSchema = [3, n0, _OICCD,
  0,
  [_i, _eIP, _gC, _tS],
  [0, [() => EntityIdPrefix, 0], [() => OpenIdConnectGroupConfigurationDetail$, 0], [() => OpenIdConnectTokenSelectionDetail$, 0]]
];
export var OpenIdConnectConfigurationItem$: StaticStructureSchema = [3, n0, _OICCI,
  0,
  [_i, _eIP, _gC, _tS],
  [0, [() => EntityIdPrefix, 0], [() => OpenIdConnectGroupConfigurationItem$, 0], [() => OpenIdConnectTokenSelectionItem$, 0]]
];
export var OpenIdConnectGroupConfiguration$: StaticStructureSchema = [3, n0, _OICGC,
  0,
  [_gCr, _gET],
  [[() => Claim, 0], [() => GroupEntityType, 0]]
];
export var OpenIdConnectGroupConfigurationDetail$: StaticStructureSchema = [3, n0, _OICGCD,
  0,
  [_gCr, _gET],
  [[() => Claim, 0], [() => GroupEntityType, 0]]
];
export var OpenIdConnectGroupConfigurationItem$: StaticStructureSchema = [3, n0, _OICGCI,
  0,
  [_gCr, _gET],
  [[() => Claim, 0], [() => GroupEntityType, 0]]
];
export var OpenIdConnectIdentityTokenConfiguration$: StaticStructureSchema = [3, n0, _OICITC,
  0,
  [_pIC, _cI],
  [[() => Claim, 0], [() => ClientIds, 0]]
];
export var OpenIdConnectIdentityTokenConfigurationDetail$: StaticStructureSchema = [3, n0, _OICITCD,
  0,
  [_pIC, _cI],
  [[() => Claim, 0], [() => ClientIds, 0]]
];
export var OpenIdConnectIdentityTokenConfigurationItem$: StaticStructureSchema = [3, n0, _OICITCI,
  0,
  [_pIC, _cI],
  [[() => Claim, 0], [() => ClientIds, 0]]
];
...
export var UpdateCognitoGroupConfiguration$: StaticStructureSchema = [3, n0, _UCGC,
  0,
  [_gET],
  [[() => GroupEntityType, 0]]
];
export var UpdateCognitoUserPoolConfiguration$: StaticStructureSchema = [3, n0, _UCUPC,
  0,
  [_uPA, _cI, _gC],
  [0, [() => ClientIds, 0], [() => UpdateCognitoGroupConfiguration$, 0]]
];
export var UpdateIdentitySourceInput$: StaticStructureSchema = [3, n0, _UISI,
  0,
  [_pSI, _iSI, _uC, _pET],
  [0, 0, [() => UpdateConfiguration$, 0], [() => PrincipalEntityType, 0]]
];
export var UpdateIdentitySourceOutput$: StaticStructureSchema = [3, n0, _UISO,
  0,
  [_cD, _iSI, _lUD, _pSI],
  [5, 0, 5, 0]
];
export var UpdateOpenIdConnectAccessTokenConfiguration$: StaticStructureSchema = [3, n0, _UOICATC,
  0,
  [_pIC, _au],
  [[() => Claim, 0], 64 | 0]
];
export var UpdateOpenIdConnectConfiguration$: StaticStructureSchema = [3, n0, _UOICC,
  0,
  [_i, _eIP, _gC, _tS],
  [0, [() => EntityIdPrefix, 0], [() => UpdateOpenIdConnectGroupConfiguration$, 0], [() => UpdateOpenIdConnectTokenSelection$, 0]]
];
export var UpdateOpenIdConnectGroupConfiguration$: StaticStructureSchema = [3, n0, _UOICGC,
  0,
  [_gCr, _gET],
  [[() => Claim, 0], [() => GroupEntityType, 0]]
];
export var UpdateOpenIdConnectIdentityTokenConfiguration$: StaticStructureSchema = [3, n0, _UOICITC,
  0,
  [_pIC, _cI],
  [[() => Claim, 0], [() => ClientIds, 0]]
];
...
export var UpdatePolicyStoreOutput$: StaticStructureSchema = [3, n0, _UPSO,
  0,
  [_pSI, _ar, _cD, _lUD],
  [0, 0, 5, 5]
];
...
export var ValidationSettings$: StaticStructureSchema = [3, n0, _VS,
  0,
  [_mo],
  [0]
];
...
var Audiences = 64 | 0;
var BatchGetPolicyErrorList: StaticListSchema = [1, n0, _BGPEL,
  0, () => BatchGetPolicyErrorItem$
];
var BatchGetPolicyInputList: StaticListSchema = [1, n0, _BGPIL,
  0, () => BatchGetPolicyInputItem$
];
var BatchGetPolicyOutputList: StaticListSchema = [1, n0, _BGPOL,
  0, [() => BatchGetPolicyOutputItem$,
    0]
];
var BatchIsAuthorizedInputList: StaticListSchema = [1, n0, _BIAIL,
  0, [() => BatchIsAuthorizedInputItem$,
    0]
];
var BatchIsAuthorizedOutputList: StaticListSchema = [1, n0, _BIAOL,
  0, [() => BatchIsAuthorizedOutputItem$,
    0]
];
var BatchIsAuthorizedWithTokenInputList: StaticListSchema = [1, n0, _BIAWTIL,
  0, [() => BatchIsAuthorizedWithTokenInputItem$,
    0]
];
var BatchIsAuthorizedWithTokenOutputList: StaticListSchema = [1, n0, _BIAWTOL,
  0, [() => BatchIsAuthorizedWithTokenOutputItem$,
    0]
];
var CedarTagSetAttribute: StaticListSchema = [1, n0, _CTSA,
  0, [() => CedarTagValue$,
    0]
];
var ClientIds: StaticListSchema = [1, n0, _CIl,
  0, [() => ClientId,
    0]
];
var DeterminingPolicyList: StaticListSchema = [1, n0, _DPL,
...
var EvaluationErrorList: StaticListSchema = [1, n0, _EEL,
  0, [() => EvaluationErrorItem$,
    0]
];
var IdentitySourceFilters: StaticListSchema = [1, n0, _ISFd,
  0, [() => IdentitySourceFilter$,
    0]
];
var IdentitySources: StaticListSchema = [1, n0, _IS,
  0, [() => IdentitySourceItem$,
    0]
];
var NamespaceList: StaticListSchema = [1, n0, _NL,
  0, [() => Namespace,
    0]
];
var ParentList: StaticListSchema = [1, n0, _PL,
  0, [() => EntityIdentifier$,
    0]
];
...
var PolicyTemplatesList: StaticListSchema = [1, n0, _PTL,
  0, [() => PolicyTemplateItem$,
    0]
];
var ResourceConflictList: StaticListSchema = [1, n0, _RCL,
  0, () => ResourceConflict$
];
var SetAttribute: StaticListSchema = [1, n0, _SAe,
  0, [() => AttributeValue$,
    0]
];
var TagKeyList = 64 | 0;
...
var CedarTagRecordAttribute: StaticMapSchema = [2, n0, _CTRA,
  0, [0,
    0]
  , [() => CedarTagValue$,
    0]
];
var ContextMap: StaticMapSchema = [2, n0, _CM,
  8, [0,
    0]
  , [() => AttributeValue$,
    0]
...
var EntityCedarTags: StaticMapSchema = [2, n0, _ECT,
  0, [0,
    0]
  , [() => CedarTagValue$,
    0]
];
var RecordAttribute: StaticMapSchema = [2, n0, _RA,
  0, [0,
    0]
  , [() => AttributeValue$,
    0]
...
export var ConfigurationDetail$: StaticUnionSchema = [4, n0, _CD,
  0,
  [_cUPC, _oICC],
  [[() => CognitoUserPoolConfigurationDetail$, 0], [() => OpenIdConnectConfigurationDetail$, 0]]
];
export var ConfigurationItem$: StaticUnionSchema = [4, n0, _CIo,
  0,
  [_cUPC, _oICC],
  [[() => CognitoUserPoolConfigurationItem$, 0], [() => OpenIdConnectConfigurationItem$, 0]]
];
export var ContextDefinition$: StaticUnionSchema = [4, n0, _CDo,
  0,
  [_cM, _cJ],
...
export var EntityReference$: StaticUnionSchema = [4, n0, _ER,
  0,
  [_u, _id],
  [2, [() => EntityIdentifier$, 0]]
];
export var OpenIdConnectTokenSelection$: StaticUnionSchema = [4, n0, _OICTS,
  0,
  [_aTO, _iTO],
  [[() => OpenIdConnectAccessTokenConfiguration$, 0], [() => OpenIdConnectIdentityTokenConfiguration$, 0]]
];
export var OpenIdConnectTokenSelectionDetail$: StaticUnionSchema = [4, n0, _OICTSD,
  0,
  [_aTO, _iTO],
  [[() => OpenIdConnectAccessTokenConfigurationDetail$, 0], [() => OpenIdConnectIdentityTokenConfigurationDetail$, 0]]
];
export var OpenIdConnectTokenSelectionItem$: StaticUnionSchema = [4, n0, _OICTSI,
  0,
  [_aTO, _iTO],
...
export var UpdateConfiguration$: StaticUnionSchema = [4, n0, _UC,
  0,
  [_cUPC, _oICC],
  [[() => UpdateCognitoUserPoolConfiguration$, 0], [() => UpdateOpenIdConnectConfiguration$, 0]]
];
export var UpdateOpenIdConnectTokenSelection$: StaticUnionSchema = [4, n0, _UOICTS,
  0,
  [_aTO, _iTO],
...
export var BatchIsAuthorized$: StaticOperationSchema = [9, n0, _BIA,
  0, () => BatchIsAuthorizedInput$, () => BatchIsAuthorizedOutput$
];
export var BatchIsAuthorizedWithToken$: StaticOperationSchema = [9, n0, _BIAWT,
  0, () => BatchIsAuthorizedWithTokenInput$, () => BatchIsAuthorizedWithTokenOutput$
];
export var CreateIdentitySource$: StaticOperationSchema = [9, n0, _CIS,
  2, () => CreateIdentitySourceInput$, () => CreateIdentitySourceOutput$
];
export var CreatePolicy$: StaticOperationSchema = [9, n0, _CP,
...
export var DeleteIdentitySource$: StaticOperationSchema = [9, n0, _DIS,
...
export var GetIdentitySource$: StaticOperationSchema = [9, n0, _GIS,
...
export var GetSchema$: StaticOperationSchema = [9, n0, _GS,
  0, () => GetSchemaInput$, () => GetSchemaOutput$
];
export var IsAuthorized$: StaticOperationSchema = [9, n0, _IAs,
  0, () => IsAuthorizedInput$, () => IsAuthorizedOutput$
];
export var IsAuthorizedWithToken$: StaticOperationSchema = [9, n0, _IAWT,
...
export var ListPolicyTemplates$: StaticOperationSchema = [9, n0, _LPT,
  0, () => ListPolicyTemplatesInput$, () => ListPolicyTemplatesOutput$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceInput$, () => ListTagsForResourceOutput$
];
export var PutSchema$: StaticOperationSchema = [9, n0, _PSu,
...
export var UpdateIdentitySource$: StaticOperationSchema = [9, n0, _UIS,
...
export var UpdatePolicyStore$: StaticOperationSchema = [9, n0, _UPS,
  2, () => UpdatePolicyStoreInput$, () => UpdatePolicyStoreOutput$
];
export var UpdatePolicyTemplate$: StaticOperationSchema = [9, n0, _UPT,
