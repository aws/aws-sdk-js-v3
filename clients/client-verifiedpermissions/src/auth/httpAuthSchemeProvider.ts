...
import { VerifiedPermissionsClientConfig, VerifiedPermissionsClientResolvedConfig } from "../VerifiedPermissionsClient";
 ...
 * @internal
 */
export const defaultVerifiedPermissionsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: VerifiedPermissionsHttpAuthSchemeParameters): HttpAuthOption {
  return {
