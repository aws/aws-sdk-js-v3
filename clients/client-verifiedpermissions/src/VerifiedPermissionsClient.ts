  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<VerifiedPermissionsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultVerifiedPermissionsHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: VerifiedPermissionsClientResolvedConfig) =>
