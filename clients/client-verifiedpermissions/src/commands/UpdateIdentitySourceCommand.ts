...
> {
  ...
  ): Handler<UpdateIdentitySourceCommandInput, UpdateIdentitySourceCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, UpdateIdentitySourceCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: UpdateIdentitySourceCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
