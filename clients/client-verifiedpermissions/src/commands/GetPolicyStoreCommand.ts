...
> {
   ...
   * @public
   */
  constructor(readonly input: GetPolicyStoreCommandInput) {
  ...
  resolveMiddleware(
    ...
    this.middlewareStack.use(
      getEndpointPlugin(configuration, GetPolicyStoreCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "GetPolicyStoreCommand";
   ...
   * @internal
   */
  private serialize(input: GetPolicyStoreCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_GetPolicyStoreCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetPolicyStoreCommandOutput> {
    return de_GetPolicyStoreCommand(output, context);
  }
