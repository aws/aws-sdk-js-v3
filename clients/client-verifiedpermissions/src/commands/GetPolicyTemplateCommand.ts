...
> {
   ...
   * @public
   */
  constructor(readonly input: GetPolicyTemplateCommandInput) {
  ...
  resolveMiddleware(
    ...
    this.middlewareStack.use(
      getEndpointPlugin(configuration, GetPolicyTemplateCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: GetPolicyTemplateCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_GetPolicyTemplateCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetPolicyTemplateCommandOutput> {
    return de_GetPolicyTemplateCommand(output, context);
  }
