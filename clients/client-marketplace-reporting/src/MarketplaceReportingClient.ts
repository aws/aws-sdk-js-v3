...
import {
  defaultMarketplaceReportingHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type MarketplaceReportingClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type MarketplaceReportingClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 */
export class MarketplaceReportingClient extends __Client<
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<MarketplaceReportingClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultMarketplaceReportingHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: MarketplaceReportingClientResolvedConfig) =>
