...
import {
  type MarketplaceReportingClientResolvedConfig,
...
function createAwsAuthSigv4HttpAuthOption(authParameters: MarketplaceReportingHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultMarketplaceReportingHttpAuthSchemeProvider: MarketplaceReportingHttpAuthSchemeProvider = (authParameters) => {
