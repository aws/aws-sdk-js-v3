...
import {
  ...
  defaultTrustedAdvisorHttpAuthSchemeParametersProvider,
...
import type { ListChecksCommandInput, ListChecksCommandOutput } from "./commands/ListChecksCommand";
import type {
 ...
 * @public
 */
export type TrustedAdvisorClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<TrustedAdvisorClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultTrustedAdvisorHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: TrustedAdvisorClientResolvedConfig) =>
