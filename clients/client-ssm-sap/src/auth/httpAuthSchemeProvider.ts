...
import { type SsmSapClientResolvedConfig, SsmSapClientConfig } from "../SsmSapClient";
 ...
 * @internal
 */
export const defaultSsmSapHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SsmSapHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultSsmSapHttpAuthSchemeProvider: SsmSapHttpAuthSchemeProvider = (authParameters) => {
