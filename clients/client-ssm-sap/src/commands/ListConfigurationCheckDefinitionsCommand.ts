 ...
 * @public
 */
export class ListConfigurationCheckDefinitionsCommand extends command<ListConfigurationCheckDefinitionsCommandInput, ListConfigurationCheckDefinitionsCommandOutput>(
  _ep0,
  _mw0,
