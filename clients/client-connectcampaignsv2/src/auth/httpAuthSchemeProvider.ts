...
import {
  type ConnectCampaignsV2ClientResolvedConfig,
  ConnectCampaignsV2ClientConfig,
 ...
 * @internal
 */
export const defaultConnectCampaignsV2HttpAuthSchemeProvider: ConnectCampaignsV2HttpAuthSchemeProvider = (authParameters) => {
