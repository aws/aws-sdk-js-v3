 ...
 * @public
 */
export class DeleteCampaignChannelSubtypeConfigCommand extends command<DeleteCampaignChannelSubtypeConfigCommandInput, DeleteCampaignChannelSubtypeConfigCommandOutput>(
  _ep0,
  _mw0,
