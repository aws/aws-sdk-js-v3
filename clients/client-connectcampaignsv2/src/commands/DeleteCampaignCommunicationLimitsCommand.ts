 ...
 * @public
 */
export class DeleteCampaignCommunicationLimitsCommand extends command<DeleteCampaignCommunicationLimitsCommandInput, DeleteCampaignCommunicationLimitsCommandOutput>(
  _ep0,
  _mw0,
