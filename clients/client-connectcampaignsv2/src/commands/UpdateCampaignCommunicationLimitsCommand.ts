 ...
 * @public
 */
export class UpdateCampaignCommunicationLimitsCommand extends command<UpdateCampaignCommunicationLimitsCommandInput, UpdateCampaignCommunicationLimitsCommandOutput>(
  _ep0,
  _mw0,
