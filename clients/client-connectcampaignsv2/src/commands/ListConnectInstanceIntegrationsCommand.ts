 ...
 * @public
 */
export class ListConnectInstanceIntegrationsCommand extends command<ListConnectInstanceIntegrationsCommandInput, ListConnectInstanceIntegrationsCommandOutput>(
  _ep0,
  _mw0,
