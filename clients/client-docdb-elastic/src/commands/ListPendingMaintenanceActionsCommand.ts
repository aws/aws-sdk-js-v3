 ...
 * @public
 */
export class ListPendingMaintenanceActionsCommand extends command<ListPendingMaintenanceActionsCommandInput, ListPendingMaintenanceActionsCommandOutput>(
  _ep0,
  _mw0,
