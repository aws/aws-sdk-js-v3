...
export var DocDBElasticServiceException$: StaticErrorSchema = [-3, _s, "DocDBElasticServiceException", 0, [], []];
...
export var ListClusterSnapshotsInput$: StaticStructureSchema = [3, n0, _LCSI,
  0,
  [_cA, _nT, _mR, _sT],
  [[0, { [_hQ]: _cA }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _sT }]]
];
export var ListClusterSnapshotsOutput$: StaticStructureSchema = [3, n0, _LCSO,
  0,
  [_sna, _nT],
...
export var ListPendingMaintenanceActionsInput$: StaticStructureSchema = [3, n0, _LPMAI,
  0,
  [_nT, _mR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
...
var ClusterSnapshotList: StaticListSchema = [1, n0, _CSL,
  0, () => ClusterSnapshotInList$
];
var PendingMaintenanceActionDetailsList: StaticListSchema = [1, n0, _PMADL,
  0, () => PendingMaintenanceActionDetails$
];
var ResourcePendingMaintenanceActionList: StaticListSchema = [1, n0, _RPMAL,
  0, () => ResourcePendingMaintenanceAction$
];
var ShardList: StaticListSchema = [1, n0, _SL,
  0, () => Shard$
];
var StringList = 64 | 0;
var TagKeyList = 64 | 0;
...
export var GetClusterSnapshot$: StaticOperationSchema = [9, n0, _GCS,
  { [_h]: ["GET", "/cluster-snapshot/{snapshotArn}", 200] }, () => GetClusterSnapshotInput$, () => GetClusterSnapshotOutput$
];
export var GetPendingMaintenanceAction$: StaticOperationSchema = [9, n0, _GPMA,
...
export var ListClusterSnapshots$: StaticOperationSchema = [9, n0, _LCS,
  { [_h]: ["GET", "/cluster-snapshots", 200] }, () => ListClusterSnapshotsInput$, () => ListClusterSnapshotsOutput$
];
export var ListPendingMaintenanceActions$: StaticOperationSchema = [9, n0, _LPMA,
