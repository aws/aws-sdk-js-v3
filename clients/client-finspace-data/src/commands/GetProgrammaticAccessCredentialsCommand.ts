 ...
 * @public
 */
export class GetProgrammaticAccessCredentialsCommand extends command<GetProgrammaticAccessCredentialsCommandInput, GetProgrammaticAccessCredentialsCommandOutput>(
  _ep0,
  _mw0,
