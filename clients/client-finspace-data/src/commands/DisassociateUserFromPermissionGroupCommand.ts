 ...
 * @public
 */
export class DisassociateUserFromPermissionGroupCommand extends command<DisassociateUserFromPermissionGroupCommandInput, DisassociateUserFromPermissionGroupCommandOutput>(
  _ep0,
  _mw0,
