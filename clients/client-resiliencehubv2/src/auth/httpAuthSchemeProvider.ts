...
import { type Resiliencehubv2ClientResolvedConfig, Resiliencehubv2ClientConfig } from "../Resiliencehubv2Client";
 ...
 * @internal
 */
export const defaultResiliencehubv2HttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: Resiliencehubv2HttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<Resiliencehubv2ClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultResiliencehubv2HttpAuthSchemeProvider: Resiliencehubv2HttpAuthSchemeProvider = (authParameters) => {
