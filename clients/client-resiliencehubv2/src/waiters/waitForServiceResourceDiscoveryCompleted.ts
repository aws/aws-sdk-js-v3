 ...
 *  @deprecated Use waitUntilServiceResourceDiscoveryCompleted instead. waitForServiceResourceDiscoveryCompleted does not throw error in non-success cases.
 */
export const waitForServiceResourceDiscoveryCompleted = async (
 ...
 */
export const waitUntilServiceResourceDiscoveryCompleted = async (
  params: WaiterConfiguration<Resiliencehubv2Client>,
  input: GetServiceCommandInput
