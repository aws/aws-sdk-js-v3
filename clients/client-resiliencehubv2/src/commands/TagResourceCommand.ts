 ...
 * ```javascript
 * import { Resiliencehubv2Client, TagResourceCommand } from "@aws-sdk/client-resiliencehubv2"; // ES Modules import
 * // const { Resiliencehubv2Client, TagResourceCommand } = require("@aws-sdk/client-resiliencehubv2"); // CommonJS import
