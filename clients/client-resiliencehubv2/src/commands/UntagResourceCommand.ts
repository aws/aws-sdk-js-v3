 ...
 * ```javascript
 * import { Resiliencehubv2Client, UntagResourceCommand } from "@aws-sdk/client-resiliencehubv2"; // ES Modules import
 * // const { Resiliencehubv2Client, UntagResourceCommand } = require("@aws-sdk/client-resiliencehubv2"); // CommonJS import
