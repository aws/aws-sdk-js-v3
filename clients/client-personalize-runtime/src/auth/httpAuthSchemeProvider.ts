...
import {
  type PersonalizeRuntimeClientResolvedConfig,
  PersonalizeRuntimeClientConfig,
 ...
 * @internal
 */
export const defaultPersonalizeRuntimeHttpAuthSchemeProvider: PersonalizeRuntimeHttpAuthSchemeProvider = (authParameters) => {
