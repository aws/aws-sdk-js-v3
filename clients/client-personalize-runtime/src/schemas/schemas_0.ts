...
export var GetActionRecommendationsResponse$: StaticStructureSchema = [3, n0, _GARRe,
  0,
  [_aL, _rI],
  [() => ActionList, 0]
];
...
var PromotionList: StaticListSchema = [1, n0, _PL,
  0, [() => Promotion$,
    0]
];
var ReasonList = 64 | 0;
var Context: StaticMapSchema = [2, n0, _C,
  0, [0,
    0]
  , [() => AttributeValue,
    0]
];
var FilterValues: StaticMapSchema = [2, n0, _FV,
  0, [0,
    0]
  , [() => FilterAttributeValue,
    0]
];
var Metadata: StaticMapSchema = [2, n0, _M,
  8, 0, 0
];
var MetadataColumns: StaticMapSchema = [2, n0, _MC,
  0, 0, 64 | 0
];
export var GetActionRecommendations$: StaticOperationSchema = [9, n0, _GAR,
  { [_h]: ["POST", "/action-recommendations", 200] }, () => GetActionRecommendationsRequest$, () => GetActionRecommendationsResponse$
];
export var GetPersonalizedRanking$: StaticOperationSchema = [9, n0, _GPR,
