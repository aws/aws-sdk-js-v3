 ...
 * ```javascript
 * import { NetworkSecurityManagerClient, TagResourceCommand } from "@aws-sdk/client-network-security-manager"; // ES Modules import
 * // const { NetworkSecurityManagerClient, TagResourceCommand } = require("@aws-sdk/client-network-security-manager"); // CommonJS import
