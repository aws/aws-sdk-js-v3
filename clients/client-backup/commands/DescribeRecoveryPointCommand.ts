...
import { DescribeRecoveryPointInput, DescribeRecoveryPointOutput } from "../models/index";
import {
...
> {
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeRecoveryPointCommand(output, context);
  }
