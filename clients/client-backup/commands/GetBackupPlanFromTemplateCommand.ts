...
export class GetBackupPlanFromTemplateCommand extends $Command<GetBackupPlanFromTemplateCommandInput, GetBackupPlanFromTemplateCommandOutput, BackupClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetBackupPlanFromTemplateCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetBackupPlanFromTemplateCommand(output, context);
  }
