...
import {
  deserializeAws_restJson1_1PutBackupVaultNotificationsCommand,
  serializeAws_restJson1_1PutBackupVaultNotificationsCommand,
...
export class PutBackupVaultNotificationsCommand extends $Command<PutBackupVaultNotificationsCommandInput, PutBackupVaultNotificationsCommandOutput, BackupClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1PutBackupVaultNotificationsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1PutBackupVaultNotificationsCommand(output, context);
  }
