...
export type DescribeProtectedResourceCommandOutput = DescribeProtectedResourceOutput &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1DescribeProtectedResourceCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1DescribeProtectedResourceCommand(
      output,
      context
    );
  }
