...
import { type BackupClientResolvedConfig, BackupClientConfig } from "../BackupClient";
 ...
 * @internal
 */
export const defaultBackupHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: BackupHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultBackupHttpAuthSchemeProvider: BackupHttpAuthSchemeProvider = (authParameters) => {
