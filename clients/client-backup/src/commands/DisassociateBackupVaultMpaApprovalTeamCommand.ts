 ...
 * @public
 */
export class DisassociateBackupVaultMpaApprovalTeamCommand extends command<DisassociateBackupVaultMpaApprovalTeamCommandInput, DisassociateBackupVaultMpaApprovalTeamCommandOutput>(
  _ep0,
  _mw0,
