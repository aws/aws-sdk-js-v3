 ...
 * @public
 */
export class UpdateRestoreTestingSelectionCommand extends command<UpdateRestoreTestingSelectionCommandInput, UpdateRestoreTestingSelectionCommandOutput>(
  _ep0,
  _mw0,
