...
import type { GetBackupSelectionInput, GetBackupSelectionOutput } from "../models/models_0";
 ...
 * @public
 */
export class GetBackupSelectionCommand extends command<GetBackupSelectionCommandInput, GetBackupSelectionCommandOutput>(
  _ep0,
  _mw0,
  "GetBackupSelection",
  GetBackupSelection$
