 ...
 * @public
 */
export class DeleteBackupVaultLockConfigurationCommand extends command<DeleteBackupVaultLockConfigurationCommandInput, DeleteBackupVaultLockConfigurationCommandOutput>(
  _ep0,
  _mw0,
