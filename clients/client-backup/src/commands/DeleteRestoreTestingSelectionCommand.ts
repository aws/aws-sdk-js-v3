...
import type { DeleteRestoreTestingSelectionInput } from "../models/models_0";
 ...
 * @public
 */
export class DeleteRestoreTestingSelectionCommand extends command<DeleteRestoreTestingSelectionCommandInput, DeleteRestoreTestingSelectionCommandOutput>(
  _ep0,
  _mw0,
