...
> {
   ...
   * @public
   */
  constructor(readonly input: CreateRestoreTestingSelectionCommandInput) {
    super();
  }
  ...
  ): Handler<CreateRestoreTestingSelectionCommandInput, CreateRestoreTestingSelectionCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, CreateRestoreTestingSelectionCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: CreateRestoreTestingSelectionCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
