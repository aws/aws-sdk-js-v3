...
import type { DeleteReportPlanInput } from "../models/models_0";
 ...
 * @public
 */
export class DeleteReportPlanCommand extends command<DeleteReportPlanCommandInput, DeleteReportPlanCommandOutput>(
  _ep0,
  _mw0,
  "DeleteReportPlan",
  DeleteReportPlan$
