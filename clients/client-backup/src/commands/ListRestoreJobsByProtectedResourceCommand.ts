 ...
 * @public
 */
export class ListRestoreJobsByProtectedResourceCommand extends command<ListRestoreJobsByProtectedResourceCommandInput, ListRestoreJobsByProtectedResourceCommandOutput>(
  _ep0,
  _mw0,
