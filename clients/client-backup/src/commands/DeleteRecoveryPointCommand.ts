...
import type { DeleteRecoveryPointInput } from "../models/models_0";
 ...
 * @public
 */
export class DeleteRecoveryPointCommand extends command<DeleteRecoveryPointCommandInput, DeleteRecoveryPointCommandOutput>(
  _ep0,
  _mw0,
  "DeleteRecoveryPoint",
  DeleteRecoveryPoint$
