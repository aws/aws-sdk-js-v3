 ...
 * @public
 */
export class CreateRestoreAccessBackupVaultCommand extends command<CreateRestoreAccessBackupVaultCommandInput, CreateRestoreAccessBackupVaultCommandOutput>(
  _ep0,
  _mw0,
