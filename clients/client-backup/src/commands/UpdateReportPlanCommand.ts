...
import type { UpdateReportPlanInput, UpdateReportPlanOutput } from "../models/models_0";
 ...
 * @public
 */
export class UpdateReportPlanCommand extends command<UpdateReportPlanCommandInput, UpdateReportPlanCommandOutput>(
  _ep0,
  _mw0,
  "UpdateReportPlan",
  UpdateReportPlan$
