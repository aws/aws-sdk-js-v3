 ...
 * @public
 */
export class ListRecoveryPointsByLegalHoldCommand extends command<ListRecoveryPointsByLegalHoldCommandInput, ListRecoveryPointsByLegalHoldCommandOutput>(
  _ep0,
  _mw0,
