...
const AWS_TEMPLATE = "backup.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "backup.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "backup.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "backup.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "backup.{region}.amazonaws.com";
...
export const defaultRegionInfoProvider: RegionInfoProvider = (region: string, options?: any) => {
  ...
  switch (region) {
    ...
    case "ap-northeast-3":
      regionInfo = {
        hostname: "backup.ap-northeast-3.amazonaws.com",
        partition: "aws",
      };
      break;
    case "ap-south-1":
    ...
    case "cn-northwest-1":
      regionInfo = {
        hostname: "backup.cn-northwest-1.amazonaws.com.cn",
        partition: "aws-cn",
      };
      break;
    case "eu-central-1":
    ...
    case "eu-south-1":
      regionInfo = {
        hostname: "backup.eu-south-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "eu-west-1":
    ...
    case "us-gov-west-1":
      regionInfo = {
        hostname: "backup.us-gov-west-1.amazonaws.com",
        partition: "aws-us-gov",
      };
      break;
    case "us-west-1":
