...
export var DescribeHomeRegionControlsRequest$: StaticStructureSchema = [3, n0, _DHRCRes,
  0,
  [_CI, _HR, _T, _MR, _NT],
  [0, 0, () => Target$, 1, 0]
];
export var DescribeHomeRegionControlsResult$: StaticStructureSchema = [3, n0, _DHRCResc,
  0,
  [_HRCo, _NT],
...
export var GetHomeRegionResult$: StaticStructureSchema = [3, n0, _GHRRe,
  0,
  [_HR],
  [0]
];
export var HomeRegionControl$: StaticStructureSchema = [3, n0, _HRC,
  0,
  [_CI, _HR, _T, _RT],
  [0, 0, () => Target$, 4]
];
...
export var CreateHomeRegionControl$: StaticOperationSchema = [9, n0, _CHRC,
  0, () => CreateHomeRegionControlRequest$, () => CreateHomeRegionControlResult$
];
export var DeleteHomeRegionControl$: StaticOperationSchema = [9, n0, _DHRC,
  0, () => DeleteHomeRegionControlRequest$, () => DeleteHomeRegionControlResult$
];
export var DescribeHomeRegionControls$: StaticOperationSchema = [9, n0, _DHRCe,
  0, () => DescribeHomeRegionControlsRequest$, () => DescribeHomeRegionControlsResult$
];
export var GetHomeRegion$: StaticOperationSchema = [9, n0, _GHR,
