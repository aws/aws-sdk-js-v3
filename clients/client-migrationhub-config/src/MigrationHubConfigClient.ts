...
import {
  ...
  defaultMigrationHubConfigHttpAuthSchemeParametersProvider,
...
import type { GetHomeRegionCommandInput, GetHomeRegionCommandOutput } from "./commands/GetHomeRegionCommand";
import {
 ...
 * @public
 */
export type MigrationHubConfigClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type MigrationHubConfigClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<MigrationHubConfigClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultMigrationHubConfigHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: MigrationHubConfigClientResolvedConfig) =>
