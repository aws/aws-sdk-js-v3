...
import {
  type MigrationHubConfigClientResolvedConfig,
  MigrationHubConfigClientConfig,
 ...
 * @internal
 */
export const defaultMigrationHubConfigHttpAuthSchemeProvider: MigrationHubConfigHttpAuthSchemeProvider = (authParameters) => {
