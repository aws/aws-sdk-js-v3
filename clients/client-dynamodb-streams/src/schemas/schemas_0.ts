...
export var StreamRecord$: StaticStructureSchema = [3, n0, _SR,
  0,
...
var StreamList: StaticListSchema = [1, n0, _SLt,
  0, () => _Stream$
];
...
export var DescribeStream$: StaticOperationSchema = [9, n0, _DS,
