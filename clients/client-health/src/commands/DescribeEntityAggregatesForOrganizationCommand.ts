 ...
 * @public
 */
export class DescribeEntityAggregatesForOrganizationCommand extends command<DescribeEntityAggregatesForOrganizationCommandInput, DescribeEntityAggregatesForOrganizationCommandOutput>(
  _ep0,
  _mw0,
