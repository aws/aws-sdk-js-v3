...
const deserializeAws_json1_1AffectedEntity = (output: any, context: __SerdeContext): AffectedEntity => {
  return {
    ...
    tags: output.tags != undefined ? deserializeAws_json1_1tagSet(output.tags, context) : undefined,
  } as any;
};
...
const deserializeAws_json1_1DescribeAffectedEntitiesForOrganizationResponse = (
  ...
  return {
    entities: output.entities != undefined ? deserializeAws_json1_1EntityList(output.entities, context) : undefined,
    failedSet:
      output.failedSet != undefined
...
const deserializeAws_json1_1DescribeEventAggregatesResponse = (
  ...
  return {
    eventAggregates:
      output.eventAggregates != undefined
  ...
  return {
    failedSet:
      output.failedSet != undefined
        ...
        : undefined,
    successfulSet:
      output.successfulSet != undefined
...
const deserializeAws_json1_1DescribeEventsForOrganizationResponse = (
  ...
  return {
    events:
      output.events != undefined ? deserializeAws_json1_1OrganizationEventList(output.events, context) : undefined,
    nextToken: __expectString(output.nextToken),
  } as any;
};
  ...
  return {
    ...
    eventDescription:
      output.eventDescription != undefined
        ...
        : undefined,
    eventMetadata:
      output.eventMetadata != undefined
