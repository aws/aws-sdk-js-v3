...
import { type HealthClientResolvedConfig, HealthClientConfig } from "../HealthClient";
 ...
 * @internal
 */
export const defaultHealthHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: HealthHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<HealthClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultHealthHttpAuthSchemeProvider: HealthHttpAuthSchemeProvider = (authParameters) => {
