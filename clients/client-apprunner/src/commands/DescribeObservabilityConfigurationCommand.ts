 ...
 * @public
 */
export class DescribeObservabilityConfigurationCommand extends command<DescribeObservabilityConfigurationCommandInput, DescribeObservabilityConfigurationCommandOutput>(
  _ep0,
  _mw0,
