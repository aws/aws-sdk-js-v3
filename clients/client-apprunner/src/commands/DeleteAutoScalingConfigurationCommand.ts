 ...
 * @public
 */
export class DeleteAutoScalingConfigurationCommand extends command<DeleteAutoScalingConfigurationCommandInput, DeleteAutoScalingConfigurationCommandOutput>(
  _ep0,
  _mw0,
