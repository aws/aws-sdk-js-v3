 ...
 * @public
 */
export class CreateAutoScalingConfigurationCommand extends command<CreateAutoScalingConfigurationCommandInput, CreateAutoScalingConfigurationCommandOutput>(
  _ep0,
  _mw0,
