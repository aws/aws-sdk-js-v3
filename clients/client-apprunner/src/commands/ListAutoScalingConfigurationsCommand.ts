 ...
 * @public
 */
export class ListAutoScalingConfigurationsCommand extends command<ListAutoScalingConfigurationsCommandInput, ListAutoScalingConfigurationsCommandOutput>(
  _ep0,
  _mw0,
