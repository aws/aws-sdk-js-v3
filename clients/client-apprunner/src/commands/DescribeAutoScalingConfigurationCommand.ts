 ...
 * @public
 */
export class DescribeAutoScalingConfigurationCommand extends command<DescribeAutoScalingConfigurationCommandInput, DescribeAutoScalingConfigurationCommandOutput>(
  _ep0,
  _mw0,
