 ...
 * @public
 */
export class DeleteObservabilityConfigurationCommand extends command<DeleteObservabilityConfigurationCommandInput, DeleteObservabilityConfigurationCommandOutput>(
  _ep0,
  _mw0,
