...
export var AppRunnerServiceException$: StaticErrorSchema = [-3, _s, "AppRunnerServiceException", 0, [], []];
...
export var AutoScalingConfigurationSummary$: StaticStructureSchema = [3, n0, _ASCS,
  0,
  [_ASCA, _ASCN, _ASCR, _S, _CAr, _HAS, _ID],
  [0, 0, 1, 0, 4, 2, 2]
];
export var CertificateValidationRecord$: StaticStructureSchema = [3, n0, _CVR,
  0,
  [_N, _T, _V, _S],
  [0, 0, 0, 0]
];
...
export var ConnectionSummary$: StaticStructureSchema = [3, n0, _CSo,
  0,
  [_CN, _CA, _PT, _S, _CAr],
  [0, 0, 0, 0, 4]
];
...
export var IngressVpcConfiguration$: StaticStructureSchema = [3, n0, _IVC,
  0,
  [_VI, _VEI],
  [0, 0]
];
...
export var ListAutoScalingConfigurationsRequest$: StaticStructureSchema = [3, n0, _LASCR,
  0,
  [_ASCN, _LO, _MR, _NT],
  [0, 2, 1, 0]
];
...
export var ListVpcConnectorsRequest$: StaticStructureSchema = [3, n0, _LVCR,
  0,
  [_MR, _NT],
  [1, 0]
];
...
export var ListVpcIngressConnectionsRequest$: StaticStructureSchema = [3, n0, _LVICR,
  0,
  [_F, _MR, _NT],
...
export var ObservabilityConfiguration$: StaticStructureSchema = [3, n0, _OC,
  0,
  [_OCA, _OCN, _TC, _OCR, _L, _S, _CAr, _DA],
  [0, 0, () => TraceConfiguration$, 1, 2, 0, 4, 4]
];
export var ObservabilityConfigurationSummary$: StaticStructureSchema = [3, n0, _OCS,
  0,
  [_OCA, _OCN, _OCR],
  [0, 0, 1]
];
...
export var VpcDNSTarget$: StaticStructureSchema = [3, n0, _VDNSTp,
  0,
  [_VICA, _VI, _DN],
  [0, 0, 0]
];
export var VpcIngressConnection$: StaticStructureSchema = [3, n0, _VIC,
  0,
  [_VICA, _VICN, _SA, _S, _AI, _DN, _IVC, _CAr, _DA],
  [0, 0, 0, 0, 0, 0, () => IngressVpcConfiguration$, 4, 4]
];
export var VpcIngressConnectionSummary$: StaticStructureSchema = [3, n0, _VICS,
  0,
  [_VICA, _SA],
  [0, 0]
];
var AutoScalingConfigurationSummaryList: StaticListSchema = [1, n0, _ASCSL,
  0, () => AutoScalingConfigurationSummary$
];
var CertificateValidationRecordList: StaticListSchema = [1, n0, _CVRL,
  0, () => CertificateValidationRecord$
];
var ConnectionSummaryList: StaticListSchema = [1, n0, _CSL,
  0, () => ConnectionSummary$
];
var CustomDomainList: StaticListSchema = [1, n0, _CDL,
  0, () => CustomDomain$
];
var ObservabilityConfigurationSummaryList: StaticListSchema = [1, n0, _OCSL,
...
var VpcConnectors: StaticListSchema = [1, n0, _VCp,
  0, () => VpcConnector$
];
var VpcDNSTargetList: StaticListSchema = [1, n0, _VDNSTL,
  0, () => VpcDNSTarget$
];
var VpcIngressConnectionSummaryList: StaticListSchema = [1, n0, _VICSL,
  0, () => VpcIngressConnectionSummary$
];
var RuntimeEnvironmentSecrets: StaticMapSchema = [2, n0, _RES,
  0, [() => RuntimeEnvironmentSecretsName,
    0]
  , [() => RuntimeEnvironmentSecretsValue,
    0]
];
var RuntimeEnvironmentVariables: StaticMapSchema = [2, n0, _REV,
  0, [() => RuntimeEnvironmentVariablesKey,
    0]
  , [() => RuntimeEnvironmentVariablesValue,
    0]
];
export var AssociateCustomDomain$: StaticOperationSchema = [9, n0, _ACD,
  0, () => AssociateCustomDomainRequest$, () => AssociateCustomDomainResponse$
];
export var CreateAutoScalingConfiguration$: StaticOperationSchema = [9, n0, _CASC,
  0, () => CreateAutoScalingConfigurationRequest$, () => CreateAutoScalingConfigurationResponse$
];
export var CreateConnection$: StaticOperationSchema = [9, n0, _CCr,
  0, () => CreateConnectionRequest$, () => CreateConnectionResponse$
];
export var CreateObservabilityConfiguration$: StaticOperationSchema = [9, n0, _COC,
...
export var CreateVpcConnector$: StaticOperationSchema = [9, n0, _CVC,
  0, () => CreateVpcConnectorRequest$, () => CreateVpcConnectorResponse$
];
export var CreateVpcIngressConnection$: StaticOperationSchema = [9, n0, _CVIC,
  0, () => CreateVpcIngressConnectionRequest$, () => CreateVpcIngressConnectionResponse$
];
export var DeleteAutoScalingConfiguration$: StaticOperationSchema = [9, n0, _DASC,
...
export var DeleteObservabilityConfiguration$: StaticOperationSchema = [9, n0, _DOC,
...
export var DeleteVpcConnector$: StaticOperationSchema = [9, n0, _DVC,
  0, () => DeleteVpcConnectorRequest$, () => DeleteVpcConnectorResponse$
];
export var DeleteVpcIngressConnection$: StaticOperationSchema = [9, n0, _DVIC,
  0, () => DeleteVpcIngressConnectionRequest$, () => DeleteVpcIngressConnectionResponse$
];
export var DescribeAutoScalingConfiguration$: StaticOperationSchema = [9, n0, _DASCe,
  0, () => DescribeAutoScalingConfigurationRequest$, () => DescribeAutoScalingConfigurationResponse$
];
export var DescribeCustomDomains$: StaticOperationSchema = [9, n0, _DCD,
  0, () => DescribeCustomDomainsRequest$, () => DescribeCustomDomainsResponse$
];
export var DescribeObservabilityConfiguration$: StaticOperationSchema = [9, n0, _DOCe,
  0, () => DescribeObservabilityConfigurationRequest$, () => DescribeObservabilityConfigurationResponse$
];
export var DescribeService$: StaticOperationSchema = [9, n0, _DSe,
  0, () => DescribeServiceRequest$, () => DescribeServiceResponse$
];
export var DescribeVpcConnector$: StaticOperationSchema = [9, n0, _DVCe,
  0, () => DescribeVpcConnectorRequest$, () => DescribeVpcConnectorResponse$
];
export var DescribeVpcIngressConnection$: StaticOperationSchema = [9, n0, _DVICe,
  0, () => DescribeVpcIngressConnectionRequest$, () => DescribeVpcIngressConnectionResponse$
];
export var DisassociateCustomDomain$: StaticOperationSchema = [9, n0, _DCDi,
  0, () => DisassociateCustomDomainRequest$, () => DisassociateCustomDomainResponse$
];
export var ListAutoScalingConfigurations$: StaticOperationSchema = [9, n0, _LASC,
...
export var ListObservabilityConfigurations$: StaticOperationSchema = [9, n0, _LOC,
  0, () => ListObservabilityConfigurationsRequest$, () => ListObservabilityConfigurationsResponse$
];
export var ListOperations$: StaticOperationSchema = [9, n0, _LOi,
...
export var ListServicesForAutoScalingConfiguration$: StaticOperationSchema = [9, n0, _LSFASC,
  0, () => ListServicesForAutoScalingConfigurationRequest$, () => ListServicesForAutoScalingConfigurationResponse$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceRequest$, () => ListTagsForResourceResponse$
];
export var ListVpcConnectors$: StaticOperationSchema = [9, n0, _LVC,
  0, () => ListVpcConnectorsRequest$, () => ListVpcConnectorsResponse$
];
export var ListVpcIngressConnections$: StaticOperationSchema = [9, n0, _LVIC,
  0, () => ListVpcIngressConnectionsRequest$, () => ListVpcIngressConnectionsResponse$
];
export var PauseService$: StaticOperationSchema = [9, n0, _PS,
  0, () => PauseServiceRequest$, () => PauseServiceResponse$
];
export var ResumeService$: StaticOperationSchema = [9, n0, _RS,
  0, () => ResumeServiceRequest$, () => ResumeServiceResponse$
];
export var StartDeployment$: StaticOperationSchema = [9, n0, _SDt,
...
export var UpdateDefaultAutoScalingConfiguration$: StaticOperationSchema = [9, n0, _UDASC,
...
export var UpdateVpcIngressConnection$: StaticOperationSchema = [9, n0, _UVIC,
