...
import { type AppStreamClientResolvedConfig, AppStreamClientConfig } from "../AppStreamClient";
 ...
 * @internal
 */
export const defaultAppStreamHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: AppStreamHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultAppStreamHttpAuthSchemeProvider: AppStreamHttpAuthSchemeProvider = (authParameters) => {
