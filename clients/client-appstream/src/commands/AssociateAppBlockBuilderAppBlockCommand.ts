 ...
 * @public
 */
export class AssociateAppBlockBuilderAppBlockCommand extends command<AssociateAppBlockBuilderAppBlockCommandInput, AssociateAppBlockBuilderAppBlockCommandOutput>(
  _ep0,
  _mw0,
