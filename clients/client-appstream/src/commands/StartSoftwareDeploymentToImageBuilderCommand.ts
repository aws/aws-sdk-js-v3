 ...
 * @public
 */
export class StartSoftwareDeploymentToImageBuilderCommand extends command<StartSoftwareDeploymentToImageBuilderCommandInput, StartSoftwareDeploymentToImageBuilderCommandOutput>(
  _ep0,
  _mw0,
