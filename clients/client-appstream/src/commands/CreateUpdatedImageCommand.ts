...
import type { CreateUpdatedImageRequest, CreateUpdatedImageResult } from "../models/models_0";
 ...
 * @public
 */
export class CreateUpdatedImageCommand extends command<CreateUpdatedImageCommandInput, CreateUpdatedImageCommandOutput>(
  _ep0,
  _mw0,
  "CreateUpdatedImage",
  CreateUpdatedImage$
