 ...
 * @public
 */
export class CreateImageBuilderStreamingURLCommand extends command<CreateImageBuilderStreamingURLCommandInput, CreateImageBuilderStreamingURLCommandOutput>(
  _ep0,
  _mw0,
