...
import type { CreateFleetRequest, CreateFleetResult } from "../models/models_0";
 ...
 * @public
 */
export class CreateFleetCommand extends command<CreateFleetCommandInput, CreateFleetCommandOutput>(
  _ep0,
  _mw0,
  "CreateFleet",
  CreateFleet$
