 ...
 * @public
 */
export class DescribeApplicationFleetAssociationsCommand extends command<DescribeApplicationFleetAssociationsCommandInput, DescribeApplicationFleetAssociationsCommandOutput>(
  _ep0,
  _mw0,
