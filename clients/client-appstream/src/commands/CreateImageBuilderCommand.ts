...
import type { CreateImageBuilderRequest, CreateImageBuilderResult } from "../models/models_0";
 ...
 * @public
 */
export class CreateImageBuilderCommand extends command<CreateImageBuilderCommandInput, CreateImageBuilderCommandOutput>(
  _ep0,
  _mw0,
  "CreateImageBuilder",
  CreateImageBuilder$
