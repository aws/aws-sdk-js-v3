...
export type DescribeUserStackAssociationsCommandOutput = DescribeUserStackAssociationsResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1DescribeUserStackAssociationsCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1DescribeUserStackAssociationsCommand(
      output,
      context
    );
  }
