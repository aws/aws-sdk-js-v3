 ...
 * @public
 */
export class GetThirdPartyFirewallAssociationStatusCommand extends command<GetThirdPartyFirewallAssociationStatusCommandInput, GetThirdPartyFirewallAssociationStatusCommandOutput>(
  _ep0,
  _mw0,
