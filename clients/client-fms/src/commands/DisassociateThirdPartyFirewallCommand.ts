 ...
 * @public
 */
export class DisassociateThirdPartyFirewallCommand extends command<DisassociateThirdPartyFirewallCommandInput, DisassociateThirdPartyFirewallCommandOutput>(
  _ep0,
  _mw0,
