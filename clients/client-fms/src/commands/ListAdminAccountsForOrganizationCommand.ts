 ...
 * @public
 */
export class ListAdminAccountsForOrganizationCommand extends command<ListAdminAccountsForOrganizationCommandInput, ListAdminAccountsForOrganizationCommandOutput>(
  _ep0,
  _mw0,
