...
export declare type ServiceInputTypes = AssociateAdminAccountCommandInput | DeleteNotificationChannelCommandInput | DeletePolicyCommandInput | DisassociateAdminAccountCommandInput | GetAdminAccountCommandInput | GetComplianceDetailCommandInput | GetNotificationChannelCommandInput | GetPolicyCommandInput | GetProtectionStatusCommandInput | ListComplianceStatusCommandInput | ListMemberAccountsCommandInput | ListPoliciesCommandInput | ListTagsForResourceCommandInput | PutNotificationChannelCommandInput | PutPolicyCommandInput | TagResourceCommandInput | UntagResourceCommandInput;
export declare type ServiceOutputTypes = AssociateAdminAccountCommandOutput | DeleteNotificationChannelCommandOutput | DeletePolicyCommandOutput | DisassociateAdminAccountCommandOutput | GetAdminAccountCommandOutput | GetComplianceDetailCommandOutput | GetNotificationChannelCommandOutput | GetPolicyCommandOutput | GetProtectionStatusCommandOutput | ListComplianceStatusCommandOutput | ListMemberAccountsCommandOutput | ListPoliciesCommandOutput | ListTagsForResourceCommandOutput | PutNotificationChannelCommandOutput | PutPolicyCommandOutput | TagResourceCommandOutput | UntagResourceCommandOutput;
...
export declare type FMSClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type FMSClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
