...
import { CreateTrustedEntitySet$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CreateTrustedEntitySetCommand extends command<CreateTrustedEntitySetCommandInput, CreateTrustedEntitySetCommandOutput>(
  _ep0,
  _mw0,
