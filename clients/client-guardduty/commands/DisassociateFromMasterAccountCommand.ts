...
export class DisassociateFromMasterAccountCommand extends $Command<DisassociateFromMasterAccountCommandInput, DisassociateFromMasterAccountCommandOutput, GuardDutyClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DisassociateFromMasterAccountCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DisassociateFromMasterAccountCommand(output, context);
  }
