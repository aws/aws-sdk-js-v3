...
import { UpdateThreatIntelSetRequest, UpdateThreatIntelSetResponse } from "../models/index";
import {
  deserializeAws_restJson1_1UpdateThreatIntelSetCommand,
  serializeAws_restJson1_1UpdateThreatIntelSetCommand
...
> {
  ...
  private serialize(input: UpdateThreatIntelSetCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1UpdateThreatIntelSetCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<UpdateThreatIntelSetCommandOutput> {
    return deserializeAws_restJson1_1UpdateThreatIntelSetCommand(output, context);
  }
