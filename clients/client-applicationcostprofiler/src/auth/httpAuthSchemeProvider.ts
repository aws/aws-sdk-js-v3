...
import {
  type ApplicationCostProfilerClientResolvedConfig,
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ApplicationCostProfilerHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultApplicationCostProfilerHttpAuthSchemeProvider: ApplicationCostProfilerHttpAuthSchemeProvider = (authParameters) => {
