...
const deserializeAws_json1_1BillingRecord = (
  ...
  return {
    ...
    InvoiceId:
      output.InvoiceId !== undefined && output.InvoiceId !== null ? output.InvoiceId : undefined,
    Operation:
  ...
  return {
    ...
    RegistryDomainId:
      output.RegistryDomainId !== undefined && output.RegistryDomainId !== null
        ...
        : undefined,
    Reseller:
      output.Reseller !== undefined && output.Reseller !== null ? output.Reseller : undefined,
    StatusList:
...
const deserializeAws_json1_1RetrieveDomainAuthCodeResponse = (
  ...
  return {
    __type: "RetrieveDomainAuthCodeResponse",
    AuthCode:
      output.AuthCode !== undefined && output.AuthCode !== null ? output.AuthCode : undefined
  } as any;
};
