...
const serializeAws_json1_1RegisterDomainRequest = (input: RegisterDomainRequest, context: __SerdeContext): any => {
  return {
    ...
    ...(input.PrivacyProtectTechContact != undefined && { PrivacyProtectTechContact: input.PrivacyProtectTechContact }),
...
const deserializeAws_json1_1CheckDomainTransferabilityResponse = (
  ...
  return {
    Transferability:
      output.Transferability != undefined
...
const deserializeAws_json1_1ContactDetail = (output: any, context: __SerdeContext): ContactDetail => {
  return {
    ...
    ExtraParams:
      output.ExtraParams != undefined ? deserializeAws_json1_1ExtraParamList(output.ExtraParams, context) : undefined,
...
const deserializeAws_json1_1DomainSummary = (output: any, context: __SerdeContext): DomainSummary => {
  return {
    ...
    DomainName: __expectString(output.DomainName),
    Expiry:
      output.Expiry != undefined ? __expectNonNull(__parseEpochTimestamp(__expectNumber(output.Expiry))) : undefined,
...
const deserializeAws_json1_1GetDomainDetailResponse = (
  ...
  return {
    ...
    AdminContact:
      output.AdminContact != undefined ? deserializeAws_json1_1ContactDetail(output.AdminContact, context) : undefined,
    ...
    ExpirationDate:
      output.ExpirationDate != undefined
        ...
        : undefined,
    Nameservers:
      output.Nameservers != undefined ? deserializeAws_json1_1NameserverList(output.Nameservers, context) : undefined,
    RegistrantContact:
    ...
    StatusList:
      output.StatusList != undefined ? deserializeAws_json1_1DomainStatusList(output.StatusList, context) : undefined,
    TechContact:
      output.TechContact != undefined ? deserializeAws_json1_1ContactDetail(output.TechContact, context) : undefined,
...
const deserializeAws_json1_1GetDomainSuggestionsResponse = (
  ...
  return {
    SuggestionsList:
      output.SuggestionsList != undefined
...
const deserializeAws_json1_1GetOperationDetailResponse = (
  ...
  return {
    ...
    Status: __expectString(output.Status),
    SubmittedDate:
      output.SubmittedDate != undefined
...
const deserializeAws_json1_1ListDomainsResponse = (output: any, context: __SerdeContext): ListDomainsResponse => {
  return {
    Domains: output.Domains != undefined ? deserializeAws_json1_1DomainSummaryList(output.Domains, context) : undefined,
...
const deserializeAws_json1_1ListPricesResponse = (output: any, context: __SerdeContext): ListPricesResponse => {
  return {
    NextPageMarker: __expectString(output.NextPageMarker),
    Prices: output.Prices != undefined ? deserializeAws_json1_1DomainPriceList(output.Prices, context) : undefined,
  } as any;
};
...
const deserializeAws_json1_1Nameserver = (output: any, context: __SerdeContext): Nameserver => {
  return {
    GlueIps: output.GlueIps != undefined ? deserializeAws_json1_1GlueIpList(output.GlueIps, context) : undefined,
    Name: __expectString(output.Name),
  } as any;
};
...
const deserializeAws_json1_1ViewBillingResponse = (output: any, context: __SerdeContext): ViewBillingResponse => {
  return {
    BillingRecords:
      output.BillingRecords != undefined
