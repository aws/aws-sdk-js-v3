...
export var BillingRecord$: StaticStructureSchema = [3, n0, _BR,
  0,
  [_DN, _O, _II, _BD, _Pr],
  [0, 0, 0, 4, 1]
];
...
export var ContactDetail$: StaticStructureSchema = [3, n0, _CD,
  ...
  [[() => ContactName, 0], [() => ContactName, 0], 0, [() => ContactName, 0], [() => AddressLine, 0], [() => AddressLine, 0], [() => City, 0], [() => State, 0], [() => CountryCode, 0], [() => ZipCode, 0], [() => ContactNumber, 0], [() => Email, 0], [() => ContactNumber, 0], [() => ExtraParamList, 0]]
];
...
export var DnssecKey$: StaticStructureSchema = [3, n0, _DK,
  0,
  [_Al, _Fl, _PK, _DT, _D, _KT, _I],
  [1, 1, 0, 1, 0, 1, 0]
];
export var DnssecLimitExceeded$: StaticErrorSchema = [-3, n0, _DLE,
  { [_e]: _c, [_hE]: 400 },
  [_m],
  [0]
];
TypeRegistry.for(n0).registerError(DnssecLimitExceeded$, DnssecLimitExceeded);
export var DnssecSigningAttributes$: StaticStructureSchema = [3, n0, _DSA,
  0,
  [_Al, _Fl, _PK],
  [1, 1, 0]
];
export var DomainLimitExceeded$: StaticErrorSchema = [-3, n0, _DLEo,
  { [_e]: _c, [_hE]: 400 },
  [_m],
  [0]
];
TypeRegistry.for(n0).registerError(DomainLimitExceeded$, DomainLimitExceeded);
export var DomainPrice$: StaticStructureSchema = [3, n0, _DP,
  0,
  [_N, _RP, _TP, _RPe, _COP, _RPes],
  [0, () => PriceWithCurrency$, () => PriceWithCurrency$, () => PriceWithCurrency$, () => PriceWithCurrency$, () => PriceWithCurrency$]
];
export var DomainSuggestion$: StaticStructureSchema = [3, n0, _DS,
  0,
  [_DN, _A],
  [0, 0]
];
...
export var DomainTransferability$: StaticStructureSchema = [3, n0, _DTo,
  0,
  [_Tr],
  [0]
];
...
export var GetContactReachabilityStatusResponse$: StaticStructureSchema = [3, n0, _GCRSRe,
  0,
  [_dN, _s],
  [0, 0]
];
...
export var ListPricesRequest$: StaticStructureSchema = [3, n0, _LPR,
  0,
  [_Tl, _Ma, _MI],
  [0, 0, 1]
];
export var ListPricesResponse$: StaticStructureSchema = [3, n0, _LPRi,
  0,
  [_Pri, _NPM],
  [() => DomainPriceList, 0]
];
...
export var ResendContactReachabilityEmailRequest$: StaticStructureSchema = [3, n0, _RCRER,
  0,
  [_dN],
  [0]
];
export var ResendContactReachabilityEmailResponse$: StaticStructureSchema = [3, n0, _RCRERe,
  0,
  [_dN, _eA, _iAV],
  [0, [() => Email, 0], 2]
];
...
export var UnsupportedTLD$: StaticErrorSchema = [-3, n0, _UTLD,
  { [_e]: _c, [_hE]: 400 },
  [_m],
  [0]
];
...
export var ViewBillingRequest$: StaticStructureSchema = [3, n0, _VBR,
  0,
  [_Sta, _En, _Ma, _MI],
  [4, 4, 0, 1]
];
export var ViewBillingResponse$: StaticStructureSchema = [3, n0, _VBRi,
  0,
  [_NPM, _BRi],
  [0, () => BillingRecords]
];
...
var BillingRecords: StaticListSchema = [1, n0, _BRi,
  0, () => BillingRecord$
];
var DnssecKeyList: StaticListSchema = [1, n0, _DKL,
  0, () => DnssecKey$
];
var DomainPriceList: StaticListSchema = [1, n0, _DPL,
  0, () => DomainPrice$
];
var DomainStatusList = 64 | 0;
var DomainSuggestionsList: StaticListSchema = [1, n0, _DSL,
  0, () => DomainSuggestion$
];
var DomainSummaryList: StaticListSchema = [1, n0, _DSLo,
  0, () => DomainSummary$
];
var ExtraParamList: StaticListSchema = [1, n0, _EPL,
  0, [() => ExtraParam$,
    0]
];
var FilterConditions: StaticListSchema = [1, n0, _FCi,
  0, () => FilterCondition$
];
var GlueIpList = 64 | 0;
var NameserverList: StaticListSchema = [1, n0, _NL,
  0, () => Nameserver$
];
var OperationStatusList = 64 | 0;
var OperationSummaryList: StaticListSchema = [1, n0, _OSL,
  0, () => OperationSummary$
];
...
var Values = 64 | 0;
export var AcceptDomainTransferFromAnotherAwsAccount$: StaticOperationSchema = [9, n0, _ADTFAAA,
  0, () => AcceptDomainTransferFromAnotherAwsAccountRequest$, () => AcceptDomainTransferFromAnotherAwsAccountResponse$
];
export var AssociateDelegationSignerToDomain$: StaticOperationSchema = [9, n0, _ADSTD,
  0, () => AssociateDelegationSignerToDomainRequest$, () => AssociateDelegationSignerToDomainResponse$
];
export var CancelDomainTransferToAnotherAwsAccount$: StaticOperationSchema = [9, n0, _CDTTAAA,
  0, () => CancelDomainTransferToAnotherAwsAccountRequest$, () => CancelDomainTransferToAnotherAwsAccountResponse$
];
export var CheckDomainAvailability$: StaticOperationSchema = [9, n0, _CDA,
  0, () => CheckDomainAvailabilityRequest$, () => CheckDomainAvailabilityResponse$
];
export var CheckDomainTransferability$: StaticOperationSchema = [9, n0, _CDT,
...
export var DeleteTagsForDomain$: StaticOperationSchema = [9, n0, _DTFD,
  0, () => DeleteTagsForDomainRequest$, () => DeleteTagsForDomainResponse$
];
export var DisableDomainAutoRenew$: StaticOperationSchema = [9, n0, _DDAR,
  0, () => DisableDomainAutoRenewRequest$, () => DisableDomainAutoRenewResponse$
];
export var DisableDomainTransferLock$: StaticOperationSchema = [9, n0, _DDTL,
  0, () => DisableDomainTransferLockRequest$, () => DisableDomainTransferLockResponse$
];
export var DisassociateDelegationSignerFromDomain$: StaticOperationSchema = [9, n0, _DDSFD,
  0, () => DisassociateDelegationSignerFromDomainRequest$, () => DisassociateDelegationSignerFromDomainResponse$
];
export var EnableDomainAutoRenew$: StaticOperationSchema = [9, n0, _EDAR,
  0, () => EnableDomainAutoRenewRequest$, () => EnableDomainAutoRenewResponse$
];
export var EnableDomainTransferLock$: StaticOperationSchema = [9, n0, _EDTL,
  0, () => EnableDomainTransferLockRequest$, () => EnableDomainTransferLockResponse$
];
export var GetContactReachabilityStatus$: StaticOperationSchema = [9, n0, _GCRS,
  0, () => GetContactReachabilityStatusRequest$, () => GetContactReachabilityStatusResponse$
];
export var GetDomainDetail$: StaticOperationSchema = [9, n0, _GDD,
  0, () => GetDomainDetailRequest$, () => GetDomainDetailResponse$
];
export var GetDomainSuggestions$: StaticOperationSchema = [9, n0, _GDS,
  0, () => GetDomainSuggestionsRequest$, () => GetDomainSuggestionsResponse$
];
export var GetOperationDetail$: StaticOperationSchema = [9, n0, _GOD,
...
export var ListOperations$: StaticOperationSchema = [9, n0, _LO,
  0, () => ListOperationsRequest$, () => ListOperationsResponse$
];
export var ListPrices$: StaticOperationSchema = [9, n0, _LP,
  0, () => ListPricesRequest$, () => ListPricesResponse$
];
export var ListTagsForDomain$: StaticOperationSchema = [9, n0, _LTFD,
  0, () => ListTagsForDomainRequest$, () => ListTagsForDomainResponse$
];
export var PushDomain$: StaticOperationSchema = [9, n0, _PD,
  0, () => PushDomainRequest$, () => __Unit
];
export var RegisterDomain$: StaticOperationSchema = [9, n0, _RD,
  0, () => RegisterDomainRequest$, () => RegisterDomainResponse$
];
export var RejectDomainTransferFromAnotherAwsAccount$: StaticOperationSchema = [9, n0, _RDTFAAA,
  0, () => RejectDomainTransferFromAnotherAwsAccountRequest$, () => RejectDomainTransferFromAnotherAwsAccountResponse$
];
export var RenewDomain$: StaticOperationSchema = [9, n0, _RDe,
  0, () => RenewDomainRequest$, () => RenewDomainResponse$
];
export var ResendContactReachabilityEmail$: StaticOperationSchema = [9, n0, _RCRE,
  0, () => ResendContactReachabilityEmailRequest$, () => ResendContactReachabilityEmailResponse$
];
export var ResendOperationAuthorization$: StaticOperationSchema = [9, n0, _ROA,
  0, () => ResendOperationAuthorizationRequest$, () => __Unit
];
export var RetrieveDomainAuthCode$: StaticOperationSchema = [9, n0, _RDAC,
  0, () => RetrieveDomainAuthCodeRequest$, () => RetrieveDomainAuthCodeResponse$
];
export var TransferDomain$: StaticOperationSchema = [9, n0, _TD,
  0, () => TransferDomainRequest$, () => TransferDomainResponse$
];
export var TransferDomainToAnotherAwsAccount$: StaticOperationSchema = [9, n0, _TDTAAA,
  0, () => TransferDomainToAnotherAwsAccountRequest$, () => TransferDomainToAnotherAwsAccountResponse$
];
export var UpdateDomainContact$: StaticOperationSchema = [9, n0, _UDC,
  0, () => UpdateDomainContactRequest$, () => UpdateDomainContactResponse$
];
export var UpdateDomainContactPrivacy$: StaticOperationSchema = [9, n0, _UDCP,
  0, () => UpdateDomainContactPrivacyRequest$, () => UpdateDomainContactPrivacyResponse$
];
export var UpdateDomainNameservers$: StaticOperationSchema = [9, n0, _UDN,
  0, () => UpdateDomainNameserversRequest$, () => UpdateDomainNameserversResponse$
];
export var UpdateTagsForDomain$: StaticOperationSchema = [9, n0, _UTFD,
  0, () => UpdateTagsForDomainRequest$, () => UpdateTagsForDomainResponse$
];
export var ViewBilling$: StaticOperationSchema = [9, n0, _VB,
