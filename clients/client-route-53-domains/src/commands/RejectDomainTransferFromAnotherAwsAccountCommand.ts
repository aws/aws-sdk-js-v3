 ...
 * ```
 *
 * @param RejectDomainTransferFromAnotherAwsAccountRequest - {@link RejectDomainTransferFromAnotherAwsAccountRequest}
 * @returns {@link RejectDomainTransferFromAnotherAwsAccountResponse}
