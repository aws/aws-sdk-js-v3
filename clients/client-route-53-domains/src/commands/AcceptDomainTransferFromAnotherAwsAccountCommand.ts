 ...
 * ```
 *
 * @param AcceptDomainTransferFromAnotherAwsAccountRequest - {@link AcceptDomainTransferFromAnotherAwsAccountRequest}
 * @returns {@link AcceptDomainTransferFromAnotherAwsAccountResponse}
