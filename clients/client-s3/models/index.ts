...
export interface AbortMultipartUploadRequest {
  ...
  /**
   *
   *          <p>Confirms that the requester knows that she or he will be charged for the request. Bucket
   *          owners need not specify this parameter in their requests. For information about downloading
   *          objects from Requester Pays buckets, see <a href="https://docs.aws.amazon.com/http:/docs.aws.amazon.com/AmazonS3/latest/dev/ObjectsinRequesterPaysBuckets.html">Downloading Objects in Requestor Pays Buckets</a> in the
...
export interface CompleteMultipartUploadOutput extends $MetadataBearer {
  ...
  /**
   *
   *          <p>If present, specifies the ID of the AWS Key Management Service (AWS KMS) customer master key
...
export interface Encryption {
  ...
  /**
   *
   *          <p>If the encryption type is <code>aws:kms</code>, this optional value specifies the AWS KMS key
   *          ID to use for encryption of job results.</p>
   *
   */
  KMSKeyId?: string;
}
...
export interface EncryptionConfiguration {
  ...
  /**
   *
   *          <p>Specifies the AWS KMS Key ID (Key ARN or Alias ARN) for the destination bucket. Amazon
   *       S3 uses this key to encrypt replica objects.</p>
   *
   */
...
export interface PutObjectOutput extends $MetadataBearer {
   ...
   *          (AWS KMS) customer master key (CMK) that was used for the object.</p>
   *
   */
  SSEKMSKeyId?: string;
...
export interface PutObjectRequest {
   ...
   *          header specifies the ID of the AWS KMS CMK that will be used for the object. If you specify
...
export interface SSEKMS {
  ...
  /**
   *
   *          <p>Specifies the ID of the AWS Key Management Service (AWS KMS) customer master key (CMK) to use
