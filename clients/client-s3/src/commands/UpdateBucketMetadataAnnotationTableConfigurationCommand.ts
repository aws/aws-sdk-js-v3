 ...
 * @public
 */
export class UpdateBucketMetadataAnnotationTableConfigurationCommand extends command<UpdateBucketMetadataAnnotationTableConfigurationCommandInput, UpdateBucketMetadataAnnotationTableConfigurationCommandOutput>(
  _ep3,
  _mw3,
