 ...
 * @public
 */
export class GetBucketMetadataTableConfigurationCommand extends command<GetBucketMetadataTableConfigurationCommandInput, GetBucketMetadataTableConfigurationCommandOutput>(
  _ep3,
  _mw0,
