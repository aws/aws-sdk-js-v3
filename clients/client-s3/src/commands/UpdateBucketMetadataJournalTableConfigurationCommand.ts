 ...
 * @public
 */
export class UpdateBucketMetadataJournalTableConfigurationCommand extends command<UpdateBucketMetadataJournalTableConfigurationCommandInput, UpdateBucketMetadataJournalTableConfigurationCommandOutput>(
  _ep3,
  _mw3,
