 ...
 * //           SSEAlgorithm: "AES256" || "aws:fsx" || "aws:backup" || "aws:kms" || "aws:kms:dsse", // required
 ...
 * @public
 */
export class GetBucketEncryptionCommand extends command<GetBucketEncryptionCommandInput, GetBucketEncryptionCommandOutput>(
  _ep3,
  _mw0,
  "GetBucketEncryption",
  GetBucketEncryption$
