...
import { _ep7, _mw0, command } from "../commandBuilder";
 ...
 * @public
 */
export class ListDirectoryBucketsCommand extends command<ListDirectoryBucketsCommandInput, ListDirectoryBucketsCommandOutput>(
  _ep7,
  _mw0,
