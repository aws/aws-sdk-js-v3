 ...
 * @public
 */
export class DeleteBucketIntelligentTieringConfigurationCommand extends command<DeleteBucketIntelligentTieringConfigurationCommandInput, DeleteBucketIntelligentTieringConfigurationCommandOutput>(
  _ep3,
  _mw4,
