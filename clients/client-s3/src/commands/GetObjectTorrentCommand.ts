...
import { _ep5, _mw4, command } from "../commandBuilder";
 ...
 * @public
 */
export class GetObjectTorrentCommand extends command<GetObjectTorrentCommandInput, GetObjectTorrentCommandOutput>(
  _ep5,
  _mw4,
  "GetObjectTorrent",
  GetObjectTorrent$
