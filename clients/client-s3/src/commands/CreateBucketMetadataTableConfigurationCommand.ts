 ...
 * @public
 */
export class CreateBucketMetadataTableConfigurationCommand extends command<CreateBucketMetadataTableConfigurationCommandInput, CreateBucketMetadataTableConfigurationCommandOutput>(
  _ep3,
  _mw3,
