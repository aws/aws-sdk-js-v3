...
describe("S3Client" + ` (${mode})`, () => {
  const runner = new SnapshotRunner({
    ...
    schemas: new Map<any, any>([
      ...
      [DeleteObjectAnnotation$, DeleteObjectAnnotationCommand],
      ...
      [GetObjectAnnotation$, GetObjectAnnotationCommand],
      ...
      [ListObjectAnnotations$, ListObjectAnnotationsCommand],
      ...
      [PutObjectAnnotation$, PutObjectAnnotationCommand],
      ...
      [UpdateBucketMetadataAnnotationTableConfiguration$, UpdateBucketMetadataAnnotationTableConfigurationCommand],
