...
import { type SyntheticsClientResolvedConfig, SyntheticsClientConfig } from "../SyntheticsClient";
 ...
 * @internal
 */
export const defaultSyntheticsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SyntheticsHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultSyntheticsHttpAuthSchemeProvider: SyntheticsHttpAuthSchemeProvider = (authParameters) => {
