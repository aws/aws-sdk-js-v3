...
export var ArtifactConfigOutput$: StaticStructureSchema = [3, n0, _ACO,
  0,
  [_SE],
  [() => S3EncryptionConfig$]
];
...
export var CanaryCodeOutput$: StaticStructureSchema = [3, n0, _CCO,
  0,
  [_SLA, _H, _BTl, _D],
  [0, 0, 64 | 0, () => Dependencies]
];
export var CanaryDryRunConfigOutput$: StaticStructureSchema = [3, n0, _CDRCO,
  0,
  [_DRI],
  [0]
];
export var CanaryLastRun$: StaticStructureSchema = [3, n0, _CLR,
  0,
  [_CN, _LR],
  [0, () => CanaryRun$]
];
...
export var CanaryRunConfigOutput$: StaticStructureSchema = [3, n0, _CRCO,
  0,
  [_TIS, _MIMB, _AT, _ES],
  [1, 1, 2, 1]
];
export var CanaryRunStatus$: StaticStructureSchema = [3, n0, _CRS,
  0,
  [_Sta, _SR, _SRC, _TR],
  [0, 0, 0, 0]
];
export var CanaryRunTimeline$: StaticStructureSchema = [3, n0, _CRT,
  0,
  [_Star, _Com, _MTFRAR],
  [4, 4, 4]
];
...
export var CanaryStatus$: StaticStructureSchema = [3, n0, _CS,
  0,
  [_Sta, _SR, _SRC],
  [0, 0, 0]
];
export var CanaryTimeline$: StaticStructureSchema = [3, n0, _CT,
  0,
  [_Cr, _LM, _LS, _LSa],
  [4, 4, 4, 4]
];
...
export var DescribeCanariesLastRunResponse$: StaticStructureSchema = [3, n0, _DCLRRe,
  0,
  [_CLRa, _NT],
  [() => CanariesLastRun, 0]
];
export var DescribeCanariesRequest$: StaticStructureSchema = [3, n0, _DCRes,
  0,
  [_NT, _MR, _Na],
  [0, 1, 64 | 0]
];
export var DescribeCanariesResponse$: StaticStructureSchema = [3, n0, _DCResc,
  0,
  [_Ca, _NT],
  [() => Canaries, 0]
];
export var DescribeRuntimeVersionsRequest$: StaticStructureSchema = [3, n0, _DRVR,
  0,
  [_NT, _MR],
  [0, 1]
];
export var DescribeRuntimeVersionsResponse$: StaticStructureSchema = [3, n0, _DRVRe,
  0,
  [_RVu, _NT],
...
export var DryRunConfigOutput$: StaticStructureSchema = [3, n0, _DRCO,
  0,
  [_DRI, _LDRES],
  [0, 0]
];
export var EngineConfig$: StaticStructureSchema = [3, n0, _ECn,
  0,
  [_EA, _BT],
  [0, 0]
];
...
export var RuntimeVersion$: StaticStructureSchema = [3, n0, _RV,
  0,
  [_VN, _Des, _RD, _DD],
  [0, 0, 4, 4]
];
export var S3EncryptionConfig$: StaticStructureSchema = [3, n0, _SEC,
  0,
  [_EM, _KKA],
  [0, 0]
];
...
export var VpcConfigInput$: StaticStructureSchema = [3, n0, _VCI,
  0,
  [_SI, _SGI, _IAFDS],
  [64 | 0, 64 | 0, 2]
];
export var VpcConfigOutput$: StaticStructureSchema = [3, n0, _VCO,
  0,
  [_VI, _SI, _SGI, _IAFDS],
  [0, 64 | 0, 64 | 0, 2]
];
...
var BrowserConfigs: StaticListSchema = [1, n0, _BCr,
  0, () => BrowserConfig$
];
var Canaries: StaticListSchema = [1, n0, _Ca,
  0, () => Canary$
];
var CanariesLastRun: StaticListSchema = [1, n0, _CLRa,
  0, () => CanaryLastRun$
];
var CanaryRuns: StaticListSchema = [1, n0, _CRa,
  0, () => CanaryRun$
];
var Dependencies: StaticListSchema = [1, n0, _D,
  0, () => Dependency$
];
var DescribeCanariesLastRunNameFilter = 64 | 0;
var DescribeCanariesNameFilter = 64 | 0;
var EngineConfigs: StaticListSchema = [1, n0, _EC,
  0, () => EngineConfig$
];
...
var SubnetIds = 64 | 0;
var TagKeyList = 64 | 0;
var VisualReferences: StaticListSchema = [1, n0, _VRi,
  0, () => VisualReferenceInput$
];
var VisualReferencesOutput: StaticListSchema = [1, n0, _VROi,
...
export var CreateCanary$: StaticOperationSchema = [9, n0, _CC,
...
export var DeleteCanary$: StaticOperationSchema = [9, n0, _DC,
...
export var DescribeCanaries$: StaticOperationSchema = [9, n0, _DCe,
  { [_h]: ["POST", "/canaries", 200] }, () => DescribeCanariesRequest$, () => DescribeCanariesResponse$
];
export var DescribeCanariesLastRun$: StaticOperationSchema = [9, n0, _DCLR,
  { [_h]: ["POST", "/canaries/last-run", 200] }, () => DescribeCanariesLastRunRequest$, () => DescribeCanariesLastRunResponse$
];
export var DescribeRuntimeVersions$: StaticOperationSchema = [9, n0, _DRV,
...
export var GetCanary$: StaticOperationSchema = [9, n0, _GC,
  { [_h]: ["GET", "/canary/{Name}", 200] }, () => GetCanaryRequest$, () => GetCanaryResponse$
];
export var GetCanaryRuns$: StaticOperationSchema = [9, n0, _GCRet,
...
export var ListAssociatedGroups$: StaticOperationSchema = [9, n0, _LAG,
  { [_h]: ["POST", "/resource/{ResourceArn}/groups", 200] }, () => ListAssociatedGroupsRequest$, () => ListAssociatedGroupsResponse$
];
export var ListGroupResources$: StaticOperationSchema = [9, n0, _LGRis,
...
export var StartCanary$: StaticOperationSchema = [9, n0, _SC,
  { [_h]: ["POST", "/canary/{Name}/start", 200] }, () => StartCanaryRequest$, () => StartCanaryResponse$
];
export var StartCanaryDryRun$: StaticOperationSchema = [9, n0, _SCDR,
  { [_h]: ["POST", "/canary/{Name}/dry-run/start", 200] }, () => StartCanaryDryRunRequest$, () => StartCanaryDryRunResponse$
];
export var StopCanary$: StaticOperationSchema = [9, n0, _SCt,
...
export var UpdateCanary$: StaticOperationSchema = [9, n0, _UC,
