...
import { type RUMClientResolvedConfig, RUMClientConfig } from "../RUMClient";
 ...
 * @internal
 */
export const defaultRUMHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: RUMHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultRUMHttpAuthSchemeProvider: RUMHttpAuthSchemeProvider = (authParameters) => {
