...
import type { GetAppMonitorDataRequest, GetAppMonitorDataResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetAppMonitorDataCommand extends command<GetAppMonitorDataCommandInput, GetAppMonitorDataCommandOutput>(
  _ep0,
  _mw0,
  "GetAppMonitorData",
  GetAppMonitorData$
