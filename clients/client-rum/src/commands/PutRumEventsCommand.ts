...
import type { PutRumEventsRequest, PutRumEventsResponse } from "../models/models_0";
 ...
 * @public
 */
export class PutRumEventsCommand extends command<PutRumEventsCommandInput, PutRumEventsCommandOutput>(
  _ep0,
  _mw0,
  "PutRumEvents",
  PutRumEvents$
