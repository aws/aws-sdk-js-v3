...
import {
  ...
  defaultRbinHttpAuthSchemeParametersProvider,
...
import type { LockRuleCommandInput, LockRuleCommandOutput } from "./commands/LockRuleCommand";
import type { TagResourceCommandInput, TagResourceCommandOutput } from "./commands/TagResourceCommand";
import type { UnlockRuleCommandInput, UnlockRuleCommandOutput } from "./commands/UnlockRuleCommand";
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<RbinClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultRbinHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: RbinClientResolvedConfig) =>
