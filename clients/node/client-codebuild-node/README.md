# @aws-sdk/client-codebuild-node

[![NPM version](https://img.shields.io/npm/v/@aws-sdk/client-codebuild-node/preview.svg)](https://www.npmjs.com/package/@aws-sdk/client-codebuild-node)
[![NPM downloads](https://img.shields.io/npm/dm/@aws-sdk/client-codebuild-node.svg)](https://www.npmjs.com/package/@aws-sdk/client-codebuild-node)
...
```
npm install @aws-sdk/client-codebuild-node
```
...
const {
  CodeBuildClient
} = require("@aws-sdk/client-codebuild-node/CodeBuildClient");
const {
  BatchDeleteBuildsCommand
} = require("@aws-sdk/client-codebuild-node/commands/BatchDeleteBuildsCommand");
```

```javascript
//typescript
const { CodeBuildClient } = import '@aws-sdk/client-codebuild-node/CodeBuildClient';
const { BatchDeleteBuildsCommand } = import '@aws-sdk/client-codebuild-node/commands/BatchDeleteBuildsCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-codebuild-node/CodeBuild";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-codebuild-node' package is updated. To contribute to SDK you can checkout our [code generator package][].
