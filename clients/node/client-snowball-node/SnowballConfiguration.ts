...
export interface SnowballConfiguration {
  /**
...
export interface SnowballResolvableConfiguration extends SnowballConfiguration {
  /**
...
export interface SnowballResolvedConfiguration
  extends SnowballConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  SnowballResolvableConfiguration,
