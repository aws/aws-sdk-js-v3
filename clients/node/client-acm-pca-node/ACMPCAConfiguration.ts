...
export interface ACMPCAConfiguration {
  /**
...
export interface ACMPCAResolvableConfiguration extends ACMPCAConfiguration {
  /**
...
export interface ACMPCAResolvedConfiguration
  extends ACMPCAConfiguration,
