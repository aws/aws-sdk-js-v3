...
export interface SageMakerConfiguration {
  /**
...
export interface SageMakerResolvableConfiguration
  extends SageMakerConfiguration {
  /**
...
export interface SageMakerResolvedConfiguration
  extends SageMakerConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  SageMakerResolvableConfiguration,
