import {
  _ProposalActions,
  _UnmarshalledProposalActions
} from "./_ProposalActions";

/**
 * <p>Properties of a proposal on a Managed Blockchain network.</p>
 */
export interface _Proposal {
  /**
...
export interface _UnmarshalledProposal extends _Proposal {
  /**
   * <p>The actions to perform on the network if the proposal is <code>APPROVED</code>.</p>
   */
  Actions?: _UnmarshalledProposalActions;
