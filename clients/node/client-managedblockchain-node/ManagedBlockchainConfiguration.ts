...
export interface ManagedBlockchainConfiguration {
  /**
...
export interface ManagedBlockchainResolvableConfiguration
  extends ManagedBlockchainConfiguration {
  /**
...
export interface ManagedBlockchainResolvedConfiguration
  extends ManagedBlockchainConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ManagedBlockchainResolvableConfiguration,
...
> = {
  ...
  signingName: {
    defaultValue: "managedblockchain"
  },
  signer: {
    defaultProvider: (configuration: {
      credentials: __aws_sdk_types.Provider<__aws_sdk_types.Credentials>;
