...
export class ManagedBlockchainClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: ManagedBlockchainResolvedConfiguration;
  ...
  constructor(configuration: ManagedBlockchainConfiguration) {
