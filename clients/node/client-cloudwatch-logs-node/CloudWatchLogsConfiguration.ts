...
export interface CloudWatchLogsResolvableConfiguration
  extends CloudWatchLogsConfiguration {
  /**
...
export interface CloudWatchLogsResolvedConfiguration
  extends CloudWatchLogsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CloudWatchLogsResolvableConfiguration,
