...
export interface InspectorResolvableConfiguration
  extends InspectorConfiguration {
  /**
...
export interface InspectorResolvedConfiguration
  extends InspectorConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  InspectorResolvableConfiguration,
