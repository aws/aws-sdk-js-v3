...
```javascript
//TypeScript
import { RoboMakerClient } from "@aws-sdk/client-robomaker-node/RoboMakerClient";
import { BatchDescribeSimulationJobCommand } from "@aws-sdk/client-robomaker-node/commands/BatchDescribeSimulationJobCommand";
```
