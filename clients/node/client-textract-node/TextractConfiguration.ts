...
export interface TextractResolvableConfiguration extends TextractConfiguration {
  /**
...
export interface TextractResolvedConfiguration
  extends TextractConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  TextractResolvableConfiguration,
