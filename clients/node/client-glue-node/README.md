...
```javascript
//TypeScript
import { GlueClient } from "@aws-sdk/client-glue-node/GlueClient";
import { BatchCreatePartitionCommand } from "@aws-sdk/client-glue-node/commands/BatchCreatePartitionCommand";
```
