...
export interface AppSyncResolvableConfiguration extends AppSyncConfiguration {
  /**
...
export interface AppSyncResolvedConfiguration
  extends AppSyncConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  AppSyncResolvableConfiguration,
