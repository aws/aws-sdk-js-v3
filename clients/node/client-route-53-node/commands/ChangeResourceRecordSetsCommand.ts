...
import { ChangeResourceRecordSets } from "../model/operations/ChangeResourceRecordSets";
...
export class ChangeResourceRecordSetsCommand
  implements
    __aws_sdk_types.Command<
      ...
      _stream.Readable
    > {
  readonly model = ChangeResourceRecordSets;
  ...
  > {
    ...
    return stack.resolve(
      handler<ChangeResourceRecordSetsInput, ChangeResourceRecordSetsOutput>(
