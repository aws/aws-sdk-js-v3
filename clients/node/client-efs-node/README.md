...
```javascript
//typescript
const { EFSClient } = import '@aws-sdk/client-efs-node/EFSClient';
const { CreateFileSystemCommand } = import '@aws-sdk/client-efs-node/commands/CreateFileSystemCommand';
```
