...
export class DataPipelineClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: DataPipelineResolvedConfiguration;
  ...
  constructor(configuration: DataPipelineConfiguration) {
