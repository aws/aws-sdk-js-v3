...
export interface AlexaForBusinessConfiguration {
  /**
...
export interface AlexaForBusinessResolvableConfiguration
  extends AlexaForBusinessConfiguration {
  /**
...
export interface AlexaForBusinessResolvedConfiguration
  extends AlexaForBusinessConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  AlexaForBusinessResolvableConfiguration,
