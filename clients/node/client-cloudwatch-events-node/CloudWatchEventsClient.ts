...
export class CloudWatchEventsClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: CloudWatchEventsResolvedConfiguration;
  ...
  constructor(configuration: CloudWatchEventsConfiguration) {
