# @aws-sdk/client-s3-control-node
...
const {
  S3ControlClient,
  CreateJobCommand
} = require("@aws-sdk/client-s3-control-node");
```
...
import {
  S3ControlClient,
  CreateJobCommand
} from "@aws-sdk/client-s3-control-node";
```
...
```javascript
import * as AWS from "@aws-sdk/client-s3-control-node";
