...
export class OpsWorksCMClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: OpsWorksCMResolvedConfiguration;
  ...
  constructor(configuration: OpsWorksCMConfiguration) {
