...
export interface DirectoryServiceConfiguration {
  /**
...
export interface DirectoryServiceResolvableConfiguration
  extends DirectoryServiceConfiguration {
  /**
...
export interface DirectoryServiceResolvedConfiguration
  extends DirectoryServiceConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  DirectoryServiceResolvableConfiguration,
