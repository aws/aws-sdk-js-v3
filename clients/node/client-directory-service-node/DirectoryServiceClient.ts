...
export class DirectoryServiceClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: DirectoryServiceResolvedConfiguration;
  ...
  constructor(configuration: DirectoryServiceConfiguration) {
