...
export class QuickSightClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: QuickSightResolvedConfiguration;
  ...
  constructor(configuration: QuickSightConfiguration) {
