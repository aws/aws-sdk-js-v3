...
export interface KinesisAnalyticsV2Configuration {
  /**
...
export interface KinesisAnalyticsV2ResolvableConfiguration
  extends KinesisAnalyticsV2Configuration {
  /**
...
export interface KinesisAnalyticsV2ResolvedConfiguration
  extends KinesisAnalyticsV2Configuration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  KinesisAnalyticsV2ResolvableConfiguration,
