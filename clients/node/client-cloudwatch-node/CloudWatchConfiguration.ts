...
export interface CloudWatchResolvableConfiguration
  extends CloudWatchConfiguration {
  /**
...
export interface CloudWatchResolvedConfiguration
  extends CloudWatchConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CloudWatchResolvableConfiguration,
