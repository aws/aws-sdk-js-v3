...
export class MediaStoreClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: MediaStoreResolvedConfiguration;
  ...
  constructor(configuration: MediaStoreConfiguration) {
