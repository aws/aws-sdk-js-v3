# @aws-sdk/client-iotthingsgraph-node
...
```javascript
//typescript
const { IoTThingsGraphClient } = import '@aws-sdk/client-iotthingsgraph-node/IoTThingsGraphClient';
const { AssociateEntityToThingCommand } = import '@aws-sdk/client-iotthingsgraph-node/commands/AssociateEntityToThingCommand';
```
