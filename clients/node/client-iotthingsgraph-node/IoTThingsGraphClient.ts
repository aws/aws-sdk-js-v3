...
import {
  IoTThingsGraphConfiguration,
  IoTThingsGraphResolvedConfiguration,
  configurationProperties
} from "./IoTThingsGraphConfiguration";
...
export class IoTThingsGraphClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: IoTThingsGraphResolvedConfiguration;
  ...
  constructor(configuration: IoTThingsGraphConfiguration) {
