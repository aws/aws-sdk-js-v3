...
import {
  CostExplorerConfiguration,
  CostExplorerResolvedConfiguration,
  configurationProperties
} from "./CostExplorerConfiguration";
...
export class CostExplorerClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: CostExplorerResolvedConfiguration;
  ...
  constructor(configuration: CostExplorerConfiguration) {
