...
export interface KinesisAnalyticsConfiguration {
  /**
...
export interface KinesisAnalyticsResolvableConfiguration
  extends KinesisAnalyticsConfiguration {
  /**
...
export interface KinesisAnalyticsResolvedConfiguration
  extends KinesisAnalyticsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  KinesisAnalyticsResolvableConfiguration,
