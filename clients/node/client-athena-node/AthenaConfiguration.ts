...
export interface AthenaResolvableConfiguration extends AthenaConfiguration {
  /**
...
export interface AthenaResolvedConfiguration
  extends AthenaConfiguration,
