...
```javascript
//typescript
const { AthenaClient } = import '@aws-sdk/client-athena-node/AthenaClient';
const { BatchGetNamedQueryCommand } = import '@aws-sdk/client-athena-node/commands/BatchGetNamedQueryCommand';
```
