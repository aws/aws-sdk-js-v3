...
export interface ConnectResolvableConfiguration extends ConnectConfiguration {
  /**
...
export interface ConnectResolvedConfiguration
  extends ConnectConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ConnectResolvableConfiguration,
