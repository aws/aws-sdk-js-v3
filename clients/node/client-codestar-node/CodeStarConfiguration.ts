...
export interface CodeStarConfiguration {
  /**
...
export interface CodeStarResolvableConfiguration extends CodeStarConfiguration {
  /**
...
export interface CodeStarResolvedConfiguration
  extends CodeStarConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CodeStarResolvableConfiguration,
