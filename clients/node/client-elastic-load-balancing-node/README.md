# @aws-sdk/client-elastic-load-balancing-node
...
const {
  AddTagsCommand
} = require("@aws-sdk/client-elastic-load-balancing-node/commands/AddTagsCommand");
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-elastic-load-balancing-node/ElasticLoadBalancing";
