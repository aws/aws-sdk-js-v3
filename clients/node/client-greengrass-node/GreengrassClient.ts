...
export class GreengrassClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: GreengrassResolvedConfiguration;
  ...
  constructor(configuration: GreengrassConfiguration) {
