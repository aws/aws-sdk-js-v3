...
export interface IoTJobsDataPlaneConfiguration {
  /**
...
export interface IoTJobsDataPlaneResolvableConfiguration
  extends IoTJobsDataPlaneConfiguration {
  /**
...
export interface IoTJobsDataPlaneResolvedConfiguration
  extends IoTJobsDataPlaneConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  IoTJobsDataPlaneResolvableConfiguration,
