...
export interface ComprehendMedicalConfiguration {
  /**
...
export interface ComprehendMedicalResolvableConfiguration
  extends ComprehendMedicalConfiguration {
  /**
...
export interface ComprehendMedicalResolvedConfiguration
  extends ComprehendMedicalConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ComprehendMedicalResolvableConfiguration,
...
> = {
  ...
  signingName: {
    defaultValue: "comprehendmedical"
  },
  signer: {
    defaultProvider: (configuration: {
      credentials: __aws_sdk_types.Provider<__aws_sdk_types.Credentials>;
