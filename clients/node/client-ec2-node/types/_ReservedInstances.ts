 ...
 */
export interface _ReservedInstances {
  /**
   ...
   */
  State?: "payment-pending" | "active" | "payment-failed" | "retired" | string;
...
export interface _UnmarshalledReservedInstances extends _ReservedInstances {
  /**
   * <p>The time when the Reserved Instance expires.</p>
   */
  End?: Date;
