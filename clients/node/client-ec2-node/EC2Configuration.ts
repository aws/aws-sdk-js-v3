...
import * as __aws_sdk_ec2_error_unmarshaller from "@aws-sdk/ec2-error-unmarshaller";
...
export interface EC2ResolvableConfiguration extends EC2Configuration {
  /**
...
export interface EC2ResolvedConfiguration
  extends EC2Configuration,
  ...
  parser: {
    defaultProvider: (configuration: {
      ...
      new __aws_sdk_protocol_query.QueryParser(
        ...
        __aws_sdk_ec2_error_unmarshaller.ec2ErrorUnmarshaller,
