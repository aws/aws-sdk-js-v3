...
/**
 * AllocateTransitVirtualInterfaceInput shape
 */
export interface AllocateTransitVirtualInterfaceInput {
  /**
   ...
   */
  newTransitVirtualInterfaceAllocation: _NewTransitVirtualInterfaceAllocation;
