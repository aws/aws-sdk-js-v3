import { _UnmarshalledRouteFilterPrefix } from "./_RouteFilterPrefix";
import { _UnmarshalledBGPPeer } from "./_BGPPeer";
 ...
 */
export interface AllocatePublicVirtualInterfaceOutput
