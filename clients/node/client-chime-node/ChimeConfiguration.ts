...
export interface ChimeResolvableConfiguration extends ChimeConfiguration {
  /**
...
export interface ChimeResolvedConfiguration
  extends ChimeConfiguration,
