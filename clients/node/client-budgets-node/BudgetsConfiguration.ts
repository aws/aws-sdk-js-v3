...
export interface BudgetsConfiguration {
  /**
...
export interface BudgetsResolvableConfiguration extends BudgetsConfiguration {
  /**
...
export interface BudgetsResolvedConfiguration
  extends BudgetsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  BudgetsResolvableConfiguration,
