...
[![NPM version](https://img.shields.io/npm/v/@aws-sdk/client-opsworks-node/preview.svg)](https://www.npmjs.com/package/@aws-sdk/client-opsworks-node)
[![NPM downloads](https://img.shields.io/npm/dm/@aws-sdk/client-opsworks-node.svg)](https://www.npmjs.com/package/@aws-sdk/client-opsworks-node)
...
```
npm install @aws-sdk/client-opsworks-node
```
...
```javascript
//typescript
const { OpsWorksClient } = import '@aws-sdk/client-opsworks-node/OpsWorksClient';
const { AssignInstanceCommand } = import '@aws-sdk/client-opsworks-node/commands/AssignInstanceCommand';
```
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-opsworks-node' package is updated. To contribute to SDK you can checkout our [code generator package][].
