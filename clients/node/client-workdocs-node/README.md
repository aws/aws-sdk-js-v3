...
```javascript
//TypeScript
import { WorkDocsClient } from "@aws-sdk/client-workdocs-node/WorkDocsClient";
import { AbortDocumentVersionUploadCommand } from "@aws-sdk/client-workdocs-node/commands/AbortDocumentVersionUploadCommand";
```
