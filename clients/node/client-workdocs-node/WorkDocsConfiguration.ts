...
export interface WorkDocsResolvableConfiguration extends WorkDocsConfiguration {
  /**
...
export interface WorkDocsResolvedConfiguration
  extends WorkDocsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  WorkDocsResolvableConfiguration,
