...
export interface Route53DomainsConfiguration {
  /**
...
export interface Route53DomainsResolvableConfiguration
  extends Route53DomainsConfiguration {
  /**
...
export interface Route53DomainsResolvedConfiguration
  extends Route53DomainsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  Route53DomainsResolvableConfiguration,
