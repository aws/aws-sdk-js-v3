...
export interface MediaLiveConfiguration {
  /**
...
export interface MediaLiveResolvableConfiguration
  extends MediaLiveConfiguration {
  /**
...
export interface MediaLiveResolvedConfiguration
  extends MediaLiveConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  MediaLiveResolvableConfiguration,
