...
/**
 * DescribeEnvironmentMembershipsInput shape
 */
export interface DescribeEnvironmentMembershipsInput {
  /**
   ...
   */
  permissions?:
    | Array<"owner" | "read-write" | "read-only" | string>
    | Iterable<"owner" | "read-write" | "read-only" | string>;
