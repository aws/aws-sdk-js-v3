 ...
 */
export interface _ExtendedS3DestinationConfiguration {
  /**
...
export interface _UnmarshalledExtendedS3DestinationConfiguration
  extends _ExtendedS3DestinationConfiguration {
  /**
   * <p>The buffering option.</p>
   */
