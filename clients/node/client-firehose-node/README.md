...
const {
  FirehoseClient
} = require("@aws-sdk/client-firehose-node/FirehoseClient");
const {
  CreateDeliveryStreamCommand
} = require("@aws-sdk/client-firehose-node/commands/CreateDeliveryStreamCommand");
```

```javascript
//typescript
const { FirehoseClient } = import '@aws-sdk/client-firehose-node/FirehoseClient';
const { CreateDeliveryStreamCommand } = import '@aws-sdk/client-firehose-node/commands/CreateDeliveryStreamCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-firehose-node/Firehose";
