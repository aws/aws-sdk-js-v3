...
```javascript
//TypeScript
import { FirehoseClient } from "@aws-sdk/client-firehose-node/FirehoseClient";
import { CreateDeliveryStreamCommand } from "@aws-sdk/client-firehose-node/commands/CreateDeliveryStreamCommand";
```
