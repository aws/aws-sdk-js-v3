...
export interface SageMakerRuntimeConfiguration {
  /**
...
export interface SageMakerRuntimeResolvableConfiguration
  extends SageMakerRuntimeConfiguration {
  /**
...
export interface SageMakerRuntimeResolvedConfiguration
  extends SageMakerRuntimeConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  SageMakerRuntimeResolvableConfiguration,
