...
export interface AppMeshResolvableConfiguration extends AppMeshConfiguration {
  /**
...
export interface AppMeshResolvedConfiguration
  extends AppMeshConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  AppMeshResolvableConfiguration,
