# @aws-sdk/client-ec2-instance-connect-node
...
```javascript
//typescript
const { EC2InstanceConnectClient } = import '@aws-sdk/client-ec2-instance-connect-node/EC2InstanceConnectClient';
const { SendSSHPublicKeyCommand } = import '@aws-sdk/client-ec2-instance-connect-node/commands/SendSSHPublicKeyCommand';
```
