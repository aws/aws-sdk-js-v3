...
export interface AutoScalingPlansConfiguration {
  /**
...
export interface AutoScalingPlansResolvableConfiguration
  extends AutoScalingPlansConfiguration {
  /**
...
export interface AutoScalingPlansResolvedConfiguration
  extends AutoScalingPlansConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  AutoScalingPlansResolvableConfiguration,
...
> = {
  ...
  signingName: {
    defaultValue: "autoscaling-plans"
  },
  signer: {
    defaultProvider: (configuration: {
      credentials: __aws_sdk_types.Provider<__aws_sdk_types.Credentials>;
