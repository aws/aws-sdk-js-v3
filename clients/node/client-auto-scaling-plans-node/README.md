# @aws-sdk/client-auto-scaling-plans-node
...
```javascript
//typescript
const { AutoScalingPlansClient } = import '@aws-sdk/client-auto-scaling-plans-node/AutoScalingPlansClient';
const { CreateScalingPlanCommand } = import '@aws-sdk/client-auto-scaling-plans-node/commands/CreateScalingPlanCommand';
```
