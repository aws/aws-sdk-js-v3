# @aws-sdk/client-storage-gateway-node
...
```javascript
//typescript
const { StorageGatewayClient } = import '@aws-sdk/client-storage-gateway-node/StorageGatewayClient';
const { ActivateGatewayCommand } = import '@aws-sdk/client-storage-gateway-node/commands/ActivateGatewayCommand';
```
