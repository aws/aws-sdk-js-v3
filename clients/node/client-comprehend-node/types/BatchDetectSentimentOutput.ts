import { _UnmarshalledBatchDetectSentimentItemResult } from "./_BatchDetectSentimentItemResult";
import { _UnmarshalledBatchItemError } from "./_BatchItemError";
import * as __aws_sdk_types from "@aws-sdk/types";

/**
 * BatchDetectSentimentOutput shape
 */
export interface BatchDetectSentimentOutput
   ...
   */
  ResultList: Array<_UnmarshalledBatchDetectSentimentItemResult>;
