import { _UnmarshalledBatchDetectSyntaxItemResult } from "./_BatchDetectSyntaxItemResult";
import { _UnmarshalledBatchItemError } from "./_BatchItemError";
import * as __aws_sdk_types from "@aws-sdk/types";

/**
 * BatchDetectSyntaxOutput shape
 */
export interface BatchDetectSyntaxOutput
   ...
   */
  ResultList: Array<_UnmarshalledBatchDetectSyntaxItemResult>;
