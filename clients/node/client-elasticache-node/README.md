# @aws-sdk/client-elasticache-node
...
} = require("@aws-sdk/client-elasticache-node");
```
...
import {
  ElastiCacheClient,
  AddTagsToResourceCommand
} from "@aws-sdk/client-elasticache-node";
```
...
```javascript
import * as AWS from "@aws-sdk/client-elasticache-node";
