# @aws-sdk/client-device-farm-node
...
} = require("@aws-sdk/client-device-farm-node");
```
...
import {
  DeviceFarmClient,
  CreateDevicePoolCommand
} from "@aws-sdk/client-device-farm-node";
```
...
```javascript
import * as AWS from "@aws-sdk/client-device-farm-node";
