# @aws-sdk/client-elastic-beanstalk-node
...
} = require("@aws-sdk/client-elastic-beanstalk-node/commands/AbortEnvironmentUpdateCommand");
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-elastic-beanstalk-node/ElasticBeanstalk";
