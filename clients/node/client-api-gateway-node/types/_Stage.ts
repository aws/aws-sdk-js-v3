import { _MethodSetting, _UnmarshalledMethodSetting } from "./_MethodSetting";
import {
  _AccessLogSettings,
  _UnmarshalledAccessLogSettings
} from "./_AccessLogSettings";
import {
  _CanarySettings,
  _UnmarshalledCanarySettings
} from "./_CanarySettings";
...
export interface _Stage {
   ...
   */
  methodSettings?:
    | { [key: string]: _MethodSetting }
    | Iterable<[string, _MethodSetting]>;
...
export interface _UnmarshalledStage extends _Stage {
  /**
   * <p>A map that defines the method settings for a <a>Stage</a> resource. Keys (designated as <code>/{method_setting_key</code> below) are method paths defined as <code>{resource_path}/{http_method}</code> for an individual method override, or <code>/\\*\/\*</code> for overriding all methods in the stage. </p>
   */
