...
export interface APIGatewayResolvableConfiguration
  extends APIGatewayConfiguration {
  /**
...
export interface APIGatewayResolvedConfiguration
  extends APIGatewayConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  APIGatewayResolvableConfiguration,
