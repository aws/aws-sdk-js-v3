...
export interface BackupResolvableConfiguration extends BackupConfiguration {
  /**
...
export interface BackupResolvedConfiguration
  extends BackupConfiguration,
