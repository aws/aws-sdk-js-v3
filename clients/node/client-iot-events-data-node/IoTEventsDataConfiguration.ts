...
export interface IoTEventsDataConfiguration {
  /**
...
export interface IoTEventsDataResolvableConfiguration
  extends IoTEventsDataConfiguration {
  /**
...
export interface IoTEventsDataResolvedConfiguration
  extends IoTEventsDataConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  IoTEventsDataResolvableConfiguration,
