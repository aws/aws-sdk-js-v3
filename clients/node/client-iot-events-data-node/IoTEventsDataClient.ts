...
export class IoTEventsDataClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: IoTEventsDataResolvedConfiguration;
  ...
  constructor(configuration: IoTEventsDataConfiguration) {
