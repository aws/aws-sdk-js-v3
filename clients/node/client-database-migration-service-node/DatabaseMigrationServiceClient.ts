...
import {
  DatabaseMigrationServiceConfiguration,
  DatabaseMigrationServiceResolvedConfiguration,
  configurationProperties
} from "./DatabaseMigrationServiceConfiguration";
...
export class DatabaseMigrationServiceClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: DatabaseMigrationServiceResolvedConfiguration;
  ...
  constructor(configuration: DatabaseMigrationServiceConfiguration) {
