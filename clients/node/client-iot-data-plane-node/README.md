...
```javascript
//typescript
const { IoTDataPlaneClient } = import '@aws-sdk/client-iot-data-plane-node/IoTDataPlaneClient';
const { DeleteThingShadowCommand } = import '@aws-sdk/client-iot-data-plane-node/commands/DeleteThingShadowCommand';
```
