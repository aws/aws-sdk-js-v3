...
export interface GroundStationResolvableConfiguration
  extends GroundStationConfiguration {
  /**
...
export interface GroundStationResolvedConfiguration
  extends GroundStationConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  GroundStationResolvableConfiguration,
