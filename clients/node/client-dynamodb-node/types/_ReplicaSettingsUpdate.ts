...
} from "./_ReplicaGlobalSecondaryIndexSettingsUpdate";
...
export interface _ReplicaSettingsUpdate {
  ...
  ReplicaGlobalSecondaryIndexSettingsUpdate?:
    | Array<_ReplicaGlobalSecondaryIndexSettingsUpdate>
    | Iterable<_ReplicaGlobalSecondaryIndexSettingsUpdate>;
}

export interface _UnmarshalledReplicaSettingsUpdate
  extends _ReplicaSettingsUpdate {
  /**
   * <p>Autoscaling settings for managing a global table replica's read capacity units.</p>
   */
