...
export interface MediaPackageVodConfiguration {
  /**
...
export interface MediaPackageVodResolvableConfiguration
  extends MediaPackageVodConfiguration {
  /**
...
export interface MediaPackageVodResolvedConfiguration
  extends MediaPackageVodConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  MediaPackageVodResolvableConfiguration,
