...
export interface OrganizationsConfiguration {
  /**
...
export interface OrganizationsResolvableConfiguration
  extends OrganizationsConfiguration {
  /**
...
export interface OrganizationsResolvedConfiguration
  extends OrganizationsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  OrganizationsResolvableConfiguration,
