# @aws-sdk/client-organizations-node
...
} = require("@aws-sdk/client-organizations-node/commands/AcceptHandshakeCommand");
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-organizations-node/Organizations";
