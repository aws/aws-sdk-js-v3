...
export interface ServerlessApplicationRepositoryConfiguration {
  /**
...
export interface ServerlessApplicationRepositoryResolvableConfiguration
  extends ServerlessApplicationRepositoryConfiguration {
  /**
...
export interface ServerlessApplicationRepositoryResolvedConfiguration
  extends ServerlessApplicationRepositoryConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ServerlessApplicationRepositoryResolvableConfiguration,
