...
export class IoTEventsClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: IoTEventsResolvedConfiguration;
  ...
  constructor(configuration: IoTEventsConfiguration) {
