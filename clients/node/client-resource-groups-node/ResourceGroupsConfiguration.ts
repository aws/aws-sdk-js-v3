...
export interface ResourceGroupsConfiguration {
  /**
...
export interface ResourceGroupsResolvableConfiguration
  extends ResourceGroupsConfiguration {
  /**
...
export interface ResourceGroupsResolvedConfiguration
  extends ResourceGroupsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ResourceGroupsResolvableConfiguration,
