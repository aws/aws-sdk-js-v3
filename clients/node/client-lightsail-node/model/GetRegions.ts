import { GetRegionsInput } from "./GetRegionsInput";
import { GetRegionsOutput } from "./GetRegionsOutput";
...
export const GetRegions: _Operation_ = {
  ...
  input: {
    shape: GetRegionsInput
  },
  output: {
    shape: GetRegionsOutput
  },
  errors: [
    {
