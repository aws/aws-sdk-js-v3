import { GetInstanceSnapshotInput } from "../shapes/GetInstanceSnapshotInput";
import { GetInstanceSnapshotOutput } from "../shapes/GetInstanceSnapshotOutput";
...
export const GetInstanceSnapshot: _Operation_ = {
  ...
  input: {
    shape: GetInstanceSnapshotInput
  },
  output: {
    shape: GetInstanceSnapshotOutput
  },
  errors: [
    {
