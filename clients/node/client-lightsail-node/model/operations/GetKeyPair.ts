import { GetKeyPairInput } from "../shapes/GetKeyPairInput";
import { GetKeyPairOutput } from "../shapes/GetKeyPairOutput";
...
export const GetKeyPair: _Operation_ = {
  ...
  input: {
    shape: GetKeyPairInput
  },
  output: {
    shape: GetKeyPairOutput
  },
  errors: [
    {
