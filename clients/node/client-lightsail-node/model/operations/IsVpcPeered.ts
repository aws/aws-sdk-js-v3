import { IsVpcPeeredInput } from "../shapes/IsVpcPeeredInput";
import { IsVpcPeeredOutput } from "../shapes/IsVpcPeeredOutput";
...
export const IsVpcPeered: _Operation_ = {
  ...
  input: {
    shape: IsVpcPeeredInput
  },
  output: {
    shape: IsVpcPeeredOutput
  },
  errors: [
    {
