...
import {
  ApiGatewayV2Configuration,
  ApiGatewayV2ResolvedConfiguration,
  configurationProperties
} from "./ApiGatewayV2Configuration";
...
export class ApiGatewayV2Client
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: ApiGatewayV2ResolvedConfiguration;
  ...
  constructor(configuration: ApiGatewayV2Configuration) {
