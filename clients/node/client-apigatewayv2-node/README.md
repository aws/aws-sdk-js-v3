...
```javascript
//typescript
const { ApiGatewayV2Client } = import '@aws-sdk/client-apigatewayv2-node/ApiGatewayV2Client';
const { CreateApiCommand } = import '@aws-sdk/client-apigatewayv2-node/commands/CreateApiCommand';
```
