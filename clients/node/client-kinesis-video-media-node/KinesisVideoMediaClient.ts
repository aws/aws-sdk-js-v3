...
export class KinesisVideoMediaClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: KinesisVideoMediaResolvedConfiguration;
  ...
  constructor(configuration: KinesisVideoMediaConfiguration) {
