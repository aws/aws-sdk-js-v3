...
```javascript
//typescript
const { PollyClient } = import '@aws-sdk/client-polly-node/PollyClient';
const { DeleteLexiconCommand } = import '@aws-sdk/client-polly-node/commands/DeleteLexiconCommand';
```
