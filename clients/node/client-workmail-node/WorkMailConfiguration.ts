...
export interface WorkMailConfiguration {
  /**
...
export interface WorkMailResolvableConfiguration extends WorkMailConfiguration {
  /**
...
export interface WorkMailResolvedConfiguration
  extends WorkMailConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  WorkMailResolvableConfiguration,
