...
export class WorkMailClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: WorkMailResolvedConfiguration;
  ...
  constructor(configuration: WorkMailConfiguration) {
