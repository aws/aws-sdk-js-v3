...
export interface MobileResolvableConfiguration extends MobileConfiguration {
  /**
...
export interface MobileResolvedConfiguration
  extends MobileConfiguration,
...
> = {
  ...
  signingName: {
    defaultValue: "AWSMobileHubService"
  },
  signer: {
    defaultProvider: (configuration: {
      credentials: __aws_sdk_types.Provider<__aws_sdk_types.Credentials>;
