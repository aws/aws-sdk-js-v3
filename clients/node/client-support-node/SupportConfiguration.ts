...
export interface SupportResolvableConfiguration extends SupportConfiguration {
  /**
...
export interface SupportResolvedConfiguration
  extends SupportConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  SupportResolvableConfiguration,
