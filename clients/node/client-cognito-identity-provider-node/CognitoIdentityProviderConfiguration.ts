...
export interface CognitoIdentityProviderConfiguration {
  /**
...
export interface CognitoIdentityProviderResolvableConfiguration
  extends CognitoIdentityProviderConfiguration {
  /**
...
export interface CognitoIdentityProviderResolvedConfiguration
  extends CognitoIdentityProviderConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CognitoIdentityProviderResolvableConfiguration,
