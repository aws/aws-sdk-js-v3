...
import {
  CognitoIdentityProviderConfiguration,
  CognitoIdentityProviderResolvedConfiguration,
  configurationProperties
} from "./CognitoIdentityProviderConfiguration";
...
export class CognitoIdentityProviderClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: CognitoIdentityProviderResolvedConfiguration;
  ...
  constructor(configuration: CognitoIdentityProviderConfiguration) {
