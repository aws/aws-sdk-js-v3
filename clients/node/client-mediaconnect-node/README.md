# @aws-sdk/client-mediaconnect-node
...
} = require("@aws-sdk/client-mediaconnect-node");
```
...
import {
  MediaConnectClient,
  AddFlowOutputsCommand
} from "@aws-sdk/client-mediaconnect-node";
```
...
```javascript
import * as AWS from "@aws-sdk/client-mediaconnect-node";
