...
export class MediaConnectClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: MediaConnectResolvedConfiguration;
  ...
  constructor(configuration: MediaConnectConfiguration) {
