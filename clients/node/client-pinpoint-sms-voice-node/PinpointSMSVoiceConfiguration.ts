...
export interface PinpointSMSVoiceConfiguration {
  /**
...
export interface PinpointSMSVoiceResolvableConfiguration
  extends PinpointSMSVoiceConfiguration {
  /**
...
export interface PinpointSMSVoiceResolvedConfiguration
  extends PinpointSMSVoiceConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  PinpointSMSVoiceResolvableConfiguration,
