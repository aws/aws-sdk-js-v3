...
[![NPM version](https://img.shields.io/npm/v/@aws-sdk/client-secrets-manager-node/preview.svg)](https://www.npmjs.com/package/@aws-sdk/client-secrets-manager-node)
[![NPM downloads](https://img.shields.io/npm/dm/@aws-sdk/client-secrets-manager-node.svg)](https://www.npmjs.com/package/@aws-sdk/client-secrets-manager-node)
...
```javascript
//typescript
const { SecretsManagerClient } = import '@aws-sdk/client-secrets-manager-node/SecretsManagerClient';
const { CancelRotateSecretCommand } = import '@aws-sdk/client-secrets-manager-node/commands/CancelRotateSecretCommand';
```
