# @aws-sdk/client-workspaces-node
...
const {
  WorkSpacesClient
} = require("@aws-sdk/client-workspaces-node/WorkSpacesClient");
const {
  AssociateIpGroupsCommand
} = require("@aws-sdk/client-workspaces-node/commands/AssociateIpGroupsCommand");
```

```javascript
//typescript
const { WorkSpacesClient } = import '@aws-sdk/client-workspaces-node/WorkSpacesClient';
const { AssociateIpGroupsCommand } = import '@aws-sdk/client-workspaces-node/commands/AssociateIpGroupsCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-workspaces-node/WorkSpaces";
