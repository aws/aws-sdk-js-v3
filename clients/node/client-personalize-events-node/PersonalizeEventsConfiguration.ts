...
export interface PersonalizeEventsConfiguration {
  /**
...
export interface PersonalizeEventsResolvableConfiguration
  extends PersonalizeEventsConfiguration {
  /**
...
export interface PersonalizeEventsResolvedConfiguration
  extends PersonalizeEventsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  PersonalizeEventsResolvableConfiguration,
