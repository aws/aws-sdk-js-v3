...
import {
  PersonalizeEventsConfiguration,
  PersonalizeEventsResolvedConfiguration,
  configurationProperties
} from "./PersonalizeEventsConfiguration";
...
export class PersonalizeEventsClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: PersonalizeEventsResolvedConfiguration;
  ...
  constructor(configuration: PersonalizeEventsConfiguration) {
