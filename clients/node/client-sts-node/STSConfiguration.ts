...
export interface STSConfiguration {
  /**
...
export interface STSResolvableConfiguration extends STSConfiguration {
  /**
...
export interface STSResolvedConfiguration
  extends STSConfiguration,
  ...
  serializer: {
    defaultProvider: (configuration: {
      ...
      const promisified = configuration
        ...
        .then(
          endpoint =>
            new __aws_sdk_protocol_query.QuerySerializer<_stream.Readable>(
              endpoint,
