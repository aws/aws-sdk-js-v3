...
import { IDPCommunicationErrorException } from "./types/IDPCommunicationErrorException";
import { IDPRejectedClaimException } from "./types/IDPRejectedClaimException";
import { InvalidAuthorizationMessageException } from "./types/InvalidAuthorizationMessageException";
import { InvalidIdentityTokenException } from "./types/InvalidIdentityTokenException";
import { MalformedPolicyDocumentException } from "./types/MalformedPolicyDocumentException";
import { PackedPolicyTooLargeException } from "./types/PackedPolicyTooLargeException";
import { RegionDisabledException } from "./types/RegionDisabledException";
...
export class STS extends STSClient {
   ...
   *   - {PackedPolicyTooLargeException} <p>The request was rejected because the policy document was too large. The error message describes how big the policy document is, in packed form, as a percentage of what the API allows.</p>
   *   - {RegionDisabledException} <p>STS is not activated in the requested region for the account that is being asked to generate credentials. The account administrator must use the IAM console to activate STS in that region. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html">Activating and Deactivating AWS STS in an AWS Region</a> in the <i>IAM User Guide</i>.</p>
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public assumeRole(args: AssumeRoleInput): Promise<AssumeRoleOutput>;
  public assumeRole(
    args: AssumeRoleInput,
    cb: (err: any, data?: AssumeRoleOutput) => void
  ): void;
  public assumeRole(
    args: AssumeRoleInput,
    cb?: (err: any, data?: AssumeRoleOutput) => void
  ): Promise<AssumeRoleOutput> | void {
   ...
   *   - {MalformedPolicyDocumentException} <p>The request was rejected because the policy document was malformed. The error message describes the specific error.</p>
   *   - {PackedPolicyTooLargeException} <p>The request was rejected because the policy document was too large. The error message describes how big the policy document is, in packed form, as a percentage of what the API allows.</p>
   *   - {IDPRejectedClaimException} <p>The identity provider (IdP) reported that authentication failed. This might be because the claim is invalid.</p> <p>If this error is returned for the <code>AssumeRoleWithWebIdentity</code> operation, it can also mean that the claim has expired or has been explicitly revoked. </p>
   *   - {InvalidIdentityTokenException} <p>The web identity token that was passed could not be validated by AWS. Get a new identity token from the identity provider and then retry the request.</p>
   *   - {ExpiredTokenException} <p>The web identity token that was passed is expired or is not valid. Get a new identity token from the identity provider and then retry the request.</p>
   *   - {RegionDisabledException} <p>STS is not activated in the requested region for the account that is being asked to generate credentials. The account administrator must use the IAM console to activate STS in that region. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html">Activating and Deactivating AWS STS in an AWS Region</a> in the <i>IAM User Guide</i>.</p>
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public assumeRoleWithSAML(
    args: AssumeRoleWithSAMLInput
  ): Promise<AssumeRoleWithSAMLOutput>;
  public assumeRoleWithSAML(
    args: AssumeRoleWithSAMLInput,
    cb: (err: any, data?: AssumeRoleWithSAMLOutput) => void
  ): void;
  public assumeRoleWithSAML(
    args: AssumeRoleWithSAMLInput,
    cb?: (err: any, data?: AssumeRoleWithSAMLOutput) => void
  ): Promise<AssumeRoleWithSAMLOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public assumeRoleWithWebIdentity(
    args: AssumeRoleWithWebIdentityInput
  ): Promise<AssumeRoleWithWebIdentityOutput>;
  public assumeRoleWithWebIdentity(
    args: AssumeRoleWithWebIdentityInput,
    cb: (err: any, data?: AssumeRoleWithWebIdentityOutput) => void
  ): void;
  public assumeRoleWithWebIdentity(
    args: AssumeRoleWithWebIdentityInput,
    cb?: (err: any, data?: AssumeRoleWithWebIdentityOutput) => void
  ): Promise<AssumeRoleWithWebIdentityOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *
   * This operation may fail with one of the following errors:
   *   - {InvalidAuthorizationMessageException} <p>The error returned if the message passed to <code>DecodeAuthorizationMessage</code> was invalid. This can happen if the token contains invalid characters, such as linebreaks. </p>
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public decodeAuthorizationMessage(
    args: DecodeAuthorizationMessageInput
  ): Promise<DecodeAuthorizationMessageOutput>;
  public decodeAuthorizationMessage(
    args: DecodeAuthorizationMessageInput,
    cb: (err: any, data?: DecodeAuthorizationMessageOutput) => void
  ): void;
  public decodeAuthorizationMessage(
    args: DecodeAuthorizationMessageInput,
    cb?: (err: any, data?: DecodeAuthorizationMessageOutput) => void
  ): Promise<DecodeAuthorizationMessageOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public getAccessKeyInfo(
    args: GetAccessKeyInfoInput
  ): Promise<GetAccessKeyInfoOutput>;
  public getAccessKeyInfo(
    args: GetAccessKeyInfoInput,
    cb: (err: any, data?: GetAccessKeyInfoOutput) => void
  ): void;
  public getAccessKeyInfo(
    args: GetAccessKeyInfoInput,
    cb?: (err: any, data?: GetAccessKeyInfoOutput) => void
  ): Promise<GetAccessKeyInfoOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public getCallerIdentity(
    args: GetCallerIdentityInput
  ): Promise<GetCallerIdentityOutput>;
  public getCallerIdentity(
    args: GetCallerIdentityInput,
    cb: (err: any, data?: GetCallerIdentityOutput) => void
  ): void;
  public getCallerIdentity(
    args: GetCallerIdentityInput,
    cb?: (err: any, data?: GetCallerIdentityOutput) => void
  ): Promise<GetCallerIdentityOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public getSessionToken(
    args: GetSessionTokenInput
  ): Promise<GetSessionTokenOutput>;
  public getSessionToken(
    args: GetSessionTokenInput,
    cb: (err: any, data?: GetSessionTokenOutput) => void
  ): void;
  public getSessionToken(
    args: GetSessionTokenInput,
    cb?: (err: any, data?: GetSessionTokenOutput) => void
  ): Promise<GetSessionTokenOutput> | void {
    // create the appropriate command and pass it to .send
