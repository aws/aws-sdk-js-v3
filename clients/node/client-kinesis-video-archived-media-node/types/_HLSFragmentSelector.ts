...
export interface _HLSFragmentSelector {
   ...
   */
  TimestampRange?: _HLSTimestampRange;
}

export interface _UnmarshalledHLSFragmentSelector extends _HLSFragmentSelector {
  /**
   * <p>The start and end of the timestamp range for the requested media.</p> <p>This value should not be present if <code>PlaybackType</code> is <code>LIVE</code>.</p>
   */
  TimestampRange?: _UnmarshalledHLSTimestampRange;
}
