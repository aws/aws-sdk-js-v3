...
import {
  ServiceQuotasConfiguration,
  ServiceQuotasResolvedConfiguration,
  configurationProperties
} from "./ServiceQuotasConfiguration";
...
export class ServiceQuotasClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: ServiceQuotasResolvedConfiguration;
  ...
  constructor(configuration: ServiceQuotasConfiguration) {
