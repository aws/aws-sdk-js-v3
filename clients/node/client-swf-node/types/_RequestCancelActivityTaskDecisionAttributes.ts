 ...
 */
export interface _RequestCancelActivityTaskDecisionAttributes {
  /**
...
export type _UnmarshalledRequestCancelActivityTaskDecisionAttributes = _RequestCancelActivityTaskDecisionAttributes;
