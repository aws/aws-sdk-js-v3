 ...
 */
export interface _CancelWorkflowExecutionDecisionAttributes {
  /**
...
export type _UnmarshalledCancelWorkflowExecutionDecisionAttributes = _CancelWorkflowExecutionDecisionAttributes;
