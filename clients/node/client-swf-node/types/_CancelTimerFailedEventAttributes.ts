 ...
 */
export interface _CancelTimerFailedEventAttributes {
  /**
   ...
   */
  cause: "TIMER_ID_UNKNOWN" | "OPERATION_NOT_PERMITTED" | string;
...
export type _UnmarshalledCancelTimerFailedEventAttributes = _CancelTimerFailedEventAttributes;
