 ...
 */
export interface _RequestCancelActivityTaskFailedEventAttributes {
  /**
   ...
   */
  cause: "ACTIVITY_ID_UNKNOWN" | "OPERATION_NOT_PERMITTED" | string;
...
export type _UnmarshalledRequestCancelActivityTaskFailedEventAttributes = _RequestCancelActivityTaskFailedEventAttributes;
