 ...
 */
export interface _FailWorkflowExecutionDecisionAttributes {
  /**
...
export type _UnmarshalledFailWorkflowExecutionDecisionAttributes = _FailWorkflowExecutionDecisionAttributes;
