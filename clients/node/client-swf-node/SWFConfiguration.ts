...
export interface SWFConfiguration {
  /**
...
export interface SWFResolvableConfiguration extends SWFConfiguration {
  /**
...
export interface SWFResolvedConfiguration
  extends SWFConfiguration,
