...
```javascript
//TypeScript
import { ECSClient } from "@aws-sdk/client-ecs-node/ECSClient";
import { CreateClusterCommand } from "@aws-sdk/client-ecs-node/commands/CreateClusterCommand";
```
