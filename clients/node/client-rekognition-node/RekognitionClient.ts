...
import {
  RekognitionConfiguration,
  RekognitionResolvedConfiguration,
  configurationProperties
} from "./RekognitionConfiguration";
...
export class RekognitionClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: RekognitionResolvedConfiguration;
  ...
  constructor(configuration: RekognitionConfiguration) {
