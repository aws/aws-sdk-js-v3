...
export class ApplicationDiscoveryServiceClient
  implements
    __aws_sdk_types.AWSClient<
      ...
      _stream.Readable
    > {
  readonly config: ApplicationDiscoveryServiceResolvedConfiguration;
  ...
  constructor(configuration: ApplicationDiscoveryServiceConfiguration) {
