...
> {
   ...
   * @public
   */
  constructor(readonly input: ListSoftwareSetsCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
    ...
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListSoftwareSetsCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: ListSoftwareSetsCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<ListSoftwareSetsCommandOutput> {
