 ...
 * @public
 */
export class CreateDataflowEndpointGroupV2Command extends command<CreateDataflowEndpointGroupV2CommandInput, CreateDataflowEndpointGroupV2CommandOutput>(
  _ep0,
  _mw0,
