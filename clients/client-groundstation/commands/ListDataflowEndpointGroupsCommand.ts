...
import {
  deserializeAws_restJson1_1ListDataflowEndpointGroupsCommand,
  serializeAws_restJson1_1ListDataflowEndpointGroupsCommand
...
> {
  ...
  private serialize(input: ListDataflowEndpointGroupsCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1ListDataflowEndpointGroupsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListDataflowEndpointGroupsCommand(output, context);
  }
