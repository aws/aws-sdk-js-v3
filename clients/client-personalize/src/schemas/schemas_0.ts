...
const _rec = "recipes";
const _reco = "recommenders";
const _s = "smithy.ts.sdk.synthetic.com.amazonaws.personalize";
const _sA = "schemaArn";
...
export var PersonalizeServiceException$: StaticErrorSchema = [-3, _s, "PersonalizeServiceException", 0, [], []];
_s_registry.registerError(PersonalizeServiceException$, PersonalizeServiceException);
...
export var Algorithm$: StaticStructureSchema = [3, n0, _A,
  0,
...
export var AutoMLResult$: StaticStructureSchema = [3, n0, _AMLR,
  0,
  [_bRA],
  [0]
];
export var AutoTrainingConfig$: StaticStructureSchema = [3, n0, _ATC,
  0,
  [_sE],
  [0]
];
export var BatchInferenceJob$: StaticStructureSchema = [3, n0, _BIJ,
  0,
  [_jN, _bIJA, _fA, _fR, _sVA, _nR, _jI, _jO, _bIJC, _rA, _bIJM, _tGC, _st, _cDT, _lUDT],
  [0, 0, 0, 0, 0, 1, () => BatchInferenceJobInput$, () => BatchInferenceJobOutput$, () => BatchInferenceJobConfig$, 0, 0, () => ThemeGenerationConfig$, 0, 4, 4]
];
export var BatchInferenceJobConfig$: StaticStructureSchema = [3, n0, _BIJC,
  0,
  [_iEC, _rI],
  [128 | 0, 128 | 1]
];
...
export var BatchInferenceJobSummary$: StaticStructureSchema = [3, n0, _BIJS,
  0,
  [_bIJA, _jN, _st, _cDT, _lUDT, _fR, _sVA, _bIJM],
  [0, 0, 0, 4, 4, 0, 0, 0]
];
export var BatchSegmentJob$: StaticStructureSchema = [3, n0, _BSJ,
  0,
  [_jN, _bSJA, _fA, _fR, _sVA, _nR, _jI, _jO, _rA, _st, _cDT, _lUDT],
...
export var BatchSegmentJobSummary$: StaticStructureSchema = [3, n0, _BSJS,
  0,
  [_bSJA, _jN, _st, _cDT, _lUDT, _fR, _sVA],
  [0, 0, 0, 4, 4, 0, 0]
];
export var Campaign$: StaticStructureSchema = [3, n0, _C,
  0,
  [_n, _cA, _sVA, _mPTPS, _cC, _st, _fR, _cDT, _lUDT, _lCU],
  [0, 0, 0, 1, () => CampaignConfig$, 0, 0, 4, 4, () => CampaignUpdateSummary$]
];
export var CampaignConfig$: StaticStructureSchema = [3, n0, _CC,
  0,
...
export var CampaignSummary$: StaticStructureSchema = [3, n0, _CS,
  0,
  [_n, _cA, _st, _cDT, _lUDT, _fR],
  [0, 0, 0, 4, 4, 0]
];
export var CampaignUpdateSummary$: StaticStructureSchema = [3, n0, _CUS,
  0,
  [_sVA, _mPTPS, _cC, _st, _fR, _cDT, _lUDT],
  [0, 1, () => CampaignConfig$, 0, 0, 4, 4]
];
export var CategoricalHyperParameterRange$: StaticStructureSchema = [3, n0, _CHPR,
  0,
  [_n, _v],
  [0, 64 | 0]
];
export var ContinuousHyperParameterRange$: StaticStructureSchema = [3, n0, _CHPRo,
  0,
  [_n, _mV, _mVa],
  [0, 1, 1]
];
...
export var DataDeletionJob$: StaticStructureSchema = [3, n0, _DDJ,
  0,
  [_jN, _dDJA, _dGA, _dS, _rA, _st, _nD, _cDT, _lUDT, _fR],
  [0, 0, 0, () => DataSource$, 0, 0, 1, 4, 4, 0]
];
export var DataDeletionJobSummary$: StaticStructureSchema = [3, n0, _DDJS,
  0,
  [_dDJA, _dGA, _jN, _st, _cDT, _lUDT, _fR],
  [0, 0, 0, 0, 4, 4, 0]
];
export var Dataset$: StaticStructureSchema = [3, n0, _D,
  0,
  [_n, _dA, _dGA, _dT, _sA, _st, _cDT, _lUDT, _lDU, _tI],
  [0, 0, 0, 0, 0, 0, 4, 4, () => DatasetUpdateSummary$, 0]
];
export var DatasetExportJob$: StaticStructureSchema = [3, n0, _DEJ,
  0,
  [_jN, _dEJA, _dA, _iM, _rA, _st, _jO, _cDT, _lUDT, _fR],
...
export var DatasetExportJobSummary$: StaticStructureSchema = [3, n0, _DEJS,
  0,
  [_dEJA, _jN, _st, _cDT, _lUDT, _fR],
  [0, 0, 0, 4, 4, 0]
];
export var DatasetGroup$: StaticStructureSchema = [3, n0, _DG,
  0,
  [_n, _dGA, _st, _rA, _kKA, _cDT, _lUDT, _fR, _d],
  [0, 0, 0, 0, 0, 4, 4, 0, 0]
];
export var DatasetGroupSummary$: StaticStructureSchema = [3, n0, _DGS,
  0,
  [_n, _dGA, _st, _cDT, _lUDT, _fR, _d],
  [0, 0, 0, 4, 4, 0, 0]
];
export var DatasetImportJob$: StaticStructureSchema = [3, n0, _DIJ,
  0,
  [_jN, _dIJA, _dA, _dS, _rA, _st, _cDT, _lUDT, _fR, _iMm, _pAMTS],
  [0, 0, 0, () => DataSource$, 0, 0, 4, 4, 0, 0, 2]
];
export var DatasetImportJobSummary$: StaticStructureSchema = [3, n0, _DIJS,
  0,
  [_dIJA, _jN, _st, _cDT, _lUDT, _fR, _iMm],
  [0, 0, 0, 4, 4, 0, 0]
];
export var DatasetSchema$: StaticStructureSchema = [3, n0, _DS,
  0,
  [_n, _sA, _sc, _cDT, _lUDT, _d],
  [0, 0, 0, 4, 4, 0]
];
export var DatasetSchemaSummary$: StaticStructureSchema = [3, n0, _DSS,
  0,
...
export var DatasetSummary$: StaticStructureSchema = [3, n0, _DSa,
  0,
  [_n, _dA, _dT, _st, _cDT, _lUDT],
  [0, 0, 0, 0, 4, 4]
];
export var DatasetUpdateSummary$: StaticStructureSchema = [3, n0, _DUS,
  0,
  [_sA, _st, _fR, _cDT, _lUDT],
  [0, 0, 0, 4, 4]
];
export var DataSource$: StaticStructureSchema = [3, n0, _DSat,
  0,
  [_dL],
  [0]
];
export var DefaultCategoricalHyperParameterRange$: StaticStructureSchema = [3, n0, _DCHPR,
  0,
  [_n, _v, _iT],
  [0, 64 | 0, 2]
];
export var DefaultContinuousHyperParameterRange$: StaticStructureSchema = [3, n0, _DCHPRe,
  0,
  [_n, _mV, _mVa, _iT],
  [0, 1, 1, 2]
];
export var DefaultHyperParameterRanges$: StaticStructureSchema = [3, n0, _DHPR,
  0,
  [_iHPR, _cHPR, _cHPRa],
  [() => DefaultIntegerHyperParameterRanges, () => DefaultContinuousHyperParameterRanges, () => DefaultCategoricalHyperParameterRanges]
];
export var DefaultIntegerHyperParameterRange$: StaticStructureSchema = [3, n0, _DIHPR,
  0,
  [_n, _mV, _mVa, _iT],
  [0, 1, 1, 2]
];
...
export var EventTracker$: StaticStructureSchema = [3, n0, _ET,
  0,
  [_n, _eTA, _aIc, _tI, _dGA, _st, _cDT, _lUDT],
  [0, 0, 0, 0, 0, 0, 4, 4]
];
export var EventTrackerSummary$: StaticStructureSchema = [3, n0, _ETS,
  0,
  [_n, _eTA, _st, _cDT, _lUDT],
  [0, 0, 0, 4, 4]
];
export var FeatureTransformation$: StaticStructureSchema = [3, n0, _FT,
  0,
  [_n, _fTA, _dP, _cDT, _lUDT, _st],
  [0, 0, 128 | 0, 4, 4, 0]
];
...
export var Filter$: StaticStructureSchema = [3, n0, _F,
  0,
  [_n, _fA, _cDT, _lUDT, _dGA, _fR, _fE, _st],
  [0, 0, 4, 4, 0, 0, [() => FilterExpression, 0], 0]
];
export var FilterSummary$: StaticStructureSchema = [3, n0, _FS,
  0,
  [_n, _fA, _cDT, _lUDT, _dGA, _fR, _st],
  [0, 0, 4, 4, 0, 0, 0]
];
...
export var HPOConfig$: StaticStructureSchema = [3, n0, _HPOC,
  0,
  [_hO, _hRC, _aHPR],
  [() => HPOObjective$, () => HPOResourceConfig$, () => HyperParameterRanges$]
];
export var HPOObjective$: StaticStructureSchema = [3, n0, _HPOO,
  0,
  [_ty, _mN, _mR],
  [0, 0, 0]
];
export var HPOResourceConfig$: StaticStructureSchema = [3, n0, _HPORC,
  0,
  [_mNOTJ, _mPTJ],
  [0, 0]
];
export var HyperParameterRanges$: StaticStructureSchema = [3, n0, _HPR,
  0,
  [_iHPR, _cHPR, _cHPRa],
  [() => IntegerHyperParameterRanges, () => ContinuousHyperParameterRanges, () => CategoricalHyperParameterRanges]
];
export var IntegerHyperParameterRange$: StaticStructureSchema = [3, n0, _IHPR,
  0,
  [_n, _mV, _mVa],
  [0, 1, 1]
];
export var ListBatchInferenceJobsRequest$: StaticStructureSchema = [3, n0, _LBIJR,
  0,
  [_sVA, _nT, _mRa],
  [0, 0, 1]
];
export var ListBatchInferenceJobsResponse$: StaticStructureSchema = [3, n0, _LBIJRi,
  0,
  [_bIJa, _nT],
  [() => BatchInferenceJobs, 0]
];
export var ListBatchSegmentJobsRequest$: StaticStructureSchema = [3, n0, _LBSJR,
  0,
  [_sVA, _nT, _mRa],
  [0, 0, 1]
];
export var ListBatchSegmentJobsResponse$: StaticStructureSchema = [3, n0, _LBSJRi,
  0,
  [_bSJa, _nT],
  [() => BatchSegmentJobs, 0]
];
...
export var ListDataDeletionJobsRequest$: StaticStructureSchema = [3, n0, _LDDJR,
  0,
  [_dGA, _nT, _mRa],
  [0, 0, 1]
];
export var ListDataDeletionJobsResponse$: StaticStructureSchema = [3, n0, _LDDJRi,
  0,
  [_dDJa, _nT],
  [() => DataDeletionJobs, 0]
];
...
export var ListEventTrackersRequest$: StaticStructureSchema = [3, n0, _LETR,
  0,
  [_dGA, _nT, _mRa],
  [0, 0, 1]
];
export var ListEventTrackersResponse$: StaticStructureSchema = [3, n0, _LETRi,
  0,
  [_eTve, _nT],
  [() => EventTrackers, 0]
];
...
export var ListMetricAttributionMetricsRequest$: StaticStructureSchema = [3, n0, _LMAMR,
  0,
  [_mAA, _nT, _mRa],
  [0, 0, 1]
];
export var ListMetricAttributionMetricsResponse$: StaticStructureSchema = [3, n0, _LMAMRi,
  0,
  [_me, _nT],
  [() => MetricAttributes, 0]
];
export var ListMetricAttributionsRequest$: StaticStructureSchema = [3, n0, _LMAR,
  0,
  [_dGA, _nT, _mRa],
  [0, 0, 1]
];
export var ListMetricAttributionsResponse$: StaticStructureSchema = [3, n0, _LMARi,
  0,
  [_mAe, _nT],
...
export var ListRecommendersRequest$: StaticStructureSchema = [3, n0, _LRRis,
  0,
  [_dGA, _nT, _mRa],
  [0, 0, 1]
];
export var ListRecommendersResponse$: StaticStructureSchema = [3, n0, _LRRist,
  0,
  [_reco, _nT],
  [() => Recommenders, 0]
];
...
export var ListSolutionsRequest$: StaticStructureSchema = [3, n0, _LSRis,
  0,
  [_dGA, _nT, _mRa],
  [0, 0, 1]
];
export var ListSolutionsResponse$: StaticStructureSchema = [3, n0, _LSRist,
  0,
  [_sol, _nT],
  [() => Solutions, 0]
];
export var ListSolutionVersionsRequest$: StaticStructureSchema = [3, n0, _LSVR,
  0,
  [_sAo, _nT, _mRa],
  [0, 0, 1]
];
export var ListSolutionVersionsResponse$: StaticStructureSchema = [3, n0, _LSVRi,
  0,
  [_sVo, _nT],
  [() => SolutionVersions, 0]
];
...
export var MetricAttribution$: StaticStructureSchema = [3, n0, _MAe,
  0,
  [_n, _mAA, _dGA, _mOC, _st, _cDT, _lUDT, _fR],
...
export var MetricAttributionSummary$: StaticStructureSchema = [3, n0, _MAS,
  0,
  [_n, _mAA, _st, _cDT, _lUDT, _fR],
  [0, 0, 0, 4, 4, 0]
];
export var OptimizationObjective$: StaticStructureSchema = [3, n0, _OO,
  0,
  [_iA, _oS],
  [0, 0]
];
export var Recipe$: StaticStructureSchema = [3, n0, _R,
  0,
  [_n, _rAe, _aA, _fTA, _st, _de, _cDT, _rT, _lUDT],
  [0, 0, 0, 0, 0, 0, 4, 0, 4]
];
export var RecipeSummary$: StaticStructureSchema = [3, n0, _RS,
  0,
  [_n, _rAe, _st, _cDT, _lUDT, _d],
  [0, 0, 0, 4, 4, 0]
];
export var Recommender$: StaticStructureSchema = [3, n0, _Re,
  0,
  [_rAec, _dGA, _n, _rAe, _rC, _cDT, _lUDT, _st, _fR, _lRU, _mM],
...
export var RecommenderSummary$: StaticStructureSchema = [3, n0, _RSe,
  0,
  [_n, _rAec, _dGA, _rAe, _rC, _st, _cDT, _lUDT],
  [0, 0, 0, 0, () => RecommenderConfig$, 0, 4, 4]
];
export var RecommenderUpdateSummary$: StaticStructureSchema = [3, n0, _RUS,
  0,
  [_rC, _cDT, _lUDT, _st, _fR],
...
export var Solution$: StaticStructureSchema = [3, n0, _S,
  0,
  [_n, _sAo, _pHPO, _pAML, _pAT, _pIU, _rAe, _dGA, _eT, _sC, _aMLR, _st, _cDT, _lUDT, _lSV, _lSU],
  [0, 0, 2, 2, 2, 2, 0, 0, 0, () => SolutionConfig$, () => AutoMLResult$, 0, 4, 4, () => SolutionVersionSummary$, () => SolutionUpdateSummary$]
];
export var SolutionConfig$: StaticStructureSchema = [3, n0, _SC,
  0,
...
export var SolutionSummary$: StaticStructureSchema = [3, n0, _SS,
  0,
  [_n, _sAo, _st, _cDT, _lUDT, _rAe],
  [0, 0, 0, 4, 4, 0]
];
export var SolutionUpdateConfig$: StaticStructureSchema = [3, n0, _SUC,
  0,
  [_aTC, _eC],
  [() => AutoTrainingConfig$, () => EventsConfig$]
];
export var SolutionUpdateSummary$: StaticStructureSchema = [3, n0, _SUS,
  0,
  [_sUC, _st, _pAT, _pIU, _cDT, _lUDT, _fR],
  [() => SolutionUpdateConfig$, 0, 2, 2, 4, 4, 0]
];
export var SolutionVersion$: StaticStructureSchema = [3, n0, _SV,
  0,
  [_n, _sVA, _sAo, _pHPO, _pAML, _pIU, _rAe, _eT, _dGA, _sC, _tH, _tM, _tHPOP, _st, _fR, _cDT, _lUDT, _tT],
  [0, 0, 0, 2, 2, 2, 0, 0, 0, () => SolutionConfig$, 1, 0, () => TunedHPOParams$, 0, 0, 4, 4, 0]
];
export var SolutionVersionSummary$: StaticStructureSchema = [3, n0, _SVS,
  0,
  [_sVA, _st, _tM, _tT, _cDT, _lUDT, _fR],
  [0, 0, 0, 0, 4, 4, 0]
];
...
export var TunedHPOParams$: StaticStructureSchema = [3, n0, _THPOP,
  0,
  [_aHP],
  [128 | 0]
];
...
export var UpdateMetricAttributionRequest$: StaticStructureSchema = [3, n0, _UMAR,
  0,
  [_aM, _rM, _mOC, _mAA],
  [() => MetricAttributes, 64 | 0, () => MetricAttributionOutput$, 0]
];
export var UpdateMetricAttributionResponse$: StaticStructureSchema = [3, n0, _UMARp,
  0,
  [_mAA],
  [0]
];
...
var ArnList = 64 | 0;
var BatchInferenceJobs: StaticListSchema = [1, n0, _BIJa,
  0, () => BatchInferenceJobSummary$
];
var BatchSegmentJobs: StaticListSchema = [1, n0, _BSJa,
  0, () => BatchSegmentJobSummary$
];
var Campaigns: StaticListSchema = [1, n0, _Ca,
  0, () => CampaignSummary$
];
var CategoricalHyperParameterRanges: StaticListSchema = [1, n0, _CHPRa,
  0, () => CategoricalHyperParameterRange$
];
var CategoricalValues = 64 | 0;
var ColumnNamesList = 64 | 0;
var ContinuousHyperParameterRanges: StaticListSchema = [1, n0, _CHPRon,
  0, () => ContinuousHyperParameterRange$
];
var DataDeletionJobs: StaticListSchema = [1, n0, _DDJa,
  0, () => DataDeletionJobSummary$
];
var DatasetExportJobs: StaticListSchema = [1, n0, _DEJa,
  0, () => DatasetExportJobSummary$
];
var DatasetGroups: StaticListSchema = [1, n0, _DGa,
  0, () => DatasetGroupSummary$
];
var DatasetImportJobs: StaticListSchema = [1, n0, _DIJa,
  0, () => DatasetImportJobSummary$
];
var Datasets: StaticListSchema = [1, n0, _Da,
  0, () => DatasetSummary$
];
var DefaultCategoricalHyperParameterRanges: StaticListSchema = [1, n0, _DCHPRef,
  0, () => DefaultCategoricalHyperParameterRange$
];
var DefaultContinuousHyperParameterRanges: StaticListSchema = [1, n0, _DCHPRefa,
  0, () => DefaultContinuousHyperParameterRange$
];
var DefaultIntegerHyperParameterRanges: StaticListSchema = [1, n0, _DIHPRe,
  0, () => DefaultIntegerHyperParameterRange$
];
var EventParametersList: StaticListSchema = [1, n0, _EPL,
  0, () => EventParameters$
];
var EventTrackers: StaticListSchema = [1, n0, _ETv,
  0, () => EventTrackerSummary$
];
var Filters: StaticListSchema = [1, n0, _Fi,
  0, () => FilterSummary$
];
var IntegerHyperParameterRanges: StaticListSchema = [1, n0, _IHPRn,
  0, () => IntegerHyperParameterRange$
];
var MetricAttributes: StaticListSchema = [1, n0, _MAet,
  0, () => MetricAttribute$
];
var MetricAttributesNamesList = 64 | 0;
var MetricAttributions: StaticListSchema = [1, n0, _MAetr,
  0, () => MetricAttributionSummary$
];
var Recipes: StaticListSchema = [1, n0, _Rec,
  0, () => RecipeSummary$
];
var Recommenders: StaticListSchema = [1, n0, _Reco,
  0, () => RecommenderSummary$
];
var Schemas: StaticListSchema = [1, n0, _Sc,
  0, () => DatasetSchemaSummary$
];
var Solutions: StaticListSchema = [1, n0, _So,
  0, () => SolutionSummary$
];
var SolutionVersions: StaticListSchema = [1, n0, _SVo,
...
var ExcludedDatasetColumns: StaticMapSchema = [2, n0, _EDC,
  0, 0, 64 | 0
];
var FeatureTransformationParameters = 128 | 0;
var FeaturizationParameters = 128 | 0;
var HyperParameters = 128 | 0;
var IncludedDatasetColumns: StaticMapSchema = [2, n0, _IDC,
  0, 0, 64 | 0
];
var Metrics = 128 | 1;
var RankingInfluence = 128 | 1;
var ResourceConfig = 128 | 0;
export var CreateBatchInferenceJob$: StaticOperationSchema = [9, n0, _CBIJ,
  0, () => CreateBatchInferenceJobRequest$, () => CreateBatchInferenceJobResponse$
];
export var CreateBatchSegmentJob$: StaticOperationSchema = [9, n0, _CBSJ,
...
export var CreateDataDeletionJob$: StaticOperationSchema = [9, n0, _CDDJ,
...
export var CreateEventTracker$: StaticOperationSchema = [9, n0, _CET,
...
export var CreateMetricAttribution$: StaticOperationSchema = [9, n0, _CMA,
  0, () => CreateMetricAttributionRequest$, () => CreateMetricAttributionResponse$
];
export var CreateRecommender$: StaticOperationSchema = [9, n0, _CR,
  2, () => CreateRecommenderRequest$, () => CreateRecommenderResponse$
];
export var CreateSchema$: StaticOperationSchema = [9, n0, _CSr,
  2, () => CreateSchemaRequest$, () => CreateSchemaResponse$
];
export var CreateSolution$: StaticOperationSchema = [9, n0, _CSre,
  0, () => CreateSolutionRequest$, () => CreateSolutionResponse$
];
export var CreateSolutionVersion$: StaticOperationSchema = [9, n0, _CSV,
...
export var DeleteEventTracker$: StaticOperationSchema = [9, n0, _DET,
  2, () => DeleteEventTrackerRequest$, () => __Unit
];
export var DeleteFilter$: StaticOperationSchema = [9, n0, _DF,
  0, () => DeleteFilterRequest$, () => __Unit
];
export var DeleteMetricAttribution$: StaticOperationSchema = [9, n0, _DMA,
...
export var DeleteSolution$: StaticOperationSchema = [9, n0, _DSel,
  2, () => DeleteSolutionRequest$, () => __Unit
];
export var DescribeAlgorithm$: StaticOperationSchema = [9, n0, _DA,
  2, () => DescribeAlgorithmRequest$, () => DescribeAlgorithmResponse$
];
export var DescribeBatchInferenceJob$: StaticOperationSchema = [9, n0, _DBIJ,
  2, () => DescribeBatchInferenceJobRequest$, () => DescribeBatchInferenceJobResponse$
];
export var DescribeBatchSegmentJob$: StaticOperationSchema = [9, n0, _DBSJ,
...
export var DescribeDataDeletionJob$: StaticOperationSchema = [9, n0, _DDDJ,
...
export var DescribeDatasetImportJob$: StaticOperationSchema = [9, n0, _DDIJ,
  2, () => DescribeDatasetImportJobRequest$, () => DescribeDatasetImportJobResponse$
];
export var DescribeEventTracker$: StaticOperationSchema = [9, n0, _DETe,
  2, () => DescribeEventTrackerRequest$, () => DescribeEventTrackerResponse$
];
export var DescribeFeatureTransformation$: StaticOperationSchema = [9, n0, _DFT,
  2, () => DescribeFeatureTransformationRequest$, () => DescribeFeatureTransformationResponse$
];
export var DescribeFilter$: StaticOperationSchema = [9, n0, _DFe,
  2, () => DescribeFilterRequest$, () => DescribeFilterResponse$
];
export var DescribeMetricAttribution$: StaticOperationSchema = [9, n0, _DMAe,
  0, () => DescribeMetricAttributionRequest$, () => DescribeMetricAttributionResponse$
];
export var DescribeRecipe$: StaticOperationSchema = [9, n0, _DRe,
  2, () => DescribeRecipeRequest$, () => DescribeRecipeResponse$
];
export var DescribeRecommender$: StaticOperationSchema = [9, n0, _DRes,
...
export var DescribeSolution$: StaticOperationSchema = [9, n0, _DSesc,
  2, () => DescribeSolutionRequest$, () => DescribeSolutionResponse$
];
export var DescribeSolutionVersion$: StaticOperationSchema = [9, n0, _DSV,
  2, () => DescribeSolutionVersionRequest$, () => DescribeSolutionVersionResponse$
];
export var GetSolutionMetrics$: StaticOperationSchema = [9, n0, _GSM,
  0, () => GetSolutionMetricsRequest$, () => GetSolutionMetricsResponse$
];
export var ListBatchInferenceJobs$: StaticOperationSchema = [9, n0, _LBIJ,
  2, () => ListBatchInferenceJobsRequest$, () => ListBatchInferenceJobsResponse$
];
export var ListBatchSegmentJobs$: StaticOperationSchema = [9, n0, _LBSJ,
...
export var ListDataDeletionJobs$: StaticOperationSchema = [9, n0, _LDDJ,
...
export var ListEventTrackers$: StaticOperationSchema = [9, n0, _LET,
...
export var ListMetricAttributionMetrics$: StaticOperationSchema = [9, n0, _LMAM,
  2, () => ListMetricAttributionMetricsRequest$, () => ListMetricAttributionMetricsResponse$
];
export var ListMetricAttributions$: StaticOperationSchema = [9, n0, _LMA,
  2, () => ListMetricAttributionsRequest$, () => ListMetricAttributionsResponse$
];
export var ListRecipes$: StaticOperationSchema = [9, n0, _LR,
  2, () => ListRecipesRequest$, () => ListRecipesResponse$
];
export var ListRecommenders$: StaticOperationSchema = [9, n0, _LRi,
...
export var ListSolutions$: StaticOperationSchema = [9, n0, _LSi,
  2, () => ListSolutionsRequest$, () => ListSolutionsResponse$
];
export var ListSolutionVersions$: StaticOperationSchema = [9, n0, _LSV,
  2, () => ListSolutionVersionsRequest$, () => ListSolutionVersionsResponse$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceRequest$, () => ListTagsForResourceResponse$
];
export var StartRecommender$: StaticOperationSchema = [9, n0, _SR,
  2, () => StartRecommenderRequest$, () => StartRecommenderResponse$
];
export var StopRecommender$: StaticOperationSchema = [9, n0, _SRt,
  2, () => StopRecommenderRequest$, () => StopRecommenderResponse$
];
export var StopSolutionVersionCreation$: StaticOperationSchema = [9, n0, _SSVC,
...
export var UpdateMetricAttribution$: StaticOperationSchema = [9, n0, _UMA,
...
export var UpdateSolution$: StaticOperationSchema = [9, n0, _US,
