...
import {
  type MigrationHubRefactorSpacesClientResolvedConfig,
...
function createAwsAuthSigv4HttpAuthOption(authParameters: MigrationHubRefactorSpacesHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultMigrationHubRefactorSpacesHttpAuthSchemeProvider: MigrationHubRefactorSpacesHttpAuthSchemeProvider = (authParameters) => {
