...
import type { GetRouteRequest, GetRouteResponse } from "../models/models_0";
import { GetRoute$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetRouteCommand extends command<GetRouteCommandInput, GetRouteCommandOutput>(
  _ep0,
  _mw0,
  "GetRoute",
  GetRoute$
