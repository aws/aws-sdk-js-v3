...
export type StartLifecyclePolicyPreviewCommandOutput = StartLifecyclePolicyPreviewResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1StartLifecyclePolicyPreviewCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1StartLifecyclePolicyPreviewCommand(
      output,
      context
    );
  }
