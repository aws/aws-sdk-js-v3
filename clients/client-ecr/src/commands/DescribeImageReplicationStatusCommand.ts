 ...
 * @public
 */
export class DescribeImageReplicationStatusCommand extends command<DescribeImageReplicationStatusCommandInput, DescribeImageReplicationStatusCommandOutput>(
  _ep0,
  _mw0,
