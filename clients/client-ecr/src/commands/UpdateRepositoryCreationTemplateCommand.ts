 ...
 * @public
 */
export class UpdateRepositoryCreationTemplateCommand extends command<UpdateRepositoryCreationTemplateCommandInput, UpdateRepositoryCreationTemplateCommandOutput>(
  _ep0,
  _mw0,
