 ...
 * @public
 */
export class PutRegistryScanningConfigurationCommand extends command<PutRegistryScanningConfigurationCommandInput, PutRegistryScanningConfigurationCommandOutput>(
  _ep0,
  _mw0,
