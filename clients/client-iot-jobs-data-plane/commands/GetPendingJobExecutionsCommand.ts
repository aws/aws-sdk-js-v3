...
export type GetPendingJobExecutionsCommandOutput = GetPendingJobExecutionsResponse;

export class GetPendingJobExecutionsCommand extends $Command<GetPendingJobExecutionsCommandInput, GetPendingJobExecutionsCommandOutput, IoTJobsDataPlaneClientResolvedConfig> {
