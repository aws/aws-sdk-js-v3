...
import { type IoTJobsDataPlaneClientResolvedConfig, IoTJobsDataPlaneClientConfig } from "../IoTJobsDataPlaneClient";
 ...
 * @internal
 */
export const defaultIoTJobsDataPlaneHttpAuthSchemeProvider: IoTJobsDataPlaneHttpAuthSchemeProvider = (authParameters) => {
