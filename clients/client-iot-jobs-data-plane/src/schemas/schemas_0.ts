...
export var JobExecutionState$: StaticStructureSchema = [3, n0, _JES,
  0,
  [_st, _sD, _vN],
  [0, 128 | 0, 1]
];
export var JobExecutionSummary$: StaticStructureSchema = [3, n0, _JESo,
  0,
...
export var DescribeJobExecution$: StaticOperationSchema = [9, n0, _DJE,
  { [_h]: ["GET", "/things/{thingName}/jobs/{jobId}", 200] }, () => DescribeJobExecutionRequest$, () => DescribeJobExecutionResponse$
];
export var GetPendingJobExecutions$: StaticOperationSchema = [9, n0, _GPJE,
...
export var StartNextPendingJobExecution$: StaticOperationSchema = [9, n0, _SNPJE,
  { [_h]: ["PUT", "/things/{thingName}/jobs/$next", 200] }, () => StartNextPendingJobExecutionRequest$, () => StartNextPendingJobExecutionResponse$
];
export var UpdateJobExecution$: StaticOperationSchema = [9, n0, _UJE,
