...
import {
  ...
  defaultIoTJobsDataPlaneHttpAuthSchemeParametersProvider,
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<IoTJobsDataPlaneClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultIoTJobsDataPlaneHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: IoTJobsDataPlaneClientResolvedConfig) =>
