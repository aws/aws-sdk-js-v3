...
export type ListGitHubAccountTokenNamesCommandOutput = ListGitHubAccountTokenNamesOutput &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1ListGitHubAccountTokenNamesCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1ListGitHubAccountTokenNamesCommand(
      output,
      context
    );
  }
