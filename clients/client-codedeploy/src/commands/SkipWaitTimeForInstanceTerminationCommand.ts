 ...
 * @public
 */
export class SkipWaitTimeForInstanceTerminationCommand extends command<SkipWaitTimeForInstanceTerminationCommandInput, SkipWaitTimeForInstanceTerminationCommandOutput>(
  _ep0,
  _mw0,
