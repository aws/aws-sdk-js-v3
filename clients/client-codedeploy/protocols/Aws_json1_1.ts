...
export const serializeAws_json1_1PutLifecycleEventHookExecutionStatusCommand = async (
  ...
  let body: any;
  body = JSON.stringify(
    serializeAws_json1_1PutLifecycleEventHookExecutionStatusInput(input, context)
  );
  return buildHttpRpcRequest(context, headers, "/", undefined, body);
};
...
const deserializeAws_json1_1DeleteGitHubAccountTokenOutput = (
  ...
  return {
    __type: "DeleteGitHubAccountTokenOutput",
    tokenName:
      output.tokenName !== undefined && output.tokenName !== null ? output.tokenName : undefined
  } as any;
};
...
const deserializeAws_json1_1Diagnostics = (output: any, context: __SerdeContext): Diagnostics => {
  return {
    ...
    message: output.message !== undefined && output.message !== null ? output.message : undefined,
    scriptName:
      output.scriptName !== undefined && output.scriptName !== null ? output.scriptName : undefined
  } as any;
};
  ...
  return {
    ...
    desiredCount:
      output.desiredCount !== undefined && output.desiredCount !== null
        ...
        : undefined,
    identifer:
      output.identifer !== undefined && output.identifer !== null ? output.identifer : undefined,
    pendingCount:
...
const deserializeAws_json1_1S3Location = (output: any, context: __SerdeContext): S3Location => {
  return {
    ...
    bundleType:
      output.bundleType !== undefined && output.bundleType !== null ? output.bundleType : undefined,
