...
const deserializeAws_json1_1CreateDeploymentGroupOutput = (
  ...
  return {
    __type: "CreateDeploymentGroupOutput",
    deploymentGroupId:
      output.deploymentGroupId !== undefined && output.deploymentGroupId !== null ? output.deploymentGroupId : undefined
  } as any;
};
...
const deserializeAws_json1_1DeploymentReadyOption = (output: any, context: __SerdeContext): DeploymentReadyOption => {
  return {
    ...
    waitTimeInMinutes:
      output.waitTimeInMinutes !== undefined && output.waitTimeInMinutes !== null ? output.waitTimeInMinutes : undefined
  } as any;
};
