...
import { type SecurityAgentClientResolvedConfig, SecurityAgentClientConfig } from "../SecurityAgentClient";
 ...
 * @internal
 */
export const defaultSecurityAgentHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SecurityAgentHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<SecurityAgentClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultSecurityAgentHttpAuthSchemeProvider: SecurityAgentHttpAuthSchemeProvider = (authParameters) => {
