 ...
 * @public
 */
export class BatchCreateSecurityRequirementsCommand extends command<BatchCreateSecurityRequirementsCommandInput, BatchCreateSecurityRequirementsCommandOutput>(
  _ep0,
  _mw0,
