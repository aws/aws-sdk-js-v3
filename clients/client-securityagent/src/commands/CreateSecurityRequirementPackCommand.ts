 ...
 * @public
 */
export class CreateSecurityRequirementPackCommand extends command<CreateSecurityRequirementPackCommandInput, CreateSecurityRequirementPackCommandOutput>(
  _ep0,
  _mw0,
