...
import type { UpdateGroupProfileInput, UpdateGroupProfileOutput } from "../models/models_2";
 ...
 * @public
 */
export class UpdateGroupProfileCommand extends command<UpdateGroupProfileCommandInput, UpdateGroupProfileCommandOutput>(
  _ep0,
  _mw0,
  "UpdateGroupProfile",
  UpdateGroupProfile$
