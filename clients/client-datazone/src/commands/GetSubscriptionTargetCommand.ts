...
import type { GetSubscriptionTargetInput, GetSubscriptionTargetOutput } from "../models/models_1";
import { GetSubscriptionTarget$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetSubscriptionTargetCommand extends command<GetSubscriptionTargetCommandInput, GetSubscriptionTargetCommandOutput>(
  _ep0,
  _mw0,
