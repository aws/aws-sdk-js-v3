...
import { AcceptSubscriptionRequest$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class AcceptSubscriptionRequestCommand extends command<AcceptSubscriptionRequestCommandInput, AcceptSubscriptionRequestCommandOutput>(
  _ep0,
  _mw0,
