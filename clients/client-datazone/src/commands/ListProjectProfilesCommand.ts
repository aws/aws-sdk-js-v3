...
import type { ListProjectProfilesInput, ListProjectProfilesOutput } from "../models/models_1";
 ...
 * @public
 */
export class ListProjectProfilesCommand extends command<ListProjectProfilesCommandInput, ListProjectProfilesCommandOutput>(
  _ep0,
  _mw0,
  "ListProjectProfiles",
  ListProjectProfiles$
