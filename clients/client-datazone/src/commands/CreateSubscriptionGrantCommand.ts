...
import type { CreateSubscriptionGrantInput, CreateSubscriptionGrantOutput } from "../models/models_1";
 ...
 * @public
 */
export class CreateSubscriptionGrantCommand extends command<CreateSubscriptionGrantCommandInput, CreateSubscriptionGrantCommandOutput>(
  _ep0,
  _mw0,
