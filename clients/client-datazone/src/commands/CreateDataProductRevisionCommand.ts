...
import { CreateDataProductRevision$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CreateDataProductRevisionCommand extends command<CreateDataProductRevisionCommandInput, CreateDataProductRevisionCommandOutput>(
  _ep0,
  _mw0,
