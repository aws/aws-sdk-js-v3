...
import type { UpdateAssetFilterInput, UpdateAssetFilterOutput } from "../models/models_2";
 ...
 * @public
 */
export class UpdateAssetFilterCommand extends command<UpdateAssetFilterCommandInput, UpdateAssetFilterCommandOutput>(
  _ep0,
  _mw0,
  "UpdateAssetFilter",
  UpdateAssetFilter$
