...
import type { UpdateAccountPoolInput, UpdateAccountPoolOutput } from "../models/models_2";
 ...
 * @public
 */
export class UpdateAccountPoolCommand extends command<UpdateAccountPoolCommandInput, UpdateAccountPoolCommandOutput>(
  _ep0,
  _mw0,
  "UpdateAccountPool",
  UpdateAccountPool$
