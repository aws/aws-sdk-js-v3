...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteSubscriptionGrantCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<DeleteSubscriptionGrantCommandInput, DeleteSubscriptionGrantCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteSubscriptionGrantCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "DeleteSubscriptionGrantCommand";
   ...
   * @internal
   */
  private serialize(input: DeleteSubscriptionGrantCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_DeleteSubscriptionGrantCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<DeleteSubscriptionGrantCommandOutput> {
    return de_DeleteSubscriptionGrantCommand(output, context);
  }
