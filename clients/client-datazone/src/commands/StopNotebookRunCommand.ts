...
import type { StopNotebookRunInput, StopNotebookRunOutput } from "../models/models_2";
 ...
 * @public
 */
export class StopNotebookRunCommand extends command<StopNotebookRunCommandInput, StopNotebookRunCommandOutput>(
  _ep0,
  _mw0,
  "StopNotebookRun",
  StopNotebookRun$
