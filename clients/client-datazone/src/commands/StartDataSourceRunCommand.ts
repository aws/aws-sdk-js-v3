...
import type { StartDataSourceRunInput, StartDataSourceRunOutput } from "../models/models_1";
 ...
 * @public
 */
export class StartDataSourceRunCommand extends command<StartDataSourceRunCommandInput, StartDataSourceRunCommandOutput>(
  _ep0,
  _mw0,
  "StartDataSourceRun",
  StartDataSourceRun$
