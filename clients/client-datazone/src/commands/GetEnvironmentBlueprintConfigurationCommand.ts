 ...
 * @public
 */
export class GetEnvironmentBlueprintConfigurationCommand extends command<GetEnvironmentBlueprintConfigurationCommandInput, GetEnvironmentBlueprintConfigurationCommandOutput>(
  _ep0,
  _mw0,
