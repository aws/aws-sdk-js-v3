 ...
 * @public
 */
export class UpdateSubscriptionGrantStatusCommand extends command<UpdateSubscriptionGrantStatusCommandInput, UpdateSubscriptionGrantStatusCommandOutput>(
  _ep0,
  _mw0,
