...
import { CreateProjectMembership$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CreateProjectMembershipCommand extends command<CreateProjectMembershipCommandInput, CreateProjectMembershipCommandOutput>(
  _ep0,
  _mw0,
