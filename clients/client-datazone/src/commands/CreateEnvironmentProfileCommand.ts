...
import { CreateEnvironmentProfile$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CreateEnvironmentProfileCommand extends command<CreateEnvironmentProfileCommandInput, CreateEnvironmentProfileCommandOutput>(
  _ep0,
  _mw0,
