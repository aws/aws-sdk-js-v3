 ...
 * @public
 */
export class PutEnvironmentBlueprintConfigurationCommand extends command<PutEnvironmentBlueprintConfigurationCommandInput, PutEnvironmentBlueprintConfigurationCommandOutput>(
  _ep0,
  _mw0,
