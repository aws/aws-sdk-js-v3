...
import type { ListPolicyGrantsInput, ListPolicyGrantsOutput } from "../models/models_1";
 ...
 * @public
 */
export class ListPolicyGrantsCommand extends command<ListPolicyGrantsCommandInput, ListPolicyGrantsCommandOutput>(
  _ep0,
  _mw0,
  "ListPolicyGrants",
  ListPolicyGrants$
