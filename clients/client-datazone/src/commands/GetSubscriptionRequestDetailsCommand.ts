 ...
 * @public
 */
export class GetSubscriptionRequestDetailsCommand extends command<GetSubscriptionRequestDetailsCommandInput, GetSubscriptionRequestDetailsCommandOutput>(
  _ep0,
  _mw0,
