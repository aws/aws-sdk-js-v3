...
import { DeleteEnvironmentAction$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteEnvironmentActionCommand extends command<DeleteEnvironmentActionCommandInput, DeleteEnvironmentActionCommandOutput>(
  _ep0,
  _mw0,
