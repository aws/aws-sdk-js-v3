...
import type { GetTimeSeriesDataPointInput, GetTimeSeriesDataPointOutput } from "../models/models_1";
import { GetTimeSeriesDataPoint$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetTimeSeriesDataPointCommand extends command<GetTimeSeriesDataPointCommandInput, GetTimeSeriesDataPointCommandOutput>(
  _ep0,
  _mw0,
