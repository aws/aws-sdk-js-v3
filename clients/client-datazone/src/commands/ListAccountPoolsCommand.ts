...
import type { ListAccountPoolsInput, ListAccountPoolsOutput } from "../models/models_1";
 ...
 * @public
 */
export class ListAccountPoolsCommand extends command<ListAccountPoolsCommandInput, ListAccountPoolsCommandOutput>(
  _ep0,
  _mw0,
  "ListAccountPools",
  ListAccountPools$
