...
import type { ListLineageEventsInput, ListLineageEventsOutput } from "../models/models_1";
 ...
 * @public
 */
export class ListLineageEventsCommand extends command<ListLineageEventsCommandInput, ListLineageEventsCommandOutput>(
  _ep0,
  _mw0,
  "ListLineageEvents",
  ListLineageEvents$
