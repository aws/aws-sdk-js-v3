...
> {
   ...
   * @public
   */
  constructor(readonly input: CancelSubscriptionCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<CancelSubscriptionCommandInput, CancelSubscriptionCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, CancelSubscriptionCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "CancelSubscriptionCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      logger,
      clientName,
      commandName,
      inputFilterSensitiveLog: (_: any) => _,
      outputFilterSensitiveLog: CancelSubscriptionOutputFilterSensitiveLog,
      [SMITHY_CONTEXT_KEY]: {
        service: "DataZone",
   ...
   * @internal
   */
  private serialize(input: CancelSubscriptionCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_CancelSubscriptionCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<CancelSubscriptionCommandOutput> {
    return de_CancelSubscriptionCommand(output, context);
  }
