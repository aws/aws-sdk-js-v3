...
import { CreateAssetFilter$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CreateAssetFilterCommand extends command<CreateAssetFilterCommandInput, CreateAssetFilterCommandOutput>(
  _ep0,
  _mw0,
  "CreateAssetFilter",
  CreateAssetFilter$
