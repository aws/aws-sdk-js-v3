...
const makePagedClientRequest = async (
  ...
  // @ts-ignore
  return await client.send(new ListAssetRevisionsCommand(input), ...args);
};
/**
 * @public
 */
export async function* paginateListAssetRevisions(
  ...
  let hasNext = true;
  let page: ListAssetRevisionsCommandOutput;
  while (hasNext) {
