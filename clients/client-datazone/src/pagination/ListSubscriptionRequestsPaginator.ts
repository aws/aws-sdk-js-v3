...
const makePagedClientRequest = async (
  ...
  // @ts-ignore
  return await client.send(new ListSubscriptionRequestsCommand(input), ...args);
};
/**
 * @public
 */
export async function* paginateListSubscriptionRequests(
  ...
  let hasNext = true;
  let page: ListSubscriptionRequestsCommandOutput;
  while (hasNext) {
