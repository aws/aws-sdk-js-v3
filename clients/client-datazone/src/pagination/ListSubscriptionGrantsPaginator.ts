...
const makePagedClientRequest = async (
  ...
  // @ts-ignore
  return await client.send(new ListSubscriptionGrantsCommand(input), ...args);
};
/**
 * @public
 */
export async function* paginateListSubscriptionGrants(
  ...
  let hasNext = true;
  let page: ListSubscriptionGrantsCommandOutput;
  while (hasNext) {
