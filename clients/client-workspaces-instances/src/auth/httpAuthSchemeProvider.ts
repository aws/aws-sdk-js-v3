...
import {
  type WorkspacesInstancesClientResolvedConfig,
  WorkspacesInstancesClientConfig,
 ...
 * @internal
 */
export const defaultWorkspacesInstancesHttpAuthSchemeProvider: WorkspacesInstancesHttpAuthSchemeProvider = (authParameters) => {
