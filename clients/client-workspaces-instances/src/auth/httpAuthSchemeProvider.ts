...
import { WorkspacesInstancesClientConfig, WorkspacesInstancesClientResolvedConfig } from "../WorkspacesInstancesClient";
 ...
 * @internal
 */
export const defaultWorkspacesInstancesHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: WorkspacesInstancesHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<WorkspacesInstancesClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultWorkspacesInstancesHttpAuthSchemeProvider: WorkspacesInstancesHttpAuthSchemeProvider = (
  authParameters
) => {
