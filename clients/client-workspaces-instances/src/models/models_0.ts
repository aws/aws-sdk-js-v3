 ...
 * @internal
 */
export const BlockDeviceMappingRequestFilterSensitiveLog = (obj: BlockDeviceMappingRequest): any => ({
  ...obj,
 ...
 * @internal
 */
export const ManagedInstanceRequestFilterSensitiveLog = (obj: ManagedInstanceRequest): any => ({
  ...obj,
  ...
  ...(obj.NetworkInterfaces && {
    NetworkInterfaces: obj.NetworkInterfaces.map((item) =>
      InstanceNetworkInterfaceSpecificationFilterSensitiveLog(item)
    ),
  }),
  ...(obj.PrivateIpAddress && { PrivateIpAddress: SENSITIVE_STRING }),
 ...
 * @internal
 */
export const CreateWorkspaceInstanceRequestFilterSensitiveLog = (obj: CreateWorkspaceInstanceRequest): any => ({
  ...obj,
  ...(obj.ClientToken && { ClientToken: SENSITIVE_STRING }),
 ...
 * @internal
 */
export const ListInstanceTypesRequestFilterSensitiveLog = (obj: ListInstanceTypesRequest): any => ({
  ...obj,
 ...
 * @internal
 */
export const ListInstanceTypesResponseFilterSensitiveLog = (obj: ListInstanceTypesResponse): any => ({
  ...obj,
  ...(obj.NextToken && { NextToken: SENSITIVE_STRING }),
});
 ...
 * @internal
 */
export const ListWorkspaceInstancesRequestFilterSensitiveLog = (obj: ListWorkspaceInstancesRequest): any => ({
  ...obj,
  ...(obj.NextToken && { NextToken: SENSITIVE_STRING }),
});
 ...
 * @internal
 */
export const ListWorkspaceInstancesResponseFilterSensitiveLog = (obj: ListWorkspaceInstancesResponse): any => ({
  ...obj,
  ...(obj.NextToken && { NextToken: SENSITIVE_STRING }),
});
