 ...
 * @public
 */
export type WorkspacesInstancesClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type WorkspacesInstancesClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 */
export class WorkspacesInstancesClient extends __Client<
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<WorkspacesInstancesClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultWorkspacesInstancesHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: WorkspacesInstancesClientResolvedConfig) =>
