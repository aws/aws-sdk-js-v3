...
export var AttachedPolicy$: StaticStructureSchema = [3, n0, _AP,
  0,
  [_PN, _PA],
  [0, 0]
];
...
export var CreateAccessKeyRequest$: StaticStructureSchema = [3, n0, _CAKR,
  0,
  [_UN],
  [0]
];
...
export var DelegationRequest$: StaticStructureSchema = [3, n0, _DR,
  0,
...
export var DisableOrganizationsRootCredentialsManagementResponse$: StaticStructureSchema = [3, n0, _DORCMRi,
  0,
  [_OIr, _EF],
  [0, 64 | 0]
];
export var DisableOrganizationsRootSessionsRequest$: StaticStructureSchema = [3, n0, _DORSR,
  0,
  [],
  []
];
export var DisableOrganizationsRootSessionsResponse$: StaticStructureSchema = [3, n0, _DORSRi,
  0,
  [_OIr, _EF],
  [0, 64 | 0]
];
...
export var EnableOrganizationsRootCredentialsManagementResponse$: StaticStructureSchema = [3, n0, _EORCMRn,
  0,
  [_OIr, _EF],
  [0, 64 | 0]
];
export var EnableOrganizationsRootSessionsRequest$: StaticStructureSchema = [3, n0, _EORSR,
  0,
  [],
  []
];
export var EnableOrganizationsRootSessionsResponse$: StaticStructureSchema = [3, n0, _EORSRn,
  0,
  [_OIr, _EF],
  [0, 64 | 0]
];
export var EnableOutboundWebIdentityFederationResponse$: StaticStructureSchema = [3, n0, _EOWIFR,
  0,
  [_II],
  [0]
];
...
export var GetAccountAuthorizationDetailsRequest$: StaticStructureSchema = [3, n0, _GAADR,
  0,
  [_F, _MI, _Ma],
  [64 | 0, 1, 0]
];
export var GetAccountAuthorizationDetailsResponse$: StaticStructureSchema = [3, n0, _GAADRe,
  0,
...
export var ListDelegationRequestsRequest$: StaticStructureSchema = [3, n0, _LDRR,
  0,
  [_OI, _Ma, _MI],
  [0, 0, 1]
];
export var ListDelegationRequestsResponse$: StaticStructureSchema = [3, n0, _LDRRi,
  0,
  [_DRe, _Ma, _iT],
...
export var ListOpenIDConnectProvidersResponse$: StaticStructureSchema = [3, n0, _LOIDCPRi,
  0,
  [_OIDCPL],
...
export var ListOrganizationsFeaturesResponse$: StaticStructureSchema = [3, n0, _LOFRi,
  0,
  [_OIr, _EF],
  [0, 64 | 0]
];
export var ListPoliciesGrantingServiceAccessEntry$: StaticStructureSchema = [3, n0, _LPGSAE,
  0,
  [_SNe, _Pol],
...
export var ListSAMLProvidersResponse$: StaticStructureSchema = [3, n0, _LSAMLPRi,
  0,
  [_SAMLPL],
...
export var ListServiceSpecificCredentialsResponse$: StaticStructureSchema = [3, n0, _LSSCRi,
  0,
  [_SSCe, _Ma, _IT],
  [() => ServiceSpecificCredentialsListType, 0, 2]
];
export var ListSigningCertificatesRequest$: StaticStructureSchema = [3, n0, _LSCRis,
  0,
  [_UN, _Ma, _MI],
  [0, 0, 1]
];
...
export var ListSSHPublicKeysResponse$: StaticStructureSchema = [3, n0, _LSSHPKRi,
  0,
  [_SSHPKu, _IT, _Ma],
...
export var PolicyDetail$: StaticStructureSchema = [3, n0, _PDo,
  0,
  [_PN, _PD],
  [0, 0]
];
...
export var PolicyRole$: StaticStructureSchema = [3, n0, _PRo,
  0,
  [_RN, _RIo],
  [0, 0]
];
export var PolicyUser$: StaticStructureSchema = [3, n0, _PUo,
  0,
  [_UN, _UI],
  [0, 0]
];
export var PolicyVersion$: StaticStructureSchema = [3, n0, _PV,
  0,
  [_Do, _VI, _IDV, _CD],
  [0, 0, 2, 4]
];
export var Position$: StaticStructureSchema = [3, n0, _Pos,
  0,
  [_Li, _Col],
  [1, 1]
];
...
export var RoleLastUsed$: StaticStructureSchema = [3, n0, _RLU,
  0,
  [_LUD, _R],
  [4, 0]
];
...
export var SAMLPrivateKey$: StaticStructureSchema = [3, n0, _SAMLPK,
  0,
  [_KI, _Ti],
  [0, 4]
];
export var SAMLProviderListEntry$: StaticStructureSchema = [3, n0, _SAMLPLE,
  0,
  [_A, _VU, _CD],
  [0, 4, 4]
];
...
var accessKeyMetadataListType: StaticListSchema = [1, n0, _aKMLT,
  0, () => AccessKeyMetadata$
];
var accountAliasListType = 64 | 0;
var ActionNameListType = 64 | 0;
var ArnListType = 64 | 0;
var attachedPoliciesListType: StaticListSchema = [1, n0, _aPLT,
  0, () => AttachedPolicy$
];
var certificateListType: StaticListSchema = [1, n0, _cLT,
  0, () => SigningCertificate$
];
var clientIDListType = 64 | 0;
var ContextEntryListType: StaticListSchema = [1, n0, _CELT,
  0, () => ContextEntry$
];
var ContextKeyNamesResultListType = 64 | 0;
var ContextKeyValueListType = 64 | 0;
var delegationRequestsListType: StaticListSchema = [1, n0, _dRLT,
  0, () => DelegationRequest$
];
var entityDetailsListType: StaticListSchema = [1, n0, _eDLT,
  0, () => EntityDetails$
];
var entityListType = 64 | 0;
var EvaluationResultsListType: StaticListSchema = [1, n0, _ERLT,
  0, () => EvaluationResult$
];
var FeaturesListType = 64 | 0;
var groupDetailListType: StaticListSchema = [1, n0, _gDLT,
  0, () => GroupDetail$
];
var groupListType: StaticListSchema = [1, n0, _gLT,
  0, () => Group$
];
...
var mfaDeviceListType: StaticListSchema = [1, n0, _mDLT,
  0, () => MFADevice$
];
...
var PolicyGroupListType: StaticListSchema = [1, n0, _PGLT,
  0, () => PolicyGroup$
];
var policyListType: StaticListSchema = [1, n0, _pLT,
  0, () => Policy$
];
var policyNameListType = 64 | 0;
var policyParameterListType: StaticListSchema = [1, n0, _pPLT,
  0, () => PolicyParameter$
];
var policyParameterValuesListType = 64 | 0;
var PolicyRoleListType: StaticListSchema = [1, n0, _PRLT,
  0, () => PolicyRole$
];
var PolicyUserListType: StaticListSchema = [1, n0, _PULT,
  0, () => PolicyUser$
];
...
var roleDetailListType: StaticListSchema = [1, n0, _rDLT,
  0, () => RoleDetail$
];
var roleListType: StaticListSchema = [1, n0, _rLT,
  0, () => Role$
];
var rolePermissionRestrictionArnListType = 64 | 0;
var RoleUsageListType: StaticListSchema = [1, n0, _RULT,
  0, () => RoleUsageType$
];
var SAMLProviderListType: StaticListSchema = [1, n0, _SAMLPLT,
  0, () => SAMLProviderListEntry$
];
var serverCertificateMetadataListType: StaticListSchema = [1, n0, _sCMLT,
  0, () => ServerCertificateMetadata$
];
var serviceNamespaceListType = 64 | 0;
var ServicesLastAccessed: StaticListSchema = [1, n0, _SLA,
  0, () => ServiceLastAccessed$
];
var ServiceSpecificCredentialsListType: StaticListSchema = [1, n0, _SSCLT,
  0, () => ServiceSpecificCredentialMetadata$
];
var SimulationPolicyListType = 64 | 0;
var SSHPublicKeyListType: StaticListSchema = [1, n0, _SSHPKLT,
  0, () => SSHPublicKeyMetadata$
];
var StatementListType: StaticListSchema = [1, n0, _SLT,
  0, () => Statement$
];
...
var userDetailListType: StaticListSchema = [1, n0, _uDLT,
  0, () => UserDetail$
];
var userListType: StaticListSchema = [1, n0, _uLT,
  0, () => User$
];
var virtualMFADeviceListType: StaticListSchema = [1, n0, _vMFADLT,
  0, [() => VirtualMFADevice$,
    0]
];
...
export var AddRoleToInstanceProfile$: StaticOperationSchema = [9, n0, _ARTIP,
  0, () => AddRoleToInstanceProfileRequest$, () => __Unit
];
export var AddUserToGroup$: StaticOperationSchema = [9, n0, _AUTG,
  0, () => AddUserToGroupRequest$, () => __Unit
];
export var AssociateDelegationRequest$: StaticOperationSchema = [9, n0, _ADRs,
  0, () => AssociateDelegationRequestRequest$, () => __Unit
];
export var AttachGroupPolicy$: StaticOperationSchema = [9, n0, _AGP,
  0, () => AttachGroupPolicyRequest$, () => __Unit
];
export var AttachRolePolicy$: StaticOperationSchema = [9, n0, _ARP,
  0, () => AttachRolePolicyRequest$, () => __Unit
];
export var AttachUserPolicy$: StaticOperationSchema = [9, n0, _AUP,
  0, () => AttachUserPolicyRequest$, () => __Unit
];
export var ChangePassword$: StaticOperationSchema = [9, n0, _CP,
  0, () => ChangePasswordRequest$, () => __Unit
];
export var CreateAccessKey$: StaticOperationSchema = [9, n0, _CAK,
  0, () => CreateAccessKeyRequest$, () => CreateAccessKeyResponse$
];
export var CreateAccountAlias$: StaticOperationSchema = [9, n0, _CAA,
  0, () => CreateAccountAliasRequest$, () => __Unit
];
export var CreateDelegationRequest$: StaticOperationSchema = [9, n0, _CDR,
...
export var CreateInstanceProfile$: StaticOperationSchema = [9, n0, _CIP,
  0, () => CreateInstanceProfileRequest$, () => CreateInstanceProfileResponse$
];
export var CreateLoginProfile$: StaticOperationSchema = [9, n0, _CLP,
  0, () => CreateLoginProfileRequest$, () => CreateLoginProfileResponse$
];
export var CreateOpenIDConnectProvider$: StaticOperationSchema = [9, n0, _COIDCP,
  0, () => CreateOpenIDConnectProviderRequest$, () => CreateOpenIDConnectProviderResponse$
];
export var CreatePolicy$: StaticOperationSchema = [9, n0, _CPr,
  0, () => CreatePolicyRequest$, () => CreatePolicyResponse$
];
export var CreatePolicyVersion$: StaticOperationSchema = [9, n0, _CPV,
  0, () => CreatePolicyVersionRequest$, () => CreatePolicyVersionResponse$
];
export var CreateRole$: StaticOperationSchema = [9, n0, _CR,
  0, () => CreateRoleRequest$, () => CreateRoleResponse$
];
export var CreateSAMLProvider$: StaticOperationSchema = [9, n0, _CSAMLP,
  0, () => CreateSAMLProviderRequest$, () => CreateSAMLProviderResponse$
];
export var CreateServiceLinkedRole$: StaticOperationSchema = [9, n0, _CSLR,
  0, () => CreateServiceLinkedRoleRequest$, () => CreateServiceLinkedRoleResponse$
];
export var CreateServiceSpecificCredential$: StaticOperationSchema = [9, n0, _CSSC,
...
export var CreateVirtualMFADevice$: StaticOperationSchema = [9, n0, _CVMFAD,
  0, () => CreateVirtualMFADeviceRequest$, () => CreateVirtualMFADeviceResponse$
];
export var DeactivateMFADevice$: StaticOperationSchema = [9, n0, _DMFAD,
  0, () => DeactivateMFADeviceRequest$, () => __Unit
];
export var DeleteAccessKey$: StaticOperationSchema = [9, n0, _DAK,
  0, () => DeleteAccessKeyRequest$, () => __Unit
];
export var DeleteAccountAlias$: StaticOperationSchema = [9, n0, _DAA,
  0, () => DeleteAccountAliasRequest$, () => __Unit
];
export var DeleteAccountPasswordPolicy$: StaticOperationSchema = [9, n0, _DAPP,
  0, () => __Unit, () => __Unit
];
export var DeleteGroup$: StaticOperationSchema = [9, n0, _DG,
  0, () => DeleteGroupRequest$, () => __Unit
];
export var DeleteGroupPolicy$: StaticOperationSchema = [9, n0, _DGP,
  0, () => DeleteGroupPolicyRequest$, () => __Unit
];
export var DeleteInstanceProfile$: StaticOperationSchema = [9, n0, _DIP,
  0, () => DeleteInstanceProfileRequest$, () => __Unit
];
export var DeleteLoginProfile$: StaticOperationSchema = [9, n0, _DLP,
  0, () => DeleteLoginProfileRequest$, () => __Unit
];
export var DeleteOpenIDConnectProvider$: StaticOperationSchema = [9, n0, _DOIDCP,
...
export var DeletePolicyVersion$: StaticOperationSchema = [9, n0, _DPV,
  0, () => DeletePolicyVersionRequest$, () => __Unit
];
export var DeleteRole$: StaticOperationSchema = [9, n0, _DRel,
  0, () => DeleteRoleRequest$, () => __Unit
];
export var DeleteRolePermissionsBoundary$: StaticOperationSchema = [9, n0, _DRPB,
  0, () => DeleteRolePermissionsBoundaryRequest$, () => __Unit
];
export var DeleteRolePolicy$: StaticOperationSchema = [9, n0, _DRP,
  0, () => DeleteRolePolicyRequest$, () => __Unit
];
export var DeleteSAMLProvider$: StaticOperationSchema = [9, n0, _DSAMLP,
  0, () => DeleteSAMLProviderRequest$, () => __Unit
];
export var DeleteServerCertificate$: StaticOperationSchema = [9, n0, _DSC,
  0, () => DeleteServerCertificateRequest$, () => __Unit
];
export var DeleteServiceLinkedRole$: StaticOperationSchema = [9, n0, _DSLR,
  0, () => DeleteServiceLinkedRoleRequest$, () => DeleteServiceLinkedRoleResponse$
];
export var DeleteServiceSpecificCredential$: StaticOperationSchema = [9, n0, _DSSC,
  0, () => DeleteServiceSpecificCredentialRequest$, () => __Unit
];
export var DeleteSigningCertificate$: StaticOperationSchema = [9, n0, _DSCe,
  0, () => DeleteSigningCertificateRequest$, () => __Unit
];
export var DeleteSSHPublicKey$: StaticOperationSchema = [9, n0, _DSSHPK,
  0, () => DeleteSSHPublicKeyRequest$, () => __Unit
];
export var DeleteUser$: StaticOperationSchema = [9, n0, _DU,
  0, () => DeleteUserRequest$, () => __Unit
];
export var DeleteUserPermissionsBoundary$: StaticOperationSchema = [9, n0, _DUPB,
  0, () => DeleteUserPermissionsBoundaryRequest$, () => __Unit
];
export var DeleteUserPolicy$: StaticOperationSchema = [9, n0, _DUP,
  0, () => DeleteUserPolicyRequest$, () => __Unit
];
export var DeleteVirtualMFADevice$: StaticOperationSchema = [9, n0, _DVMFAD,
  0, () => DeleteVirtualMFADeviceRequest$, () => __Unit
];
export var DetachGroupPolicy$: StaticOperationSchema = [9, n0, _DGPe,
  0, () => DetachGroupPolicyRequest$, () => __Unit
];
export var DetachRolePolicy$: StaticOperationSchema = [9, n0, _DRPe,
  0, () => DetachRolePolicyRequest$, () => __Unit
];
export var DetachUserPolicy$: StaticOperationSchema = [9, n0, _DUPe,
  0, () => DetachUserPolicyRequest$, () => __Unit
];
export var DisableOrganizationsRootCredentialsManagement$: StaticOperationSchema = [9, n0, _DORCM,
  0, () => DisableOrganizationsRootCredentialsManagementRequest$, () => DisableOrganizationsRootCredentialsManagementResponse$
];
export var DisableOrganizationsRootSessions$: StaticOperationSchema = [9, n0, _DORS,
  0, () => DisableOrganizationsRootSessionsRequest$, () => DisableOrganizationsRootSessionsResponse$
];
export var DisableOutboundWebIdentityFederation$: StaticOperationSchema = [9, n0, _DOWIF,
  0, () => __Unit, () => __Unit
];
export var EnableMFADevice$: StaticOperationSchema = [9, n0, _EMFAD,
  0, () => EnableMFADeviceRequest$, () => __Unit
];
export var EnableOrganizationsRootCredentialsManagement$: StaticOperationSchema = [9, n0, _EORCM,
  0, () => EnableOrganizationsRootCredentialsManagementRequest$, () => EnableOrganizationsRootCredentialsManagementResponse$
];
export var EnableOrganizationsRootSessions$: StaticOperationSchema = [9, n0, _EORS,
  0, () => EnableOrganizationsRootSessionsRequest$, () => EnableOrganizationsRootSessionsResponse$
];
export var EnableOutboundWebIdentityFederation$: StaticOperationSchema = [9, n0, _EOWIF,
  0, () => __Unit, () => EnableOutboundWebIdentityFederationResponse$
];
export var GenerateCredentialReport$: StaticOperationSchema = [9, n0, _GCR,
  0, () => __Unit, () => GenerateCredentialReportResponse$
];
export var GenerateOrganizationsAccessReport$: StaticOperationSchema = [9, n0, _GOAR,
  0, () => GenerateOrganizationsAccessReportRequest$, () => GenerateOrganizationsAccessReportResponse$
];
export var GenerateServiceLastAccessedDetails$: StaticOperationSchema = [9, n0, _GSLAD,
  0, () => GenerateServiceLastAccessedDetailsRequest$, () => GenerateServiceLastAccessedDetailsResponse$
];
export var GetAccessKeyLastUsed$: StaticOperationSchema = [9, n0, _GAKLU,
  0, () => GetAccessKeyLastUsedRequest$, () => GetAccessKeyLastUsedResponse$
];
export var GetAccountAuthorizationDetails$: StaticOperationSchema = [9, n0, _GAAD,
...
export var GetContextKeysForCustomPolicy$: StaticOperationSchema = [9, n0, _GCKFCP,
  0, () => GetContextKeysForCustomPolicyRequest$, () => GetContextKeysForPolicyResponse$
];
export var GetContextKeysForPrincipalPolicy$: StaticOperationSchema = [9, n0, _GCKFPP,
  0, () => GetContextKeysForPrincipalPolicyRequest$, () => GetContextKeysForPolicyResponse$
];
export var GetCredentialReport$: StaticOperationSchema = [9, n0, _GCRe,
  0, () => __Unit, () => GetCredentialReportResponse$
];
export var GetDelegationRequest$: StaticOperationSchema = [9, n0, _GDR,
...
export var GetGroupPolicy$: StaticOperationSchema = [9, n0, _GGP,
  0, () => GetGroupPolicyRequest$, () => GetGroupPolicyResponse$
];
export var GetHumanReadableSummary$: StaticOperationSchema = [9, n0, _GHRS,
  0, () => GetHumanReadableSummaryRequest$, () => GetHumanReadableSummaryResponse$
];
export var GetInstanceProfile$: StaticOperationSchema = [9, n0, _GIP,
  0, () => GetInstanceProfileRequest$, () => GetInstanceProfileResponse$
];
export var GetLoginProfile$: StaticOperationSchema = [9, n0, _GLP,
  0, () => GetLoginProfileRequest$, () => GetLoginProfileResponse$
];
export var GetMFADevice$: StaticOperationSchema = [9, n0, _GMFAD,
  0, () => GetMFADeviceRequest$, () => GetMFADeviceResponse$
];
export var GetOpenIDConnectProvider$: StaticOperationSchema = [9, n0, _GOIDCP,
  0, () => GetOpenIDConnectProviderRequest$, () => GetOpenIDConnectProviderResponse$
];
export var GetOrganizationsAccessReport$: StaticOperationSchema = [9, n0, _GOARe,
  0, () => GetOrganizationsAccessReportRequest$, () => GetOrganizationsAccessReportResponse$
];
export var GetOutboundWebIdentityFederationInfo$: StaticOperationSchema = [9, n0, _GOWIFI,
...
export var GetPolicyVersion$: StaticOperationSchema = [9, n0, _GPV,
  0, () => GetPolicyVersionRequest$, () => GetPolicyVersionResponse$
];
export var GetRole$: StaticOperationSchema = [9, n0, _GR,
...
export var GetServerCertificate$: StaticOperationSchema = [9, n0, _GSC,
  0, () => GetServerCertificateRequest$, () => GetServerCertificateResponse$
];
export var GetServiceLastAccessedDetails$: StaticOperationSchema = [9, n0, _GSLADe,
  0, () => GetServiceLastAccessedDetailsRequest$, () => GetServiceLastAccessedDetailsResponse$
];
export var GetServiceLastAccessedDetailsWithEntities$: StaticOperationSchema = [9, n0, _GSLADWE,
  0, () => GetServiceLastAccessedDetailsWithEntitiesRequest$, () => GetServiceLastAccessedDetailsWithEntitiesResponse$
];
export var GetServiceLinkedRoleDeletionStatus$: StaticOperationSchema = [9, n0, _GSLRDS,
  0, () => GetServiceLinkedRoleDeletionStatusRequest$, () => GetServiceLinkedRoleDeletionStatusResponse$
];
export var GetSSHPublicKey$: StaticOperationSchema = [9, n0, _GSSHPK,
...
export var GetUserPolicy$: StaticOperationSchema = [9, n0, _GUP,
  0, () => GetUserPolicyRequest$, () => GetUserPolicyResponse$
];
export var ListAccessKeys$: StaticOperationSchema = [9, n0, _LAK,
  0, () => ListAccessKeysRequest$, () => ListAccessKeysResponse$
];
export var ListAccountAliases$: StaticOperationSchema = [9, n0, _LAA,
  0, () => ListAccountAliasesRequest$, () => ListAccountAliasesResponse$
];
export var ListAttachedGroupPolicies$: StaticOperationSchema = [9, n0, _LAGP,
  0, () => ListAttachedGroupPoliciesRequest$, () => ListAttachedGroupPoliciesResponse$
];
export var ListAttachedRolePolicies$: StaticOperationSchema = [9, n0, _LARP,
  0, () => ListAttachedRolePoliciesRequest$, () => ListAttachedRolePoliciesResponse$
];
export var ListAttachedUserPolicies$: StaticOperationSchema = [9, n0, _LAUP,
  0, () => ListAttachedUserPoliciesRequest$, () => ListAttachedUserPoliciesResponse$
];
export var ListDelegationRequests$: StaticOperationSchema = [9, n0, _LDR,
  0, () => ListDelegationRequestsRequest$, () => ListDelegationRequestsResponse$
];
export var ListEntitiesForPolicy$: StaticOperationSchema = [9, n0, _LEFP,
  0, () => ListEntitiesForPolicyRequest$, () => ListEntitiesForPolicyResponse$
];
export var ListGroupPolicies$: StaticOperationSchema = [9, n0, _LGP,
...
export var ListGroupsForUser$: StaticOperationSchema = [9, n0, _LGFU,
  0, () => ListGroupsForUserRequest$, () => ListGroupsForUserResponse$
];
export var ListInstanceProfiles$: StaticOperationSchema = [9, n0, _LIP,
  0, () => ListInstanceProfilesRequest$, () => ListInstanceProfilesResponse$
];
export var ListInstanceProfilesForRole$: StaticOperationSchema = [9, n0, _LIPFR,
  0, () => ListInstanceProfilesForRoleRequest$, () => ListInstanceProfilesForRoleResponse$
];
export var ListInstanceProfileTags$: StaticOperationSchema = [9, n0, _LIPT,
  0, () => ListInstanceProfileTagsRequest$, () => ListInstanceProfileTagsResponse$
];
export var ListMFADevices$: StaticOperationSchema = [9, n0, _LMFAD,
  0, () => ListMFADevicesRequest$, () => ListMFADevicesResponse$
];
export var ListMFADeviceTags$: StaticOperationSchema = [9, n0, _LMFADT,
  0, () => ListMFADeviceTagsRequest$, () => ListMFADeviceTagsResponse$
];
export var ListOpenIDConnectProviders$: StaticOperationSchema = [9, n0, _LOIDCP,
  0, () => ListOpenIDConnectProvidersRequest$, () => ListOpenIDConnectProvidersResponse$
];
export var ListOpenIDConnectProviderTags$: StaticOperationSchema = [9, n0, _LOIDCPT,
  0, () => ListOpenIDConnectProviderTagsRequest$, () => ListOpenIDConnectProviderTagsResponse$
];
export var ListOrganizationsFeatures$: StaticOperationSchema = [9, n0, _LOF,
  0, () => ListOrganizationsFeaturesRequest$, () => ListOrganizationsFeaturesResponse$
];
export var ListPolicies$: StaticOperationSchema = [9, n0, _LPi,
  0, () => ListPoliciesRequest$, () => ListPoliciesResponse$
];
export var ListPoliciesGrantingServiceAccess$: StaticOperationSchema = [9, n0, _LPGSA,
  0, () => ListPoliciesGrantingServiceAccessRequest$, () => ListPoliciesGrantingServiceAccessResponse$
];
export var ListPolicyTags$: StaticOperationSchema = [9, n0, _LPT,
  0, () => ListPolicyTagsRequest$, () => ListPolicyTagsResponse$
];
export var ListPolicyVersions$: StaticOperationSchema = [9, n0, _LPV,
  0, () => ListPolicyVersionsRequest$, () => ListPolicyVersionsResponse$
];
export var ListRolePolicies$: StaticOperationSchema = [9, n0, _LRP,
  0, () => ListRolePoliciesRequest$, () => ListRolePoliciesResponse$
];
export var ListRoles$: StaticOperationSchema = [9, n0, _LR,
  0, () => ListRolesRequest$, () => ListRolesResponse$
];
export var ListRoleTags$: StaticOperationSchema = [9, n0, _LRT,
  0, () => ListRoleTagsRequest$, () => ListRoleTagsResponse$
];
export var ListSAMLProviders$: StaticOperationSchema = [9, n0, _LSAMLP,
  0, () => ListSAMLProvidersRequest$, () => ListSAMLProvidersResponse$
];
export var ListSAMLProviderTags$: StaticOperationSchema = [9, n0, _LSAMLPT,
  0, () => ListSAMLProviderTagsRequest$, () => ListSAMLProviderTagsResponse$
];
export var ListServerCertificates$: StaticOperationSchema = [9, n0, _LSC,
  0, () => ListServerCertificatesRequest$, () => ListServerCertificatesResponse$
];
export var ListServerCertificateTags$: StaticOperationSchema = [9, n0, _LSCT,
  0, () => ListServerCertificateTagsRequest$, () => ListServerCertificateTagsResponse$
];
export var ListServiceSpecificCredentials$: StaticOperationSchema = [9, n0, _LSSC,
  0, () => ListServiceSpecificCredentialsRequest$, () => ListServiceSpecificCredentialsResponse$
];
export var ListSigningCertificates$: StaticOperationSchema = [9, n0, _LSCi,
  0, () => ListSigningCertificatesRequest$, () => ListSigningCertificatesResponse$
];
export var ListSSHPublicKeys$: StaticOperationSchema = [9, n0, _LSSHPK,
  0, () => ListSSHPublicKeysRequest$, () => ListSSHPublicKeysResponse$
];
export var ListUserPolicies$: StaticOperationSchema = [9, n0, _LUP,
...
export var ListUserTags$: StaticOperationSchema = [9, n0, _LUT,
...
export var PutRolePermissionsBoundary$: StaticOperationSchema = [9, n0, _PRPB,
  0, () => PutRolePermissionsBoundaryRequest$, () => __Unit
];
export var PutRolePolicy$: StaticOperationSchema = [9, n0, _PRPu,
  0, () => PutRolePolicyRequest$, () => __Unit
];
export var PutUserPermissionsBoundary$: StaticOperationSchema = [9, n0, _PUPB,
  0, () => PutUserPermissionsBoundaryRequest$, () => __Unit
];
export var PutUserPolicy$: StaticOperationSchema = [9, n0, _PUP,
  0, () => PutUserPolicyRequest$, () => __Unit
];
export var RejectDelegationRequest$: StaticOperationSchema = [9, n0, _RDR,
  0, () => RejectDelegationRequestRequest$, () => __Unit
];
export var RemoveClientIDFromOpenIDConnectProvider$: StaticOperationSchema = [9, n0, _RCIDFOIDCP,
  0, () => RemoveClientIDFromOpenIDConnectProviderRequest$, () => __Unit
];
export var RemoveRoleFromInstanceProfile$: StaticOperationSchema = [9, n0, _RRFIP,
  0, () => RemoveRoleFromInstanceProfileRequest$, () => __Unit
];
export var RemoveUserFromGroup$: StaticOperationSchema = [9, n0, _RUFG,
  0, () => RemoveUserFromGroupRequest$, () => __Unit
];
export var ResetServiceSpecificCredential$: StaticOperationSchema = [9, n0, _RSSC,
  0, () => ResetServiceSpecificCredentialRequest$, () => ResetServiceSpecificCredentialResponse$
];
export var ResyncMFADevice$: StaticOperationSchema = [9, n0, _RMFAD,
  0, () => ResyncMFADeviceRequest$, () => __Unit
];
export var SendDelegationToken$: StaticOperationSchema = [9, n0, _SDT,
  0, () => SendDelegationTokenRequest$, () => __Unit
];
export var SetDefaultPolicyVersion$: StaticOperationSchema = [9, n0, _SDPV,
  0, () => SetDefaultPolicyVersionRequest$, () => __Unit
];
export var SetSecurityTokenServicePreferences$: StaticOperationSchema = [9, n0, _SSTSP,
  0, () => SetSecurityTokenServicePreferencesRequest$, () => __Unit
];
export var SimulateCustomPolicy$: StaticOperationSchema = [9, n0, _SCP,
  0, () => SimulateCustomPolicyRequest$, () => SimulatePolicyResponse$
];
export var SimulatePrincipalPolicy$: StaticOperationSchema = [9, n0, _SPP,
  0, () => SimulatePrincipalPolicyRequest$, () => SimulatePolicyResponse$
];
export var TagInstanceProfile$: StaticOperationSchema = [9, n0, _TIP,
  0, () => TagInstanceProfileRequest$, () => __Unit
];
export var TagMFADevice$: StaticOperationSchema = [9, n0, _TMFAD,
  0, () => TagMFADeviceRequest$, () => __Unit
];
export var TagOpenIDConnectProvider$: StaticOperationSchema = [9, n0, _TOIDCP,
  0, () => TagOpenIDConnectProviderRequest$, () => __Unit
];
export var TagPolicy$: StaticOperationSchema = [9, n0, _TP,
  0, () => TagPolicyRequest$, () => __Unit
];
export var TagRole$: StaticOperationSchema = [9, n0, _TR,
  0, () => TagRoleRequest$, () => __Unit
];
export var TagSAMLProvider$: StaticOperationSchema = [9, n0, _TSAMLP,
  0, () => TagSAMLProviderRequest$, () => __Unit
];
export var TagServerCertificate$: StaticOperationSchema = [9, n0, _TSC,
  0, () => TagServerCertificateRequest$, () => __Unit
];
export var TagUser$: StaticOperationSchema = [9, n0, _TU,
  0, () => TagUserRequest$, () => __Unit
];
export var UntagInstanceProfile$: StaticOperationSchema = [9, n0, _UIP,
  0, () => UntagInstanceProfileRequest$, () => __Unit
];
export var UntagMFADevice$: StaticOperationSchema = [9, n0, _UMFAD,
  0, () => UntagMFADeviceRequest$, () => __Unit
];
export var UntagOpenIDConnectProvider$: StaticOperationSchema = [9, n0, _UOIDCP,
  0, () => UntagOpenIDConnectProviderRequest$, () => __Unit
];
export var UntagPolicy$: StaticOperationSchema = [9, n0, _UP,
  0, () => UntagPolicyRequest$, () => __Unit
];
export var UntagRole$: StaticOperationSchema = [9, n0, _UR,
  0, () => UntagRoleRequest$, () => __Unit
];
export var UntagSAMLProvider$: StaticOperationSchema = [9, n0, _USAMLP,
  0, () => UntagSAMLProviderRequest$, () => __Unit
];
export var UntagServerCertificate$: StaticOperationSchema = [9, n0, _USC,
  0, () => UntagServerCertificateRequest$, () => __Unit
];
export var UntagUser$: StaticOperationSchema = [9, n0, _UU,
  0, () => UntagUserRequest$, () => __Unit
];
export var UpdateAccessKey$: StaticOperationSchema = [9, n0, _UAK,
  0, () => UpdateAccessKeyRequest$, () => __Unit
];
export var UpdateAccountPasswordPolicy$: StaticOperationSchema = [9, n0, _UAPP,
  0, () => UpdateAccountPasswordPolicyRequest$, () => __Unit
];
export var UpdateAssumeRolePolicy$: StaticOperationSchema = [9, n0, _UARP,
  0, () => UpdateAssumeRolePolicyRequest$, () => __Unit
];
export var UpdateDelegationRequest$: StaticOperationSchema = [9, n0, _UDR,
  0, () => UpdateDelegationRequestRequest$, () => __Unit
];
export var UpdateGroup$: StaticOperationSchema = [9, n0, _UG,
  0, () => UpdateGroupRequest$, () => __Unit
];
export var UpdateLoginProfile$: StaticOperationSchema = [9, n0, _ULP,
  0, () => UpdateLoginProfileRequest$, () => __Unit
];
export var UpdateOpenIDConnectProviderThumbprint$: StaticOperationSchema = [9, n0, _UOIDCPT,
  0, () => UpdateOpenIDConnectProviderThumbprintRequest$, () => __Unit
];
export var UpdateRole$: StaticOperationSchema = [9, n0, _URp,
  0, () => UpdateRoleRequest$, () => UpdateRoleResponse$
];
export var UpdateRoleDescription$: StaticOperationSchema = [9, n0, _URD,
  0, () => UpdateRoleDescriptionRequest$, () => UpdateRoleDescriptionResponse$
];
export var UpdateSAMLProvider$: StaticOperationSchema = [9, n0, _USAMLPp,
  0, () => UpdateSAMLProviderRequest$, () => UpdateSAMLProviderResponse$
];
export var UpdateServerCertificate$: StaticOperationSchema = [9, n0, _USCp,
  0, () => UpdateServerCertificateRequest$, () => __Unit
];
export var UpdateServiceSpecificCredential$: StaticOperationSchema = [9, n0, _USSC,
  0, () => UpdateServiceSpecificCredentialRequest$, () => __Unit
];
export var UpdateSigningCertificate$: StaticOperationSchema = [9, n0, _USCpd,
  0, () => UpdateSigningCertificateRequest$, () => __Unit
];
export var UpdateSSHPublicKey$: StaticOperationSchema = [9, n0, _USSHPK,
  0, () => UpdateSSHPublicKeyRequest$, () => __Unit
];
export var UpdateUser$: StaticOperationSchema = [9, n0, _UUp,
  0, () => UpdateUserRequest$, () => __Unit
];
export var UploadServerCertificate$: StaticOperationSchema = [9, n0, _USCpl,
  0, () => UploadServerCertificateRequest$, () => UploadServerCertificateResponse$
];
export var UploadSigningCertificate$: StaticOperationSchema = [9, n0, _USCplo,
  0, () => UploadSigningCertificateRequest$, () => UploadSigningCertificateResponse$
];
export var UploadSSHPublicKey$: StaticOperationSchema = [9, n0, _USSHPKp,
