...
import type { UntagServerCertificateRequest } from "../models/models_1";
 ...
 * @public
 */
export class UntagServerCertificateCommand extends command<UntagServerCertificateCommandInput, UntagServerCertificateCommandOutput>(
  _ep0,
  _mw0,
