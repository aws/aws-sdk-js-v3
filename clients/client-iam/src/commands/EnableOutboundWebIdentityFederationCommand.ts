 ...
 * @public
 */
export class EnableOutboundWebIdentityFederationCommand extends command<EnableOutboundWebIdentityFederationCommandInput, EnableOutboundWebIdentityFederationCommandOutput>(
  _ep0,
  _mw0,
