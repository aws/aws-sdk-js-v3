...
import { DeleteServerCertificate$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteServerCertificateCommand extends command<DeleteServerCertificateCommandInput, DeleteServerCertificateCommandOutput>(
  _ep0,
  _mw0,
