 ...
 * @public
 */
export class EnableOrganizationsRootSessionsCommand extends command<EnableOrganizationsRootSessionsCommandInput, EnableOrganizationsRootSessionsCommandOutput>(
  _ep0,
  _mw0,
