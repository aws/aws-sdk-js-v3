...
import type { UpdateDelegationRequestRequest } from "../models/models_0";
 ...
 * @public
 */
export class UpdateDelegationRequestCommand extends command<UpdateDelegationRequestCommandInput, UpdateDelegationRequestCommandOutput>(
  _ep0,
  _mw0,
