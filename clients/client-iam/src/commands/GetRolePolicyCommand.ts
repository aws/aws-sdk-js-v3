...
import type { GetRolePolicyRequest, GetRolePolicyResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetRolePolicyCommand extends command<GetRolePolicyCommandInput, GetRolePolicyCommandOutput>(
  _ep0,
  _mw0,
  "GetRolePolicy",
  GetRolePolicy$
