 ...
 * @public
 */
export class DeleteUserPermissionsBoundaryCommand extends command<DeleteUserPermissionsBoundaryCommandInput, DeleteUserPermissionsBoundaryCommandOutput>(
  _ep0,
  _mw0,
