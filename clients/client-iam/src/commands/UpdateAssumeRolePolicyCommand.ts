...
import type { UpdateAssumeRolePolicyRequest } from "../models/models_1";
 ...
 * @public
 */
export class UpdateAssumeRolePolicyCommand extends command<UpdateAssumeRolePolicyCommandInput, UpdateAssumeRolePolicyCommandOutput>(
  _ep0,
  _mw0,
