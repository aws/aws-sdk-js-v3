 ...
 * @public
 */
export class ListPoliciesGrantingServiceAccessCommand extends command<ListPoliciesGrantingServiceAccessCommandInput, ListPoliciesGrantingServiceAccessCommandOutput>(
  _ep0,
  _mw0,
