...
import type { TagSAMLProviderRequest } from "../models/models_1";
 ...
 * @public
 */
export class TagSAMLProviderCommand extends command<TagSAMLProviderCommandInput, TagSAMLProviderCommandOutput>(
  _ep0,
  _mw0,
  "TagSAMLProvider",
  TagSAMLProvider$
