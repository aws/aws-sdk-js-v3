...
import type { UntagInstanceProfileRequest } from "../models/models_1";
 ...
 * @public
 */
export class UntagInstanceProfileCommand extends command<UntagInstanceProfileCommandInput, UntagInstanceProfileCommandOutput>(
  _ep0,
  _mw0,
