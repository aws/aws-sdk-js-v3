 ...
 * @public
 */
export class GetServiceLastAccessedDetailsCommand extends command<GetServiceLastAccessedDetailsCommandInput, GetServiceLastAccessedDetailsCommandOutput>(
  _ep0,
  _mw0,
