...
import type { TagServerCertificateRequest } from "../models/models_1";
 ...
 * @public
 */
export class TagServerCertificateCommand extends command<TagServerCertificateCommandInput, TagServerCertificateCommandOutput>(
  _ep0,
  _mw0,
