 ...
 * @public
 */
export class ListOpenIDConnectProviderTagsCommand extends command<ListOpenIDConnectProviderTagsCommandInput, ListOpenIDConnectProviderTagsCommandOutput>(
  _ep0,
  _mw0,
