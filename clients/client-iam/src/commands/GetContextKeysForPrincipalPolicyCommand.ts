 ...
 * @public
 */
export class GetContextKeysForPrincipalPolicyCommand extends command<GetContextKeysForPrincipalPolicyCommandInput, GetContextKeysForPrincipalPolicyCommandOutput>(
  _ep0,
  _mw0,
