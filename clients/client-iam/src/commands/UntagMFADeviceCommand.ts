...
import type { UntagMFADeviceRequest } from "../models/models_0";
 ...
 * @public
 */
export class UntagMFADeviceCommand extends command<UntagMFADeviceCommandInput, UntagMFADeviceCommandOutput>(
  _ep0,
  _mw0,
  "UntagMFADevice",
  UntagMFADevice$
