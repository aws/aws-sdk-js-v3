 ...
 * @public
 */
export class ResetServiceSpecificCredentialCommand extends command<ResetServiceSpecificCredentialCommandInput, ResetServiceSpecificCredentialCommandOutput>(
  _ep0,
  _mw0,
