...
export type DescribeUserImportJobCommandInput = DescribeUserImportJobRequest;
export type DescribeUserImportJobCommandOutput = DescribeUserImportJobResponse & __MetadataBearer;
...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName: "describeUserImportJob",
      inputFilterLog: DescribeUserImportJobRequest.filterSensitiveLog,
      outputFilterLog: DescribeUserImportJobResponse.filterSensitiveLog,
    };
