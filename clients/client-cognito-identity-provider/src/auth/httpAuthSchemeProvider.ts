...
import {
  type CognitoIdentityProviderClientResolvedConfig,
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CognitoIdentityProviderHttpAuthSchemeParameters): HttpAuthOption {
  return {
...
function createSmithyApiNoAuthHttpAuthOption(authParameters: CognitoIdentityProviderHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultCognitoIdentityProviderHttpAuthSchemeProvider: CognitoIdentityProviderHttpAuthSchemeProvider = (authParameters) => {
