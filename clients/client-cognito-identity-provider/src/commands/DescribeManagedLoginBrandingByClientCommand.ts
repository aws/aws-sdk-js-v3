 ...
 * @public
 */
export class DescribeManagedLoginBrandingByClientCommand extends command<DescribeManagedLoginBrandingByClientCommandInput, DescribeManagedLoginBrandingByClientCommandOutput>(
  _ep0,
  _mw0,
