...
import { type ComprehendMedicalClientResolvedConfig, ComprehendMedicalClientConfig } from "../ComprehendMedicalClient";
 ...
 * @internal
 */
export const defaultComprehendMedicalHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ComprehendMedicalHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultComprehendMedicalHttpAuthSchemeProvider: ComprehendMedicalHttpAuthSchemeProvider = (authParameters) => {
