...
export async function serializeAws_json1_1DescribeEntitiesDetectionV2JobCommand(
  ...
  const wrappedBody: any = {
    DescribeEntitiesDetectionV2JobRequest: serializeAws_json1_1DescribeEntitiesDetectionV2JobRequest(input, context),
  };
...
export async function serializeAws_json1_1DescribePHIDetectionJobCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    DescribePHIDetectionJobRequest: serializeAws_json1_1DescribePHIDetectionJobRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1DetectEntitiesV2Command(
  ...
  let body: any = {};
  const wrappedBody: any = {
    DetectEntitiesV2Request: serializeAws_json1_1DetectEntitiesV2Request(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1ListEntitiesDetectionV2JobsCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    ListEntitiesDetectionV2JobsRequest: serializeAws_json1_1ListEntitiesDetectionV2JobsRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1ListPHIDetectionJobsCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    ListPHIDetectionJobsRequest: serializeAws_json1_1ListPHIDetectionJobsRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1StartEntitiesDetectionV2JobCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    StartEntitiesDetectionV2JobRequest: serializeAws_json1_1StartEntitiesDetectionV2JobRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1StartPHIDetectionJobCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    StartPHIDetectionJobRequest: serializeAws_json1_1StartPHIDetectionJobRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1StopEntitiesDetectionV2JobCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    StopEntitiesDetectionV2JobRequest: serializeAws_json1_1StopEntitiesDetectionV2JobRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1StopPHIDetectionJobCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    StopPHIDetectionJobRequest: serializeAws_json1_1StopPHIDetectionJobRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
async function deserializeAws_json1_1DetectEntitiesCommandError(
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.deepinsight.medical#InvalidEncodingException":
      response = await deserializeAws_json1_1InvalidEncodingExceptionResponse(parsedOutput, context);
      break;
    case "InvalidRequestException":
    case "com.amazonaws.deepinsight.medical#InvalidRequestException":
      response = await deserializeAws_json1_1InvalidRequestExceptionResponse(parsedOutput, context);
...
const deserializeAws_json1_1InvalidEncodingExceptionResponse = async (
  ...
  const deserialized: any = deserializeAws_json1_1InvalidEncodingException(output.body, context);
