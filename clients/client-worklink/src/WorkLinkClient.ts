...
import {
  defaultWorkLinkHttpAuthSchemeParametersProvider,
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<WorkLinkClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultWorkLinkHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: WorkLinkClientResolvedConfig) =>
