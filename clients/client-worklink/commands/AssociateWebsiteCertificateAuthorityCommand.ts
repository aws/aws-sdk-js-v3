...
import {
  deserializeAws_restJson1_1AssociateWebsiteCertificateAuthorityCommand,
  serializeAws_restJson1_1AssociateWebsiteCertificateAuthorityCommand,
...
export class AssociateWebsiteCertificateAuthorityCommand extends $Command<AssociateWebsiteCertificateAuthorityCommandInput, AssociateWebsiteCertificateAuthorityCommandOutput, WorkLinkClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1AssociateWebsiteCertificateAuthorityCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1AssociateWebsiteCertificateAuthorityCommand(output, context);
  }
