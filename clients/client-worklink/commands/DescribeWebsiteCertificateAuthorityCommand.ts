...
export class DescribeWebsiteCertificateAuthorityCommand extends $Command<DescribeWebsiteCertificateAuthorityCommandInput, DescribeWebsiteCertificateAuthorityCommandOutput, WorkLinkClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DescribeWebsiteCertificateAuthorityCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeWebsiteCertificateAuthorityCommand(output, context);
  }
