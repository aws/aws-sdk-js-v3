...
export class DescribeDevicePolicyConfigurationCommand extends $Command<DescribeDevicePolicyConfigurationCommandInput, DescribeDevicePolicyConfigurationCommandOutput, WorkLinkClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DescribeDevicePolicyConfigurationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeDevicePolicyConfigurationCommand(output, context);
  }
