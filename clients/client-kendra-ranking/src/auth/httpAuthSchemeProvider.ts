...
import { type KendraRankingClientResolvedConfig, KendraRankingClientConfig } from "../KendraRankingClient";
 ...
 * @internal
 */
export const defaultKendraRankingHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: KendraRankingHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultKendraRankingHttpAuthSchemeProvider: KendraRankingHttpAuthSchemeProvider = (authParameters) => {
