...
import {
  ...
  defaultKendraRankingHttpAuthSchemeParametersProvider,
...
import type { RescoreCommandInput, RescoreCommandOutput } from "./commands/RescoreCommand";
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<KendraRankingClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: KendraRankingClientResolvedConfig) =>
