...
import type { UpdateRescoreExecutionPlanRequest } from "../models/models_0";
 ...
 * @public
 */
export class UpdateRescoreExecutionPlanCommand extends command<UpdateRescoreExecutionPlanCommandInput, UpdateRescoreExecutionPlanCommandOutput>(
  _ep0,
  _mw0,
