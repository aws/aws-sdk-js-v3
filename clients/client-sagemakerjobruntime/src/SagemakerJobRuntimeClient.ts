...
import {
  ...
  defaultSagemakerJobRuntimeHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type SagemakerJobRuntimeClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type SagemakerJobRuntimeClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 */
export class SagemakerJobRuntimeClient extends __Client<
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<SagemakerJobRuntimeClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultSagemakerJobRuntimeHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: SagemakerJobRuntimeClientResolvedConfig) =>
