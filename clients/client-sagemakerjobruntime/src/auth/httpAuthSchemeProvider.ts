...
import {
  type SagemakerJobRuntimeClientResolvedConfig,
  SagemakerJobRuntimeClientConfig,
 ...
 * @internal
 */
export const defaultSagemakerJobRuntimeHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SagemakerJobRuntimeHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<SagemakerJobRuntimeClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultSagemakerJobRuntimeHttpAuthSchemeProvider: SagemakerJobRuntimeHttpAuthSchemeProvider = (authParameters) => {
