...
import { defaultSagemakerJobRuntimeHttpAuthSchemeProvider } from "./auth/httpAuthSchemeProvider";
...
export const getRuntimeConfig = (config: SagemakerJobRuntimeClientConfig) => {
  return {
    ...
    httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultSagemakerJobRuntimeHttpAuthSchemeProvider,
