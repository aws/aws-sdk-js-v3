...
export var Hypervisor$: StaticStructureSchema = [3, n0, _H,
  0,
  [_Ho, _HA, _KKA, _N, _S],
  [0, 0, 0, 0, 0]
];
export var HypervisorDetails$: StaticStructureSchema = [3, n0, _HD,
  0,
...
export var ListGatewaysOutput$: StaticStructureSchema = [3, n0, _LGO,
  0,
  [_Ga, _NT],
  [() => Gateways, 0]
];
export var ListHypervisorsInput$: StaticStructureSchema = [3, n0, _LHI,
  0,
  [_MR, _NT],
  [1, 0]
];
export var ListHypervisorsOutput$: StaticStructureSchema = [3, n0, _LHO,
  0,
  [_Hy, _NT],
  [() => Hypervisors, 0]
];
...
export var ListVirtualMachinesInput$: StaticStructureSchema = [3, n0, _LVMI,
  0,
  [_HA, _MR, _NT],
  [0, 1, 0]
];
export var ListVirtualMachinesOutput$: StaticStructureSchema = [3, n0, _LVMO,
  0,
  [_VMi, _NT],
  [() => VirtualMachines, 0]
];
...
export var VirtualMachineDetails$: StaticStructureSchema = [3, n0, _VMD,
  0,
  [_HN, _HI, _N, _Pa, _RA, _LBD, _VT],
  [0, 0, 0, 0, 0, 4, () => VmwareTags]
];
export var VmwareTag$: StaticStructureSchema = [3, n0, _VTm,
  0,
  [_VC, _VTN, _VTD],
  [0, 0, 0]
];
...
var DaysOfWeek = 64 | 1;
var Gateways: StaticListSchema = [1, n0, _Ga,
  0, () => Gateway$
];
var Hypervisors: StaticListSchema = [1, n0, _Hy,
  0, () => Hypervisor$
];
var TagKeys = 64 | 0;
...
var VirtualMachines: StaticListSchema = [1, n0, _VMi,
  0, () => VirtualMachine$
];
var VmwareTags: StaticListSchema = [1, n0, _VT,
  0, () => VmwareTag$
];
var VmwareToAwsTagMappings: StaticListSchema = [1, n0, _VTATM,
  0, () => VmwareToAwsTagMapping$
];
export var AssociateGatewayToServer$: StaticOperationSchema = [9, n0, _AGTS,
...
export var DeleteHypervisor$: StaticOperationSchema = [9, n0, _DH,
  2, () => DeleteHypervisorInput$, () => DeleteHypervisorOutput$
];
export var DisassociateGatewayFromServer$: StaticOperationSchema = [9, n0, _DGFS,
  0, () => DisassociateGatewayFromServerInput$, () => DisassociateGatewayFromServerOutput$
];
export var GetBandwidthRateLimitSchedule$: StaticOperationSchema = [9, n0, _GBRLS,
...
export var GetHypervisor$: StaticOperationSchema = [9, n0, _GH,
  0, () => GetHypervisorInput$, () => GetHypervisorOutput$
];
export var GetHypervisorPropertyMappings$: StaticOperationSchema = [9, n0, _GHPM,
  0, () => GetHypervisorPropertyMappingsInput$, () => GetHypervisorPropertyMappingsOutput$
];
export var GetVirtualMachine$: StaticOperationSchema = [9, n0, _GVM,
  0, () => GetVirtualMachineInput$, () => GetVirtualMachineOutput$
];
export var ImportHypervisorConfiguration$: StaticOperationSchema = [9, n0, _IHC,
...
export var ListHypervisors$: StaticOperationSchema = [9, n0, _LH,
  0, () => ListHypervisorsInput$, () => ListHypervisorsOutput$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceInput$, () => ListTagsForResourceOutput$
];
export var ListVirtualMachines$: StaticOperationSchema = [9, n0, _LVM,
  0, () => ListVirtualMachinesInput$, () => ListVirtualMachinesOutput$
];
export var PutBandwidthRateLimitSchedule$: StaticOperationSchema = [9, n0, _PBRLS,
  2, () => PutBandwidthRateLimitScheduleInput$, () => PutBandwidthRateLimitScheduleOutput$
];
export var PutHypervisorPropertyMappings$: StaticOperationSchema = [9, n0, _PHPM,
  2, () => PutHypervisorPropertyMappingsInput$, () => PutHypervisorPropertyMappingsOutput$
];
export var PutMaintenanceStartTime$: StaticOperationSchema = [9, n0, _PMST,
  0, () => PutMaintenanceStartTimeInput$, () => PutMaintenanceStartTimeOutput$
];
export var StartVirtualMachinesMetadataSync$: StaticOperationSchema = [9, n0, _SVMMS,
...
export var TestHypervisorConfiguration$: StaticOperationSchema = [9, n0, _THC,
...
export var UpdateGatewayInformation$: StaticOperationSchema = [9, n0, _UGI,
  0, () => UpdateGatewayInformationInput$, () => UpdateGatewayInformationOutput$
];
export var UpdateGatewaySoftwareNow$: StaticOperationSchema = [9, n0, _UGSN,
  0, () => UpdateGatewaySoftwareNowInput$, () => UpdateGatewaySoftwareNowOutput$
];
export var UpdateHypervisor$: StaticOperationSchema = [9, n0, _UH,
