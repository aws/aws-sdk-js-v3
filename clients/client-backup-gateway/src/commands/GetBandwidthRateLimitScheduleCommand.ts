 ...
 * @public
 */
export class GetBandwidthRateLimitScheduleCommand extends command<GetBandwidthRateLimitScheduleCommandInput, GetBandwidthRateLimitScheduleCommandOutput>(
  _ep0,
  _mw0,
