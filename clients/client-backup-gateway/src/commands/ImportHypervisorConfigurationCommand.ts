 ...
 * @public
 */
export class ImportHypervisorConfigurationCommand extends command<ImportHypervisorConfigurationCommandInput, ImportHypervisorConfigurationCommandOutput>(
  _ep0,
  _mw0,
