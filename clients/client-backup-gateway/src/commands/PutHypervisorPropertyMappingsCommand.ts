 ...
 * @public
 */
export class PutHypervisorPropertyMappingsCommand extends command<PutHypervisorPropertyMappingsCommandInput, PutHypervisorPropertyMappingsCommandOutput>(
  _ep0,
  _mw0,
