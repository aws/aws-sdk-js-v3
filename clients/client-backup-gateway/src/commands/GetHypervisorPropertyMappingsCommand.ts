 ...
 * @public
 */
export class GetHypervisorPropertyMappingsCommand extends command<GetHypervisorPropertyMappingsCommandInput, GetHypervisorPropertyMappingsCommandOutput>(
  _ep0,
  _mw0,
