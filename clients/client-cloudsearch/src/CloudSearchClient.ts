 ...
 * @public
 */
export type CloudSearchClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<CloudSearchClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultCloudSearchHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: CloudSearchClientResolvedConfig) =>
