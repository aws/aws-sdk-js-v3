...
import { type CloudSearchClientResolvedConfig, CloudSearchClientConfig } from "../CloudSearchClient";
 ...
 * @internal
 */
export const defaultCloudSearchHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CloudSearchHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<CloudSearchClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultCloudSearchHttpAuthSchemeProvider: CloudSearchHttpAuthSchemeProvider = (authParameters) => {
