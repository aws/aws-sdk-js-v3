...
export const serializeAws_restJson1_1CreateConfigurationSetCommand = async (
  ...
  body = JSON.stringify({
    ...
    ...(input.SuppressionOptions !== undefined && {
      SuppressionOptions: serializeAws_restJson1_1SuppressionOptions(input.SuppressionOptions, context)
    }),
...
export const serializeAws_restJson1_1CreateEmailIdentityCommand = async (
  ...
  body = JSON.stringify({
    ...(input.DkimSigningAttributes !== undefined && {
      DkimSigningAttributes: serializeAws_restJson1_1DkimSigningAttributes(input.DkimSigningAttributes, context)
    }),
...
export const serializeAws_restJson1_1PutAccountSuppressionAttributesCommand = async (
  ...
  body = JSON.stringify({
    ...(input.SuppressedReasons !== undefined && {
      SuppressedReasons: serializeAws_restJson1_1SuppressionListReasons(input.SuppressedReasons, context)
    })
  });
  const { hostname, protocol = "https", port } = await context.endpoint();
  return new __HttpRequest({
...
export const serializeAws_restJson1_1PutEmailIdentityDkimSigningAttributesCommand = async (
  ...
  body = JSON.stringify({
    ...(input.SigningAttributes !== undefined && {
      SigningAttributes: serializeAws_restJson1_1DkimSigningAttributes(input.SigningAttributes, context)
    }),
...
export const deserializeAws_restJson1_1PutEmailIdentityDkimSigningAttributesCommand = async (
  ...
  if (output.statusCode !== 200 && output.statusCode >= 400) {
    return deserializeAws_restJson1_1PutEmailIdentityDkimSigningAttributesCommandError(output, context);
  }
...
const serializeAws_restJson1_1SuppressionOptions = (input: SuppressionOptions, context: __SerdeContext): any => {
  return {
    ...(input.SuppressedReasons !== undefined && {
      SuppressedReasons: serializeAws_restJson1_1SuppressionListReasons(input.SuppressedReasons, context)
    })
...
const serializeAws_restJson1_1DkimSigningAttributes = (input: DkimSigningAttributes, context: __SerdeContext): any => {
  return {
...
const deserializeAws_restJson1_1SuppressionOptions = (output: any, context: __SerdeContext): SuppressionOptions => {
  return {
...
const deserializeAws_restJson1_1SuppressedDestinationSummaries = (
  ...
  return (output || []).map((entry: any) => deserializeAws_restJson1_1SuppressedDestinationSummary(entry, context));
};
