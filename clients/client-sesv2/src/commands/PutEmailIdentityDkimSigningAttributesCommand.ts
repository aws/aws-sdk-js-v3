 ...
 * @public
 */
export class PutEmailIdentityDkimSigningAttributesCommand extends command<PutEmailIdentityDkimSigningAttributesCommandInput, PutEmailIdentityDkimSigningAttributesCommandOutput>(
  _ep0,
  _mw0,
