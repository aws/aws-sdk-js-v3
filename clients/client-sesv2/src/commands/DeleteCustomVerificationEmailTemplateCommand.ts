 ...
 * ```
 *
 * @param DeleteCustomVerificationEmailTemplateRequest - {@link DeleteCustomVerificationEmailTemplateRequest}
 * @returns {@link DeleteCustomVerificationEmailTemplateResponse}
