 ...
 * @public
 */
export class PutAccountDedicatedIpWarmupAttributesCommand extends command<PutAccountDedicatedIpWarmupAttributesCommandInput, PutAccountDedicatedIpWarmupAttributesCommandOutput>(
  _ep0,
  _mw0,
