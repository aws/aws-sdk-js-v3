 ...
 * @public
 */
export class PutDeliverabilityDashboardOptionCommand extends command<PutDeliverabilityDashboardOptionCommandInput, PutDeliverabilityDashboardOptionCommandOutput>(
  _ep0,
  _mw0,
