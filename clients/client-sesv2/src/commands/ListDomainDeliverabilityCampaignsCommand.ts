 ...
 * @public
 */
export class ListDomainDeliverabilityCampaignsCommand extends command<ListDomainDeliverabilityCampaignsCommandInput, ListDomainDeliverabilityCampaignsCommandOutput>(
  _ep0,
  _mw0,
