...
import { _CRD, _CSN, _h, _HP, _PCSTO, _PCSTOR, _PCSTORu, n0 } from "./schemas_0";

/* eslint no-var: 0 */

export var PutConfigurationSetTrackingOptionsRequest = struct(n0, _PCSTOR, 0, [_CSN, _CRD, _HP], [[0, 1], 0, 0]);
