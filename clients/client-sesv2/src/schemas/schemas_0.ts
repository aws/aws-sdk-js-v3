...
export var UseCaseDescription: StaticSimpleSchema = [0, n0, _UCD, 8, 0];
export var WebsiteURL: StaticSimpleSchema = [0, n0, _WURL, 8, 0];
...
export var DailyVolumes: StaticListSchema = [1, n0, _DVa, 0, () => DailyVolume];
