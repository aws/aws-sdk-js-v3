...
var UseCaseDescription: StaticSimpleSchema = [0, n0, _UCD, 8, 0];
var WebsiteURL: StaticSimpleSchema = [0, n0, _WURL, 8, 0];
...
export var BatchGetMetricDataRequest$: StaticStructureSchema = [3, n0, _BGMDR,
  0,
  [_Q],
  [() => BatchGetMetricDataQueries]
];
export var BatchGetMetricDataResponse$: StaticStructureSchema = [3, n0, _BGMDRa,
  0,
  [_R, _E],
...
export var Bounce$: StaticStructureSchema = [3, n0, _Bo,
  0,
  [_BT, _BST, _DC],
  [0, 0, 0]
];
export var BulkEmailContent$: StaticStructureSchema = [3, n0, _BEC,
  0,
  [_Te],
  [() => Template$]
];
export var BulkEmailEntry$: StaticStructureSchema = [3, n0, _BEE,
  0,
  [_Des, _RT, _REC, _RH],
  [() => Destination$, () => MessageTagList, () => ReplacementEmailContent$, () => MessageHeaderList]
];
export var BulkEmailEntryResult$: StaticStructureSchema = [3, n0, _BEER,
  0,
  [_S, _Er, _MI],
  [0, 0, 0]
];
export var CancelExportJobRequest$: StaticStructureSchema = [3, n0, _CEJR,
  0,
  [_JI],
  [[0, 1]]
];
export var CancelExportJobResponse$: StaticStructureSchema = [3, n0, _CEJRa,
  0,
  [],
  []
];
...
export var Complaint$: StaticStructureSchema = [3, n0, _C,
  0,
  [_CST, _CFT],
  [0, 0]
];
...
export var ContactList$: StaticStructureSchema = [3, n0, _CLo,
  0,
  [_CLN, _LUT],
  [0, 4]
];
export var ContactListDestination$: StaticStructureSchema = [3, n0, _CLD,
  0,
  [_CLN, _CLIA],
  [0, 0]
];
export var Content$: StaticStructureSchema = [3, n0, _Con,
  0,
  [_Da, _Ch],
  [0, 0]
];
...
export var CreateContactListRequest$: StaticStructureSchema = [3, n0, _CCLR,
  0,
  [_CLN, _To, _De, _Ta],
  [0, () => Topics, 0, () => TagList]
];
export var CreateContactListResponse$: StaticStructureSchema = [3, n0, _CCLRr,
  0,
  [],
  []
];
...
export var CreateContactResponse$: StaticStructureSchema = [3, n0, _CCRr,
  0,
  [],
  []
];
export var CreateCustomVerificationEmailTemplateRequest$: StaticStructureSchema = [3, n0, _CCVETR,
  0,
  [_TN, _FEA, _TS, _TC, _Ta, _SRURL, _FRURL],
  [0, 0, 0, 0, () => TagList, 0, 0]
];
export var CreateCustomVerificationEmailTemplateResponse$: StaticStructureSchema = [3, n0, _CCVETRr,
  0,
  [],
  []
];
...
export var CreateEmailIdentityPolicyRequest$: StaticStructureSchema = [3, n0, _CEIPR,
  0,
  [_EI, _PNo, _P],
  [[0, 1], [0, 1], 0]
];
export var CreateEmailIdentityPolicyResponse$: StaticStructureSchema = [3, n0, _CEIPRr,
  0,
  [],
  []
];
...
export var CreateExportJobRequest$: StaticStructureSchema = [3, n0, _CEJRr,
  0,
  [_EDS, _EDx],
  [[() => ExportDataSource$, 0], () => ExportDestination$]
];
export var CreateExportJobResponse$: StaticStructureSchema = [3, n0, _CEJRre,
  0,
  [_JI],
  [0]
];
...
export var CreateMultiRegionEndpointRequest$: StaticStructureSchema = [3, n0, _CMRER,
  0,
  [_EN, _Det, _Ta],
  [0, () => Details$, () => TagList]
];
export var CreateMultiRegionEndpointResponse$: StaticStructureSchema = [3, n0, _CMRERr,
  0,
  [_S, _EIn],
  [0, 0]
];
...
export var CreateTenantResourceAssociationResponse$: StaticStructureSchema = [3, n0, _CTRARr,
  0,
  [],
  []
];
...
export var DashboardAttributes$: StaticStructureSchema = [3, n0, _DAa,
  0,
  [_EM],
  [0]
];
export var DashboardOptions$: StaticStructureSchema = [3, n0, _DOa,
  0,
  [_EM],
  [0]
];
...
export var DedicatedIpPool$: StaticStructureSchema = [3, n0, _DIPe,
  0,
  [_PN, _SM],
  [0, 0]
];
...
export var DeleteContactListRequest$: StaticStructureSchema = [3, n0, _DCLR,
  0,
  [_CLN],
  [[0, 1]]
];
export var DeleteContactListResponse$: StaticStructureSchema = [3, n0, _DCLRe,
  0,
  [],
  []
];
...
export var DeleteContactResponse$: StaticStructureSchema = [3, n0, _DCRe,
  0,
  [],
  []
];
export var DeleteCustomVerificationEmailTemplateRequest$: StaticStructureSchema = [3, n0, _DCVETR,
  0,
  [_TN],
  [[0, 1]]
];
export var DeleteCustomVerificationEmailTemplateResponse$: StaticStructureSchema = [3, n0, _DCVETRe,
  0,
  [],
  []
];
...
export var DeleteEmailIdentityPolicyRequest$: StaticStructureSchema = [3, n0, _DEIPR,
  0,
  [_EI, _PNo],
  [[0, 1], [0, 1]]
];
export var DeleteEmailIdentityPolicyResponse$: StaticStructureSchema = [3, n0, _DEIPRe,
  0,
  [],
  []
];
...
export var DeleteMultiRegionEndpointRequest$: StaticStructureSchema = [3, n0, _DMRER,
  0,
  [_EN],
  [[0, 1]]
];
export var DeleteMultiRegionEndpointResponse$: StaticStructureSchema = [3, n0, _DMRERe,
  0,
  [_S],
  [0]
];
...
export var DeleteTenantRequest$: StaticStructureSchema = [3, n0, _DTR,
  0,
  [_TNe],
  [0]
];
export var DeleteTenantResourceAssociationRequest$: StaticStructureSchema = [3, n0, _DTRAR,
  0,
  [_TNe, _RA],
  [0, 0]
];
export var DeleteTenantResourceAssociationResponse$: StaticStructureSchema = [3, n0, _DTRARe,
  0,
  [],
  []
];
export var DeleteTenantResponse$: StaticStructureSchema = [3, n0, _DTRe,
  0,
  [],
  []
];
export var DeliverabilityTestReport$: StaticStructureSchema = [3, n0, _DTRel,
  0,
...
export var EmailAddressInsightsMailboxEvaluations$: StaticStructureSchema = [3, n0, _EAIME,
  0,
...
export var EmailAddressInsightsVerdict$: StaticStructureSchema = [3, n0, _EAIV,
  0,
  [_CV],
  [0]
];
...
export var EmailInsights$: StaticStructureSchema = [3, n0, _EIm,
  0,
  [_Des, _Is, _Ev],
  [[() => InsightsEmailAddress, 0], 0, () => InsightsEvents]
];
export var EmailTemplateContent$: StaticStructureSchema = [3, n0, _ETC,
  0,
  [_Su, _T, _H],
  [0, 0, 0]
];
export var EmailTemplateMetadata$: StaticStructureSchema = [3, n0, _ETM,
  0,
  [_TN, _CTr],
  [0, 4]
];
export var EventBridgeDestination$: StaticStructureSchema = [3, n0, _EBD,
  0,
  [_EBA],
  [0]
];
...
export var EventDetails$: StaticStructureSchema = [3, n0, _EDve,
  0,
  [_Bo, _C],
  [() => Bounce$, () => Complaint$]
];
export var ExportDataSource$: StaticStructureSchema = [3, n0, _EDS,
  0,
  [_MDSe, _MIDS],
  [() => MetricsDataSource$, [() => MessageInsightsDataSource$, 0]]
];
export var ExportDestination$: StaticStructureSchema = [3, n0, _EDx,
  0,
  [_DF, _SU],
  [0, 0]
];
...
export var ExportMetric$: StaticStructureSchema = [3, n0, _EMx,
  0,
  [_Na, _Ag],
  [0, 0]
];
export var ExportStatistics$: StaticStructureSchema = [3, n0, _ESx,
  0,
  [_PRC, _ERC],
  [1, 1]
];
export var FailureInfo$: StaticStructureSchema = [3, n0, _FI,
  0,
  [_FRSU, _EMr],
  [0, 0]
];
...
export var GetContactListResponse$: StaticStructureSchema = [3, n0, _GCLRe,
  0,
...
export var GetContactResponse$: StaticStructureSchema = [3, n0, _GCRe,
  0,
  [_CLN, _EA, _TP, _TDP, _UA, _ADt, _CTr, _LUT],
  [0, 0, () => TopicPreferenceList, () => TopicPreferenceList, 2, 0, 4, 4]
];
export var GetCustomVerificationEmailTemplateRequest$: StaticStructureSchema = [3, n0, _GCVETR,
  0,
  [_TN],
  [[0, 1]]
];
export var GetCustomVerificationEmailTemplateResponse$: StaticStructureSchema = [3, n0, _GCVETRe,
  0,
  [_TN, _FEA, _TS, _TC, _Ta, _SRURL, _FRURL],
  [0, 0, 0, 0, () => TagList, 0, 0]
];
export var GetDedicatedIpPoolRequest$: StaticStructureSchema = [3, n0, _GDIPR,
  0,
  [_PN],
  [[0, 1]]
];
export var GetDedicatedIpPoolResponse$: StaticStructureSchema = [3, n0, _GDIPRe,
  0,
  [_DIPe],
  [() => DedicatedIpPool$]
];
...
export var GetEmailAddressInsightsRequest$: StaticStructureSchema = [3, n0, _GEAIR,
  0,
  [_EA],
  [0]
];
export var GetEmailAddressInsightsResponse$: StaticStructureSchema = [3, n0, _GEAIRe,
  0,
  [_MV],
  [() => MailboxValidation$]
];
export var GetEmailIdentityPoliciesRequest$: StaticStructureSchema = [3, n0, _GEIPR,
  0,
  [_EI],
  [[0, 1]]
];
export var GetEmailIdentityPoliciesResponse$: StaticStructureSchema = [3, n0, _GEIPRe,
  0,
  [_Po],
  [128 | 0]
];
...
export var GetMessageInsightsRequest$: StaticStructureSchema = [3, n0, _GMIR,
  0,
  [_MI],
  [[0, 1]]
];
export var GetMessageInsightsResponse$: StaticStructureSchema = [3, n0, _GMIRe,
  0,
  [_MI, _FEA, _Su, _ET, _In],
  [0, [() => InsightsEmailAddress, 0], [() => EmailSubject, 0], () => MessageTagList, [() => EmailInsightsList, 0]]
];
export var GetMultiRegionEndpointRequest$: StaticStructureSchema = [3, n0, _GMRER,
  0,
  [_EN],
  [[0, 1]]
];
export var GetMultiRegionEndpointResponse$: StaticStructureSchema = [3, n0, _GMRERe,
  0,
  [_EN, _EIn, _Ro, _S, _CTr, _LUT],
  [0, 0, () => Routes, 0, 4, 4]
];
export var GetReputationEntityRequest$: StaticStructureSchema = [3, n0, _GRER,
  0,
  [_RER, _RET],
  [[0, 1], [0, 1]]
];
export var GetReputationEntityResponse$: StaticStructureSchema = [3, n0, _GRERe,
  0,
  [_RE],
  [() => ReputationEntity$]
];
...
export var GetTenantRequest$: StaticStructureSchema = [3, n0, _GTR,
  0,
  [_TNe],
  [0]
];
export var GetTenantResponse$: StaticStructureSchema = [3, n0, _GTRe,
  0,
  [_Ten],
  [() => Tenant$]
];
export var GuardianAttributes$: StaticStructureSchema = [3, n0, _GA,
  0,
  [_OSD],
  [0]
];
export var GuardianOptions$: StaticStructureSchema = [3, n0, _GO,
  0,
  [_OSD],
  [0]
];
...
export var ImportDataSource$: StaticStructureSchema = [3, n0, _IDS,
  0,
  [_SU, _DF],
  [0, 0]
];
export var ImportDestination$: StaticStructureSchema = [3, n0, _ID,
  0,
  [_SLD, _CLD],
...
export var InsightsEvent$: StaticStructureSchema = [3, n0, _IE,
  0,
  [_Ti, _Ty, _Det],
  [4, 0, () => EventDetails$]
];
...
export var ListContactListsRequest$: StaticStructureSchema = [3, n0, _LCLR,
  0,
  [_PS, _NT],
  [[1, { [_hQ]: _PS }], [0, { [_hQ]: _NT }]]
];
export var ListContactListsResponse$: StaticStructureSchema = [3, n0, _LCLRi,
  0,
  [_CLon, _NT],
  [() => ListOfContactLists, 0]
];
export var ListContactsFilter$: StaticStructureSchema = [3, n0, _LCF,
  0,
  [_FS, _TF],
  [0, () => TopicFilter$]
];
...
export var ListContactsResponse$: StaticStructureSchema = [3, n0, _LCRi,
  0,
  [_Cont, _NT],
  [() => ListOfContacts, 0]
];
export var ListCustomVerificationEmailTemplatesRequest$: StaticStructureSchema = [3, n0, _LCVETR,
  0,
  [_NT, _PS],
  [[0, { [_hQ]: _NT }], [1, { [_hQ]: _PS }]]
];
export var ListCustomVerificationEmailTemplatesResponse$: StaticStructureSchema = [3, n0, _LCVETRi,
  0,
  [_CVET, _NT],
...
export var ListEmailTemplatesResponse$: StaticStructureSchema = [3, n0, _LETRi,
  0,
  [_TM, _NT],
  [() => EmailTemplateMetadataList, 0]
];
export var ListExportJobsRequest$: StaticStructureSchema = [3, n0, _LEJR,
  0,
  [_NT, _PS, _EST, _JS],
  [0, 1, 0, 0]
];
export var ListExportJobsResponse$: StaticStructureSchema = [3, n0, _LEJRi,
  0,
  [_EJ, _NT],
...
export var ListManagementOptions$: StaticStructureSchema = [3, n0, _LMO,
  0,
  [_CLN, _TNo],
  [0, 0]
];
export var ListMultiRegionEndpointsRequest$: StaticStructureSchema = [3, n0, _LMRER,
  0,
  [_NT, _PS],
  [[0, { [_hQ]: _NT }], [1, { [_hQ]: _PS }]]
];
export var ListMultiRegionEndpointsResponse$: StaticStructureSchema = [3, n0, _LMRERi,
  0,
  [_MRE, _NT],
...
export var ListReputationEntitiesRequest$: StaticStructureSchema = [3, n0, _LRER,
  0,
  [_F, _NT, _PS],
  [128 | 0, 0, 1]
];
export var ListReputationEntitiesResponse$: StaticStructureSchema = [3, n0, _LRERi,
  0,
  [_REe, _NT],
  [() => ReputationEntitiesList, 0]
];
export var ListResourceTenantsRequest$: StaticStructureSchema = [3, n0, _LRTR,
  0,
  [_RA, _PS, _NT],
  [0, 1, 0]
];
export var ListResourceTenantsResponse$: StaticStructureSchema = [3, n0, _LRTRi,
  0,
  [_RTe, _NT],
...
export var ListTenantResourcesRequest$: StaticStructureSchema = [3, n0, _LTRR,
  0,
  [_TNe, _F, _PS, _NT],
  [0, 128 | 0, 1, 0]
];
export var ListTenantResourcesResponse$: StaticStructureSchema = [3, n0, _LTRRi,
  0,
  [_TR, _NT],
...
export var MailboxValidation$: StaticStructureSchema = [3, n0, _MV,
  0,
  [_IV, _Eva],
...
export var MetricDataError$: StaticStructureSchema = [3, n0, _MDE,
  0,
  [_I, _Cod, _Me],
  [0, 0, 0]
];
export var MetricDataResult$: StaticStructureSchema = [3, n0, _MDR,
  0,
  [_I, _Tim, _Va],
  [0, 64 | 4, 64 | 1]
];
export var MetricsDataSource$: StaticStructureSchema = [3, n0, _MDSe,
  0,
  [_D, _N, _Met, _SD, _ED],
  [[2, n0, _EDxp, 0, 0, 64 | 0], 0, () => ExportMetrics, 4, 4]
];
export var MultiRegionEndpoint$: StaticStructureSchema = [3, n0, _MREu,
  0,
...
export var PutAccountDetailsRequest$: StaticStructureSchema = [3, n0, _PADR,
  0,
...
export var PutAccountSuppressionAttributesRequest$: StaticStructureSchema = [3, n0, _PASARut,
  0,
  [_SR, _VAa],
  [64 | 0, () => SuppressionValidationAttributes$]
];
export var PutAccountSuppressionAttributesResponse$: StaticStructureSchema = [3, n0, _PASARutc,
  0,
  [],
  []
];
export var PutAccountVdmAttributesRequest$: StaticStructureSchema = [3, n0, _PAVAR,
  0,
  [_VA],
  [() => VdmAttributes$]
];
export var PutAccountVdmAttributesResponse$: StaticStructureSchema = [3, n0, _PAVARu,
  0,
  [],
  []
];
export var PutConfigurationSetArchivingOptionsRequest$: StaticStructureSchema = [3, n0, _PCSAOR,
  0,
  [_CSN, _AA],
  [[0, 1], 0]
];
export var PutConfigurationSetArchivingOptionsResponse$: StaticStructureSchema = [3, n0, _PCSAORu,
  0,
  [],
  []
];
...
export var PutConfigurationSetVdmOptionsRequest$: StaticStructureSchema = [3, n0, _PCSVOR,
  0,
  [_CSN, _VO],
  [[0, 1], () => VdmOptions$]
];
export var PutConfigurationSetVdmOptionsResponse$: StaticStructureSchema = [3, n0, _PCSVORu,
  0,
  [],
  []
];
...
export var PutDedicatedIpPoolScalingAttributesRequest$: StaticStructureSchema = [3, n0, _PDIPSAR,
  0,
  [_PN, _SM],
  [[0, 1], 0]
];
export var PutDedicatedIpPoolScalingAttributesResponse$: StaticStructureSchema = [3, n0, _PDIPSARu,
  0,
  [],
  []
];
...
export var PutEmailIdentityConfigurationSetAttributesRequest$: StaticStructureSchema = [3, n0, _PEICSAR,
  0,
  [_EI, _CSN],
  [[0, 1], 0]
];
export var PutEmailIdentityConfigurationSetAttributesResponse$: StaticStructureSchema = [3, n0, _PEICSARu,
  0,
  [],
  []
];
...
export var PutEmailIdentityDkimSigningAttributesRequest$: StaticStructureSchema = [3, n0, _PEIDSAR,
  0,
  [_EI, _SAO, _SAi],
  [[0, 1], 0, [() => DkimSigningAttributes$, 0]]
];
export var PutEmailIdentityDkimSigningAttributesResponse$: StaticStructureSchema = [3, n0, _PEIDSARu,
  0,
  [_DS, _DT, _SHZ],
  [0, 64 | 0, 0]
];
...
export var ReplacementEmailContent$: StaticStructureSchema = [3, n0, _REC,
  0,
  [_RTep],
  [() => ReplacementTemplate$]
];
export var ReplacementTemplate$: StaticStructureSchema = [3, n0, _RTep,
  0,
  [_RTD],
  [0]
];
export var ReputationEntity$: StaticStructureSchema = [3, n0, _RE,
  0,
...
export var ResourceTenantMetadata$: StaticStructureSchema = [3, n0, _RTM,
  0,
  [_TNe, _TI, _RA, _AT],
  [0, 0, 0, 4]
];
export var ReviewDetails$: StaticStructureSchema = [3, n0, _RD,
  0,
  [_S, _CIas],
  [0, 0]
];
...
export var RouteDetails$: StaticStructureSchema = [3, n0, _RDou,
  0,
  [_Regi],
  [0]
];
...
export var SendCustomVerificationEmailRequest$: StaticStructureSchema = [3, n0, _SCVER,
  0,
  [_EA, _TN, _CSN],
  [0, 0, 0]
];
export var SendCustomVerificationEmailResponse$: StaticStructureSchema = [3, n0, _SCVERe,
  0,
  [_MI],
  [0]
];
...
export var SOARecord$: StaticStructureSchema = [3, n0, _SOAR,
  0,
  [_PNS, _AE, _SN],
  [0, 0, 1]
];
export var StatusRecord$: StaticStructureSchema = [3, n0, _SRt,
  0,
  [_S, _Ca, _LUT],
  [0, 0, 4]
];
...
export var SuppressedDestinationSummary$: StaticStructureSchema = [3, n0, _SDSu,
  0,
  [_EA, _Reas, _LUTa],
  [0, 0, 4]
];
export var SuppressionAttributes$: StaticStructureSchema = [3, n0, _SA,
  0,
  [_SR, _VAa],
  [64 | 0, () => SuppressionValidationAttributes$]
];
export var SuppressionConditionThreshold$: StaticStructureSchema = [3, n0, _SCT,
  0,
  [_CTEo, _OCT],
  [0, () => SuppressionConfidenceThreshold$]
];
export var SuppressionConfidenceThreshold$: StaticStructureSchema = [3, n0, _SCTu,
  0,
  [_CVT],
  [0]
];
export var SuppressionListDestination$: StaticStructureSchema = [3, n0, _SLD,
  0,
  [_SLIA],
  [0]
];
...
export var SuppressionValidationOptions$: StaticStructureSchema = [3, n0, _SVO,
  0,
  [_CTon],
  [() => SuppressionConditionThreshold$]
];
...
export var TestRenderEmailTemplateResponse$: StaticStructureSchema = [3, n0, _TRETRe,
  0,
  [_RTen],
  [0]
];
...
export var TopicFilter$: StaticStructureSchema = [3, n0, _TF,
  0,
  [_TNo, _UDIPU],
  [0, 2]
];
...
export var UpdateContactListRequest$: StaticStructureSchema = [3, n0, _UCLR,
  0,
  [_CLN, _To, _De],
  [[0, 1], () => Topics, 0]
];
export var UpdateContactListResponse$: StaticStructureSchema = [3, n0, _UCLRp,
  0,
  [],
  []
];
...
export var UpdateContactResponse$: StaticStructureSchema = [3, n0, _UCRp,
  0,
  [],
  []
];
export var UpdateCustomVerificationEmailTemplateRequest$: StaticStructureSchema = [3, n0, _UCVETR,
  0,
  [_TN, _FEA, _TS, _TC, _SRURL, _FRURL],
  [[0, 1], 0, 0, 0, 0, 0]
];
export var UpdateCustomVerificationEmailTemplateResponse$: StaticStructureSchema = [3, n0, _UCVETRp,
  0,
  [],
  []
];
export var UpdateEmailIdentityPolicyRequest$: StaticStructureSchema = [3, n0, _UEIPR,
  0,
  [_EI, _PNo, _P],
  [[0, 1], [0, 1], 0]
];
export var UpdateEmailIdentityPolicyResponse$: StaticStructureSchema = [3, n0, _UEIPRp,
  0,
  [],
  []
];
...
export var UpdateReputationEntityCustomerManagedStatusRequest$: StaticStructureSchema = [3, n0, _URECMSR,
  0,
  [_RET, _RER, _SS],
  [[0, 1], [0, 1], 0]
];
export var UpdateReputationEntityCustomerManagedStatusResponse$: StaticStructureSchema = [3, n0, _URECMSRp,
  0,
  [],
  []
];
export var UpdateReputationEntityPolicyRequest$: StaticStructureSchema = [3, n0, _UREPR,
  0,
  [_RET, _RER, _REP],
  [[0, 1], [0, 1], 0]
];
export var UpdateReputationEntityPolicyResponse$: StaticStructureSchema = [3, n0, _UREPRp,
  0,
  [],
  []
];
export var VdmAttributes$: StaticStructureSchema = [3, n0, _VA,
  0,
  [_VE, _DAa, _GA],
  [0, () => DashboardAttributes$, () => GuardianAttributes$]
];
export var VdmOptions$: StaticStructureSchema = [3, n0, _VO,
  0,
  [_DOa, _GO],
  [() => DashboardOptions$, () => GuardianOptions$]
];
export var VerificationInfo$: StaticStructureSchema = [3, n0, _VI,
  0,
...
var BatchGetMetricDataQueries: StaticListSchema = [1, n0, _BGMDQa,
...
var BulkEmailEntryList: StaticListSchema = [1, n0, _BEEL,
  0, () => BulkEmailEntry$
];
var BulkEmailEntryResultList: StaticListSchema = [1, n0, _BEERL,
...
var CustomVerificationEmailTemplatesList: StaticListSchema = [1, n0, _CVETL,
...
var DeliverabilityTestReports: StaticListSchema = [1, n0, _DTReli,
...
var EmailAddressFilterList: StaticListSchema = [1, n0, _EAFL,
  0, [() => InsightsEmailAddress,
    0]
];
var EmailAddressList = 64 | 0;
var EmailInsightsList: StaticListSchema = [1, n0, _EIL,
  0, [() => EmailInsights$,
    0]
];
var EmailSubjectFilterList: StaticListSchema = [1, n0, _ESFL,
  0, [() => EmailSubject,
    0]
];
var EmailTemplateMetadataList: StaticListSchema = [1, n0, _ETML,
  0, () => EmailTemplateMetadata$
];
var Esps = 64 | 0;
var EventDestinations: StaticListSchema = [1, n0, _EDven,
  0, () => EventDestination$
];
var EventTypes = 64 | 0;
...
var ImportJobSummaryList: StaticListSchema = [1, n0, _IJSL,
  0, () => ImportJobSummary$
];
var InsightsEvents: StaticListSchema = [1, n0, _IEn,
  0, () => InsightsEvent$
];
var IpList = 64 | 0;
...
var ListOfContactLists: StaticListSchema = [1, n0, _LOCL,
  0, () => ContactList$
];
var ListOfContacts: StaticListSchema = [1, n0, _LOC,
  0, () => Contact$
];
var ListOfDedicatedIpPools = 64 | 0;
var MessageHeaderList: StaticListSchema = [1, n0, _MHL,
  0, () => MessageHeader$
];
var MessageTagList: StaticListSchema = [1, n0, _MTL,
  0, () => MessageTag$
];
var MetricDataErrorList: StaticListSchema = [1, n0, _MDEL,
  0, () => MetricDataError$
];
var MetricDataResultList: StaticListSchema = [1, n0, _MDRL,
  0, () => MetricDataResult$
];
var MetricValueList = 64 | 1;
var MultiRegionEndpoints: StaticListSchema = [1, n0, _MRE,
  0, () => MultiRegionEndpoint$
];
var RecommendationsList: StaticListSchema = [1, n0, _RL,
  0, () => Recommendation$
];
var Regions = 64 | 0;
var ReputationEntitiesList: StaticListSchema = [1, n0, _REL,
  0, () => ReputationEntity$
];
var ResourceTenantMetadataList: StaticListSchema = [1, n0, _RTML,
  0, () => ResourceTenantMetadata$
];
var Routes: StaticListSchema = [1, n0, _Ro,
  0, () => Route$
];
var RoutesDetails: StaticListSchema = [1, n0, _RDo,
  0, () => RouteDetails$
];
var SuppressedDestinationSummaries: StaticListSchema = [1, n0, _SDS,
...
var TopicPreferenceList: StaticListSchema = [1, n0, _TPL,
  0, () => TopicPreference$
];
var Topics: StaticListSchema = [1, n0, _To,
  0, () => Topic$
];
...
export var CancelExportJob$: StaticOperationSchema = [9, n0, _CEJ,
...
export var CreateContact$: StaticOperationSchema = [9, n0, _CC,
  { [_h]: ["POST", "/v2/email/contact-lists/{ContactListName}/contacts", 200] }, () => CreateContactRequest$, () => CreateContactResponse$
];
export var CreateContactList$: StaticOperationSchema = [9, n0, _CCL,
  { [_h]: ["POST", "/v2/email/contact-lists", 200] }, () => CreateContactListRequest$, () => CreateContactListResponse$
];
export var CreateCustomVerificationEmailTemplate$: StaticOperationSchema = [9, n0, _CCVET,
...
export var CreateMultiRegionEndpoint$: StaticOperationSchema = [9, n0, _CMRE,
  { [_h]: ["POST", "/v2/email/multi-region-endpoints", 200] }, () => CreateMultiRegionEndpointRequest$, () => CreateMultiRegionEndpointResponse$
];
export var CreateTenant$: StaticOperationSchema = [9, n0, _CTre,
  { [_h]: ["POST", "/v2/email/tenants", 200] }, () => CreateTenantRequest$, () => CreateTenantResponse$
];
export var CreateTenantResourceAssociation$: StaticOperationSchema = [9, n0, _CTRA,
...
export var DeleteEmailIdentityPolicy$: StaticOperationSchema = [9, n0, _DEIP,
...
export var DeleteEmailTemplate$: StaticOperationSchema = [9, n0, _DETe,
  { [_h]: ["DELETE", "/v2/email/templates/{TemplateName}", 200] }, () => DeleteEmailTemplateRequest$, () => DeleteEmailTemplateResponse$
];
export var DeleteMultiRegionEndpoint$: StaticOperationSchema = [9, n0, _DMRE,
...
export var DeleteSuppressedDestination$: StaticOperationSchema = [9, n0, _DSD,
...
export var DeleteTenant$: StaticOperationSchema = [9, n0, _DTe,
...
export var GetDedicatedIpPool$: StaticOperationSchema = [9, n0, _GDIP,
...
export var GetEmailAddressInsights$: StaticOperationSchema = [9, n0, _GEAI,
...
export var GetEmailIdentityPolicies$: StaticOperationSchema = [9, n0, _GEIP,
...
export var ListContacts$: StaticOperationSchema = [9, n0, _LC,
  { [_h]: ["POST", "/v2/email/contact-lists/{ContactListName}/contacts/list", 200] }, () => ListContactsRequest$, () => ListContactsResponse$
];
export var ListCustomVerificationEmailTemplates$: StaticOperationSchema = [9, n0, _LCVET,
...
export var ListExportJobs$: StaticOperationSchema = [9, n0, _LEJ,
...
export var ListMultiRegionEndpoints$: StaticOperationSchema = [9, n0, _LMRE,
...
export var ListTenantResources$: StaticOperationSchema = [9, n0, _LTRis,
  { [_h]: ["POST", "/v2/email/tenants/resources/list", 200] }, () => ListTenantResourcesRequest$, () => ListTenantResourcesResponse$
];
export var ListTenants$: StaticOperationSchema = [9, n0, _LTi,
...
export var PutAccountSuppressionAttributes$: StaticOperationSchema = [9, n0, _PASAu,
  { [_h]: ["PUT", "/v2/email/account/suppression", 200] }, () => PutAccountSuppressionAttributesRequest$, () => PutAccountSuppressionAttributesResponse$
];
export var PutAccountVdmAttributes$: StaticOperationSchema = [9, n0, _PAVA,
  { [_h]: ["PUT", "/v2/email/account/vdm", 200] }, () => PutAccountVdmAttributesRequest$, () => PutAccountVdmAttributesResponse$
];
export var PutConfigurationSetArchivingOptions$: StaticOperationSchema = [9, n0, _PCSAO,
...
export var PutConfigurationSetSuppressionOptions$: StaticOperationSchema = [9, n0, _PCSSOu,
...
export var PutConfigurationSetVdmOptions$: StaticOperationSchema = [9, n0, _PCSVO,
...
export var PutDedicatedIpPoolScalingAttributes$: StaticOperationSchema = [9, n0, _PDIPSA,
...
export var PutEmailIdentityConfigurationSetAttributes$: StaticOperationSchema = [9, n0, _PEICSA,
...
export var PutEmailIdentityDkimSigningAttributes$: StaticOperationSchema = [9, n0, _PEIDSA,
...
export var SendCustomVerificationEmail$: StaticOperationSchema = [9, n0, _SCVE,
...
export var TestRenderEmailTemplate$: StaticOperationSchema = [9, n0, _TRET,
...
export var UpdateEmailIdentityPolicy$: StaticOperationSchema = [9, n0, _UEIP,
...
export var UpdateReputationEntityCustomerManagedStatus$: StaticOperationSchema = [9, n0, _URECMS,
...
export var UpdateReputationEntityPolicy$: StaticOperationSchema = [9, n0, _UREP,
