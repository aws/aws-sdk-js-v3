...
export class PutConfigurationSetDeliveryOptionsCommand extends $Command<PutConfigurationSetDeliveryOptionsCommandInput, PutConfigurationSetDeliveryOptionsCommandOutput, SESv2ClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1PutConfigurationSetDeliveryOptionsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1PutConfigurationSetDeliveryOptionsCommand(output, context);
  }
