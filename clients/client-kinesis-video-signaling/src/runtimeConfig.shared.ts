...
import { defaultKinesisVideoSignalingHttpAuthSchemeProvider } from "./auth/httpAuthSchemeProvider";
...
export const getRuntimeConfig = (config: KinesisVideoSignalingClientConfig) => {
  return {
    ...
    httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultKinesisVideoSignalingHttpAuthSchemeProvider,
