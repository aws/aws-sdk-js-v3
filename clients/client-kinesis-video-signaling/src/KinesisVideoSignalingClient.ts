...
import {
  defaultKinesisVideoSignalingHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type KinesisVideoSignalingClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
 ...
 * @public
 */
export type KinesisVideoSignalingClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<KinesisVideoSignalingClientConfig>) {
  ...
  private getIdentityProviderConfigProvider() {
    return async (config: KinesisVideoSignalingClientResolvedConfig) =>
