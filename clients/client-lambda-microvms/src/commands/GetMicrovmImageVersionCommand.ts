 ...
 * @public
 */
export class GetMicrovmImageVersionCommand extends $Command
  .classBuilder<
  ...
  .s("LambdaMicrovms", "GetMicrovmImageVersion", {})
  .n("LambdaMicrovmsClient", "GetMicrovmImageVersionCommand")
  .sc(GetMicrovmImageVersion$)
  .build() {
