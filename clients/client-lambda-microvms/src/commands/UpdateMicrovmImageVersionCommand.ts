 ...
 * @public
 */
export class UpdateMicrovmImageVersionCommand extends $Command
  .classBuilder<
  ...
  .s("LambdaMicrovms", "UpdateMicrovmImageVersion", {})
  .n("LambdaMicrovmsClient", "UpdateMicrovmImageVersionCommand")
  .sc(UpdateMicrovmImageVersion$)
  .build() {
