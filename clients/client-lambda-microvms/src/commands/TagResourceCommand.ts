 ...
 * ```javascript
 * import { LambdaMicrovmsClient, TagResourceCommand } from "@aws-sdk/client-lambda-microvms"; // ES Modules import
 * // const { LambdaMicrovmsClient, TagResourceCommand } = require("@aws-sdk/client-lambda-microvms"); // CommonJS import
...
export class TagResourceCommand extends $Command
  ...
  .s("LambdaMicrovms", "TagResource", {})
  .n("LambdaMicrovmsClient", "TagResourceCommand")
  .sc(TagResource$)
  .build() {
