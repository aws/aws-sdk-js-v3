 ...
 * @public
 */
export class ListMicrovmImagesCommand extends $Command
  .classBuilder<
  ...
  .s("LambdaMicrovms", "ListMicrovmImages", {})
  .n("LambdaMicrovmsClient", "ListMicrovmImagesCommand")
  .sc(ListMicrovmImages$)
  .build() {
