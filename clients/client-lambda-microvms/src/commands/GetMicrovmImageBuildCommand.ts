 ...
 * @public
 */
export class GetMicrovmImageBuildCommand extends $Command
  .classBuilder<
  ...
  .s("LambdaMicrovms", "GetMicrovmImageBuild", {})
  .n("LambdaMicrovmsClient", "GetMicrovmImageBuildCommand")
  .sc(GetMicrovmImageBuild$)
  .build() {
