 ...
 * @public
 */
export class CreateMicrovmImageCommand extends $Command
  .classBuilder<
  ...
  .s("LambdaMicrovms", "CreateMicrovmImage", {})
  .n("LambdaMicrovmsClient", "CreateMicrovmImageCommand")
  .sc(CreateMicrovmImage$)
  .build() {
