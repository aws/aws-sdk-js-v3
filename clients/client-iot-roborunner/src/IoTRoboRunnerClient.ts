...
import {
  defaultIoTRoboRunnerHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type IoTRoboRunnerClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
 ...
 * @public
 */
export type IoTRoboRunnerClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<IoTRoboRunnerClientConfig>) {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultIoTRoboRunnerHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: IoTRoboRunnerClientResolvedConfig) =>
