...
> {
  ...
  resolveMiddleware(
  ...
  ): Handler<ListWorkerFleetsCommandInput, ListWorkerFleetsCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListWorkerFleetsCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "ListWorkerFleetsCommand";
