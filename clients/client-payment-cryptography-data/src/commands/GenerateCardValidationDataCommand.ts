...
import { GenerateCardValidationData$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GenerateCardValidationDataCommand extends command<GenerateCardValidationDataCommandInput, GenerateCardValidationDataCommandOutput>(
  _ep0,
  _mw0,
