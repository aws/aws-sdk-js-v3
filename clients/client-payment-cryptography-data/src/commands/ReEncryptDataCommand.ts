...
> {
   ...
   * @public
   */
  constructor(readonly input: ReEncryptDataCommandInput) {
   ...
   * @internal
   */
  private serialize(input: ReEncryptDataCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<ReEncryptDataCommandOutput> {
