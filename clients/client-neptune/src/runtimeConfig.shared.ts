...
import { defaultNeptuneHttpAuthSchemeProvider } from "./auth/httpAuthSchemeProvider";
...
export const getRuntimeConfig = (config: NeptuneClientConfig) => {
  return {
    ...
    httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultNeptuneHttpAuthSchemeProvider,
