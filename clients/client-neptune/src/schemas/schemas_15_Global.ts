...
export var CreateGlobalClusterMessage = struct(n0, _CGCM, 0, [_GCI, _SDBCI, _En, _EV, _DP, _SE], [0, 0, 0, 0, 2, 2]);
...
export var DescribeGlobalClustersMessage = struct(n0, _DGCMe, 0, [_GCI, _MR, _M], [0, 1, 0]);
...
export var FailoverState = struct(n0, _FS, 0, [_S, _FDCA, _TDCA, _IDLA], [0, 0, 0, 2]);
