...
export async function deserializeAws_queryAddSourceIdentifierToSubscriptionCommand(
  ...
  let contents: any = {};
  contents = deserializeAws_queryEventSubscription(
...
export async function deserializeAws_queryApplyPendingMaintenanceActionCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryResourcePendingMaintenanceActions(
...
export async function deserializeAws_queryCopyDBClusterParameterGroupCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBClusterParameterGroup(
...
export async function deserializeAws_queryCopyDBClusterSnapshotCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBClusterSnapshot(
...
export async function deserializeAws_queryCopyDBParameterGroupCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBParameterGroup(
...
export async function deserializeAws_queryCreateDBClusterCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBCluster(data.CreateDBClusterResult, context);
...
export async function deserializeAws_queryCreateDBInstanceCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBInstance(
...
export async function deserializeAws_queryCreateDBSubnetGroupCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBSubnetGroup(
...
export async function deserializeAws_queryDeleteDBClusterCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBCluster(data.DeleteDBClusterResult, context);
...
export async function deserializeAws_queryDescribeDBClusterSnapshotAttributesCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBClusterSnapshotAttributesResult(
...
export async function deserializeAws_queryDescribeValidDBInstanceModificationsCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryValidDBInstanceModificationsMessage(
...
export async function deserializeAws_queryFailoverDBClusterCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBCluster(
...
export async function deserializeAws_queryModifyDBClusterCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBCluster(data.ModifyDBClusterResult, context);
...
const deserializeAws_queryDBCluster = (
  ...
  if (output["AssociatedRoles"]["DBClusterRole"] !== undefined) {
    contents.AssociatedRoles = deserializeAws_queryDBClusterRoles(
      output["AssociatedRoles"]["DBClusterRole"],
      context
    );
  }
  if (output["AvailabilityZones"]["AvailabilityZone"] !== undefined) {
  ...
  if (output["DBClusterMembers"]["DBClusterMember"] !== undefined) {
  ...
  if (output["EnabledCloudwatchLogsExports"]["member"] !== undefined) {
  ...
  if (output["ReadReplicaIdentifiers"]["ReadReplicaIdentifier"] !== undefined) {
  ...
  if (output["VpcSecurityGroups"]["VpcSecurityGroupMembership"] !== undefined) {
...
const deserializeAws_queryDBClusterMessage = (
  ...
  if (output["DBClusters"]["DBCluster"] !== undefined) {
...
const deserializeAws_queryDBClusterParameterGroupDetails = (
  ...
  if (output["Parameters"]["Parameter"] !== undefined) {
...
const deserializeAws_queryDBClusterSnapshotAttribute = (
  ...
  if (output["AttributeValues"]["AttributeValue"] !== undefined) {
...
const deserializeAws_queryDBClusterSnapshotMessage = (
  ...
  if (output["DBClusterSnapshots"]["DBClusterSnapshot"] !== undefined) {
...
const deserializeAws_queryDBEngineVersion = (
  ...
  if (output["ValidUpgradeTarget"]["UpgradeTarget"] !== undefined) {
...
const deserializeAws_queryDBEngineVersionMessage = (
  ...
  if (output["DBEngineVersions"]["DBEngineVersion"] !== undefined) {
...
const deserializeAws_queryDBInstance = (
  ...
  if (output["DomainMemberships"]["DomainMembership"] !== undefined) {
  ...
  if (output["OptionGroupMemberships"]["OptionGroupMembership"] !== undefined) {
  ...
  if (output["StatusInfos"]["DBInstanceStatusInfo"] !== undefined) {
...
const deserializeAws_queryDBInstanceMessage = (
  ...
  if (output["DBInstances"]["DBInstance"] !== undefined) {
...
const deserializeAws_queryDBSubnetGroup = (
  ...
  if (output["Subnets"]["Subnet"] !== undefined) {
...
const deserializeAws_queryDBSubnetGroupMessage = (
  ...
  if (output["DBSubnetGroups"]["DBSubnetGroup"] !== undefined) {
...
const deserializeAws_queryEvent = (
  ...
  if (output["EventCategories"]["EventCategory"] !== undefined) {
...
const deserializeAws_queryEventCategoriesMessage = (
  ...
  if (output["EventCategoriesMapList"]["EventCategoriesMap"] !== undefined) {
...
const deserializeAws_queryEventSubscription = (
  ...
  if (output["EventCategoriesList"]["EventCategory"] !== undefined) {
  ...
  if (output["SourceIdsList"]["SourceId"] !== undefined) {
...
const deserializeAws_queryEventSubscriptionsMessage = (
  ...
  if (output["EventSubscriptionsList"]["EventSubscription"] !== undefined) {
...
const deserializeAws_queryEventsMessage = (
  ...
  if (output["Events"]["Event"] !== undefined) {
...
const deserializeAws_queryTagListMessage = (
  ...
  if (output["TagList"]["Tag"] !== undefined) {
...
const deserializeAws_queryValidDBInstanceModificationsMessage = (
  ...
  if (output["Storage"]["ValidStorageOptions"] !== undefined) {
