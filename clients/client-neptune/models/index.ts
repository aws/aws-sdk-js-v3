...
export interface CopyDBClusterSnapshotMessage {
   ...
   *       <code>KmsKeyId</code> parameter, Amazon Neptune encrypts the target DB cluster snapshot using
   *       the specified KMS encryption key.</p>
...
export interface CreateDBClusterMessage {
  ...
  /**
   *
   *          <p>A value that indicates that the DB cluster should be associated with the specified
   *       CharacterSet.</p>
   *
   */
  CharacterSetName?: string;
  ...
  /**
   *
   *          <p>A value that indicates that the DB cluster should be associated with the specified option
   *       group.</p>
   *          <p>Permanent options can't be removed from an option group. The option group can't be removed
...
export interface CreateDBInstanceMessage {
   ...
   *       CharacterSet.</p>
   *          <p>Not applicable. The character set is managed by the DB cluster. For more information, see
   ...
   *       group.</p>
   *          <p>Permanent options, such as the TDE option for Oracle Advanced Security TDE, can't be
   *       removed from an option group, and that option group can't be removed from a DB instance once
  ...
  /**
   *
   *          <p>The AWS KMS key identifier for encryption of Performance Insights data. The KMS key ID is
...
export interface DBCluster extends $MetadataBearer {
  ...
  /**
   *
   *          <p>If present, specifies the name of the character set that this cluster is associated
   *       with.</p>
   *
   */
  CharacterSetName?: string;
...
export interface DBEngineVersion {
   ...
   *       <code>CharacterSetName</code> parameter of the CreateDBInstance API is not specified.</p>
   *
   */
   ...
   *       <code>CharacterSetName</code> parameter of the <code>CreateDBInstance</code> action.</p>
   *
   */
...
export interface DBInstance extends $MetadataBearer {
  ...
  /**
   *
   *          <p>If present, specifies the name of the character set that this instance is associated
   *       with.</p>
   *
   */
  CharacterSetName?: string;
 ...
 *
 */
export interface DBParameterGroup extends $MetadataBearer {
 ...
 *
 */
export interface EventSubscription extends $MetadataBearer {
...
export interface ModifyDBClusterMessage {
   ...
   *       unless the ApplyImmediately parameter is set to true.</p>
   ...
   *
   *          <p>A value that indicates that the DB cluster should be associated with the specified option
   *       group. Changing this parameter doesn't result in an outage except in the following case, and
   *       the change is applied during the next maintenance window unless the
   *       <code>ApplyImmediately</code> parameter is set to <code>true</code> for this request. If the
   *       parameter change results in an option group that enables OEM, this change can cause a brief
...
export interface ModifyDBInstanceMessage {
   ...
   *          <p>Constraints: This parameter must be set to true when specifying a value for the
  ...
  /**
   *
   *          <p> The version number of the database engine to upgrade to. Changing this parameter results
   ...
   *          <p>For major version upgrades, if a nondefault DB parameter group is currently in use, a new
  ...
  /**
   *
   *          <p> Indicates that the DB instance should be associated with the specified option group.
   ...
   *       parameter is set to <code>true</code> for this request. If the parameter change results in an
   *       option group that enables OEM, this change can cause a brief (sub-second) period during which
   *       new connections are rejected but existing connections are not interrupted.</p>
   *          <p>Permanent options, such as the TDE option for Oracle Advanced Security TDE, can't be
   *       removed from an option group, and that option group can't be removed from a DB instance once
   *       it is associated with a DB instance</p>
   *
...
/**
 *
 *          <p>A list of the log types whose configuration is still pending. In other words, these log
 *       types are in the process of being activated or deactivated.</p>
 *
 */
export interface PendingCloudwatchLogsExports {
   ...
   *       types are exported to CloudWatch Logs.</p>
   *
   */
  ...
  /**
   *
   *          <p>Log types that are in the process of being deactivated. After they are deactivated, these
   *       log types aren't exported to CloudWatch Logs.</p>
   *
   */
 ...
 *
 */
export interface ValidDBInstanceModificationsMessage extends $MetadataBearer {
