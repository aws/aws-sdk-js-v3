...
import { type TextractClientResolvedConfig, TextractClientConfig } from "../TextractClient";
 ...
 * @internal
 */
export const defaultTextractHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: TextractHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultTextractHttpAuthSchemeProvider: TextractHttpAuthSchemeProvider = (authParameters) => {
