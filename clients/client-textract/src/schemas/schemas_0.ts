...
export var TextractServiceException$: StaticErrorSchema = [-3, _s, "TextractServiceException", 0, [], []];
...
export var BadDocumentException$: StaticErrorSchema = [-3, n0, _BDE,
  { [_e]: _c },
  [_M, _C],
  [0, 0]
];
...
export var DocumentTooLargeException$: StaticErrorSchema = [-3, n0, _DTLE,
  { [_e]: _c },
  [_M, _C],
  [0, 0]
];
...
export var InvalidJobIdException$: StaticErrorSchema = [-3, n0, _IJIE,
  { [_e]: _c },
  [_M, _C],
  [0, 0]
];
n0_registry.registerError(InvalidJobIdException$, InvalidJobIdException);
export var InvalidKMSKeyException$: StaticErrorSchema = [-3, n0, _IKMSKE,
  { [_e]: _c },
  [_M, _C],
  [0, 0]
];
...
export var UnsupportedDocumentException$: StaticErrorSchema = [-3, n0, _UDE,
  { [_e]: _c },
  [_M, _C],
  [0, 0]
];
...
export var AdapterVersionEvaluationMetric$: StaticStructureSchema = [3, n0, _AVEM,
  0,
  [_B, _AV, _FTe],
  [() => EvaluationMetric$, () => EvaluationMetric$, 0]
];
export var AdapterVersionOverview$: StaticStructureSchema = [3, n0, _AVO,
  0,
...
export var Block$: StaticStructureSchema = [3, n0, _Blo,
  0,
...
export var DetectedSignature$: StaticStructureSchema = [3, n0, _DS,
  0,
  [_Pa],
  [1]
];
...
export var DocumentGroup$: StaticStructureSchema = [3, n0, _DG,
  0,
  [_Ty, _SD, _DSe, _US],
  [0, () => SplitDocumentList, () => DetectedSignatureList, () => UndetectedSignatureList]
];
export var DocumentLocation$: StaticStructureSchema = [3, n0, _DL,
  0,
  [_SO],
  [() => S3Object$]
];
...
export var EvaluationMetric$: StaticStructureSchema = [3, n0, _EM,
  0,
  [_FS, _Pr, _Re],
  [1, 1, 1]
];
export var ExpenseCurrency$: StaticStructureSchema = [3, n0, _EC,
  0,
  [_C, _Co],
  [0, 1]
];
export var ExpenseDetection$: StaticStructureSchema = [3, n0, _EDx,
  0,
  [_T, _G, _Co],
  [0, () => Geometry$, 1]
];
export var ExpenseDocument$: StaticStructureSchema = [3, n0, _EDxp,
  0,
  [_EI, _SF, _LIG, _Bl],
  [1, () => ExpenseFieldList, () => LineItemGroupList, () => BlockList]
];
export var ExpenseField$: StaticStructureSchema = [3, n0, _EF,
  0,
  [_Ty, _LD, _VD, _PN, _Cu, _GP],
  [() => ExpenseType$, () => ExpenseDetection$, () => ExpenseDetection$, 1, () => ExpenseCurrency$, () => ExpenseGroupPropertyList]
];
export var ExpenseGroupProperty$: StaticStructureSchema = [3, n0, _EGP,
  0,
  [_Typ, _I],
  [64 | 0, 0]
];
export var ExpenseType$: StaticStructureSchema = [3, n0, _ETx,
  0,
  [_T, _Co],
  [0, 1]
];
export var Extraction$: StaticStructureSchema = [3, n0, _E,
  0,
  [_LDe, _EDxp, _IDd],
...
export var HumanLoopActivationOutput$: StaticStructureSchema = [3, n0, _HLAO,
  0,
  [_HLA, _HLAR, _HLACER],
...
export var IdentityDocument$: StaticStructureSchema = [3, n0, _IDd,
  0,
  [_DI, _IDF, _Bl],
  [1, () => IdentityDocumentFieldList, () => BlockList]
];
export var IdentityDocumentField$: StaticStructureSchema = [3, n0, _IDFd,
  0,
  [_Ty, _VD],
  [() => AnalyzeIDDetections$, () => AnalyzeIDDetections$]
];
export var LendingDetection$: StaticStructureSchema = [3, n0, _LDen,
  0,
  [_T, _SS, _G, _Co],
  [0, 0, () => Geometry$, 1]
];
export var LendingDocument$: StaticStructureSchema = [3, n0, _LDe,
  0,
  [_LF, _SDi],
  [() => LendingFieldList, () => SignatureDetectionList]
];
export var LendingField$: StaticStructureSchema = [3, n0, _LFe,
  0,
  [_Ty, _KD, _VDa],
  [0, () => LendingDetection$, () => LendingDetectionList]
];
export var LendingResult$: StaticStructureSchema = [3, n0, _LR,
  0,
  [_Pa, _PC, _Ex],
  [1, () => PageClassification$, () => ExtractionList]
];
export var LendingSummary$: StaticStructureSchema = [3, n0, _LS,
  0,
  [_DGo, _UDT],
  [() => DocumentGroupList, 64 | 0]
];
export var LineItemFields$: StaticStructureSchema = [3, n0, _LIF,
  0,
  [_LIEF],
  [() => ExpenseFieldList]
];
export var LineItemGroup$: StaticStructureSchema = [3, n0, _LIGi,
  0,
  [_LIGI, _LI],
  [1, () => LineItemList]
];
export var ListAdaptersRequest$: StaticStructureSchema = [3, n0, _LAR,
  0,
  [_ACT, _BCT, _MR, _NT],
  [4, 4, 1, 0]
];
export var ListAdaptersResponse$: StaticStructureSchema = [3, n0, _LARi,
  0,
  [_Ad, _NT],
  [() => AdapterList, 0]
];
export var ListAdapterVersionsRequest$: StaticStructureSchema = [3, n0, _LAVR,
  0,
  [_AI, _ACT, _BCT, _MR, _NT],
  [0, 4, 4, 1, 0]
];
export var ListAdapterVersionsResponse$: StaticStructureSchema = [3, n0, _LAVRi,
  0,
  [_AVd, _NT],
...
export var NormalizedValue$: StaticStructureSchema = [3, n0, _NV,
  0,
  [_Va, _VT],
  [0, 0]
];
...
export var QueriesConfig$: StaticStructureSchema = [3, n0, _QCu,
  0,
  [_Qu],
  [() => Queries], 1
];
...
export var SignatureDetection$: StaticStructureSchema = [3, n0, _SDig,
  0,
  [_Co, _G],
  [1, () => Geometry$]
];
export var SplitDocument$: StaticStructureSchema = [3, n0, _SDp,
  0,
  [_In, _P],
  [1, 64 | 1]
];
...
export var UndetectedSignature$: StaticStructureSchema = [3, n0, _USn,
  0,
  [_Pa],
  [1]
];
...
export var Warning$: StaticStructureSchema = [3, n0, _War,
  0,
  [_ECr, _P],
  [0, 64 | 1]
];
var AdapterList: StaticListSchema = [1, n0, _AL,
  0, () => AdapterOverview$
];
var AdapterPages = 64 | 0;
var Adapters: StaticListSchema = [1, n0, _Ad,
  0, () => Adapter$
];
var AdapterVersionEvaluationMetrics: StaticListSchema = [1, n0, _AVEMd,
  0, () => AdapterVersionEvaluationMetric$
];
var AdapterVersionList: StaticListSchema = [1, n0, _AVL,
  0, () => AdapterVersionOverview$
];
var BlockList: StaticListSchema = [1, n0, _BL,
  0, () => Block$
];
var ContentClassifiers = 64 | 0;
var DetectedSignatureList: StaticListSchema = [1, n0, _DSL,
  0, () => DetectedSignature$
];
var DocumentGroupList: StaticListSchema = [1, n0, _DGL,
  0, () => DocumentGroup$
];
var DocumentPages: StaticListSchema = [1, n0, _DP,
  0, () => Document$
];
var EntityTypes = 64 | 0;
var ExpenseDocumentList: StaticListSchema = [1, n0, _EDL,
  0, () => ExpenseDocument$
];
var ExpenseFieldList: StaticListSchema = [1, n0, _EFL,
  0, () => ExpenseField$
];
var ExpenseGroupPropertyList: StaticListSchema = [1, n0, _EGPL,
  0, () => ExpenseGroupProperty$
];
var ExtractionList: StaticListSchema = [1, n0, _EL,
  0, () => Extraction$
];
var FeatureTypes = 64 | 0;
var HumanLoopActivationReasons = 64 | 0;
var IdentityDocumentFieldList: StaticListSchema = [1, n0, _IDFL,
  0, () => IdentityDocumentField$
];
var IdentityDocumentList: StaticListSchema = [1, n0, _IDL,
  0, () => IdentityDocument$
];
var IdList = 64 | 0;
var LendingDetectionList: StaticListSchema = [1, n0, _LDL,
  0, () => LendingDetection$
];
var LendingFieldList: StaticListSchema = [1, n0, _LFL,
  0, () => LendingField$
];
var LendingResultList: StaticListSchema = [1, n0, _LRL,
  0, () => LendingResult$
];
var LineItemGroupList: StaticListSchema = [1, n0, _LIGL,
  0, () => LineItemGroup$
];
var LineItemList: StaticListSchema = [1, n0, _LIL,
  0, () => LineItemFields$
];
var PageList = 64 | 1;
var Pages = 64 | 1;
...
var PredictionList: StaticListSchema = [1, n0, _PL,
  0, () => Prediction$
];
var Queries: StaticListSchema = [1, n0, _Qu,
  0, () => Query$
];
var QueryPages = 64 | 0;
...
var SignatureDetectionList: StaticListSchema = [1, n0, _SDL,
  0, () => SignatureDetection$
];
var SplitDocumentList: StaticListSchema = [1, n0, _SDLp,
  0, () => SplitDocument$
];
var StringList = 64 | 0;
var TagKeyList = 64 | 0;
var UndetectedDocumentTypeList = 64 | 0;
var UndetectedSignatureList: StaticListSchema = [1, n0, _USL,
  0, () => UndetectedSignature$
];
var Warnings: StaticListSchema = [1, n0, _Wa,
  0, () => Warning$
];
var TagMap = 128 | 0;
export var AnalyzeDocument$: StaticOperationSchema = [9, n0, _AD,
  0, () => AnalyzeDocumentRequest$, () => AnalyzeDocumentResponse$
];
export var AnalyzeExpense$: StaticOperationSchema = [9, n0, _AE,
  0, () => AnalyzeExpenseRequest$, () => AnalyzeExpenseResponse$
];
export var AnalyzeID$: StaticOperationSchema = [9, n0, _AID,
  0, () => AnalyzeIDRequest$, () => AnalyzeIDResponse$
];
export var CreateAdapter$: StaticOperationSchema = [9, n0, _CA,
  2, () => CreateAdapterRequest$, () => CreateAdapterResponse$
];
export var CreateAdapterVersion$: StaticOperationSchema = [9, n0, _CAV,
  2, () => CreateAdapterVersionRequest$, () => CreateAdapterVersionResponse$
];
export var DeleteAdapter$: StaticOperationSchema = [9, n0, _DAe,
  2, () => DeleteAdapterRequest$, () => DeleteAdapterResponse$
];
export var DeleteAdapterVersion$: StaticOperationSchema = [9, n0, _DAV,
  2, () => DeleteAdapterVersionRequest$, () => DeleteAdapterVersionResponse$
];
export var DetectDocumentText$: StaticOperationSchema = [9, n0, _DDT,
  0, () => DetectDocumentTextRequest$, () => DetectDocumentTextResponse$
];
export var GetAdapter$: StaticOperationSchema = [9, n0, _GA,
  0, () => GetAdapterRequest$, () => GetAdapterResponse$
];
export var GetAdapterVersion$: StaticOperationSchema = [9, n0, _GAV,
  0, () => GetAdapterVersionRequest$, () => GetAdapterVersionResponse$
];
export var GetDocumentAnalysis$: StaticOperationSchema = [9, n0, _GDA,
  0, () => GetDocumentAnalysisRequest$, () => GetDocumentAnalysisResponse$
];
export var GetDocumentTextDetection$: StaticOperationSchema = [9, n0, _GDTD,
  0, () => GetDocumentTextDetectionRequest$, () => GetDocumentTextDetectionResponse$
];
export var GetExpenseAnalysis$: StaticOperationSchema = [9, n0, _GEA,
  0, () => GetExpenseAnalysisRequest$, () => GetExpenseAnalysisResponse$
];
export var GetLendingAnalysis$: StaticOperationSchema = [9, n0, _GLA,
  0, () => GetLendingAnalysisRequest$, () => GetLendingAnalysisResponse$
];
export var GetLendingAnalysisSummary$: StaticOperationSchema = [9, n0, _GLAS,
  0, () => GetLendingAnalysisSummaryRequest$, () => GetLendingAnalysisSummaryResponse$
];
export var ListAdapters$: StaticOperationSchema = [9, n0, _LA,
  0, () => ListAdaptersRequest$, () => ListAdaptersResponse$
];
export var ListAdapterVersions$: StaticOperationSchema = [9, n0, _LAV,
  0, () => ListAdapterVersionsRequest$, () => ListAdapterVersionsResponse$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceRequest$, () => ListTagsForResourceResponse$
];
export var StartDocumentAnalysis$: StaticOperationSchema = [9, n0, _SDA,
  0, () => StartDocumentAnalysisRequest$, () => StartDocumentAnalysisResponse$
];
export var StartDocumentTextDetection$: StaticOperationSchema = [9, n0, _SDTD,
  0, () => StartDocumentTextDetectionRequest$, () => StartDocumentTextDetectionResponse$
];
export var StartExpenseAnalysis$: StaticOperationSchema = [9, n0, _SEA,
  0, () => StartExpenseAnalysisRequest$, () => StartExpenseAnalysisResponse$
];
export var StartLendingAnalysis$: StaticOperationSchema = [9, n0, _SLA,
...
export var UpdateAdapter$: StaticOperationSchema = [9, n0, _UA,
