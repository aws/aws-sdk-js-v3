...
export type DescribeMaintenanceWindowScheduleCommandOutput = DescribeMaintenanceWindowScheduleResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1DescribeMaintenanceWindowScheduleCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1DescribeMaintenanceWindowScheduleCommand(
      output,
      context
    );
  }
