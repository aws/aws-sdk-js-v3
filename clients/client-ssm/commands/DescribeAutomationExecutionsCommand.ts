...
export type DescribeAutomationExecutionsCommandOutput = DescribeAutomationExecutionsResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1DescribeAutomationExecutionsCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1DescribeAutomationExecutionsCommand(
      output,
      context
    );
  }
