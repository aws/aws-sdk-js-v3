 ...
 * @public
 */
export class DeregisterTargetFromMaintenanceWindowCommand extends command<DeregisterTargetFromMaintenanceWindowCommandInput, DeregisterTargetFromMaintenanceWindowCommandOutput>(
  _ep0,
  _mw0,
