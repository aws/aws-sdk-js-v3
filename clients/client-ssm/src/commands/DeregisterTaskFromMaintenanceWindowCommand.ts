 ...
 * @public
 */
export class DeregisterTaskFromMaintenanceWindowCommand extends command<DeregisterTaskFromMaintenanceWindowCommandInput, DeregisterTaskFromMaintenanceWindowCommandOutput>(
  _ep0,
  _mw0,
