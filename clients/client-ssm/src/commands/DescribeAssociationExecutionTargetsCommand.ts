 ...
 * ```
 *
 * @param DescribeAssociationExecutionTargetsRequest - {@link DescribeAssociationExecutionTargetsRequest}
 * @returns {@link DescribeAssociationExecutionTargetsResult}
