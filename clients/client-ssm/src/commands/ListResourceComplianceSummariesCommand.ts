 ...
 * @public
 */
export class ListResourceComplianceSummariesCommand extends command<ListResourceComplianceSummariesCommandInput, ListResourceComplianceSummariesCommandOutput>(
  _ep0,
  _mw0,
