 ...
 * @public
 */
export class GetMaintenanceWindowExecutionTaskCommand extends command<GetMaintenanceWindowExecutionTaskCommandInput, GetMaintenanceWindowExecutionTaskCommandOutput>(
  _ep0,
  _mw0,
