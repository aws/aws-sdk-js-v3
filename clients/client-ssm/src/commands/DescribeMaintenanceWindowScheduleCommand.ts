 ...
 * @public
 */
export class DescribeMaintenanceWindowScheduleCommand extends command<DescribeMaintenanceWindowScheduleCommandInput, DescribeMaintenanceWindowScheduleCommandOutput>(
  _ep0,
  _mw0,
