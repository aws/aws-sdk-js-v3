...
import type { DeleteOpsItemRequest, DeleteOpsItemResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteOpsItemCommand extends command<DeleteOpsItemCommandInput, DeleteOpsItemCommandOutput>(
  _ep0,
  _mw0,
  "DeleteOpsItem",
  DeleteOpsItem$
