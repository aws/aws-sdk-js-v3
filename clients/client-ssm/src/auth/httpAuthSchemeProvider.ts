...
import { type SSMClientResolvedConfig, SSMClientConfig } from "../SSMClient";
 ...
 * @internal
 */
export const defaultSSMHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SSMHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultSSMHttpAuthSchemeProvider: SSMHttpAuthSchemeProvider = (authParameters) => {
