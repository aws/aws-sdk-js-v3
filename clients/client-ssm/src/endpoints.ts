...
const AWS_TEMPLATE = "ssm.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "ssm.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "ssm.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "ssm.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "ssm.{region}.amazonaws.com";
