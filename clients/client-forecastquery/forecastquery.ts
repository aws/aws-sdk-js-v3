...
export class forecastquery extends forecastqueryClient {
   ...
   *       equivalent non-timestamp, non-target field) from the <code>TARGET_TIME_SERIES</code>
   *       dataset, or one of the forecast dimensions specified as part of the
   *       <code>FeaturizationConfig</code> object.</p>
   ...
   *          <p>To get the full forecast, use the
   *       operation.</p>
   *          <note>
   *             <p>The forecasts generated by Amazon Forecast are in the same timezone as the dataset
   *         that was used to create the predictor.</p>
   *          </note>
   *
   */
