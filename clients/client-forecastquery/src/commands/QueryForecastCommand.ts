...
import type { QueryForecastRequest, QueryForecastResponse } from "../models/models_0";
 ...
 * @public
 */
export class QueryForecastCommand extends command<QueryForecastCommandInput, QueryForecastCommandOutput>(
  _ep0,
  _mw0,
  "QueryForecast",
  QueryForecast$
