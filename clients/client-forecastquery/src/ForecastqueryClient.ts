...
import {
  ...
  defaultForecastqueryHttpAuthSchemeParametersProvider,
  resolveHttpAuthSchemeConfig,
} from "./auth/httpAuthSchemeProvider";
import type { QueryForecastCommandInput, QueryForecastCommandOutput } from "./commands/QueryForecastCommand";
import type {
 ...
 * @public
 */
export type ForecastqueryClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type ForecastqueryClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<ForecastqueryClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultForecastqueryHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: ForecastqueryClientResolvedConfig) =>
