...
export const defaultRegionInfoProvider: RegionInfoProvider = (region: string, options?: any) => {
  ...
  switch (region) {
    ...
    case "ap-northeast-2":
      regionInfo = {
        hostname: "forecastquery.ap-northeast-2.amazonaws.com",
        partition: "aws",
      };
      break;
    case "ap-south-1":
      regionInfo = {
        hostname: "forecastquery.ap-south-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "ap-southeast-1":
    ...
    case "ap-southeast-2":
      regionInfo = {
        hostname: "forecastquery.ap-southeast-2.amazonaws.com",
        partition: "aws",
      };
      break;
    case "eu-central-1":
      regionInfo = {
        hostname: "forecastquery.eu-central-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "eu-west-1":
