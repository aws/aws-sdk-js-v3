...
`LexModelsV2` extends `LexModelsV2Client` and additionally supports all operations, waiters, and paginators as methods.
This style may be familiar to you from the AWS SDK for JavaScript v2.

If you are bundling the AWS SDK, we recommend using only the bare-bones client (`LexModelsV2Client`).
...
const client = new LexModelsV2({ region: "REGION" });
