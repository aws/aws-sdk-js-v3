 ...
 * @public
 */
export class DescribeBotAnalyzerRecommendationCommand extends command<DescribeBotAnalyzerRecommendationCommandInput, DescribeBotAnalyzerRecommendationCommandOutput>(
  _ep0,
  _mw0,
