...
import type { DescribeTestSetRequest, DescribeTestSetResponse } from "../models/models_0";
 ...
 * @public
 */
export class DescribeTestSetCommand extends command<DescribeTestSetCommandInput, DescribeTestSetCommandOutput>(
  _ep0,
  _mw0,
  "DescribeTestSet",
  DescribeTestSet$
