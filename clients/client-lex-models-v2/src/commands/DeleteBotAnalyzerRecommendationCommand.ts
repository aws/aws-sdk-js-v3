 ...
 * @public
 */
export class DeleteBotAnalyzerRecommendationCommand extends command<DeleteBotAnalyzerRecommendationCommandInput, DeleteBotAnalyzerRecommendationCommandOutput>(
  _ep0,
  _mw0,
