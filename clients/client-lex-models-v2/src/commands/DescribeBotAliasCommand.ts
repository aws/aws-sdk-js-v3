...
import type { DescribeBotAliasRequest, DescribeBotAliasResponse } from "../models/models_0";
 ...
 * @public
 */
export class DescribeBotAliasCommand extends command<DescribeBotAliasCommandInput, DescribeBotAliasCommandOutput>(
  _ep0,
  _mw0,
  "DescribeBotAlias",
  DescribeBotAlias$
