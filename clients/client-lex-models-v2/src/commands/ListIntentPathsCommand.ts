...
import type { ListIntentPathsRequest, ListIntentPathsResponse } from "../models/models_1";
 ...
 * @public
 */
export class ListIntentPathsCommand extends command<ListIntentPathsCommandInput, ListIntentPathsCommandOutput>(
  _ep0,
  _mw0,
  "ListIntentPaths",
  ListIntentPaths$
