...
import type { StartBotRecommendationRequest, StartBotRecommendationResponse } from "../models/models_1";
 ...
 * @public
 */
export class StartBotRecommendationCommand extends command<StartBotRecommendationCommandInput, StartBotRecommendationCommandOutput>(
  _ep0,
  _mw0,
