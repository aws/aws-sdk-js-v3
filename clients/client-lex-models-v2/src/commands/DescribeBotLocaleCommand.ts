...
import type { DescribeBotLocaleRequest, DescribeBotLocaleResponse } from "../models/models_0";
 ...
 * @public
 */
export class DescribeBotLocaleCommand extends command<DescribeBotLocaleCommandInput, DescribeBotLocaleCommandOutput>(
  _ep0,
  _mw0,
  "DescribeBotLocale",
  DescribeBotLocale$
