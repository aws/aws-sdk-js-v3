...
import type { DeleteBotAliasRequest, DeleteBotAliasResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteBotAliasCommand extends command<DeleteBotAliasCommandInput, DeleteBotAliasCommandOutput>(
  _ep0,
  _mw0,
  "DeleteBotAlias",
  DeleteBotAlias$
