...
import type { DescribeSlotRequest } from "../models/models_0";
import type { DescribeSlotResponse } from "../models/models_1";
 ...
 * @public
 */
export class DescribeSlotCommand extends command<DescribeSlotCommandInput, DescribeSlotCommandOutput>(
  _ep0,
  _mw0,
  "DescribeSlot",
  DescribeSlot$
