...
import type { ListBotAliasesRequest, ListBotAliasesResponse } from "../models/models_1";
 ...
 * @public
 */
export class ListBotAliasesCommand extends command<ListBotAliasesCommandInput, ListBotAliasesCommandOutput>(
  _ep0,
  _mw0,
  "ListBotAliases",
  ListBotAliases$
