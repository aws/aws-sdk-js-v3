...
import type { CreateBotAliasRequest, CreateBotAliasResponse } from "../models/models_0";
import { CreateBotAlias$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CreateBotAliasCommand extends command<CreateBotAliasCommandInput, CreateBotAliasCommandOutput>(
  _ep0,
  _mw0,
  "CreateBotAlias",
  CreateBotAlias$
