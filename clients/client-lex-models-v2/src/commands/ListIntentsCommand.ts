...
import type { ListIntentsRequest, ListIntentsResponse } from "../models/models_1";
 ...
 * @public
 */
export class ListIntentsCommand extends command<ListIntentsCommandInput, ListIntentsCommandOutput>(
  _ep0,
  _mw0,
  "ListIntents",
  ListIntents$
