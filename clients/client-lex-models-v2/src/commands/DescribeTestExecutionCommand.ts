...
import { DescribeTestExecutionRequest, DescribeTestExecutionResponse } from "../models/models_1";
...
export class DescribeTestExecutionCommand extends $Command
  ...
  .m(function (this: any /*Command*/, Command: any /*static*/, config: LexModelsV2ClientResolvedConfig) {
    return [
