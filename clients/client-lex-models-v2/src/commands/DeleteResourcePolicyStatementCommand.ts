 ...
 * @public
 */
export class DeleteResourcePolicyStatementCommand extends command<DeleteResourcePolicyStatementCommandInput, DeleteResourcePolicyStatementCommandOutput>(
  _ep0,
  _mw0,
