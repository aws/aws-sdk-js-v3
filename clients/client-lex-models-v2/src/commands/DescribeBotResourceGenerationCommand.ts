 ...
 * @public
 */
export class DescribeBotResourceGenerationCommand extends command<DescribeBotResourceGenerationCommandInput, DescribeBotResourceGenerationCommandOutput>(
  _ep0,
  _mw0,
