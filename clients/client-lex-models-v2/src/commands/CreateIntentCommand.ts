...
import type { CreateIntentRequest, CreateIntentResponse } from "../models/models_1";
import { CreateIntent$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CreateIntentCommand extends command<CreateIntentCommandInput, CreateIntentCommandOutput>(
  _ep0,
  _mw0,
  "CreateIntent",
  CreateIntent$
