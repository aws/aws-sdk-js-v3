...
import type { DescribeSlotTypeRequest, DescribeSlotTypeResponse } from "../models/models_0";
 ...
 * @public
 */
export class DescribeSlotTypeCommand extends command<DescribeSlotTypeCommandInput, DescribeSlotTypeCommandOutput>(
  _ep0,
  _mw0,
  "DescribeSlotType",
  DescribeSlotType$
