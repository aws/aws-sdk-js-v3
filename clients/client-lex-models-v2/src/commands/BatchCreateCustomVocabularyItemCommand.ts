 ...
 * @public
 */
export class BatchCreateCustomVocabularyItemCommand extends command<BatchCreateCustomVocabularyItemCommandInput, BatchCreateCustomVocabularyItemCommandOutput>(
  _ep0,
  _mw0,
