...
import type { DescribeBotRequest, DescribeBotResponse } from "../models/models_0";
 ...
 * @public
 */
export class DescribeBotCommand extends command<DescribeBotCommandInput, DescribeBotCommandOutput>(
  _ep0,
  _mw0,
  "DescribeBot",
  DescribeBot$
