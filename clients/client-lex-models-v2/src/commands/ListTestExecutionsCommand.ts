...
import type { ListTestExecutionsRequest, ListTestExecutionsResponse } from "../models/models_1";
 ...
 * @public
 */
export class ListTestExecutionsCommand extends command<ListTestExecutionsCommandInput, ListTestExecutionsCommandOutput>(
  _ep0,
  _mw0,
  "ListTestExecutions",
  ListTestExecutions$
