...
import type { ListIntentMetricsRequest, ListIntentMetricsResponse } from "../models/models_1";
 ...
 * @public
 */
export class ListIntentMetricsCommand extends command<ListIntentMetricsCommandInput, ListIntentMetricsCommandOutput>(
  _ep0,
  _mw0,
  "ListIntentMetrics",
  ListIntentMetrics$
