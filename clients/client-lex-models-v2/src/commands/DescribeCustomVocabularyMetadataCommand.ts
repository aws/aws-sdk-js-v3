 ...
 * @public
 */
export class DescribeCustomVocabularyMetadataCommand extends command<DescribeCustomVocabularyMetadataCommandInput, DescribeCustomVocabularyMetadataCommandOutput>(
  _ep0,
  _mw0,
