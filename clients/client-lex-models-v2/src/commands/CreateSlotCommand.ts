...
import type { CreateSlotRequest, CreateSlotResponse } from "../models/models_1";
import { CreateSlot$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CreateSlotCommand extends command<CreateSlotCommandInput, CreateSlotCommandOutput>(
  _ep0,
  _mw0,
  "CreateSlot",
  CreateSlot$
