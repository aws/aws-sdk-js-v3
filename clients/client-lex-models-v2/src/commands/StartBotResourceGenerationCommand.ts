...
import type { StartBotResourceGenerationRequest, StartBotResourceGenerationResponse } from "../models/models_1";
 ...
 * @public
 */
export class StartBotResourceGenerationCommand extends command<StartBotResourceGenerationCommandInput, StartBotResourceGenerationCommandOutput>(
  _ep0,
  _mw0,
