...
> {
   ...
   * @public
   */
  constructor(readonly input: CreateTrustedTokenIssuerCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<CreateTrustedTokenIssuerCommandInput, CreateTrustedTokenIssuerCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, CreateTrustedTokenIssuerCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "CreateTrustedTokenIssuerCommand";
   ...
   * @internal
   */
  private serialize(input: CreateTrustedTokenIssuerCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_CreateTrustedTokenIssuerCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<CreateTrustedTokenIssuerCommandOutput> {
    return de_CreateTrustedTokenIssuerCommand(output, context);
  }
}
