 ...
 * @public
 */
export class GetInlinePolicyForPermissionSetCommand extends command<GetInlinePolicyForPermissionSetCommandInput, GetInlinePolicyForPermissionSetCommandOutput>(
  _ep0,
  _mw0,
