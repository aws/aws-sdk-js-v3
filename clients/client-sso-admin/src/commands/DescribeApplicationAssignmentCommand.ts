 ...
 * @public
 */
export class DescribeApplicationAssignmentCommand extends command<DescribeApplicationAssignmentCommandInput, DescribeApplicationAssignmentCommandOutput>(
  _ep0,
  _mw0,
