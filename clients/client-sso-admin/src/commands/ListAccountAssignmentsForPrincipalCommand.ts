...
> {
   ...
   * @public
   */
  constructor(readonly input: ListAccountAssignmentsForPrincipalCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<ListAccountAssignmentsForPrincipalCommandInput, ListAccountAssignmentsForPrincipalCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListAccountAssignmentsForPrincipalCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "ListAccountAssignmentsForPrincipalCommand";
  ...
  private serialize(
    ...
    return se_ListAccountAssignmentsForPrincipalCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_ListAccountAssignmentsForPrincipalCommand(output, context);
  }
}
