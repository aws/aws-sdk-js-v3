...
> {
   ...
   * @public
   */
  constructor(readonly input: ListApplicationAssignmentsForPrincipalCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<ListApplicationAssignmentsForPrincipalCommandInput, ListApplicationAssignmentsForPrincipalCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListApplicationAssignmentsForPrincipalCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "ListApplicationAssignmentsForPrincipalCommand";
  ...
  private serialize(
    ...
    return se_ListApplicationAssignmentsForPrincipalCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_ListApplicationAssignmentsForPrincipalCommand(output, context);
  }
}
