 ...
 * @public
 */
export class GetApplicationSessionConfigurationCommand extends command<GetApplicationSessionConfigurationCommandInput, GetApplicationSessionConfigurationCommandOutput>(
  _ep0,
  _mw0,
