 ...
 * @public
 */
export class DeletePermissionsBoundaryFromPermissionSetCommand extends command<DeletePermissionsBoundaryFromPermissionSetCommandInput, DeletePermissionsBoundaryFromPermissionSetCommandOutput>(
  _ep0,
  _mw0,
