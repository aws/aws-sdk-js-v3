...
> {
   ...
   * @public
   */
  constructor(readonly input: CreateApplicationAssignmentCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<CreateApplicationAssignmentCommandInput, CreateApplicationAssignmentCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, CreateApplicationAssignmentCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "CreateApplicationAssignmentCommand";
   ...
   * @internal
   */
  private serialize(input: CreateApplicationAssignmentCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_CreateApplicationAssignmentCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_CreateApplicationAssignmentCommand(output, context);
  }
}
