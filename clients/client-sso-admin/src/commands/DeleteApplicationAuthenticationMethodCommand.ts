...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteApplicationAuthenticationMethodCommandInput) {
    super();
  }
  ...
  ): Handler<DeleteApplicationAuthenticationMethodCommandInput, DeleteApplicationAuthenticationMethodCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteApplicationAuthenticationMethodCommand.getEndpointParameterInstructions())
    );
  ...
  private serialize(
    ...
    return se_DeleteApplicationAuthenticationMethodCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_DeleteApplicationAuthenticationMethodCommand(output, context);
  }
}
