...
> {
   ...
   * @public
   */
  constructor(readonly input: GetApplicationAuthenticationMethodCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<GetApplicationAuthenticationMethodCommandInput, GetApplicationAuthenticationMethodCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, GetApplicationAuthenticationMethodCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "GetApplicationAuthenticationMethodCommand";
  ...
  private serialize(
    ...
    return se_GetApplicationAuthenticationMethodCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_GetApplicationAuthenticationMethodCommand(output, context);
  }
}
