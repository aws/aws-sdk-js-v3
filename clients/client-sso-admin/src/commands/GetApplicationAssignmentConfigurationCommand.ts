...
> {
   ...
   * @public
   */
  constructor(readonly input: GetApplicationAssignmentConfigurationCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<GetApplicationAssignmentConfigurationCommandInput, GetApplicationAssignmentConfigurationCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, GetApplicationAssignmentConfigurationCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "GetApplicationAssignmentConfigurationCommand";
  ...
  private serialize(
    ...
    return se_GetApplicationAssignmentConfigurationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_GetApplicationAssignmentConfigurationCommand(output, context);
  }
}
