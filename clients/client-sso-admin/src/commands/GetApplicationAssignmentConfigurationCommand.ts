 ...
 * @public
 */
export class GetApplicationAssignmentConfigurationCommand extends command<GetApplicationAssignmentConfigurationCommandInput, GetApplicationAssignmentConfigurationCommandOutput>(
  _ep0,
  _mw0,
