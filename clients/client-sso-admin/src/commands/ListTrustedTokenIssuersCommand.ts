...
import type { ListTrustedTokenIssuersRequest, ListTrustedTokenIssuersResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListTrustedTokenIssuersCommand extends command<ListTrustedTokenIssuersCommandInput, ListTrustedTokenIssuersCommandOutput>(
  _ep0,
  _mw0,
