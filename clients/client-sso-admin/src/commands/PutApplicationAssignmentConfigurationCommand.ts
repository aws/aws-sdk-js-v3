 ...
 * @public
 */
export class PutApplicationAssignmentConfigurationCommand extends command<PutApplicationAssignmentConfigurationCommandInput, PutApplicationAssignmentConfigurationCommandOutput>(
  _ep0,
  _mw0,
