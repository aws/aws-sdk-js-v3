...
> {
   ...
   * @public
   */
  constructor(readonly input: GetApplicationAccessScopeCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<GetApplicationAccessScopeCommandInput, GetApplicationAccessScopeCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, GetApplicationAccessScopeCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "GetApplicationAccessScopeCommand";
   ...
   * @internal
   */
  private serialize(input: GetApplicationAccessScopeCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_GetApplicationAccessScopeCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_GetApplicationAccessScopeCommand(output, context);
  }
}
