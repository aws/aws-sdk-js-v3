...
const makePagedClientRequest = async (
  ...
  // @ts-ignore
  return await client.send(new ListTrustedTokenIssuersCommand(input), ...args);
};
/**
 * @public
 */
export async function* paginateListTrustedTokenIssuers(
  ...
  let hasNext = true;
  let page: ListTrustedTokenIssuersCommandOutput;
  while (hasNext) {
