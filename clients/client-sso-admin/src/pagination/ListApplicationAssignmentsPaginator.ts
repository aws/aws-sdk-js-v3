...
const makePagedClientRequest = async (
  ...
  // @ts-ignore
  return await client.send(new ListApplicationAssignmentsCommand(input), ...args);
};
/**
 * @public
 */
export async function* paginateListApplicationAssignments(
  ...
  let hasNext = true;
  let page: ListApplicationAssignmentsCommandOutput;
  while (hasNext) {
