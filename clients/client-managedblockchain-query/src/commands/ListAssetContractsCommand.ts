...
import type { ListAssetContractsInput, ListAssetContractsOutput } from "../models/models_0";
 ...
 * @public
 */
export class ListAssetContractsCommand extends command<ListAssetContractsCommandInput, ListAssetContractsCommandOutput>(
  _ep0,
  _mw0,
  "ListAssetContracts",
  ListAssetContracts$
