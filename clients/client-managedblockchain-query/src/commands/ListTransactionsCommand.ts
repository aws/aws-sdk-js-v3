...
import type { ListTransactionsInput, ListTransactionsOutput } from "../models/models_0";
 ...
 * @public
 */
export class ListTransactionsCommand extends command<ListTransactionsCommandInput, ListTransactionsCommandOutput>(
  _ep0,
  _mw0,
  "ListTransactions",
  ListTransactions$
