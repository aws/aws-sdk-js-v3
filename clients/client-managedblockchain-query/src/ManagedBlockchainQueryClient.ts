...
import {
  ...
  defaultManagedBlockchainQueryHttpAuthSchemeParametersProvider,
...
import type { GetAssetContractCommandInput, GetAssetContractCommandOutput } from "./commands/GetAssetContractCommand";
import type { GetTokenBalanceCommandInput, GetTokenBalanceCommandOutput } from "./commands/GetTokenBalanceCommand";
import type { GetTransactionCommandInput, GetTransactionCommandOutput } from "./commands/GetTransactionCommand";
import type {
 ...
 * @public
 */
export type ManagedBlockchainQueryClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type ManagedBlockchainQueryClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<ManagedBlockchainQueryClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultManagedBlockchainQueryHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: ManagedBlockchainQueryClientResolvedConfig) =>
