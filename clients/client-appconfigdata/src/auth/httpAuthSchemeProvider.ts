...
import { type AppConfigDataClientResolvedConfig, AppConfigDataClientConfig } from "../AppConfigDataClient";
 ...
 * @internal
 */
export const defaultAppConfigDataHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: AppConfigDataHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<AppConfigDataClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultAppConfigDataHttpAuthSchemeProvider: AppConfigDataHttpAuthSchemeProvider = (authParameters) => {
