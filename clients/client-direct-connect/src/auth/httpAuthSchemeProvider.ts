...
import { type DirectConnectClientResolvedConfig, DirectConnectClientConfig } from "../DirectConnectClient";
 ...
 * @internal
 */
export const defaultDirectConnectHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: DirectConnectHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultDirectConnectHttpAuthSchemeProvider: DirectConnectHttpAuthSchemeProvider = (authParameters) => {
