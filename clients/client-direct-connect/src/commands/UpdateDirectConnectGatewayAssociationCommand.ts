 ...
 * @public
 */
export class UpdateDirectConnectGatewayAssociationCommand extends command<UpdateDirectConnectGatewayAssociationCommandInput, UpdateDirectConnectGatewayAssociationCommandOutput>(
  _ep0,
  _mw0,
