 ...
 * @public
 */
export class AllocateConnectionOnInterconnectCommand extends command<AllocateConnectionOnInterconnectCommandInput, AllocateConnectionOnInterconnectCommandOutput>(
  _ep0,
  _mw0,
