 ...
 * ```
 *
 * @param CreateDirectConnectGatewayAssociationProposalRequest - {@link CreateDirectConnectGatewayAssociationProposalRequest}
 * @returns {@link CreateDirectConnectGatewayAssociationProposalResult}
