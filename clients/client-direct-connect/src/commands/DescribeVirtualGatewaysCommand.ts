...
import type { VirtualGateways } from "../models/models_0";
 ...
 * @public
 */
export class DescribeVirtualGatewaysCommand extends command<DescribeVirtualGatewaysCommandInput, DescribeVirtualGatewaysCommandOutput>(
  _ep0,
  _mw0,
