 ...
 * ```
 *
 * @param CreateDirectConnectGatewayAssociationRequest - {@link CreateDirectConnectGatewayAssociationRequest}
 * @returns {@link CreateDirectConnectGatewayAssociationResult}
