 ...
 * @public
 */
export class DescribeDirectConnectGatewaysCommand extends command<DescribeDirectConnectGatewaysCommandInput, DescribeDirectConnectGatewaysCommandOutput>(
  _ep0,
  _mw0,
