...
import type { Locations } from "../models/models_0";
 ...
 * @public
 */
export class DescribeLocationsCommand extends command<DescribeLocationsCommandInput, DescribeLocationsCommandOutput>(
  _ep0,
  _mw0,
  "DescribeLocations",
  DescribeLocations$
