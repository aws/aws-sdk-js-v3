...
const AWS_TEMPLATE = "directconnect.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "directconnect.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "directconnect.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "directconnect.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "directconnect.{region}.amazonaws.com";
