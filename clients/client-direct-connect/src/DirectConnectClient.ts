  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<DirectConnectClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultDirectConnectHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: DirectConnectClientResolvedConfig) =>
