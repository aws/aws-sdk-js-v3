...
export type ConfirmTransitVirtualInterfaceCommandOutput = ConfirmTransitVirtualInterfaceResponse;

export class ConfirmTransitVirtualInterfaceCommand extends $Command<ConfirmTransitVirtualInterfaceCommandInput, ConfirmTransitVirtualInterfaceCommandOutput, DirectConnectClientResolvedConfig> {
