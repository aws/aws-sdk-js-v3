...
import { type PinpointSMSVoiceClientResolvedConfig, PinpointSMSVoiceClientConfig } from "../PinpointSMSVoiceClient";
 ...
 * @internal
 */
export const defaultPinpointSMSVoiceHttpAuthSchemeProvider: PinpointSMSVoiceHttpAuthSchemeProvider = (authParameters) => {
