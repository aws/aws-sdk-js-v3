...
import {
  ...
  defaultPinpointSMSVoiceHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type PinpointSMSVoiceClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type PinpointSMSVoiceClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<PinpointSMSVoiceClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultPinpointSMSVoiceHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: PinpointSMSVoiceClientResolvedConfig) =>
