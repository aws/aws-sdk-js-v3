...
export var ActionParameter$: StaticStructureSchema = [3, n0, _AP,
  0,
  [_d, _r],
  [0, 2]
];
...
export var ActionTarget$: StaticStructureSchema = [3, n0, _AT,
  0,
  [_rT],
  [0]
];
...
export var ExperimentAction$: StaticStructureSchema = [3, n0, _EA,
  0,
  [_aI, _d, _p, _t, _sA, _st, _sT, _eTn],
  [0, 0, 128 | 0, 128 | 0, 64 | 0, () => ExperimentActionState$, 4, 4]
];
export var ExperimentActionState$: StaticStructureSchema = [3, n0, _EAS,
  0,
  [_sta, _re],
  [0, 0]
];
export var ExperimentCloudWatchLogsLogConfiguration$: StaticStructureSchema = [3, n0, _ECWLLC,
  0,
  [_lGA],
  [0]
];
export var ExperimentError$: StaticStructureSchema = [3, n0, _EE,
  0,
  [_aIc, _co, _l],
  [0, 0, 0]
];
export var ExperimentLogConfiguration$: StaticStructureSchema = [3, n0, _ELC,
  0,
  [_cWLC, _sC, _lSV],
  [() => ExperimentCloudWatchLogsLogConfiguration$, () => ExperimentS3LogConfiguration$, 1]
];
export var ExperimentOptions$: StaticStructureSchema = [3, n0, _EO,
  0,
  [_aT, _eTRM, _aM],
  [0, 0, 0]
];
export var ExperimentReport$: StaticStructureSchema = [3, n0, _ER,
  0,
  [_st, _sR],
  [() => ExperimentReportState$, () => ExperimentReportS3ReportList]
];
export var ExperimentReportConfiguration$: StaticStructureSchema = [3, n0, _ERC,
  0,
  [_o, _dS, _pED, _pEDo],
  [() => ExperimentReportConfigurationOutputs$, () => ExperimentReportConfigurationDataSources$, 0, 0]
];
export var ExperimentReportConfigurationCloudWatchDashboard$: StaticStructureSchema = [3, n0, _ERCCWD,
  0,
  [_dI],
  [0]
];
export var ExperimentReportConfigurationDataSources$: StaticStructureSchema = [3, n0, _ERCDS,
  0,
  [_cWD],
  [() => ExperimentReportConfigurationCloudWatchDashboardList]
];
export var ExperimentReportConfigurationOutputs$: StaticStructureSchema = [3, n0, _ERCO,
  0,
  [_sC],
  [() => ExperimentReportConfigurationOutputsS3Configuration$]
];
export var ExperimentReportConfigurationOutputsS3Configuration$: StaticStructureSchema = [3, n0, _ERCOSC,
  0,
  [_bN, _pr],
  [0, 0]
];
export var ExperimentReportError$: StaticStructureSchema = [3, n0, _ERE,
  0,
  [_co],
  [0]
];
export var ExperimentReportS3Report$: StaticStructureSchema = [3, n0, _ERSR,
  0,
  [_a, _rTep],
  [0, 0]
];
export var ExperimentReportState$: StaticStructureSchema = [3, n0, _ERS,
  0,
  [_sta, _re, _e],
  [0, 0, () => ExperimentReportError$]
];
export var ExperimentS3LogConfiguration$: StaticStructureSchema = [3, n0, _ESLC,
  0,
  [_bN, _pr],
  [0, 0]
];
export var ExperimentState$: StaticStructureSchema = [3, n0, _ES,
  0,
  [_sta, _re, _e],
  [0, 0, () => ExperimentError$]
];
...
export var ExperimentTarget$: StaticStructureSchema = [3, n0, _ET,
  0,
  [_rT, _rAe, _rTe, _f, _sM, _p],
  [0, 64 | 0, 128 | 0, () => ExperimentTargetFilterList, 0, 128 | 0]
];
export var ExperimentTargetAccountConfiguration$: StaticStructureSchema = [3, n0, _ETAC,
  0,
  [_rA, _aIc, _d],
  [0, 0, 0]
];
export var ExperimentTargetAccountConfigurationSummary$: StaticStructureSchema = [3, n0, _ETACS,
  0,
  [_rA, _aIc, _d],
  [0, 0, 0]
];
export var ExperimentTargetFilter$: StaticStructureSchema = [3, n0, _ETF,
  0,
  [_pa, _va],
  [0, 64 | 0]
];
export var ExperimentTemplate$: StaticStructureSchema = [3, n0, _ETx,
  0,
...
export var ExperimentTemplateAction$: StaticStructureSchema = [3, n0, _ETA,
  0,
  [_aI, _d, _p, _t, _sA],
  [0, 0, 128 | 0, 128 | 0, 64 | 0]
];
export var ExperimentTemplateCloudWatchLogsLogConfiguration$: StaticStructureSchema = [3, n0, _ETCWLLC,
  0,
  [_lGA],
  [0]
];
...
export var ExperimentTemplateLogConfiguration$: StaticStructureSchema = [3, n0, _ETLC,
  0,
  [_cWLC, _sC, _lSV],
  [() => ExperimentTemplateCloudWatchLogsLogConfiguration$, () => ExperimentTemplateS3LogConfiguration$, 1]
];
export var ExperimentTemplateReportConfiguration$: StaticStructureSchema = [3, n0, _ETRC,
  0,
  [_o, _dS, _pED, _pEDo],
  [() => ExperimentTemplateReportConfigurationOutputs$, () => ExperimentTemplateReportConfigurationDataSources$, 0, 0]
];
export var ExperimentTemplateReportConfigurationCloudWatchDashboard$: StaticStructureSchema = [3, n0, _ETRCCWD,
  0,
  [_dI],
  [0]
];
export var ExperimentTemplateReportConfigurationDataSources$: StaticStructureSchema = [3, n0, _ETRCDS,
  0,
  [_cWD],
  [() => ExperimentTemplateReportConfigurationCloudWatchDashboardList]
];
export var ExperimentTemplateReportConfigurationDataSourcesInput$: StaticStructureSchema = [3, n0, _ETRCDSI,
  0,
  [_cWD],
  [() => ReportConfigurationCloudWatchDashboardInputList]
];
export var ExperimentTemplateReportConfigurationOutputs$: StaticStructureSchema = [3, n0, _ETRCO,
  0,
  [_sC],
  [() => ReportConfigurationS3Output$]
];
export var ExperimentTemplateReportConfigurationOutputsInput$: StaticStructureSchema = [3, n0, _ETRCOI,
  0,
  [_sC],
  [() => ReportConfigurationS3OutputInput$]
];
export var ExperimentTemplateS3LogConfiguration$: StaticStructureSchema = [3, n0, _ETSLC,
  0,
  [_bN, _pr],
  [0, 0]
];
...
export var ExperimentTemplateTarget$: StaticStructureSchema = [3, n0, _ETT,
  0,
  [_rT, _rAe, _rTe, _f, _sM, _p],
  [0, 64 | 0, 128 | 0, () => ExperimentTemplateTargetFilterList, 0, 128 | 0]
];
export var ExperimentTemplateTargetFilter$: StaticStructureSchema = [3, n0, _ETTF,
  0,
  [_pa, _va],
  [0, 64 | 0]
];
...
export var ListExperimentTemplatesRequest$: StaticStructureSchema = [3, n0, _LETR,
  0,
  [_mR, _nT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListExperimentTemplatesResponse$: StaticStructureSchema = [3, n0, _LETRi,
  0,
  [_eTx, _nT],
...
export var ListTargetResourceTypesRequest$: StaticStructureSchema = [3, n0, _LTRTR,
  0,
  [_mR, _nT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListTargetResourceTypesResponse$: StaticStructureSchema = [3, n0, _LTRTRi,
  0,
  [_tRTa, _nT],
  [() => TargetResourceTypeSummaryList, 0]
];
export var ReportConfigurationCloudWatchDashboardInput$: StaticStructureSchema = [3, n0, _RCCWDI,
  0,
  [_dI],
  [0]
];
export var ReportConfigurationS3Output$: StaticStructureSchema = [3, n0, _RCSO,
  0,
  [_bN, _pr],
  [0, 0]
];
export var ReportConfigurationS3OutputInput$: StaticStructureSchema = [3, n0, _RCSOI,
  0,
  [_bN, _pr],
  [0, 0]
];
export var ResolvedTarget$: StaticStructureSchema = [3, n0, _RT,
  0,
  [_rT, _tN, _tI],
  [0, 0, 128 | 0]
];
...
export var SafetyLeverState$: StaticStructureSchema = [3, n0, _SLS,
  0,
  [_sta, _re],
  [0, 0]
];
...
export var TargetAccountConfiguration$: StaticStructureSchema = [3, n0, _TAC,
  0,
  [_rA, _aIc, _d],
  [0, 0, 0]
];
export var TargetAccountConfigurationSummary$: StaticStructureSchema = [3, n0, _TACS,
  0,
  [_rA, _aIc, _d],
  [0, 0, 0]
];
export var TargetResourceType$: StaticStructureSchema = [3, n0, _TRT,
  0,
  [_rT, _d, _p],
  [0, 0, () => TargetResourceTypeParameterMap]
];
export var TargetResourceTypeParameter$: StaticStructureSchema = [3, n0, _TRTP,
  0,
  [_d, _r],
  [0, 2]
];
export var TargetResourceTypeSummary$: StaticStructureSchema = [3, n0, _TRTS,
  0,
  [_rT, _d],
  [0, 0]
];
...
export var UpdateExperimentTemplateActionInputItem$: StaticStructureSchema = [3, n0, _UETAII,
  0,
  [_aI, _d, _p, _t, _sA],
  [0, 0, 128 | 0, 128 | 0, 64 | 0]
];
export var UpdateExperimentTemplateExperimentOptionsInput$: StaticStructureSchema = [3, n0, _UETEOI,
  0,
  [_eTRM],
  [0]
];
export var UpdateExperimentTemplateLogConfigurationInput$: StaticStructureSchema = [3, n0, _UETLCI,
  0,
  [_cWLC, _sC, _lSV],
  [() => ExperimentTemplateCloudWatchLogsLogConfigurationInput$, () => ExperimentTemplateS3LogConfigurationInput$, 1]
];
export var UpdateExperimentTemplateReportConfigurationInput$: StaticStructureSchema = [3, n0, _UETRCI,
  0,
  [_o, _dS, _pED, _pEDo],
  [() => ExperimentTemplateReportConfigurationOutputsInput$, () => ExperimentTemplateReportConfigurationDataSourcesInput$, 0, 0]
];
...
var CreateExperimentTemplateStopConditionInputList: StaticListSchema = [1, n0, _CETSCIL,
  0, () => CreateExperimentTemplateStopConditionInput$
];
var ExperimentActionStartAfterList = 64 | 0;
var ExperimentReportConfigurationCloudWatchDashboardList: StaticListSchema = [1, n0, _ERCCWDL,
  0, () => ExperimentReportConfigurationCloudWatchDashboard$
];
var ExperimentReportS3ReportList: StaticListSchema = [1, n0, _ERSRL,
  0, () => ExperimentReportS3Report$
];
var ExperimentStopConditionList: StaticListSchema = [1, n0, _ESCL,
  0, () => ExperimentStopCondition$
];
var ExperimentSummaryList: StaticListSchema = [1, n0, _ESL,
  0, () => ExperimentSummary$
];
var ExperimentTargetAccountConfigurationList: StaticListSchema = [1, n0, _ETACL,
  0, () => ExperimentTargetAccountConfigurationSummary$
];
var ExperimentTargetFilterList: StaticListSchema = [1, n0, _ETFL,
  0, () => ExperimentTargetFilter$
];
var ExperimentTargetFilterValues = 64 | 0;
var ExperimentTemplateActionStartAfterList = 64 | 0;
var ExperimentTemplateReportConfigurationCloudWatchDashboardList: StaticListSchema = [1, n0, _ETRCCWDL,
  0, () => ExperimentTemplateReportConfigurationCloudWatchDashboard$
];
var ExperimentTemplateStopConditionList: StaticListSchema = [1, n0, _ETSCL,
  0, () => ExperimentTemplateStopCondition$
];
var ExperimentTemplateSummaryList: StaticListSchema = [1, n0, _ETSL,
  0, () => ExperimentTemplateSummary$
];
var ExperimentTemplateTargetFilterInputList: StaticListSchema = [1, n0, _ETTFIL,
  0, () => ExperimentTemplateTargetInputFilter$
];
var ExperimentTemplateTargetFilterList: StaticListSchema = [1, n0, _ETTFL,
  0, () => ExperimentTemplateTargetFilter$
];
var ExperimentTemplateTargetFilterValues = 64 | 0;
var ReportConfigurationCloudWatchDashboardInputList: StaticListSchema = [1, n0, _RCCWDIL,
  0, () => ReportConfigurationCloudWatchDashboardInput$
];
var ResolvedTargetList: StaticListSchema = [1, n0, _RTL,
  0, () => ResolvedTarget$
];
var ResourceArnList = 64 | 0;
var TagKeyList = 64 | 0;
var TargetAccountConfigurationList: StaticListSchema = [1, n0, _TACL,
  0, () => TargetAccountConfigurationSummary$
];
var TargetResourceTypeSummaryList: StaticListSchema = [1, n0, _TRTSL,
  0, () => TargetResourceTypeSummary$
];
var UpdateExperimentTemplateStopConditionInputList: StaticListSchema = [1, n0, _UETSCIL,
  0, () => UpdateExperimentTemplateStopConditionInput$
];
var ActionParameterMap: StaticMapSchema = [2, n0, _APM,
  0, 0, () => ActionParameter$
];
var ActionTargetMap: StaticMapSchema = [2, n0, _ATM,
  0, 0, () => ActionTarget$
];
var CreateExperimentTemplateActionInputMap: StaticMapSchema = [2, n0, _CETAIM,
  0, 0, () => CreateExperimentTemplateActionInput$
];
var CreateExperimentTemplateTargetInputMap: StaticMapSchema = [2, n0, _CETTIM,
  0, 0, () => CreateExperimentTemplateTargetInput$
];
var ExperimentActionMap: StaticMapSchema = [2, n0, _EAM,
  0, 0, () => ExperimentAction$
];
var ExperimentActionParameterMap = 128 | 0;
var ExperimentActionTargetMap = 128 | 0;
var ExperimentTargetMap: StaticMapSchema = [2, n0, _ETM,
  0, 0, () => ExperimentTarget$
];
var ExperimentTargetParameterMap = 128 | 0;
var ExperimentTemplateActionMap: StaticMapSchema = [2, n0, _ETAM,
  0, 0, () => ExperimentTemplateAction$
];
var ExperimentTemplateActionParameterMap = 128 | 0;
var ExperimentTemplateActionTargetMap = 128 | 0;
var ExperimentTemplateTargetMap: StaticMapSchema = [2, n0, _ETTM,
  0, 0, () => ExperimentTemplateTarget$
];
var ExperimentTemplateTargetParameterMap = 128 | 0;
var TagMap = 128 | 0;
var TargetInformationMap = 128 | 0;
var TargetResourceTypeParameterMap: StaticMapSchema = [2, n0, _TRTPM,
  0, 0, () => TargetResourceTypeParameter$
];
var UpdateExperimentTemplateActionInputMap: StaticMapSchema = [2, n0, _UETAIM,
  0, 0, () => UpdateExperimentTemplateActionInputItem$
];
var UpdateExperimentTemplateTargetInputMap: StaticMapSchema = [2, n0, _UETTIM,
  0, 0, () => UpdateExperimentTemplateTargetInput$
];
export var CreateExperimentTemplate$: StaticOperationSchema = [9, n0, _CET,
  { [_h]: ["POST", "/experimentTemplates", 200] }, () => CreateExperimentTemplateRequest$, () => CreateExperimentTemplateResponse$
];
export var CreateTargetAccountConfiguration$: StaticOperationSchema = [9, n0, _CTAC,
...
export var DeleteExperimentTemplate$: StaticOperationSchema = [9, n0, _DET,
  { [_h]: ["DELETE", "/experimentTemplates/{id}", 200] }, () => DeleteExperimentTemplateRequest$, () => DeleteExperimentTemplateResponse$
];
export var DeleteTargetAccountConfiguration$: StaticOperationSchema = [9, n0, _DTAC,
...
export var GetExperiment$: StaticOperationSchema = [9, n0, _GE,
  { [_h]: ["GET", "/experiments/{id}", 200] }, () => GetExperimentRequest$, () => GetExperimentResponse$
];
export var GetExperimentTargetAccountConfiguration$: StaticOperationSchema = [9, n0, _GETAC,
...
export var GetExperimentTemplate$: StaticOperationSchema = [9, n0, _GET,
  { [_h]: ["GET", "/experimentTemplates/{id}", 200] }, () => GetExperimentTemplateRequest$, () => GetExperimentTemplateResponse$
];
export var GetSafetyLever$: StaticOperationSchema = [9, n0, _GSL,
  { [_h]: ["GET", "/safetyLevers/{id}", 200] }, () => GetSafetyLeverRequest$, () => GetSafetyLeverResponse$
];
export var GetTargetAccountConfiguration$: StaticOperationSchema = [9, n0, _GTAC,
...
export var GetTargetResourceType$: StaticOperationSchema = [9, n0, _GTRT,
...
export var ListExperimentResolvedTargets$: StaticOperationSchema = [9, n0, _LERT,
...
export var ListExperiments$: StaticOperationSchema = [9, n0, _LE,
  { [_h]: ["GET", "/experiments", 200] }, () => ListExperimentsRequest$, () => ListExperimentsResponse$
];
export var ListExperimentTargetAccountConfigurations$: StaticOperationSchema = [9, n0, _LETAC,
...
export var ListExperimentTemplates$: StaticOperationSchema = [9, n0, _LET,
...
export var ListTargetAccountConfigurations$: StaticOperationSchema = [9, n0, _LTAC,
...
export var ListTargetResourceTypes$: StaticOperationSchema = [9, n0, _LTRT,
  { [_h]: ["GET", "/targetResourceTypes", 200] }, () => ListTargetResourceTypesRequest$, () => ListTargetResourceTypesResponse$
];
export var StartExperiment$: StaticOperationSchema = [9, n0, _SE,
  { [_h]: ["POST", "/experiments", 200] }, () => StartExperimentRequest$, () => StartExperimentResponse$
];
export var StopExperiment$: StaticOperationSchema = [9, n0, _SEt,
...
export var UpdateExperimentTemplate$: StaticOperationSchema = [9, n0, _UET,
  { [_h]: ["PATCH", "/experimentTemplates/{id}", 200] }, () => UpdateExperimentTemplateRequest$, () => UpdateExperimentTemplateResponse$
];
export var UpdateSafetyLeverState$: StaticOperationSchema = [9, n0, _USLS,
  { [_h]: ["PATCH", "/safetyLevers/{id}/state", 200] }, () => UpdateSafetyLeverStateRequest$, () => UpdateSafetyLeverStateResponse$
];
export var UpdateTargetAccountConfiguration$: StaticOperationSchema = [9, n0, _UTAC,
