...
import { type FisClientResolvedConfig, FisClientConfig } from "../FisClient";
 ...
 * @internal
 */
export const defaultFisHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: FisHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultFisHttpAuthSchemeProvider: FisHttpAuthSchemeProvider = (authParameters) => {
