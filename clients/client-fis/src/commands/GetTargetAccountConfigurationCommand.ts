 ...
 * @public
 */
export class GetTargetAccountConfigurationCommand extends command<GetTargetAccountConfigurationCommandInput, GetTargetAccountConfigurationCommandOutput>(
  _ep0,
  _mw0,
