...
export type ListExperimentTemplatesCommandInput = ListExperimentTemplatesRequest;
export type ListExperimentTemplatesCommandOutput = ListExperimentTemplatesResponse & __MetadataBearer;
