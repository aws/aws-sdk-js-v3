...
export var ListApplicationsOutput$: StaticStructureSchema = [3, n0, _LAO,
  0,
  [_It, _NT],
  [() => ApplicationSummaryList, 0]
];
export var ListStreamGroupsInput$: StaticStructureSchema = [3, n0, _LSGI,
  0,
  [_NT, _MR],
  [[0, { [_hQ]: _NT }], [1, { [_hQ]: _MR }]]
];
export var ListStreamGroupsOutput$: StaticStructureSchema = [3, n0, _LSGO,
  0,
  [_It, _NT],
  [() => StreamGroupSummaryList, 0]
];
export var ListStreamSessionsByAccountInput$: StaticStructureSchema = [3, n0, _LSSBAI,
  0,
  [_S, _EFS, _NT, _MR],
...
var LocationStates: StaticListSchema = [1, n0, _LS,
  0, () => LocationState$
];
...
var Tags = 128 | 0;
export var AddStreamGroupLocations$: StaticOperationSchema = [9, n0, _ASGL,
  { [_h]: ["POST", "/streamgroups/{Identifier}/locations", 200] }, () => AddStreamGroupLocationsInput$, () => AddStreamGroupLocationsOutput$
];
export var AssociateApplications$: StaticOperationSchema = [9, n0, _AAss,
...
export var DeleteStreamGroup$: StaticOperationSchema = [9, n0, _DSG,
...
export var ExportStreamSessionFiles$: StaticOperationSchema = [9, n0, _ESSF,
...
export var GetStreamGroup$: StaticOperationSchema = [9, n0, _GSG,
...
export var TerminateStreamSession$: StaticOperationSchema = [9, n0, _TSS,
...
export var UpdateStreamGroup$: StaticOperationSchema = [9, n0, _USG,
