...
import {
  deserializeAws_restJson1_1PutLexiconCommand,
  serializeAws_restJson1_1PutLexiconCommand,
...
export type PutLexiconCommandOutput = PutLexiconOutput;
...
export class PutLexiconCommand extends $Command<PutLexiconCommandInput, PutLexiconCommandOutput, PollyClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1PutLexiconCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1PutLexiconCommand(output, context);
  }
