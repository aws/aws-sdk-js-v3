...
import {
  ...
  serializeAws_restJson1_1SynthesizeSpeechCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1SynthesizeSpeechCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1SynthesizeSpeechCommand(output, context);
  }
