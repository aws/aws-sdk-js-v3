...
import {
  ...
  defaultInspectorScanHttpAuthSchemeParametersProvider,
  resolveHttpAuthSchemeConfig,
} from "./auth/httpAuthSchemeProvider";
import type { ScanSbomCommandInput, ScanSbomCommandOutput } from "./commands/ScanSbomCommand";
import {
 ...
 * @public
 */
export type InspectorScanClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type InspectorScanClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<InspectorScanClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultInspectorScanHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: InspectorScanClientResolvedConfig) =>
