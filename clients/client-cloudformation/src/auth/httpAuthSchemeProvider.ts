...
import { type CloudFormationClientResolvedConfig, CloudFormationClientConfig } from "../CloudFormationClient";
 ...
 * @internal
 */
export const defaultCloudFormationHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CloudFormationHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<CloudFormationClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultCloudFormationHttpAuthSchemeProvider: CloudFormationHttpAuthSchemeProvider = (authParameters) => {
