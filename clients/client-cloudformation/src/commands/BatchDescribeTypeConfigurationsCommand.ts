 ...
 * @public
 */
export class BatchDescribeTypeConfigurationsCommand extends command<BatchDescribeTypeConfigurationsCommandInput, BatchDescribeTypeConfigurationsCommandOutput>(
  _ep0,
  _mw0,
