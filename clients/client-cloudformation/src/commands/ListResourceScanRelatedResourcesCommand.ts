 ...
 * @public
 */
export class ListResourceScanRelatedResourcesCommand extends command<ListResourceScanRelatedResourcesCommandInput, ListResourceScanRelatedResourcesCommandOutput>(
  _ep0,
  _mw0,
