...
export var Activity$: StaticStructureSchema = [3, n0, _Ac,
  0,
...
export var DescribeActivitiesResponse$: StaticStructureSchema = [3, n0, _DARe,
  0,
  [_UA, _Ma],
  [[() => UserActivities, 0], 0]
];
...
export var DocumentVersionMetadata$: StaticStructureSchema = [3, n0, _DVM,
  0,
...
export var FolderMetadata$: StaticStructureSchema = [3, n0, _FM,
  0,
...
export var GetResourcesRequest$: StaticStructureSchema = [3, n0, _GRR,
  0,
  [_AT, _UI, _CTol, _Li, _Ma],
  [[() => AuthenticationHeaderType, { [_hH]: _A }], [0, { [_hQ]: _uI }], [0, { [_hQ]: _cT }], [1, { [_hQ]: _li }], [0, { [_hQ]: _m }]]
];
export var GetResourcesResponse$: StaticStructureSchema = [3, n0, _GRRe,
  0,
  [_Fo, _D, _Ma],
  [[() => FolderMetadataList, 0], [() => DocumentMetadataList, 0], 0]
];
export var GroupMetadata$: StaticStructureSchema = [3, n0, _GM,
  0,
  [_Id, _N],
  [0, 0]
];
...
export var InitiateDocumentVersionUploadResponse$: StaticStructureSchema = [3, n0, _IDVURn,
  0,
  [_Me, _UM],
...
export var NotificationOptions$: StaticStructureSchema = [3, n0, _NO,
  0,
  [_SE, _EM],
  [2, [() => MessageType, 0]]
];
export var Participants$: StaticStructureSchema = [3, n0, _P,
  0,
  [_Use, _G],
  [[() => UserMetadataList, 0], () => GroupMetadataList]
];
export var PermissionInfo$: StaticStructureSchema = [3, n0, _PIe,
  0,
  [_R, _T],
  [0, 0]
];
...
export var ResourcePath$: StaticStructureSchema = [3, n0, _RP,
  0,
  [_Comp],
  [[() => ResourcePathComponentList, 0]]
];
export var ResourcePathComponent$: StaticStructureSchema = [3, n0, _RPC,
  0,
  [_Id, _N],
  [0, [() => ResourceNameType, 0]]
];
export var ResponseItem$: StaticStructureSchema = [3, n0, _RIes,
  0,
...
export var SearchResourcesResponse$: StaticStructureSchema = [3, n0, _SRRe,
  0,
  [_It, _Ma],
  [[() => ResponseItemsList, 0], 0]
];
export var SearchSortResult$: StaticStructureSchema = [3, n0, _SSR,
  0,
  [_Fie, _O],
  [0, 0]
];
...
export var UserMetadata$: StaticStructureSchema = [3, n0, _UMs,
  0,
  [_Id, _Us, _GN, _Sur, _EA],
  [0, [() => UsernameType, 0], [() => UserAttributeValueType, 0], [() => UserAttributeValueType, 0], [() => EmailAddressType, 0]]
];
export var UserStorageMetadata$: StaticStructureSchema = [3, n0, _USM,
  0,
  [_SUIB, _SRt],
  [1, () => StorageRuleType$]
];
...
var DocumentMetadataList: StaticListSchema = [1, n0, _DML,
  0, [() => DocumentMetadata$,
    0]
];
var DocumentVersionMetadataList: StaticListSchema = [1, n0, _DVML,
  0, [() => DocumentVersionMetadata$,
    0]
];
var EntityIdList = 64 | 0;
var FolderMetadataList: StaticListSchema = [1, n0, _FML,
  0, [() => FolderMetadata$,
    0]
];
var GroupMetadataList: StaticListSchema = [1, n0, _GML,
  0, () => GroupMetadata$
];
var OrganizationUserList: StaticListSchema = [1, n0, _OUL,
  0, [() => User$,
    0]
];
var PermissionInfoList: StaticListSchema = [1, n0, _PIL,
  0, () => PermissionInfo$
];
var PrincipalList: StaticListSchema = [1, n0, _PL,
  0, () => Principal$
];
var ResourcePathComponentList: StaticListSchema = [1, n0, _RPCL,
  0, [() => ResourcePathComponent$,
    0]
];
var ResponseItemsList: StaticListSchema = [1, n0, _RIL,
  0, [() => ResponseItem$,
    0]
];
...
var SearchPrincipalTypeList: StaticListSchema = [1, n0, _SPTL,
  0, () => SearchPrincipalType$
];
var SearchQueryScopeTypeList = 64 | 0;
var SearchResourceTypeList = 64 | 0;
var SearchResultSortList: StaticListSchema = [1, n0, _SRSL,
  0, () => SearchSortResult$
];
var SharedLabels = 64 | 0;
var SharePrincipalList: StaticListSchema = [1, n0, _SPL,
  0, () => SharePrincipal$
];
var ShareResultsList: StaticListSchema = [1, n0, _SRL,
  0, [() => ShareResult$,
    0]
];
...
var UserActivities: StaticListSchema = [1, n0, _UA,
  0, [() => Activity$,
    0]
];
var UserMetadataList: StaticListSchema = [1, n0, _UML,
  0, [() => UserMetadata$,
    0]
];
var CustomMetadataMap = 128 | 0;
var DocumentSourceUrlMap: StaticMapSchema = [2, n0, _DSUM,
  0, [0,
    0]
  , [() => UrlType,
    0]
];
var DocumentThumbnailUrlMap: StaticMapSchema = [2, n0, _DTUM,
  0, [0,
    0]
  , [() => UrlType,
    0]
...
export var DescribeResourcePermissions$: StaticOperationSchema = [9, n0, _DRP,
...
export var DescribeRootFolders$: StaticOperationSchema = [9, n0, _DRF,
...
export var UpdateDocumentVersion$: StaticOperationSchema = [9, n0, _UDV,
  { [_h]: ["PATCH", "/api/v1/documents/{DocumentId}/versions/{VersionId}", 200] }, () => UpdateDocumentVersionRequest$, () => __Unit
];
export var UpdateFolder$: StaticOperationSchema = [9, n0, _UF,
  { [_h]: ["PATCH", "/api/v1/folders/{FolderId}", 200] }, () => UpdateFolderRequest$, () => __Unit
];
export var UpdateUser$: StaticOperationSchema = [9, n0, _UUp,
