...
import type { WorkDocsHttpAuthSchemeProvider } from "./httpAuthSchemeProvider";
...
export interface HttpAuthExtensionConfiguration {
  ...
  setHttpAuthSchemeProvider(httpAuthSchemeProvider: WorkDocsHttpAuthSchemeProvider): void;
