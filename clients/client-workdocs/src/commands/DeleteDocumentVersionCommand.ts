...
import type { DeleteDocumentVersionRequest } from "../models/models_0";
 ...
 * @public
 */
export class DeleteDocumentVersionCommand extends command<DeleteDocumentVersionCommandInput, DeleteDocumentVersionCommandOutput>(
  _ep0,
  _mw0,
