 ...
 * @public
 */
export class CreateNotificationSubscriptionCommand extends command<CreateNotificationSubscriptionCommandInput, CreateNotificationSubscriptionCommandOutput>(
  _ep0,
  _mw0,
