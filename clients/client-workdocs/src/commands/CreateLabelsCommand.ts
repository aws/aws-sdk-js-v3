...
import type { CreateLabelsRequest, CreateLabelsResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateLabelsCommand extends command<CreateLabelsCommandInput, CreateLabelsCommandOutput>(
  _ep0,
  _mw0,
  "CreateLabels",
  CreateLabels$
