...
import type { GetDocumentPathRequest, GetDocumentPathResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetDocumentPathCommand extends command<GetDocumentPathCommandInput, GetDocumentPathCommandOutput>(
  _ep0,
  _mw0,
  "GetDocumentPath",
  GetDocumentPath$
