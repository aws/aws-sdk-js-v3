...
import type { GetCurrentUserRequest, GetCurrentUserResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetCurrentUserCommand extends command<GetCurrentUserCommandInput, GetCurrentUserCommandOutput>(
  _ep0,
  _mw0,
  "GetCurrentUser",
  GetCurrentUser$
