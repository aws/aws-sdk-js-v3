...
import type { DeleteFolderRequest } from "../models/models_0";
 ...
 * @public
 */
export class DeleteFolderCommand extends command<DeleteFolderCommandInput, DeleteFolderCommandOutput>(
  _ep0,
  _mw0,
  "DeleteFolder",
  DeleteFolder$
