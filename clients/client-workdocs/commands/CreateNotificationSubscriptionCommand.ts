...
export class CreateNotificationSubscriptionCommand extends $Command<CreateNotificationSubscriptionCommandInput, CreateNotificationSubscriptionCommandOutput, WorkDocsClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1CreateNotificationSubscriptionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateNotificationSubscriptionCommand(output, context);
  }
