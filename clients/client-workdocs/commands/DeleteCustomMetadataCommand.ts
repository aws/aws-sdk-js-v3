...
import {
  deserializeAws_restJson1_1DeleteCustomMetadataCommand,
  serializeAws_restJson1_1DeleteCustomMetadataCommand,
...
export class DeleteCustomMetadataCommand extends $Command<DeleteCustomMetadataCommandInput, DeleteCustomMetadataCommandOutput, WorkDocsClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteCustomMetadataCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DeleteCustomMetadataCommand(output, context);
  }
