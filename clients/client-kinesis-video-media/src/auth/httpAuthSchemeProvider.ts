...
import { type KinesisVideoMediaClientResolvedConfig, KinesisVideoMediaClientConfig } from "../KinesisVideoMediaClient";
 ...
 * @internal
 */
export const defaultKinesisVideoMediaHttpAuthSchemeProvider: KinesisVideoMediaHttpAuthSchemeProvider = (authParameters) => {
