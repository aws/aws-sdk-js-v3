 ...
 * @public
 */
export class CreateMediaLiveConnectorPipelineCommand extends command<CreateMediaLiveConnectorPipelineCommandInput, CreateMediaLiveConnectorPipelineCommandOutput>(
  _ep0,
  _mw0,
