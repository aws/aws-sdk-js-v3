 ...
 * @public
 */
export class ListMediaPipelineKinesisVideoStreamPoolsCommand extends command<ListMediaPipelineKinesisVideoStreamPoolsCommandInput, ListMediaPipelineKinesisVideoStreamPoolsCommandOutput>(
  _ep0,
  _mw0,
