 ...
 * ```
 *
 * @param GetMediaInsightsPipelineConfigurationRequest - {@link GetMediaInsightsPipelineConfigurationRequest}
 * @returns {@link GetMediaInsightsPipelineConfigurationResponse}
