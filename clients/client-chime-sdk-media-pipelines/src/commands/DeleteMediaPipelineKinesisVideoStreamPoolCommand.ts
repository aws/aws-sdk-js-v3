 ...
 * @public
 */
export class DeleteMediaPipelineKinesisVideoStreamPoolCommand extends command<DeleteMediaPipelineKinesisVideoStreamPoolCommandInput, DeleteMediaPipelineKinesisVideoStreamPoolCommandOutput>(
  _ep0,
  _mw0,
