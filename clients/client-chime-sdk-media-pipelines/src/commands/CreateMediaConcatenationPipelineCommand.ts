 ...
 * @public
 */
export class CreateMediaConcatenationPipelineCommand extends command<CreateMediaConcatenationPipelineCommandInput, CreateMediaConcatenationPipelineCommandOutput>(
  _ep0,
  _mw0,
