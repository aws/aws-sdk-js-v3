...
export var ActiveSpeakerOnlyConfiguration$: StaticStructureSchema = [3, n0, _ASOC, 0, [_ASP], [0]];
export var AmazonTranscribeCallAnalyticsProcessorConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _ATCAPC,
  0,
...
export var AmazonTranscribeProcessorConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _ATPC,
  0,
...
export var ArtifactsConcatenationConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _ACC,
  0,
...
export var ArtifactsConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _AC,
  0,
...
export var ChimeSdkMeetingConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _CSMC,
  0,
...
export var ChimeSdkMeetingLiveConnectorConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _CSMLCC,
  0,
...
export var CompositedVideoArtifactsConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _CVAC,
  0,
...
export var CompositedVideoConcatenationConfiguration$: StaticStructureSchema = [3, n0, _CVCC, 0, [_S], [0]];
export var ConcatenationSink$: StaticStructureSchema = [
  3,
  n0,
  _CS,
  0,
...
export var ConcatenationSource$: StaticStructureSchema = [
  3,
  n0,
  _CSo,
  0,
...
export var CreateMediaCapturePipelineResponse$: StaticStructureSchema = [
  3,
  n0,
  _CMCPRr,
  0,
...
export var CreateMediaConcatenationPipelineRequest$: StaticStructureSchema = [
  3,
  n0,
  _CMCPRre,
  0,
...
export var CreateMediaConcatenationPipelineResponse$: StaticStructureSchema = [
  3,
  n0,
  _CMCPRrea,
  0,
...
export var CreateMediaInsightsPipelineConfigurationRequest$: StaticStructureSchema = [
  3,
  n0,
  _CMIPCR,
  0,
...
export var CreateMediaInsightsPipelineConfigurationResponse$: StaticStructureSchema = [
  3,
  n0,
  _CMIPCRr,
  0,
...
export var CreateMediaInsightsPipelineRequest$: StaticStructureSchema = [
  3,
  n0,
  _CMIPR,
  0,
...
export var CreateMediaInsightsPipelineResponse$: StaticStructureSchema = [
  3,
  n0,
  _CMIPRr,
  0,
...
export var CreateMediaLiveConnectorPipelineRequest$: StaticStructureSchema = [
  3,
  n0,
  _CMLCPR,
  0,
...
export var CreateMediaLiveConnectorPipelineResponse$: StaticStructureSchema = [
  3,
  n0,
  _CMLCPRr,
  0,
...
export var CreateMediaPipelineKinesisVideoStreamPoolRequest$: StaticStructureSchema = [
  3,
  n0,
  _CMPKVSPR,
  0,
...
export var CreateMediaPipelineKinesisVideoStreamPoolResponse$: StaticStructureSchema = [
  3,
  n0,
  _CMPKVSPRr,
  0,
...
export var CreateMediaStreamPipelineRequest$: StaticStructureSchema = [
  3,
  n0,
  _CMSPR,
  0,
...
export var CreateMediaStreamPipelineResponse$: StaticStructureSchema = [
  3,
  n0,
  _CMSPRr,
  0,
...
export var DataChannelConcatenationConfiguration$: StaticStructureSchema = [3, n0, _DCCC, 0, [_S], [0]];
export var DeleteMediaCapturePipelineRequest$: StaticStructureSchema = [3, n0, _DMCPR, 0, [_MPI], [[0, 1]]];
export var DeleteMediaInsightsPipelineConfigurationRequest$: StaticStructureSchema = [
  3,
  n0,
  _DMIPCR,
  0,
...
export var DeleteMediaPipelineKinesisVideoStreamPoolRequest$: StaticStructureSchema = [
  3,
  n0,
  _DMPKVSPR,
  0,
...
export var GetMediaInsightsPipelineConfigurationRequest$: StaticStructureSchema = [3, n0, _GMIPCR, 0, [_I], [[0, 1]]];
export var GetMediaInsightsPipelineConfigurationResponse$: StaticStructureSchema = [
  3,
  n0,
  _GMIPCRe,
  0,
...
export var GetMediaPipelineKinesisVideoStreamPoolRequest$: StaticStructureSchema = [
  3,
  n0,
  _GMPKVSPR,
  0,
...
export var GetMediaPipelineKinesisVideoStreamPoolResponse$: StaticStructureSchema = [
  3,
  n0,
  _GMPKVSPRe,
  0,
...
export var GetMediaPipelineRequest$: StaticStructureSchema = [3, n0, _GMPR, 0, [_MPI], [[0, 1]]];
export var GetMediaPipelineResponse$: StaticStructureSchema = [3, n0, _GMPRe, 0, [_MP], [[() => MediaPipeline$, 0]]];
...
export var GridViewConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _GVC,
  0,
...
export var HorizontalLayoutConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _HLC,
  0,
...
export var IssueDetectionConfiguration$: StaticStructureSchema = [3, n0, _IDC, 0, [_RN], [0]];
export var KeywordMatchConfiguration$: StaticStructureSchema = [3, n0, _KMC, 0, [_RN, _K, _N], [0, 64 | 0, 2]];
export var KinesisDataStreamSinkConfiguration$: StaticStructureSchema = [3, n0, _KDSSC, 0, [_IT], [[() => Arn, 0]]];
export var KinesisVideoStreamConfiguration$: StaticStructureSchema = [3, n0, _KVSC, 0, [_Re, _DRIH], [0, 1]];
export var KinesisVideoStreamConfigurationUpdate$: StaticStructureSchema = [3, n0, _KVSCU, 0, [_DRIH], [1]];
export var KinesisVideoStreamPoolConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _KVSPC,
  0,
...
export var KinesisVideoStreamPoolSummary$: StaticStructureSchema = [
  3,
  n0,
  _KVSPS,
  0,
...
export var KinesisVideoStreamRecordingSourceRuntimeConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _KVSRSRC,
  0,
...
export var KinesisVideoStreamSourceRuntimeConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _KVSSRC,
  0,
...
export var KinesisVideoStreamSourceTaskConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _KVSSTC,
  0,
...
export var LambdaFunctionSinkConfiguration$: StaticStructureSchema = [3, n0, _LFSC, 0, [_IT], [[() => Arn, 0]]];
export var ListMediaCapturePipelinesRequest$: StaticStructureSchema = [
  3,
  n0,
  _LMCPR,
  0,
...
export var ListMediaInsightsPipelineConfigurationsRequest$: StaticStructureSchema = [
  3,
  n0,
  _LMIPCR,
  0,
...
export var ListMediaPipelineKinesisVideoStreamPoolsRequest$: StaticStructureSchema = [
  3,
  n0,
  _LMPKVSPR,
  0,
...
export var ListMediaPipelinesRequest$: StaticStructureSchema = [
  3,
  n0,
  _LMPR,
  0,
...
export var LiveConnectorSinkConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _LCSC,
  0,
...
export var LiveConnectorSourceConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _LCSCi,
  0,
...
export var MediaCapturePipeline$: StaticStructureSchema = [
  3,
  n0,
  _MCP,
  0,
...
export var MediaCapturePipelineSourceConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _MCPSC,
  0,
...
export var MediaCapturePipelineSummary$: StaticStructureSchema = [3, n0, _MCPS, 0, [_MPI, _MPA], [0, 0]];
export var MediaConcatenationPipeline$: StaticStructureSchema = [
  3,
  n0,
  _MCPe,
  0,
...
export var MediaInsightsPipeline$: StaticStructureSchema = [
  3,
  n0,
  _MIP,
  0,
...
export var MediaInsightsPipelineConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _MIPC,
  0,
...
export var MediaInsightsPipelineConfigurationElement$: StaticStructureSchema = [
  3,
  n0,
  _MIPCE,
  0,
...
export var MediaInsightsPipelineConfigurationSummary$: StaticStructureSchema = [
  3,
  n0,
  _MIPCS,
  0,
...
export var MediaInsightsPipelineElementStatus$: StaticStructureSchema = [3, n0, _MIPES, 0, [_T, _Sta], [0, 0]];
export var MediaLiveConnectorPipeline$: StaticStructureSchema = [
  3,
  n0,
  _MLCP,
  0,
...
export var MediaPipeline$: StaticStructureSchema = [
  3,
  n0,
  _MP,
  0,
...
export var MediaPipelineSummary$: StaticStructureSchema = [3, n0, _MPS, 0, [_MPI, _MPA], [0, 0]];
export var MediaStreamPipeline$: StaticStructureSchema = [
  3,
  n0,
  _MSP,
  0,
...
export var MediaStreamSink$: StaticStructureSchema = [
  3,
  n0,
  _MSS,
  0,
...
export var PresenterOnlyConfiguration$: StaticStructureSchema = [3, n0, _POC, 0, [_PP], [0]];
export var RealTimeAlertConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _RTAC,
  0,
...
export var RealTimeAlertRule$: StaticStructureSchema = [
  3,
  n0,
  _RTAR,
  0,
...
export var RecordingStreamConfiguration$: StaticStructureSchema = [3, n0, _RSCe, 0, [_SAt], [0]];
...
export var SelectedVideoStreams$: StaticStructureSchema = [
  3,
  n0,
  _SVS,
  0,
...
export var SentimentConfiguration$: StaticStructureSchema = [3, n0, _SCe, 0, [_RN, _STe, _TPi], [0, 0, 1]];
...
export var SqsQueueSinkConfiguration$: StaticStructureSchema = [3, n0, _SQSC, 0, [_IT], [[() => Arn, 0]]];
export var SseAwsKeyManagementParams$: StaticStructureSchema = [3, n0, _SAKMP, 0, [_AKKI, _AKEC], [0, 0]];
...
export var StreamChannelDefinition$: StaticStructureSchema = [
  3,
  n0,
  _SCD,
  0,
...
export var StreamConfiguration$: StaticStructureSchema = [
  3,
  n0,
  _SCt,
  0,
...
export var Tag$: StaticStructureSchema = [3, n0, _Tag, 0, [_Ke, _Va], [0, 0]];
...
export var UpdateMediaInsightsPipelineConfigurationResponse$: StaticStructureSchema = [
  3,
  n0,
  _UMIPCRp,
  0,
...
export var UpdateMediaInsightsPipelineStatusRequest$: StaticStructureSchema = [
  3,
  n0,
  _UMIPSR,
  0,
...
export var UpdateMediaPipelineKinesisVideoStreamPoolRequest$: StaticStructureSchema = [
  3,
  n0,
  _UMPKVSPR,
  0,
...
export var UpdateMediaPipelineKinesisVideoStreamPoolResponse$: StaticStructureSchema = [
  3,
  n0,
  _UMPKVSPRp,
  0,
...
export var VerticalLayoutConfiguration$: StaticStructureSchema = [3, n0, _VLC, 0, [_TO, _TP, _TC, _TAR], [0, 0, 1, 0]];
export var VideoArtifactsConfiguration$: StaticStructureSchema = [3, n0, _VAC, 0, [_S, _MT], [0, 0]];
export var VideoAttribute$: StaticStructureSchema = [3, n0, _VA, 0, [_CR, _BC, _HC, _BT], [1, 0, 0, 1]];
export var VideoConcatenationConfiguration$: StaticStructureSchema = [3, n0, _VCC, 0, [_S], [0]];
export var VoiceAnalyticsProcessorConfiguration$: StaticStructureSchema = [3, n0, _VAPC, 0, [_SSS, _VTAS], [0, 0]];
...
var ConcatenationSinkList: StaticListSchema = [1, n0, _CSLo, 0, [() => ConcatenationSink$, 0]];
var ConcatenationSourceList: StaticListSchema = [1, n0, _CSLon, 0, [() => ConcatenationSource$, 0]];
var ExternalUserIdList: StaticListSchema = [1, n0, _EUIL, 0, [() => ExternalUserIdType, 0]];
var KeywordMatchWordList = 64 | 0;
var KinesisVideoStreamPoolSummaryList: StaticListSchema = [
  1,
  n0,
  _KVSPSL,
  0,
...
var LiveConnectorSinkList: StaticListSchema = [1, n0, _LCSL, 0, [() => LiveConnectorSinkConfiguration$, 0]];
var LiveConnectorSourceList: StaticListSchema = [1, n0, _LCSLi, 0, [() => LiveConnectorSourceConfiguration$, 0]];
var MediaCapturePipelineSummaryList: StaticListSchema = [1, n0, _MCPSL, 0, () => MediaCapturePipelineSummary$];
var MediaInsightsPipelineConfigurationElements: StaticListSchema = [
  1,
  n0,
  _MIPCEe,
  0,
...
var MediaInsightsPipelineConfigurationSummaryList: StaticListSchema = [
  1,
  n0,
  _MIPCSL,
  0,
...
var MediaInsightsPipelineElementStatuses: StaticListSchema = [
  1,
  n0,
  _MIPESe,
  0,
...
var MediaPipelineList: StaticListSchema = [1, n0, _MPL, 0, () => MediaPipelineSummary$];
var MediaStreamSinkList: StaticListSchema = [1, n0, _MSSL, 0, [() => MediaStreamSink$, 0]];
var MediaStreamSourceList: StaticListSchema = [1, n0, _MSSLe, 0, [() => MediaStreamSource$, 0]];
var RealTimeAlertRuleList: StaticListSchema = [1, n0, _RTARL, 0, () => RealTimeAlertRule$];
var RecordingStreamList: StaticListSchema = [1, n0, _RSL, 0, () => RecordingStreamConfiguration$];
var Streams: StaticListSchema = [1, n0, _St, 0, () => StreamConfiguration$];
var TagKeyList = 64 | 0;
var TagList: StaticListSchema = [1, n0, _TL, 0, () => Tag$];
var MediaInsightsRuntimeMetadata: StaticMapSchema = [2, n0, _MIRM, 8, 0, 0];
...
export var CreateMediaConcatenationPipeline$: StaticOperationSchema = [
  9,
  n0,
  _CMCPr,
...
export var CreateMediaInsightsPipeline$: StaticOperationSchema = [
  9,
  n0,
  _CMIP,
...
export var CreateMediaInsightsPipelineConfiguration$: StaticOperationSchema = [
  9,
  n0,
  _CMIPC,
...
export var CreateMediaLiveConnectorPipeline$: StaticOperationSchema = [
  9,
  n0,
  _CMLCP,
...
export var CreateMediaPipelineKinesisVideoStreamPool$: StaticOperationSchema = [
  9,
  n0,
  _CMPKVSP,
...
export var CreateMediaStreamPipeline$: StaticOperationSchema = [
  9,
  n0,
  _CMSP,
...
export var DeleteMediaCapturePipeline$: StaticOperationSchema = [
  9,
  n0,
  _DMCP,
...
export var DeleteMediaInsightsPipelineConfiguration$: StaticOperationSchema = [
  9,
  n0,
  _DMIPC,
...
export var DeleteMediaPipeline$: StaticOperationSchema = [
  9,
  n0,
  _DMP,
...
export var DeleteMediaPipelineKinesisVideoStreamPool$: StaticOperationSchema = [
  9,
  n0,
  _DMPKVSP,
...
export var GetMediaCapturePipeline$: StaticOperationSchema = [
  9,
  n0,
  _GMCP,
...
export var GetMediaInsightsPipelineConfiguration$: StaticOperationSchema = [
  9,
  n0,
  _GMIPC,
...
export var GetMediaPipeline$: StaticOperationSchema = [
  9,
  n0,
  _GMP,
...
export var GetMediaPipelineKinesisVideoStreamPool$: StaticOperationSchema = [
  9,
  n0,
  _GMPKVSP,
...
export var ListMediaCapturePipelines$: StaticOperationSchema = [
  9,
  n0,
  _LMCP,
...
export var ListMediaInsightsPipelineConfigurations$: StaticOperationSchema = [
  9,
  n0,
  _LMIPC,
...
export var ListMediaPipelineKinesisVideoStreamPools$: StaticOperationSchema = [
  9,
  n0,
  _LMPKVSP,
...
export var ListMediaPipelines$: StaticOperationSchema = [
  9,
  n0,
  _LMP,
...
export var UpdateMediaInsightsPipelineConfiguration$: StaticOperationSchema = [
  9,
  n0,
  _UMIPC,
...
export var UpdateMediaInsightsPipelineStatus$: StaticOperationSchema = [
  9,
  n0,
  _UMIPS,
...
export var UpdateMediaPipelineKinesisVideoStreamPool$: StaticOperationSchema = [
  9,
  n0,
  _UMPKVSP,
