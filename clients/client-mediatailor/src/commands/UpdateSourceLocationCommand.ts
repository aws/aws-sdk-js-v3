...
import { UpdateSourceLocation$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateSourceLocationCommand extends command<UpdateSourceLocationCommandInput, UpdateSourceLocationCommandOutput>(
  _ep0,
  _mw0,
