...
import {
  deserializeAws_restJson1_1ListArtifactsCommand,
  serializeAws_restJson1_1ListArtifactsCommand
...
export type ListArtifactsCommandOutput = ListArtifactsResult;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ListArtifactsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListArtifactsCommand(output, context);
  }
