...
var Artifacts: StaticListSchema = [1, n0, _Art,
  0, () => Artifact$
];
var AssociatedResources = 64 | 0;
var AutoBranchCreationPatterns = 64 | 0;
var AutoSubDomainCreationPatterns = 64 | 0;
var BackendEnvironments: StaticListSchema = [1, n0, _BEa,
  0, () => BackendEnvironment$
];
var Branches: StaticListSchema = [1, n0, _Bra,
  0, [() => Branch$,
    0]
];
var CustomDomains = 64 | 0;
var CustomRules: StaticListSchema = [1, n0, _CRu,
  0, () => CustomRule$
];
var DomainAssociations: StaticListSchema = [1, n0, _DAo,
  0, () => DomainAssociation$
];
var JobSummaries: StaticListSchema = [1, n0, _JSo,
  0, () => JobSummary$
];
var Steps: StaticListSchema = [1, n0, _St,
  0, () => Step$
];
var SubDomains: StaticListSchema = [1, n0, _SDu,
  0, () => SubDomain$
];
var SubDomainSettings: StaticListSchema = [1, n0, _SDSu,
  0, () => SubDomainSetting$
];
var TagKeyList = 64 | 0;
var Webhooks: StaticListSchema = [1, n0, _We,
  0, () => Webhook$
];
...
export var CreateBackendEnvironment$: StaticOperationSchema = [9, n0, _CBE,
...
export var CreateDomainAssociation$: StaticOperationSchema = [9, n0, _CDA,
...
export var DeleteBackendEnvironment$: StaticOperationSchema = [9, n0, _DBE,
...
export var DeleteDomainAssociation$: StaticOperationSchema = [9, n0, _DDA,
...
export var GenerateAccessLogs$: StaticOperationSchema = [9, n0, _GAL,
...
export var GetArtifactUrl$: StaticOperationSchema = [9, n0, _GAU,
  { [_h]: ["GET", "/artifacts/{artifactId}", 200] }, () => GetArtifactUrlRequest$, () => GetArtifactUrlResult$
];
export var GetBackendEnvironment$: StaticOperationSchema = [9, n0, _GBE,
...
export var GetDomainAssociation$: StaticOperationSchema = [9, n0, _GDA,
...
export var GetWebhook$: StaticOperationSchema = [9, n0, _GW,
...
export var ListBackendEnvironments$: StaticOperationSchema = [9, n0, _LBE,
...
export var ListDomainAssociations$: StaticOperationSchema = [9, n0, _LDA,
...
export var StopJob$: StaticOperationSchema = [9, n0, _SJt,
...
export var UpdateBranch$: StaticOperationSchema = [9, n0, _UB,
