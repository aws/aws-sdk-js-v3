...
import { type AmplifyClientResolvedConfig, AmplifyClientConfig } from "../AmplifyClient";
 ...
 * @internal
 */
export const defaultAmplifyHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: AmplifyHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<AmplifyClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultAmplifyHttpAuthSchemeProvider: AmplifyHttpAuthSchemeProvider = (authParameters) => {
