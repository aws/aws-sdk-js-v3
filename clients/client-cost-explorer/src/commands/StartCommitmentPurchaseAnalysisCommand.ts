 ...
 * @public
 */
export class StartCommitmentPurchaseAnalysisCommand extends command<StartCommitmentPurchaseAnalysisCommandInput, StartCommitmentPurchaseAnalysisCommandOutput>(
  _ep0,
  _mw0,
