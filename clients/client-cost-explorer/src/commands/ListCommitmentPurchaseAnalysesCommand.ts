 ...
 * @public
 */
export class ListCommitmentPurchaseAnalysesCommand extends command<ListCommitmentPurchaseAnalysesCommandInput, ListCommitmentPurchaseAnalysesCommandOutput>(
  _ep0,
  _mw0,
