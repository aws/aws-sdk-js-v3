 ...
 * @public
 */
export class DescribeCostCategoryDefinitionCommand extends command<DescribeCostCategoryDefinitionCommandInput, DescribeCostCategoryDefinitionCommandOutput>(
  _ep0,
  _mw0,
