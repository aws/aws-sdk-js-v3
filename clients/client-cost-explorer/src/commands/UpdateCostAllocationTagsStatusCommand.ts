 ...
 * @public
 */
export class UpdateCostAllocationTagsStatusCommand extends command<UpdateCostAllocationTagsStatusCommandInput, UpdateCostAllocationTagsStatusCommandOutput>(
  _ep0,
  _mw0,
