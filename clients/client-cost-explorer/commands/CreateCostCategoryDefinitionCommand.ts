...
export type CreateCostCategoryDefinitionCommandOutput = CreateCostCategoryDefinitionResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1CreateCostCategoryDefinitionCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1CreateCostCategoryDefinitionCommand(
      output,
      context
    );
  }
