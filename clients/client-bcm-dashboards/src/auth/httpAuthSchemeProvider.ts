...
import { type BCMDashboardsClientResolvedConfig, BCMDashboardsClientConfig } from "../BCMDashboardsClient";
 ...
 * @internal
 */
export const defaultBCMDashboardsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: BCMDashboardsHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<BCMDashboardsClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultBCMDashboardsHttpAuthSchemeProvider: BCMDashboardsHttpAuthSchemeProvider = (authParameters) => {
