...
import {
  defaultBCMDashboardsHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type BCMDashboardsClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 */
export class BCMDashboardsClient extends __Client<
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<BCMDashboardsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: BCMDashboardsClientResolvedConfig) =>
