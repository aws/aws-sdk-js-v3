...
import { type MailManagerClientResolvedConfig, MailManagerClientConfig } from "../MailManagerClient";
 ...
 * @internal
 */
export const defaultMailManagerHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: MailManagerHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultMailManagerHttpAuthSchemeProvider: MailManagerHttpAuthSchemeProvider = (authParameters) => {
