...
import type { GetArchiveSearchRequest, GetArchiveSearchResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetArchiveSearchCommand extends command<GetArchiveSearchCommandInput, GetArchiveSearchCommandOutput>(
  _ep0,
  _mw0,
  "GetArchiveSearch",
  GetArchiveSearch$
