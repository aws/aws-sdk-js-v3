...
import type { UpdateRelayRequest, UpdateRelayResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateRelayCommand extends command<UpdateRelayCommandInput, UpdateRelayCommandOutput>(
  _ep0,
  _mw0,
  "UpdateRelay",
  UpdateRelay$
