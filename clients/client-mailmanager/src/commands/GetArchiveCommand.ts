...
import type { GetArchiveRequest, GetArchiveResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetArchiveCommand extends command<GetArchiveCommandInput, GetArchiveCommandOutput>(
  _ep0,
  _mw0,
  "GetArchive",
  GetArchive$
