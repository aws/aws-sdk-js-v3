...
import type { GetAddressListImportJobRequest, GetAddressListImportJobResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetAddressListImportJobCommand extends command<GetAddressListImportJobCommandInput, GetAddressListImportJobCommandOutput>(
  _ep0,
  _mw0,
