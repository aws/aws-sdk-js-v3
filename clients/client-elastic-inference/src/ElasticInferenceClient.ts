...
import {
  defaultElasticInferenceHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type ElasticInferenceClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type ElasticInferenceClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<ElasticInferenceClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultElasticInferenceHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: ElasticInferenceClientResolvedConfig) =>
