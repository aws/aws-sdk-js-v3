 ...
 * @public
 */
export class CreateEnvironmentAccountConnectionCommand extends command<CreateEnvironmentAccountConnectionCommandInput, CreateEnvironmentAccountConnectionCommandOutput>(
  _ep0,
  _mw0,
