 ...
 * @public
 */
export class CancelServiceInstanceDeploymentCommand extends command<CancelServiceInstanceDeploymentCommandInput, CancelServiceInstanceDeploymentCommandOutput>(
  _ep0,
  _mw0,
