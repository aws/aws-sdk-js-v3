 ...
 * @public
 */
export class CreateEnvironmentTemplateVersionCommand extends command<CreateEnvironmentTemplateVersionCommandInput, CreateEnvironmentTemplateVersionCommandOutput>(
  _ep0,
  _mw0,
