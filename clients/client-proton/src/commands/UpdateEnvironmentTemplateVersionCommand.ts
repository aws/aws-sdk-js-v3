 ...
 * @public
 */
export class UpdateEnvironmentTemplateVersionCommand extends command<UpdateEnvironmentTemplateVersionCommandInput, UpdateEnvironmentTemplateVersionCommandOutput>(
  _ep0,
  _mw0,
