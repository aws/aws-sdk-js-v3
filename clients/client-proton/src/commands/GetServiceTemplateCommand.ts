...
import type { GetServiceTemplateInput, GetServiceTemplateOutput } from "../models/models_0";
 ...
 * @public
 */
export class GetServiceTemplateCommand extends command<GetServiceTemplateCommandInput, GetServiceTemplateCommandOutput>(
  _ep0,
  _mw0,
  "GetServiceTemplate",
  GetServiceTemplate$
