...
import { UpdateServiceInstance$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateServiceInstanceCommand extends command<UpdateServiceInstanceCommandInput, UpdateServiceInstanceCommandOutput>(
  _ep0,
  _mw0,
