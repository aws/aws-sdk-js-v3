 ...
 * @public
 */
export class UpdateEnvironmentAccountConnectionCommand extends command<UpdateEnvironmentAccountConnectionCommandInput, UpdateEnvironmentAccountConnectionCommandOutput>(
  _ep0,
  _mw0,
