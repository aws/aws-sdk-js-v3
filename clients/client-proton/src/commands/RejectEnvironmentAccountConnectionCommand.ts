 ...
 * @public
 */
export class RejectEnvironmentAccountConnectionCommand extends command<RejectEnvironmentAccountConnectionCommandInput, RejectEnvironmentAccountConnectionCommandOutput>(
  _ep0,
  _mw0,
