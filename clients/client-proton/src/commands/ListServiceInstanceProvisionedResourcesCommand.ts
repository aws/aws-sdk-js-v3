 ...
 * @public
 */
export class ListServiceInstanceProvisionedResourcesCommand extends command<ListServiceInstanceProvisionedResourcesCommandInput, ListServiceInstanceProvisionedResourcesCommandOutput>(
  _ep0,
  _mw0,
