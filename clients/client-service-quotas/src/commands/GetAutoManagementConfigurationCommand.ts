 ...
 * @public
 */
export class GetAutoManagementConfigurationCommand extends command<GetAutoManagementConfigurationCommandInput, GetAutoManagementConfigurationCommandOutput>(
  _ep0,
  _mw0,
