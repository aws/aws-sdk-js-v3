 ...
 * ```
 *
 * @param ListRequestedServiceQuotaChangeHistoryRequest - {@link ListRequestedServiceQuotaChangeHistoryRequest}
 * @returns {@link ListRequestedServiceQuotaChangeHistoryResponse}
