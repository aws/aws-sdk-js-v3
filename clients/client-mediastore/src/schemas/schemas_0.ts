...
export var DescribeContainerInput$: StaticStructureSchema = [3, n0, _DCIe,
  0,
  [_CN],
  [0]
];
export var DescribeContainerOutput$: StaticStructureSchema = [3, n0, _DCOe,
  0,
  [_C],
  [() => Container$]
];
...
var ContainerList: StaticListSchema = [1, n0, _CL,
  0, () => Container$
];
var CorsPolicy: StaticListSchema = [1, n0, _CP,
  0, () => CorsRule$
];
var ExposeHeaders = 64 | 0;
var MetricPolicyRules: StaticListSchema = [1, n0, _MPR,
  0, () => MetricPolicyRule$
];
var TagKeyList = 64 | 0;
...
export var CreateContainer$: StaticOperationSchema = [9, n0, _CC,
  0, () => CreateContainerInput$, () => CreateContainerOutput$
];
export var DeleteContainer$: StaticOperationSchema = [9, n0, _DC,
  0, () => DeleteContainerInput$, () => DeleteContainerOutput$
];
export var DeleteContainerPolicy$: StaticOperationSchema = [9, n0, _DCP,
  0, () => DeleteContainerPolicyInput$, () => DeleteContainerPolicyOutput$
];
export var DeleteCorsPolicy$: StaticOperationSchema = [9, n0, _DCPe,
  0, () => DeleteCorsPolicyInput$, () => DeleteCorsPolicyOutput$
];
export var DeleteLifecyclePolicy$: StaticOperationSchema = [9, n0, _DLP,
  0, () => DeleteLifecyclePolicyInput$, () => DeleteLifecyclePolicyOutput$
];
export var DeleteMetricPolicy$: StaticOperationSchema = [9, n0, _DMP,
  0, () => DeleteMetricPolicyInput$, () => DeleteMetricPolicyOutput$
];
export var DescribeContainer$: StaticOperationSchema = [9, n0, _DCe,
  0, () => DescribeContainerInput$, () => DescribeContainerOutput$
];
export var GetContainerPolicy$: StaticOperationSchema = [9, n0, _GCP,
  0, () => GetContainerPolicyInput$, () => GetContainerPolicyOutput$
];
export var GetCorsPolicy$: StaticOperationSchema = [9, n0, _GCPe,
  0, () => GetCorsPolicyInput$, () => GetCorsPolicyOutput$
];
export var GetLifecyclePolicy$: StaticOperationSchema = [9, n0, _GLP,
  0, () => GetLifecyclePolicyInput$, () => GetLifecyclePolicyOutput$
];
export var GetMetricPolicy$: StaticOperationSchema = [9, n0, _GMP,
  0, () => GetMetricPolicyInput$, () => GetMetricPolicyOutput$
];
export var ListContainers$: StaticOperationSchema = [9, n0, _LC,
  0, () => ListContainersInput$, () => ListContainersOutput$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceInput$, () => ListTagsForResourceOutput$
];
export var PutContainerPolicy$: StaticOperationSchema = [9, n0, _PCP,
  0, () => PutContainerPolicyInput$, () => PutContainerPolicyOutput$
];
export var PutCorsPolicy$: StaticOperationSchema = [9, n0, _PCPu,
  0, () => PutCorsPolicyInput$, () => PutCorsPolicyOutput$
];
export var PutLifecyclePolicy$: StaticOperationSchema = [9, n0, _PLP,
  0, () => PutLifecyclePolicyInput$, () => PutLifecyclePolicyOutput$
];
export var PutMetricPolicy$: StaticOperationSchema = [9, n0, _PMP,
  0, () => PutMetricPolicyInput$, () => PutMetricPolicyOutput$
];
export var StartAccessLogging$: StaticOperationSchema = [9, n0, _SAL,
  0, () => StartAccessLoggingInput$, () => StartAccessLoggingOutput$
];
export var StopAccessLogging$: StaticOperationSchema = [9, n0, _SALt,
