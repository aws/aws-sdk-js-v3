...
var ContainerList: StaticListSchema = [1, n0, _CL, 0, () => Container$];
var CorsPolicy: StaticListSchema = [1, n0, _CP, 0, () => CorsRule$];
var ExposeHeaders = 64 | 0;
var MetricPolicyRules: StaticListSchema = [1, n0, _MPR, 0, () => MetricPolicyRule$];
var TagKeyList = 64 | 0;
