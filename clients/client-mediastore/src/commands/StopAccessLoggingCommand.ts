...
import type { StopAccessLoggingInput, StopAccessLoggingOutput } from "../models/models_0";
 ...
 * @public
 */
export class StopAccessLoggingCommand extends command<StopAccessLoggingCommandInput, StopAccessLoggingCommandOutput>(
  _ep0,
  _mw0,
  "StopAccessLogging",
  StopAccessLogging$
