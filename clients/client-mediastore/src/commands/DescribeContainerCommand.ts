...
import type { DescribeContainerInput, DescribeContainerOutput } from "../models/models_0";
 ...
 * @public
 */
export class DescribeContainerCommand extends command<DescribeContainerCommandInput, DescribeContainerCommandOutput>(
  _ep0,
  _mw0,
  "DescribeContainer",
  DescribeContainer$
