...
export type CreateSubscriptionCommandOutput = CreateSubscriptionResponse;

export class CreateSubscriptionCommand extends $Command<CreateSubscriptionCommandInput, CreateSubscriptionCommandOutput, ShieldClientResolvedConfig> {
