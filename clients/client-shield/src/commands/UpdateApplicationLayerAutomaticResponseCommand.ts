 ...
 * @public
 */
export class UpdateApplicationLayerAutomaticResponseCommand extends command<UpdateApplicationLayerAutomaticResponseCommandInput, UpdateApplicationLayerAutomaticResponseCommandOutput>(
  _ep0,
  _mw0,
