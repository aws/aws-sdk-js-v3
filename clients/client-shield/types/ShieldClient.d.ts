...
export declare type ServiceInputTypes = AssociateDRTLogBucketCommandInput | AssociateDRTRoleCommandInput | CreateProtectionCommandInput | CreateSubscriptionCommandInput | DeleteProtectionCommandInput | DeleteSubscriptionCommandInput | DescribeAttackCommandInput | DescribeDRTAccessCommandInput | DescribeEmergencyContactSettingsCommandInput | DescribeProtectionCommandInput | DescribeSubscriptionCommandInput | DisassociateDRTLogBucketCommandInput | DisassociateDRTRoleCommandInput | GetSubscriptionStateCommandInput | ListAttacksCommandInput | ListProtectionsCommandInput | UpdateEmergencyContactSettingsCommandInput | UpdateSubscriptionCommandInput;
export declare type ServiceOutputTypes = AssociateDRTLogBucketCommandOutput | AssociateDRTRoleCommandOutput | CreateProtectionCommandOutput | CreateSubscriptionCommandOutput | DeleteProtectionCommandOutput | DeleteSubscriptionCommandOutput | DescribeAttackCommandOutput | DescribeDRTAccessCommandOutput | DescribeEmergencyContactSettingsCommandOutput | DescribeProtectionCommandOutput | DescribeSubscriptionCommandOutput | DisassociateDRTLogBucketCommandOutput | DisassociateDRTRoleCommandOutput | GetSubscriptionStateCommandOutput | ListAttacksCommandOutput | ListProtectionsCommandOutput | UpdateEmergencyContactSettingsCommandOutput | UpdateSubscriptionCommandOutput;
...
export declare type ShieldClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type ShieldClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
