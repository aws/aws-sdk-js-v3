...
export var BatchLoadTask$: StaticStructureSchema = [3, n0, _BLT,
  0,
  [_TI, _TS, _DN, _TN, _CT, _LUT, _RU],
  [0, 0, 0, 0, 4, 4, 4]
];
export var BatchLoadTaskDescription$: StaticStructureSchema = [3, n0, _BLTD,
  0,
...
export var CsvConfiguration$: StaticStructureSchema = [3, n0, _CC,
  0,
  [_CS, _EC, _QC, _NV, _TWS],
  [0, 0, 0, 0, 2]
];
export var Database$: StaticStructureSchema = [3, n0, _D,
  0,
...
export var DataModelS3Configuration$: StaticStructureSchema = [3, n0, _DMSC,
  0,
  [_BN, _OK],
  [0, 0]
];
...
export var ListBatchLoadTasksResponse$: StaticStructureSchema = [3, n0, _LBLTRi,
  0,
  [_NT, _BLTa],
  [0, () => BatchLoadTaskList]
];
...
export var MagneticStoreRejectedDataLocation$: StaticStructureSchema = [3, n0, _MSRDL,
  0,
  [_SCo],
  [() => S3Configuration$]
];
...
export var RecordsIngested$: StaticStructureSchema = [3, n0, _RI,
  0,
  [_To, _MS, _MSa],
  [1, 1, 1]
];
...
var MeasureValues: StaticListSchema = [1, n0, _MVe,
  0, () => MeasureValue$
];
...
export var CreateBatchLoadTask$: StaticOperationSchema = [9, n0, _CBLT,
  0, () => CreateBatchLoadTaskRequest$, () => CreateBatchLoadTaskResponse$
];
export var CreateDatabase$: StaticOperationSchema = [9, n0, _CD,
...
export var DeleteDatabase$: StaticOperationSchema = [9, n0, _DD,
  0, () => DeleteDatabaseRequest$, () => __Unit
];
export var DeleteTable$: StaticOperationSchema = [9, n0, _DT,
  0, () => DeleteTableRequest$, () => __Unit
];
export var DescribeBatchLoadTask$: StaticOperationSchema = [9, n0, _DBLT,
  0, () => DescribeBatchLoadTaskRequest$, () => DescribeBatchLoadTaskResponse$
];
export var DescribeDatabase$: StaticOperationSchema = [9, n0, _DDe,
...
export var ListBatchLoadTasks$: StaticOperationSchema = [9, n0, _LBLT,
...
export var ResumeBatchLoadTask$: StaticOperationSchema = [9, n0, _RBLT,
...
export var WriteRecords$: StaticOperationSchema = [9, n0, _WR,
