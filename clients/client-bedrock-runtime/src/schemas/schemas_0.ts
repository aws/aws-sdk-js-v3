...
export var CitationSourceContentList: StaticListSchema = [1, n0, _CSCL, 0, () => CitationSourceContent];
export var CitationSourceContentListDelta: StaticListSchema = [1, n0, _CSCLD, 0, () => CitationSourceContentDelta];
export var ContentBlocks: StaticListSchema = [1, n0, _CB, 0, [() => ContentBlock, 0]];
export var DocumentContentBlocks: StaticListSchema = [1, n0, _DCB, 0, () => DocumentContentBlock];
export var GuardrailAssessmentList: StaticListSchema = [1, n0, _GAL, 0, [() => GuardrailAssessment, 0]];
export var GuardrailAutomatedReasoningDifferenceScenarioList: StaticListSchema = [
  1,
  n0,
  _GARDSL,
  0,
...
export var GuardrailAutomatedReasoningFindingList: StaticListSchema = [
  1,
  n0,
  _GARFL,
  0,
...
export var GuardrailAutomatedReasoningInputTextReferenceList: StaticListSchema = [
  1,
  n0,
  _GARITRL,
  0,
...
export var GuardrailAutomatedReasoningRuleList: StaticListSchema = [
  1,
  n0,
  _GARRL,
  0,
...
export var GuardrailAutomatedReasoningStatementList: StaticListSchema = [
  1,
  n0,
  _GARSL,
  0,
...
export var GuardrailAutomatedReasoningTranslationList: StaticListSchema = [
  1,
  n0,
  _GARTL,
  0,
...
export var GuardrailAutomatedReasoningTranslationOptionList: StaticListSchema = [
  1,
  n0,
  _GARTOL,
  0,
...
export var PromptVariableMap: StaticMapSchema = [2, n0, _PVM, 8, 0, () => PromptVariableValues];
export var RequestMetadata: StaticMapSchema = [2, n0, _RM, 8, 0, 0];
