 ...
 * @internal
 */
export const defaultBedrockRuntimeHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: BedrockRuntimeHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<BedrockRuntimeClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
...
function createSmithyApiHttpBearerAuthHttpAuthOption(authParameters: BedrockRuntimeHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultBedrockRuntimeHttpAuthSchemeProvider: BedrockRuntimeHttpAuthSchemeProvider = (authParameters) => {
