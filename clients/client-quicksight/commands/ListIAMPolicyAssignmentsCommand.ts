...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ListIAMPolicyAssignmentsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListIAMPolicyAssignmentsCommand(output, context);
  }
