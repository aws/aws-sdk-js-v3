...
export type ListIAMPolicyAssignmentsForUserCommandOutput = ListIAMPolicyAssignmentsForUserResponse;
...
export class ListIAMPolicyAssignmentsForUserCommand extends $Command<ListIAMPolicyAssignmentsForUserCommandInput, ListIAMPolicyAssignmentsForUserCommandOutput, QuickSightClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ListIAMPolicyAssignmentsForUserCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListIAMPolicyAssignmentsForUserCommand(output, context);
  }
