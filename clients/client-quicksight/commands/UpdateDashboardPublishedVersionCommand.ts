...
import {
  deserializeAws_restJson1_1UpdateDashboardPublishedVersionCommand,
  serializeAws_restJson1_1UpdateDashboardPublishedVersionCommand,
...
export class UpdateDashboardPublishedVersionCommand extends $Command<UpdateDashboardPublishedVersionCommandInput, UpdateDashboardPublishedVersionCommandOutput, QuickSightClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1UpdateDashboardPublishedVersionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1UpdateDashboardPublishedVersionCommand(output, context);
  }
