...
import { UpdateDataSourcePermissionsRequest, UpdateDataSourcePermissionsResponse } from "../models/index";
import {
  deserializeAws_restJson1_1UpdateDataSourcePermissionsCommand,
  serializeAws_restJson1_1UpdateDataSourcePermissionsCommand
...
> {
  ...
  private serialize(input: UpdateDataSourcePermissionsCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1UpdateDataSourcePermissionsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1UpdateDataSourcePermissionsCommand(output, context);
  }
