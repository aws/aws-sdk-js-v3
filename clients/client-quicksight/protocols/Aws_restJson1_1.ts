...
export async function serializeAws_restJson1_1DescribeDashboardCommand(
  ...
  if (input.AliasName !== undefined) {
    ...
    ] = __extendedEncodeURIComponent(input.AliasName.toString());
  }
  if (input.VersionNumber !== undefined) {
    query[
      __extendedEncodeURIComponent("version-number")
...
export async function serializeAws_restJson1_1GetDashboardEmbedUrlCommand(
  ...
  if (input.IdentityType !== undefined) {
    ...
    ] = __extendedEncodeURIComponent(input.IdentityType.toString());
  }
  ...
  if (input.UserArn !== undefined) {
    ...
    ] = __extendedEncodeURIComponent(input.UserArn.toString());
  }
  return new __HttpRequest({
    ...context.endpoint,
    protocol: "https",
