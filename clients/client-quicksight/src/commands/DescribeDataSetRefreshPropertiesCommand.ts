 ...
 * @public
 */
export class DescribeDataSetRefreshPropertiesCommand extends command<DescribeDataSetRefreshPropertiesCommandInput, DescribeDataSetRefreshPropertiesCommandOutput>(
  _ep0,
  _mw0,
