...
import { DescribeIngestion$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DescribeIngestionCommand extends command<DescribeIngestionCommandInput, DescribeIngestionCommandOutput>(
  _ep0,
  _mw0,
  "DescribeIngestion",
  DescribeIngestion$
