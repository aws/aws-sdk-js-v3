...
import { ListRoleMemberships$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ListRoleMembershipsCommand extends command<ListRoleMembershipsCommandInput, ListRoleMembershipsCommandOutput>(
  _ep0,
  _mw0,
  "ListRoleMemberships",
  ListRoleMemberships$
