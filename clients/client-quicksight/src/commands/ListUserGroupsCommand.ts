...
import type { ListUserGroupsRequest, ListUserGroupsResponse } from "../models/models_5";
 ...
 * @public
 */
export class ListUserGroupsCommand extends command<ListUserGroupsCommandInput, ListUserGroupsCommandOutput>(
  _ep0,
  _mw0,
  "ListUserGroups",
  ListUserGroups$
