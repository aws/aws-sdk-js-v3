 ...
 * @public
 */
export class DescribeActionConnectorPermissionsCommand extends command<DescribeActionConnectorPermissionsCommandInput, DescribeActionConnectorPermissionsCommandOutput>(
  _ep0,
  _mw0,
