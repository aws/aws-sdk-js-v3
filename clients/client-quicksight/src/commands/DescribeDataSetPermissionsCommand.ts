...
import { DescribeDataSetPermissions$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DescribeDataSetPermissionsCommand extends command<DescribeDataSetPermissionsCommandInput, DescribeDataSetPermissionsCommandOutput>(
  _ep0,
  _mw0,
