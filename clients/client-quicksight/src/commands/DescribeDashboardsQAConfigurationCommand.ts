 ...
 * @public
 */
export class DescribeDashboardsQAConfigurationCommand extends command<DescribeDashboardsQAConfigurationCommandInput, DescribeDashboardsQAConfigurationCommandOutput>(
  _ep0,
  _mw0,
