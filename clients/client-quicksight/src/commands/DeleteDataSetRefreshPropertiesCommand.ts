 ...
 * @public
 */
export class DeleteDataSetRefreshPropertiesCommand extends command<DeleteDataSetRefreshPropertiesCommandInput, DeleteDataSetRefreshPropertiesCommandOutput>(
  _ep0,
  _mw0,
