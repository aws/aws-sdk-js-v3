...
import type { UpdateKeyRegistrationRequest, UpdateKeyRegistrationResponse } from "../models/models_5";
 ...
 * @public
 */
export class UpdateKeyRegistrationCommand extends command<UpdateKeyRegistrationCommandInput, UpdateKeyRegistrationCommandOutput>(
  _ep0,
  _mw0,
