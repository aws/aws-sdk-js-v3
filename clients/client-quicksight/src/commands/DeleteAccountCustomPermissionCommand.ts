 ...
 * @public
 */
export class DeleteAccountCustomPermissionCommand extends command<DeleteAccountCustomPermissionCommandInput, DeleteAccountCustomPermissionCommandOutput>(
  _ep0,
  _mw0,
