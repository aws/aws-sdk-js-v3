...
import type { SearchAgentsRequest, SearchAgentsResponse } from "../models/models_5";
 ...
 * @public
 */
export class SearchAgentsCommand extends command<SearchAgentsCommandInput, SearchAgentsCommandOutput>(
  _ep0,
  _mw0,
  "SearchAgents",
  SearchAgents$
