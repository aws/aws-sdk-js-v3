 ...
 * @public
 */
export class GenerateEmbedUrlForAnonymousUserCommand extends command<GenerateEmbedUrlForAnonymousUserCommandInput, GenerateEmbedUrlForAnonymousUserCommandOutput>(
  _ep0,
  _mw0,
