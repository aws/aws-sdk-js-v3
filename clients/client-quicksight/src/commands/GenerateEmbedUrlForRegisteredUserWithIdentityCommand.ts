 ...
 * @public
 */
export class GenerateEmbedUrlForRegisteredUserWithIdentityCommand extends command<GenerateEmbedUrlForRegisteredUserWithIdentityCommandInput, GenerateEmbedUrlForRegisteredUserWithIdentityCommandOutput>(
  _ep0,
  _mw0,
