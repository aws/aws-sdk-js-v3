...
import type { DescribeDashboardSnapshotJobRequest, DescribeDashboardSnapshotJobResponse } from "../models/models_4";
 ...
 * @public
 */
export class DescribeDashboardSnapshotJobCommand extends command<DescribeDashboardSnapshotJobCommandInput, DescribeDashboardSnapshotJobCommandOutput>(
  _ep0,
  _mw0,
