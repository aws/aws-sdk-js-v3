 ...
 * @public
 */
export class DescribeAccountCustomPermissionCommand extends command<DescribeAccountCustomPermissionCommandInput, DescribeAccountCustomPermissionCommandOutput>(
  _ep0,
  _mw0,
