 ...
 * @public
 */
export class DescribeDataSourcePermissionsCommand extends command<DescribeDataSourcePermissionsCommandInput, DescribeDataSourcePermissionsCommandOutput>(
  _ep0,
  _mw0,
