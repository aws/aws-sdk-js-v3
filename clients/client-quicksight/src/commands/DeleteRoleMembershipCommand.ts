...
import { DeleteRoleMembership$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteRoleMembershipCommand extends command<DeleteRoleMembershipCommandInput, DeleteRoleMembershipCommandOutput>(
  _ep0,
  _mw0,
