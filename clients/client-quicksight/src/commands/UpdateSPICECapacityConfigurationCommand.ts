 ...
 * @public
 */
export class UpdateSPICECapacityConfigurationCommand extends command<UpdateSPICECapacityConfigurationCommandInput, UpdateSPICECapacityConfigurationCommandOutput>(
  _ep0,
  _mw0,
