 ...
 * @public
 */
export class DescribeDashboardSnapshotJobResultCommand extends command<DescribeDashboardSnapshotJobResultCommandInput, DescribeDashboardSnapshotJobResultCommandOutput>(
  _ep0,
  _mw0,
