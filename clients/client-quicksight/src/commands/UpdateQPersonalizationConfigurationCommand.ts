 ...
 * @public
 */
export class UpdateQPersonalizationConfigurationCommand extends command<UpdateQPersonalizationConfigurationCommandInput, UpdateQPersonalizationConfigurationCommandOutput>(
  _ep0,
  _mw0,
