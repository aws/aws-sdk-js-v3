...
import type { DescribeActionConnectorRequest, DescribeActionConnectorResponse } from "../models/models_4";
 ...
 * @public
 */
export class DescribeActionConnectorCommand extends command<DescribeActionConnectorCommandInput, DescribeActionConnectorCommandOutput>(
  _ep0,
  _mw0,
