 ...
 * ```
 *
 * @param UpdateTopicRefreshScheduleRequest - {@link UpdateTopicRefreshScheduleRequest}
 * @returns {@link UpdateTopicRefreshScheduleResponse}
...
> {
   ...
   * @public
   */
  constructor(readonly input: UpdateTopicRefreshScheduleCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<UpdateTopicRefreshScheduleCommandInput, UpdateTopicRefreshScheduleCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, UpdateTopicRefreshScheduleCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "UpdateTopicRefreshScheduleCommand";
   ...
   * @internal
   */
  private serialize(input: UpdateTopicRefreshScheduleCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_UpdateTopicRefreshScheduleCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_UpdateTopicRefreshScheduleCommand(output, context);
  }
