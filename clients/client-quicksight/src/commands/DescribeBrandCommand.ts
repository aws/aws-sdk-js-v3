...
import type { DescribeBrandRequest } from "../models/models_3";
import type { DescribeBrandResponse } from "../models/models_4";
import { DescribeBrand$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DescribeBrandCommand extends command<DescribeBrandCommandInput, DescribeBrandCommandOutput>(
  _ep0,
  _mw0,
  "DescribeBrand",
  DescribeBrand$
