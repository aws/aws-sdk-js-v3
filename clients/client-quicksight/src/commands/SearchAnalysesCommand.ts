...
import type { SearchAnalysesRequest, SearchAnalysesResponse } from "../models/models_5";
 ...
 * @public
 */
export class SearchAnalysesCommand extends command<SearchAnalysesCommandInput, SearchAnalysesCommandOutput>(
  _ep0,
  _mw0,
  "SearchAnalyses",
  SearchAnalyses$
