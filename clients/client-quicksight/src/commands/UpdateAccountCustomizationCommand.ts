...
import { UpdateAccountCustomization$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateAccountCustomizationCommand extends command<UpdateAccountCustomizationCommandInput, UpdateAccountCustomizationCommandOutput>(
  _ep0,
  _mw0,
