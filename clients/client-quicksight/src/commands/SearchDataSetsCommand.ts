...
import type { SearchDataSetsRequest, SearchDataSetsResponse } from "../models/models_5";
 ...
 * @public
 */
export class SearchDataSetsCommand extends command<SearchDataSetsCommandInput, SearchDataSetsCommandOutput>(
  _ep0,
  _mw0,
  "SearchDataSets",
  SearchDataSets$
