 ...
 * @public
 */
export class BatchDeleteTopicReviewedAnswerCommand extends command<BatchDeleteTopicReviewedAnswerCommandInput, BatchDeleteTopicReviewedAnswerCommandOutput>(
  _ep0,
  _mw0,
