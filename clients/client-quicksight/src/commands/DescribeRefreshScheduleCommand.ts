...
import { DescribeRefreshSchedule$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DescribeRefreshScheduleCommand extends command<DescribeRefreshScheduleCommandInput, DescribeRefreshScheduleCommandOutput>(
  _ep0,
  _mw0,
