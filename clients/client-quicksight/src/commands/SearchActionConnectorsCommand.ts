...
import type { SearchActionConnectorsRequest, SearchActionConnectorsResponse } from "../models/models_5";
 ...
 * @public
 */
export class SearchActionConnectorsCommand extends command<SearchActionConnectorsCommandInput, SearchActionConnectorsCommandOutput>(
  _ep0,
  _mw0,
