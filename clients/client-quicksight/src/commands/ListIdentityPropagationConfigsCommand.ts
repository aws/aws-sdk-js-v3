 ...
 * @public
 */
export class ListIdentityPropagationConfigsCommand extends command<ListIdentityPropagationConfigsCommandInput, ListIdentityPropagationConfigsCommandOutput>(
  _ep0,
  _mw0,
