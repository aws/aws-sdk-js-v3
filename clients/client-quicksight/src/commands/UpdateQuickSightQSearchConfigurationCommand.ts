 ...
 * @public
 */
export class UpdateQuickSightQSearchConfigurationCommand extends command<UpdateQuickSightQSearchConfigurationCommandInput, UpdateQuickSightQSearchConfigurationCommandOutput>(
  _ep0,
  _mw0,
