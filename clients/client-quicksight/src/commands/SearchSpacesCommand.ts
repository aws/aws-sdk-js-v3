...
import type { SearchSpacesRequest, SearchSpacesResponse } from "../models/models_5";
 ...
 * @public
 */
export class SearchSpacesCommand extends command<SearchSpacesCommandInput, SearchSpacesCommandOutput>(
  _ep0,
  _mw0,
  "SearchSpaces",
  SearchSpaces$
