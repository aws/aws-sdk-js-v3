 ...
 * @public
 */
export class DescribeQuickSightQSearchConfigurationCommand extends command<DescribeQuickSightQSearchConfigurationCommandInput, DescribeQuickSightQSearchConfigurationCommandOutput>(
  _ep0,
  _mw0,
