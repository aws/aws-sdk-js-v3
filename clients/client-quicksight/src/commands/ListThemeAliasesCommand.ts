...
import type { ListThemeAliasesRequest, ListThemeAliasesResponse } from "../models/models_5";
 ...
 * @public
 */
export class ListThemeAliasesCommand extends command<ListThemeAliasesCommandInput, ListThemeAliasesCommandOutput>(
  _ep0,
  _mw0,
  "ListThemeAliases",
  ListThemeAliases$
