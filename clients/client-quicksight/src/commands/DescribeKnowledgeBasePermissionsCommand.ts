 ...
 * @public
 */
export class DescribeKnowledgeBasePermissionsCommand extends command<DescribeKnowledgeBasePermissionsCommandInput, DescribeKnowledgeBasePermissionsCommandOutput>(
  _ep0,
  _mw0,
