...
import type { ListRefreshSchedulesRequest, ListRefreshSchedulesResponse } from "../models/models_4";
 ...
 * @public
 */
export class ListRefreshSchedulesCommand extends command<ListRefreshSchedulesCommandInput, ListRefreshSchedulesCommandOutput>(
  _ep0,
  _mw0,
