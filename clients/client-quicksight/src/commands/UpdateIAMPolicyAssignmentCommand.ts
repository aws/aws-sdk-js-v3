...
import type { UpdateIAMPolicyAssignmentRequest, UpdateIAMPolicyAssignmentResponse } from "../models/models_5";
 ...
 * @public
 */
export class UpdateIAMPolicyAssignmentCommand extends command<UpdateIAMPolicyAssignmentCommandInput, UpdateIAMPolicyAssignmentCommandOutput>(
  _ep0,
  _mw0,
