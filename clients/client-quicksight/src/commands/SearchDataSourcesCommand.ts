...
import type { SearchDataSourcesRequest, SearchDataSourcesResponse } from "../models/models_5";
 ...
 * @public
 */
export class SearchDataSourcesCommand extends command<SearchDataSourcesCommandInput, SearchDataSourcesCommandOutput>(
  _ep0,
  _mw0,
  "SearchDataSources",
  SearchDataSources$
