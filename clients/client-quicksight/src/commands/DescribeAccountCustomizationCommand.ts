...
import type { DescribeAccountCustomizationRequest, DescribeAccountCustomizationResponse } from "../models/models_4";
 ...
 * @public
 */
export class DescribeAccountCustomizationCommand extends command<DescribeAccountCustomizationCommandInput, DescribeAccountCustomizationCommandOutput>(
  _ep0,
  _mw0,
