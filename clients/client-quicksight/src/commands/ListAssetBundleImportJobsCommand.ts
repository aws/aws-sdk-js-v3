...
> {
   ...
   * @public
   */
  constructor(readonly input: ListAssetBundleImportJobsCommandInput) {
  ...
  ): Handler<ListAssetBundleImportJobsCommandInput, ListAssetBundleImportJobsCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListAssetBundleImportJobsCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: ListAssetBundleImportJobsCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
