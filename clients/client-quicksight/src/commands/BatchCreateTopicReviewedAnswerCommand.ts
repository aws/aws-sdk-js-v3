 ...
 * @public
 */
export class BatchCreateTopicReviewedAnswerCommand extends command<BatchCreateTopicReviewedAnswerCommandInput, BatchCreateTopicReviewedAnswerCommandOutput>(
  _ep0,
  _mw0,
