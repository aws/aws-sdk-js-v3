...
import type { DeleteRefreshScheduleRequest, DeleteRefreshScheduleResponse } from "../models/models_3";
 ...
 * @public
 */
export class DeleteRefreshScheduleCommand extends command<DeleteRefreshScheduleCommandInput, DeleteRefreshScheduleCommandOutput>(
  _ep0,
  _mw0,
