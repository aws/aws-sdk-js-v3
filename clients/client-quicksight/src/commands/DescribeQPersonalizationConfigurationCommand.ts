 ...
 * @public
 */
export class DescribeQPersonalizationConfigurationCommand extends command<DescribeQPersonalizationConfigurationCommandInput, DescribeQPersonalizationConfigurationCommandOutput>(
  _ep0,
  _mw0,
