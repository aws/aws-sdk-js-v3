 ...
 * @public
 */
export class DescribeDefaultQBusinessApplicationCommand extends command<DescribeDefaultQBusinessApplicationCommandInput, DescribeDefaultQBusinessApplicationCommandOutput>(
  _ep0,
  _mw0,
