...
import type { RestoreAnalysisRequest, RestoreAnalysisResponse } from "../models/models_5";
 ...
 * @public
 */
export class RestoreAnalysisCommand extends command<RestoreAnalysisCommandInput, RestoreAnalysisCommandOutput>(
  _ep0,
  _mw0,
  "RestoreAnalysis",
  RestoreAnalysis$
