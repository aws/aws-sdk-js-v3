...
import type { CreateFolderMembershipRequest, CreateFolderMembershipResponse } from "../models/models_3";
 ...
 * @public
 */
export class CreateFolderMembershipCommand extends command<CreateFolderMembershipCommandInput, CreateFolderMembershipCommandOutput>(
  _ep0,
  _mw0,
