...
import type { SearchDashboardsRequest, SearchDashboardsResponse } from "../models/models_5";
 ...
 * @public
 */
export class SearchDashboardsCommand extends command<SearchDashboardsCommandInput, SearchDashboardsCommandOutput>(
  _ep0,
  _mw0,
  "SearchDashboards",
  SearchDashboards$
