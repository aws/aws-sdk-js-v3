...
* **client-emr:** Add CloudWatch Logs integration for Spark driver, executor and step logs ([7e6e168](https://github.com/aws/aws-sdk-js-v3/commit/7e6e1684a26ef235e9bc4a5a22991058f69d21ee))
