...
import { type EMRClientResolvedConfig, EMRClientConfig } from "../EMRClient";
 ...
 * @internal
 */
export const defaultEMRHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: EMRHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultEMRHttpAuthSchemeProvider: EMRHttpAuthSchemeProvider = (authParameters) => {
