 ...
 * @public
 */
export class GetOnClusterAppUIPresignedURLCommand extends command<GetOnClusterAppUIPresignedURLCommandInput, GetOnClusterAppUIPresignedURLCommandOutput>(
  _ep0,
  _mw0,
