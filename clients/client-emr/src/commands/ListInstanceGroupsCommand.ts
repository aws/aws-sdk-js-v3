...
import type { ListInstanceGroupsInput, ListInstanceGroupsOutput } from "../models/models_0";
 ...
 * @public
 */
export class ListInstanceGroupsCommand extends command<ListInstanceGroupsCommandInput, ListInstanceGroupsCommandOutput>(
  _ep0,
  _mw0,
  "ListInstanceGroups",
  ListInstanceGroups$
