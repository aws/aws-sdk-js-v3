...
import type { DescribePersistentAppUIInput, DescribePersistentAppUIOutput } from "../models/models_0";
 ...
 * @public
 */
export class DescribePersistentAppUICommand extends command<DescribePersistentAppUICommandInput, DescribePersistentAppUICommandOutput>(
  _ep0,
  _mw0,
