...
export var AutoScalingPolicyStateChangeReason$: StaticStructureSchema = [3, n0, _ASPSCR,
  0,
  [_Co, _M],
  [0, 0]
];
export var AutoScalingPolicyStatus$: StaticStructureSchema = [3, n0, _ASPS,
  0,
  [_Sta, _SCR],
  [0, () => AutoScalingPolicyStateChangeReason$]
];
export var AutoTerminationPolicy$: StaticStructureSchema = [3, n0, _ATP,
  0,
  [_IT],
  [1]
];
...
export var CancelStepsInfo$: StaticStructureSchema = [3, n0, _CSI,
  0,
  [_SIt, _St, _Re],
  [0, 0, 0]
];
...
export var ClusterStatus$: StaticStructureSchema = [3, n0, _CS,
  0,
  [_Sta, _SCR, _Ti, _ED],
...
export var ClusterTimeline$: StaticStructureSchema = [3, n0, _CT,
  0,
  [_CDT, _RDT, _EDT],
  [4, 4, 4]
];
export var Command$: StaticStructureSchema = [3, n0, _Com,
  0,
  [_N, _SP, _Ar],
  [0, 0, 64 | 0]
];
...
export var DescribeJobFlowsInput$: StaticStructureSchema = [3, n0, _DJFI,
  0,
  [_CAr, _CB, _JFIo, _JFS],
  [4, 4, 64 | 0, 64 | 0]
];
export var DescribeJobFlowsOutput$: StaticStructureSchema = [3, n0, _DJFO,
  0,
  [_JF],
  [() => JobFlowDetailList]
];
...
export var DescribeReleaseLabelInput$: StaticStructureSchema = [3, n0, _DRLI,
  0,
  [_RL, _NT, _MR],
  [0, 0, 1]
];
export var DescribeReleaseLabelOutput$: StaticStructureSchema = [3, n0, _DRLO,
  0,
  [_RL, _Ap, _NT, _AOSR],
...
export var Ec2InstanceAttributes$: StaticStructureSchema = [3, n0, _EIA,
  0,
  [_EKN, _ESI, _RESI, _EAZ, _REAZ, _IIP, _EMMSG, _EMSSG, _SASG, _AMSG, _ASSG],
  [0, 0, 64 | 0, 0, 64 | 0, 0, 0, 0, 0, 64 | 0, 64 | 0]
];
export var EMRContainersConfig$: StaticStructureSchema = [3, n0, _EMRCC,
  0,
  [_JRI],
  [0]
];
...
export var GetBlockPublicAccessConfigurationInput$: StaticStructureSchema = [3, n0, _GBPACI,
  0,
  [],
  []
];
...
export var InstanceFleet$: StaticStructureSchema = [3, n0, _IF,
  0,
...
export var InstanceFleetStateChangeReason$: StaticStructureSchema = [3, n0, _IFSCR,
  0,
  [_Co, _M],
  [0, 0]
];
export var InstanceFleetStatus$: StaticStructureSchema = [3, n0, _IFS,
  0,
  [_Sta, _SCR, _Ti],
  [0, () => InstanceFleetStateChangeReason$, () => InstanceFleetTimeline$]
];
export var InstanceFleetTimeline$: StaticStructureSchema = [3, n0, _IFTn,
  0,
  [_CDT, _RDT, _EDT],
  [4, 4, 4]
];
...
export var InstanceGroupStatus$: StaticStructureSchema = [3, n0, _IGS,
  0,
  [_Sta, _SCR, _Ti],
  [0, () => InstanceGroupStateChangeReason$, () => InstanceGroupTimeline$]
];
export var InstanceGroupTimeline$: StaticStructureSchema = [3, n0, _IGTn,
  0,
  [_CDT, _RDT, _EDT],
  [4, 4, 4]
];
export var InstanceResizePolicy$: StaticStructureSchema = [3, n0, _IRP,
  0,
  [_ITT, _ITP, _ITTn],
  [64 | 0, 64 | 0, 1]
];
export var InstanceStateChangeReason$: StaticStructureSchema = [3, n0, _ISCR,
  0,
  [_Co, _M],
  [0, 0]
];
export var InstanceStatus$: StaticStructureSchema = [3, n0, _IS,
  0,
  [_Sta, _SCR, _Ti],
  [0, () => InstanceStateChangeReason$, () => InstanceTimeline$]
];
export var InstanceTimeline$: StaticStructureSchema = [3, n0, _ITns,
  0,
  [_CDT, _RDT, _EDT],
  [4, 4, 4]
];
...
export var ListNotebookExecutionsInput$: StaticStructureSchema = [3, n0, _LNEI,
  0,
  [_EI, _St, _F, _To, _Mar, _EEI],
  [0, 0, 4, 4, 0, 0]
];
export var ListNotebookExecutionsOutput$: StaticStructureSchema = [3, n0, _LNEO,
  0,
  [_NEo, _Mar],
  [() => NotebookExecutionSummaryList, 0]
];
export var ListReleaseLabelsInput$: StaticStructureSchema = [3, n0, _LRLI,
  0,
  [_Fi, _NT, _MR],
  [() => ReleaseLabelFilter$, 0, 1]
];
export var ListReleaseLabelsOutput$: StaticStructureSchema = [3, n0, _LRLO,
  0,
  [_RLe, _NT],
  [64 | 0, 0]
];
export var ListSecurityConfigurationsInput$: StaticStructureSchema = [3, n0, _LSCI,
  0,
  [_Mar],
  [0]
];
export var ListSecurityConfigurationsOutput$: StaticStructureSchema = [3, n0, _LSCO,
  0,
  [_SCe, _Mar],
...
export var ListStudioSessionMappingsInput$: StaticStructureSchema = [3, n0, _LSSMI,
  0,
  [_SItu, _ITd, _Mar],
  [0, 0, 0]
];
export var ListStudioSessionMappingsOutput$: StaticStructureSchema = [3, n0, _LSSMO,
  0,
  [_SMe, _Mar],
...
export var ManagedScalingPolicy$: StaticStructureSchema = [3, n0, _MSP,
  0,
  [_CL, _UPI, _SSc],
  [() => ComputeLimits$, 1, 0]
];
...
export var NotebookExecutionSummary$: StaticStructureSchema = [3, n0, _NES,
  0,
  [_NEI, _EI, _NEN, _St, _ST, _ET, _NSL, _EEI],
  [0, 0, 0, 0, 4, 4, () => NotebookS3LocationForOutput$, 0]
];
export var NotebookS3LocationForOutput$: StaticStructureSchema = [3, n0, _NSLFO,
  0,
  [_B, _K],
  [0, 0]
];
export var NotebookS3LocationFromInput$: StaticStructureSchema = [3, n0, _NSLFI,
  0,
  [_B, _K],
  [0, 0]
];
export var OnDemandCapacityReservationOptions$: StaticStructureSchema = [3, n0, _ODCRO,
  0,
  [_US, _CRP, _CRRGA],
  [0, 0, 0]
];
...
export var OSRelease$: StaticStructureSchema = [3, n0, _OSR,
  0,
  [_L],
  [0]
];
export var OutputNotebookS3LocationForOutput$: StaticStructureSchema = [3, n0, _ONSLFO,
  0,
  [_B, _K],
  [0, 0]
];
export var OutputNotebookS3LocationFromInput$: StaticStructureSchema = [3, n0, _ONSLFI,
  0,
  [_B, _K],
  [0, 0]
];
export var PersistentAppUI$: StaticStructureSchema = [3, n0, _PAUI,
  0,
...
export var ReleaseLabelFilter$: StaticStructureSchema = [3, n0, _RLF,
  0,
  [_Pre, _A],
  [0, 0]
];
...
export var SessionMappingSummary$: StaticStructureSchema = [3, n0, _SMS,
  0,
...
export var StepStateChangeReason$: StaticStructureSchema = [3, n0, _SSCR,
  0,
  [_Co, _M],
  [0, 0]
];
export var StepStatus$: StaticStructureSchema = [3, n0, _SSte,
  0,
  [_Sta, _SCR, _FD, _Ti],
  [0, () => StepStateChangeReason$, () => FailureDetails$, () => StepTimeline$]
];
export var StepSummary$: StaticStructureSchema = [3, n0, _SStep,
  0,
  [_I, _N, _Confi, _AOF, _St, _LU, _EKA],
  [0, 0, () => HadoopStepConfig$, 0, () => StepStatus$, 0, 0]
];
export var StepTimeline$: StaticStructureSchema = [3, n0, _STt,
  0,
  [_CDT, _SDT, _EDT],
  [4, 4, 4]
];
...
export var SupportedInstanceType$: StaticStructureSchema = [3, n0, _SITup,
  0,
  [_Ty, _MGB, _SGB, _VCPU, _IBO, _IFIn, _EOA, _EOBD, _NOD, _ESO, _Arc],
  [0, 1, 1, 1, 2, 0, 2, 2, 1, 2, 0]
];
export var SupportedProductConfig$: StaticStructureSchema = [3, n0, _SPC,
  0,
  [_N, _Ar],
  [0, 64 | 0]
];
...
var BootstrapActionConfigList: StaticListSchema = [1, n0, _BACL,
  0, () => BootstrapActionConfig$
];
var BootstrapActionDetailList: StaticListSchema = [1, n0, _BADL,
  0, () => BootstrapActionDetail$
];
var CancelStepsInfoList: StaticListSchema = [1, n0, _CSIL,
  0, () => CancelStepsInfo$
];
var ClusterStateList = 64 | 0;
var ClusterSummaryList: StaticListSchema = [1, n0, _CSL,
  0, () => ClusterSummary$
];
var CommandList: StaticListSchema = [1, n0, _CLo,
  0, () => Command$
];
var ConfigurationList: StaticListSchema = [1, n0, _CLon,
  0, () => Configuration$
];
var EbsBlockDeviceConfigList: StaticListSchema = [1, n0, _EBDCL,
  0, () => EbsBlockDeviceConfig$
];
var EbsBlockDeviceList: StaticListSchema = [1, n0, _EBDL,
  0, () => EbsBlockDevice$
];
var EbsVolumeList: StaticListSchema = [1, n0, _EVL,
  0, () => EbsVolume$
];
var EC2InstanceIdsList = 64 | 0;
var EC2InstanceIdsToTerminateList = 64 | 0;
var ErrorData: StaticListSchema = [1, n0, _EDrr,
  0, 128 | 0
];
var ErrorDetailList: StaticListSchema = [1, n0, _EDL,
  0, () => ErrorDetail$
];
var InstanceFleetConfigList: StaticListSchema = [1, n0, _IFCL,
  0, () => InstanceFleetConfig$
];
var InstanceFleetList: StaticListSchema = [1, n0, _IFL,
  0, () => InstanceFleet$
];
var InstanceGroupConfigList: StaticListSchema = [1, n0, _IGCL,
  0, () => InstanceGroupConfig$
];
var InstanceGroupDetailList: StaticListSchema = [1, n0, _IGDL,
  0, () => InstanceGroupDetail$
];
var InstanceGroupIdsList = 64 | 0;
var InstanceGroupList: StaticListSchema = [1, n0, _IGL,
  0, () => InstanceGroup$
];
var InstanceGroupModifyConfigList: StaticListSchema = [1, n0, _IGMCL,
...
var InstanceTypeConfigList: StaticListSchema = [1, n0, _ITCL,
  0, () => InstanceTypeConfig$
];
var InstanceTypeSpecificationList: StaticListSchema = [1, n0, _ITSL,
  0, () => InstanceTypeSpecification$
];
var JobFlowDetailList: StaticListSchema = [1, n0, _JFDL,
  0, () => JobFlowDetail$
];
var JobFlowExecutionStateList = 64 | 0;
var KeyValueList: StaticListSchema = [1, n0, _KVL,
  0, () => KeyValue$
];
var MetricDimensionList: StaticListSchema = [1, n0, _MDL,
  0, () => MetricDimension$
];
var NewSupportedProductsList: StaticListSchema = [1, n0, _NSPL,
  0, () => SupportedProductConfig$
];
var NotebookExecutionSummaryList: StaticListSchema = [1, n0, _NESL,
  0, () => NotebookExecutionSummary$
];
var OSReleaseList: StaticListSchema = [1, n0, _OSRLe,
  0, () => OSRelease$
];
var PersistentAppUITypeList = 64 | 0;
var PlacementGroupConfigList: StaticListSchema = [1, n0, _PGCL,
  0, () => PlacementGroupConfig$
];
var PortRanges: StaticListSchema = [1, n0, _PRo,
  0, () => PortRange$
];
var ScalingRuleList: StaticListSchema = [1, n0, _SRL,
  0, () => ScalingRule$
];
var SecurityConfigurationList: StaticListSchema = [1, n0, _SCLe,
...
var StepConfigList: StaticListSchema = [1, n0, _SCLt,
  0, () => StepConfig$
];
var StepDetailList: StaticListSchema = [1, n0, _SDL,
  0, () => StepDetail$
];
var StepIdsList = 64 | 0;
var StepStateList = 64 | 0;
var StepSummaryList: StaticListSchema = [1, n0, _SSL,
  0, () => StepSummary$
];
var StringList = 64 | 0;
var StudioSummaryList: StaticListSchema = [1, n0, _SSLt,
  0, () => StudioSummary$
];
var SubnetIdList = 64 | 0;
var SupportedInstanceTypesList: StaticListSchema = [1, n0, _SITL,
...
var StringMap = 128 | 0;
export var Credentials$: StaticUnionSchema = [4, n0, _Cr,
  0,
  [_UP],
  [[() => UsernamePassword$, 0]]
];
export var AddInstanceFleet$: StaticOperationSchema = [9, n0, _AIF,
  0, () => AddInstanceFleetInput$, () => AddInstanceFleetOutput$
];
export var AddInstanceGroups$: StaticOperationSchema = [9, n0, _AIG,
  0, () => AddInstanceGroupsInput$, () => AddInstanceGroupsOutput$
];
export var AddJobFlowSteps$: StaticOperationSchema = [9, n0, _AJFS,
  0, () => AddJobFlowStepsInput$, () => AddJobFlowStepsOutput$
];
export var AddTags$: StaticOperationSchema = [9, n0, _ATdd,
  0, () => AddTagsInput$, () => AddTagsOutput$
];
export var CancelSteps$: StaticOperationSchema = [9, n0, _CSa,
  0, () => CancelStepsInput$, () => CancelStepsOutput$
];
export var CreatePersistentAppUI$: StaticOperationSchema = [9, n0, _CPAUI,
  0, () => CreatePersistentAppUIInput$, () => CreatePersistentAppUIOutput$
];
export var CreateSecurityConfiguration$: StaticOperationSchema = [9, n0, _CSC,
  0, () => CreateSecurityConfigurationInput$, () => CreateSecurityConfigurationOutput$
];
export var CreateStudio$: StaticOperationSchema = [9, n0, _CSr,
  0, () => CreateStudioInput$, () => CreateStudioOutput$
];
export var CreateStudioSessionMapping$: StaticOperationSchema = [9, n0, _CSSM,
...
export var DeleteStudio$: StaticOperationSchema = [9, n0, _DS,
  0, () => DeleteStudioInput$, () => __Unit
];
export var DeleteStudioSessionMapping$: StaticOperationSchema = [9, n0, _DSSM,
  0, () => DeleteStudioSessionMappingInput$, () => __Unit
];
export var DescribeCluster$: StaticOperationSchema = [9, n0, _DC,
  0, () => DescribeClusterInput$, () => DescribeClusterOutput$
];
export var DescribeJobFlows$: StaticOperationSchema = [9, n0, _DJF,
  0, () => DescribeJobFlowsInput$, () => DescribeJobFlowsOutput$
];
export var DescribeNotebookExecution$: StaticOperationSchema = [9, n0, _DNE,
  0, () => DescribeNotebookExecutionInput$, () => DescribeNotebookExecutionOutput$
];
export var DescribePersistentAppUI$: StaticOperationSchema = [9, n0, _DPAUI,
  0, () => DescribePersistentAppUIInput$, () => DescribePersistentAppUIOutput$
];
export var DescribeReleaseLabel$: StaticOperationSchema = [9, n0, _DRL,
...
export var DescribeStep$: StaticOperationSchema = [9, n0, _DSe,
  0, () => DescribeStepInput$, () => DescribeStepOutput$
];
export var DescribeStudio$: StaticOperationSchema = [9, n0, _DSes,
  0, () => DescribeStudioInput$, () => DescribeStudioOutput$
];
export var GetAutoTerminationPolicy$: StaticOperationSchema = [9, n0, _GATP,
  0, () => GetAutoTerminationPolicyInput$, () => GetAutoTerminationPolicyOutput$
];
export var GetBlockPublicAccessConfiguration$: StaticOperationSchema = [9, n0, _GBPAC,
  0, () => GetBlockPublicAccessConfigurationInput$, () => GetBlockPublicAccessConfigurationOutput$
];
export var GetClusterSessionCredentials$: StaticOperationSchema = [9, n0, _GCSC,
  0, () => GetClusterSessionCredentialsInput$, () => GetClusterSessionCredentialsOutput$
];
export var GetManagedScalingPolicy$: StaticOperationSchema = [9, n0, _GMSP,
  0, () => GetManagedScalingPolicyInput$, () => GetManagedScalingPolicyOutput$
];
export var GetOnClusterAppUIPresignedURL$: StaticOperationSchema = [9, n0, _GOCAUIPURL,
...
export var ListBootstrapActions$: StaticOperationSchema = [9, n0, _LBA,
...
export var ListInstanceFleets$: StaticOperationSchema = [9, n0, _LIF,
  0, () => ListInstanceFleetsInput$, () => ListInstanceFleetsOutput$
];
export var ListInstanceGroups$: StaticOperationSchema = [9, n0, _LIG,
...
export var ListNotebookExecutions$: StaticOperationSchema = [9, n0, _LNE,
  0, () => ListNotebookExecutionsInput$, () => ListNotebookExecutionsOutput$
];
export var ListReleaseLabels$: StaticOperationSchema = [9, n0, _LRL,
...
export var ListSupportedInstanceTypes$: StaticOperationSchema = [9, n0, _LSIT,
  0, () => ListSupportedInstanceTypesInput$, () => ListSupportedInstanceTypesOutput$
];
export var ModifyCluster$: StaticOperationSchema = [9, n0, _MCo,
  0, () => ModifyClusterInput$, () => ModifyClusterOutput$
];
export var ModifyInstanceFleet$: StaticOperationSchema = [9, n0, _MIF,
  0, () => ModifyInstanceFleetInput$, () => __Unit
];
export var ModifyInstanceGroups$: StaticOperationSchema = [9, n0, _MIG,
  0, () => ModifyInstanceGroupsInput$, () => __Unit
];
export var PutAutoScalingPolicy$: StaticOperationSchema = [9, n0, _PASP,
  0, () => PutAutoScalingPolicyInput$, () => PutAutoScalingPolicyOutput$
];
export var PutAutoTerminationPolicy$: StaticOperationSchema = [9, n0, _PATP,
  0, () => PutAutoTerminationPolicyInput$, () => PutAutoTerminationPolicyOutput$
];
export var PutBlockPublicAccessConfiguration$: StaticOperationSchema = [9, n0, _PBPAC,
  0, () => PutBlockPublicAccessConfigurationInput$, () => PutBlockPublicAccessConfigurationOutput$
];
export var PutManagedScalingPolicy$: StaticOperationSchema = [9, n0, _PMSP,
  0, () => PutManagedScalingPolicyInput$, () => PutManagedScalingPolicyOutput$
];
export var RemoveAutoScalingPolicy$: StaticOperationSchema = [9, n0, _RASP,
  0, () => RemoveAutoScalingPolicyInput$, () => RemoveAutoScalingPolicyOutput$
];
export var RemoveAutoTerminationPolicy$: StaticOperationSchema = [9, n0, _RATP,
  0, () => RemoveAutoTerminationPolicyInput$, () => RemoveAutoTerminationPolicyOutput$
];
export var RemoveManagedScalingPolicy$: StaticOperationSchema = [9, n0, _RMSP,
  0, () => RemoveManagedScalingPolicyInput$, () => RemoveManagedScalingPolicyOutput$
];
export var RemoveTags$: StaticOperationSchema = [9, n0, _RTe,
  0, () => RemoveTagsInput$, () => RemoveTagsOutput$
];
export var RunJobFlow$: StaticOperationSchema = [9, n0, _RJF,
  0, () => RunJobFlowInput$, () => RunJobFlowOutput$
];
export var SetKeepJobFlowAliveWhenNoSteps$: StaticOperationSchema = [9, n0, _SKJFAWNS,
  0, () => SetKeepJobFlowAliveWhenNoStepsInput$, () => __Unit
];
export var SetTerminationProtection$: StaticOperationSchema = [9, n0, _STP,
  0, () => SetTerminationProtectionInput$, () => __Unit
];
export var SetUnhealthyNodeReplacement$: StaticOperationSchema = [9, n0, _SUNR,
  0, () => SetUnhealthyNodeReplacementInput$, () => __Unit
];
export var SetVisibleToAllUsers$: StaticOperationSchema = [9, n0, _SVTAU,
...
export var UpdateStudioSessionMapping$: StaticOperationSchema = [9, n0, _USSM,
