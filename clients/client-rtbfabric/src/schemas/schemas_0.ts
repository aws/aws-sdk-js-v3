...
export var FilterCriterion$: StaticStructureSchema = [3, n0, _FC,
  0,
  [_pa, _v],
  [0, 64 | 0]
];
...
export var LinkApplicationLogSampling$: StaticStructureSchema = [3, n0, _LALS,
  0,
  [_eL, _fL],
  [1, 1]
];
export var LinkAttributes$: StaticStructureSchema = [3, n0, _LA,
  0,
  [_rEM, _cPI],
  [() => ResponderErrorMasking, 0]
];
export var LinkLogSettings$: StaticStructureSchema = [3, n0, _LLS,
  0,
  [_aL],
...
export var ListLinksResponse$: StaticStructureSchema = [3, n0, _LLRi,
  0,
  [_l, _nT],
  [() => LinkList, 0]
];
...
export var ListRequesterGatewaysResponse$: StaticStructureSchema = [3, n0, _LRGRi,
  0,
  [_gIa, _nT],
  [64 | 0, 0]
];
export var ListResponderGatewaysRequest$: StaticStructureSchema = [3, n0, _LRGRis,
  0,
  [_mR, _nT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListResponderGatewaysResponse$: StaticStructureSchema = [3, n0, _LRGRist,
  0,
  [_gIa, _nT],
  [64 | 0, 0]
];
...
export var ModuleConfiguration$: StaticStructureSchema = [3, n0, _MC,
  0,
  [_ve, _n, _dO, _mP],
  [0, 0, 64 | 0, () => ModuleParameters$]
];
export var NoBidAction$: StaticStructureSchema = [3, n0, _NBA,
  0,
  [_nBRC],
  [1]
];
...
export var RejectLinkRequest$: StaticStructureSchema = [3, n0, _RLR,
  0,
  [_gI, _lI],
  [[0, 1], [0, 1]]
];
...
var FilterConfiguration: StaticListSchema = [1, n0, _FCi,
  0, () => Filter$
];
var FilterCriteria: StaticListSchema = [1, n0, _FCil,
  0, () => FilterCriterion$
];
...
export var ManagedEndpointConfiguration$: StaticUnionSchema = [4, n0, _MEC,
  0,
  [_aSG, _eE],
  [() => AutoScalingGroupsConfiguration$, [() => EksEndpointsConfiguration$, 0]]
];
export var ModuleParameters$: StaticUnionSchema = [4, n0, _MP,
  0,
  [_nB, _oRA, _rL],
...
export var CreateRequesterGateway$: StaticOperationSchema = [9, n0, _CRG,
  { [_h]: ["POST", "/requester-gateway", 200] }, () => CreateRequesterGatewayRequest$, () => CreateRequesterGatewayResponse$
];
export var CreateResponderGateway$: StaticOperationSchema = [9, n0, _CRGr,
  { [_h]: ["POST", "/responder-gateway", 200] }, () => CreateResponderGatewayRequest$, () => CreateResponderGatewayResponse$
];
export var DeleteInboundExternalLink$: StaticOperationSchema = [9, n0, _DIEL,
...
export var DeleteRequesterGateway$: StaticOperationSchema = [9, n0, _DRG,
...
export var GetRequesterGateway$: StaticOperationSchema = [9, n0, _GRG,
...
export var UpdateLink$: StaticOperationSchema = [9, n0, _UL,
...
export var UpdateResponderGateway$: StaticOperationSchema = [9, n0, _URGp,
