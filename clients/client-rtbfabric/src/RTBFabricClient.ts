 ...
 * @public
 */
export type RTBFabricClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 */
export class RTBFabricClient extends __Client<
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<RTBFabricClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: RTBFabricClientResolvedConfig) =>
