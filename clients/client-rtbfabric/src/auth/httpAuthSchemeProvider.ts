...
import { type RTBFabricClientResolvedConfig, RTBFabricClientConfig } from "../RTBFabricClient";
 ...
 * @internal
 */
export const defaultRTBFabricHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: RTBFabricHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<RTBFabricClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultRTBFabricHttpAuthSchemeProvider: RTBFabricHttpAuthSchemeProvider = (authParameters) => {
