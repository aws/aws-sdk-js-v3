 ...
 * ```javascript
 * import { RTBFabricClient, ListLinksCommand } from "@aws-sdk/client-rtbfabric"; // ES Modules import
 * // const { RTBFabricClient, ListLinksCommand } = require("@aws-sdk/client-rtbfabric"); // CommonJS import
