...
import {
  defaultKinesisVideoWebRTCStorageHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type KinesisVideoWebRTCStorageClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type KinesisVideoWebRTCStorageClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<KinesisVideoWebRTCStorageClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultKinesisVideoWebRTCStorageHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: KinesisVideoWebRTCStorageClientResolvedConfig) =>
