...
export const getRuntimeConfig = (config: KinesisVideoWebRTCStorageClientConfig) => {
  return {
    ...
    httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultKinesisVideoWebRTCStorageHttpAuthSchemeProvider,
    ...
    protocol:
      config?.protocol ?? new AwsRestJsonProtocol({ defaultNamespace: "com.amazonaws.kinesisvideowebrtcstorage" }),
