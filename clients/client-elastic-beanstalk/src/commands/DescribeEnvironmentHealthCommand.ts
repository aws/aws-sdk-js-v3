...
/**
 * <p>Returns information about the overall health of the specified environment. The <b>DescribeEnvironmentHealth</b> operation is
 *       only available with Elastic Beanstalk Enhanced Health.</p>
