...
import { type ElasticBeanstalkClientResolvedConfig, ElasticBeanstalkClientConfig } from "../ElasticBeanstalkClient";
 ...
 * @internal
 */
export const defaultElasticBeanstalkHttpAuthSchemeProvider: ElasticBeanstalkHttpAuthSchemeProvider = (authParameters) => {
