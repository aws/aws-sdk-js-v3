...
export type DescribeEnvironmentResourcesCommandOutput = EnvironmentResourceDescriptionsMessage &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_queryDescribeEnvironmentResourcesCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_queryDescribeEnvironmentResourcesCommand(
      output,
      context
    );
  }
