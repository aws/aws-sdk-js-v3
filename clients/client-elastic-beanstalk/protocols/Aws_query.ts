...
const serializeAws_queryConfigurationOptionSettingsList = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryConfigurationOptionSetting(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryOptionsSpecifierList = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryOptionSpecification(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryPlatformFilters = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryPlatformFilter(entry, context);
    counter++;
  });
  return entries;
};
...
const deserializeAws_queryApplicationDescription = (
  ...
  if (output["ConfigurationTemplates"]["member"] !== undefined) {
...
const deserializeAws_queryApplicationDescriptionsMessage = (
  ...
  if (output["Applications"]["member"] !== undefined) {
...
const deserializeAws_queryApplicationVersionDescriptionsMessage = (
  ...
  if (output["ApplicationVersions"]["member"] !== undefined) {
...
const deserializeAws_queryConfigurationOptionDescription = (
  ...
  if (output["ValueOptions"]["member"] !== undefined) {
...
const deserializeAws_queryConfigurationOptionsDescription = (
  ...
  if (output["Options"]["member"] !== undefined) {
...
const deserializeAws_queryConfigurationSettingsDescription = (
  ...
  if (output["OptionSettings"]["member"] !== undefined) {
...
const deserializeAws_queryConfigurationSettingsDescriptions = (
  ...
  if (output["ConfigurationSettings"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeEnvironmentHealthResult = (
  ...
  if (output["Causes"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeEnvironmentManagedActionHistoryResult = (
  ...
  if (output["ManagedActionHistoryItems"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeEnvironmentManagedActionsResult = (
  ...
  if (output["ManagedActions"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeInstancesHealthResult = (
  ...
  if (output["InstanceHealthList"]["member"] !== undefined) {
...
const deserializeAws_queryEnvironmentDescription = (
  ...
  if (output["EnvironmentLinks"]["member"] !== undefined) {
...
const deserializeAws_queryEnvironmentDescriptionsMessage = (
  ...
  if (output["Environments"]["member"] !== undefined) {
...
const deserializeAws_queryEnvironmentResourceDescription = (
  ...
  if (output["LaunchTemplates"]["member"] !== undefined) {
  ...
  if (output["Queues"]["member"] !== undefined) {
    contents.Queues = deserializeAws_queryQueueList(
      output["Queues"]["member"],
      context
    );
  }
  if (output["Triggers"]["member"] !== undefined) {
...
const deserializeAws_queryEventDescriptionsMessage = (
  ...
  if (output["Events"]["member"] !== undefined) {
...
const deserializeAws_queryListPlatformVersionsResult = (
  ...
  if (output["PlatformSummaryList"]["member"] !== undefined) {
...
const deserializeAws_queryLoadBalancerDescription = (
  ...
  if (output["Listeners"]["member"] !== undefined) {
...
const deserializeAws_queryPlatformDescription = (
  ...
  if (output["CustomAmiList"]["member"] !== undefined) {
  ...
  if (output["Frameworks"]["member"] !== undefined) {
  ...
  if (output["ProgrammingLanguages"]["member"] !== undefined) {
...
const deserializeAws_queryResourceTagsDescriptionMessage = (
  ...
  if (output["ResourceTags"]["member"] !== undefined) {
...
const deserializeAws_queryRetrieveEnvironmentInfoResultMessage = (
  ...
  if (output["EnvironmentInfo"]["member"] !== undefined) {
...
const deserializeAws_querySolutionStackDescription = (
  ...
  if (output["PermittedFileTypes"]["member"] !== undefined) {
...
const deserializeAws_querySystemStatus = (
  ...
  if (output["LoadAverage"]["member"] !== undefined) {
