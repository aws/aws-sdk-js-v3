...
import {
  ...
  defaultPricingPlanManagerHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type PricingPlanManagerClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type PricingPlanManagerClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<PricingPlanManagerClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: PricingPlanManagerClientResolvedConfig) =>
