...
import type { PricingPlanManagerExtensionConfiguration } from "./extensionConfiguration";
...
export const resolveRuntimeExtensions = (runtimeConfig: any, extensions: RuntimeExtension[]) => {
  const extensionConfiguration: PricingPlanManagerExtensionConfiguration = Object.assign(
