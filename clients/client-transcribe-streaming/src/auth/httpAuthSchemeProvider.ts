...
import {
  type TranscribeStreamingClientResolvedConfig,
 ...
 * @internal
 */
export const defaultTranscribeStreamingHttpAuthSchemeProvider: TranscribeStreamingHttpAuthSchemeProvider = (authParameters) => {
