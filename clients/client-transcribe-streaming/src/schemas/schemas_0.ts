...
export var CallAnalyticsItem$: StaticStructureSchema = [3, n0, _CAI,
  0,
  [_BOM, _EOM, _Ty, _Co, _Con, _VFM, _S],
  [1, 1, 0, 0, 1, 2, 2]
];
export var CallAnalyticsLanguageWithScore$: StaticStructureSchema = [3, n0, _CALWS,
  0,
  [_LC, _Sc],
  [0, 1]
];
...
export var Item$: StaticStructureSchema = [3, n0, _It,
  0,
  [_ST, _ET, _Ty, _Co, _VFM, _Sp, _Con, _S],
  [1, 1, 0, 0, 2, 0, 1, 2]
];
export var LanguageWithScore$: StaticStructureSchema = [3, n0, _LWS,
  0,
  [_LC, _Sc],
  [0, 1]
];
...
export var MedicalEntity$: StaticStructureSchema = [3, n0, _ME,
  0,
  [_ST, _ET, _C, _Co, _Con],
  [1, 1, 0, 0, 1]
];
export var MedicalItem$: StaticStructureSchema = [3, n0, _MI,
  0,
  [_ST, _ET, _Ty, _Co, _Con, _Sp],
  [1, 1, 0, 0, 1, 0]
];
export var MedicalResult$: StaticStructureSchema = [3, n0, _MR,
  0,
...
export var MedicalScribePostStreamAnalyticsResult$: StaticStructureSchema = [3, n0, _MSPSAR,
  0,
  [_CNGR],
...
export var MedicalScribeTranscriptItem$: StaticStructureSchema = [3, n0, _MSTI,
  0,
...
export var MedicalTranscriptEvent$: StaticStructureSchema = [3, n0, _MTE,
  0,
  [_T],
  [() => MedicalTranscript$]
];
export var PointsOfInterest$: StaticStructureSchema = [3, n0, _POI,
  0,
  [_TR],
  [() => TimestampRanges]
];
...
export var TranscriptEvent$: StaticStructureSchema = [3, n0, _TE,
  0,
  [_T],
  [() => Transcript$]
];
export var UtteranceEvent$: StaticStructureSchema = [3, n0, _UE,
  0,
...
var CallAnalyticsEntityList: StaticListSchema = [1, n0, _CAEL,
  0, () => CallAnalyticsEntity$
];
var CallAnalyticsItemList: StaticListSchema = [1, n0, _CAIL,
  0, () => CallAnalyticsItem$
];
var CallAnalyticsLanguageIdentification: StaticListSchema = [1, n0, _CALI,
...
var ItemList: StaticListSchema = [1, n0, _ILt,
  0, () => Item$
];
var LanguageIdentification: StaticListSchema = [1, n0, _LI,
  0, () => LanguageWithScore$
];
var MedicalAlternativeList: StaticListSchema = [1, n0, _MAL,
  0, () => MedicalAlternative$
];
var MedicalEntityList: StaticListSchema = [1, n0, _MEL,
  0, () => MedicalEntity$
];
var MedicalItemList: StaticListSchema = [1, n0, _MIL,
  0, () => MedicalItem$
];
var MedicalResultList: StaticListSchema = [1, n0, _MRL,
  0, () => MedicalResult$
];
var MedicalScribeChannelDefinitions: StaticListSchema = [1, n0, _MSCDe,
  0, () => MedicalScribeChannelDefinition$
];
var MedicalScribeTranscriptItemList: StaticListSchema = [1, n0, _MSTIL,
...
var StringList = 64 | 0;
var TimestampRanges: StaticListSchema = [1, n0, _TR,
  0, () => TimestampRange$
];
var KMSEncryptionContextMap = 128 | 0;
var MatchedCategoryDetails: StaticMapSchema = [2, n0, _MCD,
  0, 0, () => PointsOfInterest$
];
export var AudioStream$: StaticUnionSchema = [4, n0, _AS,
  { [_st]: 1 },
  [_AE, _CEo],
...
export var StartCallAnalyticsStreamTranscription$: StaticOperationSchema = [9, n0, _SCAST,
