...
export var CallAnalyticsLanguageIdentification: StaticListSchema = [
  1,
  n0,
  _CALI,
  0,
...
export var ItemList: StaticListSchema = [1, n0, _ILt, 0, () => Item];
export var LanguageIdentification: StaticListSchema = [1, n0, _LI, 0, () => LanguageWithScore];
export var MedicalAlternativeList: StaticListSchema = [1, n0, _MAL, 0, () => MedicalAlternative];
export var MedicalEntityList: StaticListSchema = [1, n0, _MEL, 0, () => MedicalEntity];
export var MedicalItemList: StaticListSchema = [1, n0, _MIL, 0, () => MedicalItem];
export var MedicalResultList: StaticListSchema = [1, n0, _MRL, 0, () => MedicalResult];
