...
const _s = "smithy.ts.sdk.synthetic.com.amazonaws.notificationscontacts";
...
export var NotificationsContactsServiceException$: StaticErrorSchema = [-3, _s, "NotificationsContactsServiceException", 0, [], []];
_s_registry.registerError(NotificationsContactsServiceException$, NotificationsContactsServiceException);
...
var EmailContacts: StaticListSchema = [1, n0, _ECm,
  0, [() => EmailContact$,
    0]
];
var TagKeys = 64 | 0;
...
var TagMap = 128 | 0;
export var ActivateEmailContact$: StaticOperationSchema = [9, n0, _AEC,
  { [_h]: ["PUT", "/emailcontacts/{arn}/activate/{code}", 200] }, () => ActivateEmailContactRequest$, () => ActivateEmailContactResponse$
];
export var CreateEmailContact$: StaticOperationSchema = [9, n0, _CEC,
  { [_h]: ["POST", "/2022-09-19/emailcontacts", 201] }, () => CreateEmailContactRequest$, () => CreateEmailContactResponse$
];
export var DeleteEmailContact$: StaticOperationSchema = [9, n0, _DEC,
  { [_h]: ["DELETE", "/emailcontacts/{arn}", 200] }, () => DeleteEmailContactRequest$, () => DeleteEmailContactResponse$
];
export var GetEmailContact$: StaticOperationSchema = [9, n0, _GEC,
  { [_h]: ["GET", "/emailcontacts/{arn}", 200] }, () => GetEmailContactRequest$, () => GetEmailContactResponse$
];
export var ListEmailContacts$: StaticOperationSchema = [9, n0, _LEC,
  { [_h]: ["GET", "/emailcontacts", 200] }, () => ListEmailContactsRequest$, () => ListEmailContactsResponse$
];
...
export var SendActivationCode$: StaticOperationSchema = [9, n0, _SAC,
  { [_h]: ["POST", "/2022-10-31/emailcontacts/{arn}/activate/send", 200] }, () => SendActivationCodeRequest$, () => SendActivationCodeResponse$
];
export var TagResource$: StaticOperationSchema = [9, n0, _TR,
  { [_h]: ["POST", "/tags/{arn}", 200] }, () => TagResourceRequest$, () => TagResourceResponse$
];
export var UntagResource$: StaticOperationSchema = [9, n0, _UR,
  { [_h]: ["DELETE", "/tags/{arn}", 200] }, () => UntagResourceRequest$, () => UntagResourceResponse$
];
