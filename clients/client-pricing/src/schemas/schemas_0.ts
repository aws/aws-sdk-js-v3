...
export var PricingServiceException$: StaticErrorSchema = [-3, _s, "PricingServiceException", 0, [], []];
...
export var AttributeValue$: StaticStructureSchema = [3, n0, _AV,
  0,
  [_V],
  [0]
];
...
export var PriceList$: StaticStructureSchema = [3, n0, _PL,
  0,
  [_PLA, _RC, _CC, _FFi],
  [0, 0, 0, 64 | 0]
];
...
var PriceListJsonItems: StaticListSchema = [1, n0, _PLJI,
  0, [() => SynthesizedJsonPriceListJsonItem,
    0]
];
var PriceLists: StaticListSchema = [1, n0, _PLr,
  0, () => PriceList$
];
var ServiceList: StaticListSchema = [1, n0, _SL,
  0, () => Service$
];
export var DescribeServices$: StaticOperationSchema = [9, n0, _DS,
  0, () => DescribeServicesRequest$, () => DescribeServicesResponse$
];
export var GetAttributeValues$: StaticOperationSchema = [9, n0, _GAV,
  0, () => GetAttributeValuesRequest$, () => GetAttributeValuesResponse$
];
export var GetPriceListFileUrl$: StaticOperationSchema = [9, n0, _GPLFU,
  0, () => GetPriceListFileUrlRequest$, () => GetPriceListFileUrlResponse$
];
export var GetProducts$: StaticOperationSchema = [9, n0, _GP,
  0, () => GetProductsRequest$, () => GetProductsResponse$
];
export var ListPriceLists$: StaticOperationSchema = [9, n0, _LPL,
