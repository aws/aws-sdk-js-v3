...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteLogAnomalyDetectorCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<DeleteLogAnomalyDetectorCommandInput, DeleteLogAnomalyDetectorCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteLogAnomalyDetectorCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "DeleteLogAnomalyDetectorCommand";
   ...
   * @internal
   */
  private serialize(input: DeleteLogAnomalyDetectorCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_DeleteLogAnomalyDetectorCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<DeleteLogAnomalyDetectorCommandOutput> {
    return de_DeleteLogAnomalyDetectorCommand(output, context);
  }
}
