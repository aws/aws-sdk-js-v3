...
> {
   ...
   * @public
   */
  constructor(readonly input: GetLogAnomalyDetectorCommandInput) {
    super();
  }
  ...
  ): Handler<GetLogAnomalyDetectorCommandInput, GetLogAnomalyDetectorCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, GetLogAnomalyDetectorCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: GetLogAnomalyDetectorCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetLogAnomalyDetectorCommandOutput> {
