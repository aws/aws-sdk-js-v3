 ...
 * @public
 */
export class DeleteDeliveryDestinationPolicyCommand extends command<DeleteDeliveryDestinationPolicyCommandInput, DeleteDeliveryDestinationPolicyCommandOutput>(
  _ep0,
  _mw0,
