 ...
 * @public
 */
export class ListAggregateLogGroupSummariesCommand extends command<ListAggregateLogGroupSummariesCommandInput, ListAggregateLogGroupSummariesCommandOutput>(
  _ep0,
  _mw0,
