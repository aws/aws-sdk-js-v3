 ...
 * @public
 */
export class AssociateSourceToS3TableIntegrationCommand extends command<AssociateSourceToS3TableIntegrationCommandInput, AssociateSourceToS3TableIntegrationCommandOutput>(
  _ep0,
  _mw0,
