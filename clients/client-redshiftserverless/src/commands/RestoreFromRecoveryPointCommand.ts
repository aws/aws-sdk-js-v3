 ...
 * ```javascript
 * import { RedshiftServerlessClient, RestoreFromRecoveryPointCommand } from "@aws-sdk/client-redshiftserverless"; // ES Modules import
 * // const { RedshiftServerlessClient, RestoreFromRecoveryPointCommand } = require("@aws-sdk/client-redshiftserverless"); // CommonJS import
...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: RestoreFromRecoveryPointRequest.filterSensitiveLog,
      outputFilterSensitiveLog: RestoreFromRecoveryPointResponse.filterSensitiveLog,
    };
