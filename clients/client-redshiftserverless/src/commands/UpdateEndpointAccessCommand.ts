 ...
 * ```javascript
 * import { RedshiftServerlessClient, UpdateEndpointAccessCommand } from "@aws-sdk/client-redshiftserverless"; // ES Modules import
 * // const { RedshiftServerlessClient, UpdateEndpointAccessCommand } = require("@aws-sdk/client-redshiftserverless"); // CommonJS import
...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: UpdateEndpointAccessRequest.filterSensitiveLog,
      outputFilterSensitiveLog: UpdateEndpointAccessResponse.filterSensitiveLog,
    };
