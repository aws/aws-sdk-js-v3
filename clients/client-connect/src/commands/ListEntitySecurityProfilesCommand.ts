...
import type { ListEntitySecurityProfilesRequest, ListEntitySecurityProfilesResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListEntitySecurityProfilesCommand extends command<ListEntitySecurityProfilesCommandInput, ListEntitySecurityProfilesCommandOutput>(
  _ep0,
  _mw0,
