...
import type { UpdateRoutingProfileQueuesRequest } from "../models/models_3";
 ...
 * @public
 */
export class UpdateRoutingProfileQueuesCommand extends command<UpdateRoutingProfileQueuesCommandInput, UpdateRoutingProfileQueuesCommandOutput>(
  _ep0,
  _mw0,
