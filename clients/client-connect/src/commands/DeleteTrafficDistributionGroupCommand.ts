 ...
 * @public
 */
export class DeleteTrafficDistributionGroupCommand extends command<DeleteTrafficDistributionGroupCommandInput, DeleteTrafficDistributionGroupCommandOutput>(
  _ep0,
  _mw0,
