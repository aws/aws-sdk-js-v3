...
import type { DeletePredefinedAttributeRequest } from "../models/models_1";
 ...
 * @public
 */
export class DeletePredefinedAttributeCommand extends command<DeletePredefinedAttributeCommandInput, DeletePredefinedAttributeCommandOutput>(
  _ep0,
  _mw0,
