...
> {
   ...
   * @public
   */
  constructor(readonly input: DeletePredefinedAttributeCommandInput) {
    super();
  }
  ...
  ): Handler<DeletePredefinedAttributeCommandInput, DeletePredefinedAttributeCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeletePredefinedAttributeCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: DeletePredefinedAttributeCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
