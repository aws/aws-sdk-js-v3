...
import type { GetTaskTemplateRequest, GetTaskTemplateResponse } from "../models/models_2";
 ...
 * @public
 */
export class GetTaskTemplateCommand extends command<GetTaskTemplateCommandInput, GetTaskTemplateCommandOutput>(
  _ep0,
  _mw0,
  "GetTaskTemplate",
  GetTaskTemplate$
