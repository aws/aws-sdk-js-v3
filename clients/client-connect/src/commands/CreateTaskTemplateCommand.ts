...
import type { CreateTaskTemplateRequest, CreateTaskTemplateResponse } from "../models/models_1";
 ...
 * @public
 */
export class CreateTaskTemplateCommand extends command<CreateTaskTemplateCommandInput, CreateTaskTemplateCommandOutput>(
  _ep0,
  _mw0,
  "CreateTaskTemplate",
  CreateTaskTemplate$
