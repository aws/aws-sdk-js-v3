...
import type { SearchContactFlowsResponse } from "../models/models_3";
 ...
 * @public
 */
export class SearchContactFlowsCommand extends command<SearchContactFlowsCommandInput, SearchContactFlowsCommandOutput>(
  _ep0,
  _mw0,
  "SearchContactFlows",
  SearchContactFlows$
