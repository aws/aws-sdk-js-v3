...
import type { UpdateRoutingProfileDefaultOutboundQueueRequest } from "../models/models_3";
 ...
 * @public
 */
export class UpdateRoutingProfileDefaultOutboundQueueCommand extends command<UpdateRoutingProfileDefaultOutboundQueueCommandInput, UpdateRoutingProfileDefaultOutboundQueueCommandOutput>(
  _ep0,
  _mw0,
