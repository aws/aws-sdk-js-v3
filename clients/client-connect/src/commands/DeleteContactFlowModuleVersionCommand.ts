...
import type { DeleteContactFlowModuleVersionRequest, DeleteContactFlowModuleVersionResponse } from "../models/models_1";
 ...
 * @public
 */
export class DeleteContactFlowModuleVersionCommand extends command<DeleteContactFlowModuleVersionCommandInput, DeleteContactFlowModuleVersionCommandOutput>(
  _ep0,
  _mw0,
