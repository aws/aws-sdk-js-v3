...
import type { DeleteEvaluationFormRequest } from "../models/models_1";
 ...
 * @public
 */
export class DeleteEvaluationFormCommand extends command<DeleteEvaluationFormCommandInput, DeleteEvaluationFormCommandOutput>(
  _ep0,
  _mw0,
