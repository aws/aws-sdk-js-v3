...
import type { UpdateQueueMaxContactsRequest } from "../models/models_3";
 ...
 * @public
 */
export class UpdateQueueMaxContactsCommand extends command<UpdateQueueMaxContactsCommandInput, UpdateQueueMaxContactsCommandOutput>(
  _ep0,
  _mw0,
