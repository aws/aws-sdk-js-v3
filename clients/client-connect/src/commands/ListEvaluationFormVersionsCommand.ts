...
import type { ListEvaluationFormVersionsRequest, ListEvaluationFormVersionsResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListEvaluationFormVersionsCommand extends command<ListEvaluationFormVersionsCommandInput, ListEvaluationFormVersionsCommandOutput>(
  _ep0,
  _mw0,
