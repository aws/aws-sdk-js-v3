...
import type { ResumeContactRequest, ResumeContactResponse } from "../models/models_3";
 ...
 * @public
 */
export class ResumeContactCommand extends command<ResumeContactCommandInput, ResumeContactCommandOutput>(
  _ep0,
  _mw0,
  "ResumeContact",
  ResumeContact$
