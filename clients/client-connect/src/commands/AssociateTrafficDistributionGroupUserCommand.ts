 ...
 * @public
 */
export class AssociateTrafficDistributionGroupUserCommand extends command<AssociateTrafficDistributionGroupUserCommandInput, AssociateTrafficDistributionGroupUserCommandOutput>(
  _ep0,
  _mw0,
