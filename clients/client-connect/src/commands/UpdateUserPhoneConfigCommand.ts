...
import type { UpdateUserPhoneConfigRequest } from "../models/models_4";
 ...
 * @public
 */
export class UpdateUserPhoneConfigCommand extends command<UpdateUserPhoneConfigCommandInput, UpdateUserPhoneConfigCommandOutput>(
  _ep0,
  _mw0,
