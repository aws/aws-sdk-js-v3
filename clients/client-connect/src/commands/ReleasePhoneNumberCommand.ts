...
import type { ReleasePhoneNumberRequest } from "../models/models_3";
 ...
 * @public
 */
export class ReleasePhoneNumberCommand extends command<ReleasePhoneNumberCommandInput, ReleasePhoneNumberCommandOutput>(
  _ep0,
  _mw0,
  "ReleasePhoneNumber",
  ReleasePhoneNumber$
