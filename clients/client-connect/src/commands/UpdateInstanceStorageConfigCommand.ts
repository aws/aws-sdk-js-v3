...
import type { UpdateInstanceStorageConfigRequest } from "../models/models_3";
import { UpdateInstanceStorageConfig$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateInstanceStorageConfigCommand extends command<UpdateInstanceStorageConfigCommandInput, UpdateInstanceStorageConfigCommandOutput>(
  _ep0,
  _mw0,
