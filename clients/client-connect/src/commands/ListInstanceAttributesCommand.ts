...
import type { ListInstanceAttributesRequest, ListInstanceAttributesResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListInstanceAttributesCommand extends command<ListInstanceAttributesCommandInput, ListInstanceAttributesCommandOutput>(
  _ep0,
  _mw0,
