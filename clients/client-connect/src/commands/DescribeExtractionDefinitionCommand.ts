...
import { DescribeExtractionDefinition$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DescribeExtractionDefinitionCommand extends command<DescribeExtractionDefinitionCommandInput, DescribeExtractionDefinitionCommandOutput>(
  _ep0,
  _mw0,
