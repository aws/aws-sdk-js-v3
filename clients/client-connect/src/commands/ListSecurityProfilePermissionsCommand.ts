 ...
 * @public
 */
export class ListSecurityProfilePermissionsCommand extends command<ListSecurityProfilePermissionsCommandInput, ListSecurityProfilePermissionsCommandOutput>(
  _ep0,
  _mw0,
