...
import type { SearchDataTablesResponse } from "../models/models_3";
import type { SearchDataTablesRequest } from "../models/models_4";
 ...
 * @public
 */
export class SearchDataTablesCommand extends command<SearchDataTablesCommandInput, SearchDataTablesCommandOutput>(
  _ep0,
  _mw0,
  "SearchDataTables",
  SearchDataTables$
