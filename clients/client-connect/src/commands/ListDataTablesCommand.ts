...
import type { ListDataTablesRequest, ListDataTablesResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListDataTablesCommand extends command<ListDataTablesCommandInput, ListDataTablesCommandOutput>(
  _ep0,
  _mw0,
  "ListDataTables",
  ListDataTables$
