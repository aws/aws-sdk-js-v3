 ...
 * @public
 */
export class StartContactConversationalAnalyticsJobCommand extends command<StartContactConversationalAnalyticsJobCommandInput, StartContactConversationalAnalyticsJobCommandOutput>(
  _ep0,
  _mw0,
