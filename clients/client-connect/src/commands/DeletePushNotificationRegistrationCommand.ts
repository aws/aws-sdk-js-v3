 ...
 * @public
 */
export class DeletePushNotificationRegistrationCommand extends command<DeletePushNotificationRegistrationCommandInput, DeletePushNotificationRegistrationCommandOutput>(
  _ep0,
  _mw0,
