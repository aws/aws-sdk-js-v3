...
import type { ListWorkspaceMediaRequest, ListWorkspaceMediaResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListWorkspaceMediaCommand extends command<ListWorkspaceMediaCommandInput, ListWorkspaceMediaCommandOutput>(
  _ep0,
  _mw0,
  "ListWorkspaceMedia",
  ListWorkspaceMedia$
