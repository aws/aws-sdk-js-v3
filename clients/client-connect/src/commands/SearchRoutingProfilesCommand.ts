...
import type { SearchRoutingProfilesResponse } from "../models/models_3";
import type { SearchRoutingProfilesRequest } from "../models/models_4";
 ...
 * @public
 */
export class SearchRoutingProfilesCommand extends command<SearchRoutingProfilesCommandInput, SearchRoutingProfilesCommandOutput>(
  _ep0,
  _mw0,
