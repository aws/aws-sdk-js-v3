...
import type { SearchPredefinedAttributesResponse } from "../models/models_3";
import type { SearchPredefinedAttributesRequest } from "../models/models_4";
 ...
 * @public
 */
export class SearchPredefinedAttributesCommand extends command<SearchPredefinedAttributesCommandInput, SearchPredefinedAttributesCommandOutput>(
  _ep0,
  _mw0,
