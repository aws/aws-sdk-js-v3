 ...
 * @public
 */
export class ListAttachedFilesConfigurationsCommand extends command<ListAttachedFilesConfigurationsCommandInput, ListAttachedFilesConfigurationsCommandOutput>(
  _ep0,
  _mw0,
