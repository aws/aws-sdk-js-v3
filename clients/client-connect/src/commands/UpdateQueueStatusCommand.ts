...
import type { UpdateQueueStatusRequest } from "../models/models_3";
 ...
 * @public
 */
export class UpdateQueueStatusCommand extends command<UpdateQueueStatusCommandInput, UpdateQueueStatusCommandOutput>(
  _ep0,
  _mw0,
  "UpdateQueueStatus",
  UpdateQueueStatus$
