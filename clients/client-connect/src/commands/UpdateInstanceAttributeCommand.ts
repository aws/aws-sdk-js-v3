...
import type { UpdateInstanceAttributeRequest } from "../models/models_3";
 ...
 * @public
 */
export class UpdateInstanceAttributeCommand extends command<UpdateInstanceAttributeCommandInput, UpdateInstanceAttributeCommandOutput>(
  _ep0,
  _mw0,
