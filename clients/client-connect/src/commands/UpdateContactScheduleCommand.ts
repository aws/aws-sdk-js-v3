...
import { UpdateContactSchedule$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateContactScheduleCommand extends command<UpdateContactScheduleCommandInput, UpdateContactScheduleCommandOutput>(
  _ep0,
  _mw0,
