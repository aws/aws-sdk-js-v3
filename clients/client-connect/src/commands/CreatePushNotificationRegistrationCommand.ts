 ...
 * @public
 */
export class CreatePushNotificationRegistrationCommand extends command<CreatePushNotificationRegistrationCommandInput, CreatePushNotificationRegistrationCommandOutput>(
  _ep0,
  _mw0,
