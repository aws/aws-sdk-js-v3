...
import type { DisassociateBotRequest } from "../models/models_1";
 ...
 * @public
 */
export class DisassociateBotCommand extends command<DisassociateBotCommandInput, DisassociateBotCommandOutput>(
  _ep0,
  _mw0,
  "DisassociateBot",
  DisassociateBot$
