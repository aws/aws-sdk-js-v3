...
import { TransferContact$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class TransferContactCommand extends command<TransferContactCommandInput, TransferContactCommandOutput>(
  _ep0,
  _mw0,
  "TransferContact",
  TransferContact$
