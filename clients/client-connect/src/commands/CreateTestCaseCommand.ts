...
import type { CreateTestCaseRequest, CreateTestCaseResponse } from "../models/models_1";
 ...
 * @public
 */
export class CreateTestCaseCommand extends command<CreateTestCaseCommandInput, CreateTestCaseCommandOutput>(
  _ep0,
  _mw0,
  "CreateTestCase",
  CreateTestCase$
