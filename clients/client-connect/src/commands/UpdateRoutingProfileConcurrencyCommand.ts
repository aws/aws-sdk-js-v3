 ...
 * @public
 */
export class UpdateRoutingProfileConcurrencyCommand extends command<UpdateRoutingProfileConcurrencyCommandInput, UpdateRoutingProfileConcurrencyCommandOutput>(
  _ep0,
  _mw0,
