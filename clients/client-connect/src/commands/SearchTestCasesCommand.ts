...
import type { SearchTestCasesResponse } from "../models/models_3";
import type { SearchTestCasesRequest } from "../models/models_4";
 ...
 * @public
 */
export class SearchTestCasesCommand extends command<SearchTestCasesCommandInput, SearchTestCasesCommandOutput>(
  _ep0,
  _mw0,
  "SearchTestCases",
  SearchTestCases$
