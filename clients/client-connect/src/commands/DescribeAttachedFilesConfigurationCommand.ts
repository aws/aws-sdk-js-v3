 ...
 * @public
 */
export class DescribeAttachedFilesConfigurationCommand extends command<DescribeAttachedFilesConfigurationCommandInput, DescribeAttachedFilesConfigurationCommandOutput>(
  _ep0,
  _mw0,
