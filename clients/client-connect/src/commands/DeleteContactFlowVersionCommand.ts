...
import type { DeleteContactFlowVersionRequest, DeleteContactFlowVersionResponse } from "../models/models_1";
 ...
 * @public
 */
export class DeleteContactFlowVersionCommand extends command<DeleteContactFlowVersionCommandInput, DeleteContactFlowVersionCommandOutput>(
  _ep0,
  _mw0,
