 ...
 * @public
 */
export class UpdateContactFlowModuleContentCommand extends command<UpdateContactFlowModuleContentCommandInput, UpdateContactFlowModuleContentCommandOutput>(
  _ep0,
  _mw0,
