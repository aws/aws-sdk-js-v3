 ...
 * @public
 */
export class DescribeAuthenticationProfileCommand extends command<DescribeAuthenticationProfileCommandInput, DescribeAuthenticationProfileCommandOutput>(
  _ep0,
  _mw0,
