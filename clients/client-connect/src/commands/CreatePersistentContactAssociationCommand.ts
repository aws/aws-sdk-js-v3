 ...
 * @public
 */
export class CreatePersistentContactAssociationCommand extends command<CreatePersistentContactAssociationCommandInput, CreatePersistentContactAssociationCommandOutput>(
  _ep0,
  _mw0,
