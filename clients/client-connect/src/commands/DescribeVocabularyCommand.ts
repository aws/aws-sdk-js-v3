...
import type { DescribeVocabularyRequest, DescribeVocabularyResponse } from "../models/models_1";
 ...
 * @public
 */
export class DescribeVocabularyCommand extends command<DescribeVocabularyCommandInput, DescribeVocabularyCommandOutput>(
  _ep0,
  _mw0,
  "DescribeVocabulary",
  DescribeVocabulary$
