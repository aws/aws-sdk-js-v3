...
import type { UpdateTaskTemplateRequest, UpdateTaskTemplateResponse } from "../models/models_3";
 ...
 * @public
 */
export class UpdateTaskTemplateCommand extends command<UpdateTaskTemplateCommandInput, UpdateTaskTemplateCommandOutput>(
  _ep0,
  _mw0,
  "UpdateTaskTemplate",
  UpdateTaskTemplate$
