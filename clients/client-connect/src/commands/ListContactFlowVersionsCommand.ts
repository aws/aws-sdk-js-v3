...
import type { ListContactFlowVersionsRequest, ListContactFlowVersionsResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListContactFlowVersionsCommand extends command<ListContactFlowVersionsCommandInput, ListContactFlowVersionsCommandOutput>(
  _ep0,
  _mw0,
