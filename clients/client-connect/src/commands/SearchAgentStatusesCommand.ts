...
import type { SearchAgentStatusesResponse } from "../models/models_3";
 ...
 * @public
 */
export class SearchAgentStatusesCommand extends command<SearchAgentStatusesCommandInput, SearchAgentStatusesCommandOutput>(
  _ep0,
  _mw0,
  "SearchAgentStatuses",
  SearchAgentStatuses$
