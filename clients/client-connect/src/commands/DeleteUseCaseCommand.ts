...
import type { DeleteUseCaseRequest } from "../models/models_1";
 ...
 * @public
 */
export class DeleteUseCaseCommand extends command<DeleteUseCaseCommandInput, DeleteUseCaseCommandOutput>(
  _ep0,
  _mw0,
  "DeleteUseCase",
  DeleteUseCase$
