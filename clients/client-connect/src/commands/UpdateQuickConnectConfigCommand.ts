...
import type { UpdateQuickConnectConfigRequest } from "../models/models_3";
 ...
 * @public
 */
export class UpdateQuickConnectConfigCommand extends command<UpdateQuickConnectConfigCommandInput, UpdateQuickConnectConfigCommandOutput>(
  _ep0,
  _mw0,
