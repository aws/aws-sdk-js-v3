...
import type { GetContactMetricsRequest } from "../models/models_1";
import type { GetContactMetricsResponse } from "../models/models_2";
 ...
 * @public
 */
export class GetContactMetricsCommand extends command<GetContactMetricsCommandInput, GetContactMetricsCommandOutput>(
  _ep0,
  _mw0,
  "GetContactMetrics",
  GetContactMetrics$
