 ...
 * @public
 */
export class DisassociateHoursOfOperationsCommand extends command<DisassociateHoursOfOperationsCommandInput, DisassociateHoursOfOperationsCommandOutput>(
  _ep0,
  _mw0,
