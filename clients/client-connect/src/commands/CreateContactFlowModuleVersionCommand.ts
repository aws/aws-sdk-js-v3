 ...
 * @public
 */
export class CreateContactFlowModuleVersionCommand extends command<CreateContactFlowModuleVersionCommandInput, CreateContactFlowModuleVersionCommandOutput>(
  _ep0,
  _mw0,
