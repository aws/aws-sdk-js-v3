 ...
 * @public
 */
export class DescribeTrafficDistributionGroupCommand extends command<DescribeTrafficDistributionGroupCommandInput, DescribeTrafficDistributionGroupCommandOutput>(
  _ep0,
  _mw0,
