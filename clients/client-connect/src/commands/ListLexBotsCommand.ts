...
import type { ListLexBotsRequest, ListLexBotsResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListLexBotsCommand extends command<ListLexBotsCommandInput, ListLexBotsCommandOutput>(
  _ep0,
  _mw0,
  "ListLexBots",
  ListLexBots$
