...
import type { CreateViewVersionRequest, CreateViewVersionResponse } from "../models/models_1";
 ...
 * @public
 */
export class CreateViewVersionCommand extends command<CreateViewVersionCommandInput, CreateViewVersionCommandOutput>(
  _ep0,
  _mw0,
  "CreateViewVersion",
  CreateViewVersion$
