...
import { UpdateExtractionDefinition$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateExtractionDefinitionCommand extends command<UpdateExtractionDefinitionCommandInput, UpdateExtractionDefinitionCommandOutput>(
  _ep0,
  _mw0,
