...
import type { SearchResourceTagsRequest, SearchResourceTagsResponse } from "../models/models_3";
 ...
 * @public
 */
export class SearchResourceTagsCommand extends command<SearchResourceTagsCommandInput, SearchResourceTagsCommandOutput>(
  _ep0,
  _mw0,
  "SearchResourceTags",
  SearchResourceTags$
