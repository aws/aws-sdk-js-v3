...
import type { ImportPhoneNumberRequest, ImportPhoneNumberResponse } from "../models/models_2";
 ...
 * @public
 */
export class ImportPhoneNumberCommand extends command<ImportPhoneNumberCommandInput, ImportPhoneNumberCommandOutput>(
  _ep0,
  _mw0,
  "ImportPhoneNumber",
  ImportPhoneNumber$
