 ...
 * @public
 */
export class ListTrafficDistributionGroupsCommand extends command<ListTrafficDistributionGroupsCommandInput, ListTrafficDistributionGroupsCommandOutput>(
  _ep0,
  _mw0,
