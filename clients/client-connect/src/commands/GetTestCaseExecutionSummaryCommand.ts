...
import type { GetTestCaseExecutionSummaryRequest, GetTestCaseExecutionSummaryResponse } from "../models/models_2";
 ...
 * @public
 */
export class GetTestCaseExecutionSummaryCommand extends command<GetTestCaseExecutionSummaryCommandInput, GetTestCaseExecutionSummaryCommandOutput>(
  _ep0,
  _mw0,
