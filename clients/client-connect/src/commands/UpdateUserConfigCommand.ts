...
import type { UpdateUserConfigRequest } from "../models/models_4";
 ...
 * @public
 */
export class UpdateUserConfigCommand extends command<UpdateUserConfigCommandInput, UpdateUserConfigCommandOutput>(
  _ep0,
  _mw0,
  "UpdateUserConfig",
  UpdateUserConfig$
