 ...
 * @public
 */
export class DisassociateQueueQuickConnectsCommand extends command<DisassociateQueueQuickConnectsCommandInput, DisassociateQueueQuickConnectsCommandOutput>(
  _ep0,
  _mw0,
