...
> {
   ...
   * @public
   */
  constructor(readonly input: ListRealtimeContactAnalysisSegmentsV2CommandInput) {
    super();
  }
  ...
  ): Handler<ListRealtimeContactAnalysisSegmentsV2CommandInput, ListRealtimeContactAnalysisSegmentsV2CommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListRealtimeContactAnalysisSegmentsV2Command.getEndpointParameterInstructions())
    );
