...
import type { UpdatePromptRequest, UpdatePromptResponse } from "../models/models_3";
 ...
 * @public
 */
export class UpdatePromptCommand extends command<UpdatePromptCommandInput, UpdatePromptCommandOutput>(
  _ep0,
  _mw0,
  "UpdatePrompt",
  UpdatePrompt$
