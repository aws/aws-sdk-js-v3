 ...
 * @public
 */
export class UpdateHoursOfOperationOverrideCommand extends command<UpdateHoursOfOperationOverrideCommandInput, UpdateHoursOfOperationOverrideCommandOutput>(
  _ep0,
  _mw0,
