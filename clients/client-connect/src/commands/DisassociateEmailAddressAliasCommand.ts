 ...
 * @public
 */
export class DisassociateEmailAddressAliasCommand extends command<DisassociateEmailAddressAliasCommandInput, DisassociateEmailAddressAliasCommandOutput>(
  _ep0,
  _mw0,
