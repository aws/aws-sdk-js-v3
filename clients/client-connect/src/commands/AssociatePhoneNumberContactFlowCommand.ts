 ...
 * @public
 */
export class AssociatePhoneNumberContactFlowCommand extends command<AssociatePhoneNumberContactFlowCommandInput, AssociatePhoneNumberContactFlowCommandOutput>(
  _ep0,
  _mw0,
