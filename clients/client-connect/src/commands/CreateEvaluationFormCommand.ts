...
import type { CreateEvaluationFormRequest } from "../models/models_4";
 ...
 * @public
 */
export class CreateEvaluationFormCommand extends command<CreateEvaluationFormCommandInput, CreateEvaluationFormCommandOutput>(
  _ep0,
  _mw0,
