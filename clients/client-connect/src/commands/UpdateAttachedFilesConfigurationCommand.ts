 ...
 * @public
 */
export class UpdateAttachedFilesConfigurationCommand extends command<UpdateAttachedFilesConfigurationCommandInput, UpdateAttachedFilesConfigurationCommandOutput>(
  _ep0,
  _mw0,
