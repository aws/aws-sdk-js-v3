...
import type { StopContactRequest, StopContactResponse } from "../models/models_3";
 ...
 * @public
 */
export class StopContactCommand extends command<StopContactCommandInput, StopContactCommandOutput>(
  _ep0,
  _mw0,
  "StopContact",
  StopContact$
