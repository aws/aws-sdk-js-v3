...
import type { UpdateUserHierarchyRequest } from "../models/models_4";
 ...
 * @public
 */
export class UpdateUserHierarchyCommand extends command<UpdateUserHierarchyCommandInput, UpdateUserHierarchyCommandOutput>(
  _ep0,
  _mw0,
  "UpdateUserHierarchy",
  UpdateUserHierarchy$
