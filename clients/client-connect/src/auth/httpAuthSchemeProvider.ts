...
import { type ConnectClientResolvedConfig, ConnectClientConfig } from "../ConnectClient";
 ...
 * @internal
 */
export const defaultConnectHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ConnectHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultConnectHttpAuthSchemeProvider: ConnectHttpAuthSchemeProvider = (authParameters) => {
