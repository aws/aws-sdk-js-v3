...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DescribeUserHierarchyStructureCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeUserHierarchyStructureCommand(output, context);
  }
