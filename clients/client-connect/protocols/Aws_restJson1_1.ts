...
const deserializeAws_restJson1_1QueueSummary = (
  ...
  return {
    ...
    Name: output.Name !== undefined && output.Name !== null ? output.Name : undefined,
    QueueType:
      output.QueueType !== undefined && output.QueueType !== null ? output.QueueType : undefined
  } as any;
};
  ...
  return {
    ...
    AfterContactWorkTimeLimit:
      output.AfterContactWorkTimeLimit !== undefined && output.AfterContactWorkTimeLimit !== null
        ...
        : undefined,
    AutoAccept:
      output.AutoAccept !== undefined && output.AutoAccept !== null ? output.AutoAccept : undefined,
    DeskPhoneNumber:
