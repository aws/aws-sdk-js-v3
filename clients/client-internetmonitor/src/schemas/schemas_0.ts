...
export var FilterParameter$: StaticStructureSchema = [3, n0, _FP,
  0,
  [_F, _O, _V],
  [0, 0, 64 | 0]
];
...
export var InternetMeasurementsLogDelivery$: StaticStructureSchema = [3, n0, _IMLD,
  0,
  [_SCo],
  [() => S3Config$]
];
...
export var LocalHealthEventsConfig$: StaticStructureSchema = [3, n0, _LHEC,
  0,
  [_St, _HST, _MTI],
  [0, 1, 1]
];
...
export var QueryField$: StaticStructureSchema = [3, n0, _QF,
  0,
  [_Na, _Ty],
  [0, 0]
];
...
var HealthEventList: StaticListSchema = [1, n0, _HEL,
  0, () => HealthEvent$
];
var ImpactedLocationsList: StaticListSchema = [1, n0, _ILL,
  0, () => ImpactedLocation$
];
var InternetEventsList: StaticListSchema = [1, n0, _IEL,
...
var NetworkList: StaticListSchema = [1, n0, _NL,
  0, () => Network$
];
var QueryData: StaticListSchema = [1, n0, _QD,
  0, 64 | 0
];
var QueryFields: StaticListSchema = [1, n0, _QFu,
  0, () => QueryField$
];
var QueryRow = 64 | 0;
var SetOfARNs = 64 | 0;
...
export var GetHealthEvent$: StaticOperationSchema = [9, n0, _GHE,
  { [_h]: ["GET", "/v20210603/Monitors/{MonitorName}/HealthEvents/{EventId}", 200] }, () => GetHealthEventInput$, () => GetHealthEventOutput$
];
export var GetInternetEvent$: StaticOperationSchema = [9, n0, _GIE,
...
export var StopQuery$: StaticOperationSchema = [9, n0, _SQt,
