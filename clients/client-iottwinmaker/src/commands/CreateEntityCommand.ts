...
import type { CreateEntityRequest, CreateEntityResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateEntityCommand extends command<CreateEntityCommandInput, CreateEntityCommandOutput>(
  _ep0,
  _mw0,
  "CreateEntity",
  CreateEntity$
