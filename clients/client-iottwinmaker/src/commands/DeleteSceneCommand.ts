...
import type { DeleteSceneRequest, DeleteSceneResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteSceneCommand extends command<DeleteSceneCommandInput, DeleteSceneCommandOutput>(
  _ep0,
  _mw0,
  "DeleteScene",
  DeleteScene$
