...
import type { ListComponentTypesRequest, ListComponentTypesResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListComponentTypesCommand extends command<ListComponentTypesCommandInput, ListComponentTypesCommandOutput>(
  _ep0,
  _mw0,
  "ListComponentTypes",
  ListComponentTypes$
