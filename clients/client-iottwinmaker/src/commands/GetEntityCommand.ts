...
import type { GetEntityRequest, GetEntityResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetEntityCommand extends command<GetEntityCommandInput, GetEntityCommandOutput>(
  _ep0,
  _mw0,
  "GetEntity",
  GetEntity$
