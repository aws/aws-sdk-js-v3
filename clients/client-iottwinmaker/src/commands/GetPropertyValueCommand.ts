...
import type { GetPropertyValueRequest, GetPropertyValueResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetPropertyValueCommand extends command<GetPropertyValueCommandInput, GetPropertyValueCommandOutput>(
  _ep0,
  _mw0,
  "GetPropertyValue",
  GetPropertyValue$
