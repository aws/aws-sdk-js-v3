...
import type { CreateComponentTypeRequest, CreateComponentTypeResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateComponentTypeCommand extends command<CreateComponentTypeCommandInput, CreateComponentTypeCommandOutput>(
  _ep0,
  _mw0,
  "CreateComponentType",
  CreateComponentType$
