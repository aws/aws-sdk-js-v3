...
import type { GetSyncJobRequest, GetSyncJobResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetSyncJobCommand extends command<GetSyncJobCommandInput, GetSyncJobCommandOutput>(
  _ep0,
  _mw0,
  "GetSyncJob",
  GetSyncJob$
