...
export var ComponentPropertyGroupRequest$: StaticStructureSchema = [3, n0, _CPGR,
  0,
  [_gT, _pN, _uT],
  [0, 64 | 0, 0]
];
...
export var CompositeComponentRequest$: StaticStructureSchema = [3, n0, _CCR,
  0,
  [_d, _pr, _pG],
  [0, () => PropertyRequests, () => ComponentPropertyGroupRequests]
];
export var CompositeComponentTypeRequest$: StaticStructureSchema = [3, n0, _CCTR,
  0,
  [_cTI],
  [0]
];
export var CompositeComponentTypeResponse$: StaticStructureSchema = [3, n0, _CCTRo,
  0,
  [_cTI, _iI],
  [0, 2]
];
export var CompositeComponentUpdateRequest$: StaticStructureSchema = [3, n0, _CCUR,
  0,
  [_uT, _d, _pU, _pGU],
  [0, 0, () => PropertyRequests, () => ComponentPropertyGroupRequests]
];
...
export var FilterByAsset$: StaticStructureSchema = [3, n0, _FBA,
  0,
  [_aI, _aEI, _iO, _iAM],
  [0, 0, 2, 2]
];
export var FilterByAssetModel$: StaticStructureSchema = [3, n0, _FBAM,
  0,
  [_aMI, _aMEI, _iO, _iA],
  [0, 0, 2, 2]
];
...
export var FunctionResponse$: StaticStructureSchema = [3, n0, _FRu,
  0,
  [_rP, _sc, _iB, _iI],
...
export var IotSiteWiseSourceConfiguration$: StaticStructureSchema = [3, n0, _ISWSC,
  0,
  [_fi],
...
export var MetadataTransferJobProgress$: StaticStructureSchema = [3, n0, _MTJP,
  0,
  [_tCo, _sCu, _sCk, _fC],
  [1, 1, 1, 1]
];
...
export var PropertyGroupRequest$: StaticStructureSchema = [3, n0, _PGR,
  0,
  [_gT, _pN],
  [0, 64 | 0]
];
...
export var PropertyResponse$: StaticStructureSchema = [3, n0, _PRr,
  0,
  [_def, _v, _aAPVR],
...
export var RelationshipValue$: StaticStructureSchema = [3, n0, _RV,
  0,
  [_tEI, _tCN],
  [0, 0]
];
...
var ComponentSummaries: StaticListSchema = [1, n0, _CSo,
  0, () => ComponentSummary$
];
var ComponentTypeSummaries: StaticListSchema = [1, n0, _CTSo,
  0, () => ComponentTypeSummary$
];
var DataValueList: StaticListSchema = [1, n0, _DVL,
  0, () => DataValue$
];
var EntitySummaries: StaticListSchema = [1, n0, _ESn,
  0, () => EntitySummary$
];
var Entries: StaticListSchema = [1, n0, _E,
  0, () => PropertyValueEntry$
];
var ErrorEntries: StaticListSchema = [1, n0, _EE,
...
var IotSiteWiseSourceConfigurationFilters: StaticListSchema = [1, n0, _ISWSCF,
  0, () => IotSiteWiseSourceConfigurationFilter$
];
var IotTwinMakerSourceConfigurationFilters: StaticListSchema = [1, n0, _ITMSCF,
  0, () => IotTwinMakerSourceConfigurationFilter$
];
var LinkedServices = 64 | 0;
var ListComponentTypesFilters: StaticListSchema = [1, n0, _LCTF,
  0, () => ListComponentTypesFilter$
];
var ListEntitiesFilters: StaticListSchema = [1, n0, _LEF,
  0, () => ListEntitiesFilter$
];
var ListMetadataTransferJobsFilters: StaticListSchema = [1, n0, _LMTJF,
  0, () => ListMetadataTransferJobsFilter$
];
var MetadataTransferJobSummaries: StaticListSchema = [1, n0, _MTJSet,
  0, () => MetadataTransferJobSummary$
];
var OrderByList: StaticListSchema = [1, n0, _OBL,
  0, () => OrderBy$
];
var PricingBundles = 64 | 0;
var PropertyFilters: StaticListSchema = [1, n0, _PFr,
  0, () => PropertyFilter$
];
var PropertyNames = 64 | 0;
var PropertySummaries: StaticListSchema = [1, n0, _PSr,
  0, () => PropertySummary$
];
var PropertyValueList: StaticListSchema = [1, n0, _PVL,
  0, () => PropertyValueHistory$
];
var PropertyValues: StaticListSchema = [1, n0, _PVr,
  0, () => PropertyValue$
];
...
var SceneSummaries: StaticListSchema = [1, n0, _SSc,
  0, () => SceneSummary$
];
var SelectedPropertyList = 64 | 0;
var SourceConfigurations: StaticListSchema = [1, n0, _SCo,
  0, () => SourceConfiguration$
];
var SyncJobSummaries: StaticListSchema = [1, n0, _SJSyn,
  0, () => SyncJobSummary$
];
var SyncResourceFilters: StaticListSchema = [1, n0, _SRF,
  0, () => SyncResourceFilter$
];
var SyncResourceSummaries: StaticListSchema = [1, n0, _SRSyn,
  0, () => SyncResourceSummary$
];
var TabularPropertyValue: StaticListSchema = [1, n0, _TPVa,
  0, () => PropertyTableValue
];
var TabularPropertyValues: StaticListSchema = [1, n0, _TPV,
  0, () => TabularPropertyValue
];
var TagKeyList = 64 | 0;
var Values: StaticListSchema = [1, n0, _V,
  0, () => PropertyValue$
];
var WorkspaceSummaries: StaticListSchema = [1, n0, _WSo,
  0, () => WorkspaceSummary$
];
var ComponentPropertyGroupRequests: StaticMapSchema = [2, n0, _CPGRom,
  0, 0, () => ComponentPropertyGroupRequest$
];
var ComponentPropertyGroupResponses: StaticMapSchema = [2, n0, _CPGRomp,
  0, 0, () => ComponentPropertyGroupResponse$
];
var ComponentsMap: StaticMapSchema = [2, n0, _CM,
  0, 0, () => ComponentResponse$
];
var ComponentsMapRequest: StaticMapSchema = [2, n0, _CMR,
  0, 0, () => ComponentRequest$
];
var ComponentUpdatesMapRequest: StaticMapSchema = [2, n0, _CUMR,
  0, 0, () => ComponentUpdateRequest$
];
var CompositeComponentResponse: StaticMapSchema = [2, n0, _CCRo,
  0, 0, () => ComponentSummary$
];
var CompositeComponentsMapRequest: StaticMapSchema = [2, n0, _CCMR,
  0, 0, () => CompositeComponentRequest$
];
var CompositeComponentTypesRequest: StaticMapSchema = [2, n0, _CCTRom,
  0, 0, () => CompositeComponentTypeRequest$
];
var CompositeComponentTypesResponse: StaticMapSchema = [2, n0, _CCTRomp,
  0, 0, () => CompositeComponentTypeResponse$
];
var CompositeComponentUpdatesMapRequest: StaticMapSchema = [2, n0, _CCUMR,
  0, 0, () => CompositeComponentUpdateRequest$
];
var Configuration = 128 | 0;
var DataValueMap: StaticMapSchema = [2, n0, _DVM,
  0, 0, () => DataValue$
];
var ExternalIdProperty = 128 | 0;
var FunctionsRequest: StaticMapSchema = [2, n0, _FRun,
  0, 0, () => FunctionRequest$
];
var FunctionsResponse: StaticMapSchema = [2, n0, _FRunc,
  0, 0, () => FunctionResponse$
];
var GeneratedSceneMetadataMap = 128 | 0;
var PropertyDefinitionsRequest: StaticMapSchema = [2, n0, _PDRro,
  0, 0, () => PropertyDefinitionRequest$
];
var PropertyDefinitionsResponse: StaticMapSchema = [2, n0, _PDRrop,
  0, 0, () => PropertyDefinitionResponse$
];
var PropertyGroupsRequest: StaticMapSchema = [2, n0, _PGRro,
  0, 0, () => PropertyGroupRequest$
];
var PropertyGroupsResponse: StaticMapSchema = [2, n0, _PGRrop,
  0, 0, () => PropertyGroupResponse$
];
var PropertyLatestValueMap: StaticMapSchema = [2, n0, _PLVM,
  0, 0, () => PropertyLatestValue$
];
var PropertyRequests: StaticMapSchema = [2, n0, _PRro,
  0, 0, () => PropertyRequest$
];
var PropertyResponses: StaticMapSchema = [2, n0, _PRrop,
  0, 0, () => PropertyResponse$
];
var PropertyTableValue: StaticMapSchema = [2, n0, _PTV,
  0, 0, () => DataValue$
];
var SceneMetadataMap = 128 | 0;
var TagMap = 128 | 0;
export var IotSiteWiseSourceConfigurationFilter$: StaticUnionSchema = [4, n0, _ISWSCFo,
  0,
  [_fBAM, _fBA],
  [() => FilterByAssetModel$, () => FilterByAsset$]
];
export var IotTwinMakerSourceConfigurationFilter$: StaticUnionSchema = [4, n0, _ITMSCFo,
  0,
  [_fBCT, _fBE],
  [() => FilterByComponentType$, () => FilterByEntity$]
];
export var ListComponentTypesFilter$: StaticUnionSchema = [4, n0, _LCTFi,
  0,
  [_eF, _na, _iAs],
  [0, 0, 2]
];
export var ListEntitiesFilter$: StaticUnionSchema = [4, n0, _LEFi,
  0,
  [_pEI, _cTI, _eIx],
  [0, 0, 0]
];
...
export var CancelMetadataTransferJob$: StaticOperationSchema = [9, n0, _CMTJ,
...
export var CreateComponentType$: StaticOperationSchema = [9, n0, _CCT,
...
export var DeleteComponentType$: StaticOperationSchema = [9, n0, _DCT,
...
export var GetComponentType$: StaticOperationSchema = [9, n0, _GCT,
...
export var GetEntity$: StaticOperationSchema = [9, n0, _GE,
  { [_end]: ["api."], [_h]: ["GET", "/workspaces/{workspaceId}/entities/{entityId}", 200] }, () => GetEntityRequest$, () => GetEntityResponse$
];
export var GetMetadataTransferJob$: StaticOperationSchema = [9, n0, _GMTJ,
...
export var ListComponentTypes$: StaticOperationSchema = [9, n0, _LCT,
...
export var UpdateComponentType$: StaticOperationSchema = [9, n0, _UCT,
...
export var UpdateEntity$: StaticOperationSchema = [9, n0, _UE,
...
export var UpdateScene$: StaticOperationSchema = [9, n0, _US,
