...
export var NetworkMonitorServiceException$: StaticErrorSchema = [-3, _s, "NetworkMonitorServiceException", 0, [], []];
...
var CreateMonitorProbeInputList: StaticListSchema = [1, n0, _CMPIL,
  0, () => CreateMonitorProbeInput$
];
var MonitorList: StaticListSchema = [1, n0, _ML,
  0, () => MonitorSummary$
];
var ProbeList: StaticListSchema = [1, n0, _PL,
  0, () => Probe$
];
var TagKeyList = 64 | 0;
var TagMap = 128 | 0;
...
export var CreateProbe$: StaticOperationSchema = [9, n0, _CP,
...
export var DeleteProbe$: StaticOperationSchema = [9, n0, _DP,
...
export var GetProbe$: StaticOperationSchema = [9, n0, _GP,
...
export var UpdateProbe$: StaticOperationSchema = [9, n0, _UP,
