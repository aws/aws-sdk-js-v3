...
import { defaultResourceGroupsHttpAuthSchemeProvider } from "./auth/httpAuthSchemeProvider";
...
export const getRuntimeConfig = (config: ResourceGroupsClientConfig) => {
  return {
    ...
    protocol: config?.protocol ?? new AwsRestJsonProtocol({ defaultNamespace: "com.amazonaws.resourcegroups" }),
