...
export var DeleteGroupInput$: StaticStructureSchema = [3, n0, _DGI,
  0,
  [_GN, _G],
  [0, 0]
];
export var DeleteGroupOutput$: StaticStructureSchema = [3, n0, _DGO,
  0,
  [_G],
  [() => Group$]
];
export var FailedResource$: StaticStructureSchema = [3, n0, _FR,
  0,
  [_RA, _EM, _EC],
  [0, 0, 0]
];
...
export var GetGroupConfigurationInput$: StaticStructureSchema = [3, n0, _GGCI,
  0,
  [_G],
  [0]
];
export var GetGroupConfigurationOutput$: StaticStructureSchema = [3, n0, _GGCO,
  0,
  [_GC],
  [() => GroupConfiguration$]
];
export var GetGroupInput$: StaticStructureSchema = [3, n0, _GGI,
  0,
  [_GN, _G],
  [0, 0]
];
export var GetGroupOutput$: StaticStructureSchema = [3, n0, _GGO,
  0,
  [_G],
  [() => Group$]
];
export var GetGroupQueryInput$: StaticStructureSchema = [3, n0, _GGQI,
  0,
  [_GN, _G],
  [0, 0]
];
export var GetGroupQueryOutput$: StaticStructureSchema = [3, n0, _GGQO,
  0,
  [_GQ],
  [() => GroupQuery$]
];
...
export var GroupingStatusesItem$: StaticStructureSchema = [3, n0, _GSI,
  0,
...
export var ListGroupResourcesInput$: StaticStructureSchema = [3, n0, _LGRI,
  0,
  [_GN, _G, _Fi, _MR, _NT],
  [0, 0, () => ResourceFilterList, 1, 0]
];
export var ListGroupResourcesItem$: StaticStructureSchema = [3, n0, _LGRIi,
  0,
  [_I, _S],
  [() => ResourceIdentifier$, () => ResourceStatus$]
];
export var ListGroupResourcesOutput$: StaticStructureSchema = [3, n0, _LGRO,
  0,
  [_R, _RI, _NT, _QE],
  [() => ListGroupResourcesItemList, () => ResourceIdentifierList, 0, () => QueryErrorList]
];
export var ListGroupsInput$: StaticStructureSchema = [3, n0, _LGI,
  0,
  [_Fi, _MR, _NT],
  [() => GroupFilterList, [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListGroupsOutput$: StaticStructureSchema = [3, n0, _LGO,
  0,
  [_GIr, _Gr, _NT],
  [() => GroupIdentifierList, () => GroupList, 0]
];
export var ListTagSyncTasksFilter$: StaticStructureSchema = [3, n0, _LTSTF,
  0,
  [_GA, _GN],
  [0, 0]
];
export var ListTagSyncTasksInput$: StaticStructureSchema = [3, n0, _LTSTI,
  0,
  [_Fi, _MR, _NT],
  [() => ListTagSyncTasksFilterList, 1, 0]
];
export var ListTagSyncTasksOutput$: StaticStructureSchema = [3, n0, _LTSTO,
  0,
  [_TST, _NT],
  [() => TagSyncTaskList, 0]
];
...
export var PutGroupConfigurationInput$: StaticStructureSchema = [3, n0, _PGCI,
  0,
  [_G, _C],
  [0, () => GroupConfigurationList]
];
export var PutGroupConfigurationOutput$: StaticStructureSchema = [3, n0, _PGCO,
  0,
  [],
  []
];
export var QueryError$: StaticStructureSchema = [3, n0, _QEu,
  0,
  [_EC, _M],
  [0, 0]
];
...
export var TagSyncTaskItem$: StaticStructureSchema = [3, n0, _TSTI,
  0,
  [_GA, _GN, _TA, _TK, _TV, _RQ, _RAo, _S, _EM, _CA],
  [0, 0, 0, 0, 0, () => ResourceQuery$, 0, 0, 0, 4]
];
...
export var UpdateGroupInput$: StaticStructureSchema = [3, n0, _UGI,
  0,
  [_GN, _G, _D, _Cr, _O, _DN],
  [0, 0, 0, 1, 0, 0]
];
export var UpdateGroupOutput$: StaticStructureSchema = [3, n0, _UGO,
  0,
  [_G],
  [() => Group$]
];
...
var GroupConfigurationList: StaticListSchema = [1, n0, _GCL,
  0, () => GroupConfigurationItem$
];
var GroupConfigurationParameterValueList = 64 | 0;
var GroupFilterList: StaticListSchema = [1, n0, _GFL,
  0, () => GroupFilter$
];
var GroupFilterValues = 64 | 0;
var GroupIdentifierList: StaticListSchema = [1, n0, _GIL,
  0, () => GroupIdentifier$
];
var GroupingStatusesList: StaticListSchema = [1, n0, _GSL,
  0, () => GroupingStatusesItem$
];
var GroupList: StaticListSchema = [1, n0, _GL,
  0, () => Group$
];
var GroupParameterList: StaticListSchema = [1, n0, _GPL,
  0, () => GroupConfigurationParameter$
];
var ListGroupingStatusesFilterList: StaticListSchema = [1, n0, _LGSFL,
  0, () => ListGroupingStatusesFilter$
];
var ListGroupingStatusesFilterValues = 64 | 0;
var ListGroupResourcesItemList: StaticListSchema = [1, n0, _LGRIL,
  0, () => ListGroupResourcesItem$
];
var ListTagSyncTasksFilterList: StaticListSchema = [1, n0, _LTSTFL,
  0, () => ListTagSyncTasksFilter$
];
var PendingResourceList: StaticListSchema = [1, n0, _PRL,
  0, () => PendingResource$
];
var QueryErrorList: StaticListSchema = [1, n0, _QEL,
  0, () => QueryError$
];
var ResourceArnList = 64 | 0;
var ResourceFilterList: StaticListSchema = [1, n0, _RFL,
  0, () => ResourceFilter$
];
...
var TagKeyList = 64 | 0;
var TagSyncTaskList: StaticListSchema = [1, n0, _TSTL,
  0, () => TagSyncTaskItem$
];
var ApplicationTag = 128 | 0;
var Tags = 128 | 0;
export var CancelTagSyncTask$: StaticOperationSchema = [9, n0, _CTST,
...
export var GetGroupConfiguration$: StaticOperationSchema = [9, n0, _GGC,
  { [_h]: ["POST", "/get-group-configuration", 200] }, () => GetGroupConfigurationInput$, () => GetGroupConfigurationOutput$
];
export var GetGroupQuery$: StaticOperationSchema = [9, n0, _GGQ,
...
export var GetTagSyncTask$: StaticOperationSchema = [9, n0, _GTST,
  { [_h]: ["POST", "/get-tag-sync-task", 200] }, () => GetTagSyncTaskInput$, () => GetTagSyncTaskOutput$
];
export var GroupResources$: StaticOperationSchema = [9, n0, _GR,
  { [_h]: ["POST", "/group-resources", 200] }, () => GroupResourcesInput$, () => GroupResourcesOutput$
];
export var ListGroupingStatuses$: StaticOperationSchema = [9, n0, _LGS,
  { [_h]: ["POST", "/list-grouping-statuses", 200] }, () => ListGroupingStatusesInput$, () => ListGroupingStatusesOutput$
];
export var ListGroupResources$: StaticOperationSchema = [9, n0, _LGR,
...
export var UpdateGroupQuery$: StaticOperationSchema = [9, n0, _UGQ,
