...
const AWS_TEMPLATE = "resource-groups.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "resource-groups.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "resource-groups.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "resource-groups.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "resource-groups.{region}.amazonaws.com";
