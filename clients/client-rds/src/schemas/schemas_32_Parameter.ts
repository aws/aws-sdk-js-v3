...
export var EngineDefaults = struct(n0, _ED, 0, [_DBPGF, _Ma, _Pa], [0, 0, [() => ParametersList, 0]]);
...
export var Parameter = struct(
  ...
  _Par,
  0,
  [_PN, _PV, _D, _S, _AT, _DTa, _AV, _IM, _MEVi, _AMp, _SEM],
  [0, 0, 0, 0, 0, 0, 0, 2, 0, 0, 64 | 0]
);
