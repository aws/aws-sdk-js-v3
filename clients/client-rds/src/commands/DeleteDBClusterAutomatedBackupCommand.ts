 ...
 * @public
 */
export class DeleteDBClusterAutomatedBackupCommand extends command<DeleteDBClusterAutomatedBackupCommandInput, DeleteDBClusterAutomatedBackupCommandOutput>(
  _ep0,
  _mw0,
