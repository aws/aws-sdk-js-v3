...
> {
   ...
   * @public
   */
  constructor(readonly input: DescribeDBRecommendationsCommandInput) {
    super();
  }
  ...
  ): Handler<DescribeDBRecommendationsCommandInput, DescribeDBRecommendationsCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DescribeDBRecommendationsCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: DescribeDBRecommendationsCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
