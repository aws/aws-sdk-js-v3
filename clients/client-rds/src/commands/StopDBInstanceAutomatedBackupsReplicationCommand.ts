 ...
 * @public
 */
export class StopDBInstanceAutomatedBackupsReplicationCommand extends command<StopDBInstanceAutomatedBackupsReplicationCommandInput, StopDBInstanceAutomatedBackupsReplicationCommandOutput>(
  _ep0,
  _mw0,
