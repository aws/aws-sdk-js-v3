...
export async function deserializeAws_queryAuthorizeDBSecurityGroupIngressCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBSecurityGroup(
...
export async function deserializeAws_queryCopyDBSnapshotCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBSnapshot(data.CopyDBSnapshotResult, context);
...
export async function deserializeAws_queryCopyOptionGroupCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryOptionGroup(
...
export async function deserializeAws_queryCreateCustomAvailabilityZoneCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryCustomAvailabilityZone(
...
export async function deserializeAws_queryCreateDBSnapshotCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBSnapshot(
...
export async function deserializeAws_queryCreateGlobalClusterCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryGlobalCluster(
...
export async function deserializeAws_queryDeleteDBInstanceAutomatedBackupCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBInstanceAutomatedBackup(
...
export async function deserializeAws_queryDescribeDBSnapshotAttributesCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBSnapshotAttributesResult(
...
export async function deserializeAws_queryPurchaseReservedDBInstancesOfferingCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryReservedDBInstance(
...
export async function deserializeAws_queryStopDBInstanceCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDBInstance(data.StopDBInstanceResult, context);
...
const serializeAws_queryOptionConfigurationList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "OptionConfiguration." + counter;
    entries[loc] = serializeAws_queryOptionConfiguration(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryOptionSettingsList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "OptionSetting." + counter;
    entries[loc] = serializeAws_queryOptionSetting(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryProcessorFeatureList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "ProcessorFeature." + counter;
    entries[loc] = serializeAws_queryProcessorFeature(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryUserAuthConfigList = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryUserAuthConfig(entry, context);
    counter++;
  });
  return entries;
};
...
const deserializeAws_queryAccountAttributesMessage = (
  ...
  if (output["AccountQuotas"]["AccountQuota"] !== undefined) {
...
const deserializeAws_queryConnectionPoolConfigurationInfo = (
  ...
  if (output["SessionPinningFilters"]["member"] !== undefined) {
...
const deserializeAws_queryDBCluster = (
  ...
  if (output["CustomEndpoints"]["member"] !== undefined) {
...
const deserializeAws_queryDBClusterBacktrackMessage = (
  ...
  if (output["DBClusterBacktracks"]["DBClusterBacktrack"] !== undefined) {
...
const deserializeAws_queryDBClusterEndpointMessage = (
  ...
  if (output["DBClusterEndpoints"]["DBClusterEndpointList"] !== undefined) {
...
const deserializeAws_queryDBInstance = (
  ...
  if (output["AssociatedRoles"]["DBInstanceRole"] !== undefined) {
  ...
  if (output["ProcessorFeatures"]["ProcessorFeature"] !== undefined) {
...
const deserializeAws_queryDBProxy = (
  ...
  if (output["Auth"]["member"] !== undefined) {
...
const deserializeAws_queryDBSnapshotAttributesResult = (
  ...
  if (output["DBSnapshotAttributes"]["DBSnapshotAttribute"] !== undefined) {
...
const deserializeAws_queryDBSnapshotMessage = (
  ...
  if (output["DBSnapshots"]["DBSnapshot"] !== undefined) {
...
const deserializeAws_queryDescribeDBLogFilesResponse = (
  ...
  if (output["DescribeDBLogFiles"]["DescribeDBLogFilesDetails"] !== undefined) {
...
const deserializeAws_queryDescribeDBProxiesResponse = (
  ...
  if (output["DBProxies"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeDBProxyTargetGroupsResponse = (
  ...
  if (output["TargetGroups"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeDBProxyTargetsResponse = (
  ...
  if (output["Targets"]["member"] !== undefined) {
...
const deserializeAws_queryGlobalCluster = (
  ...
  if (output["GlobalClusterMembers"]["GlobalClusterMember"] !== undefined) {
...
const deserializeAws_queryGlobalClusterMember = (
  ...
  if (output["Readers"]["member"] !== undefined) {
...
const deserializeAws_queryGlobalClustersMessage = (
  ...
  if (output["GlobalClusters"]["GlobalClusterMember"] !== undefined) {
...
const deserializeAws_queryInstallationMediaMessage = (
  ...
  if (output["InstallationMedia"]["InstallationMedia"] !== undefined) {
...
const deserializeAws_queryOption = (
  ...
  if (output["DBSecurityGroupMemberships"]["DBSecurityGroup"] !== undefined) {
  ...
  if (output["OptionSettings"]["OptionSetting"] !== undefined) {
...
const deserializeAws_queryOptionGroup = (
  ...
  if (output["Options"]["Option"] !== undefined) {
...
const deserializeAws_queryOptionGroupOption = (
  ...
  if (output["OptionGroupOptionVersions"]["OptionVersion"] !== undefined) {
...
const deserializeAws_queryOptionGroupOptionsMessage = (
  ...
  if (output["OptionGroupOptions"]["OptionGroupOption"] !== undefined) {
...
const deserializeAws_queryOptionGroups = (
  ...
  if (output["OptionGroupsList"]["OptionGroup"] !== undefined) {
...
const deserializeAws_queryRegisterDBProxyTargetsResponse = (
  ...
  if (output["DBProxyTargets"]["member"] !== undefined) {
...
const deserializeAws_queryReservedDBInstance = (
  ...
  if (output["RecurringCharges"]["RecurringCharge"] !== undefined) {
...
const deserializeAws_queryReservedDBInstanceMessage = (
  ...
  if (output["ReservedDBInstances"]["ReservedDBInstance"] !== undefined) {
...
const deserializeAws_querySourceRegionMessage = (
  ...
  if (output["SourceRegions"]["SourceRegion"] !== undefined) {
