...
import {
  defaultIoTFleetHubHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type IoTFleetHubClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type IoTFleetHubClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<IoTFleetHubClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultIoTFleetHubHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: IoTFleetHubClientResolvedConfig) =>
