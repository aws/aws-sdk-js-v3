...
import type { CreatePolicyEngineRequest, CreatePolicyEngineResponse } from "../models/models_2";
 ...
 * @public
 */
export class CreatePolicyEngineCommand extends command<CreatePolicyEngineCommandInput, CreatePolicyEngineCommandOutput>(
  _ep0,
  _mw0,
  "CreatePolicyEngine",
  CreatePolicyEngine$
