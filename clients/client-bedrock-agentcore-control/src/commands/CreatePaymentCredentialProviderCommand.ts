 ...
 * @public
 */
export class CreatePaymentCredentialProviderCommand extends command<CreatePaymentCredentialProviderCommandInput, CreatePaymentCredentialProviderCommandOutput>(
  _ep0,
  _mw0,
