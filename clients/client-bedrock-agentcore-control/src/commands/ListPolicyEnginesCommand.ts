...
import type { ListPolicyEnginesRequest, ListPolicyEnginesResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListPolicyEnginesCommand extends command<ListPolicyEnginesCommandInput, ListPolicyEnginesCommandOutput>(
  _ep0,
  _mw0,
  "ListPolicyEngines",
  ListPolicyEngines$
