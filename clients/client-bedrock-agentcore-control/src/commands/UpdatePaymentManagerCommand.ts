...
import type { UpdatePaymentManagerRequest, UpdatePaymentManagerResponse } from "../models/models_2";
 ...
 * @public
 */
export class UpdatePaymentManagerCommand extends command<UpdatePaymentManagerCommandInput, UpdatePaymentManagerCommandOutput>(
  _ep0,
  _mw0,
