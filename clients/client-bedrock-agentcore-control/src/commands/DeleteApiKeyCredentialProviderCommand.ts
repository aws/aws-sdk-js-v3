 ...
 * @public
 */
export class DeleteApiKeyCredentialProviderCommand extends command<DeleteApiKeyCredentialProviderCommandInput, DeleteApiKeyCredentialProviderCommandOutput>(
  _ep0,
  _mw0,
