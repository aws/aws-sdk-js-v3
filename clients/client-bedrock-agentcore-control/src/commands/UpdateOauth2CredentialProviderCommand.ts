 ...
 * @public
 */
export class UpdateOauth2CredentialProviderCommand extends command<UpdateOauth2CredentialProviderCommandInput, UpdateOauth2CredentialProviderCommandOutput>(
  _ep0,
  _mw0,
