 ...
 * @public
 */
export class ListPolicyGenerationSummariesCommand extends command<ListPolicyGenerationSummariesCommandInput, ListPolicyGenerationSummariesCommandOutput>(
  _ep0,
  _mw0,
