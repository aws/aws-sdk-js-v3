 ...
 * @public
 */
export class UpdateApiKeyCredentialProviderCommand extends command<UpdateApiKeyCredentialProviderCommandInput, UpdateApiKeyCredentialProviderCommandOutput>(
  _ep0,
  _mw0,
