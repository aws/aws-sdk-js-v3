...
import type { UpdatePaymentConnectorRequest, UpdatePaymentConnectorResponse } from "../models/models_2";
 ...
 * @public
 */
export class UpdatePaymentConnectorCommand extends command<UpdatePaymentConnectorCommandInput, UpdatePaymentConnectorCommandOutput>(
  _ep0,
  _mw0,
