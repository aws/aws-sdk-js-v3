...
import type { ListPaymentConnectorsRequest, ListPaymentConnectorsResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListPaymentConnectorsCommand extends command<ListPaymentConnectorsCommandInput, ListPaymentConnectorsCommandOutput>(
  _ep0,
  _mw0,
