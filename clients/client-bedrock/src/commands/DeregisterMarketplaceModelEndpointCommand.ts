 ...
 * @public
 */
export class DeregisterMarketplaceModelEndpointCommand extends command<DeregisterMarketplaceModelEndpointCommandInput, DeregisterMarketplaceModelEndpointCommandOutput>(
  _ep0,
  _mw0,
