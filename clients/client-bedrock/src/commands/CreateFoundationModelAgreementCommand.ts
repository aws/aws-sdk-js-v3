 ...
 * @public
 */
export class CreateFoundationModelAgreementCommand extends command<CreateFoundationModelAgreementCommandInput, CreateFoundationModelAgreementCommandOutput>(
  _ep0,
  _mw0,
