 ...
 * @public
 */
export class CreateAutomatedReasoningPolicyTestCaseCommand extends command<CreateAutomatedReasoningPolicyTestCaseCommandInput, CreateAutomatedReasoningPolicyTestCaseCommandOutput>(
  _ep0,
  _mw0,
