 ...
 * @public
 */
export class CreateAutomatedReasoningPolicyCommand extends command<CreateAutomatedReasoningPolicyCommandInput, CreateAutomatedReasoningPolicyCommandOutput>(
  _ep0,
  _mw0,
