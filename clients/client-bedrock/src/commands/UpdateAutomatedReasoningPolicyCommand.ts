 ...
 * @public
 */
export class UpdateAutomatedReasoningPolicyCommand extends command<UpdateAutomatedReasoningPolicyCommandInput, UpdateAutomatedReasoningPolicyCommandOutput>(
  _ep0,
  _mw0,
