 ...
 * @public
 */
export class UpdateMarketplaceModelEndpointCommand extends command<UpdateMarketplaceModelEndpointCommandInput, UpdateMarketplaceModelEndpointCommandOutput>(
  _ep0,
  _mw0,
