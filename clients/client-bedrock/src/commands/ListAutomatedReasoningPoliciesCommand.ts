 ...
 * @public
 */
export class ListAutomatedReasoningPoliciesCommand extends command<ListAutomatedReasoningPoliciesCommandInput, ListAutomatedReasoningPoliciesCommandOutput>(
  _ep0,
  _mw0,
