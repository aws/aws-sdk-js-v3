 ...
 * @public
 */
export class ListAutomatedReasoningPolicyTestCasesCommand extends command<ListAutomatedReasoningPolicyTestCasesCommandInput, ListAutomatedReasoningPolicyTestCasesCommandOutput>(
  _ep0,
  _mw0,
