 ...
 * @public
 */
export class CreateMarketplaceModelEndpointCommand extends command<CreateMarketplaceModelEndpointCommandInput, CreateMarketplaceModelEndpointCommandOutput>(
  _ep0,
  _mw0,
