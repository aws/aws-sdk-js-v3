 ...
 * @public
 */
export class ListEnforcedGuardrailsConfigurationCommand extends command<ListEnforcedGuardrailsConfigurationCommandInput, ListEnforcedGuardrailsConfigurationCommandOutput>(
  _ep0,
  _mw0,
