 ...
 * @public
 */
export class GetFoundationModelAvailabilityCommand extends command<GetFoundationModelAvailabilityCommandInput, GetFoundationModelAvailabilityCommandOutput>(
  _ep0,
  _mw0,
