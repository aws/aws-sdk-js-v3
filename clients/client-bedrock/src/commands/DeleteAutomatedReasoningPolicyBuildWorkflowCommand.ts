 ...
 * @public
 */
export class DeleteAutomatedReasoningPolicyBuildWorkflowCommand extends command<DeleteAutomatedReasoningPolicyBuildWorkflowCommandInput, DeleteAutomatedReasoningPolicyBuildWorkflowCommandOutput>(
  _ep0,
  _mw0,
