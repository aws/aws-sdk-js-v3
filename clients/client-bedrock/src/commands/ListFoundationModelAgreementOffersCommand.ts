 ...
 * @public
 */
export class ListFoundationModelAgreementOffersCommand extends command<ListFoundationModelAgreementOffersCommandInput, ListFoundationModelAgreementOffersCommandOutput>(
  _ep0,
  _mw0,
