 ...
 * @public
 */
export class DeleteAutomatedReasoningPolicyTestCaseCommand extends command<DeleteAutomatedReasoningPolicyTestCaseCommandInput, DeleteAutomatedReasoningPolicyTestCaseCommandOutput>(
  _ep0,
  _mw0,
