 ...
 * @public
 */
export class ListMarketplaceModelEndpointsCommand extends command<ListMarketplaceModelEndpointsCommandInput, ListMarketplaceModelEndpointsCommandOutput>(
  _ep0,
  _mw0,
