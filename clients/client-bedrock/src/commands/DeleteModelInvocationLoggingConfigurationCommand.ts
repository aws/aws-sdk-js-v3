 ...
 * @public
 */
export class DeleteModelInvocationLoggingConfigurationCommand extends command<DeleteModelInvocationLoggingConfigurationCommandInput, DeleteModelInvocationLoggingConfigurationCommandOutput>(
  _ep0,
  _mw0,
