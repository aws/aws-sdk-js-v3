 ...
 * @public
 */
export class GetModelInvocationLoggingConfigurationCommand extends command<GetModelInvocationLoggingConfigurationCommandInput, GetModelInvocationLoggingConfigurationCommandOutput>(
  _ep0,
  _mw0,
