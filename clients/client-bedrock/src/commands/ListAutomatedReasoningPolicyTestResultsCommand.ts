 ...
 * @public
 */
export class ListAutomatedReasoningPolicyTestResultsCommand extends command<ListAutomatedReasoningPolicyTestResultsCommandInput, ListAutomatedReasoningPolicyTestResultsCommandOutput>(
  _ep0,
  _mw0,
