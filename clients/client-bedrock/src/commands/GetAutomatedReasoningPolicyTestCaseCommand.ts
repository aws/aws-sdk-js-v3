 ...
 * @public
 */
export class GetAutomatedReasoningPolicyTestCaseCommand extends command<GetAutomatedReasoningPolicyTestCaseCommandInput, GetAutomatedReasoningPolicyTestCaseCommandOutput>(
  _ep0,
  _mw0,
