 ...
 * @public
 */
export class DeleteAutomatedReasoningPolicyCommand extends command<DeleteAutomatedReasoningPolicyCommandInput, DeleteAutomatedReasoningPolicyCommandOutput>(
  _ep0,
  _mw0,
