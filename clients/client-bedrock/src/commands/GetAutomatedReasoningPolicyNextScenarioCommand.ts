 ...
 * @public
 */
export class GetAutomatedReasoningPolicyNextScenarioCommand extends command<GetAutomatedReasoningPolicyNextScenarioCommandInput, GetAutomatedReasoningPolicyNextScenarioCommandOutput>(
  _ep0,
  _mw0,
