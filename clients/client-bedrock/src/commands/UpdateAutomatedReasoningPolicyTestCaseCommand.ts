 ...
 * @public
 */
export class UpdateAutomatedReasoningPolicyTestCaseCommand extends command<UpdateAutomatedReasoningPolicyTestCaseCommandInput, UpdateAutomatedReasoningPolicyTestCaseCommandOutput>(
  _ep0,
  _mw0,
