 ...
 * @public
 */
export class ListAutomatedReasoningPolicyBuildWorkflowsCommand extends command<ListAutomatedReasoningPolicyBuildWorkflowsCommandInput, ListAutomatedReasoningPolicyBuildWorkflowsCommandOutput>(
  _ep0,
  _mw0,
