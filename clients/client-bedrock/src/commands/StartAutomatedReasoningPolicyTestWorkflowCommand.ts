 ...
 * @public
 */
export class StartAutomatedReasoningPolicyTestWorkflowCommand extends command<StartAutomatedReasoningPolicyTestWorkflowCommandInput, StartAutomatedReasoningPolicyTestWorkflowCommandOutput>(
  _ep0,
  _mw0,
