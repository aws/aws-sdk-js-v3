 ...
 * @public
 */
export class CancelAutomatedReasoningPolicyBuildWorkflowCommand extends command<CancelAutomatedReasoningPolicyBuildWorkflowCommandInput, CancelAutomatedReasoningPolicyBuildWorkflowCommandOutput>(
  _ep0,
  _mw0,
