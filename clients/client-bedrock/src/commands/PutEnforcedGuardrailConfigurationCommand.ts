 ...
 * @public
 */
export class PutEnforcedGuardrailConfigurationCommand extends command<PutEnforcedGuardrailConfigurationCommandInput, PutEnforcedGuardrailConfigurationCommandOutput>(
  _ep0,
  _mw0,
