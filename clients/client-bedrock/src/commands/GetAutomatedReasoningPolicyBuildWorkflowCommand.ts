 ...
 * @public
 */
export class GetAutomatedReasoningPolicyBuildWorkflowCommand extends command<GetAutomatedReasoningPolicyBuildWorkflowCommandInput, GetAutomatedReasoningPolicyBuildWorkflowCommandOutput>(
  _ep0,
  _mw0,
