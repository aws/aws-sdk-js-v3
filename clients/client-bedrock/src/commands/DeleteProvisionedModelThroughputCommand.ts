 ...
 * @public
 */
export class DeleteProvisionedModelThroughputCommand extends command<DeleteProvisionedModelThroughputCommandInput, DeleteProvisionedModelThroughputCommandOutput>(
  _ep0,
  _mw0,
