...
export var AcknowledgeJobInput$: StaticStructureSchema = [3, n0, _AJI,
  0,
  [_jI, _n],
  [0, 0]
];
...
export var ActionContext$: StaticStructureSchema = [3, n0, _ACc,
  0,
  [_na, _aEI],
  [0, 0]
];
...
export var ActionExecutionResult$: StaticStructureSchema = [3, n0, _AER,
  0,
...
export var ActionState$: StaticStructureSchema = [3, n0, _AS,
  0,
  [_aN, _cR, _lE, _eU, _rU],
  [0, () => ActionRevision$, () => ActionExecution$, 0, 0]
];
export var ActionType$: StaticStructureSchema = [3, n0, _AT,
  0,
  [_id, _set, _aCP, _iAD, _oAD],
  [() => ActionTypeId$, () => ActionTypeSettings$, () => ActionConfigurationPropertyList, () => ArtifactDetails$, () => ArtifactDetails$]
];
export var ActionTypeArtifactDetails$: StaticStructureSchema = [3, n0, _ATAD,
  0,
  [_mC, _mCa],
  [1, 1]
];
export var ActionTypeDeclaration$: StaticStructureSchema = [3, n0, _ATD,
  0,
...
export var ActionTypeIdentifier$: StaticStructureSchema = [3, n0, _ATIc,
  0,
  [_ca, _ow, _pro, _v],
  [0, 0, 0, 0]
];
...
export var ActionTypeProperty$: StaticStructureSchema = [3, n0, _ATPc,
  0,
  [_na, _op, _k, _nE, _q, _d],
  [0, 2, 2, 2, 2, 0]
];
export var ActionTypeSettings$: StaticStructureSchema = [3, n0, _ATS,
  0,
  [_tPCU, _eUT, _eUTx, _rUT],
  [0, 0, 0, 0]
];
export var ActionTypeUrls$: StaticStructureSchema = [3, n0, _ATU,
  0,
  [_cU, _eUT, _eUTx, _rUT],
  [0, 0, 0, 0]
];
...
export var ArtifactDetail$: StaticStructureSchema = [3, n0, _ADr,
  0,
  [_na, _sl],
  [0, () => S3Location$]
];
export var ArtifactDetails$: StaticStructureSchema = [3, n0, _ADrt,
  0,
  [_mC, _mCa],
  [1, 1]
];
export var ArtifactLocation$: StaticStructureSchema = [3, n0, _AL,
  0,
  [_t, _sL],
  [0, () => S3ArtifactLocation$]
];
export var ArtifactRevision$: StaticStructureSchema = [3, n0, _ARr,
  0,
  [_na, _rI, _rCIe, _rS, _cr, _rU],
  [0, 0, 0, 0, 4, 0]
];
export var ArtifactStore$: StaticStructureSchema = [3, n0, _ASr,
  0,
  [_t, _l, _eK],
  [0, 0, () => EncryptionKey$]
];
export var AWSSessionCredentials$: StaticStructureSchema = [3, n0, _AWSSC,
  8,
  [_aKI, _sAK, _sTe],
  [[() => AccessKeyId, 0], [() => SecretAccessKey, 0], [() => SessionToken, 0]]
];
export var BeforeEntryConditions$: StaticStructureSchema = [3, n0, _BEC,
  0,
  [_con],
  [() => ConditionList]
];
export var BlockerDeclaration$: StaticStructureSchema = [3, n0, _BD,
  0,
  [_na, _t],
  [0, 0]
];
...
export var CreateCustomActionTypeOutput$: StaticStructureSchema = [3, n0, _CCATO,
  0,
  [_aT, _ta],
  [() => ActionType$, () => TagList]
];
...
export var CurrentRevision$: StaticStructureSchema = [3, n0, _CR,
  0,
  [_rev, _cI, _cr, _rS],
  [0, 0, 4, 0]
];
export var DeleteCustomActionTypeInput$: StaticStructureSchema = [3, n0, _DCATI,
  0,
  [_ca, _pro, _v],
  [0, 0, 0]
];
export var DeletePipelineInput$: StaticStructureSchema = [3, n0, _DPI,
  0,
  [_na],
  [0]
];
...
export var DeregisterWebhookWithThirdPartyInput$: StaticStructureSchema = [3, n0, _DWWTPI,
  0,
  [_wN],
  [0]
];
export var DeregisterWebhookWithThirdPartyOutput$: StaticStructureSchema = [3, n0, _DWWTPO,
  0,
  [],
  []
];
export var DisableStageTransitionInput$: StaticStructureSchema = [3, n0, _DSTI,
  0,
  [_pN, _sN, _tTr, _rea],
  [0, 0, 0, 0]
];
...
export var ExecutionTrigger$: StaticStructureSchema = [3, n0, _ET,
  0,
  [_tTri, _tD],
  [0, 0]
];
export var ExecutorConfiguration$: StaticStructureSchema = [3, n0, _EC,
  0,
  [_lEC, _jWEC],
  [() => LambdaExecutorConfiguration$, () => JobWorkerExecutorConfiguration$]
];
export var FailureConditions$: StaticStructureSchema = [3, n0, _FC,
  0,
  [_res, _rCe, _con],
...
export var GetActionTypeInput$: StaticStructureSchema = [3, n0, _GATI,
  0,
  [_ca, _ow, _pro, _v],
  [0, 0, 0, 0]
];
export var GetActionTypeOutput$: StaticStructureSchema = [3, n0, _GATO,
  0,
  [_aT],
  [() => ActionTypeDeclaration$]
];
export var GetJobDetailsInput$: StaticStructureSchema = [3, n0, _GJDI,
  0,
  [_jI],
  [0]
];
export var GetJobDetailsOutput$: StaticStructureSchema = [3, n0, _GJDO,
  0,
  [_jD],
  [[() => JobDetails$, 0]]
];
export var GetPipelineExecutionInput$: StaticStructureSchema = [3, n0, _GPEI,
  0,
  [_pN, _pEI],
  [0, 0]
];
export var GetPipelineExecutionOutput$: StaticStructureSchema = [3, n0, _GPEO,
  0,
  [_pE],
  [() => PipelineExecution$]
];
export var GetPipelineInput$: StaticStructureSchema = [3, n0, _GPI,
  0,
  [_na, _v],
  [0, 1]
];
export var GetPipelineOutput$: StaticStructureSchema = [3, n0, _GPO,
  0,
  [_pi, _me],
  [() => PipelineDeclaration$, () => PipelineMetadata$]
];
export var GetPipelineStateInput$: StaticStructureSchema = [3, n0, _GPSI,
  0,
  [_na],
  [0]
];
export var GetPipelineStateOutput$: StaticStructureSchema = [3, n0, _GPSO,
  0,
  [_pN, _pV, _sS, _cr, _up],
  [0, 1, () => StageStateList, 4, 4]
];
export var GetThirdPartyJobDetailsInput$: StaticStructureSchema = [3, n0, _GTPJDI,
  0,
  [_jI, _cT],
  [0, 0]
];
export var GetThirdPartyJobDetailsOutput$: StaticStructureSchema = [3, n0, _GTPJDO,
  0,
  [_jD],
  [[() => ThirdPartyJobDetails$, 0]]
];
export var GitBranchFilterCriteria$: StaticStructureSchema = [3, n0, _GBFC,
  0,
  [_in, _exc],
  [64 | 0, 64 | 0]
];
export var GitConfiguration$: StaticStructureSchema = [3, n0, _GC,
  0,
  [_sAN, _pu, _pR],
  [0, () => GitPushFilterList, () => GitPullRequestFilterList]
];
export var GitFilePathFilterCriteria$: StaticStructureSchema = [3, n0, _GFPFC,
  0,
  [_in, _exc],
  [64 | 0, 64 | 0]
];
export var GitPullRequestFilter$: StaticStructureSchema = [3, n0, _GPRF,
  0,
  [_ev, _b, _fP],
  [64 | 0, () => GitBranchFilterCriteria$, () => GitFilePathFilterCriteria$]
];
export var GitPushFilter$: StaticStructureSchema = [3, n0, _GPF,
  0,
  [_ta, _b, _fP],
  [() => GitTagFilterCriteria$, () => GitBranchFilterCriteria$, () => GitFilePathFilterCriteria$]
];
export var GitTagFilterCriteria$: StaticStructureSchema = [3, n0, _GTFC,
  0,
  [_in, _exc],
  [64 | 0, 64 | 0]
];
export var InputArtifact$: StaticStructureSchema = [3, n0, _IA,
  0,
  [_na],
  [0]
];
...
export var JobData$: StaticStructureSchema = [3, n0, _JD,
  0,
...
export var JobDetails$: StaticStructureSchema = [3, n0, _JDo,
  0,
  [_id, _da, _aI],
  [0, [() => JobData$, 0], 0]
];
...
export var LambdaExecutorConfiguration$: StaticStructureSchema = [3, n0, _LEC,
  0,
  [_lFA],
  [0]
];
export var LatestInPipelineExecutionFilter$: StaticStructureSchema = [3, n0, _LIPEF,
  0,
  [_pEI, _sTR],
  [0, 0]
];
...
export var ListActionExecutionsOutput$: StaticStructureSchema = [3, n0, _LAEO,
  0,
  [_aED, _nT],
  [() => ActionExecutionDetailList, 0]
];
export var ListActionTypesInput$: StaticStructureSchema = [3, n0, _LATI,
  0,
  [_aOF, _nT, _rF],
  [0, 0, 0]
];
export var ListActionTypesOutput$: StaticStructureSchema = [3, n0, _LATO,
  0,
  [_aTc, _nT],
  [() => ActionTypeList, 0]
];
export var ListDeployActionExecutionTargetsInput$: StaticStructureSchema = [3, n0, _LDAETI,
  0,
  [_pN, _aEI, _fi, _mR, _nT],
  [0, 0, () => TargetFilterList, 1, 0]
];
export var ListDeployActionExecutionTargetsOutput$: StaticStructureSchema = [3, n0, _LDAETO,
  0,
  [_tar, _nT],
  [() => DeployActionExecutionTargetList, 0]
];
export var ListPipelineExecutionsInput$: StaticStructureSchema = [3, n0, _LPEI,
  0,
  [_pN, _mR, _f, _nT],
  [0, 1, () => PipelineExecutionFilter$, 0]
];
export var ListPipelineExecutionsOutput$: StaticStructureSchema = [3, n0, _LPEO,
  0,
  [_pES, _nT],
...
export var ListRuleExecutionsInput$: StaticStructureSchema = [3, n0, _LREI,
  0,
  [_pN, _f, _mR, _nT],
  [0, () => RuleExecutionFilter$, 1, 0]
];
export var ListRuleExecutionsOutput$: StaticStructureSchema = [3, n0, _LREO,
  0,
  [_rED, _nT],
  [() => RuleExecutionDetailList, 0]
];
export var ListRuleTypesInput$: StaticStructureSchema = [3, n0, _LRTI,
  0,
  [_rOF, _rF],
  [0, 0]
];
export var ListRuleTypesOutput$: StaticStructureSchema = [3, n0, _LRTO,
  0,
  [_rT],
  [() => RuleTypeList]
];
...
export var ListWebhookItem$: StaticStructureSchema = [3, n0, _LWI,
  0,
  [_de, _ur, _eM, _eC, _lT, _a, _ta],
  [() => WebhookDefinition$, 0, 0, 0, 4, 0, () => TagList]
];
export var ListWebhooksInput$: StaticStructureSchema = [3, n0, _LWIi,
  0,
  [_NT, _MR],
  [0, 1]
];
...
export var PipelineTriggerDeclaration$: StaticStructureSchema = [3, n0, _PTD,
  0,
  [_pTr, _gC],
  [0, () => GitConfiguration$]
];
export var PipelineVariable$: StaticStructureSchema = [3, n0, _PV,
  0,
  [_na, _va],
  [0, 0]
];
export var PipelineVariableDeclaration$: StaticStructureSchema = [3, n0, _PVD,
  0,
  [_na, _dV, _d],
  [0, 0, 0]
];
...
export var PollForJobsOutput$: StaticStructureSchema = [3, n0, _PFJO,
  0,
  [_j],
  [[() => JobList, 0]]
];
export var PollForThirdPartyJobsInput$: StaticStructureSchema = [3, n0, _PFTPJI,
  0,
  [_aTI, _mBS],
  [() => ActionTypeId$, 1]
];
export var PollForThirdPartyJobsOutput$: StaticStructureSchema = [3, n0, _PFTPJO,
  0,
  [_j],
  [() => ThirdPartyJobList]
];
export var PutActionRevisionInput$: StaticStructureSchema = [3, n0, _PARI,
  0,
  [_pN, _sN, _aN, _aRc],
  [0, 0, 0, () => ActionRevision$]
];
export var PutActionRevisionOutput$: StaticStructureSchema = [3, n0, _PARO,
  0,
  [_nR, _pEI],
  [2, 0]
];
export var PutApprovalResultInput$: StaticStructureSchema = [3, n0, _PARIu,
  0,
  [_pN, _sN, _aN, _res, _to],
  [0, 0, 0, () => ApprovalResult$, 0]
];
export var PutApprovalResultOutput$: StaticStructureSchema = [3, n0, _PAROu,
  0,
  [_aAp],
  [4]
];
export var PutJobFailureResultInput$: StaticStructureSchema = [3, n0, _PJFRI,
  0,
  [_jI, _fD],
  [0, () => FailureDetails$]
];
export var PutJobSuccessResultInput$: StaticStructureSchema = [3, n0, _PJSRI,
  0,
  [_jI, _cR, _cTo, _eDx, _oV],
  [0, () => CurrentRevision$, 0, () => ExecutionDetails$, 128 | 0]
];
export var PutThirdPartyJobFailureResultInput$: StaticStructureSchema = [3, n0, _PTPJFRI,
  0,
  [_jI, _cT, _fD],
  [0, 0, () => FailureDetails$]
];
export var PutThirdPartyJobSuccessResultInput$: StaticStructureSchema = [3, n0, _PTPJSRI,
  0,
  [_jI, _cT, _cR, _cTo, _eDx],
  [0, 0, () => CurrentRevision$, 0, () => ExecutionDetails$]
];
export var PutWebhookInput$: StaticStructureSchema = [3, n0, _PWI,
  0,
  [_we, _ta],
  [() => WebhookDefinition$, () => TagList]
];
export var PutWebhookOutput$: StaticStructureSchema = [3, n0, _PWO,
  0,
  [_we],
  [() => ListWebhookItem$]
];
export var RegisterWebhookWithThirdPartyInput$: StaticStructureSchema = [3, n0, _RWWTPI,
  0,
  [_wN],
  [0]
];
export var RegisterWebhookWithThirdPartyOutput$: StaticStructureSchema = [3, n0, _RWWTPO,
  0,
  [],
  []
];
...
export var RetryStageExecutionInput$: StaticStructureSchema = [3, n0, _RSEI,
  0,
  [_pN, _sN, _pEI, _rMe],
  [0, 0, 0, 0]
];
export var RetryStageExecutionOutput$: StaticStructureSchema = [3, n0, _RSEO,
  0,
  [_pEI],
  [0]
];
export var RetryStageMetadata$: StaticStructureSchema = [3, n0, _RSM,
  0,
  [_aSRA, _mSRA, _lRT],
  [1, 1, 0]
];
export var RollbackStageInput$: StaticStructureSchema = [3, n0, _RSI,
  0,
  [_pN, _sN, _tPEI],
  [0, 0, 0]
];
export var RollbackStageOutput$: StaticStructureSchema = [3, n0, _RSO,
  0,
  [_pEI],
  [0]
];
export var RuleConfigurationProperty$: StaticStructureSchema = [3, n0, _RCP,
  0,
  [_na, _r, _k, _se, _q, _d, _t],
  [0, 2, 2, 2, 2, 0, 0]
];
...
export var RuleExecutionResult$: StaticStructureSchema = [3, n0, _RER,
  0,
  [_eEI, _eES, _eEU, _eD],
  [0, 0, 0, () => ErrorDetails$]
];
export var RuleRevision$: StaticStructureSchema = [3, n0, _RR,
  0,
  [_rI, _rCI, _cr],
  [0, 0, 4]
];
export var RuleState$: StaticStructureSchema = [3, n0, _RS,
  0,
  [_rN, _cR, _lE, _eU, _rU],
  [0, () => RuleRevision$, () => RuleExecution$, 0, 0]
];
export var RuleType$: StaticStructureSchema = [3, n0, _RT,
  0,
  [_id, _set, _rCP, _iAD],
  [() => RuleTypeId$, () => RuleTypeSettings$, () => RuleConfigurationPropertyList, () => ArtifactDetails$]
];
export var RuleTypeId$: StaticStructureSchema = [3, n0, _RTI,
  0,
  [_ca, _ow, _pro, _v],
  [0, 0, 0, 0]
];
export var RuleTypeSettings$: StaticStructureSchema = [3, n0, _RTS,
  0,
  [_tPCU, _eUT, _eUTx, _rUT],
  [0, 0, 0, 0]
];
export var S3ArtifactLocation$: StaticStructureSchema = [3, n0, _SAL,
  0,
  [_bN, _oK],
  [0, 0]
];
...
export var SourceRevision$: StaticStructureSchema = [3, n0, _SR,
  0,
  [_aN, _rI, _rS, _rU],
  [0, 0, 0, 0]
];
export var SourceRevisionOverride$: StaticStructureSchema = [3, n0, _SRO,
  0,
  [_aN, _rTe, _rVe],
  [0, 0, 0]
];
...
export var StageContext$: StaticStructureSchema = [3, n0, _SC,
  0,
  [_na],
  [0]
];
export var StageDeclaration$: StaticStructureSchema = [3, n0, _SD,
  0,
...
export var StartPipelineExecutionInput$: StaticStructureSchema = [3, n0, _SPEI,
  0,
  [_na, _var, _cRT, _sR],
  [0, () => PipelineVariableList, [0, 4], () => SourceRevisionOverrideList]
];
export var StartPipelineExecutionOutput$: StaticStructureSchema = [3, n0, _SPEO,
  0,
  [_pEI],
  [0]
];
export var StopExecutionTrigger$: StaticStructureSchema = [3, n0, _SET,
  0,
  [_rea],
  [0]
];
export var StopPipelineExecutionInput$: StaticStructureSchema = [3, n0, _SPEIt,
  0,
  [_pN, _pEI, _ab, _rea],
  [0, 0, 2, 0]
];
export var StopPipelineExecutionOutput$: StaticStructureSchema = [3, n0, _SPEOt,
  0,
  [_pEI],
  [0]
];
export var SucceededInStageFilter$: StaticStructureSchema = [3, n0, _SISF,
  0,
  [_sN],
  [0]
];
export var SuccessConditions$: StaticStructureSchema = [3, n0, _SCu,
  0,
  [_con],
  [() => ConditionList]
];
...
export var TargetFilter$: StaticStructureSchema = [3, n0, _TF,
  0,
  [_na, _val],
  [0, 64 | 0]
];
export var ThirdPartyJob$: StaticStructureSchema = [3, n0, _TPJ,
  0,
  [_cIl, _jI],
  [0, 0]
];
export var ThirdPartyJobData$: StaticStructureSchema = [3, n0, _TPJD,
  0,
  [_aTI, _aC, _pCi, _iA, _oA, _aCr, _cTo, _eK],
  [() => ActionTypeId$, () => ActionConfiguration$, () => PipelineContext$, () => ArtifactList, () => ArtifactList, [() => AWSSessionCredentials$, 0], 0, () => EncryptionKey$]
];
export var ThirdPartyJobDetails$: StaticStructureSchema = [3, n0, _TPJDh,
  0,
  [_id, _da, _n],
...
export var UpdateActionTypeInput$: StaticStructureSchema = [3, n0, _UATI,
  0,
  [_aT],
  [() => ActionTypeDeclaration$]
];
export var UpdatePipelineInput$: StaticStructureSchema = [3, n0, _UPI,
  0,
  [_pi],
  [() => PipelineDeclaration$]
];
export var UpdatePipelineOutput$: StaticStructureSchema = [3, n0, _UPO,
  0,
  [_pi],
  [() => PipelineDeclaration$]
];
...
export var WebhookDefinition$: StaticStructureSchema = [3, n0, _WD,
  0,
  [_na, _tP, _tA, _fi, _au, _aCu],
  [0, 0, 0, () => WebhookFilters, 0, () => WebhookAuthConfiguration$]
];
export var WebhookFilterRule$: StaticStructureSchema = [3, n0, _WFR,
  0,
  [_jP, _mE],
  [0, 0]
];
...
var ActionExecutionDetailList: StaticListSchema = [1, n0, _AEDL,
  0, () => ActionExecutionDetail$
];
var ActionStateList: StaticListSchema = [1, n0, _ASL,
  0, () => ActionState$
];
var ActionTypeList: StaticListSchema = [1, n0, _ATL,
  0, () => ActionType$
];
var ActionTypeProperties: StaticListSchema = [1, n0, _ATPct,
  0, () => ActionTypeProperty$
];
var AllowedAccounts = 64 | 0;
var ArtifactDetailList: StaticListSchema = [1, n0, _ADL,
  0, () => ArtifactDetail$
];
var ArtifactList: StaticListSchema = [1, n0, _ALr,
  0, () => Artifact$
];
var ArtifactRevisionList: StaticListSchema = [1, n0, _ARL,
  0, () => ArtifactRevision$
];
...
var ConditionStateList: StaticListSchema = [1, n0, _CSL,
  0, () => ConditionState$
];
var DeployActionExecutionTargetList: StaticListSchema = [1, n0, _DAETL,
  0, () => DeployActionExecutionTarget$
];
var DeployTargetEventList: StaticListSchema = [1, n0, _DTEL,
  0, () => DeployTargetEvent$
];
var EnvironmentVariableList: StaticListSchema = [1, n0, _EVL,
...
var GitPullRequestFilterList: StaticListSchema = [1, n0, _GPRFL,
  0, () => GitPullRequestFilter$
];
var GitPushFilterList: StaticListSchema = [1, n0, _GPFL,
  0, () => GitPushFilter$
];
var GitTagPatternList = 64 | 0;
var InputArtifactList: StaticListSchema = [1, n0, _IAL,
  0, () => InputArtifact$
];
...
var OutputArtifactList: StaticListSchema = [1, n0, _OAL,
  0, () => OutputArtifact$
];
...
var PipelineStageDeclarationList: StaticListSchema = [1, n0, _PSDL,
  0, () => StageDeclaration$
];
var PipelineTriggerDeclarationList: StaticListSchema = [1, n0, _PTDL,
  0, () => PipelineTriggerDeclaration$
];
var PipelineVariableDeclarationList: StaticListSchema = [1, n0, _PVDL,
  0, () => PipelineVariableDeclaration$
];
var PipelineVariableList: StaticListSchema = [1, n0, _PVL,
  0, () => PipelineVariable$
];
var PollingAccountList = 64 | 0;
var PollingServicePrincipalList = 64 | 0;
var ResolvedPipelineVariableList: StaticListSchema = [1, n0, _RPVL,
  0, () => ResolvedPipelineVariable$
];
var RuleConfigurationPropertyList: StaticListSchema = [1, n0, _RCPL,
  0, () => RuleConfigurationProperty$
];
var RuleDeclarationList: StaticListSchema = [1, n0, _RDL,
  0, () => RuleDeclaration$
];
var RuleExecutionDetailList: StaticListSchema = [1, n0, _REDL,
  0, () => RuleExecutionDetail$
];
var RuleStateList: StaticListSchema = [1, n0, _RSL,
  0, () => RuleState$
];
var RuleTypeList: StaticListSchema = [1, n0, _RTL,
  0, () => RuleType$
];
var SourceRevisionList: StaticListSchema = [1, n0, _SRL,
  0, () => SourceRevision$
];
var SourceRevisionOverrideList: StaticListSchema = [1, n0, _SROL,
  0, () => SourceRevisionOverride$
];
var StageActionDeclarationList: StaticListSchema = [1, n0, _SADL,
  0, () => ActionDeclaration$
];
var StageBlockerDeclarationList: StaticListSchema = [1, n0, _SBDL,
  0, () => BlockerDeclaration$
];
var StageExecutionList: StaticListSchema = [1, n0, _SEL,
  0, () => StageExecution$
];
var StageStateList: StaticListSchema = [1, n0, _SSL,
  0, () => StageState$
];
var TagKeyList = 64 | 0;
...
var TargetFilterList: StaticListSchema = [1, n0, _TFL,
  0, () => TargetFilter$
];
var TargetFilterValueList = 64 | 0;
var ThirdPartyJobList: StaticListSchema = [1, n0, _TPJL,
  0, () => ThirdPartyJob$
];
var WebhookFilters: StaticListSchema = [1, n0, _WF,
  0, () => WebhookFilterRule$
];
var WebhookList: StaticListSchema = [1, n0, _WL,
  0, () => ListWebhookItem$
];
var ActionConfigurationMap = 128 | 0;
var ArtifactStoreMap: StaticMapSchema = [2, n0, _ASM,
  0, 0, () => ArtifactStore$
];
...
export var AcknowledgeJob$: StaticOperationSchema = [9, n0, _AJ,
  0, () => AcknowledgeJobInput$, () => AcknowledgeJobOutput$
];
export var AcknowledgeThirdPartyJob$: StaticOperationSchema = [9, n0, _ATPJ,
  0, () => AcknowledgeThirdPartyJobInput$, () => AcknowledgeThirdPartyJobOutput$
];
export var CreateCustomActionType$: StaticOperationSchema = [9, n0, _CCAT,
...
export var DeleteCustomActionType$: StaticOperationSchema = [9, n0, _DCAT,
...
export var DeregisterWebhookWithThirdParty$: StaticOperationSchema = [9, n0, _DWWTP,
  0, () => DeregisterWebhookWithThirdPartyInput$, () => DeregisterWebhookWithThirdPartyOutput$
];
export var DisableStageTransition$: StaticOperationSchema = [9, n0, _DST,
  0, () => DisableStageTransitionInput$, () => __Unit
];
export var EnableStageTransition$: StaticOperationSchema = [9, n0, _EST,
  0, () => EnableStageTransitionInput$, () => __Unit
];
export var GetActionType$: StaticOperationSchema = [9, n0, _GAT,
  0, () => GetActionTypeInput$, () => GetActionTypeOutput$
];
export var GetJobDetails$: StaticOperationSchema = [9, n0, _GJD,
...
export var GetPipelineExecution$: StaticOperationSchema = [9, n0, _GPE,
  0, () => GetPipelineExecutionInput$, () => GetPipelineExecutionOutput$
];
export var GetPipelineState$: StaticOperationSchema = [9, n0, _GPS,
  0, () => GetPipelineStateInput$, () => GetPipelineStateOutput$
];
export var GetThirdPartyJobDetails$: StaticOperationSchema = [9, n0, _GTPJD,
  0, () => GetThirdPartyJobDetailsInput$, () => GetThirdPartyJobDetailsOutput$
];
export var ListActionExecutions$: StaticOperationSchema = [9, n0, _LAE,
  0, () => ListActionExecutionsInput$, () => ListActionExecutionsOutput$
];
export var ListActionTypes$: StaticOperationSchema = [9, n0, _LAT,
  0, () => ListActionTypesInput$, () => ListActionTypesOutput$
];
export var ListDeployActionExecutionTargets$: StaticOperationSchema = [9, n0, _LDAET,
...
export var ListRuleExecutions$: StaticOperationSchema = [9, n0, _LRE,
  0, () => ListRuleExecutionsInput$, () => ListRuleExecutionsOutput$
];
export var ListRuleTypes$: StaticOperationSchema = [9, n0, _LRT,
...
export var OverrideStageCondition$: StaticOperationSchema = [9, n0, _OSC,
  0, () => OverrideStageConditionInput$, () => __Unit
];
export var PollForJobs$: StaticOperationSchema = [9, n0, _PFJ,
  0, () => PollForJobsInput$, () => PollForJobsOutput$
];
export var PollForThirdPartyJobs$: StaticOperationSchema = [9, n0, _PFTPJ,
  0, () => PollForThirdPartyJobsInput$, () => PollForThirdPartyJobsOutput$
];
export var PutActionRevision$: StaticOperationSchema = [9, n0, _PAR,
  0, () => PutActionRevisionInput$, () => PutActionRevisionOutput$
];
export var PutApprovalResult$: StaticOperationSchema = [9, n0, _PARu,
  0, () => PutApprovalResultInput$, () => PutApprovalResultOutput$
];
export var PutJobFailureResult$: StaticOperationSchema = [9, n0, _PJFR,
  0, () => PutJobFailureResultInput$, () => __Unit
];
export var PutJobSuccessResult$: StaticOperationSchema = [9, n0, _PJSR,
  0, () => PutJobSuccessResultInput$, () => __Unit
];
export var PutThirdPartyJobFailureResult$: StaticOperationSchema = [9, n0, _PTPJFR,
  0, () => PutThirdPartyJobFailureResultInput$, () => __Unit
];
export var PutThirdPartyJobSuccessResult$: StaticOperationSchema = [9, n0, _PTPJSR,
  0, () => PutThirdPartyJobSuccessResultInput$, () => __Unit
];
export var PutWebhook$: StaticOperationSchema = [9, n0, _PW,
  0, () => PutWebhookInput$, () => PutWebhookOutput$
];
export var RegisterWebhookWithThirdParty$: StaticOperationSchema = [9, n0, _RWWTP,
  0, () => RegisterWebhookWithThirdPartyInput$, () => RegisterWebhookWithThirdPartyOutput$
];
export var RetryStageExecution$: StaticOperationSchema = [9, n0, _RSE,
  0, () => RetryStageExecutionInput$, () => RetryStageExecutionOutput$
];
export var RollbackStage$: StaticOperationSchema = [9, n0, _RSo,
...
export var UpdateActionType$: StaticOperationSchema = [9, n0, _UAT,
