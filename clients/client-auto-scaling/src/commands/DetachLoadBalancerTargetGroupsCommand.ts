 ...
 * @public
 */
export class DetachLoadBalancerTargetGroupsCommand extends command<DetachLoadBalancerTargetGroupsCommandInput, DetachLoadBalancerTargetGroupsCommandOutput>(
  _ep0,
  _mw0,
