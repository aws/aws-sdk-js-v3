...
import type { ProcessesType } from "../models/models_0";
 ...
 * @public
 */
export class DescribeScalingProcessTypesCommand extends command<DescribeScalingProcessTypesCommandInput, DescribeScalingProcessTypesCommandOutput>(
  _ep0,
  _mw0,
