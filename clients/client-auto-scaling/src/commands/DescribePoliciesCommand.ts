...
import type { DescribePoliciesType, PoliciesType } from "../models/models_0";
 ...
 * @public
 */
export class DescribePoliciesCommand extends command<DescribePoliciesCommandInput, DescribePoliciesCommandOutput>(
  _ep0,
  _mw0,
  "DescribePolicies",
  DescribePolicies$
