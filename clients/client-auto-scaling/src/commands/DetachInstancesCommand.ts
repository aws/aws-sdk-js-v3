...
import type { DetachInstancesAnswer, DetachInstancesQuery } from "../models/models_0";
 ...
 * @public
 */
export class DetachInstancesCommand extends command<DetachInstancesCommandInput, DetachInstancesCommandOutput>(
  _ep0,
  _mw0,
  "DetachInstances",
  DetachInstances$
