 ...
 * @public
 */
export class PutScheduledUpdateGroupActionCommand extends command<PutScheduledUpdateGroupActionCommandInput, PutScheduledUpdateGroupActionCommandOutput>(
  _ep0,
  _mw0,
