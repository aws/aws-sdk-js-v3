...
const serializeAws_queryBlockDeviceMappings = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryBlockDeviceMapping(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryLifecycleHookSpecifications = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryLifecycleHookSpecification(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryMetricDimensions = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryMetricDimension(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryOverrides = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryLaunchTemplateOverrides(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryScheduledUpdateGroupActionRequests = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryScheduledUpdateGroupActionRequest(
      entry,
      context
    );
    counter++;
...
const serializeAws_queryStepAdjustments = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryStepAdjustment(entry, context);
    counter++;
  });
  return entries;
};
...
const deserializeAws_queryActivitiesType = (
  ...
  if (output["Activities"]["member"] !== undefined) {
...
const deserializeAws_queryAutoScalingGroup = (
  ...
  if (output["AvailabilityZones"]["member"] !== undefined) {
  ...
  if (output["EnabledMetrics"]["member"] !== undefined) {
  ...
  if (output["Instances"]["member"] !== undefined) {
  ...
  if (output["LoadBalancerNames"]["member"] !== undefined) {
  ...
  if (output["SuspendedProcesses"]["member"] !== undefined) {
...
const deserializeAws_queryAutoScalingGroupsType = (
  ...
  if (output["AutoScalingGroups"]["member"] !== undefined) {
...
const deserializeAws_queryAutoScalingInstancesType = (
  ...
  if (output["AutoScalingInstances"]["member"] !== undefined) {
...
const deserializeAws_queryBatchDeleteScheduledActionAnswer = (
  ...
  if (output["FailedScheduledActions"]["member"] !== undefined) {
...
const deserializeAws_queryBatchPutScheduledUpdateGroupActionAnswer = (
  ...
  if (output["FailedScheduledUpdateGroupActions"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeAdjustmentTypesAnswer = (
  ...
  if (output["AdjustmentTypes"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeAutoScalingNotificationTypesAnswer = (
  ...
  if (output["AutoScalingNotificationTypes"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeLifecycleHookTypesAnswer = (
  ...
  if (output["LifecycleHookTypes"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeLifecycleHooksAnswer = (
  ...
  if (output["LifecycleHooks"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeLoadBalancerTargetGroupsResponse = (
  ...
  if (output["LoadBalancerTargetGroups"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeLoadBalancersResponse = (
  ...
  if (output["LoadBalancers"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeMetricCollectionTypesAnswer = (
  ...
  if (output["Granularities"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeNotificationConfigurationsAnswer = (
  ...
  if (output["NotificationConfigurations"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeTerminationPolicyTypesAnswer = (
  ...
  if (output["TerminationPolicyTypes"]["member"] !== undefined) {
...
const deserializeAws_queryLaunchConfiguration = (
  ...
  if (output["BlockDeviceMappings"]["member"] !== undefined) {
  ...
  if (output["ClassicLinkVPCSecurityGroups"]["member"] !== undefined) {
...
const deserializeAws_queryLaunchConfigurationsType = (
  ...
  if (output["LaunchConfigurations"]["member"] !== undefined) {
...
const deserializeAws_queryLaunchTemplate = (
  ...
  if (output["Overrides"]["member"] !== undefined) {
...
const deserializeAws_queryPoliciesType = (
  ...
  if (output["ScalingPolicies"]["member"] !== undefined) {
...
const deserializeAws_queryPolicyARNType = (
  ...
  if (output["Alarms"]["member"] !== undefined) {
...
const deserializeAws_queryProcessesType = (
  ...
  if (output["Processes"]["member"] !== undefined) {
...
const deserializeAws_queryScalingPolicy = (
  ...
  if (output["StepAdjustments"]["member"] !== undefined) {
...
const deserializeAws_queryScheduledActionsType = (
  ...
  if (output["ScheduledUpdateGroupActions"]["member"] !== undefined) {
