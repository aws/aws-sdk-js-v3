...
export declare type ServiceInputTypes = AssociateMemberAccountCommandInput | AssociateS3ResourcesCommandInput | DisassociateMemberAccountCommandInput | DisassociateS3ResourcesCommandInput | ListMemberAccountsCommandInput | ListS3ResourcesCommandInput | UpdateS3ResourcesCommandInput;
export declare type ServiceOutputTypes = AssociateMemberAccountCommandOutput | AssociateS3ResourcesCommandOutput | DisassociateMemberAccountCommandOutput | DisassociateS3ResourcesCommandOutput | ListMemberAccountsCommandOutput | ListS3ResourcesCommandOutput | UpdateS3ResourcesCommandOutput;
...
export declare type MacieClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type MacieClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
 ...
 *         Guide</a>. </p>
 */
export declare class MacieClient extends __Client<__HttpHandlerOptions, ServiceInputTypes, ServiceOutputTypes, MacieClientResolvedConfig> {
