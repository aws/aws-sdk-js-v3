...
import { type SecurityLakeClientResolvedConfig, SecurityLakeClientConfig } from "../SecurityLakeClient";
 ...
 * @internal
 */
export const defaultSecurityLakeHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SecurityLakeHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultSecurityLakeHttpAuthSchemeProvider: SecurityLakeHttpAuthSchemeProvider = (authParameters) => {
