  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<SecurityLakeClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultSecurityLakeHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: SecurityLakeClientResolvedConfig) =>
