...
export var CreateDataLakeOrganizationConfigurationRequest$: StaticStructureSchema = [3, n0, _CDLOCR,
  0,
  [_aENA],
  [() => DataLakeAutoEnableNewAccountConfigurationList]
];
export var CreateDataLakeOrganizationConfigurationResponse$: StaticStructureSchema = [3, n0, _CDLOCRr,
  0,
  [],
  []
];
...
export var CustomLogSourceAttributes$: StaticStructureSchema = [3, n0, _CLSA,
  0,
  [_cA, _dA, _tA],
  [0, 0, 0]
];
...
export var CustomLogSourceResource$: StaticStructureSchema = [3, n0, _CLSR,
  0,
  [_sN, _sV, _pr, _at],
...
export var DataLakeException$: StaticStructureSchema = [3, n0, _DLE,
  0,
  [_re, _ex, _rem, _ti],
  [0, 0, 0, 5]
];
export var DataLakeLifecycleConfiguration$: StaticStructureSchema = [3, n0, _DLLC,
  0,
  [_exp, _tr],
  [() => DataLakeLifecycleExpiration$, () => DataLakeLifecycleTransitionList]
];
export var DataLakeLifecycleExpiration$: StaticStructureSchema = [3, n0, _DLLE,
  0,
  [_d],
  [1]
];
...
export var DataLakeSourceStatus$: StaticStructureSchema = [3, n0, _DLSS,
  0,
  [_res, _st],
  [0, 0]
];
export var DataLakeUpdateException$: StaticStructureSchema = [3, n0, _DLUE,
  0,
  [_rea, _cod],
  [0, 0]
];
export var DataLakeUpdateStatus$: StaticStructureSchema = [3, n0, _DLUS,
  0,
  [_rI, _st, _ex],
...
export var DeleteDataLakeExceptionSubscriptionRequest$: StaticStructureSchema = [3, n0, _DDLESR,
  0,
  [],
  []
];
export var DeleteDataLakeExceptionSubscriptionResponse$: StaticStructureSchema = [3, n0, _DDLESRe,
  0,
  [],
  []
];
export var DeleteDataLakeOrganizationConfigurationRequest$: StaticStructureSchema = [3, n0, _DDLOCR,
  0,
  [_aENA],
  [() => DataLakeAutoEnableNewAccountConfigurationList]
];
export var DeleteDataLakeOrganizationConfigurationResponse$: StaticStructureSchema = [3, n0, _DDLOCRe,
  0,
  [],
  []
];
...
export var DeregisterDataLakeDelegatedAdministratorRequest$: StaticStructureSchema = [3, n0, _DDLDAR,
  0,
  [],
  []
];
export var DeregisterDataLakeDelegatedAdministratorResponse$: StaticStructureSchema = [3, n0, _DDLDARe,
  0,
  [],
  []
];
export var GetDataLakeExceptionSubscriptionRequest$: StaticStructureSchema = [3, n0, _GDLESR,
  0,
  [],
  []
];
export var GetDataLakeExceptionSubscriptionResponse$: StaticStructureSchema = [3, n0, _GDLESRe,
  0,
  [_sP, _nE, _eTTL],
  [0, 0, 1]
];
export var GetDataLakeOrganizationConfigurationRequest$: StaticStructureSchema = [3, n0, _GDLOCR,
  0,
  [],
  []
];
export var GetDataLakeOrganizationConfigurationResponse$: StaticStructureSchema = [3, n0, _GDLOCRe,
  0,
  [_aENA],
  [() => DataLakeAutoEnableNewAccountConfigurationList]
];
export var GetDataLakeSourcesRequest$: StaticStructureSchema = [3, n0, _GDLSR,
  0,
  [_a, _mR, _nT],
  [64 | 0, 1, 0]
];
export var GetDataLakeSourcesResponse$: StaticStructureSchema = [3, n0, _GDLSRe,
  0,
  [_dLA, _dLS, _nT],
...
export var ListDataLakeExceptionsResponse$: StaticStructureSchema = [3, n0, _LDLERi,
  0,
  [_exc, _nT],
  [() => DataLakeExceptionList, 0]
];
export var ListDataLakesRequest$: StaticStructureSchema = [3, n0, _LDLR,
  0,
  [_r],
  [[64 | 0, { [_hQ]: _r }]]
];
export var ListDataLakesResponse$: StaticStructureSchema = [3, n0, _LDLRi,
  0,
  [_dL],
  [() => DataLakeResourceList]
];
...
export var ListSubscribersResponse$: StaticStructureSchema = [3, n0, _LSRi,
  0,
  [_sub, _nT],
...
var AwsLogSourceResourceList: StaticListSchema = [1, n0, _ALSRL,
  0, () => AwsLogSourceResource$
];
var DataLakeAutoEnableNewAccountConfigurationList: StaticListSchema = [1, n0, _DLAENACL,
  0, () => DataLakeAutoEnableNewAccountConfiguration$
];
var DataLakeConfigurationList: StaticListSchema = [1, n0, _DLCL,
  0, () => DataLakeConfiguration$
];
var DataLakeExceptionList: StaticListSchema = [1, n0, _DLEL,
  0, () => DataLakeException$
];
var DataLakeLifecycleTransitionList: StaticListSchema = [1, n0, _DLLTL,
  0, () => DataLakeLifecycleTransition$
];
var DataLakeResourceList: StaticListSchema = [1, n0, _DLRL,
  0, () => DataLakeResource$
];
var DataLakeSourceList: StaticListSchema = [1, n0, _DLSL,
  0, () => DataLakeSource$
];
var DataLakeSourceStatusList: StaticListSchema = [1, n0, _DLSSL,
  0, () => DataLakeSourceStatus$
];
var LogSourceList: StaticListSchema = [1, n0, _LSL,
  0, () => LogSource$
];
var LogSourceResourceList: StaticListSchema = [1, n0, _LSRL,
  0, () => LogSourceResource$
];
var OcsfEventClassList = 64 | 0;
var RegionList = 64 | 0;
var SubscriberResourceList: StaticListSchema = [1, n0, _SRL,
...
export var LogSourceResource$: StaticUnionSchema = [4, n0, _LSRo,
  0,
  [_aLS, _cLS],
  [() => AwsLogSourceResource$, () => CustomLogSourceResource$]
];
export var NotificationConfiguration$: StaticUnionSchema = [4, n0, _NC,
  0,
  [_sNC, _hNC],
  [() => SqsNotificationConfiguration$, () => HttpsNotificationConfiguration$]
];
export var CreateAwsLogSource$: StaticOperationSchema = [9, n0, _CALS,
  { [_h]: ["POST", "/v1/datalake/logsources/aws", 200] }, () => CreateAwsLogSourceRequest$, () => CreateAwsLogSourceResponse$
];
export var CreateCustomLogSource$: StaticOperationSchema = [9, n0, _CCLS,
  { [_h]: ["POST", "/v1/datalake/logsources/custom", 200] }, () => CreateCustomLogSourceRequest$, () => CreateCustomLogSourceResponse$
];
export var CreateDataLake$: StaticOperationSchema = [9, n0, _CDL,
  { [_h]: ["POST", "/v1/datalake", 200] }, () => CreateDataLakeRequest$, () => CreateDataLakeResponse$
];
export var CreateDataLakeExceptionSubscription$: StaticOperationSchema = [9, n0, _CDLES,
...
export var CreateDataLakeOrganizationConfiguration$: StaticOperationSchema = [9, n0, _CDLOC,
...
export var CreateSubscriber$: StaticOperationSchema = [9, n0, _CS,
  { [_h]: ["POST", "/v1/subscribers", 200] }, () => CreateSubscriberRequest$, () => CreateSubscriberResponse$
];
export var CreateSubscriberNotification$: StaticOperationSchema = [9, n0, _CSN,
...
export var DeleteDataLakeOrganizationConfiguration$: StaticOperationSchema = [9, n0, _DDLOC,
...
export var DeleteSubscriberNotification$: StaticOperationSchema = [9, n0, _DSN,
...
export var DeregisterDataLakeDelegatedAdministrator$: StaticOperationSchema = [9, n0, _DDLDA,
...
export var GetDataLakeExceptionSubscription$: StaticOperationSchema = [9, n0, _GDLES,
...
export var GetDataLakeOrganizationConfiguration$: StaticOperationSchema = [9, n0, _GDLOC,
...
export var RegisterDataLakeDelegatedAdministrator$: StaticOperationSchema = [9, n0, _RDLDA,
...
export var UpdateDataLake$: StaticOperationSchema = [9, n0, _UDL,
  { [_h]: ["PUT", "/v1/datalake", 200] }, () => UpdateDataLakeRequest$, () => UpdateDataLakeResponse$
];
export var UpdateDataLakeExceptionSubscription$: StaticOperationSchema = [9, n0, _UDLES,
...
export var UpdateSubscriberNotification$: StaticOperationSchema = [9, n0, _USN,
