 ...
 * @public
 */
export class DeleteDataLakeExceptionSubscriptionCommand extends command<DeleteDataLakeExceptionSubscriptionCommandInput, DeleteDataLakeExceptionSubscriptionCommandOutput>(
  _ep0,
  _mw0,
