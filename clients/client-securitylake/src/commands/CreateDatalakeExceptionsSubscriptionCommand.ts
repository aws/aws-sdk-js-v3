 ...
 * ```
 *
 * @param CreateDatalakeExceptionsSubscriptionRequest - {@link CreateDatalakeExceptionsSubscriptionRequest}
 * @returns {@link CreateDatalakeExceptionsSubscriptionResponse}
