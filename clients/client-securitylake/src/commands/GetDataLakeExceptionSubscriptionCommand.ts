 ...
 * @public
 */
export class GetDataLakeExceptionSubscriptionCommand extends command<GetDataLakeExceptionSubscriptionCommandInput, GetDataLakeExceptionSubscriptionCommandOutput>(
  _ep0,
  _mw0,
