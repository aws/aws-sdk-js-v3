 ...
 * @public
 */
export class CreateDataLakeOrganizationConfigurationCommand extends command<CreateDataLakeOrganizationConfigurationCommandInput, CreateDataLakeOrganizationConfigurationCommandOutput>(
  _ep0,
  _mw0,
