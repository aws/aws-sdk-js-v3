...
import {
  type TimestreamInfluxDBClientResolvedConfig,
 ...
 * @internal
 */
export const defaultTimestreamInfluxDBHttpAuthSchemeProvider: TimestreamInfluxDBHttpAuthSchemeProvider = (authParameters) => {
