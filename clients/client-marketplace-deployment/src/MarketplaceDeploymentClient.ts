...
import {
  defaultMarketplaceDeploymentHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type MarketplaceDeploymentClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type MarketplaceDeploymentClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<MarketplaceDeploymentClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultMarketplaceDeploymentHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: MarketplaceDeploymentClientResolvedConfig) =>
