  ...
  return {
    ...
    unhealthyConnectors:
      output.unhealthyConnectors !== undefined && output.unhealthyConnectors !== null
        ...
        : undefined,
    unknownConnectors:
      output.unknownConnectors !== undefined && output.unknownConnectors !== null ? output.unknownConnectors : undefined
  } as any;
};
...
const deserializeAws_json1_1NeighborConnectionDetail = (
  ...
  return {
    ...
    transportProtocol:
      output.transportProtocol !== undefined && output.transportProtocol !== null ? output.transportProtocol : undefined
  } as any;
};
