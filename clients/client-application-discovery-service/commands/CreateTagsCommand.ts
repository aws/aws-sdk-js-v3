...
export type CreateTagsCommandOutput = CreateTagsResponse;

export class CreateTagsCommand extends $Command<CreateTagsCommandInput, CreateTagsCommandOutput, ApplicationDiscoveryServiceClientResolvedConfig> {
