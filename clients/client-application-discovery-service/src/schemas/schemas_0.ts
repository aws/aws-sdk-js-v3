...
export var BatchDeleteAgentsResponse$: StaticStructureSchema = [
  3,
  n0,
  _BDARa,
  0,
...
var AgentConfigurationStatusList: StaticListSchema = [1, n0, _ACSL, 0, () => AgentConfigurationStatus$];
var AgentIds = 64 | 0;
var AgentNetworkInfoList: StaticListSchema = [1, n0, _ANIL, 0, [() => AgentNetworkInfo$, 0]];
var AgentsInfo: StaticListSchema = [1, n0, _AIg, 0, [() => AgentInfo$, 0]];
var ApplicationIdsList = 64 | 0;
var BatchDeleteAgentErrors: StaticListSchema = [1, n0, _BDAEa, 0, () => BatchDeleteAgentError$];
var BatchDeleteImportDataErrorList: StaticListSchema = [1, n0, _BDIDEL, 0, () => BatchDeleteImportDataError$];
var ConfigurationIdList = 64 | 0;
var Configurations: StaticListSchema = [1, n0, _C, 0, 128 | 0];
var ConfigurationTagSet: StaticListSchema = [1, n0, _CTS, 0, [() => ConfigurationTag$, { [_xN]: _i }]];
var ContinuousExportDescriptions: StaticListSchema = [1, n0, _CEDo, 0, () => ContinuousExportDescription$];
var ContinuousExportIds = 64 | 0;
var DeleteAgents: StaticListSchema = [1, n0, _DAe, 0, () => DeleteAgent$];
var DeletionWarningsList: StaticListSchema = [1, n0, _DWL, 0, () => DeletionWarning$];
var DescribeConfigurationsAttributes: StaticListSchema = [1, n0, _DCA, 0, 128 | 0];
var DescribeImportTasksFilterList: StaticListSchema = [1, n0, _DITFL, 0, () => ImportTaskFilter$];
var ExcludedInstanceTypes = 64 | 0;
var ExportDataFormats = 64 | 0;
var ExportFilters: StaticListSchema = [1, n0, _EFx, 0, [() => ExportFilter$, 0]];
var ExportIds = 64 | 0;
var ExportsInfo: StaticListSchema = [1, n0, _EIx, 0, () => ExportInfo$];
var FailedConfigurationList: StaticListSchema = [1, n0, _FCL, 0, () => FailedConfiguration$];
var Filters: StaticListSchema = [1, n0, _Fi, 0, [() => Filter$, 0]];
var FilterValues: StaticListSchema = [1, n0, _FV, 0, [0, { [_xN]: _i }]];
var ImportTaskFilterValueList = 64 | 0;
var ImportTaskList: StaticListSchema = [1, n0, _ITL, 0, () => ImportTask$];
var NeighborDetailsList: StaticListSchema = [1, n0, _NDL, 0, () => NeighborConnectionDetail$];
var OrderByList: StaticListSchema = [1, n0, _OBL, 0, () => OrderByElement$];
var TagFilters: StaticListSchema = [1, n0, _TFa, 0, [() => TagFilter$, 0]];
var TagSet: StaticListSchema = [1, n0, _TS, 0, [() => Tag$, { [_xN]: _i }]];
