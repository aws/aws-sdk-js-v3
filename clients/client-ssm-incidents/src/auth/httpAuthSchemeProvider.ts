...
import { type SSMIncidentsClientResolvedConfig, SSMIncidentsClientConfig } from "../SSMIncidentsClient";
 ...
 * @internal
 */
export const defaultSSMIncidentsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SSMIncidentsHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultSSMIncidentsHttpAuthSchemeProvider: SSMIncidentsHttpAuthSchemeProvider = (authParameters) => {
