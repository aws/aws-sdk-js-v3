...
import type { ListTimelineEventsInput, ListTimelineEventsOutput } from "../models/models_0";
 ...
 * @public
 */
export class ListTimelineEventsCommand extends command<ListTimelineEventsCommandInput, ListTimelineEventsCommandOutput>(
  _ep0,
  _mw0,
  "ListTimelineEvents",
  ListTimelineEvents$
