...
import type { DeleteResponsePlanInput, DeleteResponsePlanOutput } from "../models/models_0";
 ...
 * @public
 */
export class DeleteResponsePlanCommand extends command<DeleteResponsePlanCommandInput, DeleteResponsePlanCommandOutput>(
  _ep0,
  _mw0,
  "DeleteResponsePlan",
  DeleteResponsePlan$
