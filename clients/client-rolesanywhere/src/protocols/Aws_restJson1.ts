...
export const serializeAws_restJson1CreateProfileCommand = async (
  ...
  body = JSON.stringify({
    ...
    ...(input.requireInstanceProperties != undefined && { requireInstanceProperties: input.requireInstanceProperties }),
    ...(input.roleArns != undefined && { roleArns: serializeAws_restJson1RoleArnList(input.roleArns, context) }),
...
export const serializeAws_restJson1ImportCrlCommand = async (
  ...
  let body: any;
  body = JSON.stringify({
    ...(input.crlData != undefined && { crlData: context.base64Encoder(input.crlData) }),
    ...(input.enabled != undefined && { enabled: input.enabled }),
    ...(input.name != undefined && { name: input.name }),
    ...(input.tags != undefined && { tags: serializeAws_restJson1TagList(input.tags, context) }),
    ...(input.trustAnchorArn != undefined && { trustAnchorArn: input.trustAnchorArn }),
  });
  return new __HttpRequest({
    protocol,
    hostname,
...
const serializeAws_restJson1Source = (input: Source, context: __SerdeContext): any => {
  return {
    ...(input.sourceData != undefined && { sourceData: serializeAws_restJson1SourceData(input.sourceData, context) }),
...
const deserializeAws_restJson1CredentialSummary = (output: any, context: __SerdeContext): CredentialSummary => {
  return {
    ...
    seenAt: output.seenAt != undefined ? __expectNonNull(__parseRfc3339DateTime(output.seenAt)) : undefined,
...
const deserializeAws_restJson1CrlDetail = (output: any, context: __SerdeContext): CrlDetail => {
  return {
    ...
    crlData: output.crlData != undefined ? context.base64Decoder(output.crlData) : undefined,
...
const deserializeAws_restJson1ProfileDetail = (output: any, context: __SerdeContext): ProfileDetail => {
  return {
    ...
    enabled: __expectBoolean(output.enabled),
    managedPolicyArns:
      output.managedPolicyArns != undefined
    ...
    roleArns: output.roleArns != undefined ? deserializeAws_restJson1RoleArnList(output.roleArns, context) : undefined,
...
const deserializeAws_restJson1SubjectDetail = (output: any, context: __SerdeContext): SubjectDetail => {
  return {
    createdAt: output.createdAt != undefined ? __expectNonNull(__parseRfc3339DateTime(output.createdAt)) : undefined,
    credentials:
      output.credentials != undefined
        ? deserializeAws_restJson1CredentialSummaries(output.credentials, context)
        : undefined,
    enabled: __expectBoolean(output.enabled),
    instanceProperties:
      output.instanceProperties != undefined
        ? deserializeAws_restJson1InstanceProperties(output.instanceProperties, context)
        : undefined,
    lastSeenAt: output.lastSeenAt != undefined ? __expectNonNull(__parseRfc3339DateTime(output.lastSeenAt)) : undefined,
