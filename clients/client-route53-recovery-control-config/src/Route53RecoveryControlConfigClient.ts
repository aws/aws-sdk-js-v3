 ...
 * @public
 */
export type Route53RecoveryControlConfigClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type Route53RecoveryControlConfigClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<Route53RecoveryControlConfigClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultRoute53RecoveryControlConfigHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: Route53RecoveryControlConfigClientResolvedConfig) =>
