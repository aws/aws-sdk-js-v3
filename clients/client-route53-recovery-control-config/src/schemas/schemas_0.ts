...
export var CreateSafetyRuleRequest$: StaticStructureSchema = [3, n0, _CSRR,
  0,
  [_AR, _CT, _GR, _T],
  [() => NewAssertionRule$, [0, 4], () => NewGatingRule$, 128 | 0]
];
export var CreateSafetyRuleResponse$: StaticStructureSchema = [3, n0, _CSRRr,
  0,
  [_AR, _GR],
...
export var ListControlPanelsRequest$: StaticStructureSchema = [3, n0, _LCPR,
  0,
  [_CA, _MR, _NTe],
  [[0, { [_hQ]: _CA }], [1, { [_hQ]: _MR }], [0, { [_hQ]: _NTe }]]
];
export var ListControlPanelsResponse$: StaticStructureSchema = [3, n0, _LCPRi,
  0,
  [_CPo, _NTe],
...
export var UpdateSafetyRuleRequest$: StaticStructureSchema = [3, n0, _USRR,
  0,
  [_ARU, _GRU],
  [() => AssertionRuleUpdate$, () => GatingRuleUpdate$]
];
export var UpdateSafetyRuleResponse$: StaticStructureSchema = [3, n0, _USRRp,
  0,
  [_AR, _GR],
  [() => AssertionRule$, () => GatingRule$]
];
...
var __listOfClusterEndpoint: StaticListSchema = [1, n0, _lOCE,
  0, () => ClusterEndpoint$
];
var __listOfControlPanel: StaticListSchema = [1, n0, _lOCP,
  0, () => ControlPanel$
];
var __listOfRoutingControl: StaticListSchema = [1, n0, _lORC,
  0, () => RoutingControl$
];
var __listOfRule: StaticListSchema = [1, n0, _lOR,
  0, () => Rule$
];
var __mapOf__stringMin0Max256PatternS = 128 | 0;
export var CreateCluster$: StaticOperationSchema = [9, n0, _CC,
  { [_h]: ["POST", "/cluster", 200] }, () => CreateClusterRequest$, () => CreateClusterResponse$
];
export var CreateControlPanel$: StaticOperationSchema = [9, n0, _CCP,
  { [_h]: ["POST", "/controlpanel", 200] }, () => CreateControlPanelRequest$, () => CreateControlPanelResponse$
];
export var CreateRoutingControl$: StaticOperationSchema = [9, n0, _CRC,
  { [_h]: ["POST", "/routingcontrol", 200] }, () => CreateRoutingControlRequest$, () => CreateRoutingControlResponse$
];
export var CreateSafetyRule$: StaticOperationSchema = [9, n0, _CSR,
...
export var ListAssociatedRoute53HealthChecks$: StaticOperationSchema = [9, n0, _LARHC,
...
export var ListControlPanels$: StaticOperationSchema = [9, n0, _LCP,
...
export var ListSafetyRules$: StaticOperationSchema = [9, n0, _LSR,
...
export var UpdateControlPanel$: StaticOperationSchema = [9, n0, _UCP,
  { [_h]: ["PUT", "/controlpanel", 200] }, () => UpdateControlPanelRequest$, () => UpdateControlPanelResponse$
];
export var UpdateRoutingControl$: StaticOperationSchema = [9, n0, _URC,
  { [_h]: ["PUT", "/routingcontrol", 200] }, () => UpdateRoutingControlRequest$, () => UpdateRoutingControlResponse$
];
export var UpdateSafetyRule$: StaticOperationSchema = [9, n0, _USR,
