...
import type { UpdateControlPanelRequest, UpdateControlPanelResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateControlPanelCommand extends command<UpdateControlPanelCommandInput, UpdateControlPanelCommandOutput>(
  _ep0,
  _mw0,
  "UpdateControlPanel",
  UpdateControlPanel$
