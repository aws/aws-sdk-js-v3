...
import type { CreateSafetyRuleRequest, CreateSafetyRuleResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateSafetyRuleCommand extends command<CreateSafetyRuleCommandInput, CreateSafetyRuleCommandOutput>(
  _ep0,
  _mw0,
  "CreateSafetyRule",
  CreateSafetyRule$
