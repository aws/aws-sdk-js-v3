 ...
 * @public
 */
export class CreateTransitGatewayPrefixListReferenceCommand extends command<CreateTransitGatewayPrefixListReferenceCommandInput, CreateTransitGatewayPrefixListReferenceCommandOutput>(
  _ep0,
  _mw0,
