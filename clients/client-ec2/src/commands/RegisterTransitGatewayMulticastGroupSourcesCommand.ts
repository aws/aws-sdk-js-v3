 ...
 * @public
 */
export class RegisterTransitGatewayMulticastGroupSourcesCommand extends command<RegisterTransitGatewayMulticastGroupSourcesCommandInput, RegisterTransitGatewayMulticastGroupSourcesCommandOutput>(
  _ep0,
  _mw0,
