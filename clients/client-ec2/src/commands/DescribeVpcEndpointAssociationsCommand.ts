 ...
 * @public
 */
export class DescribeVpcEndpointAssociationsCommand extends command<DescribeVpcEndpointAssociationsCommandInput, DescribeVpcEndpointAssociationsCommandOutput>(
  _ep0,
  _mw0,
