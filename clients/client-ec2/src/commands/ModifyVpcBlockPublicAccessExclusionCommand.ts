 ...
 * @public
 */
export class ModifyVpcBlockPublicAccessExclusionCommand extends command<ModifyVpcBlockPublicAccessExclusionCommandInput, ModifyVpcBlockPublicAccessExclusionCommandOutput>(
  _ep0,
  _mw0,
