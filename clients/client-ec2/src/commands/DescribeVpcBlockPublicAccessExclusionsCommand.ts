 ...
 * @public
 */
export class DescribeVpcBlockPublicAccessExclusionsCommand extends command<DescribeVpcBlockPublicAccessExclusionsCommandInput, DescribeVpcBlockPublicAccessExclusionsCommandOutput>(
  _ep0,
  _mw0,
