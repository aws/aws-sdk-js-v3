 ...
 * @public
 */
export class DescribeIpamPrefixListResolverTargetsCommand extends command<DescribeIpamPrefixListResolverTargetsCommandInput, DescribeIpamPrefixListResolverTargetsCommandOutput>(
  _ep0,
  _mw0,
