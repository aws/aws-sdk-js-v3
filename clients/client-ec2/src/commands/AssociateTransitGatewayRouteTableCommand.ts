 ...
 * @public
 */
export class AssociateTransitGatewayRouteTableCommand extends command<AssociateTransitGatewayRouteTableCommandInput, AssociateTransitGatewayRouteTableCommandOutput>(
  _ep0,
  _mw0,
