 ...
 * @public
 */
export class ModifyInstanceCapacityReservationAttributesCommand extends command<ModifyInstanceCapacityReservationAttributesCommandInput, ModifyInstanceCapacityReservationAttributesCommandOutput>(
  _ep0,
  _mw0,
