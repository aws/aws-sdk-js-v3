 ...
 * @public
 */
export class GetIpamPrefixListResolverRulesCommand extends command<GetIpamPrefixListResolverRulesCommandInput, GetIpamPrefixListResolverRulesCommandOutput>(
  _ep0,
  _mw0,
