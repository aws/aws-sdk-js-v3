 ...
 * @public
 */
export class CreateVerifiedAccessTrustProviderCommand extends command<CreateVerifiedAccessTrustProviderCommandInput, CreateVerifiedAccessTrustProviderCommandOutput>(
  _ep0,
  _mw0,
