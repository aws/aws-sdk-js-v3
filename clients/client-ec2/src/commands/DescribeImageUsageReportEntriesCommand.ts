 ...
 * @public
 */
export class DescribeImageUsageReportEntriesCommand extends command<DescribeImageUsageReportEntriesCommandInput, DescribeImageUsageReportEntriesCommandOutput>(
  _ep0,
  _mw0,
