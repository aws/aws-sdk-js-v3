 ...
 * @public
 */
export class DeleteLocalGatewayVirtualInterfaceGroupCommand extends command<DeleteLocalGatewayVirtualInterfaceGroupCommandInput, DeleteLocalGatewayVirtualInterfaceGroupCommandOutput>(
  _ep0,
  _mw0,
