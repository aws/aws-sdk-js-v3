 ...
 * @public
 */
export class CreateTransitGatewayRouteTableCommand extends command<CreateTransitGatewayRouteTableCommandInput, CreateTransitGatewayRouteTableCommandOutput>(
  _ep0,
  _mw0,
