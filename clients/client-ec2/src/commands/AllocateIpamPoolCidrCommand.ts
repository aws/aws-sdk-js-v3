...
import { AllocateIpamPoolCidr$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class AllocateIpamPoolCidrCommand extends command<AllocateIpamPoolCidrCommandInput, AllocateIpamPoolCidrCommandOutput>(
  _ep0,
  _mw0,
