 ...
 * @public
 */
export class DescribeLaunchTemplateVersionsCommand extends command<DescribeLaunchTemplateVersionsCommandInput, DescribeLaunchTemplateVersionsCommandOutput>(
  _ep0,
  _mw0,
