 ...
 * @public
 */
export class DescribeInstanceSqlHaHistoryStatesCommand extends command<DescribeInstanceSqlHaHistoryStatesCommandInput, DescribeInstanceSqlHaHistoryStatesCommandOutput>(
  _ep0,
  _mw0,
