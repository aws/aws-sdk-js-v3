 ...
 * @public
 */
export class CreateIpamPrefixListResolverTargetCommand extends command<CreateIpamPrefixListResolverTargetCommandInput, CreateIpamPrefixListResolverTargetCommandOutput>(
  _ep0,
  _mw0,
