...
import type { DescribeRouteTablesRequest, DescribeRouteTablesResult } from "../models/models_5";
 ...
 * @public
 */
export class DescribeRouteTablesCommand extends command<DescribeRouteTablesCommandInput, DescribeRouteTablesCommandOutput>(
  _ep0,
  _mw0,
  "DescribeRouteTables",
  DescribeRouteTables$
