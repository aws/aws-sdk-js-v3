...
import type { ImportInstanceRequest, ImportInstanceResult } from "../models/models_7";
 ...
 * @public
 */
export class ImportInstanceCommand extends command<ImportInstanceCommandInput, ImportInstanceCommandOutput>(
  _ep0,
  _mw0,
  "ImportInstance",
  ImportInstance$
