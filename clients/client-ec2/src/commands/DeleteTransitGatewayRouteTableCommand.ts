 ...
 * @public
 */
export class DeleteTransitGatewayRouteTableCommand extends command<DeleteTransitGatewayRouteTableCommandInput, DeleteTransitGatewayRouteTableCommandOutput>(
  _ep0,
  _mw0,
