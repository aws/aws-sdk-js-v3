 ...
 * @public
 */
export class GetTransitGatewayRouteTablePropagationsCommand extends command<GetTransitGatewayRouteTablePropagationsCommandInput, GetTransitGatewayRouteTablePropagationsCommandOutput>(
  _ep0,
  _mw0,
