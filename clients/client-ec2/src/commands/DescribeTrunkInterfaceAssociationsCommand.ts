 ...
 * @public
 */
export class DescribeTrunkInterfaceAssociationsCommand extends command<DescribeTrunkInterfaceAssociationsCommandInput, DescribeTrunkInterfaceAssociationsCommandOutput>(
  _ep0,
  _mw0,
