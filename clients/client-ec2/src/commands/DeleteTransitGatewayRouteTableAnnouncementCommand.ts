 ...
 * @public
 */
export class DeleteTransitGatewayRouteTableAnnouncementCommand extends command<DeleteTransitGatewayRouteTableAnnouncementCommandInput, DeleteTransitGatewayRouteTableAnnouncementCommandOutput>(
  _ep0,
  _mw0,
