 ...
 * @public
 */
export class ExportClientVpnClientConfigurationCommand extends command<ExportClientVpnClientConfigurationCommandInput, ExportClientVpnClientConfigurationCommandOutput>(
  _ep0,
  _mw0,
