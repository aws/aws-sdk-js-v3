 ...
 * @public
 */
export class GetIpamPolicyOrganizationTargetsCommand extends command<GetIpamPolicyOrganizationTargetsCommandInput, GetIpamPolicyOrganizationTargetsCommandOutput>(
  _ep0,
  _mw0,
