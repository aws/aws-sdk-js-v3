 ...
 * @public
 */
export class DescribeClientVpnAuthorizationRulesCommand extends command<DescribeClientVpnAuthorizationRulesCommandInput, DescribeClientVpnAuthorizationRulesCommandOutput>(
  _ep0,
  _mw0,
