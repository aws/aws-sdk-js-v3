 ...
 * @public
 */
export class StartDeclarativePoliciesReportCommand extends command<StartDeclarativePoliciesReportCommandInput, StartDeclarativePoliciesReportCommandOutput>(
  _ep0,
  _mw0,
