 ...
 * @public
 */
export class DeleteIpamExternalResourceVerificationTokenCommand extends command<DeleteIpamExternalResourceVerificationTokenCommandInput, DeleteIpamExternalResourceVerificationTokenCommandOutput>(
  _ep0,
  _mw0,
