 ...
 * @public
 */
export class GetIpamDiscoveredResourceCidrsCommand extends command<GetIpamDiscoveredResourceCidrsCommandInput, GetIpamDiscoveredResourceCidrsCommandOutput>(
  _ep0,
  _mw0,
