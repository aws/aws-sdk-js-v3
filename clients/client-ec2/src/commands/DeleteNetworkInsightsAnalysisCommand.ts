 ...
 * @public
 */
export class DeleteNetworkInsightsAnalysisCommand extends command<DeleteNetworkInsightsAnalysisCommandInput, DeleteNetworkInsightsAnalysisCommandOutput>(
  _ep0,
  _mw0,
