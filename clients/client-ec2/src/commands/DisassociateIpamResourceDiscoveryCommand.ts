 ...
 * @public
 */
export class DisassociateIpamResourceDiscoveryCommand extends command<DisassociateIpamResourceDiscoveryCommandInput, DisassociateIpamResourceDiscoveryCommandOutput>(
  _ep0,
  _mw0,
