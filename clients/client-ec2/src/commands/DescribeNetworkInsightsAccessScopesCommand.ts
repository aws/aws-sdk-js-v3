 ...
 * @public
 */
export class DescribeNetworkInsightsAccessScopesCommand extends command<DescribeNetworkInsightsAccessScopesCommandInput, DescribeNetworkInsightsAccessScopesCommandOutput>(
  _ep0,
  _mw0,
