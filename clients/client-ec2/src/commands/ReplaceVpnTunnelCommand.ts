...
import type { ReplaceVpnTunnelRequest, ReplaceVpnTunnelResult } from "../models/models_8";
 ...
 * @public
 */
export class ReplaceVpnTunnelCommand extends command<ReplaceVpnTunnelCommandInput, ReplaceVpnTunnelCommandOutput>(
  _ep0,
  _mw0,
  "ReplaceVpnTunnel",
  ReplaceVpnTunnel$
