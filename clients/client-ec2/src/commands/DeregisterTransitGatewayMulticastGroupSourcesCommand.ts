 ...
 * ```
 *
 * @param DeregisterTransitGatewayMulticastGroupSourcesRequest - {@link DeregisterTransitGatewayMulticastGroupSourcesRequest}
 * @returns {@link DeregisterTransitGatewayMulticastGroupSourcesResult}
