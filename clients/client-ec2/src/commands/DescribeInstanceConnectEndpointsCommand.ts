 ...
 * @public
 */
export class DescribeInstanceConnectEndpointsCommand extends command<DescribeInstanceConnectEndpointsCommandInput, DescribeInstanceConnectEndpointsCommandOutput>(
  _ep0,
  _mw0,
