 ...
 * @public
 */
export class DescribeInstanceCreditSpecificationsCommand extends command<DescribeInstanceCreditSpecificationsCommandInput, DescribeInstanceCreditSpecificationsCommandOutput>(
  _ep0,
  _mw0,
