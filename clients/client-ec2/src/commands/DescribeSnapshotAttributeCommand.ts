...
import type { DescribeSnapshotAttributeRequest, DescribeSnapshotAttributeResult } from "../models/models_4";
 ...
 * @public
 */
export class DescribeSnapshotAttributeCommand extends command<DescribeSnapshotAttributeCommandInput, DescribeSnapshotAttributeCommandOutput>(
  _ep0,
  _mw0,
