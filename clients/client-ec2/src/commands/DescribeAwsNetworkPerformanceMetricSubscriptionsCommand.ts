 ...
 * @public
 */
export class DescribeAwsNetworkPerformanceMetricSubscriptionsCommand extends command<DescribeAwsNetworkPerformanceMetricSubscriptionsCommandInput, DescribeAwsNetworkPerformanceMetricSubscriptionsCommandOutput>(
  _ep0,
  _mw0,
