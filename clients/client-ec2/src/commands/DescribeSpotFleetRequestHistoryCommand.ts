 ...
 * @public
 */
export class DescribeSpotFleetRequestHistoryCommand extends command<DescribeSpotFleetRequestHistoryCommandInput, DescribeSpotFleetRequestHistoryCommandOutput>(
  _ep0,
  _mw0,
