 ...
 * @public
 */
export class CancelDeclarativePoliciesReportCommand extends command<CancelDeclarativePoliciesReportCommandInput, CancelDeclarativePoliciesReportCommandOutput>(
  _ep0,
  _mw0,
