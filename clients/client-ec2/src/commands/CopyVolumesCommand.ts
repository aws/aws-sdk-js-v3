...
import type { CopyVolumesRequest, CopyVolumesResult } from "../models/models_0";
 ...
 * @public
 */
export class CopyVolumesCommand extends command<CopyVolumesCommandInput, CopyVolumesCommandOutput>(
  _ep0,
  _mw0,
  "CopyVolumes",
  CopyVolumes$
