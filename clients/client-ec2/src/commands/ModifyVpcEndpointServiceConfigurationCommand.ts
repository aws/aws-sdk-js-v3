 ...
 * ```
 *
 * @param ModifyVpcEndpointServiceConfigurationRequest - {@link ModifyVpcEndpointServiceConfigurationRequest}
 * @returns {@link ModifyVpcEndpointServiceConfigurationResult}
