 ...
 * @public
 */
export class DetachVerifiedAccessTrustProviderCommand extends command<DetachVerifiedAccessTrustProviderCommandInput, DetachVerifiedAccessTrustProviderCommandOutput>(
  _ep0,
  _mw0,
