 ...
 * @public
 */
export class DisassociateNatGatewayAddressCommand extends command<DisassociateNatGatewayAddressCommandInput, DisassociateNatGatewayAddressCommandOutput>(
  _ep0,
  _mw0,
