 ...
 * @public
 */
export class DeleteIpamPrefixListResolverTargetCommand extends command<DeleteIpamPrefixListResolverTargetCommandInput, DeleteIpamPrefixListResolverTargetCommandOutput>(
  _ep0,
  _mw0,
