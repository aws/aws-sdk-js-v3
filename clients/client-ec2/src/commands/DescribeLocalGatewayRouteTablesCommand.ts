 ...
 * @public
 */
export class DescribeLocalGatewayRouteTablesCommand extends command<DescribeLocalGatewayRouteTablesCommandInput, DescribeLocalGatewayRouteTablesCommandOutput>(
  _ep0,
  _mw0,
