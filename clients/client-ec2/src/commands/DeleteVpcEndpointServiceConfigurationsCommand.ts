 ...
 * @public
 */
export class DeleteVpcEndpointServiceConfigurationsCommand extends command<DeleteVpcEndpointServiceConfigurationsCommandInput, DeleteVpcEndpointServiceConfigurationsCommandOutput>(
  _ep0,
  _mw0,
