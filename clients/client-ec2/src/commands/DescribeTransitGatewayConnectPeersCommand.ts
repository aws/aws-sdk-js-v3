 ...
 * @public
 */
export class DescribeTransitGatewayConnectPeersCommand extends command<DescribeTransitGatewayConnectPeersCommandInput, DescribeTransitGatewayConnectPeersCommandOutput>(
  _ep0,
  _mw0,
