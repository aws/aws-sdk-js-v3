 ...
 * @public
 */
export class CreateCapacityReservationBySplittingCommand extends command<CreateCapacityReservationBySplittingCommandInput, CreateCapacityReservationBySplittingCommandOutput>(
  _ep0,
  _mw0,
