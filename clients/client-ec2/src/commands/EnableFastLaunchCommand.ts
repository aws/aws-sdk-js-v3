...
import type { EnableFastLaunchRequest } from "../models/models_5";
import type { EnableFastLaunchResult } from "../models/models_6";
 ...
 * @public
 */
export class EnableFastLaunchCommand extends command<EnableFastLaunchCommandInput, EnableFastLaunchCommandOutput>(
  _ep0,
  _mw0,
  "EnableFastLaunch",
  EnableFastLaunch$
