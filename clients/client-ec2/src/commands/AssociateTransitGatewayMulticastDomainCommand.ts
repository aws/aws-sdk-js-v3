 ...
 * @public
 */
export class AssociateTransitGatewayMulticastDomainCommand extends command<AssociateTransitGatewayMulticastDomainCommandInput, AssociateTransitGatewayMulticastDomainCommandOutput>(
  _ep0,
  _mw0,
