...
import type { GetSecurityGroupsForVpcRequest, GetSecurityGroupsForVpcResult } from "../models/models_6";
 ...
 * @public
 */
export class GetSecurityGroupsForVpcCommand extends command<GetSecurityGroupsForVpcCommandInput, GetSecurityGroupsForVpcCommandOutput>(
  _ep0,
  _mw0,
