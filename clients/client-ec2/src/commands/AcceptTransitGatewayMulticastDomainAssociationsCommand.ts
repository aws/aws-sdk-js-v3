 ...
 * ```
 *
 * @param AcceptTransitGatewayMulticastDomainAssociationsRequest - {@link AcceptTransitGatewayMulticastDomainAssociationsRequest}
 * @returns {@link AcceptTransitGatewayMulticastDomainAssociationsResult}
