 ...
 * @public
 */
export class DescribeCapacityReservationTopologyCommand extends command<DescribeCapacityReservationTopologyCommandInput, DescribeCapacityReservationTopologyCommandOutput>(
  _ep0,
  _mw0,
