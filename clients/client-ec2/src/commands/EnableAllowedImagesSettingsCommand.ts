...
import type { EnableAllowedImagesSettingsRequest, EnableAllowedImagesSettingsResult } from "../models/models_6";
 ...
 * @public
 */
export class EnableAllowedImagesSettingsCommand extends command<EnableAllowedImagesSettingsCommandInput, EnableAllowedImagesSettingsCommandOutput>(
  _ep0,
  _mw0,
