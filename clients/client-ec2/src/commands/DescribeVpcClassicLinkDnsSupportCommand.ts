 ...
 * @public
 */
export class DescribeVpcClassicLinkDnsSupportCommand extends command<DescribeVpcClassicLinkDnsSupportCommandInput, DescribeVpcClassicLinkDnsSupportCommandOutput>(
  _ep0,
  _mw0,
