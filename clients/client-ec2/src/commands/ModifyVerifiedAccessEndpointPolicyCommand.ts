 ...
 * @public
 */
export class ModifyVerifiedAccessEndpointPolicyCommand extends command<ModifyVerifiedAccessEndpointPolicyCommandInput, ModifyVerifiedAccessEndpointPolicyCommandOutput>(
  _ep0,
  _mw0,
