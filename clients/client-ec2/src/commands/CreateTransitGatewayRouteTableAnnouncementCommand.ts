 ...
 * ```
 *
 * @param CreateTransitGatewayRouteTableAnnouncementRequest - {@link CreateTransitGatewayRouteTableAnnouncementRequest}
 * @returns {@link CreateTransitGatewayRouteTableAnnouncementResult}
