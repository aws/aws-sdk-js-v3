 ...
 * @public
 */
export class CreateTransitGatewayRouteTableAnnouncementCommand extends command<CreateTransitGatewayRouteTableAnnouncementCommandInput, CreateTransitGatewayRouteTableAnnouncementCommandOutput>(
  _ep0,
  _mw0,
