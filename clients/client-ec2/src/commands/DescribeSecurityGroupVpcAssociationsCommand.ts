 ...
 * @public
 */
export class DescribeSecurityGroupVpcAssociationsCommand extends command<DescribeSecurityGroupVpcAssociationsCommandInput, DescribeSecurityGroupVpcAssociationsCommandOutput>(
  _ep0,
  _mw0,
