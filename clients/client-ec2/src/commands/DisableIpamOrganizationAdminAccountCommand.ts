 ...
 * ```
 *
 * @param DisableIpamOrganizationAdminAccountRequest - {@link DisableIpamOrganizationAdminAccountRequest}
 * @returns {@link DisableIpamOrganizationAdminAccountResult}
