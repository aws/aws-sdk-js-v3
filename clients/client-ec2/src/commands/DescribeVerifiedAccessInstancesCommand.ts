 ...
 * @public
 */
export class DescribeVerifiedAccessInstancesCommand extends command<DescribeVerifiedAccessInstancesCommandInput, DescribeVerifiedAccessInstancesCommandOutput>(
  _ep0,
  _mw0,
