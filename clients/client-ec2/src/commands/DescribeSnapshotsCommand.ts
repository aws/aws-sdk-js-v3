...
import type { DescribeSnapshotsRequest, DescribeSnapshotsResult } from "../models/models_5";
 ...
 * @public
 */
export class DescribeSnapshotsCommand extends command<DescribeSnapshotsCommandInput, DescribeSnapshotsCommandOutput>(
  _ep0,
  _mw0,
  "DescribeSnapshots",
  DescribeSnapshots$
