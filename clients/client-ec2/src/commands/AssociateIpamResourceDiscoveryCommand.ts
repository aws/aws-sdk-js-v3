 ...
 * @public
 */
export class AssociateIpamResourceDiscoveryCommand extends command<AssociateIpamResourceDiscoveryCommandInput, AssociateIpamResourceDiscoveryCommandOutput>(
  _ep0,
  _mw0,
