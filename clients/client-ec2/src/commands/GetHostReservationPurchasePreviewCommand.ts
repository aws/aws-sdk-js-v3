 ...
 * @public
 */
export class GetHostReservationPurchasePreviewCommand extends command<GetHostReservationPurchasePreviewCommandInput, GetHostReservationPurchasePreviewCommandOutput>(
  _ep0,
  _mw0,
