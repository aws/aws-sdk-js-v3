 ...
 * @public
 */
export class GetVpcResourcesBlockingEncryptionEnforcementCommand extends command<GetVpcResourcesBlockingEncryptionEnforcementCommandInput, GetVpcResourcesBlockingEncryptionEnforcementCommandOutput>(
  _ep0,
  _mw0,
