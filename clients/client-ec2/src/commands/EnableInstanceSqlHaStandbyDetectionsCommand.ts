 ...
 * @public
 */
export class EnableInstanceSqlHaStandbyDetectionsCommand extends command<EnableInstanceSqlHaStandbyDetectionsCommandInput, EnableInstanceSqlHaStandbyDetectionsCommandOutput>(
  _ep0,
  _mw0,
