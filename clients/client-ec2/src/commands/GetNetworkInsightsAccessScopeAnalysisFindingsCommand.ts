 ...
 * @public
 */
export class GetNetworkInsightsAccessScopeAnalysisFindingsCommand extends command<GetNetworkInsightsAccessScopeAnalysisFindingsCommandInput, GetNetworkInsightsAccessScopeAnalysisFindingsCommandOutput>(
  _ep0,
  _mw0,
