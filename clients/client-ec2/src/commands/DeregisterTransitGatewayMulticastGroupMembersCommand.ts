 ...
 * @public
 */
export class DeregisterTransitGatewayMulticastGroupMembersCommand extends command<DeregisterTransitGatewayMulticastGroupMembersCommandInput, DeregisterTransitGatewayMulticastGroupMembersCommandOutput>(
  _ep0,
  _mw0,
