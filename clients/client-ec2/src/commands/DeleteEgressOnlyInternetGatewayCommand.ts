 ...
 * @public
 */
export class DeleteEgressOnlyInternetGatewayCommand extends command<DeleteEgressOnlyInternetGatewayCommandInput, DeleteEgressOnlyInternetGatewayCommandOutput>(
  _ep0,
  _mw0,
