...
import type { ReplaceRouteTableAssociationRequest, ReplaceRouteTableAssociationResult } from "../models/models_8";
 ...
 * @public
 */
export class ReplaceRouteTableAssociationCommand extends command<ReplaceRouteTableAssociationCommandInput, ReplaceRouteTableAssociationCommandOutput>(
  _ep0,
  _mw0,
