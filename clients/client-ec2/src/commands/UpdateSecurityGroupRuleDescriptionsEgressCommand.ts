 ...
 * ```
 *
 * @param UpdateSecurityGroupRuleDescriptionsEgressRequest - {@link UpdateSecurityGroupRuleDescriptionsEgressRequest}
 * @returns {@link UpdateSecurityGroupRuleDescriptionsEgressResult}
