...
import { CreateVerifiedAccessInstance$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CreateVerifiedAccessInstanceCommand extends command<CreateVerifiedAccessInstanceCommandInput, CreateVerifiedAccessInstanceCommandOutput>(
  _ep0,
  _mw0,
