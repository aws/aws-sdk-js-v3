 ...
 * @public
 */
export class UpdateInterruptibleCapacityReservationAllocationCommand extends command<UpdateInterruptibleCapacityReservationAllocationCommandInput, UpdateInterruptibleCapacityReservationAllocationCommandOutput>(
  _ep0,
  _mw0,
