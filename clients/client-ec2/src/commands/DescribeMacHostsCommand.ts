...
import type { DescribeMacHostsRequest, DescribeMacHostsResult } from "../models/models_4";
 ...
 * @public
 */
export class DescribeMacHostsCommand extends command<DescribeMacHostsCommandInput, DescribeMacHostsCommandOutput>(
  _ep0,
  _mw0,
  "DescribeMacHosts",
  DescribeMacHosts$
