 ...
 * @public
 */
export class AssociateTransitGatewayPolicyTableCommand extends command<AssociateTransitGatewayPolicyTableCommandInput, AssociateTransitGatewayPolicyTableCommandOutput>(
  _ep0,
  _mw0,
