 ...
 * @public
 */
export class AcceptTransitGatewayPeeringAttachmentCommand extends command<AcceptTransitGatewayPeeringAttachmentCommandInput, AcceptTransitGatewayPeeringAttachmentCommandOutput>(
  _ep0,
  _mw0,
