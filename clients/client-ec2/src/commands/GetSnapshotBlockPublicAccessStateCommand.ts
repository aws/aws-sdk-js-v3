 ...
 * @public
 */
export class GetSnapshotBlockPublicAccessStateCommand extends command<GetSnapshotBlockPublicAccessStateCommandInput, GetSnapshotBlockPublicAccessStateCommandOutput>(
  _ep0,
  _mw0,
