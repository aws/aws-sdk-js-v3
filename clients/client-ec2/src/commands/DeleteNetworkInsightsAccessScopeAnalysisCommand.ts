 ...
 * @public
 */
export class DeleteNetworkInsightsAccessScopeAnalysisCommand extends command<DeleteNetworkInsightsAccessScopeAnalysisCommandInput, DeleteNetworkInsightsAccessScopeAnalysisCommandOutput>(
  _ep0,
  _mw0,
