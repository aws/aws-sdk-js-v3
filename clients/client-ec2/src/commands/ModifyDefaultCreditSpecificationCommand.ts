 ...
 * @public
 */
export class ModifyDefaultCreditSpecificationCommand extends command<ModifyDefaultCreditSpecificationCommandInput, ModifyDefaultCreditSpecificationCommandOutput>(
  _ep0,
  _mw0,
