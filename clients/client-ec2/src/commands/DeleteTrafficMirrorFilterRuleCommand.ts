 ...
 * @public
 */
export class DeleteTrafficMirrorFilterRuleCommand extends command<DeleteTrafficMirrorFilterRuleCommandInput, DeleteTrafficMirrorFilterRuleCommandOutput>(
  _ep0,
  _mw0,
