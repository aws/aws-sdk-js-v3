 ...
 * @public
 */
export class UpdateCapacityManagerMonitoredTagKeysCommand extends command<UpdateCapacityManagerMonitoredTagKeysCommandInput, UpdateCapacityManagerMonitoredTagKeysCommandOutput>(
  _ep0,
  _mw0,
