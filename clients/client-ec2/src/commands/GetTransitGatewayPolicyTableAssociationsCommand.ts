 ...
 * ```
 *
 * @param GetTransitGatewayPolicyTableAssociationsRequest - {@link GetTransitGatewayPolicyTableAssociationsRequest}
 * @returns {@link GetTransitGatewayPolicyTableAssociationsResult}
