...
import type { DeleteLocalGatewayRouteTableRequest, DeleteLocalGatewayRouteTableResult } from "../models/models_3";
 ...
 * @public
 */
export class DeleteLocalGatewayRouteTableCommand extends command<DeleteLocalGatewayRouteTableCommandInput, DeleteLocalGatewayRouteTableCommandOutput>(
  _ep0,
  _mw0,
