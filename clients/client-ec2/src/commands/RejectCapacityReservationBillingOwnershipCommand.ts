 ...
 * @public
 */
export class RejectCapacityReservationBillingOwnershipCommand extends command<RejectCapacityReservationBillingOwnershipCommandInput, RejectCapacityReservationBillingOwnershipCommandOutput>(
  _ep0,
  _mw0,
