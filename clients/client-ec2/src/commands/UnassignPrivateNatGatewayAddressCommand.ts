 ...
 * @public
 */
export class UnassignPrivateNatGatewayAddressCommand extends command<UnassignPrivateNatGatewayAddressCommandInput, UnassignPrivateNatGatewayAddressCommandOutput>(
  _ep0,
  _mw0,
