 ...
 * @public
 */
export class DescribeIpamResourceDiscoveriesCommand extends command<DescribeIpamResourceDiscoveriesCommandInput, DescribeIpamResourceDiscoveriesCommandOutput>(
  _ep0,
  _mw0,
