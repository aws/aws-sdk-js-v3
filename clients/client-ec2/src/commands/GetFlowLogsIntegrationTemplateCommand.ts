 ...
 * @public
 */
export class GetFlowLogsIntegrationTemplateCommand extends command<GetFlowLogsIntegrationTemplateCommandInput, GetFlowLogsIntegrationTemplateCommandOutput>(
  _ep0,
  _mw0,
