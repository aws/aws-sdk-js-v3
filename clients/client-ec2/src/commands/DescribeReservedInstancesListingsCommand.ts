 ...
 * @public
 */
export class DescribeReservedInstancesListingsCommand extends command<DescribeReservedInstancesListingsCommandInput, DescribeReservedInstancesListingsCommandOutput>(
  _ep0,
  _mw0,
