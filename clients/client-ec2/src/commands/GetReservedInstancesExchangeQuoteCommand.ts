 ...
 * @public
 */
export class GetReservedInstancesExchangeQuoteCommand extends command<GetReservedInstancesExchangeQuoteCommandInput, GetReservedInstancesExchangeQuoteCommandOutput>(
  _ep0,
  _mw0,
