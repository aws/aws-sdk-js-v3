 ...
 * @public
 */
export class UpdateCapacityManagerOrganizationsAccessCommand extends command<UpdateCapacityManagerOrganizationsAccessCommandInput, UpdateCapacityManagerOrganizationsAccessCommandOutput>(
  _ep0,
  _mw0,
