 ...
 * @public
 */
export class SearchTransitGatewayMulticastGroupsCommand extends command<SearchTransitGatewayMulticastGroupsCommandInput, SearchTransitGatewayMulticastGroupsCommandOutput>(
  _ep0,
  _mw0,
