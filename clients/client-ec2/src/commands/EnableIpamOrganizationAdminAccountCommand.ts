 ...
 * @public
 */
export class EnableIpamOrganizationAdminAccountCommand extends command<EnableIpamOrganizationAdminAccountCommandInput, EnableIpamOrganizationAdminAccountCommandOutput>(
  _ep0,
  _mw0,
