 ...
 * @public
 */
export class CreateInterruptibleCapacityReservationAllocationCommand extends command<CreateInterruptibleCapacityReservationAllocationCommandInput, CreateInterruptibleCapacityReservationAllocationCommandOutput>(
  _ep0,
  _mw0,
