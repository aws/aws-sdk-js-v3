 ...
 * @public
 */
export class CreateLocalGatewayVirtualInterfaceGroupCommand extends command<CreateLocalGatewayVirtualInterfaceGroupCommandInput, CreateLocalGatewayVirtualInterfaceGroupCommandOutput>(
  _ep0,
  _mw0,
