 ...
 * @public
 */
export class GetCapacityManagerMetricDimensionsCommand extends command<GetCapacityManagerMetricDimensionsCommandInput, GetCapacityManagerMetricDimensionsCommandOutput>(
  _ep0,
  _mw0,
