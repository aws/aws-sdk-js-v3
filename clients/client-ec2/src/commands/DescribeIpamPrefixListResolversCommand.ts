...
import type { DescribeIpamPrefixListResolversRequest, DescribeIpamPrefixListResolversResult } from "../models/models_4";
 ...
 * @public
 */
export class DescribeIpamPrefixListResolversCommand extends command<DescribeIpamPrefixListResolversCommandInput, DescribeIpamPrefixListResolversCommandOutput>(
  _ep0,
  _mw0,
