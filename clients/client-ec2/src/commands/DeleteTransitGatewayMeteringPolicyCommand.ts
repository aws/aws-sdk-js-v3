 ...
 * @public
 */
export class DeleteTransitGatewayMeteringPolicyCommand extends command<DeleteTransitGatewayMeteringPolicyCommandInput, DeleteTransitGatewayMeteringPolicyCommandOutput>(
  _ep0,
  _mw0,
