...
import type { DescribeScheduledInstancesRequest } from "../models/models_4";
import type { DescribeScheduledInstancesResult } from "../models/models_5";
 ...
 * @public
 */
export class DescribeScheduledInstancesCommand extends command<DescribeScheduledInstancesCommandInput, DescribeScheduledInstancesCommandOutput>(
  _ep0,
  _mw0,
