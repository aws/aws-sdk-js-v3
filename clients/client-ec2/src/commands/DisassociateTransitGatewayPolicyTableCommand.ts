 ...
 * @public
 */
export class DisassociateTransitGatewayPolicyTableCommand extends command<DisassociateTransitGatewayPolicyTableCommandInput, DisassociateTransitGatewayPolicyTableCommandOutput>(
  _ep0,
  _mw0,
