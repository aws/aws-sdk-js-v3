 ...
 * @public
 */
export class AuthorizeSecurityGroupIngressCommand extends command<AuthorizeSecurityGroupIngressCommandInput, AuthorizeSecurityGroupIngressCommandOutput>(
  _ep0,
  _mw0,
