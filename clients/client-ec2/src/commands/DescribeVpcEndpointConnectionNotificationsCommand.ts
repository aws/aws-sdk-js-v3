 ...
 * ```
 *
 * @param DescribeVpcEndpointConnectionNotificationsRequest - {@link DescribeVpcEndpointConnectionNotificationsRequest}
 * @returns {@link DescribeVpcEndpointConnectionNotificationsResult}
