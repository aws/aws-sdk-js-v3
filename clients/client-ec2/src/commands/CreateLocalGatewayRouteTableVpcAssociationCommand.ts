 ...
 * @public
 */
export class CreateLocalGatewayRouteTableVpcAssociationCommand extends command<CreateLocalGatewayRouteTableVpcAssociationCommandInput, CreateLocalGatewayRouteTableVpcAssociationCommandOutput>(
  _ep0,
  _mw0,
