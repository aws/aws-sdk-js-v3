 ...
 * ```
 *
 * @param CreateLocalGatewayRouteTableVpcAssociationRequest - {@link CreateLocalGatewayRouteTableVpcAssociationRequest}
 * @returns {@link CreateLocalGatewayRouteTableVpcAssociationResult}
