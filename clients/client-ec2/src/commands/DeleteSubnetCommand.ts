...
import type { DeleteSubnetRequest } from "../models/models_3";
 ...
 * @public
 */
export class DeleteSubnetCommand extends command<DeleteSubnetCommandInput, DeleteSubnetCommandOutput>(
  _ep0,
  _mw0,
  "DeleteSubnet",
  DeleteSubnet$
