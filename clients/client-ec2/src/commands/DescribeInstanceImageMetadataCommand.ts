 ...
 * @public
 */
export class DescribeInstanceImageMetadataCommand extends command<DescribeInstanceImageMetadataCommandInput, DescribeInstanceImageMetadataCommandOutput>(
  _ep0,
  _mw0,
