 ...
 * @public
 */
export class CreateTransitGatewayMeteringPolicyCommand extends command<CreateTransitGatewayMeteringPolicyCommandInput, CreateTransitGatewayMeteringPolicyCommandOutput>(
  _ep0,
  _mw0,
