 ...
 * @public
 */
export class GetImageBlockPublicAccessStateCommand extends command<GetImageBlockPublicAccessStateCommandInput, GetImageBlockPublicAccessStateCommandOutput>(
  _ep0,
  _mw0,
