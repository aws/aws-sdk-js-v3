...
import type { CreateDefaultVpcRequest, CreateDefaultVpcResult } from "../models/models_1";
 ...
 * @public
 */
export class CreateDefaultVpcCommand extends command<CreateDefaultVpcCommandInput, CreateDefaultVpcCommandOutput>(
  _ep0,
  _mw0,
  "CreateDefaultVpc",
  CreateDefaultVpc$
