 ...
 * @public
 */
export class DescribeNetworkInterfacePermissionsCommand extends command<DescribeNetworkInterfacePermissionsCommandInput, DescribeNetworkInterfacePermissionsCommandOutput>(
  _ep0,
  _mw0,
