 ...
 * @public
 */
export class DeleteTransitGatewayConnectPeerCommand extends command<DeleteTransitGatewayConnectPeerCommandInput, DeleteTransitGatewayConnectPeerCommandOutput>(
  _ep0,
  _mw0,
