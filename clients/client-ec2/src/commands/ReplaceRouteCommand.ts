...
import type { ReplaceRouteRequest } from "../models/models_8";
 ...
 * @public
 */
export class ReplaceRouteCommand extends command<ReplaceRouteCommandInput, ReplaceRouteCommandOutput>(
  _ep0,
  _mw0,
  "ReplaceRoute",
  ReplaceRoute$
