 ...
 * ```
 *
 * @param DisableAwsNetworkPerformanceMetricSubscriptionRequest - {@link DisableAwsNetworkPerformanceMetricSubscriptionRequest}
 * @returns {@link DisableAwsNetworkPerformanceMetricSubscriptionResult}
