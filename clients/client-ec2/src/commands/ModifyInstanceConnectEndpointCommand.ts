 ...
 * @public
 */
export class ModifyInstanceConnectEndpointCommand extends command<ModifyInstanceConnectEndpointCommandInput, ModifyInstanceConnectEndpointCommandOutput>(
  _ep0,
  _mw0,
