...
import type { ImportImageRequest, ImportImageResult } from "../models/models_7";
 ...
 * @public
 */
export class ImportImageCommand extends command<ImportImageCommandInput, ImportImageCommandOutput>(
  _ep0,
  _mw0,
  "ImportImage",
  ImportImage$
