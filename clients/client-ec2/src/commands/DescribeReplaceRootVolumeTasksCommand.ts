 ...
 * @public
 */
export class DescribeReplaceRootVolumeTasksCommand extends command<DescribeReplaceRootVolumeTasksCommandInput, DescribeReplaceRootVolumeTasksCommandOutput>(
  _ep0,
  _mw0,
