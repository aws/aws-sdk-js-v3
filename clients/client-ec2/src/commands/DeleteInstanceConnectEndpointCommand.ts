 ...
 * @public
 */
export class DeleteInstanceConnectEndpointCommand extends command<DeleteInstanceConnectEndpointCommandInput, DeleteInstanceConnectEndpointCommandOutput>(
  _ep0,
  _mw0,
