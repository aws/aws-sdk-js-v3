 ...
 * @public
 */
export class DescribeDeclarativePoliciesReportsCommand extends command<DescribeDeclarativePoliciesReportsCommandInput, DescribeDeclarativePoliciesReportsCommandOutput>(
  _ep0,
  _mw0,
