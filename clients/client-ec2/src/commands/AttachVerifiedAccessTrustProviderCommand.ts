 ...
 * @public
 */
export class AttachVerifiedAccessTrustProviderCommand extends command<AttachVerifiedAccessTrustProviderCommandInput, AttachVerifiedAccessTrustProviderCommandOutput>(
  _ep0,
  _mw0,
