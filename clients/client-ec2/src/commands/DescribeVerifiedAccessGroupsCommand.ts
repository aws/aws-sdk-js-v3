...
import { DescribeVerifiedAccessGroups$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DescribeVerifiedAccessGroupsCommand extends command<DescribeVerifiedAccessGroupsCommandInput, DescribeVerifiedAccessGroupsCommandOutput>(
  _ep0,
  _mw0,
