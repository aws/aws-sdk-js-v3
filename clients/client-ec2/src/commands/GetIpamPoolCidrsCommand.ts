...
import type { GetIpamPoolCidrsRequest, GetIpamPoolCidrsResult } from "../models/models_6";
 ...
 * @public
 */
export class GetIpamPoolCidrsCommand extends command<GetIpamPoolCidrsCommandInput, GetIpamPoolCidrsCommandOutput>(
  _ep0,
  _mw0,
  "GetIpamPoolCidrs",
  GetIpamPoolCidrs$
