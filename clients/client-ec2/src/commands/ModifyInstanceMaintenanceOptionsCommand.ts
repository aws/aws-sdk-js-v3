 ...
 * @public
 */
export class ModifyInstanceMaintenanceOptionsCommand extends command<ModifyInstanceMaintenanceOptionsCommandInput, ModifyInstanceMaintenanceOptionsCommandOutput>(
  _ep0,
  _mw0,
