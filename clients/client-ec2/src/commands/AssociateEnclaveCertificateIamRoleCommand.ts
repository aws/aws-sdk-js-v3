 ...
 * @public
 */
export class AssociateEnclaveCertificateIamRoleCommand extends command<AssociateEnclaveCertificateIamRoleCommandInput, AssociateEnclaveCertificateIamRoleCommandOutput>(
  _ep0,
  _mw0,
