 ...
 * @public
 */
export class GetIpamPrefixListResolverVersionEntriesCommand extends command<GetIpamPrefixListResolverVersionEntriesCommandInput, GetIpamPrefixListResolverVersionEntriesCommandOutput>(
  _ep0,
  _mw0,
