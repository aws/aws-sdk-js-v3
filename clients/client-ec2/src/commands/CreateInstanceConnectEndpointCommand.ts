 ...
 * @public
 */
export class CreateInstanceConnectEndpointCommand extends command<CreateInstanceConnectEndpointCommandInput, CreateInstanceConnectEndpointCommandOutput>(
  _ep0,
  _mw0,
