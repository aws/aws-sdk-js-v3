 ...
 * ```
 *
 * @param EnableTransitGatewayRouteTablePropagationRequest - {@link EnableTransitGatewayRouteTablePropagationRequest}
 * @returns {@link EnableTransitGatewayRouteTablePropagationResult}
