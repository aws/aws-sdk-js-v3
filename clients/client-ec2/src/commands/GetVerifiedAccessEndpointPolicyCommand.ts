 ...
 * @public
 */
export class GetVerifiedAccessEndpointPolicyCommand extends command<GetVerifiedAccessEndpointPolicyCommandInput, GetVerifiedAccessEndpointPolicyCommandOutput>(
  _ep0,
  _mw0,
