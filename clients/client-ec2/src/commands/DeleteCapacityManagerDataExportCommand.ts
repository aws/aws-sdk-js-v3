 ...
 * @public
 */
export class DeleteCapacityManagerDataExportCommand extends command<DeleteCapacityManagerDataExportCommandInput, DeleteCapacityManagerDataExportCommandOutput>(
  _ep0,
  _mw0,
