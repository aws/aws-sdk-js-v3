 ...
 * @public
 */
export class MoveCapacityReservationInstancesCommand extends command<MoveCapacityReservationInstancesCommandInput, MoveCapacityReservationInstancesCommandOutput>(
  _ep0,
  _mw0,
