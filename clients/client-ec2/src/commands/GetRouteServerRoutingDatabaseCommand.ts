 ...
 * @public
 */
export class GetRouteServerRoutingDatabaseCommand extends command<GetRouteServerRoutingDatabaseCommandInput, GetRouteServerRoutingDatabaseCommandOutput>(
  _ep0,
  _mw0,
