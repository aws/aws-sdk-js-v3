 ...
 * @public
 */
export class GetTransitGatewayPrefixListReferencesCommand extends command<GetTransitGatewayPrefixListReferencesCommandInput, GetTransitGatewayPrefixListReferencesCommandOutput>(
  _ep0,
  _mw0,
