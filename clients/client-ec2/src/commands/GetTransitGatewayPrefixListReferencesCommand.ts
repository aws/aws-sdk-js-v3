 ...
 * ```
 *
 * @param GetTransitGatewayPrefixListReferencesRequest - {@link GetTransitGatewayPrefixListReferencesRequest}
 * @returns {@link GetTransitGatewayPrefixListReferencesResult}
