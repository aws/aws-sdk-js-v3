...
import type { CreateClientVpnEndpointRequest } from "../models/models_0";
import type { CreateClientVpnEndpointResult } from "../models/models_1";
 ...
 * @public
 */
export class CreateClientVpnEndpointCommand extends command<CreateClientVpnEndpointCommandInput, CreateClientVpnEndpointCommandOutput>(
  _ep0,
  _mw0,
