 ...
 * @public
 */
export class RejectTransitGatewayPeeringAttachmentCommand extends command<RejectTransitGatewayPeeringAttachmentCommandInput, RejectTransitGatewayPeeringAttachmentCommandOutput>(
  _ep0,
  _mw0,
