...
import { DisassociateRouteServer$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DisassociateRouteServerCommand extends command<DisassociateRouteServerCommandInput, DisassociateRouteServerCommandOutput>(
  _ep0,
  _mw0,
