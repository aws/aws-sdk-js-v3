 ...
 * ```
 *
 * @param DescribeTransitGatewayMulticastDomainsRequest - {@link DescribeTransitGatewayMulticastDomainsRequest}
 * @returns {@link DescribeTransitGatewayMulticastDomainsResult}
