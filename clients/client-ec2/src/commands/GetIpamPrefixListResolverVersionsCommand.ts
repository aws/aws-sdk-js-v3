...
import { GetIpamPrefixListResolverVersionsRequest, GetIpamPrefixListResolverVersionsResult } from "../models/models_7";
import {
  de_GetIpamPrefixListResolverVersionsCommand,
  se_GetIpamPrefixListResolverVersionsCommand,
