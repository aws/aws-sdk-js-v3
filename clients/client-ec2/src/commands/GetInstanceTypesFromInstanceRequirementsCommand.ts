 ...
 * ```
 *
 * @param GetInstanceTypesFromInstanceRequirementsRequest - {@link GetInstanceTypesFromInstanceRequirementsRequest}
 * @returns {@link GetInstanceTypesFromInstanceRequirementsResult}
