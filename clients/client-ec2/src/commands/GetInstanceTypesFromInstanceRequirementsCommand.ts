 ...
 * @public
 */
export class GetInstanceTypesFromInstanceRequirementsCommand extends command<GetInstanceTypesFromInstanceRequirementsCommandInput, GetInstanceTypesFromInstanceRequirementsCommandOutput>(
  _ep0,
  _mw0,
