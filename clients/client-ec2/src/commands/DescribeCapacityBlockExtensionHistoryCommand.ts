 ...
 * @public
 */
export class DescribeCapacityBlockExtensionHistoryCommand extends command<DescribeCapacityBlockExtensionHistoryCommandInput, DescribeCapacityBlockExtensionHistoryCommandOutput>(
  _ep0,
  _mw0,
