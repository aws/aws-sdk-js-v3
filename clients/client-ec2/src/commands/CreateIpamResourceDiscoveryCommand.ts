...
import { CreateIpamResourceDiscovery$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CreateIpamResourceDiscoveryCommand extends command<CreateIpamResourceDiscoveryCommandInput, CreateIpamResourceDiscoveryCommandOutput>(
  _ep0,
  _mw0,
