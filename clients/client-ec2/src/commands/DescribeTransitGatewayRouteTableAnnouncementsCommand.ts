 ...
 * @public
 */
export class DescribeTransitGatewayRouteTableAnnouncementsCommand extends command<DescribeTransitGatewayRouteTableAnnouncementsCommandInput, DescribeTransitGatewayRouteTableAnnouncementsCommandOutput>(
  _ep0,
  _mw0,
