 ...
 *             </li>
 *          </ul>
 *          <p>For a future-dated Capacity Reservation that has not yet been delivered, pushing out the
 * 			start date requires a quote generated by
 * 			<code>CreateCapacityReservationDateChangeQuote</code>. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/capacity-reservations-modify.html">Modify an active
 * 				Capacity Reservation</a> in the <i>Amazon EC2 User Guide</i>.</p>
 * @example
 ...
 *   AcceptModificationTerms: true || false,
