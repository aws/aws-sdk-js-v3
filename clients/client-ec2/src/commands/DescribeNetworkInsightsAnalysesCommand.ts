 ...
 * @public
 */
export class DescribeNetworkInsightsAnalysesCommand extends command<DescribeNetworkInsightsAnalysesCommandInput, DescribeNetworkInsightsAnalysesCommandOutput>(
  _ep0,
  _mw0,
