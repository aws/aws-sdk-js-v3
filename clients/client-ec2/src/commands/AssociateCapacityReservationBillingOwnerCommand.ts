 ...
 * @public
 */
export class AssociateCapacityReservationBillingOwnerCommand extends command<AssociateCapacityReservationBillingOwnerCommandInput, AssociateCapacityReservationBillingOwnerCommandOutput>(
  _ep0,
  _mw0,
