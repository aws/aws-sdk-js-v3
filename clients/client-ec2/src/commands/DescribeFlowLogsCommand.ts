...
import type { DescribeFlowLogsRequest } from "../models/models_3";
import type { DescribeFlowLogsResult } from "../models/models_4";
 ...
 * @public
 */
export class DescribeFlowLogsCommand extends command<DescribeFlowLogsCommandInput, DescribeFlowLogsCommandOutput>(
  _ep0,
  _mw0,
  "DescribeFlowLogs",
  DescribeFlowLogs$
