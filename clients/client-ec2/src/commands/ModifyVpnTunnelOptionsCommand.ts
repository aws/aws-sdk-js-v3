...
import { ModifyVpnTunnelOptions$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ModifyVpnTunnelOptionsCommand extends command<ModifyVpnTunnelOptionsCommandInput, ModifyVpnTunnelOptionsCommandOutput>(
  _ep0,
  _mw0,
