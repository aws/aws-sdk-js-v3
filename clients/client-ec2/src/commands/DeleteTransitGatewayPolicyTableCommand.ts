 ...
 * @public
 */
export class DeleteTransitGatewayPolicyTableCommand extends command<DeleteTransitGatewayPolicyTableCommandInput, DeleteTransitGatewayPolicyTableCommandOutput>(
  _ep0,
  _mw0,
