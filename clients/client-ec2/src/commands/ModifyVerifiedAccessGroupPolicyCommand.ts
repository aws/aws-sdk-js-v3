 ...
 * @public
 */
export class ModifyVerifiedAccessGroupPolicyCommand extends command<ModifyVerifiedAccessGroupPolicyCommandInput, ModifyVerifiedAccessGroupPolicyCommandOutput>(
  _ep0,
  _mw0,
