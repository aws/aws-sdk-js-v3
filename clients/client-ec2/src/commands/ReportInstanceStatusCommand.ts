...
import type { ReportInstanceStatusRequest } from "../models/models_8";
 ...
 * @public
 */
export class ReportInstanceStatusCommand extends command<ReportInstanceStatusCommandInput, ReportInstanceStatusCommandOutput>(
  _ep0,
  _mw0,
