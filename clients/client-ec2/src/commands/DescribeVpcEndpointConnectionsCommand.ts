 ...
 * @public
 */
export class DescribeVpcEndpointConnectionsCommand extends command<DescribeVpcEndpointConnectionsCommandInput, DescribeVpcEndpointConnectionsCommandOutput>(
  _ep0,
  _mw0,
