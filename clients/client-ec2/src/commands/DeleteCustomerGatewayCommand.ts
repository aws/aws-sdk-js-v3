...
import { DeleteCustomerGateway$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteCustomerGatewayCommand extends command<DeleteCustomerGatewayCommandInput, DeleteCustomerGatewayCommandOutput>(
  _ep0,
  _mw0,
