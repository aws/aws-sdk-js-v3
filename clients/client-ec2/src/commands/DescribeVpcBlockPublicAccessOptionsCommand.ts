 ...
 * @public
 */
export class DescribeVpcBlockPublicAccessOptionsCommand extends command<DescribeVpcBlockPublicAccessOptionsCommandInput, DescribeVpcBlockPublicAccessOptionsCommandOutput>(
  _ep0,
  _mw0,
