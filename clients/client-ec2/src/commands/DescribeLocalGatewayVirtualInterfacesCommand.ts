 ...
 * ```
 *
 * @param DescribeLocalGatewayVirtualInterfacesRequest - {@link DescribeLocalGatewayVirtualInterfacesRequest}
 * @returns {@link DescribeLocalGatewayVirtualInterfacesResult}
