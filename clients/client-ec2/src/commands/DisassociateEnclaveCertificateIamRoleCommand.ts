 ...
 * @public
 */
export class DisassociateEnclaveCertificateIamRoleCommand extends command<DisassociateEnclaveCertificateIamRoleCommandInput, DisassociateEnclaveCertificateIamRoleCommandOutput>(
  _ep0,
  _mw0,
