 ...
 * @public
 */
export class DescribeNetworkInsightsAccessScopeAnalysesCommand extends command<DescribeNetworkInsightsAccessScopeAnalysesCommandInput, DescribeNetworkInsightsAccessScopeAnalysesCommandOutput>(
  _ep0,
  _mw0,
