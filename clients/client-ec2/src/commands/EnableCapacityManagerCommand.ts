...
import type { EnableCapacityManagerRequest, EnableCapacityManagerResult } from "../models/models_6";
 ...
 * @public
 */
export class EnableCapacityManagerCommand extends command<EnableCapacityManagerCommandInput, EnableCapacityManagerCommandOutput>(
  _ep0,
  _mw0,
