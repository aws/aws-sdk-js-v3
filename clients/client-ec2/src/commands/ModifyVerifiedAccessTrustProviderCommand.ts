 ...
 * @public
 */
export class ModifyVerifiedAccessTrustProviderCommand extends command<ModifyVerifiedAccessTrustProviderCommandInput, ModifyVerifiedAccessTrustProviderCommandOutput>(
  _ep0,
  _mw0,
