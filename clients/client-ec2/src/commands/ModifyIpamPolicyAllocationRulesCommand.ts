 ...
 * @public
 */
export class ModifyIpamPolicyAllocationRulesCommand extends command<ModifyIpamPolicyAllocationRulesCommandInput, ModifyIpamPolicyAllocationRulesCommandOutput>(
  _ep0,
  _mw0,
