 ...
 * @public
 */
export class GetCapacityManagerMonitoredTagKeysCommand extends command<GetCapacityManagerMonitoredTagKeysCommandInput, GetCapacityManagerMonitoredTagKeysCommandOutput>(
  _ep0,
  _mw0,
