 ...
 * @public
 */
export class CreateNetworkInsightsAccessScopeCommand extends command<CreateNetworkInsightsAccessScopeCommandInput, CreateNetworkInsightsAccessScopeCommandOutput>(
  _ep0,
  _mw0,
