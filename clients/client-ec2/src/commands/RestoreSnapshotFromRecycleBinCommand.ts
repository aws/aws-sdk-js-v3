...
import type { RestoreSnapshotFromRecycleBinRequest, RestoreSnapshotFromRecycleBinResult } from "../models/models_8";
 ...
 * @public
 */
export class RestoreSnapshotFromRecycleBinCommand extends command<RestoreSnapshotFromRecycleBinCommandInput, RestoreSnapshotFromRecycleBinCommandOutput>(
  _ep0,
  _mw0,
