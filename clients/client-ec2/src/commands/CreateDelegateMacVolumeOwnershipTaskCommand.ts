 ...
 * @public
 */
export class CreateDelegateMacVolumeOwnershipTaskCommand extends command<CreateDelegateMacVolumeOwnershipTaskCommandInput, CreateDelegateMacVolumeOwnershipTaskCommandOutput>(
  _ep0,
  _mw0,
