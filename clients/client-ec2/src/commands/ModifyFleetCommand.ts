...
import type { ModifyFleetRequest, ModifyFleetResult } from "../models/models_7";
import { ModifyFleet$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ModifyFleetCommand extends command<ModifyFleetCommandInput, ModifyFleetCommandOutput>(
  _ep0,
  _mw0,
  "ModifyFleet",
  ModifyFleet$
