 ...
 * @public
 */
export class DescribeCapacityBlockExtensionOfferingsCommand extends command<DescribeCapacityBlockExtensionOfferingsCommandInput, DescribeCapacityBlockExtensionOfferingsCommandOutput>(
  _ep0,
  _mw0,
