 ...
 * @public
 */
export class ModifyVpcPeeringConnectionOptionsCommand extends command<ModifyVpcPeeringConnectionOptionsCommandInput, ModifyVpcPeeringConnectionOptionsCommandOutput>(
  _ep0,
  _mw0,
