 ...
 * @public
 */
export class ModifyInstanceMetadataDefaultsCommand extends command<ModifyInstanceMetadataDefaultsCommandInput, ModifyInstanceMetadataDefaultsCommandOutput>(
  _ep0,
  _mw0,
