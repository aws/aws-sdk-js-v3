 ...
 * @public
 */
export class DeleteVerifiedAccessTrustProviderCommand extends command<DeleteVerifiedAccessTrustProviderCommandInput, DeleteVerifiedAccessTrustProviderCommandOutput>(
  _ep0,
  _mw0,
