 ...
 * @public
 */
export class DescribeTransitGatewayPolicyTablesCommand extends command<DescribeTransitGatewayPolicyTablesCommandInput, DescribeTransitGatewayPolicyTablesCommandOutput>(
  _ep0,
  _mw0,
