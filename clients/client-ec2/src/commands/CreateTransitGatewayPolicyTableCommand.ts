 ...
 * @public
 */
export class CreateTransitGatewayPolicyTableCommand extends command<CreateTransitGatewayPolicyTableCommandInput, CreateTransitGatewayPolicyTableCommandOutput>(
  _ep0,
  _mw0,
