 ...
 * ```
 *
 * @param DescribeTransitGatewayPeeringAttachmentsRequest - {@link DescribeTransitGatewayPeeringAttachmentsRequest}
 * @returns {@link DescribeTransitGatewayPeeringAttachmentsResult}
