 ...
 * @public
 */
export class DisableRouteServerPropagationCommand extends command<DisableRouteServerPropagationCommandInput, DisableRouteServerPropagationCommandOutput>(
  _ep0,
  _mw0,
