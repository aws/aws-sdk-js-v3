 ...
 * @public
 */
export class DescribeClientVpnTargetNetworksCommand extends command<DescribeClientVpnTargetNetworksCommandInput, DescribeClientVpnTargetNetworksCommandOutput>(
  _ep0,
  _mw0,
