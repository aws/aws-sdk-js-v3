 ...
 * @public
 */
export class DescribeVerifiedAccessTrustProvidersCommand extends command<DescribeVerifiedAccessTrustProvidersCommandInput, DescribeVerifiedAccessTrustProvidersCommandOutput>(
  _ep0,
  _mw0,
