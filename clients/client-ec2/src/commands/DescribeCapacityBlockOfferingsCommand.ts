 ...
 * @public
 */
export class DescribeCapacityBlockOfferingsCommand extends command<DescribeCapacityBlockOfferingsCommandInput, DescribeCapacityBlockOfferingsCommandOutput>(
  _ep0,
  _mw0,
