 ...
 * ```
 *
 * @param GetTransitGatewayAttachmentPropagationsRequest - {@link GetTransitGatewayAttachmentPropagationsRequest}
 * @returns {@link GetTransitGatewayAttachmentPropagationsResult}
