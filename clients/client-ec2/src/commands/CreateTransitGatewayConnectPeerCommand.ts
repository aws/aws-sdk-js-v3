 ...
 * @public
 */
export class CreateTransitGatewayConnectPeerCommand extends command<CreateTransitGatewayConnectPeerCommandInput, CreateTransitGatewayConnectPeerCommandOutput>(
  _ep0,
  _mw0,
