 ...
 * @public
 */
export class GetTransitGatewayMeteringPolicyEntriesCommand extends command<GetTransitGatewayMeteringPolicyEntriesCommandInput, GetTransitGatewayMeteringPolicyEntriesCommandOutput>(
  _ep0,
  _mw0,
