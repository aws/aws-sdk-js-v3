...
export declare type AuthorizeClientVpnIngressCommandInput = AuthorizeClientVpnIngressRequest;
export declare type AuthorizeClientVpnIngressCommandOutput = AuthorizeClientVpnIngressResult & __MetadataBearer;
