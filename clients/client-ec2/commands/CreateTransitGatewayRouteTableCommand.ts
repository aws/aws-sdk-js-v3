...
export type CreateTransitGatewayRouteTableCommandOutput = CreateTransitGatewayRouteTableResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_ec2CreateTransitGatewayRouteTableCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_ec2CreateTransitGatewayRouteTableCommand(
      output,
      context
    );
  }
