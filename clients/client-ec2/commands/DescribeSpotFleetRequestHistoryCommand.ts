...
export type DescribeSpotFleetRequestHistoryCommandOutput = DescribeSpotFleetRequestHistoryResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_ec2DescribeSpotFleetRequestHistoryCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_ec2DescribeSpotFleetRequestHistoryCommand(
      output,
      context
    );
  }
