...
export type DescribeSecurityGroupReferencesCommandOutput = DescribeSecurityGroupReferencesResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_ec2DescribeSecurityGroupReferencesCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_ec2DescribeSecurityGroupReferencesCommand(
      output,
      context
    );
  }
