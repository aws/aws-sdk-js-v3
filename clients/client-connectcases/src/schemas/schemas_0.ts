...
export var EmptyOperandValue$: StaticStructureSchema = [3, n0, _EOV,
  0,
  [],
  []
];
...
export var LayoutSections$: StaticStructureSchema = [3, n0, _LS,
  0,
  [_sec],
  [() => SectionsList]
];
...
var AuditEventsList: StaticListSchema = [1, n0, _AEL,
  { [_sp]: 1 }, [() => AuditEvent$,
    0]
];
var BatchGetCaseRuleErrorList: StaticListSchema = [1, n0, _BGCREL,
  0, () => CaseRuleError$
];
var BatchGetCaseRuleList: StaticListSchema = [1, n0, _BGCRL,
  0, [() => GetCaseRuleResponse$,
    0]
];
var BatchGetCaseRuleUnprocessedList = 64 | 0;
var BatchGetFieldErrorList: StaticListSchema = [1, n0, _BGFEL,
  0, () => FieldError$
];
var BatchGetFieldIdentifierList: StaticListSchema = [1, n0, _BGFIL,
  0, () => FieldIdentifier$
];
var BatchGetFieldList: StaticListSchema = [1, n0, _BGFL,
  0, [() => GetFieldResponse$,
    0]
];
var BooleanConditionList: StaticListSchema = [1, n0, _BCL,
  0, () => BooleanCondition$
];
var CaseFilterList: StaticListSchema = [1, n0, _CFL,
  0, () => CaseFilter$
];
var CaseRuleIdentifierList: StaticListSchema = [1, n0, _CRIL,
  0, () => CaseRuleIdentifier$
];
var CaseRuleSummaryList: StaticListSchema = [1, n0, _CRSL,
  0, () => CaseRuleSummary$
];
var CaseSummaryList: StaticListSchema = [1, n0, _CSL,
  0, () => CaseSummary$
];
var ChannelList = 64 | 0;
var CustomFieldsFilterList: StaticListSchema = [1, n0, _CFFL,
  0, () => CustomFieldsFilter$
];
var DomainSummaryList: StaticListSchema = [1, n0, _DSL,
  0, () => DomainSummary$
];
var FieldIdentifierList: StaticListSchema = [1, n0, _FIL,
  0, () => FieldIdentifier$
];
var FieldList: StaticListSchema = [1, n0, _FL,
  0, () => FieldItem$
];
var FieldOptionErrorList: StaticListSchema = [1, n0, _FOEL,
  0, () => FieldOptionError$
];
var FieldOptionsList: StaticListSchema = [1, n0, _FOL,
  0, () => FieldOption$
];
var FieldSummaryList: StaticListSchema = [1, n0, _FSL,
  0, () => FieldSummary$
];
var FieldValueList: StaticListSchema = [1, n0, _FVL,
  0, () => FieldValue$
];
var LayoutSummaryList: StaticListSchema = [1, n0, _LSL,
  0, () => LayoutSummary$
];
var ParentChildFieldOptionsMappingList: StaticListSchema = [1, n0, _PCFOML,
  0, () => ParentChildFieldOptionsMapping$
];
var ParentChildFieldOptionValueList = 64 | 0;
var RelatedItemFilterList: StaticListSchema = [1, n0, _RIFL,
  0, [() => RelatedItemTypeFilter$,
    0]
];
var RequiredFieldList: StaticListSchema = [1, n0, _RFL,
  0, () => RequiredField$
];
var SearchAllRelatedItemsResponseItemList: StaticListSchema = [1, n0, _SARIRIL,
  { [_sp]: 1 }, [() => SearchAllRelatedItemsResponseItem$,
    0]
];
var SearchAllRelatedItemsSortList: StaticListSchema = [1, n0, _SARISL,
  0, () => SearchAllRelatedItemsSort$
];
var SearchCasesResponseItemList: StaticListSchema = [1, n0, _SCRIL,
  { [_sp]: 1 }, [() => SearchCasesResponseItem$,
    0]
];
var SearchRelatedItemsResponseItemList: StaticListSchema = [1, n0, _SRIRIL,
  { [_sp]: 1 }, [() => SearchRelatedItemsResponseItem$,
    0]
];
var SectionsList: StaticListSchema = [1, n0, _SL,
  0, () => Section$
];
...
export var AuditEventFieldValueUnion$: StaticUnionSchema = [4, n0, _AEFVU,
  0,
...
export var CustomFieldsFilter$: StaticUnionSchema = [4, n0, _CFF,
  0,
  [_fie, _no, _aA, _oA],
...
export var FieldValueUnion$: StaticUnionSchema = [4, n0, _FVU,
  0,
  [_sV, _dVo, _bV, _eV, _uAV],
  [0, 1, 2, () => EmptyFieldValue$, 0]
];
export var LayoutContent$: StaticUnionSchema = [4, n0, _LCa,
  0,
  [_ba],
  [() => BasicLayout$]
];
export var OperandOne$: StaticUnionSchema = [4, n0, _OO,
  0,
  [_fI],
  [0]
];
export var OperandTwo$: StaticUnionSchema = [4, n0, _OT,
  0,
  [_sV, _bV, _dVo, _eV],
  [0, 2, 1, () => EmptyOperandValue$]
];
export var RelatedItemContent$: StaticUnionSchema = [4, n0, _RIC,
  0,
  [_conta, _com, _file, _sl, _cC, _cu],
  [() => ContactContent$, () => CommentContent$, () => FileContent$, [() => SlaContent$, 0], () => ConnectCaseContent$, () => CustomContent$]
];
export var RelatedItemInputContent$: StaticUnionSchema = [4, n0, _RIIC,
  0,
  [_conta, _com, _file, _sl, _cC, _cu],
  [() => Contact$, () => CommentContent$, () => FileContent$, [() => SlaInputContent$, 0], () => ConnectCaseInputContent$, () => CustomInputContent$]
];
export var RelatedItemTypeFilter$: StaticUnionSchema = [4, n0, _RITF,
  0,
  [_conta, _com, _file, _sl, _cC, _cu],
...
export var SlaInputContent$: StaticUnionSchema = [4, n0, _SICl,
  0,
  [_sIC],
...
export var BatchGetCaseRule$: StaticOperationSchema = [9, n0, _BGCR,
  { [_ht]: ["POST", "/domains/{domainId}/rules-batch", 200] }, () => BatchGetCaseRuleRequest$, () => BatchGetCaseRuleResponse$
];
export var BatchGetField$: StaticOperationSchema = [9, n0, _BGF,
  { [_ht]: ["POST", "/domains/{domainId}/fields-batch", 200] }, () => BatchGetFieldRequest$, () => BatchGetFieldResponse$
];
export var BatchPutFieldOptions$: StaticOperationSchema = [9, n0, _BPFO,
...
export var CreateCaseRule$: StaticOperationSchema = [9, n0, _CCRre,
...
export var CreateField$: StaticOperationSchema = [9, n0, _CFr,
  { [_ht]: ["POST", "/domains/{domainId}/fields", 200] }, () => CreateFieldRequest$, () => CreateFieldResponse$
];
export var CreateLayout$: StaticOperationSchema = [9, n0, _CL,
  { [_ht]: ["POST", "/domains/{domainId}/layouts", 200] }, () => CreateLayoutRequest$, () => CreateLayoutResponse$
];
export var CreateRelatedItem$: StaticOperationSchema = [9, n0, _CRIr,
...
export var DeleteCase$: StaticOperationSchema = [9, n0, _DC,
  { [_ht]: ["DELETE", "/domains/{domainId}/cases/{caseId}", 200] }, () => DeleteCaseRequest$, () => DeleteCaseResponse$
];
export var DeleteCaseRule$: StaticOperationSchema = [9, n0, _DCRel,
...
export var GetCaseAuditEvents$: StaticOperationSchema = [9, n0, _GCAE,
  { [_ht]: ["POST", "/domains/{domainId}/cases/{caseId}/audit-history", 200] }, () => GetCaseAuditEventsRequest$, () => GetCaseAuditEventsResponse$
];
export var GetCaseEventConfiguration$: StaticOperationSchema = [9, n0, _GCEC,
...
export var GetLayout$: StaticOperationSchema = [9, n0, _GL,
...
export var ListCaseRules$: StaticOperationSchema = [9, n0, _LCR,
  { [_ht]: ["POST", "/domains/{domainId}/rules-list/", 200] }, () => ListCaseRulesRequest$, () => ListCaseRulesResponse$
];
export var ListCasesForContact$: StaticOperationSchema = [9, n0, _LCFC,
...
export var UpdateCaseRule$: StaticOperationSchema = [9, n0, _UCRpd,
  { [_ht]: ["PUT", "/domains/{domainId}/case-rules/{caseRuleId}", 200] }, () => UpdateCaseRuleRequest$, () => UpdateCaseRuleResponse$
];
export var UpdateField$: StaticOperationSchema = [9, n0, _UF,
