...
export type DeleteAppLaunchConfigurationCommandOutput = DeleteAppLaunchConfigurationResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1DeleteAppLaunchConfigurationCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1DeleteAppLaunchConfigurationCommand(
      output,
      context
    );
  }
