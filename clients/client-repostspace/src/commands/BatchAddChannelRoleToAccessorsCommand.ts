 ...
 * @public
 */
export class BatchAddChannelRoleToAccessorsCommand extends command<BatchAddChannelRoleToAccessorsCommandInput, BatchAddChannelRoleToAccessorsCommandOutput>(
  _ep0,
  _mw0,
