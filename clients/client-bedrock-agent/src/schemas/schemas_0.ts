...
export var AgentAliasRoutingConfigurationListItem$: StaticStructureSchema = [3, n0, _AARCLI,
  0,
  [_aV, _pT],
  [0, 0]
];
...
export var BedrockDataAutomationConfiguration$: StaticStructureSchema = [3, n0, _BDAC,
  0,
  [_pM],
  [0]
];
...
export var KnowledgeBasePromptTemplate$: StaticStructureSchema = [3, n0, _KBPT,
  0,
  [_tPT],
...
export var QueryGenerationConfiguration$: StaticStructureSchema = [3, n0, _QGCu,
  0,
  [_eTS, _gCe],
  [1, [() => QueryGenerationContext$, 0]]
];
export var QueryGenerationContext$: StaticStructureSchema = [3, n0, _QGCue,
  8,
  [_tab, _cQ],
...
export var SalesforceCrawlerConfiguration$: StaticStructureSchema = [3, n0, _SCC,
  0,
  [_fC],
  [[() => CrawlFilterConfiguration$, 0]]
];
...
export var SharePointCrawlerConfiguration$: StaticStructureSchema = [3, n0, _SPCC,
  0,
  [_fC],
  [[() => CrawlFilterConfiguration$, 0]]
];
...
export var WebCrawlerLimits$: StaticStructureSchema = [3, n0, _WCL,
  0,
  [_rL, _mP],
  [1, 1]
];
...
var AgentAliasHistoryEvents: StaticListSchema = [1, n0, _AAHEg,
  0, () => AgentAliasHistoryEvent$
];
var AgentAliasRoutingConfiguration: StaticListSchema = [1, n0, _AARC,
  0, () => AgentAliasRoutingConfigurationListItem$
];
var AgentAliasSummaries: StaticListSchema = [1, n0, _AASg,
  0, () => AgentAliasSummary$
];
var AgentCollaboratorSummaries: StaticListSchema = [1, n0, _ACSg,
  0, [() => AgentCollaboratorSummary$,
    0]
];
var AgentKnowledgeBaseSummaries: StaticListSchema = [1, n0, _AKBSg,
  0, () => AgentKnowledgeBaseSummary$
];
var AgentSummaries: StaticListSchema = [1, n0, _ASg,
  0, () => AgentSummary$
];
var AgentVersionSummaries: StaticListSchema = [1, n0, _AVSg,
  0, () => AgentVersionSummary$
];
var AudioConfigurations: StaticListSchema = [1, n0, _ACud,
...
var CuratedQueries: StaticListSchema = [1, n0, _CQu,
  0, () => CuratedQuery$
];
...
var FlowAliasRoutingConfiguration: StaticListSchema = [1, n0, _FARC,
  0, () => FlowAliasRoutingConfigurationListItem$
];
var FlowAliasSummaries: StaticListSchema = [1, n0, _FASl,
  0, () => FlowAliasSummary$
];
var FlowConditions: StaticListSchema = [1, n0, _FClo,
  0, [() => FlowCondition$,
    0]
];
var FlowConnections: StaticListSchema = [1, n0, _FClow,
  0, () => FlowConnection$
];
var FlowNodeInputs: StaticListSchema = [1, n0, _FNIl,
  0, [() => FlowNodeInput$,
    0]
];
var FlowNodeOutputs: StaticListSchema = [1, n0, _FNOl,
  0, () => FlowNodeOutput$
];
var FlowNodes: StaticListSchema = [1, n0, _FNl,
  0, [() => FlowNode$,
    0]
];
var FlowSummaries: StaticListSchema = [1, n0, _FSl,
  0, () => FlowSummary$
];
var FlowValidations: StaticListSchema = [1, n0, _FVl,
  0, [() => FlowValidation$,
    0]
];
var FlowVersionSummaries: StaticListSchema = [1, n0, _FVSl,
  0, () => FlowVersionSummary$
];
var Functions: StaticListSchema = [1, n0, _Fu,
  0, () => Function$
];
var HierarchicalChunkingLevelConfigurations: StaticListSchema = [1, n0, _HCLCi,
  0, () => HierarchicalChunkingLevelConfiguration$
];
var IngestionJobFilters: StaticListSchema = [1, n0, _IJFn,
  0, () => IngestionJobFilter$
];
var IngestionJobFilterValues = 64 | 0;
var IngestionJobSummaries: StaticListSchema = [1, n0, _IJSng,
  0, () => IngestionJobSummary$
];
var KnowledgeBaseDocumentDetails: StaticListSchema = [1, n0, _KBDDn,
  0, () => KnowledgeBaseDocumentDetail$
];
var KnowledgeBaseDocuments: StaticListSchema = [1, n0, _KBDn,
  0, [() => KnowledgeBaseDocument$,
    0]
];
var KnowledgeBaseSummaries: StaticListSchema = [1, n0, _KBSn,
...
var MetadataAttributes: StaticListSchema = [1, n0, _MAe,
  0, [() => MetadataAttribute$,
    0]
];
var PatternObjectFilterList: StaticListSchema = [1, n0, _POFL,
...
var PromptInputVariablesList: StaticListSchema = [1, n0, _PIVL,
  8, () => PromptInputVariable$
];
var PromptMetadataList: StaticListSchema = [1, n0, _PML,
  8, [() => PromptMetadataEntry$,
    0]
];
var PromptSummaries: StaticListSchema = [1, n0, _PSr,
  0, () => PromptSummary$
];
var PromptVariantList: StaticListSchema = [1, n0, _PVL,
  8, [() => PromptVariant$,
    0]
];
var QueryGenerationColumns: StaticListSchema = [1, n0, _QGCuer,
  0, () => QueryGenerationColumn$
];
var QueryGenerationTables: StaticListSchema = [1, n0, _QGTu,
  0, () => QueryGenerationTable$
];
var RecommendedActions = 64 | 0;
var RedshiftQueryEngineStorageConfigurations: StaticListSchema = [1, n0, _RQESCe,
  0, () => RedshiftQueryEngineStorageConfiguration$
];
var S3Prefixes: StaticListSchema = [1, n0, _SPr,
  0, [() => S3Prefix,
    0]
];
var SeedUrls: StaticListSchema = [1, n0, _SUe,
  0, () => SeedUrl$
];
var SharePointSiteUrls = 64 | 0;
var StopSequences = 64 | 0;
var StringListValue: StaticListSchema = [1, n0, _SLV,
  0, [() => StringValue,
    0]
];
...
var Transformations: StaticListSchema = [1, n0, _Tr,
  0, () => Transformation$
];
...
export var PromptFlowNodeSourceConfiguration$: StaticUnionSchema = [4, n0, _PFNSC,
  0,
  [_res, _inl],
  [() => PromptFlowNodeResourceConfiguration$, [() => PromptFlowNodeInlineConfiguration$, 0]]
];
export var PromptGenAiResource$: StaticUnionSchema = [4, n0, _PGAR,
  8,
  [_ag],
  [[() => PromptAgentResource$, 0]]
];
export var PromptInferenceConfiguration$: StaticUnionSchema = [4, n0, _PIC,
  0,
  [_tex],
  [() => PromptModelInferenceConfiguration$]
];
export var PromptTemplateConfiguration$: StaticUnionSchema = [4, n0, _PTC,
  0,
  [_tex, _ch],
...
export var RetrievalFlowNodeServiceConfiguration$: StaticUnionSchema = [4, n0, _RFNSCe,
  0,
  [_s_],
  [() => RetrievalFlowNodeS3Configuration$]
];
export var StorageFlowNodeServiceConfiguration$: StaticUnionSchema = [4, n0, _SFNSCt,
  0,
  [_s_],
...
export var AssociateAgentCollaborator$: StaticOperationSchema = [9, n0, _AAC,
...
export var AssociateAgentKnowledgeBase$: StaticOperationSchema = [9, n0, _AAKB,
...
export var CreateAgent$: StaticOperationSchema = [9, n0, _CA,
  { [_h]: ["PUT", "/agents/", 202] }, () => CreateAgentRequest$, () => CreateAgentResponse$
];
export var CreateAgentActionGroup$: StaticOperationSchema = [9, n0, _CAAG,
...
export var CreateAgentAlias$: StaticOperationSchema = [9, n0, _CAA,
...
export var CreateFlow$: StaticOperationSchema = [9, n0, _CF,
  { [_h]: ["POST", "/flows/", 201] }, () => CreateFlowRequest$, () => CreateFlowResponse$
];
export var CreateFlowAlias$: StaticOperationSchema = [9, n0, _CFA,
  { [_h]: ["POST", "/flows/{flowIdentifier}/aliases", 201] }, () => CreateFlowAliasRequest$, () => CreateFlowAliasResponse$
];
export var CreateFlowVersion$: StaticOperationSchema = [9, n0, _CFV,
...
export var CreatePrompt$: StaticOperationSchema = [9, n0, _CP,
...
export var DeleteAgentActionGroup$: StaticOperationSchema = [9, n0, _DAAG,
...
export var DeleteAgentAlias$: StaticOperationSchema = [9, n0, _DAA,
  { [_h]: ["DELETE", "/agents/{agentId}/agentaliases/{agentAliasId}/", 202] }, () => DeleteAgentAliasRequest$, () => DeleteAgentAliasResponse$
];
export var DeleteAgentVersion$: StaticOperationSchema = [9, n0, _DAV,
...
export var DeleteFlowAlias$: StaticOperationSchema = [9, n0, _DFA,
  { [_h]: ["DELETE", "/flows/{flowIdentifier}/aliases/{aliasIdentifier}", 200] }, () => DeleteFlowAliasRequest$, () => DeleteFlowAliasResponse$
];
export var DeleteFlowVersion$: StaticOperationSchema = [9, n0, _DFV,
...
export var DeleteKnowledgeBaseDocuments$: StaticOperationSchema = [9, n0, _DKBD,
...
export var DisassociateAgentKnowledgeBase$: StaticOperationSchema = [9, n0, _DAKB,
...
export var GetAgent$: StaticOperationSchema = [9, n0, _GAe,
  { [_h]: ["GET", "/agents/{agentId}/", 200] }, () => GetAgentRequest$, () => GetAgentResponse$
];
export var GetAgentActionGroup$: StaticOperationSchema = [9, n0, _GAAG,
...
export var GetAgentAlias$: StaticOperationSchema = [9, n0, _GAA,
  { [_h]: ["GET", "/agents/{agentId}/agentaliases/{agentAliasId}/", 200] }, () => GetAgentAliasRequest$, () => GetAgentAliasResponse$
];
export var GetAgentCollaborator$: StaticOperationSchema = [9, n0, _GAC,
...
export var GetAgentKnowledgeBase$: StaticOperationSchema = [9, n0, _GAKB,
...
export var GetAgentVersion$: StaticOperationSchema = [9, n0, _GAV,
...
export var GetKnowledgeBaseDocuments$: StaticOperationSchema = [9, n0, _GKBD,
...
export var ListAgentActionGroups$: StaticOperationSchema = [9, n0, _LAAG,
...
export var ListAgentAliases$: StaticOperationSchema = [9, n0, _LAA,
  { [_h]: ["POST", "/agents/{agentId}/agentaliases/", 200] }, () => ListAgentAliasesRequest$, () => ListAgentAliasesResponse$
];
export var ListAgentCollaborators$: StaticOperationSchema = [9, n0, _LAC,
...
export var ListAgentKnowledgeBases$: StaticOperationSchema = [9, n0, _LAKB,
...
export var ListAgents$: StaticOperationSchema = [9, n0, _LA,
  { [_h]: ["POST", "/agents/", 200] }, () => ListAgentsRequest$, () => ListAgentsResponse$
];
export var ListAgentVersions$: StaticOperationSchema = [9, n0, _LAV,
...
export var ListFlowAliases$: StaticOperationSchema = [9, n0, _LFA,
...
export var ListFlowVersions$: StaticOperationSchema = [9, n0, _LFV,
  { [_h]: ["GET", "/flows/{flowIdentifier}/versions", 200] }, () => ListFlowVersionsRequest$, () => ListFlowVersionsResponse$
];
export var ListIngestionJobs$: StaticOperationSchema = [9, n0, _LIJ,
...
export var ListKnowledgeBaseDocuments$: StaticOperationSchema = [9, n0, _LKBD,
...
export var StopIngestionJob$: StaticOperationSchema = [9, n0, _SIJt,
...
export var UpdateAgent$: StaticOperationSchema = [9, n0, _UAp,
  { [_h]: ["PUT", "/agents/{agentId}/", 202] }, () => UpdateAgentRequest$, () => UpdateAgentResponse$
];
export var UpdateAgentActionGroup$: StaticOperationSchema = [9, n0, _UAAG,
...
export var UpdateAgentAlias$: StaticOperationSchema = [9, n0, _UAA,
  { [_h]: ["PUT", "/agents/{agentId}/agentaliases/{agentAliasId}/", 202] }, () => UpdateAgentAliasRequest$, () => UpdateAgentAliasResponse$
];
export var UpdateAgentCollaborator$: StaticOperationSchema = [9, n0, _UAC,
...
export var UpdateAgentKnowledgeBase$: StaticOperationSchema = [9, n0, _UAKB,
...
export var UpdateFlowAlias$: StaticOperationSchema = [9, n0, _UFA,
...
export var UpdatePrompt$: StaticOperationSchema = [9, n0, _UP,
  { [_h]: ["PUT", "/prompts/{promptIdentifier}/", 200] }, () => UpdatePromptRequest$, () => UpdatePromptResponse$
];
export var ValidateFlowDefinition$: StaticOperationSchema = [9, n0, _VFD,
