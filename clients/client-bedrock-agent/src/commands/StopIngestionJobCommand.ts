...
import type { StopIngestionJobRequest, StopIngestionJobResponse } from "../models/models_0";
 ...
 * @public
 */
export class StopIngestionJobCommand extends command<StopIngestionJobCommandInput, StopIngestionJobCommandOutput>(
  _ep0,
  _mw0,
  "StopIngestionJob",
  StopIngestionJob$
