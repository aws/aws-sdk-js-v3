...
import type { GetAgentActionGroupRequest, GetAgentActionGroupResponse } from "../models/models_0";
import { GetAgentActionGroup$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetAgentActionGroupCommand extends command<GetAgentActionGroupCommandInput, GetAgentActionGroupCommandOutput>(
  _ep0,
  _mw0,
  "GetAgentActionGroup",
  GetAgentActionGroup$
