...
import type { ListPromptsRequest, ListPromptsResponse } from "../models/models_1";
 ...
 * @public
 */
export class ListPromptsCommand extends command<ListPromptsCommandInput, ListPromptsCommandOutput>(
  _ep0,
  _mw0,
  "ListPrompts",
  ListPrompts$
