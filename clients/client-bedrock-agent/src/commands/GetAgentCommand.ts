...
import type { GetAgentRequest, GetAgentResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetAgentCommand extends command<GetAgentCommandInput, GetAgentCommandOutput>(
  _ep0,
  _mw0,
  "GetAgent",
  GetAgent$
