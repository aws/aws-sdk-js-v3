 ...
 * @public
 */
export class DisassociateAgentCollaboratorCommand extends command<DisassociateAgentCollaboratorCommandInput, DisassociateAgentCollaboratorCommandOutput>(
  _ep0,
  _mw0,
