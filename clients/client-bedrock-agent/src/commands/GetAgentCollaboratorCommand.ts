...
import { GetAgentCollaborator$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetAgentCollaboratorCommand extends command<GetAgentCollaboratorCommandInput, GetAgentCollaboratorCommandOutput>(
  _ep0,
  _mw0,
