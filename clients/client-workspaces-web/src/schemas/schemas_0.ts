...
var CookieName: StaticSimpleSchema = [0, n0, _CN, 8, 0];
var CookiePath: StaticSimpleSchema = [0, n0, _CP, 8, 0];
var Description: StaticSimpleSchema = [0, n0, _D, 8, 0];
var DescriptionSafe: StaticSimpleSchema = [0, n0, _DS, 8, 0];
var DisplayName: StaticSimpleSchema = [0, n0, _DN, 8, 0];
var DisplayNameSafe: StaticSimpleSchema = [0, n0, _DNS, 8, 0];
var IconImage: StaticSimpleSchema = [0, n0, _II, { [_mT]: _i }, 21];
var IdentityProviderName: StaticSimpleSchema = [0, n0, _IPN, 8, 0];
...
var S3Bucket: StaticSimpleSchema = [0, n0, _SB, 8, 0];
var S3KeyPrefix: StaticSimpleSchema = [0, n0, _SKP, 8, 0];
