...
export var CookieName: StaticSimpleSchema = [0, n0, _CN, 8, 0];
export var CookiePath: StaticSimpleSchema = [0, n0, _CP, 8, 0];
...
export var S3Bucket: StaticSimpleSchema = [0, n0, _SB, 8, 0];
...
export var GetBrowserSettingsResponse: StaticStructureSchema = [3, n0, _GBSRe, 0, [_bS], [[() => BrowserSettings, 0]]];
...
export var GetPortalServiceProviderMetadataResponse: StaticStructureSchema = [3, n0, _GPSPMRe, 0, [_pA, _sPSM], [0, 0]];
...
export var IpAccessSettingsList: StaticListSchema = [1, n0, _IASL, 0, [() => IpAccessSettingsSummary, 0]];
export var IpAddressList: StaticListSchema = [1, n0, _IAL, 0, [() => IpAddress, 0]];
export var IpRuleList: StaticListSchema = [1, n0, _IRL, 8, [() => IpRule, 0]];
