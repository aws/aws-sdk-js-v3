 ...
 * @public
 */
export class UpdateUserAccessLoggingSettingsCommand extends command<UpdateUserAccessLoggingSettingsCommandInput, UpdateUserAccessLoggingSettingsCommandOutput>(
  _ep0,
  _mw0,
