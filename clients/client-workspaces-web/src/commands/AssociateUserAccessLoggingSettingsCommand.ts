 ...
 * @public
 */
export class AssociateUserAccessLoggingSettingsCommand extends command<AssociateUserAccessLoggingSettingsCommandInput, AssociateUserAccessLoggingSettingsCommandOutput>(
  _ep0,
  _mw0,
