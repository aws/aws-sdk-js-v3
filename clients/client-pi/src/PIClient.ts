...
import {
  defaultPIHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type PIClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
...
> {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultPIHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: PIClientResolvedConfig) =>
