...
export var Data$: StaticStructureSchema = [3, n0, _D,
  0,
  [_PIM],
...
export var DimensionDetail$: StaticStructureSchema = [3, n0, _DD,
  0,
  [_I],
  [0]
];
...
export var DimensionKeyDescription$: StaticStructureSchema = [3, n0, _DKD,
  0,
  [_Di, _To, _AM, _P],
  [128 | 0, 1, 128 | 1, 64 | 1]
];
export var DimensionKeyDetail$: StaticStructureSchema = [3, n0, _DKDi,
  0,
  [_V, _Dim, _S],
  [0, 0, 0]
];
export var FeatureMetadata$: StaticStructureSchema = [3, n0, _FM,
  0,
  [_S],
  [0]
];
...
var DataList: StaticListSchema = [1, n0, _DL,
  0, () => Data$
];
var DataPointsList: StaticListSchema = [1, n0, _DPL,
  0, () => DataPoint$
];
var DimensionDetailList: StaticListSchema = [1, n0, _DDL,
  0, () => DimensionDetail$
];
var DimensionGroupDetailList: StaticListSchema = [1, n0, _DGDL,
  0, () => DimensionGroupDetail$
];
var DimensionKeyDescriptionList: StaticListSchema = [1, n0, _DKDL,
  0, () => DimensionKeyDescription$
];
var DimensionKeyDetailList: StaticListSchema = [1, n0, _DKDLi,
...
var MetricDimensionsList: StaticListSchema = [1, n0, _MDL,
  0, () => MetricDimensionGroups$
];
var MetricKeyDataPointsList: StaticListSchema = [1, n0, _MKDPL,
...
var ResponsePartitionKeyList: StaticListSchema = [1, n0, _RPKL,
  0, () => ResponsePartitionKey$
];
var ResponseResourceMetricList: StaticListSchema = [1, n0, _RRML,
...
var FeatureMetadataMap: StaticMapSchema = [2, n0, _FMM,
  0, 0, () => FeatureMetadata$
];
var MetricQueryFilterMap = 128 | 0;
export var CreatePerformanceAnalysisReport$: StaticOperationSchema = [9, n0, _CPAR,
  0, () => CreatePerformanceAnalysisReportRequest$, () => CreatePerformanceAnalysisReportResponse$
];
export var DeletePerformanceAnalysisReport$: StaticOperationSchema = [9, n0, _DPAR,
  0, () => DeletePerformanceAnalysisReportRequest$, () => DeletePerformanceAnalysisReportResponse$
];
export var DescribeDimensionKeys$: StaticOperationSchema = [9, n0, _DDK,
  0, () => DescribeDimensionKeysRequest$, () => DescribeDimensionKeysResponse$
];
export var GetDimensionKeyDetails$: StaticOperationSchema = [9, n0, _GDKD,
  0, () => GetDimensionKeyDetailsRequest$, () => GetDimensionKeyDetailsResponse$
];
export var GetPerformanceAnalysisReport$: StaticOperationSchema = [9, n0, _GPAR,
  0, () => GetPerformanceAnalysisReportRequest$, () => GetPerformanceAnalysisReportResponse$
];
export var GetResourceMetadata$: StaticOperationSchema = [9, n0, _GRM,
  0, () => GetResourceMetadataRequest$, () => GetResourceMetadataResponse$
];
export var GetResourceMetrics$: StaticOperationSchema = [9, n0, _GRMe,
  0, () => GetResourceMetricsRequest$, () => GetResourceMetricsResponse$
];
export var ListAvailableResourceDimensions$: StaticOperationSchema = [9, n0, _LARD,
