...
export var DevOpsAgentServiceException$: StaticErrorSchema = [-3, _s, "DevOpsAgentServiceException", 0, [], []];
...
export var ContentSizeExceededException$: StaticErrorSchema = [-3, n0, _CSEE,
  { [_e]: _c, [_hE]: 413 },
  [_m],
  [0], 1
];
n0_registry.registerError(ContentSizeExceededException$, ContentSizeExceededException);
export var IdentityCenterServiceException$: StaticErrorSchema = [-3, n0, _ICSE,
  { [_e]: _c, [_hE]: 400 },
  [_m, _uEC],
  [0, 0], 1
];
...
export var AzureDevOpsConfiguration$: StaticStructureSchema = [3, n0, _ADOC,
  0,
  [_oN, _pI, _pN],
  [0, 0, 0], 3
];
...
export var DeregisterServiceOutput$: StaticStructureSchema = [3, n0, _DSO,
  0,
  [],
  []
];
...
export var DynatraceConfiguration$: StaticStructureSchema = [3, n0, _DC,
  0,
  [_eIn, _re],
  [0, 64 | 0], 1
];
export var DynatraceOAuthClientCredentialsConfig$: StaticStructureSchema = [3, n0, _DOACCC,
  0,
  [_cI, _cS, _cN, _eP],
  [[() => ClientId, 0], [() => ClientSecret, 0], 0, [() => ExchangeParameters, 0]], 2
];
export var DynatraceServiceDetails$: StaticStructureSchema = [3, n0, _DSDy,
  0,
  [_aU, _aC],
...
export var EventChannelDetails$: StaticStructureSchema = [3, n0, _ECD,
  0,
  [_ty],
  [0]
];
...
export var GetAccountUsageInput$: StaticStructureSchema = [3, n0, _GAUI,
  0,
  [],
  []
];
...
export var GoalSchedule$: StaticStructureSchema = [3, n0, _GS,
  0,
  [_sta, _ex],
  [0, 0], 1
];
export var GoalScheduleInput$: StaticStructureSchema = [3, n0, _GSIo,
  0,
  [_sta],
  [0], 1
];
...
export var IdcAuthConfiguration$: StaticStructureSchema = [3, n0, _IACd,
  0,
...
export var ListAgentSpacesOutput$: StaticStructureSchema = [3, n0, _LASO,
  0,
  [_aSg, _nT],
...
export var ListGoalsRequest$: StaticStructureSchema = [3, n0, _LGR,
  0,
  [_aSI, _st, _gT, _li, _nT],
  [[0, 1], 0, 0, 1, 0], 1
];
export var ListGoalsResponse$: StaticStructureSchema = [3, n0, _LGRi,
  0,
  [_g, _nT],
  [() => GoalList, 0], 1
];
export var ListJournalRecordsRequest$: StaticStructureSchema = [3, n0, _LJRR,
  0,
  [_aSI, _eI, _li, _nT, _rT, _or],
  [[0, 1], 0, 1, 0, 0, 0], 2
];
export var ListJournalRecordsResponse$: StaticStructureSchema = [3, n0, _LJRRi,
  0,
  [_reco, _nT],
  [() => JournalRecordList, 0], 1
];
export var ListPendingMessagesRequest$: StaticStructureSchema = [3, n0, _LPMR,
  0,
  [_aSI, _eI],
  [[0, 1], 0], 2
];
...
export var MCPServerAPIKeyConfig$: StaticStructureSchema = [3, n0, _MCPSAPIKC,
  0,
  [_aKN, _aKV, _aKH],
  [0, [() => ApiKeyValue, 0], 0], 3
];
export var MCPServerAuthorizationDiscoveryConfig$: StaticStructureSchema = [3, n0, _MCPSADC,
  0,
  [_rTE],
  [0], 1
];
export var MCPServerBearerTokenConfig$: StaticStructureSchema = [3, n0, _MCPSBTC,
  0,
  [_tN, _tV, _aH],
  [0, [() => TokenValue, 0], 0], 2
];
...
export var MCPServerOAuthClientCredentialsConfig$: StaticStructureSchema = [3, n0, _MCPSOACCC,
  0,
...
export var OAuthAdditionalStepDetails$: StaticStructureSchema = [3, n0, _OAASD,
  0,
  [_aUu],
  [0], 1
];
...
export var PagerDutyDetails$: StaticStructureSchema = [3, n0, _PDD,
  0,
  [_sc, _aC],
  [64 | 0, [() => PagerDutyAuthorizationConfig$, 0]], 2
];
export var PagerDutyOAuthClientCredentialsConfig$: StaticStructureSchema = [3, n0, _PDOACCC,
  0,
  [_cI, _cS, _cN, _eP],
  [[() => ClientId, 0], [() => ClientSecret, 0], 0, [() => ExchangeParameters, 0]], 2
];
...
export var RegisteredGitLabServiceDetails$: StaticStructureSchema = [3, n0, _RGLSD,
  0,
  [_tU, _tTo, _gI],
  [0, 0, 0], 2
];
...
export var RegisteredPagerDutyDetails$: StaticStructureSchema = [3, n0, _RPDD,
  0,
  [_sc],
  [64 | 0], 1
];
...
export var SendMessageContentBlockDeltaEvent$: StaticStructureSchema = [3, n0, _SMCBDE,
  0,
  [_in, _de, _sN],
...
export var SendMessageJsonDelta$: StaticStructureSchema = [3, n0, _SMJD,
  0,
  [_pJ],
  [0]
];
...
export var SendMessageResponseCompletedEvent$: StaticStructureSchema = [3, n0, _SMRCE,
  0,
  [_rIes, _us, _sN],
  [0, () => SendMessageUsageInfo$, 1]
];
export var SendMessageResponseCreatedEvent$: StaticStructureSchema = [3, n0, _SMRCEe,
  0,
  [_rIes, _sN],
  [0, 1]
];
export var SendMessageResponseFailedEvent$: StaticStructureSchema = [3, n0, _SMRFE,
  0,
  [_rIes, _eC, _eM, _sN],
  [0, 0, 0, 1]
];
export var SendMessageResponseInProgressEvent$: StaticStructureSchema = [3, n0, _SMRIPE,
  0,
  [_rIes, _sN],
  [0, 1]
];
...
export var SendMessageUsageInfo$: StaticStructureSchema = [3, n0, _SMUI,
  0,
  [_iT, _oTu, _tTot],
  [1, 1, 1]
];
...
export var ServiceNowServiceDetails$: StaticStructureSchema = [3, n0, _SNSD,
  0,
  [_iUn, _aC],
...
export var UpdateGoalResponse$: StaticStructureSchema = [3, n0, _UGRp,
  0,
  [_go],
  [() => Goal$], 1
];
export var UpdateOperatorAppIdpConfigInput$: StaticStructureSchema = [3, n0, _UOAICI,
  0,
  [_aSI, _iCS],
  [[0, 1], [() => IdpClientSecret, 0]], 1
];
export var UpdateOperatorAppIdpConfigOutput$: StaticStructureSchema = [3, n0, _UOAICO,
  0,
  [_aSI, _idp],
...
export var UpdateRecommendationResponse$: StaticStructureSchema = [3, n0, _URRpd,
  0,
  [_rec],
  [() => Recommendation$], 1
];
...
export var UserReference$: StaticStructureSchema = [3, n0, _UR,
  0,
  [_uI, _uT],
  [0, 0], 2
];
export var ValidateAwsAssociationsInput$: StaticStructureSchema = [3, n0, _VAAI,
  0,
  [_aSI],
  [[0, 1]], 1
];
export var ValidateAwsAssociationsOutput$: StaticStructureSchema = [3, n0, _VAAO,
  0,
  [],
  []
];
...
var ChatExecutionList: StaticListSchema = [1, n0, _CEL,
  0, () => ChatExecution$
];
var DocumentList = 64 | 15;
var DynatraceResourceList = 64 | 0;
var ExecutionList: StaticListSchema = [1, n0, _EL,
  0, () => Execution$
];
var GoalList: StaticListSchema = [1, n0, _GL,
  0, () => Goal$
];
var JournalRecordList: StaticListSchema = [1, n0, _JRL,
  0, () => JournalRecord$
];
...
var PendingMessages: StaticListSchema = [1, n0, _PMe,
  0, () => PendingMessage$
];
var PortRanges = 64 | 0;
var PriorityList = 64 | 0;
var PrivateConnectionSummaryList: StaticListSchema = [1, n0, _PCSL,
  0, () => PrivateConnectionSummary$
];
var RecommendationList: StaticListSchema = [1, n0, _RL,
  0, () => Recommendation$
];
var RegisteredServicesList: StaticListSchema = [1, n0, _RSL,
  0, [() => RegisteredService$,
    0]
];
var Scopes = 64 | 0;
...
var WebhooksList: StaticListSchema = [1, n0, _WL,
  0, () => Webhook$
];
...
export var DatadogAuthorizationConfig$: StaticUnionSchema = [4, n0, _DAC,
  0,
  [_aD],
  [() => MCPServerAuthorizationDiscoveryConfig$]
];
export var DynatraceServiceAuthorizationConfig$: StaticUnionSchema = [4, n0, _DSAC,
  8,
  [_oACC],
...
export var PagerDutyAuthorizationConfig$: StaticUnionSchema = [4, n0, _PDAC,
  0,
  [_oACC],
