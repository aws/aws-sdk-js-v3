...
import {
  defaultS3OutpostsHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type S3OutpostsClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type S3OutpostsClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<S3OutpostsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultS3OutpostsHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: S3OutpostsClientResolvedConfig) =>
