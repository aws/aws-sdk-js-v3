...
const serializeAws_json1_1DeleteScheduledActionRequest = (
  ...
  return {
    ...(input.ResourceId != undefined && { ResourceId: input.ResourceId }),
    ...(input.ScalableDimension != undefined && { ScalableDimension: input.ScalableDimension }),
    ...(input.ScheduledActionName != undefined && { ScheduledActionName: input.ScheduledActionName }),
    ...(input.ServiceNamespace != undefined && { ServiceNamespace: input.ServiceNamespace }),
  };
};
...
const serializeAws_json1_1PredefinedMetricSpecification = (
  ...
  return {
    ...(input.PredefinedMetricType != undefined && { PredefinedMetricType: input.PredefinedMetricType }),
...
const serializeAws_json1_1StepScalingPolicyConfiguration = (
  ...
  return {
    ...
    ...(input.MetricAggregationType != undefined && { MetricAggregationType: input.MetricAggregationType }),
    ...(input.MinAdjustmentMagnitude != undefined && { MinAdjustmentMagnitude: input.MinAdjustmentMagnitude }),
...
const serializeAws_json1_1SuspendedState = (input: SuspendedState, context: __SerdeContext): any => {
  return {
    ...(input.DynamicScalingInSuspended != undefined && { DynamicScalingInSuspended: input.DynamicScalingInSuspended }),
    ...(input.DynamicScalingOutSuspended != undefined && {
      DynamicScalingOutSuspended: input.DynamicScalingOutSuspended,
    }),
    ...(input.ScheduledScalingSuspended != undefined && { ScheduledScalingSuspended: input.ScheduledScalingSuspended }),
  };
};
...
const serializeAws_json1_1TargetTrackingScalingPolicyConfiguration = (
  ...
  return {
    ...
    ...(input.TargetValue != undefined && { TargetValue: __serializeFloat(input.TargetValue) }),
  };
};
...
const deserializeAws_json1_1CustomizedMetricSpecification = (
  ...
  return {
    Dimensions:
      output.Dimensions != undefined ? deserializeAws_json1_1MetricDimensions(output.Dimensions, context) : undefined,
...
const deserializeAws_json1_1DescribeScalableTargetsResponse = (
  ...
  return {
    ...
    ScalableTargets:
      output.ScalableTargets != undefined
...
const deserializeAws_json1_1PutScalingPolicyResponse = (
  ...
  return {
    Alarms: output.Alarms != undefined ? deserializeAws_json1_1Alarms(output.Alarms, context) : undefined,
...
const deserializeAws_json1_1ScalableTarget = (output: any, context: __SerdeContext): ScalableTarget => {
  return {
    ...
    SuspendedState:
      output.SuspendedState != undefined
