...
export declare type ServiceInputTypes = BatchGrantPermissionsCommandInput | BatchRevokePermissionsCommandInput | DeregisterResourceCommandInput | DescribeResourceCommandInput | GetDataLakeSettingsCommandInput | GetEffectivePermissionsForPathCommandInput | GrantPermissionsCommandInput | ListPermissionsCommandInput | ListResourcesCommandInput | PutDataLakeSettingsCommandInput | RegisterResourceCommandInput | RevokePermissionsCommandInput | UpdateResourceCommandInput;
export declare type ServiceOutputTypes = BatchGrantPermissionsCommandOutput | BatchRevokePermissionsCommandOutput | DeregisterResourceCommandOutput | DescribeResourceCommandOutput | GetDataLakeSettingsCommandOutput | GetEffectivePermissionsForPathCommandOutput | GrantPermissionsCommandOutput | ListPermissionsCommandOutput | ListResourcesCommandOutput | PutDataLakeSettingsCommandOutput | RegisterResourceCommandOutput | RevokePermissionsCommandOutput | UpdateResourceCommandOutput;
...
export declare type LakeFormationClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type LakeFormationClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
