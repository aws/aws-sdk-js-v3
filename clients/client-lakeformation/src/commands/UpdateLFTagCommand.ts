...
import type { UpdateLFTagRequest, UpdateLFTagResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateLFTagCommand extends command<UpdateLFTagCommandInput, UpdateLFTagCommandOutput>(
  _ep0,
  _mw0,
  "UpdateLFTag",
  UpdateLFTag$
