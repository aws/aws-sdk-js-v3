...
import type { RevokePermissionsRequest, RevokePermissionsResponse } from "../models/models_0";
 ...
 * @public
 */
export class RevokePermissionsCommand extends command<RevokePermissionsCommandInput, RevokePermissionsCommandOutput>(
  _ep0,
  _mw0,
  "RevokePermissions",
  RevokePermissions$
