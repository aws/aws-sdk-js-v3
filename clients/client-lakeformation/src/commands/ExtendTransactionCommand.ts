...
import type { ExtendTransactionRequest, ExtendTransactionResponse } from "../models/models_0";
 ...
 * @public
 */
export class ExtendTransactionCommand extends command<ExtendTransactionCommandInput, ExtendTransactionCommandOutput>(
  _ep0,
  _mw0,
  "ExtendTransaction",
  ExtendTransaction$
