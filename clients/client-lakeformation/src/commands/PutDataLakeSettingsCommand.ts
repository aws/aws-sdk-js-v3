...
import type { PutDataLakeSettingsRequest, PutDataLakeSettingsResponse } from "../models/models_0";
 ...
 * @public
 */
export class PutDataLakeSettingsCommand extends command<PutDataLakeSettingsCommandInput, PutDataLakeSettingsCommandOutput>(
  _ep0,
  _mw0,
  "PutDataLakeSettings",
  PutDataLakeSettings$
