...
import type { GetWorkUnitsRequest, GetWorkUnitsResponse } from "../models/models_0";
import { GetWorkUnits$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetWorkUnitsCommand extends command<GetWorkUnitsCommandInput, GetWorkUnitsCommandOutput>(
  _ep0,
  _mw0,
  "GetWorkUnits",
  GetWorkUnits$
