...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteLakeFormationIdentityCenterConfigurationCommandInput) {
    super();
  }
  ...
  > {
    ...
    this.middlewareStack.use(
      getEndpointPlugin(
        configuration,
        DeleteLakeFormationIdentityCenterConfigurationCommand.getEndpointParameterInstructions()
      )
    );
