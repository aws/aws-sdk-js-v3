 ...
 * @public
 */
export class GetTemporaryGlueTableCredentialsCommand extends command<GetTemporaryGlueTableCredentialsCommandInput, GetTemporaryGlueTableCredentialsCommandOutput>(
  _ep0,
  _mw0,
