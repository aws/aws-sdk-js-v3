...
import { type AppConfigClientResolvedConfig, AppConfigClientConfig } from "../AppConfigClient";
 ...
 * @internal
 */
export const defaultAppConfigHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: AppConfigHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<AppConfigClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultAppConfigHttpAuthSchemeProvider: AppConfigHttpAuthSchemeProvider = (authParameters) => {
