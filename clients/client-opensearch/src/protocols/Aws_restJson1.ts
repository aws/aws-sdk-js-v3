...
export const serializeAws_restJson1PurchaseReservedInstanceOfferingCommand = async (
  ...
  body = JSON.stringify({
    ...
    ...(input.ReservedInstanceOfferingId != undefined && {
      ReservedInstanceOfferingId: input.ReservedInstanceOfferingId,
    }),
  });
  return new __HttpRequest({
    protocol,
...
const deserializeAws_restJson1ClusterConfigStatus = (output: any, context: __SerdeContext): ClusterConfigStatus => {
  return {
    Options: output.Options != undefined ? deserializeAws_restJson1ClusterConfig(output.Options, context) : undefined,
    Status: output.Status != undefined ? deserializeAws_restJson1OptionStatus(output.Status, context) : undefined,
  } as any;
};
  ...
  return {
    ...
    ChangeProgressDetails:
      output.ChangeProgressDetails != undefined
        ...
        : undefined,
    ClusterConfig:
      output.ClusterConfig != undefined
...
const deserializeAws_restJson1DomainInformationContainer = (
  ...
  return {
    AWSDomainInformation:
      output.AWSDomainInformation != undefined
