...
import type { AssociatePackagesRequest, AssociatePackagesResponse } from "../models/models_0";
 ...
 * @public
 */
export class AssociatePackagesCommand extends command<AssociatePackagesCommandInput, AssociatePackagesCommandOutput>(
  _ep0,
  _mw0,
  "AssociatePackages",
  AssociatePackages$
