...
import type { GetAccessorInput, GetAccessorOutput } from "../models/models_0";
 ...
 * @public
 */
export class GetAccessorCommand extends command<GetAccessorCommandInput, GetAccessorCommandOutput>(
  _ep0,
  _mw0,
  "GetAccessor",
  GetAccessor$
