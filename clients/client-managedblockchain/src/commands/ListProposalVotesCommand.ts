...
import type { ListProposalVotesInput, ListProposalVotesOutput } from "../models/models_0";
 ...
 * @public
 */
export class ListProposalVotesCommand extends command<ListProposalVotesCommandInput, ListProposalVotesCommandOutput>(
  _ep0,
  _mw0,
  "ListProposalVotes",
  ListProposalVotes$
