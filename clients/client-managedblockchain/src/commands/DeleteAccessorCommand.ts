...
import type { DeleteAccessorInput, DeleteAccessorOutput } from "../models/models_0";
 ...
 * @public
 */
export class DeleteAccessorCommand extends command<DeleteAccessorCommandInput, DeleteAccessorCommandOutput>(
  _ep0,
  _mw0,
  "DeleteAccessor",
  DeleteAccessor$
