...
export var AccessorSummary$: StaticStructureSchema = [3, n0, _AS,
  0,
  [_I, _T, _S, _CD, _Ar, _NT],
  [0, 0, 0, 5, 0, 0]
];
export var ApprovalThresholdPolicy$: StaticStructureSchema = [3, n0, _ATP,
  0,
  [_TP, _PDIH, _TC],
  [1, 1, 0]
];
...
export var ListAccessorsOutput$: StaticStructureSchema = [3, n0, _LAO,
  0,
  [_Acc, _NTe],
  [() => AccessorSummaryList, 0]
];
export var ListInvitationsInput$: StaticStructureSchema = [3, n0, _LII,
  0,
  [_MR, _NTe],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListInvitationsOutput$: StaticStructureSchema = [3, n0, _LIO,
  0,
  [_Inv, _NTe],
  [() => InvitationList, 0]
];
...
export var ListNetworksInput$: StaticStructureSchema = [3, n0, _LNI,
  0,
  [_N, _F, _S, _MR, _NTe],
  [[0, { [_hQ]: _n }], [0, { [_hQ]: _f }], [0, { [_hQ]: _st }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListNetworksOutput$: StaticStructureSchema = [3, n0, _LNO,
  0,
  [_Net, _NTe],
...
export var LogConfigurations$: StaticStructureSchema = [3, n0, _LCo,
  0,
  [_C],
  [() => LogConfiguration$]
];
...
export var MemberFrameworkAttributes$: StaticStructureSchema = [3, n0, _MFAe,
  0,
  [_Fa],
  [() => MemberFabricAttributes$]
];
export var MemberFrameworkConfiguration$: StaticStructureSchema = [3, n0, _MFCe,
  0,
  [_Fa],
  [[() => MemberFabricConfiguration$, 0]]
];
export var MemberLogPublishingConfiguration$: StaticStructureSchema = [3, n0, _MLPC,
  0,
  [_Fa],
  [() => MemberFabricLogPublishingConfiguration$]
];
export var MemberSummary$: StaticStructureSchema = [3, n0, _MS,
  0,
  [_I, _N, _D, _S, _CD, _IO, _Ar],
  [0, 0, 0, 0, 5, 2, 0]
];
export var Network$: StaticStructureSchema = [3, n0, _Ne,
  0,
  [_I, _N, _D, _F, _FV, _FA, _VESN, _VP, _S, _CD, _Ta, _Ar],
  [0, 0, 0, 0, 0, () => NetworkFrameworkAttributes$, 0, () => VotingPolicy$, 0, 5, 128 | 0, 0]
];
export var NetworkEthereumAttributes$: StaticStructureSchema = [3, n0, _NEA,
  0,
  [_CI],
  [0]
];
export var NetworkFabricAttributes$: StaticStructureSchema = [3, n0, _NFA,
  0,
  [_OSE, _Ed],
  [0, 0]
];
...
export var NetworkFrameworkConfiguration$: StaticStructureSchema = [3, n0, _NFCe,
  0,
  [_Fa],
  [() => NetworkFabricConfiguration$]
];
export var NetworkSummary$: StaticStructureSchema = [3, n0, _NS,
  0,
...
export var NodeFabricAttributes$: StaticStructureSchema = [3, n0, _NFAo,
  0,
  [_PE, _PEE],
  [0, 0]
];
export var NodeFabricLogPublishingConfiguration$: StaticStructureSchema = [3, n0, _NFLPC,
  0,
  [_CLh, _PL],
  [() => LogConfigurations$, () => LogConfigurations$]
];
export var NodeFrameworkAttributes$: StaticStructureSchema = [3, n0, _NFAod,
  0,
  [_Fa, _Et],
  [() => NodeFabricAttributes$, () => NodeEthereumAttributes$]
];
export var NodeLogPublishingConfiguration$: StaticStructureSchema = [3, n0, _NLPC,
  0,
  [_Fa],
  [() => NodeFabricLogPublishingConfiguration$]
];
export var NodeSummary$: StaticStructureSchema = [3, n0, _NSo,
  0,
  [_I, _S, _CD, _AZ, _IT, _Ar],
  [0, 0, 5, 0, 0, 0]
];
export var Proposal$: StaticStructureSchema = [3, n0, _P,
  0,
  [_PI, _NI, _D, _Ac, _PBMI, _PBMN, _S, _CD, _ED, _YVC, _NVC, _OVC, _Ta, _Ar],
  [0, 0, 0, () => ProposalActions$, 0, 0, 0, 5, 5, 1, 1, 1, 128 | 0, 0]
];
export var ProposalActions$: StaticStructureSchema = [3, n0, _PA,
  0,
  [_Inv, _R],
  [() => InviteActionList, () => RemoveActionList]
];
export var ProposalSummary$: StaticStructureSchema = [3, n0, _PSr,
  0,
...
export var VoteSummary$: StaticStructureSchema = [3, n0, _VS,
  0,
  [_V, _MN, _MI],
  [0, 0, 0]
];
export var VotingPolicy$: StaticStructureSchema = [3, n0, _VP,
  0,
  [_ATP],
...
var InvitationList: StaticListSchema = [1, n0, _IL,
  0, () => Invitation$
];
var InviteActionList: StaticListSchema = [1, n0, _IAL,
  0, () => InviteAction$
];
var MemberSummaryList: StaticListSchema = [1, n0, _MSL,
  0, () => MemberSummary$
];
var NetworkSummaryList: StaticListSchema = [1, n0, _NSL,
  0, () => NetworkSummary$
];
var NodeSummaryList: StaticListSchema = [1, n0, _NSLo,
  0, () => NodeSummary$
];
var ProposalSummaryList: StaticListSchema = [1, n0, _PSL,
  0, () => ProposalSummary$
];
var ProposalVoteList: StaticListSchema = [1, n0, _PVL,
  0, () => VoteSummary$
];
var RemoveActionList: StaticListSchema = [1, n0, _RAL,
  0, () => RemoveAction$
];
var TagKeyList = 64 | 0;
var InputTagMap = 128 | 0;
var OutputTagMap = 128 | 0;
export var CreateAccessor$: StaticOperationSchema = [9, n0, _CA,
  { [_h]: ["POST", "/accessors", 200] }, () => CreateAccessorInput$, () => CreateAccessorOutput$
];
export var CreateMember$: StaticOperationSchema = [9, n0, _CM,
  { [_h]: ["POST", "/networks/{NetworkId}/members", 200] }, () => CreateMemberInput$, () => CreateMemberOutput$
];
export var CreateNetwork$: StaticOperationSchema = [9, n0, _CN,
  { [_h]: ["POST", "/networks", 200] }, () => CreateNetworkInput$, () => CreateNetworkOutput$
];
export var CreateNode$: StaticOperationSchema = [9, n0, _CNr,
  { [_h]: ["POST", "/networks/{NetworkId}/nodes", 200] }, () => CreateNodeInput$, () => CreateNodeOutput$
];
export var CreateProposal$: StaticOperationSchema = [9, n0, _CP,
  { [_h]: ["POST", "/networks/{NetworkId}/proposals", 200] }, () => CreateProposalInput$, () => CreateProposalOutput$
];
export var DeleteAccessor$: StaticOperationSchema = [9, n0, _DA,
...
export var ListNetworks$: StaticOperationSchema = [9, n0, _LN,
  { [_h]: ["GET", "/networks", 200] }, () => ListNetworksInput$, () => ListNetworksOutput$
];
export var ListNodes$: StaticOperationSchema = [9, n0, _LNi,
  { [_h]: ["GET", "/networks/{NetworkId}/nodes", 200] }, () => ListNodesInput$, () => ListNodesOutput$
];
export var ListProposals$: StaticOperationSchema = [9, n0, _LP,
  { [_h]: ["GET", "/networks/{NetworkId}/proposals", 200] }, () => ListProposalsInput$, () => ListProposalsOutput$
];
export var ListProposalVotes$: StaticOperationSchema = [9, n0, _LPV,
...
export var RejectInvitation$: StaticOperationSchema = [9, n0, _RI,
...
export var UpdateMember$: StaticOperationSchema = [9, n0, _UM,
  { [_h]: ["PATCH", "/networks/{NetworkId}/members/{MemberId}", 200] }, () => UpdateMemberInput$, () => UpdateMemberOutput$
];
export var UpdateNode$: StaticOperationSchema = [9, n0, _UN,
  { [_h]: ["PATCH", "/networks/{NetworkId}/nodes/{NodeId}", 200] }, () => UpdateNodeInput$, () => UpdateNodeOutput$
];
export var VoteOnProposal$: StaticOperationSchema = [9, n0, _VOP,
