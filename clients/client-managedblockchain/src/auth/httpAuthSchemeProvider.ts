...
import { type ManagedBlockchainClientResolvedConfig, ManagedBlockchainClientConfig } from "../ManagedBlockchainClient";
 ...
 * @internal
 */
export const defaultManagedBlockchainHttpAuthSchemeProvider: ManagedBlockchainHttpAuthSchemeProvider = (authParameters) => {
