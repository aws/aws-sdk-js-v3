...
import { type SecurityIRClientResolvedConfig, SecurityIRClientConfig } from "../SecurityIRClient";
 ...
 * @internal
 */
export const defaultSecurityIRHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SecurityIRHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<SecurityIRClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultSecurityIRHttpAuthSchemeProvider: SecurityIRHttpAuthSchemeProvider = (authParameters) => {
