 ...
 * @public
 */
export class DeleteSlackWorkspaceConfigurationCommand extends command<DeleteSlackWorkspaceConfigurationCommandInput, DeleteSlackWorkspaceConfigurationCommandOutput>(
  _ep0,
  _mw0,
