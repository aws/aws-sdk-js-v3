...
export var DeleteAccountAliasResult$: StaticStructureSchema = [3, n0, _DAARe,
  0,
  [],
  []
];
...
export var GetAccountAliasRequest$: StaticStructureSchema = [3, n0, _GAAR,
  0,
  [],
  []
];
export var GetAccountAliasResult$: StaticStructureSchema = [3, n0, _GAARe,
  0,
  [_aA],
  [0]
];
...
export var ListSlackWorkspaceConfigurationsResult$: StaticStructureSchema = [3, n0, _LSWCRi,
  0,
  [_nT, _sWC],
...
var SlackWorkspaceConfigurationList: StaticListSchema = [1, n0, _SWCL,
  0, () => SlackWorkspaceConfiguration$
];
export var CreateSlackChannelConfiguration$: StaticOperationSchema = [9, n0, _CSCC,
...
export var DeleteSlackChannelConfiguration$: StaticOperationSchema = [9, n0, _DSCC,
...
export var DeleteSlackWorkspaceConfiguration$: StaticOperationSchema = [9, n0, _DSWC,
...
export var GetAccountAlias$: StaticOperationSchema = [9, n0, _GAA,
  { [_h]: ["POST", "/control/get-account-alias", 200] }, () => GetAccountAliasRequest$, () => GetAccountAliasResult$
];
export var ListSlackChannelConfigurations$: StaticOperationSchema = [9, n0, _LSCC,
...
export var ListSlackWorkspaceConfigurations$: StaticOperationSchema = [9, n0, _LSWC,
...
export var PutAccountAlias$: StaticOperationSchema = [9, n0, _PAA,
  { [_h]: ["POST", "/control/put-account-alias", 200] }, () => PutAccountAliasRequest$, () => PutAccountAliasResult$
];
export var RegisterSlackWorkspaceForOrganization$: StaticOperationSchema = [9, n0, _RSWFO,
...
export var UpdateSlackChannelConfiguration$: StaticOperationSchema = [9, n0, _USCC,
