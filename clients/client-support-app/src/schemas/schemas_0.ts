...
var slackChannelConfigurationList: StaticListSchema = [1, n0, _sCCL, 0, () => SlackChannelConfiguration$];
var SlackWorkspaceConfigurationList: StaticListSchema = [1, n0, _SWCL, 0, () => SlackWorkspaceConfiguration$];
