...
import {
  deserializeAws_restJson1_1AttachToIndexCommand,
  serializeAws_restJson1_1AttachToIndexCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1AttachToIndexCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1AttachToIndexCommand(output, context);
  }
