...
import {
  deserializeAws_restJson1_1ListIndexCommand,
  serializeAws_restJson1_1ListIndexCommand
...
export type ListIndexCommandOutput = ListIndexResponse;
...
> {
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListIndexCommand(output, context);
  }
