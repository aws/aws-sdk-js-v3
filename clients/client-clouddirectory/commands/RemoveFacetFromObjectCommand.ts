...
import { RemoveFacetFromObjectRequest, RemoveFacetFromObjectResponse } from "../models/index";
import {
...
> {
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1RemoveFacetFromObjectCommand(output, context);
  }
