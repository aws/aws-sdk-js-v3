...
import { GetObjectInformationRequest, GetObjectInformationResponse } from "../models/index";
import {
...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName: "getObjectInformation",
      inputFilterLog: GetObjectInformationRequest.filterSensitiveLog,
      outputFilterLog: GetObjectInformationResponse.filterSensitiveLog,
    };
