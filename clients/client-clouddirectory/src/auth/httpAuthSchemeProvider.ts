...
import { type CloudDirectoryClientResolvedConfig, CloudDirectoryClientConfig } from "../CloudDirectoryClient";
 ...
 * @internal
 */
export const defaultCloudDirectoryHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CloudDirectoryHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultCloudDirectoryHttpAuthSchemeProvider: CloudDirectoryHttpAuthSchemeProvider = (authParameters) => {
