...
import { type QAppsClientResolvedConfig, QAppsClientConfig } from "../QAppsClient";
 ...
 * @internal
 */
export const defaultQAppsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: QAppsHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultQAppsHttpAuthSchemeProvider: QAppsHttpAuthSchemeProvider = (authParameters) => {
