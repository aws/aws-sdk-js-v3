...
export var DeleteSchemaVersionRequest$: StaticStructureSchema = [
  3,
  n0,
  _DSVR,
  0,
...
export var DescribeCodeBindingRequest$: StaticStructureSchema = [
  3,
  n0,
  _DCBR,
  0,
...
export var DescribeDiscovererRequest$: StaticStructureSchema = [3, n0, _DDRe, 0, [_DI], [[0, 1]]];
export var DescribeDiscovererResponse$: StaticStructureSchema = [
  3,
  n0,
  _DDRes,
  0,
...
export var ExportSchemaResponse$: StaticStructureSchema = [
  3,
  n0,
  _ESRx,
  0,
...
export var ListRegistriesRequest$: StaticStructureSchema = [
  3,
  n0,
  _LRR,
  0,
...
export var ListSchemaVersionsRequest$: StaticStructureSchema = [
  3,
  n0,
  _LSVR,
  0,
...
export var SearchSchemasResponse$: StaticStructureSchema = [
  3,
  n0,
  _SSRe,
  0,
...
export var SearchSchemaSummary$: StaticStructureSchema = [
  3,
  n0,
  _SSS,
  0,
...
export var StopDiscovererResponse$: StaticStructureSchema = [3, n0, _SDRtop, 0, [_DI, _S], [0, 0]];
...
export var UpdateDiscovererResponse$: StaticStructureSchema = [
  3,
  n0,
  _UDRp,
  0,
...
export var UpdateSchemaResponse$: StaticStructureSchema = [
  3,
  n0,
  _USRp,
  0,
...
var __listOfDiscovererSummary: StaticListSchema = [1, n0, _lODS, 0, [() => DiscovererSummary$, 0]];
var __listOfGetDiscoveredSchemaVersionItemInput = 64 | 0;
var __listOfRegistrySummary: StaticListSchema = [1, n0, _lORS, 0, [() => RegistrySummary$, 0]];
var __listOfSchemaSummary: StaticListSchema = [1, n0, _lOSS, 0, [() => SchemaSummary$, 0]];
var __listOfSchemaVersionSummary: StaticListSchema = [1, n0, _lOSVS, 0, () => SchemaVersionSummary$];
var __listOfSearchSchemaSummary: StaticListSchema = [1, n0, _lOSSS, 0, () => SearchSchemaSummary$];
var __listOfSearchSchemaVersionSummary: StaticListSchema = [1, n0, _lOSSVS, 0, () => SearchSchemaVersionSummary$];
var Tags = 128 | 0;
...
export var DeleteDiscoverer$: StaticOperationSchema = [
  9,
  n0,
  _DD,
...
export var DeleteSchemaVersion$: StaticOperationSchema = [
  9,
  n0,
  _DSV,
...
export var DescribeCodeBinding$: StaticOperationSchema = [
  9,
  n0,
  _DCB,
...
export var DescribeDiscoverer$: StaticOperationSchema = [
  9,
  n0,
  _DDe,
...
export var DescribeSchema$: StaticOperationSchema = [
  9,
  n0,
  _DSes,
...
export var ExportSchema$: StaticOperationSchema = [
  9,
  n0,
  _ES,
...
export var GetCodeBindingSource$: StaticOperationSchema = [
  9,
  n0,
  _GCBS,
...
export var GetDiscoveredSchema$: StaticOperationSchema = [
  9,
  n0,
  _GDS,
...
export var ListDiscoverers$: StaticOperationSchema = [
  9,
  n0,
  _LD,
...
export var PutCodeBinding$: StaticOperationSchema = [
  9,
  n0,
  _PCB,
...
export var SearchSchemas$: StaticOperationSchema = [
  9,
  n0,
  _SSe,
...
export var StartDiscoverer$: StaticOperationSchema = [
  9,
  n0,
  _SD,
...
export var StopDiscoverer$: StaticOperationSchema = [
  9,
  n0,
  _SDt,
...
export var UpdateDiscoverer$: StaticOperationSchema = [
  9,
  n0,
  _UD,
