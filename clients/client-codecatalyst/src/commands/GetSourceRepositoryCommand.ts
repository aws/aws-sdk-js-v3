...
> {
  ...
  resolveMiddleware(
    ...
    this.middlewareStack.use(
      getEndpointPlugin(configuration, GetSourceRepositoryCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: GetSourceRepositoryCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
