...
export var GetUserDetailsRequest$: StaticStructureSchema = [3, n0, _GUDR,
  0,
  [_i, _uN],
  [[0, { [_hQ]: _i }], [0, { [_hQ]: _uN }]]
];
export var GetUserDetailsResponse$: StaticStructureSchema = [3, n0, _GUDRe,
  0,
...
export var IdeConfiguration$: StaticStructureSchema = [3, n0, _IC,
  0,
  [_ru, _n],
  [0, 0]
];
export var ListAccessTokensRequest$: StaticStructureSchema = [3, n0, _LATR,
  0,
  [_mR, _nT],
  [1, 0]
];
...
export var ListSourceRepositoryBranchesItem$: StaticStructureSchema = [3, n0, _LSRBI,
  0,
  [_re, _n, _lUT, _hCI],
  [0, 0, 5, 0]
];
...
export var WorkflowRunStatusReason$: StaticStructureSchema = [3, n0, _WRSR,
  0,
  [],
  []
];
...
var DevEnvironmentRepositorySummaries: StaticListSchema = [1, n0, _DERSe,
  0, () => DevEnvironmentRepositorySummary$
];
var DevEnvironmentSessionsSummaryList: StaticListSchema = [1, n0, _DESSL,
  0, () => DevEnvironmentSessionSummary$
];
var DevEnvironmentSummaryList: StaticListSchema = [1, n0, _DESL,
  0, () => DevEnvironmentSummary$
];
var EventLogEntries: StaticListSchema = [1, n0, _ELEv,
  0, () => EventLogEntry$
];
...
var IdeConfigurationList: StaticListSchema = [1, n0, _ICL,
  0, () => IdeConfiguration$
];
var Ides: StaticListSchema = [1, n0, _Id,
  0, () => Ide$
];
var ListSourceRepositoriesItems: StaticListSchema = [1, n0, _LSRIi,
  0, () => ListSourceRepositoriesItem$
];
var ListSourceRepositoryBranchesItems: StaticListSchema = [1, n0, _LSRBIi,
  0, () => ListSourceRepositoryBranchesItem$
];
var ProjectListFilters: StaticListSchema = [1, n0, _PLFr,
  0, () => ProjectListFilter$
];
var ProjectSummaries: StaticListSchema = [1, n0, _PSro,
  0, () => ProjectSummary$
];
var RepositoriesInput: StaticListSchema = [1, n0, _RIe,
  0, () => RepositoryInput$
];
var SpaceSummaries: StaticListSchema = [1, n0, _SSpa,
  0, () => SpaceSummary$
];
var StringList = 64 | 0;
var WorkflowRunSortCriteriaList: StaticListSchema = [1, n0, _WRSCL,
  0, () => WorkflowRunSortCriteria$
];
var WorkflowRunStatusReasons: StaticListSchema = [1, n0, _WRSRo,
  0, () => WorkflowRunStatusReason$
];
var WorkflowRunSummaries: StaticListSchema = [1, n0, _WRSo,
  0, () => WorkflowRunSummary$
];
var WorkflowSortCriteriaList: StaticListSchema = [1, n0, _WSCL,
  0, () => WorkflowSortCriteria$
];
var WorkflowSummaries: StaticListSchema = [1, n0, _WSo,
  0, () => WorkflowSummary$
];
...
export var CreateDevEnvironment$: StaticOperationSchema = [9, n0, _CDE,
...
export var CreateSourceRepository$: StaticOperationSchema = [9, n0, _CSR,
...
export var CreateSourceRepositoryBranch$: StaticOperationSchema = [9, n0, _CSRB,
...
export var DeleteDevEnvironment$: StaticOperationSchema = [9, n0, _DDE,
...
export var DeleteSourceRepository$: StaticOperationSchema = [9, n0, _DSRel,
...
export var DeleteSpace$: StaticOperationSchema = [9, n0, _DS,
  { [_ht]: ["DELETE", "/v1/spaces/{name}", 200] }, () => DeleteSpaceRequest$, () => DeleteSpaceResponse$
];
export var GetDevEnvironment$: StaticOperationSchema = [9, n0, _GDE,
...
export var GetSourceRepository$: StaticOperationSchema = [9, n0, _GSReto,
...
export var GetSourceRepositoryCloneUrls$: StaticOperationSchema = [9, n0, _GSRCU,
...
export var GetSpace$: StaticOperationSchema = [9, n0, _GS,
  { [_ht]: ["GET", "/v1/spaces/{name}", 200] }, () => GetSpaceRequest$, () => GetSpaceResponse$
];
export var GetSubscription$: StaticOperationSchema = [9, n0, _GSe,
  { [_ht]: ["GET", "/v1/spaces/{spaceName}/subscription", 200] }, () => GetSubscriptionRequest$, () => GetSubscriptionResponse$
];
export var GetUserDetails$: StaticOperationSchema = [9, n0, _GUD,
...
export var ListDevEnvironments$: StaticOperationSchema = [9, n0, _LDE,
  { [_ht]: ["POST", "/v1/spaces/{spaceName}/devEnvironments", 200] }, () => ListDevEnvironmentsRequest$, () => ListDevEnvironmentsResponse$
];
export var ListDevEnvironmentSessions$: StaticOperationSchema = [9, n0, _LDES,
...
export var ListEventLogs$: StaticOperationSchema = [9, n0, _LEL,
...
export var ListSourceRepositories$: StaticOperationSchema = [9, n0, _LSRis,
...
export var ListSourceRepositoryBranches$: StaticOperationSchema = [9, n0, _LSRB,
...
export var StartDevEnvironment$: StaticOperationSchema = [9, n0, _SDE,
...
export var StartDevEnvironmentSession$: StaticOperationSchema = [9, n0, _SDES,
...
export var StopDevEnvironment$: StaticOperationSchema = [9, n0, _SDEt,
...
export var StopDevEnvironmentSession$: StaticOperationSchema = [9, n0, _SDESt,
...
export var UpdateDevEnvironment$: StaticOperationSchema = [9, n0, _UDE,
...
export var UpdateSpace$: StaticOperationSchema = [9, n0, _US,
  { [_ht]: ["PATCH", "/v1/spaces/{name}", 200] }, () => UpdateSpaceRequest$, () => UpdateSpaceResponse$
];
export var VerifySession$: StaticOperationSchema = [9, n0, _VS,
