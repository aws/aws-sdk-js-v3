...
import type { UpdateBillingViewRequest, UpdateBillingViewResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateBillingViewCommand extends command<UpdateBillingViewCommandInput, UpdateBillingViewCommandOutput>(
  _ep0,
  _mw0,
  "UpdateBillingView",
  UpdateBillingView$
