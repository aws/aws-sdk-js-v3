...
- `npm install @aws-sdk/client-uxc`
- `yarn add @aws-sdk/client-uxc`
- `pnpm add @aws-sdk/client-uxc`
...
```js
const client = new UxcClient({ region: "REGION" });
...
[Command API Reference](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/uxc/command/GetAccountCustomizationsCommand/) / [Input](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/Package/-aws-sdk-client-uxc/Interface/GetAccountCustomizationsCommandInput/) / [Output](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/Package/-aws-sdk-client-uxc/Interface/GetAccountCustomizationsCommandOutput/)
</details>
<details>
<summary>
ListServices
...
[Command API Reference](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/uxc/command/ListServicesCommand/) / [Input](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/Package/-aws-sdk-client-uxc/Interface/ListServicesCommandInput/) / [Output](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/Package/-aws-sdk-client-uxc/Interface/ListServicesCommandOutput/)
</details>
<details>
<summary>
...
[Command API Reference](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/uxc/command/UpdateAccountCustomizationsCommand/) / [Input](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/Package/-aws-sdk-client-uxc/Interface/UpdateAccountCustomizationsCommandInput/) / [Output](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/Package/-aws-sdk-client-uxc/Interface/UpdateAccountCustomizationsCommandOutput/)
</details>
