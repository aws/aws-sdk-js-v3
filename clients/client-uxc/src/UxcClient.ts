...
import {
  ...
  defaultUxcHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type UxcClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type UxcClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 */
export class UxcClient extends __Client<
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<UxcClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultUxcHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: UxcClientResolvedConfig) =>
