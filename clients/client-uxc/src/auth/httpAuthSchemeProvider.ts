...
import { type UxcClientResolvedConfig, UxcClientConfig } from "../UxcClient";
 ...
 * @internal
 */
export const defaultUxcHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: UxcHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<UxcClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultUxcHttpAuthSchemeProvider: UxcHttpAuthSchemeProvider = (authParameters) => {
