...
import { type AccountClientResolvedConfig, AccountClientConfig } from "../AccountClient";
 ...
 * @internal
 */
export const defaultAccountHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: AccountHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<AccountClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultAccountHttpAuthSchemeProvider: AccountHttpAuthSchemeProvider = (authParameters) => {
