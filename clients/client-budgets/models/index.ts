 ...
 *
 */
export interface CreationLimitExceededException extends _smithy.SmithyException, $MetadataBearer {
...
export interface DescribeBudgetPerformanceHistoryResponse extends $MetadataBearer {
 ...
 * 	
 */
export interface DescribeNotificationsForBudgetResponse extends $MetadataBearer {
 ...
 * 	
 */
export interface DescribeSubscribersForNotificationResponse extends $MetadataBearer {
 ...
 *
 */
export interface DuplicateRecordException extends _smithy.SmithyException, $MetadataBearer {
