...
export var BudgetNotificationsForAccount$: StaticStructureSchema = [3, n0, _BNFA,
  0,
  [_N, _BN],
  [() => Notifications, 0]
];
...
export var CostTypes$: StaticStructureSchema = [3, n0, _CT,
  0,
...
var BudgetedAndActualAmountsList: StaticListSchema = [1, n0, _BAAAL,
  0, () => BudgetedAndActualAmounts$
];
var BudgetNotificationsForAccountList: StaticListSchema = [1, n0, _BNFAL,
...
var Metrics = 64 | 0;
var Notifications: StaticListSchema = [1, n0, _N,
  0, () => Notification$
];
var NotificationWithSubscribersList: StaticListSchema = [1, n0, _NWSL,
...
var Roles = 64 | 0;
var Subscribers: StaticListSchema = [1, n0, _Su,
  0, [() => Subscriber$,
    0]
];
var TargetIds = 64 | 0;
var Users = 64 | 0;
var Values = 64 | 0;
var CostFilters: StaticMapSchema = [2, n0, _CF,
  0, 0, 64 | 0
];
var PlannedBudgetLimits: StaticMapSchema = [2, n0, _PBL,
  0, 0, () => Spend$
];
export var CreateBudget$: StaticOperationSchema = [9, n0, _CB,
  0, () => CreateBudgetRequest$, () => CreateBudgetResponse$
];
export var CreateBudgetAction$: StaticOperationSchema = [9, n0, _CBA,
...
export var CreateSubscriber$: StaticOperationSchema = [9, n0, _CSr,
...
export var DeleteBudgetAction$: StaticOperationSchema = [9, n0, _DBA,
  0, () => DeleteBudgetActionRequest$, () => DeleteBudgetActionResponse$
];
export var DeleteNotification$: StaticOperationSchema = [9, n0, _DN,
  0, () => DeleteNotificationRequest$, () => DeleteNotificationResponse$
];
export var DeleteSubscriber$: StaticOperationSchema = [9, n0, _DS,
  0, () => DeleteSubscriberRequest$, () => DeleteSubscriberResponse$
];
export var DescribeBudget$: StaticOperationSchema = [9, n0, _DBe,
  0, () => DescribeBudgetRequest$, () => DescribeBudgetResponse$
];
export var DescribeBudgetAction$: StaticOperationSchema = [9, n0, _DBAe,
  0, () => DescribeBudgetActionRequest$, () => DescribeBudgetActionResponse$
];
export var DescribeBudgetActionHistories$: StaticOperationSchema = [9, n0, _DBAH,
  0, () => DescribeBudgetActionHistoriesRequest$, () => DescribeBudgetActionHistoriesResponse$
];
export var DescribeBudgetActionsForAccount$: StaticOperationSchema = [9, n0, _DBAFA,
  0, () => DescribeBudgetActionsForAccountRequest$, () => DescribeBudgetActionsForAccountResponse$
];
export var DescribeBudgetActionsForBudget$: StaticOperationSchema = [9, n0, _DBAFB,
  0, () => DescribeBudgetActionsForBudgetRequest$, () => DescribeBudgetActionsForBudgetResponse$
];
export var DescribeBudgetNotificationsForAccount$: StaticOperationSchema = [9, n0, _DBNFA,
  0, () => DescribeBudgetNotificationsForAccountRequest$, () => DescribeBudgetNotificationsForAccountResponse$
];
export var DescribeBudgetPerformanceHistory$: StaticOperationSchema = [9, n0, _DBPH,
  0, () => DescribeBudgetPerformanceHistoryRequest$, () => DescribeBudgetPerformanceHistoryResponse$
];
export var DescribeBudgets$: StaticOperationSchema = [9, n0, _DBes,
  0, () => DescribeBudgetsRequest$, () => DescribeBudgetsResponse$
];
export var DescribeNotificationsForBudget$: StaticOperationSchema = [9, n0, _DNFB,
  0, () => DescribeNotificationsForBudgetRequest$, () => DescribeNotificationsForBudgetResponse$
];
export var DescribeSubscribersForNotification$: StaticOperationSchema = [9, n0, _DSFN,
  0, () => DescribeSubscribersForNotificationRequest$, () => DescribeSubscribersForNotificationResponse$
];
export var ExecuteBudgetAction$: StaticOperationSchema = [9, n0, _EBA,
...
export var UpdateBudget$: StaticOperationSchema = [9, n0, _UBp,
  0, () => UpdateBudgetRequest$, () => UpdateBudgetResponse$
];
export var UpdateBudgetAction$: StaticOperationSchema = [9, n0, _UBA,
  0, () => UpdateBudgetActionRequest$, () => UpdateBudgetActionResponse$
];
export var UpdateNotification$: StaticOperationSchema = [9, n0, _UN,
  0, () => UpdateNotificationRequest$, () => UpdateNotificationResponse$
];
export var UpdateSubscriber$: StaticOperationSchema = [9, n0, _US,
