 ...
 * @public
 */
export class DescribeBudgetNotificationsForAccountCommand extends command<DescribeBudgetNotificationsForAccountCommandInput, DescribeBudgetNotificationsForAccountCommandOutput>(
  _ep0,
  _mw0,
