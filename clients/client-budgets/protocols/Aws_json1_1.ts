...
export const serializeAws_json1_1DescribeSubscribersForNotificationCommand = async (
  ...
  let body: any;
  body = JSON.stringify(
    serializeAws_json1_1DescribeSubscribersForNotificationRequest(input, context)
  );
  return buildHttpRpcRequest(context, headers, "/", undefined, body);
};
...
const deserializeAws_json1_1Budget = (output: any, context: __SerdeContext): Budget => {
  return {
    ...
    BudgetType:
      output.BudgetType !== undefined && output.BudgetType !== null ? output.BudgetType : undefined,
    CalculatedSpend:
  ...
  return {
    ...
    IncludeSupport:
      output.IncludeSupport !== undefined && output.IncludeSupport !== null
        ...
        : undefined,
    IncludeTax:
      output.IncludeTax !== undefined && output.IncludeTax !== null ? output.IncludeTax : undefined,
    IncludeUpfront:
    ...
    UseAmortized:
      output.UseAmortized !== undefined && output.UseAmortized !== null
        ...
        : undefined,
    UseBlended:
      output.UseBlended !== undefined && output.UseBlended !== null ? output.UseBlended : undefined
  } as any;
};
