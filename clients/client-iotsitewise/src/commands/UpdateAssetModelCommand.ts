...
import type { UpdateAssetModelRequest, UpdateAssetModelResponse } from "../models/models_1";
 ...
 * @public
 */
export class UpdateAssetModelCommand extends command<UpdateAssetModelCommandInput, UpdateAssetModelCommandOutput>(
  _ep0,
  _mw0,
  "UpdateAssetModel",
  UpdateAssetModel$
