 ...
 * @public
 */
export class UpdateGatewayCapabilityConfigurationCommand extends command<UpdateGatewayCapabilityConfigurationCommandInput, UpdateGatewayCapabilityConfigurationCommandOutput>(
  _ep0,
  _mw0,
