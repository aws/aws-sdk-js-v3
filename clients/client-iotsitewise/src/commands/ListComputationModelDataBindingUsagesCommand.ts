 ...
 * @public
 */
export class ListComputationModelDataBindingUsagesCommand extends command<ListComputationModelDataBindingUsagesCommandInput, ListComputationModelDataBindingUsagesCommandOutput>(
  _ep0,
  _mw0,
