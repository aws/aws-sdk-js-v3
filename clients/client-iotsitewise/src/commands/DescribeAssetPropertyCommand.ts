...
import type { DescribeAssetPropertyRequest, DescribeAssetPropertyResponse } from "../models/models_0";
 ...
 * @public
 */
export class DescribeAssetPropertyCommand extends command<DescribeAssetPropertyCommandInput, DescribeAssetPropertyCommandOutput>(
  _ep0,
  _mw0,
