 ...
 * @public
 */
export class ListComputationModelResolveToResourcesCommand extends command<ListComputationModelResolveToResourcesCommandInput, ListComputationModelResolveToResourcesCommandOutput>(
  _ep0,
  _mw0,
