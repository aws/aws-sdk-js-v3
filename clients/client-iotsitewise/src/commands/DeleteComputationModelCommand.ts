...
import type { DeleteComputationModelRequest, DeleteComputationModelResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteComputationModelCommand extends command<DeleteComputationModelCommandInput, DeleteComputationModelCommandOutput>(
  _ep0,
  _mw0,
