...
import type { ExecuteActionRequest, ExecuteActionResponse } from "../models/models_1";
 ...
 * @public
 */
export class ExecuteActionCommand extends command<ExecuteActionCommandInput, ExecuteActionCommandOutput>(
  _ep0,
  _mw0,
  "ExecuteAction",
  ExecuteAction$
