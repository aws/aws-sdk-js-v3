...
import type { AssociateAssetsRequest } from "../models/models_0";
 ...
 * @public
 */
export class AssociateAssetsCommand extends command<AssociateAssetsCommandInput, AssociateAssetsCommandOutput>(
  _ep0,
  _mw0,
  "AssociateAssets",
  AssociateAssets$
