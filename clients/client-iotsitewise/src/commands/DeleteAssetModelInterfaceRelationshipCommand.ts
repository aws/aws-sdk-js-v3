 ...
 * @public
 */
export class DeleteAssetModelInterfaceRelationshipCommand extends command<DeleteAssetModelInterfaceRelationshipCommandInput, DeleteAssetModelInterfaceRelationshipCommandOutput>(
  _ep0,
  _mw0,
