 ...
 * @public
 */
export class DescribeAssetModelInterfaceRelationshipCommand extends command<DescribeAssetModelInterfaceRelationshipCommandInput, DescribeAssetModelInterfaceRelationshipCommandOutput>(
  _ep0,
  _mw0,
