...
import type { CreateAssetModelRequest, CreateAssetModelResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateAssetModelCommand extends command<CreateAssetModelCommandInput, CreateAssetModelCommandOutput>(
  _ep0,
  _mw0,
  "CreateAssetModel",
  CreateAssetModel$
