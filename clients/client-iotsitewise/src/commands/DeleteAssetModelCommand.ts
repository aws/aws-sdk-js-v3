...
import type { DeleteAssetModelRequest, DeleteAssetModelResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteAssetModelCommand extends command<DeleteAssetModelCommandInput, DeleteAssetModelCommandOutput>(
  _ep0,
  _mw0,
  "DeleteAssetModel",
  DeleteAssetModel$
