...
import type { UpdateAssetPropertyRequest } from "../models/models_1";
 ...
 * @public
 */
export class UpdateAssetPropertyCommand extends command<UpdateAssetPropertyCommandInput, UpdateAssetPropertyCommandOutput>(
  _ep0,
  _mw0,
  "UpdateAssetProperty",
  UpdateAssetProperty$
