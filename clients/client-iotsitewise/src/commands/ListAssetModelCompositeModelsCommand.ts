...
import type { ListAssetModelCompositeModelsRequest, ListAssetModelCompositeModelsResponse } from "../models/models_1";
 ...
 * @public
 */
export class ListAssetModelCompositeModelsCommand extends command<ListAssetModelCompositeModelsCommandInput, ListAssetModelCompositeModelsCommandOutput>(
  _ep0,
  _mw0,
