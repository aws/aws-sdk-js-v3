 ...
 * @public
 */
export class BatchGetAssetPropertyAggregatesCommand extends command<BatchGetAssetPropertyAggregatesCommandInput, BatchGetAssetPropertyAggregatesCommandOutput>(
  _ep0,
  _mw0,
