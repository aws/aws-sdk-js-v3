 ...
 * @public
 */
export class PutAssetModelInterfaceRelationshipCommand extends command<PutAssetModelInterfaceRelationshipCommandInput, PutAssetModelInterfaceRelationshipCommandOutput>(
  _ep0,
  _mw0,
