 ...
 * ```javascript
 * import { IoTSiteWiseClient, DescribeWorkspaceCommand } from "@aws-sdk/client-iotsitewise"; // ES Modules import
 * // const { IoTSiteWiseClient, DescribeWorkspaceCommand } = require("@aws-sdk/client-iotsitewise"); // CommonJS import
