 ...
 * @public
 */
export class DescribeAssetModelCompositeModelCommand extends command<DescribeAssetModelCompositeModelCommandInput, DescribeAssetModelCompositeModelCommandOutput>(
  _ep0,
  _mw0,
