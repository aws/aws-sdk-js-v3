 ...
 * @public
 */
export class ListSensitivityInspectionTemplatesCommand extends command<ListSensitivityInspectionTemplatesCommandInput, ListSensitivityInspectionTemplatesCommandOutput>(
  _ep0,
  _mw0,
