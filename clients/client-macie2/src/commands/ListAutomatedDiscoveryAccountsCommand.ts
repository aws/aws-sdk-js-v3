 ...
 * @public
 */
export class ListAutomatedDiscoveryAccountsCommand extends command<ListAutomatedDiscoveryAccountsCommandInput, ListAutomatedDiscoveryAccountsCommandOutput>(
  _ep0,
  _mw0,
