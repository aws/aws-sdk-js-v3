 ...
 * @public
 */
export class GetSensitiveDataOccurrencesAvailabilityCommand extends command<GetSensitiveDataOccurrencesAvailabilityCommandInput, GetSensitiveDataOccurrencesAvailabilityCommandOutput>(
  _ep0,
  _mw0,
