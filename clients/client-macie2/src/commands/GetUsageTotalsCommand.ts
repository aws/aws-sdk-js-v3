...
import type { GetUsageTotalsRequest, GetUsageTotalsResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetUsageTotalsCommand extends command<GetUsageTotalsCommandInput, GetUsageTotalsCommandOutput>(
  _ep0,
  _mw0,
  "GetUsageTotals",
  GetUsageTotals$
