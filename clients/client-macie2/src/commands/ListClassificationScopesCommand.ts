...
import type { ListClassificationScopesRequest, ListClassificationScopesResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListClassificationScopesCommand extends command<ListClassificationScopesCommandInput, ListClassificationScopesCommandOutput>(
  _ep0,
  _mw0,
