 ...
 * @public
 */
export class UpdateSensitivityInspectionTemplateCommand extends command<UpdateSensitivityInspectionTemplateCommandInput, UpdateSensitivityInspectionTemplateCommandOutput>(
  _ep0,
  _mw0,
