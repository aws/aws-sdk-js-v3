 ...
 * @public
 */
export class PutFindingsPublicationConfigurationCommand extends command<PutFindingsPublicationConfigurationCommandInput, PutFindingsPublicationConfigurationCommandOutput>(
  _ep0,
  _mw0,
