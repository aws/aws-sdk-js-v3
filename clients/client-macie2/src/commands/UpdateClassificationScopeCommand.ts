...
import { UpdateClassificationScope$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateClassificationScopeCommand extends command<UpdateClassificationScopeCommandInput, UpdateClassificationScopeCommandOutput>(
  _ep0,
  _mw0,
