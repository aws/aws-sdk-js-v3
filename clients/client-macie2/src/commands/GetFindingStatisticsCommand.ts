...
import type { GetFindingStatisticsRequest, GetFindingStatisticsResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetFindingStatisticsCommand extends command<GetFindingStatisticsCommandInput, GetFindingStatisticsCommandOutput>(
  _ep0,
  _mw0,
