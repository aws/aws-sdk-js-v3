 ...
 * @public
 */
export class GetFindingsPublicationConfigurationCommand extends command<GetFindingsPublicationConfigurationCommandInput, GetFindingsPublicationConfigurationCommandOutput>(
  _ep0,
  _mw0,
