...
import { UpdateMemberSession$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateMemberSessionCommand extends command<UpdateMemberSessionCommandInput, UpdateMemberSessionCommandOutput>(
  _ep0,
  _mw0,
  "UpdateMemberSession",
  UpdateMemberSession$
