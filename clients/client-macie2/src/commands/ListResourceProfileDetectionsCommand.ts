 ...
 * @public
 */
export class ListResourceProfileDetectionsCommand extends command<ListResourceProfileDetectionsCommandInput, ListResourceProfileDetectionsCommandOutput>(
  _ep0,
  _mw0,
