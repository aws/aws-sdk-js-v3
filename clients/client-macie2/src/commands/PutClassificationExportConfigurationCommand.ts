 ...
 * @public
 */
export class PutClassificationExportConfigurationCommand extends command<PutClassificationExportConfigurationCommandInput, PutClassificationExportConfigurationCommandOutput>(
  _ep0,
  _mw0,
