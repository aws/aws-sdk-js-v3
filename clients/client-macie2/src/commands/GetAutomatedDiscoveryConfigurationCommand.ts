 ...
 * @public
 */
export class GetAutomatedDiscoveryConfigurationCommand extends command<GetAutomatedDiscoveryConfigurationCommandInput, GetAutomatedDiscoveryConfigurationCommandOutput>(
  _ep0,
  _mw0,
