...
export type GetAdministratorAccountCommandInput = GetAdministratorAccountRequest;
export type GetAdministratorAccountCommandOutput = GetAdministratorAccountResponse & __MetadataBearer;
