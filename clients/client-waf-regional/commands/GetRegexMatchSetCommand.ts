...
export type GetRegexMatchSetCommandOutput = GetRegexMatchSetResponse;

export class GetRegexMatchSetCommand extends $Command<GetRegexMatchSetCommandInput, GetRegexMatchSetCommandOutput, WAFRegionalClientResolvedConfig> {
