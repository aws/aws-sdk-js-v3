...
import type { ListRecommendationTemplatesRequest, ListRecommendationTemplatesResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListRecommendationTemplatesCommand extends command<ListRecommendationTemplatesCommandInput, ListRecommendationTemplatesCommandOutput>(
  _ep0,
  _mw0,
