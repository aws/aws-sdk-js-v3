 ...
 * @public
 */
export class RemoveDraftAppVersionResourceMappingsCommand extends command<RemoveDraftAppVersionResourceMappingsCommandInput, RemoveDraftAppVersionResourceMappingsCommandOutput>(
  _ep0,
  _mw0,
