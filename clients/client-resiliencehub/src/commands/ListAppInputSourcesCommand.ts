...
import type { ListAppInputSourcesRequest, ListAppInputSourcesResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListAppInputSourcesCommand extends command<ListAppInputSourcesCommandInput, ListAppInputSourcesCommandOutput>(
  _ep0,
  _mw0,
  "ListAppInputSources",
  ListAppInputSources$
