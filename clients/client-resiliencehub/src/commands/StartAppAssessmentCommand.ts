...
import type { StartAppAssessmentRequest, StartAppAssessmentResponse } from "../models/models_0";
 ...
 * @public
 */
export class StartAppAssessmentCommand extends command<StartAppAssessmentCommandInput, StartAppAssessmentCommandOutput>(
  _ep0,
  _mw0,
  "StartAppAssessment",
  StartAppAssessment$
