...
import type { DescribeResiliencyPolicyRequest, DescribeResiliencyPolicyResponse } from "../models/models_0";
 ...
 * @public
 */
export class DescribeResiliencyPolicyCommand extends command<DescribeResiliencyPolicyCommandInput, DescribeResiliencyPolicyCommandOutput>(
  _ep0,
  _mw0,
