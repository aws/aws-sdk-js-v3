...
import type { DescribeAppVersionAppComponentRequest, DescribeAppVersionAppComponentResponse } from "../models/models_0";
 ...
 * @public
 */
export class DescribeAppVersionAppComponentCommand extends command<DescribeAppVersionAppComponentCommandInput, DescribeAppVersionAppComponentCommandOutput>(
  _ep0,
  _mw0,
