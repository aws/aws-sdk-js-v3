...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: ListAppComponentRecommendationsRequest.filterSensitiveLog,
      outputFilterSensitiveLog: ListAppComponentRecommendationsResponse.filterSensitiveLog,
    };
