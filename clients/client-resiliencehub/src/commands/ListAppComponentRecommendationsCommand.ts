 ...
 * @public
 */
export class ListAppComponentRecommendationsCommand extends command<ListAppComponentRecommendationsCommandInput, ListAppComponentRecommendationsCommandOutput>(
  _ep0,
  _mw0,
