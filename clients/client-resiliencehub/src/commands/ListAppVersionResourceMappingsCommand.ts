 ...
 * @public
 */
export class ListAppVersionResourceMappingsCommand extends command<ListAppVersionResourceMappingsCommandInput, ListAppVersionResourceMappingsCommandOutput>(
  _ep0,
  _mw0,
