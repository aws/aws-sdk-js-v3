...
import type { PublishAppVersionRequest, PublishAppVersionResponse } from "../models/models_0";
 ...
 * @public
 */
export class PublishAppVersionCommand extends command<PublishAppVersionCommandInput, PublishAppVersionCommandOutput>(
  _ep0,
  _mw0,
  "PublishAppVersion",
  PublishAppVersion$
