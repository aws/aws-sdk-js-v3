...
import type { ListAlarmRecommendationsRequest, ListAlarmRecommendationsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListAlarmRecommendationsCommand extends command<ListAlarmRecommendationsCommandInput, ListAlarmRecommendationsCommandOutput>(
  _ep0,
  _mw0,
