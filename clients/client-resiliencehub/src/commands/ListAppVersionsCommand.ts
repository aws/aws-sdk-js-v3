...
import type { ListAppVersionsRequest, ListAppVersionsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListAppVersionsCommand extends command<ListAppVersionsCommandInput, ListAppVersionsCommandOutput>(
  _ep0,
  _mw0,
  "ListAppVersions",
  ListAppVersions$
