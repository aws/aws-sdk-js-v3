...
import { RejectResourceGroupingRecommendations } from "../schemas/schemas_2_App";
 ...
 *   ],
 * };
 * const command = new RejectResourceGroupingRecommendationsCommand(input);
 ...
 * ```
 *
 * @param RejectResourceGroupingRecommendationsCommandInput - {@link RejectResourceGroupingRecommendationsCommandInput}
 * @returns {@link RejectResourceGroupingRecommendationsCommandOutput}
 * @see {@link RejectResourceGroupingRecommendationsCommandInput} for command's `input` shape.
 * @see {@link RejectResourceGroupingRecommendationsCommandOutput} for command's `response` shape.
...
export class RejectResourceGroupingRecommendationsCommand extends $Command
  ...
  protected declare static __types: {
    ...
    sdk: {
      ...
      output: RejectResourceGroupingRecommendationsCommandOutput;
    };
  };
}
