 ...
 * @public
 */
export class DescribeResourceGroupingRecommendationTaskCommand extends command<DescribeResourceGroupingRecommendationTaskCommandInput, DescribeResourceGroupingRecommendationTaskCommandOutput>(
  _ep0,
  _mw0,
