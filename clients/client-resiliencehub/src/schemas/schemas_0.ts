...
export var AssessmentSummary$: StaticStructureSchema = [3, n0, _ASs,
  0,
  [_su, _rR],
...
export var ListRecommendationTemplatesResponse$: StaticStructureSchema = [3, n0, _LRTRi,
  0,
  [_nT, _rTeco],
  [0, [() => RecommendationTemplateList, 0]]
];
export var ListResiliencyPoliciesRequest$: StaticStructureSchema = [3, n0, _LRPR,
  0,
  [_pN, _nT, _mR],
...
export var ResiliencyPolicy$: StaticStructureSchema = [3, n0, _RP,
  0,
...
export var ResourceErrorsDetails$: StaticStructureSchema = [3, n0, _RED,
  0,
  [_rEe, _hME],
  [() => ResourceErrorList, 2]
];
...
export var ScoringComponentResiliencyScore$: StaticStructureSchema = [3, n0, _SCRS,
  0,
  [_sc, _pS, _oC, _eC],
  [1, 1, 1, 1]
];
...
var AlarmRecommendationList: StaticListSchema = [1, n0, _ARL,
  0, () => AlarmRecommendation$
];
var AlarmReferenceIdList = 64 | 0;
var AppAssessmentSummaryList: StaticListSchema = [1, n0, _AASL,
  0, () => AppAssessmentSummary$
];
var AppComponentList: StaticListSchema = [1, n0, _ACL,
  0, () => AppComponent$
];
var AppComponentNameList = 64 | 0;
var AppInputSourceList: StaticListSchema = [1, n0, _AISL,
  0, () => AppInputSource$
];
var AppSummaryList: StaticListSchema = [1, n0, _ASL,
  0, () => AppSummary$
];
var AppVersionList: StaticListSchema = [1, n0, _AVL,
  0, () => AppVersionSummary$
];
var ArnList = 64 | 0;
var AssessmentRiskRecommendationList: StaticListSchema = [1, n0, _ARRL,
  0, () => AssessmentRiskRecommendation$
];
var AssessmentStatusList = 64 | 0;
var BatchUpdateRecommendationStatusFailedEntries: StaticListSchema = [1, n0, _BURSFEa,
  0, () => BatchUpdateRecommendationStatusFailedEntry$
];
var BatchUpdateRecommendationStatusSuccessfulEntries: StaticListSchema = [1, n0, _BURSSEa,
  0, () => BatchUpdateRecommendationStatusSuccessfulEntry$
];
var ComplianceDriftList: StaticListSchema = [1, n0, _CDL,
  0, () => ComplianceDrift$
];
var ComponentCompliancesList: StaticListSchema = [1, n0, _CCL,
  0, () => AppComponentCompliance$
];
var ComponentRecommendationList: StaticListSchema = [1, n0, _CRL,
  0, () => ComponentRecommendation$
];
var ConditionList: StaticListSchema = [1, n0, _CL,
  0, () => Condition$
];
var ConfigRecommendationList: StaticListSchema = [1, n0, _CRLo,
  0, () => ConfigRecommendation$
];
var EksNamespaceList = 64 | 0;
var EksSourceList: StaticListSchema = [1, n0, _ESL,
  0, () => EksSource$
];
...
var EventSubscriptionList: StaticListSchema = [1, n0, _ESLv,
  0, () => EventSubscription$
];
var FailedGroupingRecommendationEntries: StaticListSchema = [1, n0, _FGREa,
  0, () => FailedGroupingRecommendationEntry$
];
var FieldList: StaticListSchema = [1, n0, _FL,
  0, () => Field$
];
var GroupingRecommendationList: StaticListSchema = [1, n0, _GRL,
  0, () => GroupingRecommendation$
];
var GroupingResourceList: StaticListSchema = [1, n0, _GRLr,
  0, () => GroupingResource$
];
var IamRoleArnList = 64 | 0;
var PhysicalResourceList: StaticListSchema = [1, n0, _PRL,
  0, () => PhysicalResource$
];
var RecommendationIdList = 64 | 0;
var RecommendationItemList: StaticListSchema = [1, n0, _RIL,
  0, () => RecommendationItem$
];
var RecommendationTemplateList: StaticListSchema = [1, n0, _RTL,
  0, [() => RecommendationTemplate$,
    0]
];
var RecommendationTemplateStatusList = 64 | 0;
var RejectGroupingRecommendationEntries: StaticListSchema = [1, n0, _RGREe,
  0, () => RejectGroupingRecommendationEntry$
];
var RenderRecommendationTypeList = 64 | 0;
var ResiliencyPolicies: StaticListSchema = [1, n0, _RPe,
  0, [() => ResiliencyPolicy$,
    0]
];
var ResourceDriftList: StaticListSchema = [1, n0, _RDL,
  0, () => ResourceDrift$
];
var ResourceErrorList: StaticListSchema = [1, n0, _REL,
  0, () => ResourceError$
];
var ResourceMappingList: StaticListSchema = [1, n0, _RML,
  0, () => ResourceMapping$
];
var Row = 64 | 0;
...
var SopRecommendationList: StaticListSchema = [1, n0, _SRL,
  0, () => SopRecommendation$
];
var SortList: StaticListSchema = [1, n0, _SLo,
  0, () => Sort$
];
...
var TerraformSourceList: StaticListSchema = [1, n0, _TSL,
  0, () => TerraformSource$
];
var TestRecommendationList: StaticListSchema = [1, n0, _TRL,
  0, () => TestRecommendation$
];
var UnsupportedResourceList: StaticListSchema = [1, n0, _URL,
  0, () => UnsupportedResource$
];
var UpdateRecommendationStatusRequestEntries: StaticListSchema = [1, n0, _URSREp,
  0, () => UpdateRecommendationStatusRequestEntry$
];
var AdditionalInfoMap: StaticMapSchema = [2, n0, _AIM,
  0, 0, 64 | 0
];
var AssessmentCompliance: StaticMapSchema = [2, n0, _ACs,
  0, 0, () => DisruptionCompliance$
];
var DisruptionPolicy: StaticMapSchema = [2, n0, _DP,
  0, 0, () => FailurePolicy$
];
var DisruptionResiliencyScore = 128 | 1;
var RecommendationCompliance: StaticMapSchema = [2, n0, _RC,
  0, 0, () => RecommendationDisruptionCompliance$
];
var ScoringComponentResiliencyScores: StaticMapSchema = [2, n0, _SCRSc,
  0, 0, () => ScoringComponentResiliencyScore$
];
var TagMap: StaticMapSchema = [2, n0, _TM,
  8, 0, 0
];
export var AcceptResourceGroupingRecommendations$: StaticOperationSchema = [9, n0, _ARGR,
...
export var AddDraftAppVersionResourceMappings$: StaticOperationSchema = [9, n0, _ADAVRM,
...
export var BatchUpdateRecommendationStatus$: StaticOperationSchema = [9, n0, _BURS,
...
export var DescribeAppAssessment$: StaticOperationSchema = [9, n0, _DAAe,
  { [_h]: ["POST", "/describe-app-assessment", 200] }, () => DescribeAppAssessmentRequest$, () => DescribeAppAssessmentResponse$
];
export var DescribeAppVersion$: StaticOperationSchema = [9, n0, _DAV,
  { [_h]: ["POST", "/describe-app-version", 200] }, () => DescribeAppVersionRequest$, () => DescribeAppVersionResponse$
];
export var DescribeAppVersionAppComponent$: StaticOperationSchema = [9, n0, _DAVACe,
...
export var DescribeAppVersionResource$: StaticOperationSchema = [9, n0, _DAVRes,
  { [_h]: ["POST", "/describe-app-version-resource", 200] }, () => DescribeAppVersionResourceRequest$, () => DescribeAppVersionResourceResponse$
];
export var DescribeAppVersionResourcesResolutionStatus$: StaticOperationSchema = [9, n0, _DAVRRS,
...
export var DescribeAppVersionTemplate$: StaticOperationSchema = [9, n0, _DAVT,
  { [_h]: ["POST", "/describe-app-version-template", 200] }, () => DescribeAppVersionTemplateRequest$, () => DescribeAppVersionTemplateResponse$
];
export var DescribeDraftAppVersionResourcesImportStatus$: StaticOperationSchema = [9, n0, _DDAVRIS,
...
export var DescribeMetricsExport$: StaticOperationSchema = [9, n0, _DME,
  { [_h]: ["POST", "/describe-metrics-export", 200] }, () => DescribeMetricsExportRequest$, () => DescribeMetricsExportResponse$
];
export var DescribeResiliencyPolicy$: StaticOperationSchema = [9, n0, _DRPe,
  { [_h]: ["POST", "/describe-resiliency-policy", 200] }, () => DescribeResiliencyPolicyRequest$, () => DescribeResiliencyPolicyResponse$
];
export var DescribeResourceGroupingRecommendationTask$: StaticOperationSchema = [9, n0, _DRGRT,
...
export var ImportResourcesToDraftAppVersion$: StaticOperationSchema = [9, n0, _IRTDAV,
...
export var ListAlarmRecommendations$: StaticOperationSchema = [9, n0, _LARis,
  { [_h]: ["POST", "/list-alarm-recommendations", 200] }, () => ListAlarmRecommendationsRequest$, () => ListAlarmRecommendationsResponse$
];
export var ListAppAssessmentComplianceDrifts$: StaticOperationSchema = [9, n0, _LAACD,
...
export var ListAppAssessmentResourceDrifts$: StaticOperationSchema = [9, n0, _LAARD,
...
export var ListAppAssessments$: StaticOperationSchema = [9, n0, _LAA,
  { [_h]: ["GET", "/list-app-assessments", 200] }, () => ListAppAssessmentsRequest$, () => ListAppAssessmentsResponse$
];
export var ListAppComponentCompliances$: StaticOperationSchema = [9, n0, _LACC,
  { [_h]: ["POST", "/list-app-component-compliances", 200] }, () => ListAppComponentCompliancesRequest$, () => ListAppComponentCompliancesResponse$
];
export var ListAppComponentRecommendations$: StaticOperationSchema = [9, n0, _LACR,
...
export var ListAppInputSources$: StaticOperationSchema = [9, n0, _LAIS,
...
export var ListAppVersionAppComponents$: StaticOperationSchema = [9, n0, _LAVAC,
  { [_h]: ["POST", "/list-app-version-app-components", 200] }, () => ListAppVersionAppComponentsRequest$, () => ListAppVersionAppComponentsResponse$
];
export var ListAppVersionResourceMappings$: StaticOperationSchema = [9, n0, _LAVRM,
...
export var ListAppVersionResources$: StaticOperationSchema = [9, n0, _LAVRis,
  { [_h]: ["POST", "/list-app-version-resources", 200] }, () => ListAppVersionResourcesRequest$, () => ListAppVersionResourcesResponse$
];
export var ListAppVersions$: StaticOperationSchema = [9, n0, _LAV,
...
export var ListRecommendationTemplates$: StaticOperationSchema = [9, n0, _LRT,
  { [_h]: ["GET", "/list-recommendation-templates", 200] }, () => ListRecommendationTemplatesRequest$, () => ListRecommendationTemplatesResponse$
];
export var ListResiliencyPolicies$: StaticOperationSchema = [9, n0, _LRP,
  { [_h]: ["GET", "/list-resiliency-policies", 200] }, () => ListResiliencyPoliciesRequest$, () => ListResiliencyPoliciesResponse$
];
export var ListResourceGroupingRecommendations$: StaticOperationSchema = [9, n0, _LRGR,
...
export var ListSopRecommendations$: StaticOperationSchema = [9, n0, _LSR,
  { [_h]: ["POST", "/list-sop-recommendations", 200] }, () => ListSopRecommendationsRequest$, () => ListSopRecommendationsResponse$
];
export var ListSuggestedResiliencyPolicies$: StaticOperationSchema = [9, n0, _LSRP,
...
export var ListTestRecommendations$: StaticOperationSchema = [9, n0, _LTR,
  { [_h]: ["POST", "/list-test-recommendations", 200] }, () => ListTestRecommendationsRequest$, () => ListTestRecommendationsResponse$
];
export var ListUnsupportedAppVersionResources$: StaticOperationSchema = [9, n0, _LUAVR,
...
export var PublishAppVersion$: StaticOperationSchema = [9, n0, _PAV,
  { [_h]: ["POST", "/publish-app-version", 200] }, () => PublishAppVersionRequest$, () => PublishAppVersionResponse$
];
export var PutDraftAppVersionTemplate$: StaticOperationSchema = [9, n0, _PDAVT,
  { [_h]: ["POST", "/put-draft-app-version-template", 200] }, () => PutDraftAppVersionTemplateRequest$, () => PutDraftAppVersionTemplateResponse$
];
export var RejectResourceGroupingRecommendations$: StaticOperationSchema = [9, n0, _RRGR,
...
export var RemoveDraftAppVersionResourceMappings$: StaticOperationSchema = [9, n0, _RDAVRM,
