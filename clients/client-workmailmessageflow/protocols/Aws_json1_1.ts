...
const deserializeAws_json1_1AssociateDelegateToResourceCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.workmailmessageflow#EntityNotFoundException":
      response = {
    ...
    case "com.amazonaws.workmailmessageflow#EntityStateException":
      response = {
    ...
    case "com.amazonaws.workmailmessageflow#InvalidParameterException":
      response = {
    ...
    case "com.amazonaws.workmailmessageflow#OrganizationNotFoundException":
      response = {
    ...
    case "com.amazonaws.workmailmessageflow#OrganizationStateException":
      response = {
...
const deserializeAws_json1_1AssociateMemberToGroupCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.workmailmessageflow#DirectoryServiceAuthenticationFailedException":
      response = {
    ...
    case "com.amazonaws.workmailmessageflow#DirectoryUnavailableException":
      response = {
    ...
    case "com.amazonaws.workmailmessageflow#UnsupportedOperationException":
      response = {
...
const deserializeAws_json1_1CreateAliasCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.workmailmessageflow#EmailAddressInUseException":
      response = {
    ...
    case "com.amazonaws.workmailmessageflow#LimitExceededException":
      response = {
    ...
    case "com.amazonaws.workmailmessageflow#MailDomainNotFoundException":
      response = {
    ...
    case "com.amazonaws.workmailmessageflow#MailDomainStateException":
      response = {
...
const deserializeAws_json1_1CreateGroupCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.workmailmessageflow#NameAvailabilityException":
      response = {
    ...
    case "com.amazonaws.workmailmessageflow#ReservedNameException":
      response = {
...
const deserializeAws_json1_1CreateUserCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.workmailmessageflow#InvalidPasswordException":
      response = {
...
export const deserializeAws_json1_1DeleteAccessControlRuleCommand = async (
  ...
  const response: DeleteAccessControlRuleCommandOutput = {
    $metadata: deserializeMetadata(output),
    __type: "DeleteAccessControlRuleResponse",
    ...contents,
  };
  return Promise.resolve(response);
};
...
export const deserializeAws_json1_1DeleteRetentionPolicyCommand = async (
  ...
  const response: DeleteRetentionPolicyCommandOutput = {
    $metadata: deserializeMetadata(output),
    __type: "DeleteRetentionPolicyResponse",
    ...contents,
  };
  return Promise.resolve(response);
};
...
export const deserializeAws_json1_1GetAccessControlEffectCommand = async (
  ...
  const response: GetAccessControlEffectCommandOutput = {
    $metadata: deserializeMetadata(output),
    __type: "GetAccessControlEffectResponse",
    ...contents,
  };
  return Promise.resolve(response);
};
...
export const deserializeAws_json1_1GetDefaultRetentionPolicyCommand = async (
  ...
  const response: GetDefaultRetentionPolicyCommandOutput = {
    $metadata: deserializeMetadata(output),
    __type: "GetDefaultRetentionPolicyResponse",
    ...contents,
  };
  return Promise.resolve(response);
};
...
export const deserializeAws_json1_1ListAccessControlRulesCommand = async (
  ...
  const response: ListAccessControlRulesCommandOutput = {
    $metadata: deserializeMetadata(output),
    __type: "ListAccessControlRulesResponse",
    ...contents,
  };
  return Promise.resolve(response);
};
...
export const deserializeAws_json1_1PutAccessControlRuleCommand = async (
  ...
  const response: PutAccessControlRuleCommandOutput = {
    $metadata: deserializeMetadata(output),
    __type: "PutAccessControlRuleResponse",
    ...contents,
  };
  return Promise.resolve(response);
};
...
export const deserializeAws_json1_1PutRetentionPolicyCommand = async (
  ...
  const response: PutRetentionPolicyCommandOutput = {
    $metadata: deserializeMetadata(output),
    __type: "PutRetentionPolicyResponse",
    ...contents,
  };
  return Promise.resolve(response);
};
...
const deserializeAws_json1_1RegisterToWorkMailCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.workmailmessageflow#EntityAlreadyRegisteredException":
      response = {
...
const deserializeAws_json1_1TagResourceCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.workmailmessageflow#TooManyTagsException":
      response = {
...
const deserializeAws_json1_1UpdateResourceCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.workmailmessageflow#InvalidConfigurationException":
      response = {
