...
import { type SNSClientResolvedConfig, SNSClientConfig } from "../SNSClient";
 ...
 * @internal
 */
export const defaultSNSHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SNSHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultSNSHttpAuthSchemeProvider: SNSHttpAuthSchemeProvider = (authParameters) => {
