...
import { type WAFClientResolvedConfig, WAFClientConfig } from "../WAFClient";
 ...
 * @internal
 */
export const defaultWAFHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: WAFHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<WAFClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultWAFHttpAuthSchemeProvider: WAFHttpAuthSchemeProvider = (authParameters) => {
