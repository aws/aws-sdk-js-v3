...
import type { ListGeoMatchSetsRequest, ListGeoMatchSetsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListGeoMatchSetsCommand extends command<ListGeoMatchSetsCommandInput, ListGeoMatchSetsCommandOutput>(
  _ep0,
  _mw0,
  "ListGeoMatchSets",
  ListGeoMatchSets$
