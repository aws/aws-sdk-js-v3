...
import type { CreateSizeConstraintSetRequest, CreateSizeConstraintSetResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateSizeConstraintSetCommand extends command<CreateSizeConstraintSetCommandInput, CreateSizeConstraintSetCommandOutput>(
  _ep0,
  _mw0,
