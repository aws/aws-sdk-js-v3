...
const deserializeAws_json1_1GetChangeTokenStatusResponse = (
  ...
  return {
    __type: "GetChangeTokenStatusResponse",
    ChangeTokenStatus:
      output.ChangeTokenStatus !== undefined && output.ChangeTokenStatus !== null ? output.ChangeTokenStatus : undefined
  } as any;
};
...
const deserializeAws_json1_1RegexPatternSetSummary = (output: any, context: __SerdeContext): RegexPatternSetSummary => {
  return {
    ...
    Name: output.Name !== undefined && output.Name !== null ? output.Name : undefined,
    RegexPatternSetId:
      output.RegexPatternSetId !== undefined && output.RegexPatternSetId !== null ? output.RegexPatternSetId : undefined
  } as any;
};
