...
export interface WAFBadRequestException extends _smithy.SmithyException, $MetadataBearer {
 ...
 * 	
 */
export interface WAFDisallowedNameException extends _smithy.SmithyException, $MetadataBearer {
 ...
 * 	
 */
export interface WAFInvalidAccountException extends _smithy.SmithyException, $MetadataBearer {
 ...
 * 	
 */
export interface WAFInvalidOperationException extends _smithy.SmithyException, $MetadataBearer {
 ...
 *
 */
export interface WAFInvalidPermissionPolicyException extends _smithy.SmithyException, $MetadataBearer {
 ...
 *
 */
export interface WAFInvalidRegexPatternException extends _smithy.SmithyException, $MetadataBearer {
 ...
 * 	
 */
export interface WAFNonEmptyEntityException extends _smithy.SmithyException, $MetadataBearer {
 ...
 * 	
 */
export interface WAFNonexistentContainerException extends _smithy.SmithyException, $MetadataBearer {
 ...
 * 	
 */
export interface WAFReferencedItemException extends _smithy.SmithyException, $MetadataBearer {
 ...
 * 	
 */
export interface WAFStaleDataException extends _smithy.SmithyException, $MetadataBearer {
 ...
 *
 */
export interface WAFSubscriptionNotFoundException extends _smithy.SmithyException, $MetadataBearer {
