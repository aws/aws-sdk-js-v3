...
const AWS_TEMPLATE = "xray.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "xray.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "xray.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "xray.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "xray.{region}.amazonaws.com";
