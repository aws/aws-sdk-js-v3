 ...
 * @public
 */
export class UpdateTraceSegmentDestinationCommand extends command<UpdateTraceSegmentDestinationCommandInput, UpdateTraceSegmentDestinationCommandOutput>(
  _ep0,
  _mw0,
