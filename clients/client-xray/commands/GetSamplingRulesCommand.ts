...
import {
  deserializeAws_restJson1_1GetSamplingRulesCommand,
  serializeAws_restJson1_1GetSamplingRulesCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetSamplingRulesCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetSamplingRulesCommand(output, context);
  }
