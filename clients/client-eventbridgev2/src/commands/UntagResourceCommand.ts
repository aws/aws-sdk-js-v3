 ...
 * ```javascript
 * import { EventBridgeV2Client, UntagResourceCommand } from "@aws-sdk/client-eventbridgev2"; // ES Modules import
 * // const { EventBridgeV2Client, UntagResourceCommand } = require("@aws-sdk/client-eventbridgev2"); // CommonJS import
