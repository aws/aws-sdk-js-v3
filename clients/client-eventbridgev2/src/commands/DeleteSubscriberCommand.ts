 ...
 * ```javascript
 * import { EventBridgeV2Client, DeleteSubscriberCommand } from "@aws-sdk/client-eventbridgev2"; // ES Modules import
 * // const { EventBridgeV2Client, DeleteSubscriberCommand } = require("@aws-sdk/client-eventbridgev2"); // CommonJS import
