...
export var AutoScalingSettings$: StaticStructureSchema = [3, n0, _ASS,
  0,
  [_aSD, _mU, _mUa, _sP],
  [2, 1, 1, () => AutoScalingPolicy$]
];
export var AutoScalingSpecification$: StaticStructureSchema = [3, n0, _ASSu,
  0,
  [_wCAS, _rCAS],
...
var ColumnDefinitionList: StaticListSchema = [1, n0, _CDL,
  0, () => ColumnDefinition$
];
var FieldList: StaticListSchema = [1, n0, _FL,
  0, () => FieldDefinition$
];
var KeyspaceSummaryList: StaticListSchema = [1, n0, _KSL,
  0, () => KeyspaceSummary$
];
var PartitionKeyList: StaticListSchema = [1, n0, _PKL,
  0, () => PartitionKey$
];
var RegionList = 64 | 0;
var ReplicaAutoScalingSpecificationList: StaticListSchema = [1, n0, _RASSL,
  0, () => ReplicaAutoScalingSpecification$
];
var ReplicaSpecificationList: StaticListSchema = [1, n0, _RSL,
  0, () => ReplicaSpecification$
];
var ReplicaSpecificationSummaryList: StaticListSchema = [1, n0, _RSSL,
  0, () => ReplicaSpecificationSummary$
];
var ReplicationGroupStatusList: StaticListSchema = [1, n0, _RGSL,
  0, () => ReplicationGroupStatus$
];
var StaticColumnList: StaticListSchema = [1, n0, _SCL,
  0, () => StaticColumn$
];
var TableNameList = 64 | 0;
var TableSummaryList: StaticListSchema = [1, n0, _TSL,
  0, () => TableSummary$
];
...
export var CreateKeyspace$: StaticOperationSchema = [9, n0, _CKr,
  0, () => CreateKeyspaceRequest$, () => CreateKeyspaceResponse$
];
export var CreateTable$: StaticOperationSchema = [9, n0, _CT,
  0, () => CreateTableRequest$, () => CreateTableResponse$
];
export var CreateType$: StaticOperationSchema = [9, n0, _CTr,
  0, () => CreateTypeRequest$, () => CreateTypeResponse$
];
export var DeleteKeyspace$: StaticOperationSchema = [9, n0, _DK,
...
export var DeleteType$: StaticOperationSchema = [9, n0, _DTe,
  0, () => DeleteTypeRequest$, () => DeleteTypeResponse$
];
export var GetKeyspace$: StaticOperationSchema = [9, n0, _GK,
...
export var GetTableAutoScalingSettings$: StaticOperationSchema = [9, n0, _GTASS,
  0, () => GetTableAutoScalingSettingsRequest$, () => GetTableAutoScalingSettingsResponse$
];
export var GetType$: StaticOperationSchema = [9, n0, _GTe,
  0, () => GetTypeRequest$, () => GetTypeResponse$
];
export var ListKeyspaces$: StaticOperationSchema = [9, n0, _LK,
...
export var ListTypes$: StaticOperationSchema = [9, n0, _LTi,
  0, () => ListTypesRequest$, () => ListTypesResponse$
];
export var RestoreTable$: StaticOperationSchema = [9, n0, _RT,
...
export var UpdateKeyspace$: StaticOperationSchema = [9, n0, _UK,
