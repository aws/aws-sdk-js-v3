...
import type { GetKeyspaceRequest, GetKeyspaceResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetKeyspaceCommand extends command<GetKeyspaceCommandInput, GetKeyspaceCommandOutput>(
  _ep0,
  _mw0,
  "GetKeyspace",
  GetKeyspace$
