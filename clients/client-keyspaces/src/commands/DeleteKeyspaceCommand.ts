...
import type { DeleteKeyspaceRequest, DeleteKeyspaceResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteKeyspaceCommand extends command<DeleteKeyspaceCommandInput, DeleteKeyspaceCommandOutput>(
  _ep0,
  _mw0,
  "DeleteKeyspace",
  DeleteKeyspace$
