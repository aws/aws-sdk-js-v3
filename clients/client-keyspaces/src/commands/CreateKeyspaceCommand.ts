...
import type { CreateKeyspaceRequest, CreateKeyspaceResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateKeyspaceCommand extends command<CreateKeyspaceCommandInput, CreateKeyspaceCommandOutput>(
  _ep0,
  _mw0,
  "CreateKeyspace",
  CreateKeyspace$
