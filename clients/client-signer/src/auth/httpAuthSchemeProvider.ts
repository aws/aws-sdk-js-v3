...
import { type SignerClientResolvedConfig, SignerClientConfig } from "../SignerClient";
 ...
 * @internal
 */
export const defaultSignerHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SignerHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultSignerHttpAuthSchemeProvider: SignerHttpAuthSchemeProvider = (authParameters) => {
