...
export class GetCognitoEventsCommand extends $Command<GetCognitoEventsCommandInput, GetCognitoEventsCommandOutput, CognitoSyncClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetCognitoEventsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetCognitoEventsCommand(output, context);
  }
