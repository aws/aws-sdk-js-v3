...
import {
  deserializeAws_restJson1_1SetIdentityPoolConfigurationCommand,
  serializeAws_restJson1_1SetIdentityPoolConfigurationCommand,
...
export class SetIdentityPoolConfigurationCommand extends $Command<SetIdentityPoolConfigurationCommandInput, SetIdentityPoolConfigurationCommandOutput, CognitoSyncClientResolvedConfig> {
