...
import type { TestParsingRequest, TestParsingResponse } from "../models/models_0";
 ...
 * @public
 */
export class TestParsingCommand extends command<TestParsingCommandInput, TestParsingCommandOutput>(
  _ep0,
  _mw0,
  "TestParsing",
  TestParsing$
