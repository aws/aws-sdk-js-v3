...
> {
   ...
   * @public
   */
  constructor(readonly input: CreateTransformerCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
    ...
    this.middlewareStack.use(
      getEndpointPlugin(configuration, CreateTransformerCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "CreateTransformerCommand";
   ...
   * @internal
   */
  private serialize(input: CreateTransformerCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_CreateTransformerCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<CreateTransformerCommandOutput> {
    return de_CreateTransformerCommand(output, context);
  }
}
