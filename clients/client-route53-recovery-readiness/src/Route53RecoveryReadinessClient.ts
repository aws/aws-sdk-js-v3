 ...
 * @public
 */
export type Route53RecoveryReadinessClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
 ...
 * @public
 */
export type Route53RecoveryReadinessClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<Route53RecoveryReadinessClientConfig>) {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultRoute53RecoveryReadinessHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: Route53RecoveryReadinessClientResolvedConfig) =>
