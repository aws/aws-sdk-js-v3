...
import type { CreateResourceSetRequest, CreateResourceSetResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateResourceSetCommand extends command<CreateResourceSetCommandInput, CreateResourceSetCommandOutput>(
  _ep0,
  _mw0,
  "CreateResourceSet",
  CreateResourceSet$
