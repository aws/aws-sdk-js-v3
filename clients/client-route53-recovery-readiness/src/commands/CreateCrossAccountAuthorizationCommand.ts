 ...
 * @public
 */
export class CreateCrossAccountAuthorizationCommand extends command<CreateCrossAccountAuthorizationCommandInput, CreateCrossAccountAuthorizationCommandOutput>(
  _ep0,
  _mw0,
