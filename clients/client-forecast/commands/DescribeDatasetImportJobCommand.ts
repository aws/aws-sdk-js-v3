...
export type DescribeDatasetImportJobCommandOutput = DescribeDatasetImportJobResponse;

export class DescribeDatasetImportJobCommand extends $Command<DescribeDatasetImportJobCommandInput, DescribeDatasetImportJobCommandOutput, forecastClientResolvedConfig> {
