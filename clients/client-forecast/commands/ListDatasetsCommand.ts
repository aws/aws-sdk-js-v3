...
export type ListDatasetsCommandOutput = ListDatasetsResponse;

export class ListDatasetsCommand extends $Command<ListDatasetsCommandInput, ListDatasetsCommandOutput, forecastClientResolvedConfig> {
