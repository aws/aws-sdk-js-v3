...
import { type ForecastClientResolvedConfig, ForecastClientConfig } from "../ForecastClient";
 ...
 * @internal
 */
export const defaultForecastHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ForecastHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<ForecastClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultForecastHttpAuthSchemeProvider: ForecastHttpAuthSchemeProvider = (authParameters) => {
