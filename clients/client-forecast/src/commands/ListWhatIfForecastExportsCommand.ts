...
import type { ListWhatIfForecastExportsRequest, ListWhatIfForecastExportsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListWhatIfForecastExportsCommand extends command<ListWhatIfForecastExportsCommandInput, ListWhatIfForecastExportsCommandOutput>(
  _ep0,
  _mw0,
