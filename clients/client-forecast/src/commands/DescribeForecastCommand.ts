...
import type { DescribeForecastRequest, DescribeForecastResponse } from "../models/models_0";
 ...
 * @public
 */
export class DescribeForecastCommand extends command<DescribeForecastCommandInput, DescribeForecastCommandOutput>(
  _ep0,
  _mw0,
  "DescribeForecast",
  DescribeForecast$
