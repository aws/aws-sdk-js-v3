...
import type { DescribeExplainabilityExportRequest, DescribeExplainabilityExportResponse } from "../models/models_0";
 ...
 * @public
 */
export class DescribeExplainabilityExportCommand extends command<DescribeExplainabilityExportCommandInput, DescribeExplainabilityExportCommandOutput>(
  _ep0,
  _mw0,
