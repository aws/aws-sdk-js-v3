...
import type { DeleteWhatIfAnalysisRequest } from "../models/models_0";
 ...
 * @public
 */
export class DeleteWhatIfAnalysisCommand extends command<DeleteWhatIfAnalysisCommandInput, DeleteWhatIfAnalysisCommandOutput>(
  _ep0,
  _mw0,
