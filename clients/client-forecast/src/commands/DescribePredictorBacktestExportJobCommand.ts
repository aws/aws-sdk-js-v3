 ...
 * @public
 */
export class DescribePredictorBacktestExportJobCommand extends command<DescribePredictorBacktestExportJobCommandInput, DescribePredictorBacktestExportJobCommandOutput>(
  _ep0,
  _mw0,
