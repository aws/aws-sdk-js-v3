...
import type { DeleteResourceTreeRequest } from "../models/models_0";
 ...
 * @public
 */
export class DeleteResourceTreeCommand extends command<DeleteResourceTreeCommandInput, DeleteResourceTreeCommandOutput>(
  _ep0,
  _mw0,
  "DeleteResourceTree",
  DeleteResourceTree$
