...
export var BaselineMetric$: StaticStructureSchema = [3, n0, _BM,
  0,
  [_N, _V],
  [0, 1]
];
...
export var DatasetImportJobSummary$: StaticStructureSchema = [3, n0, _DIJS,
  0,
  [_DIJA, _DIJN, _DS, _St, _M, _CT, _LMT, _IM],
  [0, 0, () => DataSource$, 0, 0, 4, 4, 0]
];
export var DatasetSummary$: StaticStructureSchema = [3, n0, _DSa,
  0,
...
export var EvaluationParameters$: StaticStructureSchema = [3, n0, _EPv,
  0,
  [_NOBW, _BTWO],
  [1, 1]
];
...
export var ExplainabilityInfo$: StaticStructureSchema = [3, n0, _EI,
  0,
  [_EA, _St],
  [0, 0]
];
export var ExplainabilitySummary$: StaticStructureSchema = [3, n0, _ES,
  0,
...
export var ForecastSummary$: StaticStructureSchema = [3, n0, _FSo,
  0,
...
export var ListDatasetGroupsResponse$: StaticStructureSchema = [3, n0, _LDGRi,
  0,
  [_DG, _NT],
  [() => DatasetGroups, 0]
];
export var ListDatasetImportJobsRequest$: StaticStructureSchema = [3, n0, _LDIJR,
  0,
  [_NT, _MR, _Fil],
  [0, 1, () => Filters]
];
export var ListDatasetImportJobsResponse$: StaticStructureSchema = [3, n0, _LDIJRi,
  0,
  [_DIJ, _NT],
  [() => DatasetImportJobs, 0]
];
...
export var ListExplainabilitiesRequest$: StaticStructureSchema = [3, n0, _LER,
  0,
  [_NT, _MR, _Fil],
  [0, 1, () => Filters]
];
export var ListExplainabilitiesResponse$: StaticStructureSchema = [3, n0, _LERi,
  0,
  [_E, _NT],
  [() => Explainabilities, 0]
];
export var ListExplainabilityExportsRequest$: StaticStructureSchema = [3, n0, _LEER,
  0,
  [_NT, _MR, _Fil],
  [0, 1, () => Filters]
];
export var ListExplainabilityExportsResponse$: StaticStructureSchema = [3, n0, _LEERi,
  0,
  [_EE, _NT],
  [() => ExplainabilityExports, 0]
];
export var ListForecastExportJobsRequest$: StaticStructureSchema = [3, n0, _LFEJR,
  0,
  [_NT, _MR, _Fil],
  [0, 1, () => Filters]
];
export var ListForecastExportJobsResponse$: StaticStructureSchema = [3, n0, _LFEJRi,
  0,
  [_FEJ, _NT],
  [() => ForecastExportJobs, 0]
];
export var ListForecastsRequest$: StaticStructureSchema = [3, n0, _LFR,
  0,
  [_NT, _MR, _Fil],
  [0, 1, () => Filters]
];
export var ListForecastsResponse$: StaticStructureSchema = [3, n0, _LFRi,
  0,
  [_Fo, _NT],
  [() => Forecasts, 0]
];
...
export var ListPredictorBacktestExportJobsRequest$: StaticStructureSchema = [3, n0, _LPBEJR,
  0,
  [_NT, _MR, _Fil],
  [0, 1, () => Filters]
];
export var ListPredictorBacktestExportJobsResponse$: StaticStructureSchema = [3, n0, _LPBEJRi,
  0,
  [_PBEJ, _NT],
  [() => PredictorBacktestExportJobs, 0]
];
export var ListPredictorsRequest$: StaticStructureSchema = [3, n0, _LPR,
  0,
  [_NT, _MR, _Fil],
  [0, 1, () => Filters]
];
export var ListPredictorsResponse$: StaticStructureSchema = [3, n0, _LPRi,
  0,
  [_P, _NT],
  [() => Predictors, 0]
];
...
export var ListWhatIfAnalysesRequest$: StaticStructureSchema = [3, n0, _LWIAR,
  0,
  [_NT, _MR, _Fil],
  [0, 1, () => Filters]
];
export var ListWhatIfAnalysesResponse$: StaticStructureSchema = [3, n0, _LWIARi,
  0,
  [_WIA, _NT],
  [() => WhatIfAnalyses, 0]
];
export var ListWhatIfForecastExportsRequest$: StaticStructureSchema = [3, n0, _LWIFER,
  0,
  [_NT, _MR, _Fil],
  [0, 1, () => Filters]
];
export var ListWhatIfForecastExportsResponse$: StaticStructureSchema = [3, n0, _LWIFERi,
  0,
  [_WIFE, _NT],
  [() => WhatIfForecastExports, 0]
];
export var ListWhatIfForecastsRequest$: StaticStructureSchema = [3, n0, _LWIFR,
  0,
  [_NT, _MR, _Fil],
  [0, 1, () => Filters]
];
export var ListWhatIfForecastsResponse$: StaticStructureSchema = [3, n0, _LWIFRi,
  0,
  [_WIF, _NT],
  [() => WhatIfForecasts, 0]
];
export var MetricResult$: StaticStructureSchema = [3, n0, _MRe,
  0,
  [_MNe, _MVe],
  [0, 1]
];
...
export var MonitorInfo$: StaticStructureSchema = [3, n0, _MI,
  0,
  [_MA, _St],
  [0, 0]
];
...
export var ParameterRanges$: StaticStructureSchema = [3, n0, _PR,
  0,
  [_CPRa, _CPRon, _IPRn],
  [() => CategoricalParameterRanges, () => ContinuousParameterRanges, () => IntegerParameterRanges]
];
export var PredictorBacktestExportJobSummary$: StaticStructureSchema = [3, n0, _PBEJS,
  0,
  [_PBEJA, _PBEJN, _De, _St, _M, _CT, _LMT],
  [0, 0, () => DataDestination$, 0, 0, 4, 4]
];
export var PredictorBaseline$: StaticStructureSchema = [3, n0, _PB,
  0,
  [_BMa],
  [() => BaselineMetrics]
];
export var PredictorEvent$: StaticStructureSchema = [3, n0, _PE,
  0,
  [_Det, _Dat],
  [0, 4]
];
export var PredictorExecution$: StaticStructureSchema = [3, n0, _PEr,
  0,
  [_AA, _TW],
  [0, () => TestWindowDetails]
];
export var PredictorExecutionDetails$: StaticStructureSchema = [3, n0, _PED,
  0,
  [_PEre],
  [() => PredictorExecutions]
];
export var PredictorMonitorEvaluation$: StaticStructureSchema = [3, n0, _PMEr,
  0,
  [_RA, _MA, _ET, _ESv, _WSD, _WED, _PE, _MDS, _MRet, _NIE, _M],
  [0, 0, 4, 0, 4, 4, () => PredictorEvent$, () => MonitorDataSource$, () => MetricResults, 1, 0]
];
export var PredictorSummary$: StaticStructureSchema = [3, n0, _PS,
  0,
  [_PA, _PN, _DGA, _IAP, _RPS, _St, _M, _CT, _LMT],
  [0, 0, 0, 2, () => ReferencePredictorSummary$, 0, 0, 4, 4]
];
export var ReferencePredictorSummary$: StaticStructureSchema = [3, n0, _RPS,
  0,
  [_Ar, _Sta],
  [0, 0]
];
...
export var SchemaAttribute$: StaticStructureSchema = [3, n0, _SA,
  0,
  [_AN, _AT],
  [0, 0]
];
export var Statistics$: StaticStructureSchema = [3, n0, _Stat,
  0,
...
export var TestWindowSummary$: StaticStructureSchema = [3, n0, _TWS,
  0,
  [_TWSe, _TWE, _St, _M],
  [4, 4, 0, 0]
];
export var TimeAlignmentBoundary$: StaticStructureSchema = [3, n0, _TAB,
  0,
  [_Mon, _DOM, _DOW, _H],
  [0, 1, 0, 1]
];
...
export var TimeSeriesTransformation$: StaticStructureSchema = [3, n0, _TSTi,
  0,
  [_A, _TSCi],
...
export var WeightedQuantileLoss$: StaticStructureSchema = [3, n0, _WQLe,
  0,
  [_Q, _LV],
  [1, 1]
];
export var WhatIfAnalysisSummary$: StaticStructureSchema = [3, n0, _WIAS,
  0,
  [_WIAA, _WIAN, _FA, _St, _M, _CT, _LMT],
  [0, 0, 0, 0, 0, 4, 4]
];
export var WhatIfForecastExportSummary$: StaticStructureSchema = [3, n0, _WIFES,
  0,
  [_WIFEA, _WIFA, _WIFEN, _De, _St, _M, _CT, _LMT],
  [0, 64 | 0, 0, () => DataDestination$, 0, 0, 4, 4]
];
export var WhatIfForecastSummary$: StaticStructureSchema = [3, n0, _WIFS,
  0,
  [_WIFAh, _WIFN, _WIAA, _St, _M, _CT, _LMT],
  [0, 0, 0, 0, 0, 4, 4]
];
export var WindowSummary$: StaticStructureSchema = [3, n0, _WS,
  0,
...
var ArnList = 64 | 0;
var AttributeConfigs: StaticListSchema = [1, n0, _ACt,
  0, () => AttributeConfig$
];
var BaselineMetrics: StaticListSchema = [1, n0, _BMa,
  0, () => BaselineMetric$
];
...
var DatasetGroups: StaticListSchema = [1, n0, _DG,
  0, () => DatasetGroupSummary$
];
var DatasetImportJobs: StaticListSchema = [1, n0, _DIJ,
  0, () => DatasetImportJobSummary$
];
var Datasets: StaticListSchema = [1, n0, _Da,
  0, () => DatasetSummary$
];
var ErrorMetrics: StaticListSchema = [1, n0, _EMr,
  0, () => ErrorMetric$
];
var Explainabilities: StaticListSchema = [1, n0, _E,
  0, () => ExplainabilitySummary$
];
var ExplainabilityExports: StaticListSchema = [1, n0, _EE,
  0, () => ExplainabilityExportSummary$
];
var FeaturizationPipeline: StaticListSchema = [1, n0, _FP,
  0, () => FeaturizationMethod$
];
var Featurizations: StaticListSchema = [1, n0, _Fea,
  0, () => Featurization$
];
...
var ForecastExportJobs: StaticListSchema = [1, n0, _FEJ,
  0, () => ForecastExportJobSummary$
];
var Forecasts: StaticListSchema = [1, n0, _Fo,
  0, () => ForecastSummary$
];
...
var MetricResults: StaticListSchema = [1, n0, _MRet,
  0, () => MetricResult$
];
var Monitors: StaticListSchema = [1, n0, _Mo,
  0, () => MonitorSummary$
];
var PredictorBacktestExportJobs: StaticListSchema = [1, n0, _PBEJ,
  0, () => PredictorBacktestExportJobSummary$
];
var PredictorEvaluationResults: StaticListSchema = [1, n0, _PER,
  0, () => EvaluationResult$
];
var PredictorExecutions: StaticListSchema = [1, n0, _PEre,
  0, () => PredictorExecution$
];
var PredictorMonitorEvaluations: StaticListSchema = [1, n0, _PME,
  0, () => PredictorMonitorEvaluation$
];
var Predictors: StaticListSchema = [1, n0, _P,
  0, () => PredictorSummary$
];
var SchemaAttributes: StaticListSchema = [1, n0, _SAc,
  0, () => SchemaAttribute$
];
var SupplementaryFeatures: StaticListSchema = [1, n0, _SF,
  0, () => SupplementaryFeature$
];
var TagKeys: StaticListSchema = [1, n0, _TKa,
  0, [() => TagKey,
    0]
];
...
var TestWindowDetails: StaticListSchema = [1, n0, _TWD,
  0, () => TestWindowSummary$
];
var TestWindows: StaticListSchema = [1, n0, _TW,
  0, () => WindowSummary$
];
var TimeSeriesConditions: StaticListSchema = [1, n0, _TSCi,
  0, () => TimeSeriesCondition$
];
var TimeSeriesTransformations: StaticListSchema = [1, n0, _TST,
  0, () => TimeSeriesTransformation$
];
var Values = 64 | 0;
var WeightedQuantileLosses: StaticListSchema = [1, n0, _WQL,
  0, () => WeightedQuantileLoss$
];
var WhatIfAnalyses: StaticListSchema = [1, n0, _WIA,
  0, () => WhatIfAnalysisSummary$
];
var WhatIfForecastArnListForExport = 64 | 0;
var WhatIfForecastExports: StaticListSchema = [1, n0, _WIFE,
  0, () => WhatIfForecastExportSummary$
];
var WhatIfForecasts: StaticListSchema = [1, n0, _WIF,
  0, () => WhatIfForecastSummary$
];
var Configuration: StaticMapSchema = [2, n0, _C,
  0, 0, 64 | 0
];
var FeaturizationMethodParameters = 128 | 0;
var FieldStatistics: StaticMapSchema = [2, n0, _FS,
  0, 0, () => Statistics$
];
var TrainingParameters = 128 | 0;
var Transformations = 128 | 0;
export var CreateAutoPredictor$: StaticOperationSchema = [9, n0, _CAP,
...
export var CreateDatasetGroup$: StaticOperationSchema = [9, n0, _CDG,
  0, () => CreateDatasetGroupRequest$, () => CreateDatasetGroupResponse$
];
export var CreateDatasetImportJob$: StaticOperationSchema = [9, n0, _CDIJ,
  0, () => CreateDatasetImportJobRequest$, () => CreateDatasetImportJobResponse$
];
export var CreateExplainability$: StaticOperationSchema = [9, n0, _CE,
  0, () => CreateExplainabilityRequest$, () => CreateExplainabilityResponse$
];
export var CreateExplainabilityExport$: StaticOperationSchema = [9, n0, _CEE,
  0, () => CreateExplainabilityExportRequest$, () => CreateExplainabilityExportResponse$
];
export var CreateForecast$: StaticOperationSchema = [9, n0, _CF,
  0, () => CreateForecastRequest$, () => CreateForecastResponse$
];
export var CreateForecastExportJob$: StaticOperationSchema = [9, n0, _CFEJ,
...
export var CreatePredictor$: StaticOperationSchema = [9, n0, _CP,
  0, () => CreatePredictorRequest$, () => CreatePredictorResponse$
];
export var CreatePredictorBacktestExportJob$: StaticOperationSchema = [9, n0, _CPBEJ,
  0, () => CreatePredictorBacktestExportJobRequest$, () => CreatePredictorBacktestExportJobResponse$
];
export var CreateWhatIfAnalysis$: StaticOperationSchema = [9, n0, _CWIA,
  0, () => CreateWhatIfAnalysisRequest$, () => CreateWhatIfAnalysisResponse$
];
export var CreateWhatIfForecast$: StaticOperationSchema = [9, n0, _CWIF,
  0, () => CreateWhatIfForecastRequest$, () => CreateWhatIfForecastResponse$
];
export var CreateWhatIfForecastExport$: StaticOperationSchema = [9, n0, _CWIFE,
...
export var DeleteDatasetGroup$: StaticOperationSchema = [9, n0, _DDG,
  2, () => DeleteDatasetGroupRequest$, () => __Unit
];
export var DeleteDatasetImportJob$: StaticOperationSchema = [9, n0, _DDIJ,
  2, () => DeleteDatasetImportJobRequest$, () => __Unit
];
export var DeleteExplainability$: StaticOperationSchema = [9, n0, _DE,
  2, () => DeleteExplainabilityRequest$, () => __Unit
];
export var DeleteExplainabilityExport$: StaticOperationSchema = [9, n0, _DEE,
  2, () => DeleteExplainabilityExportRequest$, () => __Unit
];
export var DeleteForecast$: StaticOperationSchema = [9, n0, _DFe,
  2, () => DeleteForecastRequest$, () => __Unit
];
export var DeleteForecastExportJob$: StaticOperationSchema = [9, n0, _DFEJ,
...
export var DeletePredictor$: StaticOperationSchema = [9, n0, _DP,
  2, () => DeletePredictorRequest$, () => __Unit
];
export var DeletePredictorBacktestExportJob$: StaticOperationSchema = [9, n0, _DPBEJ,
  2, () => DeletePredictorBacktestExportJobRequest$, () => __Unit
];
export var DeleteResourceTree$: StaticOperationSchema = [9, n0, _DRT,
  2, () => DeleteResourceTreeRequest$, () => __Unit
];
export var DeleteWhatIfAnalysis$: StaticOperationSchema = [9, n0, _DWIA,
  2, () => DeleteWhatIfAnalysisRequest$, () => __Unit
];
export var DeleteWhatIfForecast$: StaticOperationSchema = [9, n0, _DWIF,
  2, () => DeleteWhatIfForecastRequest$, () => __Unit
];
export var DeleteWhatIfForecastExport$: StaticOperationSchema = [9, n0, _DWIFE,
  2, () => DeleteWhatIfForecastExportRequest$, () => __Unit
];
export var DescribeAutoPredictor$: StaticOperationSchema = [9, n0, _DAP,
...
export var DescribeDatasetGroup$: StaticOperationSchema = [9, n0, _DDGe,
  2, () => DescribeDatasetGroupRequest$, () => DescribeDatasetGroupResponse$
];
export var DescribeDatasetImportJob$: StaticOperationSchema = [9, n0, _DDIJe,
  2, () => DescribeDatasetImportJobRequest$, () => DescribeDatasetImportJobResponse$
];
export var DescribeExplainability$: StaticOperationSchema = [9, n0, _DEe,
  2, () => DescribeExplainabilityRequest$, () => DescribeExplainabilityResponse$
];
export var DescribeExplainabilityExport$: StaticOperationSchema = [9, n0, _DEEe,
  2, () => DescribeExplainabilityExportRequest$, () => DescribeExplainabilityExportResponse$
];
export var DescribeForecast$: StaticOperationSchema = [9, n0, _DFes,
  2, () => DescribeForecastRequest$, () => DescribeForecastResponse$
];
export var DescribeForecastExportJob$: StaticOperationSchema = [9, n0, _DFEJe,
  2, () => DescribeForecastExportJobRequest$, () => DescribeForecastExportJobResponse$
];
export var DescribeMonitor$: StaticOperationSchema = [9, n0, _DMe,
  2, () => DescribeMonitorRequest$, () => DescribeMonitorResponse$
];
export var DescribePredictor$: StaticOperationSchema = [9, n0, _DPe,
  2, () => DescribePredictorRequest$, () => DescribePredictorResponse$
];
export var DescribePredictorBacktestExportJob$: StaticOperationSchema = [9, n0, _DPBEJe,
  2, () => DescribePredictorBacktestExportJobRequest$, () => DescribePredictorBacktestExportJobResponse$
];
export var DescribeWhatIfAnalysis$: StaticOperationSchema = [9, n0, _DWIAe,
  2, () => DescribeWhatIfAnalysisRequest$, () => DescribeWhatIfAnalysisResponse$
];
export var DescribeWhatIfForecast$: StaticOperationSchema = [9, n0, _DWIFe,
  2, () => DescribeWhatIfForecastRequest$, () => DescribeWhatIfForecastResponse$
];
export var DescribeWhatIfForecastExport$: StaticOperationSchema = [9, n0, _DWIFEe,
  2, () => DescribeWhatIfForecastExportRequest$, () => DescribeWhatIfForecastExportResponse$
];
export var GetAccuracyMetrics$: StaticOperationSchema = [9, n0, _GAM,
  2, () => GetAccuracyMetricsRequest$, () => GetAccuracyMetricsResponse$
];
export var ListDatasetGroups$: StaticOperationSchema = [9, n0, _LDG,
  2, () => ListDatasetGroupsRequest$, () => ListDatasetGroupsResponse$
];
export var ListDatasetImportJobs$: StaticOperationSchema = [9, n0, _LDIJ,
...
export var ListExplainabilities$: StaticOperationSchema = [9, n0, _LE,
  2, () => ListExplainabilitiesRequest$, () => ListExplainabilitiesResponse$
];
export var ListExplainabilityExports$: StaticOperationSchema = [9, n0, _LEEi,
  2, () => ListExplainabilityExportsRequest$, () => ListExplainabilityExportsResponse$
];
export var ListForecastExportJobs$: StaticOperationSchema = [9, n0, _LFEJ,
  2, () => ListForecastExportJobsRequest$, () => ListForecastExportJobsResponse$
];
export var ListForecasts$: StaticOperationSchema = [9, n0, _LF,
  2, () => ListForecastsRequest$, () => ListForecastsResponse$
];
export var ListMonitorEvaluations$: StaticOperationSchema = [9, n0, _LME,
...
export var ListPredictorBacktestExportJobs$: StaticOperationSchema = [9, n0, _LPBEJ,
  2, () => ListPredictorBacktestExportJobsRequest$, () => ListPredictorBacktestExportJobsResponse$
];
export var ListPredictors$: StaticOperationSchema = [9, n0, _LP,
  2, () => ListPredictorsRequest$, () => ListPredictorsResponse$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceRequest$, () => ListTagsForResourceResponse$
];
export var ListWhatIfAnalyses$: StaticOperationSchema = [9, n0, _LWIA,
  2, () => ListWhatIfAnalysesRequest$, () => ListWhatIfAnalysesResponse$
];
export var ListWhatIfForecastExports$: StaticOperationSchema = [9, n0, _LWIFE,
  2, () => ListWhatIfForecastExportsRequest$, () => ListWhatIfForecastExportsResponse$
];
export var ListWhatIfForecasts$: StaticOperationSchema = [9, n0, _LWIF,
  2, () => ListWhatIfForecastsRequest$, () => ListWhatIfForecastsResponse$
];
export var ResumeResource$: StaticOperationSchema = [9, n0, _RR,
  2, () => ResumeResourceRequest$, () => __Unit
];
export var StopResource$: StaticOperationSchema = [9, n0, _SR,
...
export var UpdateDatasetGroup$: StaticOperationSchema = [9, n0, _UDG,
