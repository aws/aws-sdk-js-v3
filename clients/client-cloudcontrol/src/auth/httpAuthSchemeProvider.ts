...
import { type CloudControlClientResolvedConfig, CloudControlClientConfig } from "../CloudControlClient";
 ...
 * @internal
 */
export const defaultCloudControlHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CloudControlHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultCloudControlHttpAuthSchemeProvider: CloudControlHttpAuthSchemeProvider = (authParameters) => {
