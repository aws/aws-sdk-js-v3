...
import { RotateIngestEndpointCredentialsRequest, RotateIngestEndpointCredentialsResponse } from "../models/index";
import {
  deserializeAws_restJson1_1RotateIngestEndpointCredentialsCommand,
  serializeAws_restJson1_1RotateIngestEndpointCredentialsCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1RotateIngestEndpointCredentialsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1RotateIngestEndpointCredentialsCommand(output, context);
  }
