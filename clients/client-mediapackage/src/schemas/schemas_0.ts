...
export var IngressAccessLogs$: StaticStructureSchema = [3, n0, _IAL,
  0,
  [_LGN],
  [[0, { [_jN]: _lGN }]]
];
...
var __listOfHarvestJob: StaticListSchema = [1, n0, _lOHJ,
  0, [() => HarvestJob$,
    0]
];
...
var __listOfHlsManifestCreateOrUpdateParameters: StaticListSchema = [1, n0, _lOHMCOUP,
  0, [() => HlsManifestCreateOrUpdateParameters$,
    0]
];
var __listOfIngestEndpoint: StaticListSchema = [1, n0, _lOIE,
  0, [() => IngestEndpoint$,
    0]
];
var __listOfOriginEndpoint: StaticListSchema = [1, n0, _lOOE,
  0, [() => OriginEndpoint$,
    0]
];
var AdTriggers = 64 | 0;
...
export var CreateHarvestJob$: StaticOperationSchema = [9, n0, _CHJ,
...
export var DescribeHarvestJob$: StaticOperationSchema = [9, n0, _DHJ,
  { [_h]: ["GET", "/harvest_jobs/{Id}", 200] }, () => DescribeHarvestJobRequest$, () => DescribeHarvestJobResponse$
];
export var DescribeOriginEndpoint$: StaticOperationSchema = [9, n0, _DOEe,
...
export var RotateChannelCredentials$: StaticOperationSchema = [9, n0, _RCC,
  { [_h]: ["PUT", "/channels/{Id}/credentials", 200] }, () => RotateChannelCredentialsRequest$, () => RotateChannelCredentialsResponse$
];
export var RotateIngestEndpointCredentials$: StaticOperationSchema = [9, n0, _RIEC,
