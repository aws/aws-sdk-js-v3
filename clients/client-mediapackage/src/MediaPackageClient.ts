  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<MediaPackageClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultMediaPackageHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: MediaPackageClientResolvedConfig) =>
