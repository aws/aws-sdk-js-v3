...
import { SustainabilityClientConfig, SustainabilityClientResolvedConfig } from "../SustainabilityClient";
 ...
 * @internal
 */
const _defaultSustainabilityHttpAuthSchemeParametersProvider = async (
  config: SustainabilityClientResolvedConfig,
  context: HandlerExecutionContext,
  input: object
): Promise<_SustainabilityHttpAuthSchemeParameters> => {
  return {
 ...
 * @internal
 */
export const defaultSustainabilityHttpAuthSchemeParametersProvider: SustainabilityHttpAuthSchemeParametersProvider =
  createEndpointRuleSetHttpAuthSchemeParametersProvider(_defaultSustainabilityHttpAuthSchemeParametersProvider);

function createAwsAuthSigv4HttpAuthOption(authParameters: SustainabilityHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<SustainabilityClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
...
function createAwsAuthSigv4aHttpAuthOption(authParameters: SustainabilityHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
interface _SustainabilityHttpAuthSchemeProvider extends HttpAuthSchemeProvider<SustainabilityHttpAuthSchemeParameters> {}
 ...
 * @internal
 */
const _defaultSustainabilityHttpAuthSchemeProvider: _SustainabilityHttpAuthSchemeProvider = (authParameters) => {
  const options: HttpAuthOption[] = [];
 ...
 * @internal
 */
export const defaultSustainabilityHttpAuthSchemeProvider: SustainabilityHttpAuthSchemeProvider = createEndpointRuleSetHttpAuthSchemeProvider(
  defaultEndpointResolver,
  _defaultSustainabilityHttpAuthSchemeProvider, {
