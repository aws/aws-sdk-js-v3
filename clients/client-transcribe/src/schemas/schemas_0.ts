...
export var CallAnalyticsJobDetails$: StaticStructureSchema = [3, n0, _CAJD,
  0,
  [_Sk],
  [() => CallAnalyticsSkippedFeatureList]
];
export var CallAnalyticsJobSettings$: StaticStructureSchema = [3, n0, _CAJSa,
  0,
  [_VN, _VFN, _VFM, _LMN, _CR, _LO, _LIS, _Su],
  [0, 0, 0, 0, () => ContentRedaction$, 64 | 0, () => LanguageIdSettingsMap, () => Summarization$]
];
export var CallAnalyticsJobSummary$: StaticStructureSchema = [3, n0, _CAJSal,
  0,
  [_CAJN, _CT, _ST, _CTo, _LC, _CAJS, _CAJD, _FR],
  [0, 4, 4, 4, 0, 0, () => CallAnalyticsJobDetails$, 0]
];
export var CallAnalyticsSkippedFeature$: StaticStructureSchema = [3, n0, _CASF,
  0,
  [_Fe, _RC, _M],
  [0, 0, 0]
];
export var CategoryProperties$: StaticStructureSchema = [3, n0, _CP,
  0,
  [_CN, _R, _CTr, _LUT, _Ta, _IT],
  [0, () => RuleList, 4, 4, () => TagList, 0]
];
export var ChannelDefinition$: StaticStructureSchema = [3, n0, _CDh,
  0,
  [_CI, _PR],
  [1, 0]
];
...
export var JobExecutionSettings$: StaticStructureSchema = [3, n0, _JES,
  0,
  [_ADE, _DARA],
  [2, 0]
];
export var LanguageCodeItem$: StaticStructureSchema = [3, n0, _LCI,
  0,
  [_LC, _DIS],
  [0, 1]
];
export var LanguageIdSettings$: StaticStructureSchema = [3, n0, _LIS,
  0,
  [_VN, _VFN, _LMN],
  [0, 0, 0]
];
...
export var ListCallAnalyticsCategoriesResponse$: StaticStructureSchema = [3, n0, _LCACRi,
  0,
  [_NTe, _C],
  [0, () => CategoryPropertiesList]
];
export var ListCallAnalyticsJobsRequest$: StaticStructureSchema = [3, n0, _LCAJR,
  0,
  [_St, _JNC, _NTe, _MR],
  [[0, { [_hQ]: _St }], [0, { [_hQ]: _JNC }], [0, { [_hQ]: _NTe }], [1, { [_hQ]: _MR }]]
];
export var ListCallAnalyticsJobsResponse$: StaticStructureSchema = [3, n0, _LCAJRi,
  0,
  [_St, _NTe, _CAJSall],
  [0, 0, () => CallAnalyticsJobSummaries]
];
export var ListLanguageModelsRequest$: StaticStructureSchema = [3, n0, _LLMR,
  0,
  [_SE, _NC, _NTe, _MR],
  [[0, { [_hQ]: _SEt }], [0, { [_hQ]: _NC }], [0, { [_hQ]: _NTe }], [1, { [_hQ]: _MR }]]
];
export var ListLanguageModelsResponse$: StaticStructureSchema = [3, n0, _LLMRi,
  0,
  [_NTe, _Mo],
  [0, () => Models]
];
export var ListMedicalScribeJobsRequest$: StaticStructureSchema = [3, n0, _LMSJR,
  0,
  [_St, _JNC, _NTe, _MR],
  [[0, { [_hQ]: _St }], [0, { [_hQ]: _JNC }], [0, { [_hQ]: _NTe }], [1, { [_hQ]: _MR }]]
];
export var ListMedicalScribeJobsResponse$: StaticStructureSchema = [3, n0, _LMSJRi,
  0,
  [_St, _NTe, _MSJS],
  [0, 0, () => MedicalScribeJobSummaries]
];
export var ListMedicalTranscriptionJobsRequest$: StaticStructureSchema = [3, n0, _LMTJR,
  0,
  [_St, _JNC, _NTe, _MR],
  [[0, { [_hQ]: _St }], [0, { [_hQ]: _JNC }], [0, { [_hQ]: _NTe }], [1, { [_hQ]: _MR }]]
];
export var ListMedicalTranscriptionJobsResponse$: StaticStructureSchema = [3, n0, _LMTJRi,
  0,
  [_St, _NTe, _MTJS],
  [0, 0, () => MedicalTranscriptionJobSummaries]
];
export var ListMedicalVocabulariesRequest$: StaticStructureSchema = [3, n0, _LMVR,
  0,
  [_NTe, _MR, _SEta, _NC],
  [[0, { [_hQ]: _NTe }], [1, { [_hQ]: _MR }], [0, { [_hQ]: _SEta }], [0, { [_hQ]: _NC }]]
];
export var ListMedicalVocabulariesResponse$: StaticStructureSchema = [3, n0, _LMVRi,
  0,
  [_St, _NTe, _V],
  [0, 0, () => Vocabularies]
];
...
export var ListTranscriptionJobsRequest$: StaticStructureSchema = [3, n0, _LTJR,
  0,
  [_St, _JNC, _NTe, _MR],
  [[0, { [_hQ]: _St }], [0, { [_hQ]: _JNC }], [0, { [_hQ]: _NTe }], [1, { [_hQ]: _MR }]]
];
export var ListTranscriptionJobsResponse$: StaticStructureSchema = [3, n0, _LTJRi,
  0,
  [_St, _NTe, _TJS],
  [0, 0, () => TranscriptionJobSummaries]
];
export var ListVocabulariesRequest$: StaticStructureSchema = [3, n0, _LVR,
  0,
  [_NTe, _MR, _SEta, _NC],
  [[0, { [_hQ]: _NTe }], [1, { [_hQ]: _MR }], [0, { [_hQ]: _SEta }], [0, { [_hQ]: _NC }]]
];
export var ListVocabulariesResponse$: StaticStructureSchema = [3, n0, _LVRi,
  0,
  [_St, _NTe, _V],
  [0, 0, () => Vocabularies]
];
export var ListVocabularyFiltersRequest$: StaticStructureSchema = [3, n0, _LVFR,
  0,
  [_NTe, _MR, _NC],
  [[0, { [_hQ]: _NTe }], [1, { [_hQ]: _MR }], [0, { [_hQ]: _NC }]]
];
export var ListVocabularyFiltersResponse$: StaticStructureSchema = [3, n0, _LVFRi,
  0,
  [_NTe, _VF],
  [0, () => VocabularyFilters]
];
export var Media$: StaticStructureSchema = [3, n0, _Me,
  0,
  [_MFU, _RMFU],
  [0, 0]
];
...
export var MedicalScribeJob$: StaticStructureSchema = [3, n0, _MSJ,
  0,
...
export var MedicalScribeJobSummary$: StaticStructureSchema = [3, n0, _MSJSed,
  0,
...
export var MedicalScribeSettings$: StaticStructureSchema = [3, n0, _MSS,
  0,
  [_SSL, _MSL, _CIh, _VN, _VFN, _VFM, _CNGS],
  [2, 1, 2, 0, 0, 0, () => ClinicalNoteGenerationSettings$]
];
export var MedicalTranscript$: StaticStructureSchema = [3, n0, _MT,
  0,
  [_TFU],
  [0]
];
export var MedicalTranscriptionJob$: StaticStructureSchema = [3, n0, _MTJ,
  0,
...
export var MedicalTranscriptionJobSummary$: StaticStructureSchema = [3, n0, _MTJSe,
  0,
  [_MTJN, _CT, _ST, _CTo, _LC, _TJSr, _FR, _OLT, _Sp, _CIT, _Ty],
  [0, 4, 4, 4, 0, 0, 0, 0, 0, 0, 0]
];
export var MedicalTranscriptionSetting$: StaticStructureSchema = [3, n0, _MTS,
  0,
  [_SSL, _MSL, _CIh, _SA, _MA, _VN],
  [2, 1, 2, 2, 1, 0]
];
export var ModelSettings$: StaticStructureSchema = [3, n0, _MSo,
  0,
  [_LMN],
  [0]
];
export var NonTalkTimeFilter$: StaticStructureSchema = [3, n0, _NTTF,
  0,
  [_Th, _ATR, _RTR, _N],
...
export var Subtitles$: StaticStructureSchema = [3, n0, _Sub,
  0,
  [_Fo, _OSI],
  [64 | 0, 1]
];
export var SubtitlesOutput$: StaticStructureSchema = [3, n0, _SO,
  0,
  [_Fo, _SFU, _OSI],
  [64 | 0, 64 | 0, 1]
];
...
export var TranscriptionJobSummary$: StaticStructureSchema = [3, n0, _TJSra,
  0,
...
export var VocabularyFilterInfo$: StaticStructureSchema = [3, n0, _VFI,
  0,
  [_VFN, _LC, _LMT],
  [0, 0, 4]
];
export var VocabularyInfo$: StaticStructureSchema = [3, n0, _VI,
  0,
  [_VN, _LC, _LMT, _VS],
  [0, 0, 4, 0]
];
...
var CallAnalyticsSkippedFeatureList: StaticListSchema = [1, n0, _CASFL,
  0, () => CallAnalyticsSkippedFeature$
];
var CategoryPropertiesList: StaticListSchema = [1, n0, _CPL,
  0, () => CategoryProperties$
];
var ChannelDefinitions: StaticListSchema = [1, n0, _CD,
  0, () => ChannelDefinition$
];
var LanguageCodeList: StaticListSchema = [1, n0, _LCL,
  0, () => LanguageCodeItem$
];
...
var MedicalScribeJobSummaries: StaticListSchema = [1, n0, _MSJS,
  0, () => MedicalScribeJobSummary$
];
var MedicalTranscriptionJobSummaries: StaticListSchema = [1, n0, _MTJS,
  0, () => MedicalTranscriptionJobSummary$
];
var Models: StaticListSchema = [1, n0, _Mo,
  0, () => LanguageModel$
];
var Phrases = 64 | 0;
...
export var StartTranscriptionJob$: StaticOperationSchema = [9, n0, _STJ,
...
export var UpdateVocabulary$: StaticOperationSchema = [9, n0, _UV,
  { [_h]: ["PATCH", "/vocabularies/{VocabularyName}", 200] }, () => UpdateVocabularyRequest$, () => UpdateVocabularyResponse$
];
export var UpdateVocabularyFilter$: StaticOperationSchema = [9, n0, _UVF,
