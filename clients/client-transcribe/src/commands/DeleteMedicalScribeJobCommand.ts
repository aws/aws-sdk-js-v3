...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteMedicalScribeJobCommandInput) {
    super();
  }
  ...
  ): Handler<DeleteMedicalScribeJobCommandInput, DeleteMedicalScribeJobCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteMedicalScribeJobCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: DeleteMedicalScribeJobCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<DeleteMedicalScribeJobCommandOutput> {
