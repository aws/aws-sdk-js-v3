...
export type DeleteMedicalTranscriptionJobCommandInput = DeleteMedicalTranscriptionJobRequest;
export type DeleteMedicalTranscriptionJobCommandOutput = __MetadataBearer;
