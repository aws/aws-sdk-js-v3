...
var DnsRecordList: StaticListSchema = [1, n0, _DRL, 0, () => DnsRecord$];
var FilterValues: StaticListSchema = [1, n0, _FV, 0, [0, { [_xN]: _i }]];
var HttpInstanceSummaryList: StaticListSchema = [1, n0, _HISL, 0, () => HttpInstanceSummary$];
var InstanceIdList: StaticListSchema = [1, n0, _IIL, 0, [0, { [_xN]: _II }]];
var InstanceSummaryList: StaticListSchema = [1, n0, _ISL, 0, [() => InstanceSummary$, { [_xN]: _IS }]];
var NamespaceFilters: StaticListSchema = [1, n0, _NFa, 0, [() => NamespaceFilter$, { [_xN]: _i }]];
var NamespaceSummariesList: StaticListSchema = [1, n0, _NSL, 0, () => NamespaceSummary$];
var OperationFilters: StaticListSchema = [1, n0, _OFp, 0, [() => OperationFilter$, { [_xN]: _i }]];
var OperationSummaryList: StaticListSchema = [1, n0, _OSL, 0, [() => OperationSummary$, { [_xN]: _OS }]];
var ServiceAttributeKeyList = 64 | 0;
var ServiceFilters: StaticListSchema = [1, n0, _SFe, 0, [() => ServiceFilter$, { [_xN]: _i }]];
var ServiceSummariesList: StaticListSchema = [1, n0, _SSL, 0, () => ServiceSummary$];
var TagKeyList = 64 | 0;
