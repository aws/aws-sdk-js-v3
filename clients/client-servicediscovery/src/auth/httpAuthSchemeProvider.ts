...
import { type ServiceDiscoveryClientResolvedConfig, ServiceDiscoveryClientConfig } from "../ServiceDiscoveryClient";
 ...
 * @internal
 */
export const defaultServiceDiscoveryHttpAuthSchemeProvider: ServiceDiscoveryHttpAuthSchemeProvider = (authParameters) => {
