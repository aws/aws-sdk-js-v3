...
import { ListManagedEndpoints$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ListManagedEndpointsCommand extends command<ListManagedEndpointsCommandInput, ListManagedEndpointsCommandOutput>(
  _ep0,
  _mw0,
