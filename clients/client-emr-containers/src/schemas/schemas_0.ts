...
export var EksInfo$: StaticStructureSchema = [3, n0, _EI,
  0,
  [_na, _nL],
  [0, 0]
];
...
export var JobDriver$: StaticStructureSchema = [3, n0, _JD,
  0,
  [_sSJD, _sSJDp],
...
export var ManagedLogs$: StaticStructureSchema = [3, n0, _ML,
  0,
  [_aAWSTRL, _eKA],
  [0, 0]
];
...
export var ParametricCloudWatchMonitoringConfiguration$: StaticStructureSchema = [3, n0, _PCWMC,
  0,
  [_lGN, _lSNP],
  [0, 0]
];
export var ParametricConfigurationOverrides$: StaticStructureSchema = [3, n0, _PCO,
  0,
  [_aC, _mC],
  [[() => ConfigurationList, 0], () => ParametricMonitoringConfiguration$]
];
export var ParametricMonitoringConfiguration$: StaticStructureSchema = [3, n0, _PMC,
  0,
  [_pAUI, _cWMC, _sMC],
  [0, () => ParametricCloudWatchMonitoringConfiguration$, () => ParametricS3MonitoringConfiguration$]
];
export var ParametricS3MonitoringConfiguration$: StaticStructureSchema = [3, n0, _PSMC,
  0,
  [_lU],
  [0]
];
...
export var TemplateParameterConfiguration$: StaticStructureSchema = [3, n0, _TPC,
  0,
  [_t, _dV],
  [0, 0]
];
export var TLSCertificateConfiguration$: StaticStructureSchema = [3, n0, _TLSCC,
  0,
  [_cPTe, _pCSA, _pCSAr],
  [0, 0, 0]
];
...
var JobTemplates: StaticListSchema = [1, n0, _JTo,
  0, [() => JobTemplate$,
    0]
];
...
var SubnetIds = 64 | 0;
var TagKeyList = 64 | 0;
var VirtualClusters: StaticListSchema = [1, n0, _VCi,
  0, () => VirtualCluster$
];
...
var TagMap = 128 | 0;
var TemplateParameterConfigurationMap: StaticMapSchema = [2, n0, _TPCM,
  0, 0, () => TemplateParameterConfiguration$
];
var TemplateParameterInputMap = 128 | 0;
export var ContainerInfo$: StaticUnionSchema = [4, n0, _CI,
  0,
  [_eIk],
  [() => EksInfo$]
];
...
export var CreateManagedEndpoint$: StaticOperationSchema = [9, n0, _CME,
...
export var CreateVirtualCluster$: StaticOperationSchema = [9, n0, _CVC,
...
export var DescribeJobRun$: StaticOperationSchema = [9, n0, _DJR,
...
export var GetManagedEndpointSessionCredentials$: StaticOperationSchema = [9, n0, _GMESC,
...
export var ListManagedEndpoints$: StaticOperationSchema = [9, n0, _LME,
...
export var ListVirtualClusters$: StaticOperationSchema = [9, n0, _LVC,
