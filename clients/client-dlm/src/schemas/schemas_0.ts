...
export var CreateRule$: StaticStructureSchema = [3, n0, _CR,
  0,
...
export var CrossRegionCopyRetainRule$: StaticStructureSchema = [3, n0, _CRCRR,
  0,
  [_I, _IU],
  [1, 0]
];
...
export var _Parameters$: StaticStructureSchema = [3, n0, _P,
  0,
  [_EBVx, _NR, _EDVT],
...
var CrossRegionCopyRules: StaticListSchema = [1, n0, _CRCRr,
  0, () => CrossRegionCopyRule$
];
var CrossRegionCopyTargetList: StaticListSchema = [1, n0, _CRCTL,
  0, () => CrossRegionCopyTarget$
];
var ExcludeDataVolumeTagList: StaticListSchema = [1, n0, _EDVTL,
  0, () => Tag$
];
var ExcludeTagsList: StaticListSchema = [1, n0, _ETL,
  0, () => Tag$
];
var ExcludeVolumeTypesList = 64 | 0;
var LifecyclePolicySummaryList: StaticListSchema = [1, n0, _LPSL,
...
var ScriptsList: StaticListSchema = [1, n0, _SLc,
  0, () => Script$
];
var ShareRules: StaticListSchema = [1, n0, _SR,
  0, () => ShareRule$
];
...
var TagsToAddList: StaticListSchema = [1, n0, _TTAL,
  0, () => Tag$
];
var TargetTagList: StaticListSchema = [1, n0, _TTL,
  0, () => Tag$
];
var TargetTagsFilterList = 64 | 0;
var TimesList = 64 | 0;
var VariableTagsList: StaticListSchema = [1, n0, _VTL,
  0, () => Tag$
];
var TagMap = 128 | 0;
export var CreateLifecyclePolicy$: StaticOperationSchema = [9, n0, _CLP,
...
export var GetLifecyclePolicies$: StaticOperationSchema = [9, n0, _GLP,
  { [_h]: ["GET", "/policies", 200] }, () => GetLifecyclePoliciesRequest$, () => GetLifecyclePoliciesResponse$
];
export var GetLifecyclePolicy$: StaticOperationSchema = [9, n0, _GLPe,
...
export var UpdateLifecyclePolicy$: StaticOperationSchema = [9, n0, _ULP,
