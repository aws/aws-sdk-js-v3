...
import {
  defaultDLMHttpAuthSchemeParametersProvider,
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<DLMClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultDLMHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: DLMClientResolvedConfig) =>
