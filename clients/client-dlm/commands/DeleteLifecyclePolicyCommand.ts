...
import {
  deserializeAws_restJson1_1DeleteLifecyclePolicyCommand,
  serializeAws_restJson1_1DeleteLifecyclePolicyCommand,
...
export class DeleteLifecyclePolicyCommand extends $Command<DeleteLifecyclePolicyCommandInput, DeleteLifecyclePolicyCommandOutput, DLMClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteLifecyclePolicyCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DeleteLifecyclePolicyCommand(output, context);
  }
