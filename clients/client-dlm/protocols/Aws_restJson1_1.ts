...
export async function serializeAws_restJson1_1CreateLifecyclePolicyCommand(
  ...
  if (input.PolicyDetails !== undefined) {
    bodyParams['PolicyDetails'] = serializeAws_restJson1_1PolicyDetails(input.PolicyDetails, context);
  }
...
export async function deserializeAws_restJson1_1GetLifecyclePoliciesCommand(
  ...
  if (data.Policies !== undefined) {
    contents.Policies = deserializeAws_restJson1_1LifecyclePolicySummaryList(data.Policies, context);
  }
  return Promise.resolve(contents);
}
...
const deserializeAws_restJson1_1InvalidRequestExceptionResponse = async (
  ...
  if (data.MutuallyExclusiveParameters !== undefined) {
    contents.MutuallyExclusiveParameters = deserializeAws_restJson1_1ParameterList(data.MutuallyExclusiveParameters, context);
  }
  if (data.RequiredParameters !== undefined) {
    contents.RequiredParameters = deserializeAws_restJson1_1ParameterList(data.RequiredParameters, context);
  }
  return contents;
};
...
const serializeAws_restJson1_1CreateRule = (
  ...
  if (input.Times !== undefined) {
    bodyParams['Times'] = serializeAws_restJson1_1TimesList(input.Times, context);
  }
  return bodyParams;
}
...
const serializeAws_restJson1_1FastRestoreRule = (
  ...
  if (input.AvailabilityZones !== undefined) {
    bodyParams['AvailabilityZones'] = serializeAws_restJson1_1AvailabilityZoneList(input.AvailabilityZones, context);
  }
...
const serializeAws_restJson1_1PolicyDetails = (
  ...
  if (input.Parameters !== undefined) {
    bodyParams['Parameters'] = serializeAws_restJson1_1_Parameters(input.Parameters, context);
  }
  if (input.PolicyType !== undefined) {
    bodyParams['PolicyType'] = input.PolicyType;
  }
  if (input.ResourceTypes !== undefined) {
    bodyParams['ResourceTypes'] = serializeAws_restJson1_1ResourceTypeValuesList(input.ResourceTypes, context);
  }
  if (input.Schedules !== undefined) {
    bodyParams['Schedules'] = serializeAws_restJson1_1ScheduleList(input.Schedules, context);
  }
  if (input.TargetTags !== undefined) {
    bodyParams['TargetTags'] = serializeAws_restJson1_1TargetTagList(input.TargetTags, context);
  }
  return bodyParams;
}
...
const serializeAws_restJson1_1Schedule = (
  ...
  if (input.CreateRule !== undefined) {
    bodyParams['CreateRule'] = serializeAws_restJson1_1CreateRule(input.CreateRule, context);
  }
  if (input.FastRestoreRule !== undefined) {
    bodyParams['FastRestoreRule'] = serializeAws_restJson1_1FastRestoreRule(input.FastRestoreRule, context);
  }
  if (input.Name !== undefined) {
    bodyParams['Name'] = input.Name;
  }
  if (input.RetainRule !== undefined) {
    bodyParams['RetainRule'] = serializeAws_restJson1_1RetainRule(input.RetainRule, context);
  }
  if (input.TagsToAdd !== undefined) {
    bodyParams['TagsToAdd'] = serializeAws_restJson1_1TagsToAddList(input.TagsToAdd, context);
  }
  if (input.VariableTags !== undefined) {
    bodyParams['VariableTags'] = serializeAws_restJson1_1VariableTagsList(input.VariableTags, context);
  }
  return bodyParams;
}
...
const deserializeAws_restJson1_1FastRestoreRule = (
  ...
  if (output.AvailabilityZones !== undefined) {
    contents.AvailabilityZones = deserializeAws_restJson1_1AvailabilityZoneList(output.AvailabilityZones, context);
  }
...
const deserializeAws_restJson1_1LifecyclePolicy = (
  ...
  if (output.DateCreated !== undefined) {
    contents.DateCreated = new Date(output.DateCreated % 1 != 0 ? Math.round(output.DateCreated * 1000) : output.DateCreated);
  }
  if (output.DateModified !== undefined) {
    contents.DateModified = new Date(output.DateModified % 1 != 0 ? Math.round(output.DateModified * 1000) : output.DateModified);
  }
  ...
  if (output.PolicyDetails !== undefined) {
    contents.PolicyDetails = deserializeAws_restJson1_1PolicyDetails(output.PolicyDetails, context);
  }
...
const deserializeAws_restJson1_1PolicyDetails = (
  ...
  if (output.Parameters !== undefined) {
    contents.Parameters = deserializeAws_restJson1_1_Parameters(output.Parameters, context);
  }
  if (output.PolicyType !== undefined) {
    contents.PolicyType = output.PolicyType;
  }
  if (output.ResourceTypes !== undefined) {
    contents.ResourceTypes = deserializeAws_restJson1_1ResourceTypeValuesList(output.ResourceTypes, context);
  }
  if (output.Schedules !== undefined) {
    contents.Schedules = deserializeAws_restJson1_1ScheduleList(output.Schedules, context);
  }
  if (output.TargetTags !== undefined) {
    contents.TargetTags = deserializeAws_restJson1_1TargetTagList(output.TargetTags, context);
  }
  return contents;
}
...
const deserializeAws_restJson1_1Schedule = (
  ...
  if (output.CreateRule !== undefined) {
    contents.CreateRule = deserializeAws_restJson1_1CreateRule(output.CreateRule, context);
  }
  if (output.FastRestoreRule !== undefined) {
    contents.FastRestoreRule = deserializeAws_restJson1_1FastRestoreRule(output.FastRestoreRule, context);
  }
  if (output.Name !== undefined) {
    contents.Name = output.Name;
  }
  if (output.RetainRule !== undefined) {
    contents.RetainRule = deserializeAws_restJson1_1RetainRule(output.RetainRule, context);
  }
  if (output.TagsToAdd !== undefined) {
    contents.TagsToAdd = deserializeAws_restJson1_1TagsToAddList(output.TagsToAdd, context);
  }
  if (output.VariableTags !== undefined) {
    contents.VariableTags = deserializeAws_restJson1_1VariableTagsList(output.VariableTags, context);
  }
  return contents;
}
