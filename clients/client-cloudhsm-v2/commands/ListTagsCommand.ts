...
export type ListTagsCommandOutput = ListTagsResponse;

export class ListTagsCommand extends $Command<ListTagsCommandInput, ListTagsCommandOutput, CloudHSMV2ClientResolvedConfig> {
