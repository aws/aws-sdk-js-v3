...
const deserializeAws_json1_1Backup = (output: any, context: __SerdeContext): Backup => {
  return {
    ...
    CopyTimestamp:
      output.CopyTimestamp != undefined
    ...
    CreateTimestamp:
      output.CreateTimestamp != undefined
        ...
        : undefined,
    DeleteTimestamp:
      output.DeleteTimestamp != undefined
...
const deserializeAws_json1_1Cluster = (output: any, context: __SerdeContext): Cluster => {
  return {
    ...
    BackupRetentionPolicy:
      output.BackupRetentionPolicy != undefined
        ? deserializeAws_json1_1BackupRetentionPolicy(output.BackupRetentionPolicy, context)
        : undefined,
    Certificates:
      output.Certificates != undefined ? deserializeAws_json1_1Certificates(output.Certificates, context) : undefined,
    ClusterId: __expectString(output.ClusterId),
    CreateTimestamp:
      output.CreateTimestamp != undefined
        ? __expectNonNull(__parseEpochTimestamp(__expectNumber(output.CreateTimestamp)))
    ...
    Hsms: output.Hsms != undefined ? deserializeAws_json1_1Hsms(output.Hsms, context) : undefined,
    ...
    SubnetMapping:
      output.SubnetMapping != undefined
...
const deserializeAws_json1_1CreateHsmResponse = (output: any, context: __SerdeContext): CreateHsmResponse => {
  return {
    Hsm: output.Hsm != undefined ? deserializeAws_json1_1Hsm(output.Hsm, context) : undefined,
  } as any;
};
