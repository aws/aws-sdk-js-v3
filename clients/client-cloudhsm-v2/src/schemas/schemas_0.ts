...
export var Certificates$: StaticStructureSchema = [3, n0, _C,
  0,
...
export var DestinationBackup$: StaticStructureSchema = [3, n0, _DB,
  0,
  [_CT, _SR, _SB, _SC],
  [4, 0, 0, 0]
];
...
var Clusters: StaticListSchema = [1, n0, _Clu,
  0, () => Cluster$
];
var Hsms: StaticListSchema = [1, n0, _H,
  0, () => Hsm$
];
var Strings = 64 | 0;
var SubnetIds = 64 | 0;
...
export var CopyBackupToRegion$: StaticOperationSchema = [9, n0, _CBTR,
...
export var CreateHsm$: StaticOperationSchema = [9, n0, _CH,
  0, () => CreateHsmRequest$, () => CreateHsmResponse$
];
export var DeleteBackup$: StaticOperationSchema = [9, n0, _DBe,
...
export var DeleteHsm$: StaticOperationSchema = [9, n0, _DH,
...
export var DescribeBackups$: StaticOperationSchema = [9, n0, _DBes,
...
export var InitializeCluster$: StaticOperationSchema = [9, n0, _IC,
...
export var ModifyBackupAttributes$: StaticOperationSchema = [9, n0, _MBA,
...
export var RestoreBackup$: StaticOperationSchema = [9, n0, _RB,
