...
export declare namespace Certificates {
    function isa(o: any): o is Certificates;
}
/**
...
export declare namespace CopyBackupToRegionRequest {
    function isa(o: any): o is CopyBackupToRegionRequest;
}
...
export declare namespace CopyBackupToRegionResponse {
    function isa(o: any): o is CopyBackupToRegionResponse;
}
...
export declare namespace DestinationBackup {
    function isa(o: any): o is DestinationBackup;
}
/**
...
export declare namespace InitializeClusterRequest {
    function isa(o: any): o is InitializeClusterRequest;
}
...
export declare namespace InitializeClusterResponse {
    function isa(o: any): o is InitializeClusterResponse;
}
...
export declare namespace RestoreBackupRequest {
    function isa(o: any): o is RestoreBackupRequest;
}
...
export declare namespace RestoreBackupResponse {
    function isa(o: any): o is RestoreBackupResponse;
}
/**
...
export declare namespace CloudHsmAccessDeniedException {
    function isa(o: any): o is CloudHsmAccessDeniedException;
}
/**
...
export declare namespace CloudHsmInternalFailureException {
    function isa(o: any): o is CloudHsmInternalFailureException;
}
/**
...
export declare namespace CloudHsmInvalidRequestException {
    function isa(o: any): o is CloudHsmInvalidRequestException;
}
/**
...
export declare namespace CloudHsmResourceNotFoundException {
    function isa(o: any): o is CloudHsmResourceNotFoundException;
}
/**
...
export declare namespace CloudHsmTagException {
    function isa(o: any): o is CloudHsmTagException;
}
