...
export declare type ServiceInputTypes = AssociateDelegateToResourceCommandInput | AssociateMemberToGroupCommandInput | CreateAliasCommandInput | CreateGroupCommandInput | CreateResourceCommandInput | CreateUserCommandInput | DeleteAliasCommandInput | DeleteGroupCommandInput | DeleteMailboxPermissionsCommandInput | DeleteResourceCommandInput | DeleteUserCommandInput | DeregisterFromWorkMailCommandInput | DescribeGroupCommandInput | DescribeOrganizationCommandInput | DescribeResourceCommandInput | DescribeUserCommandInput | DisassociateDelegateFromResourceCommandInput | DisassociateMemberFromGroupCommandInput | GetMailboxDetailsCommandInput | ListAliasesCommandInput | ListGroupMembersCommandInput | ListGroupsCommandInput | ListMailboxPermissionsCommandInput | ListOrganizationsCommandInput | ListResourceDelegatesCommandInput | ListResourcesCommandInput | ListUsersCommandInput | PutMailboxPermissionsCommandInput | RegisterToWorkMailCommandInput | ResetPasswordCommandInput | UpdateMailboxQuotaCommandInput | UpdatePrimaryEmailAddressCommandInput | UpdateResourceCommandInput;
export declare type ServiceOutputTypes = AssociateDelegateToResourceCommandOutput | AssociateMemberToGroupCommandOutput | CreateAliasCommandOutput | CreateGroupCommandOutput | CreateResourceCommandOutput | CreateUserCommandOutput | DeleteAliasCommandOutput | DeleteGroupCommandOutput | DeleteMailboxPermissionsCommandOutput | DeleteResourceCommandOutput | DeleteUserCommandOutput | DeregisterFromWorkMailCommandOutput | DescribeGroupCommandOutput | DescribeOrganizationCommandOutput | DescribeResourceCommandOutput | DescribeUserCommandOutput | DisassociateDelegateFromResourceCommandOutput | DisassociateMemberFromGroupCommandOutput | GetMailboxDetailsCommandOutput | ListAliasesCommandOutput | ListGroupMembersCommandOutput | ListGroupsCommandOutput | ListMailboxPermissionsCommandOutput | ListOrganizationsCommandOutput | ListResourceDelegatesCommandOutput | ListResourcesCommandOutput | ListUsersCommandOutput | PutMailboxPermissionsCommandOutput | RegisterToWorkMailCommandOutput | ResetPasswordCommandOutput | UpdateMailboxQuotaCommandOutput | UpdatePrimaryEmailAddressCommandOutput | UpdateResourceCommandOutput;
...
export declare type WorkMailClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type WorkMailClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
