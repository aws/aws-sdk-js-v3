 ...
 * @public
 */
export class DeleteEmailMonitoringConfigurationCommand extends command<DeleteEmailMonitoringConfigurationCommandInput, DeleteEmailMonitoringConfigurationCommandOutput>(
  _ep0,
  _mw0,
