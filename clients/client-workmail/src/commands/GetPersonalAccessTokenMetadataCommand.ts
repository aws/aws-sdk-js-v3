 ...
 * @public
 */
export class GetPersonalAccessTokenMetadataCommand extends command<GetPersonalAccessTokenMetadataCommandInput, GetPersonalAccessTokenMetadataCommandOutput>(
  _ep0,
  _mw0,
