...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: ListMobileDeviceAccessOverridesRequest.filterSensitiveLog,
      outputFilterSensitiveLog: ListMobileDeviceAccessOverridesResponse.filterSensitiveLog,
    };
