...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: DeleteMobileDeviceAccessOverrideRequest.filterSensitiveLog,
      outputFilterSensitiveLog: DeleteMobileDeviceAccessOverrideResponse.filterSensitiveLog,
    };
