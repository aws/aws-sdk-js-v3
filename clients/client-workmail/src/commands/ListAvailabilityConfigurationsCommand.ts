 ...
 * @public
 */
export class ListAvailabilityConfigurationsCommand extends command<ListAvailabilityConfigurationsCommandInput, ListAvailabilityConfigurationsCommandOutput>(
  _ep0,
  _mw0,
