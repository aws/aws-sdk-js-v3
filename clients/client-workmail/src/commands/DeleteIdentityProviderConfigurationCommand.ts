 ...
 * @public
 */
export class DeleteIdentityProviderConfigurationCommand extends command<DeleteIdentityProviderConfigurationCommandInput, DeleteIdentityProviderConfigurationCommandOutput>(
  _ep0,
  _mw0,
