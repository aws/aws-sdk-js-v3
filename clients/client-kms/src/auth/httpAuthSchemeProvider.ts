...
import { type KMSClientResolvedConfig, KMSClientConfig } from "../KMSClient";
 ...
 * @internal
 */
export const defaultKMSHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: KMSHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultKMSHttpAuthSchemeProvider: KMSHttpAuthSchemeProvider = (authParameters) => {
