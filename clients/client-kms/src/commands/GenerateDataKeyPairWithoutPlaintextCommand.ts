 ...
 * @public
 */
export class GenerateDataKeyPairWithoutPlaintextCommand extends command<GenerateDataKeyPairWithoutPlaintextCommandInput, GenerateDataKeyPairWithoutPlaintextCommandOutput>(
  _ep0,
  _mw0,
