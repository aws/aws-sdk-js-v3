...
import type { DecryptRequest, DecryptResponse } from "../models/models_0";
import { Decrypt$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DecryptCommand extends command<DecryptCommandInput, DecryptCommandOutput>(
  _ep0,
  _mw0,
  "Decrypt",
  Decrypt$
