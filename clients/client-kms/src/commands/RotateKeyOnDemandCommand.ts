...
import type { RotateKeyOnDemandRequest, RotateKeyOnDemandResponse } from "../models/models_0";
 ...
 * @public
 */
export class RotateKeyOnDemandCommand extends command<RotateKeyOnDemandCommandInput, RotateKeyOnDemandCommandOutput>(
  _ep0,
  _mw0,
  "RotateKeyOnDemand",
  RotateKeyOnDemand$
