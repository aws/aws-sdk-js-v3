...
export declare namespace AliasListEntry {
    function isa(o: any): o is AliasListEntry;
}
/**
...
export declare namespace CancelKeyDeletionRequest {
    function isa(o: any): o is CancelKeyDeletionRequest;
}
...
export declare namespace CancelKeyDeletionResponse {
    function isa(o: any): o is CancelKeyDeletionResponse;
}
/**
...
export declare namespace CloudHsmClusterInUseException {
    function isa(o: any): o is CloudHsmClusterInUseException;
}
/**
...
export declare namespace CloudHsmClusterInvalidConfigurationException {
    function isa(o: any): o is CloudHsmClusterInvalidConfigurationException;
}
/**
...
export declare namespace CloudHsmClusterNotActiveException {
    function isa(o: any): o is CloudHsmClusterNotActiveException;
}
/**
...
export declare namespace CloudHsmClusterNotFoundException {
    function isa(o: any): o is CloudHsmClusterNotFoundException;
}
/**
...
export declare namespace CloudHsmClusterNotRelatedException {
    function isa(o: any): o is CloudHsmClusterNotRelatedException;
}
...
export declare namespace ConnectCustomKeyStoreRequest {
    function isa(o: any): o is ConnectCustomKeyStoreRequest;
}
export interface ConnectCustomKeyStoreResponse {
    __type?: "ConnectCustomKeyStoreResponse";
}
export declare namespace ConnectCustomKeyStoreResponse {
    function isa(o: any): o is ConnectCustomKeyStoreResponse;
}
...
export declare namespace CreateAliasRequest {
    function isa(o: any): o is CreateAliasRequest;
}
...
export declare namespace CreateCustomKeyStoreRequest {
    function isa(o: any): o is CreateCustomKeyStoreRequest;
}
...
export declare namespace CreateCustomKeyStoreResponse {
    function isa(o: any): o is CreateCustomKeyStoreResponse;
}
export interface CreateGrantRequest {
    __type?: "CreateGrantRequest";
    /**
     * <p>Allows a cryptographic operation only when the encryption context matches or includes the
...
export declare namespace CreateGrantRequest {
    function isa(o: any): o is CreateGrantRequest;
}
...
export declare namespace CreateGrantResponse {
    function isa(o: any): o is CreateGrantResponse;
}
export interface CreateKeyRequest {
    ...
    Description?: string;
    /**
     * <p>Determines the cryptographic operations for which you can use the CMK. The default value
...
export declare namespace CreateKeyRequest {
    function isa(o: any): o is CreateKeyRequest;
}
...
export declare namespace CreateKeyResponse {
    function isa(o: any): o is CreateKeyResponse;
}
/**
...
export declare namespace CustomKeyStoreHasCMKsException {
    function isa(o: any): o is CustomKeyStoreHasCMKsException;
}
/**
...
export declare namespace CustomKeyStoreInvalidStateException {
    function isa(o: any): o is CustomKeyStoreInvalidStateException;
}
/**
...
export declare namespace CustomKeyStoreNameInUseException {
    function isa(o: any): o is CustomKeyStoreNameInUseException;
}
/**
...
export declare namespace CustomKeyStoreNotFoundException {
    function isa(o: any): o is CustomKeyStoreNotFoundException;
}
/**
...
export declare namespace CustomKeyStoresListEntry {
    function isa(o: any): o is CustomKeyStoresListEntry;
}
...
export interface DecryptRequest {
     ...
     *       An encryption context is valid only for cryptographic operations with a symmetric CMK. The standard asymmetric encryption algorithms that AWS KMS uses do not support an encryption context.</p>
...
export declare namespace DecryptRequest {
    function isa(o: any): o is DecryptRequest;
}
...
export declare namespace DecryptResponse {
    function isa(o: any): o is DecryptResponse;
}
...
export declare namespace DeleteAliasRequest {
    function isa(o: any): o is DeleteAliasRequest;
}
...
export declare namespace DeleteCustomKeyStoreRequest {
    function isa(o: any): o is DeleteCustomKeyStoreRequest;
}
...
export declare namespace DeleteCustomKeyStoreResponse {
    function isa(o: any): o is DeleteCustomKeyStoreResponse;
}
...
export declare namespace DeleteImportedKeyMaterialRequest {
    function isa(o: any): o is DeleteImportedKeyMaterialRequest;
}
/**
...
export declare namespace DependencyTimeoutException {
    function isa(o: any): o is DependencyTimeoutException;
}
...
export declare namespace DescribeCustomKeyStoresRequest {
    function isa(o: any): o is DescribeCustomKeyStoresRequest;
}
...
export declare namespace DescribeCustomKeyStoresResponse {
    function isa(o: any): o is DescribeCustomKeyStoresResponse;
}
...
export declare namespace DescribeKeyRequest {
    function isa(o: any): o is DescribeKeyRequest;
}
...
export declare namespace DescribeKeyResponse {
    function isa(o: any): o is DescribeKeyResponse;
}
...
export declare namespace DisableKeyRequest {
    function isa(o: any): o is DisableKeyRequest;
}
...
export declare namespace DisableKeyRotationRequest {
    function isa(o: any): o is DisableKeyRotationRequest;
}
/**
...
export declare namespace DisabledException {
    function isa(o: any): o is DisabledException;
}
...
export declare namespace DisconnectCustomKeyStoreRequest {
    function isa(o: any): o is DisconnectCustomKeyStoreRequest;
}
...
export declare namespace DisconnectCustomKeyStoreResponse {
    function isa(o: any): o is DisconnectCustomKeyStoreResponse;
}
...
export declare namespace EnableKeyRequest {
    function isa(o: any): o is EnableKeyRequest;
}
...
export declare namespace EnableKeyRotationRequest {
    function isa(o: any): o is EnableKeyRotationRequest;
}
...
export declare namespace EncryptRequest {
    function isa(o: any): o is EncryptRequest;
}
...
export declare namespace EncryptResponse {
    function isa(o: any): o is EncryptResponse;
}
...
export declare namespace ExpiredImportTokenException {
    function isa(o: any): o is ExpiredImportTokenException;
}
...
export declare namespace GenerateDataKeyPairRequest {
    function isa(o: any): o is GenerateDataKeyPairRequest;
}
...
export declare namespace GenerateDataKeyPairResponse {
    function isa(o: any): o is GenerateDataKeyPairResponse;
}
export interface GenerateDataKeyPairWithoutPlaintextRequest {
     ...
     *       symmetric CMK. You cannot use an asymmetric CMK. To get the type
...
export declare namespace GenerateDataKeyPairWithoutPlaintextRequest {
    function isa(o: any): o is GenerateDataKeyPairWithoutPlaintextRequest;
}
...
export declare namespace GenerateDataKeyPairWithoutPlaintextResponse {
    function isa(o: any): o is GenerateDataKeyPairWithoutPlaintextResponse;
}
...
export declare namespace GenerateDataKeyRequest {
    function isa(o: any): o is GenerateDataKeyRequest;
}
...
export declare namespace GenerateDataKeyResponse {
    function isa(o: any): o is GenerateDataKeyResponse;
}
...
export declare namespace GenerateDataKeyWithoutPlaintextRequest {
    function isa(o: any): o is GenerateDataKeyWithoutPlaintextRequest;
}
...
export declare namespace GenerateDataKeyWithoutPlaintextResponse {
    function isa(o: any): o is GenerateDataKeyWithoutPlaintextResponse;
}
...
export declare namespace GenerateRandomRequest {
    function isa(o: any): o is GenerateRandomRequest;
}
...
export declare namespace GenerateRandomResponse {
    function isa(o: any): o is GenerateRandomResponse;
}
...
export declare namespace GetKeyPolicyRequest {
    function isa(o: any): o is GetKeyPolicyRequest;
}
...
export declare namespace GetKeyPolicyResponse {
    function isa(o: any): o is GetKeyPolicyResponse;
}
...
export declare namespace GetKeyRotationStatusRequest {
    function isa(o: any): o is GetKeyRotationStatusRequest;
}
...
export declare namespace GetKeyRotationStatusResponse {
    function isa(o: any): o is GetKeyRotationStatusResponse;
}
...
export declare namespace GetParametersForImportRequest {
    function isa(o: any): o is GetParametersForImportRequest;
}
...
export declare namespace GetParametersForImportResponse {
    function isa(o: any): o is GetParametersForImportResponse;
}
...
export interface GetPublicKeyResponse {
     ...
     *          <p>This value is returned as a binary <a href="https://www.itu.int/ITU-T/studygroups/com17/languages/X.690-0207.pdf">Distinguished
     *         Encoding Rules</a> (DER)-encoded object. To decode it, use an ASN.1 parsing tool, such
     *       as <a href="https://www.openssl.org/docs/man1.0.2/man1/asn1parse.html">OpenSSL
     *         asn1parse</a>.</p>
     */
    PublicKey?: Uint8Array;
    /**
...
export declare namespace GetPublicKeyResponse {
    function isa(o: any): o is GetPublicKeyResponse;
}
/**
 * <p>Use this structure to allow cryptographic operations in the grant only when the operation
 *       request includes the specified <a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context">encryption context</a>.</p>
 *          <p>AWS KMS applies the grant constraints only when the grant allows a cryptographic operation
 *       that accepts an encryption context as input, such as the following.</p>
 *          <ul>
 *             <li>
 *                <p>
 *                   <a>Encrypt</a>
 ...
 *             </li>
 *          </ul>
 *          <p>AWS KMS does not apply the grant constraints to other operations, such as <a>DescribeKey</a> or <a>ScheduleKeyDeletion</a>.</p>
 *          <important>
...
export interface GrantConstraints {
    ...
    /**
     * <p>A list of key-value pairs that must match the encryption context in the cryptographic
...
export declare namespace GrantConstraints {
    function isa(o: any): o is GrantConstraints;
}
/**
...
export declare namespace GrantListEntry {
    function isa(o: any): o is GrantListEntry;
}
...
export declare namespace ImportKeyMaterialRequest {
    function isa(o: any): o is ImportKeyMaterialRequest;
}
export interface ImportKeyMaterialResponse {
    __type?: "ImportKeyMaterialResponse";
}
export declare namespace ImportKeyMaterialResponse {
    function isa(o: any): o is ImportKeyMaterialResponse;
}
/**
...
export declare namespace IncorrectKeyException {
    function isa(o: any): o is IncorrectKeyException;
}
/**
...
export declare namespace IncorrectKeyMaterialException {
    function isa(o: any): o is IncorrectKeyMaterialException;
}
/**
...
export declare namespace IncorrectTrustAnchorException {
    function isa(o: any): o is IncorrectTrustAnchorException;
}
/**
...
export declare namespace InvalidAliasNameException {
    function isa(o: any): o is InvalidAliasNameException;
}
/**
...
export declare namespace InvalidCiphertextException {
    function isa(o: any): o is InvalidCiphertextException;
}
/**
...
export declare namespace InvalidGrantIdException {
    function isa(o: any): o is InvalidGrantIdException;
}
/**
...
export declare namespace InvalidGrantTokenException {
    function isa(o: any): o is InvalidGrantTokenException;
}
/**
...
export declare namespace InvalidImportTokenException {
    function isa(o: any): o is InvalidImportTokenException;
}
/**
...
export declare namespace InvalidKeyUsageException {
    function isa(o: any): o is InvalidKeyUsageException;
}
/**
...
export declare namespace InvalidMarkerException {
    function isa(o: any): o is InvalidMarkerException;
}
/**
...
export declare namespace KMSInternalException {
    function isa(o: any): o is KMSInternalException;
}
/**
...
export declare namespace KMSInvalidSignatureException {
    function isa(o: any): o is KMSInvalidSignatureException;
}
/**
...
export declare namespace KMSInvalidStateException {
    function isa(o: any): o is KMSInvalidStateException;
}
/**
...
export declare namespace KeyListEntry {
    function isa(o: any): o is KeyListEntry;
}
...
export interface KeyMetadata {
    ...
    Enabled?: boolean;
    /**
     * <p>A list of encryption algorithms that the CMK supports. You cannot use the CMK with other
     ...
     *         Customer Master Key</a> in the <i>AWS Key Management Service Developer Guide</i>.</p>
     */
    ...
    Origin?: OriginType | string;
    /**
     * <p>A list of signing algorithms that the CMK supports. You cannot use the CMK with other
...
export declare namespace KeyMetadata {
    function isa(o: any): o is KeyMetadata;
}
...
export declare namespace KeyUnavailableException {
    function isa(o: any): o is KeyUnavailableException;
}
...
export declare namespace ListAliasesRequest {
    function isa(o: any): o is ListAliasesRequest;
}
...
export declare namespace ListAliasesResponse {
    function isa(o: any): o is ListAliasesResponse;
}
...
export declare namespace ListGrantsRequest {
    function isa(o: any): o is ListGrantsRequest;
}
...
export declare namespace ListGrantsResponse {
    function isa(o: any): o is ListGrantsResponse;
}
...
export declare namespace ListKeyPoliciesRequest {
    function isa(o: any): o is ListKeyPoliciesRequest;
}
...
export declare namespace ListKeyPoliciesResponse {
    function isa(o: any): o is ListKeyPoliciesResponse;
}
...
export declare namespace ListKeysRequest {
    function isa(o: any): o is ListKeysRequest;
}
...
export declare namespace ListKeysResponse {
    function isa(o: any): o is ListKeysResponse;
}
...
export declare namespace ListResourceTagsRequest {
    function isa(o: any): o is ListResourceTagsRequest;
}
...
export declare namespace ListResourceTagsResponse {
    function isa(o: any): o is ListResourceTagsResponse;
}
...
export declare namespace ListRetirableGrantsRequest {
    function isa(o: any): o is ListRetirableGrantsRequest;
}
/**
...
export declare namespace MalformedPolicyDocumentException {
    function isa(o: any): o is MalformedPolicyDocumentException;
}
...
export declare namespace PutKeyPolicyRequest {
    function isa(o: any): o is PutKeyPolicyRequest;
}
...
export declare namespace ReEncryptRequest {
    function isa(o: any): o is ReEncryptRequest;
}
...
export declare namespace ReEncryptResponse {
    function isa(o: any): o is ReEncryptResponse;
}
...
export declare namespace RetireGrantRequest {
    function isa(o: any): o is RetireGrantRequest;
}
...
export declare namespace RevokeGrantRequest {
    function isa(o: any): o is RevokeGrantRequest;
}
...
export declare namespace ScheduleKeyDeletionRequest {
    function isa(o: any): o is ScheduleKeyDeletionRequest;
}
...
export declare namespace ScheduleKeyDeletionResponse {
    function isa(o: any): o is ScheduleKeyDeletionResponse;
}
export interface SignRequest {
     ...
     *       message digest. To indicate a message, enter <code>RAW</code>. To indicate a message digest,
...
export declare namespace SignRequest {
    function isa(o: any): o is SignRequest;
}
...
export declare namespace SignResponse {
    function isa(o: any): o is SignResponse;
}
...
export declare namespace TagException {
    function isa(o: any): o is TagException;
}
...
export declare namespace UpdateAliasRequest {
    function isa(o: any): o is UpdateAliasRequest;
}
...
export declare namespace UpdateCustomKeyStoreRequest {
    function isa(o: any): o is UpdateCustomKeyStoreRequest;
}
export interface UpdateCustomKeyStoreResponse {
    __type?: "UpdateCustomKeyStoreResponse";
}
export declare namespace UpdateCustomKeyStoreResponse {
    function isa(o: any): o is UpdateCustomKeyStoreResponse;
}
...
export declare namespace UpdateKeyDescriptionRequest {
    function isa(o: any): o is UpdateKeyDescriptionRequest;
}
...
export declare namespace VerifyRequest {
    function isa(o: any): o is VerifyRequest;
}
...
export declare namespace VerifyResponse {
    function isa(o: any): o is VerifyResponse;
}
