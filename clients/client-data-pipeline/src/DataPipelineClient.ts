...
import {
  ...
  defaultDataPipelineHttpAuthSchemeParametersProvider,
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<DataPipelineClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultDataPipelineHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: DataPipelineClientResolvedConfig) =>
