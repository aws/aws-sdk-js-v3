...
var idList = 64 | 0;
var ParameterAttributeList: StaticListSchema = [1, n0, _PAL,
  0, () => ParameterAttribute$
];
var ParameterObjectList: StaticListSchema = [1, n0, _POL,
  0, () => ParameterObject$
];
var ParameterValueList: StaticListSchema = [1, n0, _PVL,
  0, () => ParameterValue$
];
var PipelineDescriptionList: StaticListSchema = [1, n0, _PDL,
  0, () => PipelineDescription$
];
var pipelineList: StaticListSchema = [1, n0, _pL,
  0, () => PipelineIdName$
];
var PipelineObjectList: StaticListSchema = [1, n0, _POLi,
  0, () => PipelineObject$
];
var SelectorList: StaticListSchema = [1, n0, _SL,
  0, () => Selector$
];
var stringList = 64 | 0;
...
var ValidationErrors: StaticListSchema = [1, n0, _VEa,
  0, () => ValidationError$
];
var validationMessages = 64 | 0;
var ValidationWarnings: StaticListSchema = [1, n0, _VWa,
  0, () => ValidationWarning$
];
var PipelineObjectMap: StaticMapSchema = [2, n0, _POM,
  0, 0, () => PipelineObject$
];
export var ActivatePipeline$: StaticOperationSchema = [9, n0, _AP,
...
export var DeactivatePipeline$: StaticOperationSchema = [9, n0, _DP,
  0, () => DeactivatePipelineInput$, () => DeactivatePipelineOutput$
];
export var DeletePipeline$: StaticOperationSchema = [9, n0, _DPe,
  0, () => DeletePipelineInput$, () => __Unit
];
export var DescribeObjects$: StaticOperationSchema = [9, n0, _DO,
  0, () => DescribeObjectsInput$, () => DescribeObjectsOutput$
];
export var DescribePipelines$: StaticOperationSchema = [9, n0, _DPes,
  0, () => DescribePipelinesInput$, () => DescribePipelinesOutput$
];
export var EvaluateExpression$: StaticOperationSchema = [9, n0, _EE,
  0, () => EvaluateExpressionInput$, () => EvaluateExpressionOutput$
];
export var GetPipelineDefinition$: StaticOperationSchema = [9, n0, _GPD,
...
export var PollForTask$: StaticOperationSchema = [9, n0, _PFT,
  0, () => PollForTaskInput$, () => PollForTaskOutput$
];
export var PutPipelineDefinition$: StaticOperationSchema = [9, n0, _PPD,
  0, () => PutPipelineDefinitionInput$, () => PutPipelineDefinitionOutput$
];
export var QueryObjects$: StaticOperationSchema = [9, n0, _QO,
...
export var ReportTaskProgress$: StaticOperationSchema = [9, n0, _RTP,
  0, () => ReportTaskProgressInput$, () => ReportTaskProgressOutput$
];
export var ReportTaskRunnerHeartbeat$: StaticOperationSchema = [9, n0, _RTRH,
  0, () => ReportTaskRunnerHeartbeatInput$, () => ReportTaskRunnerHeartbeatOutput$
];
export var SetStatus$: StaticOperationSchema = [9, n0, _SS,
  0, () => SetStatusInput$, () => __Unit
];
export var SetTaskStatus$: StaticOperationSchema = [9, n0, _STS,
  0, () => SetTaskStatusInput$, () => SetTaskStatusOutput$
];
export var ValidatePipelineDefinition$: StaticOperationSchema = [9, n0, _VPD,
