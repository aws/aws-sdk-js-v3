...
import type { QueryObjectsInput, QueryObjectsOutput } from "../models/models_0";
 ...
 * @public
 */
export class QueryObjectsCommand extends command<QueryObjectsCommandInput, QueryObjectsCommandOutput>(
  _ep0,
  _mw0,
  "QueryObjects",
  QueryObjects$
