...
import type { ActivatePipelineInput, ActivatePipelineOutput } from "../models/models_0";
 ...
 * @public
 */
export class ActivatePipelineCommand extends command<ActivatePipelineCommandInput, ActivatePipelineCommandOutput>(
  _ep0,
  _mw0,
  "ActivatePipeline",
  ActivatePipeline$
