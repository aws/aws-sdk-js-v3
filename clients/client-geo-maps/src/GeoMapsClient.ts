...
import {
  ...
  defaultGeoMapsHttpAuthSchemeParametersProvider,
  resolveHttpAuthSchemeConfig,
} from "./auth/httpAuthSchemeProvider";
import type { GetGlyphsCommandInput, GetGlyphsCommandOutput } from "./commands/GetGlyphsCommand";
import type { GetSpritesCommandInput, GetSpritesCommandOutput } from "./commands/GetSpritesCommand";
import type { GetStaticMapCommandInput, GetStaticMapCommandOutput } from "./commands/GetStaticMapCommand";
import type {
 ...
 * @public
 */
export type GeoMapsClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type GeoMapsClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<GeoMapsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultGeoMapsHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: GeoMapsClientResolvedConfig) =>
