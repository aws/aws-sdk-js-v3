  ...
  return {
    ...
    IPSet:
      output.IPSet !== undefined && output.IPSet !== null
        ...
        : undefined,
    LockToken:
      output.LockToken !== undefined && output.LockToken !== null ? output.LockToken : undefined
  } as any;
};
...
const deserializeAws_json1_1ManagedRuleGroupStatement = (
  ...
  return {
    ...
    Name: output.Name !== undefined && output.Name !== null ? output.Name : undefined,
    VendorName:
      output.VendorName !== undefined && output.VendorName !== null ? output.VendorName : undefined
  } as any;
};
