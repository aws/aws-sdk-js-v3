 ...
 * @public
 */
export class DescribeManagedProductsByVendorCommand extends command<DescribeManagedProductsByVendorCommandInput, DescribeManagedProductsByVendorCommandOutput>(
  _ep0,
  _mw0,
