...
import { type WAFV2ClientResolvedConfig, WAFV2ClientConfig } from "../WAFV2Client";
 ...
 * @internal
 */
export const defaultWAFV2HttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: WAFV2HttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultWAFV2HttpAuthSchemeProvider: WAFV2HttpAuthSchemeProvider = (authParameters) => {
