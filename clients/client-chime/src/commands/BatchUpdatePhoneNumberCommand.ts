...
import type { BatchUpdatePhoneNumberRequest, BatchUpdatePhoneNumberResponse } from "../models/models_0";
 ...
 * @public
 */
export class BatchUpdatePhoneNumberCommand extends command<BatchUpdatePhoneNumberCommandInput, BatchUpdatePhoneNumberCommandOutput>(
  _ep0,
  _mw0,
