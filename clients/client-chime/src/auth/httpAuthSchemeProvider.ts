...
import { type ChimeClientResolvedConfig, ChimeClientConfig } from "../ChimeClient";
 ...
 * @internal
 */
export const defaultChimeHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ChimeHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<ChimeClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultChimeHttpAuthSchemeProvider: ChimeHttpAuthSchemeProvider = (authParameters) => {
