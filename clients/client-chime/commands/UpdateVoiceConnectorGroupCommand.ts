...
import { UpdateVoiceConnectorGroupRequest, UpdateVoiceConnectorGroupResponse } from "../models/index";
import {
  deserializeAws_restJson1_1UpdateVoiceConnectorGroupCommand,
  serializeAws_restJson1_1UpdateVoiceConnectorGroupCommand
...
> {
  ...
  private serialize(input: UpdateVoiceConnectorGroupCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1UpdateVoiceConnectorGroupCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1UpdateVoiceConnectorGroupCommand(output, context);
  }
