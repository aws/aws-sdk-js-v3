...
import { GetVoiceConnectorTerminationRequest, GetVoiceConnectorTerminationResponse } from "../models/index";
import {
  deserializeAws_restJson1_1GetVoiceConnectorTerminationCommand,
  serializeAws_restJson1_1GetVoiceConnectorTerminationCommand
...
> {
  ...
  private serialize(input: GetVoiceConnectorTerminationCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1GetVoiceConnectorTerminationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetVoiceConnectorTerminationCommand(output, context);
  }
