...
import {
  ...
  serializeAws_restJson1_1CreateAttendeeCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1CreateAttendeeCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateAttendeeCommand(output, context);
  }
