...
import {
  deserializeAws_restJson1_1UpdateUserSettingsCommand,
  serializeAws_restJson1_1UpdateUserSettingsCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1UpdateUserSettingsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1UpdateUserSettingsCommand(output, context);
  }
