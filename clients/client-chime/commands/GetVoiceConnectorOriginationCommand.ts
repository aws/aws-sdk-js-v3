...
import { GetVoiceConnectorOriginationRequest, GetVoiceConnectorOriginationResponse } from "../models/index";
import {
  deserializeAws_restJson1_1GetVoiceConnectorOriginationCommand,
  serializeAws_restJson1_1GetVoiceConnectorOriginationCommand
...
> {
  ...
  private serialize(input: GetVoiceConnectorOriginationCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1GetVoiceConnectorOriginationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetVoiceConnectorOriginationCommand(output, context);
  }
