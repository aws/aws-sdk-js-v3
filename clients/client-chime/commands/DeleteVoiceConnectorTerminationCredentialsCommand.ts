...
import {
  deserializeAws_restJson1_1DeleteVoiceConnectorTerminationCredentialsCommand,
  serializeAws_restJson1_1DeleteVoiceConnectorTerminationCredentialsCommand,
...
export class DeleteVoiceConnectorTerminationCredentialsCommand extends $Command<DeleteVoiceConnectorTerminationCredentialsCommandInput, DeleteVoiceConnectorTerminationCredentialsCommandOutput, ChimeClientResolvedConfig> {
  ...
  ): Handler<DeleteVoiceConnectorTerminationCredentialsCommandInput, DeleteVoiceConnectorTerminationCredentialsCommandOutput> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteVoiceConnectorTerminationCredentialsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DeleteVoiceConnectorTerminationCredentialsCommand(output, context);
  }
