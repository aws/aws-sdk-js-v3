...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteVoiceConnectorTerminationCredentialsCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DeleteVoiceConnectorTerminationCredentialsCommand(
      output,
      context
    );
  }
