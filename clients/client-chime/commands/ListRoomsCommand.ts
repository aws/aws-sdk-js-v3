...
import {
  deserializeAws_restJson1_1ListRoomsCommand,
  serializeAws_restJson1_1ListRoomsCommand
...
export type ListRoomsCommandOutput = ListRoomsResponse;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ListRoomsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListRoomsCommand(output, context);
  }
