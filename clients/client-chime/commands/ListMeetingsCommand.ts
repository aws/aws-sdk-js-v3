...
import {
  deserializeAws_restJson1_1ListMeetingsCommand,
  serializeAws_restJson1_1ListMeetingsCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ListMeetingsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListMeetingsCommand(output, context);
  }
