...
import {
  deserializeAws_restJson1_1AssociateSigninDelegateGroupsWithAccountCommand,
  serializeAws_restJson1_1AssociateSigninDelegateGroupsWithAccountCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1AssociateSigninDelegateGroupsWithAccountCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1AssociateSigninDelegateGroupsWithAccountCommand(output, context);
  }
