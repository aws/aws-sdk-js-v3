...
import {
  deserializeAws_restJson1_1AssociatePhoneNumberWithUserCommand,
  serializeAws_restJson1_1AssociatePhoneNumberWithUserCommand,
...
export type AssociatePhoneNumberWithUserCommandOutput = AssociatePhoneNumberWithUserResponse;
...
export class AssociatePhoneNumberWithUserCommand extends $Command<AssociatePhoneNumberWithUserCommandInput, AssociatePhoneNumberWithUserCommandOutput, ChimeClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1AssociatePhoneNumberWithUserCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1AssociatePhoneNumberWithUserCommand(output, context);
  }
