...
export class GetVoiceConnectorStreamingConfigurationCommand extends $Command<GetVoiceConnectorStreamingConfigurationCommandInput, GetVoiceConnectorStreamingConfigurationCommandOutput, ChimeClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetVoiceConnectorStreamingConfigurationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetVoiceConnectorStreamingConfigurationCommand(output, context);
  }
