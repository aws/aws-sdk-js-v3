...
import { DeleteVoiceConnectorOriginationRequest } from "../models/index";
import {
  deserializeAws_restJson1_1DeleteVoiceConnectorOriginationCommand,
  serializeAws_restJson1_1DeleteVoiceConnectorOriginationCommand,
...
export class DeleteVoiceConnectorOriginationCommand extends $Command<DeleteVoiceConnectorOriginationCommandInput, DeleteVoiceConnectorOriginationCommandOutput, ChimeClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteVoiceConnectorOriginationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DeleteVoiceConnectorOriginationCommand(output, context);
  }
