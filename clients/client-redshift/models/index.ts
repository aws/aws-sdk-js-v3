 ...
 *
 */
export interface Cluster extends $MetadataBearer {
  __type?: "Cluster";
  /**
   *
 ...
 *
 */
export interface ClusterParameterGroup extends $MetadataBearer {
 ...
 *
 */
export interface ClusterSecurityGroup extends $MetadataBearer {
 ...
 *
 */
export interface ClusterSubnetGroup extends $MetadataBearer {
...
export interface CreateEventSubscriptionMessage {
   ...
   *         <p>Valid values: cluster, cluster-parameter-group, cluster-security-group, and
   *             cluster-snapshot.</p>
   *
   */
  SourceType?: string;
 ...
 *
 */
export interface DefaultClusterParameters extends $MetadataBearer {
...
export interface DescribeEventCategoriesMessage {
   ...
   *             categories apply.</p>
   *         <p>Valid values: cluster, cluster-snapshot, cluster-parameter-group, and
...
export interface EventSubscription extends $MetadataBearer {
  ...
  /**
   *
   *         <p>The source type of the events returned the Amazon Redshift event notification, such as
   *             cluster, or cluster-snapshot.</p>
   *
   */
  SourceType?: string;
 ...
 *
 */
export interface HsmClientCertificate extends $MetadataBearer {
 ...
 *
 */
export interface HsmConfiguration extends $MetadataBearer {
...
export interface ModifyClusterMessage {
  ...
  /**
   *
   *         <p>Indicates whether the cluster is encrypted. If the cluster is encrypted and you
   *             provide a value for the <code>KmsKeyId</code> parameter, we will encrypt the cluster
   ...
   *         <p>When you submit your request to resize a cluster, Amazon Redshift sets access permissions
   *             for the cluster to read-only. After Amazon Redshift provisions a new cluster according to your
   *             resize requirements, there will be a temporary outage while the old cluster is deleted
   *             and your connection is switched to the new cluster. When the new connection is complete,
   *             the original access permissions for the cluster are restored. You can use <a>DescribeResize</a> to track the progress of the resize request. </p>
   *         <p>Valid Values: <code>ds2.xlarge</code> | <code>ds2.8xlarge</code> |
 ...
 *
 */
export interface ReservedNode extends $MetadataBearer {
  __type?: "ReservedNode";
  /**
   *
 ...
 *
 */
export interface SnapshotCopyGrant extends $MetadataBearer {
 ...
 *
 */
export interface TableRestoreStatus extends $MetadataBearer {
