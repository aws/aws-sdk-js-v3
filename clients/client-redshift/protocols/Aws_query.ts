...
export async function deserializeAws_queryAuthorizeClusterSecurityGroupIngressCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryClusterSecurityGroup(
...
export async function deserializeAws_queryAuthorizeSnapshotAccessCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_querySnapshot(
...
export async function deserializeAws_queryCreateClusterCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryCluster(data.CreateClusterResult, context);
...
export async function deserializeAws_queryCreateClusterParameterGroupCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryClusterParameterGroup(
...
export async function deserializeAws_queryCreateClusterSubnetGroupCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryClusterSubnetGroup(
...
export async function deserializeAws_queryCreateHsmClientCertificateCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryHsmClientCertificate(
...
export async function deserializeAws_queryCreateHsmConfigurationCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryHsmConfiguration(
...
export async function deserializeAws_queryCreateSnapshotCopyGrantCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_querySnapshotCopyGrant(
...
export async function deserializeAws_queryDeleteClusterCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryCluster(data.DeleteClusterResult, context);
...
export async function deserializeAws_queryDescribeDefaultClusterParametersCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryDefaultClusterParameters(
...
export async function deserializeAws_queryDisableSnapshotCopyCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryCluster(
...
export async function deserializeAws_queryModifyClusterCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryCluster(data.ModifyClusterResult, context);
...
export async function deserializeAws_queryPurchaseReservedNodeOfferingCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryReservedNode(
...
export async function deserializeAws_queryRebootClusterCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryCluster(data.RebootClusterResult, context);
...
export async function deserializeAws_queryResizeClusterCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryCluster(data.ResizeClusterResult, context);
...
export async function deserializeAws_queryRestoreTableFromClusterSnapshotCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_queryTableRestoreStatus(
...
const serializeAws_queryClusterSecurityGroupNameList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "ClusterSecurityGroupName." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const serializeAws_queryDbGroupList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "DbGroup." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const serializeAws_queryDeleteClusterSnapshotMessageList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "DeleteClusterSnapshotMessage." + counter;
    entries[loc] = serializeAws_queryDeleteClusterSnapshotMessage(
      entry,
      context
    );
    counter++;
...
const serializeAws_queryIamRoleArnList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "IamRoleArn." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const serializeAws_queryNodeConfigurationOptionsFilterList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "NodeConfigurationOptionsFilter." + counter;
    entries[loc] = serializeAws_queryNodeConfigurationOptionsFilter(
      entry,
      context
    );
    counter++;
...
const serializeAws_queryScheduleDefinitionList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "ScheduleDefinition." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const serializeAws_queryScheduledActionFilterList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "ScheduledActionFilter." + counter;
    entries[loc] = serializeAws_queryScheduledActionFilter(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_querySnapshotIdentifierList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "String." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const serializeAws_querySnapshotSortingEntityList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "SnapshotSortingEntity." + counter;
    entries[loc] = serializeAws_querySnapshotSortingEntity(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryTagValueList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "TagValue." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const deserializeAws_queryAccountAttribute = (
  ...
  if (output["AttributeValues"]["AttributeValueTarget"] !== undefined) {
...
const deserializeAws_queryAccountAttributeList = (
  ...
  if (output["AccountAttributes"]["AccountAttribute"] !== undefined) {
...
const deserializeAws_queryAvailabilityZone = (
  ...
  if (output["SupportedPlatforms"]["SupportedPlatform"] !== undefined) {
...
const deserializeAws_queryCluster = (
  ...
  if (output["ClusterNodes"]["member"] !== undefined) {
    contents.ClusterNodes = deserializeAws_queryClusterNodesList(
      output["ClusterNodes"]["member"],
      context
    );
  }
  if (output["ClusterParameterGroups"]["ClusterParameterGroup"] !== undefined) {
  ...
  if (output["ClusterSecurityGroups"]["ClusterSecurityGroup"] !== undefined) {
  ...
  if (output["IamRoles"]["ClusterIamRole"] !== undefined) {
  ...
  if (output["PendingActions"]["member"] !== undefined) {
  ...
  if (output["Tags"]["Tag"] !== undefined) {
    contents.Tags = deserializeAws_queryTagList(output["Tags"]["Tag"], context);
  }
  if (output["VpcId"] !== undefined) {
    contents.VpcId = output["VpcId"];
  }
  if (output["VpcSecurityGroups"]["VpcSecurityGroup"] !== undefined) {
...
const deserializeAws_queryClusterDbRevision = (
  ...
  if (output["RevisionTargets"]["RevisionTarget"] !== undefined) {
...
const deserializeAws_queryClusterDbRevisionsMessage = (
  ...
  if (output["ClusterDbRevisions"]["ClusterDbRevision"] !== undefined) {
...
const deserializeAws_queryClusterParameterGroupStatus = (
  ...
  if (output["ClusterParameterStatusList"]["member"] !== undefined) {
...
const deserializeAws_queryClusterParameterGroupsMessage = (
  ...
  if (output["ParameterGroups"]["ClusterParameterGroup"] !== undefined) {
...
const deserializeAws_queryClusterSubnetGroupMessage = (
  ...
  if (output["ClusterSubnetGroups"]["ClusterSubnetGroup"] !== undefined) {
...
const deserializeAws_queryClusterVersionsMessage = (
  ...
  if (output["ClusterVersions"]["ClusterVersion"] !== undefined) {
...
const deserializeAws_queryClustersMessage = (
  ...
  if (output["Clusters"]["Cluster"] !== undefined) {
...
const deserializeAws_queryDescribeSnapshotSchedulesOutputMessage = (
  ...
  if (output["SnapshotSchedules"]["SnapshotSchedule"] !== undefined) {
...
const deserializeAws_queryEventCategoriesMap = (
  ...
  if (output["Events"]["EventInfoMap"] !== undefined) {
...
const deserializeAws_queryGetReservedNodeExchangeOfferingsOutputMessage = (
  ...
  if (output["ReservedNodeOfferings"]["ReservedNodeOffering"] !== undefined) {
...
const deserializeAws_queryHsmClientCertificateMessage = (
  ...
  if (output["HsmClientCertificates"]["HsmClientCertificate"] !== undefined) {
...
const deserializeAws_queryHsmConfigurationMessage = (
  ...
  if (output["HsmConfigurations"]["HsmConfiguration"] !== undefined) {
...
const deserializeAws_queryMaintenanceTrack = (
  ...
  if (output["UpdateTargets"]["UpdateTarget"] !== undefined) {
...
const deserializeAws_queryReservedNodesMessage = (
  ...
  if (output["ReservedNodes"]["ReservedNode"] !== undefined) {
...
const deserializeAws_queryScheduledAction = (
  ...
  if (output["NextInvocations"]["ScheduledActionTime"] !== undefined) {
...
const deserializeAws_queryScheduledActionsMessage = (
  ...
  if (output["ScheduledActions"]["ScheduledAction"] !== undefined) {
...
const deserializeAws_querySnapshot = (
  ...
  if (output["RestorableNodeTypes"]["NodeType"] !== undefined) {
...
const deserializeAws_querySnapshotCopyGrantMessage = (
  ...
  if (output["SnapshotCopyGrants"]["SnapshotCopyGrant"] !== undefined) {
...
const deserializeAws_querySnapshotMessage = (
  ...
  if (output["Snapshots"]["Snapshot"] !== undefined) {
...
const deserializeAws_querySnapshotSchedule = (
  ...
  if (output["NextInvocations"]["SnapshotTime"] !== undefined) {
    contents.NextInvocations = deserializeAws_queryScheduledSnapshotTimeList(
      output["NextInvocations"]["SnapshotTime"],
      context
    );
  }
  if (output["ScheduleDefinitions"]["ScheduleDefinition"] !== undefined) {
...
const deserializeAws_queryTableRestoreStatusMessage = (
  ...
  if (output["TableRestoreStatusDetails"]["TableRestoreStatus"] !== undefined) {
...
const deserializeAws_queryTaggedResourceListMessage = (
  ...
  if (output["TaggedResources"]["TaggedResource"] !== undefined) {
...
const deserializeAws_queryTrackListMessage = (
  ...
  if (output["MaintenanceTracks"]["MaintenanceTrack"] !== undefined) {
...
const deserializeAws_queryUpdateTarget = (
  ...
  if (output["SupportedOperations"]["SupportedOperation"] !== undefined) {
