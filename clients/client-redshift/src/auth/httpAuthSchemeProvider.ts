...
import { type RedshiftClientResolvedConfig, RedshiftClientConfig } from "../RedshiftClient";
 ...
 * @internal
 */
export const defaultRedshiftHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: RedshiftHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultRedshiftHttpAuthSchemeProvider: RedshiftHttpAuthSchemeProvider = (authParameters) => {
