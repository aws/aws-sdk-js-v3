...
import type { CopyClusterSnapshotMessage, CopyClusterSnapshotResult } from "../models/models_0";
 ...
 * @public
 */
export class CopyClusterSnapshotCommand extends command<CopyClusterSnapshotCommandInput, CopyClusterSnapshotCommandOutput>(
  _ep0,
  _mw0,
  "CopyClusterSnapshot",
  CopyClusterSnapshot$
