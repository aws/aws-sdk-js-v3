...
import type { DescribeReservedNodeOfferingsMessage, ReservedNodeOfferingsMessage } from "../models/models_0";
 ...
 * @public
 */
export class DescribeReservedNodeOfferingsCommand extends command<DescribeReservedNodeOfferingsCommandInput, DescribeReservedNodeOfferingsCommandOutput>(
  _ep0,
  _mw0,
