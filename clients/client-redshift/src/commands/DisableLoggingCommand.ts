...
import type { DisableLoggingMessage, LoggingStatus } from "../models/models_0";
 ...
 * @public
 */
export class DisableLoggingCommand extends command<DisableLoggingCommandInput, DisableLoggingCommandOutput>(
  _ep0,
  _mw0,
  "DisableLogging",
  DisableLogging$
