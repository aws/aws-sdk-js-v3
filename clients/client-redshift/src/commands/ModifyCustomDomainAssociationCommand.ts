 ...
 * @public
 */
export class ModifyCustomDomainAssociationCommand extends command<ModifyCustomDomainAssociationCommandInput, ModifyCustomDomainAssociationCommandOutput>(
  _ep0,
  _mw0,
