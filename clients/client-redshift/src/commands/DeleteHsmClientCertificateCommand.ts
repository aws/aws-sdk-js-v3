...
import { DeleteHsmClientCertificate$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteHsmClientCertificateCommand extends command<DeleteHsmClientCertificateCommandInput, DeleteHsmClientCertificateCommandOutput>(
  _ep0,
  _mw0,
