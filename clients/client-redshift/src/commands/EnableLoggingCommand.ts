...
import type { EnableLoggingMessage, LoggingStatus } from "../models/models_0";
import { EnableLogging$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class EnableLoggingCommand extends command<EnableLoggingCommandInput, EnableLoggingCommandOutput>(
  _ep0,
  _mw0,
  "EnableLogging",
  EnableLogging$
