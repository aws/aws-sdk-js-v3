...
import type { FailoverPrimaryComputeInputMessage, FailoverPrimaryComputeResult } from "../models/models_0";
import { FailoverPrimaryCompute$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class FailoverPrimaryComputeCommand extends command<FailoverPrimaryComputeCommandInput, FailoverPrimaryComputeCommandOutput>(
  _ep0,
  _mw0,
