...
import type { CreateUsageLimitMessage, UsageLimit } from "../models/models_0";
 ...
 * @public
 */
export class CreateUsageLimitCommand extends command<CreateUsageLimitCommandInput, CreateUsageLimitCommandOutput>(
  _ep0,
  _mw0,
  "CreateUsageLimit",
  CreateUsageLimit$
