...
import type { ClusterExtendedCredentials, GetClusterCredentialsWithIAMMessage } from "../models/models_0";
 ...
 * @public
 */
export class GetClusterCredentialsWithIAMCommand extends command<GetClusterCredentialsWithIAMCommandInput, GetClusterCredentialsWithIAMCommandOutput>(
  _ep0,
  _mw0,
