...
import type { CancelResizeMessage, ResizeProgressMessage } from "../models/models_0";
 ...
 * @public
 */
export class CancelResizeCommand extends command<CancelResizeCommandInput, CancelResizeCommandOutput>(
  _ep0,
  _mw0,
  "CancelResize",
  CancelResize$
