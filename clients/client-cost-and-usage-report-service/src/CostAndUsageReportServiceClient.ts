...
import {
  defaultCostAndUsageReportServiceHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type CostAndUsageReportServiceClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
 ...
 * @public
 */
export type CostAndUsageReportServiceClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultCostAndUsageReportServiceHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: CostAndUsageReportServiceClientResolvedConfig) =>
