 ...
 * @public
 */
export class DeleteCoreNetworkPolicyVersionCommand extends command<DeleteCoreNetworkPolicyVersionCommandInput, DeleteCoreNetworkPolicyVersionCommandOutput>(
  _ep0,
  _mw0,
