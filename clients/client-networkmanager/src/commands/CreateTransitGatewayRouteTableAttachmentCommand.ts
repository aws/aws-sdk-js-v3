 ...
 * @public
 */
export class CreateTransitGatewayRouteTableAttachmentCommand extends command<CreateTransitGatewayRouteTableAttachmentCommandInput, CreateTransitGatewayRouteTableAttachmentCommandOutput>(
  _ep0,
  _mw0,
