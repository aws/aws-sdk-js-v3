 ...
 * @public
 */
export class PutAttachmentRoutingPolicyLabelCommand extends command<PutAttachmentRoutingPolicyLabelCommandInput, PutAttachmentRoutingPolicyLabelCommandOutput>(
  _ep0,
  _mw0,
