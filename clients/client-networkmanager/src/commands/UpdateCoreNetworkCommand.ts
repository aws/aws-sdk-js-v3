...
import type { UpdateCoreNetworkRequest, UpdateCoreNetworkResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateCoreNetworkCommand extends command<UpdateCoreNetworkCommandInput, UpdateCoreNetworkCommandOutput>(
  _ep0,
  _mw0,
  "UpdateCoreNetwork",
  UpdateCoreNetwork$
