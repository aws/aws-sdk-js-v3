 ...
 * @public
 */
export class UpdateDirectConnectGatewayAttachmentCommand extends command<UpdateDirectConnectGatewayAttachmentCommandInput, UpdateDirectConnectGatewayAttachmentCommandOutput>(
  _ep0,
  _mw0,
