...
import type { DisassociateLinkRequest, DisassociateLinkResponse } from "../models/models_0";
 ...
 * @public
 */
export class DisassociateLinkCommand extends command<DisassociateLinkCommandInput, DisassociateLinkCommandOutput>(
  _ep0,
  _mw0,
  "DisassociateLink",
  DisassociateLink$
