...
import type { GetConnectPeerRequest, GetConnectPeerResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetConnectPeerCommand extends command<GetConnectPeerCommandInput, GetConnectPeerCommandOutput>(
  _ep0,
  _mw0,
  "GetConnectPeer",
  GetConnectPeer$
