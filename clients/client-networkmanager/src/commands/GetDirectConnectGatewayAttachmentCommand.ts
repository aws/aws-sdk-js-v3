 ...
 * @public
 */
export class GetDirectConnectGatewayAttachmentCommand extends command<GetDirectConnectGatewayAttachmentCommandInput, GetDirectConnectGatewayAttachmentCommandOutput>(
  _ep0,
  _mw0,
