...
import type { CreateSiteRequest, CreateSiteResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateSiteCommand extends command<CreateSiteCommandInput, CreateSiteCommandOutput>(
  _ep0,
  _mw0,
  "CreateSite",
  CreateSite$
