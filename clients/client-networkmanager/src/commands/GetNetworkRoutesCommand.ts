...
import type { GetNetworkRoutesRequest, GetNetworkRoutesResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetNetworkRoutesCommand extends command<GetNetworkRoutesCommandInput, GetNetworkRoutesCommandOutput>(
  _ep0,
  _mw0,
  "GetNetworkRoutes",
  GetNetworkRoutes$
