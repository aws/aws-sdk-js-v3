...
import type { CreateCoreNetworkRequest, CreateCoreNetworkResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateCoreNetworkCommand extends command<CreateCoreNetworkCommandInput, CreateCoreNetworkCommandOutput>(
  _ep0,
  _mw0,
  "CreateCoreNetwork",
  CreateCoreNetwork$
