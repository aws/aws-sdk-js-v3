 ...
 * @public
 */
export class ListCoreNetworkRoutingInformationCommand extends command<ListCoreNetworkRoutingInformationCommandInput, ListCoreNetworkRoutingInformationCommandOutput>(
  _ep0,
  _mw0,
