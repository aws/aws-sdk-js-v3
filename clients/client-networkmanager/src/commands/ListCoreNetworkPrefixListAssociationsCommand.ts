 ...
 * @public
 */
export class ListCoreNetworkPrefixListAssociationsCommand extends command<ListCoreNetworkPrefixListAssociationsCommandInput, ListCoreNetworkPrefixListAssociationsCommandOutput>(
  _ep0,
  _mw0,
