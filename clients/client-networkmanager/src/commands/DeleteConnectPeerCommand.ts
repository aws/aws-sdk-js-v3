...
import type { DeleteConnectPeerRequest, DeleteConnectPeerResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteConnectPeerCommand extends command<DeleteConnectPeerCommandInput, DeleteConnectPeerCommandOutput>(
  _ep0,
  _mw0,
  "DeleteConnectPeer",
  DeleteConnectPeer$
