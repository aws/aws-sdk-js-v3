...
import type { CreateSiteToSiteVpnAttachmentRequest, CreateSiteToSiteVpnAttachmentResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateSiteToSiteVpnAttachmentCommand extends command<CreateSiteToSiteVpnAttachmentCommandInput, CreateSiteToSiteVpnAttachmentCommandOutput>(
  _ep0,
  _mw0,
