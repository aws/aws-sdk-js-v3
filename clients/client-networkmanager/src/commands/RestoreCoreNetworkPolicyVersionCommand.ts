 ...
 * @public
 */
export class RestoreCoreNetworkPolicyVersionCommand extends command<RestoreCoreNetworkPolicyVersionCommandInput, RestoreCoreNetworkPolicyVersionCommandOutput>(
  _ep0,
  _mw0,
