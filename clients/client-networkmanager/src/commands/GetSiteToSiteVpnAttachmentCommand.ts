...
import type { GetSiteToSiteVpnAttachmentRequest, GetSiteToSiteVpnAttachmentResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetSiteToSiteVpnAttachmentCommand extends command<GetSiteToSiteVpnAttachmentCommandInput, GetSiteToSiteVpnAttachmentCommandOutput>(
  _ep0,
  _mw0,
