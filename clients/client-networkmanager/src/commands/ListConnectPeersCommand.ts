...
import type { ListConnectPeersRequest, ListConnectPeersResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListConnectPeersCommand extends command<ListConnectPeersCommandInput, ListConnectPeersCommandOutput>(
  _ep0,
  _mw0,
  "ListConnectPeers",
  ListConnectPeers$
