...
export var NetworkManagerServiceException$: StaticErrorSchema = [-3, _s, "NetworkManagerServiceException", 0, [], []];
_s_registry.registerError(NetworkManagerServiceException$, NetworkManagerServiceException);
...
export var CoreNetworkPolicyException$: StaticErrorSchema = [-3, n0, _CNPE,
  { [_e]: _c, [_hE]: 400 },
  [_M, _E],
  [0, () => CoreNetworkPolicyErrorList], 1
];
n0_registry.registerError(CoreNetworkPolicyException$, CoreNetworkPolicyException);
...
export var AttachmentError$: StaticStructureSchema = [3, n0, _AE,
  0,
  [_Co, _M, _RAe, _RIe],
  [0, 0, 0, 0]
];
export var AttachmentRoutingPolicyAssociationSummary$: StaticStructureSchema = [3, n0, _ARPAS,
  0,
  [_AI, _PRP, _ARP, _RPL],
  [0, 64 | 0, 64 | 0, 0]
];
export var AWSLocation$: StaticStructureSchema = [3, n0, _AWSL,
  0,
  [_Z, _SA],
  [0, 0]
];
export var Bandwidth$: StaticStructureSchema = [3, n0, _B,
  0,
  [_US, _DS],
  [1, 1]
];
export var BgpOptions$: StaticStructureSchema = [3, n0, _BO,
  0,
  [_PA],
  [1]
];
...
export var ConnectAttachmentOptions$: StaticStructureSchema = [3, n0, _CAO,
  0,
  [_P],
  [0]
];
export var Connection$: StaticStructureSchema = [3, n0, _Con,
  0,
  [_CI, _CAon, _GNI, _DI, _CDI, _LI, _CLI, _D, _CA, _S, _T],
  [0, 0, 0, 0, 0, 0, 0, 0, 4, 0, () => TagList]
];
export var ConnectionHealth$: StaticStructureSchema = [3, n0, _CH,
  0,
  [_Ty, _St, _Ti],
  [0, 0, 4]
];
export var ConnectPeer$: StaticStructureSchema = [3, n0, _CP,
  0,
  [_CNI, _CAI, _CPI, _EL, _S, _CA, _Conf, _T, _SA, _LME],
  [0, 0, 0, 0, 0, 4, () => ConnectPeerConfiguration$, () => TagList, 0, () => ConnectPeerErrorList]
];
export var ConnectPeerAssociation$: StaticStructureSchema = [3, n0, _CPA,
  0,
  [_CPI, _GNI, _DI, _LI, _S],
  [0, 0, 0, 0, 0]
];
export var ConnectPeerBgpConfiguration$: StaticStructureSchema = [3, n0, _CPBC,
  0,
  [_CNAo, _PA, _CNAor, _PAe],
  [1, 1, 0, 0]
];
export var ConnectPeerConfiguration$: StaticStructureSchema = [3, n0, _CPC,
  0,
  [_CNAor, _PAe, _ICB, _P, _BC],
  [0, 0, 64 | 0, 0, () => ConnectPeerBgpConfigurationList]
];
export var ConnectPeerError$: StaticStructureSchema = [3, n0, _CPE,
  0,
  [_Co, _M, _RAe, _RIe],
  [0, 0, 0, 0]
];
export var ConnectPeerSummary$: StaticStructureSchema = [3, n0, _CPS,
  0,
  [_CNI, _CAI, _CPI, _EL, _CPSo, _CA, _T, _SA],
  [0, 0, 0, 0, 0, 4, () => TagList, 0]
];
export var CoreNetwork$: StaticStructureSchema = [3, n0, _CN,
  0,
...
export var CoreNetworkChange$: StaticStructureSchema = [3, n0, _CNC,
  0,
  [_Ty, _Ac, _I, _PV, _NV, _IP],
  [0, 0, 0, () => CoreNetworkChangeValues$, () => CoreNetworkChangeValues$, 0]
];
export var CoreNetworkChangeEvent$: StaticStructureSchema = [3, n0, _CNCE,
  0,
  [_Ty, _Ac, _IP, _ET, _St, _V],
  [0, 0, 0, 4, 0, () => CoreNetworkChangeEventValues$]
];
export var CoreNetworkChangeEventValues$: StaticStructureSchema = [3, n0, _CNCEV,
  0,
  [_EL, _PEL, _RPD, _SN, _NFGN, _AI, _Ci, _RPAD],
  [0, 0, 0, 0, 0, 0, 0, () => RoutingPolicyAssociationDetailsList]
];
export var CoreNetworkChangeValues$: StaticStructureSchema = [3, n0, _CNCV,
  0,
...
export var CoreNetworkEdge$: StaticStructureSchema = [3, n0, _CNE,
  0,
  [_EL, _As, _ICB],
  [0, 1, 64 | 0]
];
export var CoreNetworkNetworkFunctionGroup$: StaticStructureSchema = [3, n0, _CNNFG,
  0,
  [_N, _ELd, _Se],
  [0, 64 | 0, () => ServiceInsertionSegments$]
];
export var CoreNetworkNetworkFunctionGroupIdentifier$: StaticStructureSchema = [3, n0, _CNNFGI,
  0,
  [_CNI, _NFGN, _EL],
  [0, 0, 0]
];
export var CoreNetworkPolicy$: StaticStructureSchema = [3, n0, _CNP,
  0,
  [_CNI, _PVI, _Al, _D, _CA, _CSS, _PE, _PD],
  [0, 1, 0, 0, 4, 0, () => CoreNetworkPolicyErrorList, [() => SynthesizedJsonCoreNetworkPolicyDocument, 0]]
];
export var CoreNetworkPolicyError$: StaticStructureSchema = [3, n0, _CNPEo,
  0,
  [_EC, _M, _Pa],
  [0, 0, 0], 2
];
...
export var CoreNetworkRoutingInformation$: StaticStructureSchema = [3, n0, _CNRI,
  0,
  [_Pr, _NH, _LP, _Me, _AP, _Com],
  [0, () => RoutingInformationNextHop$, 0, 0, 64 | 0, 64 | 0]
];
export var CoreNetworkSegment$: StaticStructureSchema = [3, n0, _CNS,
  0,
  [_N, _ELd, _SS],
  [0, 64 | 0, 64 | 0]
];
export var CoreNetworkSegmentEdgeIdentifier$: StaticStructureSchema = [3, n0, _CNSEI,
  0,
  [_CNI, _SN, _EL],
  [0, 0, 0]
];
export var CoreNetworkSummary$: StaticStructureSchema = [3, n0, _CNSo,
  0,
...
export var CreateGlobalNetworkRequest$: StaticStructureSchema = [3, n0, _CGNR,
  0,
  [_D, _T],
  [0, () => TagList]
];
export var CreateGlobalNetworkResponse$: StaticStructureSchema = [3, n0, _CGNRr,
  0,
  [_GN],
  [() => GlobalNetwork$]
];
...
export var CustomerGatewayAssociation$: StaticStructureSchema = [3, n0, _CGAu,
  0,
...
export var DescribeGlobalNetworksRequest$: StaticStructureSchema = [3, n0, _DGNRes,
  0,
  [_GNIl, _MR, _NT],
  [[64 | 0, { [_hQ]: _gNI }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var DescribeGlobalNetworksResponse$: StaticStructureSchema = [3, n0, _DGNResc,
  0,
  [_GNl, _NT],
  [() => GlobalNetworkList, 0]
];
...
export var EdgeOverride$: StaticStructureSchema = [3, n0, _EO,
  0,
  [_ES, _UE],
  [[1, n0, _ESL, 0, 64 | 0], 0]
];
...
export var GlobalNetwork$: StaticStructureSchema = [3, n0, _GN,
  0,
...
export var LinkAssociation$: StaticStructureSchema = [3, n0, _LA,
  0,
  [_GNI, _DI, _LI, _LAS],
  [0, 0, 0, 0]
];
...
export var ListAttachmentsRequest$: StaticStructureSchema = [3, n0, _LAR,
  0,
  [_CNI, _AT, _EL, _S, _MR, _NT],
  [[0, { [_hQ]: _cNI }], [0, { [_hQ]: _aT }], [0, { [_hQ]: _eL }], [0, { [_hQ]: _st }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListAttachmentsResponse$: StaticStructureSchema = [3, n0, _LARi,
  0,
  [_At, _NT],
  [() => AttachmentList, 0]
];
export var ListConnectPeersRequest$: StaticStructureSchema = [3, n0, _LCPR,
  0,
  [_CNI, _CAI, _MR, _NT],
  [[0, { [_hQ]: _cNI }], [0, { [_hQ]: _cAI }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListConnectPeersResponse$: StaticStructureSchema = [3, n0, _LCPRi,
  0,
  [_CPo, _NT],
...
export var ListCoreNetworksRequest$: StaticStructureSchema = [3, n0, _LCNR,
  0,
  [_MR, _NT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListCoreNetworksResponse$: StaticStructureSchema = [3, n0, _LCNRi,
  0,
  [_CNo, _NT],
  [() => CoreNetworkSummaryList, 0]
];
export var ListOrganizationServiceAccessStatusRequest$: StaticStructureSchema = [3, n0, _LOSASR,
  0,
  [_MR, _NT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListOrganizationServiceAccessStatusResponse$: StaticStructureSchema = [3, n0, _LOSASRi,
  0,
  [_OS, _NT],
  [[() => OrganizationStatus$, 0], 0]
];
export var ListPeeringsRequest$: StaticStructureSchema = [3, n0, _LPR,
  0,
  [_CNI, _PT, _EL, _S, _MR, _NT],
  [[0, { [_hQ]: _cNI }], [0, { [_hQ]: _pT }], [0, { [_hQ]: _eL }], [0, { [_hQ]: _st }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListPeeringsResponse$: StaticStructureSchema = [3, n0, _LPRi,
  0,
  [_Pee, _NT],
  [() => PeeringList, 0]
];
...
export var NetworkFunctionGroup$: StaticStructureSchema = [3, n0, _NFGe,
  0,
  [_N],
  [0]
];
export var NetworkResource$: StaticStructureSchema = [3, n0, _NRet,
  0,
  [_RGA, _CNI, _AR, _AIc, _RT, _RI, _RAe, _Def, _DT, _T, _Met],
  [0, 0, 0, 0, 0, 0, 0, 0, 4, () => TagList, 128 | 0]
];
export var NetworkResourceCount$: StaticStructureSchema = [3, n0, _NRCe,
  0,
  [_RT, _Cou],
  [0, 1]
];
export var NetworkResourceSummary$: StaticStructureSchema = [3, n0, _NRS,
  0,
  [_RGA, _RAe, _RT, _Def, _NTa, _IM],
  [0, 0, 0, 0, 0, 2]
];
export var NetworkRoute$: StaticStructureSchema = [3, n0, _NRetw,
  0,
  [_DCB, _Des, _PLIr, _S, _Ty],
  [0, () => NetworkRouteDestinationList, 0, 0, 0]
];
export var NetworkRouteDestination$: StaticStructureSchema = [3, n0, _NRD,
  0,
  [_CNAI, _TGAI, _SN, _NFGN, _EL, _RT, _RI],
  [0, 0, 0, 0, 0, 0, 0]
];
export var NetworkTelemetry$: StaticStructureSchema = [3, n0, _NTe,
  0,
  [_RGA, _CNI, _AR, _AIc, _RT, _RI, _RAe, _Ad, _H],
  [0, 0, 0, 0, 0, 0, 0, 0, () => ConnectionHealth$]
];
export var OrganizationStatus$: StaticStructureSchema = [3, n0, _OS,
  0,
  [_OI, _OASAS, _SLRDS, _ASL],
  [0, 0, 0, [() => AccountStatusList, { [_xN]: _OS }]]
];
export var PathComponent$: StaticStructureSchema = [3, n0, _PC,
  0,
  [_Seq, _Res, _DCB],
  [1, () => NetworkResourceSummary$, 0]
];
export var Peering$: StaticStructureSchema = [3, n0, _Pe,
  0,
  [_CNI, _CNA, _PI, _OAI, _PT, _S, _EL, _RAe, _T, _CA, _LME],
  [0, 0, 0, 0, 0, 0, 0, 0, () => TagList, 4, () => PeeringErrorList]
];
export var PeeringError$: StaticStructureSchema = [3, n0, _PEe,
  0,
  [_Co, _M, _RAe, _RIe, _MPC],
  [0, 0, 0, 0, () => PermissionsErrorContext$]
];
export var PermissionsErrorContext$: StaticStructureSchema = [3, n0, _PEC,
  0,
  [_MP],
  [0]
];
export var PrefixListAssociation$: StaticStructureSchema = [3, n0, _PLAref,
  0,
  [_CNI, _PLA, _PLAr],
  [0, 0, 0]
];
export var ProposedNetworkFunctionGroupChange$: StaticStructureSchema = [3, n0, _PNFGC,
  0,
  [_T, _APRN, _NFGN],
  [() => TagList, 1, 0]
];
export var ProposedSegmentChange$: StaticStructureSchema = [3, n0, _PSC,
  0,
  [_T, _APRN, _SN],
  [() => TagList, 1, 0]
];
...
export var RouteAnalysis$: StaticStructureSchema = [3, n0, _RAo,
  0,
...
export var RouteAnalysisCompletion$: StaticStructureSchema = [3, n0, _RAC,
  0,
  [_RC, _RCe, _RCea],
  [0, 0, 128 | 0]
];
export var RouteAnalysisEndpointOptions$: StaticStructureSchema = [3, n0, _RAEO,
  0,
  [_TGAA, _TGA, _IA],
  [0, 0, 0]
];
export var RouteAnalysisEndpointOptionsSpecification$: StaticStructureSchema = [3, n0, _RAEOS,
  0,
  [_TGAA, _IA],
  [0, 0]
];
export var RouteAnalysisPath$: StaticStructureSchema = [3, n0, _RAP,
  0,
  [_CS, _Pa],
  [() => RouteAnalysisCompletion$, () => PathComponentList]
];
export var RouteTableIdentifier$: StaticStructureSchema = [3, n0, _RTI,
  0,
  [_TGRTA, _CNSE, _CNNFG],
  [0, () => CoreNetworkSegmentEdgeIdentifier$, () => CoreNetworkNetworkFunctionGroupIdentifier$]
];
export var RoutingInformationNextHop$: StaticStructureSchema = [3, n0, _RINH,
  0,
  [_IA, _CNAI, _RI, _RT, _SN, _EL],
  [0, 0, 0, 0, 0, 0]
];
export var RoutingPolicyAssociationDetail$: StaticStructureSchema = [3, n0, _RPADo,
  0,
  [_RPN, _SS],
  [64 | 0, 64 | 0]
];
export var ServiceInsertionAction$: StaticStructureSchema = [3, n0, _SIAe,
  0,
  [_Ac, _Mod, _WST, _Vi],
  [0, 0, () => WhenSentTo$, () => Via$]
];
export var ServiceInsertionSegments$: StaticStructureSchema = [3, n0, _SIS,
  0,
  [_SV, _STe],
  [64 | 0, 64 | 0]
];
...
export var SiteToSiteVpnAttachment$: StaticStructureSchema = [3, n0, _STSVA,
  0,
  [_A, _VCA],
  [() => Attachment$, 0]
];
...
export var TransitGatewayPeering$: StaticStructureSchema = [3, n0, _TGP,
  0,
  [_Pe, _TGA, _TGPAI],
  [() => Peering$, 0, 0]
];
export var TransitGatewayRegistration$: StaticStructureSchema = [3, n0, _TGR,
  0,
  [_GNI, _TGA, _S],
  [0, 0, () => TransitGatewayRegistrationStateReason$]
];
export var TransitGatewayRegistrationStateReason$: StaticStructureSchema = [3, n0, _TGRSR,
  0,
  [_Co, _M],
  [0, 0]
];
export var TransitGatewayRouteTableAttachment$: StaticStructureSchema = [3, n0, _TGRTAr,
  0,
  [_A, _PI, _TGRTA],
  [() => Attachment$, 0, 0]
];
...
export var VpcAttachment$: StaticStructureSchema = [3, n0, _VAp,
  0,
  [_A, _SAu, _O],
...
export var WhenSentTo$: StaticStructureSchema = [3, n0, _WST,
  0,
  [_WSTSL],
  [64 | 0]
];
var AccountStatusList: StaticListSchema = [1, n0, _ASL,
  0, () => AccountStatus$
];
var AttachmentErrorList: StaticListSchema = [1, n0, _AEL,
  0, () => AttachmentError$
];
var AttachmentList: StaticListSchema = [1, n0, _AL,
  0, () => Attachment$
];
var AttachmentRoutingPolicyAssociationsList: StaticListSchema = [1, n0, _ARPAL,
...
var ConnectPeerAssociationList: StaticListSchema = [1, n0, _CPAL,
  0, () => ConnectPeerAssociation$
];
var ConnectPeerBgpConfigurationList: StaticListSchema = [1, n0, _CPBCL,
  0, () => ConnectPeerBgpConfiguration$
];
var ConnectPeerErrorList: StaticListSchema = [1, n0, _CPEL,
  0, () => ConnectPeerError$
];
var ConnectPeerIdList = 64 | 0;
var ConnectPeerSummaryList: StaticListSchema = [1, n0, _CPSL,
  0, () => ConnectPeerSummary$
];
var ConstrainedStringList = 64 | 0;
var CoreNetworkChangeEventList: StaticListSchema = [1, n0, _CNCEL,
  0, () => CoreNetworkChangeEvent$
];
var CoreNetworkChangeList: StaticListSchema = [1, n0, _CNCL,
  0, () => CoreNetworkChange$
];
var CoreNetworkEdgeList: StaticListSchema = [1, n0, _CNEL,
  0, () => CoreNetworkEdge$
];
var CoreNetworkNetworkFunctionGroupList: StaticListSchema = [1, n0, _CNNFGL,
  0, () => CoreNetworkNetworkFunctionGroup$
];
var CoreNetworkPolicyErrorList: StaticListSchema = [1, n0, _CNPEL,
  0, () => CoreNetworkPolicyError$
];
var CoreNetworkPolicyVersionList: StaticListSchema = [1, n0, _CNPVL,
  0, () => CoreNetworkPolicyVersion$
];
var CoreNetworkRoutingInformationList: StaticListSchema = [1, n0, _CNRIL,
  0, () => CoreNetworkRoutingInformation$
];
var CoreNetworkSegmentList: StaticListSchema = [1, n0, _CNSL,
  0, () => CoreNetworkSegment$
];
var CoreNetworkSummaryList: StaticListSchema = [1, n0, _CNSLo,
  0, () => CoreNetworkSummary$
];
var CustomerGatewayArnList = 64 | 0;
var CustomerGatewayAssociationList: StaticListSchema = [1, n0, _CGAL,
...
var EdgeSet = 64 | 0;
var EdgeSetList: StaticListSchema = [1, n0, _ESL,
  0, 64 | 0
];
var ExternalRegionCodeList = 64 | 0;
var FilterValues = 64 | 0;
var GlobalNetworkIdList = 64 | 0;
var GlobalNetworkList: StaticListSchema = [1, n0, _GNL,
  0, () => GlobalNetwork$
];
var LinkAssociationList: StaticListSchema = [1, n0, _LAL,
  0, () => LinkAssociation$
];
var LinkIdList = 64 | 0;
...
var NetworkFunctionGroupList: StaticListSchema = [1, n0, _NFGL,
  0, () => NetworkFunctionGroup$
];
var NetworkResourceCountList: StaticListSchema = [1, n0, _NRCL,
  0, () => NetworkResourceCount$
];
var NetworkResourceList: StaticListSchema = [1, n0, _NRL,
  0, () => NetworkResource$
];
var NetworkRouteDestinationList: StaticListSchema = [1, n0, _NRDL,
  0, () => NetworkRouteDestination$
];
var NetworkRouteList: StaticListSchema = [1, n0, _NRLe,
  0, () => NetworkRoute$
];
var NetworkTelemetryList: StaticListSchema = [1, n0, _NTL,
  0, () => NetworkTelemetry$
];
var PathComponentList: StaticListSchema = [1, n0, _PCL,
  0, () => PathComponent$
];
var PeeringErrorList: StaticListSchema = [1, n0, _PELee,
  0, () => PeeringError$
];
var PeeringList: StaticListSchema = [1, n0, _PL,
  0, () => Peering$
];
var PrefixListAssociationList: StaticListSchema = [1, n0, _PLAL,
...
var RoutingPolicyAssociationDetailsList: StaticListSchema = [1, n0, _RPADL,
  0, () => RoutingPolicyAssociationDetail$
];
var ServiceInsertionActionList: StaticListSchema = [1, n0, _SIAL,
  0, () => ServiceInsertionAction$
];
var SiteIdList = 64 | 0;
var SiteList: StaticListSchema = [1, n0, _SL,
  0, [() => Site$,
    0]
];
...
var TransitGatewayConnectPeerAssociationList: StaticListSchema = [1, n0, _TGCPAL,
  0, () => TransitGatewayConnectPeerAssociation$
];
var TransitGatewayRegistrationList: StaticListSchema = [1, n0, _TGRL,
...
var WithEdgeOverridesList: StaticListSchema = [1, n0, _WEOL,
  0, () => EdgeOverride$
];
var ExceptionContextMap = 128 | 0;
var FilterMap: StaticMapSchema = [2, n0, _FM,
  0, 0, 64 | 0
];
var NetworkResourceMetadataMap = 128 | 0;
var ReasonContextMap = 128 | 0;
export var AcceptAttachment$: StaticOperationSchema = [9, n0, _AA,
  { [_h]: ["POST", "/attachments/{AttachmentId}/accept", 200] }, () => AcceptAttachmentRequest$, () => AcceptAttachmentResponse$
];
export var AssociateConnectPeer$: StaticOperationSchema = [9, n0, _ACP,
...
export var AssociateCustomerGateway$: StaticOperationSchema = [9, n0, _ACG,
...
export var AssociateLink$: StaticOperationSchema = [9, n0, _ALs,
  { [_h]: ["POST", "/global-networks/{GlobalNetworkId}/link-associations", 200] }, () => AssociateLinkRequest$, () => AssociateLinkResponse$
];
export var AssociateTransitGatewayConnectPeer$: StaticOperationSchema = [9, n0, _ATGCP,
...
export var CreateConnectAttachment$: StaticOperationSchema = [9, n0, _CCA,
...
export var CreateGlobalNetwork$: StaticOperationSchema = [9, n0, _CGN,
  { [_h]: ["POST", "/global-networks", 200] }, () => CreateGlobalNetworkRequest$, () => CreateGlobalNetworkResponse$
];
export var CreateLink$: StaticOperationSchema = [9, n0, _CLr,
...
export var CreateSiteToSiteVpnAttachment$: StaticOperationSchema = [9, n0, _CSTSVA,
  { [_h]: ["POST", "/site-to-site-vpn-attachments", 200] }, () => CreateSiteToSiteVpnAttachmentRequest$, () => CreateSiteToSiteVpnAttachmentResponse$
];
export var CreateTransitGatewayPeering$: StaticOperationSchema = [9, n0, _CTGP,
  { [_h]: ["POST", "/transit-gateway-peerings", 200] }, () => CreateTransitGatewayPeeringRequest$, () => CreateTransitGatewayPeeringResponse$
];
export var CreateTransitGatewayRouteTableAttachment$: StaticOperationSchema = [9, n0, _CTGRTA,
...
export var CreateVpcAttachment$: StaticOperationSchema = [9, n0, _CVA,
  { [_h]: ["POST", "/vpc-attachments", 200] }, () => CreateVpcAttachmentRequest$, () => CreateVpcAttachmentResponse$
];
export var DeleteAttachment$: StaticOperationSchema = [9, n0, _DAe,
...
export var DeleteConnectPeer$: StaticOperationSchema = [9, n0, _DCP,
  { [_h]: ["DELETE", "/connect-peers/{ConnectPeerId}", 200] }, () => DeleteConnectPeerRequest$, () => DeleteConnectPeerResponse$
];
export var DeleteCoreNetwork$: StaticOperationSchema = [9, n0, _DCN,
  { [_h]: ["DELETE", "/core-networks/{CoreNetworkId}", 200] }, () => DeleteCoreNetworkRequest$, () => DeleteCoreNetworkResponse$
];
export var DeleteCoreNetworkPolicyVersion$: StaticOperationSchema = [9, n0, _DCNPV,
...
export var DeleteCoreNetworkPrefixListAssociation$: StaticOperationSchema = [9, n0, _DCNPLA,
...
export var DeleteSite$: StaticOperationSchema = [9, n0, _DSe,
  { [_h]: ["DELETE", "/global-networks/{GlobalNetworkId}/sites/{SiteId}", 200] }, () => DeleteSiteRequest$, () => DeleteSiteResponse$
];
export var DeregisterTransitGateway$: StaticOperationSchema = [9, n0, _DTG,
...
export var DescribeGlobalNetworks$: StaticOperationSchema = [9, n0, _DGNe,
  { [_h]: ["GET", "/global-networks", 200] }, () => DescribeGlobalNetworksRequest$, () => DescribeGlobalNetworksResponse$
];
export var DisassociateConnectPeer$: StaticOperationSchema = [9, n0, _DCPi,
...
export var DisassociateCustomerGateway$: StaticOperationSchema = [9, n0, _DCG,
...
export var DisassociateLink$: StaticOperationSchema = [9, n0, _DLi,
  { [_h]: ["DELETE", "/global-networks/{GlobalNetworkId}/link-associations", 200] }, () => DisassociateLinkRequest$, () => DisassociateLinkResponse$
];
export var DisassociateTransitGatewayConnectPeer$: StaticOperationSchema = [9, n0, _DTGCP,
...
export var ExecuteCoreNetworkChangeSet$: StaticOperationSchema = [9, n0, _ECNCS,
...
export var GetCoreNetwork$: StaticOperationSchema = [9, n0, _GCN,
  { [_h]: ["GET", "/core-networks/{CoreNetworkId}", 200] }, () => GetCoreNetworkRequest$, () => GetCoreNetworkResponse$
];
export var GetCoreNetworkChangeEvents$: StaticOperationSchema = [9, n0, _GCNCE,
...
export var GetCoreNetworkChangeSet$: StaticOperationSchema = [9, n0, _GCNCS,
...
export var GetCoreNetworkPolicy$: StaticOperationSchema = [9, n0, _GCNP,
  { [_h]: ["GET", "/core-networks/{CoreNetworkId}/core-network-policy", 200] }, () => GetCoreNetworkPolicyRequest$, () => GetCoreNetworkPolicyResponse$
];
export var GetCustomerGatewayAssociations$: StaticOperationSchema = [9, n0, _GCGA,
...
export var GetDevices$: StaticOperationSchema = [9, n0, _GD,
  { [_h]: ["GET", "/global-networks/{GlobalNetworkId}/devices", 200] }, () => GetDevicesRequest$, () => GetDevicesResponse$
];
export var GetDirectConnectGatewayAttachment$: StaticOperationSchema = [9, n0, _GDCGA,
...
export var GetNetworkResourceRelationships$: StaticOperationSchema = [9, n0, _GNRRetet,
...
export var GetRouteAnalysis$: StaticOperationSchema = [9, n0, _GRA,
...
export var GetSites$: StaticOperationSchema = [9, n0, _GS,
  { [_h]: ["GET", "/global-networks/{GlobalNetworkId}/sites", 200] }, () => GetSitesRequest$, () => GetSitesResponse$
];
export var GetSiteToSiteVpnAttachment$: StaticOperationSchema = [9, n0, _GSTSVA,
...
export var GetTransitGatewayConnectPeerAssociations$: StaticOperationSchema = [9, n0, _GTGCPA,
...
export var GetTransitGatewayPeering$: StaticOperationSchema = [9, n0, _GTGP,
  { [_h]: ["GET", "/transit-gateway-peerings/{PeeringId}", 200] }, () => GetTransitGatewayPeeringRequest$, () => GetTransitGatewayPeeringResponse$
];
export var GetTransitGatewayRegistrations$: StaticOperationSchema = [9, n0, _GTGR,
...
export var GetTransitGatewayRouteTableAttachment$: StaticOperationSchema = [9, n0, _GTGRTA,
...
export var GetVpcAttachment$: StaticOperationSchema = [9, n0, _GVA,
  { [_h]: ["GET", "/vpc-attachments/{AttachmentId}", 200] }, () => GetVpcAttachmentRequest$, () => GetVpcAttachmentResponse$
];
export var ListAttachmentRoutingPolicyAssociations$: StaticOperationSchema = [9, n0, _LARPA,
...
export var ListAttachments$: StaticOperationSchema = [9, n0, _LAis,
  { [_h]: ["GET", "/attachments", 200] }, () => ListAttachmentsRequest$, () => ListAttachmentsResponse$
];
export var ListConnectPeers$: StaticOperationSchema = [9, n0, _LCP,
  { [_h]: ["GET", "/connect-peers", 200] }, () => ListConnectPeersRequest$, () => ListConnectPeersResponse$
];
export var ListCoreNetworkPolicyVersions$: StaticOperationSchema = [9, n0, _LCNPV,
...
export var ListCoreNetworkPrefixListAssociations$: StaticOperationSchema = [9, n0, _LCNPLA,
...
export var ListCoreNetworkRoutingInformation$: StaticOperationSchema = [9, n0, _LCNRI,
...
export var ListCoreNetworks$: StaticOperationSchema = [9, n0, _LCN,
  { [_h]: ["GET", "/core-networks", 200] }, () => ListCoreNetworksRequest$, () => ListCoreNetworksResponse$
];
export var ListOrganizationServiceAccessStatus$: StaticOperationSchema = [9, n0, _LOSAS,
...
export var RegisterTransitGateway$: StaticOperationSchema = [9, n0, _RTG,
...
export var RejectAttachment$: StaticOperationSchema = [9, n0, _RAej,
  { [_h]: ["POST", "/attachments/{AttachmentId}/reject", 200] }, () => RejectAttachmentRequest$, () => RejectAttachmentResponse$
];
export var RemoveAttachmentRoutingPolicyLabel$: StaticOperationSchema = [9, n0, _RARPL,
...
export var RestoreCoreNetworkPolicyVersion$: StaticOperationSchema = [9, n0, _RCNPV,
...
export var StartOrganizationServiceAccessUpdate$: StaticOperationSchema = [9, n0, _SOSAU,
...
export var StartRouteAnalysis$: StaticOperationSchema = [9, n0, _SRA,
...
export var UpdateCoreNetwork$: StaticOperationSchema = [9, n0, _UCN,
  { [_h]: ["PATCH", "/core-networks/{CoreNetworkId}", 200] }, () => UpdateCoreNetworkRequest$, () => UpdateCoreNetworkResponse$
];
export var UpdateDevice$: StaticOperationSchema = [9, n0, _UD,
  { [_h]: ["PATCH", "/global-networks/{GlobalNetworkId}/devices/{DeviceId}", 200] }, () => UpdateDeviceRequest$, () => UpdateDeviceResponse$
];
export var UpdateDirectConnectGatewayAttachment$: StaticOperationSchema = [9, n0, _UDCGA,
...
export var UpdateGlobalNetwork$: StaticOperationSchema = [9, n0, _UGN,
...
export var UpdateNetworkResourceMetadata$: StaticOperationSchema = [9, n0, _UNRM,
...
export var UpdateSite$: StaticOperationSchema = [9, n0, _USp,
  { [_h]: ["PATCH", "/global-networks/{GlobalNetworkId}/sites/{SiteId}", 200] }, () => UpdateSiteRequest$, () => UpdateSiteResponse$
];
export var UpdateVpcAttachment$: StaticOperationSchema = [9, n0, _UVA,
