 ...
 * @public
 */
export class DisassociateResourceFromProfileCommand extends command<DisassociateResourceFromProfileCommandInput, DisassociateResourceFromProfileCommandOutput>(
  _ep0,
  _mw0,
