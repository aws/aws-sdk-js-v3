...
import { Route53ProfilesClientConfig, Route53ProfilesClientResolvedConfig } from "../Route53ProfilesClient";
...
function createAwsAuthSigv4HttpAuthOption(authParameters: Route53ProfilesHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Route53ProfilesClientConfig, context) => ({
      /**
       * @internal
       */
      signingProperties: {
