  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<Route53ProfilesClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultRoute53ProfilesHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: Route53ProfilesClientResolvedConfig) =>
