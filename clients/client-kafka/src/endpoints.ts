...
const AWS_TEMPLATE = "kafka.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "kafka.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "kafka.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "kafka.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "kafka.{region}.amazonaws.com";
