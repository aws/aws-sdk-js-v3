...
import { type KafkaClientResolvedConfig, KafkaClientConfig } from "../KafkaClient";
 ...
 * @internal
 */
export const defaultKafkaHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: KafkaHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<KafkaClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultKafkaHttpAuthSchemeProvider: KafkaHttpAuthSchemeProvider = (authParameters) => {
