...
import { type CodeConnectionsClientResolvedConfig, CodeConnectionsClientConfig } from "../CodeConnectionsClient";
 ...
 * @internal
 */
export const defaultCodeConnectionsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CodeConnectionsHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultCodeConnectionsHttpAuthSchemeProvider: CodeConnectionsHttpAuthSchemeProvider = (authParameters) => {
