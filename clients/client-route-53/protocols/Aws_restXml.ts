...
export const serializeAws_restXmlChangeResourceRecordSetsCommand = async (
  ...
  if (input.ChangeBatch !== undefined) {
    const node = serializeAws_restXmlChangeBatch(input.ChangeBatch, context).withName(
      "ChangeBatch"
    );
    bodyNode.addChildNode(node);
  }
...
export const serializeAws_restXmlCreateHealthCheckCommand = async (
  ...
  if (input.HealthCheckConfig !== undefined) {
    const node = serializeAws_restXmlHealthCheckConfig(input.HealthCheckConfig, context).withName(
      "HealthCheckConfig"
    );
    bodyNode.addChildNode(node);
  }
...
export const serializeAws_restXmlCreateHostedZoneCommand = async (
  ...
  if (input.HostedZoneConfig !== undefined) {
    const node = serializeAws_restXmlHostedZoneConfig(input.HostedZoneConfig, context).withName(
      "HostedZoneConfig"
    );
    bodyNode.addChildNode(node);
  }
...
export const serializeAws_restXmlUpdateHealthCheckCommand = async (
  ...
  if (input.AlarmIdentifier !== undefined) {
    const node = serializeAws_restXmlAlarmIdentifier(input.AlarmIdentifier, context).withName(
      "AlarmIdentifier"
    );
    bodyNode.addChildNode(node);
  }
...
const serializeAws_restXmlChange = (input: Change, context: __SerdeContext): any => {
  ...
  if (input.ResourceRecordSet !== undefined) {
    const node = serializeAws_restXmlResourceRecordSet(input.ResourceRecordSet, context).withName(
      "ResourceRecordSet"
    );
    bodyNode.addChildNode(node);
  }
...
const serializeAws_restXmlResourceRecordSet = (
  ...
  if (input.AliasTarget !== undefined) {
    const node = serializeAws_restXmlAliasTarget(input.AliasTarget, context).withName(
      "AliasTarget"
    );
    bodyNode.addChildNode(node);
  }
  ...
  if (input.GeoLocation !== undefined) {
    const node = serializeAws_restXmlGeoLocation(input.GeoLocation, context).withName(
      "GeoLocation"
    );
    bodyNode.addChildNode(node);
  }
