...
import { type GlueClientResolvedConfig, GlueClientConfig } from "../GlueClient";
 ...
 * @internal
 */
export const defaultGlueHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: GlueHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultGlueHttpAuthSchemeProvider: GlueHttpAuthSchemeProvider = (authParameters) => {
