...
import type { BatchGetDataQualityResultRequest, BatchGetDataQualityResultResponse } from "../models/models_0";
import { BatchGetDataQualityResult$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class BatchGetDataQualityResultCommand extends command<BatchGetDataQualityResultCommandInput, BatchGetDataQualityResultCommandOutput>(
  _ep0,
  _mw0,
