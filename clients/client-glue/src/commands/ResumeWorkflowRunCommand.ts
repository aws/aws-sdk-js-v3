...
import type { ResumeWorkflowRunRequest, ResumeWorkflowRunResponse } from "../models/models_3";
 ...
 * @public
 */
export class ResumeWorkflowRunCommand extends command<ResumeWorkflowRunCommandInput, ResumeWorkflowRunCommandOutput>(
  _ep0,
  _mw0,
  "ResumeWorkflowRun",
  ResumeWorkflowRun$
