...
import type { ListCrawlsRequest, ListCrawlsResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListCrawlsCommand extends command<ListCrawlsCommandInput, ListCrawlsCommandOutput>(
  _ep0,
  _mw0,
  "ListCrawls",
  ListCrawls$
