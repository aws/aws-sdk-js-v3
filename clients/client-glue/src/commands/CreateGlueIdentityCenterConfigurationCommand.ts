 ...
 * @public
 */
export class CreateGlueIdentityCenterConfigurationCommand extends command<CreateGlueIdentityCenterConfigurationCommandInput, CreateGlueIdentityCenterConfigurationCommandOutput>(
  _ep0,
  _mw0,
