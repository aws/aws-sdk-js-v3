 ...
 * @public
 */
export class GetDataQualityRulesetEvaluationRunCommand extends command<GetDataQualityRulesetEvaluationRunCommandInput, GetDataQualityRulesetEvaluationRunCommandOutput>(
  _ep0,
  _mw0,
