...
import type { CreateCrawlerRequest } from "../models/models_0";
 ...
 * @public
 */
export class CreateCrawlerCommand extends command<CreateCrawlerCommandInput, CreateCrawlerCommandOutput>(
  _ep0,
  _mw0,
  "CreateCrawler",
  CreateCrawler$
