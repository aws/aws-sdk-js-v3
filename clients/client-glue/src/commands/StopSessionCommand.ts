...
import type { StopSessionRequest, StopSessionResponse } from "../models/models_3";
 ...
 * @public
 */
export class StopSessionCommand extends command<StopSessionCommandInput, StopSessionCommandOutput>(
  _ep0,
  _mw0,
  "StopSession",
  StopSession$
