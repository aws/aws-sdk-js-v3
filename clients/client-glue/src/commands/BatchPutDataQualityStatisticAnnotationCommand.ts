 ...
 * @public
 */
export class BatchPutDataQualityStatisticAnnotationCommand extends command<BatchPutDataQualityStatisticAnnotationCommandInput, BatchPutDataQualityStatisticAnnotationCommandOutput>(
  _ep0,
  _mw0,
