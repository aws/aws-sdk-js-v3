...
import type { CreateTableOptimizerRequest, CreateTableOptimizerResponse } from "../models/models_1";
 ...
 * @public
 */
export class CreateTableOptimizerCommand extends command<CreateTableOptimizerCommandInput, CreateTableOptimizerCommandOutput>(
  _ep0,
  _mw0,
