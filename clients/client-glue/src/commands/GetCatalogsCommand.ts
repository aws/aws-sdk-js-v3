...
import type { GetCatalogsRequest, GetCatalogsResponse } from "../models/models_1";
 ...
 * @public
 */
export class GetCatalogsCommand extends command<GetCatalogsCommandInput, GetCatalogsCommandOutput>(
  _ep0,
  _mw0,
  "GetCatalogs",
  GetCatalogs$
