 ...
 * @public
 */
export class GetColumnStatisticsForPartitionCommand extends command<GetColumnStatisticsForPartitionCommandInput, GetColumnStatisticsForPartitionCommandOutput>(
  _ep0,
  _mw0,
