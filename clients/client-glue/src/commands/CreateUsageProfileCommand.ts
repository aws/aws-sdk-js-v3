...
import type { CreateUsageProfileRequest, CreateUsageProfileResponse } from "../models/models_1";
 ...
 * @public
 */
export class CreateUsageProfileCommand extends command<CreateUsageProfileCommandInput, CreateUsageProfileCommandOutput>(
  _ep0,
  _mw0,
  "CreateUsageProfile",
  CreateUsageProfile$
