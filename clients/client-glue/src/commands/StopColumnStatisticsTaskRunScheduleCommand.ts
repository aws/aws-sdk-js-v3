 ...
 * @public
 */
export class StopColumnStatisticsTaskRunScheduleCommand extends command<StopColumnStatisticsTaskRunScheduleCommandInput, StopColumnStatisticsTaskRunScheduleCommandOutput>(
  _ep0,
  _mw0,
