...
import type { DeleteTableRequest, DeleteTableResponse } from "../models/models_1";
 ...
 * @public
 */
export class DeleteTableCommand extends command<DeleteTableCommandInput, DeleteTableCommandOutput>(
  _ep0,
  _mw0,
  "DeleteTable",
  DeleteTable$
