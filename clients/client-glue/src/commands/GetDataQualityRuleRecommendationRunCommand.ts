 ...
 * @public
 */
export class GetDataQualityRuleRecommendationRunCommand extends command<GetDataQualityRuleRecommendationRunCommandInput, GetDataQualityRuleRecommendationRunCommandOutput>(
  _ep0,
  _mw0,
