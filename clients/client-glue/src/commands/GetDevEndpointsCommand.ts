...
import type { GetDevEndpointsRequest, GetDevEndpointsResponse } from "../models/models_2";
 ...
 * @public
 */
export class GetDevEndpointsCommand extends command<GetDevEndpointsCommandInput, GetDevEndpointsCommandOutput>(
  _ep0,
  _mw0,
  "GetDevEndpoints",
  GetDevEndpoints$
