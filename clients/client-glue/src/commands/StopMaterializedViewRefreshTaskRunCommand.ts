 ...
 * @public
 */
export class StopMaterializedViewRefreshTaskRunCommand extends command<StopMaterializedViewRefreshTaskRunCommandInput, StopMaterializedViewRefreshTaskRunCommandOutput>(
  _ep0,
  _mw0,
