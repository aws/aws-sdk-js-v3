...
import type { GetDevEndpointRequest, GetDevEndpointResponse } from "../models/models_2";
 ...
 * @public
 */
export class GetDevEndpointCommand extends command<GetDevEndpointCommandInput, GetDevEndpointCommandOutput>(
  _ep0,
  _mw0,
  "GetDevEndpoint",
  GetDevEndpoint$
