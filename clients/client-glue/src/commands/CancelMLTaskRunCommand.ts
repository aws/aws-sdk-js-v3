...
import type { CancelMLTaskRunRequest, CancelMLTaskRunResponse } from "../models/models_0";
 ...
 * @public
 */
export class CancelMLTaskRunCommand extends command<CancelMLTaskRunCommandInput, CancelMLTaskRunCommandOutput>(
  _ep0,
  _mw0,
  "CancelMLTaskRun",
  CancelMLTaskRun$
