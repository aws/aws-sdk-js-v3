 ...
 * @public
 */
export class ListIntegrationResourcePropertiesCommand extends command<ListIntegrationResourcePropertiesCommandInput, ListIntegrationResourcePropertiesCommandOutput>(
  _ep0,
  _mw0,
