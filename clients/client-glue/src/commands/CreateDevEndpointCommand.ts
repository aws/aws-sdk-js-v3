...
import type { CreateDevEndpointRequest, CreateDevEndpointResponse } from "../models/models_1";
 ...
 * @public
 */
export class CreateDevEndpointCommand extends command<CreateDevEndpointCommandInput, CreateDevEndpointCommandOutput>(
  _ep0,
  _mw0,
  "CreateDevEndpoint",
  CreateDevEndpoint$
