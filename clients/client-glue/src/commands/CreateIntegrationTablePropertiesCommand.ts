 ...
 * @public
 */
export class CreateIntegrationTablePropertiesCommand extends command<CreateIntegrationTablePropertiesCommandInput, CreateIntegrationTablePropertiesCommandOutput>(
  _ep0,
  _mw0,
