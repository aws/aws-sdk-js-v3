...
import type { GetCatalogImportStatusRequest, GetCatalogImportStatusResponse } from "../models/models_1";
 ...
 * @public
 */
export class GetCatalogImportStatusCommand extends command<GetCatalogImportStatusCommandInput, GetCatalogImportStatusCommandOutput>(
  _ep0,
  _mw0,
