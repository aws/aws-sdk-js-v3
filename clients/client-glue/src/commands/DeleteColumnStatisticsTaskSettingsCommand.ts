 ...
 * @public
 */
export class DeleteColumnStatisticsTaskSettingsCommand extends command<DeleteColumnStatisticsTaskSettingsCommandInput, DeleteColumnStatisticsTaskSettingsCommandOutput>(
  _ep0,
  _mw0,
