...
import type { GetJobsRequest } from "../models/models_2";
import type { GetJobsResponse } from "../models/models_3";
 ...
 * @public
 */
export class GetJobsCommand extends command<GetJobsCommandInput, GetJobsCommandOutput>(
  _ep0,
  _mw0,
  "GetJobs",
  GetJobs$
