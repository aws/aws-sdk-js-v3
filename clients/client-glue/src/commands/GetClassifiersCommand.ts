...
import type { GetClassifiersRequest, GetClassifiersResponse } from "../models/models_1";
import { GetClassifiers$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetClassifiersCommand extends command<GetClassifiersCommandInput, GetClassifiersCommandOutput>(
  _ep0,
  _mw0,
  "GetClassifiers",
  GetClassifiers$
