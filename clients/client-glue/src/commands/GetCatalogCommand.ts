...
import type { GetCatalogRequest, GetCatalogResponse } from "../models/models_1";
 ...
 * @public
 */
export class GetCatalogCommand extends command<GetCatalogCommandInput, GetCatalogCommandOutput>(
  _ep0,
  _mw0,
  "GetCatalog",
  GetCatalog$
