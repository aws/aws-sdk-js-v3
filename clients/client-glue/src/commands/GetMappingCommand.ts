...
import type { GetMappingRequest, GetMappingResponse } from "../models/models_2";
 ...
 * @public
 */
export class GetMappingCommand extends command<GetMappingCommandInput, GetMappingCommandOutput>(
  _ep0,
  _mw0,
  "GetMapping",
  GetMapping$
