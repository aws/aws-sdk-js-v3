...
import { UpdateIntegrationTableProperties$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateIntegrationTablePropertiesCommand extends command<UpdateIntegrationTablePropertiesCommandInput, UpdateIntegrationTablePropertiesCommandOutput>(
  _ep0,
  _mw0,
