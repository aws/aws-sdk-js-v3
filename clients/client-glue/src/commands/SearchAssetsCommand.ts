...
import type { SearchAssetsInput, SearchAssetsOutput } from "../models/models_3";
 ...
 * @public
 */
export class SearchAssetsCommand extends command<SearchAssetsCommandInput, SearchAssetsCommandOutput>(
  _ep0,
  _mw0,
  "SearchAssets",
  SearchAssets$
