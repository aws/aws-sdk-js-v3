...
import type { GetJobBookmarkRequest, GetJobBookmarkResponse } from "../models/models_2";
 ...
 * @public
 */
export class GetJobBookmarkCommand extends command<GetJobBookmarkCommandInput, GetJobBookmarkCommandOutput>(
  _ep0,
  _mw0,
  "GetJobBookmark",
  GetJobBookmark$
