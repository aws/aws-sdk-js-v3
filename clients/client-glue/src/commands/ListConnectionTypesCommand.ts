...
import type { ListConnectionTypesRequest, ListConnectionTypesResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListConnectionTypesCommand extends command<ListConnectionTypesCommandInput, ListConnectionTypesCommandOutput>(
  _ep0,
  _mw0,
  "ListConnectionTypes",
  ListConnectionTypes$
