...
import type { GetBlueprintRunRequest, GetBlueprintRunResponse } from "../models/models_1";
 ...
 * @public
 */
export class GetBlueprintRunCommand extends command<GetBlueprintRunCommandInput, GetBlueprintRunCommandOutput>(
  _ep0,
  _mw0,
  "GetBlueprintRun",
  GetBlueprintRun$
