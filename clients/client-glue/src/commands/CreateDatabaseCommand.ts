...
import type { CreateDatabaseRequest, CreateDatabaseResponse } from "../models/models_1";
 ...
 * @public
 */
export class CreateDatabaseCommand extends command<CreateDatabaseCommandInput, CreateDatabaseCommandOutput>(
  _ep0,
  _mw0,
  "CreateDatabase",
  CreateDatabase$
