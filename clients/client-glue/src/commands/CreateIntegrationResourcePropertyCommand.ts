 ...
 * @public
 */
export class CreateIntegrationResourcePropertyCommand extends command<CreateIntegrationResourcePropertyCommandInput, CreateIntegrationResourcePropertyCommandOutput>(
  _ep0,
  _mw0,
