 ...
 * @public
 */
export class UpdateGlueIdentityCenterConfigurationCommand extends command<UpdateGlueIdentityCenterConfigurationCommandInput, UpdateGlueIdentityCenterConfigurationCommandOutput>(
  _ep0,
  _mw0,
