...
import { UpdateJobFromSourceControl$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateJobFromSourceControlCommand extends command<UpdateJobFromSourceControlCommandInput, UpdateJobFromSourceControlCommandOutput>(
  _ep0,
  _mw0,
