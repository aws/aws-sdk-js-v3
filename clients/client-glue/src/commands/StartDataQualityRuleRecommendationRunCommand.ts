 ...
 * @public
 */
export class StartDataQualityRuleRecommendationRunCommand extends command<StartDataQualityRuleRecommendationRunCommandInput, StartDataQualityRuleRecommendationRunCommandOutput>(
  _ep0,
  _mw0,
