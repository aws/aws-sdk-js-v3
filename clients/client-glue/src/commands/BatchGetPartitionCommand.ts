...
import type { BatchGetPartitionRequest, BatchGetPartitionResponse } from "../models/models_0";
 ...
 * @public
 */
export class BatchGetPartitionCommand extends command<BatchGetPartitionCommandInput, BatchGetPartitionCommandOutput>(
  _ep0,
  _mw0,
  "BatchGetPartition",
  BatchGetPartition$
