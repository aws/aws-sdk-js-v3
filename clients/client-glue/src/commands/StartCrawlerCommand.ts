...
import type { StartCrawlerRequest, StartCrawlerResponse } from "../models/models_3";
 ...
 * @public
 */
export class StartCrawlerCommand extends command<StartCrawlerCommandInput, StartCrawlerCommandOutput>(
  _ep0,
  _mw0,
  "StartCrawler",
  StartCrawler$
