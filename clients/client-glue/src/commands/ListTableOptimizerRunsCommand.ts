...
import type { ListTableOptimizerRunsRequest, ListTableOptimizerRunsResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListTableOptimizerRunsCommand extends command<ListTableOptimizerRunsCommandInput, ListTableOptimizerRunsCommandOutput>(
  _ep0,
  _mw0,
