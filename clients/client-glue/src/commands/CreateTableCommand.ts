...
import type { CreateTableRequest, CreateTableResponse } from "../models/models_1";
 ...
 * @public
 */
export class CreateTableCommand extends command<CreateTableCommandInput, CreateTableCommandOutput>(
  _ep0,
  _mw0,
  "CreateTable",
  CreateTable$
