...
import type { StopCrawlerScheduleRequest, StopCrawlerScheduleResponse } from "../models/models_3";
 ...
 * @public
 */
export class StopCrawlerScheduleCommand extends command<StopCrawlerScheduleCommandInput, StopCrawlerScheduleCommandOutput>(
  _ep0,
  _mw0,
  "StopCrawlerSchedule",
  StopCrawlerSchedule$
