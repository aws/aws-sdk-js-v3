...
import type { BatchGetWorkflowsRequest, BatchGetWorkflowsResponse } from "../models/models_0";
import { BatchGetWorkflows$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class BatchGetWorkflowsCommand extends command<BatchGetWorkflowsCommandInput, BatchGetWorkflowsCommandOutput>(
  _ep0,
  _mw0,
  "BatchGetWorkflows",
  BatchGetWorkflows$
