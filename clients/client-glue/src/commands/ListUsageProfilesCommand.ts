...
import type { ListUsageProfilesRequest, ListUsageProfilesResponse } from "../models/models_2";
 ...
 * @public
 */
export class ListUsageProfilesCommand extends command<ListUsageProfilesCommandInput, ListUsageProfilesCommandOutput>(
  _ep0,
  _mw0,
  "ListUsageProfiles",
  ListUsageProfiles$
