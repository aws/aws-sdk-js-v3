 ...
 * @public
 */
export class DeleteColumnStatisticsForTableCommand extends command<DeleteColumnStatisticsForTableCommandInput, DeleteColumnStatisticsForTableCommandOutput>(
  _ep0,
  _mw0,
