...
import type { BatchGetTriggersRequest, BatchGetTriggersResponse } from "../models/models_0";
 ...
 * @public
 */
export class BatchGetTriggersCommand extends command<BatchGetTriggersCommandInput, BatchGetTriggersCommandOutput>(
  _ep0,
  _mw0,
  "BatchGetTriggers",
  BatchGetTriggers$
