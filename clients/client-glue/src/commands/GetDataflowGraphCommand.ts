...
import type { GetDataflowGraphRequest, GetDataflowGraphResponse } from "../models/models_2";
 ...
 * @public
 */
export class GetDataflowGraphCommand extends command<GetDataflowGraphCommandInput, GetDataflowGraphCommandOutput>(
  _ep0,
  _mw0,
  "GetDataflowGraph",
  GetDataflowGraph$
