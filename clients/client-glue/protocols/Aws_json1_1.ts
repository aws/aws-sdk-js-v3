...
export const serializeAws_json1_1StartMLLabelingSetGenerationTaskRunCommand = async (
  ...
  let body: any;
  body = JSON.stringify(
    serializeAws_json1_1StartMLLabelingSetGenerationTaskRunRequest(input, context)
  );
  return buildHttpRpcRequest(context, headers, "/", undefined, body);
};
  ...
  return {
    ...
    ImportTime:
      output.ImportTime !== undefined && output.ImportTime !== null
        ...
        : undefined,
    ImportedBy:
      output.ImportedBy !== undefined && output.ImportedBy !== null ? output.ImportedBy : undefined
  } as any;
};
  ...
  return {
    ...
    CreateTime:
      output.CreateTime !== undefined && output.CreateTime !== null
        ...
        : undefined,
    PolicyHash:
      output.PolicyHash !== undefined && output.PolicyHash !== null ? output.PolicyHash : undefined,
    PolicyInJson:
...
const deserializeAws_json1_1Order = (output: any, context: __SerdeContext): Order => {
  return {
    ...
    SortOrder:
      output.SortOrder !== undefined && output.SortOrder !== null ? output.SortOrder : undefined
  } as any;
};
  ...
  return {
    ...
    Columns:
      output.Columns !== undefined && output.Columns !== null
        ...
        : undefined,
    Compressed:
      output.Compressed !== undefined && output.Compressed !== null ? output.Compressed : undefined,
    InputFormat:
      output.InputFormat !== undefined && output.InputFormat !== null
        ? output.InputFormat
        : undefined,
    Location:
      output.Location !== undefined && output.Location !== null ? output.Location : undefined,
    NumberOfBuckets:
  ...
  return {
    ...
    CreateTime:
      output.CreateTime !== undefined && output.CreateTime !== null
        ...
        : undefined,
    CreatedBy:
      output.CreatedBy !== undefined && output.CreatedBy !== null ? output.CreatedBy : undefined,
    DatabaseName:
      output.DatabaseName !== undefined && output.DatabaseName !== null
        ? output.DatabaseName
        : undefined,
    ...
    PartitionKeys:
      output.PartitionKeys !== undefined && output.PartitionKeys !== null
        ...
        : undefined,
    Retention:
      output.Retention !== undefined && output.Retention !== null ? output.Retention : undefined,
    StorageDescriptor:
      output.StorageDescriptor !== undefined && output.StorageDescriptor !== null
        ? deserializeAws_json1_1StorageDescriptor(output.StorageDescriptor, context)
        : undefined,
    TableType:
      output.TableType !== undefined && output.TableType !== null ? output.TableType : undefined,
    UpdateTime:
      output.UpdateTime !== undefined && output.UpdateTime !== null
        ? new Date(Math.round(output.UpdateTime * 1000))
        : undefined,
...
const deserializeAws_json1_1UserDefinedFunction = (
  ...
  return {
    ...
    ClassName:
      output.ClassName !== undefined && output.ClassName !== null ? output.ClassName : undefined,
    CreateTime:
      output.CreateTime !== undefined && output.CreateTime !== null
        ? new Date(Math.round(output.CreateTime * 1000))
        : undefined,
    ...
    OwnerType:
      output.OwnerType !== undefined && output.OwnerType !== null ? output.OwnerType : undefined,
    ResourceUris:
...
const deserializeAws_json1_1CreateDevEndpointResponse = (
  ...
  return {
    ...
    WorkerType:
      output.WorkerType !== undefined && output.WorkerType !== null ? output.WorkerType : undefined,
    YarnEndpointAddress:
  ...
  return {
    ...
    PublicAddress:
      output.PublicAddress !== undefined && output.PublicAddress !== null
        ...
        : undefined,
    PublicKey:
      output.PublicKey !== undefined && output.PublicKey !== null ? output.PublicKey : undefined,
    PublicKeys:
...
const deserializeAws_json1_1CancelMLTaskRunResponse = (
  ...
  return {
    ...
    Status: output.Status !== undefined && output.Status !== null ? output.Status : undefined,
    TaskRunId:
      output.TaskRunId !== undefined && output.TaskRunId !== null ? output.TaskRunId : undefined,
    TransformId:
...
const deserializeAws_json1_1FindMatchesMetrics = (
  ...
  return {
    ...
    Precision:
      output.Precision !== undefined && output.Precision !== null ? output.Precision : undefined,
...
const deserializeAws_json1_1FindMatchesTaskRunProperties = (
  ...
  return {
    ...
    JobName: output.JobName !== undefined && output.JobName !== null ? output.JobName : undefined,
    JobRunId:
      output.JobRunId !== undefined && output.JobRunId !== null ? output.JobRunId : undefined
  } as any;
};
  ...
  return {
    ...
    InputRecordTables:
      output.InputRecordTables !== undefined && output.InputRecordTables !== null
        ...
        : undefined,
    LabelCount:
      output.LabelCount !== undefined && output.LabelCount !== null ? output.LabelCount : undefined,
    LastModifiedOn:
      output.LastModifiedOn !== undefined && output.LastModifiedOn !== null
        ? new Date(Math.round(output.LastModifiedOn * 1000))
        : undefined,
    MaxCapacity:
      output.MaxCapacity !== undefined && output.MaxCapacity !== null
        ...
        : undefined,
    MaxRetries:
      output.MaxRetries !== undefined && output.MaxRetries !== null ? output.MaxRetries : undefined,
    Name: output.Name !== undefined && output.Name !== null ? output.Name : undefined,
    NumberOfWorkers:
      output.NumberOfWorkers !== undefined && output.NumberOfWorkers !== null
        ? output.NumberOfWorkers
  ...
  return {
    ...
    LabelingSetGenerationTaskRunProperties:
      ...
      output.LabelingSetGenerationTaskRunProperties !== null
        ...
        : undefined,
    TaskType:
      output.TaskType !== undefined && output.TaskType !== null ? output.TaskType : undefined
  } as any;
};
...
const deserializeAws_json1_1Condition = (output: any, context: __SerdeContext): Condition => {
  return {
    __type: "Condition",
    CrawlState:
      output.CrawlState !== undefined && output.CrawlState !== null ? output.CrawlState : undefined,
    CrawlerName:
      output.CrawlerName !== undefined && output.CrawlerName !== null
        ? output.CrawlerName
        : undefined,
  ...
  return {
    ...
    ErrorMessage:
      output.ErrorMessage !== undefined && output.ErrorMessage !== null
        ...
        : undefined,
    LogGroup:
      output.LogGroup !== undefined && output.LogGroup !== null ? output.LogGroup : undefined,
    LogStream:
      output.LogStream !== undefined && output.LogStream !== null ? output.LogStream : undefined,
    StartedOn:
      output.StartedOn !== undefined && output.StartedOn !== null
        ? new Date(Math.round(output.StartedOn * 1000))
        : undefined,
...
const deserializeAws_json1_1Node = (output: any, context: __SerdeContext): Node => {
  return {
    ...
    Type: output.Type !== undefined && output.Type !== null ? output.Type : undefined,
    UniqueId:
      output.UniqueId !== undefined && output.UniqueId !== null ? output.UniqueId : undefined
  } as any;
};
  ...
  return {
    ...
    Predicate:
      output.Predicate !== undefined && output.Predicate !== null
        ...
        : undefined,
    Schedule:
      output.Schedule !== undefined && output.Schedule !== null ? output.Schedule : undefined,
    State: output.State !== undefined && output.State !== null ? output.State : undefined,
    Type: output.Type !== undefined && output.Type !== null ? output.Type : undefined,
    WorkflowName:
...
const deserializeAws_json1_1CodeGenNode = (output: any, context: __SerdeContext): CodeGenNode => {
  return {
    ...
    Id: output.Id !== undefined && output.Id !== null ? output.Id : undefined,
    LineNumber:
      output.LineNumber !== undefined && output.LineNumber !== null ? output.LineNumber : undefined,
    NodeType:
  ...
  return {
    ...
    PythonScript:
      output.PythonScript !== undefined && output.PythonScript !== null
        ...
        : undefined,
    ScalaCode:
      output.ScalaCode !== undefined && output.ScalaCode !== null ? output.ScalaCode : undefined
  } as any;
};
  ...
  return {
    ...
    CreationTime:
      output.CreationTime !== undefined && output.CreationTime !== null
        ...
        : undefined,
    JsonPath:
      output.JsonPath !== undefined && output.JsonPath !== null ? output.JsonPath : undefined,
    LastUpdated:
      output.LastUpdated !== undefined && output.LastUpdated !== null
        ? new Date(Math.round(output.LastUpdated * 1000))
        : undefined,
  ...
  return {
    ...
    SourceTable:
      output.SourceTable !== undefined && output.SourceTable !== null
        ...
        : undefined,
    SourceType:
      output.SourceType !== undefined && output.SourceType !== null ? output.SourceType : undefined,
    TargetPath:
      output.TargetPath !== undefined && output.TargetPath !== null ? output.TargetPath : undefined,
    TargetTable:
      output.TargetTable !== undefined && output.TargetTable !== null
        ? output.TargetTable
        : undefined,
    TargetType:
      output.TargetType !== undefined && output.TargetType !== null ? output.TargetType : undefined
  } as any;
};
