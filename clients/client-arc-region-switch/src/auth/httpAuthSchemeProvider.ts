...
import { type ARCRegionSwitchClientResolvedConfig, ARCRegionSwitchClientConfig } from "../ARCRegionSwitchClient";
 ...
 * @internal
 */
export const defaultARCRegionSwitchHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ARCRegionSwitchHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<ARCRegionSwitchClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultARCRegionSwitchHttpAuthSchemeProvider: ARCRegionSwitchHttpAuthSchemeProvider = (authParameters) => {
