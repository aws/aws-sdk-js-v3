...
var HttpEndpointUrl: StaticSimpleSchema = [0, n0, _HEU, 8, 0];
var Password: StaticSimpleSchema = [0, n0, _P, 8, 0];
var SnowflakeAccountUrl: StaticSimpleSchema = [0, n0, _SAU, 8, 0];
var SnowflakeContentColumnName: StaticSimpleSchema = [0, n0, _SCCN, 8, 0];
var SnowflakeDatabase: StaticSimpleSchema = [0, n0, _SD, 8, 0];
var SnowflakeKeyPassphrase: StaticSimpleSchema = [0, n0, _SKP, 8, 0];
var SnowflakeMetaDataColumnName: StaticSimpleSchema = [0, n0, _SMDCN, 8, 0];
var SnowflakePrivateKey: StaticSimpleSchema = [0, n0, _SPK, 8, 0];
var SnowflakePrivateLinkVpceId: StaticSimpleSchema = [0, n0, _SPLVI, 8, 0];
var SnowflakeRole: StaticSimpleSchema = [0, n0, _SR, 8, 0];
var SnowflakeSchema: StaticSimpleSchema = [0, n0, _SS, 8, 0];
var SnowflakeTable: StaticSimpleSchema = [0, n0, _ST, 8, 0];
var SnowflakeUser: StaticSimpleSchema = [0, n0, _SU, 8, 0];
var Username: StaticSimpleSchema = [0, n0, _U, 8, 0];
export var AmazonOpenSearchServerlessBufferingHints$: StaticStructureSchema = [3, n0, _AOSSBH,
  0,
  [_IIS, _SIMB],
  [1, 1]
];
...
export var AmazonOpenSearchServerlessDestinationUpdate$: StaticStructureSchema = [3, n0, _AOSSDU,
  0,
...
export var AmazonOpenSearchServerlessRetryOptions$: StaticStructureSchema = [3, n0, _AOSSRO,
  0,
  [_DIS],
  [1]
];
export var AmazonopensearchserviceBufferingHints$: StaticStructureSchema = [3, n0, _ABH,
  0,
  [_IIS, _SIMB],
  [1, 1]
];
...
export var AmazonopensearchserviceDestinationUpdate$: StaticStructureSchema = [3, n0, _ADU,
  0,
...
export var AmazonopensearchserviceRetryOptions$: StaticStructureSchema = [3, n0, _ARO,
  0,
  [_DIS],
  [1]
];
...
export var CatalogConfiguration$: StaticStructureSchema = [3, n0, _CC,
  0,
  [_CARN, _WL],
  [0, 0]
];
export var CloudWatchLoggingOptions$: StaticStructureSchema = [3, n0, _CWLO,
  0,
  [_E, _LGN, _LSN],
  [2, 0, 0]
];
...
export var DatabaseColumnList$: StaticStructureSchema = [3, n0, _DCL,
  0,
  [_I, _Ex],
  [64 | 0, 64 | 0]
];
export var DatabaseList$: StaticStructureSchema = [3, n0, _DL,
  0,
  [_I, _Ex],
  [64 | 0, 64 | 0]
];
...
export var DataFormatConversionConfiguration$: StaticStructureSchema = [3, n0, _DFCC,
  0,
  [_SCc, _IFC, _OFC, _E],
...
export var ElasticsearchBufferingHints$: StaticStructureSchema = [3, n0, _EBH,
  0,
  [_IIS, _SIMB],
  [1, 1]
];
...
export var ElasticsearchDestinationUpdate$: StaticStructureSchema = [3, n0, _EDU,
  0,
  [_RARN, _DARN, _CEl, _IN, _TN, _IRP, _BH, _RO, _SUp, _PC, _CWLO, _DIO],
...
export var ElasticsearchRetryOptions$: StaticStructureSchema = [3, n0, _ERO,
  0,
  [_DIS],
  [1]
];
...
export var HttpEndpointBufferingHints$: StaticStructureSchema = [3, n0, _HEBH,
  0,
  [_SIMB, _IIS],
  [1, 1]
];
...
export var HttpEndpointDestinationUpdate$: StaticStructureSchema = [3, n0, _HEDU,
  0,
...
export var HttpEndpointRequestConfiguration$: StaticStructureSchema = [3, n0, _HERC,
  0,
  [_CEo, _CA],
  [0, [() => HttpEndpointCommonAttributesList, 0]]
];
export var HttpEndpointRetryOptions$: StaticStructureSchema = [3, n0, _HERO,
  0,
  [_DIS],
  [1]
];
...
export var InputFormatConfiguration$: StaticStructureSchema = [3, n0, _IFC,
  0,
  [_Des],
  [() => Deserializer$]
];
...
export var OpenXJsonSerDe$: StaticStructureSchema = [3, n0, _OXJSD,
  0,
  [_CDIJKTU, _CI, _CTJKM],
  [2, 2, 128 | 0]
];
export var OrcSerDe$: StaticStructureSchema = [3, n0, _OSD,
  0,
  [_SSB, _BSB, _RIS, _EP, _PT, _Com, _BFC, _BFFPP, _DKT, _FV],
  [1, 1, 1, 2, 1, 0, 64 | 0, 1, 1, 0]
];
export var OutputFormatConfiguration$: StaticStructureSchema = [3, n0, _OFC,
  0,
  [_Se],
  [() => Serializer$]
];
export var ParquetSerDe$: StaticStructureSchema = [3, n0, _PSD,
  0,
...
export var ProcessingConfiguration$: StaticStructureSchema = [3, n0, _PC,
  0,
  [_E, _Pro],
  [2, () => ProcessorList]
];
...
export var RedshiftRetryOptions$: StaticStructureSchema = [3, n0, _RRO,
  0,
  [_DIS],
  [1]
];
...
export var SchemaConfiguration$: StaticStructureSchema = [3, n0, _SCc,
  0,
...
export var SnowflakeDestinationUpdate$: StaticStructureSchema = [3, n0, _SDUn,
  0,
...
export var SnowflakeRetryOptions$: StaticStructureSchema = [3, n0, _SRO,
  0,
  [_DIS],
  [1]
];
export var SnowflakeRoleConfiguration$: StaticStructureSchema = [3, n0, _SRC,
  0,
  [_E, _SR],
  [2, [() => SnowflakeRole, 0]]
];
...
export var SplunkBufferingHints$: StaticStructureSchema = [3, n0, _SBHp,
  0,
  [_IIS, _SIMB],
  [1, 1]
];
...
export var SplunkDestinationUpdate$: StaticStructureSchema = [3, n0, _SDUp,
  0,
...
export var SplunkRetryOptions$: StaticStructureSchema = [3, n0, _SROp,
  0,
  [_DIS],
  [1]
];
...
var DestinationDescriptionList: StaticListSchema = [1, n0, _DDL,
  0, [() => DestinationDescription$,
    0]
];
var DestinationTableConfigurationList: StaticListSchema = [1, n0, _DTCL,
  0, () => DestinationTableConfiguration$
];
var HttpEndpointCommonAttributesList: StaticListSchema = [1, n0, _HECAL,
  0, [() => HttpEndpointCommonAttribute$,
    0]
];
var ListOfNonEmptyStrings = 64 | 0;
var ListOfNonEmptyStringsWithoutWhitespace = 64 | 0;
var ListTagsForDeliveryStreamOutputTagList: StaticListSchema = [1, n0, _LTFDSOTL,
  0, () => Tag$
];
var PartitionFields: StaticListSchema = [1, n0, _PFa,
  0, () => PartitionField$
];
var ProcessorList: StaticListSchema = [1, n0, _PL,
  0, () => Processor$
];
var ProcessorParameterList: StaticListSchema = [1, n0, _PPL,
  0, () => ProcessorParameter$
];
var PutRecordBatchRequestEntryList: StaticListSchema = [1, n0, _PRBREL,
  0, () => _Record$
];
var PutRecordBatchResponseEntryList: StaticListSchema = [1, n0, _PRBRELu,
  0, () => PutRecordBatchResponseEntry$
];
var SecurityGroupIdList = 64 | 0;
var SubnetIdList = 64 | 0;
var TagDeliveryStreamInputTagList: StaticListSchema = [1, n0, _TDSITL,
  0, () => Tag$
];
var TagKeyList = 64 | 0;
var ColumnToJsonKeyMappings = 128 | 0;
export var CreateDeliveryStream$: StaticOperationSchema = [9, n0, _CDS,
  0, () => CreateDeliveryStreamInput$, () => CreateDeliveryStreamOutput$
];
export var DeleteDeliveryStream$: StaticOperationSchema = [9, n0, _DDS,
  0, () => DeleteDeliveryStreamInput$, () => DeleteDeliveryStreamOutput$
];
export var DescribeDeliveryStream$: StaticOperationSchema = [9, n0, _DDSe,
  0, () => DescribeDeliveryStreamInput$, () => DescribeDeliveryStreamOutput$
];
export var ListDeliveryStreams$: StaticOperationSchema = [9, n0, _LDS,
  0, () => ListDeliveryStreamsInput$, () => ListDeliveryStreamsOutput$
];
export var ListTagsForDeliveryStream$: StaticOperationSchema = [9, n0, _LTFDS,
...
export var PutRecordBatch$: StaticOperationSchema = [9, n0, _PRB,
  0, () => PutRecordBatchInput$, () => PutRecordBatchOutput$
];
export var StartDeliveryStreamEncryption$: StaticOperationSchema = [9, n0, _SDSE,
  0, () => StartDeliveryStreamEncryptionInput$, () => StartDeliveryStreamEncryptionOutput$
];
export var StopDeliveryStreamEncryption$: StaticOperationSchema = [9, n0, _SDSEt,
  0, () => StopDeliveryStreamEncryptionInput$, () => StopDeliveryStreamEncryptionOutput$
];
export var TagDeliveryStream$: StaticOperationSchema = [9, n0, _TDS,
  0, () => TagDeliveryStreamInput$, () => TagDeliveryStreamOutput$
];
export var UntagDeliveryStream$: StaticOperationSchema = [9, n0, _UDS,
  0, () => UntagDeliveryStreamInput$, () => UntagDeliveryStreamOutput$
];
export var UpdateDestination$: StaticOperationSchema = [9, n0, _UD,
