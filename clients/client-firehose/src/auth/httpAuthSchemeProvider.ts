...
import { type FirehoseClientResolvedConfig, FirehoseClientConfig } from "../FirehoseClient";
 ...
 * @internal
 */
export const defaultFirehoseHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: FirehoseHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultFirehoseHttpAuthSchemeProvider: FirehoseHttpAuthSchemeProvider = (authParameters) => {
