...
export var ListSimulationsInput$: StaticStructureSchema = [3, n0, _LSI,
  0,
  [_MR, _NT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListSimulationsOutput$: StaticStructureSchema = [3, n0, _LSO,
  0,
  [_Si, _NT],
  [() => SimulationList, 0]
];
...
export var LiveSimulationState$: StaticStructureSchema = [3, n0, _LSS,
  0,
  [_Dom, _C],
...
export var SimulationAppMetadata$: StaticStructureSchema = [3, n0, _SAM,
  0,
  [_N, _S, _Do, _St, _TS],
  [0, 0, 0, 0, 0]
];
export var SimulationAppPortMapping$: StaticStructureSchema = [3, n0, _SAPM,
  0,
  [_Dec, _Ac],
  [1, 1]
];
export var SimulationClock$: StaticStructureSchema = [3, n0, _SC,
  0,
  [_St, _TS],
  [0, 0]
];
export var SimulationMetadata$: StaticStructureSchema = [3, n0, _SM,
  0,
  [_N, _Ar, _CTr, _St, _TS],
  [0, 0, 4, 0, 0]
];
...
var DomainList: StaticListSchema = [1, n0, _DL,
  0, () => Domain$
];
var LaunchCommandList = 64 | 0;
var LogDestinations: StaticListSchema = [1, n0, _LDo,
  0, () => LogDestination$
];
var SimulationAppList: StaticListSchema = [1, n0, _SAL,
  0, () => SimulationAppMetadata$
];
var SimulationClockList: StaticListSchema = [1, n0, _SCL,
  0, () => SimulationClock$
];
var SimulationList: StaticListSchema = [1, n0, _SLi,
