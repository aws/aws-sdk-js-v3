...
export const getRuntimeConfig = (config: SavingsplansClientConfig) => {
  return {
    ...
    httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultSavingsplansHttpAuthSchemeProvider,
    ...
    protocol: config?.protocol ?? new AwsRestJsonProtocol({ defaultNamespace: "com.amazonaws.savingsplans" }),
