...
import {
  ...
  defaultSavingsplansHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type SavingsplansClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<SavingsplansClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: SavingsplansClientResolvedConfig) =>
