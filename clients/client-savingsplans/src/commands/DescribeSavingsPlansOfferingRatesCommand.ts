 ...
 * @public
 */
export class DescribeSavingsPlansOfferingRatesCommand extends command<DescribeSavingsPlansOfferingRatesCommandInput, DescribeSavingsPlansOfferingRatesCommandOutput>(
  _ep0,
  _mw0,
