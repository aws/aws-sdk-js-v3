...
const _data={
  ...
  results: [
    ...
    [d,{[i]:[e,{[j]:c}]}],
    ["https://partnercentral-prm.us-gov.{PartitionResult#dualStackDnsSuffix}",f],
    ["https://partnercentral-prm-fips.us-gov.{PartitionResult#dualStackDnsSuffix}",f],
    ["https://partnercentral-prm-fips.global.{PartitionResult#dualStackDnsSuffix}",g],
    ["https://partnercentral-prm.global.{PartitionResult#dualStackDnsSuffix}",g],
