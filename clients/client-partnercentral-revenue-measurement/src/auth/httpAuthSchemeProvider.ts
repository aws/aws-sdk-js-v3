...
import {
  PartnerCentralRevenueMeasurementClientConfig,
 ...
 * @internal
 */
interface _PartnerCentralRevenueMeasurementHttpAuthSchemeParameters extends HttpAuthSchemeParameters {
  region?: string;
}
 ...
 * @internal
 */
export interface PartnerCentralRevenueMeasurementHttpAuthSchemeParameters extends _PartnerCentralRevenueMeasurementHttpAuthSchemeParameters, EndpointParameters {
  region?: string;
}
 ...
 * @internal
 */
export interface PartnerCentralRevenueMeasurementHttpAuthSchemeParametersProvider
  extends HttpAuthSchemeParametersProvider<
    PartnerCentralRevenueMeasurementClientResolvedConfig,
    HandlerExecutionContext,
    PartnerCentralRevenueMeasurementHttpAuthSchemeParameters,
    object
  > {}
 ...
 * @internal
 */
const _defaultPartnerCentralRevenueMeasurementHttpAuthSchemeParametersProvider = async (
  config: PartnerCentralRevenueMeasurementClientResolvedConfig,
  context: HandlerExecutionContext,
  input: object
): Promise<_PartnerCentralRevenueMeasurementHttpAuthSchemeParameters> => {
  return {
 ...
 * @internal
 */
export const defaultPartnerCentralRevenueMeasurementHttpAuthSchemeParametersProvider: PartnerCentralRevenueMeasurementHttpAuthSchemeParametersProvider =
  createEndpointRuleSetHttpAuthSchemeParametersProvider(_defaultPartnerCentralRevenueMeasurementHttpAuthSchemeParametersProvider);

function createAwsAuthSigv4HttpAuthOption(authParameters: PartnerCentralRevenueMeasurementHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<PartnerCentralRevenueMeasurementClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
...
function createAwsAuthSigv4aHttpAuthOption(authParameters: PartnerCentralRevenueMeasurementHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
interface _PartnerCentralRevenueMeasurementHttpAuthSchemeProvider extends HttpAuthSchemeProvider<PartnerCentralRevenueMeasurementHttpAuthSchemeParameters> {}

/**
 * @internal
 */
export interface PartnerCentralRevenueMeasurementHttpAuthSchemeProvider extends HttpAuthSchemeProvider<PartnerCentralRevenueMeasurementHttpAuthSchemeParameters> {}
 ...
 * @internal
 */
const _defaultPartnerCentralRevenueMeasurementHttpAuthSchemeProvider: _PartnerCentralRevenueMeasurementHttpAuthSchemeProvider = (authParameters) => {
  const options: HttpAuthOption[] = [];
 ...
 * @internal
 */
export const defaultPartnerCentralRevenueMeasurementHttpAuthSchemeProvider: PartnerCentralRevenueMeasurementHttpAuthSchemeProvider = createEndpointRuleSetHttpAuthSchemeProvider(
  defaultEndpointResolver,
  _defaultPartnerCentralRevenueMeasurementHttpAuthSchemeProvider, {
...
export interface HttpAuthSchemeResolvedConfig extends AwsSdkSigV4AuthResolvedConfig, AwsSdkSigV4AAuthResolvedConfig {
   ...
   * @internal
   */
  readonly httpAuthSchemeProvider: PartnerCentralRevenueMeasurementHttpAuthSchemeProvider;
}
