...
import {
  type SageMakerA2IRuntimeClientResolvedConfig,
 ...
 * @internal
 */
export const defaultSageMakerA2IRuntimeHttpAuthSchemeProvider: SageMakerA2IRuntimeHttpAuthSchemeProvider = (authParameters) => {
