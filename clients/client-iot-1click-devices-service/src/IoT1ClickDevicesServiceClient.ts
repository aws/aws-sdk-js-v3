...
import {
  defaultIoT1ClickDevicesServiceHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type IoT1ClickDevicesServiceClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
 ...
 * @public
 */
export type IoT1ClickDevicesServiceClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<IoT1ClickDevicesServiceClientConfig>) {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultIoT1ClickDevicesServiceHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: IoT1ClickDevicesServiceClientResolvedConfig) =>
