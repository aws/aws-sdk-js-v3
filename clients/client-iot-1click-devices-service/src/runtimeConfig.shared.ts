...
import { defaultIoT1ClickDevicesServiceHttpAuthSchemeProvider } from "./auth/httpAuthSchemeProvider";
...
export const getRuntimeConfig = (config: IoT1ClickDevicesServiceClientConfig) => {
  return {
    ...
    httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultIoT1ClickDevicesServiceHttpAuthSchemeProvider,
