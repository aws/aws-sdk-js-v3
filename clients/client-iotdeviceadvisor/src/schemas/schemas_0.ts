...
export var DeviceUnderTest$: StaticStructureSchema = [3, n0, _DUT,
  0,
  [_tA, _cAe, _dRA],
  [0, 0, 0]
];
...
export var ListSuiteDefinitionsResponse$: StaticStructureSchema = [3, n0, _LSDRi,
  0,
  [_sDIL, _nT],
  [() => SuiteDefinitionInformationList, 0]
];
export var ListSuiteRunsRequest$: StaticStructureSchema = [3, n0, _LSRR,
  0,
  [_sDI, _sDV, _mR, _nT],
  [[0, { [_hQ]: _sDI }], [0, { [_hQ]: _sDV }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListSuiteRunsResponse$: StaticStructureSchema = [3, n0, _LSRRi,
  0,
  [_sRL, _nT],
  [() => SuiteRunsList, 0]
];
...
var GroupResultList: StaticListSchema = [1, n0, _GRL,
  0, () => GroupResult$
];
var SelectedTestList = 64 | 0;
var SuiteDefinitionInformationList: StaticListSchema = [1, n0, _SDIL,
  0, () => SuiteDefinitionInformation$
];
var SuiteRunsList: StaticListSchema = [1, n0, _SRL,
  0, () => SuiteRunInformation$
];
var TagKeyList = 64 | 0;
var TestCaseRuns: StaticListSchema = [1, n0, _TCRe,
  0, () => TestCaseRun$
];
var TestCaseScenariosList: StaticListSchema = [1, n0, _TCSL,
  0, () => TestCaseScenario$
];
var TagMap = 128 | 0;
export var CreateSuiteDefinition$: StaticOperationSchema = [9, n0, _CSD,
  { [_h]: ["POST", "/suiteDefinitions", 200] }, () => CreateSuiteDefinitionRequest$, () => CreateSuiteDefinitionResponse$
];
export var DeleteSuiteDefinition$: StaticOperationSchema = [9, n0, _DSD,
...
export var UpdateSuiteDefinition$: StaticOperationSchema = [9, n0, _USD,
