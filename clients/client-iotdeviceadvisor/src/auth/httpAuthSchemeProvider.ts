...
import { type IotDeviceAdvisorClientResolvedConfig, IotDeviceAdvisorClientConfig } from "../IotDeviceAdvisorClient";
 ...
 * @internal
 */
export const defaultIotDeviceAdvisorHttpAuthSchemeProvider: IotDeviceAdvisorHttpAuthSchemeProvider = (authParameters) => {
