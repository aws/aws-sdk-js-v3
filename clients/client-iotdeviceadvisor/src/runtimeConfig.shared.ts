...
export const getRuntimeConfig = (config: IotDeviceAdvisorClientConfig) => {
  return {
    ...
    httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultIotDeviceAdvisorHttpAuthSchemeProvider,
    ...
    protocol: config?.protocol ?? new AwsRestJsonProtocol({ defaultNamespace: "com.amazonaws.iotdeviceadvisor" }),
