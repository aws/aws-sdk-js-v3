...
import { UpdateGraphqlApiRequest, UpdateGraphqlApiResponse } from "../models/index";
import {
  deserializeAws_restJson1_1UpdateGraphqlApiCommand,
  serializeAws_restJson1_1UpdateGraphqlApiCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1UpdateGraphqlApiCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1UpdateGraphqlApiCommand(output, context);
  }
