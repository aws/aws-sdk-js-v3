...
import { type AppSyncClientResolvedConfig, AppSyncClientConfig } from "../AppSyncClient";
 ...
 * @internal
 */
export const defaultAppSyncHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: AppSyncHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultAppSyncHttpAuthSchemeProvider: AppSyncHttpAuthSchemeProvider = (authParameters) => {
