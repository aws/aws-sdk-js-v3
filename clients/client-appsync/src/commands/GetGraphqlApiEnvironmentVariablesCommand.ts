 ...
 * @public
 */
export class GetGraphqlApiEnvironmentVariablesCommand extends command<GetGraphqlApiEnvironmentVariablesCommandInput, GetGraphqlApiEnvironmentVariablesCommandOutput>(
  _ep0,
  _mw0,
