...
import type { GetApiAssociationRequest, GetApiAssociationResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetApiAssociationCommand extends command<GetApiAssociationCommandInput, GetApiAssociationCommandOutput>(
  _ep0,
  _mw0,
  "GetApiAssociation",
  GetApiAssociation$
