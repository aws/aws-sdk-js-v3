...
import type { CreateApiCacheRequest, CreateApiCacheResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateApiCacheCommand extends command<CreateApiCacheCommandInput, CreateApiCacheCommandOutput>(
  _ep0,
  _mw0,
  "CreateApiCache",
  CreateApiCache$
