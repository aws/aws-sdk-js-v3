...
> {
   ...
   * @public
   */
  constructor(readonly input: StartDataSourceIntrospectionCommandInput) {
    super();
  }
  ...
  ): Handler<StartDataSourceIntrospectionCommandInput, StartDataSourceIntrospectionCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, StartDataSourceIntrospectionCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: StartDataSourceIntrospectionCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
