...
import type { CreateGraphqlApiRequest, CreateGraphqlApiResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateGraphqlApiCommand extends command<CreateGraphqlApiCommandInput, CreateGraphqlApiCommandOutput>(
  _ep0,
  _mw0,
  "CreateGraphqlApi",
  CreateGraphqlApi$
