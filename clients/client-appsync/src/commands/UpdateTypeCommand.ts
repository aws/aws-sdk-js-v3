...
import type { UpdateTypeRequest, UpdateTypeResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateTypeCommand extends command<UpdateTypeCommandInput, UpdateTypeCommandOutput>(
  _ep0,
  _mw0,
  "UpdateType",
  UpdateType$
