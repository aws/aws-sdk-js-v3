...
import {
  deserializeAws_restJson1_1GetThingShadowCommand,
  serializeAws_restJson1_1GetThingShadowCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetThingShadowCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetThingShadowCommand(output, context);
  }
