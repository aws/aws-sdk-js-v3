...
import {
  defaultIoTDataPlaneHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type IoTDataPlaneClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
 ...
 * @public
 */
export type IoTDataPlaneClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultIoTDataPlaneHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: IoTDataPlaneClientResolvedConfig) =>
