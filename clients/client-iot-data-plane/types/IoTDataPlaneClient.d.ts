...
export declare type ServiceInputTypes = DeleteThingShadowCommandInput | GetThingShadowCommandInput | PublishCommandInput | UpdateThingShadowCommandInput;
export declare type ServiceOutputTypes = DeleteThingShadowCommandOutput | GetThingShadowCommandOutput | PublishCommandOutput | UpdateThingShadowCommandOutput;
...
export declare type IoTDataPlaneClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type IoTDataPlaneClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
