...
import type { UpdateLocationHdfsRequest, UpdateLocationHdfsResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateLocationHdfsCommand extends command<UpdateLocationHdfsCommandInput, UpdateLocationHdfsCommandOutput>(
  _ep0,
  _mw0,
  "UpdateLocationHdfs",
  UpdateLocationHdfs$
