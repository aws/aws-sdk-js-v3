...
import type { UpdateLocationFsxWindowsRequest, UpdateLocationFsxWindowsResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateLocationFsxWindowsCommand extends command<UpdateLocationFsxWindowsCommandInput, UpdateLocationFsxWindowsCommandOutput>(
  _ep0,
  _mw0,
