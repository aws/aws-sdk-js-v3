...
const _AA = "ArchiveApplication";
const _AAR = "ArchiveApplicationRequest";
const _AARs = "AssociateApplicationsRequest";
const _AARss = "AssociateApplicationsResponse";
const _AAS = "ApplicationAggregatedStatus";
const _AAs = "AssociateApplications";
const _ADE = "AccessDeniedException";
const _AL = "ApplicationsList";
const _ASS = "AssociateSourceServers";
const _ASSR = "AssociateSourceServersRequest";
...
const _CSCC = "ConnectorSsmCommandConfig";
const _CSLCS = "ChangeServerLifeCycleState";
const _CSLCSR = "ChangeServerLifeCycleStateRequest";
...
const _DARi = "DisassociateApplicationsRequest";
const _DARis = "DisassociateApplicationsResponse";
const _DAi = "DisassociateApplications";
const _DC = "DeleteConnector";
const _DCR = "DeleteConnectorRequest";
const _DFS = "DisconnectFromService";
const _DFSR = "DisconnectFromServiceRequest";
const _DJ = "DeleteJob";
...
const _DSSRi = "DisassociateSourceServersRequest";
const _DSSRis = "DisassociateSourceServersResponse";
const _DSSe = "DescribeSourceServers";
const _DSSi = "DisassociateSourceServers";
const _DVC = "DeleteVcenterClient";
const _DVCR = "DeleteVcenterClientRequest";
const _DVCRe = "DescribeVcenterClientsRequest";
const _DVCRes = "DescribeVcenterClientsResponse";
const _DVCe = "DescribeVcenterClients";
const _DW = "DeleteWave";
const _DWR = "DeleteWaveRequest";
const _DWRe = "DeleteWaveResponse";
const _Di = "Disks";
...
const _ITE = "ImportTaskError";
const _ITS = "ImportTaskSummary";
const _ITSA = "ImportTaskSummaryApplications";
const _ITSS = "ImportTaskSummaryServers";
const _ITSW = "ImportTaskSummaryWaves";
const _J = "Job";
const _JL = "JobLog";
const _JLED = "JobLogEventData";
const _JLo = "JobLogs";
const _JLob = "JobsList";
const _JPLALS = "JobPostLaunchActionsLaunchStatus";
const _L = "Licensing";
const _LA = "ListApplications";
const _LAR = "ListApplicationsRequest";
const _LARF = "ListApplicationsRequestFilters";
const _LARi = "ListApplicationsResponse";
const _LC = "LaunchConfiguration";
const _LCLC = "LifeCycleLastCutover";
const _LCLCF = "LifeCycleLastCutoverFinalized";
const _LCLCI = "LifeCycleLastCutoverInitiated";
const _LCLCR = "LifeCycleLastCutoverReverted";
const _LCLT = "LifeCycleLastTest";
const _LCLTF = "LifeCycleLastTestFinalized";
const _LCLTI = "LifeCycleLastTestInitiated";
const _LCLTR = "LifeCycleLastTestReverted";
const _LCR = "ListConnectorsRequest";
const _LCRF = "ListConnectorsRequestFilters";
...
const _LCis = "ListConnectors";
const _LE = "ListExports";
const _LEE = "ListExportErrors";
const _LEER = "ListExportErrorsRequest";
const _LEERi = "ListExportErrorsResponse";
const _LER = "ListExportsRequest";
const _LERF = "ListExportsRequestFilters";
...
const _LTA = "ListTemplateActions";
const _LTAR = "ListTemplateActionsRequest";
const _LTARi = "ListTemplateActionsResponse";
const _LTDC = "LaunchTemplateDiskConf";
const _LTFR = "ListTagsForResource";
const _LTFRR = "ListTagsForResourceRequest";
const _LTFRRi = "ListTagsForResourceResponse";
const _LW = "ListWaves";
const _LWR = "ListWavesRequest";
const _LWRF = "ListWavesRequestFilters";
const _LWRi = "ListWavesResponse";
const _MA = "ManagedAccount";
...
const _PR = "PauseReplication";
const _PRR = "PauseReplicationRequest";
const _PS = "ParticipatingServer";
const _PSSA = "PutSourceServerAction";
const _PSSAR = "PutSourceServerActionRequest";
const _PSa = "ParticipatingServers";
const _PTA = "PutTemplateAction";
const _PTAR = "PutTemplateActionRequest";
...
const _RR = "ResumeReplication";
const _RRR = "ResumeReplicationRequest";
const _RSSA = "RemoveSourceServerAction";
const _RSSAR = "RemoveSourceServerActionRequest";
const _RSSARe = "RemoveSourceServerActionResponse";
const _RTA = "RemoveTemplateAction";
...
const _SE = "StartExport";
const _SEP = "SsmExternalParameter";
...
const _SR = "StartReplication";
const _SRR = "StartReplicationRequest";
const _SRRt = "StopReplicationRequest";
const _SRt = "StopReplication";
...
const _TADe = "TemplateActionDocuments";
const _TARF = "TemplateActionsRequestFilters";
...
const _UA = "UnarchiveApplication";
const _UAE = "UninitializedAccountException";
const _UAR = "UnarchiveApplicationRequest";
...
const _USS = "UpdateSourceServer";
const _USSR = "UpdateSourceServerRequest";
const _USSRT = "UpdateSourceServerReplicationType";
const _USSRTR = "UpdateSourceServerReplicationTypeRequest";
const _UW = "UnarchiveWave";
const _UWR = "UnarchiveWaveRequest";
const _UWRp = "UpdateWaveRequest";
const _UWp = "UpdateWave";
const _VC = "VcenterClient";
const _VCL = "VcenterClientList";
const _VE = "ValidationException";
const _VEF = "ValidationExceptionField";
const _VEFL = "ValidationExceptionFieldList";
const _W = "Wave";
const _WAS = "WaveAggregatedStatus";
const _WL = "WavesList";
const _a = "arn";
const _aAS = "applicationAggregatedStatus";
...
const _lSD = "lastSeenDatetime";
const _lSDT = "lastSnapshotDateTime";
const _lT = "lastTest";
...
const _rTe = "replicationTypes";
const _rTep = "replicationType";
const _re = "reverted";
const _s = "smithy.ts.sdk.synthetic.com.amazonaws.mgn";
...
const _w = "waves";
const _wAS = "waveAggregatedStatus";
const _wC = "wavesCount";
const _wID = "waveID";
const _wIDa = "waveIDs";
const n0 = "com.amazonaws.mgn";
...
export var MgnServiceException$: StaticErrorSchema = [-3, _s, "MgnServiceException", 0, [], []];
_s_registry.registerError(MgnServiceException$, MgnServiceException);
...
export var ChangeServerLifeCycleStateRequest$: StaticStructureSchema = [3, n0, _CSLCSR,
  0,
  [_sSIDo, _lC, _aIDc],
  [0, () => ChangeServerLifeCycleStateSourceServerLifecycle$, 0], 2
];
...
export var CreateConnectorRequest$: StaticStructureSchema = [3, n0, _CCR,
  0,
  [_n, _sIID, _t, _sCC],
  [0, 0, [() => TagsMap, 0], () => ConnectorSsmCommandConfig$], 2
];
...
export var Job$: StaticStructureSchema = [3, n0, _J,
  ...
  [0, 0, 0, 0, 0, 0, 0, () => ParticipatingServers, [() => TagsMap, 0]], 1
];
...
export var LaunchConfigurationTemplate$: StaticStructureSchema = [3, n0, _LCT,
  ...
  [0, 0, () => PostLaunchActions$, 2, 0, [() => TagsMap, 0], 0, 0, 0, 2, 2, 2, () => Licensing$, 0, 1, () => LaunchTemplateDiskConf$, () => LaunchTemplateDiskConf$, 2, 0], 1
];
...
export var LifeCycle$: StaticStructureSchema = [3, n0, _LCi,
  0,
  [_aTSDT, _fBDT, _eRD, _lSBSDT, _lT, _lCa, _st],
...
export var ListSourceServerActionsRequest$: StaticStructureSchema = [3, n0, _LSSAR,
  ...
  [0, () => SourceServerActionsRequestFilters$, 1, 0, 0], 1
];
...
export var ListTemplateActionsRequest$: StaticStructureSchema = [3, n0, _LTAR,
  0,
  [_lCTID, _f, _mR, _nT],
  [0, () => TemplateActionsRequestFilters$, 1, 0], 1
];
...
export var ParticipatingServer$: StaticStructureSchema = [3, n0, _PS,
  ...
  [0, 0, 0, () => PostLaunchActionsStatus$], 1
];
...
export var StartImportRequest$: StaticStructureSchema = [3, n0, _SIR,
  0,
  [_sBS, _cTl, _t],
  [() => S3BucketSource$, [0, 4], [() => TagsMap, 0]], 1
];
...
export var UpdateConnectorRequest$: StaticStructureSchema = [3, n0, _UCR,
  0,
  [_cID, _n, _sCC],
  [0, 0, () => ConnectorSsmCommandConfig$], 1
];
export var UpdateLaunchConfigurationRequest$: StaticStructureSchema = [3, n0, _ULCR,
  ...
  [0, 0, 0, 0, 2, 2, () => Licensing$, 0, () => PostLaunchActions$, 2, 0, 0], 1
];
