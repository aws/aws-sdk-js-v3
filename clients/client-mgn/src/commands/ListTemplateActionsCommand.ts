...
import type { ListTemplateActionsRequest, ListTemplateActionsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListTemplateActionsCommand extends command<ListTemplateActionsCommandInput, ListTemplateActionsCommandOutput>(
  _ep0,
  _mw0,
  "ListTemplateActions",
  ListTemplateActions$
