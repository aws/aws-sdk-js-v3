 ...
 * @public
 */
export class ListNetworkMigrationMapperSegmentsCommand extends command<ListNetworkMigrationMapperSegmentsCommandInput, ListNetworkMigrationMapperSegmentsCommandOutput>(
  _ep0,
  _mw0,
