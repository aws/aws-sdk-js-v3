 ...
 * @public
 */
export class GetNetworkMigrationDefinitionCommand extends command<GetNetworkMigrationDefinitionCommandInput, GetNetworkMigrationDefinitionCommandOutput>(
  _ep0,
  _mw0,
