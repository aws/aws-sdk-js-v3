 ...
 * @public
 */
export class StartNetworkMigrationDeploymentCommand extends command<StartNetworkMigrationDeploymentCommandInput, StartNetworkMigrationDeploymentCommandOutput>(
  _ep0,
  _mw0,
