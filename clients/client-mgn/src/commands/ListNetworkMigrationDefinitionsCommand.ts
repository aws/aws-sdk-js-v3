 ...
 * @public
 */
export class ListNetworkMigrationDefinitionsCommand extends command<ListNetworkMigrationDefinitionsCommandInput, ListNetworkMigrationDefinitionsCommandOutput>(
  _ep0,
  _mw0,
