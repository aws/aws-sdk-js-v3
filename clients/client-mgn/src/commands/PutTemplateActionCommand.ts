...
import type { PutTemplateActionRequest, TemplateActionDocument } from "../models/models_0";
import { PutTemplateAction$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class PutTemplateActionCommand extends command<PutTemplateActionCommandInput, PutTemplateActionCommandOutput>(
  _ep0,
  _mw0,
  "PutTemplateAction",
  PutTemplateAction$
