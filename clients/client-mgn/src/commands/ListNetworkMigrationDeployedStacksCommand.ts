 ...
 * @public
 */
export class ListNetworkMigrationDeployedStacksCommand extends command<ListNetworkMigrationDeployedStacksCommandInput, ListNetworkMigrationDeployedStacksCommandOutput>(
  _ep0,
  _mw0,
