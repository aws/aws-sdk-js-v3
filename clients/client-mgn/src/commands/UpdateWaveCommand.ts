...
import type { UpdateWaveRequest, Wave } from "../models/models_0";
import { UpdateWave$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateWaveCommand extends command<UpdateWaveCommandInput, UpdateWaveCommandOutput>(
  _ep0,
  _mw0,
  "UpdateWave",
  UpdateWave$
