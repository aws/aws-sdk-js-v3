...
import type { ArchiveWaveRequest, Wave } from "../models/models_0";
 ...
 * @public
 */
export class ArchiveWaveCommand extends command<ArchiveWaveCommandInput, ArchiveWaveCommandOutput>(
  _ep0,
  _mw0,
  "ArchiveWave",
  ArchiveWave$
