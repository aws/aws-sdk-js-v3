 ...
 * @public
 */
export class UpdateReplicationConfigurationTemplateCommand extends command<UpdateReplicationConfigurationTemplateCommandInput, UpdateReplicationConfigurationTemplateCommandOutput>(
  _ep0,
  _mw0,
