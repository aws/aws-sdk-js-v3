 ...
 * @public
 */
export class StartNetworkMigrationAnalysisCommand extends command<StartNetworkMigrationAnalysisCommandInput, StartNetworkMigrationAnalysisCommandOutput>(
  _ep0,
  _mw0,
