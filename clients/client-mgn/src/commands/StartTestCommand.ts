...
import type { StartTestRequest, StartTestResponse } from "../models/models_0";
 ...
 * @public
 */
export class StartTestCommand extends command<StartTestCommandInput, StartTestCommandOutput>(
  _ep0,
  _mw0,
  "StartTest",
  StartTest$
