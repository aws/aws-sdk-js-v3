 ...
 * @public
 */
export class UpdateSourceServerReplicationTypeCommand extends command<UpdateSourceServerReplicationTypeCommandInput, UpdateSourceServerReplicationTypeCommandOutput>(
  _ep0,
  _mw0,
