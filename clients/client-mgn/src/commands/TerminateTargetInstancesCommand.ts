...
import type { TerminateTargetInstancesRequest, TerminateTargetInstancesResponse } from "../models/models_0";
 ...
 * @public
 */
export class TerminateTargetInstancesCommand extends command<TerminateTargetInstancesCommandInput, TerminateTargetInstancesCommandOutput>(
  _ep0,
  _mw0,
