 ...
 * @public
 */
export class ListNetworkMigrationDeploymentsCommand extends command<ListNetworkMigrationDeploymentsCommandInput, ListNetworkMigrationDeploymentsCommandOutput>(
  _ep0,
  _mw0,
