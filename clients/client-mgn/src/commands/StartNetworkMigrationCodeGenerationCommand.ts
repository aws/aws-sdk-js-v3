 ...
 * @public
 */
export class StartNetworkMigrationCodeGenerationCommand extends command<StartNetworkMigrationCodeGenerationCommandInput, StartNetworkMigrationCodeGenerationCommandOutput>(
  _ep0,
  _mw0,
