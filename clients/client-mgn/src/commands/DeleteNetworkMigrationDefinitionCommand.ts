 ...
 * @public
 */
export class DeleteNetworkMigrationDefinitionCommand extends command<DeleteNetworkMigrationDefinitionCommandInput, DeleteNetworkMigrationDefinitionCommandOutput>(
  _ep0,
  _mw0,
