...
import type { ChangeServerLifeCycleStateRequest, SourceServer } from "../models/models_0";
import { ChangeServerLifeCycleState$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ChangeServerLifeCycleStateCommand extends command<ChangeServerLifeCycleStateCommandInput, ChangeServerLifeCycleStateCommandOutput>(
  _ep0,
  _mw0,
