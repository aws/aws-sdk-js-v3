 ...
 * @public
 */
export class ListNetworkMigrationExecutionsCommand extends command<ListNetworkMigrationExecutionsCommandInput, ListNetworkMigrationExecutionsCommandOutput>(
  _ep0,
  _mw0,
