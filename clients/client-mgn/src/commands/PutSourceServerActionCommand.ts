...
import type { PutSourceServerActionRequest, SourceServerActionDocument } from "../models/models_0";
import { PutSourceServerAction$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class PutSourceServerActionCommand extends command<PutSourceServerActionCommandInput, PutSourceServerActionCommandOutput>(
  _ep0,
  _mw0,
