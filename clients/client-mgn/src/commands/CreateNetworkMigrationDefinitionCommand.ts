 ...
 * @public
 */
export class CreateNetworkMigrationDefinitionCommand extends command<CreateNetworkMigrationDefinitionCommandInput, CreateNetworkMigrationDefinitionCommandOutput>(
  _ep0,
  _mw0,
