...
import type { AssociateSourceServersRequest, AssociateSourceServersResponse } from "../models/models_0";
 ...
 * @public
 */
export class AssociateSourceServersCommand extends command<AssociateSourceServersCommandInput, AssociateSourceServersCommandOutput>(
  _ep0,
  _mw0,
