...
import type { PauseReplicationRequest, SourceServer } from "../models/models_0";
 ...
 * @public
 */
export class PauseReplicationCommand extends command<PauseReplicationCommandInput, PauseReplicationCommandOutput>(
  _ep0,
  _mw0,
  "PauseReplication",
  PauseReplication$
