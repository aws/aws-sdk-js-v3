 ...
 * @public
 */
export class StartNetworkMigrationMappingUpdateCommand extends command<StartNetworkMigrationMappingUpdateCommandInput, StartNetworkMigrationMappingUpdateCommandOutput>(
  _ep0,
  _mw0,
