 ...
 * @public
 */
export class ListNetworkMigrationAnalysisResultsCommand extends command<ListNetworkMigrationAnalysisResultsCommandInput, ListNetworkMigrationAnalysisResultsCommandOutput>(
  _ep0,
  _mw0,
