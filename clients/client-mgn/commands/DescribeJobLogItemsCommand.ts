...
export type DescribeJobLogItemsCommandInput = DescribeJobLogItemsRequest;
export type DescribeJobLogItemsCommandOutput = DescribeJobLogItemsResponse & __MetadataBearer;
