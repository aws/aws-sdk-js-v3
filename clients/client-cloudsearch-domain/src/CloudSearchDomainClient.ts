...
import {
  ...
  defaultCloudSearchDomainHttpAuthSchemeParametersProvider,
...
import type { UploadDocumentsCommandInput, UploadDocumentsCommandOutput } from "./commands/UploadDocumentsCommand";
import {
 ...
 * @public
 */
export type CloudSearchDomainClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type CloudSearchDomainClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<CloudSearchDomainClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultCloudSearchDomainHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: CloudSearchDomainClientResolvedConfig) =>
