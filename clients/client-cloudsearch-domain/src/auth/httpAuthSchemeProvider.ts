...
import { type CloudSearchDomainClientResolvedConfig, CloudSearchDomainClientConfig } from "../CloudSearchDomainClient";
 ...
 * @internal
 */
export const defaultCloudSearchDomainHttpAuthSchemeProvider: CloudSearchDomainHttpAuthSchemeProvider = (authParameters) => {
