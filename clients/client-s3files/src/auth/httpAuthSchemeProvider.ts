...
import { type S3FilesClientResolvedConfig, S3FilesClientConfig } from "../S3FilesClient";
 ...
 * @internal
 */
export const defaultS3FilesHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: S3FilesHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<S3FilesClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultS3FilesHttpAuthSchemeProvider: S3FilesHttpAuthSchemeProvider = (authParameters) => {
