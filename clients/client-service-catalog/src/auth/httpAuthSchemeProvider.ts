...
import { type ServiceCatalogClientResolvedConfig, ServiceCatalogClientConfig } from "../ServiceCatalogClient";
 ...
 * @internal
 */
export const defaultServiceCatalogHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ServiceCatalogHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<ServiceCatalogClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultServiceCatalogHttpAuthSchemeProvider: ServiceCatalogHttpAuthSchemeProvider = (authParameters) => {
