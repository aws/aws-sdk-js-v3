...
import type { ProvisionProductInput, ProvisionProductOutput } from "../models/models_0";
 ...
 * @public
 */
export class ProvisionProductCommand extends command<ProvisionProductCommandInput, ProvisionProductCommandOutput>(
  _ep0,
  _mw0,
  "ProvisionProduct",
  ProvisionProduct$
