...
import type { DescribeServiceActionInput, DescribeServiceActionOutput } from "../models/models_0";
 ...
 * @public
 */
export class DescribeServiceActionCommand extends command<DescribeServiceActionCommandInput, DescribeServiceActionCommandOutput>(
  _ep0,
  _mw0,
