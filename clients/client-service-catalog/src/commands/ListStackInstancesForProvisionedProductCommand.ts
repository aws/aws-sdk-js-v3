 ...
 * @public
 */
export class ListStackInstancesForProvisionedProductCommand extends command<ListStackInstancesForProvisionedProductCommandInput, ListStackInstancesForProvisionedProductCommandOutput>(
  _ep0,
  _mw0,
