...
import type { CreatePortfolioInput, CreatePortfolioOutput } from "../models/models_0";
 ...
 * @public
 */
export class CreatePortfolioCommand extends command<CreatePortfolioCommandInput, CreatePortfolioCommandOutput>(
  _ep0,
  _mw0,
  "CreatePortfolio",
  CreatePortfolio$
