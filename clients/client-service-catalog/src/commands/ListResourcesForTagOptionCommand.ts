...
import type { ListResourcesForTagOptionInput, ListResourcesForTagOptionOutput } from "../models/models_0";
 ...
 * @public
 */
export class ListResourcesForTagOptionCommand extends command<ListResourcesForTagOptionCommandInput, ListResourcesForTagOptionCommandOutput>(
  _ep0,
  _mw0,
