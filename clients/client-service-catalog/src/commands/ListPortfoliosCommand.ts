...
import type { ListPortfoliosInput, ListPortfoliosOutput } from "../models/models_0";
 ...
 * @public
 */
export class ListPortfoliosCommand extends command<ListPortfoliosCommandInput, ListPortfoliosCommandOutput>(
  _ep0,
  _mw0,
  "ListPortfolios",
  ListPortfolios$
