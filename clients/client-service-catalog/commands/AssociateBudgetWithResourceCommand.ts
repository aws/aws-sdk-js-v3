...
export type AssociateBudgetWithResourceCommandOutput = AssociateBudgetWithResourceOutput &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1AssociateBudgetWithResourceCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1AssociateBudgetWithResourceCommand(
      output,
      context
    );
  }
