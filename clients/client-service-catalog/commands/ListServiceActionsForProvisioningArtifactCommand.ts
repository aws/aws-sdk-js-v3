...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1ListServiceActionsForProvisioningArtifactCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1ListServiceActionsForProvisioningArtifactCommand(
      output,
      context
    );
  }
