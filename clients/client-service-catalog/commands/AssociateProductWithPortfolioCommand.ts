...
export type AssociateProductWithPortfolioCommandOutput = AssociateProductWithPortfolioOutput &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1AssociateProductWithPortfolioCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1AssociateProductWithPortfolioCommand(
      output,
      context
    );
  }
