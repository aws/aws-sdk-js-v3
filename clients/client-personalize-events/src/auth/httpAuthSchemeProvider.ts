...
import { type PersonalizeEventsClientResolvedConfig, PersonalizeEventsClientConfig } from "../PersonalizeEventsClient";
 ...
 * @internal
 */
export const defaultPersonalizeEventsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: PersonalizeEventsHttpAuthSchemeParameters): HttpAuthOption {
  return {
