...
import type { CreateTrailRequest, CreateTrailResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateTrailCommand extends command<CreateTrailCommandInput, CreateTrailCommandOutput>(
  _ep0,
  _mw0,
  "CreateTrail",
  CreateTrail$
