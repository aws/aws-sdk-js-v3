...
import { type CloudTrailClientResolvedConfig, CloudTrailClientConfig } from "../CloudTrailClient";
 ...
 * @internal
 */
export const defaultCloudTrailHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CloudTrailHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<CloudTrailClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultCloudTrailHttpAuthSchemeProvider: CloudTrailHttpAuthSchemeProvider = (authParameters) => {
