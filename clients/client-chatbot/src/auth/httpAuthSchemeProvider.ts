...
import { type ChatbotClientResolvedConfig, ChatbotClientConfig } from "../ChatbotClient";
 ...
 * @internal
 */
export const defaultChatbotHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ChatbotHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultChatbotHttpAuthSchemeProvider: ChatbotHttpAuthSchemeProvider = (authParameters) => {
