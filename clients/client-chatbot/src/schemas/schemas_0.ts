...
export var ChatbotServiceException$: StaticErrorSchema = [-3, _s, "ChatbotServiceException", 0, [], []];
...
export var CreateChimeWebhookConfigurationException$: StaticErrorSchema = [-3, n0, _CCWCE,
  { [_e]: _se, [_hE]: 500 },
  [_M],
  [0]
];
...
export var CreateTeamsChannelConfigurationException$: StaticErrorSchema = [-3, n0, _CTCCE,
  { [_e]: _se, [_hE]: 500 },
  [_M],
  [0]
];
...
export var ListMicrosoftTeamsUserIdentitiesException$: StaticErrorSchema = [-3, n0, _LMTUIE,
  { [_e]: _se, [_hE]: 500 },
  [_M],
  [0]
];
n0_registry.registerError(ListMicrosoftTeamsUserIdentitiesException$, ListMicrosoftTeamsUserIdentitiesException);
export var ListTeamsChannelConfigurationsException$: StaticErrorSchema = [-3, n0, _LTCCE,
  { [_e]: _se, [_hE]: 500 },
  [_M],
  [0]
];
...
export var UpdateAccountPreferencesException$: StaticErrorSchema = [-3, n0, _UAPE,
  { [_e]: _se, [_hE]: 500 },
  [_M],
  [0]
];
n0_registry.registerError(UpdateAccountPreferencesException$, UpdateAccountPreferencesException);
export var UpdateChimeWebhookConfigurationException$: StaticErrorSchema = [-3, n0, _UCWCE,
  { [_e]: _se, [_hE]: 500 },
  [_M],
  [0]
];
...
export var UpdateTeamsChannelConfigurationException$: StaticErrorSchema = [-3, n0, _UTCCE,
  { [_e]: _se, [_hE]: 500 },
  [_M],
  [0]
];
...
var ChimeWebhookDescription: StaticSimpleSchema = [0, n0, _CWD, 8, 0];
var ChimeWebhookUrl: StaticSimpleSchema = [0, n0, _CWU, 8, 0];
var SlackChannelDisplayName: StaticSimpleSchema = [0, n0, _SCDN, 8, 0];
var TeamName: StaticSimpleSchema = [0, n0, _TN, 8, 0];
var TeamsChannelName: StaticSimpleSchema = [0, n0, _TCN, 8, 0];
export var AccountPreferences$: StaticStructureSchema = [3, n0, _AP,
  0,
  [_UAR, _TDCE],
  [2, 2]
];
...
export var DescribeChimeWebhookConfigurationsRequest$: StaticStructureSchema = [3, n0, _DCWCRes,
  0,
  [_MR, _NTe, _CCA],
  [1, 0, 0]
];
export var DescribeChimeWebhookConfigurationsResult$: StaticStructureSchema = [3, n0, _DCWCResc,
  0,
  [_NTe, _WCe],
  [0, [() => ChimeWebhookConfigurationList, 0]]
];
export var DescribeSlackChannelConfigurationsRequest$: StaticStructureSchema = [3, n0, _DSCCRes,
  0,
  [_MR, _NTe, _CCA],
  [1, 0, 0]
];
export var DescribeSlackChannelConfigurationsResult$: StaticStructureSchema = [3, n0, _DSCCResc,
  0,
  [_NTe, _SCC],
  [0, [() => SlackChannelConfigurationList, 0]]
];
export var DescribeSlackUserIdentitiesRequest$: StaticStructureSchema = [3, n0, _DSUIRes,
  0,
  [_CCA, _NTe, _MR],
  [0, 0, 1]
];
export var DescribeSlackUserIdentitiesResult$: StaticStructureSchema = [3, n0, _DSUIResc,
  0,
  [_SUIl, _NTe],
  [() => SlackUserIdentitiesList, 0]
];
export var DescribeSlackWorkspacesRequest$: StaticStructureSchema = [3, n0, _DSWR,
  0,
  [_MR, _NTe],
  [1, 0]
];
export var DescribeSlackWorkspacesResult$: StaticStructureSchema = [3, n0, _DSWRe,
  0,
  [_SW, _NTe],
...
export var GetAccountPreferencesRequest$: StaticStructureSchema = [3, n0, _GAPR,
  0,
  [],
  []
];
export var GetAccountPreferencesResult$: StaticStructureSchema = [3, n0, _GAPRe,
  0,
  [_AP],
  [() => AccountPreferences$]
];
...
export var ListMicrosoftTeamsConfiguredTeamsRequest$: StaticStructureSchema = [3, n0, _LMTCTR,
  0,
  [_MR, _NTe],
  [1, 0]
];
export var ListMicrosoftTeamsConfiguredTeamsResult$: StaticStructureSchema = [3, n0, _LMTCTRi,
  0,
  [_CTon, _NTe],
  [() => ConfiguredTeamsList, 0]
];
export var ListMicrosoftTeamsUserIdentitiesRequest$: StaticStructureSchema = [3, n0, _LMTUIR,
  0,
  [_CCA, _NTe, _MR],
  [0, 0, 1]
];
export var ListMicrosoftTeamsUserIdentitiesResult$: StaticStructureSchema = [3, n0, _LMTUIRi,
  0,
  [_TUI, _NTe],
...
export var ListTeamsChannelConfigurationsRequest$: StaticStructureSchema = [3, n0, _LTCCR,
  0,
  [_MR, _NTe, _TIe],
  [1, 0, 0]
];
export var ListTeamsChannelConfigurationsResult$: StaticStructureSchema = [3, n0, _LTCCRi,
  0,
  [_NTe, _TCC],
...
export var UpdateAccountPreferencesRequest$: StaticStructureSchema = [3, n0, _UAPR,
  0,
  [_UAR, _TDCE],
  [2, 2]
];
export var UpdateAccountPreferencesResult$: StaticStructureSchema = [3, n0, _UAPRp,
  0,
  [_AP],
  [() => AccountPreferences$]
];
...
var ChimeWebhookConfigurationList: StaticListSchema = [1, n0, _CWCL,
  0, [() => ChimeWebhookConfiguration$,
    0]
];
var ConfiguredTeamsList: StaticListSchema = [1, n0, _CTL,
  0, () => ConfiguredTeam$
];
var CustomActionArnList = 64 | 0;
var CustomActionAttachmentCriteriaList: StaticListSchema = [1, n0, _CAACL,
  0, () => CustomActionAttachmentCriteria$
];
var CustomActionAttachmentList: StaticListSchema = [1, n0, _CAAL,
...
var SlackUserIdentitiesList: StaticListSchema = [1, n0, _SUIL,
  0, () => SlackUserIdentity$
];
var SlackWorkspacesList: StaticListSchema = [1, n0, _SWL,
  0, () => SlackWorkspace$
];
...
var TeamChannelConfigurationsList: StaticListSchema = [1, n0, _TCCL,
  0, [() => TeamsChannelConfiguration$,
    0]
];
var TeamsUserIdentitiesList: StaticListSchema = [1, n0, _TUIL,
  0, () => TeamsUserIdentity$
];
var CustomActionAttachmentVariables = 128 | 0;
export var AssociateToConfiguration$: StaticOperationSchema = [9, n0, _ATC,
  { [_h]: ["POST", "/associate-to-configuration", 201] }, () => AssociateToConfigurationRequest$, () => AssociateToConfigurationResult$
];
export var CreateChimeWebhookConfiguration$: StaticOperationSchema = [9, n0, _CCWC,
...
export var CreateCustomAction$: StaticOperationSchema = [9, n0, _CCAr,
  { [_h]: ["POST", "/create-custom-action", 201] }, () => CreateCustomActionRequest$, () => CreateCustomActionResult$
];
export var CreateMicrosoftTeamsChannelConfiguration$: StaticOperationSchema = [9, n0, _CMTCC,
...
export var DeleteChimeWebhookConfiguration$: StaticOperationSchema = [9, n0, _DCWC,
...
export var DeleteCustomAction$: StaticOperationSchema = [9, n0, _DCA,
  { [_h]: ["POST", "/delete-custom-action", 204] }, () => DeleteCustomActionRequest$, () => DeleteCustomActionResult$
];
export var DeleteMicrosoftTeamsChannelConfiguration$: StaticOperationSchema = [9, n0, _DMTCC,
...
export var DeleteMicrosoftTeamsConfiguredTeam$: StaticOperationSchema = [9, n0, _DMTCT,
  { [_h]: ["POST", "/delete-ms-teams-configured-teams", 204] }, () => DeleteTeamsConfiguredTeamRequest$, () => DeleteTeamsConfiguredTeamResult$
];
export var DeleteMicrosoftTeamsUserIdentity$: StaticOperationSchema = [9, n0, _DMTUI,
...
export var DeleteSlackUserIdentity$: StaticOperationSchema = [9, n0, _DSUI,
  { [_h]: ["POST", "/delete-slack-user-identity", 204] }, () => DeleteSlackUserIdentityRequest$, () => DeleteSlackUserIdentityResult$
];
export var DeleteSlackWorkspaceAuthorization$: StaticOperationSchema = [9, n0, _DSWA,
...
export var DescribeChimeWebhookConfigurations$: StaticOperationSchema = [9, n0, _DCWCe,
...
export var DescribeSlackChannelConfigurations$: StaticOperationSchema = [9, n0, _DSCCe,
...
export var ListCustomActions$: StaticOperationSchema = [9, n0, _LCA,
  { [_h]: ["POST", "/list-custom-actions", 200] }, () => ListCustomActionsRequest$, () => ListCustomActionsResult$
];
export var ListMicrosoftTeamsChannelConfigurations$: StaticOperationSchema = [9, n0, _LMTCC,
...
export var ListMicrosoftTeamsConfiguredTeams$: StaticOperationSchema = [9, n0, _LMTCT,
...
export var ListMicrosoftTeamsUserIdentities$: StaticOperationSchema = [9, n0, _LMTUI,
...
export var UpdateAccountPreferences$: StaticOperationSchema = [9, n0, _UAP,
  { [_h]: ["POST", "/update-account-preferences", 200] }, () => UpdateAccountPreferencesRequest$, () => UpdateAccountPreferencesResult$
];
export var UpdateChimeWebhookConfiguration$: StaticOperationSchema = [9, n0, _UCWC,
...
export var UpdateCustomAction$: StaticOperationSchema = [9, n0, _UCA,
  { [_h]: ["POST", "/update-custom-action", 200] }, () => UpdateCustomActionRequest$, () => UpdateCustomActionResult$
];
export var UpdateMicrosoftTeamsChannelConfiguration$: StaticOperationSchema = [9, n0, _UMTCC,
