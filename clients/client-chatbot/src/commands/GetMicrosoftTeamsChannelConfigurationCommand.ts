 ...
 * @public
 */
export class GetMicrosoftTeamsChannelConfigurationCommand extends command<GetMicrosoftTeamsChannelConfigurationCommandInput, GetMicrosoftTeamsChannelConfigurationCommandOutput>(
  _ep0,
  _mw0,
