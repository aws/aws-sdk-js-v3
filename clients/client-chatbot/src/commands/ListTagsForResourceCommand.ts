 ...
 * ```javascript
 * import { ChatbotClient, ListTagsForResourceCommand } from "@aws-sdk/client-chatbot"; // ES Modules import
 * // const { ChatbotClient, ListTagsForResourceCommand } = require("@aws-sdk/client-chatbot"); // CommonJS import
