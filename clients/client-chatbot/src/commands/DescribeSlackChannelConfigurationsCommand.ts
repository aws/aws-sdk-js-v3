 ...
 * @public
 */
export class DescribeSlackChannelConfigurationsCommand extends command<DescribeSlackChannelConfigurationsCommandInput, DescribeSlackChannelConfigurationsCommandOutput>(
  _ep0,
  _mw0,
