 ...
 * @public
 */
export class ListMicrosoftTeamsChannelConfigurationsCommand extends command<ListMicrosoftTeamsChannelConfigurationsCommandInput, ListMicrosoftTeamsChannelConfigurationsCommandOutput>(
  _ep0,
  _mw0,
