 ...
 * @public
 */
export class ListMicrosoftTeamsUserIdentitiesCommand extends command<ListMicrosoftTeamsUserIdentitiesCommandInput, ListMicrosoftTeamsUserIdentitiesCommandOutput>(
  _ep0,
  _mw0,
