 ...
 * @public
 */
export class DeleteMicrosoftTeamsUserIdentityCommand extends command<DeleteMicrosoftTeamsUserIdentityCommandInput, DeleteMicrosoftTeamsUserIdentityCommandOutput>(
  _ep0,
  _mw0,
