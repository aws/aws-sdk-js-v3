 ...
 * @public
 */
export class DeleteSlackChannelConfigurationCommand extends command<DeleteSlackChannelConfigurationCommandInput, DeleteSlackChannelConfigurationCommandOutput>(
  _ep0,
  _mw0,
