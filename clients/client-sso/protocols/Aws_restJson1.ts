...
export const deserializeAws_restJson1GetRoleCredentialsCommand = async (
  ...
  if (output.statusCode !== 200 && output.statusCode >= 400) {
    return deserializeAws_restJson1GetRoleCredentialsCommandError(
      output,
      context
    );
  }
  ...
  if (data.roleCredentials !== undefined && data.roleCredentials !== null) {
    contents.roleCredentials = deserializeAws_restJson1RoleCredentials(
...
export const deserializeAws_restJson1ListAccountRolesCommand = async (
  ...
  if (output.statusCode !== 200 && output.statusCode >= 400) {
    return deserializeAws_restJson1ListAccountRolesCommandError(
      output,
      context
    );
  }
  ...
  if (data.roleList !== undefined && data.roleList !== null) {
    contents.roleList = deserializeAws_restJson1RoleListType(
      data.roleList,
      context
    );
  }
...
export const deserializeAws_restJson1ListAccountsCommand = async (
  ...
  if (data.accountList !== undefined && data.accountList !== null) {
    contents.accountList = deserializeAws_restJson1AccountListType(
      data.accountList,
      context
    );
  }
...
const deserializeAws_restJson1AccountInfo = (
  output: any,
  context: __SerdeContext
): AccountInfo => {
  return {
...
const deserializeAws_restJson1AccountListType = (
  output: any,
  context: __SerdeContext
): AccountInfo[] => {
  return (output || []).map((entry: any) =>
    deserializeAws_restJson1AccountInfo(entry, context)
  );
};

const deserializeAws_restJson1RoleCredentials = (
  output: any,
  context: __SerdeContext
): RoleCredentials => {
  return {
...
const deserializeAws_restJson1RoleListType = (
  output: any,
  context: __SerdeContext
): RoleInfo[] => {
  return (output || []).map((entry: any) =>
    deserializeAws_restJson1RoleInfo(entry, context)
  );
};
