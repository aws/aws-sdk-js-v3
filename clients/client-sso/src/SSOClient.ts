...
import type { ListAccountRolesCommandInput, ListAccountRolesCommandOutput } from "./commands/ListAccountRolesCommand";
import type { ListAccountsCommandInput, ListAccountsCommandOutput } from "./commands/ListAccountsCommand";
import type { LogoutCommandInput, LogoutCommandOutput } from "./commands/LogoutCommand";
import {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<SSOClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: SSOClientResolvedConfig) =>
