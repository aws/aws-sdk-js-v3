...
export var RoleInfo$: StaticStructureSchema = [3, n0, _RI,
  0,
  [_rN, _aI],
  [0, 0]
];
...
export var ListAccountRoles$: StaticOperationSchema = [9, n0, _LARis,
...
export var Logout$: StaticOperationSchema = [9, n0, _L,
