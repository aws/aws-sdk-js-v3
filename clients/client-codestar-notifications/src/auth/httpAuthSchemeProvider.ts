...
import {
  ...
  CodestarNotificationsClientConfig,
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CodestarNotificationsHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultCodestarNotificationsHttpAuthSchemeProvider: CodestarNotificationsHttpAuthSchemeProvider = (authParameters) => {
