...
import {
  deserializeAws_restJson1_1DeleteTargetCommand,
  serializeAws_restJson1_1DeleteTargetCommand
...
export type DeleteTargetCommandOutput = DeleteTargetResult;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteTargetCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DeleteTargetCommand(output, context);
  }
