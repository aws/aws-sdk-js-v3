...
import {
  type ConnectContactLensClientResolvedConfig,
  ConnectContactLensClientConfig,
 ...
 * @internal
 */
export const defaultConnectContactLensHttpAuthSchemeProvider: ConnectContactLensHttpAuthSchemeProvider = (authParameters) => {
