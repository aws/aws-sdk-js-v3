...
const asPartial = <T extends Partial<MarketplaceAgreementExtensionConfiguration>>(t: T) => t;

/**
 * @internal
 */
export const resolveRuntimeExtensions = (runtimeConfig: any, extensions: RuntimeExtension[]) => {
  const extensionConfiguration: MarketplaceAgreementExtensionConfiguration = {
