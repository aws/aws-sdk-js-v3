...
import {
  type MarketplaceAgreementClientResolvedConfig,
  MarketplaceAgreementClientConfig,
 ...
 * @internal
 */
export const defaultMarketplaceAgreementHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: MarketplaceAgreementHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<MarketplaceAgreementClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultMarketplaceAgreementHttpAuthSchemeProvider: MarketplaceAgreementHttpAuthSchemeProvider = (authParameters) => {
