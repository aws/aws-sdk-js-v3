 ...
 * ```javascript
 * import { ArtifactClient, ListTagsForResourceCommand } from "@aws-sdk/client-artifact"; // ES Modules import
 * // const { ArtifactClient, ListTagsForResourceCommand } = require("@aws-sdk/client-artifact"); // CommonJS import
