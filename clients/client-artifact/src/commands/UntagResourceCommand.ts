 ...
 * ```javascript
 * import { ArtifactClient, UntagResourceCommand } from "@aws-sdk/client-artifact"; // ES Modules import
 * // const { ArtifactClient, UntagResourceCommand } = require("@aws-sdk/client-artifact"); // CommonJS import
