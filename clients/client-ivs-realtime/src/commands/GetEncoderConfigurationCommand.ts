...
> {
   ...
   * @public
   */
  constructor(readonly input: GetEncoderConfigurationCommandInput) {
    super();
  }
  ...
  ): Handler<GetEncoderConfigurationCommandInput, GetEncoderConfigurationCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, GetEncoderConfigurationCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: GetEncoderConfigurationCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetEncoderConfigurationCommandOutput> {
