...
export var StartDiscoveryOutput$: StaticStructureSchema = [3, n0, _SDO,
  0,
  [],
  []
];
...
var AttributeMaps: StaticListSchema = [1, n0, _AM,
  0, 128 | 0
];
var AuditFindings: StaticListSchema = [1, n0, _AFud,
  0, () => AuditFinding$
];
var AuditorResults: StaticListSchema = [1, n0, _AR,
  0, () => AuditorResult$
];
var Auditors = 64 | 0;
...
var BurnRateConfigurations: StaticListSchema = [1, n0, _BRCu,
...
var ExclusionWindows: StaticListSchema = [1, n0, _EWx,
  0, () => ExclusionWindow$
];
var GroupingAttributeDefinitions: StaticListSchema = [1, n0, _GADr,
...
var LogGroupReferences: StaticListSchema = [1, n0, _LGR,
  0, 128 | 0
];
var MetricDataQueries: StaticListSchema = [1, n0, _MDQe,
  0, () => MetricDataQuery$
];
var MetricReferences: StaticListSchema = [1, n0, _MRet,
  0, () => MetricReference$
];
...
var ServiceLevelObjectiveBudgetReportErrors: StaticListSchema = [1, n0, _SLOBREe,
  0, () => ServiceLevelObjectiveBudgetReportError$
];
var ServiceLevelObjectiveBudgetReports: StaticListSchema = [1, n0, _SLOBRe,
  0, () => ServiceLevelObjectiveBudgetReport$
];
var ServiceLevelObjectiveIds = 64 | 0;
var ServiceLevelObjectiveSummaries: StaticListSchema = [1, n0, _SLOSe,
  0, () => ServiceLevelObjectiveSummary$
];
var ServiceOperations: StaticListSchema = [1, n0, _SO,
  0, () => ServiceOperation$
];
var ServiceStates: StaticListSchema = [1, n0, _SSer,
  0, () => ServiceState$
];
...
export var GetServiceLevelObjective$: StaticOperationSchema = [9, n0, _GSLO,
...
export var ListEntityEvents$: StaticOperationSchema = [9, n0, _LEE,
...
export var ListServiceDependents$: StaticOperationSchema = [9, n0, _LSDi,
  { [_h]: ["POST", "/service-dependents", 200] }, () => ListServiceDependentsInput$, () => ListServiceDependentsOutput$
];
export var ListServiceLevelObjectiveExclusionWindows$: StaticOperationSchema = [9, n0, _LSLOEW,
...
export var ListServiceLevelObjectives$: StaticOperationSchema = [9, n0, _LSLO,
  { [_h]: ["POST", "/slos", 200] }, () => ListServiceLevelObjectivesInput$, () => ListServiceLevelObjectivesOutput$
];
export var ListServiceOperations$: StaticOperationSchema = [9, n0, _LSOi,
...
export var ListServiceStates$: StaticOperationSchema = [9, n0, _LSS,
...
export var UpdateServiceLevelObjective$: StaticOperationSchema = [9, n0, _USLO,
