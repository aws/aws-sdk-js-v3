...
import { ApplicationSignalsClientConfig, ApplicationSignalsClientResolvedConfig } from "../ApplicationSignalsClient";
 ...
 * @internal
 */
export const defaultApplicationSignalsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ApplicationSignalsHttpAuthSchemeParameters): HttpAuthOption {
  return {
