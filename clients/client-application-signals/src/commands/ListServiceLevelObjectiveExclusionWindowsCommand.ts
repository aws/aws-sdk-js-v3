 ...
 * @public
 */
export class ListServiceLevelObjectiveExclusionWindowsCommand extends command<ListServiceLevelObjectiveExclusionWindowsCommandInput, ListServiceLevelObjectiveExclusionWindowsCommandOutput>(
  _ep0,
  _mw0,
