 ...
 * @public
 */
export class BatchDeleteInstrumentationConfigurationsCommand extends command<BatchDeleteInstrumentationConfigurationsCommandInput, BatchDeleteInstrumentationConfigurationsCommandOutput>(
  _ep0,
  _mw0,
