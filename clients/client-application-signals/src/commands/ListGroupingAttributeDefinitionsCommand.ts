 ...
 * @public
 */
export class ListGroupingAttributeDefinitionsCommand extends command<ListGroupingAttributeDefinitionsCommandInput, ListGroupingAttributeDefinitionsCommandOutput>(
  _ep0,
  _mw0,
