...
export var PutEventsRequest = struct(n0, _PER, 0, [_Ent, _EI], [() => PutEventsRequestEntryList, 0]);
...
export var PutEventsResponse = struct(n0, _PERu, 0, [_FEC, _Ent], [1, () => PutEventsResultEntryList]);
export var PutEventsResultEntry = struct(n0, _PEREu, 0, [_EIv, _ECr, _EM], [0, 0, 0]);
