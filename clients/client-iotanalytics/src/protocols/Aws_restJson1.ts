...
const serializeAws_restJson1ChannelMessages = (input: ChannelMessages, context: __SerdeContext): any => {
  return {
    ...(input.s3Paths != undefined && { s3Paths: serializeAws_restJson1S3PathChannelMessages(input.s3Paths, context) }),
  };
};
...
const serializeAws_restJson1DatastorePartitions = (input: DatastorePartitions, context: __SerdeContext): any => {
  return {
    ...(input.partitions != undefined && { partitions: serializeAws_restJson1Partitions(input.partitions, context) }),
  };
};
...
const serializeAws_restJson1SchemaDefinition = (input: SchemaDefinition, context: __SerdeContext): any => {
  return {
    ...(input.columns != undefined && { columns: serializeAws_restJson1Columns(input.columns, context) }),
  };
};
...
const deserializeAws_restJson1Channel = (output: any, context: __SerdeContext): Channel => {
  return {
    ...
    lastMessageArrivalTime:
      output.lastMessageArrivalTime != undefined
    ...
    storage: output.storage != undefined ? deserializeAws_restJson1ChannelStorage(output.storage, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1ChannelStatistics = (output: any, context: __SerdeContext): ChannelStatistics => {
  return {
    size: output.size != undefined ? deserializeAws_restJson1EstimatedResourceSize(output.size, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1ChannelSummary = (output: any, context: __SerdeContext): ChannelSummary => {
  return {
    channelName: __expectString(output.channelName),
    channelStorage:
      output.channelStorage != undefined
...
const deserializeAws_restJson1Dataset = (output: any, context: __SerdeContext): Dataset => {
  return {
    actions: output.actions != undefined ? deserializeAws_restJson1DatasetActions(output.actions, context) : undefined,
    arn: __expectString(output.arn),
    ...
    lastUpdateTime:
      output.lastUpdateTime != undefined
        ...
        : undefined,
    lateDataRules:
      output.lateDataRules != undefined
    ...
    status: __expectString(output.status),
    triggers:
      output.triggers != undefined ? deserializeAws_restJson1DatasetTriggers(output.triggers, context) : undefined,
    versioningConfiguration:
...
const deserializeAws_restJson1DatasetContentSummary = (output: any, context: __SerdeContext): DatasetContentSummary => {
  return {
    completionTime:
      output.completionTime != undefined
    ...
    creationTime:
      output.creationTime != undefined
        ...
        : undefined,
    scheduleTime:
      output.scheduleTime != undefined
        ? __expectNonNull(__parseEpochTimestamp(__expectNumber(output.scheduleTime)))
        : undefined,
    status:
      output.status != undefined ? deserializeAws_restJson1DatasetContentStatus(output.status, context) : undefined,
...
const deserializeAws_restJson1DatasetSummary = (output: any, context: __SerdeContext): DatasetSummary => {
  return {
    actions:
      output.actions != undefined ? deserializeAws_restJson1DatasetActionSummaries(output.actions, context) : undefined,
    creationTime:
      output.creationTime != undefined
        ? __expectNonNull(__parseEpochTimestamp(__expectNumber(output.creationTime)))
        : undefined,
...
const deserializeAws_restJson1DatasetTrigger = (output: any, context: __SerdeContext): DatasetTrigger => {
  return {
    dataset:
      output.dataset != undefined ? deserializeAws_restJson1TriggeringDataset(output.dataset, context) : undefined,
    schedule: output.schedule != undefined ? deserializeAws_restJson1Schedule(output.schedule, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1DatastoreIotSiteWiseMultiLayerStorage = (
  ...
  return {
    customerManagedS3Storage:
      output.customerManagedS3Storage != undefined
...
const deserializeAws_restJson1DatastorePartition = (output: any, context: __SerdeContext): DatastorePartition => {
  return {
    attributePartition:
      output.attributePartition != undefined
        ? deserializeAws_restJson1Partition(output.attributePartition, context)
        : undefined,
    timestampPartition:
      output.timestampPartition != undefined
...
const deserializeAws_restJson1DatastorePartitions = (output: any, context: __SerdeContext): DatastorePartitions => {
  return {
    partitions:
      output.partitions != undefined ? deserializeAws_restJson1Partitions(output.partitions, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1DatastoreStorageSummary = (
  ...
  return {
    ...
    iotSiteWiseMultiLayerStorage:
      output.iotSiteWiseMultiLayerStorage != undefined
...
const deserializeAws_restJson1LateDataRule = (output: any, context: __SerdeContext): LateDataRule => {
  return {
    ruleConfiguration:
      output.ruleConfiguration != undefined
...
const deserializeAws_restJson1LateDataRuleConfiguration = (
  ...
  return {
    deltaTimeSessionWindowConfiguration:
      output.deltaTimeSessionWindowConfiguration != undefined
...
const deserializeAws_restJson1PipelineActivity = (output: any, context: __SerdeContext): PipelineActivity => {
  return {
    addAttributes:
      output.addAttributes != undefined
        ? deserializeAws_restJson1AddAttributesActivity(output.addAttributes, context)
        : undefined,
    channel: output.channel != undefined ? deserializeAws_restJson1ChannelActivity(output.channel, context) : undefined,
    datastore:
      output.datastore != undefined ? deserializeAws_restJson1DatastoreActivity(output.datastore, context) : undefined,
    ...
    deviceShadowEnrich:
      output.deviceShadowEnrich != undefined
        ...
        : undefined,
    filter: output.filter != undefined ? deserializeAws_restJson1FilterActivity(output.filter, context) : undefined,
    lambda: output.lambda != undefined ? deserializeAws_restJson1LambdaActivity(output.lambda, context) : undefined,
    math: output.math != undefined ? deserializeAws_restJson1MathActivity(output.math, context) : undefined,
    removeAttributes:
...
const deserializeAws_restJson1QueryFilter = (output: any, context: __SerdeContext): QueryFilter => {
  return {
    deltaTime: output.deltaTime != undefined ? deserializeAws_restJson1DeltaTime(output.deltaTime, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1RemoveAttributesActivity = (
  ...
  return {
    attributes:
      output.attributes != undefined ? deserializeAws_restJson1AttributeNames(output.attributes, context) : undefined,
    name: __expectString(output.name),
    next: __expectString(output.next),
  } as any;
};
...
const deserializeAws_restJson1SchemaDefinition = (output: any, context: __SerdeContext): SchemaDefinition => {
  return {
    columns: output.columns != undefined ? deserializeAws_restJson1Columns(output.columns, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1SqlQueryDatasetAction = (output: any, context: __SerdeContext): SqlQueryDatasetAction => {
  return {
    filters: output.filters != undefined ? deserializeAws_restJson1QueryFilters(output.filters, context) : undefined,
