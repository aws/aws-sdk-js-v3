...
export var ChannelStatistics$: StaticStructureSchema = [3, n0, _CS,
  0,
  [_si],
  [() => EstimatedResourceSize$]
];
export var ChannelStorage$: StaticStructureSchema = [3, n0, _CSh,
  0,
  [_sMS, _cMS],
  [() => ServiceManagedChannelS3Storage$, () => CustomerManagedChannelS3Storage$]
];
export var ChannelStorageSummary$: StaticStructureSchema = [3, n0, _CSS,
  0,
  [_sMS, _cMS],
  [() => ServiceManagedChannelS3StorageSummary$, () => CustomerManagedChannelS3StorageSummary$]
];
export var ChannelSummary$: StaticStructureSchema = [3, n0, _CSha,
  0,
...
export var Dataset$: StaticStructureSchema = [3, n0, _D,
  ...
  [0, 0, () => DatasetActions, () => DatasetTriggers, () => DatasetContentDeliveryRules, 0, 4, 4, () => RetentionPeriod$, () => VersioningConfiguration$, () => LateDataRules]
];
export var DatasetAction$: StaticStructureSchema = [3, n0, _DA,
  0,
  [_aN, _qA, _cAo],
  [0, () => SqlQueryDatasetAction$, () => ContainerDatasetAction$]
];
export var DatasetActionSummary$: StaticStructureSchema = [3, n0, _DAS,
  0,
  [_aN, _aT],
  [0, 0]
];
export var DatasetContentDeliveryDestination$: StaticStructureSchema = [3, n0, _DCDD,
  0,
  [_iEDC, _sDC],
...
export var DatasetContentSummary$: StaticStructureSchema = [3, n0, _DCSa,
  0,
...
export var DatasetTrigger$: StaticStructureSchema = [3, n0, _DT,
  0,
  [_sc, _da],
  [() => Schedule$, () => TriggeringDataset$]
];
export var Datastore$: StaticStructureSchema = [3, n0, _Da,
  0,
  [_n, _s, _ar, _st, _rP, _cT, _lUT, _lMAT, _fFC, _dP],
  [0, () => DatastoreStorage$, 0, 0, () => RetentionPeriod$, 4, 4, 4, () => FileFormatConfiguration$, () => DatastorePartitions$]
];
...
export var DatastorePartition$: StaticStructureSchema = [3, n0, _DP,
  0,
  [_aP, _tP],
  [() => Partition$, () => TimestampPartition$]
];
export var DatastorePartitions$: StaticStructureSchema = [3, n0, _DPa,
  0,
  [_p],
  [() => Partitions]
];
export var DatastoreStatistics$: StaticStructureSchema = [3, n0, _DSa,
  0,
  [_si],
  [() => EstimatedResourceSize$]
];
export var DatastoreStorageSummary$: StaticStructureSchema = [3, n0, _DSS,
  0,
  [_sMS, _cMS, _iSWMLS],
  [() => ServiceManagedDatastoreS3StorageSummary$, () => CustomerManagedDatastoreS3StorageSummary$, () => DatastoreIotSiteWiseMultiLayerStorageSummary$]
];
export var DatastoreSummary$: StaticStructureSchema = [3, n0, _DSat,
  0,
...
export var FileFormatConfiguration$: StaticStructureSchema = [3, n0, _FFC,
  0,
  [_jC, _pC],
...
export var JsonConfiguration$: StaticStructureSchema = [3, n0, _JC,
  0,
  [],
  []
];
...
export var ListDatasetsRequest$: StaticStructureSchema = [3, n0, _LDRi,
  0,
  [_nT, _mR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListDatasetsResponse$: StaticStructureSchema = [3, n0, _LDRis,
  0,
  [_dSa, _nT],
  [() => DatasetSummaries, 0]
];
export var ListDatastoresRequest$: StaticStructureSchema = [3, n0, _LDRist,
  0,
  [_nT, _mR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListDatastoresResponse$: StaticStructureSchema = [3, n0, _LDRista,
  0,
  [_dSat, _nT],
...
export var PipelineActivity$: StaticStructureSchema = [3, n0, _PA,
  0,
  [_c, _la, _dat, _aA, _rAem, _sA, _f, _ma, _dRE, _dSE],
  [() => ChannelActivity$, () => LambdaActivity$, () => DatastoreActivity$, () => AddAttributesActivity$, () => RemoveAttributesActivity$, () => SelectAttributesActivity$, () => FilterActivity$, () => MathActivity$, () => DeviceRegistryEnrichActivity$, () => DeviceShadowEnrichActivity$]
];
...
export var ServiceManagedChannelS3StorageSummary$: StaticStructureSchema = [3, n0, _SMCSSS,
  0,
  [],
  []
];
export var ServiceManagedDatastoreS3Storage$: StaticStructureSchema = [3, n0, _SMDSS,
  0,
  [],
  []
];
export var ServiceManagedDatastoreS3StorageSummary$: StaticStructureSchema = [3, n0, _SMDSSS,
  0,
  [],
  []
];
...
var ChannelSummaries: StaticListSchema = [1, n0, _CShan,
  0, () => ChannelSummary$
];
var Columns: StaticListSchema = [1, n0, _Col,
  0, () => Column$
];
var DatasetActions: StaticListSchema = [1, n0, _DAat,
  0, () => DatasetAction$
];
var DatasetActionSummaries: StaticListSchema = [1, n0, _DASa,
  0, () => DatasetActionSummary$
];
var DatasetContentDeliveryRules: StaticListSchema = [1, n0, _DCDRa,
  0, () => DatasetContentDeliveryRule$
];
var DatasetContentSummaries: StaticListSchema = [1, n0, _DCSat,
  0, () => DatasetContentSummary$
];
var DatasetEntries: StaticListSchema = [1, n0, _DEa,
  0, () => DatasetEntry$
];
var DatasetSummaries: StaticListSchema = [1, n0, _DSata,
  0, () => DatasetSummary$
];
var DatasetTriggers: StaticListSchema = [1, n0, _DTa,
  0, () => DatasetTrigger$
];
var DatastoreSummaries: StaticListSchema = [1, n0, _DSatas,
  0, () => DatastoreSummary$
];
var LateDataRules: StaticListSchema = [1, n0, _LDRa,
  0, () => LateDataRule$
];
...
var Partitions: StaticListSchema = [1, n0, _Pa,
  0, () => DatastorePartition$
];
var PipelineActivities: StaticListSchema = [1, n0, _PAi,
  0, () => PipelineActivity$
];
var PipelineSummaries: StaticListSchema = [1, n0, _PSi,
  0, () => PipelineSummary$
];
var QueryFilters: StaticListSchema = [1, n0, _QFu,
  0, () => QueryFilter$
];
var ReprocessingSummaries: StaticListSchema = [1, n0, _RSe,
  0, () => ReprocessingSummary$
];
...
export var DatastoreStorage$: StaticUnionSchema = [4, n0, _DSatast,
  0,
  [_sMS, _cMS, _iSWMLS],
  [() => ServiceManagedDatastoreS3Storage$, () => CustomerManagedDatastoreS3Storage$, () => DatastoreIotSiteWiseMultiLayerStorage$]
];
export var BatchPutMessage$: StaticOperationSchema = [9, n0, _BPM,
  { [_h]: ["POST", "/messages/batch", 200] }, () => BatchPutMessageRequest$, () => BatchPutMessageResponse$
];
export var CancelPipelineReprocessing$: StaticOperationSchema = [9, n0, _CPRa,
  { [_h]: ["DELETE", "/pipelines/{pipelineName}/reprocessing/{reprocessingId}", 200] }, () => CancelPipelineReprocessingRequest$, () => CancelPipelineReprocessingResponse$
];
export var CreateChannel$: StaticOperationSchema = [9, n0, _CC,
  { [_h]: ["POST", "/channels", 201] }, () => CreateChannelRequest$, () => CreateChannelResponse$
];
export var CreateDataset$: StaticOperationSchema = [9, n0, _CD,
  { [_h]: ["POST", "/datasets", 201] }, () => CreateDatasetRequest$, () => CreateDatasetResponse$
];
export var CreateDatasetContent$: StaticOperationSchema = [9, n0, _CDC,
  { [_h]: ["POST", "/datasets/{datasetName}/content", 200] }, () => CreateDatasetContentRequest$, () => CreateDatasetContentResponse$
];
export var CreateDatastore$: StaticOperationSchema = [9, n0, _CDr,
  { [_h]: ["POST", "/datastores", 201] }, () => CreateDatastoreRequest$, () => CreateDatastoreResponse$
];
export var CreatePipeline$: StaticOperationSchema = [9, n0, _CP,
  { [_h]: ["POST", "/pipelines", 201] }, () => CreatePipelineRequest$, () => CreatePipelineResponse$
];
export var DeleteChannel$: StaticOperationSchema = [9, n0, _DC,
  { [_h]: ["DELETE", "/channels/{channelName}", 204] }, () => DeleteChannelRequest$, () => __Unit
];
export var DeleteDataset$: StaticOperationSchema = [9, n0, _DD,
  { [_h]: ["DELETE", "/datasets/{datasetName}", 204] }, () => DeleteDatasetRequest$, () => __Unit
];
export var DeleteDatasetContent$: StaticOperationSchema = [9, n0, _DDC,
  { [_h]: ["DELETE", "/datasets/{datasetName}/content", 204] }, () => DeleteDatasetContentRequest$, () => __Unit
];
export var DeleteDatastore$: StaticOperationSchema = [9, n0, _DDe,
  { [_h]: ["DELETE", "/datastores/{datastoreName}", 204] }, () => DeleteDatastoreRequest$, () => __Unit
];
export var DeletePipeline$: StaticOperationSchema = [9, n0, _DPe,
  { [_h]: ["DELETE", "/pipelines/{pipelineName}", 204] }, () => DeletePipelineRequest$, () => __Unit
];
export var DescribeChannel$: StaticOperationSchema = [9, n0, _DCe,
  { [_h]: ["GET", "/channels/{channelName}", 200] }, () => DescribeChannelRequest$, () => DescribeChannelResponse$
];
export var DescribeDataset$: StaticOperationSchema = [9, n0, _DDes,
  { [_h]: ["GET", "/datasets/{datasetName}", 200] }, () => DescribeDatasetRequest$, () => DescribeDatasetResponse$
];
export var DescribeDatastore$: StaticOperationSchema = [9, n0, _DDesc,
  { [_h]: ["GET", "/datastores/{datastoreName}", 200] }, () => DescribeDatastoreRequest$, () => DescribeDatastoreResponse$
];
...
export var DescribePipeline$: StaticOperationSchema = [9, n0, _DPes,
  { [_h]: ["GET", "/pipelines/{pipelineName}", 200] }, () => DescribePipelineRequest$, () => DescribePipelineResponse$
];
export var GetDatasetContent$: StaticOperationSchema = [9, n0, _GDC,
  { [_h]: ["GET", "/datasets/{datasetName}/content", 200] }, () => GetDatasetContentRequest$, () => GetDatasetContentResponse$
];
export var ListChannels$: StaticOperationSchema = [9, n0, _LC,
  { [_h]: ["GET", "/channels", 200] }, () => ListChannelsRequest$, () => ListChannelsResponse$
];
export var ListDatasetContents$: StaticOperationSchema = [9, n0, _LDC,
  { [_h]: ["GET", "/datasets/{datasetName}/contents", 200] }, () => ListDatasetContentsRequest$, () => ListDatasetContentsResponse$
];
export var ListDatasets$: StaticOperationSchema = [9, n0, _LD,
  { [_h]: ["GET", "/datasets", 200] }, () => ListDatasetsRequest$, () => ListDatasetsResponse$
];
export var ListDatastores$: StaticOperationSchema = [9, n0, _LDi,
  { [_h]: ["GET", "/datastores", 200] }, () => ListDatastoresRequest$, () => ListDatastoresResponse$
];
export var ListPipelines$: StaticOperationSchema = [9, n0, _LP,
  { [_h]: ["GET", "/pipelines", 200] }, () => ListPipelinesRequest$, () => ListPipelinesResponse$
];
...
export var RunPipelineActivity$: StaticOperationSchema = [9, n0, _RPA,
  { [_h]: ["POST", "/pipelineactivities/run", 200] }, () => RunPipelineActivityRequest$, () => RunPipelineActivityResponse$
];
export var SampleChannelData$: StaticOperationSchema = [9, n0, _SCD,
  { [_h]: ["GET", "/channels/{channelName}/sample", 200] }, () => SampleChannelDataRequest$, () => SampleChannelDataResponse$
];
export var StartPipelineReprocessing$: StaticOperationSchema = [9, n0, _SPR,
  { [_h]: ["POST", "/pipelines/{pipelineName}/reprocessing", 200] }, () => StartPipelineReprocessingRequest$, () => StartPipelineReprocessingResponse$
];
...
export var UpdateChannel$: StaticOperationSchema = [9, n0, _UC,
  { [_h]: ["PUT", "/channels/{channelName}", 200] }, () => UpdateChannelRequest$, () => __Unit
];
export var UpdateDataset$: StaticOperationSchema = [9, n0, _UD,
  { [_h]: ["PUT", "/datasets/{datasetName}", 200] }, () => UpdateDatasetRequest$, () => __Unit
];
export var UpdateDatastore$: StaticOperationSchema = [9, n0, _UDp,
  { [_h]: ["PUT", "/datastores/{datastoreName}", 200] }, () => UpdateDatastoreRequest$, () => __Unit
];
export var UpdatePipeline$: StaticOperationSchema = [9, n0, _UP,
  { [_h]: ["PUT", "/pipelines/{pipelineName}", 200] }, () => UpdatePipelineRequest$, () => __Unit
];
