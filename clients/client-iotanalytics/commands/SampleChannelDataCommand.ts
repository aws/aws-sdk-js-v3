...
import { SampleChannelDataRequest, SampleChannelDataResponse } from "../models/index";
import {
  deserializeAws_restJson1_1SampleChannelDataCommand,
  serializeAws_restJson1_1SampleChannelDataCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1SampleChannelDataCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1SampleChannelDataCommand(output, context);
  }
