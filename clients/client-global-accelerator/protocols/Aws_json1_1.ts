  ...
  return {
    ...
    ClientIPPreservationEnabled:
      ...
      output.ClientIPPreservationEnabled !== null
        ...
        : undefined,
    EndpointId:
      output.EndpointId !== undefined && output.EndpointId !== null ? output.EndpointId : undefined,
    HealthReason:
  ...
  return {
    ...
    IpAddresses:
      output.IpAddresses !== undefined && output.IpAddresses !== null
        ...
        : undefined,
    IpFamily:
      output.IpFamily !== undefined && output.IpFamily !== null ? output.IpFamily : undefined
  } as any;
};
...
const deserializeAws_json1_1PortRange = (output: any, context: __SerdeContext): PortRange => {
  return {
    __type: "PortRange",
    FromPort:
      output.FromPort !== undefined && output.FromPort !== null ? output.FromPort : undefined,
