...
export type UpdateAcceleratorAttributesCommandOutput = UpdateAcceleratorAttributesResponse;

export class UpdateAcceleratorAttributesCommand extends $Command<UpdateAcceleratorAttributesCommandInput, UpdateAcceleratorAttributesCommandOutput, GlobalAcceleratorClientResolvedConfig> {
