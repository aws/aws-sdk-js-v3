...
import { type GlobalAcceleratorClientResolvedConfig, GlobalAcceleratorClientConfig } from "../GlobalAcceleratorClient";
 ...
 * @internal
 */
export const defaultGlobalAcceleratorHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: GlobalAcceleratorHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultGlobalAcceleratorHttpAuthSchemeProvider: GlobalAcceleratorHttpAuthSchemeProvider = (authParameters) => {
