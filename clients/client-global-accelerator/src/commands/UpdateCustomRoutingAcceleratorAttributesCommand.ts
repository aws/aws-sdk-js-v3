 ...
 * ```
 *
 * @param UpdateCustomRoutingAcceleratorAttributesRequest - {@link UpdateCustomRoutingAcceleratorAttributesRequest}
 * @returns {@link UpdateCustomRoutingAcceleratorAttributesResponse}
