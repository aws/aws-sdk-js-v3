 ...
 * @public
 */
export class DeleteCustomRoutingEndpointGroupCommand extends command<DeleteCustomRoutingEndpointGroupCommandInput, DeleteCustomRoutingEndpointGroupCommandOutput>(
  _ep0,
  _mw0,
