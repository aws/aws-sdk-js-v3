 ...
 * @public
 */
export class DescribeCustomRoutingAcceleratorCommand extends command<DescribeCustomRoutingAcceleratorCommandInput, DescribeCustomRoutingAcceleratorCommandOutput>(
  _ep0,
  _mw0,
