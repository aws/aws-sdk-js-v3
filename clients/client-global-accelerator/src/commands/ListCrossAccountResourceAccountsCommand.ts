...
> {
   ...
   * @public
   */
  constructor(readonly input: ListCrossAccountResourceAccountsCommandInput) {
    super();
  }
  ...
  ): Handler<ListCrossAccountResourceAccountsCommandInput, ListCrossAccountResourceAccountsCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListCrossAccountResourceAccountsCommand.getEndpointParameterInstructions())
    );
