 ...
 * @public
 */
export class CreateCustomRoutingAcceleratorCommand extends command<CreateCustomRoutingAcceleratorCommandInput, CreateCustomRoutingAcceleratorCommandOutput>(
  _ep0,
  _mw0,
