...
import {
  type SnowDeviceManagementClientResolvedConfig,
 ...
 * @internal
 */
export const defaultSnowDeviceManagementHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(
  ...
  return {
    ...
    propertiesExtractor: (config: Partial<SnowDeviceManagementClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
