...
export var ExecutionSummary$: StaticStructureSchema = [3, n0, _ES,
  0,
  [_tI, _eI, _mDI, _st],
  [0, 0, 0, 0]
];
...
export var InstanceState$: StaticStructureSchema = [3, n0, _IS,
  0,
  [_cod, _n],
  [1, 0]
];
export var InstanceSummary$: StaticStructureSchema = [3, n0, _ISn,
  0,
  [_in, _lUA],
  [() => Instance$, 4]
];
...
export var ListDevicesInput$: StaticStructureSchema = [3, n0, _LDI,
  0,
  [_jI, _mR, _nT],
  [[0, { [_hQ]: _jI }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListDevicesOutput$: StaticStructureSchema = [3, n0, _LDO,
  0,
  [_de, _nT],
  [() => DeviceSummaryList, 0]
];
...
export var ListTasksInput$: StaticStructureSchema = [3, n0, _LTI,
  0,
  [_st, _mR, _nT],
  [[0, { [_hQ]: _st }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListTasksOutput$: StaticStructureSchema = [3, n0, _LTO,
  0,
  [_tas, _nT],
  [() => TaskSummaryList, 0]
];
export var PhysicalNetworkInterface$: StaticStructureSchema = [3, n0, _PNI,
  0,
  [_pNII, _pCT, _iAA, _iA, _ne, _dG, _mA],
  [0, 0, 0, 0, 0, 0, 0]
];
export var Reboot$: StaticStructureSchema = [3, n0, _R,
  0,
  [],
  []
];
...
var DeviceSummaryList: StaticListSchema = [1, n0, _DSL,
  0, () => DeviceSummary$
];
var ExecutionSummaryList: StaticListSchema = [1, n0, _ESL,
  0, () => ExecutionSummary$
];
...
var PhysicalNetworkInterfaceList: StaticListSchema = [1, n0, _PNIL,
  0, () => PhysicalNetworkInterface$
];
var ResourceSummaryList: StaticListSchema = [1, n0, _RSL,
  0, () => ResourceSummary$
];
var SecurityGroupIdentifierList: StaticListSchema = [1, n0, _SGIL,
...
var TagMap = 128 | 0;
export var Command$: StaticUnionSchema = [4, n0, _Co,
  0,
  [_un, _re],
  [() => Unlock$, () => Reboot$]
];
export var CancelTask$: StaticOperationSchema = [9, n0, _CT,
