 ...
 * @public
 */
export class UpdateLaunchConfigurationTemplateCommand extends command<UpdateLaunchConfigurationTemplateCommandInput, UpdateLaunchConfigurationTemplateCommandOutput>(
  _ep0,
  _mw0,
