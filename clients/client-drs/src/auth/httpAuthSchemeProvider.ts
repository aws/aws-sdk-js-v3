...
import { type DrsClientResolvedConfig, DrsClientConfig } from "../DrsClient";
 ...
 * @internal
 */
export const defaultDrsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: DrsHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultDrsHttpAuthSchemeProvider: DrsHttpAuthSchemeProvider = (authParameters) => {
