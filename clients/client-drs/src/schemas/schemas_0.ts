...
export var DescribeRecoveryInstancesRequest$: StaticStructureSchema = [3, n0, _DRIRe,
  0,
  [_f, _mR, _nT],
  [() => DescribeRecoveryInstancesRequestFilters$, 1, 0]
];
export var DescribeRecoveryInstancesRequestFilters$: StaticStructureSchema = [3, n0, _DRIRF,
  0,
  [_rIIDe, _sSIDo],
  [64 | 0, 64 | 0]
];
export var DescribeRecoveryInstancesResponse$: StaticStructureSchema = [3, n0, _DRIRes,
  0,
  [_nT, _i],
...
export var DescribeRecoverySnapshotsResponse$: StaticStructureSchema = [3, n0, _DRSRe,
  0,
  [_i, _nT],
...
export var DescribeSourceNetworksRequest$: StaticStructureSchema = [3, n0, _DSNRes,
  0,
  [_f, _mR, _nT],
  [() => DescribeSourceNetworksRequestFilters$, 1, 0]
];
export var DescribeSourceNetworksRequestFilters$: StaticStructureSchema = [3, n0, _DSNRF,
  0,
  [_sNIDo, _oAID, _oR],
  [64 | 0, 0, 0]
];
export var DescribeSourceNetworksResponse$: StaticStructureSchema = [3, n0, _DSNResc,
  0,
  [_i, _nT],
...
export var ListStagingAccountsResponse$: StaticStructureSchema = [3, n0, _LSARi,
  0,
  [_acc, _nT],
  [() => Accounts, 0]
];
...
export var ParticipatingResource$: StaticStructureSchema = [3, n0, _PR,
  0,
  [_pRID, _lS],
...
export var RecoveryInstanceDataReplicationError$: StaticStructureSchema = [3, n0, _RIDRE,
  0,
  [_e, _rE],
  [0, 0]
];
export var RecoveryInstanceDataReplicationInfo$: StaticStructureSchema = [3, n0, _RIDRI,
  0,
  [_lDa, _eDT, _rD, _dRS, _dRI, _dRE, _sAZ, _sOA],
...
export var RecoveryInstanceDataReplicationInfoReplicatedDisk$: StaticStructureSchema = [3, n0, _RIDRIRD,
  0,
...
export var RecoveryLifeCycle$: StaticStructureSchema = [3, n0, _RLC,
  0,
  [_aCDT, _jID, _lRR],
  [5, 0, 0]
];
...
export var SourceNetwork$: StaticStructureSchema = [3, n0, _SN,
  0,
...
var Cpus: StaticListSchema = [1, n0, _C,
  0, () => CPU$
];
...
var DescribeRecoveryInstancesItems: StaticListSchema = [1, n0, _DRII,
  0, [() => RecoveryInstance$,
    0]
];
...
var LaunchActionRuns: StaticListSchema = [1, n0, _LARa,
  0, () => LaunchActionRun$
];
var LaunchActions: StaticListSchema = [1, n0, _LAa,
  0, () => LaunchAction$
];
...
var ParticipatingResources: StaticListSchema = [1, n0, _PRa,
  0, () => ParticipatingResource$
];
var ParticipatingServers: StaticListSchema = [1, n0, _PSa,
  0, () => ParticipatingServer$
];
var PITPolicy: StaticListSchema = [1, n0, _PITP,
  0, () => PITPolicyRule$
];
var ProductCodes: StaticListSchema = [1, n0, _PCr,
  0, () => ProductCode$
];
var RecoveryInstanceDataReplicationInfoReplicatedDisks: StaticListSchema = [1, n0, _RIDRIRDe,
  0, () => RecoveryInstanceDataReplicationInfoReplicatedDisk$
];
var RecoveryInstanceDataReplicationInitiationSteps: StaticListSchema = [1, n0, _RIDRISe,
  0, () => RecoveryInstanceDataReplicationInitiationStep$
];
var RecoveryInstanceDisks: StaticListSchema = [1, n0, _RIDe,
...
var SourceNetworksList: StaticListSchema = [1, n0, _SNL,
  0, [() => SourceNetwork$,
    0]
];
...
var StagingSourceServersList: StaticListSchema = [1, n0, _SSSL,
  0, [() => StagingSourceServer$,
    0]
];
var StartFailbackRequestRecoveryInstanceIDs = 64 | 0;
var StartRecoveryRequestSourceServers: StaticListSchema = [1, n0, _SRRSSt,
  0, () => StartRecoveryRequestSourceServer$
];
var StartSourceNetworkRecoveryRequestNetworkEntries: StaticListSchema = [1, n0, _SSNRRNEt,
...
var LaunchActionParameters: StaticMapSchema = [2, n0, _LAPa,
  0, 0, () => LaunchActionParameter$
];
var TagsMap: StaticMapSchema = [2, n0, _TM,
  8, 0, 0
];
var VolumeToConversionMap: StaticMapSchema = [2, n0, _VTCM,
  0, 0, 128 | 0
];
var VolumeToProductCodes: StaticMapSchema = [2, n0, _VTPC,
  0, 0, () => ProductCodes
];
var VolumeToSizeMap = 128 | 1;
export var EventResourceData$: StaticUnionSchema = [4, n0, _ERD,
  0,
  [_sND],
  [() => SourceNetworkData$]
];
export var ParticipatingResourceID$: StaticUnionSchema = [4, n0, _PRID,
  0,
  [_sNID],
  [0]
];
...
export var CreateSourceNetwork$: StaticOperationSchema = [9, n0, _CSNr,
...
export var DeleteLaunchAction$: StaticOperationSchema = [9, n0, _DLA,
...
export var DeleteSourceNetwork$: StaticOperationSchema = [9, n0, _DSN,
...
export var DescribeRecoveryInstances$: StaticOperationSchema = [9, n0, _DRIes,
  { [_ht]: ["POST", "/DescribeRecoveryInstances", 200] }, () => DescribeRecoveryInstancesRequest$, () => DescribeRecoveryInstancesResponse$
];
export var DescribeRecoverySnapshots$: StaticOperationSchema = [9, n0, _DRS,
...
export var DescribeSourceNetworks$: StaticOperationSchema = [9, n0, _DSNe,
...
export var DisconnectRecoveryInstance$: StaticOperationSchema = [9, n0, _DRIi,
  { [_ht]: ["POST", "/DisconnectRecoveryInstance", 200] }, () => DisconnectRecoveryInstanceRequest$, () => __Unit
];
export var DisconnectSourceServer$: StaticOperationSchema = [9, n0, _DSSi,
  { [_ht]: ["POST", "/DisconnectSourceServer", 200] }, () => DisconnectSourceServerRequest$, () => SourceServer$
];
export var ExportSourceNetworkCfnTemplate$: StaticOperationSchema = [9, n0, _ESNCT,
  { [_ht]: ["POST", "/ExportSourceNetworkCfnTemplate", 200] }, () => ExportSourceNetworkCfnTemplateRequest$, () => ExportSourceNetworkCfnTemplateResponse$
];
export var GetFailbackReplicationConfiguration$: StaticOperationSchema = [9, n0, _GFRC,
...
export var ListExtensibleSourceServers$: StaticOperationSchema = [9, n0, _LESS,
...
export var StartFailbackLaunch$: StaticOperationSchema = [9, n0, _SFL,
...
export var TerminateRecoveryInstances$: StaticOperationSchema = [9, n0, _TRI,
...
export var UpdateFailbackReplicationConfiguration$: StaticOperationSchema = [9, n0, _UFRC,
