 ...
 * @enum
 */
export const QualificationsAssociationStatus = {
...
export type QualificationsAssociationStatus =
  (typeof QualificationsAssociationStatus)[keyof typeof QualificationsAssociationStatus];

/**
 * @public
 * @enum
 */
export const QualificationsAssociationTaskStatus = {
  IN_PROGRESS: "IN_PROGRESS",
  SUCCEEDED: "SUCCEEDED",
} as const;
/**
...
export type QualificationsAssociationTaskStatus =
  (typeof QualificationsAssociationTaskStatus)[keyof typeof QualificationsAssociationTaskStatus];

/**
 * @public
 * @enum
 */
export const QualificationsDisassociationTaskStatus = {
  IN_PROGRESS: "IN_PROGRESS",
  SUCCEEDED: "SUCCEEDED",
} as const;
/**
...
export type QualificationsDisassociationTaskStatus =
  (typeof QualificationsDisassociationTaskStatus)[keyof typeof QualificationsDisassociationTaskStatus];
