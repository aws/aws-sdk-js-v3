 ...
 * @internal
 */
export interface PartnerCentralAccountHttpAuthSchemeParameters extends HttpAuthSchemeParameters {
  region?: string;
}
 ...
 * @internal
 */
export const defaultPartnerCentralAccountHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: PartnerCentralAccountHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<PartnerCentralAccountClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultPartnerCentralAccountHttpAuthSchemeProvider: PartnerCentralAccountHttpAuthSchemeProvider = (authParameters) => {
