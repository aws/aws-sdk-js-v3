 ...
 * @public
 */
export class DisassociateAwsTrainingCertificationEmailDomainCommand extends command<DisassociateAwsTrainingCertificationEmailDomainCommandInput, DisassociateAwsTrainingCertificationEmailDomainCommandOutput>(
  _ep0,
  _mw0,
