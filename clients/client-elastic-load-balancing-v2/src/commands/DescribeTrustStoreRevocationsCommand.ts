...
> {
   ...
   * @public
   */
  constructor(readonly input: DescribeTrustStoreRevocationsCommandInput) {
    super();
  }
  ...
  ): Handler<DescribeTrustStoreRevocationsCommandInput, DescribeTrustStoreRevocationsCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DescribeTrustStoreRevocationsCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: DescribeTrustStoreRevocationsCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
