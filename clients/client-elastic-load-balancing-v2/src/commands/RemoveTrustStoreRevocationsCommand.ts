...
> {
   ...
   * @public
   */
  constructor(readonly input: RemoveTrustStoreRevocationsCommandInput) {
    super();
  }
  ...
  ): Handler<RemoveTrustStoreRevocationsCommandInput, RemoveTrustStoreRevocationsCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, RemoveTrustStoreRevocationsCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: RemoveTrustStoreRevocationsCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_RemoveTrustStoreRevocationsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_RemoveTrustStoreRevocationsCommand(output, context);
  }
}
