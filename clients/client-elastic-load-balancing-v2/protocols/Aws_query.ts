...
const serializeAws_queryActions = (
  ...
  (input || []).map(entry => {
    ...
    entries[loc] = serializeAws_queryAction(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryCertificateList = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryCertificate(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryLoadBalancerAttributes = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryLoadBalancerAttribute(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryQueryStringKeyValuePairList = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryQueryStringKeyValuePair(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryRuleConditionList = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryRuleCondition(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryRulePriorityList = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryRulePriorityPair(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_querySubnetMappings = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_querySubnetMapping(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryTargetDescriptions = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryTargetDescription(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryTargetGroupAttributes = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryTargetGroupAttribute(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryTargetGroupList = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryTargetGroupTuple(entry, context);
    counter++;
  });
  return entries;
};
...
const deserializeAws_queryAuthenticateCognitoActionConfig = (
  ...
  if (output["AuthenticationRequestExtraParams"]["entry"] !== undefined) {
...
const deserializeAws_queryAvailabilityZone = (
  ...
  if (output["LoadBalancerAddresses"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeLoadBalancerAttributesOutput = (
  ...
  if (output["Attributes"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeSSLPoliciesOutput = (
  ...
  if (output["SslPolicies"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeTargetHealthOutput = (
  ...
  if (output["TargetHealthDescriptions"]["member"] !== undefined) {
...
const deserializeAws_queryListener = (
  ...
  if (output["DefaultActions"]["member"] !== undefined) {
...
const deserializeAws_queryRule = (
  ...
  if (output["Conditions"]["member"] !== undefined) {
...
const deserializeAws_querySetSecurityGroupsOutput = (
  ...
  if (output["SecurityGroupIds"]["member"] !== undefined) {
...
const deserializeAws_querySslPolicy = (
  ...
  if (output["Ciphers"]["member"] !== undefined) {
  ...
  if (output["SslProtocols"]["member"] !== undefined) {
...
const deserializeAws_queryTargetGroup = (
  ...
  if (output["LoadBalancerArns"]["member"] !== undefined) {
