...
export const serializeAws_restJson1CreateApiKeyCommand = async (
  ...
  let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/apikeys";
  let body: any;
  body = JSON.stringify({
...
export const serializeAws_restJson1CreateDomainNameCommand = async (
  ...
  let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/domainnames";
  let body: any;
  body = JSON.stringify({
...
export const serializeAws_restJson1CreateRestApiCommand = async (
  ...
  let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/restapis";
  let body: any;
  body = JSON.stringify({
...
export const serializeAws_restJson1CreateUsagePlanCommand = async (
  ...
  let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/usageplans";
  let body: any;
  body = JSON.stringify({
...
export const serializeAws_restJson1CreateVpcLinkCommand = async (
  ...
  let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/vpclinks";
  let body: any;
  body = JSON.stringify({
    ...(input.description !== undefined && input.description !== null && { description: input.description }),
    ...(input.name !== undefined && input.name !== null && { name: input.name }),
...
export const serializeAws_restJson1GenerateClientCertificateCommand = async (
  ...
  let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/clientcertificates";
  let body: any;
  body = JSON.stringify({
    ...(input.description !== undefined && input.description !== null && { description: input.description }),
    ...(input.tags !== undefined &&
...
export const serializeAws_restJson1GetAccountCommand = async (
  ...
  let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/account";
  let body: any;
  body = "";
  return new __HttpRequest({
    protocol,
...
export const serializeAws_restJson1GetSdkTypesCommand = async (
  ...
  const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
  const headers: any = {};
  let resolvedPath = `${basePath?.endsWith("/") ? basePath.slice(0, -1) : basePath || ""}` + "/sdktypes";
  const query: any = {
    ...(input.position !== undefined && { position: input.position }),
    ...(input.limit !== undefined && { limit: input.limit.toString() }),
  };
