...
export interface AccessLogSettings {
   ...
   *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-mapping-template-reference.html#context-variable-reference">
   *   $context variables
   *  </a>
 ...
 *   <a href="https://docs.aws.amazon.com/apigateway/api-reference/handling-errors/#api-error-codes">
 ...
 * </div>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-limits.html">
 *   API Gateway Limits
 *  </a>
 ...
 *  </a>
 *  ,
 *  <a href="https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-account.html">
 *   AWS CLI
 *  </a>
 * </div>
 */
 ...
 * </p>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-api-keys.html">
 *   Use API Keys
 *  </a>
 * </div>
 */
...
export interface Authorizer extends $MetadataBearer {
   ...
   *     COGNITO_USER_POOLS
   *    </code>
   *    authorizer, this is required and specifies the request header mapping expression for the custom header holding the authorization token submitted by the client. For example, if the token header name is
   *    <code>
   *     Auth
   *    </code>
   ...
   *     REQUEST
   *    </code>
   *    authorizer, this is required when authorization caching is enabled. The value is a comma-separated string of one or more mapping expressions of the specified request parameters. For example, if an
   *    <code>
   *     Auth
   *    </code>
   *    header, a
   ...
   *    </code>
   *    .  These parameters will be used to derive the authorization caching key and to perform runtime validation of the
   *    <code>
   *     REQUEST
   *    </code>
   ...
   *   aud
   *  </code>
   *  field of the incoming token from the client against the specified regular expression. It will invoke the authorizer's Lambda function when there is a match. Otherwise, it will return a 401 Unauthorized response without calling the Lambda function. The validation expression does not apply to the
   *  <code>
   *   REQUEST
   *  </code>
   *  authorizer.
   ...
   *   TOKEN
   *  </code>
   *  for a Lambda function using a single authorization token submitted in a custom header,
   *  <code>
   *   REQUEST
   *  </code>
 ...
 *   BasePathMapping
 *  </code>
 *  specification identifies a deployed
 *  <a>
 *   RestApi
 *  </a>
 *  in a given stage of the owner
 *  <a>
 *   Account
 *  </a>
 *  .
 * </div>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-custom-domains.html">
 ...
 * </p>
 * <div class="remarks">
 *  Client certificates are used to authenticate an API by the backend server. To authenticate an API client (or user), use IAM roles and policies, a custom
 *  <a>
 *   Authorizer
 *  </a>
 ...
 * </div>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/getting-started-client-side-ssl-authentication.html">
...
export interface CreateApiKeyRequest {
   ...
   * </p>
   * <!-- Why is this declared as the input to create an API key? As a form of copying an existing key value into a new API key? -->
   */
  value?: string;
}
...
/**
 * <p>
 *  Requests API Gateway to create a new
 *  <a>
 *   BasePathMapping
 *  </a>
 *  resource.
...
export interface CreateDomainNameRequest {
  ...
  /**
   * <p>
   *  The endpoint configuration of this
   *  <a>
   *   DomainName
   *  </a>
...
export interface CreateStageRequest {
   ...
   *   Stage
   *  </a>
   *  resource. Stage names can only contain alphanumeric characters, hyphens, and underscores. Maximum length is 128 characters.
   * </p>
   */
...
export interface CreateUsagePlanKeyRequest {
  ...
  /**
   * <p>
   *  [Required] The identifier of a
   *  <a>
   *   UsagePlanKey
   *  </a>
   *  resource for a plan customer.
   * </p>
   */
...
export interface DeleteBasePathMappingRequest {
  ...
  /**
   * <p>
   *  [Required] The base path name of the
   *  <a>
   *   BasePathMapping
   *  </a>
   *  resource to delete.
...
/**
 * <p>
 *  A request to delete an existing
 *  <a>
 *   MethodResponse
 *  </a>
 *  resource.
 ...
 *   RestApi
 *  </a>
 *  resource that can be called by users using
 *  <a>
 *   Stages
 *  </a>
 *  . A deployment must be associated with a
 *  <a>
 *   Stage
 *  </a>
 ...
 *  </a>
 *  .
 *             To view, update, or delete a deployment, call
 *  <code>
 *   GET
 *  </code>
 *  ,
 ...
 *  </a>
 *  ,
 *  <a href="https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-deployment.html">
 *   AWS CLI
 *  </a>
 *  ,
 *  <a href="https://aws.amazon.com/tools/">
 *   AWS SDKs
 *  </a>
 * </div>
 */
 ...
 * </p>
 * <div class="remarks">
 *  To create a new deployment of a
 *  <a>
 *   RestApi
 *  </a>
 *  , make a
 ...
 * </div>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-deploy-api.html">
 *   Deploying an API
 *  </a>
 *  ,
 *  <a href="https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-deployment.html">
 ...
 *    location
 *   </code>
 *   ). The target specifies an API entity to which the documentation content applies. The supported API entity types are
 *   <code>
 *    API
 *   </code>
 *   ,
 ...
 * </div>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-documenting-api.html">
 *   Documenting an API
 *  </a>
 *  ,
 *  <a>
...
export interface DocumentationPart extends $MetadataBearer {
   ...
   *   DocumentationPart
   *  </a>
   *  identifier, generated by API Gateway when the
   *  <code>
   *   DocumentationPart
   *  </code>
   *  is created.
   ...
   *   properties
   *  </literal>
   *  map are exported and, hence, published as part of the API entity definitions, while the original documentation parts are exported in a OpenAPI extension of
   *  <code>
 ...
 *  </a>
 *  ,
 *  <a href="https://docs.aws.amazon.com/apigateway/api-reference/link-relation/documentationpart-import/">
...
export interface DocumentationPartLocation {
   ...
   *   *
   *  </code>
   *  for any method.  When an applicable child entity inherits the content of an entity of the same type with more general specifications of the other
   *  <code>
   *   location
   *  </code>
   ...
   *   /
   *  </code>
   *  for the root resource. When an applicable child entity inherits the content of another entity of the same type with more general specifications of the other
   *  <code>
   *   location
   *  </code>
   *  attributes,  the child entity's
   ...
   *   *
   *  </code>
   *  for any status code. When an applicable child  entity inherits the content of an entity of the same type with more general specifications of the other
   *  <code>
   *   location
   *  </code>
   *  attributes, the child entity's
   ...
   *   RESPONSE_BODY
   *  </code>
   *  . Content inheritance does not apply to any entity of the
   *  <code>
   *   API
   *  </code>
   *  ,
 ...
 *   </code>
 *   format. With the default host name, you can access the API's root resource with the URL of
 *   <code>
 ...
 *    apis.example.com
 *   </code>
 *   for this API, you can then access the same resource using the URL of the
 *   <code>
...
export interface DomainName extends $MetadataBearer {
  ...
  /**
   * <p>
   *  The domain name of the Amazon CloudFront distribution associated with this custom domain name for an edge-optimized endpoint. You set up this association when adding a DNS record pointing the custom domain name to this distribution name. For more information about CloudFront distributions, see the
   *  <a href="https://aws.amazon.com/documentation/cloudfront/" target="_blank">
   ...
   *   Z2FDTNDATAQYW2
   *  </code>
   *  for all the regions. For more information, see
   *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-regional-api-custom-domain-create.html">
   *   Set up a Regional Custom Domain Name
   *  </a>
   *  and
   *  <a href="https://docs.aws.amazon.com/general/latest/gr/rande.html#apigateway_region">
   ...
   *   DomainName
   *  </a>
   *  migration. The valid values are
   *  <code>
   *   AVAILABLE
   *  </code>
   *  and
   ...
   *   UPDATING
   *  </code>
   *  , the domain cannot be modified further until the existing operation is complete. If it is
   *  <code>
   *   AVAILABLE
   *  </code>
...
export interface EndpointConfiguration {
  ...
  /**
   * <p>
   *  A list of endpoint types of an API (
   *  <a>
   *   RestApi
   *  </a>
   *  ) or its custom domain name (
   ...
   *   "EDGE"
   *  </code>
   *  . For a regional API and its custom domain name, the endpoint type is
   *  <code>
   *   REGIONAL
   *  </code>
   ...
   *   RestApi
   *  </a>
   *  ) against which to create Route53 ALIASes. It is only supported for
   *  <code>
   *   PRIVATE
   *  </code>
   *  endpoint type.
 ...
 *   GetExport
 *  </a>
 *  , which contains the generated SDK.
 * </p>
 */
 ...
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/supported-gateway-response-types.html">
 ...
 * </div>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/customize-gateway-responses.html">
...
export interface GatewayResponse extends $MetadataBearer {
   ...
   *   GatewayResponse
   *  </a>
   *  is the default gateway response (
   *  <code>
   *   true
   *  </code>
   *  ) or not (
 ...
 *   </h5>
 *   <p>
 *    This example request shows how to retrieve the
 *    <a>
 *     GatewayResponses
 *    </a>
...
export interface GetDeploymentRequest {
   ...
   *   Deployment
   *  </a>
   *  resource in the response. In a REST API call, this
   *  <code>
   *   embed
   *  </code>
   ...
   *  </code>
   *  . The SDK and other platform-dependent libraries might use a different format for the list. Currently, this request supports only retrieval of the embedded API summary this way. Hence, the parameter value must be a single-valued list containing only the
   *  <code>
   *   "apisummary"
   *  </code>
   *  string.  For example,
...
export interface GetMethodResponseRequest {
  ...
  /**
   * <p>
   *  [Required] The status code for the
   *  <a>
   *   MethodResponse
   *  </a>
   *  resource.
...
export interface GetResourceRequest {
   ...
   *   Resource
   *  </a>
   *  representation in the response. This
   *  <code>
   *   embed
   *  </code>
   *  parameter value is a list of comma-separated strings. Currently, the request supports only retrieval of the embedded
   *  <a>
   *   Method
   *  </a>
...
/**
 * <p>
 *  Request a new generated client SDK for a
 *  <a>
 *   RestApi
 *  </a>
 *  and
 ...
 * </div>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-create-api.html">
 *   Creating an API
 *  </a>
 * </div>
 */
export interface Integration extends $MetadataBearer {
   ...
   *   cacheKeyParameters
   *  </code>
   *  , these parameters must also be specified for
   *  <a>
   *   Method
   *  </a>
   *  <code>
   ...
   * <p>
   *  The (
   *  <a href="https://docs.aws.amazon.com/apigateway/api-reference/resource/vpc-link/#id">
   *   <code>
   *    id
   *   </code>
   *  </a>
   ...
   *   INTERNET
   *  </code>
   *  for connections through the public routable internet or
   *  <code>
   *   VPC_LINK
   *  </code>
   ...
   *             or the content type does not match any of the mapped content types, as specified in
   *   <code>
   *    requestTemplates
   *   </code>
   *   .
   ...
   *   http/https
   *  </code>
   *  ), port and path. Standard 80 and 443 ports are supported as well as custom ports above 1024. An HTTP or HTTP proxy integration with a
   *  <code>
   *   connectionType
   *  </code>
   *  of
   ...
   *   VPC_LINK
   *  </code>
   *  is referred to as a private integration and uses a
   *  <a>
   *   VpcLink
   *  </a>
   ...
   *    <a href="https://en.wikipedia.org/wiki/Uniform_Resource_Identifier" target="_blank">
   *     RFC-3986 specification
   *    </a>
   *    , for either standard integration, where
   *    <code>
   *     connectionType
   *    </code>
   *    is not
   ...
   *     {service}
   *    </code>
   *    is the name of the integrated AWS service (e.g.,
   *    <code>
   *     s3
   *    </code>
   *    ); and
   ...
   *     {subdomain}
   *    </code>
   *    is a designated subdomain supported by certain AWS service for fast host-name lookup.
   *    <code>
   *     action
   *    </code>
   ...
   *     {service_api}
   *    </code>
   *    refers to a supported action
   *    <code>
   *     {name}
   *    </code>
   *    plus any required input parameters. Alternatively,
   *    <code>
   *     path
   *    </code>
   ...
   *     service_api
   *    </code>
   *    refers to the path to an AWS service resource, including the region of the integrated AWS service, if applicable. For example, for integration with the S3 API of
   *    <code>
   *     <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectGET.html">
   *      GetObject
   *     </a>
   *    </code>
   *    , the
 ...
 *   Integration
 *  </a>
 *  resource. Both consist of a request and one or more responses. The method request takes
 ...
 *             the back end to the client through an integration response. A method request is embodied in a
 *  <b>
 *   Method
 *  </b>
 *  resource, whereas
 *             an integration request is embodied in an
 *  <a>
 *   Integration
 *  </a>
 *  resource.  On the other hand, a method response is represented
 *             by a
 *  <a>
 *   MethodResponse
 *  </a>
 ...
 *   <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-mapping-template-reference.html#util-templat-reference">
 *    $util.urlDecode()
 *   </a>
 *   helper function.
 *  </p>
 ...
 *  </a>
 *  ,
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-method-settings.html">
...
export interface Method extends $MetadataBearer {
   ...
   * </div>
   * <div class="seeAlso">
   *  <a href="https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-integration.html">
   *   AWS CLI
   *  </a>
   * </div>
   */
   ...
   * <div class="remarks">
   *  <p>
   *   The collection of method responses are encapsulated in a key-value map, where the key is a response's HTTP status code and the value is a
   *   <a>
   *    MethodResponse
   *   </a>
   ...
   * </div>
   * <div class="seeAlso">
   *  <a href="https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-method-response.html">
   *   AWS CLI
   *  </a>
   * </div>
   */
   ...
   *   name
   *  </code>
   *  is a valid and unique parameter name. The value associated with the key is a Boolean flag indicating whether the parameter is required (
   *  <code>
   *   true
   *  </code>
   *  ) or optional (
 ...
 *  <!-- &ABP; sends back the status code to the caller as the HTTP status code. Parameters and models can be used to transform the response from the method's integration.-->
 * </p>
 * <div class="remarks">
 *  <p>
 *  </p>
...
export interface MethodResponse extends $MetadataBearer {
   ...
   *   Model
   *  </a>
   *  resources used for the response's content-type. Response models are represented as a key/value map, with a content-type as the key and a
   *  <a>
   *   Model
   *  </a>
   *  name as the value.
   ...
   *   name
   *  </code>
   *  is a valid and unique header name. API Gateway passes certain integration response data to the method response headers specified here according to the mapping you prescribe in the API's
   *  <a>
   *   IntegrationResponse
   *  </a>
   *  . The integration response data that can be mapped include an integration response header expressed in
   *  <code>
   *   integration.response.header.{name}
   *  </code>
 ...
 *  </a>
 *  ,
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/models-mappings.html">
 *   Models and Mappings
 *  </a>
 * </div>
 */
...
export interface PutIntegrationRequest {
   ...
   *   requestTemplates
   *  </code>
   *  property on the Integration resource. There are three valid values:
   *  <code>
   *   WHEN_NO_MATCH
   *  </code>
   *  ,
...
export interface PutMethodRequest {
   ...
   *   Model
   *  </a>
   *  resources used for the request's content type. Request models are represented as a key/value map, with a content type as the key and a
   *  <a>
   *   Model
   *  </a>
   *  name as the value.
...
export interface PutMethodResponseRequest {
   ...
   *   name
   *  </code>
   *  is a valid and unique header name. The response parameter names defined here are available in the integration response to be mapped from an integration response header expressed in
   *  <code>
   *   integration.response.header.{name}
   *  </code>
   *  , a static value enclosed within a pair of single quotes (e.g.,
 ...
 *   <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-swagger-extensions.html#api-gateway-swagger-extensions-request-validators.requestValidator.html">
 *    x-amazon-apigateway-request-validators.requestValidator
 *   </a>
 *   object. It the referenced using the
 *   <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-swagger-extensions.html#api-gateway-swagger-extensions-request-validator">
 ...
 * </div>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-method-request-validation.html">
 ...
 *   </a>
 *   of an API is defined by the
 *   <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-swagger-extensions.html#api-gateway-swagger-extensions-request-validators.html">
...
export interface Resource extends $MetadataBearer {
   ...
   *    OPTIONS
   *   </code>
   *   is enabled on the resource, you can follow the example here to get that method. Just replace the
   *   <code>
   *    GET
   *   </code>
   *   of the last path segment in the request URL with
   *   <code>
   *    OPTIONS
   *   </code>
   *   .
...
export interface SdkConfigurationProperty {
   ...
   *   SdkType
   *  </a>
   *  configuration property to indicate if the associated SDK configuration property is required (
   *  <code>
   *   true
   *  </code>
   *  ) or not (
...
export interface Stage extends $MetadataBearer {
  ...
  /**
   * <p>
   *  The ARN of the WebAcl associated with the
   *  <a>
   *   Stage
   *  </a>
   *  .
 ...
 * </p>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/stages.html">
 ...
 * </p>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/models-mappings.html#models-mappings-mappings">
 *   Mapping Templates
 *  </a>
 * </div>
 */
export interface Template extends $MetadataBearer {
   ...
   * <p>
   *  The Apache
   *  <a href="https://velocity.apache.org/engine/devel/vtl-reference-guide.html" target="_blank">
...
export interface TestInvokeAuthorizerResponse extends $MetadataBearer {
  ...
  /**
   * <p>
   *  The principal identity returned by the
   *  <a>
   *   Authorizer
   *  </a>
   * </p>
 ...
 * </p>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-test-method.html#how-to-test-method-console">
...
/**
 * <p>
 *  A request to update an existing
 *  <a>
 *   MethodResponse
 *  </a>
 *  resource.
...
/**
 * <p>
 *  Request to change information about a
 *  <a>
 *   Resource
 *  </a>
 *  resource.
 ...
 * </div>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-api-usage-plans.html">
 *   Create and Use Usage Plans
 *  </a>
 *  ,
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-create-usage-plans-with-console.html#api-gateway-usage-plan-manage-usage">
 ...
 * <div class="remarks">
 *  <p>
 *   To associate an API stage with a selected API key in a usage plan, you must create a UsagePlanKey resource to represent the selected
 *   <a>
 *    ApiKey
 *   </a>
 *   .
 ...
 *  <p>
 *   <p>
 *    To enable access to a resource in an Amazon Virtual Private Cloud through Amazon API Gateway, you, as an API developer, create a
 *    <a>
 *     VpcLink
 *    </a>
 *    resource targeted for one or more network load balancers of the VPC and then integrate an API method with a private integration that uses the
 *    <a>
 *     VpcLink
 *    </a>
 *    . The private integration has an integration type of
 *    <code>
 *     HTTP
 *    </code>
 *    or
...
export interface VpcLink extends $MetadataBearer {
   ...
   *   PENDING
   *  </code>
   *  and will fail if the status is
   *  <code>
   *   DELETING
   *  </code>
   *  .
 ...
 * </p>
 * <div class="seeAlso">
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/getting-started-with-private-integration.html">
 *   Getting Started with Private Integrations
 *  </a>
 *  ,
 *  <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/set-up-private-integration.html">
...
export interface PatchOperation {
   ...
   *   copy
   *  </code>
   *  update operation's source as identified by a
   *  <code>
   *   JSON-Pointer
   *  </code>
   *  value referencing the location within the targeted resource to copy the value from. For example, to promote a canary deployment, you copy the canary deployment ID to the affiliated deployment ID by calling a PATCH request on a
   *  <a>
   *   Stage
   *  </a>
   *  resource with
   ...
   *  <a href="https://tools.ietf.org/html/draft-ietf-appsawg-json-pointer-08">
   *   JSON Pointer
   *  </a>
   *  value that references a location within the targeted resource. For example, if the target resource has an updateable property of
   *  <code>
   *   {"name":"value"}
   *  </code>
   *  , the path for this property is
   *  <code>
   *   /name
   *  </code>
   *  . If the
   ...
   *   /name/child~1name
   *  </code>
   *  . Any slash ("/") character appearing in path names must be escaped with "~1", as shown in the example above. Each
   *  <code>
   *   op
   *  </code>
   ...
   *   replace
   *  </code>
   *  operation. When using AWS CLI to update a property of a JSON value, enclose the JSON object with a pair of single quotes in a Linux shell, e.g., '{"a": ...}'. In a Windows shell, see
