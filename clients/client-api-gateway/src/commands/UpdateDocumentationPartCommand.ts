...
import type { DocumentationPart, UpdateDocumentationPartRequest } from "../models/models_0";
 ...
 * @public
 */
export class UpdateDocumentationPartCommand extends command<UpdateDocumentationPartCommandInput, UpdateDocumentationPartCommandOutput>(
  _ep0,
  _mw0,
