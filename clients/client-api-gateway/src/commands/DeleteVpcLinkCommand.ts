...
import type { DeleteVpcLinkRequest } from "../models/models_0";
 ...
 * @public
 */
export class DeleteVpcLinkCommand extends command<DeleteVpcLinkCommandInput, DeleteVpcLinkCommandOutput>(
  _ep0,
  _mw0,
  "DeleteVpcLink",
  DeleteVpcLink$
