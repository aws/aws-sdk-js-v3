 ...
 * ```
 *
 * @param FlushStageAuthorizersCacheRequest - {@link FlushStageAuthorizersCacheRequest}
 * @returns {@link Unit}
...
> {
  ...
  resolveMiddleware(
    ...
    this.middlewareStack.use(
      getEndpointPlugin(configuration, FlushStageAuthorizersCacheCommand.getEndpointParameterInstructions())
    );
