 ...
 * @public
 */
export class RejectDomainNameAccessAssociationCommand extends command<RejectDomainNameAccessAssociationCommandInput, RejectDomainNameAccessAssociationCommandOutput>(
  _ep0,
  _mw0,
