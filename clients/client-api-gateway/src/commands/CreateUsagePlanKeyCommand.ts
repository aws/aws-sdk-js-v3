...
import type { CreateUsagePlanKeyRequest, UsagePlanKey } from "../models/models_0";
 ...
 * @public
 */
export class CreateUsagePlanKeyCommand extends command<CreateUsagePlanKeyCommandInput, CreateUsagePlanKeyCommandOutput>(
  _ep0,
  _mw0,
  "CreateUsagePlanKey",
  CreateUsagePlanKey$
