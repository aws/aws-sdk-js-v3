...
import { DeleteDocumentationPart$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteDocumentationPartCommand extends command<DeleteDocumentationPartCommandInput, DeleteDocumentationPartCommandOutput>(
  _ep0,
  _mw0,
