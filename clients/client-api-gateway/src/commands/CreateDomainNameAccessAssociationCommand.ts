 ...
 * @public
 */
export class CreateDomainNameAccessAssociationCommand extends command<CreateDomainNameAccessAssociationCommandInput, CreateDomainNameAccessAssociationCommandOutput>(
  _ep0,
  _mw0,
