...
import type { Method, UpdateMethodRequest } from "../models/models_0";
 ...
 * @public
 */
export class UpdateMethodCommand extends command<UpdateMethodCommandInput, UpdateMethodCommandOutput>(
  _ep0,
  _mw0,
  "UpdateMethod",
  UpdateMethod$
