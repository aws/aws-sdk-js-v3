 ...
 * @public
 */
export class GetDomainNameAccessAssociationsCommand extends command<GetDomainNameAccessAssociationsCommandInput, GetDomainNameAccessAssociationsCommandOutput>(
  _ep0,
  _mw0,
