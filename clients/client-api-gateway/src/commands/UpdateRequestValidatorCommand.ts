 ...
 * ```
 *
 * @param UpdateRequestValidatorRequest - {@link UpdateRequestValidatorRequest}
...
> {
  ...
  resolveMiddleware(
    ...
    this.middlewareStack.use(
      getEndpointPlugin(configuration, UpdateRequestValidatorCommand.getEndpointParameterInstructions())
    );
