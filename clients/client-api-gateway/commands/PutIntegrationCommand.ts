...
import {
  deserializeAws_restJson1_1PutIntegrationCommand,
  serializeAws_restJson1_1PutIntegrationCommand
...
export type PutIntegrationCommandOutput = Integration;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1PutIntegrationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1PutIntegrationCommand(output, context);
  }
