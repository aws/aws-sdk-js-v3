...
import {
  deserializeAws_restJson1_1GetUsagePlanKeysCommand,
  serializeAws_restJson1_1GetUsagePlanKeysCommand
...
export type GetUsagePlanKeysCommandOutput = UsagePlanKeys;
