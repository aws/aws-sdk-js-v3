...
import {
  deserializeAws_restJson1_1GetUsagePlansCommand,
  serializeAws_restJson1_1GetUsagePlansCommand
...
export type GetUsagePlansCommandOutput = UsagePlans;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetUsagePlansCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetUsagePlansCommand(output, context);
  }
