...
import {
  deserializeAws_restJson1_1CreateVpcLinkCommand,
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1CreateVpcLinkCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateVpcLinkCommand(output, context);
  }
