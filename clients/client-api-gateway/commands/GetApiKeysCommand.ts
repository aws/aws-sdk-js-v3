...
import {
  deserializeAws_restJson1_1GetApiKeysCommand,
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetApiKeysCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetApiKeysCommand(output, context);
  }
