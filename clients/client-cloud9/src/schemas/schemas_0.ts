...
export var DescribeEnvironmentsResult$: StaticStructureSchema = [
  3,
  n0,
  _DEResc,
  0,
...
var EnvironmentList: StaticListSchema = [1, n0, _ELn, 0, [() => Environment$, 0]];
var EnvironmentMembersList: StaticListSchema = [1, n0, _EML, 0, () => EnvironmentMember$];
var PermissionsList = 64 | 0;
var TagKeyList: StaticListSchema = [1, n0, _TKL, 8, [() => TagKey, 0]];
var TagList: StaticListSchema = [1, n0, _TL, 8, [() => Tag$, 0]];
