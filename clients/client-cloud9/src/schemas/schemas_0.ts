...
export var DescribeEnvironmentMembershipsRequest$: StaticStructureSchema = [3, n0, _DEMRes,
  0,
  [_uA, _eI, _p, _nT, _mR],
  [0, 0, 64 | 0, 0, 1]
];
export var DescribeEnvironmentMembershipsResult$: StaticStructureSchema = [3, n0, _DEMResc,
  0,
  [_mem, _nT],
...
export var ListEnvironmentsResult$: StaticStructureSchema = [3, n0, _LERi,
  0,
  [_nT, _eIn],
  [0, 64 | 0]
];
...
var EnvironmentMembersList: StaticListSchema = [1, n0, _EML,
  0, () => EnvironmentMember$
];
...
export var CreateEnvironmentEC2$: StaticOperationSchema = [9, n0, _CEEC,
  2, () => CreateEnvironmentEC2Request$, () => CreateEnvironmentEC2Result$
];
export var CreateEnvironmentMembership$: StaticOperationSchema = [9, n0, _CEM,
...
export var DeleteEnvironmentMembership$: StaticOperationSchema = [9, n0, _DEM,
  2, () => DeleteEnvironmentMembershipRequest$, () => DeleteEnvironmentMembershipResult$
];
export var DescribeEnvironmentMemberships$: StaticOperationSchema = [9, n0, _DEMe,
  0, () => DescribeEnvironmentMembershipsRequest$, () => DescribeEnvironmentMembershipsResult$
];
export var DescribeEnvironments$: StaticOperationSchema = [9, n0, _DEe,
  0, () => DescribeEnvironmentsRequest$, () => DescribeEnvironmentsResult$
];
export var DescribeEnvironmentStatus$: StaticOperationSchema = [9, n0, _DES,
...
export var UpdateEnvironmentMembership$: StaticOperationSchema = [9, n0, _UEM,
