...
import { type Cloud9ClientResolvedConfig, Cloud9ClientConfig } from "../Cloud9Client";
 ...
 * @internal
 */
export const defaultCloud9HttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: Cloud9HttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultCloud9HttpAuthSchemeProvider: Cloud9HttpAuthSchemeProvider = (authParameters) => {
