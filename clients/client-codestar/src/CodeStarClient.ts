  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<CodeStarClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultCodeStarHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: CodeStarClientResolvedConfig) =>
