...
const AWS_TEMPLATE = "codestar.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "codestar.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "codestar.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "codestar.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "codestar.{region}.amazonaws.com";
