...
export type DeleteFunctionDefinitionCommandOutput = DeleteFunctionDefinitionResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1DeleteFunctionDefinitionCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1DeleteFunctionDefinitionCommand(
      output,
      context
    );
  }
