...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ListBulkDeploymentDetailedReportsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListBulkDeploymentDetailedReportsCommand(output, context);
  }
