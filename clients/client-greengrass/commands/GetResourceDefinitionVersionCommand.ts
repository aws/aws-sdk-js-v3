...
import {
  deserializeAws_restJson1_1GetResourceDefinitionVersionCommand,
  serializeAws_restJson1_1GetResourceDefinitionVersionCommand
...
> {
  ...
  private serialize(input: GetResourceDefinitionVersionCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1GetResourceDefinitionVersionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetResourceDefinitionVersionCommand(output, context);
  }
