...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1UpdateSubscriptionDefinitionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1UpdateSubscriptionDefinitionCommand(output, context);
  }
