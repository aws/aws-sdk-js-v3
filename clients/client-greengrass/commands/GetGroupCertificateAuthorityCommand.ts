...
import {
  deserializeAws_restJson1_1GetGroupCertificateAuthorityCommand,
  serializeAws_restJson1_1GetGroupCertificateAuthorityCommand
...
export type GetGroupCertificateAuthorityCommandOutput = GetGroupCertificateAuthorityResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetGroupCertificateAuthorityCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetGroupCertificateAuthorityCommand(output, context);
  }
