...
import {
  deserializeAws_restJson1_1DeleteConnectorDefinitionCommand,
  serializeAws_restJson1_1DeleteConnectorDefinitionCommand
...
> {
  ...
  private serialize(input: DeleteConnectorDefinitionCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1DeleteConnectorDefinitionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DeleteConnectorDefinitionCommand(output, context);
  }
