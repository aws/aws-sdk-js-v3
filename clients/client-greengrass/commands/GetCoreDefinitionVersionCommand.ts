...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetCoreDefinitionVersionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetCoreDefinitionVersionCommand(output, context);
  }
