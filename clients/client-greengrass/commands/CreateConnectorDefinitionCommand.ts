...
import {
  deserializeAws_restJson1_1CreateConnectorDefinitionCommand,
  serializeAws_restJson1_1CreateConnectorDefinitionCommand
...
export type CreateConnectorDefinitionCommandOutput = CreateConnectorDefinitionResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1CreateConnectorDefinitionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateConnectorDefinitionCommand(output, context);
  }
