...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1UpdateDeviceDefinitionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1UpdateDeviceDefinitionCommand(output, context);
  }
