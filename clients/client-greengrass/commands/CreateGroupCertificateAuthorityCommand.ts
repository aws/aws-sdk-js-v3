...
import {
  deserializeAws_restJson1_1CreateGroupCertificateAuthorityCommand,
  serializeAws_restJson1_1CreateGroupCertificateAuthorityCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1CreateGroupCertificateAuthorityCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateGroupCertificateAuthorityCommand(output, context);
  }
