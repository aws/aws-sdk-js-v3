...
export type UpdateFunctionDefinitionCommandOutput = UpdateFunctionDefinitionResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1UpdateFunctionDefinitionCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1UpdateFunctionDefinitionCommand(
      output,
      context
    );
  }
