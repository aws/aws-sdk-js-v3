...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteDeviceDefinitionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DeleteDeviceDefinitionCommand(output, context);
  }
