...
import {
  deserializeAws_restJson1_1GetLoggerDefinitionVersionCommand,
  serializeAws_restJson1_1GetLoggerDefinitionVersionCommand
...
export type GetLoggerDefinitionVersionCommandOutput = GetLoggerDefinitionVersionResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetLoggerDefinitionVersionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetLoggerDefinitionVersionCommand(output, context);
  }
