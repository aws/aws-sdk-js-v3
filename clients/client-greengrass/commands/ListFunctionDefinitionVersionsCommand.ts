...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ListFunctionDefinitionVersionsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListFunctionDefinitionVersionsCommand(output, context);
  }
