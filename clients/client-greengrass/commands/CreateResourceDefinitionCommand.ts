...
import {
  deserializeAws_restJson1_1CreateResourceDefinitionCommand,
  serializeAws_restJson1_1CreateResourceDefinitionCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1CreateResourceDefinitionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateResourceDefinitionCommand(output, context);
  }
