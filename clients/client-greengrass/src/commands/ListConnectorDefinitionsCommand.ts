...
import type { ListConnectorDefinitionsRequest, ListConnectorDefinitionsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListConnectorDefinitionsCommand extends command<ListConnectorDefinitionsCommandInput, ListConnectorDefinitionsCommandOutput>(
  _ep0,
  _mw0,
