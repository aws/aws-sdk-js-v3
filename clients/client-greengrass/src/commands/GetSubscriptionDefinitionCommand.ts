...
import type { GetSubscriptionDefinitionRequest, GetSubscriptionDefinitionResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetSubscriptionDefinitionCommand extends command<GetSubscriptionDefinitionCommandInput, GetSubscriptionDefinitionCommandOutput>(
  _ep0,
  _mw0,
