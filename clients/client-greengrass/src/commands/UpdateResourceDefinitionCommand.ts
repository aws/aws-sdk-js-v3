...
import type { UpdateResourceDefinitionRequest, UpdateResourceDefinitionResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateResourceDefinitionCommand extends command<UpdateResourceDefinitionCommandInput, UpdateResourceDefinitionCommandOutput>(
  _ep0,
  _mw0,
