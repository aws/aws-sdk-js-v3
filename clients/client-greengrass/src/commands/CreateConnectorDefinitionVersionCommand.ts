 ...
 * @public
 */
export class CreateConnectorDefinitionVersionCommand extends command<CreateConnectorDefinitionVersionCommandInput, CreateConnectorDefinitionVersionCommandOutput>(
  _ep0,
  _mw0,
