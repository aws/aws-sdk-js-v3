...
import type { GetDeviceDefinitionVersionRequest, GetDeviceDefinitionVersionResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetDeviceDefinitionVersionCommand extends command<GetDeviceDefinitionVersionCommandInput, GetDeviceDefinitionVersionCommandOutput>(
  _ep0,
  _mw0,
