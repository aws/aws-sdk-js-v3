 ...
 * @public
 */
export class CreateFunctionDefinitionVersionCommand extends command<CreateFunctionDefinitionVersionCommandInput, CreateFunctionDefinitionVersionCommandOutput>(
  _ep0,
  _mw0,
