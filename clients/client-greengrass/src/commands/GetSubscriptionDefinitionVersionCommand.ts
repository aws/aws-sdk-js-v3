 ...
 * @public
 */
export class GetSubscriptionDefinitionVersionCommand extends command<GetSubscriptionDefinitionVersionCommandInput, GetSubscriptionDefinitionVersionCommandOutput>(
  _ep0,
  _mw0,
