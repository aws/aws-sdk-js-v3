...
import type { GetBulkDeploymentStatusRequest, GetBulkDeploymentStatusResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetBulkDeploymentStatusCommand extends command<GetBulkDeploymentStatusCommandInput, GetBulkDeploymentStatusCommandOutput>(
  _ep0,
  _mw0,
