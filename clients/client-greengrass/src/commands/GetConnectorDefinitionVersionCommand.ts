 ...
 * @public
 */
export class GetConnectorDefinitionVersionCommand extends command<GetConnectorDefinitionVersionCommandInput, GetConnectorDefinitionVersionCommandOutput>(
  _ep0,
  _mw0,
