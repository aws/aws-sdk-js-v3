 ...
 * @public
 */
export class UpdateThingRuntimeConfigurationCommand extends command<UpdateThingRuntimeConfigurationCommandInput, UpdateThingRuntimeConfigurationCommandOutput>(
  _ep0,
  _mw0,
