...
import type { GetThingRuntimeConfigurationRequest, GetThingRuntimeConfigurationResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetThingRuntimeConfigurationCommand extends command<GetThingRuntimeConfigurationCommandInput, GetThingRuntimeConfigurationCommandOutput>(
  _ep0,
  _mw0,
