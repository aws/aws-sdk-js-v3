 ...
 * ```
 *
 * @param CreateSubscriptionDefinitionVersionRequest - {@link CreateSubscriptionDefinitionVersionRequest}
 * @returns {@link CreateSubscriptionDefinitionVersionResponse}
