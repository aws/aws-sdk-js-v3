 ...
 * @public
 */
export class CreateSubscriptionDefinitionVersionCommand extends command<CreateSubscriptionDefinitionVersionCommandInput, CreateSubscriptionDefinitionVersionCommandOutput>(
  _ep0,
  _mw0,
