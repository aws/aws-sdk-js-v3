...
import { type GreengrassClientResolvedConfig, GreengrassClientConfig } from "../GreengrassClient";
 ...
 * @internal
 */
export const defaultGreengrassHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: GreengrassHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultGreengrassHttpAuthSchemeProvider: GreengrassHttpAuthSchemeProvider = (authParameters) => {
