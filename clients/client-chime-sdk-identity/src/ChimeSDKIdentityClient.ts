...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<ChimeSDKIdentityClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultChimeSDKIdentityHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: ChimeSDKIdentityClientResolvedConfig) =>
