 ...
 * @public
 */
export class DescribeAppInstanceUserEndpointCommand extends command<DescribeAppInstanceUserEndpointCommandInput, DescribeAppInstanceUserEndpointCommandOutput>(
  _ep0,
  _mw0,
