 ...
 * @public
 */
export class GetAppInstanceRetentionSettingsCommand extends command<GetAppInstanceRetentionSettingsCommandInput, GetAppInstanceRetentionSettingsCommandOutput>(
  _ep0,
  _mw0,
