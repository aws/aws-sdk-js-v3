 ...
 * @public
 */
export class RegisterAppInstanceUserEndpointCommand extends command<RegisterAppInstanceUserEndpointCommandInput, RegisterAppInstanceUserEndpointCommandOutput>(
  _ep0,
  _mw0,
