...
export const getRuntimeConfig = (config: ChimeSDKIdentityClientConfig) => {
  return {
    ...
    httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultChimeSDKIdentityHttpAuthSchemeProvider,
    ...
    protocol: config?.protocol ?? new AwsRestJsonProtocol({ defaultNamespace: "com.amazonaws.chimesdkidentity" }),
