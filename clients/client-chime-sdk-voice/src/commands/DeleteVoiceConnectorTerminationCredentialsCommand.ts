 ...
 * @public
 */
export class DeleteVoiceConnectorTerminationCredentialsCommand extends command<DeleteVoiceConnectorTerminationCredentialsCommandInput, DeleteVoiceConnectorTerminationCredentialsCommandOutput>(
  _ep0,
  _mw0,
