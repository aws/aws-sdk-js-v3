 ...
 * @public
 */
export class ListAvailableVoiceConnectorRegionsCommand extends command<ListAvailableVoiceConnectorRegionsCommandInput, ListAvailableVoiceConnectorRegionsCommandOutput>(
  _ep0,
  _mw0,
