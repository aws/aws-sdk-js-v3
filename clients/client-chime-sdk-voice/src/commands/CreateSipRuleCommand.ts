...
import type { CreateSipRuleRequest, CreateSipRuleResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateSipRuleCommand extends command<CreateSipRuleCommandInput, CreateSipRuleCommandOutput>(
  _ep0,
  _mw0,
  "CreateSipRule",
  CreateSipRule$
