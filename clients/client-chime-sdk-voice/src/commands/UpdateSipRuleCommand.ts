...
import type { UpdateSipRuleRequest, UpdateSipRuleResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateSipRuleCommand extends command<UpdateSipRuleCommandInput, UpdateSipRuleCommandOutput>(
  _ep0,
  _mw0,
  "UpdateSipRule",
  UpdateSipRule$
