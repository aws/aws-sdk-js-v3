 ...
 * @public
 */
export class GetSipMediaApplicationAlexaSkillConfigurationCommand extends command<GetSipMediaApplicationAlexaSkillConfigurationCommandInput, GetSipMediaApplicationAlexaSkillConfigurationCommandOutput>(
  _ep0,
  _mw0,
