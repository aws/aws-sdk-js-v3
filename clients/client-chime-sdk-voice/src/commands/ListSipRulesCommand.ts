...
import type { ListSipRulesRequest, ListSipRulesResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListSipRulesCommand extends command<ListSipRulesCommandInput, ListSipRulesCommandOutput>(
  _ep0,
  _mw0,
  "ListSipRules",
  ListSipRules$
