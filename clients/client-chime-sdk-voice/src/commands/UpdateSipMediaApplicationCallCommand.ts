 ...
 * @public
 */
export class UpdateSipMediaApplicationCallCommand extends command<UpdateSipMediaApplicationCallCommandInput, UpdateSipMediaApplicationCallCommandOutput>(
  _ep0,
  _mw0,
