...
import type { DeleteVoiceProfileDomainRequest } from "../models/models_0";
 ...
 * @public
 */
export class DeleteVoiceProfileDomainCommand extends command<DeleteVoiceProfileDomainCommandInput, DeleteVoiceProfileDomainCommandOutput>(
  _ep0,
  _mw0,
