...
import type { DeleteProxySessionRequest } from "../models/models_0";
 ...
 * @public
 */
export class DeleteProxySessionCommand extends command<DeleteProxySessionCommandInput, DeleteProxySessionCommandOutput>(
  _ep0,
  _mw0,
  "DeleteProxySession",
  DeleteProxySession$
