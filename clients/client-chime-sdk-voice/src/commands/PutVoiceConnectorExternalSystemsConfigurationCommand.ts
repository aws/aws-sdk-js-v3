 ...
 * @public
 */
export class PutVoiceConnectorExternalSystemsConfigurationCommand extends command<PutVoiceConnectorExternalSystemsConfigurationCommandInput, PutVoiceConnectorExternalSystemsConfigurationCommandOutput>(
  _ep0,
  _mw0,
