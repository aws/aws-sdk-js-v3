...
export var EnabledBaselineDriftTypes$: StaticStructureSchema = [3, n0, _EBDT,
  0,
  [_i],
...
export var EnabledControlDriftTypes$: StaticStructureSchema = [3, n0, _ECDT,
  0,
  [_i, _r],
...
export var ListBaselinesInput$: StaticStructureSchema = [3, n0, _LBI,
  0,
  [_nT, _mR],
  [0, 1]
];
...
var ControlOperations: StaticListSchema = [1, n0, _COo,
...
var EnabledBaselineParameters: StaticListSchema = [1, n0, _EBPn,
  0, () => EnabledBaselineParameter$
];
var EnabledBaselineParameterSummaries: StaticListSchema = [1, n0, _EBPSn,
  0, () => EnabledBaselineParameterSummary$
];
var EnabledBaselineParentIdentifiers = 64 | 0;
var EnabledBaselines: StaticListSchema = [1, n0, _EB,
  0, () => EnabledBaselineSummary$
];
var EnabledBaselineTargetIdentifiers = 64 | 0;
var EnabledControlIdentifiers = 64 | 0;
var EnabledControlParameters: StaticListSchema = [1, n0, _ECPn,
  0, () => EnabledControlParameter$
];
var EnabledControlParameterSummaries: StaticListSchema = [1, n0, _ECPSn,
  0, () => EnabledControlParameterSummary$
];
var EnabledControls: StaticListSchema = [1, n0, _EC,
  0, () => EnabledControlSummary$
];
var EnablementStatuses = 64 | 0;
var LandingZoneOperations: StaticListSchema = [1, n0, _LZO,
  0, () => LandingZoneOperationSummary$
];
var LandingZoneOperationStatuses = 64 | 0;
var LandingZoneOperationTypes = 64 | 0;
var LandingZoneSummaries: StaticListSchema = [1, n0, _LZSa,
...
export var UpdateEnabledBaseline$: StaticOperationSchema = [9, n0, _UEB,
  { [_h]: ["POST", "/update-enabled-baseline", 200] }, () => UpdateEnabledBaselineInput$, () => UpdateEnabledBaselineOutput$
];
export var UpdateEnabledControl$: StaticOperationSchema = [9, n0, _UEC,
  { [_h]: ["POST", "/update-enabled-control", 200] }, () => UpdateEnabledControlInput$, () => UpdateEnabledControlOutput$
];
export var UpdateLandingZone$: StaticOperationSchema = [9, n0, _ULZ,
