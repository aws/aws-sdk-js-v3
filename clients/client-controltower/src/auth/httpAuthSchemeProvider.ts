...
import { type ControlTowerClientResolvedConfig, ControlTowerClientConfig } from "../ControlTowerClient";
 ...
 * @internal
 */
export const defaultControlTowerHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ControlTowerHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultControlTowerHttpAuthSchemeProvider: ControlTowerHttpAuthSchemeProvider = (authParameters) => {
