 ...
 * @public
 */
export type NovaActClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type NovaActClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 */
export class NovaActClient extends __Client<
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<NovaActClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultNovaActHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: NovaActClientResolvedConfig) =>
