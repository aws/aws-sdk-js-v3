...
import { type NovaActClientResolvedConfig, NovaActClientConfig } from "../NovaActClient";
 ...
 * @internal
 */
export const defaultNovaActHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: NovaActHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<NovaActClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultNovaActHttpAuthSchemeProvider: NovaActHttpAuthSchemeProvider = (authParameters) => {
