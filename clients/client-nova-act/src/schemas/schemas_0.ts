...
export var Call$: StaticStructureSchema = [3, n0, _C, 0, [_cI, _i, _n], [0, [() => SensitiveDocument, 0], 0]];
...
export var CreateActResponse$: StaticStructureSchema = [3, n0, _CARr, 0, [_aI, _s], [0, 0]];
...
export var CreateSessionResponse$: StaticStructureSchema = [3, n0, _CSRr, 0, [_sI], [0]];
export var CreateWorkflowDefinitionRequest$: StaticStructureSchema = [
  3,
  n0,
  _CWDR,
  0,
...
export var CreateWorkflowDefinitionResponse$: StaticStructureSchema = [3, n0, _CWDRr, 0, [_s], [0]];
export var CreateWorkflowRunRequest$: StaticStructureSchema = [
  3,
  n0,
  _CWRR,
  0,
...
export var CreateWorkflowRunResponse$: StaticStructureSchema = [3, n0, _CWRRr, 0, [_wRI, _s], [0, 0]];
export var DeleteWorkflowDefinitionRequest$: StaticStructureSchema = [3, n0, _DWDR, 0, [_wDN], [[0, 1]]];
export var DeleteWorkflowDefinitionResponse$: StaticStructureSchema = [3, n0, _DWDRe, 0, [_s], [0]];
export var DeleteWorkflowRunRequest$: StaticStructureSchema = [
  3,
  n0,
  _DWRR,
  0,
...
export var DeleteWorkflowRunResponse$: StaticStructureSchema = [3, n0, _DWRRe, 0, [_s], [0]];
export var GetWorkflowDefinitionRequest$: StaticStructureSchema = [3, n0, _GWDR, 0, [_wDN], [[0, 1]]];
export var GetWorkflowDefinitionResponse$: StaticStructureSchema = [
  3,
  n0,
  _GWDRe,
  0,
...
export var InvokeActStepResponse$: StaticStructureSchema = [3, n0, _IASRn, 0, [_ca, _sIt], [[() => Calls, 0], 0]];
export var ListActsRequest$: StaticStructureSchema = [
  3,
  n0,
  _LAR,
  0,
...
export var ModelAlias$: StaticStructureSchema = [3, n0, _MA, 0, [_aN, _lMI, _rMI], [0, 0, 0]];
export var ModelLifecycle$: StaticStructureSchema = [3, n0, _ML, 0, [_s], [0]];
export var ModelSummary$: StaticStructureSchema = [3, n0, _MS, 0, [_mI, _mL, _mCV], [0, () => ModelLifecycle$, 1]];
...
export var TraceLocation$: StaticStructureSchema = [3, n0, _TL, 0, [_lT, _l], [0, 0]];
export var UpdateActRequest$: StaticStructureSchema = [
  3,
  n0,
  _UAR,
  0,
...
export var UpdateActResponse$: StaticStructureSchema = [3, n0, _UARp, 0, [], []];
export var UpdateWorkflowRunRequest$: StaticStructureSchema = [3, n0, _UWRR, 0, [_wDN, _wRI, _s], [[0, 1], [0, 1], 0]];
export var UpdateWorkflowRunResponse$: StaticStructureSchema = [3, n0, _UWRRp, 0, [], []];
...
var ActSummaries: StaticListSchema = [1, n0, _ASc, 0, () => ActSummary$];
var CallResultContents: StaticListSchema = [1, n0, _CRC, 0, [() => CallResultContent$, 0]];
var CallResults: StaticListSchema = [1, n0, _CRa, 0, [() => CallResult$, 0]];
var Calls: StaticListSchema = [1, n0, _Ca, 0, [() => Call$, 0]];
var ModelAliases: StaticListSchema = [1, n0, _MAo, 0, () => ModelAlias$];
var ModelIdList = 64 | 0;
var ModelSummaries: StaticListSchema = [1, n0, _MSo, 0, () => ModelSummary$];
var SessionSummaries: StaticListSchema = [1, n0, _SSes, 0, () => SessionSummary$];
var ToolSpecs: StaticListSchema = [1, n0, _TSo, 0, [() => ToolSpec$, 0]];
...
export var CreateWorkflowDefinition$: StaticOperationSchema = [
  9,
  n0,
  _CWD,
...
export var CreateWorkflowRun$: StaticOperationSchema = [
  9,
  n0,
  _CWR,
...
export var DeleteWorkflowDefinition$: StaticOperationSchema = [
  9,
  n0,
  _DWD,
...
export var DeleteWorkflowRun$: StaticOperationSchema = [
  9,
  n0,
  _DWR,
...
export var GetWorkflowDefinition$: StaticOperationSchema = [
  9,
  n0,
  _GWD,
...
export var InvokeActStep$: StaticOperationSchema = [
  9,
  n0,
  _IAS,
  {
...
export var ListActs$: StaticOperationSchema = [
  9,
  n0,
  _LA,
...
export var ListModels$: StaticOperationSchema = [
  9,
  n0,
  _LM,
  { [_h]: ["POST", "/models", 200] },
...
export var ListWorkflowDefinitions$: StaticOperationSchema = [
  9,
  n0,
  _LWD,
...
export var UpdateAct$: StaticOperationSchema = [
  9,
  n0,
  _UA,
  {
...
export var UpdateWorkflowRun$: StaticOperationSchema = [
  9,
  n0,
  _UWR,
