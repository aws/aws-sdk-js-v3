...
export const getRuntimeConfig = (config: IvsClientConfig) => {
  return {
    ...
    httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultIvsHttpAuthSchemeProvider,
    ...
    protocol: config?.protocol ?? new AwsRestJsonProtocol({ defaultNamespace: "com.amazonaws.ivs" }),
