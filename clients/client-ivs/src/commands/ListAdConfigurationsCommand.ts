 ...
 * @public
 */
export class ListAdConfigurationsCommand extends $Command
  .classBuilder<
  ...
  .s("AmazonInteractiveVideoService", "ListAdConfigurations", {})
  .n("IvsClient", "ListAdConfigurationsCommand")
  .sc(ListAdConfigurations$)
  .build() {
