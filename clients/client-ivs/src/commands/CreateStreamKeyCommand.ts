...
import type { CreateStreamKeyRequest, CreateStreamKeyResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateStreamKeyCommand extends command<CreateStreamKeyCommandInput, CreateStreamKeyCommandOutput>(
  _ep0,
  _mw0,
  "CreateStreamKey",
  CreateStreamKey$
