 ...
 * @public
 */
export class CreatePlaybackRestrictionPolicyCommand extends command<CreatePlaybackRestrictionPolicyCommandInput, CreatePlaybackRestrictionPolicyCommandOutput>(
  _ep0,
  _mw0,
