...
import type { SupportHttpAuthSchemeProvider } from "./httpAuthSchemeProvider";
...
export interface HttpAuthExtensionConfiguration {
  ...
  setHttpAuthSchemeProvider(httpAuthSchemeProvider: SupportHttpAuthSchemeProvider): void;
