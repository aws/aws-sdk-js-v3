...
export var AttachmentDetails$: StaticStructureSchema = [3, n0, _AD,
  0,
  [_aI, _fN],
  [0, 0]
];
...
export var SeverityLevel$: StaticStructureSchema = [3, n0, _SL,
  0,
  [_co, _n],
  [0, 0]
];
export var SupportedHour$: StaticStructureSchema = [3, n0, _SH,
  0,
  [_sT, _eTn],
  [0, 0]
];
export var SupportedLanguage$: StaticStructureSchema = [3, n0, _SLu,
  0,
  [_co, _l, _di],
  [0, 0, 0]
];
...
var AttachmentSet: StaticListSchema = [1, n0, _AS,
  0, () => AttachmentDetails$
];
var CaseIdList = 64 | 0;
var CaseList: StaticListSchema = [1, n0, _CL,
  0, () => CaseDetails$
];
...
var CommunicationList: StaticListSchema = [1, n0, _CLo,
  0, () => Communication$
];
...
var SeverityLevelsList: StaticListSchema = [1, n0, _SLL,
  0, () => SeverityLevel$
];
var StringList: StaticListSchema = [1, n0, _SLt,
  { [_sp]: 1 }, 0
];
var SupportedHoursList: StaticListSchema = [1, n0, _SHL,
  0, () => SupportedHour$
];
...
var TrustedAdvisorCheckRefreshStatusList: StaticListSchema = [1, n0, _TACRSL,
  0, () => TrustedAdvisorCheckRefreshStatus$
];
var TrustedAdvisorCheckSummaryList: StaticListSchema = [1, n0, _TACSL,
  0, () => TrustedAdvisorCheckSummary$
];
var TrustedAdvisorResourceDetailList: StaticListSchema = [1, n0, _TARDL,
...
export var DescribeCommunications$: StaticOperationSchema = [9, n0, _DCe,
  0, () => DescribeCommunicationsRequest$, () => DescribeCommunicationsResponse$
];
export var DescribeCreateCaseOptions$: StaticOperationSchema = [9, n0, _DCCO,
...
export var DescribeSeverityLevels$: StaticOperationSchema = [9, n0, _DSL,
  0, () => DescribeSeverityLevelsRequest$, () => DescribeSeverityLevelsResponse$
];
export var DescribeSupportedLanguages$: StaticOperationSchema = [9, n0, _DSLe,
  0, () => DescribeSupportedLanguagesRequest$, () => DescribeSupportedLanguagesResponse$
];
export var DescribeTrustedAdvisorCheckRefreshStatuses$: StaticOperationSchema = [9, n0, _DTACRS,
  0, () => DescribeTrustedAdvisorCheckRefreshStatusesRequest$, () => DescribeTrustedAdvisorCheckRefreshStatusesResponse$
];
export var DescribeTrustedAdvisorCheckResult$: StaticOperationSchema = [9, n0, _DTACRes,
  0, () => DescribeTrustedAdvisorCheckResultRequest$, () => DescribeTrustedAdvisorCheckResultResponse$
];
export var DescribeTrustedAdvisorChecks$: StaticOperationSchema = [9, n0, _DTAC,
...
export var ResolveCase$: StaticOperationSchema = [9, n0, _RC,
