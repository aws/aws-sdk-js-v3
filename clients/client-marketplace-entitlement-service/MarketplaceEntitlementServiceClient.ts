...
export type MarketplaceEntitlementServiceClientConfig = Partial<
...
export type MarketplaceEntitlementServiceClientResolvedConfig = __SmithyResolvedConfiguration<
