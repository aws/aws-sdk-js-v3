...
import {
  ...
  defaultMarketplaceEntitlementServiceHttpAuthSchemeParametersProvider,
  resolveHttpAuthSchemeConfig,
} from "./auth/httpAuthSchemeProvider";
import type { GetEntitlementsCommandInput, GetEntitlementsCommandOutput } from "./commands/GetEntitlementsCommand";
import {
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<MarketplaceEntitlementServiceClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultMarketplaceEntitlementServiceHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: MarketplaceEntitlementServiceClientResolvedConfig) =>
