...
import { type SecurityHubClientResolvedConfig, SecurityHubClientConfig } from "../SecurityHubClient";
 ...
 * @internal
 */
export const defaultSecurityHubHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SecurityHubHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultSecurityHubHttpAuthSchemeProvider: SecurityHubHttpAuthSchemeProvider = (authParameters) => {
