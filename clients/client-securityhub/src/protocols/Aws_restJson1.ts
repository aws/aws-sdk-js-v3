...
const se_AwsApiCallAction = (input: AwsApiCallAction, context: __SerdeContext): any => {
  return take(input, {
    AffectedResources: (_) => _json(_),
    Api: [],
    CallerType: [],
    DomainDetails: (_) => _json(_),
    FirstSeen: [],
    LastSeen: [],
...
const se_AwsApiGatewayMethodSettings = (input: AwsApiGatewayMethodSettings, context: __SerdeContext): any => {
  return take(input, {
    ...
    ThrottlingRateLimit: (_) => __serializeFloat(_),
...
const se_AwsCloudWatchAlarmDetails = (input: AwsCloudWatchAlarmDetails, context: __SerdeContext): any => {
  return take(input, {
    ...
    EvaluationPeriods: [],
    ExtendedStatistic: [],
    InsufficientDataActions: (_) => _json(_),
    MetricName: [],
    Namespace: [],
    OkActions: (_) => _json(_),
    Period: [],
...
const se_AwsEc2LaunchTemplateDataDetails = (input: AwsEc2LaunchTemplateDataDetails, context: __SerdeContext): any => {
  return take(input, {
    BlockDeviceMappingSet: (_) => _json(_),
    CapacityReservationSpecification: (_) => _json(_),
    CpuOptions: (_) => _json(_),
    CreditSpecification: (_) => _json(_),
    DisableApiStop: [],
    DisableApiTermination: [],
    EbsOptimized: [],
    ElasticGpuSpecificationSet: (_) => _json(_),
    ElasticInferenceAcceleratorSet: (_) => _json(_),
    EnclaveOptions: (_) => _json(_),
    HibernationOptions: (_) => _json(_),
    IamInstanceProfile: (_) => _json(_),
    ImageId: [],
    InstanceInitiatedShutdownBehavior: [],
    InstanceMarketOptions: (_) => _json(_),
    InstanceRequirements: (_) => se_AwsEc2LaunchTemplateDataInstanceRequirementsDetails(_, context),
    InstanceType: [],
    KernelId: [],
    KeyName: [],
    LicenseSet: (_) => _json(_),
    MaintenanceOptions: (_) => _json(_),
    MetadataOptions: (_) => _json(_),
    Monitoring: (_) => _json(_),
    NetworkInterfaceSet: (_) => _json(_),
    Placement: (_) => _json(_),
    PrivateDnsNameOptions: (_) => _json(_),
    RamDiskId: [],
    SecurityGroupIdSet: (_) => _json(_),
    SecurityGroupSet: (_) => _json(_),
    UserData: [],
  });
};
...
const se_AwsEc2LaunchTemplateDataInstanceRequirementsDetails = (
  ...
  return take(input, {
    AcceleratorCount: (_) => _json(_),
    AcceleratorManufacturers: (_) => _json(_),
    AcceleratorNames: (_) => _json(_),
    AcceleratorTotalMemoryMiB: (_) => _json(_),
    AcceleratorTypes: (_) => _json(_),
    BareMetal: [],
    BaselineEbsBandwidthMbps: (_) => _json(_),
    BurstablePerformance: [],
    CpuManufacturers: (_) => _json(_),
    ExcludedInstanceTypes: (_) => _json(_),
    InstanceGenerations: (_) => _json(_),
    LocalStorage: [],
    LocalStorageTypes: (_) => _json(_),
    MemoryGiBPerVCpu: (_) => se_AwsEc2LaunchTemplateDataInstanceRequirementsMemoryGiBPerVCpuDetails(_, context),
    MemoryMiB: (_) => _json(_),
    NetworkInterfaceCount: (_) => _json(_),
...
const se_AwsKmsKeyDetails = (input: AwsKmsKeyDetails, context: __SerdeContext): any => {
  return take(input, {
    AWSAccountId: [],
    CreationDate: (_) => __serializeFloat(_),
    Description: [],
    KeyId: [],
    KeyManager: [],
    KeyRotationStatus: [],
...
const se_AwsRedshiftClusterDetails = (input: AwsRedshiftClusterDetails, context: __SerdeContext): any => {
  return take(input, {
    ...
    ClusterCreateTime: [],
    ClusterIdentifier: [],
    ClusterNodes: (_) => _json(_),
    ClusterParameterGroups: (_) => _json(_),
    ClusterPublicKey: [],
    ClusterRevisionNumber: [],
    ClusterSecurityGroups: (_) => _json(_),
    ClusterSnapshotCopyStatus: (_) => _json(_),
    ClusterStatus: [],
    ClusterSubnetGroupName: [],
    ClusterVersion: [],
    DBName: [],
    DeferredMaintenanceWindows: (_) => _json(_),
    ElasticIpStatus: (_) => _json(_),
    ...
    NodeType: [],
    NumberOfNodes: [],
    PendingActions: (_) => _json(_),
    PendingModifiedValues: (_) => _json(_),
    PreferredMaintenanceWindow: [],
    PubliclyAccessible: [],
    ResizeInfo: (_) => _json(_),
    RestoreStatus: (_) => se_AwsRedshiftClusterRestoreStatus(_, context),
    SnapshotScheduleIdentifier: [],
    SnapshotScheduleState: [],
    VpcId: [],
    VpcSecurityGroups: (_) => _json(_),
  });
};
...
const se_AwsRedshiftClusterRestoreStatus = (input: AwsRedshiftClusterRestoreStatus, context: __SerdeContext): any => {
  return take(input, {
    CurrentRestoreRateInMegaBytesPerSecond: (_) => __serializeFloat(_),
...
const se_AwsSecurityFinding = (input: AwsSecurityFinding, context: __SerdeContext): any => {
  return take(input, {
    ...
    AwsAccountId: [],
    CompanyName: [],
    Compliance: (_) => _json(_),
    Confidence: [],
    CreatedAt: [],
    Criticality: [],
    Description: [],
    FindingProviderFields: (_) => _json(_),
    FirstObservedAt: [],
    GeneratorId: [],
    Id: [],
    LastObservedAt: [],
    Malware: (_) => _json(_),
    Network: (_) => _json(_),
    NetworkPath: (_) => _json(_),
    Note: (_) => _json(_),
    PatchSummary: (_) => _json(_),
    Process: (_) => _json(_),
    ProductArn: [],
    ProductFields: (_) => _json(_),
    ProductName: [],
    RecordState: [],
    Region: [],
    RelatedFindings: (_) => _json(_),
    Remediation: (_) => _json(_),
    Resources: (_) => se_ResourceList(_, context),
    Sample: [],
    SchemaVersion: [],
    Severity: (_) => se_Severity(_, context),
    SourceUrl: [],
    ThreatIntelIndicators: (_) => _json(_),
    Threats: (_) => _json(_),
    Title: [],
    Types: (_) => _json(_),
    UpdatedAt: [],
...
const se_AwsSecurityFindingFilters = (input: AwsSecurityFindingFilters, context: __SerdeContext): any => {
  return take(input, {
    AwsAccountId: (_) => _json(_),
    CompanyName: (_) => _json(_),
    ComplianceAssociatedStandardsId: (_) => _json(_),
    ComplianceSecurityControlId: (_) => _json(_),
    ComplianceStatus: (_) => _json(_),
    Confidence: (_) => se_NumberFilterList(_, context),
    CreatedAt: (_) => _json(_),
    Criticality: (_) => se_NumberFilterList(_, context),
    Description: (_) => _json(_),
    ...
    FindingProviderFieldsRelatedFindingsId: (_) => _json(_),
    FindingProviderFieldsRelatedFindingsProductArn: (_) => _json(_),
    FindingProviderFieldsSeverityLabel: (_) => _json(_),
    FindingProviderFieldsSeverityOriginal: (_) => _json(_),
    FindingProviderFieldsTypes: (_) => _json(_),
    FirstObservedAt: (_) => _json(_),
    GeneratorId: (_) => _json(_),
    Id: (_) => _json(_),
    Keyword: (_) => _json(_),
    LastObservedAt: (_) => _json(_),
    MalwareName: (_) => _json(_),
    MalwarePath: (_) => _json(_),
    MalwareState: (_) => _json(_),
    MalwareType: (_) => _json(_),
    NetworkDestinationDomain: (_) => _json(_),
    NetworkDestinationIpV4: (_) => _json(_),
    NetworkDestinationIpV6: (_) => _json(_),
    NetworkDestinationPort: (_) => se_NumberFilterList(_, context),
    NetworkDirection: (_) => _json(_),
    NetworkProtocol: (_) => _json(_),
    NetworkSourceDomain: (_) => _json(_),
    NetworkSourceIpV4: (_) => _json(_),
    NetworkSourceIpV6: (_) => _json(_),
    NetworkSourceMac: (_) => _json(_),
    NetworkSourcePort: (_) => se_NumberFilterList(_, context),
    NoteText: (_) => _json(_),
    NoteUpdatedAt: (_) => _json(_),
    NoteUpdatedBy: (_) => _json(_),
    ProcessLaunchedAt: (_) => _json(_),
    ProcessName: (_) => _json(_),
    ProcessParentPid: (_) => se_NumberFilterList(_, context),
    ProcessPath: (_) => _json(_),
    ProcessPid: (_) => se_NumberFilterList(_, context),
    ProcessTerminatedAt: (_) => _json(_),
    ProductArn: (_) => _json(_),
    ProductFields: (_) => _json(_),
    ProductName: (_) => _json(_),
    RecommendationText: (_) => _json(_),
    RecordState: (_) => _json(_),
    Region: (_) => _json(_),
    RelatedFindingsId: (_) => _json(_),
    RelatedFindingsProductArn: (_) => _json(_),
    ResourceAwsEc2InstanceIamInstanceProfileArn: (_) => _json(_),
    ResourceAwsEc2InstanceImageId: (_) => _json(_),
    ResourceAwsEc2InstanceIpV4Addresses: (_) => _json(_),
    ResourceAwsEc2InstanceIpV6Addresses: (_) => _json(_),
    ResourceAwsEc2InstanceKeyName: (_) => _json(_),
    ResourceAwsEc2InstanceLaunchedAt: (_) => _json(_),
    ResourceAwsEc2InstanceSubnetId: (_) => _json(_),
    ResourceAwsEc2InstanceType: (_) => _json(_),
    ResourceAwsEc2InstanceVpcId: (_) => _json(_),
    ResourceAwsIamAccessKeyCreatedAt: (_) => _json(_),
    ResourceAwsIamAccessKeyPrincipalName: (_) => _json(_),
    ResourceAwsIamAccessKeyStatus: (_) => _json(_),
    ResourceAwsIamAccessKeyUserName: (_) => _json(_),
    ResourceAwsIamUserUserName: (_) => _json(_),
    ResourceAwsS3BucketOwnerId: (_) => _json(_),
    ResourceAwsS3BucketOwnerName: (_) => _json(_),
    ResourceContainerImageId: (_) => _json(_),
    ResourceContainerImageName: (_) => _json(_),
    ResourceContainerLaunchedAt: (_) => _json(_),
    ResourceContainerName: (_) => _json(_),
    ResourceDetailsOther: (_) => _json(_),
    ResourceId: (_) => _json(_),
    ResourcePartition: (_) => _json(_),
    ResourceRegion: (_) => _json(_),
    ResourceTags: (_) => _json(_),
    ResourceType: (_) => _json(_),
    Sample: (_) => _json(_),
    SeverityLabel: (_) => _json(_),
    SeverityNormalized: (_) => se_NumberFilterList(_, context),
    SeverityProduct: (_) => se_NumberFilterList(_, context),
    SourceUrl: (_) => _json(_),
    ThreatIntelIndicatorCategory: (_) => _json(_),
    ThreatIntelIndicatorLastObservedAt: (_) => _json(_),
    ThreatIntelIndicatorSource: (_) => _json(_),
    ThreatIntelIndicatorSourceUrl: (_) => _json(_),
    ThreatIntelIndicatorType: (_) => _json(_),
    ThreatIntelIndicatorValue: (_) => _json(_),
    Title: (_) => _json(_),
    Type: (_) => _json(_),
    UpdatedAt: (_) => _json(_),
    UserDefinedFields: (_) => _json(_),
    VerificationState: (_) => _json(_),
    WorkflowState: (_) => _json(_),
    WorkflowStatus: (_) => _json(_),
  });
};
...
const se_Cvss = (input: Cvss, context: __SerdeContext): any => {
  return take(input, {
    Adjustments: (_) => _json(_),
    BaseScore: (_) => __serializeFloat(_),
    BaseVector: [],
    Source: [],
    Version: [],
  });
...
const se_NetworkConnectionAction = (input: NetworkConnectionAction, context: __SerdeContext): any => {
  return take(input, {
    Blocked: [],
    ConnectionDirection: [],
    LocalPortDetails: (_) => _json(_),
    Protocol: [],
    RemoteIpDetails: (_) => se_ActionRemoteIpDetails(_, context),
    RemotePortDetails: (_) => _json(_),
  });
};
...
const se_NumberFilter = (input: NumberFilter, context: __SerdeContext): any => {
  return take(input, {
    Eq: (_) => __serializeFloat(_),
    Gte: (_) => __serializeFloat(_),
    Lte: (_) => __serializeFloat(_),
  });
};
...
const se_ResourceDetails = (input: ResourceDetails, context: __SerdeContext): any => {
  return take(input, {
    AwsApiGatewayRestApi: (_) => _json(_),
    AwsApiGatewayStage: (_) => se_AwsApiGatewayStageDetails(_, context),
    AwsApiGatewayV2Api: (_) => _json(_),
    AwsApiGatewayV2Stage: (_) => se_AwsApiGatewayV2StageDetails(_, context),
    AwsAutoScalingAutoScalingGroup: (_) => _json(_),
    AwsAutoScalingLaunchConfiguration: (_) => _json(_),
    AwsBackupBackupPlan: (_) => _json(_),
    AwsBackupBackupVault: (_) => _json(_),
    AwsBackupRecoveryPoint: (_) => _json(_),
    AwsCertificateManagerCertificate: (_) => _json(_),
    AwsCloudFormationStack: (_) => _json(_),
    AwsCloudFrontDistribution: (_) => _json(_),
    AwsCloudTrailTrail: (_) => _json(_),
    AwsCloudWatchAlarm: (_) => se_AwsCloudWatchAlarmDetails(_, context),
    AwsCodeBuildProject: (_) => _json(_),
    AwsDynamoDbTable: (_) => _json(_),
    AwsEc2Eip: (_) => _json(_),
    AwsEc2Instance: (_) => _json(_),
    AwsEc2LaunchTemplate: (_) => se_AwsEc2LaunchTemplateDetails(_, context),
    AwsEc2NetworkAcl: (_) => _json(_),
    AwsEc2NetworkInterface: (_) => _json(_),
    AwsEc2RouteTable: (_) => _json(_),
    AwsEc2SecurityGroup: (_) => _json(_),
    AwsEc2Subnet: (_) => _json(_),
    AwsEc2TransitGateway: (_) => _json(_),
    AwsEc2Volume: (_) => _json(_),
    AwsEc2Vpc: (_) => _json(_),
    AwsEc2VpcEndpointService: (_) => _json(_),
    AwsEc2VpcPeeringConnection: (_) => _json(_),
    AwsEc2VpnConnection: (_) => _json(_),
    AwsEcrContainerImage: (_) => _json(_),
    AwsEcrRepository: (_) => _json(_),
    AwsEcsCluster: (_) => _json(_),
    AwsEcsContainer: (_) => _json(_),
    AwsEcsService: (_) => _json(_),
    AwsEcsTask: (_) => _json(_),
    AwsEcsTaskDefinition: (_) => _json(_),
    AwsEfsAccessPoint: (_) => _json(_),
    AwsEksCluster: (_) => _json(_),
    AwsElasticBeanstalkEnvironment: (_) => _json(_),
    AwsElasticsearchDomain: (_) => _json(_),
    AwsElbLoadBalancer: (_) => _json(_),
    AwsElbv2LoadBalancer: (_) => _json(_),
    AwsIamAccessKey: (_) => _json(_),
    AwsIamGroup: (_) => _json(_),
    AwsIamPolicy: (_) => _json(_),
    AwsIamRole: (_) => _json(_),
    AwsIamUser: (_) => _json(_),
    AwsKinesisStream: (_) => _json(_),
    AwsKmsKey: (_) => se_AwsKmsKeyDetails(_, context),
    AwsLambdaFunction: (_) => _json(_),
    AwsLambdaLayerVersion: (_) => _json(_),
    AwsNetworkFirewallFirewall: (_) => _json(_),
    AwsNetworkFirewallFirewallPolicy: (_) => _json(_),
    AwsNetworkFirewallRuleGroup: (_) => se_AwsNetworkFirewallRuleGroupDetails(_, context),
    AwsOpenSearchServiceDomain: (_) => _json(_),
    AwsRdsDbCluster: (_) => _json(_),
    AwsRdsDbClusterSnapshot: (_) => _json(_),
    AwsRdsDbInstance: (_) => _json(_),
    AwsRdsDbSecurityGroup: (_) => _json(_),
    AwsRdsDbSnapshot: (_) => _json(_),
    AwsRdsEventSubscription: (_) => _json(_),
    AwsRedshiftCluster: (_) => se_AwsRedshiftClusterDetails(_, context),
    AwsS3AccountPublicAccessBlock: (_) => _json(_),
    AwsS3Bucket: (_) => _json(_),
    AwsS3Object: (_) => _json(_),
    AwsSageMakerNotebookInstance: (_) => _json(_),
    AwsSecretsManagerSecret: (_) => _json(_),
    AwsSnsTopic: (_) => _json(_),
    AwsSqsQueue: (_) => _json(_),
    AwsSsmPatchCompliance: (_) => _json(_),
    AwsWafRateBasedRule: (_) => _json(_),
    AwsWafRegionalRateBasedRule: (_) => _json(_),
    AwsWafRegionalRule: (_) => _json(_),
    AwsWafRegionalRuleGroup: (_) => _json(_),
    AwsWafRegionalWebAcl: (_) => _json(_),
    AwsWafRule: (_) => _json(_),
    AwsWafRuleGroup: (_) => _json(_),
    AwsWafWebAcl: (_) => _json(_),
    AwsWafv2RuleGroup: (_) => _json(_),
    AwsWafv2WebAcl: (_) => _json(_),
    AwsXrayEncryptionConfig: (_) => _json(_),
    Container: (_) => _json(_),
    Other: (_) => _json(_),
  });
};
...
const se_Vulnerability = (input: Vulnerability, context: __SerdeContext): any => {
  return take(input, {
    ...
    FixAvailable: [],
    Id: [],
    ReferenceUrls: (_) => _json(_),
    RelatedVulnerabilities: (_) => _json(_),
    Vendor: (_) => _json(_),
    VulnerablePackages: (_) => _json(_),
  });
};
