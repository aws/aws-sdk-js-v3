 ...
 * @public
 */
export class GetConfigurationPolicyAssociationCommand extends command<GetConfigurationPolicyAssociationCommandInput, GetConfigurationPolicyAssociationCommandOutput>(
  _ep0,
  _mw0,
