 ...
 * @public
 */
export class DisableImportFindingsForProductCommand extends command<DisableImportFindingsForProductCommandInput, DisableImportFindingsForProductCommandOutput>(
  _ep0,
  _mw0,
