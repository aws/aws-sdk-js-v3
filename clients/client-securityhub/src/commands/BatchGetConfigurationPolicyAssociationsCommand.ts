 ...
 * @public
 */
export class BatchGetConfigurationPolicyAssociationsCommand extends command<BatchGetConfigurationPolicyAssociationsCommandInput, BatchGetConfigurationPolicyAssociationsCommandOutput>(
  _ep0,
  _mw0,
