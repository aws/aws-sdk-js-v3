...
import { DeleteActionTarget$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteActionTargetCommand extends command<DeleteActionTargetCommandInput, DeleteActionTargetCommandOutput>(
  _ep0,
  _mw0,
  "DeleteActionTarget",
  DeleteActionTarget$
