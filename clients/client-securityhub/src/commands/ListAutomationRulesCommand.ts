...
import type { ListAutomationRulesRequest, ListAutomationRulesResponse } from "../models/models_3";
 ...
 * @public
 */
export class ListAutomationRulesCommand extends command<ListAutomationRulesCommandInput, ListAutomationRulesCommandOutput>(
  _ep0,
  _mw0,
  "ListAutomationRules",
  ListAutomationRules$
