 ...
 * @public
 */
export class StartConfigurationPolicyAssociationCommand extends command<StartConfigurationPolicyAssociationCommandInput, StartConfigurationPolicyAssociationCommandOutput>(
  _ep0,
  _mw0,
