 ...
 * @public
 */
export class GetFindingStatisticsV2Command extends command<GetFindingStatisticsV2CommandInput, GetFindingStatisticsV2CommandOutput>(
  _ep0,
  _mw0,
