 ...
 * ```
 *
 * @param BatchGetStandardsControlAssociationsRequest - {@link BatchGetStandardsControlAssociationsRequest}
 * @returns {@link BatchGetStandardsControlAssociationsResponse}
