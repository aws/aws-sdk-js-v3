...
export async function serializeAws_restJson1_1BatchDisableStandardsCommand(
  ...
  if (input.StandardsSubscriptionArns !== undefined) {
    bodyParams['StandardsSubscriptionArns'] = serializeAws_restJson1_1StandardsSubscriptionArns(input.StandardsSubscriptionArns, context);
  }
  body = JSON.stringify(bodyParams);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_restJson1_1BatchEnableStandardsCommand(
  ...
  if (input.StandardsSubscriptionRequests !== undefined) {
    bodyParams['StandardsSubscriptionRequests'] = serializeAws_restJson1_1StandardsSubscriptionRequests(input.StandardsSubscriptionRequests, context);
  }
  body = JSON.stringify(bodyParams);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_restJson1_1BatchImportFindingsCommand(
  ...
  if (input.Findings !== undefined) {
    bodyParams['Findings'] = serializeAws_restJson1_1AwsSecurityFindingList(input.Findings, context);
  }
  body = JSON.stringify(bodyParams);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_restJson1_1CreateInsightCommand(
  ...
  if (input.Filters !== undefined) {
    bodyParams['Filters'] = serializeAws_restJson1_1AwsSecurityFindingFilters(input.Filters, context);
  }
...
export async function serializeAws_restJson1_1CreateMembersCommand(
  ...
  if (input.AccountDetails !== undefined) {
    bodyParams['AccountDetails'] = serializeAws_restJson1_1AccountDetailsList(input.AccountDetails, context);
  }
  body = JSON.stringify(bodyParams);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_restJson1_1DescribeActionTargetsCommand(
  ...
  if (input.ActionTargetArns !== undefined) {
    bodyParams['ActionTargetArns'] = serializeAws_restJson1_1ArnList(input.ActionTargetArns, context);
  }
...
export async function serializeAws_restJson1_1GetInsightsCommand(
  ...
  if (input.InsightArns !== undefined) {
    bodyParams['InsightArns'] = serializeAws_restJson1_1ArnList(input.InsightArns, context);
  }
  if (input.MaxResults !== undefined) {
    bodyParams['MaxResults'] = input.MaxResults;
  }
...
export async function serializeAws_restJson1_1UpdateFindingsCommand(
  ...
  if (input.Note !== undefined) {
    bodyParams['Note'] = serializeAws_restJson1_1NoteUpdate(input.Note, context);
  }
...
async function deserializeAws_restJson1_1AcceptInvitationCommandError(
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.securityhub#InvalidAccessException":
      response = await deserializeAws_restJson1_1InvalidAccessExceptionResponse(parsedOutput, context);
      break;
...
export async function deserializeAws_restJson1_1BatchDisableStandardsCommand(
  ...
  if (data.StandardsSubscriptions !== undefined) {
    contents.StandardsSubscriptions = deserializeAws_restJson1_1StandardsSubscriptions(data.StandardsSubscriptions, context);
  }
  return Promise.resolve(contents);
}
...
export async function deserializeAws_restJson1_1BatchImportFindingsCommand(
  ...
  if (data.FailedFindings !== undefined) {
    contents.FailedFindings = deserializeAws_restJson1_1ImportFindingsErrorList(data.FailedFindings, context);
  }
...
export async function deserializeAws_restJson1_1CreateMembersCommand(
  ...
  if (data.UnprocessedAccounts !== undefined) {
    contents.UnprocessedAccounts = deserializeAws_restJson1_1ResultList(data.UnprocessedAccounts, context);
  }
  return Promise.resolve(contents);
}
...
export async function deserializeAws_restJson1_1DescribeActionTargetsCommand(
  ...
  if (data.ActionTargets !== undefined) {
    contents.ActionTargets = deserializeAws_restJson1_1ActionTargetList(data.ActionTargets, context);
  }
...
export async function deserializeAws_restJson1_1GetInsightResultsCommand(
  ...
  if (data.InsightResults !== undefined) {
    contents.InsightResults = deserializeAws_restJson1_1InsightResults(data.InsightResults, context);
  }
  return Promise.resolve(contents);
}
...
export async function deserializeAws_restJson1_1ListEnabledProductsForImportCommand(
  ...
  if (data.ProductSubscriptions !== undefined) {
    contents.ProductSubscriptions = deserializeAws_restJson1_1ProductSubscriptionArnList(data.ProductSubscriptions, context);
  }
  return Promise.resolve(contents);
}
...
const serializeAws_restJson1_1AwsEc2InstanceDetails = (
  ...
  if (input.IpV4Addresses !== undefined) {
    bodyParams['IpV4Addresses'] = serializeAws_restJson1_1StringList(input.IpV4Addresses, context);
  }
  if (input.IpV6Addresses !== undefined) {
    bodyParams['IpV6Addresses'] = serializeAws_restJson1_1StringList(input.IpV6Addresses, context);
  }
...
const serializeAws_restJson1_1AwsSecurityFinding = (
  ...
  if (input.Compliance !== undefined) {
    bodyParams['Compliance'] = serializeAws_restJson1_1Compliance(input.Compliance, context);
  }
  ...
  if (input.Malware !== undefined) {
    bodyParams['Malware'] = serializeAws_restJson1_1MalwareList(input.Malware, context);
  }
  if (input.Network !== undefined) {
    bodyParams['Network'] = serializeAws_restJson1_1Network(input.Network, context);
  }
  if (input.Note !== undefined) {
    bodyParams['Note'] = serializeAws_restJson1_1Note(input.Note, context);
  }
  if (input.Process !== undefined) {
    bodyParams['Process'] = serializeAws_restJson1_1ProcessDetails(input.Process, context);
  }
  if (input.ProductArn !== undefined) {
    bodyParams['ProductArn'] = input.ProductArn;
  }
  if (input.ProductFields !== undefined) {
    bodyParams['ProductFields'] = serializeAws_restJson1_1FieldMap(input.ProductFields, context);
  }
  if (input.RecordState !== undefined) {
    bodyParams['RecordState'] = input.RecordState;
  }
  if (input.RelatedFindings !== undefined) {
    bodyParams['RelatedFindings'] = serializeAws_restJson1_1RelatedFindingList(input.RelatedFindings, context);
  }
  if (input.Remediation !== undefined) {
    bodyParams['Remediation'] = serializeAws_restJson1_1Remediation(input.Remediation, context);
  }
  if (input.Resources !== undefined) {
    bodyParams['Resources'] = serializeAws_restJson1_1ResourceList(input.Resources, context);
  }
  if (input.SchemaVersion !== undefined) {
    bodyParams['SchemaVersion'] = input.SchemaVersion;
  }
  if (input.Severity !== undefined) {
    bodyParams['Severity'] = serializeAws_restJson1_1Severity(input.Severity, context);
  }
  if (input.SourceUrl !== undefined) {
    bodyParams['SourceUrl'] = input.SourceUrl;
  }
  if (input.ThreatIntelIndicators !== undefined) {
    bodyParams['ThreatIntelIndicators'] = serializeAws_restJson1_1ThreatIntelIndicatorList(input.ThreatIntelIndicators, context);
  }
  if (input.Title !== undefined) {
    bodyParams['Title'] = input.Title;
  }
  if (input.Types !== undefined) {
    bodyParams['Types'] = serializeAws_restJson1_1TypeList(input.Types, context);
  }
  if (input.UpdatedAt !== undefined) {
    bodyParams['UpdatedAt'] = input.UpdatedAt;
  }
  if (input.UserDefinedFields !== undefined) {
    bodyParams['UserDefinedFields'] = serializeAws_restJson1_1FieldMap(input.UserDefinedFields, context);
  }
...
const serializeAws_restJson1_1AwsSecurityFindingFilters = (
  ...
  let bodyParams: any = {};
  if (input.AwsAccountId !== undefined) {
    bodyParams['AwsAccountId'] = serializeAws_restJson1_1StringFilterList(input.AwsAccountId, context);
  }
  if (input.CompanyName !== undefined) {
    bodyParams['CompanyName'] = serializeAws_restJson1_1StringFilterList(input.CompanyName, context);
  }
  if (input.ComplianceStatus !== undefined) {
    bodyParams['ComplianceStatus'] = serializeAws_restJson1_1StringFilterList(input.ComplianceStatus, context);
  }
  if (input.Confidence !== undefined) {
    bodyParams['Confidence'] = serializeAws_restJson1_1NumberFilterList(input.Confidence, context);
  }
  if (input.CreatedAt !== undefined) {
    bodyParams['CreatedAt'] = serializeAws_restJson1_1DateFilterList(input.CreatedAt, context);
  }
  if (input.Criticality !== undefined) {
    bodyParams['Criticality'] = serializeAws_restJson1_1NumberFilterList(input.Criticality, context);
  }
  if (input.Description !== undefined) {
    bodyParams['Description'] = serializeAws_restJson1_1StringFilterList(input.Description, context);
  }
  if (input.FirstObservedAt !== undefined) {
    bodyParams['FirstObservedAt'] = serializeAws_restJson1_1DateFilterList(input.FirstObservedAt, context);
  }
  if (input.GeneratorId !== undefined) {
    bodyParams['GeneratorId'] = serializeAws_restJson1_1StringFilterList(input.GeneratorId, context);
  }
  if (input.Id !== undefined) {
    bodyParams['Id'] = serializeAws_restJson1_1StringFilterList(input.Id, context);
  }
  if (input.Keyword !== undefined) {
    bodyParams['Keyword'] = serializeAws_restJson1_1KeywordFilterList(input.Keyword, context);
  }
  if (input.LastObservedAt !== undefined) {
    bodyParams['LastObservedAt'] = serializeAws_restJson1_1DateFilterList(input.LastObservedAt, context);
  }
  if (input.MalwareName !== undefined) {
    bodyParams['MalwareName'] = serializeAws_restJson1_1StringFilterList(input.MalwareName, context);
  }
  if (input.MalwarePath !== undefined) {
    bodyParams['MalwarePath'] = serializeAws_restJson1_1StringFilterList(input.MalwarePath, context);
  }
  if (input.MalwareState !== undefined) {
    bodyParams['MalwareState'] = serializeAws_restJson1_1StringFilterList(input.MalwareState, context);
  }
  if (input.MalwareType !== undefined) {
    bodyParams['MalwareType'] = serializeAws_restJson1_1StringFilterList(input.MalwareType, context);
  }
  if (input.NetworkDestinationDomain !== undefined) {
    bodyParams['NetworkDestinationDomain'] = serializeAws_restJson1_1StringFilterList(input.NetworkDestinationDomain, context);
  }
  if (input.NetworkDestinationIpV4 !== undefined) {
    bodyParams['NetworkDestinationIpV4'] = serializeAws_restJson1_1IpFilterList(input.NetworkDestinationIpV4, context);
  }
  if (input.NetworkDestinationIpV6 !== undefined) {
    bodyParams['NetworkDestinationIpV6'] = serializeAws_restJson1_1IpFilterList(input.NetworkDestinationIpV6, context);
  }
  if (input.NetworkDestinationPort !== undefined) {
    bodyParams['NetworkDestinationPort'] = serializeAws_restJson1_1NumberFilterList(input.NetworkDestinationPort, context);
  }
  if (input.NetworkDirection !== undefined) {
    bodyParams['NetworkDirection'] = serializeAws_restJson1_1StringFilterList(input.NetworkDirection, context);
  }
  if (input.NetworkProtocol !== undefined) {
    bodyParams['NetworkProtocol'] = serializeAws_restJson1_1StringFilterList(input.NetworkProtocol, context);
  }
  if (input.NetworkSourceDomain !== undefined) {
    bodyParams['NetworkSourceDomain'] = serializeAws_restJson1_1StringFilterList(input.NetworkSourceDomain, context);
  }
  if (input.NetworkSourceIpV4 !== undefined) {
    bodyParams['NetworkSourceIpV4'] = serializeAws_restJson1_1IpFilterList(input.NetworkSourceIpV4, context);
  }
  if (input.NetworkSourceIpV6 !== undefined) {
    bodyParams['NetworkSourceIpV6'] = serializeAws_restJson1_1IpFilterList(input.NetworkSourceIpV6, context);
  }
  if (input.NetworkSourceMac !== undefined) {
    bodyParams['NetworkSourceMac'] = serializeAws_restJson1_1StringFilterList(input.NetworkSourceMac, context);
  }
  if (input.NetworkSourcePort !== undefined) {
    bodyParams['NetworkSourcePort'] = serializeAws_restJson1_1NumberFilterList(input.NetworkSourcePort, context);
  }
  if (input.NoteText !== undefined) {
    bodyParams['NoteText'] = serializeAws_restJson1_1StringFilterList(input.NoteText, context);
  }
  if (input.NoteUpdatedAt !== undefined) {
    bodyParams['NoteUpdatedAt'] = serializeAws_restJson1_1DateFilterList(input.NoteUpdatedAt, context);
  }
  if (input.NoteUpdatedBy !== undefined) {
    bodyParams['NoteUpdatedBy'] = serializeAws_restJson1_1StringFilterList(input.NoteUpdatedBy, context);
  }
  if (input.ProcessLaunchedAt !== undefined) {
    bodyParams['ProcessLaunchedAt'] = serializeAws_restJson1_1DateFilterList(input.ProcessLaunchedAt, context);
  }
  if (input.ProcessName !== undefined) {
    bodyParams['ProcessName'] = serializeAws_restJson1_1StringFilterList(input.ProcessName, context);
  }
  if (input.ProcessParentPid !== undefined) {
    bodyParams['ProcessParentPid'] = serializeAws_restJson1_1NumberFilterList(input.ProcessParentPid, context);
  }
  if (input.ProcessPath !== undefined) {
    bodyParams['ProcessPath'] = serializeAws_restJson1_1StringFilterList(input.ProcessPath, context);
  }
  if (input.ProcessPid !== undefined) {
    bodyParams['ProcessPid'] = serializeAws_restJson1_1NumberFilterList(input.ProcessPid, context);
  }
  if (input.ProcessTerminatedAt !== undefined) {
    bodyParams['ProcessTerminatedAt'] = serializeAws_restJson1_1DateFilterList(input.ProcessTerminatedAt, context);
  }
  if (input.ProductArn !== undefined) {
    bodyParams['ProductArn'] = serializeAws_restJson1_1StringFilterList(input.ProductArn, context);
  }
  if (input.ProductFields !== undefined) {
    bodyParams['ProductFields'] = serializeAws_restJson1_1MapFilterList(input.ProductFields, context);
  }
  if (input.ProductName !== undefined) {
    bodyParams['ProductName'] = serializeAws_restJson1_1StringFilterList(input.ProductName, context);
  }
  if (input.RecommendationText !== undefined) {
    bodyParams['RecommendationText'] = serializeAws_restJson1_1StringFilterList(input.RecommendationText, context);
  }
  if (input.RecordState !== undefined) {
    bodyParams['RecordState'] = serializeAws_restJson1_1StringFilterList(input.RecordState, context);
  }
  if (input.RelatedFindingsId !== undefined) {
    bodyParams['RelatedFindingsId'] = serializeAws_restJson1_1StringFilterList(input.RelatedFindingsId, context);
  }
  if (input.RelatedFindingsProductArn !== undefined) {
    bodyParams['RelatedFindingsProductArn'] = serializeAws_restJson1_1StringFilterList(input.RelatedFindingsProductArn, context);
  }
  if (input.ResourceAwsEc2InstanceIamInstanceProfileArn !== undefined) {
    bodyParams['ResourceAwsEc2InstanceIamInstanceProfileArn'] = serializeAws_restJson1_1StringFilterList(input.ResourceAwsEc2InstanceIamInstanceProfileArn, context);
  }
  if (input.ResourceAwsEc2InstanceImageId !== undefined) {
    bodyParams['ResourceAwsEc2InstanceImageId'] = serializeAws_restJson1_1StringFilterList(input.ResourceAwsEc2InstanceImageId, context);
  }
  if (input.ResourceAwsEc2InstanceIpV4Addresses !== undefined) {
    bodyParams['ResourceAwsEc2InstanceIpV4Addresses'] = serializeAws_restJson1_1IpFilterList(input.ResourceAwsEc2InstanceIpV4Addresses, context);
  }
  if (input.ResourceAwsEc2InstanceIpV6Addresses !== undefined) {
    bodyParams['ResourceAwsEc2InstanceIpV6Addresses'] = serializeAws_restJson1_1IpFilterList(input.ResourceAwsEc2InstanceIpV6Addresses, context);
  }
  if (input.ResourceAwsEc2InstanceKeyName !== undefined) {
    bodyParams['ResourceAwsEc2InstanceKeyName'] = serializeAws_restJson1_1StringFilterList(input.ResourceAwsEc2InstanceKeyName, context);
  }
  if (input.ResourceAwsEc2InstanceLaunchedAt !== undefined) {
    bodyParams['ResourceAwsEc2InstanceLaunchedAt'] = serializeAws_restJson1_1DateFilterList(input.ResourceAwsEc2InstanceLaunchedAt, context);
  }
  if (input.ResourceAwsEc2InstanceSubnetId !== undefined) {
    bodyParams['ResourceAwsEc2InstanceSubnetId'] = serializeAws_restJson1_1StringFilterList(input.ResourceAwsEc2InstanceSubnetId, context);
  }
  if (input.ResourceAwsEc2InstanceType !== undefined) {
    bodyParams['ResourceAwsEc2InstanceType'] = serializeAws_restJson1_1StringFilterList(input.ResourceAwsEc2InstanceType, context);
  }
  if (input.ResourceAwsEc2InstanceVpcId !== undefined) {
    bodyParams['ResourceAwsEc2InstanceVpcId'] = serializeAws_restJson1_1StringFilterList(input.ResourceAwsEc2InstanceVpcId, context);
  }
  if (input.ResourceAwsIamAccessKeyCreatedAt !== undefined) {
    bodyParams['ResourceAwsIamAccessKeyCreatedAt'] = serializeAws_restJson1_1DateFilterList(input.ResourceAwsIamAccessKeyCreatedAt, context);
  }
  if (input.ResourceAwsIamAccessKeyStatus !== undefined) {
    bodyParams['ResourceAwsIamAccessKeyStatus'] = serializeAws_restJson1_1StringFilterList(input.ResourceAwsIamAccessKeyStatus, context);
  }
  if (input.ResourceAwsIamAccessKeyUserName !== undefined) {
    bodyParams['ResourceAwsIamAccessKeyUserName'] = serializeAws_restJson1_1StringFilterList(input.ResourceAwsIamAccessKeyUserName, context);
  }
  if (input.ResourceAwsS3BucketOwnerId !== undefined) {
    bodyParams['ResourceAwsS3BucketOwnerId'] = serializeAws_restJson1_1StringFilterList(input.ResourceAwsS3BucketOwnerId, context);
  }
  if (input.ResourceAwsS3BucketOwnerName !== undefined) {
    bodyParams['ResourceAwsS3BucketOwnerName'] = serializeAws_restJson1_1StringFilterList(input.ResourceAwsS3BucketOwnerName, context);
  }
  if (input.ResourceContainerImageId !== undefined) {
    bodyParams['ResourceContainerImageId'] = serializeAws_restJson1_1StringFilterList(input.ResourceContainerImageId, context);
  }
  if (input.ResourceContainerImageName !== undefined) {
    bodyParams['ResourceContainerImageName'] = serializeAws_restJson1_1StringFilterList(input.ResourceContainerImageName, context);
  }
  if (input.ResourceContainerLaunchedAt !== undefined) {
    bodyParams['ResourceContainerLaunchedAt'] = serializeAws_restJson1_1DateFilterList(input.ResourceContainerLaunchedAt, context);
  }
  if (input.ResourceContainerName !== undefined) {
    bodyParams['ResourceContainerName'] = serializeAws_restJson1_1StringFilterList(input.ResourceContainerName, context);
  }
  if (input.ResourceDetailsOther !== undefined) {
    bodyParams['ResourceDetailsOther'] = serializeAws_restJson1_1MapFilterList(input.ResourceDetailsOther, context);
  }
  if (input.ResourceId !== undefined) {
    bodyParams['ResourceId'] = serializeAws_restJson1_1StringFilterList(input.ResourceId, context);
  }
  if (input.ResourcePartition !== undefined) {
    bodyParams['ResourcePartition'] = serializeAws_restJson1_1StringFilterList(input.ResourcePartition, context);
  }
  if (input.ResourceRegion !== undefined) {
    bodyParams['ResourceRegion'] = serializeAws_restJson1_1StringFilterList(input.ResourceRegion, context);
  }
  if (input.ResourceTags !== undefined) {
    bodyParams['ResourceTags'] = serializeAws_restJson1_1MapFilterList(input.ResourceTags, context);
  }
  if (input.ResourceType !== undefined) {
    bodyParams['ResourceType'] = serializeAws_restJson1_1StringFilterList(input.ResourceType, context);
  }
  if (input.SeverityLabel !== undefined) {
    bodyParams['SeverityLabel'] = serializeAws_restJson1_1StringFilterList(input.SeverityLabel, context);
  }
  if (input.SeverityNormalized !== undefined) {
    bodyParams['SeverityNormalized'] = serializeAws_restJson1_1NumberFilterList(input.SeverityNormalized, context);
  }
  if (input.SeverityProduct !== undefined) {
    bodyParams['SeverityProduct'] = serializeAws_restJson1_1NumberFilterList(input.SeverityProduct, context);
  }
  if (input.SourceUrl !== undefined) {
    bodyParams['SourceUrl'] = serializeAws_restJson1_1StringFilterList(input.SourceUrl, context);
  }
  if (input.ThreatIntelIndicatorCategory !== undefined) {
    bodyParams['ThreatIntelIndicatorCategory'] = serializeAws_restJson1_1StringFilterList(input.ThreatIntelIndicatorCategory, context);
  }
  if (input.ThreatIntelIndicatorLastObservedAt !== undefined) {
    bodyParams['ThreatIntelIndicatorLastObservedAt'] = serializeAws_restJson1_1DateFilterList(input.ThreatIntelIndicatorLastObservedAt, context);
  }
  if (input.ThreatIntelIndicatorSource !== undefined) {
    bodyParams['ThreatIntelIndicatorSource'] = serializeAws_restJson1_1StringFilterList(input.ThreatIntelIndicatorSource, context);
  }
  if (input.ThreatIntelIndicatorSourceUrl !== undefined) {
    bodyParams['ThreatIntelIndicatorSourceUrl'] = serializeAws_restJson1_1StringFilterList(input.ThreatIntelIndicatorSourceUrl, context);
  }
  if (input.ThreatIntelIndicatorType !== undefined) {
    bodyParams['ThreatIntelIndicatorType'] = serializeAws_restJson1_1StringFilterList(input.ThreatIntelIndicatorType, context);
  }
  if (input.ThreatIntelIndicatorValue !== undefined) {
    bodyParams['ThreatIntelIndicatorValue'] = serializeAws_restJson1_1StringFilterList(input.ThreatIntelIndicatorValue, context);
  }
  if (input.Title !== undefined) {
    bodyParams['Title'] = serializeAws_restJson1_1StringFilterList(input.Title, context);
  }
  if (input.Type !== undefined) {
    bodyParams['Type'] = serializeAws_restJson1_1StringFilterList(input.Type, context);
  }
  if (input.UpdatedAt !== undefined) {
    bodyParams['UpdatedAt'] = serializeAws_restJson1_1DateFilterList(input.UpdatedAt, context);
  }
  if (input.UserDefinedFields !== undefined) {
    bodyParams['UserDefinedFields'] = serializeAws_restJson1_1MapFilterList(input.UserDefinedFields, context);
  }
  if (input.VerificationState !== undefined) {
    bodyParams['VerificationState'] = serializeAws_restJson1_1StringFilterList(input.VerificationState, context);
  }
  if (input.WorkflowState !== undefined) {
    bodyParams['WorkflowState'] = serializeAws_restJson1_1StringFilterList(input.WorkflowState, context);
  }
  return bodyParams;
}
...
const serializeAws_restJson1_1DateFilter = (
  ...
  if (input.DateRange !== undefined) {
    bodyParams['DateRange'] = serializeAws_restJson1_1DateRange(input.DateRange, context);
  }
...
const serializeAws_restJson1_1Remediation = (
  ...
  if (input.Recommendation !== undefined) {
    bodyParams['Recommendation'] = serializeAws_restJson1_1Recommendation(input.Recommendation, context);
  }
  return bodyParams;
}
...
const serializeAws_restJson1_1Resource = (
  ...
  if (input.Details !== undefined) {
    bodyParams['Details'] = serializeAws_restJson1_1ResourceDetails(input.Details, context);
  }
  if (input.Id !== undefined) {
    bodyParams['Id'] = input.Id;
  }
...
const serializeAws_restJson1_1ResourceDetails = (
  ...
  if (input.AwsEc2Instance !== undefined) {
    bodyParams['AwsEc2Instance'] = serializeAws_restJson1_1AwsEc2InstanceDetails(input.AwsEc2Instance, context);
  }
  if (input.AwsIamAccessKey !== undefined) {
    bodyParams['AwsIamAccessKey'] = serializeAws_restJson1_1AwsIamAccessKeyDetails(input.AwsIamAccessKey, context);
  }
  if (input.AwsS3Bucket !== undefined) {
    bodyParams['AwsS3Bucket'] = serializeAws_restJson1_1AwsS3BucketDetails(input.AwsS3Bucket, context);
  }
  if (input.Container !== undefined) {
    bodyParams['Container'] = serializeAws_restJson1_1ContainerDetails(input.Container, context);
  }
  if (input.Other !== undefined) {
    bodyParams['Other'] = serializeAws_restJson1_1FieldMap(input.Other, context);
  }
  return bodyParams;
}
...
const serializeAws_restJson1_1StandardsSubscriptionRequest = (
  ...
  if (input.StandardsInput !== undefined) {
    bodyParams['StandardsInput'] = serializeAws_restJson1_1StandardsInputParameterMap(input.StandardsInput, context);
  }
  return bodyParams;
}
...
const deserializeAws_restJson1_1AwsEc2InstanceDetails = (
  ...
  if (output.IpV4Addresses !== undefined) {
    contents.IpV4Addresses = deserializeAws_restJson1_1StringList(output.IpV4Addresses, context);
  }
  if (output.IpV6Addresses !== undefined) {
    contents.IpV6Addresses = deserializeAws_restJson1_1StringList(output.IpV6Addresses, context);
  }
...
const deserializeAws_restJson1_1AwsSecurityFinding = (
  ...
  if (output.Compliance !== undefined) {
    contents.Compliance = deserializeAws_restJson1_1Compliance(output.Compliance, context);
  }
  ...
  if (output.Malware !== undefined) {
    contents.Malware = deserializeAws_restJson1_1MalwareList(output.Malware, context);
  }
  if (output.Network !== undefined) {
    contents.Network = deserializeAws_restJson1_1Network(output.Network, context);
  }
  if (output.Note !== undefined) {
    contents.Note = deserializeAws_restJson1_1Note(output.Note, context);
  }
  if (output.Process !== undefined) {
    contents.Process = deserializeAws_restJson1_1ProcessDetails(output.Process, context);
  }
  if (output.ProductArn !== undefined) {
    contents.ProductArn = output.ProductArn;
  }
  if (output.ProductFields !== undefined) {
    contents.ProductFields = deserializeAws_restJson1_1FieldMap(output.ProductFields, context);
  }
  if (output.RecordState !== undefined) {
    contents.RecordState = output.RecordState;
  }
  if (output.RelatedFindings !== undefined) {
    contents.RelatedFindings = deserializeAws_restJson1_1RelatedFindingList(output.RelatedFindings, context);
  }
  if (output.Remediation !== undefined) {
    contents.Remediation = deserializeAws_restJson1_1Remediation(output.Remediation, context);
  }
  if (output.Resources !== undefined) {
    contents.Resources = deserializeAws_restJson1_1ResourceList(output.Resources, context);
  }
  if (output.SchemaVersion !== undefined) {
    contents.SchemaVersion = output.SchemaVersion;
  }
  if (output.Severity !== undefined) {
    contents.Severity = deserializeAws_restJson1_1Severity(output.Severity, context);
  }
  if (output.SourceUrl !== undefined) {
    contents.SourceUrl = output.SourceUrl;
  }
  if (output.ThreatIntelIndicators !== undefined) {
    contents.ThreatIntelIndicators = deserializeAws_restJson1_1ThreatIntelIndicatorList(output.ThreatIntelIndicators, context);
  }
  ...
  if (output.UserDefinedFields !== undefined) {
    contents.UserDefinedFields = deserializeAws_restJson1_1FieldMap(output.UserDefinedFields, context);
  }
...
const deserializeAws_restJson1_1AwsSecurityFindingFilters = (
  ...
  if (output.AwsAccountId !== undefined) {
    contents.AwsAccountId = deserializeAws_restJson1_1StringFilterList(output.AwsAccountId, context);
  }
  if (output.CompanyName !== undefined) {
    contents.CompanyName = deserializeAws_restJson1_1StringFilterList(output.CompanyName, context);
  }
  if (output.ComplianceStatus !== undefined) {
    contents.ComplianceStatus = deserializeAws_restJson1_1StringFilterList(output.ComplianceStatus, context);
  }
  if (output.Confidence !== undefined) {
    contents.Confidence = deserializeAws_restJson1_1NumberFilterList(output.Confidence, context);
  }
  if (output.CreatedAt !== undefined) {
    contents.CreatedAt = deserializeAws_restJson1_1DateFilterList(output.CreatedAt, context);
  }
  if (output.Criticality !== undefined) {
    contents.Criticality = deserializeAws_restJson1_1NumberFilterList(output.Criticality, context);
  }
  if (output.Description !== undefined) {
    contents.Description = deserializeAws_restJson1_1StringFilterList(output.Description, context);
  }
  if (output.FirstObservedAt !== undefined) {
    contents.FirstObservedAt = deserializeAws_restJson1_1DateFilterList(output.FirstObservedAt, context);
  }
  if (output.GeneratorId !== undefined) {
    contents.GeneratorId = deserializeAws_restJson1_1StringFilterList(output.GeneratorId, context);
  }
  if (output.Id !== undefined) {
    contents.Id = deserializeAws_restJson1_1StringFilterList(output.Id, context);
  }
  if (output.Keyword !== undefined) {
    contents.Keyword = deserializeAws_restJson1_1KeywordFilterList(output.Keyword, context);
  }
  if (output.LastObservedAt !== undefined) {
    contents.LastObservedAt = deserializeAws_restJson1_1DateFilterList(output.LastObservedAt, context);
  }
  if (output.MalwareName !== undefined) {
    contents.MalwareName = deserializeAws_restJson1_1StringFilterList(output.MalwareName, context);
  }
  if (output.MalwarePath !== undefined) {
    contents.MalwarePath = deserializeAws_restJson1_1StringFilterList(output.MalwarePath, context);
  }
  if (output.MalwareState !== undefined) {
    contents.MalwareState = deserializeAws_restJson1_1StringFilterList(output.MalwareState, context);
  }
  if (output.MalwareType !== undefined) {
    contents.MalwareType = deserializeAws_restJson1_1StringFilterList(output.MalwareType, context);
  }
  if (output.NetworkDestinationDomain !== undefined) {
    contents.NetworkDestinationDomain = deserializeAws_restJson1_1StringFilterList(output.NetworkDestinationDomain, context);
  }
  if (output.NetworkDestinationIpV4 !== undefined) {
    contents.NetworkDestinationIpV4 = deserializeAws_restJson1_1IpFilterList(output.NetworkDestinationIpV4, context);
  }
  if (output.NetworkDestinationIpV6 !== undefined) {
    contents.NetworkDestinationIpV6 = deserializeAws_restJson1_1IpFilterList(output.NetworkDestinationIpV6, context);
  }
  if (output.NetworkDestinationPort !== undefined) {
    contents.NetworkDestinationPort = deserializeAws_restJson1_1NumberFilterList(output.NetworkDestinationPort, context);
  }
  if (output.NetworkDirection !== undefined) {
    contents.NetworkDirection = deserializeAws_restJson1_1StringFilterList(output.NetworkDirection, context);
  }
  if (output.NetworkProtocol !== undefined) {
    contents.NetworkProtocol = deserializeAws_restJson1_1StringFilterList(output.NetworkProtocol, context);
  }
  if (output.NetworkSourceDomain !== undefined) {
    contents.NetworkSourceDomain = deserializeAws_restJson1_1StringFilterList(output.NetworkSourceDomain, context);
  }
  if (output.NetworkSourceIpV4 !== undefined) {
    contents.NetworkSourceIpV4 = deserializeAws_restJson1_1IpFilterList(output.NetworkSourceIpV4, context);
  }
  if (output.NetworkSourceIpV6 !== undefined) {
    contents.NetworkSourceIpV6 = deserializeAws_restJson1_1IpFilterList(output.NetworkSourceIpV6, context);
  }
  if (output.NetworkSourceMac !== undefined) {
    contents.NetworkSourceMac = deserializeAws_restJson1_1StringFilterList(output.NetworkSourceMac, context);
  }
  if (output.NetworkSourcePort !== undefined) {
    contents.NetworkSourcePort = deserializeAws_restJson1_1NumberFilterList(output.NetworkSourcePort, context);
  }
  if (output.NoteText !== undefined) {
    contents.NoteText = deserializeAws_restJson1_1StringFilterList(output.NoteText, context);
  }
  if (output.NoteUpdatedAt !== undefined) {
    contents.NoteUpdatedAt = deserializeAws_restJson1_1DateFilterList(output.NoteUpdatedAt, context);
  }
  if (output.NoteUpdatedBy !== undefined) {
    contents.NoteUpdatedBy = deserializeAws_restJson1_1StringFilterList(output.NoteUpdatedBy, context);
  }
  if (output.ProcessLaunchedAt !== undefined) {
    contents.ProcessLaunchedAt = deserializeAws_restJson1_1DateFilterList(output.ProcessLaunchedAt, context);
  }
  if (output.ProcessName !== undefined) {
    contents.ProcessName = deserializeAws_restJson1_1StringFilterList(output.ProcessName, context);
  }
  if (output.ProcessParentPid !== undefined) {
    contents.ProcessParentPid = deserializeAws_restJson1_1NumberFilterList(output.ProcessParentPid, context);
  }
  if (output.ProcessPath !== undefined) {
    contents.ProcessPath = deserializeAws_restJson1_1StringFilterList(output.ProcessPath, context);
  }
  if (output.ProcessPid !== undefined) {
    contents.ProcessPid = deserializeAws_restJson1_1NumberFilterList(output.ProcessPid, context);
  }
  if (output.ProcessTerminatedAt !== undefined) {
    contents.ProcessTerminatedAt = deserializeAws_restJson1_1DateFilterList(output.ProcessTerminatedAt, context);
  }
  if (output.ProductArn !== undefined) {
    contents.ProductArn = deserializeAws_restJson1_1StringFilterList(output.ProductArn, context);
  }
  if (output.ProductFields !== undefined) {
    contents.ProductFields = deserializeAws_restJson1_1MapFilterList(output.ProductFields, context);
  }
  if (output.ProductName !== undefined) {
    contents.ProductName = deserializeAws_restJson1_1StringFilterList(output.ProductName, context);
  }
  if (output.RecommendationText !== undefined) {
    contents.RecommendationText = deserializeAws_restJson1_1StringFilterList(output.RecommendationText, context);
  }
  if (output.RecordState !== undefined) {
    contents.RecordState = deserializeAws_restJson1_1StringFilterList(output.RecordState, context);
  }
  if (output.RelatedFindingsId !== undefined) {
    contents.RelatedFindingsId = deserializeAws_restJson1_1StringFilterList(output.RelatedFindingsId, context);
  }
  if (output.RelatedFindingsProductArn !== undefined) {
    contents.RelatedFindingsProductArn = deserializeAws_restJson1_1StringFilterList(output.RelatedFindingsProductArn, context);
  }
  if (output.ResourceAwsEc2InstanceIamInstanceProfileArn !== undefined) {
    contents.ResourceAwsEc2InstanceIamInstanceProfileArn = deserializeAws_restJson1_1StringFilterList(output.ResourceAwsEc2InstanceIamInstanceProfileArn, context);
  }
  if (output.ResourceAwsEc2InstanceImageId !== undefined) {
    contents.ResourceAwsEc2InstanceImageId = deserializeAws_restJson1_1StringFilterList(output.ResourceAwsEc2InstanceImageId, context);
  }
  if (output.ResourceAwsEc2InstanceIpV4Addresses !== undefined) {
    contents.ResourceAwsEc2InstanceIpV4Addresses = deserializeAws_restJson1_1IpFilterList(output.ResourceAwsEc2InstanceIpV4Addresses, context);
  }
  if (output.ResourceAwsEc2InstanceIpV6Addresses !== undefined) {
    contents.ResourceAwsEc2InstanceIpV6Addresses = deserializeAws_restJson1_1IpFilterList(output.ResourceAwsEc2InstanceIpV6Addresses, context);
  }
  if (output.ResourceAwsEc2InstanceKeyName !== undefined) {
    contents.ResourceAwsEc2InstanceKeyName = deserializeAws_restJson1_1StringFilterList(output.ResourceAwsEc2InstanceKeyName, context);
  }
  if (output.ResourceAwsEc2InstanceLaunchedAt !== undefined) {
    contents.ResourceAwsEc2InstanceLaunchedAt = deserializeAws_restJson1_1DateFilterList(output.ResourceAwsEc2InstanceLaunchedAt, context);
  }
  if (output.ResourceAwsEc2InstanceSubnetId !== undefined) {
    contents.ResourceAwsEc2InstanceSubnetId = deserializeAws_restJson1_1StringFilterList(output.ResourceAwsEc2InstanceSubnetId, context);
  }
  if (output.ResourceAwsEc2InstanceType !== undefined) {
    contents.ResourceAwsEc2InstanceType = deserializeAws_restJson1_1StringFilterList(output.ResourceAwsEc2InstanceType, context);
  }
  if (output.ResourceAwsEc2InstanceVpcId !== undefined) {
    contents.ResourceAwsEc2InstanceVpcId = deserializeAws_restJson1_1StringFilterList(output.ResourceAwsEc2InstanceVpcId, context);
  }
  if (output.ResourceAwsIamAccessKeyCreatedAt !== undefined) {
    contents.ResourceAwsIamAccessKeyCreatedAt = deserializeAws_restJson1_1DateFilterList(output.ResourceAwsIamAccessKeyCreatedAt, context);
  }
  if (output.ResourceAwsIamAccessKeyStatus !== undefined) {
    contents.ResourceAwsIamAccessKeyStatus = deserializeAws_restJson1_1StringFilterList(output.ResourceAwsIamAccessKeyStatus, context);
  }
  if (output.ResourceAwsIamAccessKeyUserName !== undefined) {
    contents.ResourceAwsIamAccessKeyUserName = deserializeAws_restJson1_1StringFilterList(output.ResourceAwsIamAccessKeyUserName, context);
  }
  if (output.ResourceAwsS3BucketOwnerId !== undefined) {
    contents.ResourceAwsS3BucketOwnerId = deserializeAws_restJson1_1StringFilterList(output.ResourceAwsS3BucketOwnerId, context);
  }
  if (output.ResourceAwsS3BucketOwnerName !== undefined) {
    contents.ResourceAwsS3BucketOwnerName = deserializeAws_restJson1_1StringFilterList(output.ResourceAwsS3BucketOwnerName, context);
  }
  if (output.ResourceContainerImageId !== undefined) {
    contents.ResourceContainerImageId = deserializeAws_restJson1_1StringFilterList(output.ResourceContainerImageId, context);
  }
  if (output.ResourceContainerImageName !== undefined) {
    contents.ResourceContainerImageName = deserializeAws_restJson1_1StringFilterList(output.ResourceContainerImageName, context);
  }
  if (output.ResourceContainerLaunchedAt !== undefined) {
    contents.ResourceContainerLaunchedAt = deserializeAws_restJson1_1DateFilterList(output.ResourceContainerLaunchedAt, context);
  }
  if (output.ResourceContainerName !== undefined) {
    contents.ResourceContainerName = deserializeAws_restJson1_1StringFilterList(output.ResourceContainerName, context);
  }
  if (output.ResourceDetailsOther !== undefined) {
    contents.ResourceDetailsOther = deserializeAws_restJson1_1MapFilterList(output.ResourceDetailsOther, context);
  }
  if (output.ResourceId !== undefined) {
    contents.ResourceId = deserializeAws_restJson1_1StringFilterList(output.ResourceId, context);
  }
  if (output.ResourcePartition !== undefined) {
    contents.ResourcePartition = deserializeAws_restJson1_1StringFilterList(output.ResourcePartition, context);
  }
  if (output.ResourceRegion !== undefined) {
    contents.ResourceRegion = deserializeAws_restJson1_1StringFilterList(output.ResourceRegion, context);
  }
  if (output.ResourceTags !== undefined) {
    contents.ResourceTags = deserializeAws_restJson1_1MapFilterList(output.ResourceTags, context);
  }
  if (output.ResourceType !== undefined) {
    contents.ResourceType = deserializeAws_restJson1_1StringFilterList(output.ResourceType, context);
  }
  if (output.SeverityLabel !== undefined) {
    contents.SeverityLabel = deserializeAws_restJson1_1StringFilterList(output.SeverityLabel, context);
  }
  if (output.SeverityNormalized !== undefined) {
    contents.SeverityNormalized = deserializeAws_restJson1_1NumberFilterList(output.SeverityNormalized, context);
  }
  if (output.SeverityProduct !== undefined) {
    contents.SeverityProduct = deserializeAws_restJson1_1NumberFilterList(output.SeverityProduct, context);
  }
  if (output.SourceUrl !== undefined) {
    contents.SourceUrl = deserializeAws_restJson1_1StringFilterList(output.SourceUrl, context);
  }
  if (output.ThreatIntelIndicatorCategory !== undefined) {
    contents.ThreatIntelIndicatorCategory = deserializeAws_restJson1_1StringFilterList(output.ThreatIntelIndicatorCategory, context);
  }
  if (output.ThreatIntelIndicatorLastObservedAt !== undefined) {
    contents.ThreatIntelIndicatorLastObservedAt = deserializeAws_restJson1_1DateFilterList(output.ThreatIntelIndicatorLastObservedAt, context);
  }
  if (output.ThreatIntelIndicatorSource !== undefined) {
    contents.ThreatIntelIndicatorSource = deserializeAws_restJson1_1StringFilterList(output.ThreatIntelIndicatorSource, context);
  }
  if (output.ThreatIntelIndicatorSourceUrl !== undefined) {
    contents.ThreatIntelIndicatorSourceUrl = deserializeAws_restJson1_1StringFilterList(output.ThreatIntelIndicatorSourceUrl, context);
  }
  if (output.ThreatIntelIndicatorType !== undefined) {
    contents.ThreatIntelIndicatorType = deserializeAws_restJson1_1StringFilterList(output.ThreatIntelIndicatorType, context);
  }
  if (output.ThreatIntelIndicatorValue !== undefined) {
    contents.ThreatIntelIndicatorValue = deserializeAws_restJson1_1StringFilterList(output.ThreatIntelIndicatorValue, context);
  }
  if (output.Title !== undefined) {
    contents.Title = deserializeAws_restJson1_1StringFilterList(output.Title, context);
  }
  if (output.Type !== undefined) {
    contents.Type = deserializeAws_restJson1_1StringFilterList(output.Type, context);
  }
  if (output.UpdatedAt !== undefined) {
    contents.UpdatedAt = deserializeAws_restJson1_1DateFilterList(output.UpdatedAt, context);
  }
  if (output.UserDefinedFields !== undefined) {
    contents.UserDefinedFields = deserializeAws_restJson1_1MapFilterList(output.UserDefinedFields, context);
  }
  if (output.VerificationState !== undefined) {
    contents.VerificationState = deserializeAws_restJson1_1StringFilterList(output.VerificationState, context);
  }
  if (output.WorkflowState !== undefined) {
    contents.WorkflowState = deserializeAws_restJson1_1StringFilterList(output.WorkflowState, context);
  }
  return contents;
}
...
const deserializeAws_restJson1_1DateFilter = (
  ...
  if (output.DateRange !== undefined) {
    contents.DateRange = deserializeAws_restJson1_1DateRange(output.DateRange, context);
  }
...
const deserializeAws_restJson1_1Insight = (
  ...
  if (output.Filters !== undefined) {
    contents.Filters = deserializeAws_restJson1_1AwsSecurityFindingFilters(output.Filters, context);
  }
...
const deserializeAws_restJson1_1InsightResults = (
  ...
  if (output.ResultValues !== undefined) {
    contents.ResultValues = deserializeAws_restJson1_1InsightResultValueList(output.ResultValues, context);
  }
  return contents;
}
...
const deserializeAws_restJson1_1Product = (
  ...
  if (output.Categories !== undefined) {
    contents.Categories = deserializeAws_restJson1_1CategoryList(output.Categories, context);
  }
  if (output.CompanyName !== undefined) {
  ...
  if (output.ProductSubscriptionResourcePolicy !== undefined) {
    contents.ProductSubscriptionResourcePolicy = output.ProductSubscriptionResourcePolicy;
  }
  return contents;
}
...
const deserializeAws_restJson1_1Remediation = (
  ...
  if (output.Recommendation !== undefined) {
    contents.Recommendation = deserializeAws_restJson1_1Recommendation(output.Recommendation, context);
  }
  return contents;
}
...
const deserializeAws_restJson1_1Resource = (
  ...
  if (output.Details !== undefined) {
    contents.Details = deserializeAws_restJson1_1ResourceDetails(output.Details, context);
  }
  if (output.Id !== undefined) {
    contents.Id = output.Id;
  }
...
const deserializeAws_restJson1_1ResourceDetails = (
  ...
  if (output.AwsEc2Instance !== undefined) {
    contents.AwsEc2Instance = deserializeAws_restJson1_1AwsEc2InstanceDetails(output.AwsEc2Instance, context);
  }
  if (output.AwsIamAccessKey !== undefined) {
    contents.AwsIamAccessKey = deserializeAws_restJson1_1AwsIamAccessKeyDetails(output.AwsIamAccessKey, context);
  }
  if (output.AwsS3Bucket !== undefined) {
    contents.AwsS3Bucket = deserializeAws_restJson1_1AwsS3BucketDetails(output.AwsS3Bucket, context);
  }
  if (output.Container !== undefined) {
    contents.Container = deserializeAws_restJson1_1ContainerDetails(output.Container, context);
  }
...
const deserializeAws_restJson1_1StandardsSubscription = (
  ...
  if (output.StandardsInput !== undefined) {
    contents.StandardsInput = deserializeAws_restJson1_1StandardsInputParameterMap(output.StandardsInput, context);
  }
