...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DescribeStandardsControlsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeStandardsControlsCommand(output, context);
  }
