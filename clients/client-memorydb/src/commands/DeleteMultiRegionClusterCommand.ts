...
import { de_DeleteMultiRegionClusterCommand, se_DeleteMultiRegionClusterCommand } from "../protocols/Aws_json1_1";
...
export class DeleteMultiRegionClusterCommand extends $Command
  ...
  .f(void 0, void 0)
  .ser(se_DeleteMultiRegionClusterCommand)
  .de(de_DeleteMultiRegionClusterCommand)
  .build() {
