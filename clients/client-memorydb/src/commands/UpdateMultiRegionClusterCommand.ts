...
import { UpdateMultiRegionClusterRequest, UpdateMultiRegionClusterResponse } from "../models/models_0";
import { de_UpdateMultiRegionClusterCommand, se_UpdateMultiRegionClusterCommand } from "../protocols/Aws_json1_1";
...
export class UpdateMultiRegionClusterCommand extends $Command
  ...
  .f(void 0, void 0)
  .ser(se_UpdateMultiRegionClusterCommand)
  .de(de_UpdateMultiRegionClusterCommand)
  .build() {
