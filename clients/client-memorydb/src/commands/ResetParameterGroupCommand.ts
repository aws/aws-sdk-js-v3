...
import type { ResetParameterGroupRequest, ResetParameterGroupResponse } from "../models/models_0";
 ...
 * @public
 */
export class ResetParameterGroupCommand extends command<ResetParameterGroupCommandInput, ResetParameterGroupCommandOutput>(
  _ep0,
  _mw0,
  "ResetParameterGroup",
  ResetParameterGroup$
