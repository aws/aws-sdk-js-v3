...
import {
  de_DescribeMultiRegionParameterGroupsCommand,
  se_DescribeMultiRegionParameterGroupsCommand,
...
export class DescribeMultiRegionParameterGroupsCommand extends $Command
  ...
  .f(void 0, void 0)
  .ser(se_DescribeMultiRegionParameterGroupsCommand)
  .de(de_DescribeMultiRegionParameterGroupsCommand)
  .build() {
