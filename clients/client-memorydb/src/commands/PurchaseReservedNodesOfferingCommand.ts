 ...
 * @public
 */
export class PurchaseReservedNodesOfferingCommand extends command<PurchaseReservedNodesOfferingCommandInput, PurchaseReservedNodesOfferingCommandOutput>(
  _ep0,
  _mw0,
