 ...
 * @public
 */
export class DescribeReservedNodesOfferingsCommand extends command<DescribeReservedNodesOfferingsCommandInput, DescribeReservedNodesOfferingsCommandOutput>(
  _ep0,
  _mw0,
