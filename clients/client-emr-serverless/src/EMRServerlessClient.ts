...
import {
  defaultEMRServerlessHttpAuthSchemeParametersProvider,
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<EMRServerlessClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultEMRServerlessHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: EMRServerlessClientResolvedConfig) =>
