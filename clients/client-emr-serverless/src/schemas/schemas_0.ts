...
export var InitScriptPath: StaticSimpleSchema = [0, n0, _ISP, 8, 0];
export var Query: StaticSimpleSchema = [0, n0, _Q, 8, 0];
export var SparkSubmitParameters: StaticSimpleSchema = [0, n0, _SSP, 8, 0];
