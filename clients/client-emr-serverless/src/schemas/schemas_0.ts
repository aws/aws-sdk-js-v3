...
export var IdentityCenterConfigurationInput$: StaticStructureSchema = [3, n0, _ICCI,
  0,
  [_iCIA, _uBSE],
  [0, 2]
];
...
export var WorkerTypeSpecificationInput$: StaticStructureSchema = [3, n0, _WTSI,
  0,
  [_iCm],
...
var EntryPointArguments: StaticListSchema = [1, n0, _EPAn,
  0, [() => EntryPointArgument,
    0]
];
var JobRunAttempts: StaticListSchema = [1, n0, _JRA,
  0, () => JobRunAttemptSummary$
];
var JobRuns: StaticListSchema = [1, n0, _JRo,
  0, () => JobRunSummary$
];
...
var LogTypeMap: StaticMapSchema = [2, n0, _LTM,
  0, 0, 64 | 0
];
var SensitivePropertiesMap: StaticMapSchema = [2, n0, _SPM,
  8, 0, 0
];
var TagMap = 128 | 0;
var WorkerTypeSpecificationInputMap: StaticMapSchema = [2, n0, _WTSIM,
  0, 0, () => WorkerTypeSpecificationInput$
];
var WorkerTypeSpecificationMap: StaticMapSchema = [2, n0, _WTSM,
  0, 0, () => WorkerTypeSpecification$
];
export var JobDriver$: StaticUnionSchema = [4, n0, _JD,
  0,
  [_sS, _h],
  [[() => SparkSubmit$, 0], [() => Hive$, 0]]
];
export var CancelJobRun$: StaticOperationSchema = [9, n0, _CJR,
...
export var GetDashboardForJobRun$: StaticOperationSchema = [9, n0, _GDFJR,
...
export var ListJobRunAttempts$: StaticOperationSchema = [9, n0, _LJRA,
