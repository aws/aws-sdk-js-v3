...
export type DeleteTagsCommandOutput = DeleteTagsOutput;

export class DeleteTagsCommand extends $Command<DeleteTagsCommandInput, DeleteTagsCommandOutput, MachineLearningClientResolvedConfig> {
