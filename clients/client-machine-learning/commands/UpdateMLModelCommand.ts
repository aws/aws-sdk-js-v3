...
export type UpdateMLModelCommandOutput = UpdateMLModelOutput;

export class UpdateMLModelCommand extends $Command<UpdateMLModelCommandInput, UpdateMLModelCommandOutput, MachineLearningClientResolvedConfig> {
