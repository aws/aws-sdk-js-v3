...
const serializeAws_json1_1UpdateMLModelInput = (input: UpdateMLModelInput, context: __SerdeContext): any => {
  return {
    ...(input.MLModelId != undefined && { MLModelId: input.MLModelId }),
    ...(input.MLModelName != undefined && { MLModelName: input.MLModelName }),
    ...(input.ScoreThreshold != undefined && { ScoreThreshold: __serializeFloat(input.ScoreThreshold) }),
  };
};
...
const deserializeAws_json1_1DataSource = (output: any, context: __SerdeContext): DataSource => {
  return {
    ...
    RDSMetadata:
      output.RDSMetadata != undefined ? deserializeAws_json1_1RDSMetadata(output.RDSMetadata, context) : undefined,
    RedshiftMetadata:
...
const deserializeAws_json1_1DescribeBatchPredictionsOutput = (
  ...
  return {
    ...
    Results: output.Results != undefined ? deserializeAws_json1_1BatchPredictions(output.Results, context) : undefined,
  } as any;
};
...
const deserializeAws_json1_1DescribeDataSourcesOutput = (
  ...
  return {
    NextToken: __expectString(output.NextToken),
    Results: output.Results != undefined ? deserializeAws_json1_1DataSources(output.Results, context) : undefined,
  } as any;
};
...
const deserializeAws_json1_1DescribeEvaluationsOutput = (
  ...
  return {
    NextToken: __expectString(output.NextToken),
    Results: output.Results != undefined ? deserializeAws_json1_1Evaluations(output.Results, context) : undefined,
  } as any;
};
...
const deserializeAws_json1_1DescribeMLModelsOutput = (output: any, context: __SerdeContext): DescribeMLModelsOutput => {
  return {
    NextToken: __expectString(output.NextToken),
    Results: output.Results != undefined ? deserializeAws_json1_1MLModels(output.Results, context) : undefined,
  } as any;
};
...
const deserializeAws_json1_1Prediction = (output: any, context: __SerdeContext): Prediction => {
  return {
    details: output.details != undefined ? deserializeAws_json1_1DetailsMap(output.details, context) : undefined,
    predictedLabel: __expectString(output.predictedLabel),
    predictedScores:
      output.predictedScores != undefined
...
const deserializeAws_json1_1PredictOutput = (output: any, context: __SerdeContext): PredictOutput => {
  return {
    Prediction:
      output.Prediction != undefined ? deserializeAws_json1_1Prediction(output.Prediction, context) : undefined,
  } as any;
};
...
const deserializeAws_json1_1RDSMetadata = (output: any, context: __SerdeContext): RDSMetadata => {
  return {
    ...
    Database: output.Database != undefined ? deserializeAws_json1_1RDSDatabase(output.Database, context) : undefined,
