...
> {
   ...
   * @public
   */
  constructor(readonly input: StartDICOMImportJobCommandInput) {
  ...
  ): Handler<StartDICOMImportJobCommandInput, StartDICOMImportJobCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, StartDICOMImportJobCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: StartDICOMImportJobCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<StartDICOMImportJobCommandOutput> {
