...
export var LibraryTemplateButtonInput$: StaticStructureSchema = [3, n0, _LTBIi,
  0,
  [_ty, _pN, _u, _oT, _zTTA, _sA],
  [0, 0, 128 | 0, 0, 2, [1, n0, _SA, 0, 128 | 0]]
];
export var LibraryTemplateButtonList$: StaticStructureSchema = [3, n0, _LTBL,
  0,
...
export var ListLinkedWhatsAppBusinessAccountsOutput$: StaticStructureSchema = [3, n0, _LLWABAO,
  0,
  [_lA, _nT],
...
var MetaLibraryTemplateButtonList: StaticListSchema = [1, n0, _MLTBL,
...
var Filter = 128 | 0;
var Headers = 128 | 0;
var LinkedAccountWithIncompleteSetup: StaticMapSchema = [2, n0, _LAWIS,
...
export var CreateWhatsAppMessageTemplateFromLibrary$: StaticOperationSchema = [9, n0, _CWAMTFL,
...
export var GetLinkedWhatsAppBusinessAccount$: StaticOperationSchema = [9, n0, _GLWABA,
...
export var GetWhatsAppMessageTemplate$: StaticOperationSchema = [9, n0, _GWAMT,
  { [_ht]: ["GET", "/v1/whatsapp/template", 200] }, () => GetWhatsAppMessageTemplateInput$, () => GetWhatsAppMessageTemplateOutput$
];
export var ListLinkedWhatsAppBusinessAccounts$: StaticOperationSchema = [9, n0, _LLWABA,
...
export var ListWhatsAppTemplateLibrary$: StaticOperationSchema = [9, n0, _LWATL,
