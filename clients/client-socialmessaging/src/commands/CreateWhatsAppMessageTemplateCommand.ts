 ...
 * @public
 */
export class CreateWhatsAppMessageTemplateCommand extends command<CreateWhatsAppMessageTemplateCommandInput, CreateWhatsAppMessageTemplateCommandOutput>(
  _ep0,
  _mw0,
