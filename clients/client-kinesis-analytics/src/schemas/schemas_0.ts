...
export var KinesisAnalyticsServiceException$: StaticErrorSchema = [-3, _s, "KinesisAnalyticsServiceException", 0, [], []];
...
var ParsedInputRecords: StaticListSchema = [1, n0, _PIRa,
  0, 64 | 0
];
