...
import { type KinesisAnalyticsClientResolvedConfig, KinesisAnalyticsClientConfig } from "../KinesisAnalyticsClient";
 ...
 * @internal
 */
export const defaultKinesisAnalyticsHttpAuthSchemeProvider: KinesisAnalyticsHttpAuthSchemeProvider = (authParameters) => {
