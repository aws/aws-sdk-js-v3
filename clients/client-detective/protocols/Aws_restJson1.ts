...
export const deserializeAws_restJson1CreateMembersCommand = async (
  ...
  if (data.Members !== undefined && data.Members !== null) {
    contents.Members = deserializeAws_restJson1MemberDetailList(
      data.Members,
      context
    );
  }
  if (
    ...
    contents.UnprocessedAccounts = deserializeAws_restJson1UnprocessedAccountList(
...
export const deserializeAws_restJson1DeleteMembersCommand = async (
  ...
  if (data.AccountIds !== undefined && data.AccountIds !== null) {
    contents.AccountIds = deserializeAws_restJson1AccountIdList(
      data.AccountIds,
      context
    );
  }
...
export const deserializeAws_restJson1DisassociateMembershipCommand = async (
  ...
  if (output.statusCode !== 200 && output.statusCode >= 400) {
    return deserializeAws_restJson1DisassociateMembershipCommandError(
      output,
      context
    );
  }
...
export const deserializeAws_restJson1GetMembersCommand = async (
  ...
  if (data.MemberDetails !== undefined && data.MemberDetails !== null) {
    contents.MemberDetails = deserializeAws_restJson1MemberDetailList(
      data.MemberDetails,
      context
    );
  }
...
export const deserializeAws_restJson1ListGraphsCommand = async (
  ...
  if (data.GraphList !== undefined && data.GraphList !== null) {
    contents.GraphList = deserializeAws_restJson1GraphList(
      data.GraphList,
      context
    );
  }
...
export const deserializeAws_restJson1ListInvitationsCommand = async (
  ...
  if (data.Invitations !== undefined && data.Invitations !== null) {
    contents.Invitations = deserializeAws_restJson1MemberDetailList(
      data.Invitations,
      context
    );
  }
...
const serializeAws_restJson1Account = (
  input: Account,
  context: __SerdeContext
): any => {
  return {
...
const deserializeAws_restJson1AccountIdList = (
  output: any,
  context: __SerdeContext
): string[] => {
...
const deserializeAws_restJson1Graph = (
  output: any,
  context: __SerdeContext
): Graph => {
  return {
...
const deserializeAws_restJson1GraphList = (
  output: any,
  context: __SerdeContext
): Graph[] => {
  return (output || []).map((entry: any) =>
    deserializeAws_restJson1Graph(entry, context)
  );
};

const deserializeAws_restJson1MemberDetail = (
  output: any,
  context: __SerdeContext
): MemberDetail => {
  return {
...
const deserializeAws_restJson1MemberDetailList = (
  output: any,
  context: __SerdeContext
): MemberDetail[] => {
  return (output || []).map((entry: any) =>
    deserializeAws_restJson1MemberDetail(entry, context)
  );
};
...
const deserializeAws_restJson1UnprocessedAccountList = (
  output: any,
  context: __SerdeContext
): UnprocessedAccount[] => {
  return (output || []).map((entry: any) =>
