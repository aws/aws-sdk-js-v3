 ...
 * @public
 */
export class BatchGetMembershipDatasourcesCommand extends command<BatchGetMembershipDatasourcesCommandInput, BatchGetMembershipDatasourcesCommandOutput>(
  _ep0,
  _mw0,
