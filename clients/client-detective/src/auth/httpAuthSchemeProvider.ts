...
import { type DetectiveClientResolvedConfig, DetectiveClientConfig } from "../DetectiveClient";
 ...
 * @internal
 */
export const defaultDetectiveHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: DetectiveHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultDetectiveHttpAuthSchemeProvider: DetectiveHttpAuthSchemeProvider = (authParameters) => {
