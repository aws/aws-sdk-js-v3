...
import type { DeletePackageGroupRequest, DeletePackageGroupResult } from "../models/models_0";
 ...
 * @public
 */
export class DeletePackageGroupCommand extends command<DeletePackageGroupCommandInput, DeletePackageGroupCommandOutput>(
  _ep0,
  _mw0,
  "DeletePackageGroup",
  DeletePackageGroup$
