 ...
 * @public
 */
export class DisassociateExternalConnectionCommand extends command<DisassociateExternalConnectionCommandInput, DisassociateExternalConnectionCommandOutput>(
  _ep0,
  _mw0,
