 ...
 * @public
 */
export class DeleteDomainPermissionsPolicyCommand extends command<DeleteDomainPermissionsPolicyCommandInput, DeleteDomainPermissionsPolicyCommandOutput>(
  _ep0,
  _mw0,
