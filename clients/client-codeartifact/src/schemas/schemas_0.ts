...
export var CodeartifactServiceException$: StaticErrorSchema = [-3, _s, "CodeartifactServiceException", 0, [], []];
_s_registry.registerError(CodeartifactServiceException$, CodeartifactServiceException);
...
var Asset: StaticSimpleSchema = [0, n0, _A, { [_st]: 1 }, 42];
export var AssetSummary$: StaticStructureSchema = [3, n0, _AS,
  0,
  [_n, _si, _h],
  [0, 1, 128 | 0], 1
];
export var AssociatedPackage$: StaticStructureSchema = [3, n0, _AP,
  0,
  [_f, _na, _p, _aT],
  [0, 0, 0, 0]
];
export var AssociateExternalConnectionRequest$: StaticStructureSchema = [3, n0, _AECR,
  0,
  [_d, _re, _eC, _dO],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _ec }], [0, { [_hQ]: _do }]], 3
];
export var AssociateExternalConnectionResult$: StaticStructureSchema = [3, n0, _AECRs,
  0,
  [_re],
  [() => RepositoryDescription$]
];
export var CopyPackageVersionsRequest$: StaticStructureSchema = [3, n0, _CPVR,
  0,
...
export var CopyPackageVersionsResult$: StaticStructureSchema = [3, n0, _CPVRo,
  0,
  [_sV, _fV],
...
export var CreateDomainResult$: StaticStructureSchema = [3, n0, _CDRr,
  0,
  [_d],
  [() => DomainDescription$]
];
export var CreatePackageGroupRequest$: StaticStructureSchema = [3, n0, _CPGR,
  0,
  [_d, _pG, _dO, _cI, _de, _t],
  [[0, { [_hQ]: _d }], 0, [0, { [_hQ]: _do }], 0, 0, () => TagList], 2
];
export var CreatePackageGroupResult$: StaticStructureSchema = [3, n0, _CPGRr,
  0,
  [_pG],
...
export var CreateRepositoryResult$: StaticStructureSchema = [3, n0, _CRRr,
  0,
  [_re],
  [() => RepositoryDescription$]
];
export var DeleteDomainPermissionsPolicyRequest$: StaticStructureSchema = [3, n0, _DDPPR,
  0,
  [_d, _dO, _pR],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _do }], [0, { [_hQ]: _pr }]], 1
];
export var DeleteDomainPermissionsPolicyResult$: StaticStructureSchema = [3, n0, _DDPPRe,
  0,
  [_po],
  [() => ResourcePolicy$]
];
...
export var DeleteDomainResult$: StaticStructureSchema = [3, n0, _DDRe,
  0,
  [_d],
  [() => DomainDescription$]
];
export var DeletePackageGroupRequest$: StaticStructureSchema = [3, n0, _DPGR,
  0,
  [_d, _pG, _dO],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _pg }], [0, { [_hQ]: _do }]], 2
];
export var DeletePackageGroupResult$: StaticStructureSchema = [3, n0, _DPGRe,
  0,
  [_pG],
  [() => PackageGroupDescription$]
];
...
export var DeletePackageResult$: StaticStructureSchema = [3, n0, _DPRe,
  0,
  [_dP],
  [() => PackageSummary$]
];
export var DeletePackageVersionsRequest$: StaticStructureSchema = [3, n0, _DPVR,
  0,
  [_d, _re, _f, _p, _v, _dO, _na, _eS],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _f }], [0, { [_hQ]: _p }], 64 | 0, [0, { [_hQ]: _do }], [0, { [_hQ]: _na }], 0], 5
];
export var DeletePackageVersionsResult$: StaticStructureSchema = [3, n0, _DPVRe,
  0,
  [_sV, _fV],
  [() => SuccessfulPackageVersionInfoMap, () => PackageVersionErrorMap]
];
export var DeleteRepositoryPermissionsPolicyRequest$: StaticStructureSchema = [3, n0, _DRPPR,
  0,
  [_d, _re, _dO, _pR],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _do }], [0, { [_hQ]: _pr }]], 2
];
export var DeleteRepositoryPermissionsPolicyResult$: StaticStructureSchema = [3, n0, _DRPPRe,
  0,
  [_po],
  [() => ResourcePolicy$]
];
...
export var DeleteRepositoryResult$: StaticStructureSchema = [3, n0, _DRRe,
  0,
  [_re],
  [() => RepositoryDescription$]
];
...
export var DescribeDomainResult$: StaticStructureSchema = [3, n0, _DDResc,
  0,
  [_d],
  [() => DomainDescription$]
];
export var DescribePackageGroupRequest$: StaticStructureSchema = [3, n0, _DPGRes,
  0,
  [_d, _pG, _dO],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _pg }], [0, { [_hQ]: _do }]], 2
];
export var DescribePackageGroupResult$: StaticStructureSchema = [3, n0, _DPGResc,
  0,
  [_pG],
  [() => PackageGroupDescription$]
];
...
export var DescribePackageResult$: StaticStructureSchema = [3, n0, _DPResc,
  0,
  [_p],
...
export var DescribePackageVersionResult$: StaticStructureSchema = [3, n0, _DPVResc,
  0,
  [_pV],
  [() => PackageVersionDescription$], 1
];
export var DescribeRepositoryRequest$: StaticStructureSchema = [3, n0, _DRRes,
  0,
  [_d, _re, _dO],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _do }]], 2
];
export var DescribeRepositoryResult$: StaticStructureSchema = [3, n0, _DRResc,
  0,
  [_re],
  [() => RepositoryDescription$]
];
export var DisassociateExternalConnectionRequest$: StaticStructureSchema = [3, n0, _DECR,
  0,
  [_d, _re, _eC, _dO],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _ec }], [0, { [_hQ]: _do }]], 3
];
export var DisassociateExternalConnectionResult$: StaticStructureSchema = [3, n0, _DECRi,
  0,
  [_re],
  [() => RepositoryDescription$]
];
export var DisposePackageVersionsRequest$: StaticStructureSchema = [3, n0, _DPVRi,
  0,
  [_d, _re, _f, _p, _v, _dO, _na, _vR, _eS],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _f }], [0, { [_hQ]: _p }], 64 | 0, [0, { [_hQ]: _do }], [0, { [_hQ]: _na }], 128 | 0, 0], 5
];
export var DisposePackageVersionsResult$: StaticStructureSchema = [3, n0, _DPVRis,
  0,
  [_sV, _fV],
  [() => SuccessfulPackageVersionInfoMap, () => PackageVersionErrorMap]
];
export var DomainDescription$: StaticStructureSchema = [3, n0, _DD,
  0,
  [_n, _o, _a, _sta, _cT, _eK, _rC, _aSB, _sBA],
  [0, 0, 0, 0, 4, 0, 1, 1, 0]
];
export var DomainEntryPoint$: StaticStructureSchema = [3, n0, _DEP,
  0,
  [_rN, _eCN],
  [0, 0]
];
...
export var GetAssociatedPackageGroupRequest$: StaticStructureSchema = [3, n0, _GAPGR,
  0,
  [_d, _f, _p, _dO, _na],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _f }], [0, { [_hQ]: _p }], [0, { [_hQ]: _do }], [0, { [_hQ]: _na }]], 3
];
export var GetAssociatedPackageGroupResult$: StaticStructureSchema = [3, n0, _GAPGRe,
  0,
  [_pG, _aT],
...
export var GetAuthorizationTokenResult$: StaticStructureSchema = [3, n0, _GATRe,
  8,
  [_aTu, _ex],
  [0, 4]
];
export var GetDomainPermissionsPolicyRequest$: StaticStructureSchema = [3, n0, _GDPPR,
  0,
  [_d, _dO],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _do }]], 1
];
export var GetDomainPermissionsPolicyResult$: StaticStructureSchema = [3, n0, _GDPPRe,
  0,
  [_po],
  [() => ResourcePolicy$]
];
export var GetPackageVersionAssetRequest$: StaticStructureSchema = [3, n0, _GPVAR,
  0,
...
export var GetPackageVersionAssetResult$: StaticStructureSchema = [3, n0, _GPVARe,
  0,
  [_as, _aN, _pV, _pVR],
  [[() => Asset, 16], [0, { [_hH]: _XA }], [0, { [_hH]: _XP }], [0, { [_hH]: _XP_ }]]
];
export var GetPackageVersionReadmeRequest$: StaticStructureSchema = [3, n0, _GPVRR,
  0,
  [_d, _re, _f, _p, _pV, _dO, _na],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _f }], [0, { [_hQ]: _p }], [0, { [_hQ]: _ve }], [0, { [_hQ]: _do }], [0, { [_hQ]: _na }]], 5
];
export var GetPackageVersionReadmeResult$: StaticStructureSchema = [3, n0, _GPVRRe,
  0,
  [_f, _na, _p, _ve, _vRe, _rea],
  [0, 0, 0, 0, 0, 0]
];
export var GetRepositoryEndpointRequest$: StaticStructureSchema = [3, n0, _GRER,
  0,
  [_d, _re, _f, _dO, _eT],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _f }], [0, { [_hQ]: _do }], [0, { [_hQ]: _eT }]], 3
];
export var GetRepositoryEndpointResult$: StaticStructureSchema = [3, n0, _GRERe,
  0,
  [_rE],
  [0]
];
export var GetRepositoryPermissionsPolicyRequest$: StaticStructureSchema = [3, n0, _GRPPR,
  0,
  [_d, _re, _dO],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _do }]], 2
];
export var GetRepositoryPermissionsPolicyResult$: StaticStructureSchema = [3, n0, _GRPPRe,
  0,
  [_po],
  [() => ResourcePolicy$]
];
...
export var ListAllowedRepositoriesForGroupRequest$: StaticStructureSchema = [3, n0, _LARFGR,
  0,
  [_d, _pG, _oRT, _dO, _mR, _nT],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _pg }], [0, { [_hQ]: _oRT }], [0, { [_hQ]: _do }], [1, { [_hQ]: _mr }], [0, { [_hQ]: _nt }]], 3
];
export var ListAllowedRepositoriesForGroupResult$: StaticStructureSchema = [3, n0, _LARFGRi,
  0,
  [_aR, _nT],
  [64 | 0, 0]
];
export var ListAssociatedPackagesRequest$: StaticStructureSchema = [3, n0, _LAPR,
  0,
  [_d, _pG, _dO, _mR, _nT, _pre],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _pg }], [0, { [_hQ]: _do }], [1, { [_hQ]: _mr }], [0, { [_hQ]: _nt }], [2, { [_hQ]: _pre }]], 2
];
export var ListAssociatedPackagesResult$: StaticStructureSchema = [3, n0, _LAPRi,
  0,
  [_pa, _nT],
...
export var ListDomainsResult$: StaticStructureSchema = [3, n0, _LDRi,
  0,
  [_dom, _nT],
  [() => DomainSummaryList, 0]
];
export var ListPackageGroupsRequest$: StaticStructureSchema = [3, n0, _LPGR,
  0,
  [_d, _dO, _mR, _nT, _pref],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _do }], [1, { [_hQ]: _mr }], [0, { [_hQ]: _nt }], [0, { [_hQ]: _pref }]], 1
];
export var ListPackageGroupsResult$: StaticStructureSchema = [3, n0, _LPGRi,
  0,
  [_pGa, _nT],
...
export var ListPackagesResult$: StaticStructureSchema = [3, n0, _LPRi,
  0,
  [_pa, _nT],
  [() => PackageSummaryList, 0]
];
export var ListPackageVersionAssetsRequest$: StaticStructureSchema = [3, n0, _LPVAR,
  0,
  [_d, _re, _f, _p, _pV, _dO, _na, _mR, _nT],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _f }], [0, { [_hQ]: _p }], [0, { [_hQ]: _ve }], [0, { [_hQ]: _do }], [0, { [_hQ]: _na }], [1, { [_hQ]: _mr }], [0, { [_hQ]: _nt }]], 5
];
export var ListPackageVersionAssetsResult$: StaticStructureSchema = [3, n0, _LPVARi,
  0,
  [_f, _na, _p, _ve, _vRe, _nT, _ass],
  [0, 0, 0, 0, 0, 0, () => AssetSummaryList]
];
export var ListPackageVersionDependenciesRequest$: StaticStructureSchema = [3, n0, _LPVDR,
  0,
  [_d, _re, _f, _p, _pV, _dO, _na, _nT],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _f }], [0, { [_hQ]: _p }], [0, { [_hQ]: _ve }], [0, { [_hQ]: _do }], [0, { [_hQ]: _na }], [0, { [_hQ]: _nt }]], 5
];
export var ListPackageVersionDependenciesResult$: StaticStructureSchema = [3, n0, _LPVDRi,
  0,
...
export var ListPackageVersionsResult$: StaticStructureSchema = [3, n0, _LPVRi,
  0,
  [_dDV, _f, _na, _p, _v, _nT],
  [0, 0, 0, 0, () => PackageVersionSummaryList, 0]
];
export var ListRepositoriesInDomainRequest$: StaticStructureSchema = [3, n0, _LRIDR,
  0,
  [_d, _dO, _aA, _rP, _mR, _nT],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _do }], [0, { [_hQ]: _aa }], [0, { [_hQ]: _rp }], [1, { [_hQ]: _mr }], [0, { [_hQ]: _nt }]], 1
];
export var ListRepositoriesInDomainResult$: StaticStructureSchema = [3, n0, _LRIDRi,
  0,
  [_rep, _nT],
  [() => RepositorySummaryList, 0]
];
export var ListRepositoriesRequest$: StaticStructureSchema = [3, n0, _LRR,
  0,
  [_rP, _mR, _nT],
  [[0, { [_hQ]: _rp }], [1, { [_hQ]: _mr }], [0, { [_hQ]: _nt }]]
];
export var ListRepositoriesResult$: StaticStructureSchema = [3, n0, _LRRi,
  0,
  [_rep, _nT],
  [() => RepositorySummaryList, 0]
];
export var ListSubPackageGroupsRequest$: StaticStructureSchema = [3, n0, _LSPGR,
  0,
  [_d, _pG, _dO, _mR, _nT],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _pg }], [0, { [_hQ]: _do }], [1, { [_hQ]: _mr }], [0, { [_hQ]: _nt }]], 2
];
export var ListSubPackageGroupsResult$: StaticStructureSchema = [3, n0, _LSPGRi,
  0,
  [_pGa, _nT],
  [() => PackageGroupSummaryList, 0]
];
...
export var PackageDependency$: StaticStructureSchema = [3, n0, _PD,
  0,
  [_na, _p, _dT, _vRer],
  [0, 0, 0, 0]
];
export var PackageDescription$: StaticStructureSchema = [3, n0, _PDa,
  0,
  [_f, _na, _n, _oC],
  [0, 0, 0, () => PackageOriginConfiguration$]
];
export var PackageGroupAllowedRepository$: StaticStructureSchema = [3, n0, _PGAR,
  0,
  [_rN, _oRT],
  [0, 0]
];
export var PackageGroupDescription$: StaticStructureSchema = [3, n0, _PGD,
  0,
  [_a, _pat, _dN, _dO, _cT, _cI, _de, _oC, _par],
  [0, 0, 0, 0, 4, 0, 0, () => PackageGroupOriginConfiguration$, () => PackageGroupReference$]
];
export var PackageGroupOriginConfiguration$: StaticStructureSchema = [3, n0, _PGOC,
  0,
  [_res],
  [() => PackageGroupOriginRestrictions]
];
export var PackageGroupOriginRestriction$: StaticStructureSchema = [3, n0, _PGOR,
  0,
  [_mo, _eM, _iF, _rCe],
  [0, 0, () => PackageGroupReference$, 1]
];
export var PackageGroupReference$: StaticStructureSchema = [3, n0, _PGR,
  0,
  [_a, _pat],
  [0, 0]
];
export var PackageGroupSummary$: StaticStructureSchema = [3, n0, _PGS,
  0,
  [_a, _pat, _dN, _dO, _cT, _cI, _de, _oC, _par],
  [0, 0, 0, 0, 4, 0, 0, () => PackageGroupOriginConfiguration$, () => PackageGroupReference$]
];
export var PackageOriginConfiguration$: StaticStructureSchema = [3, n0, _POC,
  0,
  [_res],
  [() => PackageOriginRestrictions$]
];
export var PackageOriginRestrictions$: StaticStructureSchema = [3, n0, _POR,
  0,
  [_pu, _up],
  [0, 0], 2
];
...
export var PackageVersionDescription$: StaticStructureSchema = [3, n0, _PVD,
  0,
  [_f, _na, _pN, _dNi, _ve, _su, _hP, _sCR, _pT, _l, _rev, _sta, _or],
  [0, 0, 0, 0, 0, 0, 0, 0, 4, () => LicenseInfoList, 0, 0, () => PackageVersionOrigin$]
];
export var PackageVersionError$: StaticStructureSchema = [3, n0, _PVE,
  0,
  [_eCr, _eMr],
  [0, 0]
];
export var PackageVersionOrigin$: StaticStructureSchema = [3, n0, _PVO,
  0,
  [_dEP, _oT],
  [() => DomainEntryPoint$, 0]
];
...
export var PublishPackageVersionRequest$: StaticStructureSchema = [3, n0, _PPVR,
  0,
...
export var PublishPackageVersionResult$: StaticStructureSchema = [3, n0, _PPVRu,
  0,
  [_f, _na, _p, _ve, _vRe, _sta, _as],
  [0, 0, 0, 0, 0, 0, () => AssetSummary$]
];
export var PutDomainPermissionsPolicyRequest$: StaticStructureSchema = [3, n0, _PDPPR,
  0,
  [_d, _pD, _dO, _pR],
  [0, 0, 0, 0], 2
];
export var PutDomainPermissionsPolicyResult$: StaticStructureSchema = [3, n0, _PDPPRu,
  0,
  [_po],
  [() => ResourcePolicy$]
];
export var PutPackageOriginConfigurationRequest$: StaticStructureSchema = [3, n0, _PPOCR,
  0,
  [_d, _re, _f, _p, _res, _dO, _na],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _f }], [0, { [_hQ]: _p }], () => PackageOriginRestrictions$, [0, { [_hQ]: _do }], [0, { [_hQ]: _na }]], 5
];
export var PutPackageOriginConfigurationResult$: StaticStructureSchema = [3, n0, _PPOCRu,
  0,
  [_oC],
  [() => PackageOriginConfiguration$]
];
export var PutRepositoryPermissionsPolicyRequest$: StaticStructureSchema = [3, n0, _PRPPR,
  0,
  [_d, _re, _pD, _dO, _pR],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], 0, [0, { [_hQ]: _do }], 0], 3
];
export var PutRepositoryPermissionsPolicyResult$: StaticStructureSchema = [3, n0, _PRPPRu,
  0,
  [_po],
  [() => ResourcePolicy$]
];
export var RepositoryDescription$: StaticStructureSchema = [3, n0, _RD,
  0,
  [_n, _aA, _dN, _dO, _a, _de, _u, _eCx, _cT],
  [0, 0, 0, 0, 0, 0, () => UpstreamRepositoryInfoList, () => RepositoryExternalConnectionInfoList, 4]
];
export var RepositoryExternalConnectionInfo$: StaticStructureSchema = [3, n0, _RECI,
  0,
  [_eCN, _pF, _sta],
  [0, 0, 0]
];
...
export var SuccessfulPackageVersionInfo$: StaticStructureSchema = [3, n0, _SPVI,
  0,
  [_rev, _sta],
  [0, 0]
];
...
export var UpdatePackageGroupOriginConfigurationRequest$: StaticStructureSchema = [3, n0, _UPGOCR,
  0,
...
export var UpdatePackageGroupOriginConfigurationResult$: StaticStructureSchema = [3, n0, _UPGOCRp,
  0,
  [_pG, _aRU],
  [() => PackageGroupDescription$, [2, n0, _PGARU, 0, 0, [2, n0, _PGARUa, 0, 0, 64 | 0]]]
];
export var UpdatePackageGroupRequest$: StaticStructureSchema = [3, n0, _UPGR,
  0,
  [_d, _pG, _dO, _cI, _de],
  [[0, { [_hQ]: _d }], 0, [0, { [_hQ]: _do }], 0, 0], 2
];
export var UpdatePackageGroupResult$: StaticStructureSchema = [3, n0, _UPGRp,
  0,
  [_pG],
  [() => PackageGroupDescription$]
];
export var UpdatePackageVersionsStatusRequest$: StaticStructureSchema = [3, n0, _UPVSR,
  0,
  [_d, _re, _f, _p, _v, _tS, _dO, _na, _vR, _eS],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _f }], [0, { [_hQ]: _p }], 64 | 0, 0, [0, { [_hQ]: _do }], [0, { [_hQ]: _na }], 128 | 0, 0], 6
];
export var UpdatePackageVersionsStatusResult$: StaticStructureSchema = [3, n0, _UPVSRp,
  0,
  [_sV, _fV],
  [() => SuccessfulPackageVersionInfoMap, () => PackageVersionErrorMap]
];
export var UpdateRepositoryRequest$: StaticStructureSchema = [3, n0, _URRp,
  0,
  [_d, _re, _dO, _de, _u],
  [[0, { [_hQ]: _d }], [0, { [_hQ]: _re }], [0, { [_hQ]: _do }], 0, () => UpstreamRepositoryList], 2
];
export var UpdateRepositoryResult$: StaticStructureSchema = [3, n0, _URRpd,
  0,
  [_re],
  [() => RepositoryDescription$]
];
export var UpstreamRepository$: StaticStructureSchema = [3, n0, _UR,
  0,
  [_rN],
  [0], 1
];
export var UpstreamRepositoryInfo$: StaticStructureSchema = [3, n0, _URI,
  0,
  [_rN],
  [0]
];
var AssetSummaryList: StaticListSchema = [1, n0, _ASL,
  0, () => AssetSummary$
];
var AssociatedPackageList: StaticListSchema = [1, n0, _APL,
  0, () => AssociatedPackage$
];
...
var PackageDependencyList: StaticListSchema = [1, n0, _PDL,
  0, () => PackageDependency$
];
var PackageGroupAllowedRepositoryList: StaticListSchema = [1, n0, _PGARL,
  0, () => PackageGroupAllowedRepository$
];
var PackageGroupSummaryList: StaticListSchema = [1, n0, _PGSL,
...
var RepositoryExternalConnectionInfoList: StaticListSchema = [1, n0, _RECIL,
...
var UpstreamRepositoryInfoList: StaticListSchema = [1, n0, _URIL,
  0, () => UpstreamRepositoryInfo$
];
var UpstreamRepositoryList: StaticListSchema = [1, n0, _URL,
  0, () => UpstreamRepository$
];
var AssetHashes = 128 | 0;
var OriginRestrictions = 128 | 0;
var PackageGroupAllowedRepositoryUpdate: StaticMapSchema = [2, n0, _PGARUa,
  0, 0, 64 | 0
];
var PackageGroupAllowedRepositoryUpdates: StaticMapSchema = [2, n0, _PGARU,
  0, 0, [2, n0, _PGARUa, 0, 0, 64 | 0]
];
var PackageGroupOriginRestrictions: StaticMapSchema = [2, n0, _PGORa,
  0, 0, () => PackageGroupOriginRestriction$
];
var PackageVersionErrorMap: StaticMapSchema = [2, n0, _PVEM,
  0, 0, () => PackageVersionError$
];
var PackageVersionRevisionMap = 128 | 0;
var SuccessfulPackageVersionInfoMap: StaticMapSchema = [2, n0, _SPVIM,
  0, 0, () => SuccessfulPackageVersionInfo$
];
export var AssociateExternalConnection$: StaticOperationSchema = [9, n0, _AEC,
  { [_ht]: ["POST", "/v1/repository/external-connection", 200] }, () => AssociateExternalConnectionRequest$, () => AssociateExternalConnectionResult$
];
export var CopyPackageVersions$: StaticOperationSchema = [9, n0, _CPV,
...
export var CreatePackageGroup$: StaticOperationSchema = [9, n0, _CPG,
...
export var DeleteDomainPermissionsPolicy$: StaticOperationSchema = [9, n0, _DDPP,
...
export var DeletePackageGroup$: StaticOperationSchema = [9, n0, _DPG,
  { [_ht]: ["DELETE", "/v1/package-group", 200] }, () => DeletePackageGroupRequest$, () => DeletePackageGroupResult$
];
export var DeletePackageVersions$: StaticOperationSchema = [9, n0, _DPV,
...
export var DeleteRepositoryPermissionsPolicy$: StaticOperationSchema = [9, n0, _DRPP,
...
export var DescribeDomain$: StaticOperationSchema = [9, n0, _DDes,
...
export var DescribePackageGroup$: StaticOperationSchema = [9, n0, _DPGe,
...
export var DescribeRepository$: StaticOperationSchema = [9, n0, _DRe,
  { [_ht]: ["GET", "/v1/repository", 200] }, () => DescribeRepositoryRequest$, () => DescribeRepositoryResult$
];
export var DisassociateExternalConnection$: StaticOperationSchema = [9, n0, _DEC,
...
export var DisposePackageVersions$: StaticOperationSchema = [9, n0, _DPVi,
  { [_ht]: ["POST", "/v1/package/versions/dispose", 200] }, () => DisposePackageVersionsRequest$, () => DisposePackageVersionsResult$
];
export var GetAssociatedPackageGroup$: StaticOperationSchema = [9, n0, _GAPG,
...
export var ListAssociatedPackages$: StaticOperationSchema = [9, n0, _LAP,
...
export var ListPackageGroups$: StaticOperationSchema = [9, n0, _LPG,
...
export var ListPackageVersionAssets$: StaticOperationSchema = [9, n0, _LPVA,
  { [_ht]: ["POST", "/v1/package/version/assets", 200] }, () => ListPackageVersionAssetsRequest$, () => ListPackageVersionAssetsResult$
];
export var ListPackageVersionDependencies$: StaticOperationSchema = [9, n0, _LPVD,
...
export var ListRepositoriesInDomain$: StaticOperationSchema = [9, n0, _LRID,
  { [_ht]: ["POST", "/v1/domain/repositories", 200] }, () => ListRepositoriesInDomainRequest$, () => ListRepositoriesInDomainResult$
];
export var ListSubPackageGroups$: StaticOperationSchema = [9, n0, _LSPG,
...
export var UpdatePackageGroup$: StaticOperationSchema = [9, n0, _UPG,
  { [_ht]: ["PUT", "/v1/package-group", 200] }, () => UpdatePackageGroupRequest$, () => UpdatePackageGroupResult$
];
export var UpdatePackageGroupOriginConfiguration$: StaticOperationSchema = [9, n0, _UPGOC,
...
export var UpdatePackageVersionsStatus$: StaticOperationSchema = [9, n0, _UPVS,
  { [_ht]: ["POST", "/v1/package/versions/update_status", 200] }, () => UpdatePackageVersionsStatusRequest$, () => UpdatePackageVersionsStatusResult$
];
export var UpdateRepository$: StaticOperationSchema = [9, n0, _URp,
