...
export const defaultRegionInfoProvider: RegionInfoProvider = (region: string, options?: any) => {
  ...
  switch (region) {
    ...
    case "ap-northeast-3":
      regionInfo = {
        hostname: "mq.ap-northeast-3.amazonaws.com",
        partition: "aws",
      };
      break;
    case "ap-south-1":
    ...
    case "cn-northwest-1":
      regionInfo = {
        hostname: "mq.cn-northwest-1.amazonaws.com.cn",
        partition: "aws-cn",
      };
      break;
    case "eu-central-1":
    ...
    case "eu-north-1":
      regionInfo = {
        hostname: "mq.eu-north-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "eu-south-1":
      regionInfo = {
        hostname: "mq.eu-south-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "eu-west-1":
    ...
    case "me-south-1":
      regionInfo = {
        hostname: "mq.me-south-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "sa-east-1":
      regionInfo = {
        hostname: "mq.sa-east-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "us-east-1":
