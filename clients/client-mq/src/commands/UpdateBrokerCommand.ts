...
import type { UpdateBrokerRequest, UpdateBrokerResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateBrokerCommand extends command<UpdateBrokerCommandInput, UpdateBrokerCommandOutput>(
  _ep0,
  _mw0,
  "UpdateBroker",
  UpdateBroker$
