...
import type { DescribeBrokerRequest, DescribeBrokerResponse } from "../models/models_0";
 ...
 * @public
 */
export class DescribeBrokerCommand extends command<DescribeBrokerCommandInput, DescribeBrokerCommandOutput>(
  _ep0,
  _mw0,
  "DescribeBroker",
  DescribeBroker$
