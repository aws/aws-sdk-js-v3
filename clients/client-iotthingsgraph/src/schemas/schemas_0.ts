...
export var IoTThingsGraphServiceException$: StaticErrorSchema = [-3, _s, "IoTThingsGraphServiceException", 0, [], []];
...
export var DeleteSystemInstanceRequest$: StaticStructureSchema = [3, n0, _DSIR,
  0,
  [_i],
  [0]
];
export var DeleteSystemInstanceResponse$: StaticStructureSchema = [3, n0, _DSIRe,
  0,
  [],
  []
];
...
export var DependencyRevision$: StaticStructureSchema = [3, n0, _DR,
  0,
  [_i, _rN],
  [0, 1]
];
export var DeploySystemInstanceRequest$: StaticStructureSchema = [3, n0, _DSIRep,
  0,
  [_i],
  [0]
];
...
export var DescribeNamespaceResponse$: StaticStructureSchema = [3, n0, _DNResc,
  0,
...
export var EntityDescription$: StaticStructureSchema = [3, n0, _ED,
  0,
  [_i, _a, _ty, _cA, _d],
...
export var FlowExecutionMessage$: StaticStructureSchema = [3, n0, _FEM,
  0,
  [_mI, _eTv, _ti, _p],
  [0, 0, 4, 0]
];
...
export var FlowTemplateDescription$: StaticStructureSchema = [3, n0, _FTD,
  0,
  [_su, _d, _vNV],
...
export var GetNamespaceDeletionStatusRequest$: StaticStructureSchema = [3, n0, _GNDSR,
  0,
  [],
  []
];
export var GetNamespaceDeletionStatusResponse$: StaticStructureSchema = [3, n0, _GNDSRe,
  0,
  [_nA, _nN, _st, _eC, _eM],
  [0, 0, 0, 0, 0]
];
...
export var SearchFlowTemplatesRequest$: StaticStructureSchema = [3, n0, _SFTR,
  0,
  [_f, _nT, _mR],
  [() => FlowTemplateFilters, 0, 1]
];
export var SearchFlowTemplatesResponse$: StaticStructureSchema = [3, n0, _SFTRe,
  0,
  [_sum, _nT],
  [() => FlowTemplateSummaries, 0]
];
export var SearchSystemInstancesRequest$: StaticStructureSchema = [3, n0, _SSIR,
  0,
  [_f, _nT, _mR],
  [() => SystemInstanceFilters, 0, 1]
];
export var SearchSystemInstancesResponse$: StaticStructureSchema = [3, n0, _SSIRe,
  0,
  [_sum, _nT],
  [() => SystemInstanceSummaries, 0]
];
export var SearchSystemTemplatesRequest$: StaticStructureSchema = [3, n0, _SSTR,
  0,
  [_f, _nT, _mR],
  [() => SystemTemplateFilters, 0, 1]
];
export var SearchSystemTemplatesResponse$: StaticStructureSchema = [3, n0, _SSTRe,
  0,
  [_sum, _nT],
  [() => SystemTemplateSummaries, 0]
];
...
export var SystemInstanceDescription$: StaticStructureSchema = [3, n0, _SID,
  0,
  [_su, _d, _sBN, _mC, _vNV, _vDR, _fARA],
  [() => SystemInstanceSummary$, () => DefinitionDocument$, 0, () => MetricsConfiguration$, 1, () => DependencyRevisions, 0]
];
export var SystemInstanceFilter$: StaticStructureSchema = [3, n0, _SIF,
  0,
  [_n, _v],
  [0, 64 | 0]
];
...
export var Thing$: StaticStructureSchema = [3, n0, _Th,
  0,
  [_tA, _tN],
  [0, 0]
];
export var UndeploySystemInstanceRequest$: StaticStructureSchema = [3, n0, _USIR,
  0,
  [_i],
  [0]
];
export var UndeploySystemInstanceResponse$: StaticStructureSchema = [3, n0, _USIRn,
  0,
  [_su],
  [() => SystemInstanceSummary$]
];
...
export var UploadEntityDefinitionsRequest$: StaticStructureSchema = [3, n0, _UEDR,
  0,
  [_do, _sWPN, _dEE],
...
var DependencyRevisions: StaticListSchema = [1, n0, _DRe,
  0, () => DependencyRevision$
];
var EntityDescriptions: StaticListSchema = [1, n0, _EDn,
  0, () => EntityDescription$
];
var EntityFilters: StaticListSchema = [1, n0, _EFn,
  0, () => EntityFilter$
];
var EntityFilterValues = 64 | 0;
var EntityTypes = 64 | 0;
var FlowExecutionMessages: StaticListSchema = [1, n0, _FEMl,
  0, () => FlowExecutionMessage$
];
var FlowExecutionSummaries: StaticListSchema = [1, n0, _FESl,
  0, () => FlowExecutionSummary$
];
var FlowTemplateFilters: StaticListSchema = [1, n0, _FTFl,
  0, () => FlowTemplateFilter$
];
var FlowTemplateFilterValues = 64 | 0;
var FlowTemplateSummaries: StaticListSchema = [1, n0, _FTSl,
  0, () => FlowTemplateSummary$
];
var StringList = 64 | 0;
var SystemInstanceFilters: StaticListSchema = [1, n0, _SIFy,
  0, () => SystemInstanceFilter$
];
var SystemInstanceFilterValues = 64 | 0;
var SystemInstanceSummaries: StaticListSchema = [1, n0, _SISy,
  0, () => SystemInstanceSummary$
];
var SystemTemplateFilters: StaticListSchema = [1, n0, _STFy,
  0, () => SystemTemplateFilter$
];
var SystemTemplateFilterValues = 64 | 0;
var SystemTemplateSummaries: StaticListSchema = [1, n0, _STSy,
...
var Things: StaticListSchema = [1, n0, _Thi,
  0, () => Thing$
];
var Urns = 64 | 0;
export var AssociateEntityToThing$: StaticOperationSchema = [9, n0, _AETT,
  0, () => AssociateEntityToThingRequest$, () => AssociateEntityToThingResponse$
];
export var CreateFlowTemplate$: StaticOperationSchema = [9, n0, _CFT,
  0, () => CreateFlowTemplateRequest$, () => CreateFlowTemplateResponse$
];
export var CreateSystemInstance$: StaticOperationSchema = [9, n0, _CSI,
  0, () => CreateSystemInstanceRequest$, () => CreateSystemInstanceResponse$
];
export var CreateSystemTemplate$: StaticOperationSchema = [9, n0, _CST,
  0, () => CreateSystemTemplateRequest$, () => CreateSystemTemplateResponse$
];
export var DeleteFlowTemplate$: StaticOperationSchema = [9, n0, _DFT,
  0, () => DeleteFlowTemplateRequest$, () => DeleteFlowTemplateResponse$
];
export var DeleteNamespace$: StaticOperationSchema = [9, n0, _DN,
  0, () => DeleteNamespaceRequest$, () => DeleteNamespaceResponse$
];
export var DeleteSystemInstance$: StaticOperationSchema = [9, n0, _DSI,
  0, () => DeleteSystemInstanceRequest$, () => DeleteSystemInstanceResponse$
];
export var DeleteSystemTemplate$: StaticOperationSchema = [9, n0, _DST,
  0, () => DeleteSystemTemplateRequest$, () => DeleteSystemTemplateResponse$
];
export var DeploySystemInstance$: StaticOperationSchema = [9, n0, _DSIe,
  0, () => DeploySystemInstanceRequest$, () => DeploySystemInstanceResponse$
];
export var DeprecateFlowTemplate$: StaticOperationSchema = [9, n0, _DFTe,
  0, () => DeprecateFlowTemplateRequest$, () => DeprecateFlowTemplateResponse$
];
export var DeprecateSystemTemplate$: StaticOperationSchema = [9, n0, _DSTe,
  0, () => DeprecateSystemTemplateRequest$, () => DeprecateSystemTemplateResponse$
];
export var DescribeNamespace$: StaticOperationSchema = [9, n0, _DNe,
  0, () => DescribeNamespaceRequest$, () => DescribeNamespaceResponse$
];
export var DissociateEntityFromThing$: StaticOperationSchema = [9, n0, _DEFT,
  0, () => DissociateEntityFromThingRequest$, () => DissociateEntityFromThingResponse$
];
export var GetEntities$: StaticOperationSchema = [9, n0, _GE,
  0, () => GetEntitiesRequest$, () => GetEntitiesResponse$
];
export var GetFlowTemplate$: StaticOperationSchema = [9, n0, _GFT,
  0, () => GetFlowTemplateRequest$, () => GetFlowTemplateResponse$
];
export var GetFlowTemplateRevisions$: StaticOperationSchema = [9, n0, _GFTRet,
  0, () => GetFlowTemplateRevisionsRequest$, () => GetFlowTemplateRevisionsResponse$
];
export var GetNamespaceDeletionStatus$: StaticOperationSchema = [9, n0, _GNDS,
  0, () => GetNamespaceDeletionStatusRequest$, () => GetNamespaceDeletionStatusResponse$
];
export var GetSystemInstance$: StaticOperationSchema = [9, n0, _GSI,
  0, () => GetSystemInstanceRequest$, () => GetSystemInstanceResponse$
];
export var GetSystemTemplate$: StaticOperationSchema = [9, n0, _GST,
  0, () => GetSystemTemplateRequest$, () => GetSystemTemplateResponse$
];
export var GetSystemTemplateRevisions$: StaticOperationSchema = [9, n0, _GSTRet,
  0, () => GetSystemTemplateRevisionsRequest$, () => GetSystemTemplateRevisionsResponse$
];
export var GetUploadStatus$: StaticOperationSchema = [9, n0, _GUS,
  0, () => GetUploadStatusRequest$, () => GetUploadStatusResponse$
];
export var ListFlowExecutionMessages$: StaticOperationSchema = [9, n0, _LFEM,
  0, () => ListFlowExecutionMessagesRequest$, () => ListFlowExecutionMessagesResponse$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceRequest$, () => ListTagsForResourceResponse$
];
export var SearchEntities$: StaticOperationSchema = [9, n0, _SE,
  0, () => SearchEntitiesRequest$, () => SearchEntitiesResponse$
];
export var SearchFlowExecutions$: StaticOperationSchema = [9, n0, _SFE,
  0, () => SearchFlowExecutionsRequest$, () => SearchFlowExecutionsResponse$
];
export var SearchFlowTemplates$: StaticOperationSchema = [9, n0, _SFT,
  0, () => SearchFlowTemplatesRequest$, () => SearchFlowTemplatesResponse$
];
export var SearchSystemInstances$: StaticOperationSchema = [9, n0, _SSI,
  0, () => SearchSystemInstancesRequest$, () => SearchSystemInstancesResponse$
];
export var SearchSystemTemplates$: StaticOperationSchema = [9, n0, _SST,
  0, () => SearchSystemTemplatesRequest$, () => SearchSystemTemplatesResponse$
];
export var SearchThings$: StaticOperationSchema = [9, n0, _ST,
  0, () => SearchThingsRequest$, () => SearchThingsResponse$
];
export var TagResource$: StaticOperationSchema = [9, n0, _TR,
  0, () => TagResourceRequest$, () => TagResourceResponse$
];
export var UndeploySystemInstance$: StaticOperationSchema = [9, n0, _USI,
...
export var UpdateFlowTemplate$: StaticOperationSchema = [9, n0, _UFT,
  0, () => UpdateFlowTemplateRequest$, () => UpdateFlowTemplateResponse$
];
export var UpdateSystemTemplate$: StaticOperationSchema = [9, n0, _UST,
  0, () => UpdateSystemTemplateRequest$, () => UpdateSystemTemplateResponse$
];
export var UploadEntityDefinitions$: StaticOperationSchema = [9, n0, _UED,
