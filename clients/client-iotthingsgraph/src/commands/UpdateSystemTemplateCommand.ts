...
import type { UpdateSystemTemplateRequest, UpdateSystemTemplateResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateSystemTemplateCommand extends command<UpdateSystemTemplateCommandInput, UpdateSystemTemplateCommandOutput>(
  _ep0,
  _mw0,
