...
import { type SESClientResolvedConfig, SESClientConfig } from "../SESClient";
 ...
 * @internal
 */
export const defaultSESHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SESHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<SESClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultSESHttpAuthSchemeProvider: SESHttpAuthSchemeProvider = (authParameters) => {
