 ...
 * @public
 */
export class CreateCustomVerificationEmailTemplateCommand extends command<CreateCustomVerificationEmailTemplateCommandInput, CreateCustomVerificationEmailTemplateCommandOutput>(
  _ep0,
  _mw0,
