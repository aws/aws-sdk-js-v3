...
import { DescribeReceiptRuleRequest, DescribeReceiptRuleResponse } from "../models/index";
import { Command as $Command } from "@aws-sdk/smithy-client";
import { Handler, MiddlewareStack, HttpHandlerOptions as __HttpHandlerOptions, MetadataBearer as __MetadataBearer } from "@aws-sdk/types";
export declare type DescribeReceiptRuleCommandInput = DescribeReceiptRuleRequest;
export declare type DescribeReceiptRuleCommandOutput = DescribeReceiptRuleResponse & __MetadataBearer;
