...
export type ProfileClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
  EndpointsInputConfig &
  AwsAuthInputConfig &
...
export type ProfileClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 */
export class ProfileClient extends __Client<
  __HttpHandlerOptions,
  ServiceInputTypes,
  ServiceOutputTypes,
  ProfileClientResolvedConfig
> {
  readonly config: ProfileClientResolvedConfig;

  constructor(configuration: ProfileClientConfig) {
    let _config_0 = {
