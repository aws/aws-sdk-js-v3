 ...
 * @public
 */
export class GetCalculatedAttributeDefinitionCommand extends command<GetCalculatedAttributeDefinitionCommandInput, GetCalculatedAttributeDefinitionCommandOutput>(
  _ep0,
  _mw0,
