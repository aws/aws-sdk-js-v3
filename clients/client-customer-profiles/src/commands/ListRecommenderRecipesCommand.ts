...
import type { ListRecommenderRecipesRequest, ListRecommenderRecipesResponse } from "../models/models_1";
 ...
 * @public
 */
export class ListRecommenderRecipesCommand extends command<ListRecommenderRecipesCommandInput, ListRecommenderRecipesCommandOutput>(
  _ep0,
  _mw0,
