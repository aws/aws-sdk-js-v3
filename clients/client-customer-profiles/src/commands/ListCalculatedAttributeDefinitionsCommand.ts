 ...
 * @public
 */
export class ListCalculatedAttributeDefinitionsCommand extends command<ListCalculatedAttributeDefinitionsCommandInput, ListCalculatedAttributeDefinitionsCommandOutput>(
  _ep0,
  _mw0,
