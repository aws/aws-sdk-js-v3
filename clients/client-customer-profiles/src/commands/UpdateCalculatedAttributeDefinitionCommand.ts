 ...
 * @public
 */
export class UpdateCalculatedAttributeDefinitionCommand extends command<UpdateCalculatedAttributeDefinitionCommandInput, UpdateCalculatedAttributeDefinitionCommandOutput>(
  _ep0,
  _mw0,
