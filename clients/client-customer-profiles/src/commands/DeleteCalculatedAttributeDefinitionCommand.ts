 ...
 * @public
 */
export class DeleteCalculatedAttributeDefinitionCommand extends command<DeleteCalculatedAttributeDefinitionCommandInput, DeleteCalculatedAttributeDefinitionCommandOutput>(
  _ep0,
  _mw0,
