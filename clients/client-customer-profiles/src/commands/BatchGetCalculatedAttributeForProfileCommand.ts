 ...
 * @public
 */
export class BatchGetCalculatedAttributeForProfileCommand extends command<BatchGetCalculatedAttributeForProfileCommandInput, BatchGetCalculatedAttributeForProfileCommandOutput>(
  _ep0,
  _mw0,
