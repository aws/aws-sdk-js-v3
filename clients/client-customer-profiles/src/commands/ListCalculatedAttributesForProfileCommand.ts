 ...
 * @public
 */
export class ListCalculatedAttributesForProfileCommand extends command<ListCalculatedAttributesForProfileCommandInput, ListCalculatedAttributesForProfileCommandOutput>(
  _ep0,
  _mw0,
