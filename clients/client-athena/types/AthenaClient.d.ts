...
export declare type ServiceInputTypes = BatchGetNamedQueryCommandInput | BatchGetQueryExecutionCommandInput | CreateNamedQueryCommandInput | CreateWorkGroupCommandInput | DeleteNamedQueryCommandInput | DeleteWorkGroupCommandInput | GetNamedQueryCommandInput | GetQueryExecutionCommandInput | GetQueryResultsCommandInput | GetWorkGroupCommandInput | ListNamedQueriesCommandInput | ListQueryExecutionsCommandInput | ListTagsForResourceCommandInput | ListWorkGroupsCommandInput | StartQueryExecutionCommandInput | StopQueryExecutionCommandInput | TagResourceCommandInput | UntagResourceCommandInput | UpdateWorkGroupCommandInput;
export declare type ServiceOutputTypes = BatchGetNamedQueryCommandOutput | BatchGetQueryExecutionCommandOutput | CreateNamedQueryCommandOutput | CreateWorkGroupCommandOutput | DeleteNamedQueryCommandOutput | DeleteWorkGroupCommandOutput | GetNamedQueryCommandOutput | GetQueryExecutionCommandOutput | GetQueryResultsCommandOutput | GetWorkGroupCommandOutput | ListNamedQueriesCommandOutput | ListQueryExecutionsCommandOutput | ListTagsForResourceCommandOutput | ListWorkGroupsCommandOutput | StartQueryExecutionCommandOutput | StopQueryExecutionCommandOutput | TagResourceCommandOutput | UntagResourceCommandOutput | UpdateWorkGroupCommandOutput;
...
export declare type AthenaClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type AthenaClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
