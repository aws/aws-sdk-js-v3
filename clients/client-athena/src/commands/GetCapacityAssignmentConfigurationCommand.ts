 ...
 * @public
 */
export class GetCapacityAssignmentConfigurationCommand extends command<GetCapacityAssignmentConfigurationCommandInput, GetCapacityAssignmentConfigurationCommandOutput>(
  _ep0,
  _mw0,
