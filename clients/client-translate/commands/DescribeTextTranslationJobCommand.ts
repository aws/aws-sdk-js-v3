...
export type DescribeTextTranslationJobCommandOutput = DescribeTextTranslationJobResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1DescribeTextTranslationJobCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1DescribeTextTranslationJobCommand(
      output,
      context
    );
  }
