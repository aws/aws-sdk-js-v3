...
export var ListAssociatedAttributeGroupsResponse$: StaticStructureSchema = [
  3,
  n0,
  _LAAGRi,
  0,
...
export var ListAssociatedResourcesResponse$: StaticStructureSchema = [
  3,
  n0,
  _LARRi,
  0,
...
var AttributeGroupDetailsList: StaticListSchema = [1, n0, _AGDL, 0, () => AttributeGroupDetails$];
var AttributeGroupIds = 64 | 0;
var AttributeGroupSummaries: StaticListSchema = [1, n0, _AGSt, 0, () => AttributeGroupSummary$];
var GetAssociatedResourceFilter = 64 | 0;
var Options = 64 | 0;
var Resources: StaticListSchema = [1, n0, _Re, 0, () => ResourceInfo$];
var ResourcesList: StaticListSchema = [1, n0, _RL, 0, () => ResourcesListItem$];
var TagKeys = 64 | 0;
