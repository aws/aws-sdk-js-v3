...
export var ApplicationTagResult$: StaticStructureSchema = [3, n0, _ATR,
  0,
  [_aTS, _eM, _r, _nT],
  [0, 0, () => ResourcesList, 0]
];
export var AppRegistryConfiguration$: StaticStructureSchema = [3, n0, _ARC,
  0,
  [_tQC],
...
export var AttributeGroup$: StaticStructureSchema = [3, n0, _AG,
  0,
  [_i, _a, _n, _d, _cT, _lUT, _t],
  [0, 0, 0, 0, 5, 5, 128 | 0]
];
export var AttributeGroupDetails$: StaticStructureSchema = [3, n0, _AGD,
  0,
  [_i, _a, _n, _cB],
  [0, 0, 0, 0]
];
export var AttributeGroupSummary$: StaticStructureSchema = [3, n0, _AGS,
  0,
...
export var GetConfigurationResponse$: StaticStructureSchema = [3, n0, _GCR,
  0,
  [_co],
  [() => AppRegistryConfiguration$]
];
export var Integrations$: StaticStructureSchema = [3, n0, _I,
  0,
  [_rG, _aTRG],
...
export var ListAttributeGroupsRequest$: StaticStructureSchema = [3, n0, _LAGR,
  0,
  [_nT, _mR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListAttributeGroupsResponse$: StaticStructureSchema = [3, n0, _LAGRi,
  0,
  [_aGt, _nT],
...
export var ResourceGroup$: StaticStructureSchema = [3, n0, _RG,
  0,
  [_st, _a, _eM],
  [0, 0, 0]
];
...
export var ResourceIntegrations$: StaticStructureSchema = [3, n0, _RIe,
  0,
  [_rG],
  [() => ResourceGroup$]
];
...
export var TagQueryConfiguration$: StaticStructureSchema = [3, n0, _TQC,
  0,
  [_tK],
  [0]
];
...
var AttributeGroupDetailsList: StaticListSchema = [1, n0, _AGDL,
  0, () => AttributeGroupDetails$
];
var AttributeGroupIds = 64 | 0;
var AttributeGroupSummaries: StaticListSchema = [1, n0, _AGSt,
...
var ResourcesList: StaticListSchema = [1, n0, _RL,
  0, () => ResourcesListItem$
];
var TagKeys = 64 | 0;
var ApplicationTagDefinition = 128 | 0;
var Tags = 128 | 0;
export var AssociateAttributeGroup$: StaticOperationSchema = [9, n0, _AAG,
...
export var AssociateResource$: StaticOperationSchema = [9, n0, _AR,
...
export var CreateAttributeGroup$: StaticOperationSchema = [9, n0, _CAG,
...
export var DeleteAttributeGroup$: StaticOperationSchema = [9, n0, _DAG,
  { [_h]: ["DELETE", "/attribute-groups/{attributeGroup}", 200] }, () => DeleteAttributeGroupRequest$, () => DeleteAttributeGroupResponse$
];
export var DisassociateAttributeGroup$: StaticOperationSchema = [9, n0, _DAGi,
...
export var DisassociateResource$: StaticOperationSchema = [9, n0, _DR,
...
export var GetAssociatedResource$: StaticOperationSchema = [9, n0, _GARet,
...
export var GetAttributeGroup$: StaticOperationSchema = [9, n0, _GAG,
...
export var ListAssociatedAttributeGroups$: StaticOperationSchema = [9, n0, _LAAG,
...
export var ListAssociatedResources$: StaticOperationSchema = [9, n0, _LARis,
  { [_h]: ["GET", "/applications/{application}/resources", 200] }, () => ListAssociatedResourcesRequest$, () => ListAssociatedResourcesResponse$
];
export var ListAttributeGroups$: StaticOperationSchema = [9, n0, _LAG,
  { [_h]: ["GET", "/attribute-groups", 200] }, () => ListAttributeGroupsRequest$, () => ListAttributeGroupsResponse$
];
export var ListAttributeGroupsForApplication$: StaticOperationSchema = [9, n0, _LAGFA,
...
export var PutConfiguration$: StaticOperationSchema = [9, n0, _PC,
  { [_h]: ["PUT", "/configuration", 200] }, () => PutConfigurationRequest$, () => __Unit
];
export var SyncResource$: StaticOperationSchema = [9, n0, _SR,
...
export var UpdateAttributeGroup$: StaticOperationSchema = [9, n0, _UAG,
