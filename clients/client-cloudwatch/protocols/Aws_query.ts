...
const serializeAws_queryAnomalyDetectorExcludedTimeRanges = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryRange(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryDimensionFilters = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryDimensionFilter(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryDimensions = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryDimension(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryMetricData = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryMetricDatum(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryMetricDataQueries = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryMetricDataQuery(entry, context);
    counter++;
  });
  return entries;
};
...
const deserializeAws_queryAnomalyDetector = (
  ...
  if (output["Dimensions"]["member"] !== undefined) {
...
const deserializeAws_queryAnomalyDetectorConfiguration = (
  ...
  if (output["ExcludedTimeRanges"]["member"] !== undefined) {
...
const deserializeAws_queryDashboardInvalidInputError = (
  ...
  if (output["dashboardValidationMessages"]["member"] !== undefined) {
...
const deserializeAws_queryDatapoint = (
  ...
  if (output["ExtendedStatistics"]["entry"] !== undefined) {
...
const deserializeAws_queryDeleteInsightRulesOutput = (
  ...
  if (output["Failures"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeAlarmHistoryOutput = (
  ...
  if (output["AlarmHistoryItems"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeAlarmsForMetricOutput = (
  ...
  if (output["MetricAlarms"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeAnomalyDetectorsOutput = (
  ...
  if (output["AnomalyDetectors"]["member"] !== undefined) {
...
const deserializeAws_queryDescribeInsightRulesOutput = (
  ...
  if (output["InsightRules"]["member"] !== undefined) {
...
const deserializeAws_queryGetMetricStatisticsOutput = (
  ...
  if (output["Datapoints"]["member"] !== undefined) {
...
const deserializeAws_queryInsightRuleContributor = (
  ...
  if (output["Keys"]["member"] !== undefined) {
...
const deserializeAws_queryListDashboardsOutput = (
  ...
  if (output["DashboardEntries"]["member"] !== undefined) {
...
const deserializeAws_queryListMetricsOutput = (
  ...
  if (output["Metrics"]["member"] !== undefined) {
...
const deserializeAws_queryListTagsForResourceOutput = (
  ...
  if (output["Tags"]["member"] !== undefined) {
...
const deserializeAws_queryMetricAlarm = (
  ...
  if (output["AlarmActions"]["member"] !== undefined) {
  ...
  if (output["InsufficientDataActions"]["member"] !== undefined) {
  ...
  if (output["OKActions"]["member"] !== undefined) {
