...
import { type CloudWatchClientResolvedConfig, CloudWatchClientConfig } from "../CloudWatchClient";
 ...
 * @internal
 */
export const defaultCloudWatchHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CloudWatchHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<CloudWatchClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultCloudWatchHttpAuthSchemeProvider: CloudWatchHttpAuthSchemeProvider = (authParameters) => {
