...
export var InvoicingServiceException$: StaticErrorSchema = [-3, _s, "InvoicingServiceException", 0, [], []];
...
var SensitiveBasicStringWithoutSpace: StaticSimpleSchema = [0, n0, _SBSWS, 8, 0];
export var AmountBreakdown$: StaticStructureSchema = [3, n0, _AB,
  0,
  [_STA, _D, _T, _F],
...
export var DiscountsBreakdownAmount$: StaticStructureSchema = [3, n0, _DBA,
  0,
  [_De, _A, _Ra],
  [0, 0, 0]
];
...
export var FeesBreakdownAmount$: StaticStructureSchema = [3, n0, _FBA,
  0,
  [_De, _A, _Ra],
  [0, 0, 0]
];
...
export var InvoicePDF$: StaticStructureSchema = [3, n0, _IPDF,
  0,
  [_II, _DU, _DUED, _SDu],
  [0, 0, 4, () => SupplementalDocuments]
];
export var InvoiceProfile$: StaticStructureSchema = [3, n0, _IP,
  0,
...
export var InvoiceUnitRule$: StaticStructureSchema = [3, n0, _IUR,
  0,
  [_LA, _BSA],
  [64 | 0, 64 | 0]
];
...
export var ListInvoiceUnitsResponse$: StaticStructureSchema = [3, n0, _LIURi,
  0,
  [_IUn, _NT],
  [() => InvoiceUnits, 0]
];
export var ListProcurementPortalPreferencesRequest$: StaticStructureSchema = [3, n0, _LPPPR,
  0,
  [_NT, _MR],
  [0, 1]
];
export var ListProcurementPortalPreferencesResponse$: StaticStructureSchema = [3, n0, _LPPPRi,
  0,
  [_PPPr, _NT],
...
export var TaxesBreakdown$: StaticStructureSchema = [3, n0, _TB,
  0,
  [_B, _TA],
  [() => TaxesBreakdownAmountList, 0]
];
export var TaxesBreakdownAmount$: StaticStructureSchema = [3, n0, _TBA,
  0,
  [_De, _A, _Ra],
  [0, 0, 0]
];
...
var DiscountsBreakdownAmountList: StaticListSchema = [1, n0, _DBAL,
  0, () => DiscountsBreakdownAmount$
];
var EinvoiceDeliveryAttachmentTypes = 64 | 0;
var EinvoiceDeliveryDocumentTypes = 64 | 0;
var FeesBreakdownAmountList: StaticListSchema = [1, n0, _FBAL,
  0, () => FeesBreakdownAmount$
];
var InvoiceSummaries: StaticListSchema = [1, n0, _ISn,
  0, () => InvoiceSummary$
];
var InvoiceUnitArns = 64 | 0;
var InvoiceUnitNames = 64 | 0;
var InvoiceUnits: StaticListSchema = [1, n0, _IUn,
  0, () => InvoiceUnit$
];
...
var PurchaseOrderDataSources: StaticListSchema = [1, n0, _PODS,
...
var SupplementalDocuments: StaticListSchema = [1, n0, _SDu,
  0, () => SupplementalDocument$
];
var TaxesBreakdownAmountList: StaticListSchema = [1, n0, _TBAL,
  0, () => TaxesBreakdownAmount$
];
var ValidationExceptionFieldList: StaticListSchema = [1, n0, _VEFL,
  0, () => ValidationExceptionField$
];
export var BatchGetInvoiceProfile$: StaticOperationSchema = [9, n0, _BGIP,
...
export var GetInvoiceUnit$: StaticOperationSchema = [9, n0, _GIU,
  0, () => GetInvoiceUnitRequest$, () => GetInvoiceUnitResponse$
];
export var GetProcurementPortalPreference$: StaticOperationSchema = [9, n0, _GPPP,
  0, () => GetProcurementPortalPreferenceRequest$, () => GetProcurementPortalPreferenceResponse$
];
export var ListInvoiceSummaries$: StaticOperationSchema = [9, n0, _LIS,
  0, () => ListInvoiceSummariesRequest$, () => ListInvoiceSummariesResponse$
];
export var ListInvoiceUnits$: StaticOperationSchema = [9, n0, _LIU,
