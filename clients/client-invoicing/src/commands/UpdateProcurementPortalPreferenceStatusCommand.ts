 ...
 * @public
 */
export class UpdateProcurementPortalPreferenceStatusCommand extends command<UpdateProcurementPortalPreferenceStatusCommandInput, UpdateProcurementPortalPreferenceStatusCommandOutput>(
  _ep0,
  _mw0,
