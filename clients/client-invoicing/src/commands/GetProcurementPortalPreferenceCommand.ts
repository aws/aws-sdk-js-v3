 ...
 * @public
 */
export class GetProcurementPortalPreferenceCommand extends command<GetProcurementPortalPreferenceCommandInput, GetProcurementPortalPreferenceCommandOutput>(
  _ep0,
  _mw0,
