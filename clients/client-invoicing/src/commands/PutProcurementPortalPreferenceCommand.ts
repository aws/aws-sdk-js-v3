 ...
 * @public
 */
export class PutProcurementPortalPreferenceCommand extends command<PutProcurementPortalPreferenceCommandInput, PutProcurementPortalPreferenceCommandOutput>(
  _ep0,
  _mw0,
