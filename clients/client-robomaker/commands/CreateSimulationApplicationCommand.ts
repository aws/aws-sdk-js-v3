...
import { CreateSimulationApplicationRequest, CreateSimulationApplicationResponse } from "../models/index";
import {
...
> {
  ...
  private serialize(input: CreateSimulationApplicationCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1CreateSimulationApplicationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateSimulationApplicationCommand(output, context);
  }
