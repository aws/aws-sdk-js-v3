...
import { DescribeSimulationApplicationRequest, DescribeSimulationApplicationResponse } from "../models/index";
import {
  deserializeAws_restJson1_1DescribeSimulationApplicationCommand,
  serializeAws_restJson1_1DescribeSimulationApplicationCommand
...
> {
  ...
  private serialize(input: DescribeSimulationApplicationCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1DescribeSimulationApplicationCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeSimulationApplicationCommand(output, context);
  }
