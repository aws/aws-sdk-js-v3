...
import { CreateRobotApplicationVersionRequest, CreateRobotApplicationVersionResponse } from "../models/index";
import {
  deserializeAws_restJson1_1CreateRobotApplicationVersionCommand,
  serializeAws_restJson1_1CreateRobotApplicationVersionCommand
...
> {
  ...
  private serialize(input: CreateRobotApplicationVersionCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1CreateRobotApplicationVersionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateRobotApplicationVersionCommand(output, context);
  }
