...
import { DescribeWorldGenerationJob } from "../schemas/schemas_12_Job";
...
export class DescribeWorldGenerationJobCommand extends $Command
  ...
  .s("robomaker", "DescribeWorldGenerationJob", {})
  .n("RoboMakerClient", "DescribeWorldGenerationJobCommand")
  .sc(DescribeWorldGenerationJob)
  .build() {
