...
import { CancelWorldExportJob } from "../schemas/schemas_30_CancelWorldExportJob";
...
export class CancelWorldExportJobCommand extends $Command
  ...
  .s("robomaker", "CancelWorldExportJob", {})
  .n("RoboMakerClient", "CancelWorldExportJobCommand")
  .sc(CancelWorldExportJob)
  .build() {
  ...
  protected declare static __types: {
    ...
    sdk: {
      ...
      output: CancelWorldExportJobCommandOutput;
    };
  };
}
