...
export type DescribeWorldExportJobCommandInput = DescribeWorldExportJobRequest;
export type DescribeWorldExportJobCommandOutput = DescribeWorldExportJobResponse & __MetadataBearer;
