...
const deserializeAws_restJson1_1Block = (output: any, context: __SerdeContext): Block => {
  return {
    __type: "Block",
    BlockIndex:
      output.BlockIndex !== undefined && output.BlockIndex !== null ? output.BlockIndex : undefined,
    BlockToken:
      output.BlockToken !== undefined && output.BlockToken !== null ? output.BlockToken : undefined
  } as any;
};
