...
import {
  defaultMobileHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export class MobileClient extends __Client<
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<MobileClientConfig>) {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultMobileHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: MobileClientResolvedConfig) =>
