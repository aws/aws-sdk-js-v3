...
import {
  ...
  serializeAws_restJson1_1ExportProjectCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ExportProjectCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ExportProjectCommand(output, context);
  }
