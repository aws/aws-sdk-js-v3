...
import { type EvsClientResolvedConfig, EvsClientConfig } from "../EvsClient";
 ...
 * @internal
 */
export const defaultEvsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: EvsHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<EvsClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultEvsHttpAuthSchemeProvider: EvsHttpAuthSchemeProvider = (authParameters) => {
