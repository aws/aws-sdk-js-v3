...
import {
  defaultEvsHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export class EvsClient extends __Client<
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<EvsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultEvsHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: EvsClientResolvedConfig) =>
