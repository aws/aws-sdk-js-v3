...
import { type ChimeSDKMessagingClientResolvedConfig, ChimeSDKMessagingClientConfig } from "../ChimeSDKMessagingClient";
 ...
 * @internal
 */
export const defaultChimeSDKMessagingHttpAuthSchemeProvider: ChimeSDKMessagingHttpAuthSchemeProvider = (authParameters) => {
