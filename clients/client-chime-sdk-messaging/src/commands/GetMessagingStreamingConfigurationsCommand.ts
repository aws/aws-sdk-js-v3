 ...
 * @public
 */
export class GetMessagingStreamingConfigurationsCommand extends command<GetMessagingStreamingConfigurationsCommandInput, GetMessagingStreamingConfigurationsCommandOutput>(
  _ep0,
  _mw0,
