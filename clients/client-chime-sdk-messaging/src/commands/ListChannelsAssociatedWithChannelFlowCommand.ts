 ...
 * @public
 */
export class ListChannelsAssociatedWithChannelFlowCommand extends command<ListChannelsAssociatedWithChannelFlowCommandInput, ListChannelsAssociatedWithChannelFlowCommandOutput>(
  _ep0,
  _mw0,
