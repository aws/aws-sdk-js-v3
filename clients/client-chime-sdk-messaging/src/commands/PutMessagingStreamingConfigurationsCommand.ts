 ...
 * @public
 */
export class PutMessagingStreamingConfigurationsCommand extends command<PutMessagingStreamingConfigurationsCommandInput, PutMessagingStreamingConfigurationsCommandOutput>(
  _ep0,
  _mw0,
