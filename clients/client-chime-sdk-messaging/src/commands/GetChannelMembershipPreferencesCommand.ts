 ...
 * @public
 */
export class GetChannelMembershipPreferencesCommand extends command<GetChannelMembershipPreferencesCommandInput, GetChannelMembershipPreferencesCommandOutput>(
  _ep0,
  _mw0,
