 ...
 * @public
 */
export class DeleteMessagingStreamingConfigurationsCommand extends command<DeleteMessagingStreamingConfigurationsCommandInput, DeleteMessagingStreamingConfigurationsCommandOutput>(
  _ep0,
  _mw0,
