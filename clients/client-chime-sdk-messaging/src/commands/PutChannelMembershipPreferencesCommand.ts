 ...
 * @public
 */
export class PutChannelMembershipPreferencesCommand extends command<PutChannelMembershipPreferencesCommandInput, PutChannelMembershipPreferencesCommandOutput>(
  _ep0,
  _mw0,
