...
export var BatchUpdateWorkloadEstimateUsageEntry$: StaticStructureSchema = [
  3,
  n0,
  _BUWEUE,
  0,
...
export var CostDifference$: StaticStructureSchema = [
  3,
  n0,
  _CD,
  0,
...
export var ListBillEstimateLineItemsFilter$: StaticStructureSchema = [
  3,
  n0,
  _LBELIF,
  0,
...
var BatchCreateBillScenarioCommitmentModificationEntries: StaticListSchema = [
  1,
  n0,
  _BCBSCMEat,
  0,
...
var BatchCreateBillScenarioCommitmentModificationErrors: StaticListSchema = [
  1,
  n0,
  _BCBSCMEatc,
  0,
...
var BatchCreateBillScenarioCommitmentModificationItems: StaticListSchema = [
  1,
  n0,
  _BCBSCMIa,
  0,
...
var BatchCreateBillScenarioUsageModificationEntries: StaticListSchema = [
  1,
  n0,
  _BCBSUMEat,
  0,
...
var BatchCreateBillScenarioUsageModificationErrors: StaticListSchema = [
  1,
  n0,
  _BCBSUMEatc,
  0,
...
var BatchCreateBillScenarioUsageModificationItems: StaticListSchema = [
  1,
  n0,
  _BCBSUMIa,
  0,
...
var BatchCreateWorkloadEstimateUsageEntries: StaticListSchema = [
  1,
  n0,
  _BCWEUEat,
  0,
...
var BatchCreateWorkloadEstimateUsageErrors: StaticListSchema = [
  1,
  n0,
  _BCWEUEatc,
  0,
...
var BatchCreateWorkloadEstimateUsageItems: StaticListSchema = [
  1,
  n0,
  _BCWEUIa,
  0,
...
var BatchDeleteBillScenarioCommitmentModificationErrors: StaticListSchema = [
  1,
  n0,
  _BDBSCMEa,
  0,
...
var BatchDeleteBillScenarioUsageModificationErrors: StaticListSchema = [
  1,
  n0,
  _BDBSUMEa,
  0,
...
var BatchDeleteWorkloadEstimateUsageErrors: StaticListSchema = [
  1,
  n0,
  _BDWEUEa,
  0,
...
var BatchUpdateBillScenarioCommitmentModificationEntries: StaticListSchema = [
  1,
  n0,
  _BUBSCMEat,
  0,
...
var BatchUpdateBillScenarioCommitmentModificationErrors: StaticListSchema = [
  1,
  n0,
  _BUBSCMEatc,
  0,
...
var BatchUpdateBillScenarioUsageModificationEntries: StaticListSchema = [
  1,
  n0,
  _BUBSUMEat,
  0,
...
var BatchUpdateBillScenarioUsageModificationErrors: StaticListSchema = [
  1,
  n0,
  _BUBSUMEatc,
  0,
...
var BatchUpdateWorkloadEstimateUsageEntries: StaticListSchema = [
  1,
  n0,
  _BUWEUEat,
  0,
...
var BatchUpdateWorkloadEstimateUsageErrors: StaticListSchema = [
  1,
  n0,
  _BUWEUEatc,
  0,
...
var BillEstimateCommitmentSummaries: StaticListSchema = [1, n0, _BECSil, 0, () => BillEstimateCommitmentSummary$];
var BillEstimateInputCommitmentModificationSummaries: StaticListSchema = [
  1,
  n0,
  _BEICMSi,
  0,
...
var BillEstimateInputUsageModificationSummaries: StaticListSchema = [
  1,
  n0,
  _BEIUMSi,
  0,
...
var BillEstimateLineItemSummaries: StaticListSchema = [1, n0, _BELISi, 0, () => BillEstimateLineItemSummary$];
var BillEstimateSummaries: StaticListSchema = [1, n0, _BESi, 0, () => BillEstimateSummary$];
var BillScenarioCommitmentModificationItems: StaticListSchema = [
  1,
  n0,
  _BSCMIi,
  0,
...
var BillScenarioSummaries: StaticListSchema = [1, n0, _BSSi, 0, () => BillScenarioSummary$];
var BillScenarioUsageModificationItems: StaticListSchema = [
  1,
  n0,
  _BSUMIi,
  0,
...
var ExpressionList: StaticListSchema = [1, n0, _EL, 0, () => Expression$];
var ListBillEstimateLineItemsFilters: StaticListSchema = [1, n0, _LBELIFi, 0, () => ListBillEstimateLineItemsFilter$];
var ListBillEstimateLineItemsFilterValues = 64 | 0;
var ListBillEstimatesFilters: StaticListSchema = [1, n0, _LBEFi, 0, () => ListBillEstimatesFilter$];
var ListBillEstimatesFilterValues = 64 | 0;
var ListBillScenariosFilters: StaticListSchema = [1, n0, _LBSFi, 0, () => ListBillScenariosFilter$];
var ListBillScenariosFilterValues = 64 | 0;
var ListUsageFilters: StaticListSchema = [1, n0, _LUFi, 0, () => ListUsageFilter$];
var ListUsageFilterValues = 64 | 0;
var ListWorkloadEstimatesFilters: StaticListSchema = [1, n0, _LWEFi, 0, () => ListWorkloadEstimatesFilter$];
var ListWorkloadEstimatesFilterValues = 64 | 0;
var RateTypes = 64 | 0;
var ResourceTagKeys = 64 | 0;
var SavingsPlanArns = 64 | 0;
var StringList = 64 | 0;
var UsageAmounts: StaticListSchema = [1, n0, _UAs, 0, () => UsageAmount$];
var UsageQuantities: StaticListSchema = [1, n0, _UQs, 0, () => UsageQuantity$];
var ValidationExceptionFieldList: StaticListSchema = [1, n0, _VEFL, 0, () => ValidationExceptionField$];
var WorkloadEstimateSummaries: StaticListSchema = [1, n0, _WESo, 0, () => WorkloadEstimateSummary$];
var WorkloadEstimateUsageItems: StaticListSchema = [1, n0, _WEUIo, 0, () => WorkloadEstimateUsageItem$];
var ServiceCostDifferenceMap: StaticMapSchema = [2, n0, _SCDM, 0, 0, () => CostDifference$];
var Tags = 128 | 0;
