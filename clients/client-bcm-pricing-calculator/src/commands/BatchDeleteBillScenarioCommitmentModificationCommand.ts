 ...
 * @public
 */
export class BatchDeleteBillScenarioCommitmentModificationCommand extends command<BatchDeleteBillScenarioCommitmentModificationCommandInput, BatchDeleteBillScenarioCommitmentModificationCommandOutput>(
  _ep0,
  _mw0,
