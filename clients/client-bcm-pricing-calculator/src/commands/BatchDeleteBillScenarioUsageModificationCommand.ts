 ...
 * @public
 */
export class BatchDeleteBillScenarioUsageModificationCommand extends command<BatchDeleteBillScenarioUsageModificationCommandInput, BatchDeleteBillScenarioUsageModificationCommandOutput>(
  _ep0,
  _mw0,
