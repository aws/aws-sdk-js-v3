 ...
 * @public
 */
export class ListBillEstimateInputCommitmentModificationsCommand extends command<ListBillEstimateInputCommitmentModificationsCommandInput, ListBillEstimateInputCommitmentModificationsCommandOutput>(
  _ep0,
  _mw0,
