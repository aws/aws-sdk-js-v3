 ...
 * @public
 */
export class BatchCreateBillScenarioUsageModificationCommand extends command<BatchCreateBillScenarioUsageModificationCommandInput, BatchCreateBillScenarioUsageModificationCommandOutput>(
  _ep0,
  _mw0,
