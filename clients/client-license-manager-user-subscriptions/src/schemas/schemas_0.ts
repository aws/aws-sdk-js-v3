...
export var ActiveDirectorySettings$: StaticStructureSchema = [3, n0, _ADS,
  0,
...
export var DeregisterIdentityProviderRequest$: StaticStructureSchema = [3, n0, _DIPR,
  0,
  [_IP, _P, _IPA],
...
export var LicenseServerEndpoint$: StaticStructureSchema = [3, n0, _LSE,
  0,
...
export var ListLicenseServerEndpointsRequest$: StaticStructureSchema = [3, n0, _LLSER,
  0,
  [_MR, _Fi, _NT],
  [1, () => FilterList, 0]
];
export var ListLicenseServerEndpointsResponse$: StaticStructureSchema = [3, n0, _LLSERi,
  0,
  [_LSEi, _NT],
...
export var ServerEndpoint$: StaticStructureSchema = [3, n0, _SE,
  0,
  [_E],
  [0]
];
...
var IdentityProviderSummaryList: StaticListSchema = [1, n0, _IPSL,
  0, () => IdentityProviderSummary$
];
var InstanceSummaryList: StaticListSchema = [1, n0, _ISL,
  0, () => InstanceSummary$
];
var InstanceUserSummaryList: StaticListSchema = [1, n0, _IUSL,
  0, () => InstanceUserSummary$
];
var IpV4List = 64 | 0;
var IpV6List = 64 | 0;
var LicenseServerEndpointList: StaticListSchema = [1, n0, _LSEL,
  0, () => LicenseServerEndpoint$
];
var LicenseServerList: StaticListSchema = [1, n0, _LSL,
  0, () => LicenseServer$
];
var ProductUserSummaryList: StaticListSchema = [1, n0, _PUSL,
...
export var CredentialsProvider$: StaticUnionSchema = [4, n0, _CP,
  0,
  [_SMCP],
  [() => SecretsManagerCredentialsProvider$]
];
export var IdentityProvider$: StaticUnionSchema = [4, n0, _IP,
  0,
  [_ADIP],
  [() => ActiveDirectoryIdentityProvider$]
];
export var ServerSettings$: StaticUnionSchema = [4, n0, _SS,
  0,
  [_RSS],
  [() => RdsSalSettings$]
];
export var AssociateUser$: StaticOperationSchema = [9, n0, _AU,
  { [_h]: ["POST", "/user/AssociateUser", 200] }, () => AssociateUserRequest$, () => AssociateUserResponse$
];
export var CreateLicenseServerEndpoint$: StaticOperationSchema = [9, n0, _CLSE,
...
export var DeleteLicenseServerEndpoint$: StaticOperationSchema = [9, n0, _DLSE,
...
export var DeregisterIdentityProvider$: StaticOperationSchema = [9, n0, _DIP,
...
export var DisassociateUser$: StaticOperationSchema = [9, n0, _DU,
...
export var ListInstances$: StaticOperationSchema = [9, n0, _LI,
  { [_h]: ["POST", "/instance/ListInstances", 200] }, () => ListInstancesRequest$, () => ListInstancesResponse$
];
export var ListLicenseServerEndpoints$: StaticOperationSchema = [9, n0, _LLSE,
...
export var ListProductSubscriptions$: StaticOperationSchema = [9, n0, _LPS,
...
export var UpdateIdentityProviderSettings$: StaticOperationSchema = [9, n0, _UIPS,
