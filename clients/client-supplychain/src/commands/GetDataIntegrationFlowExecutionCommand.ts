 ...
 * @public
 */
export class GetDataIntegrationFlowExecutionCommand extends command<GetDataIntegrationFlowExecutionCommandInput, GetDataIntegrationFlowExecutionCommandOutput>(
  _ep0,
  _mw0,
