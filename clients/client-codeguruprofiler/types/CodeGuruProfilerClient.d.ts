...
export declare type ServiceInputTypes = ConfigureAgentCommandInput | CreateProfilingGroupCommandInput | DeleteProfilingGroupCommandInput | DescribeProfilingGroupCommandInput | GetProfileCommandInput | ListProfileTimesCommandInput | ListProfilingGroupsCommandInput | PostAgentProfileCommandInput | UpdateProfilingGroupCommandInput;
export declare type ServiceOutputTypes = ConfigureAgentCommandOutput | CreateProfilingGroupCommandOutput | DeleteProfilingGroupCommandOutput | DescribeProfilingGroupCommandOutput | GetProfileCommandOutput | ListProfileTimesCommandOutput | ListProfilingGroupsCommandOutput | PostAgentProfileCommandOutput | UpdateProfilingGroupCommandOutput;
...
export declare type CodeGuruProfilerClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type CodeGuruProfilerClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
