...
import { type CodeGuruProfilerClientResolvedConfig, CodeGuruProfilerClientConfig } from "../CodeGuruProfilerClient";
 ...
 * @internal
 */
export const defaultCodeGuruProfilerHttpAuthSchemeProvider: CodeGuruProfilerHttpAuthSchemeProvider = (authParameters) => {
