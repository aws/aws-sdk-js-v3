...
import type { ListProfileTimesRequest, ListProfileTimesResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListProfileTimesCommand extends command<ListProfileTimesCommandInput, ListProfileTimesCommandOutput>(
  _ep0,
  _mw0,
  "ListProfileTimes",
  ListProfileTimes$
