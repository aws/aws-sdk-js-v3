 ...
 * @public
 */
export class GetFindingsReportAccountSummaryCommand extends command<GetFindingsReportAccountSummaryCommandInput, GetFindingsReportAccountSummaryCommandOutput>(
  _ep0,
  _mw0,
