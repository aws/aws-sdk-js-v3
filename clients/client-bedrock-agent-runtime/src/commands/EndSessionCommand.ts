...
import type { EndSessionRequest, EndSessionResponse } from "../models/models_1";
 ...
 * @public
 */
export class EndSessionCommand extends command<EndSessionCommandInput, EndSessionCommandOutput>(
  _ep0,
  _mw0,
  "EndSession",
  EndSession$
