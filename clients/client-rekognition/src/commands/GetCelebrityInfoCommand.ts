...
import type { GetCelebrityInfoRequest, GetCelebrityInfoResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetCelebrityInfoCommand extends command<GetCelebrityInfoCommandInput, GetCelebrityInfoCommandOutput>(
  _ep0,
  _mw0,
  "GetCelebrityInfo",
  GetCelebrityInfo$
