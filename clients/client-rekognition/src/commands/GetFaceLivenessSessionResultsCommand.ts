 ...
 * @public
 */
export class GetFaceLivenessSessionResultsCommand extends command<GetFaceLivenessSessionResultsCommandInput, GetFaceLivenessSessionResultsCommandOutput>(
  _ep0,
  _mw0,
