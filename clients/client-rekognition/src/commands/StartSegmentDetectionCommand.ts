...
import { StartSegmentDetection$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class StartSegmentDetectionCommand extends command<StartSegmentDetectionCommandInput, StartSegmentDetectionCommandOutput>(
  _ep0,
  _mw0,
