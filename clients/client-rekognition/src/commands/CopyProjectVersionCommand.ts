...
import { CopyProjectVersion$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CopyProjectVersionCommand extends command<CopyProjectVersionCommandInput, CopyProjectVersionCommandOutput>(
  _ep0,
  _mw0,
  "CopyProjectVersion",
  CopyProjectVersion$
