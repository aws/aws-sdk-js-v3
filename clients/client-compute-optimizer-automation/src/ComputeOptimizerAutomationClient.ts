...
import {
  ...
  defaultComputeOptimizerAutomationHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type ComputeOptimizerAutomationClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type ComputeOptimizerAutomationClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 */
export class ComputeOptimizerAutomationClient extends __Client<
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<ComputeOptimizerAutomationClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultComputeOptimizerAutomationHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: ComputeOptimizerAutomationClientResolvedConfig) =>
