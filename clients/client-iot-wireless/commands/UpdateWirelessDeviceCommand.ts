...
export type UpdateWirelessDeviceCommandInput = UpdateWirelessDeviceRequest;
export type UpdateWirelessDeviceCommandOutput = UpdateWirelessDeviceResponse & __MetadataBearer;
