...
export type CreateWirelessGatewayTaskCommandInput = CreateWirelessGatewayTaskRequest;
export type CreateWirelessGatewayTaskCommandOutput = CreateWirelessGatewayTaskResponse & __MetadataBearer;
