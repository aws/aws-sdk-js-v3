...
export type GetWirelessGatewayCommandInput = GetWirelessGatewayRequest;
export type GetWirelessGatewayCommandOutput = GetWirelessGatewayResponse & __MetadataBearer;
