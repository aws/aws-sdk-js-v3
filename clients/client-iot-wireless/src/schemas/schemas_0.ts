...
export var AbpV1_0_x$: StaticStructureSchema = [3, n0, _Ax,
  0,
  [_DA, _SK, _FCS],
  [0, () => SessionKeysAbpV1_0_x$, 1]
];
export var AbpV1_1$: StaticStructureSchema = [3, n0, _A,
  0,
  [_DA, _SK, _FCS],
...
export var Beaconing$: StaticStructureSchema = [3, n0, _B,
  0,
  [_DR, _Fr],
  [1, 64 | 1]
];
...
export var ConnectionStatusResourceTypeEventConfiguration$: StaticStructureSchema = [3, n0, _CSRTEC,
  0,
  [_LRWAN],
...
export var CreateDeviceProfileRequest$: StaticStructureSchema = [3, n0, _CDPR,
  0,
  [_N, _LRWAN, _Ta, _CRT, _S],
  [0, () => LoRaWANDeviceProfile$, () => TagList, [0, 4], () => SidewalkCreateDeviceProfile$]
];
export var CreateDeviceProfileResponse$: StaticStructureSchema = [3, n0, _CDPRr,
  0,
  [_Ar, _I],
  [0, 0]
];
...
export var CreateServiceProfileRequest$: StaticStructureSchema = [3, n0, _CSPR,
  0,
  [_N, _LRWAN, _Ta, _CRT],
  [0, () => LoRaWANServiceProfile$, () => TagList, [0, 4]]
];
export var CreateServiceProfileResponse$: StaticStructureSchema = [3, n0, _CSPRr,
  0,
  [_Ar, _I],
  [0, 0]
];
...
export var Destinations$: StaticStructureSchema = [3, n0, _Des,
  0,
  [_Ar, _N, _ET, _E, _D, _RA],
  [0, 0, 0, 0, 0, 0]
];
export var DeviceProfile$: StaticStructureSchema = [3, n0, _DP,
  0,
  [_Ar, _N, _I],
  [0, 0, 0]
];
export var DeviceRegistrationStateEventConfiguration$: StaticStructureSchema = [3, n0, _DRSEC,
  0,
  [_S, _WDIET],
  [() => SidewalkEventNotificationConfigurations$, 0]
];
export var DeviceRegistrationStateResourceTypeEventConfiguration$: StaticStructureSchema = [3, n0, _DRSRTEC,
  0,
  [_S],
...
export var DownlinkQueueMessage$: StaticStructureSchema = [3, n0, _DQM,
  0,
  [_MI, _TM, _RAe, _LRWAN],
  [0, 1, 0, () => LoRaWANSendDataToDevice$]
];
export var EventConfigurationItem$: StaticStructureSchema = [3, n0, _ECI,
  0,
  [_Id, _IT, _PT, _Ev],
  [0, 0, 0, () => EventNotificationItemConfigurations$]
];
export var EventNotificationItemConfigurations$: StaticStructureSchema = [3, n0, _ENIC,
  0,
...
export var FPorts$: StaticStructureSchema = [3, n0, _FPo,
  0,
  [_Fu, _Mu, _CSl, _P, _Ap],
  [1, 1, 1, () => Positioning$, () => Applications]
];
export var FuotaTask$: StaticStructureSchema = [3, n0, _FT,
  0,
  [_I, _Ar, _N],
  [0, 0, 0]
];
...
export var GetEventConfigurationByResourceTypesRequest$: StaticStructureSchema = [3, n0, _GECBRTR,
  0,
  [],
  []
];
export var GetEventConfigurationByResourceTypesResponse$: StaticStructureSchema = [3, n0, _GECBRTRe,
  0,
  [_DRS, _Pr, _J, _CS, _MDS],
...
export var GetLogLevelsByResourceTypesRequest$: StaticStructureSchema = [3, n0, _GLLBRTR,
  0,
  [],
  []
];
export var GetLogLevelsByResourceTypesResponse$: StaticStructureSchema = [3, n0, _GLLBRTRe,
  0,
  [_DLL, _WGLO, _WDLO, _FTLOu],
  [0, () => WirelessGatewayLogOptionList, () => WirelessDeviceLogOptionList, () => FuotaTaskLogOptionList]
];
export var GetMetricConfigurationRequest$: StaticStructureSchema = [3, n0, _GMCR,
  0,
  [],
  []
];
export var GetMetricConfigurationResponse$: StaticStructureSchema = [3, n0, _GMCRe,
  0,
  [_SM],
  [() => SummaryMetricConfiguration$]
];
export var GetMetricsRequest$: StaticStructureSchema = [3, n0, _GMR,
  0,
  [_SMQ],
  [() => SummaryMetricQueries]
];
export var GetMetricsResponse$: StaticStructureSchema = [3, n0, _GMRe,
  0,
  [_SMQR],
...
export var GetServiceEndpointRequest$: StaticStructureSchema = [3, n0, _GSER,
  0,
  [_STe],
  [[0, { [_hQ]: _sT }]]
];
export var GetServiceEndpointResponse$: StaticStructureSchema = [3, n0, _GSERe,
  0,
  [_STe, _SE, _STer],
  [0, 0, 0]
];
...
export var ImportedWirelessDevice$: StaticStructureSchema = [3, n0, _IWD,
  0,
  [_S],
...
export var JoinResourceTypeEventConfiguration$: StaticStructureSchema = [3, n0, _JRTEC,
  0,
  [_LRWAN],
...
export var ListDeviceProfilesRequest$: StaticStructureSchema = [3, n0, _LDPR,
  0,
  [_NT, _MR, _DPT],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _dPT }]]
];
export var ListDeviceProfilesResponse$: StaticStructureSchema = [3, n0, _LDPRi,
  0,
  [_NT, _DPL],
  [0, () => DeviceProfileList]
];
...
export var ListFuotaTasksRequest$: StaticStructureSchema = [3, n0, _LFTR,
  0,
  [_NT, _MR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListFuotaTasksResponse$: StaticStructureSchema = [3, n0, _LFTRi,
  0,
  [_NT, _FTL],
  [0, () => FuotaTaskList]
];
...
export var ListMulticastGroupsRequest$: StaticStructureSchema = [3, n0, _LMGR,
  0,
  [_NT, _MR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListMulticastGroupsResponse$: StaticStructureSchema = [3, n0, _LMGRi,
  0,
  [_NT, _MGL],
  [0, () => MulticastGroupList]
];
export var ListNetworkAnalyzerConfigurationsRequest$: StaticStructureSchema = [3, n0, _LNACR,
  0,
  [_MR, _NT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListNetworkAnalyzerConfigurationsResponse$: StaticStructureSchema = [3, n0, _LNACRi,
  0,
  [_NT, _NACL],
  [0, () => NetworkAnalyzerConfigurationList]
];
export var ListPartnerAccountsRequest$: StaticStructureSchema = [3, n0, _LPAR,
  0,
  [_NT, _MR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListPartnerAccountsResponse$: StaticStructureSchema = [3, n0, _LPARi,
  0,
  [_NT, _S],
  [0, [() => SidewalkAccountList, 0]]
];
export var ListPositionConfigurationsRequest$: StaticStructureSchema = [3, n0, _LPCR,
  0,
  [_RT, _MR, _NT],
  [[0, { [_hQ]: _rT }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListPositionConfigurationsResponse$: StaticStructureSchema = [3, n0, _LPCRi,
  0,
  [_PCL, _NT],
...
export var ListServiceProfilesRequest$: StaticStructureSchema = [3, n0, _LSPR,
  0,
  [_NT, _MR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListServiceProfilesResponse$: StaticStructureSchema = [3, n0, _LSPRi,
  0,
  [_NT, _SPL],
...
export var ListWirelessDeviceImportTasksRequest$: StaticStructureSchema = [3, n0, _LWDITR,
  0,
  [_MR, _NT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListWirelessDeviceImportTasksResponse$: StaticStructureSchema = [3, n0, _LWDITRi,
  0,
  [_NT, _WDITL],
  [0, () => WirelessDeviceImportTaskList]
];
export var ListWirelessDevicesRequest$: StaticStructureSchema = [3, n0, _LWDR,
  0,
  [_MR, _NT, _DN, _DPI, _SPI, _WDT, _FTI, _MGI],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }], [0, { [_hQ]: _dN }], [0, { [_hQ]: _dPI }], [0, { [_hQ]: _sPI }], [0, { [_hQ]: _wDT }], [0, { [_hQ]: _fTI }], [0, { [_hQ]: _mGI }]]
];
export var ListWirelessDevicesResponse$: StaticStructureSchema = [3, n0, _LWDRi,
  0,
  [_NT, _WDL],
  [0, () => WirelessDeviceStatisticsList]
];
export var ListWirelessGatewaysRequest$: StaticStructureSchema = [3, n0, _LWGR,
  0,
  [_NT, _MR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListWirelessGatewaysResponse$: StaticStructureSchema = [3, n0, _LWGRi,
  0,
  [_NT, _WGL],
  [0, () => WirelessGatewayStatisticsList]
];
export var ListWirelessGatewayTaskDefinitionsRequest$: StaticStructureSchema = [3, n0, _LWGTDR,
  0,
  [_MR, _NT, _TDT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }], [0, { [_hQ]: _tDT }]]
];
export var ListWirelessGatewayTaskDefinitionsResponse$: StaticStructureSchema = [3, n0, _LWGTDRi,
  0,
  [_NT, _TD],
  [0, () => WirelessGatewayTaskDefinitionList]
];
export var LoRaWANConnectionStatusEventNotificationConfigurations$: StaticStructureSchema = [3, n0, _LRWANCSENC,
  0,
  [_GEET],
  [0]
];
export var LoRaWANConnectionStatusResourceTypeEventConfiguration$: StaticStructureSchema = [3, n0, _LRWANCSRTEC,
  0,
  [_WGET],
  [0]
];
export var LoRaWANDevice$: StaticStructureSchema = [3, n0, _LRWAND,
  0,
  [_DE, _DPI, _SPI, _O, _Ox, _A, _Ax, _FPo],
  [0, 0, 0, () => OtaaV1_1$, () => OtaaV1_0_x$, () => AbpV1_1$, () => AbpV1_0_x$, () => FPorts$]
];
export var LoRaWANDeviceMetadata$: StaticStructureSchema = [3, n0, _LRWANDM,
  0,
  [_DE, _FP, _DR, _Fre, _Ti, _Ga, _PG],
  [0, 1, 1, 1, 0, () => LoRaWANGatewayMetadataList, () => LoRaWANPublicGatewayMetadataList]
];
export var LoRaWANDeviceProfile$: StaticStructureSchema = [3, n0, _LRWANDP,
  0,
...
export var LoRaWANFuotaTask$: StaticStructureSchema = [3, n0, _LRWANFT,
  0,
  [_RR],
  [0]
];
export var LoRaWANFuotaTaskGetInfo$: StaticStructureSchema = [3, n0, _LRWANFTGI,
  0,
  [_RR, _STt],
  [0, 5]
];
export var LoRaWANGateway$: StaticStructureSchema = [3, n0, _LRWANG,
  0,
  [_GE, _RR, _JEF, _NIF, _SB, _B, _ME],
  [0, 0, [1, n0, _JEF, 0, 64 | 0], 64 | 0, 64 | 1, () => Beaconing$, 1]
];
export var LoRaWANGatewayCurrentVersion$: StaticStructureSchema = [3, n0, _LRWANGCV,
  0,
  [_CV],
  [() => LoRaWANGatewayVersion$]
];
export var LoRaWANGatewayMetadata$: StaticStructureSchema = [3, n0, _LRWANGM,
  0,
  [_GE, _Sn, _R],
  [0, 1, 1]
];
export var LoRaWANGatewayVersion$: StaticStructureSchema = [3, n0, _LRWANGV,
  0,
  [_PV, _Mo, _Sta],
  [0, 0, 0]
];
export var LoRaWANGetServiceProfileInfo$: StaticStructureSchema = [3, n0, _LRWANGSPI,
  0,
...
export var LoRaWANJoinEventNotificationConfigurations$: StaticStructureSchema = [3, n0, _LRWANJENC,
  0,
  [_DEET],
  [0]
];
export var LoRaWANJoinResourceTypeEventConfiguration$: StaticStructureSchema = [3, n0, _LRWANJRTEC,
  0,
  [_WDET],
  [0]
];
export var LoRaWANListDevice$: StaticStructureSchema = [3, n0, _LRWANLD,
  0,
  [_DE],
  [0]
];
...
export var LoRaWANSendDataToDevice$: StaticStructureSchema = [3, n0, _LRWANSDTD,
  0,
  [_FP, _PGa],
  [1, () => ParticipatingGateways$]
];
export var LoRaWANServiceProfile$: StaticStructureSchema = [3, n0, _LRWANSP,
  0,
  [_AGM, _DM, _DMr, _PA, _RAa, _TPIM, _TPIMx, _NTM, _NTMb],
  [2, 1, 1, 2, 2, 1, 1, 1, 1]
];
export var LoRaWANStartFuotaTask$: StaticStructureSchema = [3, n0, _LRWANSFT,
  0,
  [_STt],
  [5]
];
export var LoRaWANUpdateDevice$: StaticStructureSchema = [3, n0, _LRWANUD,
  0,
  [_DPI, _SPI, _A, _Ax, _FPo],
  [0, 0, () => UpdateAbpV1_1$, () => UpdateAbpV1_0_x$, () => UpdateFPorts$]
];
export var LoRaWANUpdateGatewayTaskCreate$: StaticStructureSchema = [3, n0, _LRWANUGTC,
  0,
  [_US, _SKC, _CV, _UV],
  [0, 1, () => LoRaWANGatewayVersion$, () => LoRaWANGatewayVersion$]
];
export var LoRaWANUpdateGatewayTaskEntry$: StaticStructureSchema = [3, n0, _LRWANUGTE,
  0,
  [_CV, _UV],
...
export var MessageDeliveryStatusResourceTypeEventConfiguration$: StaticStructureSchema = [3, n0, _MDSRTEC,
  0,
  [_S],
  [() => SidewalkResourceTypeEventConfiguration$]
];
export var MetricQueryValue$: StaticStructureSchema = [3, n0, _MQV,
  0,
  [_Mi, _Ma, _Su, _Av, _Std, _P_],
  [1, 1, 1, 1, 1, 1]
];
export var MulticastGroup$: StaticStructureSchema = [3, n0, _MGu,
  0,
  [_I, _Ar, _N],
  [0, 0, 0]
];
export var MulticastGroupByFuotaTask$: StaticStructureSchema = [3, n0, _MGBFT,
  0,
  [_I],
  [0]
];
export var MulticastWirelessMetadata$: StaticStructureSchema = [3, n0, _MWM,
  0,
  [_LRWAN],
  [() => LoRaWANMulticastMetadata$]
];
export var NetworkAnalyzerConfigurations$: StaticStructureSchema = [3, n0, _NAC,
  0,
  [_Ar, _N],
  [0, 0]
];
export var OtaaV1_0_x$: StaticStructureSchema = [3, n0, _Ox,
  0,
  [_AK, _AE, _JE, _GAK],
  [0, 0, 0, 0]
];
export var OtaaV1_1$: StaticStructureSchema = [3, n0, _O,
  0,
  [_AK, _NK, _JE],
  [0, 0, 0]
];
...
export var PositionConfigurationItem$: StaticStructureSchema = [3, n0, _PCI,
  0,
  [_RIe, _RT, _So, _Dest],
  [0, 0, () => PositionSolverDetails$, 0]
];
export var Positioning$: StaticStructureSchema = [3, n0, _P,
  0,
  [_CSl, _Str, _Gn],
  [1, 1, 1]
];
export var PositionSolverConfigurations$: StaticStructureSchema = [3, n0, _PSC,
  0,
  [_SG],
  [() => SemtechGnssConfiguration$]
];
export var PositionSolverDetails$: StaticStructureSchema = [3, n0, _PSDo,
  0,
  [_SG],
  [() => SemtechGnssDetail$]
];
export var ProximityEventConfiguration$: StaticStructureSchema = [3, n0, _PEC,
  0,
  [_S, _WDIET],
  [() => SidewalkEventNotificationConfigurations$, 0]
];
export var ProximityResourceTypeEventConfiguration$: StaticStructureSchema = [3, n0, _PRTEC,
  0,
  [_S],
  [() => SidewalkResourceTypeEventConfiguration$]
];
...
export var ResetAllResourceLogLevelsRequest$: StaticStructureSchema = [3, n0, _RARLLR,
  0,
  [],
  []
];
export var ResetAllResourceLogLevelsResponse$: StaticStructureSchema = [3, n0, _RARLLRe,
  0,
  [],
  []
];
...
export var ServiceProfile$: StaticStructureSchema = [3, n0, _SPe,
  0,
  [_Ar, _N, _I],
  [0, 0, 0]
];
export var SessionKeysAbpV1_0_x$: StaticStructureSchema = [3, n0, _Sx,
  0,
  [_NSK, _ASK],
  [0, 0]
];
export var SessionKeysAbpV1_1$: StaticStructureSchema = [3, n0, _S_,
  0,
  [_FNSIK, _SNSIK, _NSEK, _ASK],
  [0, 0, 0, 0]
];
export var SidewalkAccountInfo$: StaticStructureSchema = [3, n0, _SAI,
  0,
  [_AIm, _ASPKp],
  [0, [() => AppServerPrivateKey, 0]]
];
export var SidewalkAccountInfoWithFingerprint$: StaticStructureSchema = [3, n0, _SAIWF,
  0,
  [_AIm, _F, _Ar],
  [0, [() => Fingerprint, 0], 0]
];
export var SidewalkCreateDeviceProfile$: StaticStructureSchema = [3, n0, _SCDP,
  0,
  [],
  []
];
export var SidewalkCreateWirelessDevice$: StaticStructureSchema = [3, n0, _SCWD,
  0,
  [_DPI, _P, _SMS],
  [0, () => SidewalkPositioning$, 0]
];
export var SidewalkDevice$: StaticStructureSchema = [3, n0, _SD,
  0,
  [_AIm, _SIi, _SMS, _DCe, _PK, _DPI, _CI, _St, _P],
  [0, 0, 0, () => DeviceCertificateList, () => PrivateKeysList, 0, 0, 0, () => SidewalkPositioning$]
];
export var SidewalkDeviceMetadata$: StaticStructureSchema = [3, n0, _SDM,
  0,
  [_R, _BLat, _Eve, _DS],
  [1, 0, 0, 0]
];
export var SidewalkEventNotificationConfigurations$: StaticStructureSchema = [3, n0, _SENC,
  0,
  [_AIET],
  [0]
];
export var SidewalkGetDeviceProfile$: StaticStructureSchema = [3, n0, _SGDP,
  0,
  [_ASPK, _QS, _DCM],
  [[() => ApplicationServerPublicKey, 0], 2, () => DakCertificateMetadataList]
];
export var SidewalkGetStartImportInfo$: StaticStructureSchema = [3, n0, _SGSII,
  0,
  [_DCFL, _Ro, _P],
  [64 | 0, 0, () => SidewalkPositioning$]
];
export var SidewalkListDevice$: StaticStructureSchema = [3, n0, _SLD,
  0,
  [_AIm, _SIi, _SMS, _DCe, _DPI, _St, _P],
  [0, 0, 0, () => DeviceCertificateList, 0, 0, () => SidewalkPositioning$]
];
export var SidewalkListDevicesForImportInfo$: StaticStructureSchema = [3, n0, _SLDFII,
  0,
  [_P],
  [() => SidewalkPositioning$]
];
export var SidewalkPositioning$: StaticStructureSchema = [3, n0, _SPi,
  0,
  [_DN],
  [0]
];
export var SidewalkResourceTypeEventConfiguration$: StaticStructureSchema = [3, n0, _SRTEC,
  0,
  [_WDET],
  [0]
];
export var SidewalkSendDataToDevice$: StaticStructureSchema = [3, n0, _SSDTD,
  0,
  [_Se, _MT, _AMRDS],
  [1, 0, 1]
];
export var SidewalkSingleStartImportInfo$: StaticStructureSchema = [3, n0, _SSSII,
  0,
  [_SMS, _P],
  [0, () => SidewalkPositioning$]
];
export var SidewalkStartImportInfo$: StaticStructureSchema = [3, n0, _SSII,
  0,
  [_DCF, _Ro, _P],
  [0, 0, () => SidewalkPositioning$]
];
export var SidewalkUpdateAccount$: StaticStructureSchema = [3, n0, _SUA,
  0,
  [_ASPKp],
  [[() => AppServerPrivateKey, 0]]
];
export var SidewalkUpdateImportInfo$: StaticStructureSchema = [3, n0, _SUII,
  0,
  [_DCF],
  [0]
];
export var SidewalkUpdateWirelessDevice$: StaticStructureSchema = [3, n0, _SUWD,
  0,
  [_P],
  [() => SidewalkPositioning$]
];
...
export var SummaryMetricConfiguration$: StaticStructureSchema = [3, n0, _SMC,
  0,
  [_St],
  [0]
];
export var SummaryMetricQuery$: StaticStructureSchema = [3, n0, _SMQu,
  0,
  [_QI, _MN, _Dim, _APg, _STta, _ETn],
  [0, 0, () => Dimensions, 0, 4, 4]
];
export var SummaryMetricQueryResult$: StaticStructureSchema = [3, n0, _SMQRu,
  0,
...
export var UpdateAbpV1_0_x$: StaticStructureSchema = [3, n0, _Ux,
  0,
  [_FCS],
  [1]
];
export var UpdateAbpV1_1$: StaticStructureSchema = [3, n0, _U_,
  0,
  [_FCS],
  [1]
];
...
export var UpdateEventConfigurationByResourceTypesRequest$: StaticStructureSchema = [3, n0, _UECBRTR,
  0,
  [_DRS, _Pr, _J, _CS, _MDS],
  [() => DeviceRegistrationStateResourceTypeEventConfiguration$, () => ProximityResourceTypeEventConfiguration$, () => JoinResourceTypeEventConfiguration$, () => ConnectionStatusResourceTypeEventConfiguration$, () => MessageDeliveryStatusResourceTypeEventConfiguration$]
];
export var UpdateEventConfigurationByResourceTypesResponse$: StaticStructureSchema = [3, n0, _UECBRTRp,
  0,
  [],
  []
];
export var UpdateFPorts$: StaticStructureSchema = [3, n0, _UFP,
  0,
  [_P, _Ap],
...
export var UpdateLogLevelsByResourceTypesRequest$: StaticStructureSchema = [3, n0, _ULLBRTR,
  0,
  [_DLL, _FTLOu, _WDLO, _WGLO],
  [0, () => FuotaTaskLogOptionList, () => WirelessDeviceLogOptionList, () => WirelessGatewayLogOptionList]
];
export var UpdateLogLevelsByResourceTypesResponse$: StaticStructureSchema = [3, n0, _ULLBRTRp,
  0,
  [],
  []
];
export var UpdateMetricConfigurationRequest$: StaticStructureSchema = [3, n0, _UMCR,
  0,
  [_SM],
  [() => SummaryMetricConfiguration$]
];
export var UpdateMetricConfigurationResponse$: StaticStructureSchema = [3, n0, _UMCRp,
  0,
  [],
  []
];
...
export var UpdateWirelessGatewayTaskCreate$: StaticStructureSchema = [3, n0, _UWGTC,
  0,
  [_UDSp, _UDRpd, _LRWAN],
  [0, 0, () => LoRaWANUpdateGatewayTaskCreate$]
];
export var UpdateWirelessGatewayTaskEntry$: StaticStructureSchema = [3, n0, _UWGTE,
  0,
  [_I, _LRWAN, _Ar],
...
export var WirelessMetadata$: StaticStructureSchema = [3, n0, _WM,
  0,
  [_LRWAN, _S],
...
var CdmaList: StaticListSchema = [1, n0, _CLd,
  0, () => CdmaObj$
];
var CdmaNmrList: StaticListSchema = [1, n0, _CNL,
  0, () => CdmaNmrObj$
];
var DakCertificateMetadataList: StaticListSchema = [1, n0, _DCML,
  0, () => DakCertificateMetadata$
];
var DestinationList: StaticListSchema = [1, n0, _DL,
  0, () => Destinations$
];
var DeviceCertificateList: StaticListSchema = [1, n0, _DCL,
  0, () => CertificateList$
];
var DeviceCreationFileList = 64 | 0;
var DeviceProfileList: StaticListSchema = [1, n0, _DPL,
  0, () => DeviceProfile$
];
var Dimensions: StaticListSchema = [1, n0, _Dim,
  0, () => Dimension$
];
var DownlinkQueueMessagesList: StaticListSchema = [1, n0, _DQML,
  0, () => DownlinkQueueMessage$
];
var EventConfigurationsList: StaticListSchema = [1, n0, _ECL,
  0, () => EventConfigurationItem$
];
var FactoryPresetFreqsList = 64 | 1;
var FuotaTaskEventLogOptionList: StaticListSchema = [1, n0, _FTELOL,
  0, () => FuotaTaskEventLogOption$
];
var FuotaTaskList: StaticListSchema = [1, n0, _FTL,
  0, () => FuotaTask$
];
var FuotaTaskLogOptionList: StaticListSchema = [1, n0, _FTLOL,
  0, () => FuotaTaskLogOption$
];
var GatewayList: StaticListSchema = [1, n0, _GL,
  0, () => GatewayListItem$
];
...
var GsmNmrList: StaticListSchema = [1, n0, _GNL,
  0, () => GsmNmrObj$
];
var ImportedWirelessDeviceList: StaticListSchema = [1, n0, _IWDL,
  0, () => ImportedWirelessDevice$
];
var JoinEuiFilters: StaticListSchema = [1, n0, _JEF,
  0, 64 | 0
];
var JoinEuiRange = 64 | 0;
var LoRaWANGatewayMetadataList: StaticListSchema = [1, n0, _LRWANGML,
  0, () => LoRaWANGatewayMetadata$
];
var LoRaWANPublicGatewayMetadataList: StaticListSchema = [1, n0, _LRWANPGML,
  0, () => LoRaWANPublicGatewayMetadata$
];
var LteList: StaticListSchema = [1, n0, _LLt,
  0, () => LteObj$
];
var LteNmrList: StaticListSchema = [1, n0, _LNL,
  0, () => LteNmrObj$
];
var MetricQueryTimestamps = 64 | 4;
var MetricQueryValues: StaticListSchema = [1, n0, _MQVe,
  0, () => MetricQueryValue$
];
var MulticastGroupList: StaticListSchema = [1, n0, _MGL,
  0, () => MulticastGroup$
];
var MulticastGroupListByFuotaTask: StaticListSchema = [1, n0, _MGLBFT,
  0, () => MulticastGroupByFuotaTask$
];
var NetIdFilters = 64 | 0;
var NetworkAnalyzerConfigurationList: StaticListSchema = [1, n0, _NACL,
  0, () => NetworkAnalyzerConfigurations$
];
var NetworkAnalyzerMulticastGroupList = 64 | 0;
var PositionConfigurationList: StaticListSchema = [1, n0, _PCL,
  0, () => PositionConfigurationItem$
];
var PositionCoordinate = 64 | 1;
var PrivateKeysList: StaticListSchema = [1, n0, _PKL,
  0, () => CertificateList$
];
var ServiceProfileList: StaticListSchema = [1, n0, _SPL,
  0, () => ServiceProfile$
];
var SidewalkAccountList: StaticListSchema = [1, n0, _SAL,
  0, [() => SidewalkAccountInfoWithFingerprint$,
    0]
];
var SubBands = 64 | 1;
var SummaryMetricQueries: StaticListSchema = [1, n0, _SMQ,
  0, () => SummaryMetricQuery$
];
var SummaryMetricQueryResults: StaticListSchema = [1, n0, _SMQR,
...
var TdscdmaList: StaticListSchema = [1, n0, _TLd,
  0, () => TdscdmaObj$
];
var TdscdmaNmrList: StaticListSchema = [1, n0, _TNL,
  0, () => TdscdmaNmrObj$
];
var WcdmaList: StaticListSchema = [1, n0, _WL,
  0, () => WcdmaObj$
];
var WcdmaNmrList: StaticListSchema = [1, n0, _WNL,
  0, () => WcdmaNmrObj$
];
var WiFiAccessPoints: StaticListSchema = [1, n0, _WFAP,
  0, () => WiFiAccessPoint$
];
var WirelessDeviceEventLogOptionList: StaticListSchema = [1, n0, _WDELOL,
  0, () => WirelessDeviceEventLogOption$
];
var WirelessDeviceImportTaskList: StaticListSchema = [1, n0, _WDITL,
  0, () => WirelessDeviceImportTask$
];
var WirelessDeviceList = 64 | 0;
var WirelessDeviceLogOptionList: StaticListSchema = [1, n0, _WDLOL,
  0, () => WirelessDeviceLogOption$
];
var WirelessDeviceStatisticsList: StaticListSchema = [1, n0, _WDSL,
  0, () => WirelessDeviceStatistics$
];
var WirelessGatewayEventLogOptionList: StaticListSchema = [1, n0, _WGELOL,
  0, () => WirelessGatewayEventLogOption$
];
var WirelessGatewayList = 64 | 0;
var WirelessGatewayLogOptionList: StaticListSchema = [1, n0, _WGLOL,
  0, () => WirelessGatewayLogOption$
];
var WirelessGatewayStatisticsList: StaticListSchema = [1, n0, _WGSL,
  0, () => WirelessGatewayStatistics$
];
var WirelessGatewayTaskDefinitionList: StaticListSchema = [1, n0, _WGTDL,
  0, () => UpdateWirelessGatewayTaskEntry$
];
export var AssociateAwsAccountWithPartnerAccount$: StaticOperationSchema = [9, n0, _AAAWPA,
  { [_h]: ["POST", "/partner-accounts", 200] }, () => AssociateAwsAccountWithPartnerAccountRequest$, () => AssociateAwsAccountWithPartnerAccountResponse$
];
export var AssociateMulticastGroupWithFuotaTask$: StaticOperationSchema = [9, n0, _AMGWFT,
...
export var AssociateWirelessDeviceWithFuotaTask$: StaticOperationSchema = [9, n0, _AWDWFT,
...
export var AssociateWirelessDeviceWithMulticastGroup$: StaticOperationSchema = [9, n0, _AWDWMG,
...
export var AssociateWirelessDeviceWithThing$: StaticOperationSchema = [9, n0, _AWDWT,
  { [_h]: ["PUT", "/wireless-devices/{Id}/thing", 204] }, () => AssociateWirelessDeviceWithThingRequest$, () => AssociateWirelessDeviceWithThingResponse$
];
export var AssociateWirelessGatewayWithCertificate$: StaticOperationSchema = [9, n0, _AWGWC,
...
export var AssociateWirelessGatewayWithThing$: StaticOperationSchema = [9, n0, _AWGWT,
  { [_h]: ["PUT", "/wireless-gateways/{Id}/thing", 204] }, () => AssociateWirelessGatewayWithThingRequest$, () => AssociateWirelessGatewayWithThingResponse$
];
export var CancelMulticastGroupSession$: StaticOperationSchema = [9, n0, _CMGS,
...
export var CreateDeviceProfile$: StaticOperationSchema = [9, n0, _CDP,
  { [_h]: ["POST", "/device-profiles", 201] }, () => CreateDeviceProfileRequest$, () => CreateDeviceProfileResponse$
];
export var CreateFuotaTask$: StaticOperationSchema = [9, n0, _CFT,
  { [_h]: ["POST", "/fuota-tasks", 201] }, () => CreateFuotaTaskRequest$, () => CreateFuotaTaskResponse$
];
export var CreateMulticastGroup$: StaticOperationSchema = [9, n0, _CMG,
  { [_h]: ["POST", "/multicast-groups", 201] }, () => CreateMulticastGroupRequest$, () => CreateMulticastGroupResponse$
];
export var CreateNetworkAnalyzerConfiguration$: StaticOperationSchema = [9, n0, _CNAC,
...
export var DeleteWirelessDeviceImportTask$: StaticOperationSchema = [9, n0, _DWDIT,
...
export var DeleteWirelessGateway$: StaticOperationSchema = [9, n0, _DWG,
  { [_h]: ["DELETE", "/wireless-gateways/{Id}", 204] }, () => DeleteWirelessGatewayRequest$, () => DeleteWirelessGatewayResponse$
];
export var DeleteWirelessGatewayTask$: StaticOperationSchema = [9, n0, _DWGT,
  { [_h]: ["DELETE", "/wireless-gateways/{Id}/tasks", 204] }, () => DeleteWirelessGatewayTaskRequest$, () => DeleteWirelessGatewayTaskResponse$
];
export var DeleteWirelessGatewayTaskDefinition$: StaticOperationSchema = [9, n0, _DWGTD,
...
export var DeregisterWirelessDevice$: StaticOperationSchema = [9, n0, _DWDe,
  { [_h]: ["PATCH", "/wireless-devices/{Identifier}/deregister", 200] }, () => DeregisterWirelessDeviceRequest$, () => DeregisterWirelessDeviceResponse$
];
export var DisassociateAwsAccountFromPartnerAccount$: StaticOperationSchema = [9, n0, _DAAFPA,
...
export var DisassociateMulticastGroupFromFuotaTask$: StaticOperationSchema = [9, n0, _DMGFFT,
...
export var DisassociateWirelessDeviceFromFuotaTask$: StaticOperationSchema = [9, n0, _DWDFFT,
...
export var DisassociateWirelessDeviceFromMulticastGroup$: StaticOperationSchema = [9, n0, _DWDFMG,
...
export var DisassociateWirelessDeviceFromThing$: StaticOperationSchema = [9, n0, _DWDFT,
...
export var DisassociateWirelessGatewayFromCertificate$: StaticOperationSchema = [9, n0, _DWGFC,
...
export var DisassociateWirelessGatewayFromThing$: StaticOperationSchema = [9, n0, _DWGFT,
...
export var GetDeviceProfile$: StaticOperationSchema = [9, n0, _GDP,
  { [_h]: ["GET", "/device-profiles/{Id}", 200] }, () => GetDeviceProfileRequest$, () => GetDeviceProfileResponse$
];
export var GetEventConfigurationByResourceTypes$: StaticOperationSchema = [9, n0, _GECBRT,
...
export var GetWirelessGateway$: StaticOperationSchema = [9, n0, _GWG,
  { [_h]: ["GET", "/wireless-gateways/{Identifier}", 200] }, () => GetWirelessGatewayRequest$, () => GetWirelessGatewayResponse$
];
export var GetWirelessGatewayCertificate$: StaticOperationSchema = [9, n0, _GWGC,
  { [_h]: ["GET", "/wireless-gateways/{Id}/certificate", 200] }, () => GetWirelessGatewayCertificateRequest$, () => GetWirelessGatewayCertificateResponse$
];
export var GetWirelessGatewayFirmwareInformation$: StaticOperationSchema = [9, n0, _GWGFI,
...
export var GetWirelessGatewayStatistics$: StaticOperationSchema = [9, n0, _GWGS,
...
export var GetWirelessGatewayTask$: StaticOperationSchema = [9, n0, _GWGT,
  { [_h]: ["GET", "/wireless-gateways/{Id}/tasks", 200] }, () => GetWirelessGatewayTaskRequest$, () => GetWirelessGatewayTaskResponse$
];
export var GetWirelessGatewayTaskDefinition$: StaticOperationSchema = [9, n0, _GWGTD,
...
export var ListDeviceProfiles$: StaticOperationSchema = [9, n0, _LDP,
  { [_h]: ["GET", "/device-profiles", 200] }, () => ListDeviceProfilesRequest$, () => ListDeviceProfilesResponse$
];
export var ListDevicesForWirelessDeviceImportTask$: StaticOperationSchema = [9, n0, _LDFWDIT,
...
export var StartBulkDisassociateWirelessDeviceFromMulticastGroup$: StaticOperationSchema = [9, n0, _SBDWDFMG,
...
export var StartFuotaTask$: StaticOperationSchema = [9, n0, _SFT,
  { [_h]: ["PUT", "/fuota-tasks/{Id}", 204] }, () => StartFuotaTaskRequest$, () => StartFuotaTaskResponse$
];
export var StartMulticastGroupSession$: StaticOperationSchema = [9, n0, _SMGS,
  { [_h]: ["PUT", "/multicast-groups/{Id}/session", 204] }, () => StartMulticastGroupSessionRequest$, () => StartMulticastGroupSessionResponse$
];
export var StartSingleWirelessDeviceImportTask$: StaticOperationSchema = [9, n0, _SSWDIT,
...
export var StartWirelessDeviceImportTask$: StaticOperationSchema = [9, n0, _SWDIT,
...
export var TestWirelessDevice$: StaticOperationSchema = [9, n0, _TWD,
...
export var UpdateEventConfigurationByResourceTypes$: StaticOperationSchema = [9, n0, _UECBRT,
...
export var UpdatePartnerAccount$: StaticOperationSchema = [9, n0, _UPA,
  { [_h]: ["PATCH", "/partner-accounts/{PartnerAccountId}", 204] }, () => UpdatePartnerAccountRequest$, () => UpdatePartnerAccountResponse$
];
export var UpdatePosition$: StaticOperationSchema = [9, n0, _UP,
  { [_h]: ["PATCH", "/positions/{ResourceIdentifier}", 204] }, () => UpdatePositionRequest$, () => UpdatePositionResponse$
];
export var UpdateResourceEventConfiguration$: StaticOperationSchema = [9, n0, _UREC,
