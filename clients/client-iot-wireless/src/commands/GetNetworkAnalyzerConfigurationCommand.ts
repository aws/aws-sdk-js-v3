 ...
 * @public
 */
export class GetNetworkAnalyzerConfigurationCommand extends command<GetNetworkAnalyzerConfigurationCommandInput, GetNetworkAnalyzerConfigurationCommandOutput>(
  _ep0,
  _mw0,
