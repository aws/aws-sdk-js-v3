 ...
 * ```
 *
 * @param CreateWirelessGatewayTaskDefinitionRequest - {@link CreateWirelessGatewayTaskDefinitionRequest}
 * @returns {@link CreateWirelessGatewayTaskDefinitionResponse}
