 ...
 * @public
 */
export class AssociateWirelessDeviceWithThingCommand extends command<AssociateWirelessDeviceWithThingCommandInput, AssociateWirelessDeviceWithThingCommandOutput>(
  _ep0,
  _mw0,
