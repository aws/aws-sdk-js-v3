 ...
 * @public
 */
export class ListMulticastGroupsByFuotaTaskCommand extends command<ListMulticastGroupsByFuotaTaskCommandInput, ListMulticastGroupsByFuotaTaskCommandOutput>(
  _ep0,
  _mw0,
