 ...
 * @public
 */
export class DisassociateMulticastGroupFromFuotaTaskCommand extends command<DisassociateMulticastGroupFromFuotaTaskCommandInput, DisassociateMulticastGroupFromFuotaTaskCommandOutput>(
  _ep0,
  _mw0,
