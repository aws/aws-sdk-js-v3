...
import type { UpdateWirelessDeviceRequest, UpdateWirelessDeviceResponse } from "../models/models_1";
 ...
 * @public
 */
export class UpdateWirelessDeviceCommand extends command<UpdateWirelessDeviceCommandInput, UpdateWirelessDeviceCommandOutput>(
  _ep0,
  _mw0,
