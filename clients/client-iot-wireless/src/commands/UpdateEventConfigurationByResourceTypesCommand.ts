 ...
 * @public
 */
export class UpdateEventConfigurationByResourceTypesCommand extends command<UpdateEventConfigurationByResourceTypesCommandInput, UpdateEventConfigurationByResourceTypesCommandOutput>(
  _ep0,
  _mw0,
