...
import { ListWirelessGateways$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ListWirelessGatewaysCommand extends command<ListWirelessGatewaysCommandInput, ListWirelessGatewaysCommandOutput>(
  _ep0,
  _mw0,
