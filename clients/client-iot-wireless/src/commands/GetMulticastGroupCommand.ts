...
import type { GetMulticastGroupRequest, GetMulticastGroupResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetMulticastGroupCommand extends command<GetMulticastGroupCommandInput, GetMulticastGroupCommandOutput>(
  _ep0,
  _mw0,
  "GetMulticastGroup",
  GetMulticastGroup$
