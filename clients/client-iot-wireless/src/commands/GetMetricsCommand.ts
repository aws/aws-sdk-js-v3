...
import type { GetMetricsRequest, GetMetricsResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetMetricsCommand extends command<GetMetricsCommandInput, GetMetricsCommandOutput>(
  _ep0,
  _mw0,
  "GetMetrics",
  GetMetrics$
