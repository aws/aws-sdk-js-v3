 ...
 * @public
 */
export class GetEventConfigurationByResourceTypesCommand extends command<GetEventConfigurationByResourceTypesCommandInput, GetEventConfigurationByResourceTypesCommandOutput>(
  _ep0,
  _mw0,
