 ...
 * @public
 */
export class DisassociateWirelessGatewayFromThingCommand extends command<DisassociateWirelessGatewayFromThingCommandInput, DisassociateWirelessGatewayFromThingCommandOutput>(
  _ep0,
  _mw0,
