...
import type { GetPositionRequest, GetPositionResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetPositionCommand extends command<GetPositionCommandInput, GetPositionCommandOutput>(
  _ep0,
  _mw0,
  "GetPosition",
  GetPosition$
