 ...
 * ```
 *
 * @param DeleteWirelessDeviceImportTaskRequest - {@link DeleteWirelessDeviceImportTaskRequest}
 * @returns {@link DeleteWirelessDeviceImportTaskResponse}
...
> {
  ...
  ): Handler<DeleteWirelessDeviceImportTaskCommandInput, DeleteWirelessDeviceImportTaskCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteWirelessDeviceImportTaskCommand.getEndpointParameterInstructions())
    );
