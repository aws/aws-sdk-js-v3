 ...
 * @public
 */
export class DisassociateAwsAccountFromPartnerAccountCommand extends command<DisassociateAwsAccountFromPartnerAccountCommandInput, DisassociateAwsAccountFromPartnerAccountCommandOutput>(
  _ep0,
  _mw0,
