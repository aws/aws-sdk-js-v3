 ...
 * @public
 */
export class GetResourceEventConfigurationCommand extends command<GetResourceEventConfigurationCommandInput, GetResourceEventConfigurationCommandOutput>(
  _ep0,
  _mw0,
