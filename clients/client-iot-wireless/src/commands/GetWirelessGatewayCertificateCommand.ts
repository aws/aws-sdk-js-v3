 ...
 * @public
 */
export class GetWirelessGatewayCertificateCommand extends command<GetWirelessGatewayCertificateCommandInput, GetWirelessGatewayCertificateCommandOutput>(
  _ep0,
  _mw0,
