 ...
 * @public
 */
export class UpdateNetworkAnalyzerConfigurationCommand extends command<UpdateNetworkAnalyzerConfigurationCommandInput, UpdateNetworkAnalyzerConfigurationCommandOutput>(
  _ep0,
  _mw0,
