 ...
 * @public
 */
export class DeleteWirelessGatewayTaskDefinitionCommand extends command<DeleteWirelessGatewayTaskDefinitionCommandInput, DeleteWirelessGatewayTaskDefinitionCommandOutput>(
  _ep0,
  _mw0,
