 ...
 * @public
 */
export class ListWirelessGatewayTaskDefinitionsCommand extends command<ListWirelessGatewayTaskDefinitionsCommandInput, ListWirelessGatewayTaskDefinitionsCommandOutput>(
  _ep0,
  _mw0,
