 ...
 * @public
 */
export class UpdateWirelessDeviceImportTaskCommand extends command<UpdateWirelessDeviceImportTaskCommandInput, UpdateWirelessDeviceImportTaskCommandOutput>(
  _ep0,
  _mw0,
