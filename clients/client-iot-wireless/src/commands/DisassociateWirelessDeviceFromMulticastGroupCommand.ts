 ...
 * @public
 */
export class DisassociateWirelessDeviceFromMulticastGroupCommand extends command<DisassociateWirelessDeviceFromMulticastGroupCommandInput, DisassociateWirelessDeviceFromMulticastGroupCommandOutput>(
  _ep0,
  _mw0,
