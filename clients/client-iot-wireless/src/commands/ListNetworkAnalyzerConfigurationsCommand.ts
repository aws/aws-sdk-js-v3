 ...
 * @public
 */
export class ListNetworkAnalyzerConfigurationsCommand extends command<ListNetworkAnalyzerConfigurationsCommandInput, ListNetworkAnalyzerConfigurationsCommandOutput>(
  _ep0,
  _mw0,
