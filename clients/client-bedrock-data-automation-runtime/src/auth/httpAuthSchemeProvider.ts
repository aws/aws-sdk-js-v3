...
import {
  type BedrockDataAutomationRuntimeClientResolvedConfig,
 ...
 * @internal
 */
export const defaultBedrockDataAutomationRuntimeHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: BedrockDataAutomationRuntimeHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<BedrockDataAutomationRuntimeClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultBedrockDataAutomationRuntimeHttpAuthSchemeProvider: BedrockDataAutomationRuntimeHttpAuthSchemeProvider = (authParameters) => {
