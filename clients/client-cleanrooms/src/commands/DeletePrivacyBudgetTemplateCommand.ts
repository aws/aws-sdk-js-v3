...
> {
   ...
   * @public
   */
  constructor(readonly input: DeletePrivacyBudgetTemplateCommandInput) {
    super();
  }
  ...
  ): Handler<DeletePrivacyBudgetTemplateCommandInput, DeletePrivacyBudgetTemplateCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeletePrivacyBudgetTemplateCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: DeletePrivacyBudgetTemplateCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
