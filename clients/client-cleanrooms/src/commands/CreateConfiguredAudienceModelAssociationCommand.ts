 ...
 * @public
 */
export class CreateConfiguredAudienceModelAssociationCommand extends command<CreateConfiguredAudienceModelAssociationCommandInput, CreateConfiguredAudienceModelAssociationCommandOutput>(
  _ep0,
  _mw0,
