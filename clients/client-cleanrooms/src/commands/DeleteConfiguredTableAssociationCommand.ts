 ...
 * @public
 */
export class DeleteConfiguredTableAssociationCommand extends command<DeleteConfiguredTableAssociationCommandInput, DeleteConfiguredTableAssociationCommandOutput>(
  _ep0,
  _mw0,
