 ...
 * @public
 */
export class GetCollaborationAnalysisTemplateCommand extends command<GetCollaborationAnalysisTemplateCommandInput, GetCollaborationAnalysisTemplateCommandOutput>(
  _ep0,
  _mw0,
