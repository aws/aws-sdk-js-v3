 ...
 * @public
 */
export class UpdateConfiguredTableAssociationAnalysisRuleCommand extends command<UpdateConfiguredTableAssociationAnalysisRuleCommandInput, UpdateConfiguredTableAssociationAnalysisRuleCommandOutput>(
  _ep0,
  _mw0,
