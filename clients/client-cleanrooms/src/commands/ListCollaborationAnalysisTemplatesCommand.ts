 ...
 * @public
 */
export class ListCollaborationAnalysisTemplatesCommand extends command<ListCollaborationAnalysisTemplatesCommandInput, ListCollaborationAnalysisTemplatesCommandOutput>(
  _ep0,
  _mw0,
