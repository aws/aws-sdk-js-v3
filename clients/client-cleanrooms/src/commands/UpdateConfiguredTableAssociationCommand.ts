 ...
 * @public
 */
export class UpdateConfiguredTableAssociationCommand extends command<UpdateConfiguredTableAssociationCommandInput, UpdateConfiguredTableAssociationCommandOutput>(
  _ep0,
  _mw0,
