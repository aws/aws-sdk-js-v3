 ...
 * @public
 */
export class ListIntermediateTableVersionsCommand extends command<ListIntermediateTableVersionsCommandInput, ListIntermediateTableVersionsCommandOutput>(
  _ep0,
  _mw0,
