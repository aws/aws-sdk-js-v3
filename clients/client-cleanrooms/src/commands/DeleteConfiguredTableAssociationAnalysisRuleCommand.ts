 ...
 * @public
 */
export class DeleteConfiguredTableAssociationAnalysisRuleCommand extends command<DeleteConfiguredTableAssociationAnalysisRuleCommandInput, DeleteConfiguredTableAssociationAnalysisRuleCommandOutput>(
  _ep0,
  _mw0,
