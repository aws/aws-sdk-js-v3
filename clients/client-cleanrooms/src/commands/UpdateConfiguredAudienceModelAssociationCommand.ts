 ...
 * @public
 */
export class UpdateConfiguredAudienceModelAssociationCommand extends command<UpdateConfiguredAudienceModelAssociationCommandInput, UpdateConfiguredAudienceModelAssociationCommandOutput>(
  _ep0,
  _mw0,
