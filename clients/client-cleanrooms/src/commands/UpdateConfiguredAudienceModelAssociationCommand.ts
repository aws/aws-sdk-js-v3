...
> {
   ...
   * @public
   */
  constructor(readonly input: UpdateConfiguredAudienceModelAssociationCommandInput) {
    super();
  }
  ...
  > {
    ...
    this.middlewareStack.use(
      getEndpointPlugin(
        configuration,
        UpdateConfiguredAudienceModelAssociationCommand.getEndpointParameterInstructions()
      )
    );
