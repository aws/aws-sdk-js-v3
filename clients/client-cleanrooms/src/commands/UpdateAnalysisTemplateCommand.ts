...
import type { UpdateAnalysisTemplateInput, UpdateAnalysisTemplateOutput } from "../models/models_0";
 ...
 * @public
 */
export class UpdateAnalysisTemplateCommand extends command<UpdateAnalysisTemplateCommandInput, UpdateAnalysisTemplateCommandOutput>(
  _ep0,
  _mw0,
