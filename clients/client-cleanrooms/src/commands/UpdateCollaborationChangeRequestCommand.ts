 ...
 * @public
 */
export class UpdateCollaborationChangeRequestCommand extends command<UpdateCollaborationChangeRequestCommandInput, UpdateCollaborationChangeRequestCommandOutput>(
  _ep0,
  _mw0,
