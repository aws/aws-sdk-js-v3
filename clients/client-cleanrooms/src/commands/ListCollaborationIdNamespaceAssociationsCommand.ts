 ...
 * @public
 */
export class ListCollaborationIdNamespaceAssociationsCommand extends command<ListCollaborationIdNamespaceAssociationsCommandInput, ListCollaborationIdNamespaceAssociationsCommandOutput>(
  _ep0,
  _mw0,
