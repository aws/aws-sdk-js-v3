...
> {
   ...
   * @public
   */
  constructor(readonly input: ListConfiguredAudienceModelAssociationsCommandInput) {
    super();
  }
  ...
  > {
    ...
    this.middlewareStack.use(
      getEndpointPlugin(
        configuration,
        ListConfiguredAudienceModelAssociationsCommand.getEndpointParameterInstructions()
      )
    );
