 ...
 * @public
 */
export class ListConfiguredAudienceModelAssociationsCommand extends command<ListConfiguredAudienceModelAssociationsCommandInput, ListConfiguredAudienceModelAssociationsCommandOutput>(
  _ep0,
  _mw0,
