 ...
 * @public
 */
export class GetConfiguredTableAnalysisRuleCommand extends command<GetConfiguredTableAnalysisRuleCommandInput, GetConfiguredTableAnalysisRuleCommandOutput>(
  _ep0,
  _mw0,
