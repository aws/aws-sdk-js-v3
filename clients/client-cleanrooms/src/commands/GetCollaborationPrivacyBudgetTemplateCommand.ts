 ...
 * @public
 */
export class GetCollaborationPrivacyBudgetTemplateCommand extends command<GetCollaborationPrivacyBudgetTemplateCommandInput, GetCollaborationPrivacyBudgetTemplateCommandOutput>(
  _ep0,
  _mw0,
