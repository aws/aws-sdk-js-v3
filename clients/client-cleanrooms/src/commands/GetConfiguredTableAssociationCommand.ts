 ...
 * @public
 */
export class GetConfiguredTableAssociationCommand extends command<GetConfiguredTableAssociationCommandInput, GetConfiguredTableAssociationCommandOutput>(
  _ep0,
  _mw0,
