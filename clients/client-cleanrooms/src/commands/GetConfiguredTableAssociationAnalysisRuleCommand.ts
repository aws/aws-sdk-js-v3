 ...
 * @public
 */
export class GetConfiguredTableAssociationAnalysisRuleCommand extends command<GetConfiguredTableAssociationAnalysisRuleCommandInput, GetConfiguredTableAssociationAnalysisRuleCommandOutput>(
  _ep0,
  _mw0,
