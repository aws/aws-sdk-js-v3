 ...
 * @public
 */
export class CreateConfiguredTableAssociationCommand extends command<CreateConfiguredTableAssociationCommandInput, CreateConfiguredTableAssociationCommandOutput>(
  _ep0,
  _mw0,
