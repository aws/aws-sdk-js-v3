 ...
 * @public
 */
export class CreateConfiguredTableAnalysisRuleCommand extends command<CreateConfiguredTableAnalysisRuleCommandInput, CreateConfiguredTableAnalysisRuleCommandOutput>(
  _ep0,
  _mw0,
