 ...
 * @public
 */
export class DescribeIdentityProviderConfigCommand extends command<DescribeIdentityProviderConfigCommandInput, DescribeIdentityProviderConfigCommandOutput>(
  _ep0,
  _mw0,
