 ...
 * @public
 */
export class CreateEksAnywhereSubscriptionCommand extends command<CreateEksAnywhereSubscriptionCommandInput, CreateEksAnywhereSubscriptionCommandOutput>(
  _ep0,
  _mw0,
