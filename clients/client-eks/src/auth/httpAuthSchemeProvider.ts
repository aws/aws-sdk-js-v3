...
import { type EKSClientResolvedConfig, EKSClientConfig } from "../EKSClient";
 ...
 * @internal
 */
export const defaultEKSHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: EKSHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<EKSClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultEKSHttpAuthSchemeProvider: EKSHttpAuthSchemeProvider = (authParameters) => {
