...
export type ListIdentityProviderConfigsCommandInput = ListIdentityProviderConfigsRequest;
export type ListIdentityProviderConfigsCommandOutput = ListIdentityProviderConfigsResponse & __MetadataBearer;
