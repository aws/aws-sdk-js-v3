  ...
  return {
    ...
    labels:
      output.labels !== undefined && output.labels !== null
        ...
        : undefined,
    namespace:
      output.namespace !== undefined && output.namespace !== null ? output.namespace : undefined
  } as any;
};
  ...
  return {
    ...
    createdAt:
      output.createdAt !== undefined && output.createdAt !== null
        ...
        : undefined,
    diskSize:
      output.diskSize !== undefined && output.diskSize !== null ? output.diskSize : undefined,
    health:
    ...
    modifiedAt:
      output.modifiedAt !== undefined && output.modifiedAt !== null
        ...
        : undefined,
    nodeRole:
      output.nodeRole !== undefined && output.nodeRole !== null ? output.nodeRole : undefined,
    nodegroupArn:
...
const deserializeAws_restJson1_1RemoteAccessConfig = (
  ...
  return {
    ...
    ec2SshKey:
      output.ec2SshKey !== undefined && output.ec2SshKey !== null ? output.ec2SshKey : undefined,
