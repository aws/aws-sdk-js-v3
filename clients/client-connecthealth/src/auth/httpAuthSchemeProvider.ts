...
import { type ConnectHealthClientResolvedConfig, ConnectHealthClientConfig } from "../ConnectHealthClient";
 ...
 * @internal
 */
export const defaultConnectHealthHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ConnectHealthHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<ConnectHealthClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultConnectHealthHttpAuthSchemeProvider: ConnectHealthHttpAuthSchemeProvider = (authParameters) => {
