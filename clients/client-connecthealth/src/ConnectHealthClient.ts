...
import {
  ...
  defaultConnectHealthHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type ConnectHealthClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<ConnectHealthClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: ConnectHealthClientResolvedConfig) =>
