 ...
 * @public
 */
export class GetMedicalScribeListeningSessionCommand extends command<GetMedicalScribeListeningSessionCommandInput, GetMedicalScribeListeningSessionCommandOutput>(
  _ep0,
  _mw0,
