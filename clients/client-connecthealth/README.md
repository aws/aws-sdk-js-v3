...
## Installing
To install this package, simply type add or install @aws-sdk/client-connecthealth
...
```ts
import * as AWS from "@aws-sdk/client-connecthealth";
const client = new AWS.ConnectHealth({ region: "REGION" });
