...
export var BatchContainerOverrides$: StaticStructureSchema = [3, n0, _BCO,
  0,
  [_C, _E, _ITn, _RR],
  [64 | 0, () => BatchEnvironmentVariableList, 0, () => BatchResourceRequirementsList]
];
export var BatchEnvironmentVariable$: StaticStructureSchema = [3, n0, _BEV,
  0,
  [_N, _V],
  [0, 0]
];
export var BatchJobDependency$: StaticStructureSchema = [3, n0, _BJD,
  0,
  [_JI, _T],
  [0, 0]
];
...
export var FirehoseLogDestination$: StaticStructureSchema = [3, n0, _FLD,
  0,
  [_DSA],
  [0]
];
...
export var ListPipesResponse$: StaticStructureSchema = [3, n0, _LPRi,
  0,
  [_Pi, _NT],
...
export var PipeEnrichmentHttpParameters$: StaticStructureSchema = [3, n0, _PEHP,
  0,
  [_PPV, _HP, _QSP],
  [[() => PathParameterList, 0], [() => HeaderParametersMap, 0], [() => QueryStringParametersMap, 0]]
];
export var PipeEnrichmentParameters$: StaticStructureSchema = [3, n0, _PEP,
  0,
  [_IT, _HPt],
  [[() => InputTemplate, 0], [() => PipeEnrichmentHttpParameters$, 0]]
];
export var PipeLogConfiguration$: StaticStructureSchema = [3, n0, _PLC,
  0,
...
export var PipeTargetHttpParameters$: StaticStructureSchema = [3, n0, _PTHP,
  0,
  [_PPV, _HP, _QSP],
  [[() => PathParameterList, 0], [() => HeaderParametersMap, 0], [() => QueryStringParametersMap, 0]]
];
...
export var PipeTargetParameters$: StaticStructureSchema = [3, n0, _PTP,
  0,
...
export var PipeTargetSqsQueueParameters$: StaticStructureSchema = [3, n0, _PTSQP,
  0,
  [_MGI, _MDI],
  [[() => MessageGroupId, 0], [() => MessageDeduplicationId, 0]]
];
export var PipeTargetStateMachineParameters$: StaticStructureSchema = [3, n0, _PTSMP,
  0,
  [_ITnv],
  [0]
];
...
export var PlacementStrategy$: StaticStructureSchema = [3, n0, _PS,
  0,
  [_t, _f],
  [0, [() => PlacementStrategyField, 0]]
];
export var S3LogDestination$: StaticStructureSchema = [3, n0, _SLD,
  0,
  [_BN, _Pr, _BO, _OF],
  [0, 0, 0, 0]
];
...
export var UpdatePipeSourceKinesisStreamParameters$: StaticStructureSchema = [3, n0, _UPSKSP,
  0,
  [_BS, _DLC, _OPBIF, _MBWIS, _MRAIS, _MRA, _PF],
  [1, () => DeadLetterConfig$, 0, 1, 1, 1, 1]
];
export var UpdatePipeSourceManagedStreamingKafkaParameters$: StaticStructureSchema = [3, n0, _UPSMSKP,
  0,
  [_BS, _Cr, _MBWIS],
  [1, () => MSKAccessCredentials$, 1]
];
export var UpdatePipeSourceParameters$: StaticStructureSchema = [3, n0, _UPSP,
  0,
  [_FC, _KSP, _DDBSP, _SQP, _AMQBP, _RMQBP, _MSKP, _SMKP],
...
export var UpdatePipeSourceSqsQueueParameters$: StaticStructureSchema = [3, n0, _UPSSQP,
  0,
  [_BS, _MBWIS],
  [1, 1]
];
...
var BatchEnvironmentVariableList: StaticListSchema = [1, n0, _BEVL,
  0, () => BatchEnvironmentVariable$
];
var BatchResourceRequirementsList: StaticListSchema = [1, n0, _BRRL,
...
var DimensionMappings: StaticListSchema = [1, n0, _DMi,
  0, () => DimensionMapping$
];
var EcsContainerOverrideList: StaticListSchema = [1, n0, _ECOL,
  0, () => EcsContainerOverride$
];
var EcsEnvironmentFileList: StaticListSchema = [1, n0, _EEFL,
  0, () => EcsEnvironmentFile$
];
var EcsEnvironmentVariableList: StaticListSchema = [1, n0, _EEVL,
  0, () => EcsEnvironmentVariable$
];
var EcsInferenceAcceleratorOverrideList: StaticListSchema = [1, n0, _EIAOL,
  0, () => EcsInferenceAcceleratorOverride$
];
var EcsResourceRequirementsList: StaticListSchema = [1, n0, _ERRL,
...
var KafkaBootstrapServers: StaticListSchema = [1, n0, _KBS,
  0, [() => EndpointString,
    0]
];
var MultiMeasureAttributeMappings: StaticListSchema = [1, n0, _MMAMu,
  0, () => MultiMeasureAttributeMapping$
];
var MultiMeasureMappings: StaticListSchema = [1, n0, _MMMu,
  0, () => MultiMeasureMapping$
];
var PathParameterList: StaticListSchema = [1, n0, _PPLa,
  0, [() => PathParameter,
    0]
];
var PipeList: StaticListSchema = [1, n0, _PL,
  0, () => Pipe$
];
var PlacementConstraints: StaticListSchema = [1, n0, _PC,
  0, [() => PlacementConstraint$,
    0]
];
var PlacementStrategies: StaticListSchema = [1, n0, _PSl,
  0, [() => PlacementStrategy$,
    0]
];
var SageMakerPipelineParameterList: StaticListSchema = [1, n0, _SMPPL,
  0, [() => SageMakerPipelineParameter$,
    0]
];
var SecurityGroupIds: StaticListSchema = [1, n0, _SGIe,
  0, [() => SecurityGroupId,
    0]
];
var SecurityGroups: StaticListSchema = [1, n0, _SGe,
  0, [() => SecurityGroup,
    0]
];
var SingleMeasureMappings: StaticListSchema = [1, n0, _SMM,
  0, () => SingleMeasureMapping$
];
var Sqls: StaticListSchema = [1, n0, _Sq,
  0, [() => Sql,
    0]
];
var StringList = 64 | 0;
var SubnetIds: StaticListSchema = [1, n0, _SIu,
  0, [() => SubnetId,
    0]
];
var Subnets: StaticListSchema = [1, n0, _Sub,
  0, [() => Subnet,
    0]
];
var TagKeyList = 64 | 0;
...
var HeaderParametersMap: StaticMapSchema = [2, n0, _HPM,
  0, [0,
    0]
  , [() => HeaderValue,
    0]
];
var QueryStringParametersMap: StaticMapSchema = [2, n0, _QSPM,
  0, [0,
    0]
  , [() => QueryStringValue,
    0]
...
export var MQBrokerAccessCredentials$: StaticUnionSchema = [4, n0, _MQBAC,
  0,
  [_BA],
  [0]
];
export var MSKAccessCredentials$: StaticUnionSchema = [4, n0, _MSKAC,
  0,
  [_SSA, _CCTA],
  [0, 0]
];
export var SelfManagedKafkaAccessConfigurationCredentials$: StaticUnionSchema = [4, n0, _SMKACC,
  0,
  [_BA, _SSA, _SSAa, _CCTA],
  [0, 0, 0, 0]
];
export var CreatePipe$: StaticOperationSchema = [9, n0, _CPr,
  { [_h]: ["POST", "/v1/pipes/{Name}", 200] }, () => CreatePipeRequest$, () => CreatePipeResponse$
];
export var DeletePipe$: StaticOperationSchema = [9, n0, _DP,
  { [_h]: ["DELETE", "/v1/pipes/{Name}", 200] }, () => DeletePipeRequest$, () => DeletePipeResponse$
];
export var DescribePipe$: StaticOperationSchema = [9, n0, _DPe,
  { [_h]: ["GET", "/v1/pipes/{Name}", 200] }, () => DescribePipeRequest$, () => DescribePipeResponse$
];
export var ListPipes$: StaticOperationSchema = [9, n0, _LP,
  { [_h]: ["GET", "/v1/pipes", 200] }, () => ListPipesRequest$, () => ListPipesResponse$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  { [_h]: ["GET", "/tags/{resourceArn}", 200] }, () => ListTagsForResourceRequest$, () => ListTagsForResourceResponse$
];
export var StartPipe$: StaticOperationSchema = [9, n0, _SPta,
  { [_h]: ["POST", "/v1/pipes/{Name}/start", 200] }, () => StartPipeRequest$, () => StartPipeResponse$
];
export var StopPipe$: StaticOperationSchema = [9, n0, _SPto,
...
export var UpdatePipe$: StaticOperationSchema = [9, n0, _UP,
