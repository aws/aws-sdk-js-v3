...
import {
  ...
  defaultPipesHttpAuthSchemeParametersProvider,
  resolveHttpAuthSchemeConfig,
} from "./auth/httpAuthSchemeProvider";
import type { CreatePipeCommandInput, CreatePipeCommandOutput } from "./commands/CreatePipeCommand";
import type { DeletePipeCommandInput, DeletePipeCommandOutput } from "./commands/DeletePipeCommand";
import type { DescribePipeCommandInput, DescribePipeCommandOutput } from "./commands/DescribePipeCommand";
import type { ListPipesCommandInput, ListPipesCommandOutput } from "./commands/ListPipesCommand";
import type {
  ListTagsForResourceCommandInput,
  ListTagsForResourceCommandOutput,
} from "./commands/ListTagsForResourceCommand";
import type { StartPipeCommandInput, StartPipeCommandOutput } from "./commands/StartPipeCommand";
import type { StopPipeCommandInput, StopPipeCommandOutput } from "./commands/StopPipeCommand";
import type { TagResourceCommandInput, TagResourceCommandOutput } from "./commands/TagResourceCommand";
import type { UntagResourceCommandInput, UntagResourceCommandOutput } from "./commands/UntagResourceCommand";
import type { UpdatePipeCommandInput, UpdatePipeCommandOutput } from "./commands/UpdatePipeCommand";
import {
 ...
 * @public
 */
export type PipesClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type PipesClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<PipesClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultPipesHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: PipesClientResolvedConfig) =>
