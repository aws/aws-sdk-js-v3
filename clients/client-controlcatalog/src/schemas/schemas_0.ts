...
export var AssociatedObjectiveSummary$: StaticStructureSchema = [3, n0, _AOS,
  0,
  [_A, _N],
  [0, 0]
];
export var CommonControlFilter$: StaticStructureSchema = [3, n0, _CCF,
  0,
  [_O],
...
export var ObjectiveResourceFilter$: StaticStructureSchema = [3, n0, _ORF,
  0,
  [_A],
  [0]
];
...
var ControlMappings: StaticListSchema = [1, n0, _CMo,
  0, () => ControlMapping$
];
var ControlParameters: StaticListSchema = [1, n0, _CPo,
  0, () => ControlParameter$
];
var Controls: StaticListSchema = [1, n0, _C,
  0, () => ControlSummary$
];
var DeployableRegions = 64 | 0;
var DomainResourceFilterList: StaticListSchema = [1, n0, _DRFL,
...
var ObjectiveResourceFilterList: StaticListSchema = [1, n0, _ORFL,
  0, () => ObjectiveResourceFilter$
];
var ObjectiveSummaryList: StaticListSchema = [1, n0, _OSL,
  0, () => ObjectiveSummary$
];
export var Mapping$: StaticUnionSchema = [4, n0, _Ma,
  0,
  [_Fr, _CCo, _RCe],
  [() => FrameworkMappingDetails$, () => CommonControlMappingDetails$, () => RelatedControlMappingDetails$]
];
export var GetControl$: StaticOperationSchema = [9, n0, _GC,
  { [_h]: ["POST", "/get-control", 200] }, () => GetControlRequest$, () => GetControlResponse$
];
export var ListCommonControls$: StaticOperationSchema = [9, n0, _LCC,
  { [_h]: ["POST", "/common-controls", 200] }, () => ListCommonControlsRequest$, () => ListCommonControlsResponse$
];
export var ListControlMappings$: StaticOperationSchema = [9, n0, _LCM,
  { [_h]: ["POST", "/list-control-mappings", 200] }, () => ListControlMappingsRequest$, () => ListControlMappingsResponse$
];
export var ListControls$: StaticOperationSchema = [9, n0, _LC,
...
export var ListObjectives$: StaticOperationSchema = [9, n0, _LO,
