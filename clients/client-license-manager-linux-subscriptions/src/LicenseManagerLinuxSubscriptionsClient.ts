...
> {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultLicenseManagerLinuxSubscriptionsHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: LicenseManagerLinuxSubscriptionsClientResolvedConfig) =>
