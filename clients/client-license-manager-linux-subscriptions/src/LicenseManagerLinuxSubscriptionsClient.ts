...
import {
  defaultLicenseManagerLinuxSubscriptionsHttpAuthSchemeParametersProvider,
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<LicenseManagerLinuxSubscriptionsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultLicenseManagerLinuxSubscriptionsHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: LicenseManagerLinuxSubscriptionsClientResolvedConfig) =>
