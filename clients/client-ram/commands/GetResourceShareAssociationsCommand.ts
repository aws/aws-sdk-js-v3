...
import {
  deserializeAws_restJson1_1GetResourceShareAssociationsCommand,
  serializeAws_restJson1_1GetResourceShareAssociationsCommand,
...
export class GetResourceShareAssociationsCommand extends $Command<GetResourceShareAssociationsCommandInput, GetResourceShareAssociationsCommandOutput, RAMClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetResourceShareAssociationsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetResourceShareAssociationsCommand(output, context);
  }
