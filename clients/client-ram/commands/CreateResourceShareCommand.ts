...
import { CreateResourceShareRequest, CreateResourceShareResponse } from "../models/index";
import {
...
> {
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateResourceShareCommand(output, context);
  }
