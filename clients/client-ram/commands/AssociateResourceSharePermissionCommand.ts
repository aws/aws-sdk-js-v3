...
export class AssociateResourceSharePermissionCommand extends $Command<AssociateResourceSharePermissionCommandInput, AssociateResourceSharePermissionCommandOutput, RAMClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1AssociateResourceSharePermissionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1AssociateResourceSharePermissionCommand(output, context);
  }
