...
import {
  deserializeAws_restJson1_1GetResourcePoliciesCommand,
  serializeAws_restJson1_1GetResourcePoliciesCommand,
...
export class GetResourcePoliciesCommand extends $Command<GetResourcePoliciesCommandInput, GetResourcePoliciesCommandOutput, RAMClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetResourcePoliciesCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetResourcePoliciesCommand(output, context);
  }
