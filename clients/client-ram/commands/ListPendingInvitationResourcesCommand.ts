...
import {
  deserializeAws_restJson1_1ListPendingInvitationResourcesCommand,
  serializeAws_restJson1_1ListPendingInvitationResourcesCommand,
...
export class ListPendingInvitationResourcesCommand extends $Command<ListPendingInvitationResourcesCommandInput, ListPendingInvitationResourcesCommandOutput, RAMClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1ListPendingInvitationResourcesCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1ListPendingInvitationResourcesCommand(output, context);
  }
