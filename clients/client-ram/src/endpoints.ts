...
const AWS_TEMPLATE = "ram.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "ram.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "ram.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "ram.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "ram.{region}.amazonaws.com";
