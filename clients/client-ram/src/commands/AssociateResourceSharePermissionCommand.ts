 ...
 * @public
 */
export class AssociateResourceSharePermissionCommand extends command<AssociateResourceSharePermissionCommandInput, AssociateResourceSharePermissionCommandOutput>(
  _ep0,
  _mw0,
