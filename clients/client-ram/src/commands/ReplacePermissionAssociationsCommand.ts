 ...
 * @public
 */
export class ReplacePermissionAssociationsCommand extends command<ReplacePermissionAssociationsCommandInput, ReplacePermissionAssociationsCommandOutput>(
  _ep0,
  _mw0,
