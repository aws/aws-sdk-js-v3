...
AWS SDK for JavaScript SageMakerRuntimeHTTP2 Client for Node.js, Browser and React Native.
...
`SageMakerRuntimeHTTP2` extends `SageMakerRuntimeHTTP2Client` and additionally supports all operations, waiters, and paginators as methods.
This style may be familiar to you from the AWS SDK for JavaScript v2.

If you are bundling the AWS SDK, we recommend using only the bare-bones client (`SageMakerRuntimeHTTP2Client`).
More details are in the blog post on
[modular packages in AWS SDK for JavaScript](https://aws.amazon.com/blogs/developer/modular-packages-in-aws-sdk-for-javascript/).

```ts
import { SageMakerRuntimeHTTP2 } from "@aws-sdk/client-sagemaker-runtime-http2";

const client = new SageMakerRuntimeHTTP2({ region: "REGION" });
