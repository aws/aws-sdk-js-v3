...
function createAwsAuthSigv4HttpAuthOption(
  authParameters: SageMakerRuntimeHTTP2HttpAuthSchemeParameters
): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultSageMakerRuntimeHTTP2HttpAuthSchemeProvider: SageMakerRuntimeHTTP2HttpAuthSchemeProvider = (
  authParameters
) => {
