...
import {
  ...
  defaultSageMakerRuntimeHTTP2HttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type SageMakerRuntimeHTTP2ClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type SageMakerRuntimeHTTP2ClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<SageMakerRuntimeHTTP2ClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: SageMakerRuntimeHTTP2ClientResolvedConfig) =>
