...
export var GetScheduleGroupOutput: StaticStructureSchema = [3, n0, _GSGO, 0, [_A, _N, _St, _CD, _LMD], [0, 0, 0, 4, 4]];
...
export var ScheduleGroupList: StaticListSchema = [1, n0, _SGL, 0, () => ScheduleGroupSummary];
export var ScheduleList: StaticListSchema = [1, n0, _SL, 0, () => ScheduleSummary];
export var SecurityGroups = 64 | 0;
export var Subnets = 64 | 0;
export var TagKeyList = 64 | 0;
export var TagList: StaticListSchema = [1, n0, _TL, 0, () => Tag];
export var Tags: StaticListSchema = [1, n0, _T, 0, 128 | 0];
