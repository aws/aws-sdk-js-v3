...
import {
  KinesisAnalyticsConfiguration,
  KinesisAnalyticsResolvedConfiguration,
  configurationProperties
} from "./KinesisAnalyticsConfiguration";
import { InputTypesUnion } from "./types/InputTypesUnion";
import { OutputTypesUnion } from "./types/OutputTypesUnion";
import { clientVersion, ServiceMetadata } from "./model/ServiceMetadata";

export class KinesisAnalyticsClient
  implements
    __aws_sdk_types.AWSClient<InputTypesUnion, OutputTypesUnion, Uint8Array> {
  readonly config: KinesisAnalyticsResolvedConfiguration;
  ...
  constructor(configuration: KinesisAnalyticsConfiguration) {
