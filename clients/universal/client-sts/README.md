...
const {
  AssumeRoleCommand
} = require("@aws-sdk/client-sts/commands/AssumeRoleCommand");
```

```javascript
//typescript
const { STSClient } = import '@aws-sdk/client-sts/STSClient';
const { AssumeRoleCommand } = import '@aws-sdk/client-sts/commands/AssumeRoleCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-sts/STS";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-sts' package is updated. To contribute to SDK you can checkout our [code generator package][].
