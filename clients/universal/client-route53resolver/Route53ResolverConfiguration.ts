...
export interface Route53ResolverConfiguration {
  /**
...
export interface Route53ResolverResolvableConfiguration
  extends Route53ResolverConfiguration {
  /**
...
export interface Route53ResolverResolvedConfiguration
  extends Route53ResolverConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  Route53ResolverResolvableConfiguration,
