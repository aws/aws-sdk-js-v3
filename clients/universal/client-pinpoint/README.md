...
const {
  CreateAppCommand
} = require("@aws-sdk/client-pinpoint/commands/CreateAppCommand");
```

```javascript
//typescript
const { PinpointClient } = import '@aws-sdk/client-pinpoint/PinpointClient';
const { CreateAppCommand } = import '@aws-sdk/client-pinpoint/commands/CreateAppCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-pinpoint/Pinpoint";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-pinpoint' package is updated. To contribute to SDK you can checkout our [code generator package][].
