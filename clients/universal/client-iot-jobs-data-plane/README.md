...
} = require("@aws-sdk/client-iot-jobs-data-plane/IoTJobsDataPlaneClient");
const {
  DescribeJobExecutionCommand
} = require("@aws-sdk/client-iot-jobs-data-plane/commands/DescribeJobExecutionCommand");
```

```javascript
//typescript
const { IoTJobsDataPlaneClient } = import '@aws-sdk/client-iot-jobs-data-plane/IoTJobsDataPlaneClient';
const { DescribeJobExecutionCommand } = import '@aws-sdk/client-iot-jobs-data-plane/commands/DescribeJobExecutionCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-iot-jobs-data-plane/IoTJobsDataPlane";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-iot-jobs-data-plane' package is updated. To contribute to SDK you can checkout our [code generator package][].
