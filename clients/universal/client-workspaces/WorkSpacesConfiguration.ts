...
export interface WorkSpacesResolvableConfiguration
  extends WorkSpacesConfiguration {
  /**
...
export interface WorkSpacesResolvedConfiguration
  extends WorkSpacesConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  WorkSpacesResolvableConfiguration,
