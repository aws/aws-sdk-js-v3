...
} = require("@aws-sdk/client-elastic-load-balancing-v2/ElasticLoadBalancingv2Client");
const {
  AddListenerCertificatesCommand
} = require("@aws-sdk/client-elastic-load-balancing-v2/commands/AddListenerCertificatesCommand");
```

```javascript
//typescript
const { ElasticLoadBalancingv2Client } = import '@aws-sdk/client-elastic-load-balancing-v2/ElasticLoadBalancingv2Client';
const { AddListenerCertificatesCommand } = import '@aws-sdk/client-elastic-load-balancing-v2/commands/AddListenerCertificatesCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-elastic-load-balancing-v2/ElasticLoadBalancingv2";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-elastic-load-balancing-v2' package is updated. To contribute to SDK you can checkout our [code generator package][].
