...
} = require("@aws-sdk/client-application-auto-scaling/ApplicationAutoScalingClient");
const {
  DeleteScalingPolicyCommand
} = require("@aws-sdk/client-application-auto-scaling/commands/DeleteScalingPolicyCommand");
```

```javascript
//typescript
const { ApplicationAutoScalingClient } = import '@aws-sdk/client-application-auto-scaling/ApplicationAutoScalingClient';
const { DeleteScalingPolicyCommand } = import '@aws-sdk/client-application-auto-scaling/commands/DeleteScalingPolicyCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-application-auto-scaling/ApplicationAutoScaling";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-application-auto-scaling' package is updated. To contribute to SDK you can checkout our [code generator package][].
