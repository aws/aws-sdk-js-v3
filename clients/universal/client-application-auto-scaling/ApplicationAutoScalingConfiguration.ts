...
export interface ApplicationAutoScalingConfiguration {
  /**
...
export interface ApplicationAutoScalingResolvableConfiguration
  extends ApplicationAutoScalingConfiguration {
  /**
...
export interface ApplicationAutoScalingResolvedConfiguration
  extends ApplicationAutoScalingConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ApplicationAutoScalingResolvableConfiguration,
...
> = {
  ...
  signingName: {
    defaultValue: "application-autoscaling"
  },
  signer: {
    defaultProvider: (configuration: {
      credentials: __aws_sdk_types.Provider<__aws_sdk_types.Credentials>;
