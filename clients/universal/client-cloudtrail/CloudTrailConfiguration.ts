...
export interface CloudTrailResolvableConfiguration
  extends CloudTrailConfiguration {
  /**
...
export interface CloudTrailResolvedConfiguration
  extends CloudTrailConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CloudTrailResolvableConfiguration,
