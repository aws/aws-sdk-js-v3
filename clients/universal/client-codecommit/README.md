...
const {
  CodeCommitClient
} = require("@aws-sdk/client-codecommit/CodeCommitClient");
const {
  BatchDescribeMergeConflictsCommand
} = require("@aws-sdk/client-codecommit/commands/BatchDescribeMergeConflictsCommand");
```

```javascript
//typescript
const { CodeCommitClient } = import '@aws-sdk/client-codecommit/CodeCommitClient';
const { BatchDescribeMergeConflictsCommand } = import '@aws-sdk/client-codecommit/commands/BatchDescribeMergeConflictsCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-codecommit/CodeCommit";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-codecommit' package is updated. To contribute to SDK you can checkout our [code generator package][].
