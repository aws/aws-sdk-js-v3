...
import {
  PersonalizeConfiguration,
  PersonalizeResolvedConfiguration,
  configurationProperties
} from "./PersonalizeConfiguration";
...
export class PersonalizeClient
  ...
  readonly config: PersonalizeResolvedConfiguration;
  ...
  constructor(configuration: PersonalizeConfiguration) {
