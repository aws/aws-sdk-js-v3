...
const {
  PersonalizeClient
} = require("@aws-sdk/client-personalize/PersonalizeClient");
const {
  CreateCampaignCommand
} = require("@aws-sdk/client-personalize/commands/CreateCampaignCommand");
```

```javascript
//typescript
const { PersonalizeClient } = import '@aws-sdk/client-personalize/PersonalizeClient';
const { CreateCampaignCommand } = import '@aws-sdk/client-personalize/commands/CreateCampaignCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-personalize/Personalize";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-personalize' package is updated. To contribute to SDK you can checkout our [code generator package][].
