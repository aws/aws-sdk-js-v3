...
const {
  OrganizationsClient
} = require("@aws-sdk/client-organizations/OrganizationsClient");
const {
  AcceptHandshakeCommand
} = require("@aws-sdk/client-organizations/commands/AcceptHandshakeCommand");
```

```javascript
//typescript
const { OrganizationsClient } = import '@aws-sdk/client-organizations/OrganizationsClient';
const { AcceptHandshakeCommand } = import '@aws-sdk/client-organizations/commands/AcceptHandshakeCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-organizations/Organizations";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-organizations' package is updated. To contribute to SDK you can checkout our [code generator package][].
