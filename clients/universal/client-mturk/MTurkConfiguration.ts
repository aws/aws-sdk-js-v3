...
export interface MTurkConfiguration {
  /**
...
export interface MTurkResolvableConfiguration extends MTurkConfiguration {
  /**
...
export interface MTurkResolvedConfiguration
  extends MTurkConfiguration,
