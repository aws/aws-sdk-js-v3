...
export interface CloudHSMConfiguration {
  /**
...
export interface CloudHSMResolvableConfiguration extends CloudHSMConfiguration {
  /**
...
export interface CloudHSMResolvedConfiguration
  extends CloudHSMConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CloudHSMResolvableConfiguration,
