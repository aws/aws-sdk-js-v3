...
export interface ApplicationDiscoveryServiceConfiguration {
  /**
...
export interface ApplicationDiscoveryServiceResolvableConfiguration
  extends ApplicationDiscoveryServiceConfiguration {
  /**
...
export interface ApplicationDiscoveryServiceResolvedConfiguration
  extends ApplicationDiscoveryServiceConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ApplicationDiscoveryServiceResolvableConfiguration,
