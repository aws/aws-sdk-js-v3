...
const {
  AppStreamClient
} = require("@aws-sdk/client-appstream/AppStreamClient");
const {
  AssociateFleetCommand
} = require("@aws-sdk/client-appstream/commands/AssociateFleetCommand");
```

```javascript
//typescript
const { AppStreamClient } = import '@aws-sdk/client-appstream/AppStreamClient';
const { AssociateFleetCommand } = import '@aws-sdk/client-appstream/commands/AssociateFleetCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-appstream/AppStream";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-appstream' package is updated. To contribute to SDK you can checkout our [code generator package][].
