...
export interface ServiceDiscoveryResolvableConfiguration
...
export interface ServiceDiscoveryResolvedConfiguration
  extends ServiceDiscoveryConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ServiceDiscoveryResolvableConfiguration,
