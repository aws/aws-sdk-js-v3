...
export interface MediaPackageConfiguration {
  /**
...
export interface MediaPackageResolvableConfiguration
  extends MediaPackageConfiguration {
  /**
...
export interface MediaPackageResolvedConfiguration
  extends MediaPackageConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  MediaPackageResolvableConfiguration,
