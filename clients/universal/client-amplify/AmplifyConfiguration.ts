...
export interface AmplifyResolvableConfiguration extends AmplifyConfiguration {
  /**
...
export interface AmplifyResolvedConfiguration
  extends AmplifyConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  AmplifyResolvableConfiguration,
