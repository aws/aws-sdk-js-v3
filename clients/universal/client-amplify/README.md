...
```javascript
//javascript
const { AmplifyClient } = require("@aws-sdk/client-amplify/AmplifyClient");
const {
  CreateAppCommand
} = require("@aws-sdk/client-amplify/commands/CreateAppCommand");
```

```javascript
//typescript
const { AmplifyClient } = import '@aws-sdk/client-amplify/AmplifyClient';
const { CreateAppCommand } = import '@aws-sdk/client-amplify/commands/CreateAppCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-amplify/Amplify";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-amplify' package is updated. To contribute to SDK you can checkout our [code generator package][].
