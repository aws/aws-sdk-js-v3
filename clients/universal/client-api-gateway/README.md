...
const {
  APIGatewayClient
} = require("@aws-sdk/client-api-gateway/APIGatewayClient");
const {
  CreateApiKeyCommand
} = require("@aws-sdk/client-api-gateway/commands/CreateApiKeyCommand");
```

```javascript
//typescript
const { APIGatewayClient } = import '@aws-sdk/client-api-gateway/APIGatewayClient';
const { CreateApiKeyCommand } = import '@aws-sdk/client-api-gateway/commands/CreateApiKeyCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-api-gateway/APIGateway";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-api-gateway' package is updated. To contribute to SDK you can checkout our [code generator package][].
