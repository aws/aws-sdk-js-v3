...
import * as __aws_sdk_middleware_sdk_api_gateway from "@aws-sdk/middleware-sdk-api-gateway";
...
export class APIGatewayClient
  ...
  readonly config: APIGatewayResolvedConfiguration;
  ...
  constructor(configuration: APIGatewayConfiguration) {
    ...
    this.middlewareStack.add(
      __aws_sdk_middleware_sdk_api_gateway.acceptsHeader,
      {
        step: "build",
        priority: 50,
