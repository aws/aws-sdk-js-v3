...
```javascript
//javascript
const { TransferClient } = require("@aws-sdk/client-transfer/TransferClient");
const {
  CreateServerCommand
} = require("@aws-sdk/client-transfer/commands/CreateServerCommand");
```

```javascript
//typescript
const { TransferClient } = import '@aws-sdk/client-transfer/TransferClient';
const { CreateServerCommand } = import '@aws-sdk/client-transfer/commands/CreateServerCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-transfer/Transfer";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-transfer' package is updated. To contribute to SDK you can checkout our [code generator package][].
