...
} = require("@aws-sdk/client-resource-groups-tagging-api/ResourceGroupsTaggingAPIClient");
const {
  GetResourcesCommand
} = require("@aws-sdk/client-resource-groups-tagging-api/commands/GetResourcesCommand");
```

```javascript
//typescript
const { ResourceGroupsTaggingAPIClient } = import '@aws-sdk/client-resource-groups-tagging-api/ResourceGroupsTaggingAPIClient';
const { GetResourcesCommand } = import '@aws-sdk/client-resource-groups-tagging-api/commands/GetResourcesCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-resource-groups-tagging-api/ResourceGroupsTaggingAPI";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-resource-groups-tagging-api' package is updated. To contribute to SDK you can checkout our [code generator package][].
