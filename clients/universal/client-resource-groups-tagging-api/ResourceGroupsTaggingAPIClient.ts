...
import {
  ResourceGroupsTaggingAPIConfiguration,
  ResourceGroupsTaggingAPIResolvedConfiguration,
  configurationProperties
} from "./ResourceGroupsTaggingAPIConfiguration";
...
export class ResourceGroupsTaggingAPIClient
  ...
  readonly config: ResourceGroupsTaggingAPIResolvedConfiguration;
  ...
  constructor(configuration: ResourceGroupsTaggingAPIConfiguration) {
