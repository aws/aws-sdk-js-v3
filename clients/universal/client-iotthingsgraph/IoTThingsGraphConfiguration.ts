...
export interface IoTThingsGraphConfiguration {
  /**
...
export interface IoTThingsGraphResolvableConfiguration
  extends IoTThingsGraphConfiguration {
  /**
...
export interface IoTThingsGraphResolvedConfiguration
  extends IoTThingsGraphConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  IoTThingsGraphResolvableConfiguration,
