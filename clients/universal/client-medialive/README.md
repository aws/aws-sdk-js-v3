...
const {
  MediaLiveClient
} = require("@aws-sdk/client-medialive/MediaLiveClient");
const {
  BatchUpdateScheduleCommand
} = require("@aws-sdk/client-medialive/commands/BatchUpdateScheduleCommand");
```

```javascript
//typescript
const { MediaLiveClient } = import '@aws-sdk/client-medialive/MediaLiveClient';
const { BatchUpdateScheduleCommand } = import '@aws-sdk/client-medialive/commands/BatchUpdateScheduleCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-medialive/MediaLive";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-medialive' package is updated. To contribute to SDK you can checkout our [code generator package][].
