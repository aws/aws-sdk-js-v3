...
import {
  ApiGatewayManagementApiConfiguration,
  ApiGatewayManagementApiResolvedConfiguration,
  configurationProperties
} from "./ApiGatewayManagementApiConfiguration";
...
export class ApiGatewayManagementApiClient
  ...
  readonly config: ApiGatewayManagementApiResolvedConfiguration;
  ...
  constructor(configuration: ApiGatewayManagementApiConfiguration) {
