...
export interface OpsWorksConfiguration {
  /**
...
export interface OpsWorksResolvableConfiguration extends OpsWorksConfiguration {
  /**
...
export interface OpsWorksResolvedConfiguration
  extends OpsWorksConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  OpsWorksResolvableConfiguration,
  ...
  serializer: {
    defaultProvider: (configuration: {
      ...
      const promisified = configuration
        ...
        .then(
          endpoint =>
            new __aws_sdk_protocol_json_rpc.JsonRpcSerializer<Uint8Array>(
              endpoint,
