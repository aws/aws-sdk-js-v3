...
```javascript
//javascript
const { XRayClient } = require("@aws-sdk/client-xray/XRayClient");
const {
  BatchGetTracesCommand
} = require("@aws-sdk/client-xray/commands/BatchGetTracesCommand");
```

```javascript
//typescript
const { XRayClient } = import '@aws-sdk/client-xray/XRayClient';
const { BatchGetTracesCommand } = import '@aws-sdk/client-xray/commands/BatchGetTracesCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-xray/XRay";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-xray' package is updated. To contribute to SDK you can checkout our [code generator package][].
