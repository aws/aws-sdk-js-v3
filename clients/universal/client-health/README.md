...
```javascript
//javascript
const { HealthClient } = require("@aws-sdk/client-health/HealthClient");
const {
  DescribeAffectedEntitiesCommand
} = require("@aws-sdk/client-health/commands/DescribeAffectedEntitiesCommand");
```

```javascript
//typescript
const { HealthClient } = import '@aws-sdk/client-health/HealthClient';
const { DescribeAffectedEntitiesCommand } = import '@aws-sdk/client-health/commands/DescribeAffectedEntitiesCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-health/Health";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-health' package is updated. To contribute to SDK you can checkout our [code generator package][].
