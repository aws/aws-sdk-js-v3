...
export interface HealthResolvableConfiguration extends HealthConfiguration {
  /**
...
export interface HealthResolvedConfiguration
  extends HealthConfiguration,
