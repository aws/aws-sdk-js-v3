...
const {
  MediaTailorClient
} = require("@aws-sdk/client-mediatailor/MediaTailorClient");
const {
  DeletePlaybackConfigurationCommand
} = require("@aws-sdk/client-mediatailor/commands/DeletePlaybackConfigurationCommand");
```

```javascript
//typescript
const { MediaTailorClient } = import '@aws-sdk/client-mediatailor/MediaTailorClient';
const { DeletePlaybackConfigurationCommand } = import '@aws-sdk/client-mediatailor/commands/DeletePlaybackConfigurationCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-mediatailor/MediaTailor";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-mediatailor' package is updated. To contribute to SDK you can checkout our [code generator package][].
