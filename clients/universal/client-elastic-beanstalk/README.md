...
} = require("@aws-sdk/client-elastic-beanstalk/ElasticBeanstalkClient");
const {
  AbortEnvironmentUpdateCommand
} = require("@aws-sdk/client-elastic-beanstalk/commands/AbortEnvironmentUpdateCommand");
```

```javascript
//typescript
const { ElasticBeanstalkClient } = import '@aws-sdk/client-elastic-beanstalk/ElasticBeanstalkClient';
const { AbortEnvironmentUpdateCommand } = import '@aws-sdk/client-elastic-beanstalk/commands/AbortEnvironmentUpdateCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-elastic-beanstalk/ElasticBeanstalk";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-elastic-beanstalk' package is updated. To contribute to SDK you can checkout our [code generator package][].
