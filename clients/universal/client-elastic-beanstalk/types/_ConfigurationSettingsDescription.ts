import {
  _ConfigurationOptionSetting,
  _UnmarshalledConfigurationOptionSetting
} from "./_ConfigurationOptionSetting";

/**
 * <p>Describes the settings for a configuration set.</p>
 */
export interface _ConfigurationSettingsDescription {
  /**
...
export interface _UnmarshalledConfigurationSettingsDescription
  extends _ConfigurationSettingsDescription {
  /**
   * <p>The date (in UTC time) when this configuration set was created.</p>
   */
  DateCreated?: Date;
