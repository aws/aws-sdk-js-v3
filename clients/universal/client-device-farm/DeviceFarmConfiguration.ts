...
export interface DeviceFarmConfiguration {
  /**
...
export interface DeviceFarmResolvableConfiguration
  extends DeviceFarmConfiguration {
  /**
...
export interface DeviceFarmResolvedConfiguration
  extends DeviceFarmConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  DeviceFarmResolvableConfiguration,
