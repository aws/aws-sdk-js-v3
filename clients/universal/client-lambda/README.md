...
```javascript
//javascript
const { LambdaClient } = require("@aws-sdk/client-lambda/LambdaClient");
const {
  InvokeAsyncCommand
} = require("@aws-sdk/client-lambda/commands/InvokeAsyncCommand");
```

```javascript
//typescript
const { LambdaClient } = import '@aws-sdk/client-lambda/LambdaClient';
const { InvokeAsyncCommand } = import '@aws-sdk/client-lambda/commands/InvokeAsyncCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-lambda/Lambda";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-lambda' package is updated. To contribute to SDK you can checkout our [code generator package][].
