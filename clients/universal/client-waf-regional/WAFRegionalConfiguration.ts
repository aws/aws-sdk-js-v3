...
export interface WAFRegionalConfiguration {
  /**
...
export interface WAFRegionalResolvableConfiguration
  extends WAFRegionalConfiguration {
  /**
...
export interface WAFRegionalResolvedConfiguration
  extends WAFRegionalConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  WAFRegionalResolvableConfiguration,
