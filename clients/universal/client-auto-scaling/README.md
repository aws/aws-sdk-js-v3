...
const {
  AutoScalingClient
} = require("@aws-sdk/client-auto-scaling/AutoScalingClient");
const {
  AttachInstancesCommand
} = require("@aws-sdk/client-auto-scaling/commands/AttachInstancesCommand");
```

```javascript
//typescript
const { AutoScalingClient } = import '@aws-sdk/client-auto-scaling/AutoScalingClient';
const { AttachInstancesCommand } = import '@aws-sdk/client-auto-scaling/commands/AttachInstancesCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-auto-scaling/AutoScaling";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-auto-scaling' package is updated. To contribute to SDK you can checkout our [code generator package][].
