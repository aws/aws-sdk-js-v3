...
} = require("@aws-sdk/client-sqs/commands/AddPermissionCommand");
```

```javascript
//typescript
const { SQSClient } = import '@aws-sdk/client-sqs/SQSClient';
const { AddPermissionCommand } = import '@aws-sdk/client-sqs/commands/AddPermissionCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-sqs/SQS";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-sqs' package is updated. To contribute to SDK you can checkout our [code generator package][].
