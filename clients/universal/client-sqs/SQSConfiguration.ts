...
import * as __aws_sdk_is_node from "@aws-sdk/is-node";
import * as __aws_sdk_middleware_serializer from "@aws-sdk/middleware-serializer";
import * as __aws_sdk_protocol_query from "@aws-sdk/protocol-query";
import * as __aws_sdk_query_builder from "@aws-sdk/query-builder";
...
import * as __aws_sdk_url_parser_universal from "@aws-sdk/url-parser-universal";
...
import * as __aws_sdk_util_utf8_universal from "@aws-sdk/util-utf8-universal";
...
export interface SQSConfiguration {
   ...
   */
  handler?: __aws_sdk_types.Terminalware<any, Uint8Array>;

  /**
   * The HTTP handler to use
   */
  httpHandler?: __aws_sdk_types.HttpHandler<Uint8Array>;
   ...
   */
  streamCollector?: __aws_sdk_types.StreamCollector<Uint8Array>;
...
export interface SQSResolvableConfiguration extends SQSConfiguration {
  /**
   ...
   */
  parser: __aws_sdk_types.ResponseParser<Uint8Array>;

  /**
   * The serializer to use when converting SDK input to HTTP requests
   */
  serializer: __aws_sdk_types.Provider<
    __aws_sdk_types.RequestSerializer<Uint8Array>
  >;
}

export interface SQSResolvedConfiguration
...
> = {
  ...
  urlParser: {
    defaultValue: __aws_sdk_url_parser_universal.parseUrl
  },
  endpointProvider: {
  ...
  base64Decoder: {
    defaultValue: __aws_sdk_util_base64_universal.fromBase64
  },
  base64Encoder: {
    defaultValue: __aws_sdk_util_base64_universal.toBase64
  },
  utf8Decoder: {
    defaultValue: __aws_sdk_util_utf8_universal.fromUtf8
  },
  utf8Encoder: {
    defaultValue: __aws_sdk_util_utf8_universal.toUtf8
  },
  streamCollector: {
    defaultValue: __aws_sdk_is_node.isNode
      ? __aws_sdk_stream_collector_node.streamCollector
      : __aws_sdk_stream_collector_browser.streamCollector
  },
  serializer: {
    defaultProvider: (configuration: {
      base64Encoder: __aws_sdk_types.Encoder;
      ...
      const promisified = configuration
        ...
        .then(
          endpoint =>
            new __aws_sdk_protocol_query.QuerySerializer<Uint8Array>(
              endpoint,
              new __aws_sdk_query_builder.QueryBuilder(
  ...
  parser: {
    defaultProvider: (configuration: {
      ...
      new __aws_sdk_protocol_query.QueryParser(
        new __aws_sdk_xml_body_parser.XmlBodyParser(
  ...
  handler: {
    defaultProvider: (configuration: {
      ...
      __aws_sdk_core_handler.coreHandler<OutputTypesUnion, Uint8Array>(
        configuration.httpHandler,
  ...
  sha256: {
    defaultValue: __aws_crypto_sha256_universal.Sha256
  },
  signingName: {
    defaultValue: "sqs"
  },
