...
```javascript
//javascript
const { WorkLinkClient } = require("@aws-sdk/client-worklink/WorkLinkClient");
const {
  AssociateDomainCommand
} = require("@aws-sdk/client-worklink/commands/AssociateDomainCommand");
```

```javascript
//typescript
const { WorkLinkClient } = import '@aws-sdk/client-worklink/WorkLinkClient';
const { AssociateDomainCommand } = import '@aws-sdk/client-worklink/commands/AssociateDomainCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-worklink/WorkLink";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-worklink' package is updated. To contribute to SDK you can checkout our [code generator package][].
