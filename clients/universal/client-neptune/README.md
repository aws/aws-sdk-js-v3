...
```javascript
//javascript
const { NeptuneClient } = require("@aws-sdk/client-neptune/NeptuneClient");
const {
  AddRoleToDBClusterCommand
} = require("@aws-sdk/client-neptune/commands/AddRoleToDBClusterCommand");
```

```javascript
//typescript
const { NeptuneClient } = import '@aws-sdk/client-neptune/NeptuneClient';
const { AddRoleToDBClusterCommand } = import '@aws-sdk/client-neptune/commands/AddRoleToDBClusterCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-neptune/Neptune";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-neptune' package is updated. To contribute to SDK you can checkout our [code generator package][].
