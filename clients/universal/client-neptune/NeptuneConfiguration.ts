...
export interface NeptuneConfiguration {
  /**
...
export interface NeptuneResolvableConfiguration extends NeptuneConfiguration {
  /**
...
export interface NeptuneResolvedConfiguration
  extends NeptuneConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  NeptuneResolvableConfiguration,
