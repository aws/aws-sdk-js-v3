...
export interface ApplicationInsightsResolvableConfiguration
  extends ApplicationInsightsConfiguration {
  /**
...
export interface ApplicationInsightsResolvedConfiguration
  extends ApplicationInsightsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ApplicationInsightsResolvableConfiguration,
