import { CreateDiskSnapshotInput } from "./CreateDiskSnapshotInput";
import { CreateDiskSnapshotOutput } from "./CreateDiskSnapshotOutput";
...
export const CreateDiskSnapshot: _Operation_ = {
  ...
  input: {
    shape: CreateDiskSnapshotInput
  },
  output: {
    shape: CreateDiskSnapshotOutput
  },
  errors: [
    {
