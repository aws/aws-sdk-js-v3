...
export interface KinesisVideoConfiguration {
  /**
...
export interface KinesisVideoResolvableConfiguration
  extends KinesisVideoConfiguration {
  /**
...
export interface KinesisVideoResolvedConfiguration
  extends KinesisVideoConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  KinesisVideoResolvableConfiguration,
