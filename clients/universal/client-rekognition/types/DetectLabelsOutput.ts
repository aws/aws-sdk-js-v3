import { _UnmarshalledLabel } from "./_Label";
import * as __aws_sdk_types from "@aws-sdk/types";

/**
 * DetectLabelsOutput shape
 */
export interface DetectLabelsOutput extends __aws_sdk_types.MetadataBearer {
  /**
   * <p>An array of labels for the real-world objects detected. </p>
   */
  Labels?: Array<_UnmarshalledLabel>;
