...
const {
  CompareFacesCommand
} = require("@aws-sdk/client-rekognition/commands/CompareFacesCommand");
```

```javascript
//typescript
const { RekognitionClient } = import '@aws-sdk/client-rekognition/RekognitionClient';
const { CompareFacesCommand } = import '@aws-sdk/client-rekognition/commands/CompareFacesCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-rekognition/Rekognition";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-rekognition' package is updated. To contribute to SDK you can checkout our [code generator package][].
