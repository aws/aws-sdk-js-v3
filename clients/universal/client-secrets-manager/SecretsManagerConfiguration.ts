...
export interface SecretsManagerResolvableConfiguration
  extends SecretsManagerConfiguration {
  /**
...
export interface SecretsManagerResolvedConfiguration
  extends SecretsManagerConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  SecretsManagerResolvableConfiguration,
