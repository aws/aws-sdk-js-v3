...
} = require("@aws-sdk/client-managedblockchain/ManagedBlockchainClient");
const {
  CreateMemberCommand
} = require("@aws-sdk/client-managedblockchain/commands/CreateMemberCommand");
```

```javascript
//typescript
const { ManagedBlockchainClient } = import '@aws-sdk/client-managedblockchain/ManagedBlockchainClient';
const { CreateMemberCommand } = import '@aws-sdk/client-managedblockchain/commands/CreateMemberCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-managedblockchain/ManagedBlockchain";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-managedblockchain' package is updated. To contribute to SDK you can checkout our [code generator package][].
