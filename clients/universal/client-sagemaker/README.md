...
const {
  SageMakerClient
} = require("@aws-sdk/client-sagemaker/SageMakerClient");
const {
  AddTagsCommand
} = require("@aws-sdk/client-sagemaker/commands/AddTagsCommand");
```

```javascript
//typescript
const { SageMakerClient } = import '@aws-sdk/client-sagemaker/SageMakerClient';
const { AddTagsCommand } = import '@aws-sdk/client-sagemaker/commands/AddTagsCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-sagemaker/SageMaker";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-sagemaker' package is updated. To contribute to SDK you can checkout our [code generator package][].
