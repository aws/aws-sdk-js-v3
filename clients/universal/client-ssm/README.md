...
```javascript
//javascript
const { SSMClient } = require("@aws-sdk/client-ssm/SSMClient");
const {
  AddTagsToResourceCommand
} = require("@aws-sdk/client-ssm/commands/AddTagsToResourceCommand");
```

```javascript
//typescript
const { SSMClient } = import '@aws-sdk/client-ssm/SSMClient';
const { AddTagsToResourceCommand } = import '@aws-sdk/client-ssm/commands/AddTagsToResourceCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-ssm/SSM";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-ssm' package is updated. To contribute to SDK you can checkout our [code generator package][].
