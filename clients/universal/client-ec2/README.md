...
```javascript
//javascript
const { EC2Client } = require("@aws-sdk/client-ec2/EC2Client");
const {
  AcceptReservedInstancesExchangeQuoteCommand
} = require("@aws-sdk/client-ec2/commands/AcceptReservedInstancesExchangeQuoteCommand");
```

```javascript
//typescript
const { EC2Client } = import '@aws-sdk/client-ec2/EC2Client';
const { AcceptReservedInstancesExchangeQuoteCommand } = import '@aws-sdk/client-ec2/commands/AcceptReservedInstancesExchangeQuoteCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-ec2/EC2";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-ec2' package is updated. To contribute to SDK you can checkout our [code generator package][].
