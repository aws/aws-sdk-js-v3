 ...
 */
export interface _ImportInstanceLaunchSpecification {
  /**
   * <p>Reserved.</p>
   */
...
export interface _UnmarshalledImportInstanceLaunchSpecification
  extends _ImportInstanceLaunchSpecification {
  /**
   * <p>The security group IDs.</p>
   */
