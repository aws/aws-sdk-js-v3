...
export interface DatabaseMigrationServiceConfiguration {
  /**
...
export interface DatabaseMigrationServiceResolvableConfiguration
  extends DatabaseMigrationServiceConfiguration {
  /**
...
export interface DatabaseMigrationServiceResolvedConfiguration
  extends DatabaseMigrationServiceConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  DatabaseMigrationServiceResolvableConfiguration,
