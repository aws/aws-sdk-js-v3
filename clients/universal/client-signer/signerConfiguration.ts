...
export interface signerResolvableConfiguration extends signerConfiguration {
  /**
...
export interface signerResolvedConfiguration
  extends signerConfiguration,
