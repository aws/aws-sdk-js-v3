...
const {
  BatchGetItemCommand
} = require("@aws-sdk/client-dynamodb/commands/BatchGetItemCommand");
```

```javascript
//typescript
const { DynamoDBClient } = import '@aws-sdk/client-dynamodb/DynamoDBClient';
const { BatchGetItemCommand } = import '@aws-sdk/client-dynamodb/commands/BatchGetItemCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-dynamodb/DynamoDB";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-dynamodb' package is updated. To contribute to SDK you can checkout our [code generator package][].
