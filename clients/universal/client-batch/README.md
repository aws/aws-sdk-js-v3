...
```javascript
//javascript
const { BatchClient } = require("@aws-sdk/client-batch/BatchClient");
const {
  CancelJobCommand
} = require("@aws-sdk/client-batch/commands/CancelJobCommand");
```

```javascript
//typescript
const { BatchClient } = import '@aws-sdk/client-batch/BatchClient';
const { CancelJobCommand } = import '@aws-sdk/client-batch/commands/CancelJobCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-batch/Batch";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-batch' package is updated. To contribute to SDK you can checkout our [code generator package][].
