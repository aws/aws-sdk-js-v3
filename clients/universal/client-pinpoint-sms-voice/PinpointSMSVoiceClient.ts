...
import {
  PinpointSMSVoiceConfiguration,
  PinpointSMSVoiceResolvedConfiguration,
  configurationProperties
} from "./PinpointSMSVoiceConfiguration";
...
export class PinpointSMSVoiceClient
  ...
  readonly config: PinpointSMSVoiceResolvedConfiguration;
  ...
  constructor(configuration: PinpointSMSVoiceConfiguration) {
