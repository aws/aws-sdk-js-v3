...
} = require("@aws-sdk/client-pinpoint-sms-voice/PinpointSMSVoiceClient");
const {
  CreateConfigurationSetCommand
} = require("@aws-sdk/client-pinpoint-sms-voice/commands/CreateConfigurationSetCommand");
```

```javascript
//typescript
const { PinpointSMSVoiceClient } = import '@aws-sdk/client-pinpoint-sms-voice/PinpointSMSVoiceClient';
const { CreateConfigurationSetCommand } = import '@aws-sdk/client-pinpoint-sms-voice/commands/CreateConfigurationSetCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-pinpoint-sms-voice/PinpointSMSVoice";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-pinpoint-sms-voice' package is updated. To contribute to SDK you can checkout our [code generator package][].
