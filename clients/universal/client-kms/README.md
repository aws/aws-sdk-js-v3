...
```javascript
//javascript
const { KMSClient } = require("@aws-sdk/client-kms/KMSClient");
const {
  CancelKeyDeletionCommand
} = require("@aws-sdk/client-kms/commands/CancelKeyDeletionCommand");
```

```javascript
//typescript
const { KMSClient } = import '@aws-sdk/client-kms/KMSClient';
const { CancelKeyDeletionCommand } = import '@aws-sdk/client-kms/commands/CancelKeyDeletionCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-kms/KMS";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-kms' package is updated. To contribute to SDK you can checkout our [code generator package][].
