...
/**
 * UpdateIndexingConfigurationInput shape
 */
export interface UpdateIndexingConfigurationInput {
  /**
   * <p>Thing indexing configuration.</p>
   */
  thingIndexingConfiguration?: _ThingIndexingConfiguration;

  /**
   * <p>Thing group indexing configuration.</p>
   */
  thingGroupIndexingConfiguration?: _ThingGroupIndexingConfiguration;
