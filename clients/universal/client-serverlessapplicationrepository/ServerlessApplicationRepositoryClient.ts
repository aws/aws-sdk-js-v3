...
import {
  ServerlessApplicationRepositoryConfiguration,
  ServerlessApplicationRepositoryResolvedConfiguration,
  configurationProperties
} from "./ServerlessApplicationRepositoryConfiguration";
import { InputTypesUnion } from "./types/InputTypesUnion";
import { OutputTypesUnion } from "./types/OutputTypesUnion";
import { clientVersion, ServiceMetadata } from "./model/ServiceMetadata";

export class ServerlessApplicationRepositoryClient
  implements
    __aws_sdk_types.AWSClient<InputTypesUnion, OutputTypesUnion, Uint8Array> {
  readonly config: ServerlessApplicationRepositoryResolvedConfiguration;
  ...
  constructor(configuration: ServerlessApplicationRepositoryConfiguration) {
