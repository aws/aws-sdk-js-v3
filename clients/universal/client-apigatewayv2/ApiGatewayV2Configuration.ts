...
export interface ApiGatewayV2Configuration {
  /**
...
export interface ApiGatewayV2ResolvableConfiguration
  extends ApiGatewayV2Configuration {
  /**
...
export interface ApiGatewayV2ResolvedConfiguration
  extends ApiGatewayV2Configuration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ApiGatewayV2ResolvableConfiguration,
