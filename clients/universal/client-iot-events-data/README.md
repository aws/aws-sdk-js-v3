...
const {
  IoTEventsDataClient
} = require("@aws-sdk/client-iot-events-data/IoTEventsDataClient");
const {
  BatchPutMessageCommand
} = require("@aws-sdk/client-iot-events-data/commands/BatchPutMessageCommand");
```

```javascript
//typescript
const { IoTEventsDataClient } = import '@aws-sdk/client-iot-events-data/IoTEventsDataClient';
const { BatchPutMessageCommand } = import '@aws-sdk/client-iot-events-data/commands/BatchPutMessageCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-iot-events-data/IoTEventsData";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-iot-events-data' package is updated. To contribute to SDK you can checkout our [code generator package][].
