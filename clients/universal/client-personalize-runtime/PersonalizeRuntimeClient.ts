...
import {
  PersonalizeRuntimeConfiguration,
  PersonalizeRuntimeResolvedConfiguration,
  configurationProperties
} from "./PersonalizeRuntimeConfiguration";
...
export class PersonalizeRuntimeClient
  ...
  readonly config: PersonalizeRuntimeResolvedConfiguration;
  ...
  constructor(configuration: PersonalizeRuntimeConfiguration) {
