...
export interface PersonalizeRuntimeConfiguration {
  /**
...
export interface PersonalizeRuntimeResolvableConfiguration
  extends PersonalizeRuntimeConfiguration {
  /**
...
export interface PersonalizeRuntimeResolvedConfiguration
  extends PersonalizeRuntimeConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  PersonalizeRuntimeResolvableConfiguration,
