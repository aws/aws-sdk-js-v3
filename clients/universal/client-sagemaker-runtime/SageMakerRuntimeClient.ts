...
import {
  SageMakerRuntimeConfiguration,
  SageMakerRuntimeResolvedConfiguration,
  configurationProperties
} from "./SageMakerRuntimeConfiguration";
...
export class SageMakerRuntimeClient
  ...
  readonly config: SageMakerRuntimeResolvedConfiguration;
  ...
  constructor(configuration: SageMakerRuntimeConfiguration) {
