...
} = require("@aws-sdk/client-marketplace-metering/MarketplaceMeteringClient");
const {
  BatchMeterUsageCommand
} = require("@aws-sdk/client-marketplace-metering/commands/BatchMeterUsageCommand");
```

```javascript
//typescript
const { MarketplaceMeteringClient } = import '@aws-sdk/client-marketplace-metering/MarketplaceMeteringClient';
const { BatchMeterUsageCommand } = import '@aws-sdk/client-marketplace-metering/commands/BatchMeterUsageCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-marketplace-metering/MarketplaceMetering";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-marketplace-metering' package is updated. To contribute to SDK you can checkout our [code generator package][].
