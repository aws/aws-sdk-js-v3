...
export interface MarketplaceMeteringConfiguration {
  /**
...
export interface MarketplaceMeteringResolvableConfiguration
  extends MarketplaceMeteringConfiguration {
  /**
...
export interface MarketplaceMeteringResolvedConfiguration
  extends MarketplaceMeteringConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  MarketplaceMeteringResolvableConfiguration,
