...
```javascript
//javascript
const { MacieClient } = require("@aws-sdk/client-macie/MacieClient");
const {
  AssociateMemberAccountCommand
} = require("@aws-sdk/client-macie/commands/AssociateMemberAccountCommand");
```

```javascript
//typescript
const { MacieClient } = import '@aws-sdk/client-macie/MacieClient';
const { AssociateMemberAccountCommand } = import '@aws-sdk/client-macie/commands/AssociateMemberAccountCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-macie/Macie";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-macie' package is updated. To contribute to SDK you can checkout our [code generator package][].
