import { _UnmarshalledServiceLastAccessed } from "./_ServiceLastAccessed";
import { _UnmarshalledErrorDetails } from "./_ErrorDetails";
import * as __aws_sdk_types from "@aws-sdk/types";

/**
 * GetServiceLastAccessedDetailsOutput shape
 */
export interface GetServiceLastAccessedDetailsOutput
   ...
   */
  ServicesLastAccessed: Array<_UnmarshalledServiceLastAccessed>;
  ...
  /**
   * <p/> <p>A flag that indicates whether there are more items to return. If your results were truncated, you can make a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. Note that IAM might return fewer than the <code>MaxItems</code> number of results even when there are more results available. We recommend that you check <code>IsTruncated</code> after every call to ensure that you receive all your results.</p>
   */
  IsTruncated?: boolean;
