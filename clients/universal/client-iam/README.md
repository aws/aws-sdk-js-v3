...
```javascript
//javascript
const { IAMClient } = require("@aws-sdk/client-iam/IAMClient");
const {
  AddClientIDToOpenIDConnectProviderCommand
} = require("@aws-sdk/client-iam/commands/AddClientIDToOpenIDConnectProviderCommand");
```

```javascript
//typescript
const { IAMClient } = import '@aws-sdk/client-iam/IAMClient';
const { AddClientIDToOpenIDConnectProviderCommand } = import '@aws-sdk/client-iam/commands/AddClientIDToOpenIDConnectProviderCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-iam/IAM";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-iam' package is updated. To contribute to SDK you can checkout our [code generator package][].
