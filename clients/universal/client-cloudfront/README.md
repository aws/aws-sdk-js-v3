...
const {
  CloudFrontClient
} = require("@aws-sdk/client-cloudfront/CloudFrontClient");
const {
  CreateCloudFrontOriginAccessIdentity2019_03_26Command
} = require("@aws-sdk/client-cloudfront/commands/CreateCloudFrontOriginAccessIdentity2019_03_26Command");
```

```javascript
//typescript
const { CloudFrontClient } = import '@aws-sdk/client-cloudfront/CloudFrontClient';
const { CreateCloudFrontOriginAccessIdentity2019_03_26Command } = import '@aws-sdk/client-cloudfront/commands/CreateCloudFrontOriginAccessIdentity2019_03_26Command';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-cloudfront/CloudFront";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-cloudfront' package is updated. To contribute to SDK you can checkout our [code generator package][].
