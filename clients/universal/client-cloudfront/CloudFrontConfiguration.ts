...
export interface CloudFrontResolvableConfiguration
  extends CloudFrontConfiguration {
  /**
...
export interface CloudFrontResolvedConfiguration
  extends CloudFrontConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CloudFrontResolvableConfiguration,
        ...
        .then(
          endpoint =>
            new __aws_sdk_protocol_rest.RestSerializer<Uint8Array>(
              endpoint,
              new __aws_sdk_xml_body_builder.XmlBodyBuilder(
