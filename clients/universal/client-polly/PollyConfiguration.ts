...
export interface PollyResolvableConfiguration extends PollyConfiguration {
  /**
...
export interface PollyResolvedConfiguration
  extends PollyConfiguration,
