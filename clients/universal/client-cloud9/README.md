...
```javascript
//javascript
const { Cloud9Client } = require("@aws-sdk/client-cloud9/Cloud9Client");
const {
  CreateEnvironmentEC2Command
} = require("@aws-sdk/client-cloud9/commands/CreateEnvironmentEC2Command");
```

```javascript
//typescript
const { Cloud9Client } = import '@aws-sdk/client-cloud9/Cloud9Client';
const { CreateEnvironmentEC2Command } = import '@aws-sdk/client-cloud9/commands/CreateEnvironmentEC2Command';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-cloud9/Cloud9";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-cloud9' package is updated. To contribute to SDK you can checkout our [code generator package][].
