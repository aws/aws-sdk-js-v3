...
```javascript
//javascript
const { ChimeClient } = require("@aws-sdk/client-chime/ChimeClient");
const {
  AssociatePhoneNumberWithUserCommand
} = require("@aws-sdk/client-chime/commands/AssociatePhoneNumberWithUserCommand");
```

```javascript
//typescript
const { ChimeClient } = import '@aws-sdk/client-chime/ChimeClient';
const { AssociatePhoneNumberWithUserCommand } = import '@aws-sdk/client-chime/commands/AssociatePhoneNumberWithUserCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-chime/Chime";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-chime' package is updated. To contribute to SDK you can checkout our [code generator package][].
