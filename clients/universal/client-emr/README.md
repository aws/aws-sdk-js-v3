...
```javascript
//javascript
const { EMRClient } = require("@aws-sdk/client-emr/EMRClient");
const {
  AddInstanceFleetCommand
} = require("@aws-sdk/client-emr/commands/AddInstanceFleetCommand");
```

```javascript
//typescript
const { EMRClient } = import '@aws-sdk/client-emr/EMRClient';
const { AddInstanceFleetCommand } = import '@aws-sdk/client-emr/commands/AddInstanceFleetCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-emr/EMR";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-emr' package is updated. To contribute to SDK you can checkout our [code generator package][].
