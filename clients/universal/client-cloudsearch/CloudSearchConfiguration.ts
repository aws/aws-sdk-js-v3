...
export interface CloudSearchConfiguration {
  /**
...
export interface CloudSearchResolvableConfiguration
  extends CloudSearchConfiguration {
  /**
...
export interface CloudSearchResolvedConfiguration
  extends CloudSearchConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CloudSearchResolvableConfiguration,
