...
export class Firehose extends FirehoseClient {
   ...
   *   - {InvalidArgumentException} <p>The specified input parameter has a value that is not valid.</p>
   *   - {LimitExceededException} <p>You have already reached the limit for a requested resource.</p>
   *   - {ResourceInUseException} <p>The resource is already in use and not available for this operation.</p>
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public createDeliveryStream(
    args: CreateDeliveryStreamInput
  ): Promise<CreateDeliveryStreamOutput>;
  public createDeliveryStream(
    args: CreateDeliveryStreamInput,
    cb: (err: any, data?: CreateDeliveryStreamOutput) => void
  ): void;
  public createDeliveryStream(
    args: CreateDeliveryStreamInput,
    cb?: (err: any, data?: CreateDeliveryStreamOutput) => void
  ): Promise<CreateDeliveryStreamOutput> | void {
  ...
  public deleteDeliveryStream(
    args: DeleteDeliveryStreamInput
  ): Promise<DeleteDeliveryStreamOutput>;
  public deleteDeliveryStream(
    args: DeleteDeliveryStreamInput,
    cb: (err: any, data?: DeleteDeliveryStreamOutput) => void
  ): void;
  public deleteDeliveryStream(
    args: DeleteDeliveryStreamInput,
    cb?: (err: any, data?: DeleteDeliveryStreamOutput) => void
  ): Promise<DeleteDeliveryStreamOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeDeliveryStream(
    args: DescribeDeliveryStreamInput
  ): Promise<DescribeDeliveryStreamOutput>;
  public describeDeliveryStream(
    args: DescribeDeliveryStreamInput,
    cb: (err: any, data?: DescribeDeliveryStreamOutput) => void
  ): void;
  public describeDeliveryStream(
    args: DescribeDeliveryStreamInput,
    cb?: (err: any, data?: DescribeDeliveryStreamOutput) => void
  ): Promise<DescribeDeliveryStreamOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public listDeliveryStreams(
    args: ListDeliveryStreamsInput
  ): Promise<ListDeliveryStreamsOutput>;
  public listDeliveryStreams(
    args: ListDeliveryStreamsInput,
    cb: (err: any, data?: ListDeliveryStreamsOutput) => void
  ): void;
  public listDeliveryStreams(
    args: ListDeliveryStreamsInput,
    cb?: (err: any, data?: ListDeliveryStreamsOutput) => void
  ): Promise<ListDeliveryStreamsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public listTagsForDeliveryStream(
    args: ListTagsForDeliveryStreamInput
  ): Promise<ListTagsForDeliveryStreamOutput>;
  public listTagsForDeliveryStream(
    args: ListTagsForDeliveryStreamInput,
    cb: (err: any, data?: ListTagsForDeliveryStreamOutput) => void
  ): void;
  public listTagsForDeliveryStream(
    args: ListTagsForDeliveryStreamInput,
    cb?: (err: any, data?: ListTagsForDeliveryStreamOutput) => void
  ): Promise<ListTagsForDeliveryStreamOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *   - {ResourceNotFoundException} <p>The specified resource could not be found.</p>
   *   - {InvalidArgumentException} <p>The specified input parameter has a value that is not valid.</p>
   *   - {ServiceUnavailableException} <p>The service is unavailable. Back off and retry the operation. If you continue to see the exception, throughput limits for the delivery stream may have been exceeded. For more information about limits and how to request an increase, see <a href="http://docs.aws.amazon.com/firehose/latest/dev/limits.html">Amazon Kinesis Data Firehose Limits</a>.</p>
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  ...
  public putRecordBatch(
    args: PutRecordBatchInput
  ): Promise<PutRecordBatchOutput>;
  public putRecordBatch(
    args: PutRecordBatchInput,
    cb: (err: any, data?: PutRecordBatchOutput) => void
  ): void;
  public putRecordBatch(
    args: PutRecordBatchInput,
    cb?: (err: any, data?: PutRecordBatchOutput) => void
  ): Promise<PutRecordBatchOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public startDeliveryStreamEncryption(
    args: StartDeliveryStreamEncryptionInput
  ): Promise<StartDeliveryStreamEncryptionOutput>;
  public startDeliveryStreamEncryption(
    args: StartDeliveryStreamEncryptionInput,
    cb: (err: any, data?: StartDeliveryStreamEncryptionOutput) => void
  ): void;
  public startDeliveryStreamEncryption(
    args: StartDeliveryStreamEncryptionInput,
    cb?: (err: any, data?: StartDeliveryStreamEncryptionOutput) => void
  ): Promise<StartDeliveryStreamEncryptionOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public stopDeliveryStreamEncryption(
    args: StopDeliveryStreamEncryptionInput
  ): Promise<StopDeliveryStreamEncryptionOutput>;
  public stopDeliveryStreamEncryption(
    args: StopDeliveryStreamEncryptionInput,
    cb: (err: any, data?: StopDeliveryStreamEncryptionOutput) => void
  ): void;
  public stopDeliveryStreamEncryption(
    args: StopDeliveryStreamEncryptionInput,
    cb?: (err: any, data?: StopDeliveryStreamEncryptionOutput) => void
  ): Promise<StopDeliveryStreamEncryptionOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public tagDeliveryStream(
    args: TagDeliveryStreamInput
  ): Promise<TagDeliveryStreamOutput>;
  public tagDeliveryStream(
    args: TagDeliveryStreamInput,
    cb: (err: any, data?: TagDeliveryStreamOutput) => void
  ): void;
  public tagDeliveryStream(
    args: TagDeliveryStreamInput,
    cb?: (err: any, data?: TagDeliveryStreamOutput) => void
  ): Promise<TagDeliveryStreamOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public untagDeliveryStream(
    args: UntagDeliveryStreamInput
  ): Promise<UntagDeliveryStreamOutput>;
  public untagDeliveryStream(
    args: UntagDeliveryStreamInput,
    cb: (err: any, data?: UntagDeliveryStreamOutput) => void
  ): void;
  public untagDeliveryStream(
    args: UntagDeliveryStreamInput,
    cb?: (err: any, data?: UntagDeliveryStreamOutput) => void
  ): Promise<UntagDeliveryStreamOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *   - {ResourceInUseException} <p>The resource is already in use and not available for this operation.</p>
   *   - {ResourceNotFoundException} <p>The specified resource could not be found.</p>
   *   - {ConcurrentModificationException} <p>Another modification has already happened. Fetch <code>VersionId</code> again and use it to update the destination.</p>
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  ...
  public updateDestination(
    args: UpdateDestinationInput,
    cb: (err: any, data?: UpdateDestinationOutput) => void
  ): void;
  public updateDestination(
    args: UpdateDestinationInput,
    cb?: (err: any, data?: UpdateDestinationOutput) => void
  ): Promise<UpdateDestinationOutput> | void {
    // create the appropriate command and pass it to .send
