...
```javascript
//javascript
const { GlacierClient } = require("@aws-sdk/client-glacier/GlacierClient");
const {
  UploadArchiveCommand
} = require("@aws-sdk/client-glacier/commands/UploadArchiveCommand");
```

```javascript
//typescript
const { GlacierClient } = import '@aws-sdk/client-glacier/GlacierClient';
const { UploadArchiveCommand } = import '@aws-sdk/client-glacier/commands/UploadArchiveCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-glacier/Glacier";
...
For operations containing stream response like `GetJobOutput()`, you can get response stream by accessing to streaming member..(`data` is the resolved response object)
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-glacier' package is updated. To contribute to SDK you can checkout our [code generator package][].
