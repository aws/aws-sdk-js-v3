...
import * as __aws_sdk_add_glacier_checksum_headers_universal from "@aws-sdk/add-glacier-checksum-headers-universal";
...
export class GlacierClient
  ...
  constructor(configuration: GlacierConfiguration) {
    ...
    this.middlewareStack.add(
      __aws_sdk_add_glacier_checksum_headers_universal.addChecksumHeaders(
        this.config.sha256,
