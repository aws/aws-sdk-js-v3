import {
  ...
  _UnmarshalledInventoryRetrievalJobDescription
} from "./_InventoryRetrievalJobDescription";
import {
  _SelectParameters,
...
export interface _GlacierJobDescription {
   ...
   */
  InventoryRetrievalParameters?: _InventoryRetrievalJobDescription;
...
export interface _UnmarshalledGlacierJobDescription
  extends _GlacierJobDescription {
  /**
   * <p>Parameters used for range inventory retrieval.</p>
   */
