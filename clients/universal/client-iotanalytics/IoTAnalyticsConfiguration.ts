...
export interface IoTAnalyticsConfiguration {
  /**
...
export interface IoTAnalyticsResolvableConfiguration
  extends IoTAnalyticsConfiguration {
  /**
...
export interface IoTAnalyticsResolvedConfiguration
  extends IoTAnalyticsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  IoTAnalyticsResolvableConfiguration,
