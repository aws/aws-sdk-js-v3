...
export interface CloudDirectoryConfiguration {
  /**
...
export interface CloudDirectoryResolvableConfiguration
  extends CloudDirectoryConfiguration {
  /**
...
export interface CloudDirectoryResolvedConfiguration
  extends CloudDirectoryConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CloudDirectoryResolvableConfiguration,
...
> = {
  ...
  serializer: {
    defaultProvider: (configuration: {
      ...
      const promisified = configuration
        ...
        .then(
          endpoint =>
            new __aws_sdk_protocol_rest.RestSerializer<Uint8Array>(
              endpoint,
  ...
  parser: {
    defaultProvider: (configuration: {
      ...
      new __aws_sdk_protocol_rest.RestParser<Uint8Array>(
