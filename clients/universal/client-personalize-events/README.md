...
} = require("@aws-sdk/client-personalize-events/PersonalizeEventsClient");
const {
  PutEventsCommand
} = require("@aws-sdk/client-personalize-events/commands/PutEventsCommand");
```

```javascript
//typescript
const { PersonalizeEventsClient } = import '@aws-sdk/client-personalize-events/PersonalizeEventsClient';
const { PutEventsCommand } = import '@aws-sdk/client-personalize-events/commands/PutEventsCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-personalize-events/PersonalizeEvents";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-personalize-events' package is updated. To contribute to SDK you can checkout our [code generator package][].
