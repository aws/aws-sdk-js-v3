...
export interface ElasticsearchServiceConfiguration {
  /**
...
export interface ElasticsearchServiceResolvableConfiguration
  extends ElasticsearchServiceConfiguration {
  /**
...
export interface ElasticsearchServiceResolvedConfiguration
  extends ElasticsearchServiceConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ElasticsearchServiceResolvableConfiguration,
