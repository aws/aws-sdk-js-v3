...
```javascript
//javascript
const { RDSDataClient } = require("@aws-sdk/client-rds-data/RDSDataClient");
const {
...
```javascript
//typescript
const { RDSDataClient } = import '@aws-sdk/client-rds-data/RDSDataClient';
const { BatchExecuteStatementCommand } = import '@aws-sdk/client-rds-data/commands/BatchExecuteStatementCommand';
```
