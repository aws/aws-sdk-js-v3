...
```javascript
//javascript
const { PricingClient } = require("@aws-sdk/client-pricing/PricingClient");
const {
  DescribeServicesCommand
} = require("@aws-sdk/client-pricing/commands/DescribeServicesCommand");
```

```javascript
//typescript
const { PricingClient } = import '@aws-sdk/client-pricing/PricingClient';
const { DescribeServicesCommand } = import '@aws-sdk/client-pricing/commands/DescribeServicesCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-pricing/Pricing";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-pricing' package is updated. To contribute to SDK you can checkout our [code generator package][].
