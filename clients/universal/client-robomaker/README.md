...
const {
  RoboMakerClient
} = require("@aws-sdk/client-robomaker/RoboMakerClient");
const {
  BatchDescribeSimulationJobCommand
} = require("@aws-sdk/client-robomaker/commands/BatchDescribeSimulationJobCommand");
```

```javascript
//typescript
const { RoboMakerClient } = import '@aws-sdk/client-robomaker/RoboMakerClient';
const { BatchDescribeSimulationJobCommand } = import '@aws-sdk/client-robomaker/commands/BatchDescribeSimulationJobCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-robomaker/RoboMaker";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-robomaker' package is updated. To contribute to SDK you can checkout our [code generator package][].
