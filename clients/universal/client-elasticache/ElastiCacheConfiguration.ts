...
export interface ElastiCacheConfiguration {
  /**
...
export interface ElastiCacheResolvableConfiguration
  extends ElastiCacheConfiguration {
  /**
...
export interface ElastiCacheResolvedConfiguration
  extends ElastiCacheConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ElastiCacheResolvableConfiguration,
