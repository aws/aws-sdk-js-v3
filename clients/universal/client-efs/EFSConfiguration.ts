...
export interface EFSResolvableConfiguration extends EFSConfiguration {
  /**
...
export interface EFSResolvedConfiguration
  extends EFSConfiguration,
...
> = {
  ...
  signingName: {
    defaultValue: "elasticfilesystem"
  },
  signer: {
    defaultProvider: (configuration: {
      credentials: __aws_sdk_types.Provider<__aws_sdk_types.Credentials>;
