...
export interface CostExplorerConfiguration {
  /**
...
export interface CostExplorerResolvableConfiguration
  extends CostExplorerConfiguration {
  /**
...
export interface CostExplorerResolvedConfiguration
  extends CostExplorerConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CostExplorerResolvableConfiguration,
