...
export interface TranslateResolvableConfiguration
  extends TranslateConfiguration {
  /**
...
export interface TranslateResolvedConfiguration
  extends TranslateConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  TranslateResolvableConfiguration,
