...
export interface DocDBConfiguration {
  /**
...
export interface DocDBResolvableConfiguration extends DocDBConfiguration {
  /**
...
export interface DocDBResolvedConfiguration
  extends DocDBConfiguration,
