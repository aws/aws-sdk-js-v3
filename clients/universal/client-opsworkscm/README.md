...
const {
  OpsWorksCMClient
} = require("@aws-sdk/client-opsworkscm/OpsWorksCMClient");
const {
  AssociateNodeCommand
} = require("@aws-sdk/client-opsworkscm/commands/AssociateNodeCommand");
```

```javascript
//typescript
const { OpsWorksCMClient } = import '@aws-sdk/client-opsworkscm/OpsWorksCMClient';
const { AssociateNodeCommand } = import '@aws-sdk/client-opsworkscm/commands/AssociateNodeCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-opsworkscm/OpsWorksCM";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-opsworkscm' package is updated. To contribute to SDK you can checkout our [code generator package][].
