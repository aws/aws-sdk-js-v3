...
export interface CloudSearchDomainConfiguration {
  /**
...
export interface CloudSearchDomainResolvableConfiguration
  extends CloudSearchDomainConfiguration {
  /**
...
export interface CloudSearchDomainResolvedConfiguration
  extends CloudSearchDomainConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CloudSearchDomainResolvableConfiguration,
