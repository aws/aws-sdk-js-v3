...
export interface MarketplaceEntitlementServiceConfiguration {
  /**
...
export interface MarketplaceEntitlementServiceResolvableConfiguration
  extends MarketplaceEntitlementServiceConfiguration {
  /**
...
export interface MarketplaceEntitlementServiceResolvedConfiguration
  extends MarketplaceEntitlementServiceConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  MarketplaceEntitlementServiceResolvableConfiguration,
