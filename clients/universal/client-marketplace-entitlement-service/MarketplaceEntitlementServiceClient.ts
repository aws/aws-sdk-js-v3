...
import {
  MarketplaceEntitlementServiceConfiguration,
  MarketplaceEntitlementServiceResolvedConfiguration,
  configurationProperties
} from "./MarketplaceEntitlementServiceConfiguration";
...
export class MarketplaceEntitlementServiceClient
  ...
  readonly config: MarketplaceEntitlementServiceResolvedConfiguration;
  ...
  constructor(configuration: MarketplaceEntitlementServiceConfiguration) {
