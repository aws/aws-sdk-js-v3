...
const {
  CognitoSyncClient
} = require("@aws-sdk/client-cognito-sync/CognitoSyncClient");
const {
  BulkPublishCommand
} = require("@aws-sdk/client-cognito-sync/commands/BulkPublishCommand");
```

```javascript
//typescript
const { CognitoSyncClient } = import '@aws-sdk/client-cognito-sync/CognitoSyncClient';
const { BulkPublishCommand } = import '@aws-sdk/client-cognito-sync/commands/BulkPublishCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-cognito-sync/CognitoSync";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-cognito-sync' package is updated. To contribute to SDK you can checkout our [code generator package][].
