...
export interface CognitoSyncConfiguration {
  /**
...
export interface CognitoSyncResolvableConfiguration
  extends CognitoSyncConfiguration {
  /**
...
export interface CognitoSyncResolvedConfiguration
  extends CognitoSyncConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CognitoSyncResolvableConfiguration,
