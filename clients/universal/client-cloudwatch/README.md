...
const {
  CloudWatchClient
} = require("@aws-sdk/client-cloudwatch/CloudWatchClient");
const {
  DeleteAlarmsCommand
} = require("@aws-sdk/client-cloudwatch/commands/DeleteAlarmsCommand");
```

```javascript
//typescript
const { CloudWatchClient } = import '@aws-sdk/client-cloudwatch/CloudWatchClient';
const { DeleteAlarmsCommand } = import '@aws-sdk/client-cloudwatch/commands/DeleteAlarmsCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-cloudwatch/CloudWatch";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-cloudwatch' package is updated. To contribute to SDK you can checkout our [code generator package][].
