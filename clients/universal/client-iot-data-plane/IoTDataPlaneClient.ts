...
import {
  IoTDataPlaneConfiguration,
  IoTDataPlaneResolvedConfiguration,
  configurationProperties
} from "./IoTDataPlaneConfiguration";
...
export class IoTDataPlaneClient
  ...
  readonly config: IoTDataPlaneResolvedConfiguration;
  ...
  constructor(configuration: IoTDataPlaneConfiguration) {
