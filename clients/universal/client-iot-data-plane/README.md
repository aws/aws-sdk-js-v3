...
const {
  IoTDataPlaneClient
} = require("@aws-sdk/client-iot-data-plane/IoTDataPlaneClient");
const {
  DeleteThingShadowCommand
} = require("@aws-sdk/client-iot-data-plane/commands/DeleteThingShadowCommand");
```

```javascript
//typescript
const { IoTDataPlaneClient } = import '@aws-sdk/client-iot-data-plane/IoTDataPlaneClient';
const { DeleteThingShadowCommand } = import '@aws-sdk/client-iot-data-plane/commands/DeleteThingShadowCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-iot-data-plane/IoTDataPlane";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-iot-data-plane' package is updated. To contribute to SDK you can checkout our [code generator package][].
