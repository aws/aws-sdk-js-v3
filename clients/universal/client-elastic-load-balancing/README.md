...
} = require("@aws-sdk/client-elastic-load-balancing/ElasticLoadBalancingClient");
const {
  AddTagsCommand
} = require("@aws-sdk/client-elastic-load-balancing/commands/AddTagsCommand");
```

```javascript
//typescript
const { ElasticLoadBalancingClient } = import '@aws-sdk/client-elastic-load-balancing/ElasticLoadBalancingClient';
const { AddTagsCommand } = import '@aws-sdk/client-elastic-load-balancing/commands/AddTagsCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-elastic-load-balancing/ElasticLoadBalancing";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-elastic-load-balancing' package is updated. To contribute to SDK you can checkout our [code generator package][].
