...
export interface ElasticLoadBalancingConfiguration {
  /**
...
export interface ElasticLoadBalancingResolvableConfiguration
  extends ElasticLoadBalancingConfiguration {
  /**
...
export interface ElasticLoadBalancingResolvedConfiguration
  extends ElasticLoadBalancingConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ElasticLoadBalancingResolvableConfiguration,
