...
const {
  InspectorClient
} = require("@aws-sdk/client-inspector/InspectorClient");
const {
  AddAttributesToFindingsCommand
} = require("@aws-sdk/client-inspector/commands/AddAttributesToFindingsCommand");
```

```javascript
//typescript
const { InspectorClient } = import '@aws-sdk/client-inspector/InspectorClient';
const { AddAttributesToFindingsCommand } = import '@aws-sdk/client-inspector/commands/AddAttributesToFindingsCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-inspector/Inspector";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-inspector' package is updated. To contribute to SDK you can checkout our [code generator package][].
