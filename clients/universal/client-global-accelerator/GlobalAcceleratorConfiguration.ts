...
export interface GlobalAcceleratorConfiguration {
  /**
...
export interface GlobalAcceleratorResolvableConfiguration
  extends GlobalAcceleratorConfiguration {
  /**
...
export interface GlobalAcceleratorResolvedConfiguration
  extends GlobalAcceleratorConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  GlobalAcceleratorResolvableConfiguration,
...
> = {
  ...
  signingName: {
    defaultValue: "globalaccelerator"
  },
  signer: {
    defaultProvider: (configuration: {
      credentials: __aws_sdk_types.Provider<__aws_sdk_types.Credentials>;
