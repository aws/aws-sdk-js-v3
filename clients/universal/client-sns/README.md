...
} = require("@aws-sdk/client-sns/commands/AddPermissionCommand");
```

```javascript
//typescript
const { SNSClient } = import '@aws-sdk/client-sns/SNSClient';
const { AddPermissionCommand } = import '@aws-sdk/client-sns/commands/AddPermissionCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-sns/SNS";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-sns' package is updated. To contribute to SDK you can checkout our [code generator package][].
