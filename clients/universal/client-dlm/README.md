...
```javascript
//javascript
const { DLMClient } = require("@aws-sdk/client-dlm/DLMClient");
const {
  CreateLifecyclePolicyCommand
} = require("@aws-sdk/client-dlm/commands/CreateLifecyclePolicyCommand");
```

```javascript
//typescript
const { DLMClient } = import '@aws-sdk/client-dlm/DLMClient';
const { CreateLifecyclePolicyCommand } = import '@aws-sdk/client-dlm/commands/CreateLifecyclePolicyCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-dlm/DLM";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-dlm' package is updated. To contribute to SDK you can checkout our [code generator package][].
