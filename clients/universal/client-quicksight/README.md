...
const {
  QuickSightClient
} = require("@aws-sdk/client-quicksight/QuickSightClient");
const {
  CreateGroupCommand
} = require("@aws-sdk/client-quicksight/commands/CreateGroupCommand");
```

```javascript
//typescript
const { QuickSightClient } = import '@aws-sdk/client-quicksight/QuickSightClient';
const { CreateGroupCommand } = import '@aws-sdk/client-quicksight/commands/CreateGroupCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-quicksight/QuickSight";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-quicksight' package is updated. To contribute to SDK you can checkout our [code generator package][].
