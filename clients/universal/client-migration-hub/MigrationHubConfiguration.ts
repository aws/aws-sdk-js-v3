...
export interface MigrationHubConfiguration {
  /**
...
export interface MigrationHubResolvableConfiguration
  extends MigrationHubConfiguration {
  /**
...
export interface MigrationHubResolvedConfiguration
  extends MigrationHubConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  MigrationHubResolvableConfiguration,
