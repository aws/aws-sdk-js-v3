...
} = require("@aws-sdk/client-storage-gateway/StorageGatewayClient");
const {
  ActivateGatewayCommand
} = require("@aws-sdk/client-storage-gateway/commands/ActivateGatewayCommand");
```

```javascript
//typescript
const { StorageGatewayClient } = import '@aws-sdk/client-storage-gateway/StorageGatewayClient';
const { ActivateGatewayCommand } = import '@aws-sdk/client-storage-gateway/commands/ActivateGatewayCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-storage-gateway/StorageGateway";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-storage-gateway' package is updated. To contribute to SDK you can checkout our [code generator package][].
