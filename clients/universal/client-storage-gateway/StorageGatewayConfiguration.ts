...
export interface StorageGatewayConfiguration {
  /**
...
export interface StorageGatewayResolvableConfiguration
  extends StorageGatewayConfiguration {
  /**
...
export interface StorageGatewayResolvedConfiguration
  extends StorageGatewayConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  StorageGatewayResolvableConfiguration,
