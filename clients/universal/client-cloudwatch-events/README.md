...
} = require("@aws-sdk/client-cloudwatch-events/CloudWatchEventsClient");
const {
  ActivateEventSourceCommand
} = require("@aws-sdk/client-cloudwatch-events/commands/ActivateEventSourceCommand");
```

```javascript
//typescript
const { CloudWatchEventsClient } = import '@aws-sdk/client-cloudwatch-events/CloudWatchEventsClient';
const { ActivateEventSourceCommand } = import '@aws-sdk/client-cloudwatch-events/commands/ActivateEventSourceCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-cloudwatch-events/CloudWatchEvents";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-cloudwatch-events' package is updated. To contribute to SDK you can checkout our [code generator package][].
