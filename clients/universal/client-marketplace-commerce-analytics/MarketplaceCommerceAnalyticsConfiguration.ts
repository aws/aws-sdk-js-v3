...
export interface MarketplaceCommerceAnalyticsConfiguration {
  /**
...
export interface MarketplaceCommerceAnalyticsResolvableConfiguration
  extends MarketplaceCommerceAnalyticsConfiguration {
  /**
...
export interface MarketplaceCommerceAnalyticsResolvedConfiguration
  extends MarketplaceCommerceAnalyticsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  MarketplaceCommerceAnalyticsResolvableConfiguration,
...
> = {
  ...
  signingName: {
    defaultValue: "marketplacecommerceanalytics"
  },
  signer: {
    defaultProvider: (configuration: {
      credentials: __aws_sdk_types.Provider<__aws_sdk_types.Credentials>;
