...
import {
  ResourceGroupsConfiguration,
  ResourceGroupsResolvedConfiguration,
  configurationProperties
} from "./ResourceGroupsConfiguration";
...
export class ResourceGroupsClient
  ...
  readonly config: ResourceGroupsResolvedConfiguration;
  ...
  constructor(configuration: ResourceGroupsConfiguration) {
