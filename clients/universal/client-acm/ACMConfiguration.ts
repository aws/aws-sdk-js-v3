...
export interface ACMConfiguration {
  /**
...
export interface ACMResolvableConfiguration extends ACMConfiguration {
  /**
...
export interface ACMResolvedConfiguration
  extends ACMConfiguration,
