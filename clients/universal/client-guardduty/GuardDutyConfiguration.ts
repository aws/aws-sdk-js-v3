...
export interface GuardDutyResolvableConfiguration
  extends GuardDutyConfiguration {
  /**
...
export interface GuardDutyResolvedConfiguration
  extends GuardDutyConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  GuardDutyResolvableConfiguration,
