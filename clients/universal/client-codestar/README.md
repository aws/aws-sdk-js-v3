...
```javascript
//javascript
const { CodeStarClient } = require("@aws-sdk/client-codestar/CodeStarClient");
const {
  AssociateTeamMemberCommand
} = require("@aws-sdk/client-codestar/commands/AssociateTeamMemberCommand");
```

```javascript
//typescript
const { CodeStarClient } = import '@aws-sdk/client-codestar/CodeStarClient';
const { AssociateTeamMemberCommand } = import '@aws-sdk/client-codestar/commands/AssociateTeamMemberCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-codestar/CodeStar";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-codestar' package is updated. To contribute to SDK you can checkout our [code generator package][].
