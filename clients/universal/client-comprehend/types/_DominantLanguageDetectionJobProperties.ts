 ...
 */
export interface _DominantLanguageDetectionJobProperties {
  /**
...
export interface _UnmarshalledDominantLanguageDetectionJobProperties
  extends _DominantLanguageDetectionJobProperties {
  /**
   * <p>The time that the dominant language detection job was submitted for processing.</p>
   */
  SubmitTime?: Date;
