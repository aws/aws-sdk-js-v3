...
} = require("@aws-sdk/client-comprehendmedical/ComprehendMedicalClient");
const {
  DetectEntitiesCommand
} = require("@aws-sdk/client-comprehendmedical/commands/DetectEntitiesCommand");
```

```javascript
//typescript
const { ComprehendMedicalClient } = import '@aws-sdk/client-comprehendmedical/ComprehendMedicalClient';
const { DetectEntitiesCommand } = import '@aws-sdk/client-comprehendmedical/commands/DetectEntitiesCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-comprehendmedical/ComprehendMedical";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-comprehendmedical' package is updated. To contribute to SDK you can checkout our [code generator package][].
