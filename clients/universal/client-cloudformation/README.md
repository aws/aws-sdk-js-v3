...
[![NPM version](https://img.shields.io/npm/v/@aws-sdk/client-cloudformation/preview.svg)](https://www.npmjs.com/package/@aws-sdk/client-cloudformation)
...
} = require("@aws-sdk/client-cloudformation/CloudFormationClient");
const {
  CancelUpdateStackCommand
} = require("@aws-sdk/client-cloudformation/commands/CancelUpdateStackCommand");
```

```javascript
//typescript
const { CloudFormationClient } = import '@aws-sdk/client-cloudformation/CloudFormationClient';
const { CancelUpdateStackCommand } = import '@aws-sdk/client-cloudformation/commands/CancelUpdateStackCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-cloudformation/CloudFormation";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-cloudformation' package is updated. To contribute to SDK you can checkout our [code generator package][].
