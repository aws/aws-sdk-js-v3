...
const {
  CodeDeployClient
} = require("@aws-sdk/client-codedeploy/CodeDeployClient");
const {
  AddTagsToOnPremisesInstancesCommand
} = require("@aws-sdk/client-codedeploy/commands/AddTagsToOnPremisesInstancesCommand");
```

```javascript
//typescript
const { CodeDeployClient } = import '@aws-sdk/client-codedeploy/CodeDeployClient';
const { AddTagsToOnPremisesInstancesCommand } = import '@aws-sdk/client-codedeploy/commands/AddTagsToOnPremisesInstancesCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-codedeploy/CodeDeploy";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-codedeploy' package is updated. To contribute to SDK you can checkout our [code generator package][].
