...
import { UpdateWebAppCustomization$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateWebAppCustomizationCommand extends command<UpdateWebAppCustomizationCommandInput, UpdateWebAppCustomizationCommandOutput>(
  _ep0,
  _mw0,
