...
var CustomHttpHeaderValueType: StaticSimpleSchema = [0, n0, _CHHVT, 8, 0];
var HostKey: StaticSimpleSchema = [0, n0, _HK, 8, 0];
var MessageSubject: StaticSimpleSchema = [0, n0, _MS, 8, 0];
...
export var As2ConnectorConfig$: StaticStructureSchema = [3, n0, _ACC,
  0,
...
export var CustomHttpHeader$: StaticStructureSchema = [3, n0, _CHH,
  8,
  [_K, _V],
...
export var ExecutionStepResult$: StaticStructureSchema = [3, n0, _ESR,
  0,
  [_ST, _O, _Er],
  [0, 0, () => ExecutionError$]
];
...
export var ListedCertificate$: StaticStructureSchema = [3, n0, _LCi,
  0,
  [_Ar, _CIer, _Us, _S, _AD, _ID, _Ty, _D],
  [0, 0, 0, 0, 4, 4, 0, 0]
];
export var ListedConnector$: StaticStructureSchema = [3, n0, _LCis,
  0,
  [_Ar, _CI, _U],
  [0, 0, 0]
];
export var ListedExecution$: StaticStructureSchema = [3, n0, _LE,
  0,
  [_EIx, _IFL, _SM, _S],
...
export var S3InputFileLocation$: StaticStructureSchema = [3, n0, _SIFL,
  0,
  [_B, _K],
  [0, 0]
];
export var S3StorageOptions$: StaticStructureSchema = [3, n0, _SSO,
  0,
  [_DLO],
  [0]
];
...
export var WorkflowStep$: StaticStructureSchema = [3, n0, _WS,
  0,
...
var ConnectorFileTransferResults: StaticListSchema = [1, n0, _CFTRo,
  0, () => ConnectorFileTransferResult$
];
var CustomHttpHeaders: StaticListSchema = [1, n0, _CHHu,
  0, [() => CustomHttpHeader$,
    0]
];
var ExecutionStepResults: StaticListSchema = [1, n0, _ESRx,
  0, () => ExecutionStepResult$
];
var FilePaths = 64 | 0;
var HomeDirectoryMappings: StaticListSchema = [1, n0, _HDM,
  0, () => HomeDirectoryMapEntry$
];
var ListedAccesses: StaticListSchema = [1, n0, _LAis,
  0, () => ListedAccess$
];
var ListedAgreements: StaticListSchema = [1, n0, _LAist,
  0, () => ListedAgreement$
];
var ListedCertificates: StaticListSchema = [1, n0, _LCist,
  0, () => ListedCertificate$
];
var ListedConnectors: StaticListSchema = [1, n0, _LCiste,
  0, () => ListedConnector$
];
var ListedExecutions: StaticListSchema = [1, n0, _LEi,
  0, () => ListedExecution$
];
var ListedHostKeys: StaticListSchema = [1, n0, _LHKi,
  0, () => ListedHostKey$
];
var ListedProfiles: StaticListSchema = [1, n0, _LPi,
  0, () => ListedProfile$
];
var ListedServers: StaticListSchema = [1, n0, _LSi,
  0, () => ListedServer$
];
var ListedUsers: StaticListSchema = [1, n0, _LUi,
  0, () => ListedUser$
];
var ListedWebApps: StaticListSchema = [1, n0, _LWAi,
  0, () => ListedWebApp$
];
var ListedWorkflows: StaticListSchema = [1, n0, _LWi,
  0, () => ListedWorkflow$
];
var OnPartialUploadWorkflowDetails: StaticListSchema = [1, n0, _OPUWD,
  0, () => WorkflowDetail$
];
var OnUploadWorkflowDetails: StaticListSchema = [1, n0, _OUWD,
  0, () => WorkflowDetail$
];
var Protocols = 64 | 0;
var S3Tags: StaticListSchema = [1, n0, _STag,
  0, () => S3Tag$
];
...
var WorkflowSteps: StaticListSchema = [1, n0, _WSo,
  0, () => WorkflowStep$
];
export var ConnectorEgressConfig$: StaticUnionSchema = [4, n0, _CEC,
  0,
  [_VL],
  [() => ConnectorVpcLatticeEgressConfig$]
];
export var DescribedConnectorEgressConfig$: StaticUnionSchema = [4, n0, _DCEC,
  0,
  [_VL],
  [() => DescribedConnectorVpcLatticeEgressConfig$]
];
export var DescribedWebAppEndpointDetails$: StaticUnionSchema = [4, n0, _DWAED,
  0,
  [_Vp],
  [() => DescribedWebAppVpcConfig$]
];
export var DescribedWebAppIdentityProviderDetails$: StaticUnionSchema = [4, n0, _DWAIPD,
  0,
  [_ICC],
  [() => DescribedIdentityCenterConfig$]
];
export var UpdateConnectorEgressConfig$: StaticUnionSchema = [4, n0, _UCEC,
  0,
  [_VL],
  [() => UpdateConnectorVpcLatticeEgressConfig$]
];
export var UpdateWebAppEndpointDetails$: StaticUnionSchema = [4, n0, _UWAED,
  0,
  [_Vp],
  [() => UpdateWebAppVpcConfig$]
];
export var UpdateWebAppIdentityProviderDetails$: StaticUnionSchema = [4, n0, _UWAIPD,
  0,
  [_ICC],
  [() => UpdateWebAppIdentityCenterConfig$]
];
export var WebAppEndpointDetails$: StaticUnionSchema = [4, n0, _WAED,
  0,
  [_Vp],
  [() => WebAppVpcConfig$]
];
export var WebAppIdentityProviderDetails$: StaticUnionSchema = [4, n0, _WAIPD,
  0,
  [_ICC],
  [() => IdentityCenterConfig$]
];
export var WebAppUnits$: StaticUnionSchema = [4, n0, _WAU,
  0,
  [_Prov],
  [1]
];
export var CreateAccess$: StaticOperationSchema = [9, n0, _CA,
  0, () => CreateAccessRequest$, () => CreateAccessResponse$
];
export var CreateAgreement$: StaticOperationSchema = [9, n0, _CAr,
...
export var CreateServer$: StaticOperationSchema = [9, n0, _CS,
...
export var CreateWebApp$: StaticOperationSchema = [9, n0, _CWA,
...
export var DeleteAccess$: StaticOperationSchema = [9, n0, _DAel,
  0, () => DeleteAccessRequest$, () => __Unit
];
export var DeleteAgreement$: StaticOperationSchema = [9, n0, _DAele,
  2, () => DeleteAgreementRequest$, () => __Unit
];
export var DeleteCertificate$: StaticOperationSchema = [9, n0, _DCel,
  2, () => DeleteCertificateRequest$, () => __Unit
];
export var DeleteConnector$: StaticOperationSchema = [9, n0, _DCele,
  2, () => DeleteConnectorRequest$, () => __Unit
];
export var DeleteHostKey$: StaticOperationSchema = [9, n0, _DHKe,
  0, () => DeleteHostKeyRequest$, () => __Unit
];
export var DeleteProfile$: StaticOperationSchema = [9, n0, _DPel,
  2, () => DeleteProfileRequest$, () => __Unit
];
export var DeleteServer$: StaticOperationSchema = [9, n0, _DSe,
  2, () => DeleteServerRequest$, () => __Unit
];
export var DeleteSshPublicKey$: StaticOperationSchema = [9, n0, _DSPK,
  0, () => DeleteSshPublicKeyRequest$, () => __Unit
];
export var DeleteUser$: StaticOperationSchema = [9, n0, _DUe,
  2, () => DeleteUserRequest$, () => __Unit
];
export var DeleteWebApp$: StaticOperationSchema = [9, n0, _DWAe,
  { [_h]: ["POST", "/deleteWebApp", 200] }, () => DeleteWebAppRequest$, () => __Unit
];
export var DeleteWebAppCustomization$: StaticOperationSchema = [9, n0, _DWACe,
  { [_h]: ["POST", "/deleteWebAppCustomization", 200] }, () => DeleteWebAppCustomizationRequest$, () => __Unit
];
export var DeleteWorkflow$: StaticOperationSchema = [9, n0, _DWe,
  2, () => DeleteWorkflowRequest$, () => __Unit
];
export var DescribeAccess$: StaticOperationSchema = [9, n0, _DAes,
  0, () => DescribeAccessRequest$, () => DescribeAccessResponse$
];
export var DescribeAgreement$: StaticOperationSchema = [9, n0, _DAesc,
...
export var DescribeConnector$: StaticOperationSchema = [9, n0, _DCesc,
  0, () => DescribeConnectorRequest$, () => DescribeConnectorResponse$
];
export var DescribeExecution$: StaticOperationSchema = [9, n0, _DEe,
  0, () => DescribeExecutionRequest$, () => DescribeExecutionResponse$
];
export var DescribeHostKey$: StaticOperationSchema = [9, n0, _DHKes,
  0, () => DescribeHostKeyRequest$, () => DescribeHostKeyResponse$
];
export var DescribeProfile$: StaticOperationSchema = [9, n0, _DPes,
  0, () => DescribeProfileRequest$, () => DescribeProfileResponse$
];
export var DescribeSecurityPolicy$: StaticOperationSchema = [9, n0, _DSPe,
  0, () => DescribeSecurityPolicyRequest$, () => DescribeSecurityPolicyResponse$
];
export var DescribeServer$: StaticOperationSchema = [9, n0, _DSes,
...
export var DescribeWebApp$: StaticOperationSchema = [9, n0, _DWAes,
  { [_h]: ["POST", "/describeWebApp", 200] }, () => DescribeWebAppRequest$, () => DescribeWebAppResponse$
];
export var DescribeWebAppCustomization$: StaticOperationSchema = [9, n0, _DWACes,
  { [_h]: ["POST", "/describeWebAppCustomization", 200] }, () => DescribeWebAppCustomizationRequest$, () => DescribeWebAppCustomizationResponse$
];
export var DescribeWorkflow$: StaticOperationSchema = [9, n0, _DWes,
...
export var ImportHostKey$: StaticOperationSchema = [9, n0, _IHK,
  0, () => ImportHostKeyRequest$, () => ImportHostKeyResponse$
];
export var ImportSshPublicKey$: StaticOperationSchema = [9, n0, _ISPK,
  0, () => ImportSshPublicKeyRequest$, () => ImportSshPublicKeyResponse$
];
export var ListAccesses$: StaticOperationSchema = [9, n0, _LAistc,
  0, () => ListAccessesRequest$, () => ListAccessesResponse$
];
export var ListAgreements$: StaticOperationSchema = [9, n0, _LAistg,
  0, () => ListAgreementsRequest$, () => ListAgreementsResponse$
];
export var ListCertificates$: StaticOperationSchema = [9, n0, _LCister,
  0, () => ListCertificatesRequest$, () => ListCertificatesResponse$
];
export var ListConnectors$: StaticOperationSchema = [9, n0, _LCisto,
  0, () => ListConnectorsRequest$, () => ListConnectorsResponse$
];
export var ListExecutions$: StaticOperationSchema = [9, n0, _LEis,
  0, () => ListExecutionsRequest$, () => ListExecutionsResponse$
];
export var ListFileTransferResults$: StaticOperationSchema = [9, n0, _LFTR,
  { [_h]: ["POST", "/listFileTransferResults", 200] }, () => ListFileTransferResultsRequest$, () => ListFileTransferResultsResponse$
];
export var ListHostKeys$: StaticOperationSchema = [9, n0, _LHKis,
  0, () => ListHostKeysRequest$, () => ListHostKeysResponse$
];
export var ListProfiles$: StaticOperationSchema = [9, n0, _LPis,
  0, () => ListProfilesRequest$, () => ListProfilesResponse$
];
export var ListSecurityPolicies$: StaticOperationSchema = [9, n0, _LSP,
  0, () => ListSecurityPoliciesRequest$, () => ListSecurityPoliciesResponse$
];
export var ListServers$: StaticOperationSchema = [9, n0, _LSis,
  0, () => ListServersRequest$, () => ListServersResponse$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceRequest$, () => ListTagsForResourceResponse$
];
export var ListUsers$: StaticOperationSchema = [9, n0, _LUis,
  0, () => ListUsersRequest$, () => ListUsersResponse$
];
export var ListWebApps$: StaticOperationSchema = [9, n0, _LWAis,
  { [_h]: ["POST", "/listWebApps", 200] }, () => ListWebAppsRequest$, () => ListWebAppsResponse$
];
export var ListWorkflows$: StaticOperationSchema = [9, n0, _LWis,
  0, () => ListWorkflowsRequest$, () => ListWorkflowsResponse$
];
export var SendWorkflowStepState$: StaticOperationSchema = [9, n0, _SWSS,
  0, () => SendWorkflowStepStateRequest$, () => SendWorkflowStepStateResponse$
];
export var StartDirectoryListing$: StaticOperationSchema = [9, n0, _SDL,
  0, () => StartDirectoryListingRequest$, () => StartDirectoryListingResponse$
];
export var StartFileTransfer$: StaticOperationSchema = [9, n0, _SFT,
  0, () => StartFileTransferRequest$, () => StartFileTransferResponse$
];
export var StartRemoteDelete$: StaticOperationSchema = [9, n0, _SRD,
  { [_h]: ["POST", "/startRemoteDelete", 200] }, () => StartRemoteDeleteRequest$, () => StartRemoteDeleteResponse$
];
export var StartRemoteMove$: StaticOperationSchema = [9, n0, _SRM,
  { [_h]: ["POST", "/startRemoteMove", 200] }, () => StartRemoteMoveRequest$, () => StartRemoteMoveResponse$
];
export var StartServer$: StaticOperationSchema = [9, n0, _SS,
  0, () => StartServerRequest$, () => __Unit
];
export var StopServer$: StaticOperationSchema = [9, n0, _SSt,
...
export var TestIdentityProvider$: StaticOperationSchema = [9, n0, _TIP,
...
export var UpdateAccess$: StaticOperationSchema = [9, n0, _UA,
  0, () => UpdateAccessRequest$, () => UpdateAccessResponse$
];
export var UpdateAgreement$: StaticOperationSchema = [9, n0, _UAp,
  0, () => UpdateAgreementRequest$, () => UpdateAgreementResponse$
];
export var UpdateCertificate$: StaticOperationSchema = [9, n0, _UCp,
  0, () => UpdateCertificateRequest$, () => UpdateCertificateResponse$
];
export var UpdateConnector$: StaticOperationSchema = [9, n0, _UCpd,
  0, () => UpdateConnectorRequest$, () => UpdateConnectorResponse$
];
export var UpdateHostKey$: StaticOperationSchema = [9, n0, _UHK,
  0, () => UpdateHostKeyRequest$, () => UpdateHostKeyResponse$
];
export var UpdateProfile$: StaticOperationSchema = [9, n0, _UPp,
  0, () => UpdateProfileRequest$, () => UpdateProfileResponse$
];
export var UpdateServer$: StaticOperationSchema = [9, n0, _US,
...
export var UpdateWebApp$: StaticOperationSchema = [9, n0, _UWA,
  { [_h]: ["POST", "/updateWebApp", 200] }, () => UpdateWebAppRequest$, () => UpdateWebAppResponse$
];
export var UpdateWebAppCustomization$: StaticOperationSchema = [9, n0, _UWAC,
