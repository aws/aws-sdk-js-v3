...
export interface CreateServerRequest {
  ...
  /**
   *
   *          <p>The virtual private cloud (VPC) endpoint settings that you want to configure for your SFTP server.
   *       This parameter is required when you specify a value for the <code>EndpointType</code> parameter.</p>
   *
   */
  ...
  /**
   *
   *          <p>The type of VPC endpoint that you want your SFTP server to connect to. If you connect to a
   *       VPC endpoint, your SFTP server isn't accessible over the public internet.</p>
   *
   */
...
/**
 *
 *          <p>The configuration settings for the virtual private cloud (VPC) endpoint for your SFTP
 *       server.</p>
 *
 */
...
export interface UpdateServerRequest {
  ...
  /**
   *
   *          <p>The virtual private cloud (VPC) endpoint settings that are configured for your SFTP
   *       server. With a VPC endpoint, your SFTP server isn't accessible over the public
   *       internet.</p>
   *
   */
  EndpointDetails?: EndpointDetails;
