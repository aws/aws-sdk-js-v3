 ...
 * @public
 */
export class ListDeploymentPatternVersionsCommand extends command<ListDeploymentPatternVersionsCommandInput, ListDeploymentPatternVersionsCommandOutput>(
  _ep0,
  _mw0,
