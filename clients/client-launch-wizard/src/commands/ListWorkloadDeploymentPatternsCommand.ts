 ...
 * @public
 */
export class ListWorkloadDeploymentPatternsCommand extends command<ListWorkloadDeploymentPatternsCommandInput, ListWorkloadDeploymentPatternsCommandOutput>(
  _ep0,
  _mw0,
