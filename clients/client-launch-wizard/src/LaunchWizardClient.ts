...
import {
  defaultLaunchWizardHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type LaunchWizardClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type LaunchWizardClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<LaunchWizardClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultLaunchWizardHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: LaunchWizardClientResolvedConfig) =>
