...
import type { ListEngineVersionsRequest, ListEngineVersionsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListEngineVersionsCommand extends command<ListEngineVersionsCommandInput, ListEngineVersionsCommandOutput>(
  _ep0,
  _mw0,
  "ListEngineVersions",
  ListEngineVersions$
