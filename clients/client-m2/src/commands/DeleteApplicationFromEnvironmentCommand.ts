 ...
 * @public
 */
export class DeleteApplicationFromEnvironmentCommand extends command<DeleteApplicationFromEnvironmentCommandInput, DeleteApplicationFromEnvironmentCommandOutput>(
  _ep0,
  _mw0,
