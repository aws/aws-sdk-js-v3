...
const AWS_TEMPLATE = "workspaces.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "workspaces.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "workspaces.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "workspaces.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "workspaces.{region}.amazonaws.com";
...
export const defaultRegionInfoProvider: RegionInfoProvider = (region: string, options?: any) => {
  ...
  switch (region) {
    ...
    case "ap-south-1":
      regionInfo = {
        hostname: "workspaces.ap-south-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "ap-southeast-1":
