...
import { type WorkSpacesClientResolvedConfig, WorkSpacesClientConfig } from "../WorkSpacesClient";
 ...
 * @internal
 */
export const defaultWorkSpacesHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: WorkSpacesHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<WorkSpacesClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultWorkSpacesHttpAuthSchemeProvider: WorkSpacesHttpAuthSchemeProvider = (authParameters) => {
