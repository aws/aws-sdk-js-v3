...
export var AccountModification$: StaticStructureSchema = [3, n0, _AM,
  0,
...
export var AssociationStateReason$: StaticStructureSchema = [3, n0, _ASRs,
  0,
  [_EC, _EM],
  [0, 0]
];
...
export var BundleResourceAssociation$: StaticStructureSchema = [3, n0, _BRA,
  0,
...
export var ConnectionAlias$: StaticStructureSchema = [3, n0, _CA,
  0,
  [_CSo, _AIl, _S, _OAI, _As],
  [0, 0, 0, 0, () => ConnectionAliasAssociationList]
];
export var ConnectionAliasAssociation$: StaticStructureSchema = [3, n0, _CAAo,
  0,
  [_AS, _AAI, _RI, _CI],
  [0, 0, 0, 0]
];
...
export var CustomWorkspaceImageImportErrorDetails$: StaticStructureSchema = [3, n0, _CWIIED,
  0,
  [_EC, _EM],
  [0, 0]
];
export var DataReplicationSettings$: StaticStructureSchema = [3, n0, _DRS,
  0,
  [_DR, _RST],
  [0, 4]
];
export var DefaultClientBrandingAttributes$: StaticStructureSchema = [3, n0, _DCBA,
  0,
  [_LU, _SE, _SL, _FPL, _LM],
  [0, 0, 0, 0, 128 | 0]
];
export var DefaultImportClientBrandingAttributes$: StaticStructureSchema = [3, n0, _DICBA,
  0,
  [_L, _SE, _SL, _FPL, _LM],
  [21, 0, 0, 0, 128 | 0]
];
export var DefaultWorkspaceCreationProperties$: StaticStructureSchema = [3, n0, _DWCP,
  0,
...
export var DeleteWorkspaceBundleRequest$: StaticStructureSchema = [3, n0, _DWBR,
  0,
  [_BI],
  [0]
];
export var DeleteWorkspaceBundleResult$: StaticStructureSchema = [3, n0, _DWBRe,
  0,
  [],
  []
];
...
export var DescribeAccountModificationsRequest$: StaticStructureSchema = [3, n0, _DAMR,
  0,
  [_NT],
  [0]
];
export var DescribeAccountModificationsResult$: StaticStructureSchema = [3, n0, _DAMRe,
  0,
  [_AMc, _NT],
...
export var DescribeAccountResult$: StaticStructureSchema = [3, n0, _DARe,
  0,
...
export var DescribeConnectionAliasesRequest$: StaticStructureSchema = [3, n0, _DCARes,
  0,
  [_AIli, _RI, _Li, _NT],
  [64 | 0, 0, 1, 0]
];
export var DescribeConnectionAliasesResult$: StaticStructureSchema = [3, n0, _DCAResc,
  0,
  [_CAo, _NT],
...
export var DescribeIpGroupsRequest$: StaticStructureSchema = [3, n0, _DIGRes,
  0,
  [_GI, _NT, _MR],
  [64 | 0, 0, 1]
];
export var DescribeIpGroupsResult$: StaticStructureSchema = [3, n0, _DIGResc,
  0,
  [_R, _NT],
...
export var DescribeWorkspaceBundlesRequest$: StaticStructureSchema = [3, n0, _DWBRes,
  0,
  [_BIu, _O, _NT],
  [64 | 0, 0, 0]
];
export var DescribeWorkspaceBundlesResult$: StaticStructureSchema = [3, n0, _DWBResc,
  0,
  [_B, _NT],
  [() => BundleList, 0]
];
...
export var DescribeWorkspaceDirectoriesResult$: StaticStructureSchema = [3, n0, _DWDResc,
  0,
  [_Di, _NT],
  [() => DirectoryList, 0]
];
...
export var DescribeWorkspaceImagesRequest$: StaticStructureSchema = [3, n0, _DWIRes,
  0,
  [_IIm, _IT, _NT, _MR],
  [64 | 0, 0, 0, 1]
];
export var DescribeWorkspaceImagesResult$: StaticStructureSchema = [3, n0, _DWIResc,
  0,
  [_I, _NT],
  [() => WorkspaceImageList, 0]
];
export var DescribeWorkspacesConnectionStatusRequest$: StaticStructureSchema = [3, n0, _DWCSR,
  0,
  [_WIo, _NT],
  [64 | 0, 0]
];
export var DescribeWorkspacesConnectionStatusResult$: StaticStructureSchema = [3, n0, _DWCSRe,
  0,
  [_WCS, _NT],
...
export var DescribeWorkspacesPoolsResult$: StaticStructureSchema = [3, n0, _DWPRe,
  0,
  [_WPo, _NT],
  [() => WorkspacesPools, 0]
];
export var DescribeWorkspacesRequest$: StaticStructureSchema = [3, n0, _DWR,
  0,
  [_WIo, _DI, _UN, _BI, _Li, _NT, _WN],
  [64 | 0, 0, 0, 0, 1, 0, 0]
];
export var DescribeWorkspacesResult$: StaticStructureSchema = [3, n0, _DWRe,
  0,
  [_W, _NT],
  [() => WorkspaceList, 0]
];
...
export var FailedCreateStandbyWorkspacesRequest$: StaticStructureSchema = [3, n0, _FCSWR,
  0,
  [_SWR, _EC, _EM],
  [() => StandbyWorkspace$, 0, 0]
];
export var FailedCreateWorkspaceRequest$: StaticStructureSchema = [3, n0, _FCWR,
  0,
  [_WR, _EC, _EM],
  [() => WorkspaceRequest$, 0, 0]
];
export var FailedWorkspaceChangeRequest$: StaticStructureSchema = [3, n0, _FWCR,
  0,
  [_WI, _EC, _EM],
  [0, 0, 0]
];
export var GetAccountLinkRequest$: StaticStructureSchema = [3, n0, _GALR,
  0,
  [_LI, _LAI],
  [0, 0]
];
export var GetAccountLinkResult$: StaticStructureSchema = [3, n0, _GALRe,
  0,
  [_AL],
  [() => AccountLink$]
];
...
export var ImagePermission$: StaticStructureSchema = [3, n0, _IPm,
  0,
  [_SAIh],
  [0]
];
export var ImageResourceAssociation$: StaticStructureSchema = [3, n0, _IRA,
  0,
...
export var IosImportClientBrandingAttributes$: StaticStructureSchema = [3, n0, _IICBA,
  0,
  [_L, _Lo, _Log, _SE, _SL, _FPL, _LM],
  [21, 21, 21, 0, 0, 0, 128 | 0]
];
export var IpRuleItem$: StaticStructureSchema = [3, n0, _IRI,
  0,
  [_iR, _rD],
  [0, 0]
];
export var ListAccountLinksRequest$: StaticStructureSchema = [3, n0, _LALR,
  0,
  [_LSF, _NT, _MR],
  [64 | 0, 0, 1]
];
export var ListAccountLinksResult$: StaticStructureSchema = [3, n0, _LALRi,
  0,
  [_ALc, _NT],
  [() => AccountLinkList, 0]
];
...
export var MicrosoftEntraConfig$: StaticStructureSchema = [3, n0, _MEC,
  0,
  [_TI, _ACSA],
  [0, 0]
];
...
export var ModificationState$: StaticStructureSchema = [3, n0, _MS,
  0,
  [_Re, _S],
  [0, 0]
];
export var ModifyAccountRequest$: StaticStructureSchema = [3, n0, _MAR,
  0,
  [_DTS, _DTMCR],
  [0, 0]
];
export var ModifyAccountResult$: StaticStructureSchema = [3, n0, _MARo,
  0,
  [_M],
  [0]
];
...
export var OperatingSystem$: StaticStructureSchema = [3, n0, _OS,
  0,
  [_Ty],
  [0]
];
...
export var RegisterWorkspaceDirectoryRequest$: StaticStructureSchema = [3, n0, _RWDR,
  0,
...
export var RegisterWorkspaceDirectoryResult$: StaticStructureSchema = [3, n0, _RWDRe,
  0,
  [_DI, _S],
  [0, 0]
];
...
export var RelatedWorkspaceProperties$: StaticStructureSchema = [3, n0, _RWP,
  0,
  [_WI, _Reg, _S, _Ty],
  [0, 0, 0, 0]
];
...
export var SelfservicePermissions$: StaticStructureSchema = [3, n0, _SPe,
  0,
...
export var StartRequest$: StaticStructureSchema = [3, n0, _SRt,
  0,
  [_WI],
  [0]
];
...
export var StopRequest$: StaticStructureSchema = [3, n0, _SRto,
  0,
  [_WI],
  [0]
];
...
export var TimeoutSettings$: StaticStructureSchema = [3, n0, _TS,
  0,
  [_DTIS, _IDTIS, _MUDIS],
  [1, 1, 1]
];
...
export var UpdateResult$: StaticStructureSchema = [3, n0, _URp,
  0,
  [_UA, _D],
  [2, 0]
];
...
export var UpdateWorkspaceBundleRequest$: StaticStructureSchema = [3, n0, _UWBR,
  0,
  [_BI, _II],
  [0, 0]
];
export var UpdateWorkspaceBundleResult$: StaticStructureSchema = [3, n0, _UWBRp,
  0,
  [],
  []
];
...
export var WorkspaceAccessProperties$: StaticStructureSchema = [3, n0, _WAP,
  0,
  [_DTW, _DTO, _DTWe, _DTI, _DTA, _DTCO, _DTZC, _DTL, _DTWSTC, _AEC],
  [0, 0, 0, 0, 0, 0, 0, 0, 0, () => AccessEndpointConfig$]
];
export var WorkSpaceApplication$: StaticStructureSchema = [3, n0, _WSA,
  0,
  [_AI, _C, _D, _LT, _N, _O, _S, _SCTN, _SOSN],
  [0, 4, 0, 0, 0, 0, 0, 64 | 0, 64 | 0]
];
export var WorkSpaceApplicationDeployment$: StaticStructureSchema = [3, n0, _WSAD,
  0,
  [_As],
  [() => WorkspaceResourceAssociationList]
];
export var WorkspaceBundle$: StaticStructureSchema = [3, n0, _WB,
  0,
  [_BI, _N, _O, _D, _II, _RS, _US, _CTo, _LUT, _CTr, _S, _BT],
  [0, 0, 0, 0, 0, () => RootStorage$, () => UserStorage$, () => ComputeType$, 4, 4, 0, 0]
];
export var WorkspaceConnectionStatus$: StaticStructureSchema = [3, n0, _WCSo,
  0,
  [_WI, _CSon, _CSCT, _LKUCT],
  [0, 0, 4, 4]
];
export var WorkspaceCreationProperties$: StaticStructureSchema = [3, n0, _WCP,
  0,
  [_EIA, _DO, _CSGI, _UEALA, _EMM, _IIRA],
  [2, 0, 0, 2, 2, 0]
];
export var WorkspaceDirectory$: StaticStructureSchema = [3, n0, _WD,
  0,
...
export var WorkspaceImage$: StaticStructureSchema = [3, n0, _WIor,
  0,
...
var AccountLinkList: StaticListSchema = [1, n0, _ALL,
  0, () => AccountLink$
];
var AccountModificationList: StaticListSchema = [1, n0, _AML,
  0, () => AccountModification$
];
var ApplicationAssociatedResourceTypeList = 64 | 0;
var ApplicationList = 64 | 0;
var ApplicationResourceAssociationList: StaticListSchema = [1, n0, _ARAL,
  0, () => ApplicationResourceAssociation$
];
var BundleAssociatedResourceTypeList = 64 | 0;
var BundleIdList = 64 | 0;
var BundleList: StaticListSchema = [1, n0, _BL,
  0, () => WorkspaceBundle$
];
var BundleResourceAssociationList: StaticListSchema = [1, n0, _BRAL,
  0, () => BundleResourceAssociation$
];
var ClientDeviceTypeList = 64 | 0;
var ClientPropertiesList: StaticListSchema = [1, n0, _CPL,
  0, () => ClientPropertiesResult$
];
var ComputeList = 64 | 0;
var ConnectClientAddInList: StaticListSchema = [1, n0, _CCAIL,
  0, () => ConnectClientAddIn$
];
var ConnectionAliasAssociationList: StaticListSchema = [1, n0, _CAAL,
  0, () => ConnectionAliasAssociation$
];
var ConnectionAliasIdList = 64 | 0;
var ConnectionAliasList: StaticListSchema = [1, n0, _CAL,
  0, () => ConnectionAlias$
];
var ConnectionAliasPermissions: StaticListSchema = [1, n0, _CAPo,
  0, () => ConnectionAliasPermission$
];
var CustomWorkspaceImageImportErrorDetailsList: StaticListSchema = [1, n0, _CWIIEDL,
...
var DescribeWorkspaceDirectoriesFilterList: StaticListSchema = [1, n0, _DWDFL,
  0, () => DescribeWorkspaceDirectoriesFilter$
];
var DescribeWorkspaceDirectoriesFilterValues = 64 | 0;
var DescribeWorkspacesPoolsFilters: StaticListSchema = [1, n0, _DWPFe,
...
var FailedCreateStandbyWorkspacesRequestList: StaticListSchema = [1, n0, _FCSWRL,
  0, () => FailedCreateStandbyWorkspacesRequest$
];
var FailedCreateWorkspaceRequests: StaticListSchema = [1, n0, _FCWRa,
  0, () => FailedCreateWorkspaceRequest$
];
var FailedRebootWorkspaceRequests: StaticListSchema = [1, n0, _FRWR,
  0, () => FailedWorkspaceChangeRequest$
];
var FailedRebuildWorkspaceRequests: StaticListSchema = [1, n0, _FRWRa,
  0, () => FailedWorkspaceChangeRequest$
];
var FailedStartWorkspaceRequests: StaticListSchema = [1, n0, _FSWR,
  0, () => FailedWorkspaceChangeRequest$
];
var FailedStopWorkspaceRequests: StaticListSchema = [1, n0, _FSWRa,
  0, () => FailedWorkspaceChangeRequest$
];
var FailedTerminateWorkspaceRequests: StaticListSchema = [1, n0, _FTWR,
  0, () => FailedWorkspaceChangeRequest$
];
var ImageAssociatedResourceTypeList = 64 | 0;
var ImagePermissions: StaticListSchema = [1, n0, _IP,
  0, () => ImagePermission$
];
var ImageResourceAssociationList: StaticListSchema = [1, n0, _IRAL,
...
var ModificationStateList: StaticListSchema = [1, n0, _MSL,
  0, () => ModificationState$
];
var OperatingSystemNameList = 64 | 0;
var PendingCreateStandbyWorkspacesRequestList: StaticListSchema = [1, n0, _PCSWRL,
  0, () => PendingCreateStandbyWorkspacesRequest$
];
var ProtocolList = 64 | 0;
var RebootWorkspaceRequests: StaticListSchema = [1, n0, _RWRe,
  0, () => RebootRequest$
];
var RebuildWorkspaceRequests: StaticListSchema = [1, n0, _RWRebui,
  0, () => RebuildRequest$
];
var RelatedWorkspaces: StaticListSchema = [1, n0, _RWel,
...
var StandbyWorkspacesList: StaticListSchema = [1, n0, _SWL,
  0, () => StandbyWorkspace$
];
var StandbyWorkspacesPropertiesList: StaticListSchema = [1, n0, _SWPL,
  0, () => StandbyWorkspacesProperties$
];
var StartWorkspaceRequests: StaticListSchema = [1, n0, _SWRta,
  0, () => StartRequest$
];
var StopWorkspaceRequests: StaticListSchema = [1, n0, _SWRtop,
  0, () => StopRequest$
];
var StorageConnectors: StaticListSchema = [1, n0, _SCt,
  0, () => StorageConnector$
];
var SubnetIds = 64 | 0;
var TagKeyList = 64 | 0;
...
var TerminateWorkspaceRequests: StaticListSchema = [1, n0, _TWRe,
  0, () => TerminateRequest$
];
var UserSettings: StaticListSchema = [1, n0, _USs,
  0, () => UserSetting$
];
var WorkSpaceApplicationIdList = 64 | 0;
var WorkSpaceApplicationList: StaticListSchema = [1, n0, _WSAL,
  0, () => WorkSpaceApplication$
];
var WorkSpaceAssociatedResourceTypeList = 64 | 0;
var WorkspaceConnectionStatusList: StaticListSchema = [1, n0, _WCSL,
  0, () => WorkspaceConnectionStatus$
];
var WorkspaceDirectoryNameList = 64 | 0;
var WorkspaceIdList = 64 | 0;
var WorkspaceImageIdList = 64 | 0;
var WorkspaceImageList: StaticListSchema = [1, n0, _WIL,
  0, () => WorkspaceImage$
];
var WorkspaceList: StaticListSchema = [1, n0, _WL,
  0, () => Workspace$
];
var WorkspaceRequestList: StaticListSchema = [1, n0, _WRL,
  0, () => WorkspaceRequest$
];
var WorkspaceResourceAssociationList: StaticListSchema = [1, n0, _WRAL,
  0, () => WorkspaceResourceAssociation$
];
var WorkspacesIpGroupsList: StaticListSchema = [1, n0, _WIGL,
  0, () => WorkspacesIpGroup$
];
var WorkspacesPoolErrors: StaticListSchema = [1, n0, _WPEo,
  0, () => WorkspacesPoolError$
];
var WorkspacesPoolIds = 64 | 0;
var WorkspacesPools: StaticListSchema = [1, n0, _WPo,
  0, () => WorkspacesPool$
];
var WorkspacesPoolSessions: StaticListSchema = [1, n0, _WPSo,
  0, () => WorkspacesPoolSession$
];
var LoginMessage = 128 | 0;
export var ImageSourceIdentifier$: StaticUnionSchema = [4, n0, _ISI,
  0,
  [_EITI, _IBVA, _EII],
  [0, 0, 0]
];
export var AcceptAccountLinkInvitation$: StaticOperationSchema = [9, n0, _AALI,
  0, () => AcceptAccountLinkInvitationRequest$, () => AcceptAccountLinkInvitationResult$
];
export var AssociateConnectionAlias$: StaticOperationSchema = [9, n0, _ACA,
  0, () => AssociateConnectionAliasRequest$, () => AssociateConnectionAliasResult$
];
export var AssociateIpGroups$: StaticOperationSchema = [9, n0, _AIG,
  0, () => AssociateIpGroupsRequest$, () => AssociateIpGroupsResult$
];
export var AssociateWorkspaceApplication$: StaticOperationSchema = [9, n0, _AWA,
  0, () => AssociateWorkspaceApplicationRequest$, () => AssociateWorkspaceApplicationResult$
];
export var AuthorizeIpRules$: StaticOperationSchema = [9, n0, _AIR,
  0, () => AuthorizeIpRulesRequest$, () => AuthorizeIpRulesResult$
];
export var CopyWorkspaceImage$: StaticOperationSchema = [9, n0, _CWI,
  0, () => CopyWorkspaceImageRequest$, () => CopyWorkspaceImageResult$
];
export var CreateAccountLinkInvitation$: StaticOperationSchema = [9, n0, _CALI,
  0, () => CreateAccountLinkInvitationRequest$, () => CreateAccountLinkInvitationResult$
];
export var CreateConnectClientAddIn$: StaticOperationSchema = [9, n0, _CCCAI,
  0, () => CreateConnectClientAddInRequest$, () => CreateConnectClientAddInResult$
];
export var CreateConnectionAlias$: StaticOperationSchema = [9, n0, _CCA,
  0, () => CreateConnectionAliasRequest$, () => CreateConnectionAliasResult$
];
export var CreateIpGroup$: StaticOperationSchema = [9, n0, _CIG,
  0, () => CreateIpGroupRequest$, () => CreateIpGroupResult$
];
export var CreateStandbyWorkspaces$: StaticOperationSchema = [9, n0, _CSW,
...
export var CreateUpdatedWorkspaceImage$: StaticOperationSchema = [9, n0, _CUWI,
  0, () => CreateUpdatedWorkspaceImageRequest$, () => CreateUpdatedWorkspaceImageResult$
];
export var CreateWorkspaceBundle$: StaticOperationSchema = [9, n0, _CWB,
  0, () => CreateWorkspaceBundleRequest$, () => CreateWorkspaceBundleResult$
];
export var CreateWorkspaceImage$: StaticOperationSchema = [9, n0, _CWIr,
  0, () => CreateWorkspaceImageRequest$, () => CreateWorkspaceImageResult$
];
export var CreateWorkspaces$: StaticOperationSchema = [9, n0, _CW,
  0, () => CreateWorkspacesRequest$, () => CreateWorkspacesResult$
];
export var CreateWorkspacesPool$: StaticOperationSchema = [9, n0, _CWP,
  0, () => CreateWorkspacesPoolRequest$, () => CreateWorkspacesPoolResult$
];
export var DeleteAccountLinkInvitation$: StaticOperationSchema = [9, n0, _DALI,
  0, () => DeleteAccountLinkInvitationRequest$, () => DeleteAccountLinkInvitationResult$
];
export var DeleteClientBranding$: StaticOperationSchema = [9, n0, _DCB,
  0, () => DeleteClientBrandingRequest$, () => DeleteClientBrandingResult$
];
export var DeleteConnectClientAddIn$: StaticOperationSchema = [9, n0, _DCCAI,
  0, () => DeleteConnectClientAddInRequest$, () => DeleteConnectClientAddInResult$
];
export var DeleteConnectionAlias$: StaticOperationSchema = [9, n0, _DCA,
  0, () => DeleteConnectionAliasRequest$, () => DeleteConnectionAliasResult$
];
export var DeleteIpGroup$: StaticOperationSchema = [9, n0, _DIG,
...
export var DeleteWorkspaceBundle$: StaticOperationSchema = [9, n0, _DWB,
  0, () => DeleteWorkspaceBundleRequest$, () => DeleteWorkspaceBundleResult$
];
export var DeleteWorkspaceImage$: StaticOperationSchema = [9, n0, _DWI,
  0, () => DeleteWorkspaceImageRequest$, () => DeleteWorkspaceImageResult$
];
export var DeployWorkspaceApplications$: StaticOperationSchema = [9, n0, _DWA,
  0, () => DeployWorkspaceApplicationsRequest$, () => DeployWorkspaceApplicationsResult$
];
export var DeregisterWorkspaceDirectory$: StaticOperationSchema = [9, n0, _DWD,
  0, () => DeregisterWorkspaceDirectoryRequest$, () => DeregisterWorkspaceDirectoryResult$
];
export var DescribeAccount$: StaticOperationSchema = [9, n0, _DA,
  0, () => DescribeAccountRequest$, () => DescribeAccountResult$
];
export var DescribeAccountModifications$: StaticOperationSchema = [9, n0, _DAM,
  0, () => DescribeAccountModificationsRequest$, () => DescribeAccountModificationsResult$
];
export var DescribeApplicationAssociations$: StaticOperationSchema = [9, n0, _DAA,
...
export var DescribeBundleAssociations$: StaticOperationSchema = [9, n0, _DBA,
  0, () => DescribeBundleAssociationsRequest$, () => DescribeBundleAssociationsResult$
];
export var DescribeClientBranding$: StaticOperationSchema = [9, n0, _DCBe,
  0, () => DescribeClientBrandingRequest$, () => DescribeClientBrandingResult$
];
export var DescribeClientProperties$: StaticOperationSchema = [9, n0, _DCP,
  0, () => DescribeClientPropertiesRequest$, () => DescribeClientPropertiesResult$
];
export var DescribeConnectClientAddIns$: StaticOperationSchema = [9, n0, _DCCAIe,
  0, () => DescribeConnectClientAddInsRequest$, () => DescribeConnectClientAddInsResult$
];
export var DescribeConnectionAliases$: StaticOperationSchema = [9, n0, _DCAe,
  0, () => DescribeConnectionAliasesRequest$, () => DescribeConnectionAliasesResult$
];
export var DescribeConnectionAliasPermissions$: StaticOperationSchema = [9, n0, _DCAP,
  0, () => DescribeConnectionAliasPermissionsRequest$, () => DescribeConnectionAliasPermissionsResult$
];
export var DescribeCustomWorkspaceImageImport$: StaticOperationSchema = [9, n0, _DCWII,
  0, () => DescribeCustomWorkspaceImageImportRequest$, () => DescribeCustomWorkspaceImageImportResult$
];
export var DescribeImageAssociations$: StaticOperationSchema = [9, n0, _DIAe,
  0, () => DescribeImageAssociationsRequest$, () => DescribeImageAssociationsResult$
];
export var DescribeIpGroups$: StaticOperationSchema = [9, n0, _DIGe,
...
export var DescribeWorkspaceAssociations$: StaticOperationSchema = [9, n0, _DWAe,
  0, () => DescribeWorkspaceAssociationsRequest$, () => DescribeWorkspaceAssociationsResult$
];
export var DescribeWorkspaceBundles$: StaticOperationSchema = [9, n0, _DWBe,
  0, () => DescribeWorkspaceBundlesRequest$, () => DescribeWorkspaceBundlesResult$
];
export var DescribeWorkspaceDirectories$: StaticOperationSchema = [9, n0, _DWDe,
  0, () => DescribeWorkspaceDirectoriesRequest$, () => DescribeWorkspaceDirectoriesResult$
];
export var DescribeWorkspaceImagePermissions$: StaticOperationSchema = [9, n0, _DWIP,
  0, () => DescribeWorkspaceImagePermissionsRequest$, () => DescribeWorkspaceImagePermissionsResult$
];
export var DescribeWorkspaceImages$: StaticOperationSchema = [9, n0, _DWIe,
  0, () => DescribeWorkspaceImagesRequest$, () => DescribeWorkspaceImagesResult$
];
export var DescribeWorkspaces$: StaticOperationSchema = [9, n0, _DW,
  0, () => DescribeWorkspacesRequest$, () => DescribeWorkspacesResult$
];
export var DescribeWorkspacesConnectionStatus$: StaticOperationSchema = [9, n0, _DWCS,
  0, () => DescribeWorkspacesConnectionStatusRequest$, () => DescribeWorkspacesConnectionStatusResult$
];
export var DescribeWorkspaceSnapshots$: StaticOperationSchema = [9, n0, _DWS,
  0, () => DescribeWorkspaceSnapshotsRequest$, () => DescribeWorkspaceSnapshotsResult$
];
export var DescribeWorkspacesPools$: StaticOperationSchema = [9, n0, _DWP,
  0, () => DescribeWorkspacesPoolsRequest$, () => DescribeWorkspacesPoolsResult$
];
export var DescribeWorkspacesPoolSessions$: StaticOperationSchema = [9, n0, _DWPS,
  0, () => DescribeWorkspacesPoolSessionsRequest$, () => DescribeWorkspacesPoolSessionsResult$
];
export var DisassociateConnectionAlias$: StaticOperationSchema = [9, n0, _DCAi,
  0, () => DisassociateConnectionAliasRequest$, () => DisassociateConnectionAliasResult$
];
export var DisassociateIpGroups$: StaticOperationSchema = [9, n0, _DIGi,
  0, () => DisassociateIpGroupsRequest$, () => DisassociateIpGroupsResult$
];
export var DisassociateWorkspaceApplication$: StaticOperationSchema = [9, n0, _DWAi,
  0, () => DisassociateWorkspaceApplicationRequest$, () => DisassociateWorkspaceApplicationResult$
];
export var GetAccountLink$: StaticOperationSchema = [9, n0, _GAL,
  0, () => GetAccountLinkRequest$, () => GetAccountLinkResult$
];
export var ImportClientBranding$: StaticOperationSchema = [9, n0, _ICB,
  0, () => ImportClientBrandingRequest$, () => ImportClientBrandingResult$
];
export var ImportCustomWorkspaceImage$: StaticOperationSchema = [9, n0, _ICWI,
  0, () => ImportCustomWorkspaceImageRequest$, () => ImportCustomWorkspaceImageResult$
];
export var ImportWorkspaceImage$: StaticOperationSchema = [9, n0, _IWI,
  0, () => ImportWorkspaceImageRequest$, () => ImportWorkspaceImageResult$
];
export var ListAccountLinks$: StaticOperationSchema = [9, n0, _LAL,
  0, () => ListAccountLinksRequest$, () => ListAccountLinksResult$
];
export var ListAvailableManagementCidrRanges$: StaticOperationSchema = [9, n0, _LAMCR,
  0, () => ListAvailableManagementCidrRangesRequest$, () => ListAvailableManagementCidrRangesResult$
];
export var MigrateWorkspace$: StaticOperationSchema = [9, n0, _MW,
  0, () => MigrateWorkspaceRequest$, () => MigrateWorkspaceResult$
];
export var ModifyAccount$: StaticOperationSchema = [9, n0, _MA,
  0, () => ModifyAccountRequest$, () => ModifyAccountResult$
];
export var ModifyCertificateBasedAuthProperties$: StaticOperationSchema = [9, n0, _MCBAP,
  0, () => ModifyCertificateBasedAuthPropertiesRequest$, () => ModifyCertificateBasedAuthPropertiesResult$
];
export var ModifyClientProperties$: StaticOperationSchema = [9, n0, _MCP,
  0, () => ModifyClientPropertiesRequest$, () => ModifyClientPropertiesResult$
];
export var ModifyEndpointEncryptionMode$: StaticOperationSchema = [9, n0, _MEEM,
  0, () => ModifyEndpointEncryptionModeRequest$, () => ModifyEndpointEncryptionModeResponse$
];
export var ModifySamlProperties$: StaticOperationSchema = [9, n0, _MSP,
  0, () => ModifySamlPropertiesRequest$, () => ModifySamlPropertiesResult$
];
export var ModifySelfservicePermissions$: StaticOperationSchema = [9, n0, _MSPo,
  0, () => ModifySelfservicePermissionsRequest$, () => ModifySelfservicePermissionsResult$
];
export var ModifyStreamingProperties$: StaticOperationSchema = [9, n0, _MSPod,
  0, () => ModifyStreamingPropertiesRequest$, () => ModifyStreamingPropertiesResult$
];
export var ModifyWorkspaceAccessProperties$: StaticOperationSchema = [9, n0, _MWAP,
  0, () => ModifyWorkspaceAccessPropertiesRequest$, () => ModifyWorkspaceAccessPropertiesResult$
];
export var ModifyWorkspaceCreationProperties$: StaticOperationSchema = [9, n0, _MWCP,
  0, () => ModifyWorkspaceCreationPropertiesRequest$, () => ModifyWorkspaceCreationPropertiesResult$
];
export var ModifyWorkspaceProperties$: StaticOperationSchema = [9, n0, _MWP,
  0, () => ModifyWorkspacePropertiesRequest$, () => ModifyWorkspacePropertiesResult$
];
export var ModifyWorkspaceState$: StaticOperationSchema = [9, n0, _MWS,
  0, () => ModifyWorkspaceStateRequest$, () => ModifyWorkspaceStateResult$
];
export var RebootWorkspaces$: StaticOperationSchema = [9, n0, _RWeb,
  0, () => RebootWorkspacesRequest$, () => RebootWorkspacesResult$
];
export var RebuildWorkspaces$: StaticOperationSchema = [9, n0, _RWebu,
  0, () => RebuildWorkspacesRequest$, () => RebuildWorkspacesResult$
];
export var RegisterWorkspaceDirectory$: StaticOperationSchema = [9, n0, _RWD,
  0, () => RegisterWorkspaceDirectoryRequest$, () => RegisterWorkspaceDirectoryResult$
];
export var RejectAccountLinkInvitation$: StaticOperationSchema = [9, n0, _RALI,
  0, () => RejectAccountLinkInvitationRequest$, () => RejectAccountLinkInvitationResult$
];
export var RestoreWorkspace$: StaticOperationSchema = [9, n0, _RWes,
  0, () => RestoreWorkspaceRequest$, () => RestoreWorkspaceResult$
];
export var RevokeIpRules$: StaticOperationSchema = [9, n0, _RIR,
  0, () => RevokeIpRulesRequest$, () => RevokeIpRulesResult$
];
export var StartWorkspaces$: StaticOperationSchema = [9, n0, _SWta,
  0, () => StartWorkspacesRequest$, () => StartWorkspacesResult$
];
export var StartWorkspacesPool$: StaticOperationSchema = [9, n0, _SWPt,
  0, () => StartWorkspacesPoolRequest$, () => StartWorkspacesPoolResult$
];
export var StopWorkspaces$: StaticOperationSchema = [9, n0, _SWto,
  0, () => StopWorkspacesRequest$, () => StopWorkspacesResult$
];
export var StopWorkspacesPool$: StaticOperationSchema = [9, n0, _SWPto,
  0, () => StopWorkspacesPoolRequest$, () => StopWorkspacesPoolResult$
];
export var TerminateWorkspaces$: StaticOperationSchema = [9, n0, _TW,
  0, () => TerminateWorkspacesRequest$, () => TerminateWorkspacesResult$
];
export var TerminateWorkspacesPool$: StaticOperationSchema = [9, n0, _TWP,
  0, () => TerminateWorkspacesPoolRequest$, () => TerminateWorkspacesPoolResult$
];
export var TerminateWorkspacesPoolSession$: StaticOperationSchema = [9, n0, _TWPS,
  0, () => TerminateWorkspacesPoolSessionRequest$, () => TerminateWorkspacesPoolSessionResult$
];
export var UpdateConnectClientAddIn$: StaticOperationSchema = [9, n0, _UCCAI,
  0, () => UpdateConnectClientAddInRequest$, () => UpdateConnectClientAddInResult$
];
export var UpdateConnectionAliasPermission$: StaticOperationSchema = [9, n0, _UCAP,
  0, () => UpdateConnectionAliasPermissionRequest$, () => UpdateConnectionAliasPermissionResult$
];
export var UpdateRulesOfIpGroup$: StaticOperationSchema = [9, n0, _UROIG,
  0, () => UpdateRulesOfIpGroupRequest$, () => UpdateRulesOfIpGroupResult$
];
export var UpdateWorkspaceBundle$: StaticOperationSchema = [9, n0, _UWB,
  0, () => UpdateWorkspaceBundleRequest$, () => UpdateWorkspaceBundleResult$
];
export var UpdateWorkspaceImagePermission$: StaticOperationSchema = [9, n0, _UWIP,
  0, () => UpdateWorkspaceImagePermissionRequest$, () => UpdateWorkspaceImagePermissionResult$
];
export var UpdateWorkspacesPool$: StaticOperationSchema = [9, n0, _UWP,
