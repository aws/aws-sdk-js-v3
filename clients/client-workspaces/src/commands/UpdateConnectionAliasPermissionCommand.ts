 ...
 * @public
 */
export class UpdateConnectionAliasPermissionCommand extends command<UpdateConnectionAliasPermissionCommandInput, UpdateConnectionAliasPermissionCommandOutput>(
  _ep0,
  _mw0,
