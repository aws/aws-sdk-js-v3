...
import type { DeleteIpGroupRequest, DeleteIpGroupResult } from "../models/models_0";
 ...
 * @public
 */
export class DeleteIpGroupCommand extends command<DeleteIpGroupCommandInput, DeleteIpGroupCommandOutput>(
  _ep0,
  _mw0,
  "DeleteIpGroup",
  DeleteIpGroup$
