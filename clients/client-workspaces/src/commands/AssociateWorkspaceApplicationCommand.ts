 ...
 * @public
 */
export class AssociateWorkspaceApplicationCommand extends command<AssociateWorkspaceApplicationCommandInput, AssociateWorkspaceApplicationCommandOutput>(
  _ep0,
  _mw0,
