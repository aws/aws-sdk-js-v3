...
> {
   ...
   * @public
   */
  constructor(readonly input: DisassociateWorkspaceApplicationCommandInput) {
  ...
  ): Handler<DisassociateWorkspaceApplicationCommandInput, DisassociateWorkspaceApplicationCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DisassociateWorkspaceApplicationCommand.getEndpointParameterInstructions())
    );
