 ...
 * @public
 */
export class ModifyWorkspaceCreationPropertiesCommand extends command<ModifyWorkspaceCreationPropertiesCommandInput, ModifyWorkspaceCreationPropertiesCommandOutput>(
  _ep0,
  _mw0,
