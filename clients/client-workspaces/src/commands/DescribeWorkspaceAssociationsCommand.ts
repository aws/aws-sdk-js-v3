 ...
 * @public
 */
export class DescribeWorkspaceAssociationsCommand extends command<DescribeWorkspaceAssociationsCommandInput, DescribeWorkspaceAssociationsCommandOutput>(
  _ep0,
  _mw0,
