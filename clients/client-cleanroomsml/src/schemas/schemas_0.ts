...
export var PutConfiguredAudienceModelPolicyResponse: StaticStructureSchema = [3, n0, _PCAMPRu, 0, [_cAMP, _pH], [0, 0]];
...
export var CollaborationMLInputChannelsList: StaticListSchema = [
  1,
  n0,
  _CMLICL,
  0,
...
export var CollaborationTrainedModelExportJobList: StaticListSchema = [
  1,
  n0,
  _CTMEJL,
  0,
...
export var CollaborationTrainedModelInferenceJobList: StaticListSchema = [
  1,
  n0,
  _CTMIJL,
  0,
...
export var TrainedModelInferenceJobList: StaticListSchema = [1, n0, _TMIJL, 0, () => TrainedModelInferenceJobSummary];
