 ...
 * @public
 */
export class DeleteConfiguredAudienceModelPolicyCommand extends command<DeleteConfiguredAudienceModelPolicyCommandInput, DeleteConfiguredAudienceModelPolicyCommandOutput>(
  _ep0,
  _mw0,
