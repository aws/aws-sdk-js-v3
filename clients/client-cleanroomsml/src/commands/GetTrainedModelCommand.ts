...
import type { GetTrainedModelRequest, GetTrainedModelResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetTrainedModelCommand extends command<GetTrainedModelCommandInput, GetTrainedModelCommandOutput>(
  _ep0,
  _mw0,
  "GetTrainedModel",
  GetTrainedModel$
