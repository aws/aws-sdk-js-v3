 ...
 * @public
 */
export class CreateConfiguredModelAlgorithmCommand extends command<CreateConfiguredModelAlgorithmCommandInput, CreateConfiguredModelAlgorithmCommandOutput>(
  _ep0,
  _mw0,
