...
import type { StartTrainedModelExportJobRequest } from "../models/models_0";
 ...
 * @public
 */
export class StartTrainedModelExportJobCommand extends command<StartTrainedModelExportJobCommandInput, StartTrainedModelExportJobCommandOutput>(
  _ep0,
  _mw0,
