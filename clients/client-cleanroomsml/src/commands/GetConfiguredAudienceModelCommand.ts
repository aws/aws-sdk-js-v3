...
import type { GetConfiguredAudienceModelRequest, GetConfiguredAudienceModelResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetConfiguredAudienceModelCommand extends command<GetConfiguredAudienceModelCommandInput, GetConfiguredAudienceModelCommandOutput>(
  _ep0,
  _mw0,
