...
import type { StartAudienceExportJobRequest } from "../models/models_0";
 ...
 * @public
 */
export class StartAudienceExportJobCommand extends command<StartAudienceExportJobCommandInput, StartAudienceExportJobCommandOutput>(
  _ep0,
  _mw0,
