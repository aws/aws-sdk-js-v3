 ...
 * @public
 */
export class CancelTrainedModelInferenceJobCommand extends command<CancelTrainedModelInferenceJobCommandInput, CancelTrainedModelInferenceJobCommandOutput>(
  _ep0,
  _mw0,
