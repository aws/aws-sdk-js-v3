 ...
 * @public
 */
export class DeleteConfiguredModelAlgorithmCommand extends command<DeleteConfiguredModelAlgorithmCommandInput, DeleteConfiguredModelAlgorithmCommandOutput>(
  _ep0,
  _mw0,
