 ...
 * @public
 */
export class ListCollaborationConfiguredModelAlgorithmAssociationsCommand extends command<ListCollaborationConfiguredModelAlgorithmAssociationsCommandInput, ListCollaborationConfiguredModelAlgorithmAssociationsCommandOutput>(
  _ep0,
  _mw0,
