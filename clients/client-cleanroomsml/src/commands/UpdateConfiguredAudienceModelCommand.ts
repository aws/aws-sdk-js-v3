 ...
 * @public
 */
export class UpdateConfiguredAudienceModelCommand extends command<UpdateConfiguredAudienceModelCommandInput, UpdateConfiguredAudienceModelCommandOutput>(
  _ep0,
  _mw0,
