...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteAudienceGenerationJobCommandInput) {
    super();
  }
  ...
  ): Handler<DeleteAudienceGenerationJobCommandInput, DeleteAudienceGenerationJobCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteAudienceGenerationJobCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: DeleteAudienceGenerationJobCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_DeleteAudienceGenerationJobCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_DeleteAudienceGenerationJobCommand(output, context);
  }
}
