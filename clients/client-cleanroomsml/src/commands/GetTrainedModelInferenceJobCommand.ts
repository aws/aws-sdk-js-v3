...
import type { GetTrainedModelInferenceJobRequest, GetTrainedModelInferenceJobResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetTrainedModelInferenceJobCommand extends command<GetTrainedModelInferenceJobCommandInput, GetTrainedModelInferenceJobCommandOutput>(
  _ep0,
  _mw0,
