 ...
 * @public
 */
export class GetConfiguredAudienceModelPolicyCommand extends command<GetConfiguredAudienceModelPolicyCommandInput, GetConfiguredAudienceModelPolicyCommandOutput>(
  _ep0,
  _mw0,
