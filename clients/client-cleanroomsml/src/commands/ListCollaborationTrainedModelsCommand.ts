...
import type { ListCollaborationTrainedModelsRequest, ListCollaborationTrainedModelsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListCollaborationTrainedModelsCommand extends command<ListCollaborationTrainedModelsCommandInput, ListCollaborationTrainedModelsCommandOutput>(
  _ep0,
  _mw0,
