...
> {
   ...
   * @public
   */
  constructor(readonly input: ListAudienceExportJobsCommandInput) {
    super();
  }
  ...
  ): Handler<ListAudienceExportJobsCommandInput, ListAudienceExportJobsCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListAudienceExportJobsCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: ListAudienceExportJobsCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<ListAudienceExportJobsCommandOutput> {
