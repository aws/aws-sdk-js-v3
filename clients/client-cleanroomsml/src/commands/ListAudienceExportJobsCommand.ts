...
import type { ListAudienceExportJobsRequest, ListAudienceExportJobsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListAudienceExportJobsCommand extends command<ListAudienceExportJobsCommandInput, ListAudienceExportJobsCommandOutput>(
  _ep0,
  _mw0,
