...
import type { DeleteScraperRequest, DeleteScraperResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteScraperCommand extends command<DeleteScraperCommandInput, DeleteScraperCommandOutput>(
  _ep0,
  _mw0,
  "DeleteScraper",
  DeleteScraper$
