...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteScraperCommandInput) {
    super();
  }
   ...
   * @internal
   */
  private serialize(input: DeleteScraperCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<DeleteScraperCommandOutput> {
