 ...
 * @public
 */
export class DeleteQueryLoggingConfigurationCommand extends command<DeleteQueryLoggingConfigurationCommandInput, DeleteQueryLoggingConfigurationCommandOutput>(
  _ep0,
  _mw0,
