 ...
 * @public
 */
export class UpdateQueryLoggingConfigurationCommand extends command<UpdateQueryLoggingConfigurationCommandInput, UpdateQueryLoggingConfigurationCommandOutput>(
  _ep0,
  _mw0,
