...
> {
   ...
   * @public
   */
  constructor(readonly input: GetDefaultScraperConfigurationCommandInput) {
    super();
  }
  ...
  ): Handler<GetDefaultScraperConfigurationCommandInput, GetDefaultScraperConfigurationCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, GetDefaultScraperConfigurationCommand.getEndpointParameterInstructions())
    );
