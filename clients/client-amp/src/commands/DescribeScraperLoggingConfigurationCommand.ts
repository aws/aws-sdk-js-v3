 ...
 * @public
 */
export class DescribeScraperLoggingConfigurationCommand extends command<DescribeScraperLoggingConfigurationCommandInput, DescribeScraperLoggingConfigurationCommandOutput>(
  _ep0,
  _mw0,
