...
import { type AmpClientResolvedConfig, AmpClientConfig } from "../AmpClient";
 ...
 * @internal
 */
export const defaultAmpHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: AmpHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultAmpHttpAuthSchemeProvider: AmpHttpAuthSchemeProvider = (authParameters) => {
