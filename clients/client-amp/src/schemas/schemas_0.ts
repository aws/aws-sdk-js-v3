...
export var AmpServiceException$: StaticErrorSchema = [-3, _s, "AmpServiceException", 0, [], []];
...
var LoggingDestinations: StaticListSchema = [1, n0, _LDo,
  0, () => LoggingDestination$
];
var RuleGroupsNamespaceSummaryList: StaticListSchema = [1, n0, _RGNSL,
  0, () => RuleGroupsNamespaceSummary$
];
var ScraperComponents: StaticListSchema = [1, n0, _SCc,
  0, () => ScraperComponent$
];
var ScraperSummaryList: StaticListSchema = [1, n0, _SSL,
  0, () => ScraperSummary$
];
...
var WorkspaceSummaryList: StaticListSchema = [1, n0, _WSL,
  0, () => WorkspaceSummary$
];
var LabelSet = 128 | 0;
var PrometheusMetricLabelMap = 128 | 0;
var ScraperFilters: StaticMapSchema = [2, n0, _SF,
  0, 0, 64 | 0
];
var StringMap = 128 | 0;
var TagMap = 128 | 0;
export var AnomalyDetectorConfiguration$: StaticUnionSchema = [4, n0, _ADC,
  0,
  [_rCF],
  [() => RandomCutForestConfiguration$]
];
export var AnomalyDetectorMissingDataAction$: StaticUnionSchema = [4, n0, _ADMDA,
  0,
  [_mAA, _sk],
  [2, 2]
];
...
export var ScrapeConfiguration$: StaticUnionSchema = [4, n0, _SCcr,
  0,
  [_cB],
  [21]
];
export var ScraperLoggingDestination$: StaticUnionSchema = [4, n0, _SLD,
  0,
  [_cWL],
  [() => CloudWatchLogDestination$]
];
export var Source$: StaticUnionSchema = [4, n0, _S,
  0,
  [_eC, _vC],
  [() => EksConfiguration$, () => VpcConfiguration$]
];
export var CreateAlertManagerDefinition$: StaticOperationSchema = [9, n0, _CAMD,
...
export var CreateAnomalyDetector$: StaticOperationSchema = [9, n0, _CAD,
...
export var CreateQueryLoggingConfiguration$: StaticOperationSchema = [9, n0, _CQLC,
...
export var CreateRuleGroupsNamespace$: StaticOperationSchema = [9, n0, _CRGN,
...
export var CreateScraper$: StaticOperationSchema = [9, n0, _CS,
...
export var DeleteAlertManagerDefinition$: StaticOperationSchema = [9, n0, _DAMD,
...
export var DeleteQueryLoggingConfiguration$: StaticOperationSchema = [9, n0, _DQLC,
...
export var DeleteRuleGroupsNamespace$: StaticOperationSchema = [9, n0, _DRGN,
  { [_h]: ["DELETE", "/workspaces/{workspaceId}/rulegroupsnamespaces/{name}", 202] }, () => DeleteRuleGroupsNamespaceRequest$, () => __Unit
];
export var DeleteScraper$: StaticOperationSchema = [9, n0, _DS,
  { [_h]: ["DELETE", "/scrapers/{scraperId}", 202] }, () => DeleteScraperRequest$, () => DeleteScraperResponse$
];
export var DeleteScraperLoggingConfiguration$: StaticOperationSchema = [9, n0, _DSLC,
...
export var DescribeAlertManagerDefinition$: StaticOperationSchema = [9, n0, _DAMDe,
...
export var DescribeAnomalyDetector$: StaticOperationSchema = [9, n0, _DADe,
...
export var DescribeLoggingConfiguration$: StaticOperationSchema = [9, n0, _DLCe,
  { [_h]: ["GET", "/workspaces/{workspaceId}/logging", 200] }, () => DescribeLoggingConfigurationRequest$, () => DescribeLoggingConfigurationResponse$
];
export var DescribeQueryLoggingConfiguration$: StaticOperationSchema = [9, n0, _DQLCe,
...
export var DescribeRuleGroupsNamespace$: StaticOperationSchema = [9, n0, _DRGNe,
...
export var DescribeScraper$: StaticOperationSchema = [9, n0, _DSe,
  { [_h]: ["GET", "/scrapers/{scraperId}", 200] }, () => DescribeScraperRequest$, () => DescribeScraperResponse$
];
export var DescribeScraperLoggingConfiguration$: StaticOperationSchema = [9, n0, _DSLCe,
...
export var DescribeWorkspaceConfiguration$: StaticOperationSchema = [9, n0, _DWC,
...
export var PutAlertManagerDefinition$: StaticOperationSchema = [9, n0, _PAMD,
...
export var PutRuleGroupsNamespace$: StaticOperationSchema = [9, n0, _PRGN,
...
export var UpdateQueryLoggingConfiguration$: StaticOperationSchema = [9, n0, _UQLC,
...
export var UpdateScraper$: StaticOperationSchema = [9, n0, _US,
  { [_h]: ["PUT", "/scrapers/{scraperId}", 202] }, () => UpdateScraperRequest$, () => UpdateScraperResponse$
];
export var UpdateScraperLoggingConfiguration$: StaticOperationSchema = [9, n0, _USLC,
...
export var UpdateWorkspaceAlias$: StaticOperationSchema = [9, n0, _UWA,
  { [_h]: ["POST", "/workspaces/{workspaceId}/alias", 204] }, () => UpdateWorkspaceAliasRequest$, () => __Unit
];
export var UpdateWorkspaceConfiguration$: StaticOperationSchema = [9, n0, _UWC,
