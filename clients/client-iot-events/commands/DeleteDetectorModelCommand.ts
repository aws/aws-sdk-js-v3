...
import { DeleteDetectorModelRequest, DeleteDetectorModelResponse } from "../models/index";
import {
...
> {
  ...
  private serialize(input: DeleteDetectorModelCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1DeleteDetectorModelCommand(input, context);
  }
