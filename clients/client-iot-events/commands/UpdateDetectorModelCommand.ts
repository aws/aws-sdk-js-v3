...
export class UpdateDetectorModelCommand extends $Command<UpdateDetectorModelCommandInput, UpdateDetectorModelCommandOutput, IoTEventsClientResolvedConfig> {
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1UpdateDetectorModelCommand(output, context);
  }
