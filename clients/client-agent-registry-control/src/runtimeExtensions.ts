...
import type { AgentRegistryControlExtensionConfiguration } from "./extensionConfiguration";
...
export const resolveRuntimeExtensions = (runtimeConfig: any, extensions: RuntimeExtension[]) => {
  const extensionConfiguration: AgentRegistryControlExtensionConfiguration = Object.assign(
