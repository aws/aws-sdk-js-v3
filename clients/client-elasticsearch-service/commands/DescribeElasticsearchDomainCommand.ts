...
import { DescribeElasticsearchDomainRequest, DescribeElasticsearchDomainResponse } from "../models/index";
import {
  deserializeAws_restJson1_1DescribeElasticsearchDomainCommand,
  serializeAws_restJson1_1DescribeElasticsearchDomainCommand
...
> {
  ...
  private serialize(input: DescribeElasticsearchDomainCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1DescribeElasticsearchDomainCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeElasticsearchDomainCommand(output, context);
  }
