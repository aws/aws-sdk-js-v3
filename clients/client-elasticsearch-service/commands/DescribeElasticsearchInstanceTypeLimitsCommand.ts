...
import {
  deserializeAws_restJson1_1DescribeElasticsearchInstanceTypeLimitsCommand,
  serializeAws_restJson1_1DescribeElasticsearchInstanceTypeLimitsCommand,
...
export class DescribeElasticsearchInstanceTypeLimitsCommand extends $Command<DescribeElasticsearchInstanceTypeLimitsCommandInput, DescribeElasticsearchInstanceTypeLimitsCommandOutput, ElasticsearchServiceClientResolvedConfig> {
  ...
  ): Handler<DescribeElasticsearchInstanceTypeLimitsCommandInput, DescribeElasticsearchInstanceTypeLimitsCommandOutput> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DescribeElasticsearchInstanceTypeLimitsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeElasticsearchInstanceTypeLimitsCommand(output, context);
  }
