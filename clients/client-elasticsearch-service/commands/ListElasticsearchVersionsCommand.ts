...
export type ListElasticsearchVersionsCommandOutput = ListElasticsearchVersionsResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1ListElasticsearchVersionsCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1ListElasticsearchVersionsCommand(
      output,
      context
    );
  }
