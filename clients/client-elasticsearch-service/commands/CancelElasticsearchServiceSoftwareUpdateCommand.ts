...
export class CancelElasticsearchServiceSoftwareUpdateCommand extends $Command<CancelElasticsearchServiceSoftwareUpdateCommandInput, CancelElasticsearchServiceSoftwareUpdateCommandOutput, ElasticsearchServiceClientResolvedConfig> {
  ...
  ): Handler<CancelElasticsearchServiceSoftwareUpdateCommandInput, CancelElasticsearchServiceSoftwareUpdateCommandOutput> {
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CancelElasticsearchServiceSoftwareUpdateCommand(output, context);
  }
