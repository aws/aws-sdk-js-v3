 ...
 * @public
 */
export class CancelElasticsearchServiceSoftwareUpdateCommand extends command<CancelElasticsearchServiceSoftwareUpdateCommandInput, CancelElasticsearchServiceSoftwareUpdateCommandOutput>(
  _ep0,
  _mw0,
