 ...
 * @public
 */
export class UpdateElasticsearchDomainConfigCommand extends command<UpdateElasticsearchDomainConfigCommandInput, UpdateElasticsearchDomainConfigCommandOutput>(
  _ep0,
  _mw0,
