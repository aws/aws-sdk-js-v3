 ...
 * ```
 *
 * @param RejectInboundCrossClusterSearchConnectionRequest - {@link RejectInboundCrossClusterSearchConnectionRequest}
 * @returns {@link RejectInboundCrossClusterSearchConnectionResponse}
