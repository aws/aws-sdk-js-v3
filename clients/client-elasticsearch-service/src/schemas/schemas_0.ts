...
export var ElasticsearchServiceServiceException$: StaticErrorSchema = [-3, _s, "ElasticsearchServiceServiceException", 0, [], []];
...
export var AcceptInboundCrossClusterSearchConnectionRequest$: StaticStructureSchema = [3, n0, _AICCSCR,
  0,
  [_CCSCI],
  [[0, 1]], 1
];
export var AcceptInboundCrossClusterSearchConnectionResponse$: StaticStructureSchema = [3, n0, _AICCSCRc,
  0,
  [_CCSC],
...
export var AdditionalLimit$: StaticStructureSchema = [3, n0, _AL,
  0,
  [_LN, _LV],
  [0, 64 | 0]
];
...
export var AdvancedSecurityOptionsInput$: StaticStructureSchema = [3, n0, _ASOI,
  0,
...
export var AutomatedSnapshotPauseOptions$: StaticStructureSchema = [3, n0, _ASPO,
  0,
  [_E, _ST, _ET, _St],
  [2, 4, 4, 0], 1
];
export var AutomatedSnapshotPauseOptionsStatus$: StaticStructureSchema = [3, n0, _ASPOS,
  0,
  [_O, _S],
  [() => AutomatedSnapshotPauseOptions$, () => OptionStatus$], 2
];
export var AutomatedSnapshotPauseRequestOptions$: StaticStructureSchema = [3, n0, _ASPRO,
  0,
  [_E, _ST, _ET],
  [2, 4, 4], 1
];
...
export var AutoTuneDetails$: StaticStructureSchema = [3, n0, _ATD,
  0,
  [_SATD],
  [() => ScheduledAutoTuneDetails$]
];
export var AutoTuneMaintenanceSchedule$: StaticStructureSchema = [3, n0, _ATMS,
  0,
  [_SA, _D, _CEFR],
  [4, () => Duration$, 0]
];
export var AutoTuneOptions$: StaticStructureSchema = [3, n0, _ATO,
  0,
  [_DS, _ROD, _MS],
  [0, 0, () => AutoTuneMaintenanceScheduleList]
];
export var AutoTuneOptionsInput$: StaticStructureSchema = [3, n0, _ATOI,
  0,
  [_DS, _MS],
  [0, () => AutoTuneMaintenanceScheduleList]
];
export var AutoTuneOptionsOutput$: StaticStructureSchema = [3, n0, _ATOO,
  0,
  [_St, _EM],
  [0, 0]
];
export var AutoTuneOptionsStatus$: StaticStructureSchema = [3, n0, _ATOS,
  0,
  [_O, _S],
...
export var CancelElasticsearchServiceSoftwareUpdateRequest$: StaticStructureSchema = [3, n0, _CESSUR,
  0,
  [_DN],
  [0], 1
];
export var CancelElasticsearchServiceSoftwareUpdateResponse$: StaticStructureSchema = [3, n0, _CESSURa,
  0,
  [_SSO],
  [() => ServiceSoftwareOptions$]
];
export var CancelledChangeProperty$: StaticStructureSchema = [3, n0, _CCPa,
  0,
  [_PN, _CV, _AV],
  [0, 0, 0]
];
...
export var CreateElasticsearchDomainRequest$: StaticStructureSchema = [3, n0, _CEDR,
  0,
  [_DN, _EV, _ECC, _EBSO, _APc, _SO, _VPCO, _CO, _EARO, _NTNEO, _AO, _LPO, _DEO, _ASO, _ATO, _TL, _DSO, _ASPO, _UC, _EMn],
  [0, 0, () => ElasticsearchClusterConfig$, () => EBSOptions$, 0, () => SnapshotOptions$, () => VPCOptions$, () => CognitoOptions$, () => EncryptionAtRestOptions$, () => NodeToNodeEncryptionOptions$, 128 | 0, () => LogPublishingOptions, () => DomainEndpointOptions$, [() => AdvancedSecurityOptionsInput$, 0], () => AutoTuneOptionsInput$, () => TagList, () => DeploymentStrategyOptions$, () => AutomatedSnapshotPauseRequestOptions$, 0, 0], 1
];
...
export var CreateOutboundCrossClusterSearchConnectionRequest$: StaticStructureSchema = [3, n0, _COCCSCR,
  0,
  [_SDI, _DDI, _CA],
  [() => DomainInformation$, () => DomainInformation$, 0], 3
];
export var CreateOutboundCrossClusterSearchConnectionResponse$: StaticStructureSchema = [3, n0, _COCCSCRr,
  0,
...
export var DeleteElasticsearchDomainRequest$: StaticStructureSchema = [3, n0, _DEDR,
  0,
  [_DN],
  [[0, 1]], 1
];
export var DeleteElasticsearchDomainResponse$: StaticStructureSchema = [3, n0, _DEDRe,
  0,
  [_DSo],
  [() => ElasticsearchDomainStatus$]
];
export var DeleteInboundCrossClusterSearchConnectionRequest$: StaticStructureSchema = [3, n0, _DICCSCR,
  0,
  [_CCSCI],
  [[0, 1]], 1
];
export var DeleteInboundCrossClusterSearchConnectionResponse$: StaticStructureSchema = [3, n0, _DICCSCRe,
  0,
  [_CCSC],
  [() => InboundCrossClusterSearchConnection$]
];
export var DeleteOutboundCrossClusterSearchConnectionRequest$: StaticStructureSchema = [3, n0, _DOCCSCR,
  0,
  [_CCSCI],
  [[0, 1]], 1
];
export var DeleteOutboundCrossClusterSearchConnectionResponse$: StaticStructureSchema = [3, n0, _DOCCSCRe,
  0,
  [_CCSC],
...
export var DescribeElasticsearchDomainConfigRequest$: StaticStructureSchema = [3, n0, _DEDCR,
  0,
  [_DN],
  [[0, 1]], 1
];
export var DescribeElasticsearchDomainConfigResponse$: StaticStructureSchema = [3, n0, _DEDCRe,
  0,
  [_DC],
  [() => ElasticsearchDomainConfig$], 1
];
export var DescribeElasticsearchDomainRequest$: StaticStructureSchema = [3, n0, _DEDRes,
  0,
  [_DN],
  [[0, 1]], 1
];
export var DescribeElasticsearchDomainResponse$: StaticStructureSchema = [3, n0, _DEDResc,
  0,
  [_DSo],
  [() => ElasticsearchDomainStatus$], 1
];
export var DescribeElasticsearchDomainsRequest$: StaticStructureSchema = [3, n0, _DEDRescr,
  0,
  [_DNo],
  [64 | 0], 1
];
export var DescribeElasticsearchDomainsResponse$: StaticStructureSchema = [3, n0, _DEDRescri,
  0,
  [_DSL],
  [() => ElasticsearchDomainStatusList], 1
];
export var DescribeElasticsearchInstanceTypeLimitsRequest$: StaticStructureSchema = [3, n0, _DEITLR,
  0,
  [_IT, _EV, _DN],
  [[0, 1], [0, 1], [0, { [_hQ]: _dN }]], 2
];
export var DescribeElasticsearchInstanceTypeLimitsResponse$: StaticStructureSchema = [3, n0, _DEITLRe,
  0,
  [_LBR],
  [() => LimitsByRole]
];
export var DescribeInboundCrossClusterSearchConnectionsRequest$: StaticStructureSchema = [3, n0, _DICCSCRes,
  0,
  [_F, _MR, _NT],
  [() => FilterList, 1, 0]
];
export var DescribeInboundCrossClusterSearchConnectionsResponse$: StaticStructureSchema = [3, n0, _DICCSCResc,
  0,
  [_CCSCr, _NT],
  [() => InboundCrossClusterSearchConnections, 0]
];
export var DescribeOutboundCrossClusterSearchConnectionsRequest$: StaticStructureSchema = [3, n0, _DOCCSCRes,
  0,
  [_F, _MR, _NT],
  [() => FilterList, 1, 0]
];
export var DescribeOutboundCrossClusterSearchConnectionsResponse$: StaticStructureSchema = [3, n0, _DOCCSCResc,
  0,
  [_CCSCr, _NT],
  [() => OutboundCrossClusterSearchConnections, 0]
];
export var DescribePackagesFilter$: StaticStructureSchema = [3, n0, _DPF,
  0,
  [_N, _V],
  [0, 64 | 0]
];
export var DescribePackagesRequest$: StaticStructureSchema = [3, n0, _DPRes,
  0,
  [_F, _MR, _NT],
  [() => DescribePackagesFilterList, 1, 0]
];
export var DescribePackagesResponse$: StaticStructureSchema = [3, n0, _DPResc,
  0,
  [_PDL, _NT],
  [() => PackageDetailsList, 0]
];
export var DescribeReservedElasticsearchInstanceOfferingsRequest$: StaticStructureSchema = [3, n0, _DREIOR,
  0,
  [_REIOI, _MR, _NT],
  [[0, { [_hQ]: _oI }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var DescribeReservedElasticsearchInstanceOfferingsResponse$: StaticStructureSchema = [3, n0, _DREIORe,
  0,
  [_NT, _REIO],
  [0, [() => ReservedElasticsearchInstanceOfferingList, 0]]
];
export var DescribeReservedElasticsearchInstancesRequest$: StaticStructureSchema = [3, n0, _DREIR,
  0,
  [_REII, _MR, _NT],
  [[0, { [_hQ]: _rI }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var DescribeReservedElasticsearchInstancesResponse$: StaticStructureSchema = [3, n0, _DREIRe,
  0,
  [_NT, _REI],
...
export var DomainInformation$: StaticStructureSchema = [3, n0, _DIo,
  0,
  [_DN, _OI, _R],
  [0, 0, 0], 1
];
...
export var EBSOptions$: StaticStructureSchema = [3, n0, _EBSO,
  0,
  [_EBSE, _VT, _VS, _I, _T],
  [2, 0, 1, 1, 1]
];
...
export var ElasticsearchClusterConfig$: StaticStructureSchema = [3, n0, _ECC,
  0,
  [_IT, _IC, _DME, _ZAE, _ZAC, _DMT, _DMC, _WE, _WT, _WC, _CSO],
  [0, 1, 2, 2, () => ZoneAwarenessConfig$, 0, 1, 2, 0, 1, () => ColdStorageOptions$]
];
export var ElasticsearchClusterConfigStatus$: StaticStructureSchema = [3, n0, _ECCS,
  0,
  [_O, _S],
...
export var ElasticsearchDomainConfig$: StaticStructureSchema = [3, n0, _EDC,
  0,
  [_EV, _ECC, _EBSO, _APc, _SO, _VPCO, _CO, _EARO, _NTNEO, _AO, _LPO, _DEO, _ASO, _ATO, _CPD, _MP, _DSO, _ASPO, _UC, _EMn],
...
export var ElasticsearchDomainStatus$: StaticStructureSchema = [3, n0, _EDS,
  0,
  [_DIom, _DN, _ARN, _ECC, _C, _Del, _En, _End, _Pro, _UP, _EV, _EBSO, _APc, _SO, _VPCO, _CO, _EARO, _NTNEO, _AO, _LPO, _SSO, _DEO, _ASO, _ATO, _CPD, _DPSo, _MP, _DSO, _ASPO, _UC, _EMn],
  [0, 0, 0, () => ElasticsearchClusterConfig$, 2, 2, 0, 128 | 0, 2, 2, 0, () => EBSOptions$, 0, () => SnapshotOptions$, () => VPCDerivedInfo$, () => CognitoOptions$, () => EncryptionAtRestOptions$, () => NodeToNodeEncryptionOptions$, 128 | 0, () => LogPublishingOptions, () => ServiceSoftwareOptions$, () => DomainEndpointOptions$, () => AdvancedSecurityOptions$, () => AutoTuneOptionsOutput$, () => ChangeProgressDetails$, 0, () => ModifyingPropertiesList, () => DeploymentStrategyOptions$, () => AutomatedSnapshotPauseOptions$, 0, 0], 4
];
...
export var GetCompatibleElasticsearchVersionsRequest$: StaticStructureSchema = [3, n0, _GCEVR,
  0,
  [_DN],
  [[0, { [_hQ]: _dN }]]
];
export var GetCompatibleElasticsearchVersionsResponse$: StaticStructureSchema = [3, n0, _GCEVRe,
  0,
  [_CEV],
...
export var InboundCrossClusterSearchConnection$: StaticStructureSchema = [3, n0, _ICCSC,
  0,
  [_SDI, _DDI, _CCSCI, _CS],
  [() => DomainInformation$, () => DomainInformation$, 0, () => InboundCrossClusterSearchConnectionStatus$]
];
export var InboundCrossClusterSearchConnectionStatus$: StaticStructureSchema = [3, n0, _ICCSCS,
  0,
  [_SC, _M],
  [0, 0]
];
...
export var InstanceLimits$: StaticStructureSchema = [3, n0, _IL,
  0,
  [_ICL],
  [() => InstanceCountLimits$]
];
...
export var ListDomainNamesRequest$: StaticStructureSchema = [3, n0, _LDNR,
  0,
  [_ETn],
  [[0, { [_hQ]: _eT }]]
];
export var ListDomainNamesResponse$: StaticStructureSchema = [3, n0, _LDNRi,
  0,
  [_DNo],
  [() => DomainInfoList]
];
...
export var ListElasticsearchInstanceTypesRequest$: StaticStructureSchema = [3, n0, _LEITR,
  0,
  [_EV, _DN, _MR, _NT],
  [[0, 1], [0, { [_hQ]: _dN }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]], 1
];
export var ListElasticsearchInstanceTypesResponse$: StaticStructureSchema = [3, n0, _LEITRi,
  0,
  [_EIT, _NT],
  [64 | 0, 0]
];
export var ListElasticsearchVersionsRequest$: StaticStructureSchema = [3, n0, _LEVR,
  0,
  [_MR, _NT],
  [[1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }]]
];
export var ListElasticsearchVersionsResponse$: StaticStructureSchema = [3, n0, _LEVRi,
  0,
  [_EVl, _NT],
  [64 | 0, 0]
];
...
export var LogPublishingOptionsStatus$: StaticStructureSchema = [3, n0, _LPOS,
  0,
  [_O, _S],
  [() => LogPublishingOptions, () => OptionStatus$]
];
export var MasterUserOptions$: StaticStructureSchema = [3, n0, _MUO,
  0,
  [_MUARN, _MUN, _MUP],
...
export var NodeToNodeEncryptionOptions$: StaticStructureSchema = [3, n0, _NTNEO,
  0,
  [_E],
  [2]
];
...
export var OutboundCrossClusterSearchConnection$: StaticStructureSchema = [3, n0, _OCCSC,
  0,
  [_SDI, _DDI, _CCSCI, _CA, _CS],
  [() => DomainInformation$, () => DomainInformation$, 0, 0, () => OutboundCrossClusterSearchConnectionStatus$]
];
export var OutboundCrossClusterSearchConnectionStatus$: StaticStructureSchema = [3, n0, _OCCSCS,
  0,
  [_SC, _M],
  [0, 0]
];
...
export var PurchaseReservedElasticsearchInstanceOfferingRequest$: StaticStructureSchema = [3, n0, _PREIOR,
  0,
  [_REIOI, _RN, _IC],
  [0, 0, 1], 2
];
export var PurchaseReservedElasticsearchInstanceOfferingResponse$: StaticStructureSchema = [3, n0, _PREIORu,
  0,
  [_REII, _RN],
  [0, 0]
];
export var RecurringCharge$: StaticStructureSchema = [3, n0, _RC,
  0,
  [_RCA, _RCF],
  [1, 0]
];
export var RejectInboundCrossClusterSearchConnectionRequest$: StaticStructureSchema = [3, n0, _RICCSCR,
  0,
  [_CCSCI],
  [[0, 1]], 1
];
export var RejectInboundCrossClusterSearchConnectionResponse$: StaticStructureSchema = [3, n0, _RICCSCRe,
  0,
  [_CCSC],
  [() => InboundCrossClusterSearchConnection$]
];
...
export var ReservedElasticsearchInstance$: StaticStructureSchema = [3, n0, _REIe,
  0,
  [_RN, _REII, _REIOI, _EITl, _ST, _D, _FP, _UPs, _CC, _EIC, _St, _PO, _RCe],
  [0, 0, 0, 0, 4, 1, 1, 1, 0, 1, 0, 0, [() => RecurringChargeList, 0]]
];
export var ReservedElasticsearchInstanceOffering$: StaticStructureSchema = [3, n0, _REIOe,
  0,
...
export var SAMLOptionsOutput$: StaticStructureSchema = [3, n0, _SAMLOO,
  0,
...
export var ServiceSoftwareOptions$: StaticStructureSchema = [3, n0, _SSO,
  0,
...
export var StartElasticsearchServiceSoftwareUpdateRequest$: StaticStructureSchema = [3, n0, _SESSUR,
  0,
  [_DN],
  [0], 1
];
export var StartElasticsearchServiceSoftwareUpdateResponse$: StaticStructureSchema = [3, n0, _SESSURt,
  0,
  [_SSO],
  [() => ServiceSoftwareOptions$]
];
export var StorageType$: StaticStructureSchema = [3, n0, _STto,
  0,
  [_STN, _SSTN, _STL],
  [0, 0, () => StorageTypeLimitList]
];
export var StorageTypeLimit$: StaticStructureSchema = [3, n0, _STLt,
  0,
  [_LN, _LV],
  [0, 64 | 0]
];
...
export var UpdateElasticsearchDomainConfigRequest$: StaticStructureSchema = [3, n0, _UEDCR,
  0,
  [_DN, _ECC, _EBSO, _SO, _VPCO, _CO, _AO, _APc, _LPO, _DEO, _ASO, _NTNEO, _EARO, _ATO, _DR, _DSO, _ASPO, _UC, _EMn],
  [[0, 1], () => ElasticsearchClusterConfig$, () => EBSOptions$, () => SnapshotOptions$, () => VPCOptions$, () => CognitoOptions$, 128 | 0, 0, () => LogPublishingOptions, () => DomainEndpointOptions$, [() => AdvancedSecurityOptionsInput$, 0], () => NodeToNodeEncryptionOptions$, () => EncryptionAtRestOptions$, () => AutoTuneOptions$, 2, () => DeploymentStrategyOptions$, () => AutomatedSnapshotPauseRequestOptions$, 0, 0], 1
];
...
export var UpgradeElasticsearchDomainRequest$: StaticStructureSchema = [3, n0, _UEDR,
  0,
  [_DN, _TVa, _PCO],
  [0, 0, 2], 2
];
export var UpgradeElasticsearchDomainResponse$: StaticStructureSchema = [3, n0, _UEDRp,
  0,
  [_DN, _TVa, _PCO, _CPD],
  [0, 0, 2, () => ChangeProgressDetails$]
];
export var UpgradeHistory$: StaticStructureSchema = [3, n0, _UHp,
  0,
  [_UN, _STta, _USpg, _SL],
  [0, 4, 0, () => UpgradeStepsList]
];
export var UpgradeStepItem$: StaticStructureSchema = [3, n0, _USI,
  0,
  [_US, _USS, _Is, _PPr],
  [0, 0, 64 | 0, 1]
];
...
export var VpcEndpointError$: StaticStructureSchema = [3, n0, _VEEp,
  0,
  [_VEI, _EC, _EM],
  [0, 0, 0]
];
...
var AuthorizedPrincipalList: StaticListSchema = [1, n0, _APL,
  0, () => AuthorizedPrincipal$
];
var AutoTuneList: StaticListSchema = [1, n0, _ATL,
  0, () => AutoTune$
];
var AutoTuneMaintenanceScheduleList: StaticListSchema = [1, n0, _ATMSL,
...
var CompatibleElasticsearchVersionsList: StaticListSchema = [1, n0, _CEVL,
  0, () => CompatibleVersionsMap$
];
var DescribePackagesFilterList: StaticListSchema = [1, n0, _DPFL,
  0, () => DescribePackagesFilter$
];
var DescribePackagesFilterValues = 64 | 0;
var DomainInfoList: StaticListSchema = [1, n0, _DIL,
  0, () => DomainInfo$
];
var DomainNameList = 64 | 0;
var DomainPackageDetailsList: StaticListSchema = [1, n0, _DPDL,
  0, () => DomainPackageDetails$
];
var ElasticsearchDomainStatusList: StaticListSchema = [1, n0, _EDSL,
...
var GUIDList = 64 | 0;
var InboundCrossClusterSearchConnections: StaticListSchema = [1, n0, _ICCSCn,
...
var OutboundCrossClusterSearchConnections: StaticListSchema = [1, n0, _OCCSCu,
  0, () => OutboundCrossClusterSearchConnection$
];
var PackageDetailsList: StaticListSchema = [1, n0, _PDL,
  0, () => PackageDetails$
];
var PackageVersionHistoryList: StaticListSchema = [1, n0, _PVHL,
...
var ReservedElasticsearchInstanceList: StaticListSchema = [1, n0, _REIL,
  0, [() => ReservedElasticsearchInstance$,
    0]
];
var ReservedElasticsearchInstanceOfferingList: StaticListSchema = [1, n0, _REIOL,
  0, [() => ReservedElasticsearchInstanceOffering$,
    { [_xN]: _REIOe }]
];
var StorageTypeLimitList: StaticListSchema = [1, n0, _STLL,
  0, () => StorageTypeLimit$
];
var StorageTypeList: StaticListSchema = [1, n0, _STLto,
  0, () => StorageType$
];
var StringList = 64 | 0;
...
var UpgradeHistoryList: StaticListSchema = [1, n0, _UHL,
  0, () => UpgradeHistory$
];
var UpgradeStepsList: StaticListSchema = [1, n0, _USL,
  0, () => UpgradeStepItem$
];
var ValueStringList = 64 | 0;
var VpcEndpointErrorList: StaticListSchema = [1, n0, _VEEL,
  0, () => VpcEndpointError$
];
...
var LimitsByRole: StaticMapSchema = [2, n0, _LBR,
  0, 0, () => Limits$
];
var LogPublishingOptions: StaticMapSchema = [2, n0, _LPO,
  0, 0, () => LogPublishingOption$
];
export var AcceptInboundCrossClusterSearchConnection$: StaticOperationSchema = [9, n0, _AICCSC,
...
export var AddTags$: StaticOperationSchema = [9, n0, _ATd,
  { [_h]: ["POST", "/2015-01-01/tags", 200] }, () => AddTagsRequest$, () => __Unit
];
export var AssociatePackage$: StaticOperationSchema = [9, n0, _APs,
...
export var CancelDomainConfigChange$: StaticOperationSchema = [9, n0, _CDCC,
...
export var CancelElasticsearchServiceSoftwareUpdate$: StaticOperationSchema = [9, n0, _CESSU,
...
export var CreateElasticsearchDomain$: StaticOperationSchema = [9, n0, _CED,
  { [_h]: ["POST", "/2015-01-01/es/domain", 200] }, () => CreateElasticsearchDomainRequest$, () => CreateElasticsearchDomainResponse$
];
export var CreateOutboundCrossClusterSearchConnection$: StaticOperationSchema = [9, n0, _COCCSC,
...
export var CreatePackage$: StaticOperationSchema = [9, n0, _CPr,
  { [_h]: ["POST", "/2015-01-01/packages", 200] }, () => CreatePackageRequest$, () => CreatePackageResponse$
];
export var CreateVpcEndpoint$: StaticOperationSchema = [9, n0, _CVE,
  { [_h]: ["POST", "/2015-01-01/es/vpcEndpoints", 200] }, () => CreateVpcEndpointRequest$, () => CreateVpcEndpointResponse$
];
export var DeleteElasticsearchDomain$: StaticOperationSchema = [9, n0, _DED,
  { [_h]: ["DELETE", "/2015-01-01/es/domain/{DomainName}", 200] }, () => DeleteElasticsearchDomainRequest$, () => DeleteElasticsearchDomainResponse$
];
export var DeleteElasticsearchServiceRole$: StaticOperationSchema = [9, n0, _DESR,
  { [_h]: ["DELETE", "/2015-01-01/es/role", 200] }, () => __Unit, () => __Unit
];
export var DeleteInboundCrossClusterSearchConnection$: StaticOperationSchema = [9, n0, _DICCSC,
...
export var DeleteOutboundCrossClusterSearchConnection$: StaticOperationSchema = [9, n0, _DOCCSC,
...
export var DeletePackage$: StaticOperationSchema = [9, n0, _DP,
...
export var DescribeDomainAutoTunes$: StaticOperationSchema = [9, n0, _DDAT,
  { [_h]: ["GET", "/2015-01-01/es/domain/{DomainName}/autoTunes", 200] }, () => DescribeDomainAutoTunesRequest$, () => DescribeDomainAutoTunesResponse$
];
export var DescribeDomainChangeProgress$: StaticOperationSchema = [9, n0, _DDCP,
...
export var DescribeElasticsearchDomain$: StaticOperationSchema = [9, n0, _DEDe,
  { [_h]: ["GET", "/2015-01-01/es/domain/{DomainName}", 200] }, () => DescribeElasticsearchDomainRequest$, () => DescribeElasticsearchDomainResponse$
];
export var DescribeElasticsearchDomainConfig$: StaticOperationSchema = [9, n0, _DEDC,
...
export var DescribeElasticsearchDomains$: StaticOperationSchema = [9, n0, _DEDes,
  { [_h]: ["POST", "/2015-01-01/es/domain-info", 200] }, () => DescribeElasticsearchDomainsRequest$, () => DescribeElasticsearchDomainsResponse$
];
export var DescribeElasticsearchInstanceTypeLimits$: StaticOperationSchema = [9, n0, _DEITL,
...
export var DescribeInboundCrossClusterSearchConnections$: StaticOperationSchema = [9, n0, _DICCSCe,
...
export var DescribeOutboundCrossClusterSearchConnections$: StaticOperationSchema = [9, n0, _DOCCSCe,
...
export var DescribePackages$: StaticOperationSchema = [9, n0, _DPe,
  { [_h]: ["POST", "/2015-01-01/packages/describe", 200] }, () => DescribePackagesRequest$, () => DescribePackagesResponse$
];
export var DescribeReservedElasticsearchInstanceOfferings$: StaticOperationSchema = [9, n0, _DREIO,
...
export var DescribeReservedElasticsearchInstances$: StaticOperationSchema = [9, n0, _DREI,
...
export var GetCompatibleElasticsearchVersions$: StaticOperationSchema = [9, n0, _GCEV,
...
export var GetUpgradeHistory$: StaticOperationSchema = [9, n0, _GUH,
...
export var ListDomainNames$: StaticOperationSchema = [9, n0, _LDN,
...
export var ListElasticsearchInstanceTypes$: StaticOperationSchema = [9, n0, _LEIT,
...
export var ListElasticsearchVersions$: StaticOperationSchema = [9, n0, _LEV,
...
export var ListVpcEndpointAccess$: StaticOperationSchema = [9, n0, _LVEA,
...
export var ListVpcEndpoints$: StaticOperationSchema = [9, n0, _LVE,
  { [_h]: ["GET", "/2015-01-01/es/vpcEndpoints", 200] }, () => ListVpcEndpointsRequest$, () => ListVpcEndpointsResponse$
];
export var ListVpcEndpointsForDomain$: StaticOperationSchema = [9, n0, _LVEFD,
...
export var PurchaseReservedElasticsearchInstanceOffering$: StaticOperationSchema = [9, n0, _PREIO,
...
export var RejectInboundCrossClusterSearchConnection$: StaticOperationSchema = [9, n0, _RICCSC,
...
export var RemoveTags$: StaticOperationSchema = [9, n0, _RT,
...
export var StartElasticsearchServiceSoftwareUpdate$: StaticOperationSchema = [9, n0, _SESSU,
...
export var UpdateElasticsearchDomainConfig$: StaticOperationSchema = [9, n0, _UEDC,
...
export var UpdatePackage$: StaticOperationSchema = [9, n0, _UPp,
  { [_h]: ["POST", "/2015-01-01/packages/update", 200] }, () => UpdatePackageRequest$, () => UpdatePackageResponse$
];
export var UpdateVpcEndpoint$: StaticOperationSchema = [9, n0, _UVE,
  { [_h]: ["POST", "/2015-01-01/es/vpcEndpoints/update", 200] }, () => UpdateVpcEndpointRequest$, () => UpdateVpcEndpointResponse$
];
export var UpgradeElasticsearchDomain$: StaticOperationSchema = [9, n0, _UED,
