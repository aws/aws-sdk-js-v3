 ...
 * @public
 */
export class StartInputDeviceMaintenanceWindowCommand extends command<StartInputDeviceMaintenanceWindowCommandInput, StartInputDeviceMaintenanceWindowCommandOutput>(
  _ep0,
  _mw0,
