 ...
 * @public
 */
export class DescribeChannelPlacementGroupCommand extends command<DescribeChannelPlacementGroupCommandInput, DescribeChannelPlacementGroupCommandOutput>(
  _ep0,
  _mw0,
