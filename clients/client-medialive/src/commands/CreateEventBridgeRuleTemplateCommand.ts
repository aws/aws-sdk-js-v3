 ...
 * @public
 */
export class CreateEventBridgeRuleTemplateCommand extends command<CreateEventBridgeRuleTemplateCommandInput, CreateEventBridgeRuleTemplateCommandOutput>(
  _ep0,
  _mw0,
