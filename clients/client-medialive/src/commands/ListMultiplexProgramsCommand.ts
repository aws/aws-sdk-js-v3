...
import { ListMultiplexPrograms$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ListMultiplexProgramsCommand extends command<ListMultiplexProgramsCommandInput, ListMultiplexProgramsCommandOutput>(
  _ep0,
  _mw0,
