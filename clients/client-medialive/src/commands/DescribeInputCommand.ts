...
import type { DescribeInputRequest, DescribeInputResponse } from "../models/models_1";
 ...
 * @public
 */
export class DescribeInputCommand extends command<DescribeInputCommandInput, DescribeInputCommandOutput>(
  _ep0,
  _mw0,
  "DescribeInput",
  DescribeInput$
