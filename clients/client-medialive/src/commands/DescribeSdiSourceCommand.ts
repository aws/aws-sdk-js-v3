...
import { DescribeSdiSource$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DescribeSdiSourceCommand extends command<DescribeSdiSourceCommandInput, DescribeSdiSourceCommandOutput>(
  _ep0,
  _mw0,
  "DescribeSdiSource",
  DescribeSdiSource$
