...
import type { StartMultiplexRequest, StartMultiplexResponse } from "../models/models_1";
 ...
 * @public
 */
export class StartMultiplexCommand extends command<StartMultiplexCommandInput, StartMultiplexCommandOutput>(
  _ep0,
  _mw0,
  "StartMultiplex",
  StartMultiplex$
