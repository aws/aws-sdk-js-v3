 ...
 * @public
 */
export class ListEventBridgeRuleTemplateGroupsCommand extends command<ListEventBridgeRuleTemplateGroupsCommandInput, ListEventBridgeRuleTemplateGroupsCommandOutput>(
  _ep0,
  _mw0,
