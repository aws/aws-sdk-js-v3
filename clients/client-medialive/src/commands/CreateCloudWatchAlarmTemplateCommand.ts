 ...
 * @public
 */
export class CreateCloudWatchAlarmTemplateCommand extends command<CreateCloudWatchAlarmTemplateCommandInput, CreateCloudWatchAlarmTemplateCommandOutput>(
  _ep0,
  _mw0,
