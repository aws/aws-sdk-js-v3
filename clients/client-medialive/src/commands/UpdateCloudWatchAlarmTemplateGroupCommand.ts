 ...
 * @public
 */
export class UpdateCloudWatchAlarmTemplateGroupCommand extends command<UpdateCloudWatchAlarmTemplateGroupCommandInput, UpdateCloudWatchAlarmTemplateGroupCommandOutput>(
  _ep0,
  _mw0,
