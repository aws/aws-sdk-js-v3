...
import type { DeleteCloudWatchAlarmTemplateRequest } from "../models/models_1";
 ...
 * @public
 */
export class DeleteCloudWatchAlarmTemplateCommand extends command<DeleteCloudWatchAlarmTemplateCommandInput, DeleteCloudWatchAlarmTemplateCommandOutput>(
  _ep0,
  _mw0,
