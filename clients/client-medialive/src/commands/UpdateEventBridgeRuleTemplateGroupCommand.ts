 ...
 * @public
 */
export class UpdateEventBridgeRuleTemplateGroupCommand extends command<UpdateEventBridgeRuleTemplateGroupCommandInput, UpdateEventBridgeRuleTemplateGroupCommandOutput>(
  _ep0,
  _mw0,
