...
import type { DescribeNodeRequest, DescribeNodeResponse } from "../models/models_1";
 ...
 * @public
 */
export class DescribeNodeCommand extends command<DescribeNodeCommandInput, DescribeNodeCommandOutput>(
  _ep0,
  _mw0,
  "DescribeNode",
  DescribeNode$
