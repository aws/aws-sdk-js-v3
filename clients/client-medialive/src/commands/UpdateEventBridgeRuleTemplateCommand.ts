 ...
 * @public
 */
export class UpdateEventBridgeRuleTemplateCommand extends command<UpdateEventBridgeRuleTemplateCommandInput, UpdateEventBridgeRuleTemplateCommandOutput>(
  _ep0,
  _mw0,
