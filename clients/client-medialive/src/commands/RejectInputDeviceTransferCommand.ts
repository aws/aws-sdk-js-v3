...
import type { RejectInputDeviceTransferRequest, RejectInputDeviceTransferResponse } from "../models/models_1";
import { RejectInputDeviceTransfer$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class RejectInputDeviceTransferCommand extends command<RejectInputDeviceTransferCommandInput, RejectInputDeviceTransferCommandOutput>(
  _ep0,
  _mw0,
