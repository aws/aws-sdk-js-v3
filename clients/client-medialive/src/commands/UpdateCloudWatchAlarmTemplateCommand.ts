 ...
 * @public
 */
export class UpdateCloudWatchAlarmTemplateCommand extends command<UpdateCloudWatchAlarmTemplateCommandInput, UpdateCloudWatchAlarmTemplateCommandOutput>(
  _ep0,
  _mw0,
