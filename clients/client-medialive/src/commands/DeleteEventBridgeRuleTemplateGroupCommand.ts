...
import type { DeleteEventBridgeRuleTemplateGroupRequest } from "../models/models_1";
import { DeleteEventBridgeRuleTemplateGroup$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteEventBridgeRuleTemplateGroupCommand extends command<DeleteEventBridgeRuleTemplateGroupCommandInput, DeleteEventBridgeRuleTemplateGroupCommandOutput>(
  _ep0,
  _mw0,
