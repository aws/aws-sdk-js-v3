...
import type { UpdateNodeRequest, UpdateNodeResponse } from "../models/models_1";
 ...
 * @public
 */
export class UpdateNodeCommand extends command<UpdateNodeCommandInput, UpdateNodeCommandOutput>(
  _ep0,
  _mw0,
  "UpdateNode",
  UpdateNode$
