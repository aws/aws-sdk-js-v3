...
import type { UpdateChannelPlacementGroupRequest, UpdateChannelPlacementGroupResponse } from "../models/models_1";
 ...
 * @public
 */
export class UpdateChannelPlacementGroupCommand extends command<UpdateChannelPlacementGroupCommandInput, UpdateChannelPlacementGroupCommandOutput>(
  _ep0,
  _mw0,
