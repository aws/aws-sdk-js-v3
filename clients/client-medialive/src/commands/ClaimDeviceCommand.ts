...
import type { ClaimDeviceRequest, ClaimDeviceResponse } from "../models/models_1";
import { ClaimDevice$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ClaimDeviceCommand extends command<ClaimDeviceCommandInput, ClaimDeviceCommandOutput>(
  _ep0,
  _mw0,
  "ClaimDevice",
  ClaimDevice$
