...
const AWS_TEMPLATE = "medialive.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "medialive.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "medialive.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "medialive.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "medialive.{region}.amazonaws.com";
