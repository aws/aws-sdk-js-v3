...
export type DescribeInputSecurityGroupCommandOutput = DescribeInputSecurityGroupResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1DescribeInputSecurityGroupCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1DescribeInputSecurityGroupCommand(
      output,
      context
    );
  }
