...
export class CreateInputSecurityGroupCommand extends $Command<CreateInputSecurityGroupCommandInput, CreateInputSecurityGroupCommandOutput, MediaLiveClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1CreateInputSecurityGroupCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateInputSecurityGroupCommand(output, context);
  }
