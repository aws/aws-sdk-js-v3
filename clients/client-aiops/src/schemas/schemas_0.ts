...
export var CreateInvestigationGroupOutput$: StaticStructureSchema = [3, n0, _CIGO,
  0,
  [_a],
  [0]
];
export var CrossAccountConfiguration$: StaticStructureSchema = [3, n0, _CAC,
  0,
  [_sRA],
  [0]
];
export var DeleteInvestigationGroupPolicyOutput$: StaticStructureSchema = [3, n0, _DIGPO,
  0,
  [],
  []
];
export var DeleteInvestigationGroupPolicyRequest$: StaticStructureSchema = [3, n0, _DIGPR,
  0,
  [_i],
  [[0, 1]]
];
export var DeleteInvestigationGroupRequest$: StaticStructureSchema = [3, n0, _DIGR,
  0,
  [_i],
  [[0, 1]]
];
...
export var GetInvestigationGroupPolicyResponse$: StaticStructureSchema = [3, n0, _GIGPRe,
  0,
  [_iGA, _p],
  [0, 0]
];
export var GetInvestigationGroupRequest$: StaticStructureSchema = [3, n0, _GIGR,
  0,
  [_i],
  [[0, 1]]
];
export var GetInvestigationGroupResponse$: StaticStructureSchema = [3, n0, _GIGRe,
  0,
...
export var ListInvestigationGroupsModel$: StaticStructureSchema = [3, n0, _LIGM,
  0,
  [_a, _n],
  [0, 0]
];
export var ListInvestigationGroupsOutput$: StaticStructureSchema = [3, n0, _LIGO,
  0,
  [_nT, _iG],
...
export var PutInvestigationGroupPolicyRequest$: StaticStructureSchema = [3, n0, _PIGPR,
  0,
  [_i, _p],
  [[0, 1], 0]
];
export var PutInvestigationGroupPolicyResponse$: StaticStructureSchema = [3, n0, _PIGPRu,
  0,
  [_iGA],
  [0]
];
...
export var UpdateInvestigationGroupOutput$: StaticStructureSchema = [3, n0, _UIGO,
  0,
  [],
  []
];
export var UpdateInvestigationGroupRequest$: StaticStructureSchema = [3, n0, _UIGR,
  0,
...
var InvestigationGroups: StaticListSchema = [1, n0, _IG,
  0, () => ListInvestigationGroupsModel$
];
var TagKeyBoundaries = 64 | 0;
var TagKeys = 64 | 0;
var ChatbotNotificationChannel: StaticMapSchema = [2, n0, _CNC,
  0, 0, 64 | 0
];
var Tags = 128 | 0;
export var CreateInvestigationGroup$: StaticOperationSchema = [9, n0, _CIG,
  { [_h]: ["POST", "/investigationGroups", 201] }, () => CreateInvestigationGroupInput$, () => CreateInvestigationGroupOutput$
];
export var DeleteInvestigationGroup$: StaticOperationSchema = [9, n0, _DIG,
  { [_h]: ["DELETE", "/investigationGroups/{identifier}", 200] }, () => DeleteInvestigationGroupRequest$, () => __Unit
];
export var DeleteInvestigationGroupPolicy$: StaticOperationSchema = [9, n0, _DIGP,
...
export var PutInvestigationGroupPolicy$: StaticOperationSchema = [9, n0, _PIGP,
...
export var UpdateInvestigationGroup$: StaticOperationSchema = [9, n0, _UIG,
