 ...
 * @public
 */
export class DeleteInvestigationGroupPolicyCommand extends command<DeleteInvestigationGroupPolicyCommandInput, DeleteInvestigationGroupPolicyCommandOutput>(
  _ep0,
  _mw0,
