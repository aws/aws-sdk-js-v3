...
import { type AIOpsClientResolvedConfig, AIOpsClientConfig } from "../AIOpsClient";
 ...
 * @internal
 */
export const defaultAIOpsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: AIOpsHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<AIOpsClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultAIOpsHttpAuthSchemeProvider: AIOpsHttpAuthSchemeProvider = (authParameters) => {
