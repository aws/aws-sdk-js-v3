...
import { type Inspector2ClientResolvedConfig, Inspector2ClientConfig } from "../Inspector2Client";
...
function createAwsAuthSigv4HttpAuthOption(authParameters: Inspector2HttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultInspector2HttpAuthSchemeProvider: Inspector2HttpAuthSchemeProvider = (authParameters) => {
