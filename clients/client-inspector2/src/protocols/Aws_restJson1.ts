...
export const serializeAws_restJson1BatchGetAccountStatusCommand = async (
  ...
  let body: any;
  body = JSON.stringify({
    ...(input.accountIds != undefined && { accountIds: serializeAws_restJson1AccountIdSet(input.accountIds, context) }),
  });
  return new __HttpRequest({
    protocol,
    hostname,
...
export const serializeAws_restJson1DisableDelegatedAdminAccountCommand = async (
  ...
  let body: any;
  body = JSON.stringify({
    ...(input.delegatedAdminAccountId != undefined && { delegatedAdminAccountId: input.delegatedAdminAccountId }),
  });
  return new __HttpRequest({
    protocol,
    hostname,
...
export const serializeAws_restJson1ListFiltersCommand = async (
  ...
  body = JSON.stringify({
    ...(input.action != undefined && { action: input.action }),
    ...(input.arns != undefined && { arns: serializeAws_restJson1FilterArnList(input.arns, context) }),
    ...(input.maxResults != undefined && { maxResults: input.maxResults }),
    ...(input.nextToken != undefined && { nextToken: input.nextToken }),
  });
  return new __HttpRequest({
...
export const serializeAws_restJson1ListFindingAggregationsCommand = async (
  ...
  body = JSON.stringify({
    ...(input.accountIds != undefined && {
      accountIds: serializeAws_restJson1StringFilterList(input.accountIds, context),
    }),
...
export const serializeAws_restJson1UpdateOrganizationConfigurationCommand = async (
  ...
  let body: any;
  body = JSON.stringify({
    ...(input.autoEnable != undefined && { autoEnable: serializeAws_restJson1AutoEnable(input.autoEnable, context) }),
  });
  return new __HttpRequest({
    protocol,
    hostname,
...
const serializeAws_restJson1AmiAggregation = (input: AmiAggregation, context: __SerdeContext): any => {
  return {
    ...(input.amis != undefined && { amis: serializeAws_restJson1StringFilterList(input.amis, context) }),
    ...(input.sortBy != undefined && { sortBy: input.sortBy }),
    ...(input.sortOrder != undefined && { sortOrder: input.sortOrder }),
  };
};
...
const serializeAws_restJson1AutoEnable = (input: AutoEnable, context: __SerdeContext): any => {
  return {
    ...(input.ec2 != undefined && { ec2: input.ec2 }),
    ...(input.ecr != undefined && { ecr: input.ecr }),
  };
};
...
const serializeAws_restJson1AwsEcrContainerAggregation = (
  ...
  return {
    ...
    ...(input.imageShas != undefined && {
      imageShas: serializeAws_restJson1StringFilterList(input.imageShas, context),
    }),
    ...(input.imageTags != undefined && {
      imageTags: serializeAws_restJson1StringFilterList(input.imageTags, context),
    }),
...
const serializeAws_restJson1DateFilter = (input: DateFilter, context: __SerdeContext): any => {
  return {
    ...(input.endInclusive != undefined && { endInclusive: Math.round(input.endInclusive.getTime() / 1000) }),
    ...(input.startInclusive != undefined && { startInclusive: Math.round(input.startInclusive.getTime() / 1000) }),
  };
};
...
const serializeAws_restJson1FilterCriteria = (input: FilterCriteria, context: __SerdeContext): any => {
  return {
    ...
    ...(input.findingArn != undefined && {
      findingArn: serializeAws_restJson1StringFilterList(input.findingArn, context),
    }),
    ...
    ...(input.portRange != undefined && {
      portRange: serializeAws_restJson1PortRangeFilterList(input.portRange, context),
    }),
    ...
    ...(input.severity != undefined && { severity: serializeAws_restJson1StringFilterList(input.severity, context) }),
...
const serializeAws_restJson1NumberFilter = (input: NumberFilter, context: __SerdeContext): any => {
  return {
    ...(input.lowerInclusive != undefined && { lowerInclusive: __serializeFloat(input.lowerInclusive) }),
    ...(input.upperInclusive != undefined && { upperInclusive: __serializeFloat(input.upperInclusive) }),
  };
};
...
const serializeAws_restJson1PackageFilter = (input: PackageFilter, context: __SerdeContext): any => {
  return {
    ...
    ...(input.epoch != undefined && { epoch: serializeAws_restJson1NumberFilter(input.epoch, context) }),
    ...(input.name != undefined && { name: serializeAws_restJson1StringFilter(input.name, context) }),
    ...(input.release != undefined && { release: serializeAws_restJson1StringFilter(input.release, context) }),
    ...(input.sourceLayerHash != undefined && {
      sourceLayerHash: serializeAws_restJson1StringFilter(input.sourceLayerHash, context),
    }),
    ...(input.version != undefined && { version: serializeAws_restJson1StringFilter(input.version, context) }),
  };
};
...
const serializeAws_restJson1PortRangeFilter = (input: PortRangeFilter, context: __SerdeContext): any => {
  return {
    ...(input.beginInclusive != undefined && { beginInclusive: input.beginInclusive }),
    ...(input.endInclusive != undefined && { endInclusive: input.endInclusive }),
  };
};
...
const serializeAws_restJson1TitleAggregation = (input: TitleAggregation, context: __SerdeContext): any => {
  return {
    ...
    ...(input.sortBy != undefined && { sortBy: input.sortBy }),
    ...(input.sortOrder != undefined && { sortOrder: input.sortOrder }),
    ...(input.titles != undefined && { titles: serializeAws_restJson1StringFilterList(input.titles, context) }),
...
const deserializeAws_restJson1Account = (output: any, context: __SerdeContext): Account => {
  return {
    ...
    resourceStatus:
      output.resourceStatus != undefined
...
const deserializeAws_restJson1AccountState = (output: any, context: __SerdeContext): AccountState => {
  return {
    accountId: __expectString(output.accountId),
    resourceState:
      output.resourceState != undefined
        ? deserializeAws_restJson1ResourceState(output.resourceState, context)
        : undefined,
    state: output.state != undefined ? deserializeAws_restJson1State(output.state, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1AwsEcrContainerAggregationResponse = (
  ...
  return {
    ...
    imageTags:
      output.imageTags != undefined ? deserializeAws_restJson1StringList(output.imageTags, context) : undefined,
...
const deserializeAws_restJson1AwsEcrContainerImageDetails = (
  ...
  return {
    ...
    imageTags:
      output.imageTags != undefined ? deserializeAws_restJson1ImageTagList(output.imageTags, context) : undefined,
    platform: __expectString(output.platform),
    pushedAt:
      output.pushedAt != undefined
...
const deserializeAws_restJson1CoveredResource = (output: any, context: __SerdeContext): CoveredResource => {
  return {
    ...
    scanStatus:
      output.scanStatus != undefined ? deserializeAws_restJson1ScanStatus(output.scanStatus, context) : undefined,
...
const deserializeAws_restJson1Ec2InstanceAggregationResponse = (
  ...
  return {
    ...
    instanceTags:
      output.instanceTags != undefined ? deserializeAws_restJson1TagMap(output.instanceTags, context) : undefined,
  ...
  return {
    ...
    createdAt:
      output.createdAt != undefined
        ...
        : undefined,
    criteria:
      output.criteria != undefined ? deserializeAws_restJson1FilterCriteria(output.criteria, context) : undefined,
...
const deserializeAws_restJson1Finding = (output: any, context: __SerdeContext): Finding => {
  return {
    ...
    inspectorScoreDetails:
      output.inspectorScoreDetails != undefined
    ...
    lastObservedAt:
      output.lastObservedAt != undefined
        ...
        : undefined,
    networkReachabilityDetails:
      output.networkReachabilityDetails != undefined
        ? deserializeAws_restJson1NetworkReachabilityDetails(output.networkReachabilityDetails, context)
        : undefined,
    packageVulnerabilityDetails:
      output.packageVulnerabilityDetails != undefined
        ? deserializeAws_restJson1PackageVulnerabilityDetails(output.packageVulnerabilityDetails, context)
        : undefined,
    remediation:
      output.remediation != undefined ? deserializeAws_restJson1Remediation(output.remediation, context) : undefined,
    resources:
      output.resources != undefined ? deserializeAws_restJson1ResourceList(output.resources, context) : undefined,
...
const deserializeAws_restJson1FreeTrialAccountInfo = (output: any, context: __SerdeContext): FreeTrialAccountInfo => {
  return {
    accountId: __expectString(output.accountId),
    freeTrialInfo:
      output.freeTrialInfo != undefined
...
const deserializeAws_restJson1NetworkPath = (output: any, context: __SerdeContext): NetworkPath => {
  return {
    steps: output.steps != undefined ? deserializeAws_restJson1StepList(output.steps, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1NetworkReachabilityDetails = (
  ...
  return {
    networkPath:
      output.networkPath != undefined ? deserializeAws_restJson1NetworkPath(output.networkPath, context) : undefined,
    openPortRange:
      output.openPortRange != undefined ? deserializeAws_restJson1PortRange(output.openPortRange, context) : undefined,
...
const deserializeAws_restJson1PackageFilter = (output: any, context: __SerdeContext): PackageFilter => {
  return {
    architecture:
      output.architecture != undefined ? deserializeAws_restJson1StringFilter(output.architecture, context) : undefined,
    epoch: output.epoch != undefined ? deserializeAws_restJson1NumberFilter(output.epoch, context) : undefined,
    name: output.name != undefined ? deserializeAws_restJson1StringFilter(output.name, context) : undefined,
    release: output.release != undefined ? deserializeAws_restJson1StringFilter(output.release, context) : undefined,
    sourceLayerHash:
      output.sourceLayerHash != undefined
        ? deserializeAws_restJson1StringFilter(output.sourceLayerHash, context)
        : undefined,
    version: output.version != undefined ? deserializeAws_restJson1StringFilter(output.version, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1PackageVulnerabilityDetails = (
  ...
  return {
    cvss: output.cvss != undefined ? deserializeAws_restJson1CvssScoreList(output.cvss, context) : undefined,
    referenceUrls:
    ...
    vendorCreatedAt:
      output.vendorCreatedAt != undefined
    ...
    vendorUpdatedAt:
      output.vendorUpdatedAt != undefined
...
const deserializeAws_restJson1Resource = (output: any, context: __SerdeContext): Resource => {
  return {
    details: output.details != undefined ? deserializeAws_restJson1ResourceDetails(output.details, context) : undefined,
...
const deserializeAws_restJson1ResourceScanMetadata = (output: any, context: __SerdeContext): ResourceScanMetadata => {
  return {
    ec2: output.ec2 != undefined ? deserializeAws_restJson1Ec2Metadata(output.ec2, context) : undefined,
    ecrImage:
      output.ecrImage != undefined
        ? deserializeAws_restJson1EcrContainerImageMetadata(output.ecrImage, context)
        : undefined,
    ecrRepository:
      output.ecrRepository != undefined
...
const deserializeAws_restJson1ResourceState = (output: any, context: __SerdeContext): ResourceState => {
  return {
    ec2: output.ec2 != undefined ? deserializeAws_restJson1State(output.ec2, context) : undefined,
    ecr: output.ecr != undefined ? deserializeAws_restJson1State(output.ecr, context) : undefined,
  } as any;
};
...
const deserializeAws_restJson1UsageTotal = (output: any, context: __SerdeContext): UsageTotal => {
  return {
    accountId: __expectString(output.accountId),
    usage: output.usage != undefined ? deserializeAws_restJson1UsageList(output.usage, context) : undefined,
  } as any;
};
