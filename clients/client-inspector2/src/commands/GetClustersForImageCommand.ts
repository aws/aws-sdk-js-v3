...
import type { GetClustersForImageRequest, GetClustersForImageResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetClustersForImageCommand extends command<GetClustersForImageCommandInput, GetClustersForImageCommandOutput>(
  _ep0,
  _mw0,
  "GetClustersForImage",
  GetClustersForImage$
