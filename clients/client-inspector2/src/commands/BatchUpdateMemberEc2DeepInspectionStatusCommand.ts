 ...
 * @public
 */
export class BatchUpdateMemberEc2DeepInspectionStatusCommand extends command<BatchUpdateMemberEc2DeepInspectionStatusCommandInput, BatchUpdateMemberEc2DeepInspectionStatusCommandOutput>(
  _ep0,
  _mw0,
