 ...
 * ```
 *
 * @param BatchUpdateMemberEc2DeepInspectionStatusRequest - {@link BatchUpdateMemberEc2DeepInspectionStatusRequest}
 * @returns {@link BatchUpdateMemberEc2DeepInspectionStatusResponse}
