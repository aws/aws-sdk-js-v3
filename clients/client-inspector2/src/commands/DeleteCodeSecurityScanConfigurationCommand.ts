 ...
 * @public
 */
export class DeleteCodeSecurityScanConfigurationCommand extends command<DeleteCodeSecurityScanConfigurationCommandInput, DeleteCodeSecurityScanConfigurationCommandOutput>(
  _ep0,
  _mw0,
