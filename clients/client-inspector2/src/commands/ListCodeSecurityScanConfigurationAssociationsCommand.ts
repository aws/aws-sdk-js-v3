 ...
 * @public
 */
export class ListCodeSecurityScanConfigurationAssociationsCommand extends command<ListCodeSecurityScanConfigurationAssociationsCommandInput, ListCodeSecurityScanConfigurationAssociationsCommandOutput>(
  _ep0,
  _mw0,
