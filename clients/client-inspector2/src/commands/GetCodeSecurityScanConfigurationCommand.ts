 ...
 * @public
 */
export class GetCodeSecurityScanConfigurationCommand extends command<GetCodeSecurityScanConfigurationCommandInput, GetCodeSecurityScanConfigurationCommandOutput>(
  _ep0,
  _mw0,
