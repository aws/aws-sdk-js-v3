 ...
 * @public
 */
export class UpdateEc2DeepInspectionConfigurationCommand extends command<UpdateEc2DeepInspectionConfigurationCommandInput, UpdateEc2DeepInspectionConfigurationCommandOutput>(
  _ep0,
  _mw0,
