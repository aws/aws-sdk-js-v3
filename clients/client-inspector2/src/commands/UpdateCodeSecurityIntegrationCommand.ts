 ...
 * @public
 */
export class UpdateCodeSecurityIntegrationCommand extends command<UpdateCodeSecurityIntegrationCommandInput, UpdateCodeSecurityIntegrationCommandOutput>(
  _ep0,
  _mw0,
