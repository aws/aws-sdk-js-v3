...
import type { GetCisScanResultDetailsRequest, GetCisScanResultDetailsResponse } from "../models/models_0";
import { GetCisScanResultDetails$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetCisScanResultDetailsCommand extends command<GetCisScanResultDetailsCommandInput, GetCisScanResultDetailsCommandOutput>(
  _ep0,
  _mw0,
