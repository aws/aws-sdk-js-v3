...
export var AccountAggregationResponse$: StaticStructureSchema = [3, n0, _AAR,
  0,
  [_aI, _sC, _eAC, _fAC],
...
export var BatchGetAccountStatusRequest$: StaticStructureSchema = [3, n0, _BGASR,
  0,
  [_aIc],
  [64 | 0]
];
...
export var BatchGetMemberEc2DeepInspectionStatusResponse$: StaticStructureSchema = [3, n0, _BGMEDISRa,
  0,
  [_aIc, _fAI],
...
export var CisaData$: StaticStructureSchema = [3, n0, _CD,
  0,
  [_dA, _dD, _act],
  [4, 4, 0]
];
...
export var CisScanResultsAggregatedByChecksFilterCriteria$: StaticStructureSchema = [3, n0, _CSRABCFC,
  0,
...
export var CisScanResultsAggregatedByTargetResourceFilterCriteria$: StaticStructureSchema = [3, n0, _CSRABTRFC,
  0,
...
export var CoverageDateFilter$: StaticStructureSchema = [3, n0, _CDFo,
  0,
  [_sIt, _eI],
  [4, 4]
];
...
export var Cvss2$: StaticStructureSchema = [3, n0, _Cv,
  0,
  [_bS, _sV],
  [1, 0]
];
export var Cvss3$: StaticStructureSchema = [3, n0, _Cvs,
  0,
  [_bS, _sV],
  [1, 0]
];
export var Cvss4$: StaticStructureSchema = [3, n0, _Cvss,
  0,
  [_bS, _sV],
  [1, 0]
];
...
export var DelegatedAdmin$: StaticStructureSchema = [3, n0, _DA,
  0,
  [_aI, _rSel],
  [0, 0]
];
...
export var Ec2ScanModeState$: StaticStructureSchema = [3, n0, _ESMS,
  0,
  [_sM, _sMSc],
  [0, 0]
];
...
export var EcrContainerImageMetadata$: StaticStructureSchema = [3, n0, _ECIM,
  0,
  [_ta, _iPA, _lIUA, _iUC],
  [64 | 0, 4, 4, 1]
];
export var EcrRepositoryMetadata$: StaticStructureSchema = [3, n0, _ERM,
  0,
  [_na, _sFc],
  [0, 0]
];
...
export var EpssDetails$: StaticStructureSchema = [3, n0, _ED,
  0,
  [_sco],
  [1]
];
...
export var ExploitObserved$: StaticStructureSchema = [3, n0, _EO,
  0,
  [_lS, _fS],
  [4, 4]
];
...
export var GetDelegatedAdminAccountRequest$: StaticStructureSchema = [3, n0, _GDAAR,
  0,
  [],
  []
];
export var GetDelegatedAdminAccountResponse$: StaticStructureSchema = [3, n0, _GDAARe,
  0,
  [_dAe],
  [() => DelegatedAdmin$]
];
export var GetEc2DeepInspectionConfigurationRequest$: StaticStructureSchema = [3, n0, _GEDICR,
  0,
  [],
  []
];
...
export var ListCisScanConfigurationsRequest$: StaticStructureSchema = [3, n0, _LCSCR,
  0,
...
export var ListCisScansFilterCriteria$: StaticStructureSchema = [3, n0, _LCSFC,
  0,
...
export var ListCisScansRequest$: StaticStructureSchema = [3, n0, _LCSR,
  0,
  [_fCi, _dL, _sB, _sO, _nT, _mR],
  [() => ListCisScansFilterCriteria$, 0, 0, 0, 0, 1]
];
export var ListCisScansResponse$: StaticStructureSchema = [3, n0, _LCSRi,
  0,
  [_sca, _nT],
  [() => CisScanList, 0]
];
export var ListCodeSecurityIntegrationsRequest$: StaticStructureSchema = [3, n0, _LCSIR,
  0,
  [_nT, _mR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListCodeSecurityIntegrationsResponse$: StaticStructureSchema = [3, n0, _LCSIRi,
  0,
  [_i, _nT],
...
export var ListCodeSecurityScanConfigurationsRequest$: StaticStructureSchema = [3, n0, _LCSSCR,
  0,
  [_nT, _mR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListCodeSecurityScanConfigurationsResponse$: StaticStructureSchema = [3, n0, _LCSSCRi,
  0,
  [_confi, _nT],
...
export var ListDelegatedAdminAccountsResponse$: StaticStructureSchema = [3, n0, _LDAARi,
  0,
  [_dAA, _nT],
...
export var ListUsageTotalsRequest$: StaticStructureSchema = [3, n0, _LUTR,
  0,
  [_mR, _nT, _aIc],
  [1, 0, 64 | 0]
];
export var ListUsageTotalsResponse$: StaticStructureSchema = [3, n0, _LUTRi,
  0,
  [_nT, _tot],
  [0, () => UsageTotalList]
];
...
export var OneTimeSchedule$: StaticStructureSchema = [3, n0, _OTS,
  0,
  [],
  []
];
export var PackageAggregation$: StaticStructureSchema = [3, n0, _PA,
  0,
  [_pNa, _sO, _sB],
  [() => StringFilterList, 0, 0]
];
...
export var ProjectCodeSecurityScanConfiguration$: StaticStructureSchema = [3, n0, _PCSSC,
  0,
  [_pSCe, _cISCo],
  [() => ProjectPeriodicScanConfigurationList, () => ProjectContinuousIntegrationScanConfigurationList]
];
export var ProjectContinuousIntegrationScanConfiguration$: StaticStructureSchema = [3, n0, _PCISC,
  0,
  [_sEu, _rSC],
  [0, 64 | 0]
];
export var ProjectPeriodicScanConfiguration$: StaticStructureSchema = [3, n0, _PPSC,
  0,
  [_fE, _rSC],
  [0, 64 | 0]
];
...
var AccountStateList: StaticListSchema = [1, n0, _ASL,
  0, () => AccountState$
];
var AggregationResponseList: StaticListSchema = [1, n0, _ARL,
...
var CisCheckAggregationList: StaticListSchema = [1, n0, _CCAL,
  0, () => CisCheckAggregation$
];
var CisFindingArnFilterList: StaticListSchema = [1, n0, _CFAFL,
  0, () => CisStringFilter$
];
var CisFindingStatusFilterList: StaticListSchema = [1, n0, _CFSFL,
  0, () => CisFindingStatusFilter$
];
var CisNumberFilterList: StaticListSchema = [1, n0, _CNFL,
  0, () => CisNumberFilter$
];
var CisResultStatusFilterList: StaticListSchema = [1, n0, _CRSFL,
  0, () => CisResultStatusFilter$
];
var CisScanArnFilterList: StaticListSchema = [1, n0, _CSAFL,
  0, () => CisStringFilter$
];
var CisScanConfigurationArnFilterList: StaticListSchema = [1, n0, _CSCAFL,
  0, () => CisStringFilter$
];
var CisScanConfigurationList: StaticListSchema = [1, n0, _CSCL,
  0, () => CisScanConfiguration$
];
var CisScanDateFilterList: StaticListSchema = [1, n0, _CSDFL,
  0, () => CisDateFilter$
];
var CisScanList: StaticListSchema = [1, n0, _CSL,
  0, () => CisScan$
];
var CisScanNameFilterList: StaticListSchema = [1, n0, _CSNFL,
  0, () => CisStringFilter$
];
var CisScanResultDetailsList: StaticListSchema = [1, n0, _CSRDL,
  0, () => CisScanResultDetails$
];
var CisScanStatusFilterList: StaticListSchema = [1, n0, _CSSFL,
  0, () => CisScanStatusFilter$
];
var CisScheduledByFilterList: StaticListSchema = [1, n0, _CSBFL,
  0, () => CisStringFilter$
];
var CisSecurityLevelFilterList: StaticListSchema = [1, n0, _CSLFL,
  0, () => CisSecurityLevelFilter$
];
var CisSessionMessages: StaticListSchema = [1, n0, _CSMi,
  0, () => CisSessionMessage$
];
...
var ClusterInformationList: StaticListSchema = [1, n0, _CIL,
  0, () => ClusterInformation$
];
var CodeLineList: StaticListSchema = [1, n0, _CLL,
  0, () => CodeLine$
];
var CodeSecurityScanConfigurationAssociationSummaries: StaticListSchema = [1, n0, _CSSCASo,
  0, () => CodeSecurityScanConfigurationAssociationSummary$
];
var CodeSecurityScanConfigurationSummaries: StaticListSchema = [1, n0, _CSSCSo,
  0, () => CodeSecurityScanConfigurationSummary$
];
var CodeSnippetErrorList: StaticListSchema = [1, n0, _CSEL,
  0, () => CodeSnippetError$
];
...
var CoverageMapFilterList: StaticListSchema = [1, n0, _CMFL,
  0, () => CoverageMapFilter$
];
var CoverageNumberFilterList: StaticListSchema = [1, n0, _CNFLo,
  0, () => CoverageNumberFilter$
];
var CoverageStringFilterList: StaticListSchema = [1, n0, _CSFL,
  0, () => CoverageStringFilter$
];
var CoveredResources: StaticListSchema = [1, n0, _CRo,
  0, () => CoveredResource$
];
var CvssScoreAdjustmentList: StaticListSchema = [1, n0, _CSAL,
  0, () => CvssScoreAdjustment$
];
var CvssScoreList: StaticListSchema = [1, n0, _CSLv,
  0, () => CvssScore$
];
var CweList = 64 | 0;
var Cwes = 64 | 0;
var DateFilterList: StaticListSchema = [1, n0, _DFL,
  0, () => DateFilter$
];
var DaysList = 64 | 0;
var DelegatedAdminAccountList: StaticListSchema = [1, n0, _DAAL,
  0, () => DelegatedAdminAccount$
];
var DetectionPlatforms = 64 | 0;
var DetectorTagList = 64 | 0;
var DisableResourceTypeList = 64 | 0;
var DisassociateConfigurationRequestList: StaticListSchema = [1, n0, _DCRL,
  0, () => DisassociateConfigurationRequest$
];
var EnableResourceTypeList = 64 | 0;
var EvidenceList: StaticListSchema = [1, n0, _EL,
  0, () => Evidence$
];
var FailedAccountList: StaticListSchema = [1, n0, _FAL,
  0, () => FailedAccount$
];
var FailedAssociationResultList: StaticListSchema = [1, n0, _FARL,
  0, () => FailedAssociationResult$
];
var FailedMemberAccountEc2DeepInspectionStatusStateList: StaticListSchema = [1, n0, _FMAEDISSL,
...
var FindingDetails: StaticListSchema = [1, n0, _FDi,
  0, () => FindingDetail$
];
var FindingDetailsErrorList: StaticListSchema = [1, n0, _FDEL,
  0, () => FindingDetailsError$
];
var FindingList: StaticListSchema = [1, n0, _FLi,
  0, () => Finding$
];
var FreeTrialAccountInfoList: StaticListSchema = [1, n0, _FTAIL,
  0, () => FreeTrialAccountInfo$
];
var FreeTrialInfoErrorList: StaticListSchema = [1, n0, _FTIEL,
  0, () => FreeTrialInfoError$
];
var FreeTrialInfoList: StaticListSchema = [1, n0, _FTIL,
  0, () => FreeTrialInfo$
];
var ImageTagList = 64 | 0;
var IntegrationSummaries: StaticListSchema = [1, n0, _IS,
...
var LayerList = 64 | 0;
var MapFilterList: StaticListSchema = [1, n0, _MFL,
  0, () => MapFilter$
];
var MemberAccountEc2DeepInspectionStatusList: StaticListSchema = [1, n0, _MAEDISL,
  0, () => MemberAccountEc2DeepInspectionStatus$
];
var MemberAccountEc2DeepInspectionStatusStateList: StaticListSchema = [1, n0, _MAEDISSL,
...
var NumberFilterList: StaticListSchema = [1, n0, _NFL,
  0, () => NumberFilter$
];
var OneAccountIdFilterList: StaticListSchema = [1, n0, _OAIFL,
  0, () => CisStringFilter$
];
var PackageFilterList: StaticListSchema = [1, n0, _PFL,
  0, () => PackageFilter$
];
var PathList = 64 | 0;
...
var PlatformFilterList: StaticListSchema = [1, n0, _PFLl,
  0, () => CisStringFilter$
];
var PortRangeFilterList: StaticListSchema = [1, n0, _PRFL,
  0, () => PortRangeFilter$
];
var ProjectContinuousIntegrationScanConfigurationList: StaticListSchema = [1, n0, _PCISCL,
...
var ResourceIdFilterList: StaticListSchema = [1, n0, _RIFL,
  0, () => CisStringFilter$
];
var ResourceList: StaticListSchema = [1, n0, _RL,
  0, () => Resource$
];
var ResourceMapFilterList: StaticListSchema = [1, n0, _RMFL,
  0, () => ResourceMapFilter$
];
var ResourceStringFilterList: StaticListSchema = [1, n0, _RSFL,
  0, () => ResourceStringFilter$
];
var ResourceTagFilterList: StaticListSchema = [1, n0, _RTFL,
  0, () => TagFilter$
];
...
var StringFilterList: StaticListSchema = [1, n0, _SFL,
  0, () => StringFilter$
];
var StringList = 64 | 0;
var SubnetIdList = 64 | 0;
var SuccessfulAssociationResultList: StaticListSchema = [1, n0, _SARL,
  0, () => SuccessfulAssociationResult$
];
var SuggestedFixes: StaticListSchema = [1, n0, _SFug,
  0, () => SuggestedFix$
];
var TagKeyList = 64 | 0;
var TagList = 64 | 0;
...
var Targets = 64 | 0;
var TargetStatusFilterList: StaticListSchema = [1, n0, _TSFL,
  0, () => CisTargetStatusFilter$
];
var TargetStatusReasonFilterList: StaticListSchema = [1, n0, _TSRFL,
  0, () => CisTargetStatusReasonFilter$
];
var TitleFilterList: StaticListSchema = [1, n0, _TFL,
  0, () => CisStringFilter$
];
var Tools = 64 | 0;
var Ttps = 64 | 0;
var UsageAccountIdList = 64 | 0;
var UsageList: StaticListSchema = [1, n0, _UL,
  0, () => Usage$
];
var UsageTotalList: StaticListSchema = [1, n0, _UTL,
  0, () => UsageTotal$
];
...
var VulnerablePackageList: StaticListSchema = [1, n0, _VPL,
  0, () => VulnerablePackage$
];
var VulnIdList = 64 | 0;
var CisTagMap = 128 | 0;
...
export var CodeSecurityResource$: StaticUnionSchema = [4, n0, _CSRo,
  0,
  [_pI],
  [0]
];
export var CreateIntegrationDetail$: StaticUnionSchema = [4, n0, _CID,
  0,
  [_gSM],
...
export var UpdateIntegrationDetails$: StaticUnionSchema = [4, n0, _UID,
  0,
  [_gSM, _g],
  [[() => UpdateGitLabSelfManagedIntegrationDetail$, 0], [() => UpdateGitHubIntegrationDetail$, 0]]
];
export var AssociateMember$: StaticOperationSchema = [9, n0, _AM,
  { [_ht]: ["POST", "/members/associate", 200] }, () => AssociateMemberRequest$, () => AssociateMemberResponse$
];
export var BatchAssociateCodeSecurityScanConfiguration$: StaticOperationSchema = [9, n0, _BACSSC,
...
export var BatchDisassociateCodeSecurityScanConfiguration$: StaticOperationSchema = [9, n0, _BDCSSC,
...
export var BatchUpdateMemberEc2DeepInspectionStatus$: StaticOperationSchema = [9, n0, _BUMEDIS,
...
export var GetDelegatedAdminAccount$: StaticOperationSchema = [9, n0, _GDAA,
  { [_ht]: ["POST", "/delegatedadminaccounts/get", 200] }, () => GetDelegatedAdminAccountRequest$, () => GetDelegatedAdminAccountResponse$
];
export var GetEc2DeepInspectionConfiguration$: StaticOperationSchema = [9, n0, _GEDIC,
...
export var GetEncryptionKey$: StaticOperationSchema = [9, n0, _GEK,
  { [_ht]: ["GET", "/encryptionkey/get", 200] }, () => GetEncryptionKeyRequest$, () => GetEncryptionKeyResponse$
];
export var GetFindingsReportStatus$: StaticOperationSchema = [9, n0, _GFRS,
...
export var ListCisScanResultsAggregatedByTargetResource$: StaticOperationSchema = [9, n0, _LCSRABTR,
...
export var ListCisScans$: StaticOperationSchema = [9, n0, _LCS,
  { [_ht]: ["POST", "/cis/scan/list", 200] }, () => ListCisScansRequest$, () => ListCisScansResponse$
];
export var ListCodeSecurityIntegrations$: StaticOperationSchema = [9, n0, _LCSI,
  { [_ht]: ["POST", "/codesecurity/integration/list", 200] }, () => ListCodeSecurityIntegrationsRequest$, () => ListCodeSecurityIntegrationsResponse$
];
export var ListCodeSecurityScanConfigurationAssociations$: StaticOperationSchema = [9, n0, _LCSSCA,
...
export var ListDelegatedAdminAccounts$: StaticOperationSchema = [9, n0, _LDAA,
...
export var ListFindingAggregations$: StaticOperationSchema = [9, n0, _LFAi,
...
export var UpdateEncryptionKey$: StaticOperationSchema = [9, n0, _UEK,
  { [_ht]: ["PUT", "/encryptionkey/update", 200] }, () => UpdateEncryptionKeyRequest$, () => UpdateEncryptionKeyResponse$
];
export var UpdateFilter$: StaticOperationSchema = [9, n0, _UF,
...
export var UpdateOrgEc2DeepInspectionConfiguration$: StaticOperationSchema = [9, n0, _UOEDIC,
