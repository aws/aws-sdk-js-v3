...
var ColumnList: StaticListSchema = [1, n0, _CL, 0, () => Column$];
var ExecutionReferenceList: StaticListSchema = [1, n0, _ERL, 0, () => ExecutionReference$];
var ExportReferenceList: StaticListSchema = [1, n0, _ERLx, 0, () => ExportReference$];
...
var TablePropertyDescriptionList: StaticListSchema = [1, n0, _TPDL, 0, () => TablePropertyDescription$];
var ValidationExceptionFieldList: StaticListSchema = [1, n0, _VEFL, 0, () => ValidationExceptionField$];
var TableConfigurations: StaticMapSchema = [2, n0, _TC, 0, 0, 128 | 0];
...
export var GetExecution$: StaticOperationSchema = [
  9,
  n0,
  _GE,
  0,
