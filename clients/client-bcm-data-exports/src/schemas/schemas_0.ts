...
export var ListExportsRequest$: StaticStructureSchema = [3, n0, _LERis,
  0,
  [_MR, _NT],
  [1, 0]
];
export var ListExportsResponse$: StaticStructureSchema = [3, n0, _LERist,
  0,
  [_Exp, _NT],
...
export var TablePropertyDescription$: StaticStructureSchema = [3, n0, _TPD,
  0,
  [_N, _VV, _DV, _D],
  [0, 64 | 0, 0, 0]
];
...
var ExecutionReferenceList: StaticListSchema = [1, n0, _ERL,
  0, () => ExecutionReference$
];
var ExportReferenceList: StaticListSchema = [1, n0, _ERLx,
  0, () => ExportReference$
];
...
var TablePropertyDescriptionList: StaticListSchema = [1, n0, _TPDL,
  0, () => TablePropertyDescription$
];
var ValidationExceptionFieldList: StaticListSchema = [1, n0, _VEFL,
  0, () => ValidationExceptionField$
];
var TableConfigurations: StaticMapSchema = [2, n0, _TC,
  0, 0, 128 | 0
];
var TableProperties = 128 | 0;
export var CreateExport$: StaticOperationSchema = [9, n0, _CE,
  0, () => CreateExportRequest$, () => CreateExportResponse$
];
export var DeleteExport$: StaticOperationSchema = [9, n0, _DE,
  2, () => DeleteExportRequest$, () => DeleteExportResponse$
];
export var GetExecution$: StaticOperationSchema = [9, n0, _GE,
  0, () => GetExecutionRequest$, () => GetExecutionResponse$
];
export var GetExport$: StaticOperationSchema = [9, n0, _GEe,
  0, () => GetExportRequest$, () => GetExportResponse$
];
export var GetTable$: StaticOperationSchema = [9, n0, _GT,
...
export var ListExports$: StaticOperationSchema = [9, n0, _LEi,
...
export var UpdateExport$: StaticOperationSchema = [9, n0, _UE,
