...
import {
  ...
  defaultBCMDataExportsHttpAuthSchemeParametersProvider,
...
import type { GetExecutionCommandInput, GetExecutionCommandOutput } from "./commands/GetExecutionCommand";
 ...
 * @public
 */
export type BCMDataExportsClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<BCMDataExportsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: BCMDataExportsClientResolvedConfig) =>
