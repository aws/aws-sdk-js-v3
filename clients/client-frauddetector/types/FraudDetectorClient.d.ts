...
export declare type ServiceInputTypes = BatchCreateVariableCommandInput | BatchGetVariableCommandInput | CreateDetectorVersionCommandInput | CreateModelVersionCommandInput | CreateRuleCommandInput | CreateVariableCommandInput | DeleteDetectorVersionCommandInput | DeleteEventCommandInput | DescribeDetectorCommandInput | DescribeModelVersionsCommandInput | GetDetectorVersionCommandInput | GetDetectorsCommandInput | GetExternalModelsCommandInput | GetModelVersionCommandInput | GetModelsCommandInput | GetOutcomesCommandInput | GetPredictionCommandInput | GetRulesCommandInput | GetVariablesCommandInput | PutDetectorCommandInput | PutExternalModelCommandInput | PutModelCommandInput | PutOutcomeCommandInput | UpdateDetectorVersionCommandInput | UpdateDetectorVersionMetadataCommandInput | UpdateDetectorVersionStatusCommandInput | UpdateModelVersionCommandInput | UpdateRuleMetadataCommandInput | UpdateRuleVersionCommandInput | UpdateVariableCommandInput;
export declare type ServiceOutputTypes = BatchCreateVariableCommandOutput | BatchGetVariableCommandOutput | CreateDetectorVersionCommandOutput | CreateModelVersionCommandOutput | CreateRuleCommandOutput | CreateVariableCommandOutput | DeleteDetectorVersionCommandOutput | DeleteEventCommandOutput | DescribeDetectorCommandOutput | DescribeModelVersionsCommandOutput | GetDetectorVersionCommandOutput | GetDetectorsCommandOutput | GetExternalModelsCommandOutput | GetModelVersionCommandOutput | GetModelsCommandOutput | GetOutcomesCommandOutput | GetPredictionCommandOutput | GetRulesCommandOutput | GetVariablesCommandOutput | PutDetectorCommandOutput | PutExternalModelCommandOutput | PutModelCommandOutput | PutOutcomeCommandOutput | UpdateDetectorVersionCommandOutput | UpdateDetectorVersionMetadataCommandOutput | UpdateDetectorVersionStatusCommandOutput | UpdateModelVersionCommandOutput | UpdateRuleMetadataCommandOutput | UpdateRuleVersionCommandOutput | UpdateVariableCommandOutput;
...
export declare type FraudDetectorClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type FraudDetectorClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
