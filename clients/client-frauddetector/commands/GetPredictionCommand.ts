...
export type GetPredictionCommandOutput = GetPredictionResult;

export class GetPredictionCommand extends $Command<GetPredictionCommandInput, GetPredictionCommandOutput, FraudDetectorClientResolvedConfig> {
