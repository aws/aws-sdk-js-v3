...
export var IdMappingJobMetrics$: StaticStructureSchema = [3, n0, _IMJM,
  0,
...
export var ListIdMappingWorkflowsInput$: StaticStructureSchema = [3, n0, _LIMWI,
  0,
  [_nT, _mRa],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListIdMappingWorkflowsOutput$: StaticStructureSchema = [3, n0, _LIMWO,
  0,
  [_wS, _nT],
  [() => IdMappingWorkflowList, 0]
];
export var ListIdNamespacesInput$: StaticStructureSchema = [3, n0, _LINI,
  0,
  [_nT, _mRa],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListIdNamespacesOutput$: StaticStructureSchema = [3, n0, _LINO,
  0,
  [_iNS, _nT],
  [() => IdNamespaceList, 0]
];
...
export var ListMatchingWorkflowsInput$: StaticStructureSchema = [3, n0, _LMWI,
  0,
  [_nT, _mRa],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListMatchingWorkflowsOutput$: StaticStructureSchema = [3, n0, _LMWO,
  0,
  [_wS, _nT],
  [() => MatchingWorkflowList, 0]
];
export var ListProviderServicesInput$: StaticStructureSchema = [3, n0, _LPSI,
  0,
  [_nT, _mRa, _pN],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }], [0, { [_hQ]: _pN }]]
];
export var ListProviderServicesOutput$: StaticStructureSchema = [3, n0, _LPSO,
  0,
  [_pSS, _nT],
  [() => ProviderServiceList, 0]
];
export var ListSchemaMappingsInput$: StaticStructureSchema = [3, n0, _LSMI,
  0,
  [_nT, _mRa],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mRa }]]
];
export var ListSchemaMappingsOutput$: StaticStructureSchema = [3, n0, _LSMO,
  0,
  [_sL, _nT],
  [() => SchemaMappingList, 0]
];
...
export var ProviderIdNameSpaceConfiguration$: StaticStructureSchema = [3, n0, _PINSC,
  0,
  [_de, _pTCD, _pSCD],
  [0, 15, 15]
];
export var ProviderIntermediateDataAccessConfiguration$: StaticStructureSchema = [3, n0, _PIDAC,
  0,
  [_aAI, _rBA],
  [64 | 0, 64 | 0]
];
...
var DeleteUniqueIdErrorsList: StaticListSchema = [1, n0, _DUIEL,
  0, () => DeleteUniqueIdError$
];
var DisconnectedUniqueIdsList = 64 | 0;
var FailedRecordsList: StaticListSchema = [1, n0, _FRL,
  0, () => FailedRecord$
];
var IdMappingJobOutputSourceConfig: StaticListSchema = [1, n0, _IMJOSC,
  0, () => IdMappingJobOutputSource$
];
var IdMappingWorkflowInputSourceConfig: StaticListSchema = [1, n0, _IMWISC,
  0, () => IdMappingWorkflowInputSource$
];
var IdMappingWorkflowList: StaticListSchema = [1, n0, _IMWL,
  0, () => IdMappingWorkflowSummary$
];
var IdMappingWorkflowOutputSourceConfig: StaticListSchema = [1, n0, _IMWOSC,
  0, () => IdMappingWorkflowOutputSource$
];
var IdMappingWorkflowRuleDefinitionTypeList = 64 | 0;
var IdNamespaceIdMappingWorkflowMetadataList: StaticListSchema = [1, n0, _INIMWML,
  0, () => IdNamespaceIdMappingWorkflowMetadata$
];
var IdNamespaceIdMappingWorkflowPropertiesList: StaticListSchema = [1, n0, _INIMWPL,
  0, () => IdNamespaceIdMappingWorkflowProperties$
];
var IdNamespaceInputSourceConfig: StaticListSchema = [1, n0, _INISC,
  0, () => IdNamespaceInputSource$
];
var IdNamespaceList: StaticListSchema = [1, n0, _INL,
  0, () => IdNamespaceSummary$
];
var InputSourceConfig: StaticListSchema = [1, n0, _ISCn,
  0, () => InputSource$
];
var JobList: StaticListSchema = [1, n0, _JL,
  0, () => JobSummary$
];
var JobOutputSourceConfig: StaticListSchema = [1, n0, _JOSC,
  0, () => JobOutputSource$
];
var MatchedRecordsList: StaticListSchema = [1, n0, _MRL,
  0, () => MatchedRecord$
];
var MatchGroupsList: StaticListSchema = [1, n0, _MGL,
  0, () => MatchGroup$
];
var MatchingKeys = 64 | 0;
var MatchingWorkflowList: StaticListSchema = [1, n0, _MWL,
  0, () => MatchingWorkflowSummary$
];
var OutputAttributes: StaticListSchema = [1, n0, _OAu,
  0, () => OutputAttribute$
];
var OutputSourceConfig: StaticListSchema = [1, n0, _OSC,
  0, () => OutputSource$
];
var ProviderSchemaAttributes: StaticListSchema = [1, n0, _PSAr,
  0, () => ProviderSchemaAttribute$
];
var ProviderServiceList: StaticListSchema = [1, n0, _PSL,
...
var RuleConditionList: StaticListSchema = [1, n0, _RCL,
  0, () => RuleCondition$
];
var RuleList: StaticListSchema = [1, n0, _RLu,
  0, () => Rule$
];
var SchemaInputAttributes: StaticListSchema = [1, n0, _SIAc,
  0, () => SchemaInputAttribute$
];
var SchemaList = 64 | 0;
var SchemaMappingList: StaticListSchema = [1, n0, _SML,
  0, () => SchemaMappingSummary$
];
var Schemas: StaticListSchema = [1, n0, _S,
  0, 64 | 0
];
...
var RecordAttributeMap: StaticMapSchema = [2, n0, _RAM,
  8, 0, 0
];
var RecordAttributeMapString255: StaticMapSchema = [2, n0, _RAMS,
  8, 0, 0
];
var TagMap = 128 | 0;
...
export var PutPolicy$: StaticOperationSchema = [9, n0, _PPu,
  { [_ht]: ["PUT", "/policies/{arn}", 200] }, () => PutPolicyInput$, () => PutPolicyOutput$
];
export var StartIdMappingJob$: StaticOperationSchema = [9, n0, _SIMJ,
  { [_ht]: ["POST", "/idmappingworkflows/{workflowName}/jobs", 200] }, () => StartIdMappingJobInput$, () => StartIdMappingJobOutput$
];
export var StartMatchingJob$: StaticOperationSchema = [9, n0, _SMJ,
