...
> {
   ...
   * @public
   */
  constructor(readonly input: ListSchemaMappingsCommandInput) {
  ...
  resolveMiddleware(
    ...
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListSchemaMappingsCommand.getEndpointParameterInstructions())
    );
    ...
    const commandName = "ListSchemaMappingsCommand";
   ...
   * @internal
   */
  private serialize(input: ListSchemaMappingsCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_ListSchemaMappingsCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<ListSchemaMappingsCommandOutput> {
    return de_ListSchemaMappingsCommand(output, context);
  }
