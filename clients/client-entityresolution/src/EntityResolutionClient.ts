  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<EntityResolutionClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultEntityResolutionHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: EntityResolutionClientResolvedConfig) =>
