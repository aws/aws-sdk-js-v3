...
import { type CloudWatchEventsClientResolvedConfig, CloudWatchEventsClientConfig } from "../CloudWatchEventsClient";
 ...
 * @internal
 */
export const defaultCloudWatchEventsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CloudWatchEventsHttpAuthSchemeParameters): HttpAuthOption {
  return {
