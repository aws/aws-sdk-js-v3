 ...
 * @public
 */
export class ListPartnerEventSourceAccountsCommand extends command<ListPartnerEventSourceAccountsCommandInput, ListPartnerEventSourceAccountsCommandOutput>(
  _ep0,
  _mw0,
