...
import {
  ...
  defaultEKSAuthHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type EKSAuthClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type EKSAuthClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<EKSAuthClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultEKSAuthHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: EKSAuthClientResolvedConfig) =>
