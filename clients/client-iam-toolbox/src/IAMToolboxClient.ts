...
import {
  ...
  defaultIAMToolboxHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type IAMToolboxClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<IAMToolboxClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: IAMToolboxClientResolvedConfig) =>
