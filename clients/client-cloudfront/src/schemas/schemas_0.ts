...
export var ParameterDefinitionSchema$: StaticStructureSchema = [
  3,
  n0,
  _PDS,
  0,
...
export var ResponseHeadersPolicyContentSecurityPolicy$: StaticStructureSchema = [
  3,
  n0,
  _RHPCSP,
  0,
...
var AccessControlAllowHeadersList: StaticListSchema = [1, n0, _ACAHL, 0, [0, { [_xN]: _He }]];
var AccessControlAllowMethodsList: StaticListSchema = [1, n0, _ACAML, 0, [0, { [_xN]: _Met }]];
var AccessControlAllowOriginsList: StaticListSchema = [1, n0, _ACAOL, 0, [0, { [_xN]: _Or }]];
var AccessControlExposeHeadersList: StaticListSchema = [1, n0, _ACEHL, 0, [0, { [_xN]: _He }]];
var AliasICPRecordals: StaticListSchema = [1, n0, _AICPRl, 0, [() => AliasICPRecordal$, { [_xN]: _AICPR }]];
var AliasList: StaticListSchema = [1, n0, _AL, 0, [0, { [_xN]: _CNAME }]];
var AnycastIpListSummaries: StaticListSchema = [1, n0, _AILSn, 0, [() => AnycastIpListSummary$, { [_xN]: _AILS }]];
var AnycastIps: StaticListSchema = [1, n0, _AI, 0, [0, { [_xN]: _AIn }]];
var AwsAccountNumberList: StaticListSchema = [1, n0, _AANL, 0, [0, { [_xN]: _AAN }]];
var CacheBehaviorList: StaticListSchema = [1, n0, _CBL, 0, [() => CacheBehavior$, { [_xN]: _CB }]];
var CachePolicySummaryList: StaticListSchema = [1, n0, _CPSL, 0, [() => CachePolicySummary$, { [_xN]: _CPS }]];
var CloudFrontOriginAccessIdentitySummaryList: StaticListSchema = [
  1,
  n0,
  _CFOAISL,
  0,
...
var ConflictingAliases: StaticListSchema = [1, n0, _CAon, 0, [() => ConflictingAlias$, { [_xN]: _CA }]];
var ConnectionFunctionSummaryList: StaticListSchema = [
  1,
  n0,
  _CFSL,
  0,
...
var ConnectionGroupSummaryList: StaticListSchema = [1, n0, _CGSL, 0, [() => ConnectionGroupSummary$, { [_xN]: _CGS }]];
var ContentTypeProfileList: StaticListSchema = [1, n0, _CTPL, 0, [() => ContentTypeProfile$, { [_xN]: _CTP }]];
var ContinuousDeploymentPolicySummaryList: StaticListSchema = [
  1,
  n0,
  _CDPSL,
  0,
...
var CookieNameList: StaticListSchema = [1, n0, _CNL, 0, [0, { [_xN]: _N }]];
var CustomErrorResponseList: StaticListSchema = [1, n0, _CERL, 0, [() => CustomErrorResponse$, { [_xN]: _CER }]];
var DistributionIdListSummary: StaticListSchema = [1, n0, _DILS, 0, [0, { [_xN]: _DI }]];
var DistributionIdOwnerItemList: StaticListSchema = [1, n0, _DIOIL, 0, [() => DistributionIdOwner$, { [_xN]: _DIO }]];
var DistributionSummaryList: StaticListSchema = [1, n0, _DSL, 0, [() => DistributionSummary$, { [_xN]: _DS }]];
var DistributionTenantList: StaticListSchema = [1, n0, _DTL, 0, [() => DistributionTenantSummary$, { [_xN]: _DTS }]];
var DnsConfigurationList: StaticListSchema = [1, n0, _DCL, 0, [() => DnsConfiguration$, { [_xN]: _DCn }]];
var DomainConflictsList: StaticListSchema = [1, n0, _DCLo, 0, [() => DomainConflict$, { [_xN]: _DCom }]];
var DomainList: StaticListSchema = [1, n0, _DLo, 0, () => DomainItem$];
var DomainResultList: StaticListSchema = [1, n0, _DRL, 0, () => DomainResult$];
var EncryptionEntityList: StaticListSchema = [1, n0, _EEL, 0, [() => EncryptionEntity$, { [_xN]: _EEn }]];
var EndPointList: StaticListSchema = [1, n0, _EPL, 0, () => EndPoint$];
var FieldLevelEncryptionProfileSummaryList: StaticListSchema = [
  1,
  n0,
  _FLEPSL,
  0,
...
var FieldLevelEncryptionSummaryList: StaticListSchema = [
  1,
  n0,
  _FLESL,
  0,
...
var FieldList: StaticListSchema = [1, n0, _FLi, 0, [0, { [_xN]: _Fie }]];
var FieldPatternList: StaticListSchema = [1, n0, _FPL, 0, [0, { [_xN]: _FPi }]];
var FunctionAssociationList: StaticListSchema = [1, n0, _FAL, 0, [() => FunctionAssociation$, { [_xN]: _FAu }]];
var FunctionExecutionLogList: StaticListSchema = [1, n0, _FELL, 8, 0];
var FunctionSummaryList: StaticListSchema = [1, n0, _FSL, 0, [() => FunctionSummary$, { [_xN]: _FS }]];
var HeaderList: StaticListSchema = [1, n0, _HL, 0, [0, { [_xN]: _N }]];
var InvalidationSummaryList: StaticListSchema = [1, n0, _ISL, 0, [() => InvalidationSummary$, { [_xN]: _ISn }]];
var IpamCidrConfigList: StaticListSchema = [1, n0, _ICCL, 0, [() => IpamCidrConfig$, { [_xN]: _ICCp }]];
var KeyGroupSummaryList: StaticListSchema = [1, n0, _KGSL, 0, [() => KeyGroupSummary$, { [_xN]: _KGS }]];
var KeyPairIdList: StaticListSchema = [1, n0, _KPIL, 0, [0, { [_xN]: _KPIe }]];
var KeyValueStoreAssociationList: StaticListSchema = [
  1,
  n0,
  _KVSAL,
  0,
...
var KeyValueStoreSummaryList: StaticListSchema = [1, n0, _KVSSL, 0, [() => KeyValueStore$, { [_xN]: _KVS }]];
var KGKeyPairIdsList: StaticListSchema = [1, n0, _KGKPIL, 0, [() => KGKeyPairIds$, { [_xN]: _KG }]];
var LambdaFunctionAssociationList: StaticListSchema = [
  1,
  n0,
  _LFAL,
  0,
...
var LocationList: StaticListSchema = [1, n0, _LL, 0, [0, { [_xN]: _L }]];
var MethodsList: StaticListSchema = [1, n0, _ML, 0, [0, { [_xN]: _Met }]];
var OriginAccessControlSummaryList: StaticListSchema = [
  1,
  n0,
  _OACSL,
  0,
...
var OriginCustomHeadersList: StaticListSchema = [1, n0, _OCHL, 0, [() => OriginCustomHeader$, { [_xN]: _OCH }]];
var OriginGroupList: StaticListSchema = [1, n0, _OGL, 0, [() => OriginGroup$, { [_xN]: _OGr }]];
var OriginGroupMemberList: StaticListSchema = [1, n0, _OGML, 0, [() => OriginGroupMember$, { [_xN]: _OGM }]];
var OriginList: StaticListSchema = [1, n0, _OL, 0, [() => Origin$, { [_xN]: _Or }]];
var OriginRequestPolicySummaryList: StaticListSchema = [
  1,
  n0,
  _ORPSL,
  0,
...
var ParameterDefinitions: StaticListSchema = [1, n0, _PDar, 0, [() => ParameterDefinition$, 0]];
var _Parameters: StaticListSchema = [1, n0, _P, 0, () => Parameter$];
var PathList: StaticListSchema = [1, n0, _PL, 0, [0, { [_xN]: _Pat }]];
var PublicKeyIdList: StaticListSchema = [1, n0, _PKIL, 0, [0, { [_xN]: _PK }]];
var PublicKeySummaryList: StaticListSchema = [1, n0, _PKSL, 0, [() => PublicKeySummary$, { [_xN]: _PKS }]];
var QueryArgProfileList: StaticListSchema = [1, n0, _QAPL, 0, [() => QueryArgProfile$, { [_xN]: _QAP }]];
var QueryStringCacheKeysList: StaticListSchema = [1, n0, _QSCKL, 0, [0, { [_xN]: _N }]];
var QueryStringNamesList: StaticListSchema = [1, n0, _QSNL, 0, [0, { [_xN]: _N }]];
var RealtimeLogConfigList: StaticListSchema = [1, n0, _RLCL, 0, [() => RealtimeLogConfig$, 0]];
var ResponseHeadersPolicyCustomHeaderList: StaticListSchema = [
  1,
  n0,
  _RHPCHL,
  0,
...
var ResponseHeadersPolicyRemoveHeaderList: StaticListSchema = [
  1,
  n0,
  _RHPRHL,
  0,
...
var ResponseHeadersPolicySummaryList: StaticListSchema = [
  1,
  n0,
  _RHPSL,
  0,
...
var SignerList: StaticListSchema = [1, n0, _SL, 0, [() => Signer$, { [_xN]: _Si }]];
var SslProtocolsList: StaticListSchema = [1, n0, _SPL, 0, [0, { [_xN]: _SPs }]];
var StagingDistributionDnsNameList: StaticListSchema = [1, n0, _SDDNL, 0, [0, { [_xN]: _DNn }]];
var StatusCodeList: StaticListSchema = [1, n0, _SCL, 0, [1, { [_xN]: _SCta }]];
var StreamingDistributionSummaryList: StaticListSchema = [
  1,
  n0,
  _SDSL,
  0,
...
var TagKeyList: StaticListSchema = [1, n0, _TKL, 0, [0, { [_xN]: _K }]];
var TagList: StaticListSchema = [1, n0, _TL, 0, [() => Tag$, { [_xN]: _Tag }]];
var TrustedKeyGroupIdList: StaticListSchema = [1, n0, _TKGIL, 0, [0, { [_xN]: _KG }]];
