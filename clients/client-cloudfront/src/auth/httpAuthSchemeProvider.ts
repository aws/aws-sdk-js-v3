...
import { type CloudFrontClientResolvedConfig, CloudFrontClientConfig } from "../CloudFrontClient";
 ...
 * @internal
 */
export const defaultCloudFrontHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CloudFrontHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultCloudFrontHttpAuthSchemeProvider: CloudFrontHttpAuthSchemeProvider = (authParameters) => {
