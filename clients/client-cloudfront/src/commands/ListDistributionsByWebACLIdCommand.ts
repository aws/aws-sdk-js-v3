...
import type { ListDistributionsByWebACLIdRequest, ListDistributionsByWebACLIdResult } from "../models/models_1";
 ...
 * @public
 */
export class ListDistributionsByWebACLIdCommand extends command<ListDistributionsByWebACLIdCommandInput, ListDistributionsByWebACLIdCommandOutput>(
  _ep0,
  _mw0,
