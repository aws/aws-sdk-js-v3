 ...
 * @public
 */
export class ListDistributionsByConnectionModeCommand extends command<ListDistributionsByConnectionModeCommandInput, ListDistributionsByConnectionModeCommandOutput>(
  _ep0,
  _mw0,
