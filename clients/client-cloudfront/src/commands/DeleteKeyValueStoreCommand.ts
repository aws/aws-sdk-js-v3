...
import { DeleteKeyValueStore$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteKeyValueStoreCommand extends command<DeleteKeyValueStoreCommandInput, DeleteKeyValueStoreCommandOutput>(
  _ep0,
  _mw0,
  "DeleteKeyValueStore",
  DeleteKeyValueStore$
