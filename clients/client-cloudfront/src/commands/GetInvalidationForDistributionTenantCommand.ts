 ...
 * @public
 */
export class GetInvalidationForDistributionTenantCommand extends command<GetInvalidationForDistributionTenantCommandInput, GetInvalidationForDistributionTenantCommandOutput>(
  _ep0,
  _mw0,
