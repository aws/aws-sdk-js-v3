...
import type { GetResponseHeadersPolicyRequest, GetResponseHeadersPolicyResult } from "../models/models_1";
 ...
 * @public
 */
export class GetResponseHeadersPolicyCommand extends command<GetResponseHeadersPolicyCommandInput, GetResponseHeadersPolicyCommandOutput>(
  _ep0,
  _mw0,
