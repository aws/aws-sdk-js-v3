 ...
 * @public
 */
export class ListDistributionsByRealtimeLogConfigCommand extends command<ListDistributionsByRealtimeLogConfigCommandInput, ListDistributionsByRealtimeLogConfigCommandOutput>(
  _ep0,
  _mw0,
