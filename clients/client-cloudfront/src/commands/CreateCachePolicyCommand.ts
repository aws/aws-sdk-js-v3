...
import type { CreateCachePolicyRequest, CreateCachePolicyResult } from "../models/models_0";
 ...
 * @public
 */
export class CreateCachePolicyCommand extends command<CreateCachePolicyCommandInput, CreateCachePolicyCommandOutput>(
  _ep0,
  _mw0,
  "CreateCachePolicy",
  CreateCachePolicy$
