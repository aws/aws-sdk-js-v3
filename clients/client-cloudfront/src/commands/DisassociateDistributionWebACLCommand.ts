 ...
 * @public
 */
export class DisassociateDistributionWebACLCommand extends command<DisassociateDistributionWebACLCommandInput, DisassociateDistributionWebACLCommandOutput>(
  _ep0,
  _mw0,
