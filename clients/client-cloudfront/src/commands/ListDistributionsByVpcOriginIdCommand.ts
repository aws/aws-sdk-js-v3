 ...
 * @public
 */
export class ListDistributionsByVpcOriginIdCommand extends command<ListDistributionsByVpcOriginIdCommandInput, ListDistributionsByVpcOriginIdCommandOutput>(
  _ep0,
  _mw0,
