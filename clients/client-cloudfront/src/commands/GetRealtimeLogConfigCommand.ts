...
import type { GetRealtimeLogConfigRequest, GetRealtimeLogConfigResult } from "../models/models_1";
 ...
 * @public
 */
export class GetRealtimeLogConfigCommand extends command<GetRealtimeLogConfigCommandInput, GetRealtimeLogConfigCommandOutput>(
  _ep0,
  _mw0,
