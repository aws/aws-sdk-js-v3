 ...
 * @public
 */
export class UpdateCloudFrontOriginAccessIdentityCommand extends command<UpdateCloudFrontOriginAccessIdentityCommandInput, UpdateCloudFrontOriginAccessIdentityCommandOutput>(
  _ep0,
  _mw0,
