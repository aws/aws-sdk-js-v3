 ...
 * @public
 */
export class ListContinuousDeploymentPoliciesCommand extends command<ListContinuousDeploymentPoliciesCommandInput, ListContinuousDeploymentPoliciesCommandOutput>(
  _ep0,
  _mw0,
