 ...
 * @public
 */
export class GetContinuousDeploymentPolicyConfigCommand extends command<GetContinuousDeploymentPolicyConfigCommandInput, GetContinuousDeploymentPolicyConfigCommandOutput>(
  _ep0,
  _mw0,
