 ...
 * @public
 */
export class GetConnectionGroupByRoutingEndpointCommand extends command<GetConnectionGroupByRoutingEndpointCommandInput, GetConnectionGroupByRoutingEndpointCommandOutput>(
  _ep0,
  _mw0,
