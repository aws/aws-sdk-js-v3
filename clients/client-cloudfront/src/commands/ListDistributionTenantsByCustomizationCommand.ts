 ...
 * @public
 */
export class ListDistributionTenantsByCustomizationCommand extends command<ListDistributionTenantsByCustomizationCommandInput, ListDistributionTenantsByCustomizationCommandOutput>(
  _ep0,
  _mw0,
