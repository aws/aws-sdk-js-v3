 ...
 * @public
 */
export class GetFieldLevelEncryptionConfigCommand extends command<GetFieldLevelEncryptionConfigCommandInput, GetFieldLevelEncryptionConfigCommandOutput>(
  _ep0,
  _mw0,
