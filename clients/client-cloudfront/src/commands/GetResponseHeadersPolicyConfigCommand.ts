 ...
 * @public
 */
export class GetResponseHeadersPolicyConfigCommand extends command<GetResponseHeadersPolicyConfigCommandInput, GetResponseHeadersPolicyConfigCommandOutput>(
  _ep0,
  _mw0,
