 ...
 * @public
 */
export class DisassociateDistributionTenantWebACLCommand extends command<DisassociateDistributionTenantWebACLCommandInput, DisassociateDistributionTenantWebACLCommandOutput>(
  _ep0,
  _mw0,
