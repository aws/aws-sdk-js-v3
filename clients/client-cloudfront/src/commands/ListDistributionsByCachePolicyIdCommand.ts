 ...
 * @public
 */
export class ListDistributionsByCachePolicyIdCommand extends command<ListDistributionsByCachePolicyIdCommandInput, ListDistributionsByCachePolicyIdCommandOutput>(
  _ep0,
  _mw0,
