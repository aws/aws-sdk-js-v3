 ...
 * @public
 */
export class DeleteFieldLevelEncryptionConfigCommand extends command<DeleteFieldLevelEncryptionConfigCommandInput, DeleteFieldLevelEncryptionConfigCommandOutput>(
  _ep0,
  _mw0,
