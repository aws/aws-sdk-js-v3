 ...
 * @public
 */
export class CreateInvalidationForDistributionTenantCommand extends command<CreateInvalidationForDistributionTenantCommandInput, CreateInvalidationForDistributionTenantCommandOutput>(
  _ep0,
  _mw0,
