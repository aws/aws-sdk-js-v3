 ...
 * @public
 */
export class UpdateContinuousDeploymentPolicyCommand extends command<UpdateContinuousDeploymentPolicyCommandInput, UpdateContinuousDeploymentPolicyCommandOutput>(
  _ep0,
  _mw0,
