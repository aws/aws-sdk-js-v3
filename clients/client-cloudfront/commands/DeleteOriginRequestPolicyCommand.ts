...
import { DeleteOriginRequestPolicyRequest } from "../models/index";
import {
...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName: "deleteOriginRequestPolicy",
      inputFilterLog: DeleteOriginRequestPolicyRequest.filterSensitiveLog,
