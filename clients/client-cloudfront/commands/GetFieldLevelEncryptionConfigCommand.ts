...
export type GetFieldLevelEncryptionConfigCommandOutput = GetFieldLevelEncryptionConfigResult &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restXmlGetFieldLevelEncryptionConfigCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restXmlGetFieldLevelEncryptionConfigCommand(
      output,
      context
    );
  }
