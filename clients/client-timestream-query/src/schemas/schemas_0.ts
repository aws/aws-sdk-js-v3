...
export var TimestreamQueryServiceException$: StaticErrorSchema = [
  -3,
  _sm,
...
var ColumnInfoList: StaticListSchema = [1, n0, _CIL, 0, () => ColumnInfo$];
var DatumList: StaticListSchema = [1, n0, _DL, 0, () => Datum$];
var DimensionMappingList: StaticListSchema = [1, n0, _DML, 0, () => DimensionMapping$];
var Endpoints: StaticListSchema = [1, n0, _E, 0, () => Endpoint$];
var MixedMeasureMappingList: StaticListSchema = [1, n0, _MMML, 0, () => MixedMeasureMapping$];
var MultiMeasureAttributeMappingList: StaticListSchema = [1, n0, _MMAML, 0, () => MultiMeasureAttributeMapping$];
var ParameterMappingList: StaticListSchema = [1, n0, _PML, 0, () => ParameterMapping$];
var PartitionKeyList = 64 | 0;
var RowList: StaticListSchema = [1, n0, _RL, 0, () => Row$];
var ScheduledQueryList: StaticListSchema = [1, n0, _SQL, 0, () => ScheduledQuery$];
var ScheduledQueryRunSummaryList: StaticListSchema = [1, n0, _SQRSL, 0, () => ScheduledQueryRunSummary$];
var SelectColumnList: StaticListSchema = [1, n0, _SCL, 0, () => SelectColumn$];
var TagKeyList = 64 | 0;
var TagList: StaticListSchema = [1, n0, _TL, 0, () => Tag$];
var TimeSeriesDataPointList: StaticListSchema = [1, n0, _TSDPL, 0, () => TimeSeriesDataPoint$];
...
export var PrepareQuery$: StaticOperationSchema = [
  9,
  n0,
  _PQ,
  2,
