  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<FinspaceClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultFinspaceHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: FinspaceClientResolvedConfig) =>
