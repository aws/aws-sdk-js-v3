...
import type { UpdateKxEnvironmentRequest, UpdateKxEnvironmentResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateKxEnvironmentCommand extends command<UpdateKxEnvironmentCommandInput, UpdateKxEnvironmentCommandOutput>(
  _ep0,
  _mw0,
  "UpdateKxEnvironment",
  UpdateKxEnvironment$
