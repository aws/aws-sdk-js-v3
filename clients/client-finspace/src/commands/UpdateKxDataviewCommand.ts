...
> {
   ...
   * @public
   */
  constructor(readonly input: UpdateKxDataviewCommandInput) {
    super();
  }
  ...
  ): Handler<UpdateKxDataviewCommandInput, UpdateKxDataviewCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, UpdateKxDataviewCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: UpdateKxDataviewCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<UpdateKxDataviewCommandOutput> {
