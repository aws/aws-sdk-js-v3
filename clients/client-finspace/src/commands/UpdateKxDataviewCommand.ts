...
import type { UpdateKxDataviewRequest, UpdateKxDataviewResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateKxDataviewCommand extends command<UpdateKxDataviewCommandInput, UpdateKxDataviewCommandOutput>(
  _ep0,
  _mw0,
  "UpdateKxDataview",
  UpdateKxDataview$
