...
import { DeleteKxEnvironment$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteKxEnvironmentCommand extends command<DeleteKxEnvironmentCommandInput, DeleteKxEnvironmentCommandOutput>(
  _ep0,
  _mw0,
  "DeleteKxEnvironment",
  DeleteKxEnvironment$
