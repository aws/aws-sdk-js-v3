...
> {
   ...
   * @public
   */
  constructor(readonly input: GetKxUserCommandInput) {
   ...
   * @internal
   */
  private serialize(input: GetKxUserCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetKxUserCommandOutput> {
