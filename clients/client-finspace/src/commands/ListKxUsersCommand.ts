...
import type { ListKxUsersRequest, ListKxUsersResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListKxUsersCommand extends command<ListKxUsersCommandInput, ListKxUsersCommandOutput>(
  _ep0,
  _mw0,
  "ListKxUsers",
  ListKxUsers$
