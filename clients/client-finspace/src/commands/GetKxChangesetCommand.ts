...
import type { GetKxChangesetRequest, GetKxChangesetResponse } from "../models/models_0";
import { GetKxChangeset$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetKxChangesetCommand extends command<GetKxChangesetCommandInput, GetKxChangesetCommandOutput>(
  _ep0,
  _mw0,
  "GetKxChangeset",
  GetKxChangeset$
