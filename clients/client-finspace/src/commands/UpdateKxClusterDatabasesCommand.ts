...
import type { UpdateKxClusterDatabasesRequest, UpdateKxClusterDatabasesResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateKxClusterDatabasesCommand extends command<UpdateKxClusterDatabasesCommandInput, UpdateKxClusterDatabasesCommandOutput>(
  _ep0,
  _mw0,
