...
import type { UpdateKxUserRequest, UpdateKxUserResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateKxUserCommand extends command<UpdateKxUserCommandInput, UpdateKxUserCommandOutput>(
  _ep0,
  _mw0,
  "UpdateKxUser",
  UpdateKxUser$
