...
> {
   ...
   * @public
   */
  constructor(readonly input: UpdateKxUserCommandInput) {
   ...
   * @internal
   */
  private serialize(input: UpdateKxUserCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<UpdateKxUserCommandOutput> {
