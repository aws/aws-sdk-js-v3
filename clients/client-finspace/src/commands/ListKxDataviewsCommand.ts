...
import type { ListKxDataviewsRequest, ListKxDataviewsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListKxDataviewsCommand extends command<ListKxDataviewsCommandInput, ListKxDataviewsCommandOutput>(
  _ep0,
  _mw0,
  "ListKxDataviews",
  ListKxDataviews$
