...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteKxClusterCommandInput) {
  ...
  resolveMiddleware(
    ...
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteKxClusterCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: DeleteKxClusterCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_DeleteKxClusterCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<DeleteKxClusterCommandOutput> {
    return de_DeleteKxClusterCommand(output, context);
  }
