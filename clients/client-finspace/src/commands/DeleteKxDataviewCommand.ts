...
import { DeleteKxDataview$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteKxDataviewCommand extends command<DeleteKxDataviewCommandInput, DeleteKxDataviewCommandOutput>(
  _ep0,
  _mw0,
  "DeleteKxDataview",
  DeleteKxDataview$
