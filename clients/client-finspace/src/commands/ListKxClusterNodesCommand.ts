...
import type { ListKxClusterNodesRequest, ListKxClusterNodesResponse } from "../models/models_0";
import { ListKxClusterNodes$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ListKxClusterNodesCommand extends command<ListKxClusterNodesCommandInput, ListKxClusterNodesCommandOutput>(
  _ep0,
  _mw0,
  "ListKxClusterNodes",
  ListKxClusterNodes$
