...
> {
   ...
   * @public
   */
  constructor(readonly input: ListKxClusterNodesCommandInput) {
  ...
  resolveMiddleware(
    ...
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListKxClusterNodesCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: ListKxClusterNodesCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<ListKxClusterNodesCommandOutput> {
