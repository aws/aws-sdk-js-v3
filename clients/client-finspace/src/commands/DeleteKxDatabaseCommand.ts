...
> {
  ...
  resolveMiddleware(
    ...
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteKxDatabaseCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: DeleteKxDatabaseCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_DeleteKxDatabaseCommand(input, context);
  }
