...
import { CreateKxCluster$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CreateKxClusterCommand extends command<CreateKxClusterCommandInput, CreateKxClusterCommandOutput>(
  _ep0,
  _mw0,
  "CreateKxCluster",
  CreateKxCluster$
