 ...
 * @public
 */
export class UpdatePullRequestApprovalStateCommand extends command<UpdatePullRequestApprovalStateCommandInput, UpdatePullRequestApprovalStateCommandOutput>(
  _ep0,
  _mw0,
