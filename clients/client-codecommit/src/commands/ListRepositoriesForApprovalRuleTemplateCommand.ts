 ...
 * ```
 *
 * @param ListRepositoriesForApprovalRuleTemplateInput - {@link ListRepositoriesForApprovalRuleTemplateInput}
 * @returns {@link ListRepositoriesForApprovalRuleTemplateOutput}
