...
import type { UpdateRepositoryNameInput } from "../models/models_0";
 ...
 * @public
 */
export class UpdateRepositoryNameCommand extends command<UpdateRepositoryNameCommandInput, UpdateRepositoryNameCommandOutput>(
  _ep0,
  _mw0,
