...
import {
  ...
  CommitDoesNotExistException as __CommitDoesNotExistException,
  ...
  EncryptionIntegrityChecksFailedException as __EncryptionIntegrityChecksFailedException,
  EncryptionKeyAccessDeniedException as __EncryptionKeyAccessDeniedException,
  EncryptionKeyDisabledException as __EncryptionKeyDisabledException,
  ...
  EncryptionKeyNotFoundException as __EncryptionKeyNotFoundException,
  EncryptionKeyRequiredException as __EncryptionKeyRequiredException,
  EncryptionKeyUnavailableException as __EncryptionKeyUnavailableException,
  ...
  FileDoesNotExistException as __FileDoesNotExistException,
  ...
  FolderDoesNotExistException as __FolderDoesNotExistException,
  ...
  InvalidCommitException as __InvalidCommitException,
  InvalidCommitIdException as __InvalidCommitIdException,
  InvalidConflictDetailLevelException as __InvalidConflictDetailLevelException,
  ...
  InvalidContinuationTokenException as __InvalidContinuationTokenException,
  ...
  InvalidPathException as __InvalidPathException,
  InvalidPullRequestEventTypeException as __InvalidPullRequestEventTypeException,
  InvalidPullRequestIdException as __InvalidPullRequestIdException,
  InvalidPullRequestStatusException as __InvalidPullRequestStatusException,
  ...
  InvalidRepositoryDescriptionException as __InvalidRepositoryDescriptionException,
  InvalidRepositoryNameException as __InvalidRepositoryNameException,
  ...
  InvalidRuleContentSha256Exception as __InvalidRuleContentSha256Exception,
  ...
  MaximumFileContentToLoadExceededException as __MaximumFileContentToLoadExceededException,
  MaximumFileEntriesExceededException as __MaximumFileEntriesExceededException,
  MaximumItemsToCompareExceededException as __MaximumItemsToCompareExceededException,
  ...
  PathRequiredException as __PathRequiredException,
  ...
  PullRequestDoesNotExistException as __PullRequestDoesNotExistException,
  ...
  RepositoryDoesNotExistException as __RepositoryDoesNotExistException,
  RepositoryLimitExceededException as __RepositoryLimitExceededException,
  RepositoryNameExistsException as __RepositoryNameExistsException,
  RepositoryNameRequiredException as __RepositoryNameRequiredException,
...
export var BatchDescribeMergeConflictsErrors: StaticListSchema = [
  1,
  n0,
  _BDMCEa,
  0,
...
export var BatchDisassociateApprovalRuleTemplateFromRepositoriesErrorsList: StaticListSchema = [
  1,
  n0,
  _BDARTFREL,
  0,
...
export var DeleteFileEntries: StaticListSchema = [1, n0, _DFEe, 0, () => DeleteFileEntry];
...
export var UpdateComment: StaticOperationSchema = [9, n0, _UC, 0, () => UpdateCommentInput, () => UpdateCommentOutput];
export var UpdateDefaultBranch: StaticOperationSchema = [9, n0, _UDB, 0, () => UpdateDefaultBranchInput, () => __Unit];
