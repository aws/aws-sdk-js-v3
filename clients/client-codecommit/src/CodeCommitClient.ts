 ...
 * @public
 */
export type CodeCommitClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultCodeCommitHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: CodeCommitClientResolvedConfig) =>
