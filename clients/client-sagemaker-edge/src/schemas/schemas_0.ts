...
var Definitions: StaticListSchema = [1, n0, _De, 0, () => Definition$];
var DeploymentModels: StaticListSchema = [1, n0, _DMe, 0, () => DeploymentModel$];
var EdgeDeployments: StaticListSchema = [1, n0, _EDd, 0, () => EdgeDeployment$];
var EdgeMetrics: StaticListSchema = [1, n0, _EMd, 0, () => EdgeMetric$];
var Models: StaticListSchema = [1, n0, _Mod, 0, () => Model$];
