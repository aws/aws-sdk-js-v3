...
import {
  ...
  defaultKeyspacesStreamsHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type KeyspacesStreamsClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type KeyspacesStreamsClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 */
export class KeyspacesStreamsClient extends __Client<
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<KeyspacesStreamsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultKeyspacesStreamsHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: KeyspacesStreamsClientResolvedConfig) =>
