...
import { type KeyspacesStreamsClientResolvedConfig, KeyspacesStreamsClientConfig } from "../KeyspacesStreamsClient";
 ...
 * @internal
 */
export const defaultKeyspacesStreamsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: KeyspacesStreamsHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<KeyspacesStreamsClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
