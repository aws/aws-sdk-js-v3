...
export var GetStreamInput$: StaticStructureSchema = [
  3,
  n0,
  _GSI,
  0,
...
var KeyspacesCellList: StaticListSchema = [1, n0, _KCL, 0, () => KeyspacesCell$];
var KeyspacesCellMap: StaticListSchema = [1, n0, _KCM, 0, () => KeyspacesCellMapDefinition$];
...
var StreamList: StaticListSchema = [1, n0, _SL, 0, () => _Stream$];
