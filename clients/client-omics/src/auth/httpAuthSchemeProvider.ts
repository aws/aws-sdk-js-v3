...
import { OmicsClientConfig, OmicsClientResolvedConfig } from "../OmicsClient";
 ...
 * @internal
 */
export const defaultOmicsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: OmicsHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultOmicsHttpAuthSchemeProvider: OmicsHttpAuthSchemeProvider = (authParameters) => {
