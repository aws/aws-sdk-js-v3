...
import type { UpdateAnnotationStoreRequest, UpdateAnnotationStoreResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateAnnotationStoreCommand extends command<UpdateAnnotationStoreCommandInput, UpdateAnnotationStoreCommandOutput>(
  _ep0,
  _mw0,
