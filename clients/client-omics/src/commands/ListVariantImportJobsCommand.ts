...
import type { ListVariantImportJobsRequest, ListVariantImportJobsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListVariantImportJobsCommand extends command<ListVariantImportJobsCommandInput, ListVariantImportJobsCommandOutput>(
  _ep0,
  _mw0,
