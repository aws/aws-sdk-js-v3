...
import type { GetVariantStoreRequest, GetVariantStoreResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetVariantStoreCommand extends command<GetVariantStoreCommandInput, GetVariantStoreCommandOutput>(
  _ep0,
  _mw0,
  "GetVariantStore",
  GetVariantStore$
