 ...
 * @public
 */
export class CompleteMultipartReadSetUploadCommand extends command<CompleteMultipartReadSetUploadCommandInput, CompleteMultipartReadSetUploadCommandOutput>(
  _ep0,
  _mw0,
