...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteShareCommandInput) {
   ...
   * @internal
   */
  private serialize(input: DeleteShareCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<DeleteShareCommandOutput> {
