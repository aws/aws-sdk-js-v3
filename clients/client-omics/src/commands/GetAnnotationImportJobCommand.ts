...
import type { GetAnnotationImportRequest, GetAnnotationImportResponse } from "../models/models_0";
import { GetAnnotationImportJob$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetAnnotationImportJobCommand extends command<GetAnnotationImportJobCommandInput, GetAnnotationImportJobCommandOutput>(
  _ep0,
  _mw0,
