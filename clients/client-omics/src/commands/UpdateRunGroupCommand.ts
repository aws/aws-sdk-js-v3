...
import type { UpdateRunGroupRequest } from "../models/models_0";
 ...
 * @public
 */
export class UpdateRunGroupCommand extends command<UpdateRunGroupCommandInput, UpdateRunGroupCommandOutput>(
  _ep0,
  _mw0,
  "UpdateRunGroup",
  UpdateRunGroup$
