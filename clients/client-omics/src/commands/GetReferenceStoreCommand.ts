...
import type { GetReferenceStoreRequest, GetReferenceStoreResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetReferenceStoreCommand extends command<GetReferenceStoreCommandInput, GetReferenceStoreCommandOutput>(
  _ep0,
  _mw0,
  "GetReferenceStore",
  GetReferenceStore$
