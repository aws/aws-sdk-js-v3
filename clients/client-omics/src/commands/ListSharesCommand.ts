...
import type { ListSharesRequest, ListSharesResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListSharesCommand extends command<ListSharesCommandInput, ListSharesCommandOutput>(
  _ep0,
  _mw0,
  "ListShares",
  ListShares$
