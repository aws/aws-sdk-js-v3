...
import type { ListReferenceImportJobsRequest, ListReferenceImportJobsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListReferenceImportJobsCommand extends command<ListReferenceImportJobsCommandInput, ListReferenceImportJobsCommandOutput>(
  _ep0,
  _mw0,
