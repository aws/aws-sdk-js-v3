...
import type { ListVariantStoresRequest, ListVariantStoresResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListVariantStoresCommand extends command<ListVariantStoresCommandInput, ListVariantStoresCommandOutput>(
  _ep0,
  _mw0,
  "ListVariantStores",
  ListVariantStores$
