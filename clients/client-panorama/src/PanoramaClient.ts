...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<PanoramaClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultPanoramaHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: PanoramaClientResolvedConfig) =>
