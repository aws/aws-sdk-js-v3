...
async function deserializeAws_restJson1_1BatchExecuteStatementCommandError(
  ...
  switch (errorCode) {
    ...
    case "com.amazon.rdsdataservice#BadRequestException":
      response = await deserializeAws_restJson1_1BadRequestExceptionResponse(errorOutput, context);
      break;
    case "ForbiddenException":
    case "com.amazon.rdsdataservice#ForbiddenException":
      response = await deserializeAws_restJson1_1ForbiddenExceptionResponse(errorOutput, context);
      break;
    case "InternalServerErrorException":
    case "com.amazon.rdsdataservice#InternalServerErrorException":
      response = await deserializeAws_restJson1_1InternalServerErrorExceptionResponse(errorOutput, context);
      break;
    case "ServiceUnavailableError":
    case "com.amazon.rdsdataservice#ServiceUnavailableError":
      response = await deserializeAws_restJson1_1ServiceUnavailableErrorResponse(errorOutput, context);
      break;
    case "StatementTimeoutException":
    case "com.amazon.rdsdataservice#StatementTimeoutException":
      response = await deserializeAws_restJson1_1StatementTimeoutExceptionResponse(errorOutput, context);
      break;
    default:
...
async function deserializeAws_restJson1_1CommitTransactionCommandError(
  ...
  switch (errorCode) {
    ...
    case "com.amazon.rdsdataservice#NotFoundException":
      response = await deserializeAws_restJson1_1NotFoundExceptionResponse(errorOutput, context);
      break;
    case "ServiceUnavailableError":
    case "com.amazon.rdsdataservice#ServiceUnavailableError":
      response = await deserializeAws_restJson1_1ServiceUnavailableErrorResponse(errorOutput, context);
