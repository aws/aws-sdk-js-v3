 ...
 * @public
 */
export class CreateApplicationPresignedUrlCommand extends command<CreateApplicationPresignedUrlCommandInput, CreateApplicationPresignedUrlCommandOutput>(
  _ep0,
  _mw0,
