...
import type { GetEndpointAccessRequest, GetEndpointAccessResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetEndpointAccessCommand extends command<GetEndpointAccessCommandInput, GetEndpointAccessCommandOutput>(
  _ep0,
  _mw0,
  "GetEndpointAccess",
  GetEndpointAccess$
