 ...
 * @public
 */
export class RestoreTableFromRecoveryPointCommand extends command<RestoreTableFromRecoveryPointCommandInput, RestoreTableFromRecoveryPointCommandOutput>(
  _ep0,
  _mw0,
