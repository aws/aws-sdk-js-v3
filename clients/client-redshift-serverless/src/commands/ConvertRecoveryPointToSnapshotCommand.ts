 ...
 * @public
 */
export class ConvertRecoveryPointToSnapshotCommand extends command<ConvertRecoveryPointToSnapshotCommandInput, ConvertRecoveryPointToSnapshotCommandOutput>(
  _ep0,
  _mw0,
