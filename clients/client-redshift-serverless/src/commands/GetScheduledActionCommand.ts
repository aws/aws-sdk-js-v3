...
import type { GetScheduledActionRequest, GetScheduledActionResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetScheduledActionCommand extends command<GetScheduledActionCommandInput, GetScheduledActionCommandOutput>(
  _ep0,
  _mw0,
  "GetScheduledAction",
  GetScheduledAction$
