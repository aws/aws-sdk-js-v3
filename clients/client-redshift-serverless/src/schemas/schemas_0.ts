...
export var ConvertRecoveryPointToSnapshotResponse$: StaticStructureSchema = [
  3,
  n0,
  _CRPTSRo,
  0,
...
var AssociationList: StaticListSchema = [1, n0, _AL, 0, () => Association$];
var ConfigParameterList: StaticListSchema = [1, n0, _CPL, 0, () => ConfigParameter$];
var EndpointAccessList: StaticListSchema = [1, n0, _EAL, 0, () => EndpointAccess$];
var IamRoleArnList = 64 | 0;
var LogExportList = 64 | 0;
var ManagedWorkgroups: StaticListSchema = [1, n0, _MW, 0, () => ManagedWorkgroupListItem$];
...
var RecoveryPointList: StaticListSchema = [1, n0, _RPL, 0, () => RecoveryPoint$];
var ReservationOfferingsList: StaticListSchema = [1, n0, _ROL, 0, () => ReservationOffering$];
var ReservationsList: StaticListSchema = [1, n0, _RL, 0, () => Reservation$];
var ScheduledActionsList: StaticListSchema = [1, n0, _SAL, 0, () => ScheduledActionAssociation$];
var SecurityGroupIdList = 64 | 0;
var SnapshotCopyConfigurations: StaticListSchema = [1, n0, _SCCn, 0, () => SnapshotCopyConfiguration$];
var SnapshotList: StaticListSchema = [1, n0, _SL, 0, () => Snapshot$];
var SubnetIdList = 64 | 0;
var TableRestoreStatusList: StaticListSchema = [1, n0, _TRSL, 0, () => TableRestoreStatus$];
var TagKeyList = 64 | 0;
var TagList: StaticListSchema = [1, n0, _TL, 0, () => Tag$];
var TrackList: StaticListSchema = [1, n0, _TLr, 0, () => ServerlessTrack$];
var UpdateTargetsList: StaticListSchema = [1, n0, _UTL, 0, () => UpdateTarget$];
var UsageLimits: StaticListSchema = [1, n0, _ULs, 0, () => UsageLimit$];
var VpcEndpointList: StaticListSchema = [1, n0, _VEL, 0, () => VpcEndpoint$];
var VpcIds = 64 | 0;
...
export var GetWorkgroup$: StaticOperationSchema = [
  9,
  n0,
  _GW,
  0,
