...
export var ConfigParameter$: StaticStructureSchema = [3, n0, _CP,
  0,
  [_pK, _pV],
  [0, 0]
];
...
export var GetCredentialsRequest$: StaticStructureSchema = [3, n0, _GCR,
  0,
  [_dN, _dS, _wN, _cDN],
  [0, 1, 0, 0]
];
export var GetCredentialsResponse$: StaticStructureSchema = [3, n0, _GCRe,
  0,
  [_dU, _dP, _ex, _nRT],
...
export var GetSnapshotRequest$: StaticStructureSchema = [3, n0, _GSR,
  0,
  [_sN, _oA, _sAn],
  [0, 0, 0]
];
...
export var ListCustomDomainAssociationsResponse$: StaticStructureSchema = [3, n0, _LCDARi,
  0,
  [_nT, _as],
  [0, () => AssociationList]
];
export var ListEndpointAccessRequest$: StaticStructureSchema = [3, n0, _LEAR,
  0,
  [_nT, _mR, _wN, _vI, _oA],
...
export var ListManagedWorkgroupsResponse$: StaticStructureSchema = [3, n0, _LMWRi,
  0,
  [_nT, _mW],
  [0, () => ManagedWorkgroups]
];
...
export var ListRecoveryPointsResponse$: StaticStructureSchema = [3, n0, _LRPRi,
  0,
  [_rPec, _nT],
  [() => RecoveryPointList, 0]
];
export var ListReservationOfferingsRequest$: StaticStructureSchema = [3, n0, _LROR,
  0,
  [_nT, _mR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
...
export var ListSnapshotCopyConfigurationsRequest$: StaticStructureSchema = [3, n0, _LSCCR,
  0,
  [_nN, _nT, _mR],
  [0, [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
...
export var ListTableRestoreStatusResponse$: StaticStructureSchema = [3, n0, _LTRSRi,
  0,
  [_nT, _tRSa],
...
export var ListTracksRequest$: StaticStructureSchema = [3, n0, _LTR,
  0,
  [_nT, _mR],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListTracksResponse$: StaticStructureSchema = [3, n0, _LTRi,
  0,
  [_tra, _nT],
  [() => TrackList, 0]
];
export var ListUsageLimitsRequest$: StaticStructureSchema = [3, n0, _LULR,
  0,
  [_rAe, _uT, _nT, _mR],
  [0, 0, [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListUsageLimitsResponse$: StaticStructureSchema = [3, n0, _LULRi,
  0,
  [_uLs, _nT],
  [() => UsageLimits, 0]
];
export var ListWorkgroupsRequest$: StaticStructureSchema = [3, n0, _LWR,
  0,
  [_nT, _mR, _oA],
  [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }], 0]
];
...
export var PerformanceTarget$: StaticStructureSchema = [3, n0, _PT,
  0,
  [_st, _l],
  [0, 1]
];
...
export var ReservationOffering$: StaticStructureSchema = [3, n0, _RO,
  0,
...
export var ScheduledActionResponse$: StaticStructureSchema = [3, n0, _SAR,
  0,
  [_sAN, _sc, _sAD, _nIe, _rA, _sta, _sT, _eT, _tA, _nN, _sAU],
  [0, () => Schedule$, 0, 64 | 4, 0, 0, 4, 4, () => TargetAction$, 0, 0]
];
export var ServerlessTrack$: StaticStructureSchema = [3, n0, _ST,
  0,
  [_tN, _wV, _uTp],
...
export var SnapshotCopyConfiguration$: StaticStructureSchema = [3, n0, _SCC,
  0,
...
var ConfigParameterList: StaticListSchema = [1, n0, _CPL,
  0, () => ConfigParameter$
];
var EndpointAccessList: StaticListSchema = [1, n0, _EAL,
  0, () => EndpointAccess$
];
var IamRoleArnList = 64 | 0;
var LogExportList = 64 | 0;
var ManagedWorkgroups: StaticListSchema = [1, n0, _MW,
...
var RecoveryPointList: StaticListSchema = [1, n0, _RPL,
  0, () => RecoveryPoint$
];
var ReservationOfferingsList: StaticListSchema = [1, n0, _ROL,
...
var SnapshotCopyConfigurations: StaticListSchema = [1, n0, _SCCn,
...
var UpdateTargetsList: StaticListSchema = [1, n0, _UTL,
  0, () => UpdateTarget$
];
var UsageLimits: StaticListSchema = [1, n0, _ULs,
  0, () => UsageLimit$
];
var VpcEndpointList: StaticListSchema = [1, n0, _VEL,
  0, () => VpcEndpoint$
];
var VpcIds = 64 | 0;
...
var WorkgroupList: StaticListSchema = [1, n0, _WL,
  0, () => Workgroup$
];
...
export var TargetAction$: StaticUnionSchema = [4, n0, _TA,
  0,
  [_cS],
  [() => CreateSnapshotScheduleActionParameters$]
];
export var ConvertRecoveryPointToSnapshot$: StaticOperationSchema = [9, n0, _CRPTS,
...
export var CreateReservation$: StaticOperationSchema = [9, n0, _CR,
...
export var CreateSnapshot$: StaticOperationSchema = [9, n0, _CS,
  2, () => CreateSnapshotRequest$, () => CreateSnapshotResponse$
];
export var CreateSnapshotCopyConfiguration$: StaticOperationSchema = [9, n0, _CSCC,
...
export var CreateWorkgroup$: StaticOperationSchema = [9, n0, _CW,
...
export var DeleteEndpointAccess$: StaticOperationSchema = [9, n0, _DEA,
...
export var DeleteSnapshot$: StaticOperationSchema = [9, n0, _DS,
  2, () => DeleteSnapshotRequest$, () => DeleteSnapshotResponse$
];
export var DeleteSnapshotCopyConfiguration$: StaticOperationSchema = [9, n0, _DSCC,
...
export var DeleteWorkgroup$: StaticOperationSchema = [9, n0, _DW,
  2, () => DeleteWorkgroupRequest$, () => DeleteWorkgroupResponse$
];
export var GetCredentials$: StaticOperationSchema = [9, n0, _GC,
  0, () => GetCredentialsRequest$, () => GetCredentialsResponse$
];
export var GetCustomDomainAssociation$: StaticOperationSchema = [9, n0, _GCDA,
  0, () => GetCustomDomainAssociationRequest$, () => GetCustomDomainAssociationResponse$
];
export var GetEndpointAccess$: StaticOperationSchema = [9, n0, _GEA,
...
export var GetRecoveryPoint$: StaticOperationSchema = [9, n0, _GRP,
  0, () => GetRecoveryPointRequest$, () => GetRecoveryPointResponse$
];
export var GetReservation$: StaticOperationSchema = [9, n0, _GR,
  0, () => GetReservationRequest$, () => GetReservationResponse$
];
export var GetReservationOffering$: StaticOperationSchema = [9, n0, _GRO,
...
export var GetScheduledAction$: StaticOperationSchema = [9, n0, _GSA,
  0, () => GetScheduledActionRequest$, () => GetScheduledActionResponse$
];
export var GetSnapshot$: StaticOperationSchema = [9, n0, _GS,
  0, () => GetSnapshotRequest$, () => GetSnapshotResponse$
];
export var GetTableRestoreStatus$: StaticOperationSchema = [9, n0, _GTRS,
  0, () => GetTableRestoreStatusRequest$, () => GetTableRestoreStatusResponse$
];
export var GetTrack$: StaticOperationSchema = [9, n0, _GT,
  0, () => GetTrackRequest$, () => GetTrackResponse$
];
export var GetUsageLimit$: StaticOperationSchema = [9, n0, _GUL,
  0, () => GetUsageLimitRequest$, () => GetUsageLimitResponse$
];
export var GetWorkgroup$: StaticOperationSchema = [9, n0, _GW,
  0, () => GetWorkgroupRequest$, () => GetWorkgroupResponse$
];
export var ListCustomDomainAssociations$: StaticOperationSchema = [9, n0, _LCDA,
  0, () => ListCustomDomainAssociationsRequest$, () => ListCustomDomainAssociationsResponse$
];
export var ListEndpointAccess$: StaticOperationSchema = [9, n0, _LEA,
  0, () => ListEndpointAccessRequest$, () => ListEndpointAccessResponse$
];
export var ListManagedWorkgroups$: StaticOperationSchema = [9, n0, _LMW,
...
export var ListRecoveryPoints$: StaticOperationSchema = [9, n0, _LRP,
  0, () => ListRecoveryPointsRequest$, () => ListRecoveryPointsResponse$
];
export var ListReservationOfferings$: StaticOperationSchema = [9, n0, _LRO,
...
export var ListScheduledActions$: StaticOperationSchema = [9, n0, _LSA,
  0, () => ListScheduledActionsRequest$, () => ListScheduledActionsResponse$
];
export var ListSnapshotCopyConfigurations$: StaticOperationSchema = [9, n0, _LSCC,
  0, () => ListSnapshotCopyConfigurationsRequest$, () => ListSnapshotCopyConfigurationsResponse$
];
export var ListSnapshots$: StaticOperationSchema = [9, n0, _LS,
  0, () => ListSnapshotsRequest$, () => ListSnapshotsResponse$
];
export var ListTableRestoreStatus$: StaticOperationSchema = [9, n0, _LTRS,
  0, () => ListTableRestoreStatusRequest$, () => ListTableRestoreStatusResponse$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceRequest$, () => ListTagsForResourceResponse$
];
export var ListTracks$: StaticOperationSchema = [9, n0, _LT,
  0, () => ListTracksRequest$, () => ListTracksResponse$
];
export var ListUsageLimits$: StaticOperationSchema = [9, n0, _LUL,
  0, () => ListUsageLimitsRequest$, () => ListUsageLimitsResponse$
];
export var ListWorkgroups$: StaticOperationSchema = [9, n0, _LW,
...
export var RestoreFromRecoveryPoint$: StaticOperationSchema = [9, n0, _RFRP,
...
export var RestoreTableFromRecoveryPoint$: StaticOperationSchema = [9, n0, _RTFRP,
  0, () => RestoreTableFromRecoveryPointRequest$, () => RestoreTableFromRecoveryPointResponse$
];
export var RestoreTableFromSnapshot$: StaticOperationSchema = [9, n0, _RTFS,
...
export var UpdateCustomDomainAssociation$: StaticOperationSchema = [9, n0, _UCDA,
  0, () => UpdateCustomDomainAssociationRequest$, () => UpdateCustomDomainAssociationResponse$
];
export var UpdateEndpointAccess$: StaticOperationSchema = [9, n0, _UEA,
  0, () => UpdateEndpointAccessRequest$, () => UpdateEndpointAccessResponse$
];
export var UpdateLakehouseConfiguration$: StaticOperationSchema = [9, n0, _ULC,
  0, () => UpdateLakehouseConfigurationRequest$, () => UpdateLakehouseConfigurationResponse$
];
export var UpdateNamespace$: StaticOperationSchema = [9, n0, _UN,
  0, () => UpdateNamespaceRequest$, () => UpdateNamespaceResponse$
];
export var UpdateScheduledAction$: StaticOperationSchema = [9, n0, _USA,
...
export var UpdateSnapshotCopyConfiguration$: StaticOperationSchema = [9, n0, _USCC,
  0, () => UpdateSnapshotCopyConfigurationRequest$, () => UpdateSnapshotCopyConfigurationResponse$
];
export var UpdateUsageLimit$: StaticOperationSchema = [9, n0, _UUL,
  0, () => UpdateUsageLimitRequest$, () => UpdateUsageLimitResponse$
];
export var UpdateWorkgroup$: StaticOperationSchema = [9, n0, _UW,
