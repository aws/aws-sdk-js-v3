...
const deserializeAws_json1_1CreateUsageLimitResponse = (
  ...
  return {
    usageLimit:
      output.usageLimit !== undefined && output.usageLimit !== null
...
const deserializeAws_json1_1Endpoint = (output: any, context: __SerdeContext): Endpoint => {
  return {
    ...
    vpcEndpoints:
      output.vpcEndpoints !== undefined && output.vpcEndpoints !== null
...
const deserializeAws_json1_1EndpointAccess = (output: any, context: __SerdeContext): EndpointAccess => {
  return {
    ...
    endpointCreateTime:
      output.endpointCreateTime !== undefined && output.endpointCreateTime !== null
  ...
  return {
    ...
    expiration:
      output.expiration !== undefined && output.expiration !== null
        ...
        : undefined,
    nextRefreshTime:
      output.nextRefreshTime !== undefined && output.nextRefreshTime !== null
...
const deserializeAws_json1_1GetRecoveryPointResponse = (
  ...
  return {
    recoveryPoint:
      output.recoveryPoint !== undefined && output.recoveryPoint !== null
...
const deserializeAws_json1_1ListRecoveryPointsResponse = (
  ...
  return {
    nextToken: __expectString(output.nextToken),
    recoveryPoints:
      output.recoveryPoints !== undefined && output.recoveryPoints !== null
...
const deserializeAws_json1_1ListUsageLimitsResponse = (
  ...
  return {
    nextToken: __expectString(output.nextToken),
    usageLimits:
      output.usageLimits !== undefined && output.usageLimits !== null
...
const deserializeAws_json1_1Namespace = (output: any, context: __SerdeContext): Namespace => {
  return {
    ...
    logExports:
      output.logExports !== undefined && output.logExports !== null
...
const deserializeAws_json1_1RecoveryPoint = (output: any, context: __SerdeContext): RecoveryPoint => {
  return {
    ...
    recoveryPointCreateTime:
      output.recoveryPointCreateTime !== undefined && output.recoveryPointCreateTime !== null
...
const deserializeAws_json1_1Snapshot = (output: any, context: __SerdeContext): Snapshot => {
  return {
    accountsWithProvisionedRestoreAccess:
      output.accountsWithProvisionedRestoreAccess !== undefined && output.accountsWithProvisionedRestoreAccess !== null
        ? deserializeAws_json1_1AccountIdList(output.accountsWithProvisionedRestoreAccess, context)
        : undefined,
    accountsWithRestoreAccess:
      output.accountsWithRestoreAccess !== undefined && output.accountsWithRestoreAccess !== null
    ...
    snapshotRetentionStartTime:
      output.snapshotRetentionStartTime !== undefined && output.snapshotRetentionStartTime !== null
...
const deserializeAws_json1_1Workgroup = (output: any, context: __SerdeContext): Workgroup => {
  return {
    ...
    configParameters:
      output.configParameters !== undefined && output.configParameters !== null
