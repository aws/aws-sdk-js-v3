...
import {
  type RedshiftServerlessClientResolvedConfig,
 ...
 * @internal
 */
export const defaultRedshiftServerlessHttpAuthSchemeProvider: RedshiftServerlessHttpAuthSchemeProvider = (authParameters) => {
