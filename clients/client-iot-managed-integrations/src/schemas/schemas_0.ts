...
export var AbortConfigCriteria$: StaticStructureSchema = [3, n0, _ACC,
  0,
  [_A, _FT, _MNOET, _TP],
  [0, 0, 1, 1]
];
...
export var CreateCredentialLockerRequest$: StaticStructureSchema = [3, n0, _CCLR,
  0,
  [_N, _CT, _Ta],
  [[() => CredentialLockerName, 0], [0, 4], [() => TagsMap, 0]]
];
export var CreateCredentialLockerResponse$: StaticStructureSchema = [3, n0, _CCLRr,
  0,
  [_I, _Ar, _CAr],
  [0, 0, 4]
];
...
export var CreateOtaTaskConfigurationRequest$: StaticStructureSchema = [3, n0, _COTCR,
  0,
  [_D, _N, _PC, _CT],
  [0, [() => OtaTaskConfigurationName, 0], () => PushConfig$, [0, 4]]
];
export var CreateOtaTaskConfigurationResponse$: StaticStructureSchema = [3, n0, _COTCRr,
  0,
  [_TCI],
  [0]
];
...
export var EventLogConfigurationSummary$: StaticStructureSchema = [3, n0, _ELCS,
  0,
  [_I, _RT, _RI, _ELL],
  [0, 0, 0, 0]
];
...
export var GetCustomEndpointRequest$: StaticStructureSchema = [3, n0, _GCER,
  0,
  [],
  []
];
...
export var GetHubConfigurationRequest$: StaticStructureSchema = [3, n0, _GHCR,
  0,
  [],
  []
];
export var GetHubConfigurationResponse$: StaticStructureSchema = [3, n0, _GHCRe,
  0,
  [_HTTESIS, _UA],
  [1, 4]
];
...
export var ListAccountAssociationsResponse$: StaticStructureSchema = [3, n0, _LAARi,
  0,
  [_It, _NT],
...
export var ListCloudConnectorsResponse$: StaticStructureSchema = [3, n0, _LCCRi,
  0,
  [_It, _NT],
  [() => ConnectorList, 0]
];
export var ListConnectorDestinationsRequest$: StaticStructureSchema = [3, n0, _LCDR,
  0,
  [_CCI, _NT, _MR],
  [[0, { [_hQ]: _CCI }], [0, { [_hQ]: _NT }], [1, { [_hQ]: _MR }]]
];
export var ListConnectorDestinationsResponse$: StaticStructureSchema = [3, n0, _LCDRi,
  0,
  [_CDL, _NT],
  [() => ConnectorDestinationListDefinition, 0]
];
export var ListCredentialLockersRequest$: StaticStructureSchema = [3, n0, _LCLR,
  0,
  [_NT, _MR],
  [[0, { [_hQ]: _NT }], [1, { [_hQ]: _MR }]]
];
export var ListCredentialLockersResponse$: StaticStructureSchema = [3, n0, _LCLRi,
  0,
  [_It, _NT],
  [[() => CredentialLockerListDefinition, 0], 0]
];
export var ListDestinationsRequest$: StaticStructureSchema = [3, n0, _LDR,
  0,
  [_NT, _MR],
  [[0, { [_hQ]: _NT }], [1, { [_hQ]: _MR }]]
];
export var ListDestinationsResponse$: StaticStructureSchema = [3, n0, _LDRi,
  0,
  [_DL, _NT],
  [() => DestinationListDefinition, 0]
];
export var ListDeviceDiscoveriesRequest$: StaticStructureSchema = [3, n0, _LDDR,
  0,
  [_NT, _MR, _TF, _SF],
  [[0, { [_hQ]: _NT }], [1, { [_hQ]: _MR }], [0, { [_hQ]: _TF }], [0, { [_hQ]: _SF }]]
];
export var ListDeviceDiscoveriesResponse$: StaticStructureSchema = [3, n0, _LDDRi,
  0,
  [_It, _NT],
...
export var ListEventLogConfigurationsRequest$: StaticStructureSchema = [3, n0, _LELCR,
  0,
  [_NT, _MR],
  [[0, { [_hQ]: _NT }], [1, { [_hQ]: _MR }]]
];
export var ListEventLogConfigurationsResponse$: StaticStructureSchema = [3, n0, _LELCRi,
  0,
  [_ELCL, _NT],
  [() => EventLogConfigurationListDefinition, 0]
];
export var ListManagedThingAccountAssociationsRequest$: StaticStructureSchema = [3, n0, _LMTAAR,
  0,
  [_MTI, _AAIc, _MR, _NT],
  [[0, { [_hQ]: _MTI }], [0, { [_hQ]: _AAIc }], [1, { [_hQ]: _MR }], [0, { [_hQ]: _NT }]]
];
export var ListManagedThingAccountAssociationsResponse$: StaticStructureSchema = [3, n0, _LMTAARi,
  0,
  [_It, _NT],
...
export var ListManagedThingsRequest$: StaticStructureSchema = [3, n0, _LMTR,
  0,
...
export var ListManagedThingsResponse$: StaticStructureSchema = [3, n0, _LMTRi,
  0,
  [_It, _NT],
...
export var ListOtaTaskConfigurationsRequest$: StaticStructureSchema = [3, n0, _LOTCR,
  0,
  [_NT, _MR],
  [[0, { [_hQ]: _NT }], [1, { [_hQ]: _MR }]]
];
export var ListOtaTaskConfigurationsResponse$: StaticStructureSchema = [3, n0, _LOTCRi,
  0,
  [_It, _NT],
...
export var ListOtaTasksRequest$: StaticStructureSchema = [3, n0, _LOTR,
  0,
  [_NT, _MR],
  [[0, { [_hQ]: _NT }], [1, { [_hQ]: _MR }]]
];
export var ListOtaTasksResponse$: StaticStructureSchema = [3, n0, _LOTRi,
  0,
  [_Tas, _NT],
  [() => OtaTaskListDefinition, 0]
];
export var ListProvisioningProfilesRequest$: StaticStructureSchema = [3, n0, _LPPR,
  0,
  [_NT, _MR],
  [[0, { [_hQ]: _NT }], [1, { [_hQ]: _MR }]]
];
export var ListProvisioningProfilesResponse$: StaticStructureSchema = [3, n0, _LPPRi,
  0,
  [_It, _NT],
...
export var MatterEndpoint$: StaticStructureSchema = [3, n0, _ME,
  0,
  [_i, _cl],
  [0, [() => MatterClusters, 0]]
];
export var NotificationConfigurationSummary$: StaticStructureSchema = [3, n0, _NCS,
  0,
  [_ETv, _DN],
  [0, 0]
];
...
export var OtaTaskAbortConfig$: StaticStructureSchema = [3, n0, _OTAC,
  0,
  [_ACCL],
  [() => AbortConfigCriteriaList]
];
export var OtaTaskConfigurationSummary$: StaticStructureSchema = [3, n0, _OTCS,
  0,
  [_TCI, _N, _CAr],
  [0, [() => OtaTaskConfigurationName, 0], 4]
];
export var OtaTaskExecutionRetryConfig$: StaticStructureSchema = [3, n0, _OTERC,
  0,
  [_RCC],
  [() => RetryConfigCriteriaList]
];
export var OtaTaskExecutionRolloutConfig$: StaticStructureSchema = [3, n0, _OTERCt,
  0,
  [_ERR, _MPM],
  [() => ExponentialRolloutRate$, 1]
];
export var OtaTaskExecutionSummaries$: StaticStructureSchema = [3, n0, _OTES,
  0,
  [_TES, _MTI],
  [() => OtaTaskExecutionSummary$, 0]
];
export var OtaTaskExecutionSummary$: StaticStructureSchema = [3, n0, _OTESt,
  0,
  [_EN, _LUA, _QA, _RAet, _SA, _St],
  [1, 4, 4, 1, 4, 0]
];
export var OtaTaskSchedulingConfig$: StaticStructureSchema = [3, n0, _OTSC,
  0,
  [_EB, _ETn, _MW, _ST],
  [0, 0, () => ScheduleMaintenanceWindowList, 0]
];
export var OtaTaskSummary$: StaticStructureSchema = [3, n0, _OTS,
  0,
  [_TI, _TA, _CAr, _LUA, _TCI, _St],
  [0, 0, 4, 4, 0, 0]
];
export var OtaTaskTimeoutConfig$: StaticStructureSchema = [3, n0, _OTTC,
  0,
  [_IPTIM],
  [1]
];
export var ProactiveRefreshTokenRenewal$: StaticStructureSchema = [3, n0, _PRTR,
  0,
  [_ena, _DBR],
  [2, 1]
];
...
export var RegisterCustomEndpointRequest$: StaticStructureSchema = [3, n0, _RCER,
  0,
  [],
  []
];
...
export var RolloutRateIncreaseCriteria$: StaticStructureSchema = [3, n0, _RRIC,
  0,
  [_nONT, _nOST],
  [1, 1]
];
export var RuntimeLogConfigurations$: StaticStructureSchema = [3, n0, _RLC,
  0,
  [_LL, _LFL, _LSL, _LSFRMF, _LSFRMB, _UL, _UPM, _DLSAU],
  [0, 0, 0, 1, 1, 2, 1, 2]
];
export var ScheduleMaintenanceWindow$: StaticStructureSchema = [3, n0, _SMW,
  0,
  [_DIM, _ST],
  [1, 0]
];
...
export var TaskProcessingDetails$: StaticStructureSchema = [3, n0, _TPD,
  0,
...
var CapabilityReportCapabilities: StaticListSchema = [1, n0, _CRCa,
  0, () => CapabilityReportCapability$
];
var CapabilityReportEndpoints: StaticListSchema = [1, n0, _CREa,
  0, () => CapabilityReportEndpoint$
];
var CapabilityReportEvents = 64 | 0;
var CapabilityReportProperties = 64 | 0;
var CapabilitySchemas: StaticListSchema = [1, n0, _CSa,
  0, () => CapabilitySchemaItem$
];
var CommandCapabilities: StaticListSchema = [1, n0, _CCom,
  0, [() => CommandCapability$,
    0]
];
var CommandEndpoints: StaticListSchema = [1, n0, _CEom,
  0, [() => CommandEndpoint$,
    0]
];
...
var CredentialLockerListDefinition: StaticListSchema = [1, n0, _CLLD,
  0, [() => CredentialLockerSummary$,
    0]
];
var DestinationListDefinition: StaticListSchema = [1, n0, _DLD,
  0, () => DestinationSummary$
];
var DeviceDiscoveryListDefinition: StaticListSchema = [1, n0, _DDLD,
...
var DiscoveredDeviceListDefinition: StaticListSchema = [1, n0, _DDLDi,
  0, [() => DiscoveredDeviceSummary$,
    0]
];
var EventLogConfigurationListDefinition: StaticListSchema = [1, n0, _ELCLD,
  0, () => EventLogConfigurationSummary$
];
var ManagedThingAssociationList: StaticListSchema = [1, n0, _MTAL,
  0, () => ManagedThingAssociation$
];
var ManagedThingListDefinition: StaticListSchema = [1, n0, _MTLD,
  0, [() => ManagedThingSummary$,
    0]
];
var ManagedThingSchemaListDefinition: StaticListSchema = [1, n0, _MTSLD,
  0, () => ManagedThingSchemaListItem$
];
var MatterCapabilityReportAttributes: StaticListSchema = [1, n0, _MCRAa,
  0, () => MatterCapabilityReportAttribute$
];
var MatterCapabilityReportClusters: StaticListSchema = [1, n0, _MCRCa,
...
var MatterCapabilityReportEndpoints: StaticListSchema = [1, n0, _MCREa,
...
var MatterClusters: StaticListSchema = [1, n0, _MCa,
  0, [() => MatterCluster$,
    0]
];
var NotificationConfigurationListDefinition: StaticListSchema = [1, n0, _NCLD,
  0, () => NotificationConfigurationSummary$
];
var OtaTaskConfigurationListDefinition: StaticListSchema = [1, n0, _OTCLD,
  0, [() => OtaTaskConfigurationSummary$,
    0]
];
var OtaTaskExecutionSummariesListDefinition: StaticListSchema = [1, n0, _OTESLD,
  0, () => OtaTaskExecutionSummaries$
];
var OtaTaskListDefinition: StaticListSchema = [1, n0, _OTLD,
  0, () => OtaTaskSummary$
];
var ProvisioningProfileListDefinition: StaticListSchema = [1, n0, _PPLD,
  0, () => ProvisioningProfileSummary$
];
var RetryConfigCriteriaList: StaticListSchema = [1, n0, _RCCL,
  0, () => RetryConfigCriteria$
];
var ScheduleMaintenanceWindowList: StaticListSchema = [1, n0, _SMWL,
  0, () => ScheduleMaintenanceWindow$
];
var SchemaVersionList: StaticListSchema = [1, n0, _SVL,
  0, () => SchemaVersionListItem$
];
var StateCapabilities: StaticListSchema = [1, n0, _SCta,
  0, [() => StateCapability$,
    0]
];
var StateEndpoints: StaticListSchema = [1, n0, _SEt,
  0, [() => StateEndpoint$,
    0]
];
var TagKeyList = 64 | 0;
...
var MatterCommands: StaticMapSchema = [2, n0, _MCat,
  0, [0,
    0]
  , [() => MatterFields,
    0]
];
var MatterEvents: StaticMapSchema = [2, n0, _MEa,
  0, [0,
    0]
  , [() => MatterFields,
    0]
...
export var DeleteConnectorDestination$: StaticOperationSchema = [9, n0, _DCD,
  { [_h]: ["DELETE", "/connector-destinations/{Identifier}", 200] }, () => DeleteConnectorDestinationRequest$, () => __Unit
];
export var DeleteCredentialLocker$: StaticOperationSchema = [9, n0, _DCL,
  { [_h]: ["DELETE", "/credential-lockers/{Identifier}", 200] }, () => DeleteCredentialLockerRequest$, () => __Unit
];
export var DeleteDestination$: StaticOperationSchema = [9, n0, _DD,
  { [_h]: ["DELETE", "/destinations/{Name}", 200] }, () => DeleteDestinationRequest$, () => __Unit
];
export var DeleteEventLogConfiguration$: StaticOperationSchema = [9, n0, _DELC,
  { [_h]: ["DELETE", "/event-log-configurations/{Id}", 200] }, () => DeleteEventLogConfigurationRequest$, () => __Unit
];
export var DeleteManagedThing$: StaticOperationSchema = [9, n0, _DMT,
...
export var DeleteOtaTask$: StaticOperationSchema = [9, n0, _DOT,
  { [_h]: ["DELETE", "/ota-tasks/{Identifier}", 200] }, () => DeleteOtaTaskRequest$, () => __Unit
];
export var DeleteOtaTaskConfiguration$: StaticOperationSchema = [9, n0, _DOTC,
  { [_h]: ["DELETE", "/ota-task-configurations/{Identifier}", 204] }, () => DeleteOtaTaskConfigurationRequest$, () => __Unit
];
export var DeleteProvisioningProfile$: StaticOperationSchema = [9, n0, _DPP,
  { [_h]: ["DELETE", "/provisioning-profiles/{Identifier}", 200] }, () => DeleteProvisioningProfileRequest$, () => __Unit
];
export var DeregisterAccountAssociation$: StaticOperationSchema = [9, n0, _DAAe,
  { [_h]: ["PUT", "/managed-thing-associations/deregister", 200] }, () => DeregisterAccountAssociationRequest$, () => __Unit
];
export var GetAccountAssociation$: StaticOperationSchema = [9, n0, _GAA,
...
export var GetManagedThingMetaData$: StaticOperationSchema = [9, n0, _GMTMD,
  { [_h]: ["GET", "/managed-things-metadata/{Identifier}", 200] }, () => GetManagedThingMetaDataRequest$, () => GetManagedThingMetaDataResponse$
];
export var GetManagedThingState$: StaticOperationSchema = [9, n0, _GMTS,
...
export var ListManagedThings$: StaticOperationSchema = [9, n0, _LMT,
  { [_h]: ["GET", "/managed-things", 200] }, () => ListManagedThingsRequest$, () => ListManagedThingsResponse$
];
export var ListManagedThingSchemas$: StaticOperationSchema = [9, n0, _LMTS,
...
export var StartDeviceDiscovery$: StaticOperationSchema = [9, n0, _SDD,
...
export var UpdateAccountAssociation$: StaticOperationSchema = [9, n0, _UAA,
...
export var UpdateConnectorDestination$: StaticOperationSchema = [9, n0, _UCD,
...
export var UpdateEventLogConfiguration$: StaticOperationSchema = [9, n0, _UELC,
  { [_h]: ["PATCH", "/event-log-configurations/{Id}", 200] }, () => UpdateEventLogConfigurationRequest$, () => __Unit
];
export var UpdateManagedThing$: StaticOperationSchema = [9, n0, _UMT,
...
export var UpdateOtaTask$: StaticOperationSchema = [9, n0, _UOT,
