 ...
 * @public
 */
export class GetManagedThingConnectivityDataCommand extends command<GetManagedThingConnectivityDataCommandInput, GetManagedThingConnectivityDataCommandOutput>(
  _ep0,
  _mw0,
