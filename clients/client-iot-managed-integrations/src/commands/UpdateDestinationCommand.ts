...
import type { UpdateDestinationRequest } from "../models/models_0";
 ...
 * @public
 */
export class UpdateDestinationCommand extends command<UpdateDestinationCommandInput, UpdateDestinationCommandOutput>(
  _ep0,
  _mw0,
  "UpdateDestination",
  UpdateDestination$
