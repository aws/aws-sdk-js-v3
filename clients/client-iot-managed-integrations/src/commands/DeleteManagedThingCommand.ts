...
import type { DeleteManagedThingRequest } from "../models/models_0";
 ...
 * @public
 */
export class DeleteManagedThingCommand extends command<DeleteManagedThingCommandInput, DeleteManagedThingCommandOutput>(
  _ep0,
  _mw0,
  "DeleteManagedThing",
  DeleteManagedThing$
