...
import type { ListEventLogConfigurationsRequest, ListEventLogConfigurationsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListEventLogConfigurationsCommand extends command<ListEventLogConfigurationsCommandInput, ListEventLogConfigurationsCommandOutput>(
  _ep0,
  _mw0,
