...
import type { RegisterAccountAssociationRequest, RegisterAccountAssociationResponse } from "../models/models_0";
 ...
 * @public
 */
export class RegisterAccountAssociationCommand extends command<RegisterAccountAssociationCommandInput, RegisterAccountAssociationCommandOutput>(
  _ep0,
  _mw0,
