 ...
 * @public
 */
export type RedshiftDataClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultRedshiftDataHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: RedshiftDataClientResolvedConfig) =>
