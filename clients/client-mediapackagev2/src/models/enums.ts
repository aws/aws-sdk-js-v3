...
export const ValidationExceptionType = {
  ...
  MULTIVIEW_CHANNEL_POLICY_NOT_ALLOWED: "MULTIVIEW_CHANNEL_POLICY_NOT_ALLOWED",
  MULTIVIEW_CONFIGURATION_NOT_ALLOWED: "MULTIVIEW_CONFIGURATION_NOT_ALLOWED",
  MULTIVIEW_CONFIGURATION_REQUIRED: "MULTIVIEW_CONFIGURATION_REQUIRED",
  MULTIVIEW_DUPLICATE_LAYOUT: "MULTIVIEW_DUPLICATE_LAYOUT",
  MULTIVIEW_DUPLICATE_SOURCE: "MULTIVIEW_DUPLICATE_SOURCE",
  MULTIVIEW_INPUT_SWITCH_NOT_ALLOWED: "MULTIVIEW_INPUT_SWITCH_NOT_ALLOWED",
  MULTIVIEW_INPUT_TYPE_WITH_FILTER_CONFIGURATION: "MULTIVIEW_INPUT_TYPE_WITH_FILTER_CONFIGURATION",
  MULTIVIEW_INPUT_TYPE_WITH_HARVEST_JOB: "MULTIVIEW_INPUT_TYPE_WITH_HARVEST_JOB",
  MULTIVIEW_INPUT_TYPE_WITH_IFRAME_ONLY_STREAMS: "MULTIVIEW_INPUT_TYPE_WITH_IFRAME_ONLY_STREAMS",
  MULTIVIEW_INPUT_TYPE_WITH_ISM_CONTAINER: "MULTIVIEW_INPUT_TYPE_WITH_ISM_CONTAINER",
  MULTIVIEW_INPUT_TYPE_WITH_LL_HLS_MANIFEST: "MULTIVIEW_INPUT_TYPE_WITH_LL_HLS_MANIFEST",
  MULTIVIEW_INPUT_TYPE_WITH_MSS_MANIFEST: "MULTIVIEW_INPUT_TYPE_WITH_MSS_MANIFEST",
  MULTIVIEW_INPUT_TYPE_WITH_NON_EPOCH_LOCKED: "MULTIVIEW_INPUT_TYPE_WITH_NON_EPOCH_LOCKED",
  MULTIVIEW_INPUT_TYPE_WITH_SEGMENT_DURATION: "MULTIVIEW_INPUT_TYPE_WITH_SEGMENT_DURATION",
  MULTIVIEW_INPUT_TYPE_WITH_START_TAG: "MULTIVIEW_INPUT_TYPE_WITH_START_TAG",
  MULTIVIEW_INVALID_TIME_DELAY_SECONDS: "MULTIVIEW_INVALID_TIME_DELAY_SECONDS",
  MULTIVIEW_MANIFEST_WINDOW_TOO_LONG: "MULTIVIEW_MANIFEST_WINDOW_TOO_LONG",
  MULTIVIEW_OUTPUT_HEADER_NOT_ALLOWED: "MULTIVIEW_OUTPUT_HEADER_NOT_ALLOWED",
  MULTIVIEW_RESET_NOT_ALLOWED: "MULTIVIEW_RESET_NOT_ALLOWED",
  MULTIVIEW_SCTE_REQUIRES_AVAILS_PERIOD_TRIGGER: "MULTIVIEW_SCTE_REQUIRES_AVAILS_PERIOD_TRIGGER",
  MULTIVIEW_SOURCE_INVALID_INPUT_TYPE: "MULTIVIEW_SOURCE_INVALID_INPUT_TYPE",
  MULTIVIEW_SOURCE_NON_EPOCH_LOCKED: "MULTIVIEW_SOURCE_NON_EPOCH_LOCKED",
  MULTIVIEW_SOURCE_NOT_FOUND: "MULTIVIEW_SOURCE_NOT_FOUND",
  MULTIVIEW_STARTOVER_WINDOW_NOT_ALLOWED: "MULTIVIEW_STARTOVER_WINDOW_NOT_ALLOWED",
  NONE_MODE_WITH_TIMING_SOURCE: "NONE_MODE_WITH_TIMING_SOURCE",
  NON_EPOCH_LOCKED_WITH_FORCE_ENDPOINT_ERROR_CONFIGURATION: "NON_EPOCH_LOCKED_WITH_FORCE_ENDPOINT_ERROR_CONFIGURATION",
  ...
  ONLY_CMAF_INPUT_TYPE_ALLOW_OUTPUT_LOCKING_MODE: "ONLY_CMAF_INPUT_TYPE_ALLOW_OUTPUT_LOCKING_MODE",
  ONLY_CMAF_INPUT_TYPE_ALLOW_PREFERRED_INPUT_CONFIGURATION: "ONLY_CMAF_INPUT_TYPE_ALLOW_PREFERRED_INPUT_CONFIGURATION",
  ONLY_HLS_INPUT_TYPE_ALLOW_STREAM_NAME_OUTPUT_MODE: "ONLY_HLS_INPUT_TYPE_ALLOW_STREAM_NAME_OUTPUT_MODE",
  ONLY_NON_EPOCH_LOCKED_ALLOW_OUTPUT_TIMESTAMP_MODE: "ONLY_NON_EPOCH_LOCKED_ALLOW_OUTPUT_TIMESTAMP_MODE",
  OUTPUT_TIMESTAMP_MODE_IMMUTABLE: "OUTPUT_TIMESTAMP_MODE_IMMUTABLE",
  ...
  STREAM_NAME_OUTPUT_MODE_IMMUTABLE: "STREAM_NAME_OUTPUT_MODE_IMMUTABLE",
 ...
 * @enum
 */
export const MultiviewLayoutType = {
  LAYOUT_2EH: "LAYOUT_2EH",
  LAYOUT_2PL: "LAYOUT_2PL",
  LAYOUT_3EL: "LAYOUT_3EL",
  LAYOUT_3PL: "LAYOUT_3PL",
  LAYOUT_4E: "LAYOUT_4E",
  LAYOUT_4PL: "LAYOUT_4PL",
} as const;
/**
 * @public
 */
export type MultiviewLayoutType = (typeof MultiviewLayoutType)[keyof typeof MultiviewLayoutType];

/**
 * @public
 * @enum
 */
export const OutputLockingMode = {
 ...
 * @public
 */
export type OutputLockingMode = (typeof OutputLockingMode)[keyof typeof OutputLockingMode];
 ...
 * @enum
 */
export const OutputTimestampMode = {
 ...
 * @public
 */
export type OutputTimestampMode = (typeof OutputTimestampMode)[keyof typeof OutputTimestampMode];
 ...
 * @enum
 */
export const StreamNameOutputMode = {
  INDEX: "INDEX",
 ...
 * @public
 */
export type StreamNameOutputMode = (typeof StreamNameOutputMode)[keyof typeof StreamNameOutputMode];
