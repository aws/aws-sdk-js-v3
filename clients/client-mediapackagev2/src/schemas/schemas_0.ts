...
export var DashProgramInformation$: StaticStructureSchema = [3, n0, _DPI,
  0,
  [_Ti, _So, _Co, _LC, _MIU],
  [0, 0, 0, 0, 0]
];
export var DashSubtitleConfiguration$: StaticStructureSchema = [3, n0, _DSC,
  0,
  [_TC],
...
export var InputSwitchConfiguration$: StaticStructureSchema = [3, n0, _ISC,
  0,
  [_MQCSIS, _PIr],
  [2, 1]
];
...
export var ListChannelGroupsResponse$: StaticStructureSchema = [3, n0, _LCGRi,
  0,
  [_It, _NT],
  [() => ChannelGroupsList, 0]
];
...
var CreateDashManifests: StaticListSchema = [1, n0, _CDM,
  0, () => CreateDashManifestConfiguration$
];
var CreateHlsManifests: StaticListSchema = [1, n0, _CHM,
  0, () => CreateHlsManifestConfiguration$
];
var CreateLowLatencyHlsManifests: StaticListSchema = [1, n0, _CLLHM,
...
var DashDvbErrorMetrics: StaticListSchema = [1, n0, _DDEM,
...
var GetDashManifests: StaticListSchema = [1, n0, _GDM,
  0, () => GetDashManifestConfiguration$
];
var GetHlsManifests: StaticListSchema = [1, n0, _GHM,
  0, () => GetHlsManifestConfiguration$
];
var GetLowLatencyHlsManifests: StaticListSchema = [1, n0, _GLLHM,
  0, () => GetLowLatencyHlsManifestConfiguration$
];
var GetMssManifests: StaticListSchema = [1, n0, _GMM,
  0, () => GetMssManifestConfiguration$
];
var HarvestedDashManifestsList: StaticListSchema = [1, n0, _HDML,
  0, () => HarvestedDashManifest$
];
var HarvestedHlsManifestsList: StaticListSchema = [1, n0, _HHML,
  0, () => HarvestedHlsManifest$
];
var HarvestedLowLatencyHlsManifestsList: StaticListSchema = [1, n0, _HLLHML,
  0, () => HarvestedLowLatencyHlsManifest$
];
var HarvestJobsList: StaticListSchema = [1, n0, _HJL,
  0, () => HarvestJob$
];
var IngestEndpointList: StaticListSchema = [1, n0, _IEL,
  0, () => IngestEndpoint$
];
var ListDashManifests: StaticListSchema = [1, n0, _LDM,
  0, () => ListDashManifestConfiguration$
];
var ListHlsManifests: StaticListSchema = [1, n0, _LHM,
  0, () => ListHlsManifestConfiguration$
];
var ListLowLatencyHlsManifests: StaticListSchema = [1, n0, _LLLHM,
...
export var CreateChannelGroup$: StaticOperationSchema = [9, n0, _CCG,
  { [_h]: ["POST", "/channelGroup", 200] }, () => CreateChannelGroupRequest$, () => CreateChannelGroupResponse$
];
export var CreateHarvestJob$: StaticOperationSchema = [9, n0, _CHJr,
...
export var CreateOriginEndpoint$: StaticOperationSchema = [9, n0, _COE,
...
export var DeleteChannelGroup$: StaticOperationSchema = [9, n0, _DCG,
...
export var DeleteOriginEndpoint$: StaticOperationSchema = [9, n0, _DOE,
...
export var DeleteOriginEndpointPolicy$: StaticOperationSchema = [9, n0, _DOEP,
...
export var GetChannelGroup$: StaticOperationSchema = [9, n0, _GCG,
...
export var GetHarvestJob$: StaticOperationSchema = [9, n0, _GHJ,
...
export var GetOriginEndpoint$: StaticOperationSchema = [9, n0, _GOE,
...
export var GetOriginEndpointPolicy$: StaticOperationSchema = [9, n0, _GOEP,
...
export var ListChannelGroups$: StaticOperationSchema = [9, n0, _LCG,
...
export var ListHarvestJobs$: StaticOperationSchema = [9, n0, _LHJ,
  { [_h]: ["GET", "/channelGroup/{ChannelGroupName}/harvestJob", 200] }, () => ListHarvestJobsRequest$, () => ListHarvestJobsResponse$
];
export var ListOriginEndpoints$: StaticOperationSchema = [9, n0, _LOE,
...
export var PutOriginEndpointPolicy$: StaticOperationSchema = [9, n0, _POEP,
...
export var ResetChannelState$: StaticOperationSchema = [9, n0, _RCS,
  { [_h]: ["POST", "/channelGroup/{ChannelGroupName}/channel/{ChannelName}/reset", 200] }, () => ResetChannelStateRequest$, () => ResetChannelStateResponse$
];
export var ResetOriginEndpointState$: StaticOperationSchema = [9, n0, _ROES,
...
export var UpdateChannelGroup$: StaticOperationSchema = [9, n0, _UCG,
  { [_h]: ["PUT", "/channelGroup/{ChannelGroupName}", 200] }, () => UpdateChannelGroupRequest$, () => UpdateChannelGroupResponse$
];
export var UpdateOriginEndpoint$: StaticOperationSchema = [9, n0, _UOE,
