...
import { GetChannelGroup$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetChannelGroupCommand extends command<GetChannelGroupCommandInput, GetChannelGroupCommandOutput>(
  _ep0,
  _mw0,
  "GetChannelGroup",
  GetChannelGroup$
