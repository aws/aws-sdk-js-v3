...
import { DeleteChannelGroup$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DeleteChannelGroupCommand extends command<DeleteChannelGroupCommandInput, DeleteChannelGroupCommandOutput>(
  _ep0,
  _mw0,
  "DeleteChannelGroup",
  DeleteChannelGroup$
