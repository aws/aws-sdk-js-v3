...
export var PlatformCommand$: StaticStructureSchema = [3, n0, _PC,
  0,
  [_l, _w],
  [0, 0]
];
export var PlatformScriptKey$: StaticStructureSchema = [3, n0, _PSK,
  0,
  [_l, _w],
  [0, 0]
];
export var PluginSummary$: StaticStructureSchema = [3, n0, _PS,
  0,
...
export var StepAutomationConfiguration$: StaticStructureSchema = [3, n0, _SAC,
  0,
  [_sLSB, _sLSK, _co, _rE, _tT],
  [0, () => PlatformScriptKey$, () => PlatformCommand$, 0, 0]
];
export var StepOutput$: StaticStructureSchema = [3, n0, _SO,
  0,
  [_n, _dT, _r],
  [0, 0, 2]
];
...
export var TemplateInput$: StaticStructureSchema = [3, n0, _TI,
  0,
  [_iN, _dT, _r],
  [0, 0, 2]
];
export var TemplateStepGroupSummary$: StaticStructureSchema = [3, n0, _TSGS,
  0,
  [_i, _n, _p, _ne],
  [0, 0, 64 | 0, 64 | 0]
];
export var TemplateStepSummary$: StaticStructureSchema = [3, n0, _TSS,
  0,
...
export var WorkflowStepGroupSummary$: StaticStructureSchema = [3, n0, _WSGS,
  0,
  [_i, _n, _ow, _s, _p, _ne],
  [0, 0, 0, 0, 64 | 0, 64 | 0]
];
export var WorkflowStepOutput$: StaticStructureSchema = [3, n0, _WSO,
  0,
  [_n, _dT, _r, _va],
  [0, 0, 2, () => WorkflowStepOutputUnion$]
];
export var WorkflowStepSummary$: StaticStructureSchema = [3, n0, _WSS,
  0,
  [_sI, _n, _sAT, _ow, _p, _ne, _s, _sM, _nOSC, _nOSF, _tNOS, _d, _sL],
  [0, 0, 0, 0, 64 | 0, 64 | 0, 0, 0, 1, 1, 1, 0, 0]
];
export var MigrationHubOrchestratorServiceException$: StaticErrorSchema = [-3, _sm, "MigrationHubOrchestratorServiceException", 0, [], []];
...
var MigrationWorkflowSummaryList: StaticListSchema = [1, n0, _MWSL,
  0, () => MigrationWorkflowSummary$
];
var PluginSummaries: StaticListSchema = [1, n0, _PSl,
  0, () => PluginSummary$
];
var StepOutputList: StaticListSchema = [1, n0, _SOL,
  0, () => StepOutput$
];
var StringList = 64 | 0;
var TagKeyList = 64 | 0;
var TemplateInputList: StaticListSchema = [1, n0, _TIL,
  0, () => TemplateInput$
];
var TemplateStepGroupSummaryList: StaticListSchema = [1, n0, _TSGSL,
  0, () => TemplateStepGroupSummary$
];
var TemplateStepSummaryList: StaticListSchema = [1, n0, _TSSL,
  0, () => TemplateStepSummary$
];
var TemplateSummaryList: StaticListSchema = [1, n0, _TSL,
  0, () => TemplateSummary$
];
var ToolsList: StaticListSchema = [1, n0, _TL,
  0, () => Tool$
];
var WorkflowStepGroupsSummaryList: StaticListSchema = [1, n0, _WSGSL,
  0, () => WorkflowStepGroupSummary$
];
var WorkflowStepOutputList: StaticListSchema = [1, n0, _WSOL,
  0, () => WorkflowStepOutput$
];
var WorkflowStepsSummaryList: StaticListSchema = [1, n0, _WSSL,
  0, () => WorkflowStepSummary$
];
var StepInputParameters: StaticMapSchema = [2, n0, _SIP,
  8, 0, () => StepInput$
];
var StringMap = 128 | 0;
var TagMap = 128 | 0;
export var StepInput$: StaticUnionSchema = [4, n0, _SI,
  0,
  [_iV, _sV, _lOSV, _mOSV],
  [1, 0, 64 | 0, 128 | 0]
];
export var TemplateSource$: StaticUnionSchema = [4, n0, _TSe,
  0,
  [_wIo],
  [0]
];
export var WorkflowStepOutputUnion$: StaticUnionSchema = [4, n0, _WSOU,
  0,
  [_iV, _sV, _lOSVi],
  [1, 0, 64 | 0]
];
export var CreateTemplate$: StaticOperationSchema = [9, n0, _CT,
...
export var CreateWorkflowStep$: StaticOperationSchema = [9, n0, _CWS,
  { [_ht]: ["POST", "/workflowstep", 200] }, () => CreateWorkflowStepRequest$, () => CreateWorkflowStepResponse$
];
export var CreateWorkflowStepGroup$: StaticOperationSchema = [9, n0, _CWSG,
...
export var DeleteWorkflowStep$: StaticOperationSchema = [9, n0, _DWS,
  { [_ht]: ["DELETE", "/workflowstep/{id}", 200] }, () => DeleteWorkflowStepRequest$, () => DeleteWorkflowStepResponse$
];
export var DeleteWorkflowStepGroup$: StaticOperationSchema = [9, n0, _DWSG,
...
export var GetTemplateStep$: StaticOperationSchema = [9, n0, _GTS,
  { [_ht]: ["GET", "/templatestep/{id}", 200] }, () => GetTemplateStepRequest$, () => GetTemplateStepResponse$
];
export var GetTemplateStepGroup$: StaticOperationSchema = [9, n0, _GTSG,
...
export var GetWorkflowStep$: StaticOperationSchema = [9, n0, _GWS,
  { [_ht]: ["GET", "/workflowstep/{id}", 200] }, () => GetWorkflowStepRequest$, () => GetWorkflowStepResponse$
];
export var GetWorkflowStepGroup$: StaticOperationSchema = [9, n0, _GWSG,
...
export var ListTemplateStepGroups$: StaticOperationSchema = [9, n0, _LTSG,
  { [_ht]: ["GET", "/templatestepgroups/{templateId}", 200] }, () => ListTemplateStepGroupsRequest$, () => ListTemplateStepGroupsResponse$
];
export var ListTemplateSteps$: StaticOperationSchema = [9, n0, _LTS,
...
export var ListWorkflowStepGroups$: StaticOperationSchema = [9, n0, _LWSG,
  { [_ht]: ["GET", "/workflowstepgroups", 200] }, () => ListWorkflowStepGroupsRequest$, () => ListWorkflowStepGroupsResponse$
];
export var ListWorkflowSteps$: StaticOperationSchema = [9, n0, _LWS,
...
export var UpdateWorkflowStep$: StaticOperationSchema = [9, n0, _UWS,
  { [_ht]: ["POST", "/workflowstep/{id}", 200] }, () => UpdateWorkflowStepRequest$, () => UpdateWorkflowStepResponse$
];
export var UpdateWorkflowStepGroup$: StaticOperationSchema = [9, n0, _UWSG,
