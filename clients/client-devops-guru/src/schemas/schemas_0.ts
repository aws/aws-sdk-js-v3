...
export var AccountInsightHealth$: StaticStructureSchema = [3, n0, _AIH,
  0,
  [_OPI, _ORI],
  [1, 1]
];
...
export var AnomalousLogGroup$: StaticStructureSchema = [3, n0, _ALG,
  0,
...
export var AnomalySourceDetails$: StaticStructureSchema = [3, n0, _ASD,
  0,
  [_CWM, _PIM],
  [() => CloudWatchMetricsDetails, () => PerformanceInsightsMetricsDetails]
];
export var AnomalySourceMetadata$: StaticStructureSchema = [3, n0, _ASM,
  0,
  [_So, _SRN, _SRT],
  [0, 0, 0]
];
...
export var CloudFormationCollectionFilter$: StaticStructureSchema = [3, n0, _CFCF,
  0,
  [_SN],
  [64 | 0]
];
export var CloudFormationCostEstimationResourceCollectionFilter$: StaticStructureSchema = [3, n0, _CFCERCF,
  0,
  [_SN],
  [64 | 0]
];
export var CloudFormationHealth$: StaticStructureSchema = [3, n0, _CFH,
  0,
  [_SNt, _I, _ARC],
  [0, () => InsightHealth$, 1]
];
...
export var CloudWatchMetricsDimension$: StaticStructureSchema = [3, n0, _CWMDl,
  0,
  [_N, _V],
  [0, 0]
];
...
export var CostEstimationTimeRange$: StaticStructureSchema = [3, n0, _CETR,
  0,
  [_ST, _ET],
  [4, 4]
];
...
export var DescribeAccountHealthRequest$: StaticStructureSchema = [3, n0, _DAHR,
  0,
  [],
  []
];
...
export var DescribeEventSourcesConfigResponse$: StaticStructureSchema = [3, n0, _DESCRe,
  0,
  [_ES],
  [() => EventSourcesConfig$]
];
export var DescribeFeedbackRequest$: StaticStructureSchema = [3, n0, _DFR,
  0,
  [_II],
  [0]
];
export var DescribeFeedbackResponse$: StaticStructureSchema = [3, n0, _DFRe,
  0,
  [_IF],
  [() => InsightFeedback$]
];
...
export var DescribeOrganizationHealthRequest$: StaticStructureSchema = [3, n0, _DOHR,
  0,
  [_AIc, _OUI],
  [64 | 0, 64 | 0]
];
...
export var DescribeServiceIntegrationRequest$: StaticStructureSchema = [3, n0, _DSIR,
  0,
  [],
  []
];
export var DescribeServiceIntegrationResponse$: StaticStructureSchema = [3, n0, _DSIRe,
  0,
  [_SI],
  [() => ServiceIntegrationConfig$]
];
export var EndTimeRange$: StaticStructureSchema = [3, n0, _ETR,
  0,
  [_FT, _TT],
  [4, 4]
];
...
export var EventSourcesConfig$: StaticStructureSchema = [3, n0, _ESC,
  0,
  [_ACGP],
...
export var GetCostEstimationResponse$: StaticStructureSchema = [3, n0, _GCERe,
  0,
...
export var KMSServerSideEncryptionIntegrationConfig$: StaticStructureSchema = [3, n0, _KMSSSEIC,
  0,
  [_KMSKI, _OIS, _T],
  [0, 0, 0]
];
export var ListAnomaliesForInsightFilters$: StaticStructureSchema = [3, n0, _LAFIF,
  0,
  [_SCe],
  [() => ServiceCollection$]
];
...
export var ListInsightsStatusFilter$: StaticStructureSchema = [3, n0, _LISF,
  0,
  [_O, _Cl, _An],
...
export var ListNotificationChannelsResponse$: StaticStructureSchema = [3, n0, _LNCRi,
  0,
  [_Ch, _NT],
  [() => Channels, 0]
];
...
export var LogAnomalyShowcase$: StaticStructureSchema = [3, n0, _LASo,
  0,
  [_LACo],
  [() => LogAnomalyClasses]
];
export var LogsAnomalyDetectionIntegration$: StaticStructureSchema = [3, n0, _LADI,
  0,
  [_OIS],
  [0]
];
export var LogsAnomalyDetectionIntegrationConfig$: StaticStructureSchema = [3, n0, _LADIC,
  0,
  [_OIS],
  [0]
];
export var MonitoredResourceIdentifier$: StaticStructureSchema = [3, n0, _MRIo,
  0,
  [_MRN, _T, _RP, _LU, _RC],
...
export var OpsCenterIntegration$: StaticStructureSchema = [3, n0, _OCI,
  0,
  [_OIS],
  [0]
];
export var OpsCenterIntegrationConfig$: StaticStructureSchema = [3, n0, _OCIC,
  0,
  [_OIS],
  [0]
];
...
export var PerformanceInsightsMetricsDetail$: StaticStructureSchema = [3, n0, _PIMD,
  0,
...
export var PerformanceInsightsReferenceComparisonValues$: StaticStructureSchema = [3, n0, _PIRCV,
  0,
  [_RS, _RM],
  [() => PerformanceInsightsReferenceScalar$, () => PerformanceInsightsReferenceMetric$]
];
export var PerformanceInsightsReferenceData$: StaticStructureSchema = [3, n0, _PIRD,
  0,
  [_N, _CV],
  [0, () => PerformanceInsightsReferenceComparisonValues$]
];
export var PerformanceInsightsReferenceMetric$: StaticStructureSchema = [3, n0, _PIRM,
  0,
  [_MQ],
  [() => PerformanceInsightsMetricQuery$]
];
export var PerformanceInsightsReferenceScalar$: StaticStructureSchema = [3, n0, _PIRS,
  0,
  [_V],
  [1]
];
export var PerformanceInsightsStat$: StaticStructureSchema = [3, n0, _PIS,
  0,
  [_T, _V],
  [0, 1]
];
...
export var ProactiveAnomalySummary$: StaticStructureSchema = [3, n0, _PAS,
  0,
  [_Id, _Seve, _S, _UT, _ATR, _ARTR, _PTR, _SD, _AII, _RC, _Li, _SM, _ARn, _De],
  [0, 0, 0, 4, () => AnomalyTimeRange$, () => AnomalyReportedTimeRange$, () => PredictionTimeRange$, () => AnomalySourceDetails$, 0, () => ResourceCollection$, 1, () => AnomalySourceMetadata$, () => AnomalyResources, 0]
];
export var ProactiveInsight$: StaticStructureSchema = [3, n0, _PIr,
  0,
  [_Id, _N, _Seve, _S, _ITR, _PTR, _RC, _SOII, _De],
  [0, 0, 0, 0, () => InsightTimeRange$, () => PredictionTimeRange$, () => ResourceCollection$, 0, 0]
];
export var ProactiveInsightSummary$: StaticStructureSchema = [3, n0, _PISr,
  0,
...
export var ProactiveOrganizationInsightSummary$: StaticStructureSchema = [3, n0, _POIS,
  0,
...
export var PutFeedbackResponse$: StaticStructureSchema = [3, n0, _PFRu,
  0,
  [],
  []
];
...
export var ReactiveAnomalySummary$: StaticStructureSchema = [3, n0, _RASe,
  0,
  [_Id, _Seve, _S, _ATR, _ARTR, _SD, _AII, _RC, _T, _N, _De, _CAI, _ARn],
  [0, 0, 0, () => AnomalyTimeRange$, () => AnomalyReportedTimeRange$, () => AnomalySourceDetails$, 0, () => ResourceCollection$, 0, 0, 0, 0, () => AnomalyResources]
];
export var ReactiveInsight$: StaticStructureSchema = [3, n0, _RIea,
  0,
  [_Id, _N, _Seve, _S, _ITR, _RC, _SOII, _De],
  [0, 0, 0, 0, () => InsightTimeRange$, () => ResourceCollection$, 0, 0]
];
export var ReactiveInsightSummary$: StaticStructureSchema = [3, n0, _RIS,
  0,
  [_Id, _N, _Seve, _S, _ITR, _RC, _SCe, _ARA],
  [0, 0, 0, 0, () => InsightTimeRange$, () => ResourceCollection$, () => ServiceCollection$, 64 | 0]
];
export var ReactiveOrganizationInsightSummary$: StaticStructureSchema = [3, n0, _ROIS,
  0,
...
export var RecommendationRelatedAnomalySourceDetail$: StaticStructureSchema = [3, n0, _RRASD,
  0,
  [_CWM],
  [() => RecommendationRelatedCloudWatchMetricsSourceDetails]
];
export var RecommendationRelatedCloudWatchMetricsSourceDetail$: StaticStructureSchema = [3, n0, _RRCWMSD,
  0,
  [_MN, _Na],
  [0, 0]
];
...
export var ResourceCollection$: StaticStructureSchema = [3, n0, _RC,
  0,
  [_CF, _Ta],
  [() => CloudFormationCollection$, () => TagCollections]
];
export var ResourceCollectionFilter$: StaticStructureSchema = [3, n0, _RCF,
  0,
  [_CF, _Ta],
...
export var SearchOrganizationInsightsFilters$: StaticStructureSchema = [3, n0, _SOIF,
  0,
  [_Sev, _Sta, _RC, _SCe],
  [64 | 0, 64 | 0, () => ResourceCollection$, () => ServiceCollection$]
];
...
export var ServiceCollection$: StaticStructureSchema = [3, n0, _SCe,
  0,
  [_SNe],
  [64 | 0]
];
export var ServiceHealth$: StaticStructureSchema = [3, n0, _SH,
  0,
  [_SNer, _I, _ARC],
  [0, () => ServiceInsightHealth$, 1]
];
export var ServiceInsightHealth$: StaticStructureSchema = [3, n0, _SIH,
  0,
  [_OPI, _ORI],
  [1, 1]
];
export var ServiceIntegrationConfig$: StaticStructureSchema = [3, n0, _SIC,
  0,
  [_OC, _LAD, _KMSSSE],
...
export var SnsChannelConfig$: StaticStructureSchema = [3, n0, _SCC,
  0,
  [_TA],
  [0]
];
...
export var StartTimeRange$: StaticStructureSchema = [3, n0, _STR,
  0,
  [_FT, _TT],
  [4, 4]
];
...
export var UpdateCloudFormationCollectionFilter$: StaticStructureSchema = [3, n0, _UCFCF,
  0,
  [_SN],
  [64 | 0]
];
export var UpdateEventSourcesConfigRequest$: StaticStructureSchema = [3, n0, _UESCR,
  0,
  [_ES],
  [() => EventSourcesConfig$]
];
export var UpdateEventSourcesConfigResponse$: StaticStructureSchema = [3, n0, _UESCRp,
  0,
  [],
  []
];
export var UpdateResourceCollectionFilter$: StaticStructureSchema = [3, n0, _URCF,
  0,
  [_CF, _Ta],
...
export var UpdateServiceIntegrationConfig$: StaticStructureSchema = [3, n0, _USIC,
  0,
  [_OC, _LAD, _KMSSSE],
...
var AnomalousLogGroups: StaticListSchema = [1, n0, _ALGn,
  0, () => AnomalousLogGroup$
];
var AnomalyResources: StaticListSchema = [1, n0, _ARn,
  0, () => AnomalyResource$
];
...
var CloudFormationHealths: StaticListSchema = [1, n0, _CFHl,
  0, () => CloudFormationHealth$
];
var CloudWatchMetricsDetails: StaticListSchema = [1, n0, _CWMDlo,
  0, () => CloudWatchMetricsDetail$
];
var CloudWatchMetricsDimensions: StaticListSchema = [1, n0, _CWMDlou,
  0, () => CloudWatchMetricsDimension$
];
var CostEstimationStackNames = 64 | 0;
var CostEstimationTagValues = 64 | 0;
var EventResources: StaticListSchema = [1, n0, _ERv,
  0, () => EventResource$
];
...
var LogAnomalyClasses: StaticListSchema = [1, n0, _LACo,
  0, () => LogAnomalyClass$
];
var LogAnomalyShowcases: StaticListSchema = [1, n0, _LAS,
  0, () => LogAnomalyShowcase$
];
var MonitoredResourceIdentifiers: StaticListSchema = [1, n0, _MRI,
...
var PerformanceInsightsMetricsDetails: StaticListSchema = [1, n0, _PIMDe,
  0, () => PerformanceInsightsMetricsDetail$
];
var PerformanceInsightsReferenceDataList: StaticListSchema = [1, n0, _PIRDL,
  0, () => PerformanceInsightsReferenceData$
];
var PerformanceInsightsStats: StaticListSchema = [1, n0, _PISe,
  0, () => PerformanceInsightsStat$
];
var ProactiveAnomalies: StaticListSchema = [1, n0, _PAr,
  0, () => ProactiveAnomalySummary$
];
var ProactiveInsights: StaticListSchema = [1, n0, _PI,
...
var ReactiveOrganizationInsights: StaticListSchema = [1, n0, _ROI,
  0, () => ReactiveOrganizationInsightSummary$
];
var RecommendationRelatedAnomalies: StaticListSchema = [1, n0, _RRAe,
  0, () => RecommendationRelatedAnomaly$
];
var RecommendationRelatedAnomalyResources: StaticListSchema = [1, n0, _RRARe,
  0, () => RecommendationRelatedAnomalyResource$
];
var RecommendationRelatedCloudWatchMetricsSourceDetails: StaticListSchema = [1, n0, _RRCWMSDe,
  0, () => RecommendationRelatedCloudWatchMetricsSourceDetail$
];
var RecommendationRelatedEventResources: StaticListSchema = [1, n0, _RRERe,
...
var ServiceHealths: StaticListSchema = [1, n0, _SHe,
  0, () => ServiceHealth$
];
var ServiceNames = 64 | 0;
var ServiceResourceCosts: StaticListSchema = [1, n0, _SRCe,
  0, () => ServiceResourceCost$
];
var StackNames = 64 | 0;
var TagCollectionFilters: StaticListSchema = [1, n0, _TCFa,
  0, () => TagCollectionFilter$
];
var TagCollections: StaticListSchema = [1, n0, _TCag,
  0, () => TagCollection$
];
var TagCostEstimationResourceCollectionFilters: StaticListSchema = [1, n0, _TCERCFa,
  0, () => TagCostEstimationResourceCollectionFilter$
];
var TagHealths: StaticListSchema = [1, n0, _THa,
  0, () => TagHealth$
];
var TagValues = 64 | 0;
var TimestampMetricValuePairList: StaticListSchema = [1, n0, _TMVPL,
  0, () => TimestampMetricValuePair$
];
var UpdateStackNames = 64 | 0;
var UpdateTagCollectionFilters: StaticListSchema = [1, n0, _UTCFp,
...
export var DescribeResourceCollectionHealth$: StaticOperationSchema = [9, n0, _DRCH,
...
export var ListMonitoredResources$: StaticOperationSchema = [9, n0, _LMR,
  { [_h]: ["POST", "/monitoredResources", 200] }, () => ListMonitoredResourcesRequest$, () => ListMonitoredResourcesResponse$
];
export var ListNotificationChannels$: StaticOperationSchema = [9, n0, _LNC,
  { [_h]: ["POST", "/channels", 200] }, () => ListNotificationChannelsRequest$, () => ListNotificationChannelsResponse$
];
export var ListOrganizationInsights$: StaticOperationSchema = [9, n0, _LOI,
