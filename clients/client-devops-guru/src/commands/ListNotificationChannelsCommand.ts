...
import type { ListNotificationChannelsRequest, ListNotificationChannelsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListNotificationChannelsCommand extends command<ListNotificationChannelsCommandInput, ListNotificationChannelsCommandOutput>(
  _ep0,
  _mw0,
