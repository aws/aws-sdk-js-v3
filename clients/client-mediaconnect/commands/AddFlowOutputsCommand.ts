...
import {
  deserializeAws_restJson1_1AddFlowOutputsCommand,
  serializeAws_restJson1_1AddFlowOutputsCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1AddFlowOutputsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1AddFlowOutputsCommand(output, context);
  }
