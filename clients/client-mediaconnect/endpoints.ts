...
const AWS_TEMPLATE = "mediaconnect.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "mediaconnect.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "mediaconnect.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "mediaconnect.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "mediaconnect.{region}.amazonaws.com";
