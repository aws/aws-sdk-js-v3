...
import type { AddFlowMediaStreamsRequest, AddFlowMediaStreamsResponse } from "../models/models_0";
import { AddFlowMediaStreams$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class AddFlowMediaStreamsCommand extends command<AddFlowMediaStreamsCommandInput, AddFlowMediaStreamsCommandOutput>(
  _ep0,
  _mw0,
  "AddFlowMediaStreams",
  AddFlowMediaStreams$
