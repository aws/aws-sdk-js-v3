...
import type { DeleteRouterInputRequest, DeleteRouterInputResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteRouterInputCommand extends command<DeleteRouterInputCommandInput, DeleteRouterInputCommandOutput>(
  _ep0,
  _mw0,
  "DeleteRouterInput",
  DeleteRouterInput$
