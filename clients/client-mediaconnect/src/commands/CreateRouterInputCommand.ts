...
import type { CreateRouterInputRequest, CreateRouterInputResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateRouterInputCommand extends command<CreateRouterInputCommandInput, CreateRouterInputCommandOutput>(
  _ep0,
  _mw0,
  "CreateRouterInput",
  CreateRouterInput$
