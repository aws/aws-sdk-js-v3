...
import type { CreateRouterOutputRequest, CreateRouterOutputResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateRouterOutputCommand extends command<CreateRouterOutputCommandInput, CreateRouterOutputCommandOutput>(
  _ep0,
  _mw0,
  "CreateRouterOutput",
  CreateRouterOutput$
