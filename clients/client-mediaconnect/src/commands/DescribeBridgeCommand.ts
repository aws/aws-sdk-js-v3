...
import type { DescribeBridgeRequest, DescribeBridgeResponse } from "../models/models_0";
import { DescribeBridge$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class DescribeBridgeCommand extends command<DescribeBridgeCommandInput, DescribeBridgeCommandOutput>(
  _ep0,
  _mw0,
  "DescribeBridge",
  DescribeBridge$
