...
import type { UpdateBridgeStateRequest, UpdateBridgeStateResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateBridgeStateCommand extends command<UpdateBridgeStateCommandInput, UpdateBridgeStateCommandOutput>(
  _ep0,
  _mw0,
  "UpdateBridgeState",
  UpdateBridgeState$
