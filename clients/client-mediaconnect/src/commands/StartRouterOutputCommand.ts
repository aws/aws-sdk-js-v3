...
import type { StartRouterOutputRequest, StartRouterOutputResponse } from "../models/models_1";
 ...
 * @public
 */
export class StartRouterOutputCommand extends command<StartRouterOutputCommandInput, StartRouterOutputCommandOutput>(
  _ep0,
  _mw0,
  "StartRouterOutput",
  StartRouterOutput$
