...
import type { AddFlowOutputsRequest, AddFlowOutputsResponse } from "../models/models_0";
 ...
 * @public
 */
export class AddFlowOutputsCommand extends command<AddFlowOutputsCommandInput, AddFlowOutputsCommandOutput>(
  _ep0,
  _mw0,
  "AddFlowOutputs",
  AddFlowOutputs$
