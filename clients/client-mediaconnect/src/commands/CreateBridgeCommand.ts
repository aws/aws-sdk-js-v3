...
import type { CreateBridgeRequest, CreateBridgeResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateBridgeCommand extends command<CreateBridgeCommandInput, CreateBridgeCommandOutput>(
  _ep0,
  _mw0,
  "CreateBridge",
  CreateBridge$
