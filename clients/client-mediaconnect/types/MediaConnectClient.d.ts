...
export declare type ServiceInputTypes = AddFlowOutputsCommandInput | CreateFlowCommandInput | DeleteFlowCommandInput | DescribeFlowCommandInput | GrantFlowEntitlementsCommandInput | ListEntitlementsCommandInput | ListFlowsCommandInput | ListTagsForResourceCommandInput | RemoveFlowOutputCommandInput | RevokeFlowEntitlementCommandInput | StartFlowCommandInput | StopFlowCommandInput | TagResourceCommandInput | UntagResourceCommandInput | UpdateFlowEntitlementCommandInput | UpdateFlowOutputCommandInput | UpdateFlowSourceCommandInput;
export declare type ServiceOutputTypes = AddFlowOutputsCommandOutput | CreateFlowCommandOutput | DeleteFlowCommandOutput | DescribeFlowCommandOutput | GrantFlowEntitlementsCommandOutput | ListEntitlementsCommandOutput | ListFlowsCommandOutput | ListTagsForResourceCommandOutput | RemoveFlowOutputCommandOutput | RevokeFlowEntitlementCommandOutput | StartFlowCommandOutput | StopFlowCommandOutput | TagResourceCommandOutput | UntagResourceCommandOutput | UpdateFlowEntitlementCommandOutput | UpdateFlowOutputCommandOutput | UpdateFlowSourceCommandOutput;
...
export declare type MediaConnectClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type MediaConnectClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
