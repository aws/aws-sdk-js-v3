...
import {
  defaultQLDBSessionHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type QLDBSessionClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type QLDBSessionClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<QLDBSessionClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultQLDBSessionHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: QLDBSessionClientResolvedConfig) =>
