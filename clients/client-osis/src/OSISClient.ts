...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<OSISClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultOSISHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: OSISClientResolvedConfig) =>
