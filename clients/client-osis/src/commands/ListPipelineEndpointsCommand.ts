...
import { de_ListPipelineEndpointsCommand, se_ListPipelineEndpointsCommand } from "../protocols/Aws_restJson1";
...
export class ListPipelineEndpointsCommand extends $Command
  ...
  .f(void 0, void 0)
  .ser(se_ListPipelineEndpointsCommand)
  .de(de_ListPipelineEndpointsCommand)
  .build() {
