 ...
 * @public
 */
export class StartQueryMonitorTopContributorsCommand extends command<StartQueryMonitorTopContributorsCommandInput, StartQueryMonitorTopContributorsCommandOutput>(
  _ep0,
  _mw0,
