...
import {
  de_GetQueryResultsMonitorTopContributorsCommand,
  se_GetQueryResultsMonitorTopContributorsCommand,
...
export class GetQueryResultsMonitorTopContributorsCommand extends $Command
  ...
  .f(void 0, void 0)
  .ser(se_GetQueryResultsMonitorTopContributorsCommand)
  .de(de_GetQueryResultsMonitorTopContributorsCommand)
  .build() {
