 ...
 * @public
 */
export class GetQueryStatusMonitorTopContributorsCommand extends command<GetQueryStatusMonitorTopContributorsCommandInput, GetQueryStatusMonitorTopContributorsCommandOutput>(
  _ep0,
  _mw0,
