 ...
 * @public
 */
export class DescribePiiEntitiesDetectionJobCommand extends command<DescribePiiEntitiesDetectionJobCommandInput, DescribePiiEntitiesDetectionJobCommandOutput>(
  _ep0,
  _mw0,
