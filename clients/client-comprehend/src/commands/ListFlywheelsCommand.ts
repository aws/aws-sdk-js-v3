...
import type { ListFlywheelsRequest, ListFlywheelsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListFlywheelsCommand extends command<ListFlywheelsCommandInput, ListFlywheelsCommandOutput>(
  _ep0,
  _mw0,
  "ListFlywheels",
  ListFlywheels$
