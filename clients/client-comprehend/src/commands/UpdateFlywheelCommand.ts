...
import type { UpdateFlywheelRequest, UpdateFlywheelResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateFlywheelCommand extends command<UpdateFlywheelCommandInput, UpdateFlywheelCommandOutput>(
  _ep0,
  _mw0,
  "UpdateFlywheel",
  UpdateFlywheel$
