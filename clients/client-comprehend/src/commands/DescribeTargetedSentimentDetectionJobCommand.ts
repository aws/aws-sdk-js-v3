 ...
 * ```
 *
 * @param DescribeTargetedSentimentDetectionJobRequest - {@link DescribeTargetedSentimentDetectionJobRequest}
 * @returns {@link DescribeTargetedSentimentDetectionJobResponse}
