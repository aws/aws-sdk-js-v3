 ...
 * @public
 */
export class DescribeTargetedSentimentDetectionJobCommand extends command<DescribeTargetedSentimentDetectionJobCommandInput, DescribeTargetedSentimentDetectionJobCommandOutput>(
  _ep0,
  _mw0,
