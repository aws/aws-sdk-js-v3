 ...
 * @public
 */
export class DescribeSentimentDetectionJobCommand extends command<DescribeSentimentDetectionJobCommandInput, DescribeSentimentDetectionJobCommandOutput>(
  _ep0,
  _mw0,
