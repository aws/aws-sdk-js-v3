 ...
 * @public
 */
export class GetTableBucketMaintenanceConfigurationCommand extends command<GetTableBucketMaintenanceConfigurationCommandInput, GetTableBucketMaintenanceConfigurationCommandOutput>(
  _ep0,
  _mw0,
