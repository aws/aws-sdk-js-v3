 ...
 * @public
 */
export class GetTableRecordExpirationJobStatusCommand extends command<GetTableRecordExpirationJobStatusCommandInput, GetTableRecordExpirationJobStatusCommandOutput>(
  _ep0,
  _mw0,
