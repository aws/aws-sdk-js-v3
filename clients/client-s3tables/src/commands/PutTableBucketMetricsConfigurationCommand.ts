 ...
 * @public
 */
export class PutTableBucketMetricsConfigurationCommand extends command<PutTableBucketMetricsConfigurationCommandInput, PutTableBucketMetricsConfigurationCommandOutput>(
  _ep0,
  _mw0,
