 ...
 * @public
 */
export class GetTableBucketMetricsConfigurationCommand extends command<GetTableBucketMetricsConfigurationCommandInput, GetTableBucketMetricsConfigurationCommandOutput>(
  _ep0,
  _mw0,
