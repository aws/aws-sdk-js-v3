 ...
 * @public
 */
export class GetTableRecordExpirationConfigurationCommand extends command<GetTableRecordExpirationConfigurationCommandInput, GetTableRecordExpirationConfigurationCommandOutput>(
  _ep0,
  _mw0,
