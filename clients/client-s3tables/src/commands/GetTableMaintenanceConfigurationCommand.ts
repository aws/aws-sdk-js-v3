 ...
 * @public
 */
export class GetTableMaintenanceConfigurationCommand extends command<GetTableMaintenanceConfigurationCommandInput, GetTableMaintenanceConfigurationCommandOutput>(
  _ep0,
  _mw0,
