 ...
 * @public
 */
export class DeleteTableBucketMetricsConfigurationCommand extends command<DeleteTableBucketMetricsConfigurationCommandInput, DeleteTableBucketMetricsConfigurationCommandOutput>(
  _ep0,
  _mw0,
