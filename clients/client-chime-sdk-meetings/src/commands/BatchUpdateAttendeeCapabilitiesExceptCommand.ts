 ...
 * @public
 */
export class BatchUpdateAttendeeCapabilitiesExceptCommand extends command<BatchUpdateAttendeeCapabilitiesExceptCommandInput, BatchUpdateAttendeeCapabilitiesExceptCommandOutput>(
  _ep0,
  _mw0,
