...
import { type CodeGuruSecurityClientResolvedConfig, CodeGuruSecurityClientConfig } from "../CodeGuruSecurityClient";
 ...
 * @internal
 */
export const defaultCodeGuruSecurityHttpAuthSchemeProvider: CodeGuruSecurityHttpAuthSchemeProvider = (authParameters) => {
