...
import { type BillingconductorClientResolvedConfig, BillingconductorClientConfig } from "../BillingconductorClient";
 ...
 * @internal
 */
export const defaultBillingconductorHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: BillingconductorHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultBillingconductorHttpAuthSchemeProvider: BillingconductorHttpAuthSchemeProvider = (authParameters) => {
