...
> {
  ...
  > {
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: BatchAssociateResourcesToCustomLineItemInput.filterSensitiveLog,
      outputFilterSensitiveLog: BatchAssociateResourcesToCustomLineItemOutput.filterSensitiveLog,
    };
