 ...
 * @public
 */
export class ListPricingRulesAssociatedToPricingPlanCommand extends command<ListPricingRulesAssociatedToPricingPlanCommandInput, ListPricingRulesAssociatedToPricingPlanCommandOutput>(
  _ep0,
  _mw0,
