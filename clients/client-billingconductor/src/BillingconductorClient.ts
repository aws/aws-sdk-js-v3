...
import {
  ...
  defaultBillingconductorHttpAuthSchemeParametersProvider,
...
import type { ListPricingPlansCommandInput, ListPricingPlansCommandOutput } from "./commands/ListPricingPlansCommand";
import type {
...
import type { ListPricingRulesCommandInput, ListPricingRulesCommandOutput } from "./commands/ListPricingRulesCommand";
import type {
 ...
 * @public
 */
export type BillingconductorClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type BillingconductorClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<BillingconductorClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultBillingconductorHttpAuthSchemeParametersProvider,
