...
import { CreateSmsTemplateRequest, CreateSmsTemplateResponse } from "../models/index";
import {
  deserializeAws_restJson1_1CreateSmsTemplateCommand,
  serializeAws_restJson1_1CreateSmsTemplateCommand
...
> {
  ...
  private serialize(input: CreateSmsTemplateCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1CreateSmsTemplateCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<CreateSmsTemplateCommandOutput> {
    return deserializeAws_restJson1_1CreateSmsTemplateCommand(output, context);
  }
