...
export class GetApnsVoipSandboxChannelCommand extends $Command<GetApnsVoipSandboxChannelCommandInput, GetApnsVoipSandboxChannelCommandOutput, PinpointClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetApnsVoipSandboxChannelCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetApnsVoipSandboxChannelCommand(output, context);
  }
