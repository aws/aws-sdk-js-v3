...
import { DeleteApnsVoipChannelRequest, DeleteApnsVoipChannelResponse } from "../models/index";
import {
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteApnsVoipChannelCommand(input, context);
  }
