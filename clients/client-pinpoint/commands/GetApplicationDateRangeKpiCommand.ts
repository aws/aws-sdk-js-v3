...
export class GetApplicationDateRangeKpiCommand extends $Command<GetApplicationDateRangeKpiCommandInput, GetApplicationDateRangeKpiCommandOutput, PinpointClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetApplicationDateRangeKpiCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetApplicationDateRangeKpiCommand(output, context);
  }
