...
import { UpdateApnsSandboxChannelRequest, UpdateApnsSandboxChannelResponse } from "../models/index";
import {
  deserializeAws_restJson1_1UpdateApnsSandboxChannelCommand,
  serializeAws_restJson1_1UpdateApnsSandboxChannelCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1UpdateApnsSandboxChannelCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1UpdateApnsSandboxChannelCommand(output, context);
  }
