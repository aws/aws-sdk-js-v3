...
export const getRuntimeConfig = (config: PinpointClientConfig) => {
  return {
    ...
    httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultPinpointHttpAuthSchemeProvider,
    ...
    protocol: config?.protocol ?? new AwsRestJsonProtocol({ defaultNamespace: "com.amazonaws.pinpoint" }),
