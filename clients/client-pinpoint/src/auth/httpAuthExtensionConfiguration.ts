...
import type { PinpointHttpAuthSchemeProvider } from "./httpAuthSchemeProvider";
...
export interface HttpAuthExtensionConfiguration {
  ...
  setHttpAuthSchemeProvider(httpAuthSchemeProvider: PinpointHttpAuthSchemeProvider): void;
