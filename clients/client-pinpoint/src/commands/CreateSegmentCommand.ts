...
import type { CreateSegmentRequest, CreateSegmentResponse } from "../models/models_0";
import { CreateSegment$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CreateSegmentCommand extends command<CreateSegmentCommandInput, CreateSegmentCommandOutput>(
  _ep0,
  _mw0,
  "CreateSegment",
  CreateSegment$
