...
import type { GetSmsChannelRequest, GetSmsChannelResponse } from "../models/models_1";
 ...
 * @public
 */
export class GetSmsChannelCommand extends command<GetSmsChannelCommandInput, GetSmsChannelCommandOutput>(
  _ep0,
  _mw0,
  "GetSmsChannel",
  GetSmsChannel$
