...
import type { GetSegmentVersionRequest, GetSegmentVersionResponse } from "../models/models_1";
 ...
 * @public
 */
export class GetSegmentVersionCommand extends command<GetSegmentVersionCommandInput, GetSegmentVersionCommandOutput>(
  _ep0,
  _mw0,
  "GetSegmentVersion",
  GetSegmentVersion$
