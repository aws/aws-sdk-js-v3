...
import type { ListJourneysRequest, ListJourneysResponse } from "../models/models_1";
 ...
 * @public
 */
export class ListJourneysCommand extends command<ListJourneysCommandInput, ListJourneysCommandOutput>(
  _ep0,
  _mw0,
  "ListJourneys",
  ListJourneys$
