...
import type { GetImportJobsRequest, GetImportJobsResponse } from "../models/models_0";
import { GetImportJobs$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetImportJobsCommand extends command<GetImportJobsCommandInput, GetImportJobsCommandOutput>(
  _ep0,
  _mw0,
  "GetImportJobs",
  GetImportJobs$
