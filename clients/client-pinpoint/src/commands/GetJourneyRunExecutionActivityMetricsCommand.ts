 ...
 * @public
 */
export class GetJourneyRunExecutionActivityMetricsCommand extends command<GetJourneyRunExecutionActivityMetricsCommandInput, GetJourneyRunExecutionActivityMetricsCommandOutput>(
  _ep0,
  _mw0,
