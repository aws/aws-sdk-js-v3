 ...
 * ```
 *
 * @param GetJourneyRunExecutionActivityMetricsRequest - {@link GetJourneyRunExecutionActivityMetricsRequest}
 * @returns {@link GetJourneyRunExecutionActivityMetricsResponse}
