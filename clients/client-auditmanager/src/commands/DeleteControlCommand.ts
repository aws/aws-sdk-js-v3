...
import type { DeleteControlRequest, DeleteControlResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteControlCommand extends command<DeleteControlCommandInput, DeleteControlCommandOutput>(
  _ep0,
  _mw0,
  "DeleteControl",
  DeleteControl$
