...
import type { GetAccountStatusRequest, GetAccountStatusResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetAccountStatusCommand extends command<GetAccountStatusCommandInput, GetAccountStatusCommandOutput>(
  _ep0,
  _mw0,
  "GetAccountStatus",
  GetAccountStatus$
