 ...
 * @public
 */
export class StartAssessmentFrameworkShareCommand extends command<StartAssessmentFrameworkShareCommandInput, StartAssessmentFrameworkShareCommandOutput>(
  _ep0,
  _mw0,
