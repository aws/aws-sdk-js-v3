 ...
 * @public
 */
export class BatchAssociateAssessmentReportEvidenceCommand extends command<BatchAssociateAssessmentReportEvidenceCommandInput, BatchAssociateAssessmentReportEvidenceCommandOutput>(
  _ep0,
  _mw0,
