 ...
 * @public
 */
export class UpdateAssessmentFrameworkShareCommand extends command<UpdateAssessmentFrameworkShareCommandInput, UpdateAssessmentFrameworkShareCommandOutput>(
  _ep0,
  _mw0,
