 ...
 * ```
 *
 * @param GetEvidenceFoldersByAssessmentControlRequest - {@link GetEvidenceFoldersByAssessmentControlRequest}
 * @returns {@link GetEvidenceFoldersByAssessmentControlResponse}
