...
import type { GetEvidenceFolderRequest, GetEvidenceFolderResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetEvidenceFolderCommand extends command<GetEvidenceFolderCommandInput, GetEvidenceFolderCommandOutput>(
  _ep0,
  _mw0,
  "GetEvidenceFolder",
  GetEvidenceFolder$
