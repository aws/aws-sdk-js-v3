 ...
 * @public
 */
export class AssociateAssessmentReportEvidenceFolderCommand extends command<AssociateAssessmentReportEvidenceFolderCommandInput, AssociateAssessmentReportEvidenceFolderCommandOutput>(
  _ep0,
  _mw0,
