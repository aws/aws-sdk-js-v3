...
import type { UpdateAssessmentRequest, UpdateAssessmentResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateAssessmentCommand extends command<UpdateAssessmentCommandInput, UpdateAssessmentCommandOutput>(
  _ep0,
  _mw0,
  "UpdateAssessment",
  UpdateAssessment$
