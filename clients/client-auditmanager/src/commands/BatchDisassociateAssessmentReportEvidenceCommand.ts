 ...
 * @public
 */
export class BatchDisassociateAssessmentReportEvidenceCommand extends command<BatchDisassociateAssessmentReportEvidenceCommandInput, BatchDisassociateAssessmentReportEvidenceCommandOutput>(
  _ep0,
  _mw0,
