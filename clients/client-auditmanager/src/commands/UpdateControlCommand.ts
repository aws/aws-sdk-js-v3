...
import type { UpdateControlRequest, UpdateControlResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateControlCommand extends command<UpdateControlCommandInput, UpdateControlCommandOutput>(
  _ep0,
  _mw0,
  "UpdateControl",
  UpdateControl$
