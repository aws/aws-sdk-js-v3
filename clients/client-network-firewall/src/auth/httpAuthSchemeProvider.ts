...
import { type NetworkFirewallClientResolvedConfig, NetworkFirewallClientConfig } from "../NetworkFirewallClient";
 ...
 * @internal
 */
export const defaultNetworkFirewallHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: NetworkFirewallHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultNetworkFirewallHttpAuthSchemeProvider: NetworkFirewallHttpAuthSchemeProvider = (authParameters) => {
