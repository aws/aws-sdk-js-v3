 ...
 * @public
 */
export class UpdateAvailabilityZoneChangeProtectionCommand extends command<UpdateAvailabilityZoneChangeProtectionCommandInput, UpdateAvailabilityZoneChangeProtectionCommandOutput>(
  _ep0,
  _mw0,
