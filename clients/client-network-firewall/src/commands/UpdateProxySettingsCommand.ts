...
import { UpdateProxySettings$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class UpdateProxySettingsCommand extends command<UpdateProxySettingsCommandInput, UpdateProxySettingsCommandOutput>(
  _ep0,
  _mw0,
  "UpdateProxySettings",
  UpdateProxySettings$
