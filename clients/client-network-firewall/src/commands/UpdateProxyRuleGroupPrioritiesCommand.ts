 ...
 * @public
 */
export class UpdateProxyRuleGroupPrioritiesCommand extends command<UpdateProxyRuleGroupPrioritiesCommandInput, UpdateProxyRuleGroupPrioritiesCommandOutput>(
  _ep0,
  _mw0,
