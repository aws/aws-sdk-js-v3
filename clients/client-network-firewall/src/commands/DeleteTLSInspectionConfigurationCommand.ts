 ...
 * @public
 */
export class DeleteTLSInspectionConfigurationCommand extends command<DeleteTLSInspectionConfigurationCommandInput, DeleteTLSInspectionConfigurationCommandOutput>(
  _ep0,
  _mw0,
