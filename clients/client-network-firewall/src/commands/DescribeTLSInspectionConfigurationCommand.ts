 ...
 * @public
 */
export class DescribeTLSInspectionConfigurationCommand extends command<DescribeTLSInspectionConfigurationCommandInput, DescribeTLSInspectionConfigurationCommandOutput>(
  _ep0,
  _mw0,
