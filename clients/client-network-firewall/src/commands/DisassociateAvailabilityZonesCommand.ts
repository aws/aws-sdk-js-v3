 ...
 * @public
 */
export class DisassociateAvailabilityZonesCommand extends command<DisassociateAvailabilityZonesCommandInput, DisassociateAvailabilityZonesCommandOutput>(
  _ep0,
  _mw0,
