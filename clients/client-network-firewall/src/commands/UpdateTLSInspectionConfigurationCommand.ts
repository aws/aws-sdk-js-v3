 ...
 * @public
 */
export class UpdateTLSInspectionConfigurationCommand extends command<UpdateTLSInspectionConfigurationCommandInput, UpdateTLSInspectionConfigurationCommandOutput>(
  _ep0,
  _mw0,
