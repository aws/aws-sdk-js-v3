 ...
 * @public
 */
export class ListTLSInspectionConfigurationsCommand extends command<ListTLSInspectionConfigurationsCommandInput, ListTLSInspectionConfigurationsCommandOutput>(
  _ep0,
  _mw0,
