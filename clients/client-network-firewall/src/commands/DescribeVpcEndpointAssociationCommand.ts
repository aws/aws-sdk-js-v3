 ...
 * @public
 */
export class DescribeVpcEndpointAssociationCommand extends command<DescribeVpcEndpointAssociationCommandInput, DescribeVpcEndpointAssociationCommandOutput>(
  _ep0,
  _mw0,
