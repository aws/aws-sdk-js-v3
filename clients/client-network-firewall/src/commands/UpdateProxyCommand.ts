...
import type { UpdateProxyRequest, UpdateProxyResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateProxyCommand extends command<UpdateProxyCommandInput, UpdateProxyCommandOutput>(
  _ep0,
  _mw0,
  "UpdateProxy",
  UpdateProxy$
