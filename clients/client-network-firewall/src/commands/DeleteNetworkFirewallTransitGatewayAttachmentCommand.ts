 ...
 * @public
 */
export class DeleteNetworkFirewallTransitGatewayAttachmentCommand extends command<DeleteNetworkFirewallTransitGatewayAttachmentCommandInput, DeleteNetworkFirewallTransitGatewayAttachmentCommandOutput>(
  _ep0,
  _mw0,
