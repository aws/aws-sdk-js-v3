 ...
 * ```javascript
 * import { CommanderClient, PutResourcePolicyCommand } from "@aws-sdk/client-commander"; // ES Modules import
 * // const { CommanderClient, PutResourcePolicyCommand } = require("@aws-sdk/client-commander"); // CommonJS import
