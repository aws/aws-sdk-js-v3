 ...
 * ```javascript
 * import { CommanderClient, GetResponsePlanCommand } from "@aws-sdk/client-commander"; // ES Modules import
 * // const { CommanderClient, GetResponsePlanCommand } = require("@aws-sdk/client-commander"); // CommonJS import
