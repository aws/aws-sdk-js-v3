 ...
 * ```javascript
 * import { CommanderClient, ListResponsePlansCommand } from "@aws-sdk/client-commander"; // ES Modules import
 * // const { CommanderClient, ListResponsePlansCommand } = require("@aws-sdk/client-commander"); // CommonJS import
