 ...
 * ```javascript
 * import { CommanderClient, UpdateIncidentRecordCommand } from "@aws-sdk/client-commander"; // ES Modules import
 * // const { CommanderClient, UpdateIncidentRecordCommand } = require("@aws-sdk/client-commander"); // CommonJS import
