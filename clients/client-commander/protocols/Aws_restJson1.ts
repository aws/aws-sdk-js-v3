...
const deserializeAws_restJson1CreateReplicationSetCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.commander#AccessDeniedException":
      response = {
    ...
    case "com.amazonaws.commander#ConflictException":
      response = {
    ...
    case "com.amazonaws.commander#ServiceQuotaExceededException":
      response = {
    ...
    case "com.amazonaws.commander#ThrottlingException":
      response = {
    ...
    case "com.amazonaws.commander#ValidationException":
      response = {
...
const deserializeAws_restJson1CreateResponsePlanCommandError = async (
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.commander#ResourceNotFoundException":
      response = {
