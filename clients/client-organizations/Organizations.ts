...
export class Organizations extends OrganizationsClient {
   ...
   *                     handshake: only a principal from the master account.</p>
   ...
   *             </li>
   *             <li>
   *                 <p>You already have an account in the AWS GovCloud (US) Region that is
   *                     associated with your master account in the commercial Region. </p>
   *             </li>
   *             <li>
   *                 <p>You call this action from the master account of your organization in the
   *                     commercial Region.</p>
   *             </li>
   *             <li>
   ...
   *             account access works, see <a href="http://docs.aws.amazon.com/govcloud-us/latest/UserGuide/govcloud-organizations.html">AWS Organizations</a> in the <i>AWS GovCloud User Guide.</i>
   *          </p>
   *
   *
   *         <p>For more information about creating accounts, see <a href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_create.html">Creating
   ...
   *                 <code>CreateOrganization</code> operation automatically becomes the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/orgs_getting-started_concepts.html#account">master account</a> of the new organization.</p>
   ...
   *             from the master account. The organization must be empty of member accounts.</p>
   */
   ...
   *     master account or by a member account that is a delegated administrator for an AWS service.</p>
   */
   ...
   *             account inherits, plus any policy of that type that is directly attached to the account. </p>
   ...
   *             remove the default SCP. This is the authorization strategy of an "<a href="https://docs.aws.amazon.com/organizations/latest/userguide/SCP_strategies.html#orgs_policies_allowlist">allow list</a>". If you instead attach a second SCP and leave the
   ...
   *                 AWS Services</a> in the <i>AWS Organizations User Guide.</i>
   *          </p>
   *         <p>This operation can be called only from the organization's master account and only if
   *             the organization has <a href="http://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_org_support-all-features.html">enabled all features</a>.</p>
   */
   ...
   *             <ul>
   *                <li>
   *                     <p>You can invite AWS accounts only from the same seller as the master
   ...
   *             the master account, use <a>RemoveAccountFromOrganization</a> instead.</p>
   ...
   *                         you want to make standalone, you must do the following steps:</p>
   *                     <ul>
   *                      <li>
   *                             <p>Accept the end user license agreement (EULA)</p>
   *                         </li>
   *                      <li>
   ...
   *         <important>
   *             <p>You can remove an account from your organization only if the account is configured
   ...
   *                 information required of standalone accounts is <i>not</i>
   ...
   *                 account and follow the steps at <a href="http://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_remove.html#leave-without-all-info"> To
   ...
   *             OUs and accounts remain in place, and any attached policies of the OU remain attached. </p>
   *         <p>This operation can be called only from the organization's master account.</p>
   */
