...
import type { UpdateResponsibilityTransferRequest, UpdateResponsibilityTransferResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateResponsibilityTransferCommand extends command<UpdateResponsibilityTransferCommandInput, UpdateResponsibilityTransferCommandOutput>(
  _ep0,
  _mw0,
