 ...
 * @public
 */
export class InviteOrganizationToTransferResponsibilityCommand extends command<InviteOrganizationToTransferResponsibilityCommandInput, InviteOrganizationToTransferResponsibilityCommandOutput>(
  _ep0,
  _mw0,
