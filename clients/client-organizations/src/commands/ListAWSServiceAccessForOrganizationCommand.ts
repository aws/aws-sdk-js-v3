 ...
 * @public
 */
export class ListAWSServiceAccessForOrganizationCommand extends command<ListAWSServiceAccessForOrganizationCommandInput, ListAWSServiceAccessForOrganizationCommandOutput>(
  _ep0,
  _mw0,
