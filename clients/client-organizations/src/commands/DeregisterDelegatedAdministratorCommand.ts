 ...
 * @public
 */
export class DeregisterDelegatedAdministratorCommand extends command<DeregisterDelegatedAdministratorCommandInput, DeregisterDelegatedAdministratorCommandOutput>(
  _ep0,
  _mw0,
