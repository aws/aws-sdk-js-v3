 ...
 *             again later.</p>
 *
 * @throws {@link DestinationParentNotFoundException} (client fault)
 *  <p>We can't find the destination container (a root or OU) with the <code>ParentId</code>
 *             that you specified.</p>
 *
 * @throws {@link DuplicateAccountException} (client fault)
 ...
 *             later.</p>
 *
 * @throws {@link SourceParentNotFoundException} (client fault)
 ...
 * @public
 */
export class MoveAccountCommand extends command<MoveAccountCommandInput, MoveAccountCommandOutput>(
  _ep0,
  _mw0,
  "MoveAccount",
  MoveAccount$
