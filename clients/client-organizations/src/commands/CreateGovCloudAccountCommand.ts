...
import type { CreateGovCloudAccountRequest, CreateGovCloudAccountResponse } from "../models/models_0";
 ...
 *          <ul>
 *             <li>
 *                <p>Use the <code>Id</code> response element from this operation to
 ...
 * @public
 */
export class CreateGovCloudAccountCommand extends command<CreateGovCloudAccountCommandInput, CreateGovCloudAccountCommandOutput>(
  _ep0,
  _mw0,
