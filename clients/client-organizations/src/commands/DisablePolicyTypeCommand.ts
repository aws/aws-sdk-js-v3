...
import type { DisablePolicyTypeRequest, DisablePolicyTypeResponse } from "../models/models_0";
 ...
 * @public
 */
export class DisablePolicyTypeCommand extends command<DisablePolicyTypeCommandInput, DisablePolicyTypeCommandOutput>(
  _ep0,
  _mw0,
  "DisablePolicyType",
  DisablePolicyType$
