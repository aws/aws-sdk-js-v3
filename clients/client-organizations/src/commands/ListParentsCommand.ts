...
import type { ListParentsRequest, ListParentsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListParentsCommand extends command<ListParentsCommandInput, ListParentsCommandOutput>(
  _ep0,
  _mw0,
  "ListParents",
  ListParents$
