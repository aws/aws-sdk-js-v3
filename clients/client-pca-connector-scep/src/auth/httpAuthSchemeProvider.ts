...
import { type PcaConnectorScepClientResolvedConfig, PcaConnectorScepClientConfig } from "../PcaConnectorScepClient";
 ...
 * @internal
 */
export const defaultPcaConnectorScepHttpAuthSchemeProvider: PcaConnectorScepHttpAuthSchemeProvider = (authParameters) => {
