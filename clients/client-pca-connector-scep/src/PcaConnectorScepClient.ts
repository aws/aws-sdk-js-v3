...
import {
  ...
  defaultPcaConnectorScepHttpAuthSchemeParametersProvider,
  resolveHttpAuthSchemeConfig,
} from "./auth/httpAuthSchemeProvider";
import type { CreateChallengeCommandInput, CreateChallengeCommandOutput } from "./commands/CreateChallengeCommand";
import type { CreateConnectorCommandInput, CreateConnectorCommandOutput } from "./commands/CreateConnectorCommand";
import type { DeleteChallengeCommandInput, DeleteChallengeCommandOutput } from "./commands/DeleteChallengeCommand";
 ...
 * @public
 */
export type PcaConnectorScepClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type PcaConnectorScepClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<PcaConnectorScepClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: PcaConnectorScepClientResolvedConfig) =>
