...
export var GetKeyResponse$: StaticStructureSchema = [
  3,
  n0,
  _GKRe,
  0,
...
export var ListKeysResponseListItem$: StaticStructureSchema = [3, n0, _LKRLI, 0, [_K, _V], [0, [() => Value, 0]]];
export var PutKeyRequest$: StaticStructureSchema = [
  3,
  n0,
  _PKR,
  0,
...
var DeleteKeyRequestsList: StaticListSchema = [1, n0, _DKRL, 0, () => DeleteKeyRequestListItem$];
var ListKeysResponseList: StaticListSchema = [1, n0, _LKRL, 0, [() => ListKeysResponseListItem$, 0]];
var PutKeyRequestsList: StaticListSchema = [1, n0, _PKRL, 0, [() => PutKeyRequestListItem$, 0]];
...
export var GetKey$: StaticOperationSchema = [
  9,
  n0,
  _GK,
...
export var PutKey$: StaticOperationSchema = [
  9,
  n0,
  _PK,
...
export var UpdateKeys$: StaticOperationSchema = [
  9,
  n0,
  _UK,
