...
const AWS_TEMPLATE = "opsworks-cm.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "opsworks-cm.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "opsworks-cm.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "opsworks-cm.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "opsworks-cm.{region}.amazonaws.com";
// Partition regions
