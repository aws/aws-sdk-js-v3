...
export async function deserializeAws_json1_1AssociateNodeCommand(
  ...
  let contents: any = {};
  contents = deserializeAws_json1_1AssociateNodeResponse(
...
export async function deserializeAws_json1_1DeleteServerCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_json1_1DeleteServerResponse(
...
export async function deserializeAws_json1_1DescribeServersCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_json1_1DescribeServersResponse(
...
export async function deserializeAws_json1_1DisassociateNodeCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_json1_1DisassociateNodeResponse(
...
export async function deserializeAws_json1_1RestoreServerCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_json1_1RestoreServerResponse(
...
export async function deserializeAws_json1_1StartMaintenanceCommand(
  ...
  const data: any = await parseBody(output.body, context);
  let contents: any = {};
  contents = deserializeAws_json1_1StartMaintenanceResponse(
