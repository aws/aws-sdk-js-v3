...
export async function serializeAws_json1_1AssociateNodeCommand(
  ...
  const wrappedBody: any = {
    AssociateNodeRequest: serializeAws_json1_1AssociateNodeRequest(input, context),
  };
...
export async function serializeAws_json1_1DescribeAccountAttributesCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    DescribeAccountAttributesRequest: serializeAws_json1_1DescribeAccountAttributesRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1DescribeNodeAssociationStatusCommand(
  ...
  const headers: any = {};
  headers['Content-Type'] = "application/x-amz-json-1.1";
  headers['X-Amz-Target'] = "OpsWorksCM_V2016_11_01.DescribeNodeAssociationStatus";
  let body: any = {};
  const wrappedBody: any = {
    DescribeNodeAssociationStatusRequest: serializeAws_json1_1DescribeNodeAssociationStatusRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1DescribeServersCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    DescribeServersRequest: serializeAws_json1_1DescribeServersRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1DisassociateNodeCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    DisassociateNodeRequest: serializeAws_json1_1DisassociateNodeRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1ExportServerEngineAttributeCommand(
  ...
  const headers: any = {};
  headers['Content-Type'] = "application/x-amz-json-1.1";
  headers['X-Amz-Target'] = "OpsWorksCM_V2016_11_01.ExportServerEngineAttribute";
  let body: any = {};
  const wrappedBody: any = {
    ExportServerEngineAttributeRequest: serializeAws_json1_1ExportServerEngineAttributeRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1RestoreServerCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    RestoreServerRequest: serializeAws_json1_1RestoreServerRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1StartMaintenanceCommand(
  ...
  let body: any = {};
  const wrappedBody: any = {
    StartMaintenanceRequest: serializeAws_json1_1StartMaintenanceRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
...
export async function serializeAws_json1_1UpdateServerEngineAttributesCommand(
  ...
  const headers: any = {};
  headers['Content-Type'] = "application/x-amz-json-1.1";
  headers['X-Amz-Target'] = "OpsWorksCM_V2016_11_01.UpdateServerEngineAttributes";
  let body: any = {};
  const wrappedBody: any = {
    UpdateServerEngineAttributesRequest: serializeAws_json1_1UpdateServerEngineAttributesRequest(input, context),
  };
  body = JSON.stringify(wrappedBody);
  return new __HttpRequest({
    ...context.endpoint,
