...
import { CodeStarConnectionsClientConfig, CodeStarConnectionsClientResolvedConfig } from "../CodeStarConnectionsClient";
 ...
 * @internal
 */
export const defaultCodeStarConnectionsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CodeStarConnectionsHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<CodeStarConnectionsClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultCodeStarConnectionsHttpAuthSchemeProvider: CodeStarConnectionsHttpAuthSchemeProvider = (
  authParameters
) => {
