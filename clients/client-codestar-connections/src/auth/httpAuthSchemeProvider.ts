...
import {
  type CodeStarConnectionsClientResolvedConfig,
  CodeStarConnectionsClientConfig,
 ...
 * @internal
 */
export const defaultCodeStarConnectionsHttpAuthSchemeProvider: CodeStarConnectionsHttpAuthSchemeProvider = (authParameters) => {
