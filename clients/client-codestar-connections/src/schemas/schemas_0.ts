...
export var CodeStarConnectionsServiceException$: StaticErrorSchema = [-3, _s, "CodeStarConnectionsServiceException", 0, [], []];
...
export var ListHostsInput$: StaticStructureSchema = [3, n0, _LHI,
  0,
  [_MR, _NT],
  [1, 0]
];
export var ListHostsOutput$: StaticStructureSchema = [3, n0, _LHO,
  0,
  [_Ho, _NT],
  [() => HostList, 0]
];
export var ListRepositoryLinksInput$: StaticStructureSchema = [3, n0, _LRLI,
  0,
  [_MR, _NT],
  [1, 0]
];
...
var LatestSyncBlockerList: StaticListSchema = [1, n0, _LSBL,
  0, () => SyncBlocker$
];
var RepositoryLinkList: StaticListSchema = [1, n0, _RLL,
  0, () => RepositoryLinkInfo$
];
var RepositorySyncDefinitionList: StaticListSchema = [1, n0, _RSDL,
  0, () => RepositorySyncDefinition$
];
var RepositorySyncEventList: StaticListSchema = [1, n0, _RSEL,
  0, () => RepositorySyncEvent$
];
var ResourceSyncEventList: StaticListSchema = [1, n0, _RSELe,
  0, () => ResourceSyncEvent$
];
var SecurityGroupIds = 64 | 0;
var SubnetIds = 64 | 0;
var SyncBlockerContextList: StaticListSchema = [1, n0, _SBCL,
  0, () => SyncBlockerContext$
];
var SyncConfigurationList: StaticListSchema = [1, n0, _SCL,
  0, () => SyncConfiguration$
];
var TagKeyList = 64 | 0;
...
export var CreateHost$: StaticOperationSchema = [9, n0, _CH,
  0, () => CreateHostInput$, () => CreateHostOutput$
];
export var CreateRepositoryLink$: StaticOperationSchema = [9, n0, _CRL,
  0, () => CreateRepositoryLinkInput$, () => CreateRepositoryLinkOutput$
];
export var CreateSyncConfiguration$: StaticOperationSchema = [9, n0, _CSC,
...
export var DeleteHost$: StaticOperationSchema = [9, n0, _DH,
  0, () => DeleteHostInput$, () => DeleteHostOutput$
];
export var DeleteRepositoryLink$: StaticOperationSchema = [9, n0, _DRL,
  0, () => DeleteRepositoryLinkInput$, () => DeleteRepositoryLinkOutput$
];
export var DeleteSyncConfiguration$: StaticOperationSchema = [9, n0, _DSC,
...
export var GetHost$: StaticOperationSchema = [9, n0, _GH,
  0, () => GetHostInput$, () => GetHostOutput$
];
export var GetRepositoryLink$: StaticOperationSchema = [9, n0, _GRL,
...
export var GetResourceSyncStatus$: StaticOperationSchema = [9, n0, _GRSSe,
  0, () => GetResourceSyncStatusInput$, () => GetResourceSyncStatusOutput$
];
export var GetSyncBlockerSummary$: StaticOperationSchema = [9, n0, _GSBS,
  0, () => GetSyncBlockerSummaryInput$, () => GetSyncBlockerSummaryOutput$
];
export var GetSyncConfiguration$: StaticOperationSchema = [9, n0, _GSC,
...
export var ListHosts$: StaticOperationSchema = [9, n0, _LH,
  0, () => ListHostsInput$, () => ListHostsOutput$
];
export var ListRepositoryLinks$: StaticOperationSchema = [9, n0, _LRL,
...
export var ListSyncConfigurations$: StaticOperationSchema = [9, n0, _LSC,
...
export var UpdateHost$: StaticOperationSchema = [9, n0, _UH,
  0, () => UpdateHostInput$, () => UpdateHostOutput$
];
export var UpdateRepositoryLink$: StaticOperationSchema = [9, n0, _URL,
  0, () => UpdateRepositoryLinkInput$, () => UpdateRepositoryLinkOutput$
];
export var UpdateSyncBlocker$: StaticOperationSchema = [9, n0, _USB,
  0, () => UpdateSyncBlockerInput$, () => UpdateSyncBlockerOutput$
];
export var UpdateSyncConfiguration$: StaticOperationSchema = [9, n0, _USC,
