...
export var GetSyncBlockerSummaryOutput$: StaticStructureSchema = [
  3,
  n0,
  _GSBSO,
  0,
...
export var ListSyncConfigurationsInput$: StaticStructureSchema = [
  3,
  n0,
  _LSCI,
  0,
...
var HostList: StaticListSchema = [1, n0, _HL, 0, () => Host$];
var LatestSyncBlockerList: StaticListSchema = [1, n0, _LSBL, 0, () => SyncBlocker$];
var RepositoryLinkList: StaticListSchema = [1, n0, _RLL, 0, () => RepositoryLinkInfo$];
var RepositorySyncDefinitionList: StaticListSchema = [1, n0, _RSDL, 0, () => RepositorySyncDefinition$];
var RepositorySyncEventList: StaticListSchema = [1, n0, _RSEL, 0, () => RepositorySyncEvent$];
var ResourceSyncEventList: StaticListSchema = [1, n0, _RSELe, 0, () => ResourceSyncEvent$];
var SecurityGroupIds = 64 | 0;
var SubnetIds = 64 | 0;
var SyncBlockerContextList: StaticListSchema = [1, n0, _SBCL, 0, () => SyncBlockerContext$];
var SyncConfigurationList: StaticListSchema = [1, n0, _SCL, 0, () => SyncConfiguration$];
var TagKeyList = 64 | 0;
