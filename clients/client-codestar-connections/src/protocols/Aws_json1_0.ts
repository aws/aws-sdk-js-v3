...
const serializeAws_json1_0ListConnectionsInput = (input: ListConnectionsInput, context: __SerdeContext): any => {
  return {
    ...(input.HostArnFilter != undefined && { HostArnFilter: input.HostArnFilter }),
...
const serializeAws_json1_0VpcConfiguration = (input: VpcConfiguration, context: __SerdeContext): any => {
  return {
    ...
    ...(input.SubnetIds != undefined && { SubnetIds: serializeAws_json1_0SubnetIds(input.SubnetIds, context) }),
...
const deserializeAws_json1_0ListConnectionsOutput = (output: any, context: __SerdeContext): ListConnectionsOutput => {
  return {
    Connections:
      output.Connections != undefined ? deserializeAws_json1_0ConnectionList(output.Connections, context) : undefined,
...
const deserializeAws_json1_0ListHostsOutput = (output: any, context: __SerdeContext): ListHostsOutput => {
  return {
    Hosts: output.Hosts != undefined ? deserializeAws_json1_0HostList(output.Hosts, context) : undefined,
    NextToken: __expectString(output.NextToken),
  } as any;
};
  ...
  return {
    SecurityGroupIds:
      output.SecurityGroupIds != undefined
        ...
        : undefined,
    SubnetIds: output.SubnetIds != undefined ? deserializeAws_json1_0SubnetIds(output.SubnetIds, context) : undefined,
