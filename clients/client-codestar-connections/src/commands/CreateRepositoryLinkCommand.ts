...
> {
   ...
   * @public
   */
  constructor(readonly input: CreateRepositoryLinkCommandInput) {
    super();
  }
  ...
  ): Handler<CreateRepositoryLinkCommandInput, CreateRepositoryLinkCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, CreateRepositoryLinkCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: CreateRepositoryLinkCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_CreateRepositoryLinkCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<CreateRepositoryLinkCommandOutput> {
    return de_CreateRepositoryLinkCommand(output, context);
  }
}
