...
> {
   ...
   * @public
   */
  constructor(readonly input: DeleteRepositoryLinkCommandInput) {
    super();
  }
  ...
  ): Handler<DeleteRepositoryLinkCommandInput, DeleteRepositoryLinkCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DeleteRepositoryLinkCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: DeleteRepositoryLinkCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_DeleteRepositoryLinkCommand(input, context);
  }

  /**
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<DeleteRepositoryLinkCommandOutput> {
    return de_DeleteRepositoryLinkCommand(output, context);
  }
}
