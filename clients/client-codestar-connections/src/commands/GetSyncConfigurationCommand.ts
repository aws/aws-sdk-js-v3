...
> {
   ...
   * @public
   */
  constructor(readonly input: GetSyncConfigurationCommandInput) {
    super();
  }
  ...
  ): Handler<GetSyncConfigurationCommandInput, GetSyncConfigurationCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, GetSyncConfigurationCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: GetSyncConfigurationCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetSyncConfigurationCommandOutput> {
