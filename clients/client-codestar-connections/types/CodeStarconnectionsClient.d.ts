...
export declare type ServiceInputTypes = CreateConnectionCommandInput | DeleteConnectionCommandInput | GetConnectionCommandInput | ListConnectionsCommandInput;
export declare type ServiceOutputTypes = CreateConnectionCommandOutput | DeleteConnectionCommandOutput | GetConnectionCommandOutput | ListConnectionsCommandOutput;
...
export declare type CodeStarconnectionsClientConfig = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & AwsAuthInputConfig & RetryInputConfig & UserAgentInputConfig & HostHeaderInputConfig;
export declare type CodeStarconnectionsClientResolvedConfig = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & AwsAuthResolvedConfig & RetryResolvedConfig & UserAgentResolvedConfig & HostHeaderResolvedConfig;
/**
