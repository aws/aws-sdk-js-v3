...
import { type BedrockAgentCoreClientResolvedConfig, BedrockAgentCoreClientConfig } from "../BedrockAgentCoreClient";
 ...
 * @internal
 */
export const defaultBedrockAgentCoreHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: BedrockAgentCoreHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<BedrockAgentCoreClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultBedrockAgentCoreHttpAuthSchemeProvider: BedrockAgentCoreHttpAuthSchemeProvider = (authParameters) => {
