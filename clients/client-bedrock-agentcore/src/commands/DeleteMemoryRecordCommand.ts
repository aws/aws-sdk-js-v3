...
import type { DeleteMemoryRecordInput } from "../models/models_0";
import type { DeleteMemoryRecordOutput } from "../models/models_1";
 ...
 * @public
 */
export class DeleteMemoryRecordCommand extends command<DeleteMemoryRecordCommandInput, DeleteMemoryRecordCommandOutput>(
  _ep0,
  _mw0,
  "DeleteMemoryRecord",
  DeleteMemoryRecord$
