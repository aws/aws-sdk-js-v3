 ...
 * @public
 */
export class GetWorkloadAccessTokenForUserIdCommand extends command<GetWorkloadAccessTokenForUserIdCommandInput, GetWorkloadAccessTokenForUserIdCommandOutput>(
  _ep0,
  _mw0,
