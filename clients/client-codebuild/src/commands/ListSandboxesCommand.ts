...
import type { ListSandboxesInput, ListSandboxesOutput } from "../models/models_0";
 ...
 * @public
 */
export class ListSandboxesCommand extends command<ListSandboxesCommandInput, ListSandboxesCommandOutput>(
  _ep0,
  _mw0,
  "ListSandboxes",
  ListSandboxes$
