...
export var BuildArtifacts$: StaticStructureSchema = [3, n0, _BA,
  0,
  [_lo, _sh, _md, _oAN, _eD, _aI, _bOA],
  [0, 0, 0, 2, 2, 0, 0]
];
export var BuildBatch$: StaticStructureSchema = [3, n0, _BB,
  0,
...
export var BuildBatchFilter$: StaticStructureSchema = [3, n0, _BBF,
  0,
  [_st],
  [0]
];
export var BuildBatchPhase$: StaticStructureSchema = [3, n0, _BBP,
  0,
  [_pT, _pS, _sT, _eT, _dIS, _con],
  [0, 0, 4, 4, 1, () => PhaseContexts]
];
export var BuildGroup$: StaticStructureSchema = [3, n0, _BG,
  0,
  [_ide, _dO, _iF, _cBS, _pBSL],
  [0, 64 | 0, 2, () => BuildSummary$, () => BuildSummaries]
];
export var BuildNotDeleted$: StaticStructureSchema = [3, n0, _BND,
  0,
  [_id, _sC],
  [0, 0]
];
export var BuildPhase$: StaticStructureSchema = [3, n0, _BP,
  0,
  [_pT, _pS, _sT, _eT, _dIS, _con],
  [0, 0, 4, 4, 1, () => PhaseContexts]
];
export var BuildStatusConfig$: StaticStructureSchema = [3, n0, _BSC,
  0,
  [_cont, _tU],
  [0, 0]
];
export var BuildSummary$: StaticStructureSchema = [3, n0, _BS,
  0,
  [_a, _rO, _bS, _pA, _sA],
...
export var CodeCoverageReportSummary$: StaticStructureSchema = [3, n0, _CCRS,
  0,
  [_lCP, _lCi, _lM, _bCP, _bCr, _bM],
  [1, 1, 1, 1, 1, 1]
];
export var CommandExecution$: StaticStructureSchema = [3, n0, _CE,
  0,
...
export var ComputeConfiguration$: StaticStructureSchema = [3, n0, _CCo,
  0,
  [_vCp, _me, _d, _mT, _iT],
  [1, 1, 1, 0, 0]
];
...
export var DebugSession$: StaticStructureSchema = [3, n0, _DS,
  0,
  [_sE, _sTe],
  [2, 0]
];
...
export var EnvironmentImage$: StaticStructureSchema = [3, n0, _EI,
  0,
  [_na, _de, _v],
  [0, 0, 64 | 0]
];
export var EnvironmentLanguage$: StaticStructureSchema = [3, n0, _EL,
  0,
  [_la, _im],
  [0, () => EnvironmentImages]
];
export var EnvironmentPlatform$: StaticStructureSchema = [3, n0, _EP,
  0,
  [_pl, _lan],
...
export var ListBuildBatchesForProjectOutput$: StaticStructureSchema = [3, n0, _LBBFPO,
  0,
  [_i, _nT],
  [64 | 0, 0]
];
export var ListBuildBatchesInput$: StaticStructureSchema = [3, n0, _LBBI,
  0,
  [_fi, _mR, _sO, _nT],
  [() => BuildBatchFilter$, 1, 0, 0]
];
export var ListBuildBatchesOutput$: StaticStructureSchema = [3, n0, _LBBO,
  0,
  [_i, _nT],
  [64 | 0, 0]
];
...
export var ListCuratedEnvironmentImagesInput$: StaticStructureSchema = [3, n0, _LCEII,
  0,
  [],
  []
];
export var ListCuratedEnvironmentImagesOutput$: StaticStructureSchema = [3, n0, _LCEIO,
  0,
  [_pla],
...
export var ListReportGroupsInput$: StaticStructureSchema = [3, n0, _LRGI,
  0,
  [_sO, _sB, _nT, _mR],
  [0, 0, 0, 1]
];
export var ListReportGroupsOutput$: StaticStructureSchema = [3, n0, _LRGO,
  0,
  [_nT, _rG],
  [0, 64 | 0]
];
...
export var ListReportsInput$: StaticStructureSchema = [3, n0, _LRI,
  0,
  [_sO, _nT, _mR, _fi],
  [0, 0, 1, () => ReportFilter$]
];
export var ListReportsOutput$: StaticStructureSchema = [3, n0, _LRO,
  0,
  [_nT, _r],
  [0, 64 | 0]
];
...
export var ListSandboxesInput$: StaticStructureSchema = [3, n0, _LSI,
  0,
  [_mR, _sO, _nT],
  [1, 0, 0]
];
export var ListSandboxesOutput$: StaticStructureSchema = [3, n0, _LSO,
  0,
  [_i, _nT],
  [64 | 0, 0]
];
export var ListSharedProjectsInput$: StaticStructureSchema = [3, n0, _LSPI,
  0,
  [_sB, _sO, _mR, _nT],
  [0, 0, 1, 0]
];
export var ListSharedProjectsOutput$: StaticStructureSchema = [3, n0, _LSPO,
  0,
  [_nT, _p],
  [0, 64 | 0]
];
export var ListSharedReportGroupsInput$: StaticStructureSchema = [3, n0, _LSRGI,
  0,
  [_sO, _sB, _nT, _mR],
  [0, 0, 0, 1]
];
export var ListSharedReportGroupsOutput$: StaticStructureSchema = [3, n0, _LSRGO,
  0,
  [_nT, _rG],
  [0, 64 | 0]
];
export var ListSourceCredentialsInput$: StaticStructureSchema = [3, n0, _LSCI,
  0,
  [],
  []
];
export var ListSourceCredentialsOutput$: StaticStructureSchema = [3, n0, _LSCO,
  0,
  [_sCI],
  [() => SourceCredentialsInfos]
];
export var LogsConfig$: StaticStructureSchema = [3, n0, _LC,
  0,
  [_cWL, _sL],
  [() => CloudWatchLogsConfig$, () => S3LogsConfig$]
];
export var LogsLocation$: StaticStructureSchema = [3, n0, _LL,
  0,
...
export var ProjectBuildBatchConfig$: StaticStructureSchema = [3, n0, _PBBC,
  0,
...
export var ProjectFleet$: StaticStructureSchema = [3, n0, _PF,
  0,
  [_fAl],
  [0]
];
...
export var ReportExportConfig$: StaticStructureSchema = [3, n0, _REC,
  0,
  [_eCT, _sD],
  [0, () => S3ReportExportConfig$]
];
export var ReportFilter$: StaticStructureSchema = [3, n0, _RF,
  0,
  [_st],
  [0]
];
export var ReportGroup$: StaticStructureSchema = [3, n0, _RG,
  0,
  [_a, _na, _t, _eCx, _cr, _lMa, _ta, _st],
  [0, 0, 0, () => ReportExportConfig$, 4, 4, () => TagList, 0]
];
export var ReportGroupTrendStats$: StaticStructureSchema = [3, n0, _RGTS,
  0,
  [_av, _ma, _mi],
  [0, 0, 0]
];
export var ReportWithRawData$: StaticStructureSchema = [3, n0, _RWRD,
  0,
  [_rAep, _da],
  [0, 0]
];
export var ResolvedArtifact$: StaticStructureSchema = [3, n0, _RA,
  0,
  [_t, _lo, _ide],
  [0, 0, 0]
];
...
export var RetryBuildBatchOutput$: StaticStructureSchema = [3, n0, _RBBO,
  0,
  [_bBu],
  [() => BuildBatch$]
];
export var RetryBuildInput$: StaticStructureSchema = [3, n0, _RBI,
  0,
  [_id, _iTd],
  [0, 0]
];
export var RetryBuildOutput$: StaticStructureSchema = [3, n0, _RBO,
  0,
  [_bui],
  [() => Build$]
];
...
export var Sandbox$: StaticStructureSchema = [3, n0, _S,
  0,
...
export var SandboxSession$: StaticStructureSchema = [3, n0, _SSa,
  0,
  [_id, _st, _sT, _eT, _cP, _ph, _rSV, _l, _nI],
  [0, 0, 4, 4, 0, () => SandboxSessionPhases, 0, () => LogsLocation$, () => NetworkInterface$]
];
export var SandboxSessionPhase$: StaticStructureSchema = [3, n0, _SSP,
  0,
  [_pT, _pS, _sT, _eT, _dIS, _con],
  [0, 0, 4, 4, 1, () => PhaseContexts]
];
export var ScalingConfigurationInput$: StaticStructureSchema = [3, n0, _SCI,
  0,
  [_sTc, _tTSC, _mCa],
  [0, () => TargetTrackingScalingConfigurations, 1]
];
export var ScalingConfigurationOutput$: StaticStructureSchema = [3, n0, _SCO,
  0,
  [_sTc, _tTSC, _mCa, _dC],
...
export var SSMSession$: StaticStructureSchema = [3, n0, _SSMS,
  0,
  [_sIe, _tV, _sU],
  [0, 0, 0]
];
...
export var StartSandboxInput$: StaticStructureSchema = [3, n0, _SSI,
  0,
  [_pN, _iTd],
  [0, [() => SensitiveString, 0]]
];
...
export var TargetTrackingScalingConfiguration$: StaticStructureSchema = [3, n0, _TTSC,
  0,
  [_mTe, _tVa],
  [0, 1]
];
export var TestCase$: StaticStructureSchema = [3, n0, _TC,
  0,
  [_rAep, _tRDP, _pre, _na, _st, _dINS, _m, _ex, _tSN],
  [0, 0, 0, 0, 0, 1, 0, 4, 0]
];
export var TestCaseFilter$: StaticStructureSchema = [3, n0, _TCF,
  0,
  [_st, _ke],
  [0, 0]
];
...
var BuildBatches: StaticListSchema = [1, n0, _BBu,
  0, () => BuildBatch$
];
var BuildBatchIds = 64 | 0;
var BuildBatchPhases: StaticListSchema = [1, n0, _BBPu,
  0, () => BuildBatchPhase$
];
var BuildGroups: StaticListSchema = [1, n0, _BGu,
  0, () => BuildGroup$
];
var BuildIds = 64 | 0;
var BuildPhases: StaticListSchema = [1, n0, _BPu,
  0, () => BuildPhase$
];
var BuildReportArns = 64 | 0;
var Builds: StaticListSchema = [1, n0, _Bu,
  0, () => Build$
];
var BuildsNotDeleted: StaticListSchema = [1, n0, _BNDu,
  0, () => BuildNotDeleted$
];
var BuildSummaries: StaticListSchema = [1, n0, _BSu,
  0, () => BuildSummary$
];
var CodeCoverages: StaticListSchema = [1, n0, _CCod,
  0, () => CodeCoverage$
];
var CommandExecutionIds = 64 | 0;
var CommandExecutions: StaticListSchema = [1, n0, _CEo,
  0, [() => CommandExecution$,
    0]
];
var ComputeTypesAllowed = 64 | 0;
var EnvironmentImages: StaticListSchema = [1, n0, _EIn,
  0, () => EnvironmentImage$
];
var EnvironmentLanguages: StaticListSchema = [1, n0, _ELn,
  0, () => EnvironmentLanguage$
];
var EnvironmentPlatforms: StaticListSchema = [1, n0, _EPn,
  0, () => EnvironmentPlatform$
];
var EnvironmentVariables: StaticListSchema = [1, n0, _EVn,
  0, () => EnvironmentVariable$
];
var ExportedEnvironmentVariables: StaticListSchema = [1, n0, _EEVx,
  0, () => ExportedEnvironmentVariable$
];
var FilterGroup: StaticListSchema = [1, n0, _FGi,
  0, () => WebhookFilter$
];
var FilterGroups: StaticListSchema = [1, n0, _FG,
  0, () => FilterGroup
];
var FleetArns = 64 | 0;
var FleetNames = 64 | 0;
var FleetProxyRuleEntities = 64 | 0;
var FleetProxyRules: StaticListSchema = [1, n0, _FPRl,
  0, () => FleetProxyRule$
];
var Fleets: StaticListSchema = [1, n0, _Fl,
  0, () => Fleet$
];
var FleetsAllowed = 64 | 0;
var Identifiers = 64 | 0;
var ImageVersions = 64 | 0;
var PhaseContexts: StaticListSchema = [1, n0, _PCh,
  0, () => PhaseContext$
];
var ProjectArns = 64 | 0;
var ProjectArtifactsList: StaticListSchema = [1, n0, _PAL,
  0, () => ProjectArtifacts$
];
var ProjectCacheModes = 64 | 0;
var ProjectFileSystemLocations: StaticListSchema = [1, n0, _PFSLr,
  0, () => ProjectFileSystemLocation$
];
var ProjectNames = 64 | 0;
var Projects: StaticListSchema = [1, n0, _Pr,
  0, () => Project$
];
var ProjectSecondarySourceVersions: StaticListSchema = [1, n0, _PSSV,
  0, () => ProjectSourceVersion$
];
var ProjectSources: StaticListSchema = [1, n0, _PSr,
  0, () => ProjectSource$
];
var PullRequestBuildApproverRoles = 64 | 0;
var ReportArns = 64 | 0;
var ReportGroupArns = 64 | 0;
var ReportGroups: StaticListSchema = [1, n0, _RGe,
  0, () => ReportGroup$
];
var ReportGroupTrendRawDataList: StaticListSchema = [1, n0, _RGTRDL,
  0, () => ReportWithRawData$
];
var Reports: StaticListSchema = [1, n0, _Re,
  0, () => Report$
];
var ResolvedSecondaryArtifacts: StaticListSchema = [1, n0, _RSA,
  0, () => ResolvedArtifact$
];
var Sandboxes: StaticListSchema = [1, n0, _Sa,
  0, () => Sandbox$
];
var SandboxIds = 64 | 0;
var SandboxSessionPhases: StaticListSchema = [1, n0, _SSPa,
  0, () => SandboxSessionPhase$
];
var SecurityGroupIds = 64 | 0;
var SourceCredentialsInfos: StaticListSchema = [1, n0, _SCIou,
...
var TargetTrackingScalingConfigurations: StaticListSchema = [1, n0, _TTSCa,
  0, () => TargetTrackingScalingConfiguration$
];
var TestCases: StaticListSchema = [1, n0, _TCe,
  0, () => TestCase$
];
var ReportStatusCounts = 128 | 1;
export var BatchDeleteBuilds$: StaticOperationSchema = [9, n0, _BDB,
  0, () => BatchDeleteBuildsInput$, () => BatchDeleteBuildsOutput$
];
export var BatchGetBuildBatches$: StaticOperationSchema = [9, n0, _BGBB,
  0, () => BatchGetBuildBatchesInput$, () => BatchGetBuildBatchesOutput$
];
export var BatchGetBuilds$: StaticOperationSchema = [9, n0, _BGB,
  0, () => BatchGetBuildsInput$, () => BatchGetBuildsOutput$
];
export var BatchGetCommandExecutions$: StaticOperationSchema = [9, n0, _BGCE,
  0, () => BatchGetCommandExecutionsInput$, () => BatchGetCommandExecutionsOutput$
];
export var BatchGetFleets$: StaticOperationSchema = [9, n0, _BGF,
  0, () => BatchGetFleetsInput$, () => BatchGetFleetsOutput$
];
export var BatchGetProjects$: StaticOperationSchema = [9, n0, _BGP,
  0, () => BatchGetProjectsInput$, () => BatchGetProjectsOutput$
];
export var BatchGetReportGroups$: StaticOperationSchema = [9, n0, _BGRG,
  0, () => BatchGetReportGroupsInput$, () => BatchGetReportGroupsOutput$
];
export var BatchGetReports$: StaticOperationSchema = [9, n0, _BGR,
  0, () => BatchGetReportsInput$, () => BatchGetReportsOutput$
];
export var BatchGetSandboxes$: StaticOperationSchema = [9, n0, _BGS,
...
export var CreateReportGroup$: StaticOperationSchema = [9, n0, _CRG,
  0, () => CreateReportGroupInput$, () => CreateReportGroupOutput$
];
export var CreateWebhook$: StaticOperationSchema = [9, n0, _CW,
  0, () => CreateWebhookInput$, () => CreateWebhookOutput$
];
export var DeleteBuildBatch$: StaticOperationSchema = [9, n0, _DBB,
...
export var DeleteReport$: StaticOperationSchema = [9, n0, _DR,
  0, () => DeleteReportInput$, () => DeleteReportOutput$
];
export var DeleteReportGroup$: StaticOperationSchema = [9, n0, _DRG,
...
export var DeleteSourceCredentials$: StaticOperationSchema = [9, n0, _DSC,
  0, () => DeleteSourceCredentialsInput$, () => DeleteSourceCredentialsOutput$
];
export var DeleteWebhook$: StaticOperationSchema = [9, n0, _DW,
  0, () => DeleteWebhookInput$, () => DeleteWebhookOutput$
];
export var DescribeCodeCoverages$: StaticOperationSchema = [9, n0, _DCC,
  0, () => DescribeCodeCoveragesInput$, () => DescribeCodeCoveragesOutput$
];
export var DescribeTestCases$: StaticOperationSchema = [9, n0, _DTC,
  0, () => DescribeTestCasesInput$, () => DescribeTestCasesOutput$
];
export var GetReportGroupTrend$: StaticOperationSchema = [9, n0, _GRGT,
...
export var ImportSourceCredentials$: StaticOperationSchema = [9, n0, _ISC,
  0, () => ImportSourceCredentialsInput$, () => ImportSourceCredentialsOutput$
];
export var InvalidateProjectCache$: StaticOperationSchema = [9, n0, _IPC,
  0, () => InvalidateProjectCacheInput$, () => InvalidateProjectCacheOutput$
];
export var ListBuildBatches$: StaticOperationSchema = [9, n0, _LBB,
  0, () => ListBuildBatchesInput$, () => ListBuildBatchesOutput$
];
export var ListBuildBatchesForProject$: StaticOperationSchema = [9, n0, _LBBFP,
...
export var ListBuildsForProject$: StaticOperationSchema = [9, n0, _LBFP,
  0, () => ListBuildsForProjectInput$, () => ListBuildsForProjectOutput$
];
export var ListCommandExecutionsForSandbox$: StaticOperationSchema = [9, n0, _LCEFS,
  0, () => ListCommandExecutionsForSandboxInput$, () => ListCommandExecutionsForSandboxOutput$
];
export var ListCuratedEnvironmentImages$: StaticOperationSchema = [9, n0, _LCEI,
...
export var ListReportGroups$: StaticOperationSchema = [9, n0, _LRG,
...
export var ListReportsForReportGroup$: StaticOperationSchema = [9, n0, _LRFRG,
  0, () => ListReportsForReportGroupInput$, () => ListReportsForReportGroupOutput$
];
export var ListSandboxes$: StaticOperationSchema = [9, n0, _LS,
  0, () => ListSandboxesInput$, () => ListSandboxesOutput$
];
export var ListSandboxesForProject$: StaticOperationSchema = [9, n0, _LSFP,
  0, () => ListSandboxesForProjectInput$, () => ListSandboxesForProjectOutput$
];
export var ListSharedProjects$: StaticOperationSchema = [9, n0, _LSP,
  0, () => ListSharedProjectsInput$, () => ListSharedProjectsOutput$
];
export var ListSharedReportGroups$: StaticOperationSchema = [9, n0, _LSRG,
  0, () => ListSharedReportGroupsInput$, () => ListSharedReportGroupsOutput$
];
export var ListSourceCredentials$: StaticOperationSchema = [9, n0, _LSC,
...
export var RetryBuild$: StaticOperationSchema = [9, n0, _RB,
  0, () => RetryBuildInput$, () => RetryBuildOutput$
];
export var RetryBuildBatch$: StaticOperationSchema = [9, n0, _RBB,
  0, () => RetryBuildBatchInput$, () => RetryBuildBatchOutput$
];
export var StartBuild$: StaticOperationSchema = [9, n0, _SB,
  0, () => StartBuildInput$, () => StartBuildOutput$
];
export var StartBuildBatch$: StaticOperationSchema = [9, n0, _SBB,
  0, () => StartBuildBatchInput$, () => StartBuildBatchOutput$
];
export var StartCommandExecution$: StaticOperationSchema = [9, n0, _SCE,
  0, () => StartCommandExecutionInput$, () => StartCommandExecutionOutput$
];
export var StartSandbox$: StaticOperationSchema = [9, n0, _SSt,
  0, () => StartSandboxInput$, () => StartSandboxOutput$
];
export var StartSandboxConnection$: StaticOperationSchema = [9, n0, _SSC,
  0, () => StartSandboxConnectionInput$, () => StartSandboxConnectionOutput$
];
export var StopBuild$: StaticOperationSchema = [9, n0, _SBt,
  0, () => StopBuildInput$, () => StopBuildOutput$
];
export var StopBuildBatch$: StaticOperationSchema = [9, n0, _SBBt,
  0, () => StopBuildBatchInput$, () => StopBuildBatchOutput$
];
export var StopSandbox$: StaticOperationSchema = [9, n0, _SSto,
...
export var UpdateProjectVisibility$: StaticOperationSchema = [9, n0, _UPV,
  0, () => UpdateProjectVisibilityInput$, () => UpdateProjectVisibilityOutput$
];
export var UpdateReportGroup$: StaticOperationSchema = [9, n0, _URG,
  0, () => UpdateReportGroupInput$, () => UpdateReportGroupOutput$
];
export var UpdateWebhook$: StaticOperationSchema = [9, n0, _UW,
