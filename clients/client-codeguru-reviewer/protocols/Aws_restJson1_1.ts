...
const serializeAws_restJson1_1CodeCommitRepository = (input: CodeCommitRepository, context: __SerdeContext): any => {
  return {
    ...(input.Name !== undefined && { Name: input.Name })
  };
};

const serializeAws_restJson1_1Repository = (input: Repository, context: __SerdeContext): any => {
  return {
    ...(input.CodeCommit !== undefined && {
      CodeCommit: serializeAws_restJson1_1CodeCommitRepository(input.CodeCommit, context)
    })
  };
};
...
const deserializeAws_restJson1_1RepositoryAssociationSummaries = (
  ...
  return (output || []).map((entry: any) => deserializeAws_restJson1_1RepositoryAssociationSummary(entry, context));
};
