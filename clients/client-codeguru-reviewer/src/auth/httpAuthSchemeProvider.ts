...
import { type CodeGuruReviewerClientResolvedConfig, CodeGuruReviewerClientConfig } from "../CodeGuruReviewerClient";
 ...
 * @internal
 */
export const defaultCodeGuruReviewerHttpAuthSchemeProvider: CodeGuruReviewerHttpAuthSchemeProvider = (authParameters) => {
