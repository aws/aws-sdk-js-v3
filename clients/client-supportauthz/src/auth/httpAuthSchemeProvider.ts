...
import { type SupportAuthZClientResolvedConfig, SupportAuthZClientConfig } from "../SupportAuthZClient";
 ...
 * @internal
 */
export const defaultSupportAuthZHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SupportAuthZHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<SupportAuthZClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultSupportAuthZHttpAuthSchemeProvider: SupportAuthZHttpAuthSchemeProvider = (authParameters) => {
