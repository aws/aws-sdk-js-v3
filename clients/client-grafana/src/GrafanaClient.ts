  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<GrafanaClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultGrafanaHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: GrafanaClientResolvedConfig) =>
