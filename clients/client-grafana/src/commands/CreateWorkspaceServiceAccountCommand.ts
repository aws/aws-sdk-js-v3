 ...
 * @public
 */
export class CreateWorkspaceServiceAccountCommand extends command<CreateWorkspaceServiceAccountCommandInput, CreateWorkspaceServiceAccountCommandOutput>(
  _ep0,
  _mw0,
