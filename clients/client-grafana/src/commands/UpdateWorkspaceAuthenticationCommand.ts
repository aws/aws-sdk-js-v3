...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: UpdateWorkspaceAuthenticationRequest.filterSensitiveLog,
      outputFilterSensitiveLog: UpdateWorkspaceAuthenticationResponse.filterSensitiveLog,
    };
