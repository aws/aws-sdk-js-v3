 ...
 * @public
 */
export class UpdateWorkspaceAuthenticationCommand extends command<UpdateWorkspaceAuthenticationCommandInput, UpdateWorkspaceAuthenticationCommandOutput>(
  _ep0,
  _mw0,
