 ...
 * @public
 */
export class DeleteWorkspaceServiceAccountCommand extends command<DeleteWorkspaceServiceAccountCommandInput, DeleteWorkspaceServiceAccountCommandOutput>(
  _ep0,
  _mw0,
