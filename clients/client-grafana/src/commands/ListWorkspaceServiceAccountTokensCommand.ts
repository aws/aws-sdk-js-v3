 ...
 * @public
 */
export class ListWorkspaceServiceAccountTokensCommand extends command<ListWorkspaceServiceAccountTokensCommandInput, ListWorkspaceServiceAccountTokensCommandOutput>(
  _ep0,
  _mw0,
