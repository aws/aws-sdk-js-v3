...
import { type GrafanaClientResolvedConfig, GrafanaClientConfig } from "../GrafanaClient";
 ...
 * @internal
 */
export const defaultGrafanaHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: GrafanaHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultGrafanaHttpAuthSchemeProvider: GrafanaHttpAuthSchemeProvider = (authParameters) => {
