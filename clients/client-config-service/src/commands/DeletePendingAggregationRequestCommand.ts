 ...
 * @public
 */
export class DeletePendingAggregationRequestCommand extends command<DeletePendingAggregationRequestCommandInput, DeletePendingAggregationRequestCommandOutput>(
  _ep0,
  _mw0,
