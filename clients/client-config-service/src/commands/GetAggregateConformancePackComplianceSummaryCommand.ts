 ...
 * @public
 */
export class GetAggregateConformancePackComplianceSummaryCommand extends command<GetAggregateConformancePackComplianceSummaryCommandInput, GetAggregateConformancePackComplianceSummaryCommandOutput>(
  _ep0,
  _mw0,
