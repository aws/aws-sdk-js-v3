 ...
 * @public
 */
export class DeleteAggregationAuthorizationCommand extends command<DeleteAggregationAuthorizationCommandInput, DeleteAggregationAuthorizationCommandOutput>(
  _ep0,
  _mw0,
