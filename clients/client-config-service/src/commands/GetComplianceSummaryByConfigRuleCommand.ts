 ...
 * @public
 */
export class GetComplianceSummaryByConfigRuleCommand extends command<GetComplianceSummaryByConfigRuleCommandInput, GetComplianceSummaryByConfigRuleCommandOutput>(
  _ep0,
  _mw0,
