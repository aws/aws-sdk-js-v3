 ...
 * @public
 */
export class DeleteRemediationConfigurationCommand extends command<DeleteRemediationConfigurationCommandInput, DeleteRemediationConfigurationCommandOutput>(
  _ep0,
  _mw0,
