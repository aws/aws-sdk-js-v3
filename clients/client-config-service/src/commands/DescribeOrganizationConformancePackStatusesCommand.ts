 ...
 * @public
 */
export class DescribeOrganizationConformancePackStatusesCommand extends command<DescribeOrganizationConformancePackStatusesCommandInput, DescribeOrganizationConformancePackStatusesCommandOutput>(
  _ep0,
  _mw0,
