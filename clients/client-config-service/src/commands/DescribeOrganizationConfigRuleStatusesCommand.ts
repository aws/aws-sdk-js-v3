 ...
 * @public
 */
export class DescribeOrganizationConfigRuleStatusesCommand extends command<DescribeOrganizationConfigRuleStatusesCommandInput, DescribeOrganizationConfigRuleStatusesCommandOutput>(
  _ep0,
  _mw0,
