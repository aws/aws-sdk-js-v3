 ...
 * ```
 *
 * @param GetConformancePackComplianceDetailsRequest - {@link GetConformancePackComplianceDetailsRequest}
 * @returns {@link GetConformancePackComplianceDetailsResponse}
