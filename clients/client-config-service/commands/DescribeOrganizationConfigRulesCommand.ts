...
export type DescribeOrganizationConfigRulesCommandOutput = DescribeOrganizationConfigRulesResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1DescribeOrganizationConfigRulesCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1DescribeOrganizationConfigRulesCommand(
      output,
      context
    );
  }
