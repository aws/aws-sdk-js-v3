...
export type DescribeConformancePackStatusCommandOutput = DescribeConformancePackStatusResponse &
  __MetadataBearer;
...
> {
  ...
  private serialize(
    ...
    return serializeAws_json1_1DescribeConformancePackStatusCommand(
      input,
      context
    );
  }
  ...
  private deserialize(
    ...
    return deserializeAws_json1_1DescribeConformancePackStatusCommand(
      output,
      context
    );
  }
