...
export async function serializeAws_restJson1_1CancelChangeSetCommand(
  ...
  if (input.Catalog !== undefined) {
    ...
    ] = __extendedEncodeURIComponent(input.Catalog.toString());
  }
  if (input.ChangeSetId !== undefined) {
    query[
      __extendedEncodeURIComponent("changeSetId")
    ] = __extendedEncodeURIComponent(input.ChangeSetId.toString());
  }
...
export async function serializeAws_restJson1_1DescribeEntityCommand(
  ...
  if (input.EntityId !== undefined) {
    ...
    ] = __extendedEncodeURIComponent(input.EntityId.toString());
  }
  return new __HttpRequest({
    ...context.endpoint,
    protocol: "https",
