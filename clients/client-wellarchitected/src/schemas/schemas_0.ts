...
export var UpdateWorkloadShareOutput: StaticStructureSchema = [3, n0, _UWSO, 0, [_WI, _WSor], [0, () => WorkloadShare]];
...
export var CheckDetails: StaticListSchema = [1, n0, _CDh, 0, () => CheckDetail];
export var CheckSummaries: StaticListSchema = [1, n0, _CSh, 0, () => CheckSummary];
export var ChoiceAnswers: StaticListSchema = [1, n0, _CA, 0, () => ChoiceAnswer];
export var ChoiceAnswerSummaries: StaticListSchema = [1, n0, _CAS, 0, () => ChoiceAnswerSummary];
export var ChoiceImprovementPlans: StaticListSchema = [1, n0, _CIPh, 0, () => ChoiceImprovementPlan];
export var Choices: StaticListSchema = [1, n0, _Ch, 0, () => Choice];
...
export var LensSummaries: StaticListSchema = [1, n0, _LSen, 0, () => LensSummary];
export var MilestoneSummaries: StaticListSchema = [1, n0, _MS, 0, () => MilestoneSummary];
export var NotificationSummaries: StaticListSchema = [1, n0, _NS, 0, () => NotificationSummary];
export var PillarDifferences: StaticListSchema = [1, n0, _PDil, 0, () => PillarDifference];
...
export var ProfileQuestionUpdates: StaticListSchema = [1, n0, _PQUr, 0, () => ProfileQuestionUpdate];
export var ProfileShareSummaries: StaticListSchema = [1, n0, _PSS, 0, () => ProfileShareSummary];
export var ProfileSummaries: StaticListSchema = [1, n0, _PS, 0, () => ProfileSummary];
export var ProfileTemplateQuestionChoices: StaticListSchema = [1, n0, _PTQC, 0, () => ProfileTemplateChoice];
export var QuestionDifferences: StaticListSchema = [1, n0, _QDu, 0, () => QuestionDifference];
