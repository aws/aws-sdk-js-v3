 ...
 * @public
 */
export class UpdateReviewTemplateLensReviewCommand extends command<UpdateReviewTemplateLensReviewCommandInput, UpdateReviewTemplateLensReviewCommandOutput>(
  _ep0,
  _mw0,
