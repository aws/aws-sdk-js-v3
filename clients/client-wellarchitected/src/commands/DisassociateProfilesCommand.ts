...
> {
   ...
   * @public
   */
  constructor(readonly input: DisassociateProfilesCommandInput) {
  ...
  ): Handler<DisassociateProfilesCommandInput, DisassociateProfilesCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, DisassociateProfilesCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: DisassociateProfilesCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<DisassociateProfilesCommandOutput> {
