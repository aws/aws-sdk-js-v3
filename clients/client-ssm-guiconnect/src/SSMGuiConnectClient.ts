...
import {
  ...
  defaultSSMGuiConnectHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type SSMGuiConnectClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type SSMGuiConnectClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<SSMGuiConnectClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: SSMGuiConnectClientResolvedConfig) =>
