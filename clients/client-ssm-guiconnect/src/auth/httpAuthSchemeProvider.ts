...
import { type SSMGuiConnectClientResolvedConfig, SSMGuiConnectClientConfig } from "../SSMGuiConnectClient";
 ...
 * @internal
 */
export const defaultSSMGuiConnectHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: SSMGuiConnectHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<SSMGuiConnectClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultSSMGuiConnectHttpAuthSchemeProvider: SSMGuiConnectHttpAuthSchemeProvider = (authParameters) => {
