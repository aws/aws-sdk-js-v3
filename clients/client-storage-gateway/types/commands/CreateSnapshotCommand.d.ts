...
export declare type CreateSnapshotCommandInput = CreateSnapshotInput;
export declare type CreateSnapshotCommandOutput = CreateSnapshotOutput & __MetadataBearer;
