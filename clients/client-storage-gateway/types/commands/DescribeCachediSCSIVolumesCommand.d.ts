...
export declare type DescribeCachediSCSIVolumesCommandInput = DescribeCachediSCSIVolumesInput;
export declare type DescribeCachediSCSIVolumesCommandOutput = DescribeCachediSCSIVolumesOutput & __MetadataBearer;
