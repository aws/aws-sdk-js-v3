...
export declare type DescribeSMBSettingsCommandInput = DescribeSMBSettingsInput;
export declare type DescribeSMBSettingsCommandOutput = DescribeSMBSettingsOutput & __MetadataBearer;
