...
export type CreateTapesCommandOutput = CreateTapesOutput;

export class CreateTapesCommand extends $Command<CreateTapesCommandInput, CreateTapesCommandOutput, StorageGatewayClientResolvedConfig> {
