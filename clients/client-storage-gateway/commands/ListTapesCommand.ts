...
export type ListTapesCommandOutput = ListTapesOutput;

export class ListTapesCommand extends $Command<ListTapesCommandInput, ListTapesCommandOutput, StorageGatewayClientResolvedConfig> {
