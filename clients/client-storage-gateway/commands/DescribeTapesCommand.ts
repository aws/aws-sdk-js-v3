...
export type DescribeTapesCommandOutput = DescribeTapesOutput;

export class DescribeTapesCommand extends $Command<DescribeTapesCommandInput, DescribeTapesCommandOutput, StorageGatewayClientResolvedConfig> {
