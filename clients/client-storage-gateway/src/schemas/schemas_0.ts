...
export var AutomaticTapeCreationPolicyInfo$: StaticStructureSchema = [3, n0, _ATCPI,
  0,
  [_ATCR, _GARN],
...
export var CachediSCSIVolume$: StaticStructureSchema = [3, n0, _CSCSIV,
  0,
...
export var ChapInfo$: StaticStructureSchema = [3, n0, _CI,
  0,
...
export var DescribeTapeArchivesInput$: StaticStructureSchema = [3, n0, _DTAIe,
  0,
  [_TARNap, _M, _L],
  [64 | 0, 0, 1]
];
export var DescribeTapeArchivesOutput$: StaticStructureSchema = [3, n0, _DTAOe,
  0,
  [_TA, _M],
  [() => TapeArchives, 0]
];
...
export var DeviceiSCSIAttributes$: StaticStructureSchema = [3, n0, _DSCSIA,
  0,
...
export var Disk$: StaticStructureSchema = [3, n0, _Di,
  0,
  [_DIi, _DP, _DNi, _DS, _DSIB, _DAT, _DAR, _DAL],
  [0, 0, 0, 0, 1, 0, 0, 64 | 0]
];
export var EndpointNetworkConfiguration$: StaticStructureSchema = [3, n0, _ENC,
  0,
  [_IA],
  [64 | 0]
];
...
export var FileShareInfo$: StaticStructureSchema = [3, n0, _FSI,
  0,
  [_FST, _FSARN, _FSIi, _FSS, _GARN],
  [0, 0, 0, 0, 0]
];
export var FileSystemAssociationInfo$: StaticStructureSchema = [3, n0, _FSAI,
  0,
...
export var FileSystemAssociationStatusDetail$: StaticStructureSchema = [3, n0, _FSASDi,
  0,
  [_EC],
  [0]
];
export var FileSystemAssociationSummary$: StaticStructureSchema = [3, n0, _FSASi,
  0,
  [_FSAIi, _FSAARN, _FSAS, _GARN],
  [0, 0, 0, 0]
];
export var GatewayInfo$: StaticStructureSchema = [3, n0, _GIa,
  0,
...
export var ListAutomaticTapeCreationPoliciesInput$: StaticStructureSchema = [3, n0, _LATCPI,
  0,
  [_GARN],
  [0]
];
export var ListAutomaticTapeCreationPoliciesOutput$: StaticStructureSchema = [3, n0, _LATCPO,
  0,
  [_ATCPIu],
  [() => AutomaticTapeCreationPolicyInfos]
];
export var ListCacheReportsInput$: StaticStructureSchema = [3, n0, _LCRI,
  0,
  [_M],
  [0]
];
export var ListCacheReportsOutput$: StaticStructureSchema = [3, n0, _LCRO,
  0,
  [_CRL, _M],
  [() => CacheReportList, 0]
];
export var ListFileSharesInput$: StaticStructureSchema = [3, n0, _LFSI,
  0,
  [_GARN, _L, _M],
  [0, 1, 0]
];
export var ListFileSharesOutput$: StaticStructureSchema = [3, n0, _LFSO,
  0,
  [_M, _NM, _FSIL],
  [0, 0, () => FileShareInfoList]
];
export var ListFileSystemAssociationsInput$: StaticStructureSchema = [3, n0, _LFSAI,
  0,
  [_GARN, _L, _M],
  [0, 1, 0]
];
export var ListFileSystemAssociationsOutput$: StaticStructureSchema = [3, n0, _LFSAO,
  0,
  [_M, _NM, _FSASL],
...
export var ListTapePoolsInput$: StaticStructureSchema = [3, n0, _LTPI,
  0,
  [_PARNo, _M, _L],
  [64 | 0, 0, 1]
];
export var ListTapePoolsOutput$: StaticStructureSchema = [3, n0, _LTPO,
  0,
  [_PIo, _M],
  [() => PoolInfos, 0]
];
export var ListTapesInput$: StaticStructureSchema = [3, n0, _LTI,
  0,
  [_TARNap, _M, _L],
  [64 | 0, 0, 1]
];
export var ListTapesOutput$: StaticStructureSchema = [3, n0, _LTO,
  0,
  [_TI, _M],
  [() => TapeInfos, 0]
];
...
export var ListVolumesInput$: StaticStructureSchema = [3, n0, _LVI,
  0,
  [_GARN, _M, _L],
  [0, 0, 1]
];
export var ListVolumesOutput$: StaticStructureSchema = [3, n0, _LVO,
  0,
  [_GARN, _M, _VIo],
  [0, 0, () => VolumeInfos]
];
...
export var NFSFileShareDefaults$: StaticStructureSchema = [3, n0, _NFSFSD,
  0,
  [_FM, _DM, _GIr, _OI],
  [0, 0, 1, 1]
];
export var NFSFileShareInfo$: StaticStructureSchema = [3, n0, _NFSFSI,
  0,
...
export var PoolInfo$: StaticStructureSchema = [3, n0, _PIoo,
  0,
...
export var SMBFileShareInfo$: StaticStructureSchema = [3, n0, _SMBFSI,
  0,
...
export var SMBLocalGroups$: StaticStructureSchema = [3, n0, _SMBLG,
  0,
  [_GA],
  [64 | 0]
];
export var SoftwareUpdatePreferences$: StaticStructureSchema = [3, n0, _SUP,
  0,
  [_AUP],
  [0]
];
...
export var StorageGatewayError$: StaticStructureSchema = [3, n0, _SGE,
  0,
  [_eC, _eD],
  [0, 128 | 0]
];
export var StorediSCSIVolume$: StaticStructureSchema = [3, n0, _SSCSIVt,
  0,
...
export var TapeArchive$: StaticStructureSchema = [3, n0, _TAa,
  0,
  [_TARN, _TB, _TCD, _TSIB, _CTo, _RT, _TS, _TUIB, _KMSK, _PI, _W, _RSD, _PEDo],
  [0, 0, 4, 1, 4, 0, 0, 1, 0, 0, 2, 4, 4]
];
export var TapeInfo$: StaticStructureSchema = [3, n0, _TIa,
  0,
  [_TARN, _TB, _TSIB, _TS, _GARN, _PI, _RSD, _PEDo],
  [0, 0, 1, 0, 0, 0, 4, 4]
];
export var TapeRecoveryPointInfo$: StaticStructureSchema = [3, n0, _TRPIa,
  0,
...
export var VolumeInfo$: StaticStructureSchema = [3, n0, _VIol,
  0,
  [_VARN, _VI, _GARN, _GI, _VT, _VSIB, _VAS],
  [0, 0, 0, 0, 0, 1, 0]
];
export var VolumeiSCSIAttributes$: StaticStructureSchema = [3, n0, _VSCSIA,
  0,
  [_TARNa, _NII, _NIP, _LN, _CE],
  [0, 0, 1, 1, 2]
];
export var VolumeRecoveryPointInfo$: StaticStructureSchema = [3, n0, _VRPIo,
  0,
  [_VARN, _VSIB, _VUIBo, _VRPT],
  [0, 1, 1, 0]
];
export var VTLDevice$: StaticStructureSchema = [3, n0, _VTLDe,
  0,
...
var AutomaticTapeCreationRules: StaticListSchema = [1, n0, _ATCR,
  0, () => AutomaticTapeCreationRule$
];
var BandwidthRateLimitIntervals: StaticListSchema = [1, n0, _BRLIa,
  0, () => BandwidthRateLimitInterval$
];
var CachediSCSIVolumes: StaticListSchema = [1, n0, _CSCSIVa,
  0, () => CachediSCSIVolume$
];
var CacheReportFilterList: StaticListSchema = [1, n0, _CRFL,
  0, () => CacheReportFilter$
];
var CacheReportFilterValues = 64 | 0;
var CacheReportList: StaticListSchema = [1, n0, _CRL,
  0, () => CacheReportInfo$
];
var ChapCredentials: StaticListSchema = [1, n0, _CC,
  0, [() => ChapInfo$,
    0]
];
var DaysOfWeek = 64 | 1;
...
var DiskIds = 64 | 0;
var Disks: StaticListSchema = [1, n0, _Dis,
  0, () => Disk$
];
var FileShareARNList = 64 | 0;
var FileShareClientList = 64 | 0;
var FileShareInfoList: StaticListSchema = [1, n0, _FSIL,
  0, () => FileShareInfo$
];
var FileSystemAssociationARNList = 64 | 0;
var FileSystemAssociationInfoList: StaticListSchema = [1, n0, _FSAIL,
  0, () => FileSystemAssociationInfo$
];
var FileSystemAssociationStatusDetails: StaticListSchema = [1, n0, _FSASD,
  0, () => FileSystemAssociationStatusDetail$
];
var FileSystemAssociationSummaryList: StaticListSchema = [1, n0, _FSASL,
  0, () => FileSystemAssociationSummary$
];
var FolderList = 64 | 0;
var GatewayNetworkInterfaces: StaticListSchema = [1, n0, _GNI,
  0, [() => NetworkInterface$,
    0]
];
var Gateways: StaticListSchema = [1, n0, _G,
  0, () => GatewayInfo$
];
var Hosts = 64 | 0;
var Initiators = 64 | 0;
var IpAddressList = 64 | 0;
var NFSFileShareInfoList: StaticListSchema = [1, n0, _NFSFSIL,
  0, () => NFSFileShareInfo$
];
var PoolARNs = 64 | 0;
var PoolInfos: StaticListSchema = [1, n0, _PIo,
  0, () => PoolInfo$
];
var SMBFileShareInfoList: StaticListSchema = [1, n0, _SMBFSIL,
  0, () => SMBFileShareInfo$
];
var StorediSCSIVolumes: StaticListSchema = [1, n0, _SSCSIV,
  0, () => StorediSCSIVolume$
];
...
var TapeArchives: StaticListSchema = [1, n0, _TA,
  0, () => TapeArchive$
];
var TapeARNs = 64 | 0;
var TapeInfos: StaticListSchema = [1, n0, _TI,
  0, () => TapeInfo$
];
var TapeRecoveryPointInfos: StaticListSchema = [1, n0, _TRPI,
  0, () => TapeRecoveryPointInfo$
];
var Tapes: StaticListSchema = [1, n0, _Ta,
  0, () => Tape$
];
var UserList = 64 | 0;
var VolumeARNs = 64 | 0;
var VolumeInfos: StaticListSchema = [1, n0, _VIo,
  0, () => VolumeInfo$
];
var VolumeRecoveryPointInfos: StaticListSchema = [1, n0, _VRPI,
  0, () => VolumeRecoveryPointInfo$
];
var VTLDeviceARNs = 64 | 0;
var VTLDevices: StaticListSchema = [1, n0, _VTLD,
  0, () => VTLDevice$
];
var errorDetails = 128 | 0;
export var ActivateGateway$: StaticOperationSchema = [9, n0, _AG,
  0, () => ActivateGatewayInput$, () => ActivateGatewayOutput$
];
export var AddCache$: StaticOperationSchema = [9, n0, _AC,
...
export var AddUploadBuffer$: StaticOperationSchema = [9, n0, _AUB,
  0, () => AddUploadBufferInput$, () => AddUploadBufferOutput$
];
export var AddWorkingStorage$: StaticOperationSchema = [9, n0, _AWS,
  0, () => AddWorkingStorageInput$, () => AddWorkingStorageOutput$
];
export var AssignTapePool$: StaticOperationSchema = [9, n0, _ATP,
  0, () => AssignTapePoolInput$, () => AssignTapePoolOutput$
];
export var AssociateFileSystem$: StaticOperationSchema = [9, n0, _AFS,
  0, () => AssociateFileSystemInput$, () => AssociateFileSystemOutput$
];
export var AttachVolume$: StaticOperationSchema = [9, n0, _AV,
  0, () => AttachVolumeInput$, () => AttachVolumeOutput$
];
export var CancelArchival$: StaticOperationSchema = [9, n0, _CAa,
  0, () => CancelArchivalInput$, () => CancelArchivalOutput$
];
export var CancelCacheReport$: StaticOperationSchema = [9, n0, _CCR,
  0, () => CancelCacheReportInput$, () => CancelCacheReportOutput$
];
export var CancelRetrieval$: StaticOperationSchema = [9, n0, _CR,
  0, () => CancelRetrievalInput$, () => CancelRetrievalOutput$
];
export var CreateCachediSCSIVolume$: StaticOperationSchema = [9, n0, _CCSCSIV,
  0, () => CreateCachediSCSIVolumeInput$, () => CreateCachediSCSIVolumeOutput$
];
export var CreateNFSFileShare$: StaticOperationSchema = [9, n0, _CNFSFS,
  0, () => CreateNFSFileShareInput$, () => CreateNFSFileShareOutput$
];
export var CreateSMBFileShare$: StaticOperationSchema = [9, n0, _CSMBFS,
...
export var CreateSnapshotFromVolumeRecoveryPoint$: StaticOperationSchema = [9, n0, _CSFVRP,
  0, () => CreateSnapshotFromVolumeRecoveryPointInput$, () => CreateSnapshotFromVolumeRecoveryPointOutput$
];
export var CreateStorediSCSIVolume$: StaticOperationSchema = [9, n0, _CSSCSIV,
  0, () => CreateStorediSCSIVolumeInput$, () => CreateStorediSCSIVolumeOutput$
];
export var CreateTapePool$: StaticOperationSchema = [9, n0, _CTP,
  0, () => CreateTapePoolInput$, () => CreateTapePoolOutput$
];
export var CreateTapes$: StaticOperationSchema = [9, n0, _CTr,
  0, () => CreateTapesInput$, () => CreateTapesOutput$
];
export var CreateTapeWithBarcode$: StaticOperationSchema = [9, n0, _CTWB,
  0, () => CreateTapeWithBarcodeInput$, () => CreateTapeWithBarcodeOutput$
];
export var DeleteAutomaticTapeCreationPolicy$: StaticOperationSchema = [9, n0, _DATCP,
  0, () => DeleteAutomaticTapeCreationPolicyInput$, () => DeleteAutomaticTapeCreationPolicyOutput$
];
export var DeleteBandwidthRateLimit$: StaticOperationSchema = [9, n0, _DBRL,
  0, () => DeleteBandwidthRateLimitInput$, () => DeleteBandwidthRateLimitOutput$
];
export var DeleteCacheReport$: StaticOperationSchema = [9, n0, _DCR,
  0, () => DeleteCacheReportInput$, () => DeleteCacheReportOutput$
];
export var DeleteChapCredentials$: StaticOperationSchema = [9, n0, _DCC,
  0, () => DeleteChapCredentialsInput$, () => DeleteChapCredentialsOutput$
];
export var DeleteFileShare$: StaticOperationSchema = [9, n0, _DFS,
...
export var DeleteTape$: StaticOperationSchema = [9, n0, _DTe,
  0, () => DeleteTapeInput$, () => DeleteTapeOutput$
];
export var DeleteTapeArchive$: StaticOperationSchema = [9, n0, _DTA,
  0, () => DeleteTapeArchiveInput$, () => DeleteTapeArchiveOutput$
];
export var DeleteTapePool$: StaticOperationSchema = [9, n0, _DTP,
...
export var DescribeAvailabilityMonitorTest$: StaticOperationSchema = [9, n0, _DAMT,
  0, () => DescribeAvailabilityMonitorTestInput$, () => DescribeAvailabilityMonitorTestOutput$
];
export var DescribeBandwidthRateLimit$: StaticOperationSchema = [9, n0, _DBRLe,
  0, () => DescribeBandwidthRateLimitInput$, () => DescribeBandwidthRateLimitOutput$
];
export var DescribeBandwidthRateLimitSchedule$: StaticOperationSchema = [9, n0, _DBRLS,
  0, () => DescribeBandwidthRateLimitScheduleInput$, () => DescribeBandwidthRateLimitScheduleOutput$
];
export var DescribeCache$: StaticOperationSchema = [9, n0, _DCe,
  0, () => DescribeCacheInput$, () => DescribeCacheOutput$
];
export var DescribeCachediSCSIVolumes$: StaticOperationSchema = [9, n0, _DCSCSIV,
  0, () => DescribeCachediSCSIVolumesInput$, () => DescribeCachediSCSIVolumesOutput$
];
export var DescribeCacheReport$: StaticOperationSchema = [9, n0, _DCRe,
  0, () => DescribeCacheReportInput$, () => DescribeCacheReportOutput$
];
export var DescribeChapCredentials$: StaticOperationSchema = [9, n0, _DCCe,
  0, () => DescribeChapCredentialsInput$, () => DescribeChapCredentialsOutput$
];
export var DescribeFileSystemAssociations$: StaticOperationSchema = [9, n0, _DFSA,
  0, () => DescribeFileSystemAssociationsInput$, () => DescribeFileSystemAssociationsOutput$
];
export var DescribeGatewayInformation$: StaticOperationSchema = [9, n0, _DGIe,
  0, () => DescribeGatewayInformationInput$, () => DescribeGatewayInformationOutput$
];
export var DescribeMaintenanceStartTime$: StaticOperationSchema = [9, n0, _DMST,
  0, () => DescribeMaintenanceStartTimeInput$, () => DescribeMaintenanceStartTimeOutput$
];
export var DescribeNFSFileShares$: StaticOperationSchema = [9, n0, _DNFSFS,
  0, () => DescribeNFSFileSharesInput$, () => DescribeNFSFileSharesOutput$
];
export var DescribeSMBFileShares$: StaticOperationSchema = [9, n0, _DSMBFS,
  0, () => DescribeSMBFileSharesInput$, () => DescribeSMBFileSharesOutput$
];
export var DescribeSMBSettings$: StaticOperationSchema = [9, n0, _DSMBS,
  0, () => DescribeSMBSettingsInput$, () => DescribeSMBSettingsOutput$
];
export var DescribeSnapshotSchedule$: StaticOperationSchema = [9, n0, _DSSe,
  0, () => DescribeSnapshotScheduleInput$, () => DescribeSnapshotScheduleOutput$
];
export var DescribeStorediSCSIVolumes$: StaticOperationSchema = [9, n0, _DSSCSIV,
  0, () => DescribeStorediSCSIVolumesInput$, () => DescribeStorediSCSIVolumesOutput$
];
export var DescribeTapeArchives$: StaticOperationSchema = [9, n0, _DTAe,
  0, () => DescribeTapeArchivesInput$, () => DescribeTapeArchivesOutput$
];
export var DescribeTapeRecoveryPoints$: StaticOperationSchema = [9, n0, _DTRP,
  0, () => DescribeTapeRecoveryPointsInput$, () => DescribeTapeRecoveryPointsOutput$
];
export var DescribeTapes$: StaticOperationSchema = [9, n0, _DTes,
  0, () => DescribeTapesInput$, () => DescribeTapesOutput$
];
export var DescribeUploadBuffer$: StaticOperationSchema = [9, n0, _DUB,
  0, () => DescribeUploadBufferInput$, () => DescribeUploadBufferOutput$
];
export var DescribeVTLDevices$: StaticOperationSchema = [9, n0, _DVTLD,
  0, () => DescribeVTLDevicesInput$, () => DescribeVTLDevicesOutput$
];
export var DescribeWorkingStorage$: StaticOperationSchema = [9, n0, _DWS,
  0, () => DescribeWorkingStorageInput$, () => DescribeWorkingStorageOutput$
];
export var DetachVolume$: StaticOperationSchema = [9, n0, _DVe,
  0, () => DetachVolumeInput$, () => DetachVolumeOutput$
];
export var DisableGateway$: StaticOperationSchema = [9, n0, _DGi,
  0, () => DisableGatewayInput$, () => DisableGatewayOutput$
];
export var DisassociateFileSystem$: StaticOperationSchema = [9, n0, _DFSi,
  0, () => DisassociateFileSystemInput$, () => DisassociateFileSystemOutput$
];
export var EvictFilesFailingUpload$: StaticOperationSchema = [9, n0, _EFFU,
  0, () => EvictFilesFailingUploadInput$, () => EvictFilesFailingUploadOutput$
];
export var JoinDomain$: StaticOperationSchema = [9, n0, _JD,
  0, () => JoinDomainInput$, () => JoinDomainOutput$
];
export var ListAutomaticTapeCreationPolicies$: StaticOperationSchema = [9, n0, _LATCP,
  0, () => ListAutomaticTapeCreationPoliciesInput$, () => ListAutomaticTapeCreationPoliciesOutput$
];
export var ListCacheReports$: StaticOperationSchema = [9, n0, _LCR,
  0, () => ListCacheReportsInput$, () => ListCacheReportsOutput$
];
export var ListFileShares$: StaticOperationSchema = [9, n0, _LFS,
  0, () => ListFileSharesInput$, () => ListFileSharesOutput$
];
export var ListFileSystemAssociations$: StaticOperationSchema = [9, n0, _LFSA,
...
export var ListLocalDisks$: StaticOperationSchema = [9, n0, _LLD,
  0, () => ListLocalDisksInput$, () => ListLocalDisksOutput$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceInput$, () => ListTagsForResourceOutput$
];
export var ListTapePools$: StaticOperationSchema = [9, n0, _LTP,
  0, () => ListTapePoolsInput$, () => ListTapePoolsOutput$
];
export var ListTapes$: StaticOperationSchema = [9, n0, _LT,
  0, () => ListTapesInput$, () => ListTapesOutput$
];
export var ListVolumeInitiators$: StaticOperationSchema = [9, n0, _LVIi,
  0, () => ListVolumeInitiatorsInput$, () => ListVolumeInitiatorsOutput$
];
export var ListVolumeRecoveryPoints$: StaticOperationSchema = [9, n0, _LVRP,
...
export var NotifyWhenUploaded$: StaticOperationSchema = [9, n0, _NWU,
  0, () => NotifyWhenUploadedInput$, () => NotifyWhenUploadedOutput$
];
export var RefreshCache$: StaticOperationSchema = [9, n0, _RC,
...
export var ResetCache$: StaticOperationSchema = [9, n0, _RCe,
  0, () => ResetCacheInput$, () => ResetCacheOutput$
];
export var RetrieveTapeArchive$: StaticOperationSchema = [9, n0, _RTA,
  0, () => RetrieveTapeArchiveInput$, () => RetrieveTapeArchiveOutput$
];
export var RetrieveTapeRecoveryPoint$: StaticOperationSchema = [9, n0, _RTRP,
  0, () => RetrieveTapeRecoveryPointInput$, () => RetrieveTapeRecoveryPointOutput$
];
export var SetLocalConsolePassword$: StaticOperationSchema = [9, n0, _SLCP,
  0, () => SetLocalConsolePasswordInput$, () => SetLocalConsolePasswordOutput$
];
export var SetSMBGuestPassword$: StaticOperationSchema = [9, n0, _SSMBGP,
  0, () => SetSMBGuestPasswordInput$, () => SetSMBGuestPasswordOutput$
];
export var ShutdownGateway$: StaticOperationSchema = [9, n0, _SG,
  0, () => ShutdownGatewayInput$, () => ShutdownGatewayOutput$
];
export var StartAvailabilityMonitorTest$: StaticOperationSchema = [9, n0, _SAMT,
  0, () => StartAvailabilityMonitorTestInput$, () => StartAvailabilityMonitorTestOutput$
];
export var StartCacheReport$: StaticOperationSchema = [9, n0, _SCR,
  0, () => StartCacheReportInput$, () => StartCacheReportOutput$
];
export var StartGateway$: StaticOperationSchema = [9, n0, _SGt,
  0, () => StartGatewayInput$, () => StartGatewayOutput$
];
export var UpdateAutomaticTapeCreationPolicy$: StaticOperationSchema = [9, n0, _UATCP,
  0, () => UpdateAutomaticTapeCreationPolicyInput$, () => UpdateAutomaticTapeCreationPolicyOutput$
];
export var UpdateBandwidthRateLimit$: StaticOperationSchema = [9, n0, _UBRL,
  0, () => UpdateBandwidthRateLimitInput$, () => UpdateBandwidthRateLimitOutput$
];
export var UpdateBandwidthRateLimitSchedule$: StaticOperationSchema = [9, n0, _UBRLS,
  0, () => UpdateBandwidthRateLimitScheduleInput$, () => UpdateBandwidthRateLimitScheduleOutput$
];
export var UpdateChapCredentials$: StaticOperationSchema = [9, n0, _UCC,
  0, () => UpdateChapCredentialsInput$, () => UpdateChapCredentialsOutput$
];
export var UpdateFileSystemAssociation$: StaticOperationSchema = [9, n0, _UFSA,
...
export var UpdateMaintenanceStartTime$: StaticOperationSchema = [9, n0, _UMST,
  0, () => UpdateMaintenanceStartTimeInput$, () => UpdateMaintenanceStartTimeOutput$
];
export var UpdateNFSFileShare$: StaticOperationSchema = [9, n0, _UNFSFS,
  0, () => UpdateNFSFileShareInput$, () => UpdateNFSFileShareOutput$
];
export var UpdateSMBFileShare$: StaticOperationSchema = [9, n0, _USMBFS,
  0, () => UpdateSMBFileShareInput$, () => UpdateSMBFileShareOutput$
];
export var UpdateSMBFileShareVisibility$: StaticOperationSchema = [9, n0, _USMBFSV,
  0, () => UpdateSMBFileShareVisibilityInput$, () => UpdateSMBFileShareVisibilityOutput$
];
export var UpdateSMBLocalGroups$: StaticOperationSchema = [9, n0, _USMBLG,
  0, () => UpdateSMBLocalGroupsInput$, () => UpdateSMBLocalGroupsOutput$
];
export var UpdateSMBSecurityStrategy$: StaticOperationSchema = [9, n0, _USMBSS,
  0, () => UpdateSMBSecurityStrategyInput$, () => UpdateSMBSecurityStrategyOutput$
];
export var UpdateSnapshotSchedule$: StaticOperationSchema = [9, n0, _USS,
  0, () => UpdateSnapshotScheduleInput$, () => UpdateSnapshotScheduleOutput$
];
export var UpdateVTLDeviceType$: StaticOperationSchema = [9, n0, _UVTLDT,
