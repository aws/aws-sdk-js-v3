...
import type { AddUploadBufferInput, AddUploadBufferOutput } from "../models/models_0";
 ...
 * @public
 */
export class AddUploadBufferCommand extends command<AddUploadBufferCommandInput, AddUploadBufferCommandOutput>(
  _ep0,
  _mw0,
  "AddUploadBuffer",
  AddUploadBuffer$
