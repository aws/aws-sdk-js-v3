...
import type { CancelArchivalInput, CancelArchivalOutput } from "../models/models_0";
 ...
 * @public
 */
export class CancelArchivalCommand extends command<CancelArchivalCommandInput, CancelArchivalCommandOutput>(
  _ep0,
  _mw0,
  "CancelArchival",
  CancelArchival$
