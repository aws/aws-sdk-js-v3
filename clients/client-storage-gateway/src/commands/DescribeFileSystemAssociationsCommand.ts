 ...
 * @public
 */
export class DescribeFileSystemAssociationsCommand extends command<DescribeFileSystemAssociationsCommandInput, DescribeFileSystemAssociationsCommandOutput>(
  _ep0,
  _mw0,
