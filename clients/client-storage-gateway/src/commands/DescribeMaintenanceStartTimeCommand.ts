...
import type { DescribeMaintenanceStartTimeInput, DescribeMaintenanceStartTimeOutput } from "../models/models_0";
 ...
 * @public
 */
export class DescribeMaintenanceStartTimeCommand extends command<DescribeMaintenanceStartTimeCommandInput, DescribeMaintenanceStartTimeCommandOutput>(
  _ep0,
  _mw0,
