...
import type { DescribeTapeArchivesInput, DescribeTapeArchivesOutput } from "../models/models_0";
 ...
 * @public
 */
export class DescribeTapeArchivesCommand extends command<DescribeTapeArchivesCommandInput, DescribeTapeArchivesCommandOutput>(
  _ep0,
  _mw0,
