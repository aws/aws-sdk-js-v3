...
import type { DescribeTapeRecoveryPointsInput, DescribeTapeRecoveryPointsOutput } from "../models/models_0";
 ...
 * @public
 */
export class DescribeTapeRecoveryPointsCommand extends command<DescribeTapeRecoveryPointsCommandInput, DescribeTapeRecoveryPointsCommandOutput>(
  _ep0,
  _mw0,
