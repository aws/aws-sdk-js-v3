...
import type { DeleteChapCredentialsInput, DeleteChapCredentialsOutput } from "../models/models_0";
 ...
 * @public
 */
export class DeleteChapCredentialsCommand extends command<DeleteChapCredentialsCommandInput, DeleteChapCredentialsCommandOutput>(
  _ep0,
  _mw0,
