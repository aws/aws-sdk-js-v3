...
import type { StartGatewayInput, StartGatewayOutput } from "../models/models_0";
 ...
 * @public
 */
export class StartGatewayCommand extends command<StartGatewayCommandInput, StartGatewayCommandOutput>(
  _ep0,
  _mw0,
  "StartGateway",
  StartGateway$
