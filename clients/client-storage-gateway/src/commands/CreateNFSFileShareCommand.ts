...
import type { CreateNFSFileShareInput, CreateNFSFileShareOutput } from "../models/models_0";
 ...
 * @public
 */
export class CreateNFSFileShareCommand extends command<CreateNFSFileShareCommandInput, CreateNFSFileShareCommandOutput>(
  _ep0,
  _mw0,
  "CreateNFSFileShare",
  CreateNFSFileShare$
