...
import type { CancelRetrievalInput, CancelRetrievalOutput } from "../models/models_0";
 ...
 * @public
 */
export class CancelRetrievalCommand extends command<CancelRetrievalCommandInput, CancelRetrievalCommandOutput>(
  _ep0,
  _mw0,
  "CancelRetrieval",
  CancelRetrieval$
