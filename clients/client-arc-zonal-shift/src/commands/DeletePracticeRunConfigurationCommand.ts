 ...
 * @public
 */
export class DeletePracticeRunConfigurationCommand extends command<DeletePracticeRunConfigurationCommandInput, DeletePracticeRunConfigurationCommandOutput>(
  _ep0,
  _mw0,
