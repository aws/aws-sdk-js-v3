...
import { LookoutVisionHttpAuthSchemeProvider } from "./httpAuthSchemeProvider";
...
export interface HttpAuthExtensionConfiguration {
  ...
  setHttpAuthSchemeProvider(httpAuthSchemeProvider: LookoutVisionHttpAuthSchemeProvider): void;
