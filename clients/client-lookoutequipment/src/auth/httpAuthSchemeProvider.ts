...
import { type LookoutEquipmentClientResolvedConfig, LookoutEquipmentClientConfig } from "../LookoutEquipmentClient";
 ...
 * @internal
 */
export const defaultLookoutEquipmentHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: LookoutEquipmentHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<LookoutEquipmentClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultLookoutEquipmentHttpAuthSchemeProvider: LookoutEquipmentHttpAuthSchemeProvider = (authParameters) => {
