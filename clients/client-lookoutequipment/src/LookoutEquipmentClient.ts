  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<LookoutEquipmentClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultLookoutEquipmentHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: LookoutEquipmentClientResolvedConfig) =>
