...
import {
  defaultIoT1ClickProjectsHttpAuthSchemeParametersProvider,
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<IoT1ClickProjectsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultIoT1ClickProjectsHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: IoT1ClickProjectsClientResolvedConfig) =>
