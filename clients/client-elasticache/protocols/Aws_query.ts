...
const serializeAws_queryCacheNodeIdsList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "CacheNodeId." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const serializeAws_queryCacheSecurityGroupNameList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "CacheSecurityGroupName." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const serializeAws_queryCustomerNodeEndpointList = (
  ...
  (input || []).map(entry => {
    const loc: string = "member." + counter;
    entries[loc] = serializeAws_queryCustomerNodeEndpoint(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryNodeGroupConfigurationList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "NodeGroupConfiguration." + counter;
    entries[loc] = serializeAws_queryNodeGroupConfiguration(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryNodeGroupsToRemoveList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "NodeGroupToRemove." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const serializeAws_queryNodeGroupsToRetainList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "NodeGroupToRetain." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const serializeAws_queryParameterNameValueList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "ParameterNameValue." + counter;
    entries[loc] = serializeAws_queryParameterNameValue(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryPreferredAvailabilityZoneList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "PreferredAvailabilityZone." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const serializeAws_queryReplicaConfigurationList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "ConfigureShard." + counter;
    entries[loc] = serializeAws_queryConfigureShard(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_queryReshardingConfigurationList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "ReshardingConfiguration." + counter;
    entries[loc] = serializeAws_queryReshardingConfiguration(entry, context);
    counter++;
  });
  return entries;
};
...
const serializeAws_querySecurityGroupIdsList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "SecurityGroupId." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const serializeAws_querySnapshotArnsList = (
  ...
  let counter = 1;
  (input || []).map(entry => {
    const loc: string = "SnapshotArn." + counter;
    entries[loc] = entry;
    counter++;
  });
  return entries;
...
const deserializeAws_queryCacheCluster = (
  ...
  if (output["CacheNodes"]["CacheNode"] !== undefined) {
  ...
  if (output["CacheSecurityGroups"]["CacheSecurityGroup"] !== undefined) {
  ...
  if (output["SecurityGroups"]["member"] !== undefined) {
...
const deserializeAws_queryCacheClusterMessage = (
  ...
  if (output["CacheClusters"]["CacheCluster"] !== undefined) {
...
const deserializeAws_queryCacheEngineVersionMessage = (
  ...
  if (output["CacheEngineVersions"]["CacheEngineVersion"] !== undefined) {
...
const deserializeAws_queryCacheParameterGroupStatus = (
  ...
  if (output["CacheNodeIdsToReboot"]["CacheNodeId"] !== undefined) {
...
const deserializeAws_queryCacheParameterGroupsMessage = (
  ...
  if (output["CacheParameterGroups"]["CacheParameterGroup"] !== undefined) {
...
const deserializeAws_queryCacheSubnetGroupMessage = (
  ...
  if (output["CacheSubnetGroups"]["CacheSubnetGroup"] !== undefined) {
...
const deserializeAws_queryNodeGroup = (
  ...
  if (output["NodeGroupMembers"]["NodeGroupMember"] !== undefined) {
...
const deserializeAws_queryNodeGroupConfiguration = (
  ...
  if (output["ReplicaAvailabilityZones"]["AvailabilityZone"] !== undefined) {
...
const deserializeAws_queryPendingModifiedValues = (
  ...
  if (output["CacheNodeIdsToRemove"]["CacheNodeId"] !== undefined) {
...
const deserializeAws_queryReplicationGroupMessage = (
  ...
  if (output["ReplicationGroups"]["ReplicationGroup"] !== undefined) {
...
const deserializeAws_queryReservedCacheNodeMessage = (
  ...
  if (output["ReservedCacheNodes"]["ReservedCacheNode"] !== undefined) {
...
const deserializeAws_queryServiceUpdatesMessage = (
  ...
  if (output["ServiceUpdates"]["ServiceUpdate"] !== undefined) {
...
const deserializeAws_querySnapshot = (
  ...
  if (output["NodeSnapshots"]["NodeSnapshot"] !== undefined) {
...
const deserializeAws_queryUpdateAction = (
  ...
  if (output["CacheNodeUpdateStatus"]["CacheNodeUpdateStatus"] !== undefined) {
  ...
  if (output["NodeGroupUpdateStatus"]["NodeGroupUpdateStatus"] !== undefined) {
...
const deserializeAws_queryUpdateActionResultsMessage = (
  ...
  if (output["ProcessedUpdateActions"]["ProcessedUpdateAction"] !== undefined) {
...
const deserializeAws_queryUpdateActionsMessage = (
  ...
  if (output["UpdateActions"]["UpdateAction"] !== undefined) {
