 ...
 * @public
 */
export class DescribeReservedCacheNodesOfferingsCommand extends command<DescribeReservedCacheNodesOfferingsCommandInput, DescribeReservedCacheNodesOfferingsCommandOutput>(
  _ep0,
  _mw0,
