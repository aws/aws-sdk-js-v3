 ...
 * @public
 */
export class DescribeServerlessCacheSnapshotsCommand extends command<DescribeServerlessCacheSnapshotsCommandInput, DescribeServerlessCacheSnapshotsCommandOutput>(
  _ep0,
  _mw0,
