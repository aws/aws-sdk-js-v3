 ...
 * @public
 */
export class CreateServerlessCacheSnapshotCommand extends command<CreateServerlessCacheSnapshotCommandInput, CreateServerlessCacheSnapshotCommandOutput>(
  _ep0,
  _mw0,
