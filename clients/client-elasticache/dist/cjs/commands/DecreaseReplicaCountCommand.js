...
class DecreaseReplicaCountCommand extends smithy_client_1.Command {
    ...
    serialize(input, context) {
        return Aws_query_1.serializeAws_queryDecreaseReplicaCountCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_query_1.deserializeAws_queryDecreaseReplicaCountCommand(output, context);
    }
}
