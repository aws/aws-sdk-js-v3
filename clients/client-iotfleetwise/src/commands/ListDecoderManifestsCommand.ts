...
> {
  ...
  ): Handler<ListDecoderManifestsCommandInput, ListDecoderManifestsCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, ListDecoderManifestsCommand.getEndpointParameterInstructions())
    );
