...
import type { UpdateVehicleRequest, UpdateVehicleResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateVehicleCommand extends command<UpdateVehicleCommandInput, UpdateVehicleCommandOutput>(
  _ep0,
  _mw0,
  "UpdateVehicle",
  UpdateVehicle$
