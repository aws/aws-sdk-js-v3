...
import type { CreateDecoderManifestRequest, CreateDecoderManifestResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateDecoderManifestCommand extends command<CreateDecoderManifestCommandInput, CreateDecoderManifestCommandOutput>(
  _ep0,
  _mw0,
