...
import type { GetFleetRequest, GetFleetResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetFleetCommand extends command<GetFleetCommandInput, GetFleetCommandOutput>(
  _ep0,
  _mw0,
  "GetFleet",
  GetFleet$
