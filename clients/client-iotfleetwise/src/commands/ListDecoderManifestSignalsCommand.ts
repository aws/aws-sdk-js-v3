...
import type { ListDecoderManifestSignalsRequest, ListDecoderManifestSignalsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListDecoderManifestSignalsCommand extends command<ListDecoderManifestSignalsCommandInput, ListDecoderManifestSignalsCommandOutput>(
  _ep0,
  _mw0,
