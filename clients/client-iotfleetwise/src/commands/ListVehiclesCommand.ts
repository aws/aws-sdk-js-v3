...
import type { ListVehiclesRequest, ListVehiclesResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListVehiclesCommand extends command<ListVehiclesCommandInput, ListVehiclesCommandOutput>(
  _ep0,
  _mw0,
  "ListVehicles",
  ListVehicles$
