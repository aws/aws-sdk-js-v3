...
import type { DeleteVehicleRequest, DeleteVehicleResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteVehicleCommand extends command<DeleteVehicleCommandInput, DeleteVehicleCommandOutput>(
  _ep0,
  _mw0,
  "DeleteVehicle",
  DeleteVehicle$
