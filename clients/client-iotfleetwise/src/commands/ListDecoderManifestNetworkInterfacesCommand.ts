 ...
 * @public
 */
export class ListDecoderManifestNetworkInterfacesCommand extends command<ListDecoderManifestNetworkInterfacesCommandInput, ListDecoderManifestNetworkInterfacesCommandOutput>(
  _ep0,
  _mw0,
