...
import type { GetVehicleRequest, GetVehicleResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetVehicleCommand extends command<GetVehicleCommandInput, GetVehicleCommandOutput>(
  _ep0,
  _mw0,
  "GetVehicle",
  GetVehicle$
