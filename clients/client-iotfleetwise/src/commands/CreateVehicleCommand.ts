...
import type { CreateVehicleRequest, CreateVehicleResponse } from "../models/models_0";
 ...
 * @public
 */
export class CreateVehicleCommand extends command<CreateVehicleCommandInput, CreateVehicleCommandOutput>(
  _ep0,
  _mw0,
  "CreateVehicle",
  CreateVehicle$
