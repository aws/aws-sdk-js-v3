...
import {
  ...
  defaultGeoRoutesHttpAuthSchemeParametersProvider,
...
import type { CalculateRoutesCommandInput, CalculateRoutesCommandOutput } from "./commands/CalculateRoutesCommand";
import type {
  OptimizeWaypointsCommandInput,
  OptimizeWaypointsCommandOutput,
} from "./commands/OptimizeWaypointsCommand";
import type { SnapToRoadsCommandInput, SnapToRoadsCommandOutput } from "./commands/SnapToRoadsCommand";
import {
 ...
 * @public
 */
export type GeoRoutesClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<GeoRoutesClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultGeoRoutesHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: GeoRoutesClientResolvedConfig) =>
