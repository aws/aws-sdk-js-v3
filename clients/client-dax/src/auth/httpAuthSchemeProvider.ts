...
import { type DAXClientResolvedConfig, DAXClientConfig } from "../DAXClient";
 ...
 * @internal
 */
export const defaultDAXHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: DAXHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultDAXHttpAuthSchemeProvider: DAXHttpAuthSchemeProvider = (authParameters) => {
