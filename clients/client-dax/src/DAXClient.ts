...
import {
  ...
  defaultDAXHttpAuthSchemeParametersProvider,
...
import type { RebootNodeCommandInput, RebootNodeCommandOutput } from "./commands/RebootNodeCommand";
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<DAXClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultDAXHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: DAXClientResolvedConfig) =>
