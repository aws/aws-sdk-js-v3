...
export type RebootNodeCommandOutput = RebootNodeResponse;

export class RebootNodeCommand extends $Command<RebootNodeCommandInput, RebootNodeCommandOutput, DAXClientResolvedConfig> {
