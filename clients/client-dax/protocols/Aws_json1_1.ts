  ...
  return {
    ...
    SubnetGroup:
      output.SubnetGroup !== undefined && output.SubnetGroup !== null
        ...
        : undefined,
    TotalNodes:
      output.TotalNodes !== undefined && output.TotalNodes !== null ? output.TotalNodes : undefined
  } as any;
};
...
const deserializeAws_json1_1Event = (output: any, context: __SerdeContext): Event => {
  return {
    ...
    Message: output.Message !== undefined && output.Message !== null ? output.Message : undefined,
    SourceName:
      output.SourceName !== undefined && output.SourceName !== null ? output.SourceName : undefined,
    SourceType:
...
const deserializeAws_json1_1Node = (output: any, context: __SerdeContext): Node => {
  return {
    ...
    NodeStatus:
      output.NodeStatus !== undefined && output.NodeStatus !== null ? output.NodeStatus : undefined,
    ParameterGroupStatus:
