...
import {
  defaultLookoutMetricsHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type LookoutMetricsClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type LookoutMetricsClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<LookoutMetricsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultLookoutMetricsHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: LookoutMetricsClientResolvedConfig) =>
