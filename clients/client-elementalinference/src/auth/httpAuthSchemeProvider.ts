...
import {
  type ElementalInferenceClientResolvedConfig,
 ...
 * @internal
 */
export const defaultElementalInferenceHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ElementalInferenceHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<ElementalInferenceClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultElementalInferenceHttpAuthSchemeProvider: ElementalInferenceHttpAuthSchemeProvider = (authParameters) => {
