...
import {
  ...
  defaultElementalInferenceHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type ElementalInferenceClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type ElementalInferenceClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<ElementalInferenceClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: ElementalInferenceClientResolvedConfig) =>
