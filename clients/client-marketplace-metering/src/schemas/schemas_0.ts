...
var UsageAllocations: StaticListSchema = [1, n0, _UA,
  0, () => UsageAllocation$
];
var UsageRecordList: StaticListSchema = [1, n0, _URL,
  0, () => UsageRecord$
];
var UsageRecordResultList: StaticListSchema = [1, n0, _URRL,
  0, () => UsageRecordResult$
];
export var BatchMeterUsage$: StaticOperationSchema = [9, n0, _BMU,
  0, () => BatchMeterUsageRequest$, () => BatchMeterUsageResult$
];
export var MeterUsage$: StaticOperationSchema = [9, n0, _MU,
  0, () => MeterUsageRequest$, () => MeterUsageResult$
];
export var RegisterUsage$: StaticOperationSchema = [9, n0, _RU,
  0, () => RegisterUsageRequest$, () => RegisterUsageResult$
];
export var ResolveCustomer$: StaticOperationSchema = [9, n0, _RC,
