...
export var CustomerNotEntitledException$: StaticErrorSchema = [-3, n0, _CNEE, { [_e]: _c }, [_m], [0]];
TypeRegistry.for(n0).registerError(CustomerNotEntitledException$, CustomerNotEntitledException);
export var DisabledApiException$: StaticErrorSchema = [-3, n0, _DAE, { [_e]: _c }, [_m], [0]];
TypeRegistry.for(n0).registerError(DisabledApiException$, DisabledApiException);
export var DuplicateRequestException$: StaticErrorSchema = [-3, n0, _DRE, { [_e]: _c }, [_m], [0]];
TypeRegistry.for(n0).registerError(DuplicateRequestException$, DuplicateRequestException);
export var ExpiredTokenException$: StaticErrorSchema = [-3, n0, _ETE, { [_e]: _c }, [_m], [0]];
TypeRegistry.for(n0).registerError(ExpiredTokenException$, ExpiredTokenException);
export var IdempotencyConflictException$: StaticErrorSchema = [-3, n0, _ICE, { [_e]: _c, [_hE]: 409 }, [_m], [0]];
...
export var InvalidCustomerIdentifierException$: StaticErrorSchema = [-3, n0, _ICIE, { [_e]: _c }, [_m], [0]];
TypeRegistry.for(n0).registerError(InvalidCustomerIdentifierException$, InvalidCustomerIdentifierException);
export var InvalidEndpointRegionException$: StaticErrorSchema = [-3, n0, _IERE, { [_e]: _c }, [_m], [0]];
TypeRegistry.for(n0).registerError(InvalidEndpointRegionException$, InvalidEndpointRegionException);
export var InvalidProductCodeException$: StaticErrorSchema = [-3, n0, _IPCE, { [_e]: _c }, [_m], [0]];
TypeRegistry.for(n0).registerError(InvalidProductCodeException$, InvalidProductCodeException);
export var InvalidPublicKeyVersionException$: StaticErrorSchema = [-3, n0, _IPKVE, { [_e]: _c }, [_m], [0]];
TypeRegistry.for(n0).registerError(InvalidPublicKeyVersionException$, InvalidPublicKeyVersionException);
export var InvalidRegionException$: StaticErrorSchema = [-3, n0, _IRE, { [_e]: _c }, [_m], [0]];
...
export var InvalidTokenException$: StaticErrorSchema = [-3, n0, _ITEn, { [_e]: _c }, [_m], [0]];
TypeRegistry.for(n0).registerError(InvalidTokenException$, InvalidTokenException);
export var InvalidUsageAllocationsException$: StaticErrorSchema = [-3, n0, _IUAE, { [_e]: _c }, [_m], [0]];
TypeRegistry.for(n0).registerError(InvalidUsageAllocationsException$, InvalidUsageAllocationsException);
export var InvalidUsageDimensionException$: StaticErrorSchema = [-3, n0, _IUDE, { [_e]: _c }, [_m], [0]];
...
export var PlatformNotSupportedException$: StaticErrorSchema = [-3, n0, _PNSE, { [_e]: _c }, [_m], [0]];
...
export var TimestampOutOfBoundsException$: StaticErrorSchema = [-3, n0, _TOOBE, { [_e]: _c }, [_m], [0]];
...
var UsageAllocations: StaticListSchema = [1, n0, _UA, 0, () => UsageAllocation$];
var UsageRecordList: StaticListSchema = [1, n0, _URL, 0, () => UsageRecord$];
var UsageRecordResultList: StaticListSchema = [1, n0, _URRL, 0, () => UsageRecordResult$];
