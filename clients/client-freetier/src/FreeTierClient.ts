...
import {
  ...
  defaultFreeTierHttpAuthSchemeParametersProvider,
...
import type { GetFreeTierUsageCommandInput, GetFreeTierUsageCommandOutput } from "./commands/GetFreeTierUsageCommand";
import type {
 ...
 * @public
 */
export type FreeTierClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type FreeTierClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<FreeTierClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultFreeTierHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: FreeTierClientResolvedConfig) =>
