...
import {
  type ResourceGroupsTaggingAPIClientResolvedConfig,
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ResourceGroupsTaggingAPIHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultResourceGroupsTaggingAPIHttpAuthSchemeProvider: ResourceGroupsTaggingAPIHttpAuthSchemeProvider = (authParameters) => {
