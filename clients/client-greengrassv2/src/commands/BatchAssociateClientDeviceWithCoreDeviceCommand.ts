 ...
 * @public
 */
export class BatchAssociateClientDeviceWithCoreDeviceCommand extends command<BatchAssociateClientDeviceWithCoreDeviceCommandInput, BatchAssociateClientDeviceWithCoreDeviceCommandOutput>(
  _ep0,
  _mw0,
