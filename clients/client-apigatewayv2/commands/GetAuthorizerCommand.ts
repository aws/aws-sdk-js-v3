...
import { GetAuthorizerRequest, GetAuthorizerResponse } from "../models/index";
import {
  deserializeAws_restJson1_1GetAuthorizerCommand,
  serializeAws_restJson1_1GetAuthorizerCommand
...
export type GetAuthorizerCommandOutput = GetAuthorizerResponse &
  __MetadataBearer;
