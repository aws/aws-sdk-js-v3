...
import {
  deserializeAws_restJson1_1DeleteRouteResponseCommand,
  serializeAws_restJson1_1DeleteRouteResponseCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteRouteResponseCommand(input, context);
  }
