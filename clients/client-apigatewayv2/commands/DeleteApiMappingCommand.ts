...
import {
  deserializeAws_restJson1_1DeleteApiMappingCommand,
  serializeAws_restJson1_1DeleteApiMappingCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteApiMappingCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DeleteApiMappingCommand(output, context);
  }
