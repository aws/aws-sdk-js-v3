...
import { CreateIntegrationRequest, CreateIntegrationResult } from "../models/index";
import {
  deserializeAws_restJson1_1CreateIntegrationCommand,
  serializeAws_restJson1_1CreateIntegrationCommand
...
> {
  ...
  private serialize(input: CreateIntegrationCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restJson1_1CreateIntegrationCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<CreateIntegrationCommandOutput> {
    return deserializeAws_restJson1_1CreateIntegrationCommand(output, context);
  }
