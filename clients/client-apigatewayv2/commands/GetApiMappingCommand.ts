...
import {
  deserializeAws_restJson1_1GetApiMappingCommand,
  serializeAws_restJson1_1GetApiMappingCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetApiMappingCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetApiMappingCommand(output, context);
  }
