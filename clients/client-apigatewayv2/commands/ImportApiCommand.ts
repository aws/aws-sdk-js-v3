...
import { ImportApiRequest, ImportApiResponse } from "../models/index";
import {
  deserializeAws_restJson1_1ImportApiCommand,
  serializeAws_restJson1_1ImportApiCommand
...
export type ImportApiCommandOutput = ImportApiResponse;
