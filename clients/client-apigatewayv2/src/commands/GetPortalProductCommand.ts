...
import type { GetPortalProductRequest, GetPortalProductResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetPortalProductCommand extends command<GetPortalProductCommandInput, GetPortalProductCommandOutput>(
  _ep0,
  _mw0,
  "GetPortalProduct",
  GetPortalProduct$
