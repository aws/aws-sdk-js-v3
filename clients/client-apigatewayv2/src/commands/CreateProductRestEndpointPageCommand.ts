 ...
 * @public
 */
export class CreateProductRestEndpointPageCommand extends command<CreateProductRestEndpointPageCommandInput, CreateProductRestEndpointPageCommandOutput>(
  _ep0,
  _mw0,
