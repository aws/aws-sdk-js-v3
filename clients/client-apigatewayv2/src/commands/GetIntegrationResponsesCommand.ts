...
import type { GetIntegrationResponsesRequest, GetIntegrationResponsesResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetIntegrationResponsesCommand extends command<GetIntegrationResponsesCommandInput, GetIntegrationResponsesCommandOutput>(
  _ep0,
  _mw0,
