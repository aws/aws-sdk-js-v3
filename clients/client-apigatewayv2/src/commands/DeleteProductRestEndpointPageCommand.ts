 ...
 * @public
 */
export class DeleteProductRestEndpointPageCommand extends command<DeleteProductRestEndpointPageCommandInput, DeleteProductRestEndpointPageCommandOutput>(
  _ep0,
  _mw0,
