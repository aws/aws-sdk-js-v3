 ...
 * @public
 */
export class DeletePortalProductSharingPolicyCommand extends command<DeletePortalProductSharingPolicyCommandInput, DeletePortalProductSharingPolicyCommandOutput>(
  _ep0,
  _mw0,
