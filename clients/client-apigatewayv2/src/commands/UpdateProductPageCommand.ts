...
import type { UpdateProductPageRequest, UpdateProductPageResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateProductPageCommand extends command<UpdateProductPageCommandInput, UpdateProductPageCommandOutput>(
  _ep0,
  _mw0,
  "UpdateProductPage",
  UpdateProductPage$
