 ...
 * @public
 */
export class PutPortalProductSharingPolicyCommand extends command<PutPortalProductSharingPolicyCommandInput, PutPortalProductSharingPolicyCommandOutput>(
  _ep0,
  _mw0,
