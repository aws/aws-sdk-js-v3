...
import { type MWAAServerlessClientResolvedConfig, MWAAServerlessClientConfig } from "../MWAAServerlessClient";
 ...
 * @internal
 */
export const defaultMWAAServerlessHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: MWAAServerlessHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<MWAAServerlessClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultMWAAServerlessHttpAuthSchemeProvider: MWAAServerlessHttpAuthSchemeProvider = (authParameters) => {
