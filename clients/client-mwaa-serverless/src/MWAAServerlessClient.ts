...
import {
  ...
  defaultMWAAServerlessHttpAuthSchemeParametersProvider,
...
import type { GetTaskInstanceCommandInput, GetTaskInstanceCommandOutput } from "./commands/GetTaskInstanceCommand";
 ...
 * @public
 */
export type MWAAServerlessClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
 ...
 * @public
 */
export class MWAAServerlessClient extends __Client<
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<MWAAServerlessClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: MWAAServerlessClientResolvedConfig) =>
