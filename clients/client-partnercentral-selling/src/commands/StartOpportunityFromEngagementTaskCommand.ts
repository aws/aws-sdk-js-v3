 ...
 * @public
 */
export class StartOpportunityFromEngagementTaskCommand extends command<StartOpportunityFromEngagementTaskCommandInput, StartOpportunityFromEngagementTaskCommandOutput>(
  _ep0,
  _mw0,
