 ...
 * @public
 */
export class StartEngagementByAcceptingInvitationTaskCommand extends command<StartEngagementByAcceptingInvitationTaskCommandInput, StartEngagementByAcceptingInvitationTaskCommandOutput>(
  _ep0,
  _mw0,
