 ...
 * @public
 */
export class ListProspectingFromEngagementTasksCommand extends command<ListProspectingFromEngagementTasksCommandInput, ListProspectingFromEngagementTasksCommandOutput>(
  _ep0,
  _mw0,
