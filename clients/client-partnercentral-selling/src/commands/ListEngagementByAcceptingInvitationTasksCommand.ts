 ...
 * @public
 */
export class ListEngagementByAcceptingInvitationTasksCommand extends command<ListEngagementByAcceptingInvitationTasksCommandInput, ListEngagementByAcceptingInvitationTasksCommandOutput>(
  _ep0,
  _mw0,
