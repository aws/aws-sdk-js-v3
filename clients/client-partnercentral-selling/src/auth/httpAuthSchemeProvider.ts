...
function createAwsAuthSigv4HttpAuthOption(authParameters: PartnerCentralSellingHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultPartnerCentralSellingHttpAuthSchemeProvider: PartnerCentralSellingHttpAuthSchemeProvider = (authParameters) => {
