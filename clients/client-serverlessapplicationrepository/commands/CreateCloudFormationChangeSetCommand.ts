...
export class CreateCloudFormationChangeSetCommand extends $Command<CreateCloudFormationChangeSetCommandInput, CreateCloudFormationChangeSetCommandOutput, ServerlessApplicationRepositoryClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1CreateCloudFormationChangeSetCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1CreateCloudFormationChangeSetCommand(output, context);
  }
