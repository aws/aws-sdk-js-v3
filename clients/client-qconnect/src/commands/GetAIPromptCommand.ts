...
import type { GetAIPromptRequest, GetAIPromptResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetAIPromptCommand extends command<GetAIPromptCommandInput, GetAIPromptCommandOutput>(
  _ep0,
  _mw0,
  "GetAIPrompt",
  GetAIPrompt$
