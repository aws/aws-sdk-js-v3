...
import type { ListAIPromptsRequest, ListAIPromptsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListAIPromptsCommand extends command<ListAIPromptsCommandInput, ListAIPromptsCommandOutput>(
  _ep0,
  _mw0,
  "ListAIPrompts",
  ListAIPrompts$
