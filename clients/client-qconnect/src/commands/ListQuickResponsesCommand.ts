...
import type { ListQuickResponsesRequest, ListQuickResponsesResponse } from "../models/models_1";
 ...
 * @public
 */
export class ListQuickResponsesCommand extends command<ListQuickResponsesCommandInput, ListQuickResponsesCommandOutput>(
  _ep0,
  _mw0,
  "ListQuickResponses",
  ListQuickResponses$
