...
import type { GetAIAgentRequest, GetAIAgentResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetAIAgentCommand extends command<GetAIAgentCommandInput, GetAIAgentCommandOutput>(
  _ep0,
  _mw0,
  "GetAIAgent",
  GetAIAgent$
