...
import type { ListAIGuardrailsRequest, ListAIGuardrailsResponse } from "../models/models_0";
 ...
 * @public
 */
export class ListAIGuardrailsCommand extends command<ListAIGuardrailsCommandInput, ListAIGuardrailsCommandOutput>(
  _ep0,
  _mw0,
  "ListAIGuardrails",
  ListAIGuardrails$
