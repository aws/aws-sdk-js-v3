...
import type { DeleteAIPromptVersionRequest, DeleteAIPromptVersionResponse } from "../models/models_0";
 ...
 * @public
 */
export class DeleteAIPromptVersionCommand extends command<DeleteAIPromptVersionCommandInput, DeleteAIPromptVersionCommandOutput>(
  _ep0,
  _mw0,
