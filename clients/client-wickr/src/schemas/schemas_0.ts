...
export var CallingSettings$: StaticStructureSchema = [3, n0, _CS,
  0,
  [_cSC, _cVC, _fTC],
  [2, 2, 2]
];
...
export var PasswordRequirements$: StaticStructureSchema = [3, n0, _PR,
  0,
  [_l, _mL, _nu, _sy, _up],
  [1, 1, 1, 1, 1]
];
...
var BatchDeviceErrorResponseItems: StaticListSchema = [1, n0, _BDERIa,
  0, () => BatchDeviceErrorResponseItem$
];
var BatchDeviceSuccessResponseItems: StaticListSchema = [1, n0, _BDSRIa,
  0, () => BatchDeviceSuccessResponseItem$
];
var BatchUnameErrorResponseItems: StaticListSchema = [1, n0, _BUERIat,
  0, () => BatchUnameErrorResponseItem$
];
var BatchUnameSuccessResponseItems: StaticListSchema = [1, n0, _BUSRIat,
  0, () => BatchUnameSuccessResponseItem$
];
var BatchUserErrorResponseItems: StaticListSchema = [1, n0, _BUERIatc,
  0, () => BatchUserErrorResponseItem$
];
var BatchUserSuccessResponseItems: StaticListSchema = [1, n0, _BUSRIatc,
  0, () => BatchUserSuccessResponseItem$
];
var BlockedGuestUserList: StaticListSchema = [1, n0, _BGUL,
  0, () => BlockedGuestUser$
];
var Bots: StaticListSchema = [1, n0, _Bo,
  0, () => Bot$
];
var Devices: StaticListSchema = [1, n0, _D,
  0, () => BasicDeviceObject$
];
var ErrorDetailList: StaticListSchema = [1, n0, _EDL,
  0, () => ErrorDetail$
];
var GuestUserHistoryCountList: StaticListSchema = [1, n0, _GUHCL,
  0, () => GuestUserHistoryCount$
];
var GuestUserList: StaticListSchema = [1, n0, _GUL,
  0, () => GuestUser$
];
...
var PermittedWickrEnterpriseNetworksList: StaticListSchema = [1, n0, _PWENL,
  0, () => PermittedWickrEnterpriseNetwork$
];
var SecurityGroupIdList = 64 | 0;
var SecurityGroupList: StaticListSchema = [1, n0, _SGL,
  0, () => SecurityGroup$
];
var SecurityGroupStringList = 64 | 0;
var SettingsList: StaticListSchema = [1, n0, _SL,
  0, () => Setting$
];
var StringList = 64 | 0;
var Unames = 64 | 0;
var UserIds = 64 | 0;
var Users: StaticListSchema = [1, n0, _Us,
  0, [() => User$,
    0]
];
var WickrAwsNetworksList: StaticListSchema = [1, n0, _WANL,
  0, () => WickrAwsNetworks$
];
export var BatchCreateUser$: StaticOperationSchema = [9, n0, _BCU,
  { [_ht]: ["POST", "/networks/{networkId}/users", 200] }, () => BatchCreateUserRequest$, () => BatchCreateUserResponse$
];
export var BatchDeleteUser$: StaticOperationSchema = [9, n0, _BDU,
  { [_ht]: ["POST", "/networks/{networkId}/users/batch-delete", 200] }, () => BatchDeleteUserRequest$, () => BatchDeleteUserResponse$
];
export var BatchLookupUserUname$: StaticOperationSchema = [9, n0, _BLUU,
  { [_ht]: ["POST", "/networks/{networkId}/users/uname-lookup", 200] }, () => BatchLookupUserUnameRequest$, () => BatchLookupUserUnameResponse$
];
export var BatchReinviteUser$: StaticOperationSchema = [9, n0, _BRU,
  { [_ht]: ["PATCH", "/networks/{networkId}/users/re-invite", 200] }, () => BatchReinviteUserRequest$, () => BatchReinviteUserResponse$
];
export var BatchResetDevicesForUser$: StaticOperationSchema = [9, n0, _BRDFU,
  { [_ht]: ["PATCH", "/networks/{networkId}/users/{userId}/devices", 200] }, () => BatchResetDevicesForUserRequest$, () => BatchResetDevicesForUserResponse$
];
export var BatchToggleUserSuspendStatus$: StaticOperationSchema = [9, n0, _BTUSS,
...
export var CreateBot$: StaticOperationSchema = [9, n0, _CB,
  { [_ht]: ["POST", "/networks/{networkId}/bots", 200] }, () => CreateBotRequest$, () => CreateBotResponse$
];
export var CreateDataRetentionBot$: StaticOperationSchema = [9, n0, _CDRB,
  { [_ht]: ["POST", "/networks/{networkId}/data-retention-bots", 200] }, () => CreateDataRetentionBotRequest$, () => CreateDataRetentionBotResponse$
];
export var CreateDataRetentionBotChallenge$: StaticOperationSchema = [9, n0, _CDRBC,
...
export var DeleteDataRetentionBot$: StaticOperationSchema = [9, n0, _DDRB,
...
export var GetBotsCount$: StaticOperationSchema = [9, n0, _GBC,
  { [_ht]: ["GET", "/networks/{networkId}/bots/count", 200] }, () => GetBotsCountRequest$, () => GetBotsCountResponse$
];
export var GetDataRetentionBot$: StaticOperationSchema = [9, n0, _GDRB,
  { [_ht]: ["GET", "/networks/{networkId}/data-retention-bots", 200] }, () => GetDataRetentionBotRequest$, () => GetDataRetentionBotResponse$
];
export var GetGuestUserHistoryCount$: StaticOperationSchema = [9, n0, _GGUHC,
...
export var GetUser$: StaticOperationSchema = [9, n0, _GUe,
  { [_ht]: ["GET", "/networks/{networkId}/users/{userId}", 200] }, () => GetUserRequest$, () => GetUserResponse$
];
export var GetUsersCount$: StaticOperationSchema = [9, n0, _GUC,
  { [_ht]: ["GET", "/networks/{networkId}/users/count", 200] }, () => GetUsersCountRequest$, () => GetUsersCountResponse$
];
export var ListBlockedGuestUsers$: StaticOperationSchema = [9, n0, _LBGU,
...
export var ListDevicesForUser$: StaticOperationSchema = [9, n0, _LDFU,
  { [_ht]: ["GET", "/networks/{networkId}/users/{userId}/devices", 200] }, () => ListDevicesForUserRequest$, () => ListDevicesForUserResponse$
];
export var ListGuestUsers$: StaticOperationSchema = [9, n0, _LGU,
...
export var ListSecurityGroups$: StaticOperationSchema = [9, n0, _LSG,
  { [_ht]: ["GET", "/networks/{networkId}/security-groups", 200] }, () => ListSecurityGroupsRequest$, () => ListSecurityGroupsResponse$
];
export var ListSecurityGroupUsers$: StaticOperationSchema = [9, n0, _LSGU,
...
export var RegisterOidcConfig$: StaticOperationSchema = [9, n0, _ROC,
...
export var UpdateGuestUser$: StaticOperationSchema = [9, n0, _UGU,
...
export var UpdateSecurityGroup$: StaticOperationSchema = [9, n0, _USG,
