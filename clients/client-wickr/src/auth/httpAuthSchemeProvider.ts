...
import { type WickrClientResolvedConfig, WickrClientConfig } from "../WickrClient";
 ...
 * @internal
 */
export const defaultWickrHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: WickrHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<WickrClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultWickrHttpAuthSchemeProvider: WickrHttpAuthSchemeProvider = (authParameters) => {
