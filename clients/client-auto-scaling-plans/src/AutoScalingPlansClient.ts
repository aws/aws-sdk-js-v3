...
import {
  ...
  defaultAutoScalingPlansHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type AutoScalingPlansClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type AutoScalingPlansClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<AutoScalingPlansClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: AutoScalingPlansClientResolvedConfig) =>
