...
export type UpdateScalingPlanCommandOutput = UpdateScalingPlanResponse;

export class UpdateScalingPlanCommand extends $Command<UpdateScalingPlanCommandInput, UpdateScalingPlanCommandOutput, AutoScalingPlansClientResolvedConfig> {
