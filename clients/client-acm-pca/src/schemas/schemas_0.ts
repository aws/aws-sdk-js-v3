...
export var CreatePermissionRequest: StaticStructureSchema = [3, n0, _CPR, 0, [_CAA, _Pr, _SAo, _Ac], [0, 0, 0, 64 | 0]];
...
export var GetCertificateAuthorityCertificateResponse: StaticStructureSchema = [3, n0, _GCACRe, 0, [_Ce, _CCe], [0, 0]];
...
export var CustomExtensionList: StaticListSchema = [1, n0, _CEL, 0, () => CustomExtension];
export var ExtendedKeyUsageList: StaticListSchema = [1, n0, _EKUL, 0, () => ExtendedKeyUsage];
export var GeneralNameList: StaticListSchema = [1, n0, _GNL, 0, () => GeneralName];
export var PermissionList: StaticListSchema = [1, n0, _PL, 0, () => Permission];
export var PolicyQualifierInfoList: StaticListSchema = [1, n0, _PQIL, 0, () => PolicyQualifierInfo];
