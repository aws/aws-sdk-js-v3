...
const AWS_TEMPLATE = "acm-pca.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "acm-pca.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "acm-pca.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "acm-pca.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "acm-pca.{region}.amazonaws.com";
