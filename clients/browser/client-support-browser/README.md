...
```javascript
//TypeScript
import { SupportClient } from "@aws-sdk/client-support-browser/SupportClient";
import { AddAttachmentsToSetCommand } from "@aws-sdk/client-support-browser/commands/AddAttachmentsToSetCommand";
```
