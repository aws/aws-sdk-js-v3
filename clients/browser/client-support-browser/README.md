# @aws-sdk/client-support-browser

[![NPM version](https://img.shields.io/npm/v/@aws-sdk/client-support-browser/preview.svg)](https://www.npmjs.com/package/@aws-sdk/client-support-browser)
[![NPM downloads](https://img.shields.io/npm/dm/@aws-sdk/client-support-browser.svg)](https://www.npmjs.com/package/@aws-sdk/client-support-browser)
...
```
npm install @aws-sdk/client-support-browser
```
...
const {
  SupportClient
} = require("@aws-sdk/client-support-browser/SupportClient");
const {
  AddAttachmentsToSetCommand
} = require("@aws-sdk/client-support-browser/commands/AddAttachmentsToSetCommand");
```

```javascript
//typescript
const { SupportClient } = import '@aws-sdk/client-support-browser/SupportClient';
const { AddAttachmentsToSetCommand } = import '@aws-sdk/client-support-browser/commands/AddAttachmentsToSetCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-support-browser/Support";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-support-browser' package is updated. To contribute to SDK you can checkout our [code generator package][].
