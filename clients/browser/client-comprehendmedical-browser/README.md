# @aws-sdk/client-comprehendmedical-browser
...
```javascript
//typescript
const { ComprehendMedicalClient } = import '@aws-sdk/client-comprehendmedical-browser/ComprehendMedicalClient';
const { DetectEntitiesCommand } = import '@aws-sdk/client-comprehendmedical-browser/commands/DetectEntitiesCommand';
```
