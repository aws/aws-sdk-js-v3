...
import {
  ComprehendMedicalConfiguration,
  ComprehendMedicalResolvedConfiguration,
  configurationProperties
} from "./ComprehendMedicalConfiguration";
...
export class ComprehendMedicalClient
  ...
  readonly config: ComprehendMedicalResolvedConfiguration;
  ...
  constructor(configuration: ComprehendMedicalConfiguration) {
