...
import {
  PinpointEmailConfiguration,
  PinpointEmailResolvedConfiguration,
  configurationProperties
} from "./PinpointEmailConfiguration";
...
export class PinpointEmailClient
  ...
  readonly config: PinpointEmailResolvedConfiguration;
  ...
  constructor(configuration: PinpointEmailConfiguration) {
