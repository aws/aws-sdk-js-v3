...
export interface PinpointEmailConfiguration {
  /**
...
export interface PinpointEmailResolvableConfiguration
  extends PinpointEmailConfiguration {
  /**
...
export interface PinpointEmailResolvedConfiguration
  extends PinpointEmailConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  PinpointEmailResolvableConfiguration,
