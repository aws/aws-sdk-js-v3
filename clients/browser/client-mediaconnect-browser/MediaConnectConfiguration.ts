...
export interface MediaConnectConfiguration {
  /**
...
export interface MediaConnectResolvableConfiguration
  extends MediaConnectConfiguration {
  /**
...
export interface MediaConnectResolvedConfiguration
  extends MediaConnectConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  MediaConnectResolvableConfiguration,
