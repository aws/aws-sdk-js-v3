# @aws-sdk/client-codepipeline-browser

[![NPM version](https://img.shields.io/npm/v/@aws-sdk/client-codepipeline-browser/preview.svg)](https://www.npmjs.com/package/@aws-sdk/client-codepipeline-browser)
[![NPM downloads](https://img.shields.io/npm/dm/@aws-sdk/client-codepipeline-browser.svg)](https://www.npmjs.com/package/@aws-sdk/client-codepipeline-browser)
...
```
npm install @aws-sdk/client-codepipeline-browser
```
...
const {
  CodePipelineClient
} = require("@aws-sdk/client-codepipeline-browser/CodePipelineClient");
const {
  AcknowledgeJobCommand
} = require("@aws-sdk/client-codepipeline-browser/commands/AcknowledgeJobCommand");
```

```javascript
//typescript
const { CodePipelineClient } = import '@aws-sdk/client-codepipeline-browser/CodePipelineClient';
const { AcknowledgeJobCommand } = import '@aws-sdk/client-codepipeline-browser/commands/AcknowledgeJobCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-codepipeline-browser/CodePipeline";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-codepipeline-browser' package is updated. To contribute to SDK you can checkout our [code generator package][].
