...
export interface CodePipelineConfiguration {
  /**
...
export interface CodePipelineResolvableConfiguration
  extends CodePipelineConfiguration {
  /**
...
export interface CodePipelineResolvedConfiguration
  extends CodePipelineConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CodePipelineResolvableConfiguration,
