...
export interface ElasticBeanstalkConfiguration {
  /**
...
export interface ElasticBeanstalkResolvableConfiguration
  extends ElasticBeanstalkConfiguration {
  /**
...
export interface ElasticBeanstalkResolvedConfiguration
  extends ElasticBeanstalkConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ElasticBeanstalkResolvableConfiguration,
