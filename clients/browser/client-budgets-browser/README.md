# @aws-sdk/client-budgets-browser
...
const {
  BudgetsClient,
  CreateBudgetCommand
} = require("@aws-sdk/client-budgets-browser");
```
...
import {
  BudgetsClient,
  CreateBudgetCommand
} from "@aws-sdk/client-budgets-browser";
```
...
```javascript
import * as AWS from "@aws-sdk/client-budgets-browser";
