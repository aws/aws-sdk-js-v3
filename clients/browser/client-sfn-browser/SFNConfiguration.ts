...
export interface SFNConfiguration {
  /**
...
export interface SFNResolvableConfiguration extends SFNConfiguration {
  /**
...
export interface SFNResolvedConfiguration
  extends SFNConfiguration,
