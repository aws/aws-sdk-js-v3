...
export interface TransferResolvableConfiguration extends TransferConfiguration {
  /**
...
export interface TransferResolvedConfiguration
  extends TransferConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  TransferResolvableConfiguration,
