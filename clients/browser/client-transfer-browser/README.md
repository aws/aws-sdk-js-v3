...
```javascript
//typescript
const { TransferClient } = import '@aws-sdk/client-transfer-browser/TransferClient';
const { CreateServerCommand } = import '@aws-sdk/client-transfer-browser/commands/CreateServerCommand';
```
