...
```javascript
//typescript
const { DLMClient } = import '@aws-sdk/client-dlm-browser/DLMClient';
const { CreateLifecyclePolicyCommand } = import '@aws-sdk/client-dlm-browser/commands/CreateLifecyclePolicyCommand';
```
