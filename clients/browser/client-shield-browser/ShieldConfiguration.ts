...
export interface ShieldResolvableConfiguration extends ShieldConfiguration {
  /**
...
export interface ShieldResolvedConfiguration
  extends ShieldConfiguration,
