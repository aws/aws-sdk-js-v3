...
export interface DynamoDBStreamsConfiguration {
  /**
...
export interface DynamoDBStreamsResolvableConfiguration
  extends DynamoDBStreamsConfiguration {
  /**
...
export interface DynamoDBStreamsResolvedConfiguration
  extends DynamoDBStreamsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  DynamoDBStreamsResolvableConfiguration,
