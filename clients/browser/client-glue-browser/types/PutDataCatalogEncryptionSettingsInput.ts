...
/**
 * PutDataCatalogEncryptionSettingsInput shape
 */
export interface PutDataCatalogEncryptionSettingsInput {
  /**
   ...
   */
  DataCatalogEncryptionSettings: _DataCatalogEncryptionSettings;
