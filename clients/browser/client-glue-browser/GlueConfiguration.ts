...
export interface GlueResolvableConfiguration extends GlueConfiguration {
  /**
...
export interface GlueResolvedConfiguration
  extends GlueConfiguration,
