...
export interface IoTEventsConfiguration {
  /**
...
export interface IoTEventsResolvableConfiguration
  extends IoTEventsConfiguration {
  /**
...
export interface IoTEventsResolvedConfiguration
  extends IoTEventsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  IoTEventsResolvableConfiguration,
