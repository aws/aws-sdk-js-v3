# @aws-sdk/client-cloudsearch-domain-browser
...
```javascript
//typescript
const { CloudSearchDomainClient } = import '@aws-sdk/client-cloudsearch-domain-browser/CloudSearchDomainClient';
const { UploadDocumentsCommand } = import '@aws-sdk/client-cloudsearch-domain-browser/commands/UploadDocumentsCommand';
```
