...
import {
  CloudSearchDomainConfiguration,
  CloudSearchDomainResolvedConfiguration,
  configurationProperties
} from "./CloudSearchDomainConfiguration";
...
export class CloudSearchDomainClient
  ...
  readonly config: CloudSearchDomainResolvedConfiguration;
  ...
  constructor(configuration: CloudSearchDomainConfiguration) {
