...
export interface SecurityHubResolvableConfiguration
  extends SecurityHubConfiguration {
  /**
...
export interface SecurityHubResolvedConfiguration
  extends SecurityHubConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  SecurityHubResolvableConfiguration,
