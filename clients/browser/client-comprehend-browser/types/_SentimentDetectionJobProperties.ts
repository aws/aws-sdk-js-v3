 ...
 */
export interface _SentimentDetectionJobProperties {
  /**
...
export interface _UnmarshalledSentimentDetectionJobProperties
  extends _SentimentDetectionJobProperties {
  /**
   * <p>The time that the sentiment detection job was submitted for processing.</p>
   */
  SubmitTime?: Date;
