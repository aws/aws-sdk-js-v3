 ...
 */
export interface _KeyPhrasesDetectionJobProperties {
  /**
...
export interface _UnmarshalledKeyPhrasesDetectionJobProperties
  extends _KeyPhrasesDetectionJobProperties {
  /**
   * <p>The time that the key phrases detection job was submitted for processing.</p>
   */
  SubmitTime?: Date;
