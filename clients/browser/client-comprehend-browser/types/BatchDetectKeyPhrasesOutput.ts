import { _UnmarshalledBatchDetectKeyPhrasesItemResult } from "./_BatchDetectKeyPhrasesItemResult";
import { _UnmarshalledBatchItemError } from "./_BatchItemError";
import * as __aws_sdk_types from "@aws-sdk/types";

/**
 * BatchDetectKeyPhrasesOutput shape
 */
export interface BatchDetectKeyPhrasesOutput
   ...
   */
  ResultList: Array<_UnmarshalledBatchDetectKeyPhrasesItemResult>;
