...
export interface ComprehendResolvableConfiguration
  extends ComprehendConfiguration {
  /**
...
export interface ComprehendResolvedConfiguration
  extends ComprehendConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ComprehendResolvableConfiguration,
