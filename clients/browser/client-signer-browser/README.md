...
```javascript
//typescript
const { signerClient } = import '@aws-sdk/client-signer-browser/signerClient';
const { CancelSigningProfileCommand } = import '@aws-sdk/client-signer-browser/commands/CancelSigningProfileCommand';
```
