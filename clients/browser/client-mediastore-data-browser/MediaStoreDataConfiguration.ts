...
export interface MediaStoreDataConfiguration {
  /**
...
export interface MediaStoreDataResolvableConfiguration
  extends MediaStoreDataConfiguration {
  /**
...
export interface MediaStoreDataResolvedConfiguration
  extends MediaStoreDataConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  MediaStoreDataResolvableConfiguration,
