...
export interface QuickSightResolvableConfiguration
  extends QuickSightConfiguration {
  /**
...
export interface QuickSightResolvedConfiguration
  extends QuickSightConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  QuickSightResolvableConfiguration,
