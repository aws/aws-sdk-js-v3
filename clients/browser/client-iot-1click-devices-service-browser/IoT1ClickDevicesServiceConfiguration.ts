...
export interface IoT1ClickDevicesServiceConfiguration {
  /**
...
export interface IoT1ClickDevicesServiceResolvableConfiguration
  extends IoT1ClickDevicesServiceConfiguration {
  /**
...
export interface IoT1ClickDevicesServiceResolvedConfiguration
  extends IoT1ClickDevicesServiceConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  IoT1ClickDevicesServiceResolvableConfiguration,
