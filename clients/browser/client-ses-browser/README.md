...
```javascript
//typescript
const { SESClient } = import '@aws-sdk/client-ses-browser/SESClient';
const { CloneReceiptRuleSetCommand } = import '@aws-sdk/client-ses-browser/commands/CloneReceiptRuleSetCommand';
```
