...
export interface ServiceQuotasConfiguration {
  /**
...
export interface ServiceQuotasResolvableConfiguration
  extends ServiceQuotasConfiguration {
  /**
...
export interface ServiceQuotasResolvedConfiguration
  extends ServiceQuotasConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ServiceQuotasResolvableConfiguration,
