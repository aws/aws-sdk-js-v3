...
export interface CostandUsageReportServiceConfiguration {
  /**
...
export interface CostandUsageReportServiceResolvableConfiguration
  extends CostandUsageReportServiceConfiguration {
  /**
...
export interface CostandUsageReportServiceResolvedConfiguration
  extends CostandUsageReportServiceConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CostandUsageReportServiceResolvableConfiguration,
