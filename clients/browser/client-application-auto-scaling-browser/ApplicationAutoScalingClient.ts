...
import {
  ApplicationAutoScalingConfiguration,
  ApplicationAutoScalingResolvedConfiguration,
  configurationProperties
} from "./ApplicationAutoScalingConfiguration";
...
export class ApplicationAutoScalingClient
  ...
  readonly config: ApplicationAutoScalingResolvedConfiguration;
  ...
  constructor(configuration: ApplicationAutoScalingConfiguration) {
