 ...
 */
export interface _CompleteWorkflowExecutionDecisionAttributes {
  /**
...
export type _UnmarshalledCompleteWorkflowExecutionDecisionAttributes = _CompleteWorkflowExecutionDecisionAttributes;
