 ...
 */
export interface _RequestCancelExternalWorkflowExecutionDecisionAttributes {
  /**
...
export type _UnmarshalledRequestCancelExternalWorkflowExecutionDecisionAttributes = _RequestCancelExternalWorkflowExecutionDecisionAttributes;
