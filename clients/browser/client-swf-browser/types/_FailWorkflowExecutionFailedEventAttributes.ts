 ...
 */
export interface _FailWorkflowExecutionFailedEventAttributes {
  /**
...
export type _UnmarshalledFailWorkflowExecutionFailedEventAttributes = _FailWorkflowExecutionFailedEventAttributes;
