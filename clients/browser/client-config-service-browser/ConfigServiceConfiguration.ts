...
export interface ConfigServiceResolvableConfiguration
  extends ConfigServiceConfiguration {
  /**
...
export interface ConfigServiceResolvedConfiguration
  extends ConfigServiceConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ConfigServiceResolvableConfiguration,
