...
import {
  ElasticLoadBalancingv2Configuration,
  ElasticLoadBalancingv2ResolvedConfiguration,
  configurationProperties
} from "./ElasticLoadBalancingv2Configuration";
...
export class ElasticLoadBalancingv2Client
  ...
  readonly config: ElasticLoadBalancingv2ResolvedConfiguration;
  ...
  constructor(configuration: ElasticLoadBalancingv2Configuration) {
