...
export interface ElasticLoadBalancingv2Configuration {
  /**
...
export interface ElasticLoadBalancingv2ResolvableConfiguration
  extends ElasticLoadBalancingv2Configuration {
  /**
...
export interface ElasticLoadBalancingv2ResolvedConfiguration
  extends ElasticLoadBalancingv2Configuration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ElasticLoadBalancingv2ResolvableConfiguration,
...
> = {
  ...
  signingName: {
    defaultValue: "elasticloadbalancing"
  },
  signer: {
    defaultProvider: (configuration: {
      credentials: __aws_sdk_types.Provider<__aws_sdk_types.Credentials>;
