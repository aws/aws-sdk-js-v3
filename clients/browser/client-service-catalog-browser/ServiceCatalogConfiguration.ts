...
export interface ServiceCatalogConfiguration {
  /**
...
export interface ServiceCatalogResolvableConfiguration
  extends ServiceCatalogConfiguration {
  /**
...
export interface ServiceCatalogResolvedConfiguration
  extends ServiceCatalogConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ServiceCatalogResolvableConfiguration,
