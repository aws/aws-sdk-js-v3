...
```javascript
//typescript
const { MacieClient } = import '@aws-sdk/client-macie-browser/MacieClient';
const { AssociateMemberAccountCommand } = import '@aws-sdk/client-macie-browser/commands/AssociateMemberAccountCommand';
```
