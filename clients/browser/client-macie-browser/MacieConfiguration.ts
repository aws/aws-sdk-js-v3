...
export interface MacieConfiguration {
  /**
...
export interface MacieResolvableConfiguration extends MacieConfiguration {
  /**
...
export interface MacieResolvedConfiguration
  extends MacieConfiguration,
