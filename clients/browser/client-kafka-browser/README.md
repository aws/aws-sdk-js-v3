...
```javascript
//typescript
const { KafkaClient } = import '@aws-sdk/client-kafka-browser/KafkaClient';
const { CreateClusterCommand } = import '@aws-sdk/client-kafka-browser/commands/CreateClusterCommand';
```
