...
export interface LexModelBuildingServiceConfiguration {
  /**
...
export interface LexModelBuildingServiceResolvableConfiguration
  extends LexModelBuildingServiceConfiguration {
  /**
...
export interface LexModelBuildingServiceResolvedConfiguration
  extends LexModelBuildingServiceConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  LexModelBuildingServiceResolvableConfiguration,
