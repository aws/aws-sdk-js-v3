...
import {
  LexModelBuildingServiceConfiguration,
  LexModelBuildingServiceResolvedConfiguration,
  configurationProperties
} from "./LexModelBuildingServiceConfiguration";
import { InputTypesUnion } from "./types/InputTypesUnion";
import { OutputTypesUnion } from "./types/OutputTypesUnion";
import { clientVersion, ServiceMetadata } from "./model/ServiceMetadata";

export class LexModelBuildingServiceClient
  implements
    __aws_sdk_types.AWSClient<InputTypesUnion, OutputTypesUnion, Blob> {
  readonly config: LexModelBuildingServiceResolvedConfiguration;
  ...
  constructor(configuration: LexModelBuildingServiceConfiguration) {
