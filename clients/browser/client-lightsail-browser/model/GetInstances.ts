import { GetInstancesInput } from "./GetInstancesInput";
import { GetInstancesOutput } from "./GetInstancesOutput";
...
export const GetInstances: _Operation_ = {
  ...
  input: {
    shape: GetInstancesInput
  },
  output: {
    shape: GetInstancesOutput
  },
  errors: [
    {
