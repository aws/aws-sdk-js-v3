import { GetBundlesInput } from "./GetBundlesInput";
import { GetBundlesOutput } from "./GetBundlesOutput";
...
export const GetBundles: _Operation_ = {
  ...
  input: {
    shape: GetBundlesInput
  },
  output: {
    shape: GetBundlesOutput
  },
  errors: [
    {
