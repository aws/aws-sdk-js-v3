import { GetOperationsInput } from "../shapes/GetOperationsInput";
import { GetOperationsOutput } from "../shapes/GetOperationsOutput";
...
export const GetOperations: _Operation_ = {
  ...
  input: {
    shape: GetOperationsInput
  },
  output: {
    shape: GetOperationsOutput
  },
  errors: [
    {
