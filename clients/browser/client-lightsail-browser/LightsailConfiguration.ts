...
export interface LightsailConfiguration {
  /**
...
export interface LightsailResolvableConfiguration
  extends LightsailConfiguration {
  /**
...
export interface LightsailResolvedConfiguration
  extends LightsailConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  LightsailResolvableConfiguration,
