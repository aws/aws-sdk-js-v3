...
export interface RoboMakerConfiguration {
  /**
...
export interface RoboMakerResolvableConfiguration
  extends RoboMakerConfiguration {
  /**
...
export interface RoboMakerResolvedConfiguration
  extends RoboMakerConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  RoboMakerResolvableConfiguration,
