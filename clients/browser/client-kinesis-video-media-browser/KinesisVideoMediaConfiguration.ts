...
export interface KinesisVideoMediaConfiguration {
  /**
...
export interface KinesisVideoMediaResolvableConfiguration
  extends KinesisVideoMediaConfiguration {
  /**
...
export interface KinesisVideoMediaResolvedConfiguration
  extends KinesisVideoMediaConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  KinesisVideoMediaResolvableConfiguration,
...
> = {
  ...
  serializer: {
    defaultProvider: (configuration: {
      ...
      const promisified = configuration
        ...
        .then(
          endpoint =>
            new __aws_sdk_protocol_rest.RestSerializer<Blob>(
              endpoint,
  ...
  parser: {
    defaultProvider: (configuration: {
      ...
      new __aws_sdk_protocol_rest.RestParser<Blob>(
