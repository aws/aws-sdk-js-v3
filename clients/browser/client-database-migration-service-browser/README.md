# @aws-sdk/client-database-migration-service-browser
...
} = require("@aws-sdk/client-database-migration-service-browser");
```
...
import {
  DatabaseMigrationServiceClient,
  AddTagsToResourceCommand
} from "@aws-sdk/client-database-migration-service-browser";
```
...
```javascript
import * as AWS from "@aws-sdk/client-database-migration-service-browser";
