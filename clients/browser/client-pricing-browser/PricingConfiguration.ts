...
export interface PricingResolvableConfiguration extends PricingConfiguration {
  /**
...
export interface PricingResolvedConfiguration
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  PricingResolvableConfiguration,
