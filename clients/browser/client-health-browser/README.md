...
} = require("@aws-sdk/client-health-browser/commands/DescribeAffectedEntitiesCommand");
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-health-browser/Health";
