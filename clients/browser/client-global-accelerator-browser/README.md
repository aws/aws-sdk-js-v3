...
```javascript
//typescript
const { GlobalAcceleratorClient } = import '@aws-sdk/client-global-accelerator-browser/GlobalAcceleratorClient';
const { CreateAcceleratorCommand } = import '@aws-sdk/client-global-accelerator-browser/commands/CreateAcceleratorCommand';
```
