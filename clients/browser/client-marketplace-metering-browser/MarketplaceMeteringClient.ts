...
import {
  MarketplaceMeteringConfiguration,
  MarketplaceMeteringResolvedConfiguration,
  configurationProperties
} from "./MarketplaceMeteringConfiguration";
...
export class MarketplaceMeteringClient
  ...
  readonly config: MarketplaceMeteringResolvedConfiguration;
  ...
  constructor(configuration: MarketplaceMeteringConfiguration) {
