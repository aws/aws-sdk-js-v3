...
export interface GreengrassResolvableConfiguration
  extends GreengrassConfiguration {
  /**
...
export interface GreengrassResolvedConfiguration
  extends GreengrassConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  GreengrassResolvableConfiguration,
