...
export interface LicenseManagerConfiguration {
  /**
...
export interface LicenseManagerResolvableConfiguration
  extends LicenseManagerConfiguration {
  /**
...
export interface LicenseManagerResolvedConfiguration
  extends LicenseManagerConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  LicenseManagerResolvableConfiguration,
