...
export interface CodeBuildResolvableConfiguration
  extends CodeBuildConfiguration {
  /**
...
export interface CodeBuildResolvedConfiguration
  extends CodeBuildConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CodeBuildResolvableConfiguration,
