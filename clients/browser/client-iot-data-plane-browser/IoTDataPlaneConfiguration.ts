...
export interface IoTDataPlaneConfiguration {
  /**
...
export interface IoTDataPlaneResolvableConfiguration
  extends IoTDataPlaneConfiguration {
  /**
...
export interface IoTDataPlaneResolvedConfiguration
  extends IoTDataPlaneConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  IoTDataPlaneResolvableConfiguration,
