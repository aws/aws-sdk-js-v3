...
export interface IoT1ClickProjectsConfiguration {
  /**
...
export interface IoT1ClickProjectsResolvableConfiguration
  extends IoT1ClickProjectsConfiguration {
  /**
...
export interface IoT1ClickProjectsResolvedConfiguration
  extends IoT1ClickProjectsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  IoT1ClickProjectsResolvableConfiguration,
