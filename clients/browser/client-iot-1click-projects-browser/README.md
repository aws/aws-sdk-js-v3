# @aws-sdk/client-iot-1click-projects-browser
...
} = require("@aws-sdk/client-iot-1click-projects-browser/IoT1ClickProjectsClient");
const {
  AssociateDeviceWithPlacementCommand
} = require("@aws-sdk/client-iot-1click-projects-browser/commands/AssociateDeviceWithPlacementCommand");
```

```javascript
//typescript
const { IoT1ClickProjectsClient } = import '@aws-sdk/client-iot-1click-projects-browser/IoT1ClickProjectsClient';
const { AssociateDeviceWithPlacementCommand } = import '@aws-sdk/client-iot-1click-projects-browser/commands/AssociateDeviceWithPlacementCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-iot-1click-projects-browser/IoT1ClickProjects";
