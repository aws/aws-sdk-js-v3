...
[![NPM version](https://img.shields.io/npm/v/@aws-sdk/client-codecommit-browser/preview.svg)](https://www.npmjs.com/package/@aws-sdk/client-codecommit-browser)
[![NPM downloads](https://img.shields.io/npm/dm/@aws-sdk/client-codecommit-browser.svg)](https://www.npmjs.com/package/@aws-sdk/client-codecommit-browser)
...
```
npm install @aws-sdk/client-codecommit-browser
```
...
const {
  CodeCommitClient
} = require("@aws-sdk/client-codecommit-browser/CodeCommitClient");
const {
  BatchDescribeMergeConflictsCommand
} = require("@aws-sdk/client-codecommit-browser/commands/BatchDescribeMergeConflictsCommand");
```

```javascript
//typescript
const { CodeCommitClient } = import '@aws-sdk/client-codecommit-browser/CodeCommitClient';
const { BatchDescribeMergeConflictsCommand } = import '@aws-sdk/client-codecommit-browser/commands/BatchDescribeMergeConflictsCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-codecommit-browser/CodeCommit";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-codecommit-browser' package is updated. To contribute to SDK you can checkout our [code generator package][].
