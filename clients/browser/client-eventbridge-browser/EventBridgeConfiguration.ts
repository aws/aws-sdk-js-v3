...
export interface EventBridgeResolvableConfiguration
  extends EventBridgeConfiguration {
  /**
...
export interface EventBridgeResolvedConfiguration
  extends EventBridgeConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  EventBridgeResolvableConfiguration,
