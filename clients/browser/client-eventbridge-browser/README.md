# @aws-sdk/client-eventbridge-browser
...
```javascript
//typescript
const { EventBridgeClient } = import '@aws-sdk/client-eventbridge-browser/EventBridgeClient';
const { ActivateEventSourceCommand } = import '@aws-sdk/client-eventbridge-browser/commands/ActivateEventSourceCommand';
```
