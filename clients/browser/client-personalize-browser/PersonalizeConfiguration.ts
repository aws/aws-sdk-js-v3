...
export interface PersonalizeConfiguration {
  /**
...
export interface PersonalizeResolvableConfiguration
  extends PersonalizeConfiguration {
  /**
...
export interface PersonalizeResolvedConfiguration
  extends PersonalizeConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  PersonalizeResolvableConfiguration,
