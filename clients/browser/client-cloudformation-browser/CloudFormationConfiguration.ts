...
export interface CloudFormationConfiguration {
  /**
...
export interface CloudFormationResolvableConfiguration
  extends CloudFormationConfiguration {
  /**
...
export interface CloudFormationResolvedConfiguration
  extends CloudFormationConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CloudFormationResolvableConfiguration,
  ...
  serializer: {
    defaultProvider: (configuration: {
      ...
      const promisified = configuration
        ...
        .then(
          endpoint =>
            new __aws_sdk_protocol_query.QuerySerializer<Blob>(
              endpoint,
