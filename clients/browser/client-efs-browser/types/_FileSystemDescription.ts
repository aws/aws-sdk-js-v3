import {
  _FileSystemSize,
  _UnmarshalledFileSystemSize
} from "./_FileSystemSize";
import { _Tag, _UnmarshalledTag } from "./_Tag";

/**
 * <p>A description of the file system.</p>
 */
export interface _FileSystemDescription {
  /**
...
export interface _UnmarshalledFileSystemDescription
  extends _FileSystemDescription {
  /**
   * <p>The time that the file system was created, in seconds (since 1970-01-01T00:00:00Z).</p>
   */
  CreationTime: Date;
