 ...
 */
export interface _NewTransitVirtualInterfaceAllocation {
  /**
...
export interface _UnmarshalledNewTransitVirtualInterfaceAllocation
  extends _NewTransitVirtualInterfaceAllocation {
  /**
   * <p>Any tags assigned to the transit virtual interface.</p>
   */
