...
export interface DirectConnectConfiguration {
  /**
...
export interface DirectConnectResolvableConfiguration
  extends DirectConnectConfiguration {
  /**
...
export interface DirectConnectResolvedConfiguration
  extends DirectConnectConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  DirectConnectResolvableConfiguration,
