...
export interface MediaStoreConfiguration {
  /**
...
export interface MediaStoreResolvableConfiguration
  extends MediaStoreConfiguration {
  /**
...
export interface MediaStoreResolvedConfiguration
  extends MediaStoreConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  MediaStoreResolvableConfiguration,
