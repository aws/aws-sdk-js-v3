# @aws-sdk/client-connect-browser
...
```javascript
//typescript
const { ConnectClient } = import '@aws-sdk/client-connect-browser/ConnectClient';
const { CreateUserCommand } = import '@aws-sdk/client-connect-browser/commands/CreateUserCommand';
```
