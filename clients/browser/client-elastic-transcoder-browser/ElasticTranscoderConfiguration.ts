...
export interface ElasticTranscoderConfiguration {
  /**
...
export interface ElasticTranscoderResolvableConfiguration
  extends ElasticTranscoderConfiguration {
  /**
...
export interface ElasticTranscoderResolvedConfiguration
  extends ElasticTranscoderConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ElasticTranscoderResolvableConfiguration,
...
> = {
  ...
  signingName: {
    defaultValue: "elastictranscoder"
  },
  signer: {
    defaultProvider: (configuration: {
      credentials: __aws_sdk_types.Provider<__aws_sdk_types.Credentials>;
