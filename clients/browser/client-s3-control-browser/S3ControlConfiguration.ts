...
export interface S3ControlConfiguration {
  /**
...
export interface S3ControlResolvableConfiguration
  extends S3ControlConfiguration {
  /**
...
export interface S3ControlResolvedConfiguration
  extends S3ControlConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  S3ControlResolvableConfiguration,
