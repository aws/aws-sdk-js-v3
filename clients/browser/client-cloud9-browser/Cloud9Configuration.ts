...
export interface Cloud9Configuration {
  /**
...
export interface Cloud9ResolvableConfiguration extends Cloud9Configuration {
  /**
...
export interface Cloud9ResolvedConfiguration
  extends Cloud9Configuration,
