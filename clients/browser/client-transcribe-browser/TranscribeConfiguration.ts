...
export interface TranscribeResolvableConfiguration
  extends TranscribeConfiguration {
  /**
...
export interface TranscribeResolvedConfiguration
  extends TranscribeConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  TranscribeResolvableConfiguration,
