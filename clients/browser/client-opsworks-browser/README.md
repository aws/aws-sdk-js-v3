# @aws-sdk/client-opsworks-browser
...
} = require("@aws-sdk/client-opsworks-browser/commands/AssignInstanceCommand");
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-opsworks-browser/OpsWorks";
