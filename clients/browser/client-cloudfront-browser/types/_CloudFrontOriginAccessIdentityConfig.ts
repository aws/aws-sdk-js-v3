 ...
 */
export interface _CloudFrontOriginAccessIdentityConfig {
  /**
...
export type _UnmarshalledCloudFrontOriginAccessIdentityConfig = _CloudFrontOriginAccessIdentityConfig;
