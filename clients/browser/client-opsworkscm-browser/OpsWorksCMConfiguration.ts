...
export interface OpsWorksCMConfiguration {
  /**
...
export interface OpsWorksCMResolvableConfiguration
  extends OpsWorksCMConfiguration {
  /**
...
export interface OpsWorksCMResolvedConfiguration
  extends OpsWorksCMConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  OpsWorksCMResolvableConfiguration,
