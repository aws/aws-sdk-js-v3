...
export interface LexRuntimeServiceConfiguration {
  /**
...
export interface LexRuntimeServiceResolvableConfiguration
  extends LexRuntimeServiceConfiguration {
  /**
...
export interface LexRuntimeServiceResolvedConfiguration
  extends LexRuntimeServiceConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  LexRuntimeServiceResolvableConfiguration,
