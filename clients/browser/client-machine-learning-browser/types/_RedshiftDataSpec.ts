import {
  _RedshiftDatabase,
  _UnmarshalledRedshiftDatabase
} from "./_RedshiftDatabase";
import {
  _RedshiftDatabaseCredentials,
  _UnmarshalledRedshiftDatabaseCredentials
} from "./_RedshiftDatabaseCredentials";
