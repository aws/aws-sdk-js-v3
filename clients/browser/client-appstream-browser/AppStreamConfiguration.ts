...
export interface AppStreamConfiguration {
  /**
...
export interface AppStreamResolvableConfiguration
  extends AppStreamConfiguration {
  /**
...
export interface AppStreamResolvedConfiguration
  extends AppStreamConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  AppStreamResolvableConfiguration,
