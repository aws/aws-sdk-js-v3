...
export interface CodeDeployConfiguration {
  /**
...
export interface CodeDeployResolvableConfiguration
  extends CodeDeployConfiguration {
  /**
...
export interface CodeDeployResolvedConfiguration
  extends CodeDeployConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CodeDeployResolvableConfiguration,
