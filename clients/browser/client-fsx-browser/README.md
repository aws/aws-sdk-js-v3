...
```javascript
//typescript
const { FSxClient } = import '@aws-sdk/client-fsx-browser/FSxClient';
const { CreateBackupCommand } = import '@aws-sdk/client-fsx-browser/commands/CreateBackupCommand';
```
