import { _UnmarshalledUsagePlan } from "./_UsagePlan";
 ...
 */
export interface GetUsagePlansOutput extends __aws_sdk_types.MetadataBearer {
  /**
   * _String shape
   */
  position?: string;
   ...
   */
  items?: Array<_UnmarshalledUsagePlan>;
