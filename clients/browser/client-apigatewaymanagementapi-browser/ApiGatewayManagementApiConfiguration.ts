...
export interface ApiGatewayManagementApiConfiguration {
  /**
...
export interface ApiGatewayManagementApiResolvableConfiguration
  extends ApiGatewayManagementApiConfiguration {
  /**
...
export interface ApiGatewayManagementApiResolvedConfiguration
  extends ApiGatewayManagementApiConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ApiGatewayManagementApiResolvableConfiguration,
