...
export interface CloudHSMV2Configuration {
  /**
...
export interface CloudHSMV2ResolvableConfiguration
  extends CloudHSMV2Configuration {
  /**
...
export interface CloudHSMV2ResolvedConfiguration
  extends CloudHSMV2Configuration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CloudHSMV2ResolvableConfiguration,
