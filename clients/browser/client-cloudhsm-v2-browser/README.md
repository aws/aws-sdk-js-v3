# @aws-sdk/client-cloudhsm-v2-browser
...
} = require("@aws-sdk/client-cloudhsm-v2-browser");
```
...
import {
  CloudHSMV2Client,
  CopyBackupToRegionCommand
} from "@aws-sdk/client-cloudhsm-v2-browser";
```
...
```javascript
import * as AWS from "@aws-sdk/client-cloudhsm-v2-browser";
