...
export interface WorkLinkConfiguration {
  /**
...
export interface WorkLinkResolvableConfiguration extends WorkLinkConfiguration {
  /**
...
export interface WorkLinkResolvedConfiguration
  extends WorkLinkConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  WorkLinkResolvableConfiguration,
