...
export interface FirehoseResolvableConfiguration extends FirehoseConfiguration {
  /**
...
export interface FirehoseResolvedConfiguration
  extends FirehoseConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  FirehoseResolvableConfiguration,
