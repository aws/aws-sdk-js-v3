...
export interface AutoScalingResolvableConfiguration
  extends AutoScalingConfiguration {
  /**
...
export interface AutoScalingResolvedConfiguration
  extends AutoScalingConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  AutoScalingResolvableConfiguration,
