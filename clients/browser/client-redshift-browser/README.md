...
```javascript
//typescript
const { RedshiftClient } = import '@aws-sdk/client-redshift-browser/RedshiftClient';
const { AcceptReservedNodeExchangeCommand } = import '@aws-sdk/client-redshift-browser/commands/AcceptReservedNodeExchangeCommand';
```
