...
export interface RedshiftResolvableConfiguration extends RedshiftConfiguration {
  /**
...
export interface RedshiftResolvedConfiguration
  extends RedshiftConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  RedshiftResolvableConfiguration,
