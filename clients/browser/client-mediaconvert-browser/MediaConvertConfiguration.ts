...
export interface MediaConvertConfiguration {
  /**
...
export interface MediaConvertResolvableConfiguration
  extends MediaConvertConfiguration {
  /**
...
export interface MediaConvertResolvedConfiguration
  extends MediaConvertConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  MediaConvertResolvableConfiguration,
