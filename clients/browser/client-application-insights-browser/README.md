...
```javascript
//typescript
const { ApplicationInsightsClient } = import '@aws-sdk/client-application-insights-browser/ApplicationInsightsClient';
const { CreateApplicationCommand } = import '@aws-sdk/client-application-insights-browser/commands/CreateApplicationCommand';
```
