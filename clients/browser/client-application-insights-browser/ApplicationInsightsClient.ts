...
} from "./ApplicationInsightsConfiguration";
...
export class ApplicationInsightsClient
  ...
  readonly config: ApplicationInsightsResolvedConfiguration;
  ...
  constructor(configuration: ApplicationInsightsConfiguration) {
