...
export interface DataSyncResolvableConfiguration extends DataSyncConfiguration {
  /**
...
export interface DataSyncResolvedConfiguration
  extends DataSyncConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  DataSyncResolvableConfiguration,
