...
import { FleetCapacityExceededException } from "./types/FleetCapacityExceededException";
import { GameSessionFullException } from "./types/GameSessionFullException";
...
import { InvalidFleetStatusException } from "./types/InvalidFleetStatusException";
import { InvalidGameSessionStatusException } from "./types/InvalidGameSessionStatusException";
...
import { TerminalRoutingStrategyException } from "./types/TerminalRoutingStrategyException";
import { UnauthorizedException } from "./types/UnauthorizedException";
import { UnsupportedRegionException } from "./types/UnsupportedRegionException";
...
export class GameLift extends GameLiftClient {
   ...
   *   - {InvalidRequestException} <p>One or more parameter values in the request are invalid. Correct the invalid parameter values before retrying.</p>
   *   - {NotFoundException} <p>A service resource associated with the request could not be found. Clients should not retry such requests.</p>
   *   - {InternalServiceException} <p>The service encountered an unrecoverable internal failure while processing the request. Clients can retry such requests immediately or after a waiting period.</p>
   *   - {UnsupportedRegionException} <p>The requested operation is not supported in the region specified.</p>
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public acceptMatch(args: AcceptMatchInput): Promise<AcceptMatchOutput>;
  public acceptMatch(
    args: AcceptMatchInput,
    cb: (err: any, data?: AcceptMatchOutput) => void
  ): void;
  public acceptMatch(
    args: AcceptMatchInput,
    cb?: (err: any, data?: AcceptMatchOutput) => void
  ): Promise<AcceptMatchOutput> | void {
   ...
   *
   * This operation may fail with one of the following errors:
   *   - {UnauthorizedException} <p>The client failed authentication. Clients should not retry such requests.</p>
   *   - {InvalidRequestException} <p>One or more parameter values in the request are invalid. Correct the invalid parameter values before retrying.</p>
   *   - {ConflictException} <p>The requested operation would cause a conflict with the current state of a service resource associated with the request. Resolve the conflict before retrying this request.</p>
   *   - {InternalServiceException} <p>The service encountered an unrecoverable internal failure while processing the request. Clients can retry such requests immediately or after a waiting period.</p>
   *   - {LimitExceededException} <p>The requested operation would cause the resource to exceed the allowed service limit. Resolve the issue before retrying.</p>
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
   ...
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public createBuild(args: CreateBuildInput): Promise<CreateBuildOutput>;
  public createBuild(
    args: CreateBuildInput,
    cb: (err: any, data?: CreateBuildOutput) => void
  ): void;
  public createBuild(
    args: CreateBuildInput,
    cb?: (err: any, data?: CreateBuildOutput) => void
  ): Promise<CreateBuildOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *   - {InternalServiceException} <p>The service encountered an unrecoverable internal failure while processing the request. Clients can retry such requests immediately or after a waiting period.</p>
   *   - {UnauthorizedException} <p>The client failed authentication. Clients should not retry such requests.</p>
   *   - {InvalidFleetStatusException} <p>The requested operation would cause a conflict with the current state of a resource associated with the request and/or the fleet. Resolve the conflict before retrying.</p>
   *   - {TerminalRoutingStrategyException} <p>The service is unable to resolve the routing for a particular alias because it has a terminal <a>RoutingStrategy</a> associated with it. The message returned in this exception is the message defined in the routing strategy itself. Such requests should only be retried if the routing strategy for the specified alias is modified. </p>
   *   - {InvalidRequestException} <p>One or more parameter values in the request are invalid. Correct the invalid parameter values before retrying.</p>
   *   - {NotFoundException} <p>A service resource associated with the request could not be found. Clients should not retry such requests.</p>
   *   - {FleetCapacityExceededException} <p>The specified fleet has no available instances to fulfill a <code>CreateGameSession</code> request. Clients can retry such requests immediately or after a waiting period.</p>
   *   - {LimitExceededException} <p>The requested operation would cause the resource to exceed the allowed service limit. Resolve the issue before retrying.</p>
   *   - {IdempotentParameterMismatchException} <p>A game session with this custom ID string already exists in this fleet. Resolve this conflict before retrying this request.</p>
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public createGameSession(
    args: CreateGameSessionInput
  ): Promise<CreateGameSessionOutput>;
  public createGameSession(
    args: CreateGameSessionInput,
    cb: (err: any, data?: CreateGameSessionOutput) => void
  ): void;
  public createGameSession(
    args: CreateGameSessionInput,
    cb?: (err: any, data?: CreateGameSessionOutput) => void
  ): Promise<CreateGameSessionOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public createGameSessionQueue(
    args: CreateGameSessionQueueInput
  ): Promise<CreateGameSessionQueueOutput>;
  public createGameSessionQueue(
    args: CreateGameSessionQueueInput,
    cb: (err: any, data?: CreateGameSessionQueueOutput) => void
  ): void;
  public createGameSessionQueue(
    args: CreateGameSessionQueueInput,
    cb?: (err: any, data?: CreateGameSessionQueueOutput) => void
  ): Promise<CreateGameSessionQueueOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public createMatchmakingConfiguration(
    args: CreateMatchmakingConfigurationInput
  ): Promise<CreateMatchmakingConfigurationOutput>;
  public createMatchmakingConfiguration(
    args: CreateMatchmakingConfigurationInput,
    cb: (err: any, data?: CreateMatchmakingConfigurationOutput) => void
  ): void;
  public createMatchmakingConfiguration(
    args: CreateMatchmakingConfigurationInput,
    cb?: (err: any, data?: CreateMatchmakingConfigurationOutput) => void
  ): Promise<CreateMatchmakingConfigurationOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public createMatchmakingRuleSet(
    args: CreateMatchmakingRuleSetInput
  ): Promise<CreateMatchmakingRuleSetOutput>;
  public createMatchmakingRuleSet(
    args: CreateMatchmakingRuleSetInput,
    cb: (err: any, data?: CreateMatchmakingRuleSetOutput) => void
  ): void;
  public createMatchmakingRuleSet(
    args: CreateMatchmakingRuleSetInput,
    cb?: (err: any, data?: CreateMatchmakingRuleSetOutput) => void
  ): Promise<CreateMatchmakingRuleSetOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *   - {InternalServiceException} <p>The service encountered an unrecoverable internal failure while processing the request. Clients can retry such requests immediately or after a waiting period.</p>
   *   - {UnauthorizedException} <p>The client failed authentication. Clients should not retry such requests.</p>
   *   - {InvalidGameSessionStatusException} <p>The requested operation would cause a conflict with the current state of a resource associated with the request and/or the game instance. Resolve the conflict before retrying.</p>
   *   - {GameSessionFullException} <p>The game instance is currently full and cannot allow the requested player(s) to join. Clients can retry such requests immediately or after a waiting period.</p>
   *   - {TerminalRoutingStrategyException} <p>The service is unable to resolve the routing for a particular alias because it has a terminal <a>RoutingStrategy</a> associated with it. The message returned in this exception is the message defined in the routing strategy itself. Such requests should only be retried if the routing strategy for the specified alias is modified. </p>
   *   - {InvalidRequestException} <p>One or more parameter values in the request are invalid. Correct the invalid parameter values before retrying.</p>
   *   - {NotFoundException} <p>A service resource associated with the request could not be found. Clients should not retry such requests.</p>
   *   - {Error} An error originating from the SDK or customizations rather than the service
  ...
  public createPlayerSession(
    args: CreatePlayerSessionInput
  ): Promise<CreatePlayerSessionOutput>;
  public createPlayerSession(
    args: CreatePlayerSessionInput,
    cb: (err: any, data?: CreatePlayerSessionOutput) => void
  ): void;
  public createPlayerSession(
    args: CreatePlayerSessionInput,
    cb?: (err: any, data?: CreatePlayerSessionOutput) => void
  ): Promise<CreatePlayerSessionOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public createPlayerSessions(
    args: CreatePlayerSessionsInput
  ): Promise<CreatePlayerSessionsOutput>;
  public createPlayerSessions(
    args: CreatePlayerSessionsInput,
    cb: (err: any, data?: CreatePlayerSessionsOutput) => void
  ): void;
  public createPlayerSessions(
    args: CreatePlayerSessionsInput,
    cb?: (err: any, data?: CreatePlayerSessionsOutput) => void
  ): Promise<CreatePlayerSessionsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public createVpcPeeringAuthorization(
    args: CreateVpcPeeringAuthorizationInput
  ): Promise<CreateVpcPeeringAuthorizationOutput>;
  public createVpcPeeringAuthorization(
    args: CreateVpcPeeringAuthorizationInput,
    cb: (err: any, data?: CreateVpcPeeringAuthorizationOutput) => void
  ): void;
  public createVpcPeeringAuthorization(
    args: CreateVpcPeeringAuthorizationInput,
    cb?: (err: any, data?: CreateVpcPeeringAuthorizationOutput) => void
  ): Promise<CreateVpcPeeringAuthorizationOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public deleteBuild(args: DeleteBuildInput): Promise<DeleteBuildOutput>;
  public deleteBuild(
    args: DeleteBuildInput,
    cb: (err: any, data?: DeleteBuildOutput) => void
  ): void;
  public deleteBuild(
    args: DeleteBuildInput,
    cb?: (err: any, data?: DeleteBuildOutput) => void
  ): Promise<DeleteBuildOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public deleteGameSessionQueue(
    args: DeleteGameSessionQueueInput
  ): Promise<DeleteGameSessionQueueOutput>;
  public deleteGameSessionQueue(
    args: DeleteGameSessionQueueInput,
    cb: (err: any, data?: DeleteGameSessionQueueOutput) => void
  ): void;
  public deleteGameSessionQueue(
    args: DeleteGameSessionQueueInput,
    cb?: (err: any, data?: DeleteGameSessionQueueOutput) => void
  ): Promise<DeleteGameSessionQueueOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public deleteMatchmakingConfiguration(
    args: DeleteMatchmakingConfigurationInput
  ): Promise<DeleteMatchmakingConfigurationOutput>;
  public deleteMatchmakingConfiguration(
    args: DeleteMatchmakingConfigurationInput,
    cb: (err: any, data?: DeleteMatchmakingConfigurationOutput) => void
  ): void;
  public deleteMatchmakingConfiguration(
    args: DeleteMatchmakingConfigurationInput,
    cb?: (err: any, data?: DeleteMatchmakingConfigurationOutput) => void
  ): Promise<DeleteMatchmakingConfigurationOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public deleteMatchmakingRuleSet(
    args: DeleteMatchmakingRuleSetInput
  ): Promise<DeleteMatchmakingRuleSetOutput>;
  public deleteMatchmakingRuleSet(
    args: DeleteMatchmakingRuleSetInput,
    cb: (err: any, data?: DeleteMatchmakingRuleSetOutput) => void
  ): void;
  public deleteMatchmakingRuleSet(
    args: DeleteMatchmakingRuleSetInput,
    cb?: (err: any, data?: DeleteMatchmakingRuleSetOutput) => void
  ): Promise<DeleteMatchmakingRuleSetOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public deleteScript(args: DeleteScriptInput): Promise<DeleteScriptOutput>;
  public deleteScript(
    args: DeleteScriptInput,
    cb: (err: any, data?: DeleteScriptOutput) => void
  ): void;
  public deleteScript(
    args: DeleteScriptInput,
    cb?: (err: any, data?: DeleteScriptOutput) => void
  ): Promise<DeleteScriptOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public deleteVpcPeeringAuthorization(
    args: DeleteVpcPeeringAuthorizationInput
  ): Promise<DeleteVpcPeeringAuthorizationOutput>;
  public deleteVpcPeeringAuthorization(
    args: DeleteVpcPeeringAuthorizationInput,
    cb: (err: any, data?: DeleteVpcPeeringAuthorizationOutput) => void
  ): void;
  public deleteVpcPeeringAuthorization(
    args: DeleteVpcPeeringAuthorizationInput,
    cb?: (err: any, data?: DeleteVpcPeeringAuthorizationOutput) => void
  ): Promise<DeleteVpcPeeringAuthorizationOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public describeAlias(args: DescribeAliasInput): Promise<DescribeAliasOutput>;
  public describeAlias(
    args: DescribeAliasInput,
    cb: (err: any, data?: DescribeAliasOutput) => void
  ): void;
  public describeAlias(
    args: DescribeAliasInput,
    cb?: (err: any, data?: DescribeAliasOutput) => void
  ): Promise<DescribeAliasOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public describeBuild(args: DescribeBuildInput): Promise<DescribeBuildOutput>;
  public describeBuild(
    args: DescribeBuildInput,
    cb: (err: any, data?: DescribeBuildOutput) => void
  ): void;
  public describeBuild(
    args: DescribeBuildInput,
    cb?: (err: any, data?: DescribeBuildOutput) => void
  ): Promise<DescribeBuildOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeEC2InstanceLimits(
    args: DescribeEC2InstanceLimitsInput
  ): Promise<DescribeEC2InstanceLimitsOutput>;
  public describeEC2InstanceLimits(
    args: DescribeEC2InstanceLimitsInput,
    cb: (err: any, data?: DescribeEC2InstanceLimitsOutput) => void
  ): void;
  public describeEC2InstanceLimits(
    args: DescribeEC2InstanceLimitsInput,
    cb?: (err: any, data?: DescribeEC2InstanceLimitsOutput) => void
  ): Promise<DescribeEC2InstanceLimitsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeFleetAttributes(
    args: DescribeFleetAttributesInput
  ): Promise<DescribeFleetAttributesOutput>;
  public describeFleetAttributes(
    args: DescribeFleetAttributesInput,
    cb: (err: any, data?: DescribeFleetAttributesOutput) => void
  ): void;
  public describeFleetAttributes(
    args: DescribeFleetAttributesInput,
    cb?: (err: any, data?: DescribeFleetAttributesOutput) => void
  ): Promise<DescribeFleetAttributesOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeFleetCapacity(
    args: DescribeFleetCapacityInput
  ): Promise<DescribeFleetCapacityOutput>;
  public describeFleetCapacity(
    args: DescribeFleetCapacityInput,
    cb: (err: any, data?: DescribeFleetCapacityOutput) => void
  ): void;
  public describeFleetCapacity(
    args: DescribeFleetCapacityInput,
    cb?: (err: any, data?: DescribeFleetCapacityOutput) => void
  ): Promise<DescribeFleetCapacityOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeFleetEvents(
    args: DescribeFleetEventsInput
  ): Promise<DescribeFleetEventsOutput>;
  public describeFleetEvents(
    args: DescribeFleetEventsInput,
    cb: (err: any, data?: DescribeFleetEventsOutput) => void
  ): void;
  public describeFleetEvents(
    args: DescribeFleetEventsInput,
    cb?: (err: any, data?: DescribeFleetEventsOutput) => void
  ): Promise<DescribeFleetEventsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeFleetPortSettings(
    args: DescribeFleetPortSettingsInput
  ): Promise<DescribeFleetPortSettingsOutput>;
  public describeFleetPortSettings(
    args: DescribeFleetPortSettingsInput,
    cb: (err: any, data?: DescribeFleetPortSettingsOutput) => void
  ): void;
  public describeFleetPortSettings(
    args: DescribeFleetPortSettingsInput,
    cb?: (err: any, data?: DescribeFleetPortSettingsOutput) => void
  ): Promise<DescribeFleetPortSettingsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeFleetUtilization(
    args: DescribeFleetUtilizationInput
  ): Promise<DescribeFleetUtilizationOutput>;
  public describeFleetUtilization(
    args: DescribeFleetUtilizationInput,
    cb: (err: any, data?: DescribeFleetUtilizationOutput) => void
  ): void;
  public describeFleetUtilization(
    args: DescribeFleetUtilizationInput,
    cb?: (err: any, data?: DescribeFleetUtilizationOutput) => void
  ): Promise<DescribeFleetUtilizationOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeGameSessionDetails(
    args: DescribeGameSessionDetailsInput
  ): Promise<DescribeGameSessionDetailsOutput>;
  public describeGameSessionDetails(
    args: DescribeGameSessionDetailsInput,
    cb: (err: any, data?: DescribeGameSessionDetailsOutput) => void
  ): void;
  public describeGameSessionDetails(
    args: DescribeGameSessionDetailsInput,
    cb?: (err: any, data?: DescribeGameSessionDetailsOutput) => void
  ): Promise<DescribeGameSessionDetailsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeGameSessionPlacement(
    args: DescribeGameSessionPlacementInput
  ): Promise<DescribeGameSessionPlacementOutput>;
  public describeGameSessionPlacement(
    args: DescribeGameSessionPlacementInput,
    cb: (err: any, data?: DescribeGameSessionPlacementOutput) => void
  ): void;
  public describeGameSessionPlacement(
    args: DescribeGameSessionPlacementInput,
    cb?: (err: any, data?: DescribeGameSessionPlacementOutput) => void
  ): Promise<DescribeGameSessionPlacementOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeGameSessionQueues(
    args: DescribeGameSessionQueuesInput
  ): Promise<DescribeGameSessionQueuesOutput>;
  public describeGameSessionQueues(
    args: DescribeGameSessionQueuesInput,
    cb: (err: any, data?: DescribeGameSessionQueuesOutput) => void
  ): void;
  public describeGameSessionQueues(
    args: DescribeGameSessionQueuesInput,
    cb?: (err: any, data?: DescribeGameSessionQueuesOutput) => void
  ): Promise<DescribeGameSessionQueuesOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeGameSessions(
    args: DescribeGameSessionsInput
  ): Promise<DescribeGameSessionsOutput>;
  public describeGameSessions(
    args: DescribeGameSessionsInput,
    cb: (err: any, data?: DescribeGameSessionsOutput) => void
  ): void;
  public describeGameSessions(
    args: DescribeGameSessionsInput,
    cb?: (err: any, data?: DescribeGameSessionsOutput) => void
  ): Promise<DescribeGameSessionsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeMatchmaking(
    args: DescribeMatchmakingInput
  ): Promise<DescribeMatchmakingOutput>;
  public describeMatchmaking(
    args: DescribeMatchmakingInput,
    cb: (err: any, data?: DescribeMatchmakingOutput) => void
  ): void;
  public describeMatchmaking(
    args: DescribeMatchmakingInput,
    cb?: (err: any, data?: DescribeMatchmakingOutput) => void
  ): Promise<DescribeMatchmakingOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeMatchmakingConfigurations(
    args: DescribeMatchmakingConfigurationsInput
  ): Promise<DescribeMatchmakingConfigurationsOutput>;
  public describeMatchmakingConfigurations(
    args: DescribeMatchmakingConfigurationsInput,
    cb: (err: any, data?: DescribeMatchmakingConfigurationsOutput) => void
  ): void;
  public describeMatchmakingConfigurations(
    args: DescribeMatchmakingConfigurationsInput,
    cb?: (err: any, data?: DescribeMatchmakingConfigurationsOutput) => void
  ): Promise<DescribeMatchmakingConfigurationsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeMatchmakingRuleSets(
    args: DescribeMatchmakingRuleSetsInput
  ): Promise<DescribeMatchmakingRuleSetsOutput>;
  public describeMatchmakingRuleSets(
    args: DescribeMatchmakingRuleSetsInput,
    cb: (err: any, data?: DescribeMatchmakingRuleSetsOutput) => void
  ): void;
  public describeMatchmakingRuleSets(
    args: DescribeMatchmakingRuleSetsInput,
    cb?: (err: any, data?: DescribeMatchmakingRuleSetsOutput) => void
  ): Promise<DescribeMatchmakingRuleSetsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describePlayerSessions(
    args: DescribePlayerSessionsInput
  ): Promise<DescribePlayerSessionsOutput>;
  public describePlayerSessions(
    args: DescribePlayerSessionsInput,
    cb: (err: any, data?: DescribePlayerSessionsOutput) => void
  ): void;
  public describePlayerSessions(
    args: DescribePlayerSessionsInput,
    cb?: (err: any, data?: DescribePlayerSessionsOutput) => void
  ): Promise<DescribePlayerSessionsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeRuntimeConfiguration(
    args: DescribeRuntimeConfigurationInput
  ): Promise<DescribeRuntimeConfigurationOutput>;
  public describeRuntimeConfiguration(
    args: DescribeRuntimeConfigurationInput,
    cb: (err: any, data?: DescribeRuntimeConfigurationOutput) => void
  ): void;
  public describeRuntimeConfiguration(
    args: DescribeRuntimeConfigurationInput,
    cb?: (err: any, data?: DescribeRuntimeConfigurationOutput) => void
  ): Promise<DescribeRuntimeConfigurationOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeScript(
    args: DescribeScriptInput
  ): Promise<DescribeScriptOutput>;
  public describeScript(
    args: DescribeScriptInput,
    cb: (err: any, data?: DescribeScriptOutput) => void
  ): void;
  public describeScript(
    args: DescribeScriptInput,
    cb?: (err: any, data?: DescribeScriptOutput) => void
  ): Promise<DescribeScriptOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public describeVpcPeeringAuthorizations(
    args: DescribeVpcPeeringAuthorizationsInput
  ): Promise<DescribeVpcPeeringAuthorizationsOutput>;
  public describeVpcPeeringAuthorizations(
    args: DescribeVpcPeeringAuthorizationsInput,
    cb: (err: any, data?: DescribeVpcPeeringAuthorizationsOutput) => void
  ): void;
  public describeVpcPeeringAuthorizations(
    args: DescribeVpcPeeringAuthorizationsInput,
    cb?: (err: any, data?: DescribeVpcPeeringAuthorizationsOutput) => void
  ): Promise<DescribeVpcPeeringAuthorizationsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public getGameSessionLogUrl(
    args: GetGameSessionLogUrlInput
  ): Promise<GetGameSessionLogUrlOutput>;
  public getGameSessionLogUrl(
    args: GetGameSessionLogUrlInput,
    cb: (err: any, data?: GetGameSessionLogUrlOutput) => void
  ): void;
  public getGameSessionLogUrl(
    args: GetGameSessionLogUrlInput,
    cb?: (err: any, data?: GetGameSessionLogUrlOutput) => void
  ): Promise<GetGameSessionLogUrlOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public getInstanceAccess(
    args: GetInstanceAccessInput
  ): Promise<GetInstanceAccessOutput>;
  public getInstanceAccess(
    args: GetInstanceAccessInput,
    cb: (err: any, data?: GetInstanceAccessOutput) => void
  ): void;
  public getInstanceAccess(
    args: GetInstanceAccessInput,
    cb?: (err: any, data?: GetInstanceAccessOutput) => void
  ): Promise<GetInstanceAccessOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public listScripts(args: ListScriptsInput): Promise<ListScriptsOutput>;
  public listScripts(
    args: ListScriptsInput,
    cb: (err: any, data?: ListScriptsOutput) => void
  ): void;
  public listScripts(
    args: ListScriptsInput,
    cb?: (err: any, data?: ListScriptsOutput) => void
  ): Promise<ListScriptsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public requestUploadCredentials(
    args: RequestUploadCredentialsInput
  ): Promise<RequestUploadCredentialsOutput>;
  public requestUploadCredentials(
    args: RequestUploadCredentialsInput,
    cb: (err: any, data?: RequestUploadCredentialsOutput) => void
  ): void;
  public requestUploadCredentials(
    args: RequestUploadCredentialsInput,
    cb?: (err: any, data?: RequestUploadCredentialsOutput) => void
  ): Promise<RequestUploadCredentialsOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public resolveAlias(args: ResolveAliasInput): Promise<ResolveAliasOutput>;
  public resolveAlias(
    args: ResolveAliasInput,
    cb: (err: any, data?: ResolveAliasOutput) => void
  ): void;
  public resolveAlias(
    args: ResolveAliasInput,
    cb?: (err: any, data?: ResolveAliasOutput) => void
  ): Promise<ResolveAliasOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public searchGameSessions(
    args: SearchGameSessionsInput
  ): Promise<SearchGameSessionsOutput>;
  public searchGameSessions(
    args: SearchGameSessionsInput,
    cb: (err: any, data?: SearchGameSessionsOutput) => void
  ): void;
  public searchGameSessions(
    args: SearchGameSessionsInput,
    cb?: (err: any, data?: SearchGameSessionsOutput) => void
  ): Promise<SearchGameSessionsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public startFleetActions(
    args: StartFleetActionsInput
  ): Promise<StartFleetActionsOutput>;
  public startFleetActions(
    args: StartFleetActionsInput,
    cb: (err: any, data?: StartFleetActionsOutput) => void
  ): void;
  public startFleetActions(
    args: StartFleetActionsInput,
    cb?: (err: any, data?: StartFleetActionsOutput) => void
  ): Promise<StartFleetActionsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public startGameSessionPlacement(
    args: StartGameSessionPlacementInput
  ): Promise<StartGameSessionPlacementOutput>;
  public startGameSessionPlacement(
    args: StartGameSessionPlacementInput,
    cb: (err: any, data?: StartGameSessionPlacementOutput) => void
  ): void;
  public startGameSessionPlacement(
    args: StartGameSessionPlacementInput,
    cb?: (err: any, data?: StartGameSessionPlacementOutput) => void
  ): Promise<StartGameSessionPlacementOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public startMatchBackfill(
    args: StartMatchBackfillInput
  ): Promise<StartMatchBackfillOutput>;
  public startMatchBackfill(
    args: StartMatchBackfillInput,
    cb: (err: any, data?: StartMatchBackfillOutput) => void
  ): void;
  public startMatchBackfill(
    args: StartMatchBackfillInput,
    cb?: (err: any, data?: StartMatchBackfillOutput) => void
  ): Promise<StartMatchBackfillOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public startMatchmaking(
    args: StartMatchmakingInput
  ): Promise<StartMatchmakingOutput>;
  public startMatchmaking(
    args: StartMatchmakingInput,
    cb: (err: any, data?: StartMatchmakingOutput) => void
  ): void;
  public startMatchmaking(
    args: StartMatchmakingInput,
    cb?: (err: any, data?: StartMatchmakingOutput) => void
  ): Promise<StartMatchmakingOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public stopFleetActions(
    args: StopFleetActionsInput
  ): Promise<StopFleetActionsOutput>;
  public stopFleetActions(
    args: StopFleetActionsInput,
    cb: (err: any, data?: StopFleetActionsOutput) => void
  ): void;
  public stopFleetActions(
    args: StopFleetActionsInput,
    cb?: (err: any, data?: StopFleetActionsOutput) => void
  ): Promise<StopFleetActionsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public stopGameSessionPlacement(
    args: StopGameSessionPlacementInput
  ): Promise<StopGameSessionPlacementOutput>;
  public stopGameSessionPlacement(
    args: StopGameSessionPlacementInput,
    cb: (err: any, data?: StopGameSessionPlacementOutput) => void
  ): void;
  public stopGameSessionPlacement(
    args: StopGameSessionPlacementInput,
    cb?: (err: any, data?: StopGameSessionPlacementOutput) => void
  ): Promise<StopGameSessionPlacementOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public stopMatchmaking(
    args: StopMatchmakingInput
  ): Promise<StopMatchmakingOutput>;
  public stopMatchmaking(
    args: StopMatchmakingInput,
    cb: (err: any, data?: StopMatchmakingOutput) => void
  ): void;
  public stopMatchmaking(
    args: StopMatchmakingInput,
    cb?: (err: any, data?: StopMatchmakingOutput) => void
  ): Promise<StopMatchmakingOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public updateBuild(args: UpdateBuildInput): Promise<UpdateBuildOutput>;
  public updateBuild(
    args: UpdateBuildInput,
    cb: (err: any, data?: UpdateBuildOutput) => void
  ): void;
  public updateBuild(
    args: UpdateBuildInput,
    cb?: (err: any, data?: UpdateBuildOutput) => void
  ): Promise<UpdateBuildOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public updateFleetAttributes(
    args: UpdateFleetAttributesInput
  ): Promise<UpdateFleetAttributesOutput>;
  public updateFleetAttributes(
    args: UpdateFleetAttributesInput,
    cb: (err: any, data?: UpdateFleetAttributesOutput) => void
  ): void;
  public updateFleetAttributes(
    args: UpdateFleetAttributesInput,
    cb?: (err: any, data?: UpdateFleetAttributesOutput) => void
  ): Promise<UpdateFleetAttributesOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public updateFleetCapacity(
    args: UpdateFleetCapacityInput
  ): Promise<UpdateFleetCapacityOutput>;
  public updateFleetCapacity(
    args: UpdateFleetCapacityInput,
    cb: (err: any, data?: UpdateFleetCapacityOutput) => void
  ): void;
  public updateFleetCapacity(
    args: UpdateFleetCapacityInput,
    cb?: (err: any, data?: UpdateFleetCapacityOutput) => void
  ): Promise<UpdateFleetCapacityOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public updateFleetPortSettings(
    args: UpdateFleetPortSettingsInput
  ): Promise<UpdateFleetPortSettingsOutput>;
  public updateFleetPortSettings(
    args: UpdateFleetPortSettingsInput,
    cb: (err: any, data?: UpdateFleetPortSettingsOutput) => void
  ): void;
  public updateFleetPortSettings(
    args: UpdateFleetPortSettingsInput,
    cb?: (err: any, data?: UpdateFleetPortSettingsOutput) => void
  ): Promise<UpdateFleetPortSettingsOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public updateGameSession(
    args: UpdateGameSessionInput
  ): Promise<UpdateGameSessionOutput>;
  public updateGameSession(
    args: UpdateGameSessionInput,
    cb: (err: any, data?: UpdateGameSessionOutput) => void
  ): void;
  public updateGameSession(
    args: UpdateGameSessionInput,
    cb?: (err: any, data?: UpdateGameSessionOutput) => void
  ): Promise<UpdateGameSessionOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public updateGameSessionQueue(
    args: UpdateGameSessionQueueInput
  ): Promise<UpdateGameSessionQueueOutput>;
  public updateGameSessionQueue(
    args: UpdateGameSessionQueueInput,
    cb: (err: any, data?: UpdateGameSessionQueueOutput) => void
  ): void;
  public updateGameSessionQueue(
    args: UpdateGameSessionQueueInput,
    cb?: (err: any, data?: UpdateGameSessionQueueOutput) => void
  ): Promise<UpdateGameSessionQueueOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public updateMatchmakingConfiguration(
    args: UpdateMatchmakingConfigurationInput
  ): Promise<UpdateMatchmakingConfigurationOutput>;
  public updateMatchmakingConfiguration(
    args: UpdateMatchmakingConfigurationInput,
    cb: (err: any, data?: UpdateMatchmakingConfigurationOutput) => void
  ): void;
  public updateMatchmakingConfiguration(
    args: UpdateMatchmakingConfigurationInput,
    cb?: (err: any, data?: UpdateMatchmakingConfigurationOutput) => void
  ): Promise<UpdateMatchmakingConfigurationOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public updateRuntimeConfiguration(
    args: UpdateRuntimeConfigurationInput
  ): Promise<UpdateRuntimeConfigurationOutput>;
  public updateRuntimeConfiguration(
    args: UpdateRuntimeConfigurationInput,
    cb: (err: any, data?: UpdateRuntimeConfigurationOutput) => void
  ): void;
  public updateRuntimeConfiguration(
    args: UpdateRuntimeConfigurationInput,
    cb?: (err: any, data?: UpdateRuntimeConfigurationOutput) => void
  ): Promise<UpdateRuntimeConfigurationOutput> | void {
    // create the appropriate command and pass it to .send
   ...
   *   - {Error} An error originating from the SDK or customizations rather than the service
   */
  public updateScript(args: UpdateScriptInput): Promise<UpdateScriptOutput>;
  public updateScript(
    args: UpdateScriptInput,
    cb: (err: any, data?: UpdateScriptOutput) => void
  ): void;
  public updateScript(
    args: UpdateScriptInput,
    cb?: (err: any, data?: UpdateScriptOutput) => void
  ): Promise<UpdateScriptOutput> | void {
    // create the appropriate command and pass it to .send
  ...
  public validateMatchmakingRuleSet(
    args: ValidateMatchmakingRuleSetInput
  ): Promise<ValidateMatchmakingRuleSetOutput>;
  public validateMatchmakingRuleSet(
    args: ValidateMatchmakingRuleSetInput,
    cb: (err: any, data?: ValidateMatchmakingRuleSetOutput) => void
  ): void;
  public validateMatchmakingRuleSet(
    args: ValidateMatchmakingRuleSetInput,
    cb?: (err: any, data?: ValidateMatchmakingRuleSetOutput) => void
  ): Promise<ValidateMatchmakingRuleSetOutput> | void {
    // create the appropriate command and pass it to .send
