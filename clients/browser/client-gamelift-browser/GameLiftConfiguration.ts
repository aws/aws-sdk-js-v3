...
export interface GameLiftConfiguration {
  /**
...
export interface GameLiftResolvableConfiguration extends GameLiftConfiguration {
  /**
...
export interface GameLiftResolvedConfiguration
  extends GameLiftConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  GameLiftResolvableConfiguration,
