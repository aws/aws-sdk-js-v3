...
export interface RekognitionConfiguration {
  /**
...
export interface RekognitionResolvableConfiguration
  extends RekognitionConfiguration {
  /**
...
export interface RekognitionResolvedConfiguration
  extends RekognitionConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  RekognitionResolvableConfiguration,
