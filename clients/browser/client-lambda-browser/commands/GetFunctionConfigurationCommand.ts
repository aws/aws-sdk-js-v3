...
import { GetFunctionConfiguration } from "../model/operations/GetFunctionConfiguration";
...
export class GetFunctionConfigurationCommand
  implements
    __aws_sdk_types.Command<
      ...
      Blob
    > {
  readonly model = GetFunctionConfiguration;
  ...
  > {
    ...
    return stack.resolve(
      handler<GetFunctionConfigurationInput, GetFunctionConfigurationOutput>(
