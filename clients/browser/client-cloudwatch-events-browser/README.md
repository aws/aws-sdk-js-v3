...
} = require("@aws-sdk/client-cloudwatch-events-browser/CloudWatchEventsClient");
const {
  ActivateEventSourceCommand
} = require("@aws-sdk/client-cloudwatch-events-browser/commands/ActivateEventSourceCommand");
```

```javascript
//typescript
const { CloudWatchEventsClient } = import '@aws-sdk/client-cloudwatch-events-browser/CloudWatchEventsClient';
const { ActivateEventSourceCommand } = import '@aws-sdk/client-cloudwatch-events-browser/commands/ActivateEventSourceCommand';
```
...
```javascript
import * as AWS from "@aws-sdk/@aws-sdk/client-cloudwatch-events-browser/CloudWatchEvents";
