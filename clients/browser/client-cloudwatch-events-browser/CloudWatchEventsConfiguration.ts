...
export interface CloudWatchEventsConfiguration {
  /**
...
export interface CloudWatchEventsResolvableConfiguration
  extends CloudWatchEventsConfiguration {
  /**
...
export interface CloudWatchEventsResolvedConfiguration
  extends CloudWatchEventsConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  CloudWatchEventsResolvableConfiguration,
