...
export interface MediaTailorConfiguration {
  /**
...
export interface MediaTailorResolvableConfiguration
  extends MediaTailorConfiguration {
  /**
...
export interface MediaTailorResolvedConfiguration
  extends MediaTailorConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  MediaTailorResolvableConfiguration,
