...
```javascript
//typescript
const { KinesisAnalyticsClient } = import '@aws-sdk/client-kinesis-analytics-browser/KinesisAnalyticsClient';
const { AddApplicationCloudWatchLoggingOptionCommand } = import '@aws-sdk/client-kinesis-analytics-browser/commands/AddApplicationCloudWatchLoggingOptionCommand';
```
