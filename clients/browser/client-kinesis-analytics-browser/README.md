...
} = require("@aws-sdk/client-kinesis-analytics-browser");
```
...
import {
  KinesisAnalyticsClient,
  AddApplicationCloudWatchLoggingOptionCommand
} from "@aws-sdk/client-kinesis-analytics-browser";
```
...
```javascript
import * as AWS from "@aws-sdk/client-kinesis-analytics-browser";
