...
export interface DataPipelineConfiguration {
  /**
...
export interface DataPipelineResolvableConfiguration
  extends DataPipelineConfiguration {
  /**
...
export interface DataPipelineResolvedConfiguration
  extends DataPipelineConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  DataPipelineResolvableConfiguration,
