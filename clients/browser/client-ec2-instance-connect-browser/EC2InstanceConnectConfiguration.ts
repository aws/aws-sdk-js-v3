...
export interface EC2InstanceConnectConfiguration {
  /**
...
export interface EC2InstanceConnectResolvableConfiguration
  extends EC2InstanceConnectConfiguration {
  /**
...
export interface EC2InstanceConnectResolvedConfiguration
  extends EC2InstanceConnectConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  EC2InstanceConnectResolvableConfiguration,
...
> = {
  ...
  serializer: {
    defaultProvider: (configuration: {
      ...
      const promisified = configuration
        ...
        .then(
          endpoint =>
            new __aws_sdk_protocol_json_rpc.JsonRpcSerializer<Blob>(
              endpoint,
  ...
  signingName: {
    defaultValue: "ec2-instance-connect"
  },
  signer: {
    defaultProvider: (configuration: {
      credentials: __aws_sdk_types.Provider<__aws_sdk_types.Credentials>;
