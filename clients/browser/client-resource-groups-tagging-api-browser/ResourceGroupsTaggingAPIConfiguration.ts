...
export interface ResourceGroupsTaggingAPIConfiguration {
  /**
...
export interface ResourceGroupsTaggingAPIResolvableConfiguration
  extends ResourceGroupsTaggingAPIConfiguration {
  /**
...
export interface ResourceGroupsTaggingAPIResolvedConfiguration
  extends ResourceGroupsTaggingAPIConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  ResourceGroupsTaggingAPIResolvableConfiguration,
