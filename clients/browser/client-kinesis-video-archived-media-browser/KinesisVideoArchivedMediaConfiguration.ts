...
export interface KinesisVideoArchivedMediaConfiguration {
  /**
...
export interface KinesisVideoArchivedMediaResolvableConfiguration
  extends KinesisVideoArchivedMediaConfiguration {
  /**
...
export interface KinesisVideoArchivedMediaResolvedConfiguration
  extends KinesisVideoArchivedMediaConfiguration,
...
export const configurationProperties: __aws_sdk_types.ConfigurationDefinition<
  KinesisVideoArchivedMediaResolvableConfiguration,
