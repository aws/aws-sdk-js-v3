...
import {
  _RunInstancesMonitoringEnabled,
  _UnmarshalledRunInstancesMonitoringEnabled
} from "./_RunInstancesMonitoringEnabled";

/**
 * <p>Describes the launch specification for an instance.</p>
 */
export interface _LaunchSpecification {
  /**
...
export interface _UnmarshalledLaunchSpecification extends _LaunchSpecification {
  /**
   * <p>One or more security groups. When requesting instances in a VPC, you must specify the IDs of the security groups. When requesting instances in EC2-Classic, you can specify the names or the IDs of the security groups.</p>
   */
   ...
   * <p>Describes the monitoring of an instance.</p>
   */
  Monitoring?: _UnmarshalledRunInstancesMonitoringEnabled;
}
