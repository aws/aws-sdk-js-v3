...
export var ListItemsRequest$: StaticStructureSchema = [3, n0, _LIR,
  0,
  [_P, _MR, _NT],
  [[0, { [_hQ]: _P }], [1, { [_hQ]: _MR }], [0, { [_hQ]: _NT }]]
];
export var ListItemsResponse$: StaticStructureSchema = [3, n0, _LIRi,
  0,
  [_It, _NT],
  [() => ItemList, 0]
];
...
export var DeleteObject$: StaticOperationSchema = [9, n0, _DO,
  { [_h]: ["DELETE", "/{Path+}", 200] }, () => DeleteObjectRequest$, () => DeleteObjectResponse$
];
export var DescribeObject$: StaticOperationSchema = [9, n0, _DOe,
...
export var ListItems$: StaticOperationSchema = [9, n0, _LI,
