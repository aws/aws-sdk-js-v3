...
import {
  defaultMediaStoreDataHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type MediaStoreDataClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type MediaStoreDataClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<MediaStoreDataClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultMediaStoreDataHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: MediaStoreDataClientResolvedConfig) =>
