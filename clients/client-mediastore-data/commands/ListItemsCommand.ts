...
export type ListItemsCommandOutput = ListItemsResponse;

export class ListItemsCommand extends $Command<ListItemsCommandInput, ListItemsCommandOutput, MediaStoreDataClientResolvedConfig> {
