...
export type GetObjectCommandOutput = GetObjectResponse;

export class GetObjectCommand extends $Command<GetObjectCommandInput, GetObjectCommandOutput, MediaStoreDataClientResolvedConfig> {
