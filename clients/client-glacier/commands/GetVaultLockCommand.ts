...
import {
  deserializeAws_restJson1_1GetVaultLockCommand,
  serializeAws_restJson1_1GetVaultLockCommand,
...
export type GetVaultLockCommandOutput = GetVaultLockOutput;
...
export class GetVaultLockCommand extends $Command<GetVaultLockCommandInput, GetVaultLockCommandOutput, GlacierClientResolvedConfig> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1GetVaultLockCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1GetVaultLockCommand(output, context);
  }
