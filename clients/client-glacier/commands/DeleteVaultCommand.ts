...
import {
  deserializeAws_restJson1_1DeleteVaultCommand,
  serializeAws_restJson1_1DeleteVaultCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DeleteVaultCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DeleteVaultCommand(output, context);
  }
