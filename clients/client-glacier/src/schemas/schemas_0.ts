...
export var GetDataRetrievalPolicyOutput: StaticStructureSchema = [3, n0, _GDRPO, 0, [_P], [() => DataRetrievalPolicy]];
...
export var UploadListElement: StaticStructureSchema = [3, n0, _ULE, 0, [_MUI, _VARN, _AD, _PSIB, _CD], [0, 0, 0, 1, 0]];
