...
export var DeleteVectorBucketInput$: StaticStructureSchema = [3, n0, _DVBI,
  0,
  [_vBN, _vBA],
  [0, 0]
];
export var DeleteVectorBucketOutput$: StaticStructureSchema = [3, n0, _DVBO,
  0,
  [],
  []
];
export var DeleteVectorBucketPolicyInput$: StaticStructureSchema = [3, n0, _DVBPI,
  0,
  [_vBN, _vBA],
  [0, 0]
];
export var DeleteVectorBucketPolicyOutput$: StaticStructureSchema = [3, n0, _DVBPO,
  0,
  [],
  []
];
...
export var GetIndexInput$: StaticStructureSchema = [3, n0, _GII,
  0,
  [_vBN, _iN, _iA],
  [0, 0, 0]
];
...
export var GetVectorBucketPolicyOutput$: StaticStructureSchema = [3, n0, _GVBPO,
  0,
  [_p],
  [0]
];
...
var GetVectorsOutputList: StaticListSchema = [1, n0, _GVOL,
  0, () => GetOutputVector$
];
var ListIndexesOutputList: StaticListSchema = [1, n0, _LIOL,
  0, () => IndexSummary$
];
var ListVectorBucketsOutputList: StaticListSchema = [1, n0, _LVBOL,
  0, () => VectorBucketSummary$
];
var ListVectorsOutputList: StaticListSchema = [1, n0, _LVOL,
  0, () => ListOutputVector$
];
var NonFilterableMetadataKeys = 64 | 0;
var PutVectorsInputList: StaticListSchema = [1, n0, _PVIL,
  0, () => PutInputVector$
];
var QueryVectorsOutputList: StaticListSchema = [1, n0, _QVOL,
  0, () => QueryOutputVector$
];
var TagKeyList = 64 | 0;
...
var TagsMap = 128 | 0;
export var VectorData$: StaticUnionSchema = [4, n0, _VD,
  0,
  [_fl],
  [64 | 1]
];
...
export var CreateVectorBucket$: StaticOperationSchema = [9, n0, _CVB,
...
export var DeleteVectorBucket$: StaticOperationSchema = [9, n0, _DVB,
  { [_h]: ["POST", "/DeleteVectorBucket", 200] }, () => DeleteVectorBucketInput$, () => DeleteVectorBucketOutput$
];
export var DeleteVectorBucketPolicy$: StaticOperationSchema = [9, n0, _DVBP,
  { [_h]: ["POST", "/DeleteVectorBucketPolicy", 200] }, () => DeleteVectorBucketPolicyInput$, () => DeleteVectorBucketPolicyOutput$
];
export var DeleteVectors$: StaticOperationSchema = [9, n0, _DV,
...
export var GetVectorBucket$: StaticOperationSchema = [9, n0, _GVB,
  { [_h]: ["POST", "/GetVectorBucket", 200] }, () => GetVectorBucketInput$, () => GetVectorBucketOutput$
];
export var GetVectorBucketPolicy$: StaticOperationSchema = [9, n0, _GVBP,
  { [_h]: ["POST", "/GetVectorBucketPolicy", 200] }, () => GetVectorBucketPolicyInput$, () => GetVectorBucketPolicyOutput$
];
export var GetVectors$: StaticOperationSchema = [9, n0, _GV,
...
export var ListVectorBuckets$: StaticOperationSchema = [9, n0, _LVB,
...
export var PutVectors$: StaticOperationSchema = [9, n0, _PV,
  { [_h]: ["POST", "/PutVectors", 200] }, () => PutVectorsInput$, () => PutVectorsOutput$
];
export var QueryVectors$: StaticOperationSchema = [9, n0, _QV,
