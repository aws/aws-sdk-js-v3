...
export var AuroraDbClusterStorageConfiguration$: StaticStructureSchema = [3, n0, _ADCSC,
  0,
  [_sT],
  [0]
];
export var BlockStoragePerformanceConfiguration$: StaticStructureSchema = [3, n0, _BSPC,
  0,
  [_i, _t],
  [1, 1]
];
export var ComputeConfiguration$: StaticStructureSchema = [3, n0, _CC,
  0,
  [_vC, _mSIMB, _a, _p],
  [1, 1, 0, 0]
];
export var ComputeSavingsPlans$: StaticStructureSchema = [3, n0, _CSP,
  0,
  [_co, _cC],
  [() => ComputeSavingsPlansConfiguration$, () => SavingsPlansCostCalculation$]
];
export var ComputeSavingsPlansConfiguration$: StaticStructureSchema = [3, n0, _CSPC,
  0,
  [_aS, _te, _pO, _hC],
  [0, 0, 0, 0]
];
export var DbInstanceConfiguration$: StaticStructureSchema = [3, n0, _DIC,
  0,
  [_dIC],
  [0]
];
...
export var Ec2AutoScalingGroupConfiguration$: StaticStructureSchema = [3, n0, _EASGC,
  0,
  [_in, _mI, _ty, _aSl],
  [() => InstanceConfiguration$, () => MixedInstanceConfigurationList, 0, 0]
];
export var Ec2Instance$: StaticStructureSchema = [3, n0, _EI,
  0,
  [_co, _cC],
  [() => Ec2InstanceConfiguration$, () => ResourceCostCalculation$]
];
export var Ec2InstanceConfiguration$: StaticStructureSchema = [3, n0, _EIC,
  0,
  [_in],
  [() => InstanceConfiguration$]
];
export var Ec2InstanceSavingsPlans$: StaticStructureSchema = [3, n0, _EISP,
  0,
  [_co, _cC],
  [() => Ec2InstanceSavingsPlansConfiguration$, () => SavingsPlansCostCalculation$]
];
export var Ec2InstanceSavingsPlansConfiguration$: StaticStructureSchema = [3, n0, _EISPC,
  0,
  [_aS, _te, _pO, _hC, _iF, _sPR],
  [0, 0, 0, 0, 0, 0]
];
export var Ec2ReservedInstances$: StaticStructureSchema = [3, n0, _ERI,
  0,
  [_co, _cC],
...
export var EcsServiceConfiguration$: StaticStructureSchema = [3, n0, _ESC,
  0,
  [_com],
  [() => ComputeConfiguration$]
];
export var EfficiencyMetricsByGroup$: StaticStructureSchema = [3, n0, _EMBG,
  0,
  [_mBT, _g, _m],
...
export var ListEnrollmentStatusesRequest$: StaticStructureSchema = [3, n0, _LESR,
  0,
  [_iOI, _aI, _nT, _mR],
  [2, 0, 0, 1]
];
export var ListEnrollmentStatusesResponse$: StaticStructureSchema = [3, n0, _LESRi,
  0,
  [_it, _iMA, _nT],
...
export var MixedInstanceConfiguration$: StaticStructureSchema = [3, n0, _MIC,
  0,
  [_ty],
  [0]
];
...
export var NatGatewayConfiguration$: StaticStructureSchema = [3, n0, _NGC,
  0,
  [_aCC, _pIFS, _pIFD],
  [1, 1, 1]
];
export var OpenSearchReservedInstances$: StaticStructureSchema = [3, n0, _OSRI,
  0,
  [_co, _cC],
...
export var PreferredCommitment$: StaticStructureSchema = [3, n0, _PC,
  0,
  [_te, _pO],
  [0, 0]
];
export var RdsDbInstance$: StaticStructureSchema = [3, n0, _RDI,
  0,
  [_co, _cC],
  [() => RdsDbInstanceConfiguration$, () => ResourceCostCalculation$]
];
export var RdsDbInstanceConfiguration$: StaticStructureSchema = [3, n0, _RDIC,
  0,
  [_in],
  [() => DbInstanceConfiguration$]
];
export var RdsDbInstanceStorage$: StaticStructureSchema = [3, n0, _RDIS,
  0,
  [_co, _cC],
  [() => RdsDbInstanceStorageConfiguration$, () => ResourceCostCalculation$]
];
export var RdsDbInstanceStorageConfiguration$: StaticStructureSchema = [3, n0, _RDISC,
  0,
  [_sT, _aSIG, _i, _sTt],
  [0, 1, 1, 1]
];
export var RdsReservedInstances$: StaticStructureSchema = [3, n0, _RRI,
  0,
  [_co, _cC],
...
export var RedshiftReservedInstances$: StaticStructureSchema = [3, n0, _RRIe,
  0,
  [_co, _cC],
...
export var ReservedInstancesPricing$: StaticStructureSchema = [3, n0, _RIP,
  0,
  [_eODC, _mREC, _sP, _eMARC],
  [1, 1, 1, 1]
];
export var ResourceCostCalculation$: StaticStructureSchema = [3, n0, _RCC,
  0,
  [_u, _pr],
...
export var SageMakerSavingsPlansConfiguration$: StaticStructureSchema = [3, n0, _SMSPC,
  0,
  [_aS, _te, _pO, _hC],
  [0, 0, 0, 0]
];
export var SavingsPlansCostCalculation$: StaticStructureSchema = [3, n0, _SPCC,
  0,
  [_pr],
  [() => SavingsPlansPricing$]
];
export var SavingsPlansPricing$: StaticStructureSchema = [3, n0, _SPP,
  0,
...
export var SummaryMetricsResult$: StaticStructureSchema = [3, n0, _SMR,
  0,
  [_sP],
  [0]
];
...
var EfficiencyMetricsByGroupList: StaticListSchema = [1, n0, _EMBGL,
  0, () => EfficiencyMetricsByGroup$
];
var ImplementationEffortList = 64 | 0;
var MetricsByTimeList: StaticListSchema = [1, n0, _MBTL,
  0, () => MetricsByTime$
];
var MixedInstanceConfigurationList: StaticListSchema = [1, n0, _MICL,
...
var RecommendationSummariesList: StaticListSchema = [1, n0, _RSL,
...
var ValidationExceptionDetails: StaticListSchema = [1, n0, _VEDa,
...
export var ListEfficiencyMetrics$: StaticOperationSchema = [9, n0, _LEM,
  0, () => ListEfficiencyMetricsRequest$, () => ListEfficiencyMetricsResponse$
];
export var ListEnrollmentStatuses$: StaticOperationSchema = [9, n0, _LES,
...
export var ListRecommendationSummaries$: StaticOperationSchema = [9, n0, _LRS,
