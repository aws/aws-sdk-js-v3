...
import {
  defaultCostOptimizationHubHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type CostOptimizationHubClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  UserAgentInputConfig &
  RetryInputConfig &
  RegionInputConfig &
 ...
 * @public
 */
export type CostOptimizationHubClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<CostOptimizationHubClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultCostOptimizationHubHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: CostOptimizationHubClientResolvedConfig) =>
