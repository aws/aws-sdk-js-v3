...
import {
  type CostOptimizationHubClientResolvedConfig,
  CostOptimizationHubClientConfig,
 ...
 * @internal
 */
export const defaultCostOptimizationHubHttpAuthSchemeProvider: CostOptimizationHubHttpAuthSchemeProvider = (authParameters) => {
