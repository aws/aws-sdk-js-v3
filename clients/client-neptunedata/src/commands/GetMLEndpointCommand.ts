...
> {
  ...
  ): Handler<GetMLEndpointCommandInput, GetMLEndpointCommandOutput> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetMLEndpointCommandOutput> {
