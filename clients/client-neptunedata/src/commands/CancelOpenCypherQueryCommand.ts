...
> {
  ...
  ): Handler<CancelOpenCypherQueryCommandInput, CancelOpenCypherQueryCommandOutput> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<CancelOpenCypherQueryCommandOutput> {
