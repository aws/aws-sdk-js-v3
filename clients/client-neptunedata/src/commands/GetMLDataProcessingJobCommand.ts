...
> {
  ...
  ): Handler<GetMLDataProcessingJobCommandInput, GetMLDataProcessingJobCommandOutput> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetMLDataProcessingJobCommandOutput> {
