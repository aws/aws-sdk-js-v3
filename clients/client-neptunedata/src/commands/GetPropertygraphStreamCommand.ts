...
import { GetPropertygraphStream$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetPropertygraphStreamCommand extends command<GetPropertygraphStreamCommandInput, GetPropertygraphStreamCommandOutput>(
  _ep0,
  _mw0,
