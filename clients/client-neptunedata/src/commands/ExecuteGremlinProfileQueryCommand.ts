...
import { ExecuteGremlinProfileQuery$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ExecuteGremlinProfileQueryCommand extends command<ExecuteGremlinProfileQueryCommandInput, ExecuteGremlinProfileQueryCommandOutput>(
  _ep0,
  _mw0,
