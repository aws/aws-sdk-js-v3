...
import { CancelLoaderJob$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CancelLoaderJobCommand extends command<CancelLoaderJobCommandInput, CancelLoaderJobCommandOutput>(
  _ep0,
  _mw0,
  "CancelLoaderJob",
  CancelLoaderJob$
