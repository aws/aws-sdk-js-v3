...
> {
  ...
  ): Handler<ListOpenCypherQueriesCommandInput, ListOpenCypherQueriesCommandOutput> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<ListOpenCypherQueriesCommandOutput> {
