...
import { GetMLModelTransformJob$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetMLModelTransformJobCommand extends command<GetMLModelTransformJobCommandInput, GetMLModelTransformJobCommandOutput>(
  _ep0,
  _mw0,
