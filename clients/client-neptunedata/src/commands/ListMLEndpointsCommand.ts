...
import { ListMLEndpoints$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class ListMLEndpointsCommand extends command<ListMLEndpointsCommandInput, ListMLEndpointsCommandOutput>(
  _ep0,
  _mw0,
  "ListMLEndpoints",
  ListMLEndpoints$
