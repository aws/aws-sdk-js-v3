...
import { CancelMLDataProcessingJob$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class CancelMLDataProcessingJobCommand extends command<CancelMLDataProcessingJobCommandInput, CancelMLDataProcessingJobCommandOutput>(
  _ep0,
  _mw0,
