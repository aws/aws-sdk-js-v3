...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<NeptunedataClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultNeptunedataHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: NeptunedataClientResolvedConfig) =>
