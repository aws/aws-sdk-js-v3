...
import { type InterconnectClientResolvedConfig, InterconnectClientConfig } from "../InterconnectClient";
 ...
 * @internal
 */
export const defaultInterconnectHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: InterconnectHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<InterconnectClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultInterconnectHttpAuthSchemeProvider: InterconnectHttpAuthSchemeProvider = (authParameters) => {
