...
import {
  ...
  defaultInterconnectHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type InterconnectClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<InterconnectClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: InterconnectClientResolvedConfig) =>
