...
export declare namespace AccessPoint {
    function isa(o: any): o is AccessPoint;
}
/**
 * <p></p>
 */
...
export declare namespace CreateAccessPointRequest {
    function isa(o: any): o is CreateAccessPointRequest;
}
...
export declare namespace DeleteAccessPointPolicyRequest {
    function isa(o: any): o is DeleteAccessPointPolicyRequest;
}
...
export declare namespace DeleteAccessPointRequest {
    function isa(o: any): o is DeleteAccessPointRequest;
}
...
export declare namespace GetAccessPointPolicyRequest {
    function isa(o: any): o is GetAccessPointPolicyRequest;
}
...
export declare namespace GetAccessPointPolicyResult {
    function isa(o: any): o is GetAccessPointPolicyResult;
}
...
export declare namespace GetAccessPointPolicyStatusRequest {
    function isa(o: any): o is GetAccessPointPolicyStatusRequest;
}
...
export declare namespace GetAccessPointPolicyStatusResult {
    function isa(o: any): o is GetAccessPointPolicyStatusResult;
}
...
export declare namespace GetAccessPointRequest {
    function isa(o: any): o is GetAccessPointRequest;
}
...
export declare namespace GetAccessPointResult {
    function isa(o: any): o is GetAccessPointResult;
}
...
export declare namespace IdempotencyException {
    function isa(o: any): o is IdempotencyException;
}
/**
 * <p></p>
 */
...
export declare namespace JobDescriptor {
    function isa(o: any): o is JobDescriptor;
}
/**
...
export declare namespace JobFailure {
    function isa(o: any): o is JobFailure;
}
/**
...
export declare namespace JobListDescriptor {
    function isa(o: any): o is JobListDescriptor;
}
/**
...
export declare namespace JobManifest {
    function isa(o: any): o is JobManifest;
}
...
export declare namespace JobManifestLocation {
    function isa(o: any): o is JobManifestLocation;
}
/**
...
export declare namespace JobManifestSpec {
    function isa(o: any): o is JobManifestSpec;
}
/**
 * <p>The operation that you want this job to perform on each object listed in the manifest. For more information about the available operations, see
 *          <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/batch-ops-operations.html">Available Operations</a> in the <i>Amazon Simple Storage Service Developer Guide</i>.</p>
...
export declare namespace JobOperation {
    function isa(o: any): o is JobOperation;
}
/**
 * <p>Describes the total number of tasks that the specified job has executed, the number of tasks that succeeded, and the number of tasks that failed.</p>
 */
...
export declare namespace JobProgressSummary {
    function isa(o: any): o is JobProgressSummary;
}
/**
...
export declare namespace JobReport {
    function isa(o: any): o is JobReport;
}
...
export declare namespace JobStatusException {
    function isa(o: any): o is JobStatusException;
}
/**
...
export declare namespace LambdaInvokeOperation {
    function isa(o: any): o is LambdaInvokeOperation;
}
...
export declare namespace ListAccessPointsRequest {
    function isa(o: any): o is ListAccessPointsRequest;
}
...
export declare namespace ListAccessPointsResult {
    function isa(o: any): o is ListAccessPointsResult;
}
...
export declare namespace NoSuchPublicAccessBlockConfiguration {
    function isa(o: any): o is NoSuchPublicAccessBlockConfiguration;
}
/**
 * <p></p>
 */
...
export declare namespace PutAccessPointPolicyRequest {
    function isa(o: any): o is PutAccessPointPolicyRequest;
}
...
export declare namespace S3AccessControlList {
    function isa(o: any): o is S3AccessControlList;
}
/**
 * <p></p>
 */
...
export declare namespace S3AccessControlPolicy {
    function isa(o: any): o is S3AccessControlPolicy;
}
...
export declare namespace S3CopyObjectOperation {
    function isa(o: any): o is S3CopyObjectOperation;
}
...
export declare namespace S3Grant {
    function isa(o: any): o is S3Grant;
}
/**
 * <p></p>
 */
...
export declare namespace S3Grantee {
    function isa(o: any): o is S3Grantee;
}
...
export declare namespace S3InitiateRestoreObjectOperation {
    function isa(o: any): o is S3InitiateRestoreObjectOperation;
}
...
export declare namespace S3ObjectMetadata {
    function isa(o: any): o is S3ObjectMetadata;
}
/**
 * <p></p>
 */
...
export declare namespace S3ObjectOwner {
    function isa(o: any): o is S3ObjectOwner;
}
...
export declare namespace S3SetObjectAclOperation {
    function isa(o: any): o is S3SetObjectAclOperation;
}
/**
...
export declare namespace S3SetObjectTaggingOperation {
    function isa(o: any): o is S3SetObjectTaggingOperation;
}
...
export declare namespace UpdateJobPriorityResult {
    function isa(o: any): o is UpdateJobPriorityResult;
}
...
export declare namespace UpdateJobStatusRequest {
    function isa(o: any): o is UpdateJobStatusRequest;
}
...
export declare namespace UpdateJobStatusResult {
    function isa(o: any): o is UpdateJobStatusResult;
}
/**
