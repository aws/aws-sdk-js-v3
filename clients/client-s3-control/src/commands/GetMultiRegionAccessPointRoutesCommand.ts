 ...
 * @public
 */
export class GetMultiRegionAccessPointRoutesCommand extends command<GetMultiRegionAccessPointRoutesCommandInput, GetMultiRegionAccessPointRoutesCommandOutput>(
  _ep0,
  _mw0,
