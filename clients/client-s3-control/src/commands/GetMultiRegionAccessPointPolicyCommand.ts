 ...
 * @public
 */
export class GetMultiRegionAccessPointPolicyCommand extends command<GetMultiRegionAccessPointPolicyCommandInput, GetMultiRegionAccessPointPolicyCommandOutput>(
  _ep0,
  _mw0,
