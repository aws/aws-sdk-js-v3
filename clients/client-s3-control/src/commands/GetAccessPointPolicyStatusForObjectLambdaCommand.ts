 ...
 * @public
 */
export class GetAccessPointPolicyStatusForObjectLambdaCommand extends command<GetAccessPointPolicyStatusForObjectLambdaCommandInput, GetAccessPointPolicyStatusForObjectLambdaCommandOutput>(
  _ep0,
  _mw1,
