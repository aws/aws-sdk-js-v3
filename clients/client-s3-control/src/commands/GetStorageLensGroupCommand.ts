...
import type { GetStorageLensGroupRequest, GetStorageLensGroupResult } from "../models/models_0";
import { GetStorageLensGroup$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class GetStorageLensGroupCommand extends command<GetStorageLensGroupCommandInput, GetStorageLensGroupCommandOutput>(
  _ep0,
  _mw1,
  "GetStorageLensGroup",
  GetStorageLensGroup$
