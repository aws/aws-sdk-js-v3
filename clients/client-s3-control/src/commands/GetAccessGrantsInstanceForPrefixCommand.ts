 ...
 * @public
 */
export class GetAccessGrantsInstanceForPrefixCommand extends command<GetAccessGrantsInstanceForPrefixCommandInput, GetAccessGrantsInstanceForPrefixCommandOutput>(
  _ep0,
  _mw0,
