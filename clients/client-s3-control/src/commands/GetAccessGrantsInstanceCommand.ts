...
> {
   ...
   * @public
   */
  constructor(readonly input: GetAccessGrantsInstanceCommandInput) {
    super();
  }
  ...
  ): Handler<GetAccessGrantsInstanceCommandInput, GetAccessGrantsInstanceCommandOutput> {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(
      getEndpointPlugin(configuration, GetAccessGrantsInstanceCommand.getEndpointParameterInstructions())
    );
   ...
   * @internal
   */
  private serialize(input: GetAccessGrantsInstanceCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
   ...
   * @internal
   */
  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetAccessGrantsInstanceCommandOutput> {
