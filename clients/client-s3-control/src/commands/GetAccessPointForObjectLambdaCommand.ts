 ...
 * @public
 */
export class GetAccessPointForObjectLambdaCommand extends command<GetAccessPointForObjectLambdaCommandInput, GetAccessPointForObjectLambdaCommandOutput>(
  _ep0,
  _mw1,
