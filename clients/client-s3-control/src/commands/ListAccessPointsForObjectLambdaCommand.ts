 ...
 * @public
 */
export class ListAccessPointsForObjectLambdaCommand extends command<ListAccessPointsForObjectLambdaCommandInput, ListAccessPointsForObjectLambdaCommandOutput>(
  _ep0,
  _mw1,
