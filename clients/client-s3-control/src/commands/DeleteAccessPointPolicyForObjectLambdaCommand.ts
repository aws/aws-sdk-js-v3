 ...
 * @public
 */
export class DeleteAccessPointPolicyForObjectLambdaCommand extends command<DeleteAccessPointPolicyForObjectLambdaCommandInput, DeleteAccessPointPolicyForObjectLambdaCommandOutput>(
  _ep0,
  _mw1,
