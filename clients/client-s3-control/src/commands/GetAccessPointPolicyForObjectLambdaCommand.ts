 ...
 * ```
 *
 * @param GetAccessPointPolicyForObjectLambdaRequest - {@link GetAccessPointPolicyForObjectLambdaRequest}
 * @returns {@link GetAccessPointPolicyForObjectLambdaResult}
