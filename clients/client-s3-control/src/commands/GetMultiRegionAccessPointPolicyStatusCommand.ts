 ...
 * ```
 *
 * @param GetMultiRegionAccessPointPolicyStatusRequest - {@link GetMultiRegionAccessPointPolicyStatusRequest}
 * @returns {@link GetMultiRegionAccessPointPolicyStatusResult}
