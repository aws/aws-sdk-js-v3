 ...
 * @public
 */
export class DissociateAccessGrantsIdentityCenterCommand extends command<DissociateAccessGrantsIdentityCenterCommandInput, DissociateAccessGrantsIdentityCenterCommandOutput>(
  _ep0,
  _mw0,
