 ...
 * @public
 */
export class SubmitMultiRegionAccessPointRoutesCommand extends command<SubmitMultiRegionAccessPointRoutesCommandInput, SubmitMultiRegionAccessPointRoutesCommandOutput>(
  _ep0,
  _mw0,
