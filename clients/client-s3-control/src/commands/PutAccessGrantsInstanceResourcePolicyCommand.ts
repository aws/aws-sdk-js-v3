 ...
 * @public
 */
export class PutAccessGrantsInstanceResourcePolicyCommand extends command<PutAccessGrantsInstanceResourcePolicyCommandInput, PutAccessGrantsInstanceResourcePolicyCommandOutput>(
  _ep0,
  _mw0,
