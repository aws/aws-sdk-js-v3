...
P={[aH]:[{[aI]:true,[aJ]:"sigv4",[aK]:l,[aL]:m}]},
Q={},
...
Z={[aF]:y},
aa={[aH]:[{[aI]:true,[aJ]:"sigv4",[aK]:l,[aL]:"{accessPointArn#region}"}]},
...
al={[aH]:[{[aI]:true,[aJ]:"sigv4",[aK]:l,[aL]:"{bucketArn#region}"}]},
am={[aM]:[B],[aN]:["{outpostId}"]},
an={[aH]:[{[aI]:true,[aJ]:"sigv4",[aK]:"s3",[aL]:m}]},
