 ...
 * ```javascript
 * import { Route53GlobalResolverClient, UpdateFirewallRuleCommand } from "@aws-sdk/client-route53globalresolver"; // ES Modules import
 * // const { Route53GlobalResolverClient, UpdateFirewallRuleCommand } = require("@aws-sdk/client-route53globalresolver"); // CommonJS import
 ...
 * const input = { // UpdateFirewallRuleInput
 ...
 * @public
 */
export class UpdateFirewallRuleCommand extends command<UpdateFirewallRuleCommandInput, UpdateFirewallRuleCommandOutput>(
  _ep0,
  _mw0,
  "UpdateFirewallRule",
  UpdateFirewallRule$
