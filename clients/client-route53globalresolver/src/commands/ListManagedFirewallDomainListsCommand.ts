 ...
 * @public
 */
export class ListManagedFirewallDomainListsCommand extends command<ListManagedFirewallDomainListsCommandInput, ListManagedFirewallDomainListsCommandOutput>(
  _ep0,
  _mw0,
