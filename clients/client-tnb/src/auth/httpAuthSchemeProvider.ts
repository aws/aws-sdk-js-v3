...
import { type TnbClientResolvedConfig, TnbClientConfig } from "../TnbClient";
 ...
 * @internal
 */
export const defaultTnbHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: TnbHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultTnbHttpAuthSchemeProvider: TnbHttpAuthSchemeProvider = (authParameters) => {
