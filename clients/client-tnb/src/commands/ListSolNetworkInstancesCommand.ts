 ...
 *
 * @example List Sol Network Instantiate instances```javascript/* Optional.empty *\/some code here```
 *
 * @example List Sol Network Instances with nextToken and maxResults```javascript/* Optional.empty *\/some code here```
 *
 */
