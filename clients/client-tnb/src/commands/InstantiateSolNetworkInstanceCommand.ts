 ...
 * @public
 */
export class InstantiateSolNetworkInstanceCommand extends command<InstantiateSolNetworkInstanceCommandInput, InstantiateSolNetworkInstanceCommandOutput>(
  _ep0,
  _mw0,
