...
import {
  defaultSSMQuickSetupHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type SSMQuickSetupClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<SSMQuickSetupClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        ...
        identityProviderConfigProvider: async (config: SSMQuickSetupClientResolvedConfig) =>
