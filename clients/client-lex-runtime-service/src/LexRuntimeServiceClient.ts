...
import {
  ...
  defaultLexRuntimeServiceHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type LexRuntimeServiceClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type LexRuntimeServiceClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<LexRuntimeServiceClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultLexRuntimeServiceHttpAuthSchemeParametersProvider,
        identityProviderConfigProvider: async (config: LexRuntimeServiceClientResolvedConfig) =>
