...
import { type LexRuntimeServiceClientResolvedConfig, LexRuntimeServiceClientConfig } from "../LexRuntimeServiceClient";
 ...
 * @internal
 */
export const defaultLexRuntimeServiceHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: LexRuntimeServiceHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultLexRuntimeServiceHttpAuthSchemeProvider: LexRuntimeServiceHttpAuthSchemeProvider = (authParameters) => {
