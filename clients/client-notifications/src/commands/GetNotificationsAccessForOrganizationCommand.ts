 ...
 * @public
 */
export class GetNotificationsAccessForOrganizationCommand extends command<GetNotificationsAccessForOrganizationCommandInput, GetNotificationsAccessForOrganizationCommandOutput>(
  _ep0,
  _mw0,
