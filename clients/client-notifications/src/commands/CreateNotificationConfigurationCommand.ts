 ...
 * @public
 */
export class CreateNotificationConfigurationCommand extends command<CreateNotificationConfigurationCommandInput, CreateNotificationConfigurationCommandOutput>(
  _ep0,
  _mw0,
