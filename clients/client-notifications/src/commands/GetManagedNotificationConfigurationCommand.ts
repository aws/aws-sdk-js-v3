 ...
 * @public
 */
export class GetManagedNotificationConfigurationCommand extends command<GetManagedNotificationConfigurationCommandInput, GetManagedNotificationConfigurationCommandOutput>(
  _ep0,
  _mw0,
