 ...
 * @public
 */
export class ListManagedNotificationEventsCommand extends command<ListManagedNotificationEventsCommandInput, ListManagedNotificationEventsCommandOutput>(
  _ep0,
  _mw0,
