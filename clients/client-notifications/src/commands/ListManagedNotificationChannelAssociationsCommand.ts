 ...
 * @public
 */
export class ListManagedNotificationChannelAssociationsCommand extends command<ListManagedNotificationChannelAssociationsCommandInput, ListManagedNotificationChannelAssociationsCommandOutput>(
  _ep0,
  _mw0,
