...
import { type NotificationsClientResolvedConfig, NotificationsClientConfig } from "../NotificationsClient";
 ...
 * @internal
 */
export const defaultNotificationsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: NotificationsHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<NotificationsClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultNotificationsHttpAuthSchemeProvider: NotificationsHttpAuthSchemeProvider = (authParameters) => {
