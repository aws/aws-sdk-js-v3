...
export type DeleteContactCommandOutput = DeleteContactResponse;

export class DeleteContactCommand extends $Command<DeleteContactCommandInput, DeleteContactCommandOutput, AlexaForBusinessClientResolvedConfig> {
