...
export type GetGatewayCommandOutput = GetGatewayResponse;

export class GetGatewayCommand extends $Command<GetGatewayCommandInput, GetGatewayCommandOutput, AlexaForBusinessClientResolvedConfig> {
