...
export type GetDeviceCommandOutput = GetDeviceResponse;

export class GetDeviceCommand extends $Command<GetDeviceCommandInput, GetDeviceCommandOutput, AlexaForBusinessClientResolvedConfig> {
