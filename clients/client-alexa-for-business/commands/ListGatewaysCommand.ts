...
export type ListGatewaysCommandOutput = ListGatewaysResponse;

export class ListGatewaysCommand extends $Command<ListGatewaysCommandInput, ListGatewaysCommandOutput, AlexaForBusinessClientResolvedConfig> {
