...
export type DeleteConferenceProviderCommandOutput = DeleteConferenceProviderResponse;

export class DeleteConferenceProviderCommand extends $Command<DeleteConferenceProviderCommandInput, DeleteConferenceProviderCommandOutput, AlexaForBusinessClientResolvedConfig> {
