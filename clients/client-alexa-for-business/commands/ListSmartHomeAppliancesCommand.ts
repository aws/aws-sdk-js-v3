...
export type ListSmartHomeAppliancesCommandOutput = ListSmartHomeAppliancesResponse;

export class ListSmartHomeAppliancesCommand extends $Command<ListSmartHomeAppliancesCommandInput, ListSmartHomeAppliancesCommandOutput, AlexaForBusinessClientResolvedConfig> {
