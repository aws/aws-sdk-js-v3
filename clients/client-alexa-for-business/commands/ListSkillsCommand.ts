...
export type ListSkillsCommandOutput = ListSkillsResponse;

export class ListSkillsCommand extends $Command<ListSkillsCommandInput, ListSkillsCommandOutput, AlexaForBusinessClientResolvedConfig> {
