...
export type GetProfileCommandOutput = GetProfileResponse;

export class GetProfileCommand extends $Command<GetProfileCommandInput, GetProfileCommandOutput, AlexaForBusinessClientResolvedConfig> {
