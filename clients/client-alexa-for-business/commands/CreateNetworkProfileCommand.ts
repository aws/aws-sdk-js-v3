...
export type CreateNetworkProfileCommandOutput = CreateNetworkProfileResponse;

export class CreateNetworkProfileCommand extends $Command<CreateNetworkProfileCommandInput, CreateNetworkProfileCommandOutput, AlexaForBusinessClientResolvedConfig> {
