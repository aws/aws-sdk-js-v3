...
export type SearchProfilesCommandOutput = SearchProfilesResponse;

export class SearchProfilesCommand extends $Command<SearchProfilesCommandInput, SearchProfilesCommandOutput, AlexaForBusinessClientResolvedConfig> {
