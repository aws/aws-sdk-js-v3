...
export type GetContactCommandOutput = GetContactResponse;

export class GetContactCommand extends $Command<GetContactCommandInput, GetContactCommandOutput, AlexaForBusinessClientResolvedConfig> {
