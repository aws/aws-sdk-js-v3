...
export type ResolveRoomCommandOutput = ResolveRoomResponse;

export class ResolveRoomCommand extends $Command<ResolveRoomCommandInput, ResolveRoomCommandOutput, AlexaForBusinessClientResolvedConfig> {
