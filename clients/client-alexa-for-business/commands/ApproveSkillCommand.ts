...
export type ApproveSkillCommandOutput = ApproveSkillResponse;

export class ApproveSkillCommand extends $Command<ApproveSkillCommandInput, ApproveSkillCommandOutput, AlexaForBusinessClientResolvedConfig> {
