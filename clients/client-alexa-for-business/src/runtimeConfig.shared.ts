...
import { defaultAlexaForBusinessHttpAuthSchemeProvider } from "./auth/httpAuthSchemeProvider";
...
export const getRuntimeConfig = (config: AlexaForBusinessClientConfig) => {
  return {
    ...
    httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultAlexaForBusinessHttpAuthSchemeProvider,
