...
import {
  defaultAlexaForBusinessHttpAuthSchemeParametersProvider,
...
> {
  ...
  private getDefaultHttpAuthSchemeParametersProvider() {
    return defaultAlexaForBusinessHttpAuthSchemeParametersProvider;
  }
  private getIdentityProviderConfigProvider() {
    return async (config: AlexaForBusinessClientResolvedConfig) =>
