 ...
 * @public
 */
export class ListDataAutomationLibraryEntitiesCommand extends command<ListDataAutomationLibraryEntitiesCommandInput, ListDataAutomationLibraryEntitiesCommandOutput>(
  _ep0,
  _mw0,
