 ...
 * @public
 */
export class GetBlueprintOptimizationStatusCommand extends command<GetBlueprintOptimizationStatusCommandInput, GetBlueprintOptimizationStatusCommandOutput>(
  _ep0,
  _mw0,
