 ...
 * @public
 */
export class GetDataAutomationLibraryIngestionJobCommand extends command<GetDataAutomationLibraryIngestionJobCommandInput, GetDataAutomationLibraryIngestionJobCommandOutput>(
  _ep0,
  _mw0,
