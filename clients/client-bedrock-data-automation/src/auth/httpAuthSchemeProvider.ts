...
import {
  type BedrockDataAutomationClientResolvedConfig,
 ...
 * @internal
 */
export const defaultBedrockDataAutomationHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(
  ...
  return {
    ...
    propertiesExtractor: (config: Partial<BedrockDataAutomationClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
