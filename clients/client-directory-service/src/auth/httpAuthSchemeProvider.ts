...
import { type DirectoryServiceClientResolvedConfig, DirectoryServiceClientConfig } from "../DirectoryServiceClient";
 ...
 * @internal
 */
export const defaultDirectoryServiceHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: DirectoryServiceHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultDirectoryServiceHttpAuthSchemeProvider: DirectoryServiceHttpAuthSchemeProvider = (authParameters) => {
