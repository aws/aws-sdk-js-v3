...
import type { StartADAssessmentRequest, StartADAssessmentResult } from "../models/models_0";
 ...
 * @public
 */
export class StartADAssessmentCommand extends command<StartADAssessmentCommandInput, StartADAssessmentCommandOutput>(
  _ep0,
  _mw0,
  "StartADAssessment",
  StartADAssessment$
