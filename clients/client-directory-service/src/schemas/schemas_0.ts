...
export var ADAssessmentLimitExceededException$: StaticErrorSchema = [-3, n0, _ADALEE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
...
export var AssessmentValidation$: StaticStructureSchema = [3, n0, _AV,
  0,
...
export var AuthenticationFailedException$: StaticErrorSchema = [-3, n0, _AFE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
...
export var CertificateAlreadyExistsException$: StaticErrorSchema = [-3, n0, _CAEE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(CertificateAlreadyExistsException$, CertificateAlreadyExistsException);
export var CertificateDoesNotExistException$: StaticErrorSchema = [-3, n0, _CDNEE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(CertificateDoesNotExistException$, CertificateDoesNotExistException);
export var CertificateInfo$: StaticStructureSchema = [3, n0, _CIe,
  0,
  [_CI, _CN, _St, _EDT, _Ty],
  [0, 0, 0, 4, 0]
];
export var CertificateInUseException$: StaticErrorSchema = [-3, n0, _CIUE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(CertificateInUseException$, CertificateInUseException);
export var CertificateLimitExceededException$: StaticErrorSchema = [-3, n0, _CLEE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(CertificateLimitExceededException$, CertificateLimitExceededException);
export var ClientAuthenticationSettingInfo$: StaticStructureSchema = [3, n0, _CASI,
  0,
  [_Ty, _S, _LUDTa],
  [0, 0, 4]
];
export var ClientCertAuthSettings$: StaticStructureSchema = [3, n0, _CCAS,
  0,
  [_OCSPU],
  [0]
];
...
export var Computer$: StaticStructureSchema = [3, n0, _Co,
  0,
  [_CIo, _CNo, _CA],
  [0, 0, () => Attributes]
];
export var ConditionalForwarder$: StaticStructureSchema = [3, n0, _CF,
  0,
  [_RDN, _DIA, _DIAn, _RS],
  [0, 64 | 0, 64 | 0, 0]
];
...
export var DescribeDirectoriesRequest$: StaticStructureSchema = [3, n0, _DDRes,
  0,
  [_DIi, _NTe, _L],
  [64 | 0, 0, 1]
];
export var DescribeDirectoriesResult$: StaticStructureSchema = [3, n0, _DDResc,
  0,
  [_DD, _NTe],
...
export var DescribeEventTopicsRequest$: StaticStructureSchema = [3, n0, _DETRes,
  0,
  [_DI, _TNo],
  [0, 64 | 0]
];
export var DescribeEventTopicsResult$: StaticStructureSchema = [3, n0, _DETResc,
  0,
  [_ET],
  [() => EventTopics]
];
...
export var DescribeSnapshotsRequest$: StaticStructureSchema = [3, n0, _DSRescr,
  0,
  [_DI, _SIna, _NTe, _L],
  [0, 64 | 0, 0, 1]
];
export var DescribeSnapshotsResult$: StaticStructureSchema = [3, n0, _DSRescri,
  0,
  [_Sn, _NTe],
  [() => Snapshots, 0]
];
export var DescribeTrustsRequest$: StaticStructureSchema = [3, n0, _DTRes,
  0,
  [_DI, _TIr, _NTe, _L],
  [0, 64 | 0, 0, 1]
];
export var DescribeTrustsResult$: StaticStructureSchema = [3, n0, _DTResc,
  0,
  [_Tr, _NTe],
  [() => Trusts, 0]
];
...
export var DirectoryAlreadyInRegionException$: StaticErrorSchema = [-3, n0, _DAIRE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(DirectoryAlreadyInRegionException$, DirectoryAlreadyInRegionException);
export var DirectoryAlreadySharedException$: StaticErrorSchema = [-3, n0, _DASE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
...
export var DirectoryDescription$: StaticStructureSchema = [3, n0, _DDi,
  0,
...
export var DisableAlreadyInProgressException$: StaticErrorSchema = [-3, n0, _DAIPE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
...
export var DomainController$: StaticStructureSchema = [3, n0, _DCo,
  0,
  [_DI, _DCIom, _DIAns, _DIAnsp, _VI, _SIu, _AZv, _S, _SR, _LT, _SLUDTt],
  [0, 0, 0, 0, 0, 0, 0, 0, 0, 4, 4]
];
export var DomainControllerLimitExceededException$: StaticErrorSchema = [-3, n0, _DCLEE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(DomainControllerLimitExceededException$, DomainControllerLimitExceededException);
export var EnableAlreadyInProgressException$: StaticErrorSchema = [-3, n0, _EAIPE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
...
export var EntityDoesNotExistException$: StaticErrorSchema = [-3, n0, _EDNEE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(EntityDoesNotExistException$, EntityDoesNotExistException);
export var EventTopic$: StaticStructureSchema = [3, n0, _ETv,
  0,
  [_DI, _TN, _TA, _CDT, _S],
  [0, 0, 0, 4, 0]
];
export var GetDirectoryLimitsRequest$: StaticStructureSchema = [3, n0, _GDLR,
  0,
  [],
  []
];
export var GetDirectoryLimitsResult$: StaticStructureSchema = [3, n0, _GDLRe,
  0,
  [_DL],
  [() => DirectoryLimits$]
];
...
export var HybridUpdateActivities$: StaticStructureSchema = [3, n0, _HUA,
  0,
  [_SMI, _HAA],
  [() => HybridUpdateInfoEntries, () => HybridUpdateInfoEntries]
];
export var HybridUpdateInfoEntry$: StaticStructureSchema = [3, n0, _HUIE,
  0,
  [_S, _SR, _IB, _NV, _PV, _ST, _LUDTa, _AI],
  [0, 0, 0, () => HybridUpdateValue$, () => HybridUpdateValue$, 4, 4, 0]
];
export var HybridUpdateValue$: StaticStructureSchema = [3, n0, _HUV,
  0,
  [_II, _DIn],
  [64 | 0, 64 | 0]
];
export var IncompatibleSettingsException$: StaticErrorSchema = [-3, n0, _ISE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
...
export var InvalidClientAuthStatusException$: StaticErrorSchema = [-3, n0, _ICASE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(InvalidClientAuthStatusException$, InvalidClientAuthStatusException);
export var InvalidLDAPSStatusException$: StaticErrorSchema = [-3, n0, _ILDAPSSE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
...
export var InvalidParameterException$: StaticErrorSchema = [-3, n0, _IPEn,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(InvalidParameterException$, InvalidParameterException);
export var InvalidPasswordException$: StaticErrorSchema = [-3, n0, _IPEnv,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
...
export var IpRoute$: StaticStructureSchema = [3, n0, _IRp,
  0,
  [_CIi, _CIid, _D],
  [0, 0, 0]
];
export var IpRouteInfo$: StaticStructureSchema = [3, n0, _IRI,
  0,
  [_DI, _CIi, _CIid, _IRSM, _ADT, _IRSR, _D],
  [0, 0, 0, 0, 4, 0, 0]
];
export var IpRouteLimitExceededException$: StaticErrorSchema = [-3, n0, _IRLEE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(IpRouteLimitExceededException$, IpRouteLimitExceededException);
export var LDAPSSettingInfo$: StaticStructureSchema = [3, n0, _LDAPSSIe,
  0,
  [_LDAPSS, _LDAPSSR, _LUDTa],
  [0, 0, 4]
];
export var ListADAssessmentsRequest$: StaticStructureSchema = [3, n0, _LADAR,
  0,
  [_DI, _NTe, _L],
  [0, 0, 1]
];
export var ListADAssessmentsResult$: StaticStructureSchema = [3, n0, _LADARi,
  0,
  [_As, _NTe],
  [() => Assessments, 0]
];
...
export var ListLogSubscriptionsRequest$: StaticStructureSchema = [3, n0, _LLSR,
  0,
  [_DI, _NTe, _L],
  [0, 0, 1]
];
export var ListLogSubscriptionsResult$: StaticStructureSchema = [3, n0, _LLSRi,
  0,
  [_LS, _NTe],
  [() => LogSubscriptions, 0]
];
...
export var LogSubscription$: StaticStructureSchema = [3, n0, _LSo,
  0,
  [_DI, _LGN, _SCDT],
  [0, 0, 4]
];
export var NetworkUpdateSettings$: StaticStructureSchema = [3, n0, _NUS,
  0,
  [_NT, _CDIV],
  [0, 64 | 0]
];
export var NoAvailableCertificateException$: StaticErrorSchema = [-3, n0, _NACE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(NoAvailableCertificateException$, NoAvailableCertificateException);
export var OrganizationsException$: StaticErrorSchema = [-3, n0, _OE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(OrganizationsException$, OrganizationsException);
export var OSUpdateSettings$: StaticStructureSchema = [3, n0, _OSUS,
  0,
  [_OSV],
  [0]
];
export var OwnerDirectoryDescription$: StaticStructureSchema = [3, n0, _ODD,
  0,
  [_DI, _AIc, _DIA, _DIAn, _VS, _RSa, _RSad, _NT],
  [0, 0, 64 | 0, 64 | 0, () => DirectoryVpcSettingsDescription$, [() => RadiusSettings$, 0], 0, 0]
];
export var RadiusSettings$: StaticStructureSchema = [3, n0, _RSa,
  0,
  [_RSadi, _RSI, _RP, _RTa, _RR, _SSh, _AP, _DLi, _USU],
  [64 | 0, 64 | 0, 1, 1, 1, [() => RadiusSharedSecret, 0], 0, 0, 2]
];
export var RegionDescription$: StaticStructureSchema = [3, n0, _RDe,
  0,
  [_DI, _RN, _RTe, _S, _VS, _DNODC, _LT, _SLUDTt, _LUDTa],
  [0, 0, 0, 0, () => DirectoryVpcSettings$, 1, 4, 4, 4]
];
export var RegionLimitExceededException$: StaticErrorSchema = [-3, n0, _RLEE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(RegionLimitExceededException$, RegionLimitExceededException);
export var RegionsInfo$: StaticStructureSchema = [3, n0, _RIeg,
  0,
  [_PR, _ARd],
  [0, 64 | 0]
];
...
export var SchemaExtensionInfo$: StaticStructureSchema = [3, n0, _SEIch,
  0,
  [_DI, _SEI, _D, _SES, _SESR, _SDT, _EDTn],
  [0, 0, 0, 0, 0, 4, 4]
];
export var ServiceException$: StaticErrorSchema = [-3, n0, _SEe,
  { [_e]: _s },
  [_M, _RI],
  [0, 0]
];
...
export var SharedDirectory$: StaticStructureSchema = [3, n0, _SD,
  0,
...
export var ShareLimitExceededException$: StaticErrorSchema = [-3, n0, _SLEE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
...
export var SnapshotLimitExceededException$: StaticErrorSchema = [-3, n0, _SLEEn,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
TypeRegistry.for(n0).registerError(SnapshotLimitExceededException$, SnapshotLimitExceededException);
export var SnapshotLimits$: StaticStructureSchema = [3, n0, _SL,
  0,
  [_MSL, _MSCC, _MSLR],
  [1, 1, 2]
];
export var StartADAssessmentRequest$: StaticStructureSchema = [3, n0, _SADAR,
  0,
  [_AC, _DI],
  [() => AssessmentConfiguration$, 0]
];
export var StartADAssessmentResult$: StaticStructureSchema = [3, n0, _SADARt,
  0,
  [_AI],
  [0]
];
...
export var Trust$: StaticStructureSchema = [3, n0, _Tru,
  0,
...
export var UnsupportedSettingsException$: StaticErrorSchema = [-3, n0, _USE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
...
export var UpdateInfoEntry$: StaticStructureSchema = [3, n0, _UIE,
  0,
...
export var UpdateValue$: StaticStructureSchema = [3, n0, _UV,
  0,
  [_OSUS],
  [() => OSUpdateSettings$]
];
export var UserDoesNotExistException$: StaticErrorSchema = [-3, n0, _UDNEE,
  { [_e]: _c },
  [_M, _RI],
  [0, 0]
];
...
export var DirectoryServiceServiceException$: StaticErrorSchema = [-3, _sm, "DirectoryServiceServiceException", 0, [], []];
...
var AssessmentReports: StaticListSchema = [1, n0, _ARs,
  0, () => AssessmentReport$
];
var Assessments: StaticListSchema = [1, n0, _As,
  0, () => AssessmentSummary$
];
var AssessmentValidations: StaticListSchema = [1, n0, _AVs,
  0, () => AssessmentValidation$
];
var Attributes: StaticListSchema = [1, n0, _Att,
  0, () => Attribute$
];
var AvailabilityZones = 64 | 0;
var CertificatesInfo: StaticListSchema = [1, n0, _CIer,
  0, () => CertificateInfo$
];
var CidrIps = 64 | 0;
var CidrIpv6s = 64 | 0;
var ClientAuthenticationSettingsInfo: StaticListSchema = [1, n0, _CASIl,
  0, () => ClientAuthenticationSettingInfo$
];
var ConditionalForwarders: StaticListSchema = [1, n0, _CFo,
  0, () => ConditionalForwarder$
];
var CustomerDnsIps = 64 | 0;
var DirectoryDescriptions: StaticListSchema = [1, n0, _DD,
...
var DomainControllers: StaticListSchema = [1, n0, _DC,
  0, () => DomainController$
];
var EventTopics: StaticListSchema = [1, n0, _ET,
  0, () => EventTopic$
];
var HybridUpdateInfoEntries: StaticListSchema = [1, n0, _HUIEy,
  0, () => HybridUpdateInfoEntry$
];
var IpAddrs = 64 | 0;
var IpRoutes: StaticListSchema = [1, n0, _IR,
  0, () => IpRoute$
];
var IpRoutesInfo: StaticListSchema = [1, n0, _IRIp,
  0, () => IpRouteInfo$
];
var IpV6Addrs = 64 | 0;
var LDAPSSettingsInfo: StaticListSchema = [1, n0, _LDAPSSI,
  0, () => LDAPSSettingInfo$
];
var LogSubscriptions: StaticListSchema = [1, n0, _LS,
  0, () => LogSubscription$
];
var RegionsDescription: StaticListSchema = [1, n0, _RD,
  0, () => RegionDescription$
];
var RemoteDomainNames = 64 | 0;
var SchemaExtensionsInfo: StaticListSchema = [1, n0, _SEIc,
  0, () => SchemaExtensionInfo$
];
var SecurityGroupIds = 64 | 0;
var Servers = 64 | 0;
var SettingEntries: StaticListSchema = [1, n0, _SE,
  0, () => SettingEntry$
];
var Settings: StaticListSchema = [1, n0, _Set,
  0, () => Setting$
];
var SharedDirectories: StaticListSchema = [1, n0, _SDh,
  0, [() => SharedDirectory$,
    0]
];
var SnapshotIds = 64 | 0;
var Snapshots: StaticListSchema = [1, n0, _Sn,
  0, () => Snapshot$
];
var SubnetIds = 64 | 0;
var TagKeys = 64 | 0;
...
var TopicNames = 64 | 0;
var TrustIds = 64 | 0;
var Trusts: StaticListSchema = [1, n0, _Tr,
  0, () => Trust$
];
var UpdateActivities: StaticListSchema = [1, n0, _UA,
  0, () => UpdateInfoEntry$
];
var DirectoryConfigurationSettingRequestDetailedStatus = 128 | 0;
export var AcceptSharedDirectory$: StaticOperationSchema = [9, n0, _ASD,
  0, () => AcceptSharedDirectoryRequest$, () => AcceptSharedDirectoryResult$
];
export var AddIpRoutes$: StaticOperationSchema = [9, n0, _AIR,
  0, () => AddIpRoutesRequest$, () => AddIpRoutesResult$
];
export var AddRegion$: StaticOperationSchema = [9, n0, _ARdd,
...
export var CancelSchemaExtension$: StaticOperationSchema = [9, n0, _CSE,
  0, () => CancelSchemaExtensionRequest$, () => CancelSchemaExtensionResult$
];
export var ConnectDirectory$: StaticOperationSchema = [9, n0, _CDo,
  0, () => ConnectDirectoryRequest$, () => ConnectDirectoryResult$
];
export var CreateAlias$: StaticOperationSchema = [9, n0, _CAr,
  0, () => CreateAliasRequest$, () => CreateAliasResult$
];
export var CreateComputer$: StaticOperationSchema = [9, n0, _CC,
  0, () => CreateComputerRequest$, () => CreateComputerResult$
];
export var CreateConditionalForwarder$: StaticOperationSchema = [9, n0, _CCF,
  0, () => CreateConditionalForwarderRequest$, () => CreateConditionalForwarderResult$
];
export var CreateDirectory$: StaticOperationSchema = [9, n0, _CDr,
  0, () => CreateDirectoryRequest$, () => CreateDirectoryResult$
];
export var CreateHybridAD$: StaticOperationSchema = [9, n0, _CHAD,
  0, () => CreateHybridADRequest$, () => CreateHybridADResult$
];
export var CreateLogSubscription$: StaticOperationSchema = [9, n0, _CLS,
  0, () => CreateLogSubscriptionRequest$, () => CreateLogSubscriptionResult$
];
export var CreateMicrosoftAD$: StaticOperationSchema = [9, n0, _CMAD,
...
export var CreateTrust$: StaticOperationSchema = [9, n0, _CT,
  0, () => CreateTrustRequest$, () => CreateTrustResult$
];
export var DeleteADAssessment$: StaticOperationSchema = [9, n0, _DADA,
  0, () => DeleteADAssessmentRequest$, () => DeleteADAssessmentResult$
];
export var DeleteConditionalForwarder$: StaticOperationSchema = [9, n0, _DCF,
  0, () => DeleteConditionalForwarderRequest$, () => DeleteConditionalForwarderResult$
];
export var DeleteDirectory$: StaticOperationSchema = [9, n0, _DDe,
  0, () => DeleteDirectoryRequest$, () => DeleteDirectoryResult$
];
export var DeleteLogSubscription$: StaticOperationSchema = [9, n0, _DLS,
  0, () => DeleteLogSubscriptionRequest$, () => DeleteLogSubscriptionResult$
];
export var DeleteSnapshot$: StaticOperationSchema = [9, n0, _DSe,
  0, () => DeleteSnapshotRequest$, () => DeleteSnapshotResult$
];
export var DeleteTrust$: StaticOperationSchema = [9, n0, _DTe,
  0, () => DeleteTrustRequest$, () => DeleteTrustResult$
];
export var DeregisterCertificate$: StaticOperationSchema = [9, n0, _DCe,
  0, () => DeregisterCertificateRequest$, () => DeregisterCertificateResult$
];
export var DeregisterEventTopic$: StaticOperationSchema = [9, n0, _DET,
  0, () => DeregisterEventTopicRequest$, () => DeregisterEventTopicResult$
];
export var DescribeADAssessment$: StaticOperationSchema = [9, n0, _DADAe,
  0, () => DescribeADAssessmentRequest$, () => DescribeADAssessmentResult$
];
export var DescribeCAEnrollmentPolicy$: StaticOperationSchema = [9, n0, _DCAEP,
...
export var DescribeClientAuthenticationSettings$: StaticOperationSchema = [9, n0, _DCAS,
  0, () => DescribeClientAuthenticationSettingsRequest$, () => DescribeClientAuthenticationSettingsResult$
];
export var DescribeConditionalForwarders$: StaticOperationSchema = [9, n0, _DCFe,
  0, () => DescribeConditionalForwardersRequest$, () => DescribeConditionalForwardersResult$
];
export var DescribeDirectories$: StaticOperationSchema = [9, n0, _DDes,
  0, () => DescribeDirectoriesRequest$, () => DescribeDirectoriesResult$
];
export var DescribeDirectoryDataAccess$: StaticOperationSchema = [9, n0, _DDDA,
  0, () => DescribeDirectoryDataAccessRequest$, () => DescribeDirectoryDataAccessResult$
];
export var DescribeDomainControllers$: StaticOperationSchema = [9, n0, _DDC,
  0, () => DescribeDomainControllersRequest$, () => DescribeDomainControllersResult$
];
export var DescribeEventTopics$: StaticOperationSchema = [9, n0, _DETe,
  0, () => DescribeEventTopicsRequest$, () => DescribeEventTopicsResult$
];
export var DescribeHybridADUpdate$: StaticOperationSchema = [9, n0, _DHADU,
  0, () => DescribeHybridADUpdateRequest$, () => DescribeHybridADUpdateResult$
];
export var DescribeLDAPSSettings$: StaticOperationSchema = [9, n0, _DLDAPSS,
  0, () => DescribeLDAPSSettingsRequest$, () => DescribeLDAPSSettingsResult$
];
export var DescribeRegions$: StaticOperationSchema = [9, n0, _DR,
  0, () => DescribeRegionsRequest$, () => DescribeRegionsResult$
];
export var DescribeSettings$: StaticOperationSchema = [9, n0, _DSes,
  0, () => DescribeSettingsRequest$, () => DescribeSettingsResult$
];
export var DescribeSharedDirectories$: StaticOperationSchema = [9, n0, _DSD,
  0, () => DescribeSharedDirectoriesRequest$, () => DescribeSharedDirectoriesResult$
];
export var DescribeSnapshots$: StaticOperationSchema = [9, n0, _DSesc,
  0, () => DescribeSnapshotsRequest$, () => DescribeSnapshotsResult$
];
export var DescribeTrusts$: StaticOperationSchema = [9, n0, _DTes,
  0, () => DescribeTrustsRequest$, () => DescribeTrustsResult$
];
export var DescribeUpdateDirectory$: StaticOperationSchema = [9, n0, _DUD,
  0, () => DescribeUpdateDirectoryRequest$, () => DescribeUpdateDirectoryResult$
];
export var DisableCAEnrollmentPolicy$: StaticOperationSchema = [9, n0, _DCAEPi,
  0, () => DisableCAEnrollmentPolicyRequest$, () => DisableCAEnrollmentPolicyResult$
];
export var DisableClientAuthentication$: StaticOperationSchema = [9, n0, _DCA,
  0, () => DisableClientAuthenticationRequest$, () => DisableClientAuthenticationResult$
];
export var DisableDirectoryDataAccess$: StaticOperationSchema = [9, n0, _DDDAi,
  0, () => DisableDirectoryDataAccessRequest$, () => DisableDirectoryDataAccessResult$
];
export var DisableLDAPS$: StaticOperationSchema = [9, n0, _DLDAPS,
  0, () => DisableLDAPSRequest$, () => DisableLDAPSResult$
];
export var DisableRadius$: StaticOperationSchema = [9, n0, _DRi,
  0, () => DisableRadiusRequest$, () => DisableRadiusResult$
];
export var DisableSso$: StaticOperationSchema = [9, n0, _DSi,
  0, () => DisableSsoRequest$, () => DisableSsoResult$
];
export var EnableCAEnrollmentPolicy$: StaticOperationSchema = [9, n0, _ECAEP,
  0, () => EnableCAEnrollmentPolicyRequest$, () => EnableCAEnrollmentPolicyResult$
];
export var EnableClientAuthentication$: StaticOperationSchema = [9, n0, _ECA,
  0, () => EnableClientAuthenticationRequest$, () => EnableClientAuthenticationResult$
];
export var EnableDirectoryDataAccess$: StaticOperationSchema = [9, n0, _EDDA,
  0, () => EnableDirectoryDataAccessRequest$, () => EnableDirectoryDataAccessResult$
];
export var EnableLDAPS$: StaticOperationSchema = [9, n0, _ELDAPS,
  0, () => EnableLDAPSRequest$, () => EnableLDAPSResult$
];
export var EnableRadius$: StaticOperationSchema = [9, n0, _ER,
  0, () => EnableRadiusRequest$, () => EnableRadiusResult$
];
export var EnableSso$: StaticOperationSchema = [9, n0, _ES,
  0, () => EnableSsoRequest$, () => EnableSsoResult$
];
export var GetDirectoryLimits$: StaticOperationSchema = [9, n0, _GDL,
  0, () => GetDirectoryLimitsRequest$, () => GetDirectoryLimitsResult$
];
export var GetSnapshotLimits$: StaticOperationSchema = [9, n0, _GSL,
  0, () => GetSnapshotLimitsRequest$, () => GetSnapshotLimitsResult$
];
export var ListADAssessments$: StaticOperationSchema = [9, n0, _LADA,
  0, () => ListADAssessmentsRequest$, () => ListADAssessmentsResult$
];
export var ListCertificates$: StaticOperationSchema = [9, n0, _LCi,
  0, () => ListCertificatesRequest$, () => ListCertificatesResult$
];
export var ListIpRoutes$: StaticOperationSchema = [9, n0, _LIR,
  0, () => ListIpRoutesRequest$, () => ListIpRoutesResult$
];
export var ListLogSubscriptions$: StaticOperationSchema = [9, n0, _LLS,
  0, () => ListLogSubscriptionsRequest$, () => ListLogSubscriptionsResult$
];
export var ListSchemaExtensions$: StaticOperationSchema = [9, n0, _LSE,
...
export var RegisterCertificate$: StaticOperationSchema = [9, n0, _RC,
  0, () => RegisterCertificateRequest$, () => RegisterCertificateResult$
];
export var RegisterEventTopic$: StaticOperationSchema = [9, n0, _RET,
  0, () => RegisterEventTopicRequest$, () => RegisterEventTopicResult$
];
export var RejectSharedDirectory$: StaticOperationSchema = [9, n0, _RSD,
  0, () => RejectSharedDirectoryRequest$, () => RejectSharedDirectoryResult$
];
export var RemoveIpRoutes$: StaticOperationSchema = [9, n0, _RIR,
  0, () => RemoveIpRoutesRequest$, () => RemoveIpRoutesResult$
];
export var RemoveRegion$: StaticOperationSchema = [9, n0, _RRe,
...
export var ResetUserPassword$: StaticOperationSchema = [9, n0, _RUP,
  0, () => ResetUserPasswordRequest$, () => ResetUserPasswordResult$
];
export var RestoreFromSnapshot$: StaticOperationSchema = [9, n0, _RFS,
  0, () => RestoreFromSnapshotRequest$, () => RestoreFromSnapshotResult$
];
export var ShareDirectory$: StaticOperationSchema = [9, n0, _SDha,
  0, () => ShareDirectoryRequest$, () => ShareDirectoryResult$
];
export var StartADAssessment$: StaticOperationSchema = [9, n0, _SADA,
  0, () => StartADAssessmentRequest$, () => StartADAssessmentResult$
];
export var StartSchemaExtension$: StaticOperationSchema = [9, n0, _SSE,
  0, () => StartSchemaExtensionRequest$, () => StartSchemaExtensionResult$
];
export var UnshareDirectory$: StaticOperationSchema = [9, n0, _UD,
  0, () => UnshareDirectoryRequest$, () => UnshareDirectoryResult$
];
export var UpdateConditionalForwarder$: StaticOperationSchema = [9, n0, _UCF,
  0, () => UpdateConditionalForwarderRequest$, () => UpdateConditionalForwarderResult$
];
export var UpdateDirectorySetup$: StaticOperationSchema = [9, n0, _UDS,
  0, () => UpdateDirectorySetupRequest$, () => UpdateDirectorySetupResult$
];
export var UpdateHybridAD$: StaticOperationSchema = [9, n0, _UHAD,
  0, () => UpdateHybridADRequest$, () => UpdateHybridADResult$
];
export var UpdateNumberOfDomainControllers$: StaticOperationSchema = [9, n0, _UNODC,
  0, () => UpdateNumberOfDomainControllersRequest$, () => UpdateNumberOfDomainControllersResult$
];
export var UpdateRadius$: StaticOperationSchema = [9, n0, _UR,
  0, () => UpdateRadiusRequest$, () => UpdateRadiusResult$
];
export var UpdateSettings$: StaticOperationSchema = [9, n0, _US,
  0, () => UpdateSettingsRequest$, () => UpdateSettingsResult$
];
export var UpdateTrust$: StaticOperationSchema = [9, n0, _UTp,
  0, () => UpdateTrustRequest$, () => UpdateTrustResult$
];
export var VerifyTrust$: StaticOperationSchema = [9, n0, _VT,
