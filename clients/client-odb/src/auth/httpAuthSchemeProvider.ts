...
import { type OdbClientResolvedConfig, OdbClientConfig } from "../OdbClient";
 ...
 * @internal
 */
export const defaultOdbHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: OdbHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<OdbClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultOdbHttpAuthSchemeProvider: OdbHttpAuthSchemeProvider = (authParameters) => {
