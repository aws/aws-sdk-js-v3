 ...
 * @public
 */
export class FailoverAutonomousDatabaseCommand extends $Command
  .classBuilder<
  ...
  .s("Odb", "FailoverAutonomousDatabase", {})
  .n("OdbClient", "FailoverAutonomousDatabaseCommand")
  .sc(FailoverAutonomousDatabase$)
  .build() {
