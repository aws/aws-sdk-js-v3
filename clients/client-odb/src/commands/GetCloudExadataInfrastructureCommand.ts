 ...
 * @public
 *
 * The input for {@link GetCloudExadataInfrastructureCommand}.
 */
export interface GetCloudExadataInfrastructureCommandInput extends GetCloudExadataInfrastructureInput {}
/**
 * @public
 *
 ...
 * };
 * const command = new GetCloudExadataInfrastructureCommand(input);
 ...
 * ```
 *
 * @param GetCloudExadataInfrastructureCommandInput - {@link GetCloudExadataInfrastructureCommandInput}
 * @returns {@link GetCloudExadataInfrastructureCommandOutput}
 * @see {@link GetCloudExadataInfrastructureCommandInput} for command's `input` shape.
 * @see {@link GetCloudExadataInfrastructureCommandOutput} for command's `response` shape.
 ...
 * @public
 */
export class GetCloudExadataInfrastructureCommand extends command<GetCloudExadataInfrastructureCommandInput, GetCloudExadataInfrastructureCommandOutput>(
  _ep0,
  _mw0,
