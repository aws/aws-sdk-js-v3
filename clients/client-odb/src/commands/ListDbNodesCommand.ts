...
import type { ListDbNodesInput, ListDbNodesOutput } from "../models/models_0";
 ...
 * @public
 */
export class ListDbNodesCommand extends command<ListDbNodesCommandInput, ListDbNodesCommandOutput>(
  _ep0,
  _mw0,
  "ListDbNodes",
  ListDbNodes$
