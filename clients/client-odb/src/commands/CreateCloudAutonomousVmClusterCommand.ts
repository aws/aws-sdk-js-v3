 ...
 * @public
 */
export class CreateCloudAutonomousVmClusterCommand extends command<CreateCloudAutonomousVmClusterCommandInput, CreateCloudAutonomousVmClusterCommandOutput>(
  _ep0,
  _mw0,
