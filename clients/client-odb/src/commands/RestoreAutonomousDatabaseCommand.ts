 ...
 * @public
 */
export class RestoreAutonomousDatabaseCommand extends $Command
  .classBuilder<
  ...
  .s("Odb", "RestoreAutonomousDatabase", {})
  .n("OdbClient", "RestoreAutonomousDatabaseCommand")
  .sc(RestoreAutonomousDatabase$)
  .build() {
