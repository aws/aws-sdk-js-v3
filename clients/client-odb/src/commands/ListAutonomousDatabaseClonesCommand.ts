...
import type { ListAutonomousDatabaseClonesInput, ListAutonomousDatabaseClonesOutput } from "../models/models_0";
import type { OdbClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes } from "../OdbClient";
import { ListAutonomousDatabaseClones$ } from "../schemas/schemas_0";
 ...
 * @public
 *
 * The input for {@link ListAutonomousDatabaseClonesCommand}.
 */
export interface ListAutonomousDatabaseClonesCommandInput extends ListAutonomousDatabaseClonesInput {}
/**
 * @public
 *
 * The output of {@link ListAutonomousDatabaseClonesCommand}.
 */
export interface ListAutonomousDatabaseClonesCommandOutput extends ListAutonomousDatabaseClonesOutput, __MetadataBearer {}
 ...
 * ```javascript
 * import { OdbClient, ListAutonomousDatabaseClonesCommand } from "@aws-sdk/client-odb"; // ES Modules import
 * // const { OdbClient, ListAutonomousDatabaseClonesCommand } = require("@aws-sdk/client-odb"); // CommonJS import
 * // import type { OdbClientConfig } from "@aws-sdk/client-odb";
 * const config = {}; // type is OdbClientConfig
 * const client = new OdbClient(config);
 * const input = { // ListAutonomousDatabaseClonesInput
 *   maxResults: Number("int"),
 *   nextToken: "STRING_VALUE",
 *   autonomousDatabaseId: "STRING_VALUE", // required
 * };
 * const command = new ListAutonomousDatabaseClonesCommand(input);
 * const response = await client.send(command);
 * // { // ListAutonomousDatabaseClonesOutput
 * //   nextToken: "STRING_VALUE",
 * //   autonomousDatabaseClones: [ // AutonomousDatabaseList // required
 ...
 * ```
 *
 * @param ListAutonomousDatabaseClonesCommandInput - {@link ListAutonomousDatabaseClonesCommandInput}
 * @returns {@link ListAutonomousDatabaseClonesCommandOutput}
 * @see {@link ListAutonomousDatabaseClonesCommandInput} for command's `input` shape.
 * @see {@link ListAutonomousDatabaseClonesCommandOutput} for command's `response` shape.
 ...
 * @public
 */
export class ListAutonomousDatabaseClonesCommand extends $Command
  .classBuilder<
  ...
  .s("Odb", "ListAutonomousDatabaseClones", {})
  .n("OdbClient", "ListAutonomousDatabaseClonesCommand")
  .sc(ListAutonomousDatabaseClones$)
  .build() {
  ...
  protected declare static __types: {
    ...
    sdk: {
      ...
      output: ListAutonomousDatabaseClonesCommandOutput;
    };
  };
}
