...
import type { ListOdbNetworksInput, ListOdbNetworksOutput } from "../models/models_0";
 ...
 * @public
 */
export class ListOdbNetworksCommand extends command<ListOdbNetworksCommandInput, ListOdbNetworksCommandOutput>(
  _ep0,
  _mw0,
  "ListOdbNetworks",
  ListOdbNetworks$
