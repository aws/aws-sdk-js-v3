 ...
 * @public
 */
export class ListAutonomousDatabaseBackupsCommand extends command<ListAutonomousDatabaseBackupsCommandInput, ListAutonomousDatabaseBackupsCommandOutput>(
  _ep0,
  _mw0,
