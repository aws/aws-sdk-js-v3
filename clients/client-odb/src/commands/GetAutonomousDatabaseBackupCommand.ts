 ...
 * @public
 */
export class GetAutonomousDatabaseBackupCommand extends $Command
  .classBuilder<
  ...
  .s("Odb", "GetAutonomousDatabaseBackup", {})
  .n("OdbClient", "GetAutonomousDatabaseBackupCommand")
  .sc(GetAutonomousDatabaseBackup$)
  .build() {
