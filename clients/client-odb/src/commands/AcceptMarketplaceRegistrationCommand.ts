 ...
 * @public
 */
export class AcceptMarketplaceRegistrationCommand extends command<AcceptMarketplaceRegistrationCommandInput, AcceptMarketplaceRegistrationCommandOutput>(
  _ep0,
  _mw0,
