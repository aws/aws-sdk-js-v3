 ...
 * @public
 */
export class UpdateCloudExadataInfrastructureCommand extends command<UpdateCloudExadataInfrastructureCommandInput, UpdateCloudExadataInfrastructureCommandOutput>(
  _ep0,
  _mw0,
