...
import type { ListDbServersInput, ListDbServersOutput } from "../models/models_0";
 ...
 * @public
 */
export class ListDbServersCommand extends command<ListDbServersCommandInput, ListDbServersCommandOutput>(
  _ep0,
  _mw0,
  "ListDbServers",
  ListDbServers$
