 ...
 * @public
 */
export class ListCloudAutonomousVmClustersCommand extends command<ListCloudAutonomousVmClustersCommandInput, ListCloudAutonomousVmClustersCommandOutput>(
  _ep0,
  _mw0,
