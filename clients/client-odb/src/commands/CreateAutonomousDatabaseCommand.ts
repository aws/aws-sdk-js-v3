 ...
 * @public
 */
export class CreateAutonomousDatabaseCommand extends $Command
  .classBuilder<
  ...
  .s("Odb", "CreateAutonomousDatabase", {})
  .n("OdbClient", "CreateAutonomousDatabaseCommand")
  .sc(CreateAutonomousDatabase$)
  .build() {
