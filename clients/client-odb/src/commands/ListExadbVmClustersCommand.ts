...
import type { ListExadbVmClustersInput, ListExadbVmClustersOutput } from "../models/models_0";
import { ListExadbVmClusters$ } from "../schemas/schemas_0";
 ...
 * @public
 *
 * The input for {@link ListExadbVmClustersCommand}.
 */
export interface ListExadbVmClustersCommandInput extends ListExadbVmClustersInput {}
/**
 * @public
 *
 * The output of {@link ListExadbVmClustersCommand}.
 */
export interface ListExadbVmClustersCommandOutput extends ListExadbVmClustersOutput, __MetadataBearer {}
 ...
 * ```javascript
 * import { OdbClient, ListExadbVmClustersCommand } from "@aws-sdk/client-odb"; // ES Modules import
 * // const { OdbClient, ListExadbVmClustersCommand } = require("@aws-sdk/client-odb"); // CommonJS import
 * // import type { OdbClientConfig } from "@aws-sdk/client-odb";
 * const config = {}; // type is OdbClientConfig
 * const client = new OdbClient(config);
 * const input = { // ListExadbVmClustersInput
 *   exascaleDbStorageVaultId: "STRING_VALUE",
 *   maxResults: Number("int"),
 *   nextToken: "STRING_VALUE",
 * };
 * const command = new ListExadbVmClustersCommand(input);
 * const response = await client.send(command);
 * // { // ListExadbVmClustersOutput
 * //   nextToken: "STRING_VALUE",
 * //   exadbVmClusters: [ // ExadbVmClusterList // required
 ...
 * ```
 *
 * @param ListExadbVmClustersCommandInput - {@link ListExadbVmClustersCommandInput}
 * @returns {@link ListExadbVmClustersCommandOutput}
 * @see {@link ListExadbVmClustersCommandInput} for command's `input` shape.
 * @see {@link ListExadbVmClustersCommandOutput} for command's `response` shape.
 ...
 * @public
 */
export class ListExadbVmClustersCommand extends command<ListExadbVmClustersCommandInput, ListExadbVmClustersCommandOutput>(
  _ep0,
  _mw0,
  "ListExadbVmClusters",
  ListExadbVmClusters$
  ...
  protected declare static __types: {
    ...
    sdk: {
      ...
      output: ListExadbVmClustersCommandOutput;
    };
  };
}
