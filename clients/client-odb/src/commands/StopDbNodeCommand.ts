...
import type { StopDbNodeInput, StopDbNodeOutput } from "../models/models_0";
 ...
 * @public
 */
export class StopDbNodeCommand extends command<StopDbNodeCommandInput, StopDbNodeCommandOutput>(
  _ep0,
  _mw0,
  "StopDbNode",
  StopDbNode$
