...
import { ListSystemVersionsInput, ListSystemVersionsOutput } from "../models/models_0";
import { OdbClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes } from "../OdbClient";
import { de_ListSystemVersionsCommand, se_ListSystemVersionsCommand } from "../protocols/Aws_json1_0";
