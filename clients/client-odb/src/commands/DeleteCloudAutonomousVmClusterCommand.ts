 ...
 * @public
 */
export class DeleteCloudAutonomousVmClusterCommand extends command<DeleteCloudAutonomousVmClusterCommandInput, DeleteCloudAutonomousVmClusterCommandOutput>(
  _ep0,
  _mw0,
