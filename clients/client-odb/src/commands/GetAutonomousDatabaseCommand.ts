 ...
 * @public
 *
 * The input for {@link GetAutonomousDatabaseCommand}.
 */
export interface GetAutonomousDatabaseCommandInput extends GetAutonomousDatabaseInput {}
/**
 * @public
 *
 * The output of {@link GetAutonomousDatabaseCommand}.
 */
export interface GetAutonomousDatabaseCommandOutput extends GetAutonomousDatabaseOutput, __MetadataBearer {}
 ...
 * ```javascript
 * import { OdbClient, GetAutonomousDatabaseCommand } from "@aws-sdk/client-odb"; // ES Modules import
 * // const { OdbClient, GetAutonomousDatabaseCommand } = require("@aws-sdk/client-odb"); // CommonJS import
 * // import type { OdbClientConfig } from "@aws-sdk/client-odb";
 * const config = {}; // type is OdbClientConfig
 * const client = new OdbClient(config);
 * const input = { // GetAutonomousDatabaseInput
 *   autonomousDatabaseId: "STRING_VALUE", // required
 * };
 * const command = new GetAutonomousDatabaseCommand(input);
 ...
 * ```
 *
 * @param GetAutonomousDatabaseCommandInput - {@link GetAutonomousDatabaseCommandInput}
 * @returns {@link GetAutonomousDatabaseCommandOutput}
 * @see {@link GetAutonomousDatabaseCommandInput} for command's `input` shape.
 * @see {@link GetAutonomousDatabaseCommandOutput} for command's `response` shape.
...
export class GetAutonomousDatabaseCommand extends $Command
  ...
  protected declare static __types: {
    ...
    sdk: {
      input: GetAutonomousDatabaseCommandInput;
      output: GetAutonomousDatabaseCommandOutput;
    };
  };
}
