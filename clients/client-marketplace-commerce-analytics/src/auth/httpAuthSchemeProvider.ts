...
function createAwsAuthSigv4HttpAuthOption(authParameters: MarketplaceCommerceAnalyticsHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultMarketplaceCommerceAnalyticsHttpAuthSchemeProvider: MarketplaceCommerceAnalyticsHttpAuthSchemeProvider = (authParameters) => {
