...
import {
  ...
  defaultMarketplaceCommerceAnalyticsHttpAuthSchemeParametersProvider,
  resolveHttpAuthSchemeConfig,
} from "./auth/httpAuthSchemeProvider";
import type { GenerateDataSetCommandInput, GenerateDataSetCommandOutput } from "./commands/GenerateDataSetCommand";
import type {
 ...
 * @public
 */
export type MarketplaceCommerceAnalyticsClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type MarketplaceCommerceAnalyticsClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<MarketplaceCommerceAnalyticsClientConfig>) {
    ...
    this.middlewareStack.use(
      getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
        httpAuthSchemeParametersProvider: defaultMarketplaceCommerceAnalyticsHttpAuthSchemeParametersProvider,
