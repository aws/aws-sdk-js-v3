...
function createAwsAuthSigv4HttpAuthOption(authParameters: KinesisVideoArchivedMediaHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultKinesisVideoArchivedMediaHttpAuthSchemeProvider: KinesisVideoArchivedMediaHttpAuthSchemeProvider = (authParameters) => {
