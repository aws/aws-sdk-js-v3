...
export var GetMediaForFragmentListInput$: StaticStructureSchema = [
  3,
  n0,
  _GMFFLI,
  0,
...
export var InvalidCodecPrivateDataException$: StaticErrorSchema = [-3, n0, _ICPDE, { [_e]: _c, [_hE]: 400 }, [_M], [0]];
TypeRegistry.for(n0).registerError(InvalidCodecPrivateDataException$, InvalidCodecPrivateDataException);
export var InvalidMediaFrameException$: StaticErrorSchema = [-3, n0, _IMFE, { [_e]: _c, [_hE]: 400 }, [_M], [0]];
...
export var MissingCodecPrivateDataException$: StaticErrorSchema = [-3, n0, _MCPDE, { [_e]: _c, [_hE]: 400 }, [_M], [0]];
...
var FragmentList: StaticListSchema = [1, n0, _FL, 0, () => Fragment$];
var FragmentNumberList = 64 | 0;
var Images: StaticListSchema = [1, n0, _I, 0, () => Image$];
