...
export var DASHTimestampRange$: StaticStructureSchema = [3, n0, _DASHTR,
  0,
  [_ST, _ET],
  [4, 4]
];
export var Fragment$: StaticStructureSchema = [3, n0, _F,
  0,
...
export var GetDASHStreamingSessionURLInput$: StaticStructureSchema = [3, n0, _GDASHSSURLI,
  0,
  [_SN, _SARN, _PM, _DFT, _DFN, _DASHFS, _E, _MMFR],
  [0, 0, 0, 0, 0, () => DASHFragmentSelector$, 1, 1]
];
export var GetDASHStreamingSessionURLOutput$: StaticStructureSchema = [3, n0, _GDASHSSURLO,
  0,
  [_DASHSSURL],
  [0]
];
export var GetHLSStreamingSessionURLInput$: StaticStructureSchema = [3, n0, _GHLSSSURLI,
  0,
  [_SN, _SARN, _PM, _HLSFS, _CF, _DM, _DFT, _E, _MMPFR],
  [0, 0, 0, () => HLSFragmentSelector$, 0, 0, 0, 1, 1]
];
export var GetHLSStreamingSessionURLOutput$: StaticStructureSchema = [3, n0, _GHLSSSURLO,
  0,
  [_HLSSSURL],
  [0]
];
...
export var HLSFragmentSelector$: StaticStructureSchema = [3, n0, _HLSFS,
  0,
  [_FST, _TR],
  [0, () => HLSTimestampRange$]
];
export var HLSTimestampRange$: StaticStructureSchema = [3, n0, _HLSTR,
  0,
  [_ST, _ET],
  [4, 4]
];
...
export var ListFragmentsOutput$: StaticStructureSchema = [3, n0, _LFO,
  0,
  [_Fr, _NT],
  [() => FragmentList, 0]
];
