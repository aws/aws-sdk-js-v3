 ...
 * @public
 */
export class StartSessionsStatisticsAggregationCommand extends command<StartSessionsStatisticsAggregationCommandInput, StartSessionsStatisticsAggregationCommandOutput>(
  _ep0,
  _mw0,
