 ...
 * ```javascript
 * import { DeadlineClient, UntagResourceCommand } from "@aws-sdk/client-deadline"; // ES Modules import
 * // const { DeadlineClient, UntagResourceCommand } = require("@aws-sdk/client-deadline"); // CommonJS import
