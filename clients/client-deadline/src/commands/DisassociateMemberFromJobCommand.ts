...
import type { DisassociateMemberFromJobRequest, DisassociateMemberFromJobResponse } from "../models/models_0";
 ...
 * @public
 */
export class DisassociateMemberFromJobCommand extends command<DisassociateMemberFromJobCommandInput, DisassociateMemberFromJobCommandOutput>(
  _ep0,
  _mw0,
