...
import type { SearchStepsRequest, SearchStepsResponse } from "../models/models_1";
 ...
 * @public
 */
export class SearchStepsCommand extends command<SearchStepsCommandInput, SearchStepsCommandOutput>(
  _ep0,
  _mw0,
  "SearchSteps",
  SearchSteps$
