...
import type { GetSessionActionRequest, GetSessionActionResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetSessionActionCommand extends command<GetSessionActionCommandInput, GetSessionActionCommandOutput>(
  _ep0,
  _mw0,
  "GetSessionAction",
  GetSessionAction$
