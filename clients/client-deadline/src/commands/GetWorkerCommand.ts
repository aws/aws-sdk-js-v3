...
import type { GetWorkerRequest, GetWorkerResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetWorkerCommand extends command<GetWorkerCommandInput, GetWorkerCommandOutput>(
  _ep0,
  _mw0,
  "GetWorker",
  GetWorker$
