...
import type { GetLimitRequest, GetLimitResponse } from "../models/models_0";
 ...
 * @public
 */
export class GetLimitCommand extends command<GetLimitCommandInput, GetLimitCommandOutput>(
  _ep0,
  _mw0,
  "GetLimit",
  GetLimit$
