...
import type { UpdateWorkerRequest, UpdateWorkerResponse } from "../models/models_0";
 ...
 * @public
 */
export class UpdateWorkerCommand extends command<UpdateWorkerCommandInput, UpdateWorkerCommandOutput>(
  _ep0,
  _mw0,
  "UpdateWorker",
  UpdateWorker$
