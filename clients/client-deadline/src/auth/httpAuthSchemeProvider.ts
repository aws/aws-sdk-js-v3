...
import { type DeadlineClientResolvedConfig, DeadlineClientConfig } from "../DeadlineClient";
 ...
 * @internal
 */
export const defaultDeadlineHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: DeadlineHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultDeadlineHttpAuthSchemeProvider: DeadlineHttpAuthSchemeProvider = (authParameters) => {
