...
const AWS_TEMPLATE = "mediaconvert.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "mediaconvert.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "mediaconvert.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "mediaconvert.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "mediaconvert.{region}.amazonaws.com";
...
export const defaultRegionInfoProvider: RegionInfoProvider = (region: string, options?: any) => {
  ...
  switch (region) {
    ...
    case "eu-north-1":
      regionInfo = {
        hostname: "mediaconvert.eu-north-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "eu-west-1":
