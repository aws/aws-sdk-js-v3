...
import {
  deserializeAws_restJson1_1DescribeEndpointsCommand,
  serializeAws_restJson1_1DescribeEndpointsCommand
...
> {
  ...
  private serialize(
    ...
    return serializeAws_restJson1_1DescribeEndpointsCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_restJson1_1DescribeEndpointsCommand(output, context);
  }
