...
export declare namespace Attachment {
    function isa(o: any): o is Attachment;
}
/**
...
export declare namespace AttachmentStateChange {
    function isa(o: any): o is AttachmentStateChange;
}
/**
...
export interface Attribute {
    __type?: "Attribute";
    /**
     * <p>The name of the attribute. Up to 128 letters (uppercase and lowercase), numbers,
     *             hyphens, underscores, and periods are allowed.</p>
     */
...
export declare namespace Attribute {
    function isa(o: any): o is Attribute;
}
/**
...
export declare namespace AttributeLimitExceededException {
    function isa(o: any): o is AttributeLimitExceededException;
}
/**
...
export declare namespace AutoScalingGroupProvider {
    function isa(o: any): o is AutoScalingGroupProvider;
}
/**
...
export interface AwsVpcConfiguration {
    ...
    /**
     * <p>The security groups associated with the task or service. If you do not specify a
     *             security group, the default security group for the VPC is used. There is a limit of 5
     *             security groups that can be specified per <code>AwsVpcConfiguration</code>.</p>
     *
     *         <note>
     ...
     *             can be specified per <code>AwsVpcConfiguration</code>.</p>
     *
     *         <note>
...
export declare namespace AwsVpcConfiguration {
    function isa(o: any): o is AwsVpcConfiguration;
}
/**
...
export declare namespace BlockedException {
    function isa(o: any): o is BlockedException;
}
/**
...
export declare namespace CapacityProvider {
    function isa(o: any): o is CapacityProvider;
}
...
export declare namespace CapacityProviderStrategyItem {
    function isa(o: any): o is CapacityProviderStrategyItem;
}
/**
...
export declare namespace ClientException {
    function isa(o: any): o is ClientException;
}
/**
...
export declare namespace ClusterContainsContainerInstancesException {
    function isa(o: any): o is ClusterContainsContainerInstancesException;
}
/**
...
export declare namespace ClusterContainsServicesException {
    function isa(o: any): o is ClusterContainsServicesException;
}
/**
...
export declare namespace ClusterContainsTasksException {
    function isa(o: any): o is ClusterContainsTasksException;
}
...
export declare namespace ClusterNotFoundException {
    function isa(o: any): o is ClusterNotFoundException;
}
/**
...
export declare namespace ClusterSetting {
    function isa(o: any): o is ClusterSetting;
}
...
export declare namespace Container {
    function isa(o: any): o is Container;
}
...
export interface ContainerDefinition {
     ...
     *             <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--cpu-shares</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     ...
     *             described in the task definition.</p>
     */
    cpu?: number;
    /**
     ...
     *             <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--dns-search</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     *          <note>
     *                         <p>This parameter is not supported for Windows containers.</p>
     *                      </note>
     */
     ...
     *             <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--dns</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     *          <note>
     *                         <p>This parameter is not supported for Windows containers.</p>
     *                      </note>
     */
     ...
     *             <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--env</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     *         <important>
    ...
    /**
     * <p>The health check command and associated configuration parameters for the container.
     *             This parameter maps to <code>HealthCheck</code> in the
     *             <a href="https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate">Create a container</a> section of the <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the
     ...
     *             section of the <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--interactive</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     */
    interactive?: boolean;
    /**
     ...
     *             <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--memory</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     ...
     *             the <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--memory-reservation</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     ...
     *             section of the <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--volume</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     ...
     *             <a href="https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate">Create a container</a> section of the <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the
     *                 <code>--name</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker
     *             run</a>. </p>
     */
    name?: string;
    /**
     ...
     *             <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--privileged</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     *          <note>
     ...
     *             <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--tty</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     */
     ...
     *         <p>For tasks using the EC2 launch type, the container instances require at
     *             least version 1.26.0 of the container agent to enable a container start timeout value.
     *             However, we recommend using the latest container agent version. For information about
     *             checking your agent version and updating to the latest version, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-agent-update.html">Updating the Amazon ECS Container Agent</a> in the
     *                 <i>Amazon Elastic Container Service Developer Guide</i>. If you are using an Amazon ECS-optimized Linux AMI, your
     ...
     *         <p>For tasks using the Fargate launch type, the max
     *                 <code>stopTimeout</code> value is 2 minutes and the task or service requires
     *             platform version <code>1.3.0</code> or later.</p>
     *         <p>For tasks using the EC2 launch type, the stop timeout value for the
     *             container takes precedence over the <code>ECS_CONTAINER_STOP_TIMEOUT</code> container
     *             agent configuration parameter, if used. Container instances require at least version
     ...
     *             agent version and updating to the latest version, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-agent-update.html">Updating the Amazon ECS
     *                 Container Agent</a> in the <i>Amazon Elastic Container Service Developer Guide</i>. If you are
     *             using an Amazon ECS-optimized Linux AMI, your instance needs at least version 1.26.0-1 of the
     *                 <code>ecs-init</code> package. If your container instances are launched from version
     *                 <code>20190301</code> or later, then they contain the required versions of the
     ...
     *             <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--sysctl</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     *         <note>
     ...
     *                 <code>Ulimits</code> in the <a href="https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate">Create a container</a> section of the
     *             <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--ulimit</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>. Valid naming values are displayed
     ...
     *             run</a>.</p>
     *         <p>You can use the following formats. If specifying a UID or GID, you must specify it as
     ...
     *             <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--workdir</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     */
    workingDirectory?: string;
}
export declare namespace ContainerDefinition {
    function isa(o: any): o is ContainerDefinition;
}
/**
 * <p>The dependencies defined for container startup and shutdown. A container can contain
 *             multiple dependencies. When a dependency is defined for container startup, for container
...
export declare namespace ContainerDependency {
    function isa(o: any): o is ContainerDependency;
}
/**
...
export declare namespace ContainerInstance {
    function isa(o: any): o is ContainerInstance;
}
...
export declare namespace ContainerOverride {
    function isa(o: any): o is ContainerOverride;
}
/**
...
export declare namespace ContainerStateChange {
    function isa(o: any): o is ContainerStateChange;
}
...
export declare namespace CreateCapacityProviderRequest {
    function isa(o: any): o is CreateCapacityProviderRequest;
}
...
export declare namespace CreateCapacityProviderResponse {
    function isa(o: any): o is CreateCapacityProviderResponse;
}
export interface CreateClusterRequest {
    __type?: "CreateClusterRequest";
    /**
     * <p>The short name or full Amazon Resource Name (ARN) of one or more capacity providers to associate with
     *             the cluster.</p>
...
export interface CreateServiceRequest {
     ...
     *             instance is registered with the load balancer specified here.</p>
     ...
     *                     constraints that you specify in your cluster. When you're using this strategy,
     *                     you don't need to specify a desired number of tasks, a task placement strategy,
     *                     or use Service Auto Scaling policies.</p>
     *                 <note>
     ...
     *         <p>A task definition must be specified if the service is using the <code>ECS</code>
     *             deployment controller.</p>
     */
    taskDefinition?: string;
}
export declare namespace CreateServiceRequest {
    function isa(o: any): o is CreateServiceRequest;
}
...
export declare namespace CreateServiceResponse {
    function isa(o: any): o is CreateServiceResponse;
}
...
export declare namespace CreateTaskSetRequest {
    function isa(o: any): o is CreateTaskSetRequest;
}
...
export declare namespace CreateTaskSetResponse {
    function isa(o: any): o is CreateTaskSetResponse;
}
...
export declare namespace DeleteAccountSettingRequest {
    function isa(o: any): o is DeleteAccountSettingRequest;
}
...
export declare namespace DeleteAccountSettingResponse {
    function isa(o: any): o is DeleteAccountSettingResponse;
}
...
export declare namespace DeleteAttributesRequest {
    function isa(o: any): o is DeleteAttributesRequest;
}
...
export declare namespace DeleteAttributesResponse {
    function isa(o: any): o is DeleteAttributesResponse;
}
...
export declare namespace DeleteServiceRequest {
    function isa(o: any): o is DeleteServiceRequest;
}
...
export declare namespace DeleteServiceResponse {
    function isa(o: any): o is DeleteServiceResponse;
}
...
export declare namespace DeleteTaskSetRequest {
    function isa(o: any): o is DeleteTaskSetRequest;
}
...
export declare namespace DeleteTaskSetResponse {
    function isa(o: any): o is DeleteTaskSetResponse;
}
/**
...
export declare namespace DeploymentConfiguration {
    function isa(o: any): o is DeploymentConfiguration;
}
/**
...
export declare namespace DeploymentController {
    function isa(o: any): o is DeploymentController;
}
...
export declare namespace DeregisterContainerInstanceRequest {
    function isa(o: any): o is DeregisterContainerInstanceRequest;
}
...
export declare namespace DeregisterContainerInstanceResponse {
    function isa(o: any): o is DeregisterContainerInstanceResponse;
}
...
export declare namespace DeregisterTaskDefinitionRequest {
    function isa(o: any): o is DeregisterTaskDefinitionRequest;
}
...
export declare namespace DeregisterTaskDefinitionResponse {
    function isa(o: any): o is DeregisterTaskDefinitionResponse;
}
...
export declare namespace DescribeCapacityProvidersRequest {
    function isa(o: any): o is DescribeCapacityProvidersRequest;
}
...
export declare namespace DescribeCapacityProvidersResponse {
    function isa(o: any): o is DescribeCapacityProvidersResponse;
}
...
export declare namespace DescribeContainerInstancesRequest {
    function isa(o: any): o is DescribeContainerInstancesRequest;
}
...
export declare namespace DescribeContainerInstancesResponse {
    function isa(o: any): o is DescribeContainerInstancesResponse;
}
...
export declare namespace DescribeServicesRequest {
    function isa(o: any): o is DescribeServicesRequest;
}
...
export declare namespace DescribeServicesResponse {
    function isa(o: any): o is DescribeServicesResponse;
}
...
export declare namespace DescribeTaskDefinitionRequest {
    function isa(o: any): o is DescribeTaskDefinitionRequest;
}
...
export declare namespace DescribeTaskDefinitionResponse {
    function isa(o: any): o is DescribeTaskDefinitionResponse;
}
...
export declare namespace DescribeTaskSetsRequest {
    function isa(o: any): o is DescribeTaskSetsRequest;
}
...
export declare namespace DescribeTaskSetsResponse {
    function isa(o: any): o is DescribeTaskSetsResponse;
}
...
export declare namespace DescribeTasksRequest {
    function isa(o: any): o is DescribeTasksRequest;
}
...
export declare namespace DescribeTasksResponse {
    function isa(o: any): o is DescribeTasksResponse;
}
...
export declare namespace DiscoverPollEndpointRequest {
    function isa(o: any): o is DiscoverPollEndpointRequest;
}
...
export declare namespace DiscoverPollEndpointResponse {
    function isa(o: any): o is DiscoverPollEndpointResponse;
}
/**
...
export declare namespace DockerVolumeConfiguration {
    function isa(o: any): o is DockerVolumeConfiguration;
}
/**
 * <p>This parameter is specified when you are using an Amazon Elastic File System (Amazon
 ...
 *                 defined by and subject to the Beta Service Participation Service Terms located at
 *                     <a href="https://aws.amazon.com/service-terms">https://aws.amazon.com/service-terms</a> ("Beta Terms"). These Beta Terms
 *                 apply to your participation in this preview of
 *                 <code>EFSVolumeConfiguration</code>.</p>
 *         </important>
 */
export interface EFSVolumeConfiguration {
    ...
    /**
     * <p>The directory within the Amazon EFS file system to mount as the root directory inside
     *             the host.</p>
     */
    rootDirectory?: string;
}
export declare namespace EFSVolumeConfiguration {
    function isa(o: any): o is EFSVolumeConfiguration;
}
/**
...
export declare namespace Failure {
    function isa(o: any): o is Failure;
}
/**
 * <p>The FireLens configuration for the container. This is used to specify and configure a
 *             log router for container logs. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_firelens.html">Custom Log Routing</a>
...
export declare namespace FirelensConfiguration {
    function isa(o: any): o is FirelensConfiguration;
}
...
export declare namespace HealthCheck {
    function isa(o: any): o is HealthCheck;
}
...
export declare namespace HostEntry {
    function isa(o: any): o is HostEntry;
}
/**
...
export declare namespace HostVolumeProperties {
    function isa(o: any): o is HostVolumeProperties;
}
/**
...
export declare namespace InferenceAccelerator {
    function isa(o: any): o is InferenceAccelerator;
}
/**
...
export declare namespace InferenceAcceleratorOverride {
    function isa(o: any): o is InferenceAcceleratorOverride;
}
/**
...
export interface KernelCapabilities {
     ...
     *                     <code>add</code> parameter is not supported.</p>
     *         </note>
...
export declare namespace KernelCapabilities {
    function isa(o: any): o is KernelCapabilities;
}
/**
...
export declare namespace KeyValuePair {
    function isa(o: any): o is KeyValuePair;
}
...
export interface LinuxParameters {
     ...
     *         <note>
     *             <p>If you are using tasks that use the Fargate launch type,
     *                     <code>capabilities</code> is supported but the <code>add</code> parameter is not
     *                 supported.</p>
     *         </note>
     */
     ...
     *             <a href="https://docs.docker.com/engine/api/v1.35/">Docker Remote API</a> and the <code>--device</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     *         <note>
     *             <p>If you are using tasks that use the Fargate launch type, the
     ...
     *             translated to the <code>--memory-swap</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a> where the value would be the sum of
     ...
     *             parameter maps to the <code>--tmpfs</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker run</a>.</p>
     *         <note>
     *             <p>If you are using tasks that use the Fargate launch type, the
...
export declare namespace LinuxParameters {
    function isa(o: any): o is LinuxParameters;
}
...
export declare namespace ListAccountSettingsRequest {
    function isa(o: any): o is ListAccountSettingsRequest;
}
...
export declare namespace ListAccountSettingsResponse {
    function isa(o: any): o is ListAccountSettingsResponse;
}
...
export declare namespace ListAttributesRequest {
    function isa(o: any): o is ListAttributesRequest;
}
...
export declare namespace ListAttributesResponse {
    function isa(o: any): o is ListAttributesResponse;
}
...
export declare namespace ListClustersRequest {
    function isa(o: any): o is ListClustersRequest;
}
...
export declare namespace ListClustersResponse {
    function isa(o: any): o is ListClustersResponse;
}
...
export declare namespace ListContainerInstancesRequest {
    function isa(o: any): o is ListContainerInstancesRequest;
}
...
export declare namespace ListContainerInstancesResponse {
    function isa(o: any): o is ListContainerInstancesResponse;
}
...
export declare namespace ListTaskDefinitionFamiliesRequest {
    function isa(o: any): o is ListTaskDefinitionFamiliesRequest;
}
...
export declare namespace ListTaskDefinitionFamiliesResponse {
    function isa(o: any): o is ListTaskDefinitionFamiliesResponse;
}
...
export declare namespace ListTaskDefinitionsRequest {
    function isa(o: any): o is ListTaskDefinitionsRequest;
}
...
export declare namespace ListTaskDefinitionsResponse {
    function isa(o: any): o is ListTaskDefinitionsResponse;
}
...
export declare namespace ListTasksRequest {
    function isa(o: any): o is ListTasksRequest;
}
...
export declare namespace ListTasksResponse {
    function isa(o: any): o is ListTasksResponse;
}
/**
 * <p>Details on the load balancer or load balancers to use with a service or task
 *             set.</p>
 */
export interface LoadBalancer {
     ...
     *             or a Network Load Balancer this should be omitted.</p>
     */
     ...
     *             Classic Load Balancer this should be omitted.</p>
 ...
 *                <code>docker
 *                     run</code>
 *             </a>. By default, containers use the same logging driver that the
 ...
 *             drivers, see <a href="https://docs.docker.com/engine/admin/logging/overview/">Configure logging drivers</a> in the Docker documentation.</p>
 ...
 *             </li>
 *             <li>
 *                 <p>For tasks using the EC2 launch type, the Amazon ECS container agent
 ...
 *                     configuration options. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-agent-config.html">Amazon ECS Container Agent Configuration</a> in the
 *                         <i>Amazon Elastic Container Service Developer Guide</i>.</p>
 *             </li>
 *             <li>
 *                 <p>For tasks using the Fargate launch type, because you do not have
...
export interface LogConfiguration {
    ...
    /**
     * <p>The log driver to use for the container. The valid values listed earlier are log
     *             drivers that the Amazon ECS container agent can communicate with by default.</p>
     *         <p>For tasks using the Fargate launch type, the supported log drivers are
     *                 <code>awslogs</code>, <code>splunk</code>, and <code>awsfirelens</code>.</p>
     *         <p>For tasks using the EC2 launch type, the supported log drivers are
...
export declare namespace LogConfiguration {
    function isa(o: any): o is LogConfiguration;
}
...
export declare namespace ManagedScaling {
    function isa(o: any): o is ManagedScaling;
}
...
export declare namespace MissingVersionException {
    function isa(o: any): o is MissingVersionException;
}
/**
...
export declare namespace MountPoint {
    function isa(o: any): o is MountPoint;
}
/**
...
export declare namespace NetworkBinding {
    function isa(o: any): o is NetworkBinding;
}
/**
 * <p>An object representing the network configuration for a task or service.</p>
 */
...
export declare namespace NetworkConfiguration {
    function isa(o: any): o is NetworkConfiguration;
}
/**
...
export declare namespace NetworkInterface {
    function isa(o: any): o is NetworkInterface;
}
...
export declare namespace NoUpdateAvailableException {
    function isa(o: any): o is NoUpdateAvailableException;
}
...
export declare namespace PlacementConstraint {
    function isa(o: any): o is PlacementConstraint;
}
...
export declare namespace PlacementStrategy {
    function isa(o: any): o is PlacementStrategy;
}
...
export declare namespace PlatformDevice {
    function isa(o: any): o is PlatformDevice;
}
...
export declare namespace PlatformTaskDefinitionIncompatibilityException {
    function isa(o: any): o is PlatformTaskDefinitionIncompatibilityException;
}
/**
...
export declare namespace PlatformUnknownException {
    function isa(o: any): o is PlatformUnknownException;
}
/**
...
export declare namespace ProxyConfiguration {
    function isa(o: any): o is ProxyConfiguration;
}
...
export declare namespace PutAccountSettingDefaultRequest {
    function isa(o: any): o is PutAccountSettingDefaultRequest;
}
...
export declare namespace PutAccountSettingDefaultResponse {
    function isa(o: any): o is PutAccountSettingDefaultResponse;
}
...
export declare namespace PutAccountSettingRequest {
    function isa(o: any): o is PutAccountSettingRequest;
}
...
export declare namespace PutAccountSettingResponse {
    function isa(o: any): o is PutAccountSettingResponse;
}
...
export declare namespace PutAttributesRequest {
    function isa(o: any): o is PutAttributesRequest;
}
...
export declare namespace PutAttributesResponse {
    function isa(o: any): o is PutAttributesResponse;
}
...
export declare namespace PutClusterCapacityProvidersRequest {
    function isa(o: any): o is PutClusterCapacityProvidersRequest;
}
...
export declare namespace PutClusterCapacityProvidersResponse {
    function isa(o: any): o is PutClusterCapacityProvidersResponse;
}
...
export declare namespace RegisterContainerInstanceRequest {
    function isa(o: any): o is RegisterContainerInstanceRequest;
}
...
export declare namespace RegisterContainerInstanceResponse {
    function isa(o: any): o is RegisterContainerInstanceResponse;
}
export interface RegisterTaskDefinitionRequest {
    ...
    cpu?: string;
    /**
     * <p>The Amazon Resource Name (ARN) of the task execution role that the Amazon ECS container agent and the Docker
     *             daemon can assume.</p>
     */
     ...
     *             The default Docker network mode is <code>bridge</code>. If you are using the
     *             Fargate launch type, the <code>awsvpc</code> network mode is required. If
...
export declare namespace RegisterTaskDefinitionRequest {
    function isa(o: any): o is RegisterTaskDefinitionRequest;
}
...
export declare namespace RegisterTaskDefinitionResponse {
    function isa(o: any): o is RegisterTaskDefinitionResponse;
}
/**
...
export declare namespace RepositoryCredentials {
    function isa(o: any): o is RepositoryCredentials;
}
/**
...
export declare namespace ResourceRequirement {
    function isa(o: any): o is ResourceRequirement;
}
...
export declare namespace RunTaskRequest {
    function isa(o: any): o is RunTaskRequest;
}
...
export declare namespace RunTaskResponse {
    function isa(o: any): o is RunTaskResponse;
}
/**
 * <p>A floating-point percentage of the desired number of tasks to place and keep running
 *             in the task set.</p>
...
export declare namespace Secret {
    function isa(o: any): o is Secret;
}
/**
...
export declare namespace ServerException {
    function isa(o: any): o is ServerException;
}
/**
...
export interface Service {
     ...
     *                 <p>
     *                   <code>DAEMON</code>-The daemon scheduling strategy deploys exactly one
     *                     task on each container instance in your cluster. When you are using this
     *                     strategy, do not specify a desired number of tasks or any task placement
     *                     strategies.</p>
     *                 <note>
...
export declare namespace Service {
    function isa(o: any): o is Service;
}
/**
...
export declare namespace ServiceEvent {
    function isa(o: any): o is ServiceEvent;
}
...
export declare namespace ServiceNotActiveException {
    function isa(o: any): o is ServiceNotActiveException;
}
/**
...
export declare namespace ServiceNotFoundException {
    function isa(o: any): o is ServiceNotFoundException;
}
/**
...
export declare namespace ServiceRegistry {
    function isa(o: any): o is ServiceRegistry;
}
/**
 * <p>The current account setting for a resource.</p>
 */
...
export declare namespace Setting {
    function isa(o: any): o is Setting;
}
...
export declare namespace StartTaskRequest {
    function isa(o: any): o is StartTaskRequest;
}
...
export declare namespace StartTaskResponse {
    function isa(o: any): o is StartTaskResponse;
}
...
export declare namespace StopTaskRequest {
    function isa(o: any): o is StopTaskRequest;
}
...
export declare namespace StopTaskResponse {
    function isa(o: any): o is StopTaskResponse;
}
...
export declare namespace SubmitAttachmentStateChangesRequest {
    function isa(o: any): o is SubmitAttachmentStateChangesRequest;
}
...
export declare namespace SubmitAttachmentStateChangesResponse {
    function isa(o: any): o is SubmitAttachmentStateChangesResponse;
}
...
export declare namespace SubmitContainerStateChangeRequest {
    function isa(o: any): o is SubmitContainerStateChangeRequest;
}
...
export declare namespace SubmitContainerStateChangeResponse {
    function isa(o: any): o is SubmitContainerStateChangeResponse;
}
...
export declare namespace SubmitTaskStateChangeRequest {
    function isa(o: any): o is SubmitTaskStateChangeRequest;
}
...
export declare namespace SubmitTaskStateChangeResponse {
    function isa(o: any): o is SubmitTaskStateChangeResponse;
}
/**
 * <p>A list of namespaced kernel parameters to set in the container. This parameter maps to
 *                 <code>Sysctls</code> in the <a href="https://docs.docker.com/engine/api/v1.35/#operation/ContainerCreate">Create a container</a> section of the
...
export declare namespace SystemControl {
    function isa(o: any): o is SystemControl;
}
/**
...
export declare namespace TargetNotFoundException {
    function isa(o: any): o is TargetNotFoundException;
}
...
export interface TaskDefinition {
    ...
    cpu?: string;
    /**
     * <p>The Amazon Resource Name (ARN) of the task execution role that containers in this task can assume. All
     ...
     *             multiple versions of a task definition. Amazon ECS gives the first task definition that you
     *             registered to a family a revision number of 1. Amazon ECS gives sequential revision numbers
     *             to each task definition that you add.</p>
     */
    family?: string;
    /**
     * <p>The Elastic Inference accelerator associated with the task.</p>
     ...
     *         <p>If using the EC2 launch type, this field is optional and any value can
     ...
     *             task permission to call AWS APIs on your behalf. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_IAM_role.html">Amazon ECS
...
export declare namespace TaskDefinition {
    function isa(o: any): o is TaskDefinition;
}
...
export declare namespace TaskDefinitionPlacementConstraint {
    function isa(o: any): o is TaskDefinitionPlacementConstraint;
}
...
export declare namespace TaskOverride {
    function isa(o: any): o is TaskOverride;
}
/**
 * <p>Information about a set of Amazon ECS tasks in either an AWS CodeDeploy or an <code>EXTERNAL</code>
 *             deployment. An Amazon ECS task set includes details such as the desired number of tasks, how
...
export declare namespace TaskSet {
    function isa(o: any): o is TaskSet;
}
/**
...
export declare namespace TaskSetNotFoundException {
    function isa(o: any): o is TaskSetNotFoundException;
}
...
export declare namespace Ulimit {
    function isa(o: any): o is Ulimit;
}
...
export declare namespace UnsupportedFeatureException {
    function isa(o: any): o is UnsupportedFeatureException;
}
...
export declare namespace UpdateClusterSettingsRequest {
    function isa(o: any): o is UpdateClusterSettingsRequest;
}
...
export declare namespace UpdateClusterSettingsResponse {
    function isa(o: any): o is UpdateClusterSettingsResponse;
}
...
export declare namespace UpdateContainerAgentRequest {
    function isa(o: any): o is UpdateContainerAgentRequest;
}
...
export declare namespace UpdateContainerAgentResponse {
    function isa(o: any): o is UpdateContainerAgentResponse;
}
...
export declare namespace UpdateContainerInstancesStateRequest {
    function isa(o: any): o is UpdateContainerInstancesStateRequest;
}
...
export declare namespace UpdateContainerInstancesStateResponse {
    function isa(o: any): o is UpdateContainerInstancesStateResponse;
}
/**
...
export declare namespace UpdateInProgressException {
    function isa(o: any): o is UpdateInProgressException;
}
...
export declare namespace UpdateServicePrimaryTaskSetRequest {
    function isa(o: any): o is UpdateServicePrimaryTaskSetRequest;
}
...
export declare namespace UpdateServicePrimaryTaskSetResponse {
    function isa(o: any): o is UpdateServicePrimaryTaskSetResponse;
}
export interface UpdateServiceRequest {
     ...
     *             service can be updated to use one or more capacity providers. However, when a service is
     *             using a non-default capacity provider strategy, the service cannot be updated to use the
...
export declare namespace UpdateServiceRequest {
    function isa(o: any): o is UpdateServiceRequest;
}
...
export declare namespace UpdateServiceResponse {
    function isa(o: any): o is UpdateServiceResponse;
}
...
export declare namespace UpdateTaskSetRequest {
    function isa(o: any): o is UpdateTaskSetRequest;
}
...
export declare namespace UpdateTaskSetResponse {
    function isa(o: any): o is UpdateTaskSetResponse;
}
/**
...
export declare namespace VersionInfo {
    function isa(o: any): o is VersionInfo;
}
/**
 * <p>A data volume used in a task definition. For tasks that use a Docker volume, specify a
 *                 <code>DockerVolumeConfiguration</code>. For tasks that use a bind mount host volume,
 *             specify a <code>host</code> and optional <code>sourcePath</code>. For more information,
 *             see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_data_volumes.html">Using Data Volumes in
 *                 Tasks</a>.</p>
 */
export interface Volume {
    ...
    /**
     * <p>This parameter is specified when you are using bind mount host volumes. Bind mount
     *             host volumes are supported when you are using either the EC2 or
     *             Fargate launch types. The contents of the <code>host</code> parameter
     *             determine whether your bind mount host volume persists on the host container instance
     *             and where it is stored. If the <code>host</code> parameter is empty, then the Docker
...
export declare namespace Volume {
    function isa(o: any): o is Volume;
}
/**
...
export declare namespace VolumeFrom {
    function isa(o: any): o is VolumeFrom;
}
