...
export interface TaskManagedEBSVolumeTerminationPolicy {
   ...
   * 				<code>true</code> is specified,  Amazon ECS deletes the Amazon EBS volume on
   * 			your behalf when the task goes into the <code>STOPPED</code> state. If no value is
   * 			specified, the  default value is <code>true</code> is used. When set to
   * 				<code>false</code>, Amazon ECS leaves the volume in your  account.</p>
   * @public
   */
