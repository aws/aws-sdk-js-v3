...
export interface EBSTagSpecification {
  ...
  /**
   * <p>Determines whether to propagate the tags from the task definition to  the Amazon EBS volume. Tags can only
   * 			propagate to a <code>SERVICE</code> specified in  <code>ServiceVolumeConfiguration</code>. If no value
...
export interface TaskEphemeralStorage {
   ...
   * 			is <code>20</code> GiB and the maximum supported value is  <code>200</code> GiB.</p>
   * @public
   */
  sizeInGiB?: number | undefined;
...
export interface TaskManagedEBSVolumeTerminationPolicy {
   ...
   * 				<code>true</code> is specified,  Amazon ECS deletes the Amazon EBS volume on your behalf when the task goes
   * 			into the <code>STOPPED</code> state. If no value is specified, the  default value is <code>true</code>
   * 			is used. When set to <code>false</code>, Amazon ECS leaves the volume in your  account.</p>
   * @public
   */
...
export interface TaskManagedEBSVolumeConfiguration {
   ...
   *          <p>The available filesystem types are  <code>ext3</code>, <code>ext4</code>, and <code>xfs</code>. If no
