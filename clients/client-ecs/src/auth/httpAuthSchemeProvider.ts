...
import { type ECSClientResolvedConfig, ECSClientConfig } from "../ECSClient";
 ...
 * @internal
 */
export const defaultECSHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ECSHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultECSHttpAuthSchemeProvider: ECSHttpAuthSchemeProvider = (authParameters) => {
