 ...
 * @public
 */
export class DescribeExpressGatewayServiceCommand extends command<DescribeExpressGatewayServiceCommandInput, DescribeExpressGatewayServiceCommandOutput>(
  _ep0,
  _mw0,
