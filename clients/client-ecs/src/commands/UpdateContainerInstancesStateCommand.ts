 ...
 * @public
 */
export class UpdateContainerInstancesStateCommand extends command<UpdateContainerInstancesStateCommandInput, UpdateContainerInstancesStateCommandOutput>(
  _ep0,
  _mw0,
