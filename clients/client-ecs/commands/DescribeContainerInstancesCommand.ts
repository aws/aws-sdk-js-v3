...
export type DescribeContainerInstancesCommandOutput = DescribeContainerInstancesResponse;

export class DescribeContainerInstancesCommand extends $Command<DescribeContainerInstancesCommandInput, DescribeContainerInstancesCommandOutput, ECSClientResolvedConfig> {
