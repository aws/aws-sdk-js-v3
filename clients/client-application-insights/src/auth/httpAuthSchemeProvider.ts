...
import { ApplicationInsightsClientConfig, ApplicationInsightsClientResolvedConfig } from "../ApplicationInsightsClient";
 ...
 * @internal
 */
export const defaultApplicationInsightsHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: ApplicationInsightsHttpAuthSchemeParameters): HttpAuthOption {
  return {
 ...
 * @internal
 */
export const defaultApplicationInsightsHttpAuthSchemeProvider: ApplicationInsightsHttpAuthSchemeProvider = (
  authParameters
) => {
