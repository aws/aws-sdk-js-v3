...
import {
  type ApplicationInsightsClientResolvedConfig,
  ApplicationInsightsClientConfig,
 ...
 * @internal
 */
export const defaultApplicationInsightsHttpAuthSchemeProvider: ApplicationInsightsHttpAuthSchemeProvider = (authParameters) => {
