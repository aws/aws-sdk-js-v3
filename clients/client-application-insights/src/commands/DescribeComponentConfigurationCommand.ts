 ...
 * @public
 */
export class DescribeComponentConfigurationCommand extends command<DescribeComponentConfigurationCommandInput, DescribeComponentConfigurationCommandOutput>(
  _ep0,
  _mw0,
