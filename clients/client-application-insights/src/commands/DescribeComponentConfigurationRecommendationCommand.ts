 ...
 * @public
 */
export class DescribeComponentConfigurationRecommendationCommand extends command<DescribeComponentConfigurationRecommendationCommandInput, DescribeComponentConfigurationRecommendationCommandOutput>(
  _ep0,
  _mw0,
