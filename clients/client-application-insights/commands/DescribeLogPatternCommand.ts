...
export type DescribeLogPatternCommandOutput = DescribeLogPatternResponse;

export class DescribeLogPatternCommand extends $Command<DescribeLogPatternCommandInput, DescribeLogPatternCommandOutput, ApplicationInsightsClientResolvedConfig> {
