...
export type ListProblemsCommandOutput = ListProblemsResponse;

export class ListProblemsCommand extends $Command<ListProblemsCommandInput, ListProblemsCommandOutput, ApplicationInsightsClientResolvedConfig> {
