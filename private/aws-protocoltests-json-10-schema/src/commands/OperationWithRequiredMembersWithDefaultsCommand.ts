 ...
 *
 */
export class OperationWithRequiredMembersWithDefaultsCommand extends command<OperationWithRequiredMembersWithDefaultsCommandInput, OperationWithRequiredMembersWithDefaultsCommandOutput>(
  _ep0,
  _mw0,
