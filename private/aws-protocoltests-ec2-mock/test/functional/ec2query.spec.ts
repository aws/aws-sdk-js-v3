...
import { PutEc2AliasCommand } from "../../src/commands/PutEc2AliasCommand";
import { Ec2MockClient } from "../../src/Ec2MockClient";
 ...
 *
 */
it("Ec2QueryNameSerializationRequest:Request", async () => {
  const client = new Ec2MockClient({
    ...clientParams,
    requestHandler: new RequestSerializationTestHandler(),
  });

  const command = new PutEc2AliasCommand(
    {
      alias: {
        ec2MemberNameWithAliases: "A",
        ec2MemberNameWithOnlyXmlAlias: "B",
        ec2MemberNameWithOnlyEc2Alias: "C",
        ec2MemberNameWithNoAlias: "D",
      } as any,
    } as any,
  );
  try {
    ...
    const bodyString = `Action=PutEc2Alias&Version=2024-01-01&Alias.ec2QueryMemberNameWithAliases=A&Alias.Ec2XmlMemberNameWithOnlyXmlAlias=B&Alias.ec2QueryMemberNameWithOnlyEc2Alias=C&Alias.Ec2MemberNameWithNoAlias=D`;
