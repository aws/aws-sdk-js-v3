...
export class MalformedLengthOverrideHandler<Context> implements __ServiceHandler<Context> {
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    ...
    if (target === undefined) {
      console.log('Received a request that did not match aws.protocoltests.restjson.validation#RestJsonValidation.MalformedLengthOverride. This indicates a misconfiguration.');
      return this.serializeFrameworkException(new __InternalFailureException(), serdeContextBase);
    }
    return handle(request, context, "MalformedLengthOverride", this.serializer, this.operation, this.serializeFrameworkException, MalformedLengthOverrideServerInput.validate, this.validationCustomizer);
  }
}
