...
import { MalformedLengthOverrideInput } from "../../models/models_0";
import {
...
export type MalformedLengthOverride<Context> = __Operation<MalformedLengthOverrideServerInput, MalformedLengthOverrideServerOutput, Context>
...
export namespace MalformedLengthOverrideServerInput {
   ...
   * @internal
   */
  export const validate: (obj: Parameters<typeof MalformedLengthOverrideInput.validate>[0]) => __ValidationFailure[] = MalformedLengthOverrideInput.validate;
}
export interface MalformedLengthOverrideServerOutput {}

export type MalformedLengthOverrideErrors = ValidationException

export class MalformedLengthOverrideSerializer implements __OperationSerializer<RestJsonValidationService<any>, "MalformedLengthOverride", MalformedLengthOverrideErrors> {
...
export const getMalformedLengthOverrideHandler = <Context>(operation: __Operation<MalformedLengthOverrideServerInput, MalformedLengthOverrideServerOutput, Context>): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new MalformedLengthOverrideHandler(operation, mux, new MalformedLengthOverrideSerializer(), serializeFrameworkException, customizer);
}
...
export class MalformedLengthOverrideHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<MalformedLengthOverrideServerInput, MalformedLengthOverrideServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonValidationService<Context>, "MalformedLengthOverride", MalformedLengthOverrideErrors>;
  ...
  constructor(
    ...
    serializer: __OperationSerializer<RestJsonValidationService<Context>, "MalformedLengthOverride", MalformedLengthOverrideErrors>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "MalformedLengthOverride" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (MalformedLengthOverrideServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "MalformedLengthOverride" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as MalformedLengthOverrideServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as MalformedLengthOverrideServerOutput, serdeContextBase),
