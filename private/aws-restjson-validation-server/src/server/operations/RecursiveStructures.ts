...
export class RecursiveStructuresHandler<Context> implements __ServiceHandler<Context> {
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    ...
    if (target === undefined) {
      console.log('Received a request that did not match aws.protocoltests.restjson.validation#RestJsonValidation.RecursiveStructures. This indicates a misconfiguration.');
      return this.serializeFrameworkException(new __InternalFailureException(), serdeContextBase);
    }
    return handle(request, context, "RecursiveStructures", this.serializer, this.operation, this.serializeFrameworkException, RecursiveStructuresServerInput.validate, this.validationCustomizer);
  }
}
