...
import {
  de_HttpQueryParamsOnlyOperationCommand,
  se_HttpQueryParamsOnlyOperationCommand,
 ...
 * ```javascript
 * import { RestJsonProtocolClient, HttpQueryParamsOnlyOperationCommand } from "@aws-sdk/aws-protocoltests-restjson"; // ES Modules import
 * // const { RestJsonProtocolClient, HttpQueryParamsOnlyOperationCommand } = require("@aws-sdk/aws-protocoltests-restjson"); // CommonJS import
...
export class HttpQueryParamsOnlyOperationCommand extends $Command
  ...
  .f(void 0, void 0)
  .ser(se_HttpQueryParamsOnlyOperationCommand)
  .de(de_HttpQueryParamsOnlyOperationCommand)
  .build() {
