...
import { type OutputStreamOutput, OutputStreamOutputFilterSensitiveLog } from "../models/models_0";
import { de_OutputStreamCommand, se_OutputStreamCommand } from "../protocols/Aws_restJson1";
import type {
 ...
 * ```javascript
 * import { RestJsonProtocolClient, OutputStreamCommand } from "@aws-sdk/aws-protocoltests-restjson"; // ES Modules import
 * // const { RestJsonProtocolClient, OutputStreamCommand } = require("@aws-sdk/aws-protocoltests-restjson"); // CommonJS import
...
export class OutputStreamCommand extends $Command
  ...
  .f(void 0, OutputStreamOutputFilterSensitiveLog)
  .ser(se_OutputStreamCommand)
  .de(de_OutputStreamCommand)
  .build() {
