...
import {
  type InputStreamWithInitialRequestInput,
  InputStreamWithInitialRequestInputFilterSensitiveLog,
} from "../models/models_0";
import {
  de_InputStreamWithInitialRequestCommand,
  se_InputStreamWithInitialRequestCommand,
 ...
 * ```javascript
 * import { RestJsonProtocolClient, InputStreamWithInitialRequestCommand } from "@aws-sdk/aws-protocoltests-restjson"; // ES Modules import
 * // const { RestJsonProtocolClient, InputStreamWithInitialRequestCommand } = require("@aws-sdk/aws-protocoltests-restjson"); // CommonJS import
...
export class InputStreamWithInitialRequestCommand extends $Command
  ...
  .f(InputStreamWithInitialRequestInputFilterSensitiveLog, void 0)
  .ser(se_InputStreamWithInitialRequestCommand)
  .de(de_InputStreamWithInitialRequestCommand)
  .build() {
