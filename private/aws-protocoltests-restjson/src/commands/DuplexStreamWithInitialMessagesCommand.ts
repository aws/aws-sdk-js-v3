 ...
 * ```javascript
 * import { RestJsonProtocolClient, DuplexStreamWithInitialMessagesCommand } from "@aws-sdk/aws-protocoltests-restjson"; // ES Modules import
 * // const { RestJsonProtocolClient, DuplexStreamWithInitialMessagesCommand } = require("@aws-sdk/aws-protocoltests-restjson"); // CommonJS import
...
export class DuplexStreamWithInitialMessagesCommand extends $Command
  ...
  .f(DuplexStreamWithInitialMessagesInputFilterSensitiveLog, DuplexStreamWithInitialMessagesOutputFilterSensitiveLog)
  .ser(se_DuplexStreamWithInitialMessagesCommand)
  .de(de_DuplexStreamWithInitialMessagesCommand)
  .build() {
