...
import {
  type OutputStreamWithInitialResponseOutput,
  OutputStreamWithInitialResponseOutputFilterSensitiveLog,
} from "../models/models_0";
import {
  de_OutputStreamWithInitialResponseCommand,
  se_OutputStreamWithInitialResponseCommand,
 ...
 * ```javascript
 * import { RestJsonProtocolClient, OutputStreamWithInitialResponseCommand } from "@aws-sdk/aws-protocoltests-restjson"; // ES Modules import
 * // const { RestJsonProtocolClient, OutputStreamWithInitialResponseCommand } = require("@aws-sdk/aws-protocoltests-restjson"); // CommonJS import
...
export class OutputStreamWithInitialResponseCommand extends $Command
  ...
  .f(void 0, OutputStreamWithInitialResponseOutputFilterSensitiveLog)
  .ser(se_OutputStreamWithInitialResponseCommand)
  .de(de_OutputStreamWithInitialResponseCommand)
  .build() {
