...
const _s = "smithy.ts.sdk.synthetic.aws.protocoltests.ec2";
...
export var QueryListsInput$: StaticStructureSchema = [3, n0, _QLI,
  ...
  [64 | 0, () => GreetingList, [() => ListWithXmlName, 0], [() => ListWithXmlName, { [_xN]: _H }], () => NestedStructWithList$]
];
