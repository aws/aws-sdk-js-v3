...
export class MalformedTimestampHeaderDefaultHandler<Context> implements __ServiceHandler<Context> {
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    ...
    if (target === undefined) {
      console.log(
        "Received a request that did not match aws.protocoltests.restjson#RestJson.MalformedTimestampHeaderDefault. This indicates a misconfiguration."
      );
...
export interface MalformedTimestampHeaderDefaultServerOutput extends __MetadataBearer {}
...
export const getMalformedTimestampHeaderDefaultHandler = <Context>(
  operation: __Operation<
    MalformedTimestampHeaderDefaultServerInput,
    MalformedTimestampHeaderDefaultServerOutput,
    Context
  >,
  customizer: __ValidationCustomizer<"MalformedTimestampHeaderDefault">
  ...
  return new MalformedTimestampHeaderDefaultHandler(
    operation,
    mux,
    new MalformedTimestampHeaderDefaultSerializer(),
    serializeFrameworkException,
    customizer
  );
};
