...
export const getResponseCodeHttpFallbackHandler = <Context>(
  operation: __Operation<ResponseCodeHttpFallbackServerInput, ResponseCodeHttpFallbackServerOutput, Context>,
  customizer: __ValidationCustomizer<"ResponseCodeHttpFallback">
  ...
  return new ResponseCodeHttpFallbackHandler(
    operation,
    mux,
    new ResponseCodeHttpFallbackSerializer(),
    serializeFrameworkException,
    customizer
  );
};
...
export class ResponseCodeHttpFallbackHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly serializer: __OperationSerializer<
    ...
    ResponseCodeHttpFallbackErrors
  >;
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    ...
    if (target === undefined) {
      console.log(
        "Received a request that did not match aws.protocoltests.restjson#RestJson.ResponseCodeHttpFallback. This indicates a misconfiguration."
      );
