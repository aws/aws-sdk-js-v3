...
export type InputStreamWithInitialRequest<Context> = __Operation<
...
export namespace InputStreamWithInitialRequestServerInput {
  ...
  export const validate: (
    obj: Parameters<typeof InputStreamWithInitialRequestInput.validate>[0]
  ) => __ValidationFailure[] = InputStreamWithInitialRequestInput.validate;
}
export interface InputStreamWithInitialRequestServerOutput {}

export type InputStreamWithInitialRequestErrors = never;

export class InputStreamWithInitialRequestSerializer
  implements
    __OperationSerializer<RestJsonService<any>, "InputStreamWithInitialRequest", InputStreamWithInitialRequestErrors>
{
...
export const getInputStreamWithInitialRequestHandler = <Context>(
  operation: __Operation<InputStreamWithInitialRequestServerInput, InputStreamWithInitialRequestServerOutput, Context>,
  customizer: __ValidationCustomizer<"InputStreamWithInitialRequest">
  ...
  return new InputStreamWithInitialRequestHandler(
    operation,
    mux,
    new InputStreamWithInitialRequestSerializer(),
    serializeFrameworkException,
    customizer
  );
};
...
export class InputStreamWithInitialRequestHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly serializer: __OperationSerializer<
    ...
    InputStreamWithInitialRequestErrors
  >;
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    ...
    if (target === undefined) {
      console.log(
        "Received a request that did not match aws.protocoltests.restjson#RestJson.InputStreamWithInitialRequest. This indicates a misconfiguration."
      );
