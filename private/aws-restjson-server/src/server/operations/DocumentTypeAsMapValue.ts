...
export type DocumentTypeAsMapValue<Context> = __Operation<DocumentTypeAsMapValueServerInput, DocumentTypeAsMapValueServerOutput, Context>
...
export namespace DocumentTypeAsMapValueServerInput {
   ...
   * @internal
   */
  export const validate: (obj: Parameters<typeof DocumentTypeAsMapValueInputOutput.validate>[0]) => __ValidationFailure[] = DocumentTypeAsMapValueInputOutput.validate;
}
...
export class DocumentTypeAsMapValueSerializer implements __OperationSerializer<RestJsonService<any>, "DocumentTypeAsMapValue", DocumentTypeAsMapValueErrors> {
...
export const getDocumentTypeAsMapValueHandler = <Context>(operation: __Operation<DocumentTypeAsMapValueServerInput, DocumentTypeAsMapValueServerOutput, Context>, customizer: __ValidationCustomizer<"DocumentTypeAsMapValue">): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new DocumentTypeAsMapValueHandler(operation, mux, new DocumentTypeAsMapValueSerializer(), serializeFrameworkException, customizer);
}
...
export class DocumentTypeAsMapValueHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<DocumentTypeAsMapValueServerInput, DocumentTypeAsMapValueServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonService<Context>, "DocumentTypeAsMapValue", DocumentTypeAsMapValueErrors>;
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "DocumentTypeAsMapValue" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (DocumentTypeAsMapValueServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "DocumentTypeAsMapValue" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as DocumentTypeAsMapValueServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as DocumentTypeAsMapValueServerOutput, serdeContextBase),
