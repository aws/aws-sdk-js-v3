...
type StreamingTraitsRequireLengthServerInputType = Omit<StreamingTraitsRequireLengthInputOutput, "blob"> & {
  /**
...
export namespace StreamingTraitsRequireLengthServerInput {
  ...
  export const validate: (
    obj: Parameters<typeof StreamingTraitsRequireLengthInputOutput.validate>[0]
  ) => __ValidationFailure[] = StreamingTraitsRequireLengthInputOutput.validate;
}
