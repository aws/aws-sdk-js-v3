...
export type StreamingTraitsRequireLength<Context> = __Operation<StreamingTraitsRequireLengthServerInput, StreamingTraitsRequireLengthServerOutput, Context>
...
export namespace StreamingTraitsRequireLengthServerInput {
   ...
   * @internal
   */
  export const validate: (obj: Parameters<typeof StreamingTraitsRequireLengthInput.validate>[0]) => __ValidationFailure[] = StreamingTraitsRequireLengthInput.validate;
}
export interface StreamingTraitsRequireLengthServerOutput {}

export type StreamingTraitsRequireLengthErrors = never;

export class StreamingTraitsRequireLengthSerializer implements __OperationSerializer<RestJsonService<any>, "StreamingTraitsRequireLength", StreamingTraitsRequireLengthErrors> {
...
export const getStreamingTraitsRequireLengthHandler = <Context>(operation: __Operation<StreamingTraitsRequireLengthServerInput, StreamingTraitsRequireLengthServerOutput, Context>, customizer: __ValidationCustomizer<"StreamingTraitsRequireLength">): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new StreamingTraitsRequireLengthHandler(operation, mux, new StreamingTraitsRequireLengthSerializer(), serializeFrameworkException, customizer);
}
...
export class StreamingTraitsRequireLengthHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<StreamingTraitsRequireLengthServerInput, StreamingTraitsRequireLengthServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonService<Context>, "StreamingTraitsRequireLength", StreamingTraitsRequireLengthErrors>;
  ...
  constructor(
    ...
    serializer: __OperationSerializer<RestJsonService<Context>, "StreamingTraitsRequireLength", StreamingTraitsRequireLengthErrors>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "StreamingTraitsRequireLength" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (StreamingTraitsRequireLengthServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "StreamingTraitsRequireLength" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as StreamingTraitsRequireLengthServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as StreamingTraitsRequireLengthServerOutput, serdeContextBase),
