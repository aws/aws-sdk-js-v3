...
export type HttpRequestWithLabelsAndTimestampFormat<Context> = __Operation<HttpRequestWithLabelsAndTimestampFormatServerInput, HttpRequestWithLabelsAndTimestampFormatServerOutput, Context>

export interface HttpRequestWithLabelsAndTimestampFormatServerInput extends HttpRequestWithLabelsAndTimestampFormatInput {}
export namespace HttpRequestWithLabelsAndTimestampFormatServerInput {
  /**
   * @internal
   */
  export const validate: (obj: Parameters<typeof HttpRequestWithLabelsAndTimestampFormatInput.validate>[0]) => __ValidationFailure[] = HttpRequestWithLabelsAndTimestampFormatInput.validate;
}
...
export class HttpRequestWithLabelsAndTimestampFormatSerializer implements __OperationSerializer<RestJsonService<any>, "HttpRequestWithLabelsAndTimestampFormat", HttpRequestWithLabelsAndTimestampFormatErrors> {
  ...
  serializeError(error: HttpRequestWithLabelsAndTimestampFormatErrors, ctx: ServerSerdeContext): Promise<__HttpResponse> {
    throw error;
  }

}

export const getHttpRequestWithLabelsAndTimestampFormatHandler = <Context>(operation: __Operation<HttpRequestWithLabelsAndTimestampFormatServerInput, HttpRequestWithLabelsAndTimestampFormatServerOutput, Context>, customizer: __ValidationCustomizer<"HttpRequestWithLabelsAndTimestampFormat">): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new HttpRequestWithLabelsAndTimestampFormatHandler(operation, mux, new HttpRequestWithLabelsAndTimestampFormatSerializer(), serializeFrameworkException, customizer);
}
...
export class HttpRequestWithLabelsAndTimestampFormatHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<HttpRequestWithLabelsAndTimestampFormatServerInput, HttpRequestWithLabelsAndTimestampFormatServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonService<Context>, "HttpRequestWithLabelsAndTimestampFormat", HttpRequestWithLabelsAndTimestampFormatErrors>;
   ...
   */
  constructor(
    operation: __Operation<HttpRequestWithLabelsAndTimestampFormatServerInput, HttpRequestWithLabelsAndTimestampFormatServerOutput, Context>,
    mux: __Mux<"RestJson", "HttpRequestWithLabelsAndTimestampFormat">,
    serializer: __OperationSerializer<RestJsonService<Context>, "HttpRequestWithLabelsAndTimestampFormat", HttpRequestWithLabelsAndTimestampFormatErrors>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "HttpRequestWithLabelsAndTimestampFormat" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (HttpRequestWithLabelsAndTimestampFormatServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "HttpRequestWithLabelsAndTimestampFormat" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as HttpRequestWithLabelsAndTimestampFormatServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as HttpRequestWithLabelsAndTimestampFormatServerOutput, serdeContextBase),
