...
export type HttpPayloadWithStructure<Context> = __Operation<HttpPayloadWithStructureServerInput, HttpPayloadWithStructureServerOutput, Context>
...
export namespace HttpPayloadWithStructureServerInput {
   ...
   * @internal
   */
  export const validate: (obj: Parameters<typeof HttpPayloadWithStructureInputOutput.validate>[0]) => __ValidationFailure[] = HttpPayloadWithStructureInputOutput.validate;
}
...
export class HttpPayloadWithStructureSerializer implements __OperationSerializer<RestJsonService<any>, "HttpPayloadWithStructure", HttpPayloadWithStructureErrors> {
...
export const getHttpPayloadWithStructureHandler = <Context>(operation: __Operation<HttpPayloadWithStructureServerInput, HttpPayloadWithStructureServerOutput, Context>, customizer: __ValidationCustomizer<"HttpPayloadWithStructure">): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new HttpPayloadWithStructureHandler(operation, mux, new HttpPayloadWithStructureSerializer(), serializeFrameworkException, customizer);
}
...
export class HttpPayloadWithStructureHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<HttpPayloadWithStructureServerInput, HttpPayloadWithStructureServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonService<Context>, "HttpPayloadWithStructure", HttpPayloadWithStructureErrors>;
  ...
  constructor(
    ...
    serializer: __OperationSerializer<RestJsonService<Context>, "HttpPayloadWithStructure", HttpPayloadWithStructureErrors>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "HttpPayloadWithStructure" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (HttpPayloadWithStructureServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "HttpPayloadWithStructure" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as HttpPayloadWithStructureServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as HttpPayloadWithStructureServerOutput, serdeContextBase),
