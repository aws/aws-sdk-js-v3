...
export class QueryPrecedenceHandler<Context> implements __ServiceHandler<Context> {
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    ...
    if (target === undefined) {
      console.log('Received a request that did not match aws.protocoltests.restjson#RestJson.QueryPrecedence. This indicates a misconfiguration.');
      return this.serializeFrameworkException(new __InternalFailureException(), serdeContextBase);
    }
    return handle(request, context, "QueryPrecedence", this.serializer, this.operation, this.serializeFrameworkException, QueryPrecedenceServerInput.validate, this.validationCustomizer);
  }
}
