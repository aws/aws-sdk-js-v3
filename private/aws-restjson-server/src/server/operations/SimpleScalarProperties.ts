...
export type SimpleScalarProperties<Context> = __Operation<SimpleScalarPropertiesServerInput, SimpleScalarPropertiesServerOutput, Context>
...
export namespace SimpleScalarPropertiesServerInput {
   ...
   * @internal
   */
  export const validate: (obj: Parameters<typeof SimpleScalarPropertiesInputOutput.validate>[0]) => __ValidationFailure[] = SimpleScalarPropertiesInputOutput.validate;
}
...
export class SimpleScalarPropertiesSerializer implements __OperationSerializer<RestJsonService<any>, "SimpleScalarProperties", SimpleScalarPropertiesErrors> {
...
export const getSimpleScalarPropertiesHandler = <Context>(operation: __Operation<SimpleScalarPropertiesServerInput, SimpleScalarPropertiesServerOutput, Context>, customizer: __ValidationCustomizer<"SimpleScalarProperties">): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new SimpleScalarPropertiesHandler(operation, mux, new SimpleScalarPropertiesSerializer(), serializeFrameworkException, customizer);
}
...
export class SimpleScalarPropertiesHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<SimpleScalarPropertiesServerInput, SimpleScalarPropertiesServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonService<Context>, "SimpleScalarProperties", SimpleScalarPropertiesErrors>;
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "SimpleScalarProperties" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (SimpleScalarPropertiesServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "SimpleScalarProperties" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as SimpleScalarPropertiesServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as SimpleScalarPropertiesServerOutput, serdeContextBase),
