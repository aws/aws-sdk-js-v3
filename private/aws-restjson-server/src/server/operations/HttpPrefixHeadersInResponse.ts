...
export type HttpPrefixHeadersInResponse<Context> = __Operation<HttpPrefixHeadersInResponseServerInput, HttpPrefixHeadersInResponseServerOutput, Context>
...
export namespace HttpPrefixHeadersInResponseServerInput {
   ...
   * @internal
   */
  export const validate: (obj: Parameters<typeof HttpPrefixHeadersInResponseInput.validate>[0]) => __ValidationFailure[] = HttpPrefixHeadersInResponseInput.validate;
}
...
export class HttpPrefixHeadersInResponseSerializer implements __OperationSerializer<RestJsonService<any>, "HttpPrefixHeadersInResponse", HttpPrefixHeadersInResponseErrors> {
...
export const getHttpPrefixHeadersInResponseHandler = <Context>(operation: __Operation<HttpPrefixHeadersInResponseServerInput, HttpPrefixHeadersInResponseServerOutput, Context>, customizer: __ValidationCustomizer<"HttpPrefixHeadersInResponse">): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new HttpPrefixHeadersInResponseHandler(operation, mux, new HttpPrefixHeadersInResponseSerializer(), serializeFrameworkException, customizer);
}
...
export class HttpPrefixHeadersInResponseHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<HttpPrefixHeadersInResponseServerInput, HttpPrefixHeadersInResponseServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonService<Context>, "HttpPrefixHeadersInResponse", HttpPrefixHeadersInResponseErrors>;
  ...
  constructor(
    ...
    serializer: __OperationSerializer<RestJsonService<Context>, "HttpPrefixHeadersInResponse", HttpPrefixHeadersInResponseErrors>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "HttpPrefixHeadersInResponse" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (HttpPrefixHeadersInResponseServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "HttpPrefixHeadersInResponse" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as HttpPrefixHeadersInResponseServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as HttpPrefixHeadersInResponseServerOutput, serdeContextBase),
