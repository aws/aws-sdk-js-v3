...
export type MalformedAcceptWithGenericString<Context> = __Operation<MalformedAcceptWithGenericStringServerInput, MalformedAcceptWithGenericStringServerOutput, Context>
...
export class MalformedAcceptWithGenericStringSerializer implements __OperationSerializer<RestJsonService<any>, "MalformedAcceptWithGenericString", MalformedAcceptWithGenericStringErrors> {
...
export const getMalformedAcceptWithGenericStringHandler = <Context>(operation: __Operation<MalformedAcceptWithGenericStringServerInput, MalformedAcceptWithGenericStringServerOutput, Context>, customizer: __ValidationCustomizer<"MalformedAcceptWithGenericString">): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new MalformedAcceptWithGenericStringHandler(operation, mux, new MalformedAcceptWithGenericStringSerializer(), serializeFrameworkException, customizer);
}
...
export class MalformedAcceptWithGenericStringHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<MalformedAcceptWithGenericStringServerInput, MalformedAcceptWithGenericStringServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonService<Context>, "MalformedAcceptWithGenericString", MalformedAcceptWithGenericStringErrors>;
   ...
   */
  constructor(
    operation: __Operation<MalformedAcceptWithGenericStringServerInput, MalformedAcceptWithGenericStringServerOutput, Context>,
    mux: __Mux<"RestJson", "MalformedAcceptWithGenericString">,
    serializer: __OperationSerializer<RestJsonService<Context>, "MalformedAcceptWithGenericString", MalformedAcceptWithGenericStringErrors>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "MalformedAcceptWithGenericString" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (MalformedAcceptWithGenericStringServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "MalformedAcceptWithGenericString" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as MalformedAcceptWithGenericStringServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as MalformedAcceptWithGenericStringServerOutput, serdeContextBase),
