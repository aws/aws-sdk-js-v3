...
export class DocumentTypeHandler<Context> implements __ServiceHandler<Context> {
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    ...
    if (target === undefined) {
      console.log('Received a request that did not match aws.protocoltests.restjson#RestJson.DocumentType. This indicates a misconfiguration.');
      return this.serializeFrameworkException(new __InternalFailureException(), serdeContextBase);
    }
    return handle(request, context, "DocumentType", this.serializer, this.operation, this.serializeFrameworkException, DocumentTypeServerInput.validate, this.validationCustomizer);
  }
}
