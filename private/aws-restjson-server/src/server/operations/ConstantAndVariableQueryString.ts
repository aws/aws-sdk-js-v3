...
export type ConstantAndVariableQueryString<Context> = __Operation<ConstantAndVariableQueryStringServerInput, ConstantAndVariableQueryStringServerOutput, Context>
...
export namespace ConstantAndVariableQueryStringServerInput {
   ...
   * @internal
   */
  export const validate: (obj: Parameters<typeof ConstantAndVariableQueryStringInput.validate>[0]) => __ValidationFailure[] = ConstantAndVariableQueryStringInput.validate;
}
export interface ConstantAndVariableQueryStringServerOutput {}

export type ConstantAndVariableQueryStringErrors = never;

export class ConstantAndVariableQueryStringSerializer implements __OperationSerializer<RestJsonService<any>, "ConstantAndVariableQueryString", ConstantAndVariableQueryStringErrors> {
...
export const getConstantAndVariableQueryStringHandler = <Context>(operation: __Operation<ConstantAndVariableQueryStringServerInput, ConstantAndVariableQueryStringServerOutput, Context>, customizer: __ValidationCustomizer<"ConstantAndVariableQueryString">): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new ConstantAndVariableQueryStringHandler(operation, mux, new ConstantAndVariableQueryStringSerializer(), serializeFrameworkException, customizer);
}
...
export class ConstantAndVariableQueryStringHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<ConstantAndVariableQueryStringServerInput, ConstantAndVariableQueryStringServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonService<Context>, "ConstantAndVariableQueryString", ConstantAndVariableQueryStringErrors>;
   ...
   */
  constructor(
    operation: __Operation<ConstantAndVariableQueryStringServerInput, ConstantAndVariableQueryStringServerOutput, Context>,
    mux: __Mux<"RestJson", "ConstantAndVariableQueryString">,
    serializer: __OperationSerializer<RestJsonService<Context>, "ConstantAndVariableQueryString", ConstantAndVariableQueryStringErrors>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "ConstantAndVariableQueryString" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (ConstantAndVariableQueryStringServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "ConstantAndVariableQueryString" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as ConstantAndVariableQueryStringServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as ConstantAndVariableQueryStringServerOutput, serdeContextBase),
