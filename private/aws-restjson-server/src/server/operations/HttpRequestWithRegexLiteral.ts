...
export type HttpRequestWithRegexLiteral<Context> = __Operation<HttpRequestWithRegexLiteralServerInput, HttpRequestWithRegexLiteralServerOutput, Context>
...
export namespace HttpRequestWithRegexLiteralServerInput {
   ...
   * @internal
   */
  export const validate: (obj: Parameters<typeof HttpRequestWithRegexLiteralInput.validate>[0]) => __ValidationFailure[] = HttpRequestWithRegexLiteralInput.validate;
}
export interface HttpRequestWithRegexLiteralServerOutput {}

export type HttpRequestWithRegexLiteralErrors = never;

export class HttpRequestWithRegexLiteralSerializer implements __OperationSerializer<RestJsonService<any>, "HttpRequestWithRegexLiteral", HttpRequestWithRegexLiteralErrors> {
...
export const getHttpRequestWithRegexLiteralHandler = <Context>(operation: __Operation<HttpRequestWithRegexLiteralServerInput, HttpRequestWithRegexLiteralServerOutput, Context>, customizer: __ValidationCustomizer<"HttpRequestWithRegexLiteral">): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new HttpRequestWithRegexLiteralHandler(operation, mux, new HttpRequestWithRegexLiteralSerializer(), serializeFrameworkException, customizer);
}
...
export class HttpRequestWithRegexLiteralHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<HttpRequestWithRegexLiteralServerInput, HttpRequestWithRegexLiteralServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonService<Context>, "HttpRequestWithRegexLiteral", HttpRequestWithRegexLiteralErrors>;
  ...
  constructor(
    ...
    serializer: __OperationSerializer<RestJsonService<Context>, "HttpRequestWithRegexLiteral", HttpRequestWithRegexLiteralErrors>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "HttpRequestWithRegexLiteral" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (HttpRequestWithRegexLiteralServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "HttpRequestWithRegexLiteral" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as HttpRequestWithRegexLiteralServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as HttpRequestWithRegexLiteralServerOutput, serdeContextBase),
