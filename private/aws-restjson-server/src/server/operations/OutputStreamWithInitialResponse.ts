...
export type OutputStreamWithInitialResponse<Context> = __Operation<OutputStreamWithInitialResponseServerInput, OutputStreamWithInitialResponseServerOutput, Context>
...
export class OutputStreamWithInitialResponseSerializer implements __OperationSerializer<RestJsonService<any>, "OutputStreamWithInitialResponse", OutputStreamWithInitialResponseErrors> {
...
export const getOutputStreamWithInitialResponseHandler = <Context>(operation: __Operation<OutputStreamWithInitialResponseServerInput, OutputStreamWithInitialResponseServerOutput, Context>, customizer: __ValidationCustomizer<"OutputStreamWithInitialResponse">): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new OutputStreamWithInitialResponseHandler(operation, mux, new OutputStreamWithInitialResponseSerializer(), serializeFrameworkException, customizer);
}
...
export class OutputStreamWithInitialResponseHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<OutputStreamWithInitialResponseServerInput, OutputStreamWithInitialResponseServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonService<Context>, "OutputStreamWithInitialResponse", OutputStreamWithInitialResponseErrors>;
   ...
   */
  constructor(
    operation: __Operation<OutputStreamWithInitialResponseServerInput, OutputStreamWithInitialResponseServerOutput, Context>,
    mux: __Mux<"RestJson", "OutputStreamWithInitialResponse">,
    serializer: __OperationSerializer<RestJsonService<Context>, "OutputStreamWithInitialResponse", OutputStreamWithInitialResponseErrors>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "OutputStreamWithInitialResponse" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (OutputStreamWithInitialResponseServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "OutputStreamWithInitialResponse" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as OutputStreamWithInitialResponseServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as OutputStreamWithInitialResponseServerOutput, serdeContextBase),
