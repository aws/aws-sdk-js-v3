...
export type IgnoreQueryParamsInResponse<Context> = __Operation<IgnoreQueryParamsInResponseServerInput, IgnoreQueryParamsInResponseServerOutput, Context>
...
export class IgnoreQueryParamsInResponseSerializer implements __OperationSerializer<RestJsonService<any>, "IgnoreQueryParamsInResponse", IgnoreQueryParamsInResponseErrors> {
...
export const getIgnoreQueryParamsInResponseHandler = <Context>(operation: __Operation<IgnoreQueryParamsInResponseServerInput, IgnoreQueryParamsInResponseServerOutput, Context>, customizer: __ValidationCustomizer<"IgnoreQueryParamsInResponse">): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new IgnoreQueryParamsInResponseHandler(operation, mux, new IgnoreQueryParamsInResponseSerializer(), serializeFrameworkException, customizer);
}
...
export class IgnoreQueryParamsInResponseHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<IgnoreQueryParamsInResponseServerInput, IgnoreQueryParamsInResponseServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonService<Context>, "IgnoreQueryParamsInResponse", IgnoreQueryParamsInResponseErrors>;
  ...
  constructor(
    ...
    serializer: __OperationSerializer<RestJsonService<Context>, "IgnoreQueryParamsInResponse", IgnoreQueryParamsInResponseErrors>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "IgnoreQueryParamsInResponse" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (IgnoreQueryParamsInResponseServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "IgnoreQueryParamsInResponse" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as IgnoreQueryParamsInResponseServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as IgnoreQueryParamsInResponseServerOutput, serdeContextBase),
