...
export type MalformedAcceptWithBody<Context> = __Operation<MalformedAcceptWithBodyServerInput, MalformedAcceptWithBodyServerOutput, Context>
...
export class MalformedAcceptWithBodySerializer implements __OperationSerializer<RestJsonService<any>, "MalformedAcceptWithBody", MalformedAcceptWithBodyErrors> {
...
export const getMalformedAcceptWithBodyHandler = <Context>(operation: __Operation<MalformedAcceptWithBodyServerInput, MalformedAcceptWithBodyServerOutput, Context>, customizer: __ValidationCustomizer<"MalformedAcceptWithBody">): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  ...
  return new MalformedAcceptWithBodyHandler(operation, mux, new MalformedAcceptWithBodySerializer(), serializeFrameworkException, customizer);
}
...
export class MalformedAcceptWithBodyHandler<Context> implements __ServiceHandler<Context> {
  ...
  private readonly operation: __Operation<MalformedAcceptWithBodyServerInput, MalformedAcceptWithBodyServerOutput, Context>;
  private readonly serializer: __OperationSerializer<RestJsonService<Context>, "MalformedAcceptWithBody", MalformedAcceptWithBodyErrors>;
  ...
  constructor(
    ...
    serializer: __OperationSerializer<RestJsonService<Context>, "MalformedAcceptWithBody", MalformedAcceptWithBodyErrors>,
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "MalformedAcceptWithBody" : undefined,
      ...
      validate: (_op, input) => {
        const validationFailures = (MalformedAcceptWithBodyServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "MalformedAcceptWithBody" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      },
      invoke: (_op, input, context) => this.operation(input as MalformedAcceptWithBodyServerInput, context),
      serialize: (_op, output) => this.serializer.serialize(output as MalformedAcceptWithBodyServerOutput, serdeContextBase),
