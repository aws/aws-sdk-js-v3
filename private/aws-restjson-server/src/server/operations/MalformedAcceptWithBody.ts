...
export class MalformedAcceptWithBodyHandler<Context> implements __ServiceHandler<Context> {
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    ...
    if (target === undefined) {
      console.log('Received a request that did not match aws.protocoltests.restjson#RestJson.MalformedAcceptWithBody. This indicates a misconfiguration.');
      return this.serializeFrameworkException(new __InternalFailureException(), serdeContextBase);
    }
    return handle(request, context, "MalformedAcceptWithBody", this.serializer, this.operation, this.serializeFrameworkException, MalformedAcceptWithBodyServerInput.validate, this.validationCustomizer);
  }
}
