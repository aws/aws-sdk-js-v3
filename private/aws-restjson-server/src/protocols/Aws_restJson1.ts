...
export const deserializeHostWithPathOperationRequest = async (
  ...
  const contents: HostWithPathOperationServerInput = {};
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
export const deserializeHttpChecksumRequiredRequest = async (
  ...
  const contents: HttpChecksumRequiredServerInput = {
    foo: undefined,
  };
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
...
export const deserializeHttpPrefixHeadersInResponseRequest = async (
  ...
  const contents: HttpPrefixHeadersInResponseServerInput = {};
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
export const deserializeHttpRequestWithRegexLiteralRequest = async (
  ...
  const contents: HttpRequestWithRegexLiteralServerInput = {
    str: undefined,
  };
...
export const deserializeMalformedAcceptWithBodyRequest = async (
  ...
  const contents: MalformedAcceptWithBodyServerInput = {};
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
export const deserializeMalformedAcceptWithPayloadRequest = async (
  ...
  const contents: MalformedAcceptWithPayloadServerInput = {};
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
export const deserializeMalformedBlobRequest = async (
  ...
  const contents: MalformedBlobServerInput = {
    blob: undefined,
  };
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
...
export const deserializeMalformedBooleanRequest = async (
  ...
  const contents: MalformedBooleanServerInput = {
    booleanInBody: undefined,
    booleanInHeader: undefined,
    booleanInPath: undefined,
    booleanInQuery: undefined,
  };
  const query = output.query;
  if (query !== undefined && query !== null) {
  ...
  if (output.headers["booleaninheader"] !== undefined) {
    contents.booleanInHeader = __parseBoolean(output.headers["booleaninheader"]);
  }
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
  if (data.booleanInBody !== undefined && data.booleanInBody !== null) {
...
export const deserializeMalformedByteRequest = async (
  ...
  const contents: MalformedByteServerInput = {
    byteInBody: undefined,
    byteInHeader: undefined,
    byteInPath: undefined,
    byteInQuery: undefined,
  };
  const query = output.query;
  if (query !== undefined && query !== null) {
  ...
  if (output.headers["byteinheader"] !== undefined) {
    contents.byteInHeader = __strictParseByte(output.headers["byteinheader"]);
  }
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
  if (data.byteInBody !== undefined && data.byteInBody !== null) {
...
export const deserializeMalformedContentTypeWithBodyRequest = async (
  ...
  const contents: MalformedContentTypeWithBodyServerInput = {
    hi: undefined,
  };
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
...
export const deserializeMalformedContentTypeWithGenericStringRequest = async (
  ...
  const contents: MalformedContentTypeWithGenericStringServerInput = {
    payload: undefined,
  };
  const data: any = await collectBodyString(output.body, context);
  contents.payload = __expectString(data);
...
export const deserializeMalformedContentTypeWithoutBodyRequest = async (
  ...
  const contents: MalformedContentTypeWithoutBodyServerInput = {};
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
export const deserializeMalformedContentTypeWithPayloadRequest = async (
  ...
  const contents: MalformedContentTypeWithPayloadServerInput = {
    payload: undefined,
  };
  const data: any = await collectBody(output.body, context);
  contents.payload = data;
...
export const deserializeMalformedDoubleRequest = async (
  ...
  const contents: MalformedDoubleServerInput = {
    doubleInBody: undefined,
    doubleInHeader: undefined,
    doubleInPath: undefined,
    doubleInQuery: undefined,
  };
  const query = output.query;
  if (query !== undefined && query !== null) {
  ...
  if (output.headers["doubleinheader"] !== undefined) {
    contents.doubleInHeader = __strictParseDouble(output.headers["doubleinheader"]);
  }
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
  if (data.doubleInBody !== undefined && data.doubleInBody !== null) {
...
export const deserializeMalformedFloatRequest = async (
  ...
  const contents: MalformedFloatServerInput = {
    floatInBody: undefined,
    floatInHeader: undefined,
    floatInPath: undefined,
    floatInQuery: undefined,
  };
  const query = output.query;
  if (query !== undefined && query !== null) {
  ...
  if (output.headers["floatinheader"] !== undefined) {
    contents.floatInHeader = __strictParseFloat(output.headers["floatinheader"]);
  }
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
  if (data.floatInBody !== undefined && data.floatInBody !== null) {
...
export const deserializeMalformedIntegerRequest = async (
  ...
  const contents: MalformedIntegerServerInput = {
    integerInBody: undefined,
    integerInHeader: undefined,
    integerInPath: undefined,
    integerInQuery: undefined,
  };
  const query = output.query;
  if (query !== undefined && query !== null) {
  ...
  if (output.headers["integerinheader"] !== undefined) {
    contents.integerInHeader = __strictParseInt32(output.headers["integerinheader"]);
  }
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
  if (data.integerInBody !== undefined && data.integerInBody !== null) {
...
export const deserializeMalformedListRequest = async (
  ...
  const contents: MalformedListServerInput = {
    bodyList: undefined,
  };
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
  if (data.bodyList !== undefined && data.bodyList !== null) {
...
export const deserializeMalformedLongRequest = async (
  ...
  const contents: MalformedLongServerInput = {
    longInBody: undefined,
    longInHeader: undefined,
    longInPath: undefined,
    longInQuery: undefined,
  };
  const query = output.query;
  if (query !== undefined && query !== null) {
  ...
  if (output.headers["longinheader"] !== undefined) {
    contents.longInHeader = __strictParseLong(output.headers["longinheader"]);
  }
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
  if (data.longInBody !== undefined && data.longInBody !== null) {
...
export const deserializeMalformedMapRequest = async (
  ...
  const contents: MalformedMapServerInput = {
    bodyMap: undefined,
  };
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
  if (data.bodyMap !== undefined && data.bodyMap !== null) {
...
export const deserializeMalformedRequestBodyRequest = async (
  ...
  const contents: MalformedRequestBodyServerInput = {
    float: undefined,
    int: undefined,
  };
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
  ...
  if (data.int !== undefined && data.int !== null) {
...
export const deserializeMalformedShortRequest = async (
  ...
  const contents: MalformedShortServerInput = {
    shortInBody: undefined,
    shortInHeader: undefined,
    shortInPath: undefined,
    shortInQuery: undefined,
  };
  const query = output.query;
  if (query !== undefined && query !== null) {
  ...
  if (output.headers["shortinheader"] !== undefined) {
    contents.shortInHeader = __strictParseShort(output.headers["shortinheader"]);
  }
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
  if (data.shortInBody !== undefined && data.shortInBody !== null) {
...
export const deserializeMalformedStringRequest = async (
  ...
  const contents: MalformedStringServerInput = {
    blob: undefined,
  };
  if (output.headers["amz-media-typed-header"] !== undefined) {
    contents.blob = new __LazyJsonString(
...
export const deserializeMalformedTimestampBodyDateTimeRequest = async (
  ...
  const contents: MalformedTimestampBodyDateTimeServerInput = {
    timestamp: undefined,
  };
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
...
export const deserializeMalformedTimestampBodyDefaultRequest = async (
  ...
  const contents: MalformedTimestampBodyDefaultServerInput = {
    timestamp: undefined,
  };
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
  if (data.timestamp !== undefined && data.timestamp !== null) {
...
export const deserializeMalformedTimestampBodyHttpDateRequest = async (
  ...
  const contents: MalformedTimestampBodyHttpDateServerInput = {
    timestamp: undefined,
  };
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
  if (data.timestamp !== undefined && data.timestamp !== null) {
...
export const deserializeMalformedTimestampHeaderDateTimeRequest = async (
  ...
  const contents: MalformedTimestampHeaderDateTimeServerInput = {
    timestamp: undefined,
  };
  if (output.headers["timestamp"] !== undefined) {
    contents.timestamp = __expectNonNull(__parseRfc3339DateTime(output.headers["timestamp"]));
  }
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
export const deserializeMalformedTimestampHeaderDefaultRequest = async (
  ...
  const contents: MalformedTimestampHeaderDefaultServerInput = {
    timestamp: undefined,
  };
  if (output.headers["timestamp"] !== undefined) {
    contents.timestamp = __expectNonNull(__parseRfc7231DateTime(output.headers["timestamp"]));
  }
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
export const deserializeMalformedTimestampHeaderEpochRequest = async (
  ...
  const contents: MalformedTimestampHeaderEpochServerInput = {
    timestamp: undefined,
  };
  if (output.headers["timestamp"] !== undefined) {
    contents.timestamp = __expectNonNull(__parseEpochTimestamp(output.headers["timestamp"]));
  }
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
export const deserializeMalformedTimestampPathDefaultRequest = async (
  ...
  const contents: MalformedTimestampPathDefaultServerInput = {
    timestamp: undefined,
  };
...
export const deserializeMalformedTimestampPathEpochRequest = async (
  ...
  const contents: MalformedTimestampPathEpochServerInput = {
    timestamp: undefined,
  };
...
export const deserializeMalformedTimestampPathHttpDateRequest = async (
  ...
  const contents: MalformedTimestampPathHttpDateServerInput = {
    timestamp: undefined,
  };
...
export const deserializeMalformedTimestampQueryDefaultRequest = async (
  ...
  const contents: MalformedTimestampQueryDefaultServerInput = {
    timestamp: undefined,
  };
  const query = output.query;
  if (query !== undefined && query !== null) {
...
export const deserializeMalformedTimestampQueryEpochRequest = async (
  ...
  const contents: MalformedTimestampQueryEpochServerInput = {
    timestamp: undefined,
  };
  const query = output.query;
  if (query !== undefined && query !== null) {
...
export const deserializeMalformedTimestampQueryHttpDateRequest = async (
  ...
  const contents: MalformedTimestampQueryHttpDateServerInput = {
    timestamp: undefined,
  };
  const query = output.query;
  if (query !== undefined && query !== null) {
...
export const deserializeMalformedUnionRequest = async (
  ...
  const contents: MalformedUnionServerInput = {
    union: undefined,
  };
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
...
export const deserializePostPlayerActionRequest = async (
  ...
  const contents: PostPlayerActionServerInput = {
    action: undefined,
  };
  const data: { [key: string]: any } = __expectNonNull(__expectObject(await parseBody(output.body, context)), "body");
...
export const deserializeTestBodyStructureRequest = async (
  ...
  const contents: TestBodyStructureServerInput = {
...
export const deserializeTestNoPayloadRequest = async (
  ...
  const contents: TestNoPayloadServerInput = {
    testId: undefined,
  };
  if (output.headers["x-amz-test-id"] !== undefined) {
    contents.testId = output.headers["x-amz-test-id"];
...
export const deserializeTestPayloadBlobRequest = async (
  ...
  const contents: TestPayloadBlobServerInput = {
...
export const deserializeTestPayloadStructureRequest = async (
  ...
  const contents: TestPayloadStructureServerInput = {
...
export const deserializeUnitInputAndOutputRequest = async (
  ...
  const contents: UnitInputAndOutputServerInput = {};
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
const deserializeAws_restJson1SimpleMap = (output: any, context: __SerdeContext): { [key: string]: string } => {
  return Object.entries(output).reduce((acc: { [key: string]: string }, [key, value]: [string, any]) => {
    if (value === null) {
      return acc;
    }
...
const deserializeAws_restJson1SimpleSet = (output: any, context: __SerdeContext): string[] => {
  const retVal = (output || []).map((entry: any) => {
    if (entry === null) {
      throw new TypeError(
        'All elements of the non-sparse list "aws.protocoltests.restjson#SimpleSet" must be non-null.'
      );
    }
    return __expectString(entry) as any;
  });
