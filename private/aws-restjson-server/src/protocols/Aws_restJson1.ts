...
export const deserializeAllQueryStringTypesRequest = async (
  ...
  if (query != null) {
    ...
    if (query["StringList"] !== undefined) {
      const queryValue = Array.isArray(query["StringList"]) ? (query["StringList"] as string[]) : [query["StringList"] as string];
      contents.queryStringList = queryValue;
    }
    if (query["StringSet"] !== undefined) {
      const queryValue = Array.isArray(query["StringSet"]) ? (query["StringSet"] as string[]) : [query["StringSet"] as string];
    ...
    if (query["IntegerList"] !== undefined) {
      const queryValue = Array.isArray(query["IntegerList"]) ? (query["IntegerList"] as string[]) : [query["IntegerList"] as string];
      contents.queryIntegerList = queryValue.map(_entry => __strictParseInt32(_entry) as any);
    }
    if (query["IntegerSet"] !== undefined) {
      const queryValue = Array.isArray(query["IntegerSet"]) ? (query["IntegerSet"] as string[]) : [query["IntegerSet"] as string];
    ...
    if (query["DoubleList"] !== undefined) {
      const queryValue = Array.isArray(query["DoubleList"]) ? (query["DoubleList"] as string[]) : [query["DoubleList"] as string];
    ...
    if (query["BooleanList"] !== undefined) {
      const queryValue = Array.isArray(query["BooleanList"]) ? (query["BooleanList"] as string[]) : [query["BooleanList"] as string];
    ...
    if (query["TimestampList"] !== undefined) {
      const queryValue = Array.isArray(query["TimestampList"]) ? (query["TimestampList"] as string[]) : [query["TimestampList"] as string];
    ...
    if (query["EnumList"] !== undefined) {
      const queryValue = Array.isArray(query["EnumList"]) ? (query["EnumList"] as string[]) : [query["EnumList"] as string];
    ...
    if (query["IntegerEnumList"] !== undefined) {
      const queryValue = Array.isArray(query["IntegerEnumList"]) ? (query["IntegerEnumList"] as string[]) : [query["IntegerEnumList"] as string];
...
export const deserializeHttpEmptyPrefixHeadersRequest = async (
  ...
  export const deserializeHttpPrefixHeadersRequest = async (
    ...
    export const deserializeHttpRequestWithLabelsRequest = async (
      ...
      const pathRegex = new RegExp("/HttpRequestWithLabels/(?<string>[^/]+)/(?<short>[^/]+)/(?<integer>[^/]+)/(?<long>[^/]+)/(?<float>[^/]+)/(?<double>[^/]+)/(?<boolean>[^/]+)/(?<timestamp>[^/]+)");
      const parsedPath = output.path.match(pathRegex);
      if (parsedPath?.groups !== undefined) {
    ...
    export const deserializeHttpRequestWithLabelsAndTimestampFormatRequest = async (
      ...
      const pathRegex = new RegExp("/HttpRequestWithLabelsAndTimestampFormat/(?<memberEpochSeconds>[^/]+)/(?<memberHttpDate>[^/]+)/(?<memberDateTime>[^/]+)/(?<defaultFormat>[^/]+)/(?<targetEpochSeconds>[^/]+)/(?<targetHttpDate>[^/]+)/(?<targetDateTime>[^/]+)");
      const parsedPath = output.path.match(pathRegex);
      if (parsedPath?.groups !== undefined) {
        contents.memberEpochSeconds = __expectNonNull(__parseEpochTimestamp(decodeURIComponent(parsedPath.groups.memberEpochSeconds)));
        contents.memberHttpDate = __expectNonNull(__parseRfc7231DateTime(decodeURIComponent(parsedPath.groups.memberHttpDate)));
        contents.memberDateTime = __expectNonNull(__parseRfc3339DateTime(decodeURIComponent(parsedPath.groups.memberDateTime)));
        contents.defaultFormat = __expectNonNull(__parseRfc3339DateTime(decodeURIComponent(parsedPath.groups.defaultFormat)));
        contents.targetEpochSeconds = __expectNonNull(__parseEpochTimestamp(decodeURIComponent(parsedPath.groups.targetEpochSeconds)));
        contents.targetHttpDate = __expectNonNull(__parseRfc7231DateTime(decodeURIComponent(parsedPath.groups.targetHttpDate)));
        contents.targetDateTime = __expectNonNull(__parseRfc3339DateTime(decodeURIComponent(parsedPath.groups.targetDateTime)));
      }
      await collectBody(output.body, context);
      return contents;
    };
    ...
    export const deserializeMalformedStringRequest = async (
      ...
      const contents: any = map({
        [_bl]: [() => void 0 !== output.headers[_amth], () => __LazyJsonString.from(Buffer.from(context.base64Decoder(output.headers[_amth])).toString('utf8'))],
      });
      await collectBody(output.body, context);
      return contents;
    };
    ...
    export const deserializeTimestampFormatHeadersRequest = async (
      ...
      const contents: any = map({
        ...
        [_mDT]: [() => void 0 !== output.headers[_xm__], () => __expectNonNull(__parseRfc3339DateTime(output.headers[_xm__]))],
        ...
        [_tDT]: [() => void 0 !== output.headers[_xt___], () => __expectNonNull(__parseRfc3339DateTime(output.headers[_xt___]))],
      });
      await collectBody(output.body, context);
      return contents;
    };
              ...
              const se_StringPayloadEvent_event = (
                ...
                const se_StructurePayloadEvent_event = (
                  ...
                  const se_UnionPayloadEvent_event = (
                     ...
                     */
                    const se_HeadersAndExplicitPayloadEvent = (
                      input: HeadersAndExplicitPayloadEvent,
                      context: __SerdeContext
                    ): any => {
                      return take(input, {
                     ...
                     */
                    const se_HeadersAndImplicitPayloadEvent = (
                      input: HeadersAndImplicitPayloadEvent,
                      context: __SerdeContext
                    ): any => {
                      return take(input, {
                     ...
                     */
                    const se_PayloadStructure = (
                      input: PayloadStructure,
                      context: __SerdeContext
                    ): any => {
                      return take(input, {
                        'structureMember': [],
                     ...
                     */
                    const se_SingletonEvent = (
                      input: SingletonEvent,
                      context: __SerdeContext
                    ): any => {
                      return take(input, {
                        'value': [],
                     ...
                     */
                    const se_SingletonEventStream = (
                      input: SingletonEventStream,
                      context: __SerdeContext
                    ): any => {
                     ...
                     */
                    const se_StructurePayloadEvent = (
                      input: StructurePayloadEvent,
                      context: __SerdeContext
                    ): any => {
                      return take(input, {
                     ...
                     */
                    const se_RenamedGreeting = (
                      input: RenamedGreeting,
                      context: __SerdeContext
                    ): any => {
                      return take(input, {
                        'salutation': [],
                     ...
                     */
                    const de_ClientOptionalDefaults = (
                      output: any,
                      context: __SerdeContext
                    ): ClientOptionalDefaults => {
                      return take(output, {
                    ...
                    const de_DialogList = (
                      ...
                      const retVal = (output || []).map((entry: any) => {
                        if (entry === null) {
                          throw new TypeError('All elements of the non-sparse list "aws.protocoltests.restjson#DialogList" must be non-null.');
                        }
                     ...
                     */
                    const de_HeadersAndExplicitPayloadEvent = (
                      output: any,
                      context: __SerdeContext
                    ): HeadersAndExplicitPayloadEvent => {
                      return take(output, {
                     ...
                     */
                    const de_HeadersAndImplicitPayloadEvent = (
                      output: any,
                      context: __SerdeContext
                    ): HeadersAndImplicitPayloadEvent => {
                      return take(output, {
                    ...
                    const de_SimpleList = (
                      ...
                      const retVal = (output || []).map((entry: any) => {
                        if (entry === null) {
                          throw new TypeError('All elements of the non-sparse list "aws.protocoltests.restjson#SimpleList" must be non-null.');
                        }
                    ...
                    const de_StructureList = (
                      ...
                      const retVal = (output || []).map((entry: any) => {
                        if (entry === null) {
                          throw new TypeError('All elements of the non-sparse list "aws.protocoltests.restjson#StructureList" must be non-null.');
                        }
                     ...
                     */
                    const de_StructurePayloadEvent = (
                      output: any,
                      context: __SerdeContext
                    ): StructurePayloadEvent => {
                      return take(output, {
                    ...
                    const de_TestStringList = (
                      ...
                      const retVal = (output || []).map((entry: any) => {
                        if (entry === null) {
                          throw new TypeError('All elements of the non-sparse list "aws.protocoltests.restjson#TestStringList" must be non-null.');
                        }
                        return __expectString(entry) as any;
                      });
                      return retVal;
                    ...
                    const de_BooleanList = (
                      ...
                      const retVal = (output || []).map((entry: any) => {
                        if (entry === null) {
                          throw new TypeError('All elements of the non-sparse list "aws.protocoltests.shared#BooleanList" must be non-null.');
                        }
                    ...
                    const de_FooEnumList = (
                      ...
                      const retVal = (output || []).map((entry: any) => {
                        if (entry === null) {
                          throw new TypeError('All elements of the non-sparse list "aws.protocoltests.shared#FooEnumList" must be non-null.');
                        }
                        return __expectString(entry) as any;
                      });
                      return retVal;
                    ...
                    const de_IntegerEnumList = (
                      ...
                      const retVal = (output || []).map((entry: any) => {
                        if (entry === null) {
                          throw new TypeError('All elements of the non-sparse list "aws.protocoltests.shared#IntegerEnumList" must be non-null.');
                        }
                    ...
                    const de_IntegerList = (
                      ...
                      const retVal = (output || []).map((entry: any) => {
                        if (entry === null) {
                          throw new TypeError('All elements of the non-sparse list "aws.protocoltests.shared#IntegerList" must be non-null.');
                        }
                        return __expectInt32(entry) as any;
                      });
                      return retVal;
                    ...
                    const de_NestedStringList = (
                      ...
                      const retVal = (output || []).map((entry: any) => {
                        if (entry === null) {
                          throw new TypeError('All elements of the non-sparse list "aws.protocoltests.shared#NestedStringList" must be non-null.');
                        }
                    ...
                    const de_TimestampList = (
                      ...
                      const retVal = (output || []).map((entry: any) => {
                        if (entry === null) {
                          throw new TypeError('All elements of the non-sparse list "aws.protocoltests.shared#TimestampList" must be non-null.');
                        }
