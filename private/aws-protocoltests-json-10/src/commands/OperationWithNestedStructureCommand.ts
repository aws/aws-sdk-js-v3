...
> {
   ...
   * @public
   */
  constructor(readonly input: OperationWithNestedStructureCommandInput) {
    super();
  }
  ...
  resolveMiddleware(
  ...
  ): Handler<OperationWithNestedStructureCommandInput, OperationWithNestedStructureCommandOutput> {
    ...
    const commandName = "OperationWithNestedStructureCommand";
   ...
   * @internal
   */
  private serialize(input: OperationWithNestedStructureCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return se_OperationWithNestedStructureCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_OperationWithNestedStructureCommand(output, context);
  }
}
