...
const serializeAws_json1_1JsonEnumsInputOutput = (input: JsonEnumsInputOutput, context: __SerdeContext): any => {
  return {
    ...
    ...(input.fooEnumList != undefined && { fooEnumList: serializeAws_json1_1FooEnumList(input.fooEnumList, context) }),
    ...(input.fooEnumMap != undefined && { fooEnumMap: serializeAws_json1_1FooEnumMap(input.fooEnumMap, context) }),
    ...(input.fooEnumSet != undefined && { fooEnumSet: serializeAws_json1_1FooEnumSet(input.fooEnumSet, context) }),
  };
};
...
const serializeAws_json1_1KitchenSink = (input: KitchenSink, context: __SerdeContext): any => {
  return {
    ...
    ...(input.Double != undefined && { Double: __serializeFloat(input.Double) }),
    ...(input.EmptyStruct != undefined && { EmptyStruct: serializeAws_json1_1EmptyStruct(input.EmptyStruct, context) }),
    ...(input.Float != undefined && { Float: __serializeFloat(input.Float) }),
    ...
    ...(input.MapOfMaps != undefined && { MapOfMaps: serializeAws_json1_1MapOfMapOfStrings(input.MapOfMaps, context) }),
...
const serializeAws_json1_1UnionInputOutput = (input: UnionInputOutput, context: __SerdeContext): any => {
  return {
    ...(input.contents != undefined && { contents: serializeAws_json1_1MyUnion(input.contents, context) }),
  };
};
...
const deserializeAws_json1_1ComplexError = (output: any, context: __SerdeContext): ComplexError => {
  return {
    Nested:
      output.Nested != undefined ? deserializeAws_json1_1ComplexNestedErrorData(output.Nested, context) : undefined,
...
const deserializeAws_json1_1ErrorWithMembers = (output: any, context: __SerdeContext): ErrorWithMembers => {
  return {
    ...
    ComplexData:
      output.ComplexData != undefined ? deserializeAws_json1_1KitchenSink(output.ComplexData, context) : undefined,
    IntegerField: __expectInt32(output.IntegerField),
    ListField:
      output.ListField != undefined ? deserializeAws_json1_1ListOfStrings(output.ListField, context) : undefined,
    MapField: output.MapField != undefined ? deserializeAws_json1_1MapOfStrings(output.MapField, context) : undefined,
...
const deserializeAws_json1_1JsonEnumsInputOutput = (output: any, context: __SerdeContext): JsonEnumsInputOutput => {
  return {
    ...
    fooEnumList:
      output.fooEnumList != undefined ? deserializeAws_json1_1FooEnumList(output.fooEnumList, context) : undefined,
    fooEnumMap:
      output.fooEnumMap != undefined ? deserializeAws_json1_1FooEnumMap(output.fooEnumMap, context) : undefined,
    fooEnumSet:
      output.fooEnumSet != undefined ? deserializeAws_json1_1FooEnumSet(output.fooEnumSet, context) : undefined,
  } as any;
};

const deserializeAws_json1_1KitchenSink = (output: any, context: __SerdeContext): KitchenSink => {
  return {
    Blob: output.Blob != undefined ? context.base64Decoder(output.Blob) : undefined,
    Boolean: __expectBoolean(output.Boolean),
    Double: __limitedParseDouble(output.Double),
    EmptyStruct:
      output.EmptyStruct != undefined ? deserializeAws_json1_1EmptyStruct(output.EmptyStruct, context) : undefined,
    ...
    Iso8601Timestamp:
      output.Iso8601Timestamp != undefined
        ...
        : undefined,
    JsonValue: output.JsonValue != undefined ? new __LazyJsonString(output.JsonValue) : undefined,
    ListOfLists:
      output.ListOfLists != undefined
    ...
    MapOfListsOfStrings:
      output.MapOfListsOfStrings != undefined
        ...
        : undefined,
    MapOfMaps:
      output.MapOfMaps != undefined ? deserializeAws_json1_1MapOfMapOfStrings(output.MapOfMaps, context) : undefined,
    MapOfStrings:
      output.MapOfStrings != undefined ? deserializeAws_json1_1MapOfStrings(output.MapOfStrings, context) : undefined,
    MapOfStructs:
      output.MapOfStructs != undefined ? deserializeAws_json1_1MapOfStructs(output.MapOfStructs, context) : undefined,
    RecursiveList:
      output.RecursiveList != undefined
        ? deserializeAws_json1_1ListOfKitchenSinks(output.RecursiveList, context)
        : undefined,
    RecursiveMap:
      output.RecursiveMap != undefined
        ? deserializeAws_json1_1MapOfKitchenSinks(output.RecursiveMap, context)
        : undefined,
    RecursiveStruct:
      output.RecursiveStruct != undefined
        ? deserializeAws_json1_1KitchenSink(output.RecursiveStruct, context)
        : undefined,
    SimpleStruct:
      output.SimpleStruct != undefined ? deserializeAws_json1_1SimpleStruct(output.SimpleStruct, context) : undefined,
    String: __expectString(output.String),
    StructWithJsonName:
      output.StructWithJsonName != undefined
    ...
    Timestamp:
      output.Timestamp != undefined
        ...
        : undefined,
    UnixTimestamp:
      output.UnixTimestamp != undefined
...
const deserializeAws_json1_1PutAndGetInlineDocumentsInputOutput = (
  ...
  return {
    inlineDocument:
      output.inlineDocument != undefined ? deserializeAws_json1_1Document(output.inlineDocument, context) : undefined,
  } as any;
};
...
const deserializeAws_json1_1UnionInputOutput = (output: any, context: __SerdeContext): UnionInputOutput => {
  return {
    contents:
      output.contents != undefined ? deserializeAws_json1_1MyUnion(__expectUnion(output.contents), context) : undefined,
  } as any;
};
