...
/**
 * The user didn't apply an encoding, so the SDK applies gzip
 */
...
/**
 * The user provided a content-encoding so the SDK appends gzip
 */
it("SDKAppendedGzipAfterProvidedEncoding_awsJson1_1:Request", async () => {
  const client = new JsonProtocolClient({
    ...clientParams,
    requestHandler: new RequestSerializationTestHandler(),
  });
