...
export var GetRestApisRequest$: StaticStructureSchema = [3, n0, _GRAR,
  0,
  [_p, _l],
  [[0, { [_hQ]: _p }], [1, { [_hQ]: _l }]]
];
...
export var GetRestApis$: StaticOperationSchema = [9, n0, _GRA,
  { [_h]: ["GET", "/restapis", 200] }, () => GetRestApisRequest$, () => RestApis$
];
