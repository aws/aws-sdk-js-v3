 ...
 * ```javascript
 * import { S3Client, ListObjectsV2Command } from "@aws-sdk/aws-protocoltests-restxml-schema-s3"; // ES Modules import
 * // const { S3Client, ListObjectsV2Command } = require("@aws-sdk/aws-protocoltests-restxml-schema-s3"); // CommonJS import
