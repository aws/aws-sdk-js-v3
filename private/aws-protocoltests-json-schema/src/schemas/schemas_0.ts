...
var ListOfKitchenSinks: StaticListSchema = [1, n0, _LOKS, 0, [() => KitchenSink$, 0]];
var ListOfListOfStrings: StaticListSchema = [1, n0, _LOLOS, 0, 64 | 0];
var ListOfMapsOfStrings: StaticListSchema = [1, n0, _LOMOS, 0, 128 | 0];
var ListOfStrings = 64 | 0;
var ListOfStructs: StaticListSchema = [1, n0, _LOSi, 0, () => SimpleStruct$];
var FooEnumList = 64 | 0;
var FooEnumSet = 64 | 0;
var IntegerEnumList = 64 | 1;
var IntegerEnumSet = 64 | 1;
var SparseStringList: StaticListSchema = [1, n1, _SSL, { [_sp]: 1 }, 0];
var StringList = 64 | 0;
var MapOfKitchenSinks: StaticMapSchema = [2, n0, _MOKS, 0, [0, 0], [() => KitchenSink$, 0]];
var MapOfListsOfStrings: StaticMapSchema = [2, n0, _MOLOS, 0, 0, 64 | 0];
var MapOfMapOfStrings: StaticMapSchema = [2, n0, _MOMOS, 0, 0, 128 | 0];
var MapOfStrings = 128 | 0;
var MapOfStructs: StaticMapSchema = [2, n0, _MOSa, 0, 0, () => SimpleStruct$];
