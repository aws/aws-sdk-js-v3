...
import type { RestJsonProtocolExtensionConfiguration } from "./extensionConfiguration";
...
export const resolveRuntimeExtensions = (runtimeConfig: any, extensions: RuntimeExtension[]) => {
  const extensionConfiguration: RestJsonProtocolExtensionConfiguration = Object.assign(
