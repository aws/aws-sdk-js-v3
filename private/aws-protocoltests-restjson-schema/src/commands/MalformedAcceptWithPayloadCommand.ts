...
import type { MalformedAcceptWithPayloadOutput } from "../models/models_0";
 ...
 *
 */
export class MalformedAcceptWithPayloadCommand extends command<MalformedAcceptWithPayloadCommandInput, MalformedAcceptWithPayloadCommandOutput>(
  _ep0,
  _mw0,
