...
import { HttpRequestWithRegexLiteral$ } from "../schemas/schemas_0";
 ...
 *
 */
export class HttpRequestWithRegexLiteralCommand extends command<HttpRequestWithRegexLiteralCommandInput, HttpRequestWithRegexLiteralCommandOutput>(
  _ep0,
  _mw0,
