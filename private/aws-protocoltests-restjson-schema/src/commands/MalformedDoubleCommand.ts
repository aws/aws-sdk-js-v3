...
import type { MalformedDoubleInput } from "../models/models_0";
import { MalformedDouble$ } from "../schemas/schemas_0";
 ...
 *
 */
export class MalformedDoubleCommand extends command<MalformedDoubleCommandInput, MalformedDoubleCommandOutput>(
  _ep0,
  _mw0,
  "MalformedDouble",
  MalformedDouble$
