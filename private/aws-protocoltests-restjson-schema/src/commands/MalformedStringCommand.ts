...
import { MalformedString$ } from "../schemas/schemas_0";
 ...
 *
 */
export class MalformedStringCommand extends command<MalformedStringCommandInput, MalformedStringCommandOutput>(
  _ep0,
  _mw0,
  "MalformedString",
  MalformedString$
