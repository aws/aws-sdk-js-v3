 ...
 *
 */
export class MalformedTimestampHeaderDateTimeCommand extends command<MalformedTimestampHeaderDateTimeCommandInput, MalformedTimestampHeaderDateTimeCommandOutput>(
  _ep0,
  _mw0,
