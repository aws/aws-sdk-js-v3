 ...
 * ```javascript
 * import { RestJsonProtocolClient, MalformedAcceptWithBodyCommand } from "@aws-sdk/aws-protocoltests-restjson-schema"; // ES Modules import
 * // const { RestJsonProtocolClient, MalformedAcceptWithBodyCommand } = require("@aws-sdk/aws-protocoltests-restjson-schema"); // CommonJS import
 ...
 *
 */
export class MalformedAcceptWithBodyCommand extends command<MalformedAcceptWithBodyCommandInput, MalformedAcceptWithBodyCommandOutput>(
  _ep0,
  _mw0,
