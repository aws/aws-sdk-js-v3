...
import type { MalformedMapInput } from "../models/models_0";
import { MalformedMap$ } from "../schemas/schemas_0";
 ...
 *
 */
export class MalformedMapCommand extends command<MalformedMapCommandInput, MalformedMapCommandOutput>(
  _ep0,
  _mw0,
  "MalformedMap",
  MalformedMap$
