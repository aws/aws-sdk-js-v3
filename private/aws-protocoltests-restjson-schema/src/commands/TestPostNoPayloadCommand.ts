...
import { TestPostNoPayload$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class TestPostNoPayloadCommand extends command<TestPostNoPayloadCommandInput, TestPostNoPayloadCommandOutput>(
  _ep0,
  _mw0,
  "TestPostNoPayload",
  TestPostNoPayload$
