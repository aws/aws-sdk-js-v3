...
import type { DuplexStreamInput, DuplexStreamOutput } from "../models/models_0";
 ...
 * ```javascript
 * import { RestJsonProtocolClient, DuplexStreamCommand } from "@aws-sdk/aws-protocoltests-restjson-schema"; // ES Modules import
 * // const { RestJsonProtocolClient, DuplexStreamCommand } = require("@aws-sdk/aws-protocoltests-restjson-schema"); // CommonJS import
 ...
 *
 */
export class DuplexStreamCommand extends command<DuplexStreamCommandInput, DuplexStreamCommandOutput>(
  _ep0,
  _mw1,
  "DuplexStream",
  DuplexStream$
