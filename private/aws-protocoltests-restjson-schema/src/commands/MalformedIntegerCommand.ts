...
import type { MalformedIntegerInput } from "../models/models_0";
 ...
 *
 */
export class MalformedIntegerCommand extends command<MalformedIntegerCommandInput, MalformedIntegerCommandOutput>(
  _ep0,
  _mw0,
  "MalformedInteger",
  MalformedInteger$
