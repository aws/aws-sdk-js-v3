...
import type { MalformedTimestampBodyDefaultInput } from "../models/models_0";
import { MalformedTimestampBodyDefault$ } from "../schemas/schemas_0";
 ...
 *
 */
export class MalformedTimestampBodyDefaultCommand extends command<MalformedTimestampBodyDefaultCommandInput, MalformedTimestampBodyDefaultCommandOutput>(
  _ep0,
  _mw0,
