...
import { NullAndEmptyHeadersServer$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class NullAndEmptyHeadersServerCommand extends command<NullAndEmptyHeadersServerCommandInput, NullAndEmptyHeadersServerCommandOutput>(
  _ep0,
  _mw0,
