...
import type { BodyWithXmlNameInputOutput } from "../models/models_0";
import { BodyWithXmlName$ } from "../schemas/schemas_0";
 ...
 * @public
 */
export class BodyWithXmlNameCommand extends command<BodyWithXmlNameCommandInput, BodyWithXmlNameCommandOutput>(
  _ep0,
  _mw0,
  "BodyWithXmlName",
  BodyWithXmlName$
