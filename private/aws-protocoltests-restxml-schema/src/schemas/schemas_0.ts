...
export var RestXmlProtocolServiceException$: StaticErrorSchema = [
  -3,
  _sm,
...
var ListWithMemberNamespace: StaticListSchema = [1, n1, _LWMN, { [_xNm]: [_, _hl] }, [0, { [_xNm]: [_, _hm_] }]];
var ListWithNamespace: StaticListSchema = [1, n1, _LWN, { [_xNm]: [_, _hl] }, 0];
var RenamedListMembers: StaticListSchema = [1, n1, _RLM, 0, [0, { [_xN]: _it }]];
var StructureList: StaticListSchema = [1, n1, _SLt, 0, [() => StructureListMember$, { [_xN]: _it }]];
var XmlNamespacedList: StaticListSchema = [1, n1, _XNL, 0, [0, { [_xNm]: [_, _httpb] }]];
...
var IntegerSet = 64 | 1;
var NestedStringList: StaticListSchema = [1, n0, _NSL, 0, 64 | 0];
var StringList = 64 | 0;
var StringSet = 64 | 0;
var TimestampList = 64 | 4;
var FlattenedXmlMapWithXmlNameInputOutputMap: StaticMapSchema = [
  2,
  n1,
  _FXMWXNIOM,
  0,
...
var FlattenedXmlMapWithXmlNamespaceOutputMap: StaticMapSchema = [
  2,
  n1,
  _FXMWXNOM,
  0,
...
var NestedMap: StaticMapSchema = [2, n1, _NM, 0, 0, 128 | 0];
var NestedXmlMapWithXmlNameInnerMap: StaticMapSchema = [2, n1, _NXMWXNIM, 0, [0, { [_xN]: _IK }], [0, { [_xN]: _IV }]];
var NestedXmlMapWithXmlNameMap: StaticMapSchema = [
  2,
  n1,
  _NXMWXNM,
  0,
...
var XmlMapsInputOutputMap: StaticMapSchema = [2, n1, _XMIOM, 0, 0, () => GreetingStruct$];
var XmlMapsXmlNameInputOutputMap: StaticMapSchema = [
  2,
  n1,
  _XMXNIOM,
  0,
...
var XmlMapWithXmlNamespaceInputOutputMap: StaticMapSchema = [
  2,
  n1,
  _XMWXNIOM,
  0,
...
var StringListMap: StaticMapSchema = [2, n0, _SLM, 0, 0, 64 | 0];
var StringMap = 128 | 0;
export var UnionPayload$: StaticUnionSchema = [4, n1, _UP, 0, [_g], [0]];
export var XmlUnionShape$: StaticUnionSchema = [
  4,
  n1,
  _XUS,
  0,
...
export var EndpointOperation$: StaticOperationSchema = [
  ...
  n1,
  _EO,
  { [_end]: ["foo."], [_http_]: ["POST", "/EndpointOperation", 200] },
  () => __Unit,
  () => __Unit,
];
export var EndpointWithHostLabelHeaderOperation$: StaticOperationSchema = [
  ...
  n1,
  _EWHLHO,
  { [_end]: ["{accountId}."], [_http_]: ["POST", "/EndpointWithHostLabelHeaderOperation", 200] },
...
export var EndpointWithHostLabelOperation$: StaticOperationSchema = [
  ...
  n1,
  _EWHLO,
  { [_end]: ["foo.{label}."], [_http_]: ["POST", "/EndpointWithHostLabelOperation", 200] },
