 ...
 * ```javascript
 * import { RpcV2ProtocolClient, FractionalSecondsCommand } from "@aws-sdk/smithy-rpcv2-cbor"; // ES Modules import
 * // const { RpcV2ProtocolClient, FractionalSecondsCommand } = require("@aws-sdk/smithy-rpcv2-cbor"); // CommonJS import
