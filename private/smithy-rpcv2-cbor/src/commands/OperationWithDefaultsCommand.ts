 ...
 * ```javascript
 * import { RpcV2ProtocolClient, OperationWithDefaultsCommand } from "@aws-sdk/smithy-rpcv2-cbor"; // ES Modules import
 * // const { RpcV2ProtocolClient, OperationWithDefaultsCommand } = require("@aws-sdk/smithy-rpcv2-cbor"); // CommonJS import
