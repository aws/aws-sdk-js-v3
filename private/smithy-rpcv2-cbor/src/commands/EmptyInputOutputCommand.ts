 ...
 * ```javascript
 * import { RpcV2ProtocolClient, EmptyInputOutputCommand } from "@aws-sdk/smithy-rpcv2-cbor"; // ES Modules import
 * // const { RpcV2ProtocolClient, EmptyInputOutputCommand } = require("@aws-sdk/smithy-rpcv2-cbor"); // CommonJS import
