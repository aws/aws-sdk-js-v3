 ...
 * ```javascript
 * import { RpcV2ProtocolClient, RpcV2CborListsCommand } from "@aws-sdk/smithy-rpcv2-cbor"; // ES Modules import
 * // const { RpcV2ProtocolClient, RpcV2CborListsCommand } = require("@aws-sdk/smithy-rpcv2-cbor"); // CommonJS import
