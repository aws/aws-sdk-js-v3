 ...
 * ```javascript
 * import { RpcV2ProtocolClient, OptionalInputOutputCommand } from "@aws-sdk/smithy-rpcv2-cbor"; // ES Modules import
 * // const { RpcV2ProtocolClient, OptionalInputOutputCommand } = require("@aws-sdk/smithy-rpcv2-cbor"); // CommonJS import
