 ...
 * ```javascript
 * import { RpcV2ProtocolClient, NoInputOutputCommand } from "@aws-sdk/smithy-rpcv2-cbor"; // ES Modules import
 * // const { RpcV2ProtocolClient, NoInputOutputCommand } = require("@aws-sdk/smithy-rpcv2-cbor"); // CommonJS import
