...
it("RpcV2CborSimpleScalarProperties:Response", async () => {
  const client = new RpcV2ProtocolClient({
    ...
    requestHandler: new ResponseDeserializationTestHandler(
      ...
      `v3B0cnVlQm9vbGVhblZhbHVl9XFmYWxzZUJvb2xlYW5WYWx1ZfRpYnl0ZVZhbHVlBWtkb3VibGVWYWx1Zfs//jlYEGJN02pmbG9hdFZhbHVl+kDz989saW50ZWdlclZhbHVlGQEAanNob3J0VmFsdWUZJqprc3RyaW5nVmFsdWVmc2ltcGxlaWJsb2JWYWx1ZUNmb2//`
    ),
  });
...
it("RpcV2CborSimpleScalarPropertiesUsingDefiniteLength:Response", async () => {
  const client = new RpcV2ProtocolClient({
    ...
    requestHandler: new ResponseDeserializationTestHandler(
      ...
      `qXB0cnVlQm9vbGVhblZhbHVl9XFmYWxzZUJvb2xlYW5WYWx1ZfRpYnl0ZVZhbHVlBWtkb3VibGVWYWx1Zfs//jlYEGJN02pmbG9hdFZhbHVl+kDz989saW50ZWdlclZhbHVlGQEAanNob3J0VmFsdWUZJqprc3RyaW5nVmFsdWVmc2ltcGxlaWJsb2JWYWx1ZUNmb28=`
    ),
  });
