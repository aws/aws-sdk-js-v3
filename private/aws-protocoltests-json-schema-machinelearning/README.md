...
# @aws-sdk/aws-protocoltests-json-schema-machinelearning
...
To install this package, simply type add or install @aws-sdk/aws-protocoltests-json-schema-machinelearning
using your favorite package manager:

- `npm install @aws-sdk/aws-protocoltests-json-schema-machinelearning`
- `yarn add @aws-sdk/aws-protocoltests-json-schema-machinelearning`
- `pnpm add @aws-sdk/aws-protocoltests-json-schema-machinelearning`
...
```js
// ES5 example
const { MachineLearningClient, PredictCommand } = require("@aws-sdk/aws-protocoltests-json-schema-machinelearning");
```

```ts
// ES6+ example
import { MachineLearningClient, PredictCommand } from "@aws-sdk/aws-protocoltests-json-schema-machinelearning";
```
...
```ts
import * as AWS from "@aws-sdk/aws-protocoltests-json-schema-machinelearning";
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/aws-protocoltests-json-schema-machinelearning` package is updated.
