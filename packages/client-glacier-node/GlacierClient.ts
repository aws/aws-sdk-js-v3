import * as __aws_sdk_add_glacier_checksum_headers_node from '@aws-sdk/add-glacier-checksum-headers-node';
...
import * as __aws_sdk_middleware_input_default from '@aws-sdk/middleware-input-default';
import * as __aws_sdk_middleware_sdk_glacier from '@aws-sdk/middleware-sdk-glacier';
...
export class GlacierClient {
    ...
    constructor(configuration: __aws_sdk_types.Undefinable<GlacierConfiguration>) {
        ...
        this.middlewareStack.add(
            __aws_sdk_middleware_input_default.inputDefault<InputTypesUnion>({
                accountId: '-'
            }),
            {
                step: 'initialize',
        ...
        this.middlewareStack.add(
            __aws_sdk_middleware_sdk_glacier.addGlacierApiVersion,
            {
                step: 'build',
                priority: 0,
        ...
        this.middlewareStack.add(
            __aws_sdk_add_glacier_checksum_headers_node.addChecksumHeaders(
            this.config.sha256,
    ...
    >(command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, GlacierResolvedConfiguration, _stream.Readable>): Promise<OutputType>;
    send<
        InputType extends InputTypesUnion,
        OutputType extends OutputTypesUnion
    >(
        command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, GlacierResolvedConfiguration, _stream.Readable>,
