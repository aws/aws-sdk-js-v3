...
import { TreeModelShape, TreeModelStructure } from "@aws-sdk/build-types";
...
export interface ${getUnmarshalledShapeName(name)} extends ${name} {
  ...
  it("should prefer documentation defined on the input structure member to that defined on the shape", () => {
