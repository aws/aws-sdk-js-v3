...
export const INPUT_RETRIES_PROPERTY: SyntheticParameterCustomizationDefinition = {
    ...
    documentation: 'The maximum number of times this operation should be retried. If set, this value will override the `maxRetries` configuration set on the client for this command.',
    name: '$maxRetries'
};
...
export const INPUT_HTTP_OPTIONS_PROPERTY: SyntheticParameterCustomizationDefinition = {
    ...
    documentation: 'Per-request HTTP configuration options. If set, any options specified will override the corresponding HTTP option set on the client for this command.',
    name: '$httpOptions'
};
