...
describe("Import", () => {
  it("should create es6 imports", () => {
    expect(new Import("module-name", "ExportedClass").toString()).toBe(
      "import {ExportedClass} from 'module-name';"
    );
  });
  ...
  it("should create es6 imports with destructured imports", () => {
    ...
    expect(importInstance.toString()).toBe(
      "import {ExportedInterface, ExportedType} from 'module-name';"
    );
  });
