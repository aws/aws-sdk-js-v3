...
describe("serializerConfigurationProperties", () => {
  ...
  describe("serializer property", () => {
    it("should import protocol-json-rpc and json-builder if the protocol is json", () => {
      const {
        serializer: { imports }
      } = serializerConfigurationProperties(
        {
    ...
    it("should import protocol-rest and json-builder if the protocol is rest-json", () => {
      const {
        serializer: { imports }
      } = serializerConfigurationProperties(
        {
    ...
    it("should import protocol-rest and xml-body-builder if the protocol is rest-xml", () => {
      const {
        serializer: { imports }
      } = serializerConfigurationProperties(
        {
    ...
    for (const protocol of <SupportedProtocol[]>["ec2", "query"]) {
      it(`should import protocol-query and query-builder if the protocol is ${protocol}`, () => {
        const {
          serializer: { imports }
        } = serializerConfigurationProperties(
          {
  ...
  describe("parser property", () => {
    it("should import protocol-json-rpc and json-parser if the protocol is json", () => {
      const {
        parser: { imports }
      } = serializerConfigurationProperties(
        {
    ...
    it("should import protocol-rest and json-parser if the protocol is rest-json", () => {
      const {
        parser: { imports }
      } = serializerConfigurationProperties(
        {
    ...
    it("should import protocol-rest and xml-body-parser if the protocol is rest-xml", () => {
      const {
        parser: { imports }
      } = serializerConfigurationProperties(
        {
    ...
    it(`should import protocol-query and xml-body-parser if the protocol is ec2`, () => {
      const {
        parser: { imports }
      } = serializerConfigurationProperties(
        {
    ...
    it(`should import protocol-query and xml-body-parser if the protocol is query`, () => {
      const {
        parser: { imports }
      } = serializerConfigurationProperties(
        {
