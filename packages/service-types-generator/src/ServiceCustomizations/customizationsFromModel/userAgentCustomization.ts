    ...
    client: [
      {
        ...
        '${
          runtime === "node" ? "User-Agent" : "X-Amz-User-Agent"
        }': ${packageNameToVariable(defaultValuePackageName)}.defaultUserAgent(
