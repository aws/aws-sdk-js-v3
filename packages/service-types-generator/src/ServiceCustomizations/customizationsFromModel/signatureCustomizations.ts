...
import { credentials, region, sha256, optionalCredentials } from './standardConfigurationProperties';
    ...
    return {
        client: customizationsForAuthType(
            ...
            configuration: {
                ...
                credentials: authTypeMap.client === 'none'
                    ? optionalCredentials
                    : credentials,
            }
        }),
...
function authTypeMapFromModel(
    { metadata: { signatureVersion }, operations }: TreeModel
): AuthTypeMap {
