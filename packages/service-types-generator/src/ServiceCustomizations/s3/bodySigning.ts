...
const md5Checksum: MiddlewareCustomizationDefinition = {
  imports: [IMPORTS["apply-body-checksum-middleware"]],
  step: "build",
  priority: 0,
  type: "Middleware",
...
export function streamHasherProperty(
  ...
  return {
    type: "forked",
    inputType: `${packageNameToVariable(
      "@aws-sdk/types"
    )}.StreamHasher<${streamType}>`,
    documentation:
...
export const bodySigningCustomizations: CustomizationProvider = (
  ...
  return {
    commands: {
      DeleteObjects: [md5Checksum],
      PutBucketCors: [md5Checksum],
      PutBucketLifecycle: [md5Checksum],
      PutBucketLifecycleConfiguration: [md5Checksum],
      PutBucketPolicy: [md5Checksum],
      PutBucketTagging: [md5Checksum],
      PutBucketReplication: [md5Checksum],
      PutObject: [unsignedPayload],
      UploadPart: [unsignedPayload]
    },
    client: [
      {
        type: "Configuration",
