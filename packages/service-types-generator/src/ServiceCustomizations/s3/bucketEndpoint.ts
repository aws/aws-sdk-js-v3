...
const bucketEndpointProperty: SyntheticParameterCustomizationDefinition = {
  ...
  documentation: `Whether to use the bucket name as the endpoint for this request. The bucket
...
const bucketEndpointMiddleware: MiddlewareCustomizationDefinition = {
  ...
  step: "build",
  priority: 0,
  imports: [IMPORTS["bucket-endpoint-middleware"]],
...
const uncustomizedCommands = ["CreateBucket", "DeleteBucket", "ListBuckets"];
