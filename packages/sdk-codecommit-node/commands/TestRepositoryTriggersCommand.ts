...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<TestRepositoryTriggersInput, TestRepositoryTriggersOutput, _stream.Readable>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<TestRepositoryTriggersInput, TestRepositoryTriggersOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
