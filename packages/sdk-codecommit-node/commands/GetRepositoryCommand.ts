...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<GetRepositoryInput, GetRepositoryOutput, _stream.Readable>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<GetRepositoryInput, GetRepositoryOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
