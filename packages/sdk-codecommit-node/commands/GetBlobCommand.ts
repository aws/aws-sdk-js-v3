...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<GetBlobInput, GetBlobOutput, _stream.Readable>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<GetBlobInput, GetBlobOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
