...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<GetRepositoryTriggersInput, GetRepositoryTriggersOutput, _stream.Readable>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<GetRepositoryTriggersInput, GetRepositoryTriggersOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
