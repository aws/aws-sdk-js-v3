...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<UpdateRepositoryNameInput, UpdateRepositoryNameOutput, _stream.Readable>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<UpdateRepositoryNameInput, UpdateRepositoryNameOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
