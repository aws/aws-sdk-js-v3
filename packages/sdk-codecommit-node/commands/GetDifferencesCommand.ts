...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<GetDifferencesInput, GetDifferencesOutput, _stream.Readable>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<GetDifferencesInput, GetDifferencesOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
