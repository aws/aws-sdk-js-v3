...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<CreateBranchInput, CreateBranchOutput, _stream.Readable>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<CreateBranchInput, CreateBranchOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
