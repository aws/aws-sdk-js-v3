...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<PutRepositoryTriggersInput, PutRepositoryTriggersOutput, _stream.Readable>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<PutRepositoryTriggersInput, PutRepositoryTriggersOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
