...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<ListRepositoriesInput, ListRepositoriesOutput, _stream.Readable>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<ListRepositoriesInput, ListRepositoriesOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
