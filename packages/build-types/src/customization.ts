...
export interface EnvironmentForkedConfigurationPropertyDefinition
   ...
   * runtime environment.
   */
  node: ConfigurationPropertyDefinitionRuntimeAttributes &
   ...
   * runtime environment.
   */
  browser: ConfigurationPropertyDefinitionRuntimeAttributes &
    AdditionalDocumentation;
   ...
   */
  universal: ConfigurationPropertyDefinitionRuntimeAttributes &
    AdditionalDocumentation;
}

export interface UnifiedConfigurationPropertyDefinition
  extends ConfigurationPropertyDefinitionSharedAttributes,
...
export interface CustomizationProvider {
  (model: TreeModel, target: RuntimeTarget): ServiceCustomizationDefinition;
}
