...
import {MachineLearningConfiguration, MachineLearningResolvedConfiguration, configurationProperties} from './MachineLearningConfiguration';
import {InputTypesUnion} from './types/InputTypesUnion';
import {OutputTypesUnion} from './types/OutputTypesUnion';

export class MachineLearningClient {
    protected readonly config: MachineLearningResolvedConfiguration;
    ...
    constructor(configuration: MachineLearningConfiguration) {
    ...
    >(command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, MachineLearningResolvedConfiguration, _stream.Readable>): Promise<OutputType>;
    send<
        InputType extends InputTypesUnion,
        OutputType extends OutputTypesUnion
    >(
        command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, MachineLearningResolvedConfiguration, _stream.Readable>,
