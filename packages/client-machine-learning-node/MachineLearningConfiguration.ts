...
export interface MachineLearningConfiguration {
    /**
...
export interface MachineLearningResolvableConfiguration extends MachineLearningConfiguration {
    /**
...
export interface MachineLearningResolvedConfiguration extends MachineLearningConfiguration {
