...
export class CreateRealtimeEndpointCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<CreateRealtimeEndpointInput, CreateRealtimeEndpointOutput> {
