...
export class UpdateBatchPredictionCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<UpdateBatchPredictionInput, UpdateBatchPredictionOutput> {
