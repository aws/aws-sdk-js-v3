...
export class DeleteRealtimeEndpointCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<DeleteRealtimeEndpointInput, DeleteRealtimeEndpointOutput> {
