...
export class DeleteBatchPredictionCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<DeleteBatchPredictionInput, DeleteBatchPredictionOutput> {
