...
export class CreateDataSourceFromRedshiftCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<CreateDataSourceFromRedshiftInput, CreateDataSourceFromRedshiftOutput> {
