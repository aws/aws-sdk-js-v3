...
import {PinpointConfiguration, PinpointResolvedConfiguration, configurationProperties} from './PinpointConfiguration';
...
export class PinpointClient {
    ...
    >(command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, PinpointResolvedConfiguration, Blob>): Promise<OutputType>;
    send<
        InputType extends InputTypesUnion,
        OutputType extends OutputTypesUnion
    >(
        command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, PinpointResolvedConfiguration, Blob>,
