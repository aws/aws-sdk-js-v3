...
import {UpdateGcmChannel} from '../model/UpdateGcmChannel';
...
export class UpdateGcmChannelCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: UpdateGcmChannel
        };

        return stack.resolve(
            handler<UpdateGcmChannelInput, UpdateGcmChannelOutput>(handlerExecutionContext),
