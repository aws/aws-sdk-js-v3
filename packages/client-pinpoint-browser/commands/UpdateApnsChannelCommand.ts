...
export class UpdateApnsChannelCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: UpdateApnsChannel
        };

        return stack.resolve(
            handler<UpdateApnsChannelInput, UpdateApnsChannelOutput>(handlerExecutionContext),
