...
export class GetApnsVoipChannelCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<GetApnsVoipChannelInput, GetApnsVoipChannelOutput> {
        ...
        return stack.resolve(
            handler<GetApnsVoipChannelInput, GetApnsVoipChannelOutput>(handlerExecutionContext),
