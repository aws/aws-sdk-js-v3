...
export class UpdateApplicationSettingsCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<UpdateApplicationSettingsInput, UpdateApplicationSettingsOutput> {
        ...
        return stack.resolve(
            handler<UpdateApplicationSettingsInput, UpdateApplicationSettingsOutput>(handlerExecutionContext),
