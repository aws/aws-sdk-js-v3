...
import {CreateImportJob} from '../model/CreateImportJob';
...
export class CreateImportJobCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: CreateImportJob
        };

        return stack.resolve(
            handler<CreateImportJobInput, CreateImportJobOutput>(handlerExecutionContext),
