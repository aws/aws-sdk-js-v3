...
export class DeleteEmailChannelCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<DeleteEmailChannelInput, DeleteEmailChannelOutput> {
        ...
        return stack.resolve(
            handler<DeleteEmailChannelInput, DeleteEmailChannelOutput>(handlerExecutionContext),
