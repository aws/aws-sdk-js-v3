...
export class DeleteEventStreamCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        return stack.resolve(
            handler<DeleteEventStreamInput, DeleteEventStreamOutput>(handlerExecutionContext),
