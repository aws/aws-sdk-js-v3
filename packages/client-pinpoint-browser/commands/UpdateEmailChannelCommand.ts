...
export class UpdateEmailChannelCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<UpdateEmailChannelInput, UpdateEmailChannelOutput> {
        ...
        return stack.resolve(
            handler<UpdateEmailChannelInput, UpdateEmailChannelOutput>(handlerExecutionContext),
