...
export class GetUserEndpointsCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: GetUserEndpoints
        };

        return stack.resolve(
            handler<GetUserEndpointsInput, GetUserEndpointsOutput>(handlerExecutionContext),
