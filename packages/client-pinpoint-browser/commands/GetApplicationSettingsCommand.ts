...
export class GetApplicationSettingsCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<GetApplicationSettingsInput, GetApplicationSettingsOutput> {
        ...
        return stack.resolve(
            handler<GetApplicationSettingsInput, GetApplicationSettingsOutput>(handlerExecutionContext),
