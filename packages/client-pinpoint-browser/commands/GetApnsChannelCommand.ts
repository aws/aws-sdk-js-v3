...
export class GetApnsChannelCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
    GetApnsChannelInput,
    OutputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: GetApnsChannel
        };

        return stack.resolve(
            handler<GetApnsChannelInput, GetApnsChannelOutput>(handlerExecutionContext),
