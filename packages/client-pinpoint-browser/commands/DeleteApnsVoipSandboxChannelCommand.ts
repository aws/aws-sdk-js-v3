...
export class DeleteApnsVoipSandboxChannelCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<DeleteApnsVoipSandboxChannelInput, DeleteApnsVoipSandboxChannelOutput> {
        ...
        return stack.resolve(
            handler<DeleteApnsVoipSandboxChannelInput, DeleteApnsVoipSandboxChannelOutput>(handlerExecutionContext),
