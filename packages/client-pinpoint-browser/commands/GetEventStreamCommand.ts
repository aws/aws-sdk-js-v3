...
export class GetEventStreamCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
    GetEventStreamInput,
    OutputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: GetEventStream
        };

        return stack.resolve(
            handler<GetEventStreamInput, GetEventStreamOutput>(handlerExecutionContext),
