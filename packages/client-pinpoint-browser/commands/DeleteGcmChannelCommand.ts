...
export class DeleteGcmChannelCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        const handlerExecutionContext: __aws_sdk_types.HandlerExecutionContext = {
            logger: {} as any,
            model: DeleteGcmChannel
        };

        return stack.resolve(
            handler<DeleteGcmChannelInput, DeleteGcmChannelOutput>(handlerExecutionContext),
