...
export class GetSegmentVersionCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        return stack.resolve(
            handler<GetSegmentVersionInput, GetSegmentVersionOutput>(handlerExecutionContext),
