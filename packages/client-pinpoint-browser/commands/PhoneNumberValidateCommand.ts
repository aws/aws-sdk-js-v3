...
export class PhoneNumberValidateCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<PhoneNumberValidateInput, PhoneNumberValidateOutput> {
        ...
        return stack.resolve(
            handler<PhoneNumberValidateInput, PhoneNumberValidateOutput>(handlerExecutionContext),
