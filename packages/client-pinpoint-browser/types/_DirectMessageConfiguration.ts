...
import {_DefaultMessage, _UnmarshalledDefaultMessage} from './_DefaultMessage';
import {_DefaultPushNotificationMessage, _UnmarshalledDefaultPushNotificationMessage} from './_DefaultPushNotificationMessage';
...
export interface _UnmarshalledDirectMessageConfiguration extends _DirectMessageConfiguration {
    /**
     * The message to ADM channels. Overrides the default push notification message.
     */
