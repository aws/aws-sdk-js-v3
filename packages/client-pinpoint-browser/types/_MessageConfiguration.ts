...
import {_CampaignEmailMessage, _UnmarshalledCampaignEmailMessage} from './_CampaignEmailMessage';
import {_CampaignSmsMessage, _UnmarshalledCampaignSmsMessage} from './_CampaignSmsMessage';
...
export interface _UnmarshalledMessageConfiguration extends _MessageConfiguration {
    /**
     * The message that the campaign delivers to ADM channels. Overrides the default message.
     */
