import {_EndpointItemResponse, _UnmarshalledEndpointItemResponse} from './_EndpointItemResponse';
import {_EventItemResponse, _UnmarshalledEventItemResponse} from './_EventItemResponse';
...
export interface _ItemResponse {
     ...
     */
    EventsItemResponse?: {[key: string]: _EventItemResponse}|Iterable<[string, _EventItemResponse]>;
}
