...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<DescribeGlobalTableInput, DescribeGlobalTableOutput> {
        ...
        return stack.resolve(
            handler<DescribeGlobalTableInput, DescribeGlobalTableOutput>(handlerExecutionContext),
