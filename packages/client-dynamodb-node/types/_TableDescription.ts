import {
  ...
  _UnmarshalledAttributeDefinition
} from "./_AttributeDefinition";
import {
  _KeySchemaElement,
...
export interface _TableDescription {
   ...
   */
  BillingModeSummary?: _BillingModeSummary;
  ...
  LocalSecondaryIndexes?:
    | Array<_LocalSecondaryIndexDescription>
    | Iterable<_LocalSecondaryIndexDescription>;
  ...
  GlobalSecondaryIndexes?:
    | Array<_GlobalSecondaryIndexDescription>
    | Iterable<_GlobalSecondaryIndexDescription>;
...
export interface _UnmarshalledTableDescription extends _TableDescription {
   ...
   * <p>Contains the details for the read/write capacity mode.</p>
   */
  BillingModeSummary?: _UnmarshalledBillingModeSummary;
