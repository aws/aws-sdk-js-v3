...
import * as __aws_middleware_expect_continue from '@aws-sdk/middleware-expect-continue';
...
export class S3Client {
    ...
    >(command: __aws_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, S3ResolvedConfiguration, _stream.Readable>): Promise<OutputType>;
    send<
        InputType extends InputTypesUnion,
        OutputType extends OutputTypesUnion
    >(
        command: __aws_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, S3ResolvedConfiguration, _stream.Readable>,
