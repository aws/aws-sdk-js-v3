...
export class GetBucketPolicyCommand implements __aws_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_types.Handler<GetBucketPolicyInput, GetBucketPolicyOutput> {
        ...
        return stack.resolve(
            handler<GetBucketPolicyInput, GetBucketPolicyOutput>(handlerExecutionContext),
