...
export class PutBucketRequestPaymentCommand implements __aws_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_types.Handler<PutBucketRequestPaymentInput, PutBucketRequestPaymentOutput> {
