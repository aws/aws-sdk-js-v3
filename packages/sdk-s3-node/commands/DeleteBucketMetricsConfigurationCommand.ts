...
export class DeleteBucketMetricsConfigurationCommand implements __aws_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_types.Handler<DeleteBucketMetricsConfigurationInput, DeleteBucketMetricsConfigurationOutput> {
        ...
        return stack.resolve(
            handler<DeleteBucketMetricsConfigurationInput, DeleteBucketMetricsConfigurationOutput>(handlerExecutionContext),
