...
export class DeleteBucketReplicationCommand implements __aws_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_types.Handler<DeleteBucketReplicationInput, DeleteBucketReplicationOutput> {
