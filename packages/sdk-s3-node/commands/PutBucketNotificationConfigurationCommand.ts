...
export class PutBucketNotificationConfigurationCommand implements __aws_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_types.Handler<PutBucketNotificationConfigurationInput, PutBucketNotificationConfigurationOutput> {
