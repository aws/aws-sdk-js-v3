...
export class PutBucketAccelerateConfigurationCommand implements __aws_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_types.Handler<PutBucketAccelerateConfigurationInput, PutBucketAccelerateConfigurationOutput> {
