...
export class DeleteBucketInventoryConfigurationCommand implements __aws_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_types.Handler<DeleteBucketInventoryConfigurationInput, DeleteBucketInventoryConfigurationOutput> {
