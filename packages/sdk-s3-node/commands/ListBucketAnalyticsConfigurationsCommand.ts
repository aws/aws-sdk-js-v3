...
export class ListBucketAnalyticsConfigurationsCommand implements __aws_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_types.Handler<ListBucketAnalyticsConfigurationsInput, ListBucketAnalyticsConfigurationsOutput> {
