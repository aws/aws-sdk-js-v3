...
export class GetBucketMetricsConfigurationCommand implements __aws_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_types.Handler<GetBucketMetricsConfigurationInput, GetBucketMetricsConfigurationOutput> {
        ...
        return stack.resolve(
            handler<GetBucketMetricsConfigurationInput, GetBucketMetricsConfigurationOutput>(handlerExecutionContext),
