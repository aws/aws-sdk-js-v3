...
export const presignRequestQuery = async (
  ...
  request = {
    ...
    ...endpoint,
    method: "GET",
    query: appendBodyToQuery(request.query, request.body as string),
  ...
  return await signer.presignRequest(request, expirationTime(expireTime));
};

function appendBodyToQuery(
