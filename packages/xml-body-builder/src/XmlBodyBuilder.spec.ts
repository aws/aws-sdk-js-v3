...
import { HttpEndpoint, Member, OperationModel } from "@aws-sdk/types";
...
describe("XmlBodyBuilder", () => {
  ...
  describe("#build", () => {
    ...
    it("ignores non-body members", () => {
      ...
      ).toBe(`<TestRequest>` + `<body>body</body>` + `</TestRequest>`);
    });
    ...
    it("wraps simple structures with location of body", () => {
      ...
      expect(
        ...
        `<TestRequest>` + `<Foo>abc</Foo>` + `<baz>123</baz>` + `</TestRequest>`
      );
    });
    ...
    it("serializes empty structures as empty elements", () => {
      ...
      ).toBe(`<TestRequest>` + `<Config/>` + `</TestRequest>`);
    });
    ...
    it("includes list elements even if they have no members", () => {
      ...
      ).toBe(`<TestRequest>` + `<Aliases/>` + `</TestRequest>`);
    });
    ...
    it("serializes integers", () => {
      ...
      ).toBe(`<TestRequest>` + `<Count>123</Count>` + `</TestRequest>`);
    });
    ...
    it("ignores null integers", () => {
      ...
      expect(
        ...
        `<TestRequest>` + `<Count>3</Count>` + `<Nested/>` + `</TestRequest>`
      );
    });
    ...
    it("serializes floats", () => {
      ...
      ).toBe(`<TestRequest>` + `<Count>123.123</Count>` + `</TestRequest>`);
    });
    ...
    it("serializes booleans", () => {
      ...
      ).toBe(`<TestRequest>` + `<Enabled>true</Enabled>` + `</TestRequest>`);
      ...
      ).toBe(`<TestRequest>` + `<Enabled>false</Enabled>` + `</TestRequest>`);
    });
    ...
    it("serializes timestamps (unixTimestmap)", () => {
      ...
      ).toBe(`<TestRequest>` + `<Expires>0</Expires>` + `</TestRequest>`);
    });
    ...
    it("does not need an xml namespace at the root element", () => {
      ...
      ).toBe(`<TestRequest>` + `<Foo>bar</Foo>` + `</TestRequest>`);
    });
