...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<RegisterStreamConsumerInput, RegisterStreamConsumerOutput> {
        ...
        return stack.resolve(
            handler<RegisterStreamConsumerInput, RegisterStreamConsumerOutput>(handlerExecutionContext),
