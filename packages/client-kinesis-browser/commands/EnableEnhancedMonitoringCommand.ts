...
export class EnableEnhancedMonitoringCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<EnableEnhancedMonitoringInput, EnableEnhancedMonitoringOutput> {
        ...
        return stack.resolve(
            handler<EnableEnhancedMonitoringInput, EnableEnhancedMonitoringOutput>(handlerExecutionContext),
