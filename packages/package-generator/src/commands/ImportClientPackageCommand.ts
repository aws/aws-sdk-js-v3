...
export const ImportClientPackageCommand: yargs.CommandModule = {
  ...
  describe:
    "Create a client for the provided service model targeting the provided runtime. This package will be added to the AWS SDK for JavaScript repository if it is not already present.",
  ...
  builder: {
    ...
    smoke: {
      ...
      type: "string",
      coerce: smokePath =>
        fromSmokeTestModelJson(readFileSync(smokePath, "utf8"))
    },
    version: {
      alias: ["v"],
      type: "string"
