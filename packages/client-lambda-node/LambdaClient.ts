...
import {LambdaConfiguration, LambdaResolvedConfiguration, configurationProperties} from './LambdaConfiguration';
...
export class LambdaClient {
    ...
    >(command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, LambdaResolvedConfiguration, _stream.Readable>): Promise<OutputType>;
    send<
        InputType extends InputTypesUnion,
        OutputType extends OutputTypesUnion
    >(
        command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, LambdaResolvedConfiguration, _stream.Readable>,
