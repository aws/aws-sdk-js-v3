import {_VpcConfigResponse, _UnmarshalledVpcConfigResponse} from './_VpcConfigResponse';
import {_DeadLetterConfig, _UnmarshalledDeadLetterConfig} from './_DeadLetterConfig';
import {_EnvironmentResponse, _UnmarshalledEnvironmentResponse} from './_EnvironmentResponse';
import {_TracingConfigResponse, _UnmarshalledTracingConfigResponse} from './_TracingConfigResponse';
...
export interface _UnmarshalledFunctionConfiguration extends _FunctionConfiguration {
    /**
     * <p>The function's networking configuration.</p>
     */
