...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<DeleteEventSourceMappingInput, DeleteEventSourceMappingOutput> {
        ...
        return stack.resolve(
            handler<DeleteEventSourceMappingInput, DeleteEventSourceMappingOutput>(handlerExecutionContext),
