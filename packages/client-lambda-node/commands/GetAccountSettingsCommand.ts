...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<GetAccountSettingsInput, GetAccountSettingsOutput> {
        ...
        return stack.resolve(
            handler<GetAccountSettingsInput, GetAccountSettingsOutput>(handlerExecutionContext),
