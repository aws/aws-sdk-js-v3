...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<PutFunctionConcurrencyInput, PutFunctionConcurrencyOutput> {
        ...
        return stack.resolve(
            handler<PutFunctionConcurrencyInput, PutFunctionConcurrencyOutput>(handlerExecutionContext),
