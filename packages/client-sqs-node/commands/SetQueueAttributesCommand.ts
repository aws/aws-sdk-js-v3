...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<SetQueueAttributesInput, SetQueueAttributesOutput> {
        ...
        return stack.resolve(
            handler<SetQueueAttributesInput, SetQueueAttributesOutput>(handlerExecutionContext),
