...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<ListDeadLetterSourceQueuesInput, ListDeadLetterSourceQueuesOutput> {
        ...
        return stack.resolve(
            handler<ListDeadLetterSourceQueuesInput, ListDeadLetterSourceQueuesOutput>(handlerExecutionContext),
