...
export type SerializeHandlerOutput<Output extends object> = InitializeHandlerOutput<Output>;

export type BuildHandlerArguments<Input extends object> = FinalizeHandlerArguments<Input>;

export type BuildHandlerOutput<Output extends object> = InitializeHandlerOutput<Output>;
...
export type FinalizeHandlerOutput<Output extends object> = InitializeHandlerOutput<Output>;

export type DeserializeHandlerArguments<Input extends object> = FinalizeHandlerArguments<Input>;
