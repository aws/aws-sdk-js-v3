...
export class PostCommentForPullRequestCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<PostCommentForPullRequestInput, PostCommentForPullRequestOutput> {
