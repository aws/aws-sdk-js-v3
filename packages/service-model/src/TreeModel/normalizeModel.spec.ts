...
describe("normalizeModel", () => {
  ...
  it("should remove replaced input and output names", () => {
    ...
    expect(Object.keys(api.shapes)).toEqual(["GetFooInput", "GetFooOutput"]);
  });

  it("should create input and output shapes for each operation if not provided in model", () => {
    const shapes: ShapeMap = {
      GetFooOutput: {
        type: "structure",
        members: {}
  ...
  it("should create input and output shapes for each operation if IO shapes are shared", () => {
    const shapes: ShapeMap = {
      GetInput: {
        type: "structure",
        members: {}
  ...
  it("should preserve non-IO shape if IO shape used as a member of another shape", () => {
    const shapes: ShapeMap = {
      GetInput: {
        type: "structure",
        members: {}
    ...
    expect(Object.keys(api.shapes).sort()).toEqual(
      ["GetFooInput", "GetFooOutput", shape].sort()
    );
    expect(api.operations.GetFoo.input.shape).toBe("GetFooInput");
    expect(api.operations.GetFoo.output.shape).toBe("GetFooOutput");
