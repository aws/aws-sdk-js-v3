...
import { fromSmokeTestModelJson, isSmokeTestModel } from "./index";
...
describe("isSmokeTestModel", () => {
  ...
  it(`should reject objects where a test case's errorExpectedFromService is not a boolean`, () => {
    expect(
      isSmokeTestModel({
        ...minimalValidSmokeTestModel,
        testCases: [
...
describe("fromSmokeTestModel", () => {
  it("should parse a smoke test model", () => {
    const model = fromSmokeTestModelJson(
      JSON.stringify(minimalValidSmokeTestModel)
    );
  ...
  it(`should throw when a test case's errorExpectedFromService is not a boolean`, () => {
    expect(() => {
      const model = fromSmokeTestModelJson(
        JSON.stringify({
          ...minimalValidSmokeTestModel,
