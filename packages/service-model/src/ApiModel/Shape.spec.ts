import { isComplexShape, isStructureMember, isShape } from "./Shape";
...
describe("isStructureMember", () => {
  ...
  it('should accept objects where a "documentation" property is present and a string', () => {
    expect(
      isStructureMember({
        ...minimalValidStructureMember,
        documentation: "docs"
  ...
  it('should reject objects where a "flattened" property is present and not a boolean', () => {
    expect(
      isStructureMember({
        ...minimalValidStructureMember,
        flattened: {}
  ...
  it('should accept objects where a "flattened" property is present and a boolean', () => {
    expect(
      isStructureMember({
        ...minimalValidStructureMember,
        flattened: true
  ...
  it('should reject objects where a "locationName" property is present and not a string', () => {
    expect(
      isStructureMember({
        ...minimalValidStructureMember,
        locationName: {}
  ...
  it('should accept objects where a "locationName" property is present and a string', () => {
    expect(
      isStructureMember({
        ...minimalValidStructureMember,
  ...
  it('should reject objects where a "xmlAttribute" property is present and not a boolean', () => {
    expect(
      isStructureMember({
        ...minimalValidStructureMember,
        xmlAttribute: {}
  ...
  it('should accept objects where a "xmlAttribute" property is present and a boolean', () => {
    expect(
      isStructureMember({
        ...minimalValidStructureMember,
        xmlAttribute: true
...
describe("isShape", () => {
  ...
  it('should reject objects where a "documentation" property is present and not a string', () => {
    expect(isShape({ ...minimalValidShape, documentation: {} })).toBe(false);
  });

  it('should accept objects where a "documentation" property is present and a string', () => {
    expect(isShape({ ...minimalValidShape, documentation: "docs" })).toBe(true);
  });

  it('should reject objects where a "sensitive" property is present and not a boolean', () => {
    expect(isShape({ ...minimalValidShape, sensitive: {} })).toBe(false);
  });

  it('should accept objects where a "sensitive" property is present and a boolean', () => {
    expect(isShape({ ...minimalValidShape, sensitive: true })).toBe(true);
  });

  it('should reject objects where a "deprecated" property is present and not a boolean', () => {
    expect(isShape({ ...minimalValidShape, deprecated: {} })).toBe(false);
  });

  it('should accept objects where a "deprecated" property is present and a boolean', () => {
    expect(isShape({ ...minimalValidShape, deprecated: true })).toBe(true);
  });
  ...
  describe("blobs", () => {
    ...
    it('should reject objects where a "streaming" property is present and not a boolean', () => {
  ...
  describe("bytes", () => {
    ...
    it('should reject objects where a "min" property is present and not a number', () => {
      expect(isShape({ type: "byte", min: "1" })).toBe(false);
    });

    it('should reject objects where a "max" property is present and not a number', () => {
  ...
  describe("strings", () => {
    ...
    it('should reject objects where a "pattern" property is present and not a string', () => {
      expect(isShape({ type: "string", pattern: false })).toBe(false);
    });

    it('should reject objects where a "enum" property is present and not an array of strings', () => {
      expect(
        isShape({
          type: "string",
    ...
    it('should reject objects where a "jsonValue" property is present and not a boolean', () => {
      expect(isShape({ type: "string", jsonValue: "1" })).toBe(false);
    });

    it('should reject objects where a "idempotencyToken" property is present and not a boolean', () => {
  ...
  describe("timestamps", () => {
    it("should accept valid timestamps", () => {
      expect(isShape({ type: "timestamp", timestampFormat: "atom" })).toBe(
        true
      );
    });

    it('should reject objects where a "timestampFormat" property is present and not a string', () => {
      expect(isShape({ type: "timestamp", timestampFormat: true })).toBe(false);
    });
  });
  ...
  describe("structures", () => {
    ...
    it('should reject objects where "members" is not an object map of StructureMembers', () => {
      expect(
        isShape({
    ...
    it('should reject objects where a "exception" property is present and not a boolean', () => {
      expect(
        isShape({
          ...minimalValidStructure,
          exception: "1"
    ...
    it('should reject objects where a "fault" property is present and not a boolean', () => {
      expect(
        isShape({
          ...minimalValidStructure,
          fault: "1"
    ...
    it('should reject objects where a "payload" property is present and not a string', () => {
      expect(
        isShape({
          ...minimalValidStructure,
          payload: 1
    ...
    it('should reject objects where a "error" property is present and not an object', () => {
      expect(
        isShape({
          ...minimalValidStructure,
          error: false
