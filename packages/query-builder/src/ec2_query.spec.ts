...
describe('EC2 QueryBUilder (should pass general query tests first)', () => {
    ...
    describe('Structure', () => {
        it('should serialize structure with both lowercased locationName or queryName', () => {
            ...
            expect(queryBody.build(structure, toSerialize))
                .toEqual('BarLocationName=val2&Foo=val1&yuckQueryName=val3');
        });
    ...
    describe('List', () => {
        it('should serialize non-flattened list as it\'s flattened', () => {
            ...
            expect(queryBody.build(structure, toSerialize))
                .toEqual('ListArg.1=mem1&ListArg.2=mem2&ListArg.3=mem3');
        });
        ...
        it('should serialize list with queryName', () => {
            ...
            const toSerialize = {ListArg: ['mem1', 'mem2', 'mem3']};
            expect(queryBody.build(structure, toSerialize)).toEqual(
                'ListArgQueryName.1=mem1&ListArgQueryName.2=mem2&ListArgQueryName.3=mem3'
            );
        });
    });
});
