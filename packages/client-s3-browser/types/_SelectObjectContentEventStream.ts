...
import {_ContinuationEvent, _UnmarshalledContinuationEvent} from './_ContinuationEvent';
...
export interface _UnmarshalledSelectObjectContentEventStream extends _SelectObjectContentEventStream {
    /**
     * <p>The Records Event.</p>
     */
