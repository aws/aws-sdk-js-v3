...
export class GetBucketLifecycleConfigurationCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<GetBucketLifecycleConfigurationInput, GetBucketLifecycleConfigurationOutput> {
