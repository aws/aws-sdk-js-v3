...
export class PutBucketAccelerateConfigurationCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<PutBucketAccelerateConfigurationInput, PutBucketAccelerateConfigurationOutput> {
        ...
        return stack.resolve(
            handler<PutBucketAccelerateConfigurationInput, PutBucketAccelerateConfigurationOutput>(handlerExecutionContext),
