...
export class ListBucketMetricsConfigurationsCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<ListBucketMetricsConfigurationsInput, ListBucketMetricsConfigurationsOutput> {
