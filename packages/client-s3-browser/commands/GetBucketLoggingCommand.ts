...
export class GetBucketLoggingCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
        ...
        return stack.resolve(
            handler<GetBucketLoggingInput, GetBucketLoggingOutput>(handlerExecutionContext),
