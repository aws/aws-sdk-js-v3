...
export class CreateBucketCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
    CreateBucketInput,
    OutputTypesUnion,
    CreateBucketOutput,
...
> {
    ...
    resolveMiddleware(
        ...
        stack.add(
            __aws_sdk_location_constraint_middleware.locationConstraintMiddleware(configuration.region),
            {
                step: 'initialize',
                priority: 0
            }
