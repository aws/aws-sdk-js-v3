...
export class DeleteBucketMetricsConfigurationCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<DeleteBucketMetricsConfigurationInput, DeleteBucketMetricsConfigurationOutput> {
