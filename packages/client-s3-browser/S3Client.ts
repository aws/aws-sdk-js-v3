...
import {S3Configuration, S3ResolvedConfiguration, configurationProperties} from './S3Configuration';
...
export class S3Client {
    ...
    >(command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, S3ResolvedConfiguration, Blob>): Promise<OutputType>;
    send<
        InputType extends InputTypesUnion,
        OutputType extends OutputTypesUnion
    >(
        command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, S3ResolvedConfiguration, Blob>,
