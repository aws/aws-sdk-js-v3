...
export class SetDataRetrievalPolicyCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<SetDataRetrievalPolicyInput, SetDataRetrievalPolicyOutput> {
