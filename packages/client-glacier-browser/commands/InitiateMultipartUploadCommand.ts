...
export class InitiateMultipartUploadCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<InitiateMultipartUploadInput, InitiateMultipartUploadOutput> {
