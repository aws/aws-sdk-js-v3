...
export class GlacierClient {
    ...
    constructor(configuration: GlacierConfiguration) {
        ...
        this.middlewareStack.add(
            __aws_sdk_add_glacier_checksum_headers_browser.addChecksumHeaders(
            this.config.sha256,
    ...
    >(command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, GlacierResolvedConfiguration, Blob>): Promise<OutputType>;
    send<
        InputType extends InputTypesUnion,
        OutputType extends OutputTypesUnion
    >(
        command: __aws_sdk_types.Command<InputTypesUnion, InputType, OutputTypesUnion, OutputType, GlacierResolvedConfiguration, Blob>,
