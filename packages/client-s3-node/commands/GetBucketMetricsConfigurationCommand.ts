...
export class GetBucketMetricsConfigurationCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<GetBucketMetricsConfigurationInput, GetBucketMetricsConfigurationOutput> {
