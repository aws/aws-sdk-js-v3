...
export class DeleteBucketEncryptionCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<DeleteBucketEncryptionInput, DeleteBucketEncryptionOutput> {
