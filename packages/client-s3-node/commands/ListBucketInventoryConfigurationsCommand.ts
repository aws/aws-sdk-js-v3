...
export class ListBucketInventoryConfigurationsCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<ListBucketInventoryConfigurationsInput, ListBucketInventoryConfigurationsOutput> {
