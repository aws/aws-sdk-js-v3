...
export class DeleteBucketLifecycleCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<DeleteBucketLifecycleInput, DeleteBucketLifecycleOutput> {
        ...
        return stack.resolve(
            handler<DeleteBucketLifecycleInput, DeleteBucketLifecycleOutput>(handlerExecutionContext),
