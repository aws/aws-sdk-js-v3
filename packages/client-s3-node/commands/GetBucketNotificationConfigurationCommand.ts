...
export class GetBucketNotificationConfigurationCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<GetBucketNotificationConfigurationInput, GetBucketNotificationConfigurationOutput> {
