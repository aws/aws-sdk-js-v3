...
export class ListBucketAnalyticsConfigurationsCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<ListBucketAnalyticsConfigurationsInput, ListBucketAnalyticsConfigurationsOutput> {
        ...
        return stack.resolve(
            handler<ListBucketAnalyticsConfigurationsInput, ListBucketAnalyticsConfigurationsOutput>(handlerExecutionContext),
