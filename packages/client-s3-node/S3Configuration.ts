...
import * as __aws_sdk_hash_stream_node from '@aws-sdk/hash-stream-node';
...
export interface S3Configuration {
     ...
     */
    streamHasher?: __aws_sdk_types.StreamHasher<_stream.Readable>;
    ...
    serializer: {
        defaultProvider: (
            ...
            const promisified = configuration.endpoint()
                .then(endpoint => new __aws_sdk_protocol_rest.RestSerializer<_stream.Readable>(
                    endpoint,
