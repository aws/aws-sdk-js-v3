...
describe('remove sensitive parameters from logging', () => {
    ...
    describe('scalars', () => {
        it('scalars', () => {
            ...
            [sensitiveBlobShape, sensitiveBooleanShape, sensitiveFloatShape, sensitiveIntegerShape,
                sensitiveStringShape, sensitiveTimestampShape].forEach(scalerShape => {
                const shape: Member = {
                    shape: {
                        type: 'structure',
                        required: [],
