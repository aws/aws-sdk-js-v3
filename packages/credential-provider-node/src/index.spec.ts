...
describe('defaultProvider', () => {
    ...
    it(
        'should stop after the process provider if credentials have been found',
        async () => {
            const creds = {
                accessKeyId: 'foo',
                secretAccessKey: 'bar',
    ...
    it(
        'should continue on to the IMDS provider if no env, ini or process credentials have been found',
        async () => {
            const creds = {
                accessKeyId: 'foo',
                secretAccessKey: 'bar',
