...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<GetBlobInput, GetBlobOutput, ReadableStream>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<GetBlobInput, GetBlobOutput, ReadableStream> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
