...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<ListRepositoriesInput, ListRepositoriesOutput, ReadableStream>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<ListRepositoriesInput, ListRepositoriesOutput, ReadableStream> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
