...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<UpdateDefaultBranchInput, UpdateDefaultBranchOutput, ReadableStream>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<UpdateDefaultBranchInput, UpdateDefaultBranchOutput, ReadableStream> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
