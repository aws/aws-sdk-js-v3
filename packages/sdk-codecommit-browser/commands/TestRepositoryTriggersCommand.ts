...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<TestRepositoryTriggersInput, TestRepositoryTriggersOutput, ReadableStream>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<TestRepositoryTriggersInput, TestRepositoryTriggersOutput, ReadableStream> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
