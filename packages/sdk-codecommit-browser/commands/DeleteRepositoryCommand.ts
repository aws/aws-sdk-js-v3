...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<DeleteRepositoryInput, DeleteRepositoryOutput, ReadableStream>,
        configuration: CodeCommitResolvedConfiguration
    ): __aws_types.Handler<DeleteRepositoryInput, DeleteRepositoryOutput, ReadableStream> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
