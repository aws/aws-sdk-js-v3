...
export class ListVPCAssociationAuthorizationsCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<ListVPCAssociationAuthorizationsInput, ListVPCAssociationAuthorizationsOutput> {
