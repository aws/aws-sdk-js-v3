...
export class DeleteVPCAssociationAuthorizationCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<DeleteVPCAssociationAuthorizationInput, DeleteVPCAssociationAuthorizationOutput> {
