...
export class DeleteTrafficPolicyInstanceCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<DeleteTrafficPolicyInstanceInput, DeleteTrafficPolicyInstanceOutput> {
