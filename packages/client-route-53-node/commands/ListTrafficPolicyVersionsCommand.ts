...
export class ListTrafficPolicyVersionsCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<ListTrafficPolicyVersionsInput, ListTrafficPolicyVersionsOutput> {
