...
export class UpdateTrafficPolicyInstanceCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<UpdateTrafficPolicyInstanceInput, UpdateTrafficPolicyInstanceOutput> {
