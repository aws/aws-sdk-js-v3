...
export class GetQueryLoggingConfigCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<GetQueryLoggingConfigInput, GetQueryLoggingConfigOutput> {
