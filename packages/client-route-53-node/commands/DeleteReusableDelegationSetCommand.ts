...
export class DeleteReusableDelegationSetCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<DeleteReusableDelegationSetInput, DeleteReusableDelegationSetOutput> {
