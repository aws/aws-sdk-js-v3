...
export class GetHealthCheckLastFailureReasonCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<GetHealthCheckLastFailureReasonInput, GetHealthCheckLastFailureReasonOutput> {
