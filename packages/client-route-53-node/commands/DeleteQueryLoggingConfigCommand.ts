...
export class DeleteQueryLoggingConfigCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<DeleteQueryLoggingConfigInput, DeleteQueryLoggingConfigOutput> {
