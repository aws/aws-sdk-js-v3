...
export class CreateVPCAssociationAuthorizationCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<CreateVPCAssociationAuthorizationInput, CreateVPCAssociationAuthorizationOutput> {
