...
export class AssociateVPCWithHostedZoneCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<AssociateVPCWithHostedZoneInput, AssociateVPCWithHostedZoneOutput> {
