...
export class ListReusableDelegationSetsCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<ListReusableDelegationSetsInput, ListReusableDelegationSetsOutput> {
