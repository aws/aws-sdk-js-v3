...
export class CreateTrafficPolicyVersionCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<CreateTrafficPolicyVersionInput, CreateTrafficPolicyVersionOutput> {
