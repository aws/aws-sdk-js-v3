...
export class GetReusableDelegationSetLimitCommand implements __aws_sdk_types.Command<
    InputTypesUnion,
...
> {
    ...
    ): __aws_sdk_types.Handler<GetReusableDelegationSetLimitInput, GetReusableDelegationSetLimitOutput> {
