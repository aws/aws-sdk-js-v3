...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<ListResourceTagsInput, ListResourceTagsOutput, _stream.Readable>,
        configuration: KMSResolvedConfiguration
    ): __aws_types.Handler<ListResourceTagsInput, ListResourceTagsOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
