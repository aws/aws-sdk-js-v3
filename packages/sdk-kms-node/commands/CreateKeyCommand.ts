...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<CreateKeyInput, CreateKeyOutput, _stream.Readable>,
        configuration: KMSResolvedConfiguration
    ): __aws_types.Handler<CreateKeyInput, CreateKeyOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
