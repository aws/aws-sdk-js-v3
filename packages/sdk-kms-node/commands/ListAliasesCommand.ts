...
export class ListAliasesCommand implements __aws_types.Command<
    ListAliasesInput,
    ListAliasesOutput,
...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<ListAliasesInput, ListAliasesOutput, _stream.Readable>,
        configuration: KMSResolvedConfiguration
    ): __aws_types.Handler<ListAliasesInput, ListAliasesOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
