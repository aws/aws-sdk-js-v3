...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<GetKeyPolicyInput, GetKeyPolicyOutput, _stream.Readable>,
        configuration: KMSResolvedConfiguration
    ): __aws_types.Handler<GetKeyPolicyInput, GetKeyPolicyOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
