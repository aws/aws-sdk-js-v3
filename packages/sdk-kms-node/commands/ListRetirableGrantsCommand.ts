...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<ListRetirableGrantsInput, ListRetirableGrantsOutput, _stream.Readable>,
        configuration: KMSResolvedConfiguration
    ): __aws_types.Handler<ListRetirableGrantsInput, ListRetirableGrantsOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
