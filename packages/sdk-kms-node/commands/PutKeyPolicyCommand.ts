...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<PutKeyPolicyInput, PutKeyPolicyOutput, _stream.Readable>,
        configuration: KMSResolvedConfiguration
    ): __aws_types.Handler<PutKeyPolicyInput, PutKeyPolicyOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
