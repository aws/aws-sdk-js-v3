...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<GenerateDataKeyInput, GenerateDataKeyOutput, _stream.Readable>,
        configuration: KMSResolvedConfiguration
    ): __aws_types.Handler<GenerateDataKeyInput, GenerateDataKeyOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
