...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<GetKeyRotationStatusInput, GetKeyRotationStatusOutput, _stream.Readable>,
        configuration: KMSResolvedConfiguration
    ): __aws_types.Handler<GetKeyRotationStatusInput, GetKeyRotationStatusOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
