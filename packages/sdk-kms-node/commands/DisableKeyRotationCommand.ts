...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<DisableKeyRotationInput, DisableKeyRotationOutput, _stream.Readable>,
        configuration: KMSResolvedConfiguration
    ): __aws_types.Handler<DisableKeyRotationInput, DisableKeyRotationOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
