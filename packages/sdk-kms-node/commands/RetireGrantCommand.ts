...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<RetireGrantInput, RetireGrantOutput, _stream.Readable>,
        configuration: KMSResolvedConfiguration
    ): __aws_types.Handler<RetireGrantInput, RetireGrantOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
