...
> {
    ...
    resolveMiddleware(
        clientStack: __aws_middleware_stack.MiddlewareStack<ImportKeyMaterialInput, ImportKeyMaterialOutput, _stream.Readable>,
        configuration: KMSResolvedConfiguration
    ): __aws_types.Handler<ImportKeyMaterialInput, ImportKeyMaterialOutput, _stream.Readable> {
        const {
            handler: Handler,
            httpHandler
        } = configuration;
