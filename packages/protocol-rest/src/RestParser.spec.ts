...
describe("RestParser", () => {
  ...
  describe("#parse", () => {
    ...
    describe("body", () => {
      ...
      it("should pass the operation and HTTP response body to the body parser", async () => {
        const parsed = await restParser.parse(
          getSimpleHeadersOperation,
          httpResponse
        );
      ...
      it("should collect and UTF-8 encode stream bodies for non-streaming bodies", async () => {
        const streamBody = {
        ...
        expect(utf8Encoder.mock.calls.length).toBe(1);
        expect(utf8Encoder.mock.calls[0][0].buffer).toBe(
          collectedStream.buffer
        );
      ...
      describe("payloads", () => {
        ...
        it("should collect and return a byte array for non-streaming blobs", async () => {
        ...
        it("should return a stream for streaming blobs", async () => {
          const operation: OperationModel = {
            ...minimalPostOperation,
            output: {
              shape: {
        ...
        it("should return a stream for streaming member blobs", async () => {
          const operation: OperationModel = {
            ...minimalPostOperation,
            output: {
              shape: {
        ...
        it("should parse a structure", async () => {
          const operation: OperationModel = {
            ...minimalPostOperation,
            output: {
              shape: {
    ...
    describe("headers", () => {
      ...
      it("treats response headers as case insensitive", async () => {
        ...
        let parsed = await restParser.parse(
          getSimpleHeadersOperation,
          httpResponse
        );
        expect(parsed).toEqual({
      ...
      describe("scalars", () => {
        ...
        it("extracts string JSON member", async () => {
          ...
          const utf8Encoder = jest.fn(
            () => '{"data":{"bool":true,"float":3.14,"int":3,"string":"test"}}'
          );
      ...
      describe("maps", () => {
        ...
        it("extracts maps from header values (with locationName)", async () => {
          const headerMapName = "testHeader";
          const headerMapLocationName = <string>(
            headerMapCustomLocationMember.locationName
          );
          const operation: OperationModel = {
            ...minimalPostOperation,
            output: {
