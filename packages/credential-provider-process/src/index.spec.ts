...
credential_process = /cred_proc foo`
        ...
        it('should read from a filepath if provided', async () => {
            ...
            expect(await fromProcess({filepath: customPath})())
        ...
        it(
            ...
            async () => {
                ...
                __addFsMatcher(customPath, `
[default]
credential_process = /cred_proc default`
                );
                __addChildProcessMatcher('/cred_proc default', DEFAULT_CREDS_JSON);

                __addFsMatcher(process.env[ENV_CREDENTIALS_PATH], `
[default]
credential_process = /cred_proc foo`
                );
                __addChildProcessMatcher('/cred_proc foo', FOO_CREDS_JSON);
        ...
        it('should prefer $HOME to $USERPROFILE', async () => {
            ...
            __addFsMatcher(`${sep}foo${sep}bar${sep}.aws${sep}credentials`, `
[default]
credential_process = /cred_proc default`
            );
            __addChildProcessMatcher('/cred_proc default', DEFAULT_CREDS_JSON);

            __addFsMatcher(`C:\\Users\\user${sep}.aws${sep}credentials`, `
[default]
credential_process = /cred_proc foo`
            );
            __addChildProcessMatcher('/cred_proc foo', FOO_CREDS_JSON);
...
credential_process = /cred_proc default`
            ...
            __addFsMatcher(`D:\\Users\\user2${sep}.aws${sep}credentials`, `
[default]
credential_process = /cred_proc foo`
            );
            __addChildProcessMatcher('/cred_proc foo', FOO_CREDS_JSON);
...
credential_process = /cred_proc foo`
        ...
        it('should read from a filepath if provided', async () => {
            ...
            expect(await fromProcess({configFilepath: customPath})())
                .toEqual(DEFAULT_CREDS);
        });
...
credential_process = /cred_proc default`
                ...
                __addFsMatcher(process.env[ENV_CONFIG_PATH], `
[default]
credential_process = /cred_proc foo`
                );
                __addChildProcessMatcher('/cred_proc foo', FOO_CREDS_JSON);
        ...
        it('should prefer $HOME to $USERPROFILE', async () => {
            ...
            __addFsMatcher(`${sep}foo${sep}bar${sep}.aws${sep}config`, `
[default]
credential_process = /cred_proc default`
            );
            __addChildProcessMatcher('/cred_proc default', DEFAULT_CREDS_JSON);
            ...
            __addFsMatcher(`C:\\Users\\user${sep}.aws${sep}config`, `
[default]
credential_process = /cred_proc foo`
            );
            __addChildProcessMatcher('/cred_proc foo', FOO_CREDS_JSON);
...
credential_process = /cred_proc default`
            ...
            __addFsMatcher(`D:\\Users\\user2${sep}.aws${sep}config`, `
[default]
credential_process = /cred_proc foo`
            );
            __addChildProcessMatcher('/cred_proc foo', FOO_CREDS_JSON);
...
credential_process = /cred_proc foo`
    ...
    it(
        ...
        async () => {
            __addFsMatcher(join(homedir(), '.aws', 'credentials'), `
[default]
credential_process = /cred_proc default`
            );
            __addChildProcessMatcher('/cred_proc default', DEFAULT_CREDS_JSON);
            ...
            __addFsMatcher(join(homedir(), '.aws', 'config'), `
[default]
credential_process = /cred_proc foo`
            );
            __addChildProcessMatcher('/cred_proc foo', FOO_CREDS_JSON);
...
credential_process = /cred_proc default`
        ...
        __addChildProcessMatcher('/cred_proc default', `
{
