...
> {
    ...
    resolveMiddleware(
    ...
    ): __aws_sdk_types.Handler<RestoreTableToPointInTimeInput, RestoreTableToPointInTimeOutput> {
        ...
        return stack.resolve(
            handler<RestoreTableToPointInTimeInput, RestoreTableToPointInTimeOutput>(handlerExecutionContext),
