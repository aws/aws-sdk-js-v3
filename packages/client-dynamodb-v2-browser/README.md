# @aws-sdk/client-dynamodb-v2-browser
...
```
npm install @aws-sdk/client-dynamodb-v2-browser
```
...
```javascript
//javascript
const { DynamoDBClient } = require('@aws-sdk/client-dynamodb-v2-browser/DynamoDBClient');
const { BatchGetItemCommand } = require('@aws-sdk/client-dynamodb-v2-browser/BatchGetItemCommand');
```

```javascript
//typescript
const { DynamoDBClient } = import '@aws-sdk/client-dynamodb-v2-browser/DynamoDBClient';
const { BatchGetItemCommand } = import '@aws-sdk/client-dynamodb-v2-browser/commands/BatchGetItemCommand';
```
...
```javascript
import * as AWS from '@aws-sdk/@aws-sdk/client-dynamodb-v2-browser/DynamoDB';
...
This client code is generated automatically. Any modifications will be overwritten the next time the `@aws-sdk/@aws-sdk/client-dynamodb-v2-browser' package is updated. To contribute to SDK you can checkout our [code generator package][].
