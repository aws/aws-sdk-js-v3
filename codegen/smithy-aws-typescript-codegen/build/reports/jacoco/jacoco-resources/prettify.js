...
(function () {
  ...
  var JSCRIPT_KEYWORDS =
    COMMON_KEYWORDS + "debugger eval export function get null set undefined var with " + "Infinity NaN ";
  var PERL_KEYWORDS =
  ...
  function recombineTagsAndDecorations(job) {
    ...
    if (numberLines) {
      ...
      var lineNum = numberLines[1] && numberLines[1].length ? numberLines[1] - 1 : 0; // Lines are 1-indexed
    ...
    function emitTextUpTo(sourceIdx) {
      if (sourceIdx > outputIdx) {
        ...
        // chunkify.
        var htmlChunk = textToHtml(tabExpander(sourceText.substring(outputIdx, sourceIdx))).replace(
