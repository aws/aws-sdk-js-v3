...
import { InlineDocumentServerInput, InlineDocumentServerOutput } from "../server/operations/InlineDocument";
import {
...
import { SmithyFrameworkException as __SmithyFrameworkException } from "@aws-smithy/server-common";
...
export const serializeAws_restJson1InlineDocumentCommand = async (
  input: InlineDocumentCommandInput,
  context: __SerdeContext
): Promise<__HttpRequest> => {
  const headers: any = {
    "content-type": "application/json",
  };
  let resolvedPath = "/InlineDocument";
  let body: any;
  body = JSON.stringify({
...
export const serializeAws_restJson1InlineDocumentAsPayloadCommand = async (
  input: InlineDocumentAsPayloadCommandInput,
  context: __SerdeContext
): Promise<__HttpRequest> => {
  const headers: any = {
    "content-type": "application/json",
  };
  let resolvedPath = "/InlineDocumentAsPayload";
  let body: any;
...
export const serializeAws_restJson1SimpleScalarPropertiesCommand = async (
  ...
  body = JSON.stringify({
    ...
    ...(input.doubleValue !== undefined && input.doubleValue !== null && { DoubleDribble: input.doubleValue }),
    ...(input.falseBooleanValue !== undefined &&
      input.falseBooleanValue !== null && { falseBooleanValue: input.falseBooleanValue }),
    ...(input.floatValue !== undefined && input.floatValue !== null && { floatValue: input.floatValue }),
...
export const deserializeAws_restJson1InlineDocumentCommand = async (
  output: __HttpResponse,
  context: __SerdeContext
): Promise<InlineDocumentCommandOutput> => {
  if (output.statusCode !== 200 && output.statusCode >= 300) {
    return deserializeAws_restJson1InlineDocumentCommandError(output, context);
  }
  const contents: InlineDocumentCommandOutput = {
    $metadata: deserializeMetadata(output),
...
const deserializeAws_restJson1InlineDocumentCommandError = async (
  output: __HttpResponse,
  context: __SerdeContext
): Promise<InlineDocumentCommandOutput> => {
  const parsedOutput: any = {
...
export const deserializeAws_restJson1InlineDocumentAsPayloadCommand = async (
  output: __HttpResponse,
  context: __SerdeContext
): Promise<InlineDocumentAsPayloadCommandOutput> => {
  if (output.statusCode !== 200 && output.statusCode >= 300) {
    return deserializeAws_restJson1InlineDocumentAsPayloadCommandError(output, context);
  }
  const contents: InlineDocumentAsPayloadCommandOutput = {
    $metadata: deserializeMetadata(output),
    documentValue: undefined,
  };
...
const deserializeAws_restJson1InlineDocumentAsPayloadCommandError = async (
  output: __HttpResponse,
  context: __SerdeContext
): Promise<InlineDocumentAsPayloadCommandOutput> => {
  const parsedOutput: any = {
...
export const deserializeAllQueryStringTypesRequest = async (
  ...
  if (query !== undefined && query !== null) {
    if (query["String"] !== undefined) {
      contents.queryString = query["String"] as string;
    }
    if (query["StringList"] !== undefined) {
      contents.queryStringList = (query["StringList"] as string[]).map((_entry) => _entry.trim());
    }
    if (query["StringSet"] !== undefined) {
      contents.queryStringSet = (query["StringSet"] as string[]).map((_entry) => _entry.trim());
    }
    if (query["Byte"] !== undefined) {
      contents.queryByte = parseInt(query["Byte"] as string, 10);
    }
    if (query["Short"] !== undefined) {
      contents.queryShort = parseInt(query["Short"] as string, 10);
    }
    if (query["Integer"] !== undefined) {
      contents.queryInteger = parseInt(query["Integer"] as string, 10);
    }
    if (query["IntegerList"] !== undefined) {
      contents.queryIntegerList = (query["IntegerList"] as string[]).map((_entry) => parseInt(_entry.trim(), 10));
    }
    if (query["IntegerSet"] !== undefined) {
      contents.queryIntegerSet = (query["IntegerSet"] as string[]).map((_entry) => parseInt(_entry.trim(), 10));
    }
    if (query["Long"] !== undefined) {
      contents.queryLong = parseInt(query["Long"] as string, 10);
    }
    if (query["Float"] !== undefined) {
      contents.queryFloat = parseFloat(query["Float"] as string);
    }
    if (query["Double"] !== undefined) {
      contents.queryDouble = parseFloat(query["Double"] as string);
    }
    if (query["DoubleList"] !== undefined) {
      contents.queryDoubleList = (query["DoubleList"] as string[]).map((_entry) => parseFloat(_entry.trim()));
    }
    if (query["Boolean"] !== undefined) {
      contents.queryBoolean = (query["Boolean"] as string) === "true";
    }
    if (query["BooleanList"] !== undefined) {
      contents.queryBooleanList = (query["BooleanList"] as string[]).map((_entry) => _entry.trim() === "true");
    }
    if (query["Timestamp"] !== undefined) {
      contents.queryTimestamp = new Date(query["Timestamp"] as string);
    }
    if (query["TimestampList"] !== undefined) {
      contents.queryTimestampList = (query["TimestampList"] as string[]).map((_entry) => new Date(_entry.trim()));
    }
    if (query["Enum"] !== undefined) {
      contents.queryEnum = query["Enum"] as string;
    }
    if (query["EnumList"] !== undefined) {
      contents.queryEnumList = (query["EnumList"] as string[]).map((_entry) => _entry.trim());
    }
  }
  await collectBody(output.body, context);
  return Promise.resolve(contents);
...
export const deserializeConstantAndVariableQueryStringRequest = async (
  ...
  if (query !== undefined && query !== null) {
    if (query["baz"] !== undefined) {
      contents.baz = query["baz"] as string;
    }
    if (query["maybeSet"] !== undefined) {
      contents.maybeSet = query["maybeSet"] as string;
    }
  }
  await collectBody(output.body, context);
  return Promise.resolve(contents);
...
export const deserializeConstantQueryStringRequest = async (
  ...
  if (parsedPath?.groups !== undefined) {
    contents.hello = parsedPath.groups.hello;
  }
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
export const deserializeHttpRequestWithGreedyLabelInPathRequest = async (
  ...
  const parsedPath = output.path.match(pathRegex);
  if (parsedPath?.groups !== undefined) {
    contents.foo = parsedPath.groups.foo;
    contents.baz = parsedPath.groups.baz;
  }
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
export const deserializeHttpRequestWithLabelsRequest = async (
  ...
  const parsedPath = output.path.match(pathRegex);
  if (parsedPath?.groups !== undefined) {
    contents.string = parsedPath.groups.string;
    contents.short = parseInt(parsedPath.groups.short, 10);
    contents.integer = parseInt(parsedPath.groups.integer, 10);
    contents.long = parseInt(parsedPath.groups.long, 10);
    contents.float = parseFloat(parsedPath.groups.float);
    contents.double = parseFloat(parsedPath.groups.double);
    contents.boolean = parsedPath.groups.boolean === "true";
    contents.timestamp = new Date(parsedPath.groups.timestamp);
  }
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
export const deserializeHttpRequestWithLabelsAndTimestampFormatRequest = async (
  ...
  const parsedPath = output.path.match(pathRegex);
  if (parsedPath?.groups !== undefined) {
    contents.memberEpochSeconds = new Date(Math.round(parseInt(parsedPath.groups.memberEpochSeconds, 10) * 1000));
    contents.memberHttpDate = new Date(parsedPath.groups.memberHttpDate);
    contents.memberDateTime = new Date(parsedPath.groups.memberDateTime);
    contents.defaultFormat = new Date(parsedPath.groups.defaultFormat);
    contents.targetEpochSeconds = new Date(Math.round(parseInt(parsedPath.groups.targetEpochSeconds, 10) * 1000));
    contents.targetHttpDate = new Date(parsedPath.groups.targetHttpDate);
    contents.targetDateTime = new Date(parsedPath.groups.targetDateTime);
  }
  await collectBody(output.body, context);
  return Promise.resolve(contents);
};
...
export const deserializeInlineDocumentRequest = async (
  output: __HttpRequest,
  context: __SerdeContext
): Promise<InlineDocumentServerInput> => {
  const contents: InlineDocumentServerInput = {
    documentValue: undefined,
    stringValue: undefined,
  };
  const data: any = await parseBody(output.body, context);
...
export const deserializeInlineDocumentAsPayloadRequest = async (
  output: __HttpRequest,
  context: __SerdeContext
): Promise<InlineDocumentAsPayloadServerInput> => {
  const contents: InlineDocumentAsPayloadServerInput = {
    documentValue: undefined,
  };
  const data: any = await collectBodyString(output.body, context);
  contents.documentValue = data;
...
export const deserializeOmitsNullSerializesEmptyStringRequest = async (
  ...
  if (query !== undefined && query !== null) {
    if (query["Null"] !== undefined) {
      contents.nullValue = query["Null"] as string;
    }
    if (query["Empty"] !== undefined) {
      contents.emptyString = query["Empty"] as string;
    }
  }
  await collectBody(output.body, context);
  return Promise.resolve(contents);
...
export const deserializeQueryIdempotencyTokenAutoFillRequest = async (
  ...
  if (query !== undefined && query !== null) {
    if (query["token"] !== undefined) {
      contents.token = query["token"] as string;
    }
  }
  await collectBody(output.body, context);
  return Promise.resolve(contents);
...
export const serializeInlineDocumentResponse = async (
  input: InlineDocumentServerOutput,
  ctx: Omit<__SerdeContext, "endpoint">
): Promise<__HttpResponse> => {
  const context: __SerdeContext = {
    ...ctx,
...
export const serializeInlineDocumentAsPayloadResponse = async (
  input: InlineDocumentAsPayloadServerOutput,
  ctx: Omit<__SerdeContext, "endpoint">
): Promise<__HttpResponse> => {
  const context: __SerdeContext = {
    ...ctx,
...
export const serializeFooErrorError = async (
  input: FooError,
  ctx: Omit<__SerdeContext, "endpoint">
): Promise<__HttpResponse> => {
  const context: __SerdeContext = {
...
const serializeAws_restJson1DenseStructMap = (
  ...
  return Object.entries(input).reduce((acc: { [key: string]: GreetingStruct }, [key, value]: [string, any]) => {
    if (value === null) {
      return acc;
    }
    return {
