...
> {
  ...
  resolveMiddleware(
  ...
  ): Handler<MalformedIntegerCommandInput, MalformedIntegerCommandOutput> {
    ...
    const commandName = "MalformedIntegerCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      logger,
      clientName,
      commandName,
      inputFilterSensitiveLog: MalformedIntegerInput.filterSensitiveLog,
