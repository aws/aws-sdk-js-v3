 ...
 * ```javascript
 * import { RestJsonProtocolClient, TestPayloadStructureCommand } from "@aws-sdk/aws-restjson"; // ES Modules import
 * // const { RestJsonProtocolClient, TestPayloadStructureCommand } = require("@aws-sdk/aws-restjson"); // CommonJS import
...
> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: TestPayloadStructureInputOutput.filterSensitiveLog,
      outputFilterSensitiveLog: TestPayloadStructureInputOutput.filterSensitiveLog,
    };
