 ...
 * ```javascript
 * import { RestJsonProtocolClient, TestPayloadBlobCommand } from "@aws-sdk/aws-restjson"; // ES Modules import
 * // const { RestJsonProtocolClient, TestPayloadBlobCommand } = require("@aws-sdk/aws-restjson"); // CommonJS import
