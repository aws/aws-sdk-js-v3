 ...
 * ```javascript
 * import { RestXmlProtocolClient, XmlEnumsCommand } from "@aws-sdk/aws-restxml"; // ES Modules import
 * // const { RestXmlProtocolClient, XmlEnumsCommand } = require("@aws-sdk/aws-restxml"); // CommonJS import
