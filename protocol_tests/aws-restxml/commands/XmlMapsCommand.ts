...
import { XmlMapsInputOutput } from "../models/index";
import {
...
export class XmlMapsCommand extends $Command<XmlMapsCommandInput, XmlMapsCommandOutput, RestXmlProtocolClientResolvedConfig> {
