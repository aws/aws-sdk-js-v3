...
export class XmlAttributesOnPayloadCommand extends $Command<XmlAttributesOnPayloadCommandInput, XmlAttributesOnPayloadCommandOutput, RestXmlProtocolClientResolvedConfig> {
