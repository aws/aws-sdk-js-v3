...
import { XmlEnumsOutput } from "../models/index";
import {
...
export class XmlEnumsCommand extends $Command<XmlEnumsCommandInput, XmlEnumsCommandOutput, QueryProtocolClientResolvedConfig> {
