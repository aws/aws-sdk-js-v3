...
export interface HttpPrefixHeadersServerInput extends HttpPrefixHeadersInputOutput {}
export namespace HttpPrefixHeadersServerInput {
  /**
   * @internal
   */
  export const validate: (obj: Parameters<typeof HttpPrefixHeadersInputOutput.validate>[0]) => __ValidationFailure[] =
    HttpPrefixHeadersInputOutput.validate;
}
export interface HttpPrefixHeadersServerOutput extends HttpPrefixHeadersInputOutput, __MetadataBearer {}
