...
- [Downloading Objects to a directory](#downloading-objects-to-a-directory) — downloads all objects under a key prefix into a local directory, mapping the `/` key delimiter to subdirectories.
...
### Downloading Objects to a directory
