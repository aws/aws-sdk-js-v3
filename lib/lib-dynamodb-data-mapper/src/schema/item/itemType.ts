import { AttributeValue, ScalarAttributeType } from "@aws-sdk/client-dynamodb";
    ...
    switch (arg.type) {
      ...
      case "Custom":
        return (
          ...
          [void 0, "S", "N", "B"].indexOf((arg as CustomType<any>).attributeType) > -1
        );
      case "Document":
      ...
      case "Number":
        return isKeyableType(arg) && ["boolean", "undefined"].indexOf(typeof (arg as NumberType).versionAttribute) > -1;
      case "Tuple":
