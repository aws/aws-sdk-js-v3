import type { NumberValue as INumberValue } from "./JsAttributeValue";
...
export class NumberValue implements INumberValue {
   ...
   */
  public constructor(value: number | bigint | string | { N: string }) {
   ...
   * @param value - a precise number, or any BigInt or string, or AttributeValue.
   */
  public static from(value: number | bigint | string | { N: string }) {
