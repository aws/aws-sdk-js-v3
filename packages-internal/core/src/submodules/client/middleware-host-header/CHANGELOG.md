...
The original package (`@aws-sdk/middleware-host-header`) is now a re-export stub.
All future development happens in `packages-internal/core/src/submodules/client/middleware-host-header/`.
