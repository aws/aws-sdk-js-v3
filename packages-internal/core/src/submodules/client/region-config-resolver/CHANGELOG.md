...
The original package (`@aws-sdk/region-config-resolver`) is now a re-export stub.
All future development happens in `packages-internal/core/src/submodules/client/region-config-resolver/`.
