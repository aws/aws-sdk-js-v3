...
The original package (`@aws-sdk/middleware-logger`) is now a re-export stub.
All future development happens in `packages-internal/core/src/submodules/client/middleware-logger/`.
