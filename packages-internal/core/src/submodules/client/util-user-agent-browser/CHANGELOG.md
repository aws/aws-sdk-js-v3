...
The original package (`@aws-sdk/util-user-agent-browser`) is now a re-export stub.
All future development happens in `packages-internal/core/src/submodules/client/util-user-agent-browser/`.
