...
This package has been consolidated into `@aws-sdk/core/client`.
The original package (`@aws-sdk/middleware-user-agent`) is now a re-export stub.
All future development happens in `packages-internal/core/src/submodules/client/middleware-user-agent/`.
...
* **packages-internal:** set submodule for core imports ([#7898](https://github.com/aws/aws-sdk-js-v3/issues/7898)) ([10459be](https://github.com/aws/aws-sdk-js-v3/commit/10459be92a693eefec88f7d9dd8bd0d287366929))
