...
The original package (`@aws-sdk/util-endpoints`) is now a re-export stub.
All future development happens in `packages-internal/core/src/submodules/client/util-endpoints/`.
